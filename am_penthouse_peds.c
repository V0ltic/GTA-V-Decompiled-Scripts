...
void __EntryFunction__()
{
	...
	{
		func_37();
		if (((!network_is_game_in_progress() || func_29()) || Global_1579058 == 0) || func_28())
		{
			func_25();
		}
		func_3();
...
void func_1()
{
	...
	if (iLocal_38 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (does_entity_exist(Local_40[iVar0 /*47*/]) && !is_entity_dead(Local_40[iVar0 /*47*/], false))
			{
				play_stream_from_ped(Local_40[iVar0 /*47*/]);
				iLocal_38++;
			}
		}
	}
	if (iLocal_38 == 2)
	{
		if (is_stream_playing())
		{
			...
			set_variable_on_stream("Crowd_Size", fVar1);
			iLocal_38++;
		}
	}
}
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		...
		{
			if (!does_entity_exist(Local_40[iVar0 /*47*/]))
			{
				func_12(&(Local_40[iVar0 /*47*/]));
			}
			else if (is_entity_dead(Local_40[iVar0 /*47*/], false))
			{
	...
	if (iVar3 != 0 && iVar3 != 1)
	{
		if (has_anim_dict_loaded(sVar0))
		{
			...
			if (!func_7(uParam0))
			{
				if (func_6(uParam0))
				{
					task_play_anim_advanced(0, sVar0, sVar1, uParam0->f_40, 0f, 0f, uParam0->f_43, 8f, -8f, -1, 790529, fVar2, 2, 3);
				}
				else
				{
			...
			else
			{
				...
				while (iVar8 < 4)
				{
					...
					{
						case 0:
							task_play_anim(0, sVar0, "IDLE_A", 8f, -8f, -1, 0, 0f, false, false, false);
							break;
						
						case 1:
							task_play_anim(0, sVar0, "IDLE_B", 8f, -8f, -1, 0, 0f, false, false, false);
							break;
						
						case 2:
							task_play_anim(0, sVar0, "IDLE_C", 8f, -8f, -1, 0, 0f, false, false, false);
							break;
						
						case 3:
							task_play_anim(0, sVar0, "IDLE_D", 8f, -8f, -1, 0, 0f, false, false, false);
							break;
					}
					iVar8++;
				}
...
void func_12(var uParam0)
{
	...
	if (iLocal_37 < 2)
	{
		...
		if (func_20(uParam0))
		{
			*uParam0 = create_ped(26, func_19(uParam0), uParam0->f_40, uParam0->f_43, false, false);
			if (does_entity_exist(*uParam0))
			{
				iVar0 = 0;
				while (iVar0 < 12)
				{
					set_ped_component_variation(*uParam0, iVar0, uParam0->f_3[iVar0 /*2*/], uParam0->f_3[iVar0 /*2*/].f_1, 0);
					iVar0++;
				}
				iVar0 = 0;
				while (iVar0 < 3)
				{
					...
					{
						set_ped_prop_index(*uParam0, uParam0->f_32[iVar0], 0, uParam0->f_36[iVar0], false);
					}
					iVar0++;
				}
				func_18(uParam0);
				if (func_17(uParam0))
				{
					...
					{
						uParam0->f_1 = create_object(func_16(uParam0), get_ped_bone_coords(*uParam0, func_15(uParam0), 0f, 0f, 0f), false, false, false);
						attach_entity_to_entity(uParam0->f_1, *uParam0, get_ped_bone_index(*uParam0, func_15(uParam0)), func_14(uParam0), 0f, 0f, 0f, true, true, false, false, 2, true, 0);
					}
				}
				if (func_7(uParam0))
				{
					set_ped_alternate_movement_anim(*uParam0, 0, func_13(uParam0), "BASE", 8f, true);
				}
				iLocal_37++;
			}
		}
...
int func_20(var uParam0)
{
	if (func_22(uParam0))
	{
		if (has_model_loaded(func_19(uParam0)) && has_anim_dict_loaded(func_10(uParam0)))
		{
			if (func_7(uParam0))
			{
				if (!has_anim_dict_loaded(func_13(uParam0)))
				{
					return 0;
				}
			}
			if (func_17(uParam0))
			{
				if (has_model_loaded(func_16(uParam0)))
				{
					return 1;
				}
				else
...
void func_21(var uParam0)
{
	if (func_22(uParam0))
	{
		request_model(func_19(uParam0));
		request_anim_dict(func_10(uParam0));
		if (func_7(uParam0))
		{
			request_anim_dict(func_13(uParam0));
		}
		if (func_17(uParam0))
		{
			request_model(func_16(uParam0));
		}
	}
}
...
bool func_28()
{
	return (!Global_1579054 && network_is_activity_session());
}
...
int func_29()
{
	...
	if (func_30() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_30()) == 0)
		{
			return 1;
		}
	}
...
void func_47()
{
	while (!_network_is_this_script_marked(32, false, Global_1579073))
	{
		wait(0);
	}
	Global_1579073++;
	func_48(0, -1, 0);
	network_register_host_broadcast_variables(&Local_39, 3, 0);
}
