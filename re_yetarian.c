...
void __EntryFunction__()
{
	...
	if (has_force_cleanup_occurred(27))
	{
		func_172();
	}
	...
	while (true)
	{
		...
		fVar0 = (_replay_free_cam_get_max_range() + 20f);
		if (vdist2(get_entity_coords(player_ped_id(), false), Local_57) < (fVar0 * fVar0))
		{
			_disable_rockstar_editor_camera_changes();
		}
		if (vdist2(get_entity_coords(player_ped_id(), false), Local_59) < (fVar0 * fVar0))
		{
			_disable_rockstar_editor_camera_changes();
		}
		...
		else if (bLocal_72)
		{
			...
			if (func_2(iLocal_48))
			{
				if (func_1(iLocal_48, player_ped_id(), 1) > 120f)
				{
					func_100();
				}
			}
		...
		case 1:
			...
			if (func_2(iLocal_48))
			{
				if (func_58())
				{
					if (!iLocal_66)
					{
						...
						if (!bLocal_64)
						{
							...
							task_perform_sequence(iLocal_48, iLocal_87);
						...
						else
						{
							if (!bLocal_65)
							{
								open_sequence_task(&iLocal_87);
								task_look_at_entity(0, player_ped_id(), -1, 0, 2);
								if (func_1(iLocal_48, player_ped_id(), 1) <= 4f)
								{
									task_turn_ped_to_face_entity(0, player_ped_id(), 1500);
								}
								task_smart_flee_ped(0, player_ped_id(), 150f, -1, true, false);
								close_sequence_task(iLocal_87);
							}
							else
							{
					...
					{
						func_36();
						set_ped_max_move_blend_ratio(iLocal_48, 2f);
						if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_48, false), true) >= 100f && !is_sphere_visible(get_entity_coords(iLocal_48, false), 3f))
						{
				...
				else
				{
					...
					if (Local_45[0 /*20*/].f_18 >= 5 && Local_45[1 /*20*/].f_18 >= 5)
					{
						if (!is_entity_in_angled_area(player_ped_id(), -69.62395f, -1087.37f, 24.59833f, -11.27861f, -1108.28f, 34.17205f, 47.5f, false, true, 0))
						{
							func_4();
						}
					}
					if (func_2(iLocal_48))
					{
						set_ped_reset_flag(iLocal_48, 60, true);
					}
				}
			}
			else
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_38(iParam2), 1);
}
...
int func_58()
{
	if (func_2(iLocal_48))
	{
		if (!bLocal_64)
		{
			if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_48, false), true) <= 7f || get_script_task_status(iLocal_48, 242628503) == 7)
			{
				if (!iLocal_66)
				{
					if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_48, false), true) <= 7f)
					{
					}
					if (get_script_task_status(iLocal_48, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_48, false), true) <= 4.5f || get_script_task_status(iLocal_48, 242628503) == 7)
		{
			if (!iLocal_66)
			{
				if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_48, false), true) <= 4.5f)
				{
				}
				if (get_script_task_status(iLocal_48, 242628503) == 7)
				{
...
void func_59()
{
	if (func_2(iLocal_48))
	{
		if (is_entity_playing_anim(iLocal_48, "cellphone@", "cellphone_call_out", 3))
		{
			if (get_entity_anim_current_time(iLocal_48, "cellphone@", "cellphone_call_out") >= 0.24f)
			{
				if (does_entity_exist(iLocal_52))
				{
					delete_object(&iLocal_52);
...
int func_60()
{
	...
	iVar0 = get_interior_at_coords(Local_45[0 /*20*/].f_10);
	if (iVar0 != 0)
	{
...
void func_61()
{
	switch (iLocal_47)
	{
		...
		case 1:
			if (func_60())
			{
				if (!is_door_registered_with_system(-1831288286))
				{
					add_door_to_system(-1831288286, joaat("v_ilev_fib_door1"), -31.72f, -1101.85f, 26.57f, true, true, false);
				}
				else if (door_system_get_open_ratio(-1831288286) < 1f)
				{
					door_system_set_open_ratio(-1831288286, 1f, false, false);
					door_system_set_door_state(-1831288286, 1, false, true);
				}
			}
			func_59();
			if (is_player_playing(player_id()))
					...
					if (func_65())
					{
						if (iLocal_71 == 0)
						{
							if (bLocal_63)
							{
								clear_ped_tasks(iLocal_48);
								open_sequence_task(&iLocal_87);
								task_look_at_entity(0, player_ped_id(), -1, 12, 2);
								task_play_anim(0, "cellphone@", "cellphone_call_out", 8f, -8f, -1, 0, 0f, false, false, false);
								close_sequence_task(iLocal_87);
								task_perform_sequence(iLocal_48, iLocal_87);
								clear_sequence_task(&iLocal_87);
							}
						...
						{
							if ((get_game_timer() - iLocal_55) >= iLocal_56)
							{
								func_62();
...
void func_62()
{
	if (func_55() == 1)
	{
		func_56(&uLocal_92, 1, player_ped_id(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_56(&uLocal_92, 0, player_ped_id(), "MICHAEL", 0, 1);
	}
...
int func_63()
{
	if ((((((((func_64(player_ped_id()) != joaat("weapon_unarmed") && func_64(player_ped_id()) != joaat("object")) && func_64(player_ped_id()) != joaat("weapon_knife")) && func_64(player_ped_id()) != joaat("weapon_nightstick")) && func_64(player_ped_id()) != joaat("weapon_hammer")) && func_64(player_ped_id()) != joaat("weapon_bat")) && func_64(player_ped_id()) != joaat("weapon_crowbar")) && func_64(player_ped_id()) != joaat("weapon_golfclub")) && func_64(player_ped_id()) != joaat("weapon_bottle"))
	{
...
int func_65()
{
	if (!is_cop_ped_in_area_3d(Local_78, Local_79) && !(is_position_occupied(-61.01321f, -1093.393f, 25.75297f, 2f, false, true, false, false, false, 0, false) && is_position_occupied(-38.59683f, -1109.284f, 25.68742f, 2f, false, true, false, false, false, 0, false)))
	{
		if (get_room_key_from_entity(player_ped_id()) == get_hash_key("rm_showroom"))
		{
			if (!func_129())
			{
				if (is_entity_in_angled_area(player_ped_id(), -41.19015f, -1104.137f, 24.42232f, -33.7943f, -1107.183f, 28.67232f, 8.5f, false, true, 0))
				{
					bLocal_64 = true;
					func_77(0);
				}
	...
	else if (is_cop_ped_in_area_3d(Local_78, Local_79) || (is_position_occupied(-61.01321f, -1093.393f, 25.75297f, 2f, false, true, false, false, false, 0, false) && is_position_occupied(-38.59683f, -1109.284f, 25.68742f, 2f, false, true, false, false, false, 0, false)))
	{
		if (get_room_key_from_entity(player_ped_id()) == get_hash_key("rm_showroom"))
		{
...
int func_71()
{
	switch (func_72(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
void func_77(bool bParam0)
{
	if (bParam0)
	{
		if (func_2(iLocal_50))
		{
			set_entity_visible(iLocal_50, true, false);
			freeze_entity_position(iLocal_50, false);
			set_entity_can_be_damaged(iLocal_50, true);
			iLocal_48 = iLocal_50;
			iLocal_52 = iLocal_54;
			func_66(&iLocal_49);
			func_78(&iLocal_53);
	...
	{
		set_entity_visible(iLocal_49, true, false);
		freeze_entity_position(iLocal_49, false);
		set_entity_can_be_damaged(iLocal_49, true);
		iLocal_48 = iLocal_49;
		iLocal_52 = iLocal_53;
		func_66(&iLocal_50);
		func_78(&iLocal_54);
...
void func_79()
{
	switch (iLocal_47)
	{
		case 0:
			...
			set_all_vehicle_generators_active_in_area(-51.89f, -1097.35f, 23.42f, -45.71f, -1092.1f, 27.42f, false, true);
			clear_angled_area_of_vehicles(-53.57574f, -1095.356f, 24.17232f, -46.52551f, -1094.587f, 27.42232f, 3.75f, false, false, false, false, false, 0, 0);
			break;
		...
		case 1:
			if (!func_2(iLocal_49) || !func_2(iLocal_50))
			{
				...
				if (func_2(iLocal_49))
				{
					set_entity_visible(iLocal_49, false, false);
					set_entity_can_be_damaged(iLocal_49, false);
					set_ped_can_be_targetted(iLocal_49, false);
					set_blocking_of_non_temporary_events(iLocal_49, true);
					set_ped_relationship_group_hash(iLocal_49, iLocal_90);
					set_entity_only_damaged_by_player(iLocal_49, true);
					give_weapon_to_ped(iLocal_49, joaat("weapon_pistol"), 999, false, false);
					set_entity_can_be_damaged_by_relationship_group(iLocal_49, false, iLocal_88);
					set_relationship_between_groups(5, iLocal_88, joaat("player"));
					set_entity_load_collision_flag(iLocal_49, true, 1);
					set_ped_config_flag(iLocal_49, 104, true);
					iLocal_53 = create_object(iLocal_74, get_entity_coords(iLocal_49, true), true, true, false);
					attach_entity_to_entity(iLocal_53, iLocal_49, get_ped_bone_index(iLocal_49, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
					open_sequence_task(&iLocal_87);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_d", 8f, -8f, -1, 0, 0f, false, false, false);
					set_sequence_to_repeat(iLocal_87, true);
					close_sequence_task(iLocal_87);
					task_perform_sequence(iLocal_49, iLocal_87);
					clear_sequence_task(&iLocal_87);
					freeze_entity_position(iLocal_49, true);
				}
				func_81(&iLocal_50, 18, Local_59, fLocal_60, 1);
				if (func_2(iLocal_50))
				{
					set_entity_visible(iLocal_50, false, false);
					set_entity_can_be_damaged(iLocal_50, false);
					set_ped_can_be_targetted(iLocal_50, false);
					set_blocking_of_non_temporary_events(iLocal_50, true);
					set_ped_relationship_group_hash(iLocal_50, iLocal_90);
					set_entity_only_damaged_by_player(iLocal_50, true);
					give_weapon_to_ped(iLocal_50, joaat("weapon_pistol"), 999, false, false);
					set_entity_can_be_damaged_by_relationship_group(iLocal_50, false, iLocal_88);
					set_relationship_between_groups(5, iLocal_88, joaat("player"));
					set_entity_load_collision_flag(iLocal_50, true, 1);
					set_ped_config_flag(iLocal_50, 104, true);
					iLocal_54 = create_object(iLocal_74, get_entity_coords(iLocal_50, true), true, true, false);
					attach_entity_to_entity(iLocal_54, iLocal_50, get_ped_bone_index(iLocal_50, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
					open_sequence_task(&iLocal_87);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0f, false, false, false);
					...
					set_sequence_to_repeat(iLocal_87, true);
					close_sequence_task(iLocal_87);
					task_perform_sequence(iLocal_50, iLocal_87);
					clear_sequence_task(&iLocal_87);
					freeze_entity_position(iLocal_49, true);
				}
			}
			...
			{
				func_80();
				iLocal_75 = create_vehicle(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, true, true, false);
				set_vehicle_colour_combination(iLocal_75, 7);
				set_vehicle_window_tint(iLocal_75, 3);
				set_vehicle_doors_locked(iLocal_75, 2);
				set_vehicle_is_considered_by_player(iLocal_75, false);
				iLocal_76 = create_vehicle(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, true, true, false);
				set_vehicle_colour_combination(iLocal_76, 12);
				set_vehicle_doors_locked(iLocal_76, 2);
				set_vehicle_is_considered_by_player(iLocal_76, false);
				iLocal_77 = create_vehicle(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, true, true, false);
				set_vehicle_colour_combination(iLocal_77, 4);
				set_vehicle_window_tint(iLocal_77, 3);
				set_vehicle_doors_locked(iLocal_77, 2);
				set_vehicle_is_considered_by_player(iLocal_77, false);
				iLocal_47 = 2;
			}
			break;
...
int func_81(int* iParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_84()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_95())
		{
			return 0;
		}
	}
...
int func_96()
{
	if (((((((((((has_model_loaded(Local_45[0 /*20*/]) && has_model_loaded(Local_45[1 /*20*/])) && has_weapon_asset_loaded(Local_45[0 /*20*/].f_17)) && has_weapon_asset_loaded(Local_45[1 /*20*/].f_17)) && func_60()) && has_anim_dict_loaded("cellphone@")) && has_anim_dict_loaded("cellphone@str")) && get_is_waypoint_recording_loaded("reyetarian_simeonoffice")) && has_model_loaded(iLocal_74)) && has_model_loaded(joaat("bjxl"))) && has_model_loaded(joaat("tailgater"))) && has_model_loaded(joaat("baller2")))
	{
		return 1;
	}
	return 0;
	...
	switch (Local_45[iParam0 /*20*/].f_18)
	{
		...
		case 1:
			if (!Local_45[iParam0 /*20*/].f_19)
			{
				...
				{
					Local_45[iParam0 /*20*/].f_1 = create_ped(22, Local_45[iParam0 /*20*/], Local_45[iParam0 /*20*/].f_10, Local_45[iParam0 /*20*/].f_13, true, true);
					if (func_2(Local_45[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							task_start_scenario_at_position(Local_45[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", Local_80[iParam0 /*3*/], fLocal_81[iParam0], 0, false, true);
							set_ped_should_play_normal_scenario_exit(Local_45[iParam0 /*20*/].f_1);
							_0x425AECF167663F48(Local_45[iParam0 /*20*/].f_1, true);
							set_ped_sphere_defensive_area(Local_45[iParam0 /*20*/].f_1, -37.34785f, -1102.022f, 25.42232f, 3f, false, false);
							set_ped_combat_attributes(Local_45[iParam0 /*20*/].f_1, 37, true);
						}
						set_blocking_of_non_temporary_events(Local_45[iParam0 /*20*/].f_1, true);
						set_ped_relationship_group_hash(Local_45[iParam0 /*20*/].f_1, iLocal_88);
						set_entity_can_be_damaged_by_relationship_group(Local_45[iParam0 /*20*/].f_1, false, iLocal_88);
						set_ped_combat_attributes(Local_45[iParam0 /*20*/].f_1, 23, false);
						set_ped_combat_attributes(Local_45[iParam0 /*20*/].f_1, 1, false);
						set_ped_combat_attributes(Local_45[iParam0 /*20*/].f_1, 28, true);
						set_ped_chance_of_firing_blanks(Local_45[iParam0 /*20*/].f_1, 0.7f, 0.3f);
						iLocal_70[iParam0] = 0;
						if (func_55() == 0)
						{
							give_weapon_to_ped(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, true, true);
						}
						set_model_as_no_longer_needed(Local_45[iParam0 /*20*/]);
		...
		case 2:
			if (func_2(Local_45[iParam0 /*20*/].f_1))
			{
				if (iLocal_67)
				{
					...
					clear_ped_tasks(Local_45[iParam0 /*20*/].f_1);
					set_ped_using_action_mode(Local_45[iParam0 /*20*/].f_1, true, -1, "DEFAULT_ACTION");
					open_sequence_task(&iLocal_87);
					task_look_at_entity(0, player_ped_id(), -1, 12, 2);
					task_follow_nav_mesh_to_coord(0, Local_45[iParam0 /*20*/].f_14, 1f, -1, 3f, false, 40000f);
					task_turn_ped_to_face_entity(0, player_ped_id(), 0);
					close_sequence_task(iLocal_87);
					task_perform_sequence(Local_45[iParam0 /*20*/].f_1, iLocal_87);
					clear_sequence_task(&iLocal_87);
					Local_45[iParam0 /*20*/].f_18 = 3;
				}
				if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(Local_45[iParam0 /*20*/].f_1, false), true) >= 250f)
				{
		...
		case 3:
			...
			{
				func_99(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
				if (get_script_task_status(Local_45[iParam0 /*20*/].f_1, 242628503) == 7 || get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(Local_45[iParam0 /*20*/].f_1, false), true) <= 5f)
				{
					task_look_at_entity(Local_45[iParam0 /*20*/].f_1, player_ped_id(), -1, 0, 2);
					task_combat_ped(Local_45[iParam0 /*20*/].f_1, player_ped_id(), 0, 16);
					set_ped_alertness(Local_45[iParam0 /*20*/].f_1, 3);
					set_ped_keep_task(Local_45[iParam0 /*20*/].f_1, true);
		...
		case 4:
			...
			else
			{
				if (iLocal_70[iParam0] == 0)
				{
					...
					{
						give_weapon_to_ped(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_17, -1, false, true);
						iLocal_70[iParam0] = 1;
					}
				}
				if (get_script_task_status(Local_45[iParam0 /*20*/].f_1, 780511057) == 7)
				{
					task_combat_ped(Local_45[iParam0 /*20*/].f_1, player_ped_id(), 0, 16);
				}
				if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), get_entity_coords(Local_45[iParam0 /*20*/].f_1, false), true) >= 75f)
				{
					Local_45[iParam0 /*20*/].f_18 = 5;
				}
			}
		...
		case 5:
			...
			if (does_entity_exist(Local_45[iParam0 /*20*/].f_1))
			{
				set_ped_as_no_longer_needed(&(Local_45[iParam0 /*20*/].f_1));
			}
...
void func_100()
{
	...
	func_101(-1);
	remove_relationship_group(iLocal_88);
	remove_relationship_group(iLocal_89);
	remove_relationship_group(iLocal_90);
	if (iLocal_61 == 0)
	{
	...
	if (does_entity_exist(iLocal_48))
	{
		set_ped_as_no_longer_needed(&iLocal_48);
		if (does_blip_exist(iLocal_51))
		{
			remove_blip(&iLocal_51);
		}
	...
	remove_scenario_blocking_area(iLocal_82, false);
	...
	if (iLocal_84 != -1)
	{
		remove_navmesh_blocking_object(iLocal_84);
	}
	if (iLocal_85 != -1)
	{
	...
	if (iLocal_86 != -1)
	{
		remove_navmesh_blocking_object(iLocal_86);
	}
	if (does_scenario_group_exist("DEALERSHIP"))
	{
		if (!is_scenario_group_enabled("DEALERSHIP"))
	...
	set_all_vehicle_generators_active_in_area(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, true, true);
	terminate_this_thread();
}
...
int func_125()
{
	...
	func_123(&uVar0, get_clock_seconds());
	func_122(&uVar0, get_clock_minutes());
	func_121(&uVar0, get_clock_hours());
	func_119(&uVar0, get_clock_day_of_month());
	func_120(&uVar0, get_clock_month());
	func_118(&uVar0, get_clock_year());
	return uVar0;
}
...
int func_129()
{
	if ((Global_113375 == func_32() && get_random_event_flag()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
void func_130()
{
	...
	fLocal_81[1] = 136.57f;
	add_relationship_group("GoonGroup", &iLocal_88);
	add_relationship_group("PlayerGroup", &iLocal_89);
	add_relationship_group("YetarianGroup", &iLocal_90);
	set_relationship_between_groups(1, iLocal_90, joaat("player"));
	set_relationship_between_groups(1, joaat("player"), iLocal_90);
	set_relationship_between_groups(5, iLocal_88, joaat("player"));
	set_relationship_between_groups(5, joaat("player"), iLocal_88);
	set_all_vehicle_generators_active_in_area(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, false, true);
	iLocal_82 = add_scenario_blocking_area(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, false, true, true, true);
	add_cover_blocking_area(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, true, true, true, false);
	if (iLocal_86 == -1)
	{
		iLocal_86 = add_navmesh_blocking_object(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, false, 7);
	}
	func_131(196, 0);
	func_131(197, 0);
	func_131(194, 0);
	func_131(195, 0);
	request_model(Local_45[0 /*20*/]);
	request_model(Local_45[1 /*20*/]);
	request_model(iLocal_74);
	request_model(joaat("bjxl"));
	request_model(joaat("tailgater"));
	request_model(joaat("baller2"));
	request_weapon_asset(Local_45[0 /*20*/].f_17, 31, 0);
	request_weapon_asset(Local_45[1 /*20*/].f_17, 31, 0);
...
int func_136(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				iVar0 = get_entity_model(func_137(get_vehicle_ped_is_in(player_ped_id(), true)));
				switch (iVar0)
				{
...
void func_138(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_139(iParam0) && _get_number_of_references_of_script_with_name_hash(Global_91229[26 /*34*/].f_6) == 0)
			{
				Global_113386.f_7261[iParam0] = 1;
				door_system_set_door_state(uParam1->f_5, Global_113386.f_7261[iParam0], true, true);
			}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_164()) || Global_31962) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_164()) || Global_112433) || Global_31962) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_159()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_164() || get_player_wanted_level(player_id()) > 0) || func_52(8, -1)) || func_159()) || func_158()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
