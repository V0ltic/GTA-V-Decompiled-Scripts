...
void __EntryFunction__()
{
	...
	if (func_297(player_ped_id()))
	{
		iLocal_262 = get_ped_relationship_group_hash(player_ped_id());
	}
	if (func_296(Local_81.f_28[0]))
	{
		set_ped_relationship_group_hash(Local_81.f_28[0], iLocal_262);
		set_ped_config_flag(Local_81.f_28[0], 132, true);
	}
	while (true)
	{
		_0x208784099002BC30("SF_EC", 0);
		wait(0);
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			if (has_anim_dict_loaded("rcmjosh1leadinout") && has_model_loaded(joaat("p_amb_phone_01")))
			{
				if (!does_entity_exist(iLocal_85))
				{
					if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
					{
						set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, false);
					}
					iLocal_85 = get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
				}
				iLocal_83 = 1;
			}
			break;
		...
		case 1:
			if (iLocal_92 == 1)
			{
				...
				if ((get_game_timer() - iLocal_93) >= 500)
				{
					func_235(1, 1, 1);
					iLocal_92 = 0;
				}
			...
			if (!iLocal_94)
			{
				if (func_297(Local_81.f_28[0]) && does_entity_exist(iLocal_85))
				{
					iLocal_87 = create_synchronized_scene(Local_88, Local_89, 2);
					task_synchronized_scene(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					play_synchronized_entity_anim(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
					force_entity_ai_and_animation_update(iLocal_85);
					force_ped_ai_and_animation_update(Local_81.f_28[0], true, false);
					func_246("Done Josh leadout anim");
					iLocal_94 = 1;
				}
			}
			else if (is_synchronized_scene_running(iLocal_87))
			{
				if (get_synchronized_scene_phase(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
						func_234(&uLocal_97, 2, player_ped_id(), "Trevor", 0, 1);
				...
				if (get_synchronized_scene_phase(iLocal_87) > 0.98f)
				{
					func_246("Leadout done, end mission");
					iLocal_83 = 2;
				}
				if (is_entity_in_angled_area(player_ped_id(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, false, true, 0))
				{
					func_246("Too close, stopping scene");
					if (func_296(Local_81.f_28[0]))
					{
						clear_ped_tasks(Local_81.f_28[0]);
						func_246("Stopping Josh?");
					}
					if (does_entity_exist(iLocal_85))
					{
						stop_synchronized_entity_anim(iLocal_85, -8f, true);
					}
					iLocal_96 = 1;
				}
				if (func_218(Local_81.f_28[0], player_ped_id(), 1) > 17.5f)
				{
					if (func_296(Local_81.f_28[0]))
					{
						stop_synchronized_entity_anim(Local_81.f_28[0], -8f, true);
						clear_ped_tasks(Local_81.f_28[0]);
					}
					if (does_entity_exist(iLocal_85))
					{
				...
				if ((is_ped_injured(Local_81.f_28[0]) || is_entity_on_fire(Local_81.f_28[0])) || is_explosion_in_sphere(-1, get_entity_coords(Local_81.f_28[0], true), 5f))
				{
					if (func_296(Local_81.f_28[0]))
					{
						stop_synchronized_entity_anim(Local_81.f_28[0], -8f, true);
		...
		case 2:
			...
			if (func_296(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
					...
					task_follow_nav_mesh_to_coord(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, false, 40000f);
					task_play_anim(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0f, false, false, false);
					close_sequence_task(iLocal_84);
				}
				else
				{
					open_sequence_task(&iLocal_84);
					task_follow_nav_mesh_to_coord(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, true, 40000f);
					task_play_anim(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0f, false, false, false);
					close_sequence_task(iLocal_84);
				}
				task_perform_sequence(Local_81.f_28[0], iLocal_84);
				clear_sequence_task(&iLocal_84);
				set_blocking_of_non_temporary_events(Local_81.f_28[0], false);
				if (iLocal_96 == 0)
				{
					force_ped_motion_state(Local_81.f_28[0], joaat("MotionState_Walk"), false, 0, true);
				}
			}
			if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
			{
			...
			if (iLocal_96 == 0)
			{
				door_system_set_open_ratio(904342475, 0f, true, true);
...
void func_238(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_242(player_id())) && !func_240(player_id(), 0)) && !func_239()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_242(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_247()
{
	...
	if (can_request_assets_for_cutscene_entity())
	{
		...
		if (func_296(Local_81.f_28[0]))
		{
			set_cutscene_ped_component_variation_from_ped("Josh", Local_81.f_28[0], 0);
		}
	}
	switch (iLocal_83)
	{
		case 0:
			if (func_263(1, 1093140480, 0))
			{
				...
				if (func_296(Local_81.f_28[0]))
				{
					register_entity_for_cutscene(Local_81.f_28[0], "Josh", 0, 0, 0);
				}
				if (func_296(player_ped_id()))
				{
					register_entity_for_cutscene(player_ped_id(), "Trevor", 0, 0, 0);
				}
				set_roads_in_angled_area(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, false, false, true);
				clear_area_of_vehicles(-1146.306f, 295.9831f, 66.13612f, 9f, false, false, false, false, false, false, 0);
				clear_area_of_vehicles(-1143.244f, 280.2762f, 65.41892f, 12f, false, false, false, false, false, false, 0);
				clear_area_of_vehicles(-1152.426f, 313.6157f, 67.10429f, 12f, false, false, false, false, false, false, 0);
				clear_area_of_vehicles(-1165.966f, 332.6786f, 68.81f, 12f, false, false, false, false, false, false, 0);
				clear_area_of_vehicles(-1178.729f, 346.4572f, 70.04675f, 12f, false, false, false, false, false, false, 0);
				clear_angled_area_of_vehicles(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, false, false, false, false, false, 0, 0);
				iVar0 = get_players_last_vehicle();
				if (func_262(iVar0))
				{
					if (is_entity_in_angled_area(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, false, true, 0))
					{
				...
				if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
				{
					...
					set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, true, 90f, false);
				}
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					func_248(player_ped_id(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					set_gameplay_cam_relative_pitch(0f, 1f);
					set_gameplay_cam_relative_heading(0f);
					if (func_297(Local_81.f_28[0]) && does_entity_exist(iLocal_85))
					{
						iLocal_87 = create_synchronized_scene(Local_88, Local_89, 2);
						task_synchronized_scene(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						play_synchronized_entity_anim(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
						func_246("Done Josh leadout anim on Josh exit state");
						force_entity_ai_and_animation_update(iLocal_85);
						force_ped_motion_state(Local_81.f_28[0], joaat("MotionState_Idle"), false, 1, true);
						iLocal_94 = 1;
					}
				}
			}
			...
			if (was_cutscene_skipped())
			{
				...
				if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
				{
					remove_model_hide(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false);
					set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, true, 0f, false);
				}
				if (does_object_of_type_exist_at_coords(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), false))
				{
					remove_model_hide(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), false);
					set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1101.62f, 290.36f, 64.76f, true, 0f, false);
				}
			}
			if (!is_cutscene_active())
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = create_synchronized_scene(Local_88, Local_89, 2);
						task_synchronized_scene(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						play_synchronized_entity_anim(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
						func_246("Done Josh leadout anim on non active cutscene");
						force_entity_ai_and_animation_update(iLocal_85);
						force_ped_ai_and_animation_update(Local_81.f_28[0], false, false);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
int func_248(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_249(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_250(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_263(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_269(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_268(player_ped_id(), -828834893))
				{
...
void func_271()
{
	...
	{
		case 0:
			if (!func_5(0) && is_entity_in_angled_area(player_ped_id(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, false, true, 0))
			{
				func_246("Doing setup for leadin");
				func_234(&uLocal_97, 2, player_ped_id(), "Trevor", 0, 1);
				func_234(&uLocal_97, 5, Local_81.f_28[0], "Josh", 0, 1);
				request_anim_dict("rcmjosh1leadinout");
				if (has_anim_dict_loaded("rcmjosh1leadinout"))
				{
					if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
					{
						set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, false);
					...
					iLocal_85 = get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
					func_251(1);
					request_cutscene_with_playback_list("JOSH_1_INT_CONCAT", 14, 8);
					iLocal_83 = 1;
				}
			}
			else
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (is_entity_in_angled_area(player_ped_id(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, false, true, 0))
					{
						if (func_297(Local_81.f_28[0]) && does_entity_exist(iLocal_85))
						{
							iLocal_86 = create_synchronized_scene(Local_88, Local_89, 2);
							task_synchronized_scene(Local_81.f_28[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1000f, 0);
							play_synchronized_entity_anim(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
							task_look_at_entity(player_ped_id(), Local_81.f_28[0], -1, 0, 2);
							task_look_at_entity(Local_81.f_28[0], player_ped_id(), 4000, 2060, 2);
					...
					else
					{
						if (!func_5(0) && !bLocal_90)
						{
							...
							remove_cutscene();
							request_cutscene_with_playback_list("JOSH_1_INT_CONCAT", 13, 8);
						}
						func_246("Replay in progress, skipping leadin");
						iLocal_83 = 2;
					}
				}
				else if (is_synchronized_scene_running(iLocal_86))
				{
					if (get_synchronized_scene_phase(iLocal_86) > 0.15f)
					{
						if (!iLocal_91)
						{
					...
					if (get_synchronized_scene_phase(iLocal_86) > 0.9f)
					{
						func_246("Leadin anim done, launch cutscene");
						iLocal_83 = 2;
					}
					if (func_218(player_ped_id(), Local_81.f_28[0], 1) <= 2.5f)
					{
...
void func_273()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_269(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_293(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_278(0)) || func_292(1))
			{
			}
			else
			{
...
int func_299(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 3:
			set_ped_paths_in_area(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_300(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		door_system_set_open_ratio(904342475, 0f, false, false);
	...
	if (bParam1)
	{
		door_system_set_open_ratio(-795418380, 0f, false, false);
		door_system_set_door_state(904342475, 4, false, true);
		iVar0++;
	}
	else
...
void func_302(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_303(iParam0);
...
int func_304(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_305(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_312()
{
	...
	set_ped_paths_in_area(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, true, 0);
	disable_navmesh_in_area(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, 0);
...
void func_326(bool bParam0)
{
	...
	if (!func_343())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_327(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_328(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_334())
	{
		...
		{
			iVar2 = func_329(get_this_script_name());
			if (iVar2 > -1)
			{
