...
void func_1()
{
	if (timerb() > 10000)
	{
		if (is_entity_at_coord(player_ped_id(), Local_47, 10f, 10f, 10f, false, true, 0) && !is_ped_in_any_vehicle(player_ped_id(), false))
		{
			settimerb(0);
			if (!is_entity_dead(iLocal_50, false))
			{
				if (iLocal_44 == 0)
				{
					...
					task_play_anim(0, "amb@drug_dealer", "beckon_03", 8f, -8f, -1, 0, 0f, false, false, false);
				...
				{
					task_turn_ped_to_face_entity(iLocal_50, iLocal_51, 0);
					if (iLocal_46 == 0)
					{
					}
					task_wander_standard(iLocal_51, 40000f, 0);
					iLocal_44 = 0;
				}
			}
		}
...
int func_3(int iParam0, struct<3> Param1, float fParam2, float fParam3, bool bParam4)
{
	...
	{
		if ((((is_entity_at_coord(player_ped_id(), get_offset_from_entity_in_world_coords(iParam0, Param1), Var1, false, true, 0) && is_ped_heading_towards_position(player_ped_id(), get_entity_coords(iParam0, true), fParam2)) && func_5(bParam4)) && !is_ped_ragdoll(iParam0)) && !is_ped_getting_up(iParam0))
		{
			func_4(iParam0, 1);
			return 1;
		}
...
void func_7()
{
	if (is_entity_at_coord(player_ped_id(), Local_47, 50f, 50f, 50f, false, true, 0))
	{
		...
		add_relationship_group("homeless", &iLocal_49);
		Local_48.f_2 = (Local_47.f_2 - 1f);
		iLocal_50 = create_ped(19, joaat("a_m_o_tramp_01"), Local_47.f_0, Local_47.f_1, Local_48.f_2, 0f, true, true);
		set_ped_relationship_group_hash(iLocal_50, iLocal_49);
		if (iLocal_44 == 1)
		{
			Local_48 = { get_offset_from_entity_in_world_coords(iLocal_50, 0.8f, 0.8f, -1f) };
			iLocal_51 = create_ped(5, joaat("g_m_y_strpunk_01"), Local_48, 0f, true, true);
			add_relationship_group("homeless", &iLocal_49);
			set_ped_relationship_group_hash(iLocal_51, iLocal_49);
			if (!is_entity_dead(iLocal_50, false))
			{
				open_sequence_task(&iLocal_53);
				task_turn_ped_to_face_coord(0, Local_48, 0);
				task_play_anim(0, "amb@drug_dealer", "beckon_01", 8f, -8f, -1, 0, 0f, false, false, false);
				close_sequence_task(iLocal_53);
				task_perform_sequence(iLocal_50, iLocal_53);
				clear_sequence_task(&iLocal_53);
			}
			...
			{
				open_sequence_task(&iLocal_53);
				task_turn_ped_to_face_coord(0, Local_47, 0);
				task_play_anim(0, "amb@drug_dealer", "beckon_02", 8f, -8f, -1, 0, 0f, false, false, false);
				close_sequence_task(iLocal_53);
				task_perform_sequence(iLocal_51, iLocal_53);
				clear_sequence_task(&iLocal_53);
			}
		}
		iLocal_45 = 1;
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_18()) || Global_31962) || func_17()) || func_16(8, -1)) || func_13()) || func_15()) || func_14()) || func_12()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_18()) || Global_112433) || Global_31962) || func_17()) || func_16(8, -1)) || func_13()) || func_15()) || func_14()) || func_12()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_18()) || Global_112433) || Global_31962) || func_17()) || func_16(8, -1)) || func_15()) || func_14()) || func_12()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_18() || get_player_wanted_level(player_id()) > 0) || func_16(8, -1)) || func_12()) || func_11()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_18()) || func_14()) || Global_112433) || Global_31962) || func_17()) || Global_44238) || func_16(8, -1)) || func_13()) || func_11()) || func_12()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
