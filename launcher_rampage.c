		...
		if (iLocal_241 != -1)
		{
			if (!func_222())
			{
				*uParam0 = func_221(iLocal_241);
				...
				set_bit(&(Global_113386.f_18574[*uParam0 /*6*/]), 0);
				set_bit(&(Global_113386.f_18574[*uParam0 /*6*/]), 2);
				clear_bit(&(Global_113386.f_18574[*uParam0 /*6*/]), 3);
				...
				{
					func_4(500, 1);
					clear_area(Param1, uParam0->f_15, true, false, false, false);
...
void func_28(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_229();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_58())
		{
			func_51(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_37(bParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_59()
{
	...
	{
		if (func_49(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_61(int iParam0, bool bParam1)
{
	...
	bVar0 = func_48(iParam0);
	if (func_39(bVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
...
void func_62(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_67(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_64(Var7.f_1)) && iVar9 < 51)
			{
...
int func_73(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_96())
		{
			*uParam0 = func_79(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_79(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_95(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_80(iVar0, 0), true);
...
var func_97()
{
	...
	func_107(&uVar0, get_clock_seconds());
	func_106(&uVar0, get_clock_minutes());
	func_105(&uVar0, get_clock_hours());
	func_100(&uVar0, get_clock_day_of_month());
	func_99(&uVar0, get_clock_month());
	func_98(&uVar0, get_clock_year());
	return uVar0;
}
...
void func_108(int iParam0)
{
	...
	if (is_xbox360_version() || func_110())
	{
		uVar0 = iParam0;
		network_set_rich_presence(9, &uVar0, 1, 1);
	}
	else if (is_ps3_version() || func_109())
	{
...
void func_111(char* sParam0, int iParam1, int iParam2)
{
	...
	playstats_mission_started(sParam0, iParam1, iParam2, func_219(0));
}
...
void func_137(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_141(player_id())) && !func_139(player_id(), 0)) && !func_138()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_141(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_151(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_130(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_153(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_152(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_153(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_152(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_72(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_159(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_163(int iParam0, float fParam1)
{
	...
	if (func_130(player_ped_id()) && func_130(iParam0))
	{
		if (func_174(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_165(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_166(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_169(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_171(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_171(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_178(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_171(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_188()
{
	return func_189(get_this_script_name(), 0);
}
...
void func_194()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_195(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_222()
{
	...
	else if ((func_225(0) || is_player_switch_in_progress()) || func_224())
	{
		if (func_2("RAMP_HELP_TRIG"))
		{
			if (func_225(0))
...
int func_228(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		if (get_distance_between_coords(Var2, Var1, true) <= fParam0 && absf((Var2.f_2 - Var1.f_2)) < 1.5f)
		{
			return iVar0;
		}
		iVar0++;
...
void func_230(var* uParam0, struct<3> Param1)
{
	...
	while (true)
	{
		...
		if (*uParam0 == 52 || *uParam0 == 53)
		{
			...
			{
				if (is_explosion_in_sphere(-1, get_entity_coords(uParam0->f_28[0], true), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar2 = 0;
						while (iVar2 < uParam0->f_41)
						{
							...
							{
								if ((func_130(uParam0->f_28[0]) && is_entity_attached_to_entity(uParam0->f_41[iVar2], uParam0->f_28[0])) || (func_130(uParam0->f_28[1]) && is_entity_attached_to_entity(uParam0->f_41[iVar2], uParam0->f_28[1])))
								{
									delete_object(&(uParam0->f_41[iVar2]));
								}
							}
							iVar2++;
						}
					}
					set_ped_to_ragdoll(uParam0->f_28[0], 100, 500, 0, true, true, false);
					apply_damage_to_ped(uParam0->f_28[0], 1000, true, 0);
					if (func_130(uParam0->f_28[1]))
					{
						set_ped_to_ragdoll(uParam0->f_28[1], 100, 500, 0, true, true, false);
						apply_damage_to_ped(uParam0->f_28[1], 1000, true, 0);
					}
			...
			if (func_130(uParam0->f_28[1]))
			{
				if (is_explosion_in_sphere(-1, get_entity_coords(uParam0->f_28[1], true), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar2 = 0;
		...
		Local_249 = { get_entity_coords(player_ped_id(), true) };
...
void func_231(var* uParam0)
{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			if (func_130(uParam0->f_28[0]))
			{
				if (func_246(uParam0->f_28[0], player_ped_id(), 1) < 30f && is_entity_on_screen(uParam0->f_28[0]))
				{
		...
		case 2:
			iLocal_71[0] = create_synchronized_scene(Local_66, Local_67, 2);
			if (func_130(uParam0->f_28[0]))
			{
				func_232(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_1", 7, 0, 0);
				task_synchronized_scene(uParam0->f_28[0], iLocal_71[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1000f, 0);
			}
			set_synchronized_scene_looped(iLocal_71[0], false);
			set_synchronized_scene_hold_last_frame(iLocal_71[0], true);
			iLocal_70++;
			break;
		
		case 3:
			if (is_synchronized_scene_running(iLocal_71[0]))
			{
				if (get_synchronized_scene_phase(iLocal_71[0]) >= 0.95f)
				{
					iLocal_70++;
				}
			}
		...
		case 4:
			iLocal_71[1] = create_synchronized_scene(Local_66, Local_67, 2);
			if (func_130(uParam0->f_28[0]))
			{
				func_232(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_2", 7, 0, 0);
				task_synchronized_scene(uParam0->f_28[0], iLocal_71[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1000f, 0);
			}
			set_synchronized_scene_looped(iLocal_71[1], false);
			set_synchronized_scene_hold_last_frame(iLocal_71[1], true);
			iLocal_70++;
			break;
		
		case 5:
			if (is_synchronized_scene_running(iLocal_71[1]))
			{
				if (get_synchronized_scene_phase(iLocal_71[1]) >= 0.95f)
				{
					iLocal_70++;
				}
			}
		...
		case 6:
			iLocal_71[2] = create_synchronized_scene(Local_66, Local_67, 2);
			if (func_130(uParam0->f_28[0]))
			{
				task_synchronized_scene(uParam0->f_28[0], iLocal_71[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1000f, 0);
			}
			set_synchronized_scene_looped(iLocal_71[2], true);
			set_synchronized_scene_hold_last_frame(iLocal_71[2], false);
			iLocal_70++;
			break;
...
int func_247(var* uParam0)
{
	...
	if (iLocal_69 < 0)
	{
		if (vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(uParam0->f_28[1], true)) < 25f)
		{
			return 1;
		}
		switch (*uParam0)
		{
			case 52:
				set_gameplay_entity_hint(uParam0->f_28[0], 0.1f, 0f, 0.9f, true, -1, 2500, 2000, 0);
				task_look_at_entity(player_ped_id(), uParam0->f_28[0], -1, 0, 2);
				_set_gameplay_hint_anim_closeup(true);
				set_gameplay_hint_base_orbit_pitch_offset(-5f);
				_set_gameplay_hint_anim_offsetx(0.1f);
				_set_gameplay_hint_anim_offsety(0f);
				set_gameplay_hint_follow_distance_scalar(0.3f);
				set_gameplay_hint_fov(40f);
				break;
			
			case 54:
				set_gameplay_entity_hint(uParam0->f_28[0], 0f, -0.1f, 0.9f, true, -1, 2500, 2000, 0);
				task_look_at_entity(player_ped_id(), uParam0->f_28[0], -1, 0, 2);
				_set_gameplay_hint_anim_closeup(true);
				set_gameplay_hint_base_orbit_pitch_offset(-10f);
				_set_gameplay_hint_anim_offsetx(-0.9f);
				_set_gameplay_hint_anim_offsety(0f);
				set_gameplay_hint_follow_distance_scalar(0.35f);
				set_gameplay_hint_fov(40f);
				break;
			
			case 55:
				set_gameplay_entity_hint(uParam0->f_28[1], 0f, 0f, 0.9f, true, -1, 2500, 2000, 0);
				task_look_at_entity(player_ped_id(), uParam0->f_28[1], -1, 0, 2);
				_set_gameplay_hint_anim_closeup(true);
				set_gameplay_hint_base_orbit_pitch_offset(-8f);
				_set_gameplay_hint_anim_offsetx(-0.9f);
				_set_gameplay_hint_anim_offsety(0.1f);
				set_gameplay_hint_follow_distance_scalar(0.35f);
				set_gameplay_hint_fov(40f);
				break;
			
			case 56:
				set_gameplay_entity_hint(uParam0->f_28[1], 0f, 0f, 0f, true, -1, 2500, 2000, 0);
				task_look_at_entity(player_ped_id(), uParam0->f_28[1], -1, 0, 2);
				_set_gameplay_hint_anim_closeup(true);
				set_gameplay_hint_base_orbit_pitch_offset(-5f);
				_set_gameplay_hint_anim_offsetx(0.15f);
				_set_gameplay_hint_anim_offsety(0f);
				set_gameplay_hint_follow_distance_scalar(0.3f);
				set_gameplay_hint_fov(40f);
				break;
		}
		iLocal_69 = get_game_timer() + 2500;
	}
	else if (get_game_timer() > iLocal_69)
	{
		iLocal_69 = -1;
		return 1;
	}
		...
		case 1:
			if (func_130(uParam0->f_28[0]))
			{
				if (!func_149())
				{
					...
					{
						iLocal_238 = create_synchronized_scene(Local_66, Local_67, 2);
						task_synchronized_scene(uParam0->f_28[0], iLocal_238, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1000f, 0);
						set_gameplay_entity_hint(uParam0->f_28[0], 0f, 0f, 0.5f, true, -1, 2500, 2000, 0);
						task_look_at_entity(player_ped_id(), uParam0->f_28[0], -1, 0, 2);
						_set_gameplay_hint_anim_closeup(true);
						set_gameplay_hint_base_orbit_pitch_offset(0f);
						_set_gameplay_hint_anim_offsetx(0.1f);
						_set_gameplay_hint_anim_offsety(0f);
						set_gameplay_hint_follow_distance_scalar(0.35f);
						set_gameplay_hint_fov(40f);
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_130(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_224()) || Global_31962) || func_262()) || func_243(8, -1)) || func_260()) || func_96()) || func_261()) || func_259()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_224()) || Global_112433) || Global_31962) || func_262()) || func_243(8, -1)) || func_96()) || func_261()) || func_259()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_224() || get_player_wanted_level(player_id()) > 0) || func_243(8, -1)) || func_259()) || func_258()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
		...
		switch (*uParam0)
		{
			case 52:
				if (func_130(uParam0->f_28[0]))
				{
					...
					set_cutscene_ped_component_variation_from_ped((*uParam1)[0], uParam0->f_28[0], 0);
				}
				if (func_130(uParam0->f_28[1]))
				{
					(*uParam1)[1] = "Nervous_WhiteTrash";
					set_cutscene_ped_component_variation_from_ped((*uParam1)[1], uParam0->f_28[1], 0);
				}
				break;
			...
			case 54:
				if (func_130(uParam0->f_28[0]))
				{
					...
					set_cutscene_ped_component_variation_from_ped((*uParam1)[0], uParam0->f_28[0], 0);
					set_cutscene_ped_component_variation((*uParam1)[0], 8, 1, 0, 0);
				}
				if (func_130(uParam0->f_28[1]))
				{
			...
			case 55:
				if (func_130(uParam0->f_28[0]))
				{
					(*uParam1)[0] = "Thug";
					set_cutscene_ped_component_variation_from_ped((*uParam1)[0], uParam0->f_28[0], 0);
					set_cutscene_ped_component_variation((*uParam1)[0], 10, 0, 1, 0);
				}
				if (func_130(uParam0->f_28[1]))
				{
					(*uParam1)[1] = "Armed_Thug";
					set_cutscene_ped_component_variation_from_ped((*uParam1)[1], uParam0->f_28[1], 0);
					set_cutscene_ped_component_variation((*uParam1)[1], 10, 1, 0, 0);
				}
				break;
...
void func_264(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_268(player_ped_id(), Param2, 1) <= 100f)
				{
					func_267(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_268(player_ped_id(), Param2, 1) > 120f)
				{
					func_270(iParam0);
				}
			}
...
float func_268(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
void func_274(var uParam0)
{
	if (*uParam0 == 52)
	{
		...
		if (does_entity_exist(uParam0->f_41[4]))
		{
...
int func_275(var uParam0)
{
	...
	{
		if (_0x5407B7288D0478B7(player_ped_id()) > 0)
		{
			return 1;
		}
	}
...
void func_277(var uParam0)
{
	...
	while ((!has_model_loaded(iVar1) || !has_model_loaded(iVar2)) || !has_anim_dict_loaded(sVar0))
	{
		wait(0);
	}
	...
	task_play_anim(uParam0->f_28[0], sVar0, "marines_idle_a", 8f, -8f, -1, 1, 0f, false, false, false);
	set_ped_component_variation(uParam0->f_28[0], 0, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 1, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 2, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 3, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 4, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 5, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 6, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 7, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 8, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 9, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 10, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 11, 0, 0, 0);
	clear_ped_prop(uParam0->f_28[0], 0);
	clear_ped_prop(uParam0->f_28[0], 1);
	...
	set_ped_component_variation(uParam0->f_28[1], 1, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 2, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 3, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 4, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 5, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 6, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 7, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 8, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 9, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 10, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 11, 0, 0, 0);
	clear_ped_prop(uParam0->f_28[1], 0);
	clear_ped_prop(uParam0->f_28[1], 1);
	...
	task_play_anim(uParam0->f_28[1], sVar0, "marines_idle_b", 8f, -8f, -1, 1, 0f, false, false, false);
	...
	{
		set_entity_collision(uParam0->f_41[0], false, false);
		set_entity_coords(uParam0->f_41[0], -1297.84f, 2505.91f, 19.34f, true, false, false, true);
		set_entity_heading(uParam0->f_41[0], func_335(-0.5f));
...
int func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	...
	request_model(iVar0);
	iVar2 = get_game_timer() + 10000;
	while (get_game_timer() < iVar2)
	{
		if (has_model_loaded(iVar0))
		{
			*iParam0 = create_weapon_object(iParam1, -1, Param2, true, 1f, 0, 0, 1);
			set_model_as_no_longer_needed(iVar0);
			if (func_334(&uVar1, iParam1, joaat("gun_root")))
			{
				if (has_weapon_got_weapon_component(*iParam0, func_279(&uVar1, iParam1, joaat("gun_root"), 0)))
				{
					remove_weapon_component_from_weapon_object(*iParam0, func_279(&uVar1, iParam1, joaat("gun_root"), 0));
				}
				else if (has_weapon_got_weapon_component(*iParam0, func_279(&uVar1, iParam1, joaat("gun_root"), 1)))
				{
					remove_weapon_component_from_weapon_object(*iParam0, func_279(&uVar1, iParam1, joaat("gun_root"), 1));
				}
			}
			if (does_entity_exist(*iParam0))
			{
...
bool func_280(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		...
		default:
			...
			{
				iVar13 = 0;
				while (iVar13 < get_num_dlc_weapon_components(iVar12))
				{
					if (get_dlc_weapon_component_data(iVar12, iVar13, &Var16))
					{
...
int func_281(int iParam0, int iParam1)
{
		...
		switch (iParam0)
		{
			...
			default:
				...
				if (iVar2 != -1)
				{
					...
					{
						if (get_dlc_weapon_component_data(iVar2, iVar3, &Var5))
						{
							if (!func_63(Var5.f_3))
							{
								if (Var5.f_3 == iParam1)
		...
		switch (iParam0)
		{
			...
			case joaat("weapon_advancedrifle"):
				switch (iParam1)
				{
					...
					case joaat("component_advancedrifle_clip_02"):
						iVar0 = 9925;
						iVar0 = floor((to_float(iVar0) * Global_262145.f_2904));
						break;
			...
			case joaat("weapon_assaultshotgun"):
				switch (iParam1)
				{
					...
					case joaat("component_assaultshotgun_clip_02"):
						iVar0 = 9625;
						iVar0 = floor((to_float(iVar0) * Global_262145.f_2908));
						break;
			...
			case joaat("weapon_grenadelauncher"):
				switch (iParam1)
				{
					...
					case joaat("component_at_ar_flsh"):
						iVar0 = 2500;
						iVar0 = floor((to_float(iVar0) * Global_262145.f_4400));
						break;
			...
			case joaat("weapon_knuckle"):
				switch (iParam1)
				{
					case joaat("component_knuckle_varmod_pimp"):
						...
						iVar0 = floor((to_float(iVar0) * Global_262145.f_4432));
						break;
			...
			case joaat("weapon_machinepistol"):
				switch (iParam1)
				{
					...
					case joaat("component_machinepistol_clip_02"):
						...
						iVar0 = floor((to_float(iVar0) * Global_262145.f_4442));
						break;
			...
			default:
				...
				{
					iVar7 = 0;
					while (iVar7 < get_num_dlc_weapon_components(iVar6))
					{
						if (get_dlc_weapon_component_data(iVar6, iVar7, &Var9))
						{
							if (!func_63(Var9.f_3))
							{
								if (Var9.f_3 == iParam1)
	...
	if (network_is_game_in_progress() && func_316())
	{
		StringCopy(&Var11, func_314(iParam1, iParam0), 16);
		func_309(&sVar10, Var11, get_entity_model(player_ped_id()), 3, 1, func_312(iParam0), func_311(iParam0), -1, 0, 0);
		if (_net_gameserver_catalog_item_exists(&sVar10))
		{
			iVar0 = net_gameserver_get_price(get_hash_key(&sVar10), 1671640801, true);
		}
	}
	if (iVar0 > 0)
	{
	...
	if (network_is_game_in_progress())
	{
		if (iLocal_64 == 1)
		{
			*iParam1 = floor((to_float(*iParam1) * Global_262145.f_77));
			fVar1 = (fVar1 + (to_float(Global_262145.f_132) / 100f));
		}
		if (iLocal_64 == 0)
		{
			*iParam1 = floor((to_float(*iParam1) * Global_262145.f_77));
...
struct<7> func_301(int iParam0)
{
	...
	iVar0 = iParam0;
	if (stat_get_date(iVar0, &Var2, 7, -1))
	{
		return Var2;
	}
	return Var1;
...
void func_309(char* sParam0, char[8] cParam1, char[4] cParam2, char[4] cParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
		...
		default:
			if (iParam1 != 0)
			{
				...
				if (iVar0 != -1)
				{
					...
					{
						if (get_dlc_weapon_component_data(iVar0, iVar1, &Var3))
						{
							if (Var3.f_3 == iParam0)
							{
...
int func_316()
{
	if (network_is_game_in_progress() && func_317())
	{
		return 1;
	}
	return 0;
...
int func_337(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	if (does_entity_exist(*iParam0))
	{
...
int func_339(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	if (does_entity_exist(*iParam0))
	{
		delete_ped(iParam0);
...
int func_341()
{
	return add_scenario_blocking_area(-177.0628f, -1679.715f, 33.16263f, -157.0628f, -1659.715f, 37.16263f, false, true, true, true);
}
...
void func_342(var uParam0)
{
	...
	while (!has_model_loaded(iVar0) || !has_anim_dict_loaded(sVar1))
	{
		wait(0);
	}
	...
	set_ped_component_variation(uParam0->f_28[0], 0, 1, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 1, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 2, 0, 0, 0);
	...
	set_ped_component_variation(uParam0->f_28[0], 8, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 9, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[0], 10, 0, 1, 0);
	set_ped_component_variation(uParam0->f_28[0], 11, 0, 0, 0);
	task_play_anim(uParam0->f_28[0], sVar1, "thugs_idle_b", 8f, -8f, -1, 1, 0f, false, false, false);
	...
	set_ped_component_variation(uParam0->f_28[1], 1, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 2, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 3, 1, 1, 0);
	set_ped_component_variation(uParam0->f_28[1], 4, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 5, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 6, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 7, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 8, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 9, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 10, 1, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 11, 0, 0, 0);
	give_weapon_to_ped(uParam0->f_28[1], joaat("weapon_assaultrifle"), 100, true, true);
	task_play_anim(uParam0->f_28[1], sVar1, "thugs_idle_a", 8f, -8f, -1, 1, 0f, false, false, false);
...
void func_343(var uParam0)
{
	...
	while ((!has_model_loaded(iVar0) || !has_weapon_asset_loaded(joaat("weapon_microsmg"))) || !has_anim_dict_loaded(sVar1))
	{
		wait(0);
	}
	...
	set_ped_component_variation(uParam0->f_28[0], 11, 0, 0, 0);
	set_ped_name_debug(uParam0->f_28[0], "RAMP:PED 0");
	task_play_anim(uParam0->f_28[0], sVar1, "mexicans_idle_a", 8f, -8f, -1, 1, 0f, false, false, false);
	...
	set_ped_component_variation(uParam0->f_28[1], 1, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 2, 0, 0, 0);
	set_ped_component_variation(uParam0->f_28[1], 3, 1, 0, 0);
	...
	set_ped_component_variation(uParam0->f_28[1], 11, 0, 0, 0);
	set_ped_name_debug(uParam0->f_28[1], "RAMP:PED 1");
	task_play_anim(uParam0->f_28[1], sVar1, "mexicans_idle_b", 8f, -8f, -1, 1, 0f, false, false, false);
...
void func_346(var uParam0)
{
	...
	func_350(&uLocal_68);
	while ((((!has_model_loaded(iVar0) || !has_model_loaded(iVar1)) || !has_model_loaded(iVar2)) || !has_anim_dict_loaded(sVar3)) || !func_349(&uLocal_68))
	{
		wait(0);
	}
	clear_area_of_objects(1180.021f, -401.7374f, 66.8767f, 0.75f, 0);
	uParam0->f_41[2] = get_closest_object_of_type(1179.778f, -401.7374f, 66.8697f, 1f, joaat("prop_chair_01a"), true, false, true);
	if (does_entity_exist(uParam0->f_41[2]))
	{
		set_entity_coords(uParam0->f_41[2], 1180.05f, -401.83f, 66.88f, true, false, false, true);
		set_entity_rotation(uParam0->f_41[2], 0f, 0f, 50f, 2, true);
		freeze_entity_position(uParam0->f_41[2], true);
	}
	uParam0->f_41[3] = get_closest_object_of_type(1181.243f, -402.5309f, 67.2564f, 1f, joaat("prop_table_01"), true, false, true);
	if (does_entity_exist(uParam0->f_41[3]))
	{
		freeze_entity_position(uParam0->f_41[3], true);
	}
	...
	attach_entity_to_entity(uParam0->f_41[1], uParam0->f_28[0], get_ped_bone_index(uParam0->f_28[0], iVar4), Var6, Var5, true, false, false, false, 2, true, 0);
	func_347(&uLocal_68, 0, 3);
	if (!is_synchronized_scene_running(uParam0->f_59))
	{
		uParam0->f_59 = create_synchronized_scene(Local_66, Local_67, 2);
		if (func_130(uParam0->f_28[0]))
		{
...
void func_347(var uParam0, bool bParam1, int iParam2)
{
	...
	if (has_scaleform_movie_loaded(*uParam0))
	{
		...
		else
		{
			...
			{
				register_named_rendertarget("npcphone", false);
				link_named_rendertarget(joaat("prop_npc_phone"));
			}
			iVar0 = get_named_rendertarget_render_id("npcphone");
		}
		set_text_render_id(iVar0);
		begin_scaleform_movie_method(*uParam0, "DISPLAY_VIEW");
		scaleform_movie_method_add_param_int(iParam2);
		end_scaleform_movie_method();
		draw_scaleform_movie(*uParam0, Global_20186, Global_20187, Global_20188, Global_20189, 255, 255, 255, 255, 0);
	}
}

void func_348(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_156(iParam0);
...
{
	*uParam0 = request_scaleform_movie(func_351());
}
...
void func_353(var uParam0)
{
	...
	request_anim_dict(sVar1);
	request_weapon_asset(joaat("weapon_assaultrifle"), 31, 0);
	while ((((!has_model_loaded(iVar5) || !has_model_loaded(iVar6)) || !has_model_loaded(iVar7)) || !has_anim_dict_loaded(sVar1)) || !has_weapon_asset_loaded(joaat("weapon_assaultrifle")))
	{
		wait(0);
	}
	...
	if (func_130(uParam0->f_28[0]))
	{
		...
		set_ped_component_variation(uParam0->f_28[0], 10, 0, 0, 0);
		set_ped_component_variation(uParam0->f_28[0], 11, 0, 0, 0);
		Var0 = { get_ped_bone_coords(uParam0->f_28[0], iVar2, 0f, 0f, 0f) };
		set_ped_name_debug(uParam0->f_28[0], "RAMP:PED 0");
		func_348(&(uParam0->f_41[1]), iVar7, Var0, 0f);
		attach_entity_to_entity(uParam0->f_41[1], uParam0->f_28[0], get_ped_bone_index(uParam0->f_28[0], iVar2), Var4, Var3, true, true, false, false, 2, true, 0);
		set_activate_object_physics_as_soon_as_it_is_unfrozen(uParam0->f_41[1], true);
		freeze_entity_position(uParam0->f_28[0], true);
	...
	if (func_130(uParam0->f_28[1]))
	{
		set_ped_component_variation(uParam0->f_28[1], 0, 1, 0, 0);
		set_ped_component_variation(uParam0->f_28[1], 1, 0, 0, 0);
		set_ped_component_variation(uParam0->f_28[1], 2, 1, 0, 0);
		set_ped_component_variation(uParam0->f_28[1], 3, 1, 0, 0);
		...
		set_ped_component_variation(uParam0->f_28[1], 10, 0, 0, 0);
		set_ped_component_variation(uParam0->f_28[1], 11, 0, 0, 0);
		Var0 = { get_ped_bone_coords(uParam0->f_28[1], iVar2, 0f, 0f, 0f) };
		set_ped_name_debug(uParam0->f_28[1], "RAMP:PED 1");
		func_348(&(uParam0->f_41[2]), iVar7, Var0, 0f);
		attach_entity_to_entity(uParam0->f_41[2], uParam0->f_28[1], get_ped_bone_index(uParam0->f_28[1], iVar2), Var4, Var3, true, true, false, false, 2, true, 0);
		set_activate_object_physics_as_soon_as_it_is_unfrozen(uParam0->f_41[2], true);
		freeze_entity_position(uParam0->f_28[1], true);
		set_ped_config_flag(uParam0->f_28[1], 208, true);
		set_ped_relationship_group_hash(uParam0->f_28[1], joaat("player"));
	}
	uParam0->f_41[3] = get_closest_object_of_type(909.3884f, 3643.652f, 31.699f, 1f, joaat("prop_table_03b_chr"), true, false, true);
	if (does_entity_exist(uParam0->f_41[3]))
	{
		freeze_entity_position(uParam0->f_41[3], true);
	}
	uParam0->f_41[4] = get_closest_object_of_type(908.0437f, 3643.682f, 31.7073f, 1f, joaat("prop_table_03b_chr"), true, false, true);
	if (does_entity_exist(uParam0->f_41[4]))
	{
		freeze_entity_position(uParam0->f_41[4], true);
	}
	if (!is_synchronized_scene_running(uParam0->f_59))
	{
		uParam0->f_59 = create_synchronized_scene(910.13f, 3643.74f, 31.69f, 0f, 0f, func_335(-0.26f), 2);
		if (func_130(uParam0->f_28[0]))
		{
			task_synchronized_scene(uParam0->f_28[0], uParam0->f_59, sVar1, "redneck_idle_a", 8f, -8f, 513, 0, 1000f, 0);
		}
		if (func_130(uParam0->f_28[1]))
		{
			task_synchronized_scene(uParam0->f_28[1], uParam0->f_59, sVar1, "redneck_idle_b", 8f, -8f, 513, 0, 1000f, 0);
		}
		set_synchronized_scene_looped(uParam0->f_59, true);
	}
	...
	set_model_as_no_longer_needed(iVar5);
...
void func_360(var* uParam0, bool bParam1)
{
	...
	if (iLocal_250 != 0)
	{
		...
		{
			remove_scenario_blocking_area(iLocal_250, false);
		}
	}
	if (is_gameplay_hint_active())
	{
