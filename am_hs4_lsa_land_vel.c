			...
			if (does_entity_exist(iVar2))
			{
				...
				else if (bParam2)
				{
					if (is_ped_a_player(iVar2))
					{
						...
						if (((!is_ped_injured(iVar2) && iVar3 != func_62()) && func_7(iVar3, 1, 1)) || iParam8)
						{
...
int func_67(var uParam0)
{
	...
	request_model(func_68());
	if (!has_model_loaded(func_68()))
	{
		return 0;
	}
	uParam0->f_22 = create_ped(4, func_68(), uParam0->f_9, 0f, false, false);
...
void func_76(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam0, false))
	{
		if ((network_is_game_in_progress() && network_has_control_of_entity(iParam0)) || !network_is_game_in_progress())
		{
			...
			if (func_129(get_entity_model(iParam0)))
			{
				if (uParam1->f_9[44] == 2)
				{
			...
			if ((!func_83(4) && !bParam4) && !network_is_activity_session())
			{
				func_80(iParam0);
			}
			if (func_79(iVar0))
			...
			if (func_78(get_entity_model(iParam0)))
			{
				switch (uParam1->f_9[5])
				{
					case 1:
			...
			switch (uParam1->f_94)
			{
				...
				case 2:
					...
					{
						if (func_77(uParam1->f_81) && network_is_gamer_in_my_session(&(uParam1->f_81)))
						{
...
void func_81(struct<3> Param0)
{
	...
	_trigger_script_event_2(1, &Var0, 5, func_82(1, 1));
}
...
bool func_96(var uParam0, bool bParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)
{
...
int func_100(int iParam0)
{
	if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam0, false))
	{
		if (does_vehicle_have_crew_emblem(iParam0, 0) || func_101(iParam0))
		{
			return 1;
		}
	}
...
int func_102(int iParam0, var* uParam1)
{
	...
	if (((((((!(does_entity_exist(iParam0) && !is_entity_dead(iParam0, false)) || !network_has_control_of_entity(iParam0)) || !network_check_user_content_privileges(0, -1, true)) || !((network_is_handle_valid(uParam1, 13) && network_clan_service_is_valid()) && network_clan_player_is_active(uParam1))) || iVar0 == func_62()) || !func_7(iVar0, 0, 0)) || !bVar1) || func_103(iParam0))
	{
		return 0;
	}
	return 1;
...
{
	return func_110(player_id(), bParam0);
}
...
int func_124(int iParam0, int iParam1, int iParam2)
{
	...
	if ((network_is_game_in_progress() && func_125()) && Global_1576214)
	{
...
void func_130(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_150(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_150(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_150(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_150(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_150(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_150(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_150(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_150(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_131() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
int func_137(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_141(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_140(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_140(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_139(iParam0);
	if (func_138(*iParam0))
	{
...
void func_155(var uParam0)
{
	...
	if (!uParam0->f_15)
	{
		if (!new_load_scene_start(uParam0->f_9, func_156(uParam0->f_12), 4000f, 0))
		{
			return;
		}
		else
...
int func_157(var uParam0)
{
	...
	if (iVar0 == player_id())
	{
		uParam0->f_23 = _clone_ped_ex(func_269(), false, false, true, true);
		if (!does_entity_exist(uParam0->f_23))
		{
			return 0;
		}
	...
	{
		uParam0->f_23 = _clone_ped_ex(func_269(), false, false, false, false);
		if (!does_entity_exist(uParam0->f_23))
		{
			return 0;
		}
...
int func_160(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (iParam4 == 0)
	{
		...
		iParam4 = get_hash_key(func_165(iVar1));
	}
...
bool func_167(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, round((to_float(20000) * Global_262145.f_2916)), 0);
					break;
				
				case 1:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, round((to_float(1400) * Global_262145.f_2917)), 2);
					break;
				
				case 2:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, round((to_float(9750) * Global_262145.f_2918)), 3);
					break;
				
				case 3:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, round((to_float(2150) * Global_262145.f_2919)), 0);
					break;
				
				case 4:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, round((to_float(10000) * Global_262145.f_2920)), 0);
					break;
				
				case 54:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, round((to_float(12400) * Global_262145.f_2921)), 1);
					break;
				
				case 5:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, round((to_float(3500) * Global_262145.f_2922)), 0);
					break;
				
				case 6:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, round((to_float(4950) * Global_262145.f_2923)), 2);
					break;
				
				case 55:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, round((to_float(1350) * Global_262145.f_2924)), 1);
					break;
				
				case 7:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, round((to_float(1450) * Global_262145.f_2925)), 0);
					break;
				
				case 8:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, round((to_float(2700) * Global_262145.f_2926)), 7);
					break;
				
				case 9:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, round((to_float(1200) * Global_262145.f_2927)), 0);
					break;
				
				case 10:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, round((to_float(1500) * Global_262145.f_2928)), 0);
					break;
				
				case 11:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, round((to_float(2650) * Global_262145.f_2929)), 0);
					break;
				
				case 56:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, round((to_float(1900) * Global_262145.f_2930)), 1);
					break;
				
				case 12:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, round((to_float(4950) * Global_262145.f_2931)), 2);
					break;
				
				case 57:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, round((to_float(2400) * Global_262145.f_2932)), 1);
					break;
				
				case 58:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, round((to_float(5100) * Global_262145.f_2933)), 1);
					break;
				
				case 59:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, round((to_float(7400) * Global_262145.f_2934)), 1);
					break;
				
				case 60:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, round((to_float(10000) * Global_262145.f_2935)), 1);
					break;
				
				case 17:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, round((to_float(2400) * Global_262145.f_2940)), 2);
					break;
				
				case 18:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, round((to_float(5100) * Global_262145.f_2941)), 2);
					break;
				
				case 19:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, round((to_float(3600) * Global_262145.f_2942)), 2);
					break;
				
				case 20:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, round((to_float(10000) * Global_262145.f_2943)), 3);
					break;
				
				case 21:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, round((to_float(12500) * Global_262145.f_2944)), 3);
					break;
				
				case 22:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, round((to_float(10000) * Global_262145.f_2945)), 3);
					break;
				
				case 23:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, round((to_float(5000) * Global_262145.f_2946)), 3);
					break;
				
				case 24:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, round((to_float(7500) * Global_262145.f_2947)), 3);
					break;
				
				case 25:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, round((to_float(3750) * Global_262145.f_2948)), 2);
					break;
				
				case 26:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, round((to_float(3750) * Global_262145.f_2949)), 3);
					break;
				
				case 27:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, round((to_float(4800) * Global_262145.f_2950)), 3);
					break;
				
				case 28:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, round((to_float(3500) * Global_262145.f_2951)), 3);
					break;
				
				case 61:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, round((to_float(12350) * Global_262145.f_2952)), 1);
					break;
				
				case 62:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, round((to_float(1900) * Global_262145.f_2953)), 1);
					break;
				
				case 63:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, round((to_float(4500) * Global_262145.f_2954)), 1);
					break;
				
				case 64:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, round((to_float(12250) * Global_262145.f_2955)), 1);
					break;
				
				case 65:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, round((to_float(12300) * Global_262145.f_2956)), 1);
					break;
				
				case 29:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, round((to_float(2500) * Global_262145.f_2957)), 0);
					break;
				
				case 30:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, round((to_float(10000) * Global_262145.f_2958)), 0);
					break;
				
				case 31:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, round((to_float(10000) * Global_262145.f_2959)), 0);
					break;
				
				case 66:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, round((to_float(7500) * Global_262145.f_2960)), 1);
					break;
				
				case 32:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, round((to_float(5000) * Global_262145.f_2961)), 2);
					break;
				
				case 33:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, round((to_float(7300) * Global_262145.f_2962)), 3);
					break;
				
				case 34:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, round((to_float(7250) * Global_262145.f_2963)), 2);
					break;
				
				case 35:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, round((to_float(11900) * Global_262145.f_2964)), 0);
					break;
				
				case 36:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, round((to_float(2750) * Global_262145.f_2965)), 0);
					break;
				
				case 37:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, round((to_float(1750) * Global_262145.f_2966)), 0);
					break;
				
				case 38:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, round((to_float(7300) * Global_262145.f_2967)), 3);
					break;
				
				case 39:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, round((to_float(3250) * Global_262145.f_2968)), 2);
					break;
				
				case 40:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, round((to_float(1000) * Global_262145.f_2969)), 0);
					break;
				
				case 67:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, round((to_float(5000) * Global_262145.f_2970)), 1);
					break;
				
				case 41:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, round((to_float(7500) * Global_262145.f_2971)), 2);
					break;
				
				case 68:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, round((to_float(5100) * Global_262145.f_2972)), 1);
					break;
				
				case 42:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, round((to_float(5050) * Global_262145.f_2973)), 0);
					break;
				
				case 43:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, round((to_float(2450) * Global_262145.f_2974)), 2);
					break;
				
				case 44:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, round((to_float(4950) * Global_262145.f_2975)), 0);
					break;
				
				case 45:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, round((to_float(5100) * Global_262145.f_2976)), 0);
					break;
				
				case 46:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, round((to_float(12250) * Global_262145.f_2977)), 0);
					break;
				
				case 47:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, round((to_float(1150) * Global_262145.f_2978)), 3);
					break;
				
				case 48:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, round((to_float(7500) * Global_262145.f_2979)), 3);
					break;
				
				case 49:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, round((to_float(7600) * Global_262145.f_2980)), 3);
					break;
				
				case 50:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, round((to_float(2600) * Global_262145.f_2981)), 2);
					break;
				
				case 51:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, round((to_float(2500) * Global_262145.f_2982)), 3);
					break;
				
				case 52:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, round((to_float(7450) * Global_262145.f_2983)), 3);
					break;
				
				case 53:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, round((to_float(7500) * Global_262145.f_2984)), 0);
					break;
				
				case 69:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, round((to_float(10000) * Global_262145.f_2985)), 1);
					break;
				
				case 70:
					func_174(sParam0, iParam1, iParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, round((to_float(2500) * Global_262145.f_2986)), 2);
					break;
			}
			if (iVar0 == joaat("mp_m_freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2987)), 0);
						break;
					
					case 88:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2988)), 0);
						break;
					
					case 89:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2989)), 0);
						break;
					...
					case 13:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_A", "crewLogo", iParam2, round((to_float(5000) * Global_262145.f_2936)), 0);
						break;
					
					case 14:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_B", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2937)), 0);
						break;
					
					case 15:
						func_174(sParam0, iParam1, iParam3, "TAT_FMM_CLB", "multiplayer_overlays", "000_C", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2938)), 2);
						break;
					
					case 16:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_D", "crewLogo", iParam2, round((to_float(5000) * Global_262145.f_2939)), 0);
						break;
					
					case 71:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_E", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2939)), 0);
						break;
					
					case 72:
						func_174(sParam0, iParam1, iParam3, "TAT_FMM_CLB", "multiplayer_overlays", "000_F", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2939)), 0);
						break;
				}
			}
			else if (iVar0 == joaat("mp_f_freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2987)), 0);
						break;
					
					case 88:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2988)), 0);
						break;
					
					case 89:
						func_174(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, round((to_float(100) * Global_262145.f_2989)), 0);
						break;
					...
					case 14:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_B", "crewLogo", iParam2, round((to_float(5000) * Global_262145.f_2937)), 0);
						break;
					
					case 15:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_C", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2938)), 2);
						break;
					
					case 16:
						func_174(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_D", "crewLogo", iParam2, round((to_float(10000) * Global_262145.f_2939)), 0);
						break;
					}
			}
			break;
...
int func_176(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_178(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_184(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		if (iVar0 == joaat("mp_m_freemode_01"))
		{
			return func_186(get_entity_model(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_186(get_entity_model(iParam0), iVar1, 14, 4);
		}
	}
...
int func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_178(iParam2));
...
int func_189(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_178(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_178(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_176(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_176(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_176(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_176(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_218(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_208(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_208(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_178(iParam0));
			if (iVar11 > iVar10)
			{
			...
			switch (iVar0)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_110(player_id(), 1) && Global_1892703[player_id() /*599*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
{
	return func_267(player_id(), bParam0);
}
...
int func_278()
{
	...
	if (func_279() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_279()) == 0)
		{
			return 1;
		}
	}
...
void func_287(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
