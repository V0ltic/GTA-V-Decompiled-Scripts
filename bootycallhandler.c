	...
	switch (Global_112380)
	{
		case 0:
			if (!Global_112380.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_66(func_67(iVar0)) && (Global_112380.f_15[iVar1] + 120000) < get_game_timer())
					{
						if (func_64(iVar0))
						{
							func_63(iVar0, 0);
						...
						else
						{
							...
							else if (((get_game_timer() >= Global_112380.f_4[iVar1] && func_51()) && func_50(iVar0)) && func_49(iVar0) >= func_48(iVar0))
							{
							...
							if (func_47() == 2)
							{
								func_55(&uLocal_36, 0, player_ped_id(), "TREVOR", 0, 1);
							}
							else if (func_47() == 0)
							{
								func_55(&uLocal_36, 0, player_ped_id(), "MICHAEL", 0, 1);
							}
							else if (func_47() == 1)
							{
								func_55(&uLocal_36, 0, player_ped_id(), "FRANKLIN", 0, 1);
							}
...
void func_68()
{
	...
	switch (Global_112380)
	{
		case 0:
			...
			{
				if (get_game_timer() >= Global_112380.f_3)
				{
...
int func_76()
{
	...
	while (iVar0 < 10)
	{
		if (Global_113386.f_243[func_47() /*53*/].f_2[iVar0 /*5*/].f_4 && get_game_timer() >= Global_112380.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
...
void func_79()
{
	...
	{
		if (Global_112380.f_3 < (get_game_timer() + 120000))
		{
			func_82(1800000);
		}
