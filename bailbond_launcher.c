...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (Global_113386.f_24986.f_2)
		{
					...
					if (!func_245())
					{
						if (func_223(4, 62, 2, -1, 0))
						{
							if (func_220(Local_43.f_4, Local_43.f_5))
							{
								...
								clear_bit(&(Global_113386.f_24986), 9);
			...
			case 1:
				if (func_192() == 2)
				{
					...
					if (!BitTest(Global_113386.f_24986, 8))
					{
						if (!func_245())
						{
							set_bit(&(Global_113386.f_24986), 8);
						}
						else
						{
							wait(2000);
					...
					else if (func_245())
					{
						if (func_155(0))
						{
							if (func_149(&(Local_43.f_6)))
							{
								...
								if (!func_146())
								{
									func_76(get_this_script_name(), 1);
								}
						...
						else
						{
							if (BitTest(Global_113386.f_24986, 8))
							{
								clear_bit(&(Global_113386.f_24986), 8);
							}
							wait(2000);
						}
					}
			...
			case 2:
				if (!is_thread_active(iLocal_213))
				{
...
void func_28(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			set_bit(&(Global_113386.f_24986), func_73(Local_43.f_4));
			if (iParam0 == 1)
			{
				func_72(0);
				iVar0 = 8;
				set_bit(&(Global_113386.f_24986), func_71(Local_43.f_4));
			}
			else
			{
				func_72(1);
				iVar0 = 4;
				clear_bit(&(Global_113386.f_24986), func_71(Local_43.f_4));
		...
		if (func_17(Global_113386.f_24986.f_3))
		{
			if (func_247())
			{
				if (func_223(4, 62, 2, -1, 0))
				{
					...
					{
						set_bit(&(Global_113386.f_24986), 9);
					}
				}
			}
		}
...
void func_79(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_192();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_108())
		{
			func_101(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_88(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_92(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_109()
{
	...
	{
		if (func_99(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_98(player_ped_id());
...
void func_110(int iParam0, bool bParam1)
{
	...
	iVar0 = func_98(iParam0);
	if (func_90(iVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
...
void func_111(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_116(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_113(Var7.f_1)) && iVar9 < 51)
			{
...
int func_122(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_145())
		{
			*uParam0 = func_128(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
void func_147(int iParam0)
{
	...
	iLocal_213 = start_new_script_with_args(&Var0, &Local_43, 8, 51000);
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_158()) || Global_31962) || func_164()) || func_163(8, -1)) || func_156()) || func_145()) || func_162()) || func_157()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_158()) || Global_112433) || Global_31962) || func_164()) || func_163(8, -1)) || func_145()) || func_162()) || func_157()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || get_player_wanted_level(player_id()) > 0) || func_163(8, -1)) || func_157()) || func_161()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_158()) || func_162()) || Global_112433) || Global_31962) || func_164()) || Global_44238) || func_163(8, -1)) || func_156()) || func_161()) || func_157()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_173(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_31(26, func_32(uParam0->f_4), 0))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				if ((!func_191() && !is_ambient_speech_playing(player_ped_id())) && !is_message_being_displayed())
				{
					func_190(uParam1, 2, player_ped_id(), "TREVOR", 0, 1);
...
int func_201()
{
	...
	func_200(&uVar0, get_clock_seconds());
	func_199(&uVar0, get_clock_minutes());
	func_198(&uVar0, get_clock_hours());
	func_196(&uVar0, get_clock_day_of_month());
	func_197(&uVar0, get_clock_month());
	func_195(&uVar0, get_clock_year());
	return uVar0;
}
...
void func_206(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_208() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_208() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_207(bParam0));
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iParam3 != -1)
	{
		if (func_225(player_ped_id(), iParam3, 0))
		{
			return 0;
		}
	}
...
int func_245()
{
	...
	Var0 = { func_246(get_player_index()) };
	fVar1 = Local_43.f_3;
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
...
void func_248()
{
	...
	if (iLocal_219 != 0)
	{
		...
		{
			case 1:
				iLocal_214 = request_scaleform_movie("MIDSIZED_MESSAGE");
				iLocal_219 = 2;
				break;
			...
			case 2:
				...
				if (has_scaleform_movie_loaded(iLocal_214))
				{
					begin_scaleform_movie_method(iLocal_214, "SHOW_SHARD_MIDSIZED_MESSAGE");
					begin_text_command_scaleform_string("BBS_MP");
					end_text_command_scaleform_string();
					begin_text_command_scaleform_string(sVar0);
					add_text_component_substring_text_label(sLocal_218);
					end_text_command_scaleform_string();
			...
			case 3:
				if (has_scaleform_movie_loaded(iLocal_214))
				{
					draw_scaleform_movie_fullscreen(iLocal_214, 255, 255, 255, 255, 0);
				...
				if ((get_game_timer() - iLocal_217) > 7000)
				{
					if (!iLocal_46)
					{
						begin_scaleform_movie_method(iLocal_214, "SHARD_ANIM_OUT");
				...
				if ((get_game_timer() - iLocal_217) > 7500)
				{
					iLocal_219 = 4;
				}
				break;
			...
			case 4:
				set_scaleform_movie_as_no_longer_needed(&iLocal_214);
				iLocal_46 = 0;
				func_249();
				break;
			}
...
void func_251()
{
	if (Global_113386.f_24986.f_1 == 0)
	{
		...
		{
			clear_bit(&(Global_113386.f_24986), false);
			clear_bit(&(Global_113386.f_24986), true);
			clear_bit(&(Global_113386.f_24986), 2);
			clear_bit(&(Global_113386.f_24986), 3);
			clear_bit(&(Global_113386.f_24986), 4);
			clear_bit(&(Global_113386.f_24986), 5);
			clear_bit(&(Global_113386.f_24986), 6);
			clear_bit(&(Global_113386.f_24986), 7);
			clear_bit(&(Global_113386.f_24986), 8);
			clear_bit(&(Global_113386.f_24986), 9);
			iLocal_212 = func_201();
