...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iLocal_48)
		{
			...
			case 2:
				if (!can_phone_be_seen_on_screen())
				{
			...
			case 3:
				if (get_current_scripted_conversation_line() > iVar0)
				{
				...
				if (is_ped_jumping_out_of_vehicle(player_ped_id()) || is_entity_in_water(player_ped_id()))
				{
					func_55(0);
				}
				if (func_54())
...
void func_17(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_19() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_19() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_18(bParam0));
...
void func_88(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	request_additional_text("DrfAud", 6);
	while (!has_additional_text_loaded(0) || !has_additional_text_loaded(6))
	{
		wait(0);
	}
	func_121(uParam0, 0, player_ped_id(), "MICHAEL", 0, 1);
	...
	while (iVar4 < 47)
	{
		if (is_string_null_or_empty(uParam1[iVar4 /*4*/]))
		{
			iVar4 = 47;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (is_string_null_or_empty(uParam4[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
	...
	while (iVar4 < 27)
	{
		if (is_string_null_or_empty(uParam7[iVar4 /*4*/]))
		{
			iVar4 = 27;
		}
		iVar4++;
...
struct<4> func_104(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_109(&(Global_113386.f_19961), 8) && iParam1) && iParam0 != 4) && func_107(3) > 0) && get_random_float_in_range(0f, 1f) < 0.75f)
	{
		bVar1 = 8;
		*uParam3 = 4;
	}
...
void func_111(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_90(uParam0, uParam1, uParam2, "DRF_OVG", get_random_int_in_range(1, 3), 1, 0);
		func_90(uParam0, uParam1, uParam2, "DRF_TMG", func_113(func_114(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_90(uParam0, uParam1, uParam2, "DRF_OVO", get_random_int_in_range(1, 3), 1, 0);
...
void func_112(var uParam0, var uParam1, var uParam2, char* sParam3, int iParam4)
{
	...
	iVar0 = get_random_int_in_range(1, iParam4 + 1);
...
{
	if (Global_96902 != 0 && (get_game_timer() - Global_96902) < 1800000)
	{
		return 0;
	}
	request_additional_text("SHRINK", 0);
