		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_32299[iVar0 /*7*/])))
			{
				if (func_12(iVar0, Var2))
				{
					...
					{
						if (is_thread_active(Global_32299[iVar0 /*7*/].f_5))
						{
							force_cleanup_for_thread_with_this_id(Global_32299[iVar0 /*7*/].f_5, 1);
						}
...
void func_1(int iParam0)
{
	...
	if (get_length_of_literal_string(sVar0) != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(iVar1) == 0)
		{
			...
			Global_32299[iParam0 /*7*/].f_5 = start_new_script(sVar0, iVar2);
...
int func_5(var uParam0, struct<3> Param1)
{
	...
	{
		if (is_entity_in_angled_area(player_ped_id(), -2080.115f, 3292.193f, -11.667f, -2112.049f, 3224.331f, 11.667f, 115f, true, false, 0))
		{
			return 0;
		}
	}
...
{
	Param1.f_2 = 0f;
	if (!is_thread_active(Global_32299[iParam0 /*7*/].f_5))
	{
		return 1;
	}
	...
	if (func_9() && !func_6(6))
	{
		if (!func_10(Global_32299[iParam0 /*7*/], 1))
		{
			...
			{
				if (_get_number_of_references_of_script_with_name_hash(joaat("golf")) == 0)
				{
					return 1;
				}
			}
	...
	if (vdist2(Global_32299[iParam0 /*7*/].f_2, Param1) > (Global_32299[iParam0 /*7*/].f_1 + 400f))
	{
		return 1;
	}
	return 0;
