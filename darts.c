...
void __EntryFunction__()
{
	...
	if (!does_entity_exist(ScriptParam_228.f_4))
	{
		if (!is_ped_injured(player_ped_id()))
		{
			if (iLocal_175 == 2)
			...
			if (does_object_of_type_exist_at_coords(ScriptParam_228, 5f, joaat("prop_dart_bd_cab_01"), false))
			{
				ScriptParam_228.f_4 = get_closest_object_of_type(ScriptParam_228, 5f, joaat("prop_dart_bd_cab_01"), true, false, true);
				get_coords_and_rotation_of_closest_object_of_type(ScriptParam_228, 5f, joaat("prop_dart_bd_cab_01"), &ScriptParam_228, &Var19, 0);
	...
	{
		Var19 = { get_entity_coords(ScriptParam_228.f_4, true) };
	}
	if (!is_entity_dead(func_504(), false))
	{
		func_502(iLocal_170, 1);
		if (is_ped_in_any_vehicle(func_504(), false))
		{
			task_leave_any_vehicle(func_504(), 0, 0);
		}
	...
	while (true)
	{
		...
		{
			draw_scaleform_movie_3d(Var4.f_0, Var4.f_18, Var4.f_21, Var4.f_24, Var4.f_24, 2);
		}
		if ((is_ped_injured(ScriptParam_228.f_5) && !does_entity_exist(func_504())) || (does_entity_exist(func_504()) && is_ped_injured(func_504())))
		{
			func_475(&Var0, &Var5, &Var6);
		}
		if (!is_ped_injured(iLocal_138[0]))
		{
			set_ped_reset_flag(iLocal_138[0], 239, true);
			set_ped_reset_flag(iLocal_138[0], 124, true);
			func_468();
			_0x7F4724035FDCA1DD(0);
			_0x7F4724035FDCA1DD(2);
			iVar14 = 0;
			while (iVar14 < get_ped_nearby_peds(player_ped_id(), &uVar26, -1))
			{
				if (uVar26[iVar14] != iLocal_138[1])
				{
					if (!is_ped_injured(uVar26[iVar14]))
					{
						set_ped_reset_flag(uVar26[iVar14], 240, true);
					}
				}
				iVar14++;
			}
			switch (Var0.f_0)
			{
				case 0:
					...
					if (does_entity_exist(Var0.f_243))
					{
						Local_207 = { get_offset_from_entity_in_world_coords(Var0.f_243, 0.7792f, -1.138f, 0.1814f) };
						Local_208 = { -7.9947f, 0f, (Var0.f_243.f_4 + 36.19176f) };
						iLocal_84 = create_camera_with_params(26379945, Local_207, Local_208, 65f, false, 2);
						set_cam_fov(iLocal_84, 30f);
					}
					func_465();
					settimera(0);
					Var0.f_0 = 1;
				...
				case 1:
					if (timera() > 500 && !is_ped_ragdoll(player_ped_id()))
					{
						clear_area(ScriptParam_228, 0.5f, true, false, false, false);
						if (!is_ped_injured(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), true))
						{
							clear_sequence_task(&iLocal_173);
							open_sequence_task(&iLocal_173);
							task_leave_any_vehicle(0, 0, 0);
							close_sequence_task(iLocal_173);
							task_perform_sequence(player_ped_id(), iLocal_173);
						}
						Local_42 = { Local_42 };
						Var0.f_0 = 2;
					}
				...
				case 2:
					...
					if (does_entity_exist(Var0.f_243))
					{
						Var19 = { get_offset_from_entity_given_world_coords(Var0.f_243, Var4.f_18) };
					}
					func_458(&Var4, &Var5);
				...
				case 3:
					if (func_455(&Var4, &Var5))
					{
						...
						if (!is_entity_dead(func_504(), false))
						{
							...
							switch (iLocal_218)
							{
								...
								case 19:
									...
									set_ped_component_variation(func_504(), 5, 2, 0, 0);
									break;
						...
						{
							iVar12 = get_random_int_in_range(0, 200);
							if (iLocal_175 == 2)
							{
								if (iVar12 < 51)
								{
						...
						iLocal_36 = create_object(iLocal_37, Var3, true, true, false);
						Var0.f_446[0] = 0;
						Var0.f_446[1] = 0;
						Var0.f_0 = 4;
					}
				...
				case 4:
					...
					{
						iVar27 = create_object(joaat("prop_dart_1"), Var3, true, true, false);
						func_445(Var0.f_243.f_4, Var2, &uVar26, &ScriptParam_228);
						func_444(&Var4, sLocal_219, sLocal_220);
						clear_ped_tasks(iLocal_138[1]);
						iLocal_174 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, false, 2);
						if (!is_ped_injured(player_ped_id()))
						{
							force_ped_motion_state(player_ped_id(), joaat("MotionState_Idle"), false, 0, false);
						}
						func_443(&(Var0.f_257), 0, player_ped_id(), sLocal_219, 0, 1);
						if (is_entity_dead(func_504(), false))
						{
							if (iLocal_175 == 2)
							{
				...
				case 5:
					if ((((!is_ped_injured(iLocal_138[1]) && is_ped_on_foot(iLocal_138[0])) && !is_ped_in_any_vehicle(iLocal_138[0], true)) && is_ped_on_foot(iLocal_138[1])) && !is_ped_in_any_vehicle(iLocal_138[1], true))
					{
						bLocal_146 = func_438(&uLocal_162);
						if ((func_437() && get_game_timer() >= iLocal_164 + 1000) && iVar13 != 9)
						{
						...
						if (is_screen_faded_out() && iVar13 != 9)
						{
							func_433(0);
							func_431();
							iVar13 = 9;
						...
						{
							case -1:
								if (!is_ped_injured(iLocal_138[1]))
								{
									iLocal_168 = create_synchronized_scene(get_offset_from_entity_in_world_coords(ScriptParam_228.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (get_entity_heading(ScriptParam_228.f_4) - 3.783146f), 2);
									iLocal_174 = create_cam("DEFAULT_ANIMATED_CAMERA", false);
									play_synchronized_cam_anim(iLocal_174, iLocal_168, "darts_ig_intro_cam", "mini@dartsintro");
									set_cam_active(iLocal_174, true);
									render_script_cams(true, false, 3000, true, false, 0);
									task_clear_look_at(iLocal_138[0]);
									task_clear_look_at(iLocal_138[1]);
									clear_ped_tasks_immediately(iLocal_138[0]);
									clear_ped_tasks_immediately(iLocal_138[1]);
									task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1000f, 0);
									task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1000f, 0);
									task_play_anim(iLocal_138[1], "mini@dartsintro", "darts_ig_intro_guy1_face", 8f, -8f, -1, 32, 0f, false, false, false);
									task_play_anim(iLocal_138[0], "mini@dartsintro", sVar22, 8f, -8f, -1, 32, 0f, false, false, false);
									play_synchronized_entity_anim(iVar27, iLocal_168, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 8f, 0, 1000f);
									func_430(&iVar25);
									iVar13++;
								}
								break;
							...
							case 0:
								if (is_synchronized_scene_running(iLocal_168))
								{
									if (!bVar9)
									{
									...
									else if (!is_ambient_speech_playing(iLocal_138[0]))
									{
										if (!bVar10)
										{
											if (!func_426(&iVar25))
									...
									switch (iLocal_31)
									{
										...
										case 1:
											if (get_synchronized_scene_phase(iLocal_168) > 0.25f)
											{
												func_430(&iVar25);
										...
										case 2:
											if (get_synchronized_scene_phase(iLocal_168) > 0.55f)
											{
										...
										case 3:
											if (get_synchronized_scene_phase(iLocal_168) > 0.85f)
											{
												func_424("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (get_synchronized_scene_phase(iLocal_168) > 0.95f)
									{
										iLocal_158 = 1;
										iVar13++;
									}
							...
							case 1:
								if (get_synchronized_scene_phase(iLocal_168) > 0.99f)
								{
									if (!is_ped_injured(iLocal_138[1]))
									{
										...
										iLocal_31 = 0;
										clear_help(true);
										destroy_cam(iLocal_174, false);
										clear_ped_tasks(iLocal_138[0]);
										clear_ped_tasks(iLocal_138[1]);
										stop_synchronized_entity_anim(iVar27, -1000f, false);
										delete_object(&iVar27);
										stop_audio_scene(func_420(0));
										func_427(&iVar25);
										Var0.f_0 = 6;
										iVar13 = 0;
									}
							...
							case 3:
								if (!is_ped_injured(iLocal_138[1]))
								{
									iLocal_168 = create_synchronized_scene(get_offset_from_entity_in_world_coords(ScriptParam_228.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (get_entity_heading(ScriptParam_228.f_4) - 3.783146f), 2);
									iLocal_174 = create_cam("DEFAULT_ANIMATED_CAMERA", false);
									play_synchronized_cam_anim(iLocal_174, iLocal_168, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
									set_cam_active(iLocal_174, true);
									render_script_cams(true, false, 3000, true, false, 0);
									task_clear_look_at(iLocal_138[0]);
									task_clear_look_at(iLocal_138[1]);
									clear_ped_tasks_immediately(iLocal_138[0]);
									clear_ped_tasks_immediately(iLocal_138[1]);
									task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1000f, 0);
									task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1000f, 0);
									task_play_anim(iLocal_138[1], "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1_face", 8f, -8f, -1, 32, 0f, false, false, false);
									task_play_anim(iLocal_138[0], "mini@dartsintro_alt1", sVar22, 8f, -8f, -1, 32, 0f, false, false, false);
									play_synchronized_entity_anim(iVar27, iLocal_168, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 8f, 0, 1000f);
									func_430(&iVar25);
									iVar13++;
								}
								break;
							...
							case 9:
								if (is_screen_faded_out())
								{
									...
									if (!is_ped_injured(iLocal_138[1]))
									{
										set_entity_coords(iLocal_138[0], Var2, true, false, false, true);
										set_entity_heading(iLocal_138[0], Var0.f_243.f_4);
										set_entity_coords(iLocal_138[1], Var2.f_3, true, false, false, true);
										set_entity_heading(iLocal_138[1], Var0.f_243.f_4);
										clear_ped_tasks(iLocal_138[0]);
										clear_ped_tasks(iLocal_138[1]);
									}
									destroy_cam(iLocal_174, false);
				...
				case 6:
					switch (iVar13)
					{
						case 0:
							...
							start_audio_scene(func_420(1));
							iVar13 = 0;
							Var0.f_0 = 7;
							break;
						
						case 1:
							if ((get_game_timer() - iLocal_164) > 1500)
							{
				...
				case 8:
					...
					{
						case 0:
							if (!does_entity_exist(func_504()))
							{
								if (!BitTest(Global_113347, 10))
								{
									set_bit(&Global_113347, 10);
								}
								else
								{
									clear_bit(&Global_113347, 10);
								}
								func_411(&Var5);
								iVar13++;
							}
						...
						case 1:
							if (is_pc_version())
							{
								if (fLocal_89 != _get_aspect_ratio(false))
								{
									fLocal_89 = _get_aspect_ratio(false);
									set_cam_fov(iLocal_75, func_410(fLocal_89));
									set_cam_fov(iLocal_76, func_410(fLocal_89));
								}
							}
							if (func_350(&Var5, &(Var0.f_452), &(Var0.f_453)))
							{
								stop_audio_scene(func_420(1));
								if (Var0.f_452 > 0)
								{
									iVar13 = 0;
					...
					switch (iVar13)
					{
						case 0:
							if (func_429(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar33 = func_246();
								iLocal_168 = create_synchronized_scene(Var20, Var21, 2);
								iLocal_174 = create_cam("DEFAULT_ANIMATED_CAMERA", false);
								play_synchronized_cam_anim(iLocal_174, iLocal_168, sLocal_227[iVar33], "mini@dartsoutro");
								set_cam_active(iLocal_174, true);
								render_script_cams(true, false, 3000, true, false, 0);
								if (!is_ped_injured(iLocal_138[0]) && !is_ped_injured(iLocal_138[1]))
								{
									if (Var0.f_454)
									{
										...
										play_sound_frontend(-1, "TENNIS_POINT_WON", "HUD_AWARDS", true);
										func_245(&iLocal_138, iVar35);
										task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsoutro", sLocal_225[iVar33], 1000f, -1.5f, 0, 0, 1000f, 0);
										task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsoutro", sLocal_226[iVar33], 1000f, -1.5f, 0, 0, 1000f, 0);
										task_play_anim(player_ped_id(), sLocal_223, sLocal_224[get_random_int_in_range(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
									}
									else
									{
										play_sound_frontend(-1, "OTHER_TEXT", "HUD_AWARDS", true);
										func_244(&iLocal_138);
										task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsoutro", sLocal_225[iVar33], 1000f, -1.5f, 0, 0, 1000f, 0);
										task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsoutro", sLocal_226[iVar33], 1000f, -1.5f, 0, 0, 1000f, 0);
										task_play_anim(iLocal_138[1], sLocal_222, sLocal_224[get_random_int_in_range(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
									}
								}
								iVar13++;
							}
						...
						case 2:
							func_427(&(Var0.f_254));
							iLocal_152 = 0;
							stop_audio_scene(func_420(3));
							func_419();
							if (does_cam_exist(iLocal_174))
							{
								destroy_cam(iLocal_174, false);
							}
							iVar13 = 0;
				...
				case 13:
					...
					switch (iVar13)
					{
						case 0:
							...
							if (!bLocal_154)
							{
								render_script_cams(false, bLocal_154, 3000, true, false, 0);
							}
							else
							{
							...
							clear_prints();
							task_look_at_entity(iLocal_138[0], iLocal_138[1], 5000, 2049, 3);
							func_441(&iVar25);
							iVar13++;
							break;
				...
				case 14:
					...
					if (is_control_just_released(2, 201))
					{
						...
						iLocal_171 = 2;
						bVar7 = true;
						if (is_audio_scene_active(func_420(2)))
						{
							stop_audio_scene(func_420(2));
						}
						Var0.f_0 = 13;
					}
...
{
	if (!is_entity_dead(func_504(), false) || iParam2)
	{
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_6(iParam3), false);
}
...
int func_10(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_567)
	{
		switch (func_506(get_player_ped(get_player_index())))
		{
			case 1:
...
void func_11(var uParam0, bool bParam1)
{
	...
	func_13(get_control_instructional_button(2, 215, true));
	func_12("ES_HELP");
	if (is_pc_version())
	{
		scaleform_movie_method_add_param_bool(true);
	...
	if (bParam1)
	{
		...
		func_13(get_control_instructional_button(2, 216, true));
		func_12("ES_XPAND");
		if (is_pc_version())
		{
			scaleform_movie_method_add_param_bool(true);
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_36();
		draw_rect(0.5f, (fVar1 - (func_40((2f - 0.5f)) - 0.001388889f)), fVar6, func_30(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_40(25f))), 0f, 1f);
					func_36();
					draw_rect(0.5f, (fVar1 + func_40((2f * 0.5f))), fVar6, func_30(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
					fVar1 = (fVar1 + func_40((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_40((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					end_text_command_display_text(fVar20, (fVar1 + func_40((2f * 2f))), 0);
					break;
...
void func_27(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			draw_sprite("CommonMenu", func_23(7, 0), (fParam4 - 0.006f), ((fParam2 + func_40(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_19(5, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_23(5, 0), (fParam4 - 0.006f), ((fParam2 + func_40(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_19(6, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_23(6, 0), (fParam4 - 0.006f), ((fParam2 + func_40(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (iLocal_141)
	{
		...
		if ((is_synchronized_scene_running(iLocal_168) && get_synchronized_scene_phase(iLocal_168) >= 0.995f) || !is_synchronized_scene_running(iLocal_168))
		{
			bLocal_154 = true;
			if (does_cam_exist(iLocal_174))
			{
				...
				if (!is_ped_injured(iLocal_138[0]) && !is_ped_injured(iLocal_138[1]))
				{
					clear_ped_tasks_immediately(iLocal_138[0]);
					clear_ped_tasks_immediately(iLocal_138[1]);
					force_ped_ai_and_animation_update(iLocal_138[0], false, false);
					force_ped_ai_and_animation_update(iLocal_138[1], false, false);
				}
			}
			func_109();
		}
		...
		else if (((is_control_just_pressed(0, 234) || is_control_just_pressed(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			uParam0->f_457 = 0;
			if (iLocal_140)
			{
				Var3 = { get_entity_coords(uParam0->f_5[iLocal_30 /*79*/][iLocal_163 /*26*/], true) };
		...
		else if (((is_control_just_pressed(0, 211) || is_disabled_control_just_pressed(0, 211)) && bVar1) && (iLocal_159 || !is_player_online()))
		{
			uParam1->f_680 = 1;
			func_121(&(uParam1->f_509), 0, 0, 1, 1);
			func_120(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if (!uParam0->f_457)
	{
		...
		iVar7 = func_246();
		iLocal_168 = create_synchronized_scene(Var5, Var6, 2);
		iLocal_174 = create_cam("DEFAULT_ANIMATED_CAMERA", false);
		play_synchronized_cam_anim(iLocal_174, iLocal_168, sLocal_227[iVar7], "mini@dartsoutro");
		set_cam_active(iLocal_174, true);
		render_script_cams(true, false, 3000, true, false, 0);
		if (!is_ped_injured(iLocal_138[0]) && !is_ped_injured(iLocal_138[1]))
		{
			if (uParam0->f_454)
			{
				task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsoutro", sLocal_225[iVar7], 1000f, -1.5f, 0, 0, 1000f, 0);
				task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsoutro", sLocal_226[iVar7], 1000f, -1.5f, 0, 0, 1000f, 0);
				task_play_anim(player_ped_id(), sLocal_223, sLocal_224[get_random_int_in_range(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
			}
			else
			{
				task_synchronized_scene(iLocal_138[1], iLocal_168, "mini@dartsoutro", sLocal_225[iVar7], 1000f, -1.5f, 0, 0, 1000f, 0);
				task_synchronized_scene(iLocal_138[0], iLocal_168, "mini@dartsoutro", sLocal_226[iVar7], 1000f, -1.5f, 0, 0, 1000f, 0);
				task_play_anim(iLocal_138[1], sLocal_222, sLocal_224[get_random_int_in_range(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
			}
		}
		bLocal_154 = false;
		uParam0->f_457 = 1;
		uParam1->f_671 = get_game_timer();
		iVar8 = 0;
		while (iVar8 < 2)
		{
			iVar9 = 0;
	...
	else if ((get_game_timer() - uParam1->f_671) > 400 && func_45(uParam3, 0, 0))
	{
		if (!uParam0->f_454)
		{
			play_sound_frontend(-1, "LOOSE_MATCH", "HUD_MINI_GAME_SOUNDSET", true);
		}
		iLocal_141 = 1;
	}
}
...
void func_46(var uParam0)
{
	...
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(2);
	func_13(get_control_instructional_button(2, 188, true));
	func_12("ES_HELP_TU");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(1);
	func_13(get_control_instructional_button(2, 187, true));
	func_12("ES_HELP_TD");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(0);
	func_13(get_control_instructional_button(2, 202, true));
	func_12("ES_HELP_AB");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	end_scaleform_movie_method();
...
void func_53(struct<3> Param0)
{
	...
	if (bLocal_88)
	{
		set_cam_coord(iLocal_86, Var0);
		set_cam_active_with_interp(iLocal_86, iLocal_85, 500, 1, 1);
		bLocal_88 = false;
	}
	else
	{
		set_cam_coord(iLocal_85, Var0);
		set_cam_active_with_interp(iLocal_85, iLocal_86, 500, 1, 1);
		bLocal_88 = true;
	}
}
...
void func_55(struct<3> Param0, bool bParam1, bool bParam2)
{
	...
	{
		set_cam_coord(iLocal_85, Var0);
		set_cam_active_with_interp(iLocal_85, iLocal_84, 1500, 1, 1);
		set_cam_active(iLocal_84, false);
		set_cam_coord(iLocal_86, Var0);
		bLocal_88 = true;
	}
	else if (bParam2)
	{
		set_cam_coord(iLocal_85, Var0);
		set_cam_active_with_interp(iLocal_85, iLocal_77, 2000, 1, 1);
		bLocal_88 = true;
	}
	else
	{
		if (bLocal_88)
		{
			set_cam_active_with_interp(iLocal_84, iLocal_85, 1500, 1, 1);
		}
		else
		{
			set_cam_active_with_interp(iLocal_84, iLocal_86, 1500, 1, 1);
		}
		set_cam_active(iLocal_85, false);
	}
}
...
void func_92()
{
	...
	{
		if (func_94(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_506(player_ped_id());
...
int func_110(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (!is_pause_menu_active())
		{
			if ((get_game_timer() - uParam0->f_671) > 900)
			{
...
void func_123(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_125(uParam0->f_1, 256) || (func_125(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			scaleform_movie_method_add_param_bool(func_125(uParam0->f_1, 4096));
			end_scaleform_movie_method();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_130(var uParam0, int iParam1)
{
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_154(&(uParam0->f_246.f_3), 250, 0))
		{
			return 1;
		}
	}
	else if ((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) || func_154(&(uParam0->f_246.f_3), 250, 0))
	{
		return 1;
	}
	return 0;
...
void func_137(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, bool bParam14, int iParam15, bool bParam16, bool bParam17)
{
	...
	switch (Param0.f_29[bParam14])
	{
		...
		case 8:
			...
			{
				begin_text_command_scaleform_string(func_142(func_145(iParam15), 0));
				end_text_command_scaleform_string();
			}
			else
			{
		...
		case 22:
			...
			{
				begin_text_command_scaleform_string("NUMBER");
				add_text_component_integer(func_138(iParam15));
				end_text_command_scaleform_string();
			}
			else
			{
	...
	else if (*uParam2 == 1)
	{
		...
		else
		{
			if (Global_2097536.f_2775[iParam3] < 0)
			{
				...
				(uParam0[iParam1 /*100*/])->f_32 = { func_25(player_id()) };
...
void func_158(var uParam0)
{
	...
	Global_2100721.f_87[iVar2 /*3*/] = { func_159(player_id()) };
}
...
int func_162(var uParam0)
{
	...
	switch ((uParam0[0 /*100*/])->f_76)
	{
		case 0:
			func_168(uParam0);
			if ((func_167() || func_166()) && !network_have_user_content_privileges(0))
			{
	...
	switch (*uParam0)
	{
		case 0:
			if (func_148(Var0))
			{
				...
				{
					if ((is_xbox360_version() || func_166()) || func_167())
					{
						...
						if (func_187())
						{
							...
							while (iVar7 < Var1.f_3)
							{
								...
								if (iVar5 < 0)
								{
									...
									{
										if (Global_2097157.f_211.f_36[0] >= leaderboards2_read_by_help_purple_int(iVar7, 0))
										{
											iVar5 = iVar7;
										}
									}
									else if (Global_2097157.f_211.f_3[0] >= leaderboards2_read_by_help_purple_float(iVar7, 0))
									{
										iVar5 = iVar7;
									}
								}
							...
							if (Global_2097536.f_2704[iVar9] < 11 || bVar10)
							{
								...
								else if (iVar2 == 0 || bVar10)
								{
									...
									while (iVar3 < Global_2097536.f_2708)
									{
										if (BitTest(Global_2097536.f_2769, Global_2097536.f_2710[iVar3]))
										{
											Global_2097536[iVar9 /*901*/][0 /*75*/].f_67[iVar3] = leaderboards2_read_by_help_purple_int(0, Global_2097536.f_2710[iVar3]);
										}
										else
										{
											Global_2097536[iVar9 /*901*/][0 /*75*/].f_60[iVar3] = leaderboards2_read_by_help_purple_float(0, Global_2097536.f_2710[iVar3]);
										}
										iVar3++;
									}
								...
								else if (Global_2097536.f_2704[iVar9] < 11)
								{
									...
									while (iVar3 < Global_2097536.f_2708)
									{
										if (BitTest(Global_2097536.f_2769, Global_2097536.f_2710[iVar3]))
										{
											Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/].f_67[iVar3] = leaderboards2_read_by_help_purple_int(iVar2, Global_2097536.f_2710[iVar3]);
										}
										else
										{
											Global_2097536[iVar9 /*901*/][Global_2097536.f_2704[iVar9] /*75*/].f_60[iVar3] = leaderboards2_read_by_help_purple_float(iVar2, Global_2097536.f_2710[iVar3]);
										}
										iVar3++;
									}
									if (iVar2 != 0)
...
int func_179()
{
	if (is_pause_menu_active() && !func_201())
	{
		return 1;
	}
	return 0;
...
void func_183(var uParam0, char* sParam1, int iParam2)
{
	...
	else
	{
		...
		sParam1->f_32 = { func_25(player_id()) };
	}
			...
			if (iVar3 > 0)
			{
				...
				if (func_189(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], bVar8, 0, 100))
				{
						...
						if (func_187())
						{
							...
							while (iVar6 < Var1.f_3)
							{
								if (iVar4 < 0)
								{
									...
									if (BitTest(Global_2097157.f_142.f_2, 0))
									{
										if (Global_2097157.f_211.f_36[0] >= leaderboards2_read_by_help_purple_int(iVar6, 0))
										{
											iVar4 = iVar6;
										}
									}
									else if (Global_2097157.f_211.f_3[0] >= leaderboards2_read_by_help_purple_float(iVar6, 0))
									{
										iVar4 = iVar6;
									}
									func_184(&Var0);
					...
					else
					{
						...
						Global_2097536.f_2704[1] = 0;
						(*uParam0)[1] = 1;
						set_bit(&(Global_2097536.f_2832), 1);
						return 0;
					}
				}
			}
						...
						if (func_187())
						{
							...
							while (iVar8 < Var2.f_3)
							{
								...
								if (iVar6 < 0)
								{
									if (BitTest(Global_2097157.f_142.f_2, 0))
									{
										if (Global_2097157.f_211.f_36[0] >= leaderboards2_read_by_help_purple_int(iVar8, 0))
										{
											iVar6 = iVar8;
										}
									}
									else if (Global_2097157.f_211.f_3[0] >= leaderboards2_read_by_help_purple_float(iVar8, 0))
									{
										iVar6 = iVar8;
									}
								}
								...
								if (Global_2097536.f_2704[iVar10] < 11 || bVar11)
								{
									if (iVar3 == 0 || bVar11)
									{
										...
										while (iVar4 < Global_2097536.f_2708)
										{
											...
											{
												Global_2097536[iVar10 /*901*/][iVar3 /*75*/].f_67[iVar4] = leaderboards2_read_by_help_purple_int(iVar3, Global_2097536.f_2710[iVar4]);
											}
											else
											{
												Global_2097536[iVar10 /*901*/][iVar3 /*75*/].f_60[iVar4] = leaderboards2_read_by_help_purple_float(iVar3, Global_2097536.f_2710[iVar4]);
											}
											iVar4++;
										}
									...
									else if (Global_2097536.f_2704[iVar10] < 11)
									{
										...
										while (iVar4 < Global_2097536.f_2708)
										{
											if (BitTest(Global_2097536.f_2769, Global_2097536.f_2710[iVar4]))
											{
												Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/].f_67[iVar4] = leaderboards2_read_by_help_purple_int(iVar3, Global_2097536.f_2710[iVar4]);
											}
											else
											{
												Global_2097536[iVar10 /*901*/][Global_2097536.f_2704[iVar10] /*75*/].f_60[iVar4] = leaderboards2_read_by_help_purple_float(iVar3, Global_2097536.f_2710[iVar4]);
											}
											iVar4++;
										}
										if (iVar3 != 0)
...
int func_210(int* iParam0, bool bParam1)
{
	...
	if ((func_167() && (((iVar1 == 4 || iVar1 == 2) || iVar1 == 1) || iVar1 == 5)) || (!func_216() && network_is_signed_online()))
	{
	...
	{
		func_213(&(Global_2103068.f_3), func_215(&(Global_2103068.f_3)));
		if ((func_193(&(Global_2103068.f_49)) && !func_154(&(Global_2103068.f_49), 2000, 1)) && !network_is_signed_online())
		{
			set_bit(iParam0, 3);
			StringCopy(&(Global_2103068.f_3.f_1), "", 64);
			func_211(&(Global_2103068.f_3), 0);
...
int func_220(var uParam0)
{
	...
	switch (Global_2097157)
	{
			...
			if (func_227(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &Var3))
			{
				...
				while (iVar4 < Global_2097157.f_142.f_1)
				{
					if (!func_226(uParam0->f_44, iVar4))
					{
						...
						{
							set_bit(&(Global_2097157.f_142.f_2), iVar4);
						}
						else
						{
							clear_bit(&(Global_2097157.f_142.f_2), iVar4);
						}
					}
					bVar4++;
				}
		...
		case 4:
			if (network_is_game_in_progress() && func_222())
			{
				if (func_221())
				{
					Global_2097157 = 99;
...
void func_229(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4)
{
	...
	if (!Global_2097157.f_3)
	{
		...
		while (iVar1 < 32)
		{
			if (iVar1 < Global_2097157.f_142.f_1)
			{
				...
				{
					set_bit(&(Global_2097157.f_142.f_2), iVar1);
				}
				else
				{
					clear_bit(&(Global_2097157.f_142.f_2), iVar1);
				}
			}
			else
			{
	...
	if (iParam2 != 0)
	{
		set_bit(&(Global_2097157.f_142.f_2), iVar0);
	}
	else if (fParam3 != 0f)
	{
		clear_bit(&(Global_2097157.f_142.f_2), iVar0);
	}
}
...
void func_232(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	switch (iParam1)
	{
		...
		case 8:
			...
			Global_2097536.f_2710[0] = 0;
			Global_2097536.f_2710[1] = 1;
			set_bit(&(Global_2097536.f_2768), 1);
...
void func_244(int iParam0)
{
	...
	{
		if (!is_ped_injured((*iParam0)[0]))
		{
			func_4((*iParam0)[0], "GAME_LOSE_SELF", 1, 4);
		}
	}
	else if (!is_ped_injured((*iParam0)[1]))
	{
...
void func_247(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam4 != 5)
	{
		begin_scaleform_movie_method(*uParam0, "RESET_MOVIE");
		end_scaleform_movie_method();
	}
	begin_scaleform_movie_method(*uParam0, sVar0);
	begin_text_command_scaleform_string("STRING");
...
{
	begin_scaleform_movie_method(*uParam0, "CLEAR_SCORES");
	scaleform_movie_method_add_param_int(iParam1);
	end_scaleform_movie_method();
}
...
{
	set_cam_active_with_interp(iLocal_77, iLocal_75, 1500, 1, 1);
	set_cam_active(iLocal_78, true);
	set_cam_active_with_interp(iLocal_77, iLocal_78, 8000, 1, 1);
	attach_cam_to_entity(iLocal_80, iParam0, -0.0301f, 1.498f, 0.7435f, true);
	point_cam_at_entity(iLocal_80, iParam0, 0.0557f, -1.4905f, 0.4958f, true);
	set_cam_fov(iLocal_80, 35f);
}
...
void func_252(var uParam0, var uParam1, var uParam2, var uParam3, int* iParam4)
{
	...
	if (!is_cam_interpolating(iLocal_75))
	{
		bVar0 = false;
		func_333(uParam0);
		if (!bLocal_147)
		...
		if (uParam0->f_1 == 1)
		{
			if (!is_cam_interpolating(iLocal_84) && uParam0->f_3 == 2)
			{
				func_332(uParam3);
			}
		}
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			if (is_control_pressed(2, 228) && iLocal_30 == 0)
			{
				uParam0->f_1 = 1;
			}
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_309("DARTS_SHT_USE") && !func_309("DARTS_INSTR_W")) && !func_309("DARTS_INSTR_B")) && !func_309("DARTS_AIM_HLP")) && !func_309("DARTS_STD_HLP")) && !func_309("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						set_bit(&(Global_113386.f_18970.f_6), iLocal_167);
			...
			else if (timera() > get_random_int_in_range(1250, 2500))
			{
				func_295(&(uParam0->f_422), &(uParam0->f_249));
				func_292(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), 0);
			}
...
void func_253(var uParam0, var uParam1)
{
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			if (bLocal_148)
			{
				if (does_entity_exist(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
			...
			else
			{
				...
				Var0 = { _get_object_offset_from_coords(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
				if (does_entity_exist(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
					set_entity_coords(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], Var0, true, false, false, true);
				}
			}
			func_276(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), 0);
			func_261(uParam0, uParam1);
			if (bLocal_148)
			{
				if (iLocal_150)
				{
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/] = create_object(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_1, Local_40, true, true, false);
					Var0 = { _get_object_offset_from_coords(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
					set_entity_coords(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], Var0, true, false, false, true);
					fVar1 = get_random_float_in_range(0f, 90f);
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_17 = { 90f, fVar1, uParam0->f_243.f_4 };
					set_entity_rotation(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_17, 0, true);
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_23 = 1;
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24 = 0;
				}
			}
			...
			if (bLocal_148)
			{
				if (iLocal_150)
				{
					...
					while (iVar2 < iLocal_31 + 1)
					{
						...
						{
							uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/] = create_object(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_1, Local_40, true, true, false);
							Var0 = { _get_object_offset_from_coords(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11.f_2) };
							if (does_entity_exist(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/]))
							{
								set_entity_coords(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/], Var0, true, false, false, true);
							}
							fVar3 = get_random_float_in_range(0f, 90f);
							uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_17 = { 90f, fVar3, uParam0->f_243.f_4 };
							set_entity_rotation(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_17, 0, true);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (is_control_just_pressed(2, 190))
			{
				...
				Var0 = { get_entity_coords(uParam0->f_5[iLocal_30 /*79*/][iLocal_163 /*26*/], true) };
				func_53(Var0);
			}
		...
		case 2:
			if (is_control_just_pressed(2, 201) || (iLocal_149 && bLocal_148))
			{
				iLocal_139 = 1;
			}
			...
			if (iLocal_139 || timerb() > 2000)
			{
				...
				if (uParam0->f_425[iLocal_30] != uParam0->f_422[iLocal_30])
				{
					...
					play_sound_from_coord(-1, "DARTS_SCOREBOARD_MASTER", uParam0->f_243.f_1, 0, false, 0, false);
				}
...
{
	begin_scaleform_movie_method(*uParam0, "ADD_DARTS_SCORE");
	scaleform_movie_method_add_param_int(iParam1);
	scaleform_movie_method_add_param_int(iParam2);
	end_scaleform_movie_method();
}
...
int func_256(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iVar2 < 85)
	{
		if (BitTest(uVar0, 0))
		{
			if (iVar1 < 50)
			{
				func_4(player_ped_id(), "GAME_GOOD_SELF", 1, 4);
			}
			else if (iVar1 < 75)
			{
		...
		else if (BitTest(uVar0, 2))
		{
			if (iVar1 < 50)
			{
				func_4(player_ped_id(), "GAME_BAD_SELF", 1, 4);
			}
			else if (iVar1 < 68)
			{
		...
		else if (BitTest(uVar0, 1))
		{
			if (iVar1 < 50)
			{
				func_4(player_ped_id(), "GAME_GOOD_OTHER", 1, 4);
			}
			else if (iVar1 < 75)
			{
		...
		else if (BitTest(uVar0, 3))
		{
			if (iVar1 < 50)
			{
				func_4(player_ped_id(), "GAME_BAD_OTHER", 1, 4);
			}
			else if (iVar1 < 100)
			{
...
int func_257(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iVar2 < 75)
	{
		if (BitTest(uVar0, 0))
		{
			if (iVar1 < 35)
			{
				func_4(player_ped_id(), "DARTS_HAPPY", 1, 4);
			}
			else if (iVar1 < 70)
			{
				func_4(*uParam1, "DARTS_PLAYING_WELL", 0, 4);
		...
		else if (BitTest(uVar0, 2))
		{
			...
			else if (iVar1 < 68 && !does_entity_exist(func_504()))
			{
				func_4(*uParam1, "DARTS_PLAYING_POORLY", 0, 4);
			}
			else if (iVar1 < 86)
		...
		else if (BitTest(uVar0, 1))
		{
			if (iVar1 < 40)
			{
				func_4(player_ped_id(), "DARTS_PLAYING_WELL", 1, 4);
			}
			else if (iVar1 < 60)
			{
				func_4(player_ped_id(), "GAME_GOOD_OTHER", 1, 4);
		...
		else if (BitTest(uVar0, 3))
		{
			...
			{
				func_4(player_ped_id(), "GAME_HECKLE", 1, 4);
			}
			return 1;
		}
	}
...
void func_262(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	end_text_command_print(iParam3, true);
}
...
int func_264(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 75)
	{
		if (does_entity_exist(func_504()))
		{
			if (bParam1)
			{
				func_4(player_ped_id(), "DARTS_140", 1, 4);
			}
			else
			{
...
int func_266(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 75)
	{
		if (does_entity_exist(func_504()))
		{
			if (bParam1)
			{
				func_4(player_ped_id(), "DARTS_180", 1, 4);
			}
			else
			{
...
void func_271(int iParam0)
{
	switch (iParam0)
	{
		...
		case 7:
			Global_113386.f_18970.f_7 = (to_float(Global_113386.f_18970.f_2) / to_float(Global_113386.f_18970.f_5));
			break;
		
		case 8:
			Global_113386.f_18970.f_8 = (to_float(Global_113386.f_18970.f_4) / to_float(Global_113386.f_18970.f_5));
			break;
	}
}
...
void func_276(var uParam0, var uParam1, bool bParam2)
{
	...
	fVar1 = get_angle_between_2d_vectors(0f, 1f, Var3.f_0, Var3.f_2);
	fVar0 = func_277(Var3);
	uParam0->f_22 = fVar0;
	if (bParam2)
	{
		play_sound_from_coord(-1, "DARTS_HIT_DART_MASTER", uParam1->f_1, 0, false, 0, false);
	}
	if (fVar0 < 0.009f)
	{
		play_sound_from_coord(-1, "DARTS_HIT_BULLSEYE_MASTER", uParam1->f_1, 0, false, 0, false);
		uParam0->f_20 = 50;
	}
	else if (fVar0 < 0.021f)
	{
		play_sound_from_coord(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
		uParam0->f_20 = 25;
	}
	else if (fVar0 > 0.3f)
	{
		play_sound_from_coord(-1, "DARTS_HIT_WALL_MASTER", uParam1->f_1, 0, false, 0, false);
		uParam0->f_20 = 0;
	}
	...
	else
	{
		...
		{
			uParam0->f_21 = 3;
			play_sound_from_coord(-1, "DARTS_SCORE_TRIPLE_MASTER", uParam1->f_1, 0, false, 0, false);
		}
		else if (fVar0 > 0.2132f && fVar0 < 0.226f)
		{
			uParam0->f_21 = 2;
			play_sound_from_coord(-1, "DARTS_SCORE_DOUBLE_MASTER", uParam1->f_1, 0, false, 0, false);
		}
		else
		{
			uParam0->f_21 = 1;
		...
		while (iVar4 < 21)
		{
			if (fVar1 >= (fVar2 - 9f) && fVar1 < (fVar2 + 9f))
			{
				...
				{
					play_sound_from_coord(-1, "DARTS_HIT_WIRE_MASTER", uParam1->f_1, 0, false, 0, false);
				}
...
int func_279(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (uParam0->f_2.f_1 > (uParam0->f_8.f_1 - 0.04f))
	{
		uParam0->f_23 = 1;
		uParam0->f_24 = 0;
		Var0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_11, (uParam0->f_11.f_1 + fLocal_34), uParam0->f_11.f_2) };
		set_entity_coords(*uParam0, Var0, true, false, false, true);
		return 1;
	}
	Var0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_2, (uParam0->f_2.f_1 + fLocal_34), uParam0->f_2.f_2) };
	set_entity_coords(*uParam0, Var0, true, false, false, true);
	uParam0->f_17.f_1 = (uParam0->f_17.f_1 + (1000f * fVar2));
	set_entity_rotation(*uParam0, uParam0->f_17, 0, true);
...
void func_280(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (func_283())
	{
		...
		if (iParam3 == 1)
		{
			draw_sprite(sParam0, sParam1, func_282(Var0.f_0), func_281(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, bParam6, 0);
		}
		else
		{
			draw_sprite(sParam0, sParam1, func_282(Var0.f_0), func_281(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, bParam6, 0);
...
void func_292(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!bParam4 && uParam3->f_3 < 30)
	{
		...
		iVar6 = get_random_int_in_range(func_294(uParam3), 150);
		if (uParam3->f_2 > 140)
		{
	...
	else
	{
		...
		uParam0->f_24 = 1;
		func_293(uParam0);
		*uParam0 = create_object(uParam0->f_1, Local_40, false, false, false);
		fVar1 = get_random_float_in_range(0f, 90f);
		Var7 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, Local_41) };
		Var8 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_34), uParam0->f_8.f_2) };
		fVar2 = get_heading_from_vector_2d((Var7.f_0 - Var8.f_0), (Var7.f_1 - Var8.f_1));
		fVar2 = (fVar2 - 180f);
		uParam0->f_17 = { 90f, fVar1, fVar2 };
		set_entity_rotation(*uParam0, uParam0->f_17, 0, true);
		uParam0->f_2 = { Local_41 };
		*uParam2 = 3;
		play_sound_from_entity(-1, "DARTS_THROW_DART_MASTER", *uParam0, 0, false, 0);
	}
}
...
void func_293(var uParam0)
{
	...
	fVar2 = get_heading_from_vector_2d(uParam0->f_5, uParam0->f_5.f_1);
	uParam0->f_17.f_2 = (fVar2 - 180f);
	fVar3 = (tan(uParam0->f_17.f_2) * fVar4);
...
int func_299(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	switch (iParam6)
	{
		case 0:
			...
			{
				if (!(is_control_just_pressed(2, 223) && iLocal_56) && !bParam4)
				{
					iLocal_53 = 1;
					iLocal_54 = 1;
					if (!iLocal_55)
...
int func_300(var uParam0)
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			...
			else if ((iLocal_91 < 120 && iLocal_91 > -120) && (get_game_timer() - iLocal_92) > 500)
			{
				iLocal_90 = 0;
			}
...
void func_304(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	Var0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	if (iParam3 == 1)
	{
		Var0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	}
	get_screen_coord_from_world_coord(Var0, &Local_38, &(Local_38.f_1));
...
void func_305(var uParam0, int iParam1)
{
	...
	fVar0 = 0.033367f;
	bVar7 = false;
	fVar3 = get_control_unbound_normal(2, 218);
	fVar4 = get_control_unbound_normal(2, 219);
	...
	if (iParam1 == 0)
	{
		fVar2 = get_random_float_in_range((0f - fLocal_44), (0f + fLocal_44));
		fVar1 = get_random_float_in_range((0f - fLocal_43), (0f + fLocal_43));
...
void func_307(var uParam0, struct<4> Param1, var uParam2, var uParam3)
{
	...
	Var0 = { 0f, 0f, 0f };
	Var0.f_0 = (Var0.f_0 + get_random_float_in_range(-0.1f, 0.1f));
	Var0.f_2 = (Var0.f_2 + get_random_float_in_range(-0.1f, 0.1f));
...
int func_308(var uParam0, var uParam1, bool bParam2)
{
	...
	if (does_entity_exist(*uParam0))
	{
		set_entity_coords(*uParam0, Local_40, true, false, false, true);
	}
	else
	{
		*uParam0 = create_object(uParam0->f_1, Local_40, false, false, false);
	...
	uParam0->f_24 = 1;
	func_293(uParam0);
	fVar4 = get_random_float_in_range(0f, 90f);
	Var1 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, Local_41) };
	Var2 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, (uParam0->f_14 + 0.0035f), (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	fVar5 = get_heading_from_vector_2d((Var1.f_0 - Var2.f_0), (Var1.f_1 - Var2.f_1));
	fVar5 = (fVar5 - 180f);
	fVar3 = 90f;
	...
	Var0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_34), uParam0->f_8.f_2) };
	get_screen_coord_from_world_coord(Var0, &Local_39, &(Local_39.f_1));
	return 1;
}
...
int func_311(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch (*uParam2)
	{
		case 0:
			...
			*uParam3 = { get_offset_from_entity_in_world_coords(*uParam1, Var0) };
			func_313(*uParam3);
			settimerb(0);
			*uParam2 = 1;
			break;
...
void func_312()
{
	set_cam_active_with_interp(iLocal_75, iLocal_87, 2000, 1, 1);
	destroy_cam(iLocal_87, false);
}
...
void func_313(struct<3> Param0)
{
	...
	iLocal_87 = create_camera_with_params(26379945, Param0, Var0, 65f, false, 2);
	set_cam_active_with_interp(iLocal_87, iLocal_75, 2000, 1, 1);
}
...
int func_318(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1:
			if (is_control_pressed(2, 228))
			{
				if (!is_cam_interpolating(iLocal_84))
				{
					func_323();
		...
		case 3:
			func_325(0);
			func_505();
			if (does_cam_exist(iLocal_176))
			{
				if (is_cam_active(iLocal_176))
				{
					set_cam_active(iLocal_176, false);
				}
				destroy_cam(iLocal_176, false);
			}
			*uParam0 = 0;
			return 0;
			break;
...
void func_323()
{
	...
	func_324();
	init_pc_scripted_controls("Darts Zoom");
	iLocal_136 = 1;
}
...
void func_325(bool bParam0)
{
	if (bParam0)
	{
		set_cam_active_with_interp(iLocal_84, iLocal_75, 1000, 1, 1);
	}
	else
	{
		set_cam_active_with_interp(iLocal_75, iLocal_84, 1000, 1, 1);
	}
}
...
void func_329(var uParam0)
{
	...
	{
		if ((is_control_pressed(2, 201) || is_control_just_pressed(2, 223)) && iLocal_54)
		{
			*uParam0 = 6;
		}
	}
...
int func_331(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 < 8)
	{
		...
		set_bit(&(uParam0->f_2[iVar0 /*15*/].f_12), 0);
		if (iParam4 == 1)
		{
			set_bit(&(uParam0->f_2[iVar0 /*15*/].f_13), 0);
		}
...
void func_333(var uParam0)
{
	...
	if (!iLocal_54)
	{
		if (!is_control_pressed(2, 201) && !is_control_pressed(2, 202))
		{
			iLocal_54 = 1;
		}
		else
...
{
	display_radar(false);
	if (is_cam_active(iLocal_77))
	{
		set_cam_active(iLocal_77, false);
	}
	if (is_cam_active(iLocal_81))
	{
		set_cam_active(iLocal_81, false);
	}
	if (is_screen_faded_out())
	{
		func_342();
...
{
	begin_scaleform_movie_method(*uParam0, "SET_PLAYER_SETS_AND_LEGS");
	scaleform_movie_method_add_param_int(iParam1);
	scaleform_movie_method_add_param_int(iParam2);
...
int func_350(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_405())
		{
			...
			Global_4539962 = get_game_timer() + 300;
		}
		else if (func_402() && get_game_timer() > Global_4539962)
		{
			if (Global_4539961 == uParam0->f_660)
			{
				iVar2 = func_401(0);
		...
		if ((is_control_just_pressed(2, 201) || iVar1 == 1) && uParam0->f_660 == 2)
		{
			...
			*uParam2 = func_379(uParam0->f_664 + 1, 0);
			play_sound_frontend(-1, "OK", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			return 1;
		}
		func_353(1, -1, 1, 0, 1, -1082130432, 0, 0, -1);
		if (is_control_just_released(2, 202) || func_352())
		{
			func_351(0, 0);
			func_337(&(uParam0->f_666), 8, 0);
		...
		if (iVar5 == 1 && Global_23150.f_6119)
		{
			...
			if (get_hash_key(&(Global_23150.f_5081)) != 0 && Global_23150.f_5157 != -1)
			{
				...
				if (Global_23150.f_5159 != 0)
				{
					...
					draw_sprite(func_26(Global_23150.f_5159), func_23(Global_23150.f_5159, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
			...
			if (get_hash_key(&(Global_4539885.f_21)) != 0 && Global_4539885.f_65 != -1)
			{
				...
				if (Global_4539885.f_67 != 0)
				{
					...
					draw_sprite(func_26(Global_4539885.f_67), func_23(Global_4539885.f_67, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
				fVar49 = (fVar49 + (((get_rendered_character_height(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_19(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_19(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_26(26), func_23(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
										if (func_19(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_19(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_26(27), func_23(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
									}
												...
												if (func_19(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_19(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_26(Global_23150.f_4824[(iVar22 + iVar28)]), func_23(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_26(Global_23150.f_4824[(iVar22 + iVar28)]), func_23(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
									...
									if (get_hash_key(&(Global_23150.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_357() && _get_number_of_references_of_script_with_name_hash(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													if (Global_23150.f_2130[iVar24])
												...
												if (func_19(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_19(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																draw_sprite(func_26(Global_23150.f_4824[(iVar22 + iVar14)]), func_23(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (Global_23147 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_26(Global_23150.f_4824[(iVar22 + iVar14)]), func_23(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_26(Global_23150.f_4824[(iVar22 + iVar14)]), func_23(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
													}
									...
									if (func_19(Global_23150.f_4824[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_19(Global_23150.f_4824[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												draw_sprite(func_26(Global_23150.f_4824[iVar22]), func_23(Global_23150.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_354(Global_23150.f_4824[iVar22])), (fVar37 * func_354(Global_23150.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
											}
										}
									}
								}
...
int func_376(bool bParam0, bool bParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_378(8, -1) && func_377() != 65)) || (get_pause_menu_state() != 0 && !bParam1)) || (is_player_switch_in_progress() && !bParam0)) || is_commerce_store_open()) || Global_78579) || Global_23150.f_8807) || is_warning_message_active()) || Global_100493.f_1458)
	{
		return 0;
	}
	return 1;
...
int func_382(int* iParam0)
{
	...
	if ((fVar0 > 0.8f || is_control_pressed(2, 190)) || is_disabled_control_pressed(2, 190))
	{
		if (!func_426(iParam0))
		{
			func_381(iParam0);
...
int func_398(int* iParam0)
{
	...
	if (fVar0 < -0.8f || is_control_pressed(2, 189))
	{
		if (!func_426(iParam0))
		{
			func_381(iParam0);
...
int func_399(int* iParam0)
{
	...
	if (fVar0 > 0.8f || is_control_pressed(2, 187))
	{
		if (!func_426(iParam0))
		{
			func_381(iParam0);
...
int func_400(int* iParam0)
{
	...
	if (fVar0 < -0.8f || is_control_pressed(2, 188))
	{
		if (!func_426(iParam0))
		{
			func_381(iParam0);
...
int func_413(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* iParam5)
{
	...
	if ((func_437() && get_game_timer() >= iLocal_164 + 1000) && *iParam0 != 8)
	{
		if (!is_screen_faded_out() && !is_screen_fading_out())
		{
			do_screen_fade_out(500);
	...
	switch (*iParam0)
	{
		...
		case 3:
			...
			{
				case 0:
					if (!is_cam_interpolating(iLocal_83))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 20;
		...
		case 4:
			...
			{
				case 0:
					if (!is_cam_interpolating(iLocal_82))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 50;
				...
				case 1:
					...
					if (func_429(iParam5) > 5f)
					{
						func_441(iParam5);
						clear_help(true);
						play_sound_frontend(-1, "CAM_PAN_DARTS", "HUD_MINI_GAME_SOUNDSET", true);
		...
		case 5:
			if (!is_cam_interpolating(iLocal_83) && !func_309("DARTS_DBL_WIN"))
			{
		...
		case 6:
			play_sound_frontend(-1, "CAM_PAN_DARTS", "HUD_MINI_GAME_SOUNDSET", true);
			set_cam_active_with_interp(iLocal_75, iLocal_83, 1500, 1, 1);
			*iParam0 = 7;
			break;
...
void func_414(int* iParam0)
{
	...
	if (does_entity_exist(*iParam0))
	{
		set_entity_coords(*iParam0, Var0, true, false, false, true);
...
{
	stop_cam_pointing(iLocal_83);
	set_cam_fov(iLocal_83, 35f);
	set_cam_coord(iLocal_83, _get_object_offset_from_coords(Param0, fParam1, Param2));
	set_cam_rot(iLocal_83, Vector(fParam1, 0f, 0f) - Param3, 2);
	set_cam_active_with_interp(iLocal_83, iLocal_82, iParam4, 1, 1);
}
...
void func_417(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7)
{
	...
	begin_scaleform_movie_method(*uParam0, sVar0);
	begin_text_command_scaleform_string("STRING");
	set_colour_of_next_text_component(iParam4);
	add_text_component_substring_text_label(sParam1);
	end_text_command_scaleform_string();
	if (!is_string_null_or_empty(sParam2))
	{
...
void func_419()
{
	...
	if (is_cam_active(iLocal_79))
	{
		set_cam_active(iLocal_79, false);
	}
	if (is_cam_active(iLocal_80))
	{
		set_cam_active(iLocal_80, false);
	}
	if (is_cam_active(iLocal_81))
	{
		set_cam_active(iLocal_81, false);
...
{
	stop_cam_pointing(iLocal_82);
	set_cam_fov(iLocal_82, 35f);
	set_cam_coord(iLocal_82, _get_object_offset_from_coords(Param0, fParam1, Param2));
	set_cam_rot(iLocal_82, Vector(fParam1, 0f, 0f) - Param3, 2);
	if (bParam5)
	{
	...
	{
		set_cam_active_with_interp(iLocal_82, iLocal_83, iParam4, 1, 1);
	}
}
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_6(iParam2), 1);
}
...
int func_438(var uParam0)
{
	...
	if (does_entity_exist(iVar0))
	{
		if (!func_439(iVar0))
		{
			if (!is_ped_injured(player_ped_id()) && is_entity_at_entity(iVar0, player_ped_id(), Local_137, false, true, 0))
			{
...
{
	iParam1++;
	begin_scaleform_movie_method(*uParam0, "SET_PLAYER_HIGHLIGHT");
	scaleform_movie_method_add_param_int(iParam1);
	end_scaleform_movie_method();
}
...
{
	begin_scaleform_movie_method(*uParam0, "SET_DARTS_PLAYER_NAMES");
	func_37(sParam1);
	func_37(sParam2);
	end_scaleform_movie_method();
}
...
void func_445(float fParam0, struct<4> Param1, var uParam2, var uParam3, var* uParam4, var uParam5)
{
	...
	if (does_entity_exist(func_504()) && !is_ped_injured(func_504()))
	{
		remove_ped_from_group(func_504());
	}
	else
	{
		if (does_entity_exist(uParam5->f_5) && !is_ped_injured(uParam5->f_5))
		{
			set_entity_as_mission_entity(uParam5->f_5, true, true);
		...
		{
			iLocal_138[1] = create_ped(26, iLocal_172, Param1.f_3, fParam0, true, true);
		}
		if (decor_exist_on(iLocal_138[1], "Darts_name"))
		{
			iVar0 = decor_get_int(iLocal_138[1], "Darts_name");
			if (954610991 == iVar0)
			{
				sLocal_220 = func_451("RAYMOND");
				iLocal_221 = 954610991;
		...
		decor_set_int(iLocal_138[1], "Darts_name", iLocal_221);
	}
	iVar1 = get_entity_model(iLocal_138[1]);
	func_446(iVar1);
	task_turn_ped_to_face_entity(iLocal_138[1], iLocal_138[0], 0);
	task_turn_ped_to_face_entity(iLocal_138[0], iLocal_138[1], 0);
}
...
int func_447(var* uParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < get_ped_nearby_peds(player_ped_id(), uParam0, -1))
	{
		if (!is_ped_injured((*uParam0)[iVar0]))
		{
			if ((((((get_entity_model((*uParam0)[iVar0]) == joaat("a_f_m_salton_01") || get_entity_model((*uParam0)[iVar0]) == joaat("a_f_o_salton_01")) || get_entity_model((*uParam0)[iVar0]) == joaat("a_m_y_vinewood_01")) || get_entity_model((*uParam0)[iVar0]) == joaat("a_m_y_stlat_01")) || get_entity_model((*uParam0)[iVar0]) == joaat("a_m_y_vinewood_04")) || get_entity_model((*uParam0)[iVar0]) == joaat("a_m_y_stwhi_02")) || get_entity_model((*uParam0)[iVar0]) == joaat("a_m_y_vinewood_03"))
			{
...
char* func_451(char* sParam0)
{
	if (get_current_language() == 7)
	{
		...
		else if (are_strings_equal(sParam0, "LAMAR"))
		{
			return "??????????";
		}
		else if (are_strings_equal(sParam0, "JIMMY"))
		{
			return "????????????";
		}
		else if (are_strings_equal(sParam0, "KRISTY"))
		{
			return "????????????";
		}
		else if (are_strings_equal(sParam0, "MARLENE"))
		{
			return "????????????";
		}
		else if (are_strings_equal(sParam0, "LORIE"))
		{
			return "????????";
		}
		else if (are_strings_equal(sParam0, "SHELLEY"))
		{
			return "??????????";
		}
		else if (are_strings_equal(sParam0, "RAYMOND"))
		{
			return "??????????????";
		}
		else if (are_strings_equal(sParam0, "JOHAN"))
		{
			return "??????????";
		}
		else if (are_strings_equal(sParam0, "STAN"))
		{
			return "????????";
		}
		else if (are_strings_equal(sParam0, "VINCE"))
		{
			return "????????";
		}
	}
...
void func_452(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	Local_40 = { _get_object_offset_from_coords(uParam0->f_1, uParam0->f_4, Local_41) };
...
{
	*uParam0 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, -0.4f, (-2.4f + fLocal_34), -1.7272f) };
	uParam0->f_3 = { _get_object_offset_from_coords(uParam1->f_1, uParam1->f_4, 0.5f, (-2.4f + fLocal_34), -1.7272f) };
}

int func_455(var uParam0, var uParam1)
{
	if (!request_script_audio_bank("SCRIPT\DARTS", false, -1))
	{
		return 0;
	}
	if (!request_script_audio_bank("SCRIPT\FAMILY1_2", false, -1))
	{
		return 0;
	}
	if ((((((((((((!has_model_loaded(iLocal_28) || !has_model_loaded(iLocal_29)) || !has_model_loaded(iLocal_37)) || !has_model_loaded(iLocal_172)) || !has_scaleform_movie_loaded(*uParam0)) || !has_scaleform_movie_loaded(uParam1->f_645)) || !has_scaleform_movie_loaded(uParam1->f_57)) || !has_scaleform_movie_loaded(uParam1->f_62)) || !has_additional_text_loaded(3)) || !has_streamed_texture_dict_loaded("Darts")) || !has_anim_dict_loaded(sLocal_222)) || !has_anim_dict_loaded(sLocal_223)) || !func_456(0, -1, 0))
	{
		return 0;
	}
	return 1;
...
void func_458(var uParam0, var uParam1)
{
	...
	request_model(iLocal_37);
	request_model(iLocal_172);
	request_streamed_texture_dict("Darts", false);
	request_streamed_texture_dict("ShopUI_Title_Darts", false);
	request_anim_dict(sLocal_222);
	request_anim_dict(sLocal_223);
	*uParam0 = request_scaleform_movie("darts_scoreboard");
...
void func_461(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	...
	{
		iParam0->f_18 = { _get_object_offset_from_coords(Param2, fParam3, -0.687645f, -0.350352f, 0.343273f) };
...
void func_466(struct<3> Param0, float fParam1)
{
	...
	Var1 = { _get_object_offset_from_coords(Param0, fParam1, Var8) };
	Var3 = { fVar10, 0f, (fParam1 - fVar9) };
	Var0 = { _get_object_offset_from_coords(Param0, fParam1, Var11) };
	Var2 = { fVar13, 0f, (fParam1 - fVar12) };
	Var4 = { _get_object_offset_from_coords(Param0, fParam1, Var14) };
	Var5 = { 0.8351f, -0.0048f, (fParam1 - 186.5073f) };
	Var15 = { _get_object_offset_from_coords(Param0, fParam1, Var16) };
	Var6 = { 0.8351f, -0.0048f, (fParam1 - 186.5073f) };
	iLocal_75 = create_camera_with_params(26379945, Var0, Var2, fVar7, false, 2);
	iLocal_76 = create_camera_with_params(26379945, Var1, Var3, fVar7, false, 2);
	iLocal_77 = create_camera_with_params(26379945, Var4, Var5, 65f, false, 2);
	iLocal_78 = create_camera_with_params(26379945, Var15, Var6, 65f, false, 2);
	iLocal_79 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, false, 2);
	iLocal_80 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, false, 2);
	iLocal_82 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, false, 2);
	iLocal_83 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, false, 2);
	iLocal_81 = create_camera_with_params(26379945, 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, false, 2);
	set_cam_fov(iLocal_77, 43.35f);
	set_cam_fov(iLocal_78, 42.35f);
	shake_cam(iLocal_77, "HAND_SHAKE", 0.1f);
	shake_cam(iLocal_78, "HAND_SHAKE", 0.1f);
}
...
void func_475(int iParam0, var uParam1, var uParam2)
{
	...
	if (!is_entity_dead(func_504(), false))
	{
		set_ped_as_group_member(func_504(), func_487());
...
void func_480()
{
	...
	{
		func_86(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_481() == 2 == 0 && !network_is_game_in_progress())
			{
...
void func_482(int iParam0, bool bParam1)
{
	...
	{
		leaderboards_write_add_column(103, iLocal_106[1], 0f);
		leaderboards_write_add_column(99, iLocal_106[2], 0f);
		leaderboards_write_add_column(109, iLocal_106[3], 0f);
		leaderboards_write_add_column(106, iLocal_106[5], 0f);
		leaderboards_write_add_column(2, iLocal_106[10], 0f);
		leaderboards_write_add_column(107, iLocal_106[8], 0f);
		leaderboards_write_add_column(116, iLocal_106[6], 0f);
	}
}
...
void func_483(var uParam0, int iParam1)
{
	...
	if (!Global_78587)
	{
		if (!is_player_dead(get_player_index()))
		{
			if (!Global_78588)
			{
				if (is_screen_faded_out() && !func_478(0))
				{
...
void func_484(var uParam0)
{
	if (does_entity_exist(*uParam0) && !is_ped_injured(*uParam0))
	{
		clear_sequence_task(&iLocal_173);
		open_sequence_task(&iLocal_173);
		if (does_entity_exist(iLocal_138[0]))
		{
			task_look_at_entity(0, iLocal_138[0], 8000, 2049, 3);
		}
		...
		if (bLocal_151)
		{
			if (!BitTest(Global_113347, 10))
			{
				task_follow_nav_mesh_to_coord(0, func_485(iLocal_175 == 2, Local_210, Local_212), 1f, 20000, 0.25f, false, func_124(iLocal_175 == 2, fLocal_214, fLocal_216));
			}
			else
			{
				task_follow_nav_mesh_to_coord(0, func_485(iLocal_175 == 2, Local_209, Local_211), 1f, 20000, 0.25f, false, func_124(iLocal_175 == 2, fLocal_213, fLocal_215));
			}
			task_start_scenario_in_place(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, true);
		}
		else
		{
			task_follow_nav_mesh_to_coord(0, func_485(iLocal_175 == 2, Local_209, Local_211), 1f, 20000, 0.25f, false, func_124(iLocal_175 == 2, 172.6813f, 142.6717f));
			task_start_scenario_in_place(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, true);
		}
		close_sequence_task(iLocal_173);
		task_perform_sequence(*uParam0, iLocal_173);
		set_ped_keep_task(*uParam0, true);
	}
	set_model_as_no_longer_needed(iLocal_172);
}
...
{
	if (is_ped_injured(func_504()))
	{
		return;
	}
	if (bParam1)
	{
		if (!is_ped_group_member(func_504(), func_487()))
		{
			return;
		}
		if (!is_ped_injured(func_503()))
		{
			if (!is_ped_group_member(func_503(), func_487()))
			{
				return;
			}
		}
...
void func_505()
{
	...
	func_324();
	init_pc_scripted_controls("Darts");
	iLocal_135 = 1;
}
