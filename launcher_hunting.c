...
void __EntryFunction__()
{
	...
	iLocal_54 = get_weapontype_model(joaat("weapon_sniperrifle"));
	iLocal_55 = get_weapon_component_type_model(joaat("component_at_scope_large"));
	iLocal_56 = get_weapon_component_type_model(joaat("component_at_ar_supp_02"));
	...
	clear_area(Var1, 3f, true, false, false, false);
	while (true)
	{
		wait(0);
		if (!func_199(&Var0, 1))
		...
		if (Var0.f_0 == 25)
		{
			...
			{
				set_ped_max_move_blend_ratio(player_ped_id(), 3f);
			}
		}
		if (func_171(&Var0, 0) && absf((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_262(&Var0, 1);
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && !func_148()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_190(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_200(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_202(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_201(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_202(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_201(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_208(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_211(int iParam0, float fParam1)
{
	...
	{
		if (func_222(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_213(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !has_anim_dict_loaded("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				iLocal_58 = create_weapon_object(joaat("weapon_sniperrifle"), 0, Local_57, false, 1f, 0, 0, 1);
				give_weapon_component_to_weapon_object(iLocal_58, joaat("component_at_scope_large"));
				give_weapon_component_to_weapon_object(iLocal_58, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			if (does_object_of_type_exist_at_coords(Local_57, 1f, iLocal_54, false))
			{
				set_entity_rotation(iLocal_58, 0f, -90f, -162.64f, 2, true);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_239(int* iParam0, struct<3> Param1, float fParam2, int iParam3)
{
...
int func_242(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_246(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_245(&iVar0) || !func_247(&(uParam0->f_48))) || !has_anim_dict_loaded("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_259(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_260(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_261(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
