...
void __EntryFunction__()
{
	...
	while (!bVar0)
	{
		...
		if ((!func_163(get_player_index()) && func_157(get_player_index(), 0, -1)) || func_155(player_id()))
		{
			if (func_154(get_player_index()))
			{
				if (Global_1853348[player_id() /*834*/].f_267.f_32 != -1)
				{
					iVar1 = Global_1853348[player_id() /*834*/].f_267.f_32;
					bVar0 = true;
					func_153(&iLocal_127);
				}
				else if (bVar2)
	...
	Local_146.f_6 = Global_1853348[player_id() /*834*/].f_267.f_33;
	if (func_139(player_id()))
	{
		Local_146.f_6 = Global_2689235[player_id() /*453*/].f_318.f_7 + 32;
	}
	...
	Local_147.f_13 = Global_1853348[player_id() /*834*/].f_267.f_33;
	...
	{
		Local_147.f_13 = Global_2689235[player_id() /*453*/].f_318.f_7 + 32;
		iLocal_206 = 2;
	}
	...
	while (true)
	{
		...
		if (!func_163(get_player_index()))
		{
			if ((((!func_157(get_player_index(), 0, -1) && !func_154(get_player_index())) && !is_player_in_cutscene(get_player_index())) && !func_155(player_id())) && Local_218[participant_id_to_int() /*5*/].f_4 < 6)
			{
				if (func_124(&(Local_218[participant_id_to_int() /*5*/]), 6))
				{
		...
		switch (Local_218[participant_id_to_int() /*5*/].f_2)
		{
			case 0:
				if (func_123() == 1)
				{
					Local_218[participant_id_to_int() /*5*/].f_2 = 1;
				}
				else if (func_123() == 4)
				{
					Local_218[participant_id_to_int() /*5*/].f_2 = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_218[participant_id_to_int() /*5*/].f_2 = 4;
				}
				break;
...
void func_3()
{
	...
	{
		switch (get_event_at_index(1, iVar2))
		{
			case 174:
	...
	while (iVar4 < 2)
	{
		...
		bVar7 = false;
		bVar3 = false;
		while (bVar3 < network_get_max_num_participants())
		{
			iVar5 = int_to_participantindex(bVar3);
			if (network_is_participant_active(iVar5))
			{
				...
				if (iLocal_217[iVar4] > Local_216[iVar4 /*21*/].f_11)
				{
					if (!bVar6)
					{
						...
						{
							func_18(1473310688, network_get_player_index(iVar5), iVar4);
							bVar6 = true;
						}
					}
				}
		...
		if (iLocal_217[iVar4] > 0)
		{
			...
			else if (func_14(&iLocal_213) >= 1f)
			{
				...
				while (bVar3 < network_get_max_num_participants())
				{
					if (network_is_participant_active(int_to_participantindex(bVar3)))
					{
						if (Local_218[bVar3 /*5*/].f_1 == iVar4 && func_19(&(Local_218[bVar3 /*5*/]), 1))
						{
							iVar8 = bVar3;
		...
		if (iVar4 == iVar0)
		{
			if (iLocal_217[iVar4] >= Local_216[iVar4 /*21*/].f_10)
			{
				...
				iVar13 = get_random_int_in_range(0, 65535);
				bVar3 = false;
				while (bVar3 < network_get_max_num_participants())
				{
					if (network_is_participant_active(int_to_participantindex(bVar3)))
					{
						iVar14 = network_get_player_index(int_to_participantindex(bVar3));
...
void func_4(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	Var0.f_3 = iParam2;
	Var0.f_5 = iParam0;
	_trigger_script_event_2(1, &Var0, 6, func_5(iParam1));
}
...
int func_7(var uParam0, struct<13>[] Param1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, int iParam61)
{
	...
	while (iVar4 < network_get_max_num_participants())
	{
		...
		if (network_is_participant_active(iVar5))
		{
			iVar2 = network_get_player_index(int_to_participantindex(bVar4));
			if ((uParam0[bVar4 /*5*/])->f_1 == iParam61 && func_19(uParam0[bVar4 /*5*/], 1))
			{
				...
				if (func_8(iVar3))
				{
					if (func_8(iVar3))
					{
						...
						{
							iVar0 = bVar4;
							fVar1 = get_distance_between_coords(get_entity_coords(iVar3, true), Param1[0 /*13*/], true);
						}
						else
						{
							fVar6 = get_distance_between_coords(get_entity_coords(iVar3, true), Param1[0 /*13*/], true);
							if (fVar6 < fVar1)
							{
								fVar1 = fVar6;
								iVar0 = bVar4;
...
void func_21(int iParam0, var uParam1, bool bParam2)
{
	...
	Var0.f_4 = iParam0;
	Var0.f_3 = uParam1;
	_trigger_script_event_2(1, &Var0, 6, func_5(iParam0));
}
...
{
	if (get_event_data(1, iParam0, iParam1, 6))
	{
...
void func_25(var uParam0, var uParam1, var uParam2)
{
	...
	{
		if (func_122(get_player_index()))
		{
			func_124(&(Local_218[participant_id_to_int() /*5*/]), 5);
		}
	}
	func_121(&Local_218, &Local_146, uParam2, &Local_216);
	func_118(uParam2);
	switch (Local_218[participant_id_to_int() /*5*/].f_4)
	{
		case 0:
			if (!BitTest(Local_218[participant_id_to_int() /*5*/].f_3, 2))
			{
				func_46(uParam1, uParam0, &Local_146);
			}
			if (func_45(&(Local_218[participant_id_to_int() /*5*/].f_3), 8))
			{
				...
				{
					func_44(&(Local_218[participant_id_to_int() /*5*/]), 8, 0);
					func_44(&(Local_218[participant_id_to_int() /*5*/]), 2, 0);
					func_44(&(Local_218[participant_id_to_int() /*5*/]), 7, 0);
					func_43(&(Local_218[participant_id_to_int() /*5*/]), -1);
					func_42(&(Local_218[participant_id_to_int() /*5*/]));
					func_124(&(Local_218[participant_id_to_int() /*5*/]), 0);
					func_41(&Local_146, 0);
					func_38(&iLocal_137);
					func_11(&iLocal_118);
					func_153(&iLocal_133);
		...
		case 1:
			if (Local_218[participant_id_to_int() /*5*/].f_1 >= 0)
			{
				if (!is_string_null_or_empty(Local_146.f_3))
				{
					if (has_script_loaded(Local_146.f_3))
					{
						func_124(&(Local_218[participant_id_to_int() /*5*/]), 2);
					}
					else if (does_script_exist(Local_146.f_3))
					{
						request_script(Local_146.f_3);
					}
				}
			}
			else
		...
		case 2:
			...
			func_44(&(Local_218[participant_id_to_int() /*5*/]), 8, 0);
			func_44(&(Local_218[participant_id_to_int() /*5*/]), 7, 1);
			iLocal_97 = 1;
			if (!func_19(&(Local_218[participant_id_to_int() /*5*/]), 0) && !network_is_script_active(Local_146.f_3, Local_146.f_6, false, 0))
			{
				iLocal_97 = 0;
				if (func_14(&iLocal_124) >= 30f)
				{
					func_124(&(Local_218[participant_id_to_int() /*5*/]), 4);
				}
			}
			if (iLocal_97)
			{
				...
				if (func_35(Local_146.f_3, 8344, Local_146.f_6, 0, func_19(&(Local_218[participant_id_to_int() /*5*/]), 0), func_19(&(Local_218[participant_id_to_int() /*5*/]), 5)))
				{
					func_153(&iLocal_118);
					func_153(&iLocal_130);
					iLocal_96 = 0;
					func_44(&(Local_218[participant_id_to_int() /*5*/]), 3, 0);
					func_44(&(Local_218[participant_id_to_int() /*5*/]), 6, 0);
					func_17(&iLocal_137, 2, 0);
					iLocal_97 = 0;
					func_124(&(Local_218[participant_id_to_int() /*5*/]), 3);
				}
			}
			break;
		...
		case 3:
			...
			if (!is_string_null_or_empty(Local_146.f_3))
			{
				if (network_is_script_active(Local_146.f_3, Local_146.f_6, true, 0))
				{
					iLocal_96 = 1;
				}
			}
			else if ((get_game_timer() % 1000) > 100)
			{
			}
			if (iLocal_96)
			{
		...
		case 4:
			if ((!network_is_script_active(Local_146.f_3, Local_146.f_6, true, 0) || (_get_number_of_references_of_script_with_name_hash(joaat("am_darts_apartment")) == 0 && Local_146.f_2 == 0)) || (_get_number_of_references_of_script_with_name_hash(joaat("am_armwrestling_apartment")) == 0 && Local_146.f_2 == 1))
			{
				func_38(&iLocal_137);
				func_42(&(Local_218[participant_id_to_int() /*5*/]));
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 7, 0);
...
void func_26(int* iParam0)
{
	...
	if (bVar0 != BitTest(*iParam0, 4))
	{
		...
		{
			set_ped_config_flag(player_ped_id(), 185, bVar0);
			set_ped_config_flag(player_ped_id(), 108, bVar0);
		}
...
int func_35(char* sParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	{
		clear_bit(&(Var0.f_18), 3);
	}
	Var0.f_16 = uParam2;
	if (!network_is_script_active(sParam0, Var0.f_16, true, 0))
	{
		Global_1853348[get_player_index() /*834*/] = -1;
...
int func_36(char* sParam0, int iParam1, struct<17> Param2, var uParam3, var uParam4, var uParam5, var uParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	if (does_script_exist(sParam0))
	{
		...
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_36.f_18), 4);
			Global_1853348[player_id() /*834*/].f_1 = Param2.f_16;
		...
		if (has_script_loaded(sParam0))
		{
			...
			if (!bParam10)
			{
				set_bit(&(Global_1853348[player_id() /*834*/].f_36.f_18), 0);
			}
			clear_bit(&(Global_1853348[player_id() /*834*/].f_36.f_18), 4);
			if (bParam9)
			{
...
void func_46(var uParam0, var uParam1, bool bParam2)
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (!is_ped_dead_or_dying(player_ped_id(), true))
		{
			if (Local_218[participant_id_to_int() /*5*/].f_1 == -1)
			{
			...
			else if (!BitTest(bParam2->f_5, Local_218[participant_id_to_int() /*5*/].f_1))
			{
			...
			{
				func_41(bParam2, 8);
				func_47(Local_216[Local_218[participant_id_to_int() /*5*/].f_1 /*21*/], 1);
			}
		}
	}
...
void func_47(struct<21> Param0, bool bParam1)
{
	...
	if (!BitTest(Local_218[participant_id_to_int() /*5*/].f_3, 2))
	{
		if (does_entity_exist(player_ped_id()))
		{
			if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Param0.f_3, true) < 2f)
			{
				func_9(&Local_158, iLocal_206, Param0.f_2);
				Local_136.f_3 = 1;
				if (is_entity_at_coord(player_ped_id(), Local_158.f_53, Local_158.f_56, false, true, 0))
				{
					Local_136.f_2 = 1;
					if (Param0.f_0 == 1)
					{
						...
						{
							if (is_entity_at_coord(player_ped_id(), Local_158[iVar0 /*13*/], Local_158[iVar0 /*13*/].f_7, false, true, 0))
							{
								Local_136.f_4 = 1;
								Local_136.f_8 = iVar0;
							}
						...
						while (iVar1 < network_get_max_num_participants())
						{
							...
							if (bVar1 != participant_id_to_int())
							{
								if (network_is_participant_active(iVar2))
								{
									if ((Local_218[bVar1 /*5*/].f_1 == Param0.f_0 && BitTest(Local_218[bVar1 /*5*/].f_3, 6)) && BitTest(Local_218[bVar1 /*5*/].f_3, 1))
									{
										Local_136.f_5 = 1;
										if (Local_136.f_8 >= 0)
										{
											if (Local_136.f_8 == 0 && BitTest(Local_218[bVar1 /*5*/].f_3, 5))
											{
												Local_136.f_6 = 1;
											}
											else if (Local_136.f_8 == 1 && !BitTest(Local_218[bVar1 /*5*/].f_3, 5))
											{
												Local_136.f_6 = 1;
											}
										}
						...
						if (Local_136.f_4)
						{
							if (!Local_136.f_6)
							{
								...
								if (Local_136.f_8 == 0)
								{
									func_44(&(Local_218[participant_id_to_int() /*5*/]), 5, 1);
								}
							}
							else
							{
								func_44(&(Local_218[participant_id_to_int() /*5*/]), 5, 0);
								func_44(&(Local_218[participant_id_to_int() /*5*/]), 6, 0);
							}
						}
						if (Local_146.f_4 == 0)
	...
	if (bParam1)
	{
		switch (Local_146.f_4)
		{
			case 0:
				...
				{
					Local_136.f_0 = false;
					func_43(&(Local_218[participant_id_to_int() /*5*/]), Param0.f_0);
					...
					else
					{
						...
						{
							func_103(get_player_index(), Param0.f_0, 1);
							func_44(&(Local_218[participant_id_to_int() /*5*/]), 1, 1);
							func_44(&(Local_218[participant_id_to_int() /*5*/]), 6, 1);
				...
				{
					func_105(func_104(Param0, 6), 0);
					if (Local_218[participant_id_to_int() /*5*/].f_1 == Param0.f_0)
					{
						func_43(&(Local_218[participant_id_to_int() /*5*/]), -1);
						Local_136.f_0 = true;
					}
			...
			case 2:
				...
				disable_control_action(0, 12, true);
				disable_control_action(0, 13, true);
				fVar5 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_158[0 /*13*/], true);
				fVar6 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_158[1 /*13*/], true);
				if (fVar5 < fVar6)
				{
					Var4 = { Local_158[0 /*13*/] };
				}
				...
				if (!is_ped_injured(player_ped_id()))
				{
					task_go_straight_to_coord(player_ped_id(), Var4, 1f, 300, fVar7, 0.05f);
				}
				func_41(&Local_146, 6);
				break;
			...
			case 6:
				...
				else if (func_14(&iLocal_210) >= 1f || !func_19(&(Local_218[participant_id_to_int() /*5*/]), 3))
				{
					func_11(&iLocal_210);
					if (func_101(Param0.f_0, &Local_156))
					{
						if (func_44(&(Local_218[participant_id_to_int() /*5*/]), 0, 1))
						{
							func_44(&(Local_218[participant_id_to_int() /*5*/]), 3, 1);
						}
					}
					else if (func_44(&(Local_218[participant_id_to_int() /*5*/]), 0, 0))
					{
					}
				}
				...
				{
					if (!func_19(&(Local_218[participant_id_to_int() /*5*/]), 3))
					{
						func_44(&(Local_218[participant_id_to_int() /*5*/]), 3, 1);
					}
				}
				if ((is_control_just_pressed(2, func_100(0)) || BitTest(Local_156.f_3, Param0.f_0)) && !bLocal_94)
				{
					func_41(&Local_146, 8);
				}
				...
				if (func_19(&(Local_218[participant_id_to_int() /*5*/]), 3))
				{
					if (func_19(&(Local_218[participant_id_to_int() /*5*/]), 0))
					{
						if ((is_control_just_pressed(2, 201) && BitTest(Local_156.f_2, Param0.f_0)) && !bLocal_94)
						{
							func_41(&Local_146, 7);
						}
						if (Param0.f_2 == 0)
					...
					{
						if (BitTest(Local_156.f_1, Local_218[participant_id_to_int() /*5*/].f_1))
						{
							func_44(&(Local_218[participant_id_to_int() /*5*/]), 1, 1);
						}
						if (func_19(&(Local_218[participant_id_to_int() /*5*/]), 1))
						{
			...
			case 7:
				...
				disable_control_action(0, 12, true);
				disable_control_action(0, 13, true);
				func_48(get_player_index(), Param0.f_0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 8, 1);
				func_17(&iLocal_137, 1, 1);
			...
			case 8:
				iLocal_95 = 0;
				Local_136.f_0 = true;
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 1, 0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 0, 0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 3, 0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 6, 0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 5, 0);
				func_44(&(Local_218[participant_id_to_int() /*5*/]), 7, 0);
...
void func_48(int iParam0, var uParam1)
{
	...
	Var0.f_4 = iParam0;
	func_6(&(Var0.f_2), 3, 1);
	_trigger_script_event_2(1, &Var0, 6, func_49());
}
...
var func_49()
{
	...
	iVar1 = network_get_host_of_this_script();
		...
		if (iVar5 == 1 && Global_23150.f_6119)
		{
			...
			if (get_hash_key(&(Global_23150.f_5081)) != 0 && Global_23150.f_5157 != -1)
			{
				...
				if (Global_23150.f_5159 != 0)
				{
					...
					draw_sprite(func_77(Global_23150.f_5159), func_74(Global_23150.f_5159, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
			...
			if (get_hash_key(&(Global_4539885.f_21)) != 0 && Global_4539885.f_65 != -1)
			{
				...
				if (Global_4539885.f_67 != 0)
				{
					...
					draw_sprite(func_77(Global_4539885.f_67), func_74(Global_4539885.f_67, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
				fVar49 = (fVar49 + (((get_rendered_character_height(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_84(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_84(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_77(26), func_74(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
										if (func_84(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_84(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_77(27), func_74(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
									}
												...
												if (func_84(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_84(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_77(Global_23150.f_4824[(iVar22 + iVar28)]), func_74(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_77(Global_23150.f_4824[(iVar22 + iVar28)]), func_74(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
									...
									if (get_hash_key(&(Global_23150.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_56() && _get_number_of_references_of_script_with_name_hash(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													if (Global_23150.f_2130[iVar24])
												...
												if (func_84(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_84(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																draw_sprite(func_77(Global_23150.f_4824[(iVar22 + iVar14)]), func_74(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (Global_23147 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_77(Global_23150.f_4824[(iVar22 + iVar14)]), func_74(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_77(Global_23150.f_4824[(iVar22 + iVar14)]), func_74(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
													}
									...
									if (func_84(Global_23150.f_4824[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_84(Global_23150.f_4824[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												draw_sprite(func_77(Global_23150.f_4824[iVar22]), func_74(Global_23150.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_53(Global_23150.f_4824[iVar22])), (fVar37 * func_53(Global_23150.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
											}
										}
									}
								}
...
int func_86(bool bParam0, bool bParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_88(8, -1) && func_87() != 65)) || (get_pause_menu_state() != 0 && !bParam1)) || (is_player_switch_in_progress() && !bParam0)) || is_commerce_store_open()) || Global_78579) || Global_23150.f_8807) || is_warning_message_active()) || Global_100493.f_1458)
	{
		return 0;
	}
	return 1;
...
int func_101(int iParam0, var uParam1)
{
	...
	{
		case 0:
			if (BitTest(uParam1->f_5, participant_id_to_int()))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (BitTest(uParam1->f_6, participant_id_to_int()))
			{
				return 1;
			}
			break;
...
float func_102(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
...
var func_104(struct<13> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9)
{
	if (_is_using_keyboard(2))
	{
		switch (iParam9)
...
void func_109(var uParam0, var uParam1)
{
	...
	if ((is_help_message_being_displayed() && !func_107(func_104(Var0, 3))) || func_110())
	{
		bVar1 = false;
		func_112(uParam0, 4);
	}
...
void func_115(var uParam0)
{
	...
	bVar0 = true;
	bVar1 = true;
	if (((func_32(0) || is_pause_menu_active()) || func_117()) || func_116())
	{
		bVar0 = false;
		bLocal_94 = true;
	}
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (!is_ped_dead_or_dying(player_ped_id(), true))
		{
			bVar1 = !is_ped_running(player_ped_id());
		}
	}
	uParam0->f_12 = 1;
	...
	uParam0->f_11 = bVar1;
	uParam0->f_10 = Local_218[participant_id_to_int() /*5*/].f_1;
	iVar2 = 0;
	while (iVar2 <= 1)
	{
		uParam0->f_4[iVar2] = network_is_script_active(Local_216[iVar2 /*21*/].f_1, uParam0->f_13, false, 0);
		uParam0->f_7[iVar2] = network_is_script_active(Local_216[iVar2 /*21*/].f_1, uParam0->f_13, true, 0);
		iVar3 = 0;
		if ((BitTest(Local_156.f_1, iVar2) && !network_is_script_active(Local_216[iVar2 /*21*/].f_1, uParam0->f_13, false, 0)) && func_20(&Local_218, iVar2) > 0)
		{
			iVar3 = 1;
		}
...
void func_119(var uParam0)
{
	...
	{
		if ((func_14(&(uParam0->f_4)) < uParam0->f_7 && uParam0->f_2) && !network_is_script_active(uParam0->f_1, uParam0->f_3, true, 0))
		{
			Var0.f_1 = -1;
			Var0.f_2 = -1;
			Var0.f_9 = -1;
			...
			if (func_120())
			{
				if (network_is_script_active(uParam0->f_1, uParam0->f_3, false, 0) && !network_is_script_active(uParam0->f_1, uParam0->f_3, true, 0))
				{
...
int func_120()
{
	if (!func_163(get_player_index()))
	{
		if (((!func_157(get_player_index(), 0, -1) && !func_154(get_player_index())) && !is_player_in_cutscene(get_player_index())) && !func_155(player_id()))
		{
			return 0;
		}
	}
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	while (iVar2 < get_number_of_events(1))
	{
		...
		{
			case 174:
				if (func_23(iVar2, &Var1, 0) && (uParam0[participant_id_to_int() /*5*/])->f_4 == 0)
				{
					switch (Var1.f_0)
					{
						case -1180214947:
							if (Var1.f_3 == (uParam0[participant_id_to_int() /*5*/])->f_1 && Var1.f_4 == get_player_index())
							{
								uParam1->f_1 = 1;
								...
								if (Var1.f_3 >= 0 && Var1.f_3 <= 1)
								{
									if (!BitTest(uParam1->f_5, Var1.f_3))
									{
										if (!func_22(Var1.f_2, 4))
										{
											uParam1->f_2 = Var1.f_3;
											uParam1->f_3 = (uParam3[uParam1->f_2 /*21*/])->f_1;
											func_44(uParam0[participant_id_to_int() /*5*/], 2, 1);
											if (func_44(uParam0[participant_id_to_int() /*5*/], 0, func_22(Var1.f_2, 2)) && Var1.f_3 == (uParam0[participant_id_to_int() /*5*/])->f_1)
											{
											}
											func_44(uParam0[participant_id_to_int() /*5*/], 5, func_22(Var1.f_2, 5));
											func_124(uParam0[participant_id_to_int() /*5*/], 1);
										}
									}
								}
							}
				...
				if (get_event_data(1, iVar2, &Var0, 5))
				{
					switch (Var0.f_0)
					{
						case -1930547080:
							if (Var0.f_3 == uParam1->f_6 && Var0.f_2 != player_id())
							{
								if (!(func_19(uParam0[participant_id_to_int() /*5*/], 2) && (uParam0[participant_id_to_int() /*5*/])->f_1 == Var0.f_4))
								{
									if (func_120())
									{
...
void func_126(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 1)
	{
		...
		(uParam0[iVar0 /*8*/])->f_3 = Global_1853348[player_id() /*834*/].f_267.f_33;
		if (func_139(player_id()))
		{
			(uParam0[iVar0 /*8*/])->f_3 = Global_2689235[player_id() /*453*/].f_318.f_7 + 32;
		}
		iVar0++;
	}
}
...
int func_139(int iParam0)
{
	if (iParam0 != func_140())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_50(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_141()
{
	...
	Var0.f_19 = -1;
	Var0.f_20 = -1;
	Var0.f_16 = Global_1853348[player_id() /*834*/].f_267.f_33;
	if (func_139(player_id()))
	{
		Var0.f_16 = Global_2689235[player_id() /*453*/].f_318.f_7 + 32;
	}
	if (Var0.f_0 != 12)
	{
		Var0.f_0 = 12;
	...
	func_145(0, -1, 0);
	network_register_host_broadcast_variables(&Local_156, 10, 0);
	network_register_player_broadcast_variables(&Local_218, 161, 0);
	if (!func_142())
	{
		func_164();
	}
	if (network_is_game_in_progress())
	{
		...
		Local_218[participant_id_to_int() /*5*/].f_2 = 0;
	}
	else
	{
		func_164();
...
void func_148(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!network_is_game_in_progress())
	{
		func_147();
...
int func_162(int iParam0)
{
	if (iParam0 != func_140())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_50(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
int func_167()
{
	...
	if (func_168() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_168()) == 0)
		{
			return 1;
		}
	}
