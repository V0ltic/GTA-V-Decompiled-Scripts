...
void func_1()
{
	if (timerb() > 7000)
	{
		...
		{
			if (is_entity_at_entity(player_ped_id(), iLocal_48, 10f, 10f, 10f, false, true, 0) && iLocal_50 == 0)
			{
				settimerb(0);
				Local_46 = { get_entity_coords(player_ped_id(), true) };
				open_sequence_task(&iLocal_51);
				task_turn_ped_to_face_coord(0, Local_46, 0);
				task_play_anim(0, "amb@PREACHER", "PREACH", 8f, -8f, -1, 1, 0f, false, false, false);
				close_sequence_task(iLocal_51);
				if (!is_entity_dead(iLocal_48, false))
				{
					task_perform_sequence(iLocal_48, iLocal_51);
				}
				clear_sequence_task(&iLocal_51);
				iLocal_50 = 1;
			}
			if (is_entity_at_entity(player_ped_id(), iLocal_48, 3f, 3f, 3f, false, true, 0) && iLocal_49 == 0)
			{
				Local_46 = { get_entity_coords(player_ped_id(), true) };
				settimerb(0);
				open_sequence_task(&iLocal_51);
...
void func_2()
{
	...
	iLocal_48 = create_ped(19, joaat("s_m_m_strpreach_01"), Local_45.f_0, Local_45.f_1, Local_46.f_2, 0f, true, true);
	if (!is_entity_dead(iLocal_48, false))
	{
		open_sequence_task(&iLocal_51);
		task_turn_ped_to_face_coord(0, Local_46, 0);
