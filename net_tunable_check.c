				...
				if (iVar2 < iVar5)
				{
					...
					if (iVar2 >= Var3.f_4 && iVar2 != 27)
					{
						if (iVar7 != 0 && Var3.f_5 != 0)
						{
							...
							else if (network_access_tunable_int_hash(iVar7, Var3.f_5, &iVar1))
							{
...
void func_5()
{
	...
	add_stunt_jump(-9f, -9f, -9f, -10f, -10f, -10f, -25f, -25f, -25f, -28f, -28f, -28f, 0f, 0f, 0f, 0, 0, 0);
	add_scenario_blocking_area(-9f, -9f, -9f, -10f, -10f, -10f, false, true, true, true);
	func_5();
}
