...
void func_1()
{
	switch (iLocal_261)
	{
		case 0:
			bLocal_262 = false;
			func_231(&uLocal_95, 2, player_ped_id(), "TREVOR", 0, 1);
			iLocal_261 = 1;
			break;
			...
			switch (iLocal_264)
			{
				case 0:
					if (func_313(1, 1093140480, 0))
					{
						...
						{
							register_entity_for_cutscene(Local_94.f_28[0], "Nigel", 0, 0, 0);
						}
						if (func_312(Local_94.f_28[1]))
						{
							register_entity_for_cutscene(Local_94.f_28[1], "MRS_Thornhill", 0, 0, 0);
						}
						func_311();
				...
				case 1:
					if (is_cutscene_playing())
					{
						...
						{
							clear_area(get_entity_coords(player_ped_id(), true), 100f, true, true, false, false);
						}
				...
				case 2:
					if (!is_cutscene_playing())
					{
						...
						if (func_312(Local_94.f_35[0]))
						{
							...
							set_vehicle_on_ground_properly(Local_94.f_35[0], 5f);
							set_disable_pretend_occupants(Local_94.f_35[0], true);
							if (func_312(Local_94.f_28[0]))
							{
								set_ped_relationship_group_hash(Local_94.f_28[0], joaat("player"));
								clear_ped_tasks_immediately(Local_94.f_28[0]);
								set_blocking_of_non_temporary_events(Local_94.f_28[0], true);
								set_ped_into_vehicle(Local_94.f_28[0], Local_94.f_35[0], -1);
								set_ped_keep_task(Local_94.f_28[0], true);
							}
							if (func_312(Local_94.f_28[1]))
							{
								set_ped_relationship_group_hash(Local_94.f_28[1], joaat("player"));
								clear_ped_tasks_immediately(Local_94.f_28[1]);
								set_blocking_of_non_temporary_events(Local_94.f_28[1], true);
								set_ped_into_vehicle(Local_94.f_28[1], Local_94.f_35[0], 0);
								set_ped_keep_task(Local_94.f_28[1], true);
							}
							set_vehicle_engine_on(Local_94.f_35[0], true, true, false);
							task_vehicle_drive_wander(Local_94.f_28[0], Local_94.f_35[0], 20f, 786603);
						}
						_0x81CBAE94390F9F89();
...
int func_235(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
int func_236(int* iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)
{
	request_model(iLocal_81);
	if (iParam4 == 1)
	{
		while (!has_model_loaded(iLocal_81))
		{
			wait(0);
		}
	}
	else if (!has_model_loaded(iLocal_81))
	{
		return 0;
	}
	...
	set_model_as_no_longer_needed(iLocal_81);
	return 1;
}

void func_237(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_238(iParam0);
...
void func_242(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_246(player_id())) && !func_244(player_id(), 0)) && !func_243()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_246(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_251(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_252(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
	...
	if (does_entity_exist(Global_103950.f_4))
	{
		if (is_vehicle_driveable(Global_103950.f_4, false))
		{
			if (func_302(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_299(get_entity_coords(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_255(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_292(iParam0) != 145) || func_272(iParam0)) || func_271(iParam0)) || func_270(iParam0)) || func_269(iParam0)) || !func_259(get_entity_model(iParam0)))
	{
		if (func_271(iParam0))
		{
		}
...
var func_275()
{
	...
	func_285(&uVar0, get_clock_seconds());
	func_284(&uVar0, get_clock_minutes());
	func_283(&uVar0, get_clock_hours());
	func_278(&uVar0, get_clock_day_of_month());
	func_277(&uVar0, get_clock_month());
	func_276(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_281(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_289(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_286(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_295(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_313(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_318(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_317(player_ped_id(), -828834893))
				{
...
{
	if (((!func_335(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_334(0)) || func_333(1))
			{
			}
			else
			{
...
void func_342(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_93 = add_scenario_blocking_area(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true);
				set_scenario_type_enabled("WORLD_HUMAN_GUARD_STAND", false);
				set_scenario_type_enabled("WORLD_HUMAN_CLIPBOARD", false);
				set_scenario_type_enabled("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_93 = add_scenario_blocking_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true);
		...
		case 41:
			if (bParam1)
			{
				iLocal_93 = add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_93 = add_scenario_blocking_area(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true);
...
int func_344(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_345(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_352()
{
	...
	remove_scenario_blocking_area(iLocal_263, false);
	clear_ped_non_creation_area();
...
void func_365(bool bParam0)
{
	...
	if (!func_386())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_366(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_367(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_373())
	{
		...
		{
			iVar2 = func_368(get_this_script_name());
			if (iVar2 > -1)
			{
