...
void __EntryFunction__()
{
	...
	iLocal_90 = get_weapontype_model(iLocal_89);
	sLocal_91 = "empty";
	iLocal_269 = 1;
	iLocal_426 = -1;
	iLocal_427 = -1;
	...
	iLocal_426 = add_navmesh_blocking_object(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, false, 7);
	iLocal_427 = add_navmesh_blocking_object(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, false, 7);
	iLocal_428 = add_navmesh_blocking_object(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, false, 7);
	...
	iLocal_290 = _0xBE197EAA669238F4(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_402();
	func_385();
	func_384();
	Local_434.f_0 = 0;
	...
	while (true)
	{
		_0x208784099002BC30("SF_Epsilon4", 0);
		...
		if (func_350(player_ped_id()))
		{
			if (func_349(player_ped_id()) == iLocal_89)
			{
...
void func_1()
{
	...
	switch (Local_434.f_1)
	{
		case 0:
			...
			if (are_strings_equal(sVar0, sLocal_91))
			{
				func_421(1);
			}
			else
...
void func_11()
{
	...
	while (func_349(player_ped_id()) == iLocal_89)
	{
		wait(0);
		hide_hud_component_this_frame(2);
		if (has_anim_dict_loaded("weapons@holster_1h"))
		{
			if (!is_entity_playing_anim(player_ped_id(), "weapons@holster_1h", "holster", 3))
			{
				task_play_anim(player_ped_id(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0f, false, false, false);
			}
			else if (get_entity_anim_current_time(player_ped_id(), "weapons@holster_1h", "holster") >= 0.5f)
			{
	...
	if (iVar0 < 12)
	{
		stat_set_int(joaat("num_epsilon_step"), 12, true);
		func_12(23, 12);
	}
	func_418();
}
...
int func_220()
{
	return func_221(get_this_script_name(), 0);
}
...
void func_230()
{
	stop_sound(Local_301.f_2);
	stop_sound(Local_301.f_3);
	stop_sound(Local_301.f_4);
	stop_sound(Local_301.f_5);
	Local_301.f_6 = 0;
	Local_301.f_7 = 0;
}
...
void func_232()
{
	switch (Local_434.f_1)
	{
		case 0:
			...
			hide_hud_component_this_frame(2);
			remove_weapon_from_ped(player_ped_id(), iLocal_89);
			Local_434.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (is_entity_dead(Local_298[0 /*8*/], false))
			{
				func_242(6);
				Local_434.f_9 = 2;
				Local_434.f_1 = 3;
			}
			else if (is_entity_dead(Local_298[1 /*8*/], false))
			{
				func_242(6);
				Local_434.f_9 = 3;
				Local_434.f_1 = 3;
			}
			else if (has_entity_been_damaged_by_entity(Local_298[0 /*8*/], player_ped_id(), true) && has_entity_been_damaged_by_weapon(Local_298[0 /*8*/], 0, 2))
			{
				func_242(6);
				Local_434.f_9 = 4;
				Local_434.f_1 = 3;
			}
			else if (has_entity_been_damaged_by_entity(Local_298[1 /*8*/], player_ped_id(), true) && has_entity_been_damaged_by_weapon(Local_298[1 /*8*/], 0, 2))
			{
				func_242(6);
				Local_434.f_9 = 5;
				Local_434.f_1 = 3;
			...
			{
				if (func_233(player_ped_id(), Local_298[0 /*8*/], 1) >= 50f)
				{
...
int func_239(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_241(Param1 - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_241(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_243()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (can_request_assets_for_cutscene_entity())
		{
			...
			{
				func_297("Michael", player_ped_id(), 0, 2);
			}
	...
	if (Local_434.f_1 == 0)
	{
		...
		{
			iLocal_292 = create_vehicle(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, true, true, false);
			set_vehicle_colours(iLocal_292, 157, 157);
			set_vehicle_extra_colours(iLocal_292, 5, 157);
		...
		if (func_350(player_ped_id()))
		{
			...
			while ((get_game_timer() - iVar0) < 500)
			{
			...
			if (iLocal_283 == 0)
			{
				...
				{
					register_entity_for_cutscene(Local_298[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
				}
				if (func_234(Local_298[0 /*8*/]))
				{
					register_entity_for_cutscene(Local_298[0 /*8*/], "Marnie", 0, 0, 0);
				}
				if (func_234(player_ped_id()))
				{
				...
				{
					iLocal_303 = func_274(player_ped_id(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					register_entity_for_cutscene(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
				if (func_234(Local_293[iLocal_283 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_293[iLocal_283 /*43*/].f_1, "EPS_TV", 0, 0, 0);
				}
			}
			else if (iLocal_283 == 1)
			{
				...
				if (func_234(Local_293[iLocal_283 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_293[iLocal_283 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
				}
			}
			else
			{
				...
				if (func_234(Local_293[iLocal_283 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_293[iLocal_283 /*43*/].f_1, "Old_Boot", 0, 0, 0);
				}
			}
			start_cutscene(0);
			_0x48621C9FCA3EBD28(1);
			iVar0 = get_game_timer();
			while ((get_game_timer() - iVar0) < 1)
			{
				hide_hud_component_this_frame(2);
				wait(0);
				_0x208784099002BC30("SF_Epsilon4", 0);
			...
			if (iLocal_283 >= 2)
			{
				if (func_234(player_ped_id()))
				{
					give_weapon_to_ped(player_ped_id(), joaat("weapon_unarmed"), -1, true, true);
				}
			}
			...
			if (iLocal_283 >= 2)
			{
				if (is_cutscene_playing())
				{
					if (get_cutscene_time() > 17000)
					{
						if (!is_new_load_scene_active())
						{
							new_load_scene_start(1847.472f, 4756.157f, 36.6968f, func_258(271.4718f), 145f, 0);
						}
					}
				}
			}
...
void func_245(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_249(player_id())) && !func_247(player_id(), 0)) && !func_246()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_249(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_253()
{
	begin_scaleform_movie_method(iLocal_95, "SET_COLOUR");
	...
	begin_scaleform_movie_method(iLocal_95, "SET_DISTANCE");
	scaleform_movie_method_add_param_float(10f);
	end_scaleform_movie_method();
	set_text_render_id(iLocal_96);
	draw_scaleform_movie(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
	...
	if (func_234(player_ped_id()))
	{
		if (can_set_exit_state_for_registered_entity("Michael", 0))
		{
			...
			else
			{
				...
				if (func_349(player_ped_id()) != iLocal_89)
				{
					give_weapon_to_ped(player_ped_id(), iLocal_89, -1, true, true);
				}
				force_ped_motion_state(player_ped_id(), joaat("MotionState_Idle"), false, 1, false);
				return 1;
			}
	...
	if (func_234(Local_298[1 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					open_sequence_task(&iLocal_435);
					task_warp_ped_into_vehicle(0, iLocal_292, 0);
					close_sequence_task(iLocal_435);
					task_perform_sequence(Local_81.f_28[1], iLocal_435);
					clear_sequence_task(&iLocal_435);
					func_405("Did Jimmy pass exit");
				}
			}
			else
			{
				task_go_straight_to_coord(Local_81.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 40000f, 0.5f);
				func_405("Did Jimmy regular exit");
			}
			force_ped_motion_state(Local_298[1 /*8*/], joaat("MotionState_Walk"), false, 1, false);
		}
	}
}
...
void func_256()
{
	if (func_234(Local_298[0 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					open_sequence_task(&iLocal_435);
					task_warp_ped_into_vehicle(0, iLocal_292, -1);
					task_vehicle_drive_to_coord(0, iLocal_292, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					task_vehicle_drive_wander(0, iLocal_292, 30f, 262275);
					close_sequence_task(iLocal_435);
					task_perform_sequence(Local_81.f_28[0], iLocal_435);
					clear_sequence_task(&iLocal_435);
			...
			{
				task_follow_nav_mesh_to_coord(Local_81.f_28[0], get_offset_from_entity_in_world_coords(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 40000f);
				func_405("Did Marnie regular exit");
			}
			force_ped_motion_state(Local_298[0 /*8*/], joaat("MotionState_Walk"), false, 1, false);
		}
	}
}
...
void func_257()
{
	...
	{
		if (can_set_exit_state_for_registered_entity("Artefact_Detector", 0))
		{
			if (iLocal_283 < 2)
			{
				func_405("*** Detector exit");
				give_weapon_object_to_ped(iLocal_303, player_ped_id());
				func_5(&iLocal_303);
				if (!does_entity_exist(Local_301.f_0))
				{
					func_405("*** Recreating gDetector.hObj after cutscene...");
					Local_301.f_0 = get_current_ped_weapon_entity_index(player_ped_id(), 1);
				}
			}
			else
			{
...
void func_260(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_262(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_274(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_278(iVar2, iVar6) != 0)
	{
		if (!is_entity_dead(iParam0, false))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_278(iVar2, iVar6)))
			{
				if (func_277(func_278(iVar2, iVar6)))
				{
					iVar7 = get_weapon_component_type_model(func_278(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_278(iVar2, iVar8) != 0)
	{
		if (!is_entity_dead(iParam0, false))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_278(iVar2, iVar8)))
			{
				give_weapon_component_to_weapon_object(iVar1, func_278(iVar2, iVar8));
...
int func_281(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_288(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_287(player_ped_id(), -828834893))
				{
...
{
	begin_scaleform_movie_method(iLocal_95, "SET_COLOUR");
	scaleform_movie_method_add_param_int(67);
	scaleform_movie_method_add_param_int(200);
	scaleform_movie_method_add_param_int(255);
	scaleform_movie_method_add_param_int(255);
	scaleform_movie_method_add_param_int(209);
	scaleform_movie_method_add_param_int(67);
	scaleform_movie_method_add_param_int(255);
...
void func_293(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_294())
		{
			if ((are_strings_equal(Local_301.f_14, "NO_RECENT_ANIM") || !is_entity_playing_anim(Local_301.f_0, "rcm_epsilonism4", Local_301.f_14, 3)) || get_entity_anim_current_time(Local_301.f_0, "rcm_epsilonism4", Local_301.f_14) >= 0.98f)
			{
				if (fLocal_302 > 80f)
				{
				...
				play_entity_anim(Local_301.f_0, Local_301.f_14, "rcm_epsilonism4", 16f, false, false, false, 0f, 0);
			}
		}
	}
	else if (func_294())
	{
		if (!are_strings_equal(Local_301.f_14, "NO_RECENT_ANIM"))
		{
			if (is_entity_playing_anim(Local_301.f_0, "rcm_epsilonism4", Local_301.f_14, 1))
			{
				if (get_entity_anim_current_time(Local_301.f_0, "rcm_epsilonism4", Local_301.f_14) <= 0.05f)
				{
					stop_entity_anim(Local_301.f_0, Local_301.f_14, "rcm_epsilonism4", -4f);
...
void func_306()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (iLocal_283 == 0)
		{
			if (!func_338())
			{
				...
				set_entity_heading(player_ped_id(), fLocal_84);
			}
			func_290(&(Local_298[1 /*8*/]), 1);
			func_290(&(Local_298[0 /*8*/]), 1);
			if (func_350(Local_298[1 /*8*/]))
			{
				freeze_entity_position(Local_81.f_28[1], false);
				set_entity_coords(Local_298[1 /*8*/], 1829.75f, 4693.5f, 38.51f, true, false, false, true);
				set_entity_heading(Local_298[1 /*8*/], 27.46f);
				Var2 = { get_entity_coords(Local_298[1 /*8*/], true) };
				get_ground_z_for_3d_coord(1829.75f, 4693.5f, 38.51f, &fVar1, false, false);
				set_entity_coords(Local_298[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, true, false, false, true);
				func_405("Setting Jimmy position (0)");
			}
			if (func_350(Local_298[0 /*8*/]))
			{
				set_entity_coords(Local_298[0 /*8*/], 1827.32f, 4692.59f, 38.53f, true, false, false, true);
				set_entity_heading(Local_298[0 /*8*/], 171.22f);
				func_405("Setting Marnie position (0)");
			}
		}
		else if (iLocal_283 == 1)
		{
			set_entity_coords(player_ped_id(), 1754.634f, 4675.789f, 42.9068f, true, false, false, true);
			set_entity_heading(player_ped_id(), 293.2275f);
			if (func_350(Local_298[1 /*8*/]))
			{
				set_entity_coords(Local_298[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, true, false, false, true);
				set_entity_heading(Local_298[1 /*8*/], 262.4368f);
				func_405("Setting Jimmy position (1)");
			}
			if (func_350(Local_298[0 /*8*/]))
			{
				set_entity_coords(Local_298[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, true, false, false, true);
				set_entity_heading(Local_298[0 /*8*/], 148.3211f);
				func_405("Setting Marnie position (1)");
			}
		}
		else if (iLocal_283 == 2)
		{
			set_entity_coords(player_ped_id(), 1758.454f, 4829.431f, 39.729f, true, false, false, true);
			set_entity_heading(player_ped_id(), 168.2012f);
			if (func_350(Local_298[0 /*8*/]))
			{
				set_entity_coords(Local_298[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, true, false, false, true);
				set_entity_heading(Local_298[0 /*8*/], 169.6486f);
	...
	if (Local_434.f_1 == 0)
	{
		...
		iLocal_415 = 0;
		iLocal_416 = 0;
		iLocal_417 = get_game_timer();
		iLocal_419 = get_game_timer();
		iLocal_420 = 0;
		if (iLocal_283 == 0)
		{
			if (func_350(player_ped_id()))
			...
			if (func_350(Local_298[1 /*8*/]))
			{
				remove_weapon_from_ped(Local_298[1 /*8*/], iLocal_89);
				task_follow_nav_mesh_to_coord(Local_298[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, false, 40000f);
			}
		...
		func_333(&uLocal_98, 0, player_ped_id(), "MICHAEL", 0, 1);
		...
		iLocal_409 = get_game_timer() + 1000;
	...
	if (Local_434.f_1 == 1)
	{
		...
		else if (!func_331(&uLocal_356, get_entity_coords(player_ped_id(), true)))
		{
			func_242(6);
			Local_434.f_9 = 8;
			Local_434.f_1 = 3;
		...
		else
		{
			...
			if (does_entity_exist(Local_293[iLocal_283 /*43*/].f_1))
			{
				if (iLocal_283 == 0)
				{
					if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!has_cutscene_loaded())
						{
							request_cutscene("EPS_4_MCS_1", 8);
							func_405("Requesting midtro now");
						}
					}
					else if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
					{
						if (has_cutscene_loaded())
						{
				...
				else if (iLocal_283 == 1)
				{
					if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!has_cutscene_loaded())
						{
							request_cutscene("EPS_4_MCS_2", 8);
							func_405("Requesting midtro now");
						}
					}
					else if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
				...
				else if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
				{
					if (!has_cutscene_loaded())
					{
						request_cutscene("EPS_4_MCS_3", 8);
						func_405("Requesting midtro now");
					}
				}
				else if (func_233(player_ped_id(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
			...
			if (iLocal_283 == 0)
			{
				if (iLocal_408 == 0)
				{
					if (iLocal_409 < get_game_timer())
					{
						if (!func_351())
						{
							func_326("EPS4_T0");
							iLocal_409 = get_game_timer() + 7500;
							iLocal_408++;
							iLocal_421 = get_game_timer();
						}
						else
						{
							iLocal_408 = 2;
				...
				{
					if (is_control_just_pressed(0, 25) || iLocal_409 < get_game_timer())
					{
						clear_help(true);
						iLocal_409 = get_game_timer() + 1000;
						iLocal_408++;
			...
			{
				func_325(&iLocal_94);
				if (!func_331(&uLocal_304, get_entity_coords(player_ped_id(), true)))
				{
					iLocal_269 = 0;
					stop_scripted_conversation(false);
					clear_prints();
				...
				{
					if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!are_strings_equal(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_234(iLocal_291))
							{
								task_look_at_entity(iLocal_291, player_ped_id(), 10000, 0, 2);
							}
						}
						iLocal_421 = get_game_timer();
						iLocal_270 = 1;
				...
				{
					if (!func_285() && (get_game_timer() - iLocal_288) >= 7500)
					{
						if ((are_strings_equal(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !is_entity_at_entity(player_ped_id(), iLocal_291, 30f, 30f, 30f, false, true, 0)) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!are_strings_equal(Local_293[iLocal_283 /*43*/].f_37, sLocal_91))
							{
								if (func_234(iLocal_291))
								{
									task_look_at_entity(iLocal_291, player_ped_id(), 5000, 0, 2);
								}
							}
							iLocal_271 = 1;
							iLocal_421 = get_game_timer();
				...
				else if (iLocal_268 == 0 && !func_309(player_ped_id(), Local_293[iLocal_283 /*43*/].f_2, 9f, 1))
				{
					if (func_309(player_ped_id(), Local_293[iLocal_283 /*43*/].f_2, 20f, 1))
					{
						if (!iLocal_273)
						{
							if (!func_285())
					...
					{
						if (func_308(player_ped_id(), iLocal_291, 30f, 1) || iLocal_283 == 2)
						{
							if (!func_285() && (get_game_timer() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_350(iLocal_291))
												{
													task_look_at_entity(iLocal_291, player_ped_id(), 3000, 0, 2);
												}
												iLocal_286 = get_game_timer();
												iLocal_412++;
												if (iLocal_283 == 2)
									...
									{
										if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = get_game_timer();
											iLocal_414++;
										}
								...
								{
									if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_350(iLocal_291))
										{
											task_look_at_entity(iLocal_291, player_ped_id(), 3000, 0, 2);
							...
							else if (bLocal_266 != Local_301.f_1)
							{
								...
								if (bLocal_266)
								{
									if (iLocal_287 < get_game_timer())
									{
										if (func_285())
										{
											stop_scripted_conversation(true);
										}
										iLocal_286 = (get_game_timer() - 7500);
										iLocal_287 = get_game_timer();
									}
								}
								else
								{
					...
					{
						iLocal_286 = (get_game_timer() - 5000);
					}
				}
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((get_game_timer() - iLocal_417) > 7500 && !func_285()) && !is_message_being_displayed())
						{
							if (func_234(Local_298[0 /*8*/]))
							{
								if (func_233(Local_298[0 /*8*/], player_ped_id(), 1) < 4f)
								{
				...
				else if (iLocal_283 == 1)
				{
					if (iLocal_415 < 4)
					{
						if (((get_game_timer() - iLocal_417) > 7500 && !func_285()) && !is_message_being_displayed())
						{
							if (func_234(Local_298[1 /*8*/]))
							{
								if (func_233(Local_298[1 /*8*/], player_ped_id(), 1) < 4f)
								{
				...
				if (is_entity_at_coord(player_ped_id(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, false, false, 1))
				{
					if (iLocal_289 == -1)
					{
						iLocal_289 = get_game_timer();
					}
					else if ((get_game_timer() - iLocal_289) >= 1500)
					{
						if (func_285())
						{
							func_283();
				...
				else if (!func_309(player_ped_id(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f), 1))
				{
					iLocal_267 = 0;
				}
			}
			else
			{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (is_entity_at_entity(player_ped_id(), iLocal_291, 30f, 30f, 30f, false, true, 0))
						{
							if (!func_285() && !is_message_being_displayed())
							{
								if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
					...
					else if (!func_285() && !is_message_being_displayed())
					{
						if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_274 = 1;
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (is_entity_at_entity(player_ped_id(), iLocal_291, 30f, 30f, 30f, false, true, 0))
						{
							if ((!func_285() && (get_game_timer() - iLocal_288) >= 7500) && !is_message_being_displayed())
							{
								if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_285() && (get_game_timer() - iLocal_288) >= 7500) && !is_message_being_displayed())
					{
						if (are_strings_equal(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
	...
	if (Local_434.f_1 == 3)
	{
		...
		func_292();
		set_pad_shake(0, 200, 150);
		if ((get_game_timer() - iLocal_295) > 750)
		{
			func_230();
...
int func_307(struct<3> Param0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_309(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
void func_327(var uParam0)
{
	...
	fVar0 = vdist(uParam0->f_2, get_entity_coords(player_ped_id(), true));
	...
	Var4 = { uParam0->f_2 - get_entity_coords(player_ped_id(), true) };
	Var5 = { uParam0->f_2 - get_offset_from_entity_in_world_coords(player_ped_id(), 0f, -5f, 0f) };
	bVar6 = ((Var4.f_0 * Var2.f_0) + (Var4.f_1 * Var2.f_1)) > 0f;
	fVar7 = (1f - (get_angle_between_2d_vectors(Var2.f_0, Var2.f_1, Var5.f_0, Var5.f_1) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_284 < get_game_timer())
	{
		if (fVar0 <= 6.5f && bVar8)
		{
			stop_sound(Local_301.f_3);
			play_sound_from_entity(Local_301.f_4, "CONTINUAL_BEEP", player_ped_id(), "EPSILONISM_04_SOUNDSET", false, 0);
			Local_301.f_6 = 1;
		}
		else
		{
			...
			iLocal_284 = (get_game_timer() + iVar10);
			iVar10 = (iVar10 / 3);
			if (iVar10 < 100)
			{
				iVar10 = 100;
			}
			iLocal_285 = (get_game_timer() + iVar10);
			play_sound_from_entity(Local_301.f_3, "IDLE_BEEP", player_ped_id(), "EPSILONISM_04_SOUNDSET", false, 0);
			if (bVar8)
			{
				set_pad_shake(0, 200, 150);
			}
			...
			{
				set_pad_shake(0, 200, 100);
			}
		}
	}
	if (iLocal_285 > 0 && get_game_timer() > iLocal_285)
	{
		stop_sound(Local_301.f_3);
		iLocal_285 = 0;
	}
	if (is_aim_cam_active())
	{
		if (Local_301.f_7 == 0)
		{
			play_sound_from_entity(Local_301.f_5, "SCAN", player_ped_id(), "EPSILONISM_04_SOUNDSET", false, 0);
			Local_301.f_7 = 1;
		}
		else if (bVar8)
		{
			set_variable_on_sound(Local_301.f_5, "IsOnTarget", 1f);
		}
		else
		{
			set_variable_on_sound(Local_301.f_5, "IsOnTarget", 0f);
		}
		iLocal_421 = get_game_timer();
	}
	...
	else
	{
		...
		begin_scaleform_movie_method(iLocal_95, "SET_DISTANCE");
		scaleform_movie_method_add_param_float(fLocal_302);
		end_scaleform_movie_method();
		set_text_render_id(iLocal_96);
		draw_scaleform_movie(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
...
void func_328(var uParam0)
{
	...
	if (func_350(*uParam0) && is_ped_in_group(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				iVar0 = get_random_int_in_range(0, iLocal_297);
				while (uParam0->f_3 == -1)
				{
					if (Local_296[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!is_entity_at_coord(*uParam0, Local_296[iVar0 /*6*/], 3f, 3f, 3f, false, true, 0))
							{
				...
				task_follow_nav_mesh_to_coord(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 40000f);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (get_script_task_status(*uParam0, 713668775) == 7)
					{
				...
				else if (get_script_task_status(*uParam0, 2106541073) == 7)
				{
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				open_sequence_task(&iLocal_97);
				if (Local_296[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_298[1 /*8*/])
					{
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0f, false, false, false);
					}
					else
					{
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0f, false, false, false);
					}
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 2)
				{
					task_achieve_heading(0, Local_296[uParam0->f_3 /*6*/].f_3, 0);
					task_play_anim(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0f, false, false, false);
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 3)
				{
					task_play_anim(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0f, false, false, false);
				}
				...
				close_sequence_task(iLocal_97);
				task_perform_sequence(*uParam0, iLocal_97);
				clear_sequence_task(&iLocal_97);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (get_script_task_status(*uParam0, 242628503) == 7)
				{
					Local_296[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!is_entity_at_coord(player_ped_id(), uParam0->f_4, 1f, 1f, 1f, false, true, 0) || iLocal_283 > 0)
				{
					if (!is_ped_in_group(*uParam0))
					{
						clear_ped_tasks(*uParam0);
						set_ped_as_group_member(*uParam0, func_329());
						set_ped_config_flag(*uParam0, 167, true);
					}
					iLocal_418 = get_game_timer();
					if (iLocal_283 == 0)
					{
						set_group_formation(func_329(), 0);
					}
					else
					{
						set_group_formation(func_329(), 0);
					}
					set_group_formation_spacing(func_329(), 4f, -1f, -1f);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (is_ped_still(*uParam0))
				{
					if (!iLocal_280)
					{
						if ((get_game_timer() - iLocal_418) > 6000)
						{
							open_sequence_task(&iLocal_97);
							if (*uParam0 == Local_298[1 /*8*/])
							{
				...
				if (is_ped_sprinting(player_ped_id()) || is_ped_jumping(player_ped_id()))
				{
					if ((((get_game_timer() - iLocal_419) > 7500 && !func_285()) && !is_message_being_displayed()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
				...
				if ((get_game_timer() - iLocal_421) > 15000)
				{
					if ((((iLocal_420 < 4 && !func_285()) && !is_message_being_displayed()) && !iLocal_267) && !func_351())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
		...
		case 5:
			...
			{
				task_go_to_entity(*uParam0, player_ped_id(), 20000, 4.5f, 2f, 2f, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_350(iParam0) && func_234(player_ped_id()))
	{
		if (iLocal_299 == 0)
		{
			if (is_entity_touching_entity(player_ped_id(), iParam0) && is_ped_ragdoll(iParam0))
			{
		...
		{
			if (is_ped_getting_up(iLocal_300) || is_ped_on_foot(iLocal_300))
			{
				if (!func_285() && !is_message_being_displayed())
				{
...
{
	play_sound_from_entity(Local_301.f_2, "DEVICE", player_ped_id(), "EPSILONISM_04_SOUNDSET", false, 0);
	if (Local_301.f_13 == 0)
	{
...
void func_334(var uParam0, int iParam1)
{
	if (func_350(*uParam0))
	{
		...
		clear_ped_tasks_immediately(*uParam0);
		set_entity_coords(*uParam0, Local_296[iParam1 /*6*/], true, false, false, true);
		set_entity_heading(*uParam0, Local_296[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
{
	if (func_350(*uParam0) && func_350(player_ped_id()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		task_look_at_entity(*uParam0, player_ped_id(), -1, 0, 2);
		if (bParam1)
		{
			task_turn_ped_to_face_entity(*uParam0, player_ped_id(), 0);
		}
		uParam0->f_4 = { get_entity_coords(player_ped_id(), true) };
	}
	else
	{
		uParam0->f_1 = 0;
...
int func_340()
{
	...
	if (has_anim_dict_loaded("rcm_epsilonism4") && has_anim_dict_loaded("rcm_epsilonism4leadinout"))
	{
		return 1;
	}
	return 0;
...
int func_341()
{
	...
	while (iVar0 < iLocal_294)
	{
		request_model(Local_293[iVar0 /*43*/]);
		iVar0++;
	}
	...
	while (iVar0 < iLocal_294)
	{
		if (!has_model_loaded(Local_293[iVar0 /*43*/]))
		{
			return 0;
		}
		iVar0++;
	}
	if (!has_model_loaded(iLocal_90) || !has_model_loaded(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
int func_342()
{
	request_additional_text("EPS4", 0);
...
void func_343()
{
	...
	if (Local_434.f_1 == 0)
	{
		if (!is_cutscene_active())
		{
			request_cutscene("ep_4_rcm_concat", 8);
		}
		...
		if (func_281(1, 1093140480, 0))
		{
			...
			{
				register_entity_for_cutscene(Local_81.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_350(Local_81.f_28[1]))
			{
				freeze_entity_position(Local_81.f_28[1], false);
				if (func_234(get_current_ped_weapon_entity_index(Local_81.f_28[1], 1)))
				{
					iLocal_303 = func_274(Local_81.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					register_entity_for_cutscene(iLocal_303, "Artefact_Detector", 0, 0, 0);
				}
				register_entity_for_cutscene(Local_81.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			if (func_350(player_ped_id()))
			{
				register_entity_for_cutscene(player_ped_id(), "Michael", 0, 0, 0);
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (func_234(player_ped_id()))
		{
			...
			{
				func_405("*** Forcing Michael's move state");
				func_346(player_ped_id(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				give_weapon_to_ped(player_ped_id(), iLocal_89, -1, true, true);
			}
		}
...
void func_344()
{
	...
	if (func_234(Local_298[1 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Jimmy_Boston", 0))
		{
			get_ground_z_for_3d_coord(1829.8f, 4693.48f, 38.5f, &fVar0, false, false);
			set_entity_coords(Local_298[1 /*8*/], 1829.8f, 4693.48f, fVar0, true, false, false, true);
		}
	}
}
...
void func_345()
{
	if (func_234(Local_298[0 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Marnie", 0))
		{
			...
			task_go_straight_to_coord(Local_298[0 /*8*/], Local_296[Local_298[0 /*8*/].f_3 /*6*/], 1f, -1, 40000f, 0.5f);
			force_ped_motion_state(Local_298[0 /*8*/], joaat("MotionState_Walk"), false, 1, true);
			Local_298[0 /*8*/].f_7 = 1;
...
int func_346(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_348()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_416(0) && is_entity_in_angled_area(player_ped_id(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, false, true, 0))
		{
	...
	if (Local_434.f_1 == 1)
	{
		if ((get_game_timer() - iLocal_284) > 1250)
		{
			play_sound_from_coord(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", false, 0, false);
			iLocal_284 = get_game_timer();
		}
		if (!func_416(0) && is_entity_in_angled_area(player_ped_id(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, false, true, 0))
		{
			if (func_233(player_ped_id(), Local_81.f_28[0], 1) >= 3f)
			{
				if (!is_gameplay_hint_active())
				{
					if (!iLocal_263)
					{
						...
						{
							set_gameplay_entity_hint(Local_81.f_28[0], 0f, 0f, 0.2f, true, 30000, 2000, 2000, 0);
							set_gameplay_hint_fov(fLocal_429);
							set_gameplay_hint_follow_distance_scalar(fLocal_430);
							set_gameplay_hint_base_orbit_pitch_offset(fLocal_431);
							_set_gameplay_hint_anim_offsetx(fLocal_432);
							_set_gameplay_hint_anim_offsety(fLocal_433);
							_set_gameplay_hint_anim_closeup(true);
							if (func_234(player_ped_id()))
							{
								open_sequence_task(&iLocal_97);
								task_look_at_entity(0, Local_81.f_28[0], 15000, 0, 2);
								task_follow_nav_mesh_to_coord(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, true, 40000f);
								task_turn_ped_to_face_entity(0, Local_81.f_28[0], 0);
								close_sequence_task(iLocal_97);
								task_perform_sequence(player_ped_id(), iLocal_97);
								clear_sequence_task(&iLocal_97);
			...
			if (!iLocal_264)
			{
				...
				{
					task_look_at_entity(Local_81.f_28[0], player_ped_id(), -1, 48, 2);
					task_play_anim(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0f, false, false, false);
					remove_cutscene();
					request_cutscene_with_playback_list("EP_4_RCM_CONCAT", 2, 8);
			...
			{
				if (is_entity_playing_anim(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (get_entity_anim_current_time(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_265)
						{
					...
					if (get_entity_anim_current_time(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						func_405("Leadin done, launch cutscene");
						func_242(1);
						Local_434.f_1 = 3;
					}
					if (func_233(player_ped_id(), Local_81.f_28[0], 1) <= 1.5f)
					{
						set_player_control(player_id(), false, 0);
						clear_ped_tasks(player_ped_id());
					}
...
{
	if (((!func_365(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_228(0)) || func_364(1))
			{
			}
			else
			{
...
void func_381(var uParam0)
{
	...
	uParam0->f_1 = create_object_no_offset(*uParam0, Var0, true, true, false);
	if (does_entity_exist(uParam0->f_1))
	{
		set_entity_rotation(uParam0->f_1, uParam0->f_5, 0, true);
		func_382("Rock rot vector: ", get_entity_rotation(uParam0->f_1, 0));
		func_382("Rock actual position: ", get_entity_coords(uParam0->f_1, false));
		set_entity_can_be_damaged(uParam0->f_1, false);
...
void func_383()
{
	Local_301.f_2 = get_sound_id();
	Local_301.f_3 = get_sound_id();
	Local_301.f_4 = get_sound_id();
	Local_301.f_5 = get_sound_id();
	Local_301.f_12 = 0.92f;
	Local_301.f_13 = 0;
	Local_301.f_14 = "NO_RECENT_ANIM";
	iLocal_95 = request_scaleform_movie("digiscanner");
	while (!has_scaleform_movie_loaded(iLocal_95))
	{
		wait(0);
	}
	...
	link_named_rendertarget(iLocal_90);
	if (is_named_rendertarget_registered("digiscanner"))
	{
		iLocal_96 = get_named_rendertarget_render_id("digiscanner");
	}
}
...
void func_403()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_288(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_407()
{
	return add_scenario_blocking_area(1789.2f, 4658f, 30.73f, 1871.87f, 4745.51f, 40.17f, false, true, true, true);
}
...
int func_408(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (func_350(player_ped_id()))
			{
				iVar3 = get_ped_relationship_group_hash(player_ped_id());
			}
			if (!does_entity_exist(uParam0->f_28[0]))
			{
				...
				{
					set_ped_relationship_group_hash(uParam0->f_28[0], iVar3);
			...
			if (!does_entity_exist(uParam0->f_28[1]))
			{
				...
				{
					set_ped_relationship_group_hash(uParam0->f_28[1], iVar3);
					set_ped_config_flag(uParam0->f_28[1], 132, true);
					set_ped_prop_index(uParam0->f_28[1], 1, 0, 0, false);
					clear_ped_tasks(uParam0->f_28[1]);
					give_weapon_to_ped(uParam0->f_28[1], joaat("weapon_digiscanner"), -1, true, true);
					task_play_anim(uParam0->f_28[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0f, false, false, false);
...
int func_409(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_410(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_418()
{
	...
	if (func_350(player_ped_id()))
	{
		...
		set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
		clear_ped_tasks(player_ped_id());
		set_ped_capsule(player_ped_id(), 0f);
	}
	if (is_new_load_scene_active())
	{
		new_load_scene_stop();
	}
	_0x61F95E5BB3E0A8C6(iLocal_290);
	if (func_234(Local_298[0 /*8*/]) && func_234(Local_298[1 /*8*/]))
	{
		if (is_ped_in_group(Local_298[0 /*8*/]))
		{
			remove_ped_from_group(Local_298[0 /*8*/]);
		}
		else if (is_ped_in_group(Local_298[1 /*8*/]))
		{
			remove_ped_from_group(Local_298[1 /*8*/]);
		}
	}
	func_419(&(Local_298[0 /*8*/]), 1, 1, 1);
	func_419(&(Local_298[1 /*8*/]), 1, 1, 1);
	release_named_rendertarget("digiscanner");
	remove_scenario_blocking_area(iLocal_92, false);
	remove_scenario_blocking_area(iLocal_93, false);
	remove_navmesh_blocking_object(iLocal_426);
	remove_navmesh_blocking_object(iLocal_427);
	remove_navmesh_blocking_object(iLocal_428);
	if (is_audio_scene_active("EPSILONISM_04_MIX"))
	{
...
void func_421(bool bParam0)
{
	...
	if (!func_436())
	{
		...
		{
			func_178(iVar0, 1, 0);
			func_422(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_423(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_429())
	{
		...
		{
			iVar2 = func_424(get_this_script_name());
			if (iVar2 > -1)
			{
