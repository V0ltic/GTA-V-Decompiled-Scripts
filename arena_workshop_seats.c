...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = network_get_local_scene_from_network_id(uParam0->f_43.f_1);
		if (is_synchronized_scene_running(iVar0))
		{
			network_stop_synchronised_scene(uParam0->f_43.f_1);
		}
	}
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 1:
			...
			if (func_64(uParam0))
			{
				uParam0->f_43.f_6 = get_game_timer();
				func_65(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_63(player_ped_id(), uParam0[uParam0->f_43.f_2 /*14*/]) && func_62(player_ped_id(), (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_43.f_2 /*14*/]))
			{
				...
				else
				{
					...
					{
						if ((get_game_timer() - uParam0->f_43.f_6) > 150)
						{
		...
		case 5:
			...
			{
				uParam0->f_43.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
				network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_43.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1000f, 0);
				network_start_synchronised_scene(uParam0->f_43.f_1);
				uParam0->f_43.f_8.f_4 = get_game_timer();
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = network_get_local_scene_from_network_id(uParam0->f_43.f_1);
			if (is_synchronized_scene_running(iVar9))
			{
				if (get_synchronized_scene_phase(iVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_43.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
					network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_43.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					network_start_synchronised_scene(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			iVar10 = network_get_local_scene_from_network_id(uParam0->f_43.f_1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((get_game_timer() - uParam0->f_43.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_43.f_8.f_1)
			{
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_43.f_4 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_43.f_4 == 6 && !has_anim_event_fired(player_ped_id(), -1322051853)) && !func_32(&(uParam0->f_43), 12))
		{
		...
		else
		{
			...
			if (((((!is_pause_menu_active() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				if (uParam0->f_43.f_5 == -1)
				{
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
	func_50(uParam0, &sVar0);
	network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_43.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	network_start_synchronised_scene(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
int func_52(var uParam0)
{
	...
	switch (uParam0->f_43.f_8)
	{
		...
		default:
			iVar0 = get_random_int_in_range(0, func_14(uParam0->f_43.f_8));
	}
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
int func_56(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			{
				if (func_63(get_player_ped(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || func_58(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((does_entity_exist(uVar0[iVar1]) && !is_ped_injured(uVar0[iVar1])) && is_entity_visible(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || vdist2(get_entity_coords(uVar0[iVar1], false), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_43.f_4 > 4)
	{
		...
		uParam0->f_43.f_7 = get_frame_count();
	}
	else if ((get_frame_count() - uParam0->f_43.f_7) < 5)
	{
		set_ped_capsule(player_ped_id(), func_68());
	}
}
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_43), 1, is_entity_dead(player_ped_id(), false));
	func_70(&(uParam0->f_43), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_70(&(uParam0->f_43), 0, func_45(0));
	func_70(&(uParam0->f_43), 2, is_ped_running(player_ped_id()));
}
...
int func_72()
{
	if ((is_screen_faded_out() && !func_82()) && !Global_2789734)
	{
		return 1;
	}
	if (!func_81())
...
int func_81()
{
	if (is_entity_in_angled_area(player_ped_id(), 207.5193f, 5163.855f, -86.59737f, 211.7083f, 5163.879f, -83.6007f, 6.25f, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_83()
{
	if (Global_2689235[player_id() /*453*/].f_318.f_9 != func_19())
	{
		if (network_is_script_active("arena_workshop_seats", Global_2689235[player_id() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
