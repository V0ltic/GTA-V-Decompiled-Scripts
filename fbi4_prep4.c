...
void __EntryFunction__()
{
	...
	while (true)
	{
		_0x208784099002BC30("M_MS", 0);
		if (func_246(player_ped_id()))
		{
			if (iLocal_80 == 2)
			{
				iLocal_191 = func_245();
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			clear_help(true);
			func_21();
			if (!is_string_null_or_empty(sLocal_187))
			{
				if (are_strings_equal(sLocal_187, "PRE_FKICKOFF"))
				{
					while ((get_game_timer() - iLocal_199) < 3000)
					{
						wait(0);
					}
				}
...
void func_23()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				task_look_at_coord(player_ped_id(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
		
		case 1:
			if (func_93(player_ped_id(), Local_196, 2f, 1) && func_87(21))
			{
			...
			else
			{
				...
				if (bLocal_190)
				{
					iLocal_198 = get_game_timer();
					iLocal_81 = 2;
				}
				else if (!func_93(player_ped_id(), Local_195, 75f, 1))
				{
					if (!iLocal_201)
					{
						func_22(&iLocal_192);
				...
				else if (func_93(player_ped_id(), Local_196, 12f, 1))
				{
					if (iLocal_201)
					{
						func_22(&iLocal_192);
					...
					{
						set_blip_colour(iLocal_192, 2);
						set_blip_route_colour(iLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((get_game_timer() - iLocal_198) > 2000)
			{
				func_22(&iLocal_192);
...
bool func_93(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_95(player_ped_id(), -1339.786f, -1277.51f, 3.8874f, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_95(player_ped_id(), Local_196, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_96(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			request_additional_text(sLocal_188, 0);
			request_additional_text(sLocal_203, 6);
...
void func_100(var uParam0)
{
	...
	func_77(uParam0, iVar0, player_ped_id(), sVar1, 0, 1);
}
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_93(player_ped_id(), Local_195, 60f, 1))
				{
		...
		case 3:
			func_95(player_ped_id(), Local_196, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
		...
		case 0:
			if (func_94(iLocal_80, 0))
			{
				...
				if (func_281())
				{
					...
					while (!func_110(21) && (get_game_timer() - iVar0) < 2000)
					{
						wait(0);
					}
					func_25(500, 1);
...
void func_116(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_121(*iParam1, 0, &uVar0))
		{
...
int func_121(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_150(iVar0, bParam1, uParam2) && !func_149(player_id())) && !func_131(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_129(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_127(iParam0)) && !bVar1) && !(func_126(get_entity_model(iParam0)) && func_123(player_id())))
	{
	...
	if (!network_is_game_in_progress())
	{
		if ((func_122(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_148(player_id()) || func_147(player_id()))
	{
		if (func_132(iParam0))
		{
			return 1;
...
int func_133(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_127(iParam0)) || func_134(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_135(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_137(get_entity_model(iParam0), 0))
			{
...
int func_150(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_129(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_174(iParam0, 0, 0)) || func_174(iParam0, 1, 0)) || func_174(iParam0, 2, 0)) || func_173(iParam0) != 145) || func_172(iParam0)) || func_171(iParam0)) || func_122(iParam0)) || func_170(iParam0)) || !func_158(get_entity_model(iParam0)))
	{
		if (func_171(iParam0))
		{
		}
...
int func_159(int iParam0, bool bParam1)
{
	...
	{
		if ((func_164() || is_pc_version()) || func_163())
		{
		}
		else if (!func_166())
		{
...
int func_179(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_146(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_182(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_182(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_181(iParam0);
	if (func_180(*iParam0))
	{
...
void func_187(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_188(iParam0, iParam1))
				{
...
int func_199(struct<3> Param0, float fParam1)
{
	return func_200(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_200(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_202(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_203(iParam0, uVar1[iVar3], 1) && func_98(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_198(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
void func_204(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		if (((func_205() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
void func_233()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(player_ped_id(), Local_195, 150f, 1))
				{
					func_239(2);
				}
				else if (!func_93(player_ped_id(), Local_195, 75f, 1))
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_288(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_288(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_296(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_362(bool bParam0)
{
	...
	if (does_cam_exist(iLocal_193))
	{
		render_script_cams(false, false, 3000, true, false, 0);
		destroy_cam(iLocal_193, false);
	}
}
