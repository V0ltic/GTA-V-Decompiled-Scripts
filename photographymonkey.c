						...
						if (fVar0 < fLocal_46)
						{
							...
							if (((((fVar7 >= 0.35f && func_98(Var1, 0f, 1f)) && func_98(Var2, 0f, 1f)) && func_98(Var3, 0f, 1f)) && func_98(Var4, 0f, 1f)) || ((((fVar7 < 0.35f && func_98(Var1, 0.05f, 0.95f)) && func_98(Var2, 0.05f, 0.95f)) && func_98(Var3, 0.05f, 0.95f)) && func_98(Var4, 0.05f, 0.95f)))
							{
								if (fVar5 >= 0.08f && fVar6 >= 0.101f)
								{
									...
									{
										bVar8 = ((((is_tracked_point_visible(iLocal_49) && is_tracked_point_visible(iLocal_50)) && is_tracked_point_visible(iLocal_51)) && is_tracked_point_visible(iLocal_52)) && is_tracked_point_visible(iLocal_53));
										iVar9++;
										wait(0);
									}
									if (bVar8)
									{
										func_96(iLocal_48, 1);
										stat_set_int(joaat("num_hidden_packages_6"), func_93(), true);
										bLocal_58 = true;
										if (func_106())
										{
											func_6();
...
void func_2(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			set_bit(&(Global_113386.f_24995), iVar0);
		}
		else
		{
			clear_bit(&(Global_113386.f_24995), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			set_bit(&(Global_113386.f_24995.f_1), iVar0);
		}
		else
		{
			clear_bit(&(Global_113386.f_24995.f_1), iVar0);
		}
	}
}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_13(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_13(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_24(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_24(iParam2));
...
void func_96(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_bit(&(Global_113386.f_10049.f_135[iVar0]), iVar1);
	}
	else
	{
		clear_bit(&(Global_113386.f_10049.f_135[iVar0]), iVar1);
	}
}
...
void func_97(int iParam0, struct<3> Param1, float fParam2)
{
	*iParam0 = create_tracked_point();
	...
	{
		set_tracked_point_info(*iParam0, Param1, fParam2);
	}
}
...
int func_98(struct<3> Param0, float fParam1, float fParam2)
{
	...
	if (get_screen_coord_from_world_coord(Param0, &fVar0, &fVar1))
	{
...
void func_99(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, float fParam4)
{
	...
	get_screen_coord_from_world_coord(Param0, &Var0, &(Var0.f_1));
	get_screen_coord_from_world_coord(Param1, &Var1, &(Var1.f_1));
	get_screen_coord_from_world_coord(Param2, &Var2, &(Var2.f_1));
...
Vector3 func_102(struct<3> Param0, struct<3> Param1)
{
...
bool func_106()
{
	...
	return Global_113386.f_10049.f_135[iVar0] == (round(pow(2f, to_float(iVar1 + 1))) - 1);
}
...
void func_107()
{
	if (bLocal_58)
	{
		if (has_scaleform_movie_loaded(iLocal_57))
		{
			draw_scaleform_movie(iLocal_57, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_56)
		{
			case 0:
			...
			case 1:
				if (iLocal_60 < get_game_timer())
				{
					if (!func_113())
					{
						iLocal_57 = request_scaleform_movie("MIDSIZED_MESSAGE");
						iLocal_60 = get_game_timer() + 5000;
						iLocal_56++;
					}
				}
				break;
			...
			case 2:
				if (has_scaleform_movie_loaded(iLocal_57) || iLocal_60 < get_game_timer())
				{
					if (iLocal_60 < get_game_timer())
					{
						bLocal_58 = false;
			...
			case 3:
				begin_scaleform_movie_method(iLocal_57, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_112("PM_TITLE");
				scaleform_movie_method_add_param_int(50);
				func_112("PM_PASS");
				func_112("PM_CHALLENGE");
				scaleform_movie_method_add_param_int(func_93());
				end_scaleform_movie_method();
				iLocal_60 = get_game_timer() + 7500;
				play_sound_frontend(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", true);
				iLocal_56++;
				break;
			
			case 4:
				if ((((((iLocal_60 < get_game_timer() || is_screen_faded_out()) || !is_player_playing(player_id())) || func_113()) || !is_player_control_on(player_id())) || func_111()) || func_110())
				{
					begin_scaleform_movie_method(iLocal_57, "SHARD_ANIM_OUT");
					scaleform_movie_method_add_param_int(1);
					scaleform_movie_method_add_param_float(0.33f);
					end_scaleform_movie_method();
					iLocal_60 = get_game_timer() + 500;
					iLocal_56++;
				}
				break;
			...
			case 6:
				set_scaleform_movie_as_no_longer_needed(&iLocal_57);
				if (func_106())
				{
					iLocal_60 = get_game_timer() + 1000;
					iLocal_56++;
				}
				else
				{
