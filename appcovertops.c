...
void __EntryFunction__()
{
	...
	iLocal_132 = -1;
	sLocal_134 = "";
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appCovertOps")) > 1)
	{
		func_263(0, 0);
	}
	func_215();
...
void func_41()
{
	...
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_311) && is_scaleform_movie_method_return_value_ready(iLocal_312))
		{
			iVar0 = get_scaleform_movie_method_return_value_int(iLocal_311);
			iVar1 = get_scaleform_movie_method_return_value_int(iLocal_312);
			switch (iVar0)
			{
				case 102:
...
{
	begin_scaleform_movie_method(iLocal_310, "SHOW_OVERLAY");
	func_48(sParam0);
...
void func_61(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (func_131(Var0))
		{
			if (func_148(player_id(), 0))
			{
				if (does_entity_exist(func_128()) && !is_entity_dead(func_128(), false))
				{
					Var0 = { get_entity_coords(func_128(), true) };
					Var1 = { 0f, 0f, get_entity_heading(func_128()) };
					if (func_127(Global_1853348[player_id() /*834*/].f_775, 1, 0))
					{
			...
			if ((func_126(player_id()) || func_124(player_id())) && func_123())
			{
	...
	{
		iVar6 = func_118(player_id());
		Var0 = { _get_object_offset_from_coords(func_117(iVar6), func_116(iVar6), 3.5688f, 7.9792f, 4.1641f) };
	...
	{
		func_100();
		func_99(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		if (!func_131(Var7))
		{
			Var0 = { Var7 };
		}
		func_93(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		Var1 = { Var7 };
	}
...
void func_62(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (network_is_game_in_progress())
		{
			...
			{
				func_80(player_id(), 0, 32768, 0);
			}
			else if (func_63())
			{
				func_80(player_id(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_80(player_id(), 0, 319492, 0);
			}
		}
		else
		{
			func_80(player_id(), 0, 57348, 0);
		}
	}
}
...
int func_69()
{
	if (func_148(player_id(), 0))
	{
		if (Global_1853348[player_id() /*834*/].f_775 != func_17())
		{
			if (func_70(Global_1853348[player_id() /*834*/].f_775, 0, 1))
			{
				if (func_127(Global_1853348[player_id() /*834*/].f_775, 1, 0))
				{
					return 0;
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_148(player_id(), 0) && !func_88()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_84(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
Vector3 func_95(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
{
	if (!animpostfx_is_running(func_137(0)))
	{
		animpostfx_play(func_137(iParam0), 0, true);
	}
}
...
void func_155(int iParam0)
{
	...
	if (func_157() == 0 || is_pause_menu_active())
	{
		func_156(1);
...
void func_159(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_157() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_156(0);
...
void func_190()
{
	begin_scaleform_movie_method(iLocal_310, "HIDE_OVERLAY");
	end_scaleform_movie_method();
	func_47(0);
...
void func_191()
{
	if (func_192())
	{
		if (!BitTest(uLocal_129, 0))
		{
			begin_scaleform_movie_method(iLocal_310, "GET_CURRENT_SELECTION");
			iLocal_311 = end_scaleform_movie_method_return_value();
			begin_scaleform_movie_method(iLocal_310, "GET_CURRENT_SCREEN_ID");
			iLocal_312 = end_scaleform_movie_method_return_value();
			set_bit(&uLocal_129, 0);
		}
	}
}
...
void func_193()
{
	...
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 206, true);
	if (is_control_just_pressed(2, 206))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		...
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
		enable_control_action(2, 187, true);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_RELEASE_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_RELEASE_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (is_control_just_pressed(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
		}
		enable_control_action(2, 187, true);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
		}
	}
	enable_control_action(2, 189, true);
	if (is_control_just_pressed(2, 189))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 190, true);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 201, true);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 202, true);
	if (is_control_just_pressed(2, 202))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1f, -1f);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 204, true);
	if (is_control_just_pressed(2, 204))
	{
		call_scaleform_movie_method_with_number(iLocal_310, "SET_INPUT_EVENT", to_float(204), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		begin_scaleform_movie_method(iLocal_310, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			begin_scaleform_movie_method(iLocal_310, "SET_ANALOG_STICK_INPUT");
			iLocal_313 = iVar0;
			iLocal_314 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_313);
			scaleform_movie_method_add_param_int(iLocal_314);
			end_scaleform_movie_method();
		}
	}
	...
	if (((iVar2 != 127 || iLocal_315 != 127) || iVar3 != 127) || iLocal_316 != 127)
	{
		...
		scaleform_movie_method_add_param_int(iLocal_315);
		scaleform_movie_method_add_param_int(iLocal_316);
...
void func_195()
{
	...
	set_script_gfx_draw_order(1);
	draw_scaleform_movie_fullscreen(iLocal_310, 255, 255, 255, 255, 0);
	func_204();
	func_198(0);
	func_196(1);
}
...
void func_210()
{
	...
	else if (!func_212(player_id()))
	{
		func_263(0, 0);
	}
	else if (func_211(player_id()))
	{
		func_263(0, 0);
	}
}
...
int func_212(int iParam0)
{
	if (iParam0 != func_17())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_70(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
{
	func_210();
	iLocal_310 = request_scaleform_movie("COVERT_OPS");
	while (!has_scaleform_movie_loaded(iLocal_310))
	{
		wait(0);
	}
...
void func_220()
{
	...
	begin_scaleform_movie_method(iLocal_310, "SET_PLAYER_DATA");
...
void func_221(int iParam0)
{
	...
	if (iVar1 != -1)
	{
		if (!func_253())
		{
			...
			if (iVar1 != -1)
			{
				func_222(&fVar5, &fVar6, 0, 9, 0, 0, get_hash_key(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	begin_scaleform_movie_method(iLocal_310, "ADD_MISSION");
	scaleform_movie_method_add_param_int(iParam0);
	if (iVar1 != -1)
	{
		_scaleform_movie_method_add_param_texture_name_string_2(&(Global_794709.f_4[iVar1 /*88*/].f_22));
		begin_text_command_scaleform_string("FMMC_OFFLN_HD");
		iVar0 = 0;
		while (iVar0 < 8)
		{
			add_text_component_substring_player_name(&(Local_135[iVar0 /*16*/]));
			iVar0++;
		}
		end_text_command_scaleform_string();
	}
	...
	_scaleform_movie_method_add_param_texture_name_string_2(sVar4);
	scaleform_movie_method_add_param_int(iVar2);
	scaleform_movie_method_add_param_bool(bVar3);
	scaleform_movie_method_add_param_int(floor(fVar6));
...
bool func_249(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (!bVar7)
		{
			...
			{
				StringCopy(&(Local_135[iVar5 /*16*/]), _get_text_substring_safe(sVar2, iVar3, iVar4, 63), 64);
				iVar3 = (iVar3 + get_length_of_literal_string(&(Local_135[iVar5 /*16*/])));
				iVar5++;
			}
		}
	}
...
{
	set_scaleform_movie_as_no_longer_needed(&iLocal_310);
	func_259(iParam1);
	func_261(0);
	func_264();
