...
void func_186(int iParam0)
{
	...
	if ((get_game_timer() - iLocal_58) > 1250)
	{
		if (func_129(iParam0->f_28[0]) && !is_entity_on_screen(iParam0->f_28[0]))
		{
			if (func_129(player_ped_id()) && !func_187(player_ped_id(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { get_entity_coords(iParam0->f_28[0], true) };
				Var1 = { get_entity_coords(player_ped_id(), true) };
				fVar3 = (Var1.f_0 - Var0.f_0);
				fVar4 = (Var1.f_1 - Var0.f_1);
				if (fVar4 != 0f)
				{
					fVar2 = atan2(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				set_entity_heading(iParam0->f_28[0], fVar2);
			}
		}
...
void func_188()
{
	...
	begin_scaleform_movie_method(iLocal_56, "SET_COLOUR");
	...
	begin_scaleform_movie_method(iLocal_56, "SET_DISTANCE");
	scaleform_movie_method_add_param_float(10f);
	end_scaleform_movie_method();
	set_text_render_id(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	draw_scaleform_movie(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((get_game_timer() - iLocal_58) > 1250)
	{
		play_sound_from_coord(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, false);
		iLocal_58 = get_game_timer();
	}
}

int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_177(2))
		{
			if (!func_148())
			{
				if ((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && func_196(player_ped_id(), Param1, 1) < 20f)
				{
			...
			if (func_196(player_ped_id(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
void func_206(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_207(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_217(int iParam0, float fParam1)
{
	...
	{
		if (func_228(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_219(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_225(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_225(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_232(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_225(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_244()
{
	iLocal_56 = request_scaleform_movie("digiscanner");
	while (!has_scaleform_movie_loaded(iLocal_56))
	{
		wait(0);
	}
	...
	if (is_named_rendertarget_registered("digiscanner"))
	{
		iLocal_57 = get_named_rendertarget_render_id("digiscanner");
	}
	iLocal_59 = get_sound_id();
	iLocal_58 = get_game_timer();
}
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_248(iParam0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if ((func_129(uParam0->f_28[0]) && does_entity_exist(uParam0->f_41[0])) && does_entity_exist(uParam0->f_41[1]))
			{
...
void func_269(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && does_entity_exist(iParam0->f_41[1]))
		{
			set_object_as_no_longer_needed(&(iParam0->f_41[1]));
		}
