...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { get_entity_coords(iLocal_68, false) };
		fVar2 = vdist2(Local_170 + Local_173, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			task_vehicle_drive_wander(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (is_vehicle_driveable(iLocal_70, false))
	{
	}
	else
	{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (is_synchronized_scene_running(Global_97771))
		{
			...
			if (!func_5(Global_100162, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					set_ped_into_vehicle(Global_100162, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
		...
		else
		{
			...
			stop_synchronized_entity_anim(iLocal_70, -8f, true);
			wait(100);
			if (!func_3(&uVar0))
			{
				open_sequence_task(&iVar2);
				task_vehicle_temp_action(0, iLocal_70, 24, 50);
				task_pause(0, 2000);
				task_vehicle_drive_to_coord(0, iLocal_70, Local_170 + Local_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				close_sequence_task(iVar2);
				task_perform_sequence(iLocal_68, iVar2);
...
void func_22()
{
	...
	iLocal_70 = get_random_vehicle_in_sphere(Local_173 + Local_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!does_entity_exist(Global_100162) || !does_entity_exist(iLocal_70)) || (!has_model_loaded(iLocal_69) && iVar0 < 400))
	{
	...
	{
		set_ped_relationship_group_hash(Global_100162, Global_95445);
		set_ambient_voice_name(Global_100162, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!is_entity_dead(iLocal_70, false))
	{
		set_vehicle_engine_on(iLocal_70, true, true, false);
		set_vehicle_doors_locked(iLocal_70, 2);
		set_vehicle_on_ground_properly(iLocal_70, 5f);
		iLocal_68 = create_ped_inside_vehicle(iLocal_70, 4, iLocal_69, -1, true, true);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
int func_32(int iParam0, bool bParam1)
{
	...
	{
		if ((func_37() || is_pc_version()) || func_36())
		{
		}
		else if (!func_39())
		{
...
void func_52()
{
	if (!is_entity_dead(iLocal_68, false) && does_entity_belong_to_this_script(iLocal_68, true))
	{
		set_ped_as_no_longer_needed(&iLocal_68);
	}
	if (!is_entity_dead(iLocal_70, false) && does_entity_belong_to_this_script(iLocal_70, true))
	{
		set_vehicle_as_no_longer_needed(&iLocal_70);
	}
	set_vehicle_model_is_suppressed(iLocal_69, false);
	set_model_as_no_longer_needed(iLocal_69);
