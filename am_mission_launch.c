...
void __EntryFunction__()
{
	...
	{
		func_391();
		if (func_383() || !func_382(player_id(), 0, 1))
		{
			func_380();
		}
		switch (func_379(participant_id_to_int()))
		{
			case 0:
				if (func_378() == 2)
				{
					Local_88[participant_id_to_int() /*3*/].f_1 = 2;
				}
				else if (func_378() == 6)
				{
					Local_88[participant_id_to_int() /*3*/].f_1 = 5;
				}
				break;
			...
			case 2:
				...
				if (((func_51(player_id(), 1, 0) || func_48(player_id())) || BitTest(uLocal_91, 8)) || BitTest(uLocal_91, 16))
				{
					Local_88[participant_id_to_int() /*3*/].f_1 = 6;
				}
				break;
...
int func_6()
{
	if (Local_83.f_5 == 0)
	{
		...
		{
			bLocal_99 = false;
			iLocal_100 = get_random_int_in_range(0, 5);
			iLocal_86 = 0;
			Local_83.f_3 = -1;
			Local_83.f_4 = 0;
			set_bit(&Local_83, true);
		}
...
int func_7()
{
	...
	iVar0 = func_35();
	iVar1 = func_34();
	if (!network_does_entity_exist_with_network_id(Local_83.f_12[0]))
	{
		if (Local_83.f_15 == 0)
		{
			...
			if (func_26(iVar1))
			{
				if (func_26(iVar0))
				{
					if (func_14(&Var2, &fVar3))
					{
						...
						{
							set_entity_only_damaged_by_player(net_to_veh(Local_83.f_12[0]), true);
							if (decor_is_registered_as_type("Not_Allow_As_Saved_Veh", 3))
							{
								decor_set_int(net_to_veh(Local_83.f_12[0]), "Not_Allow_As_Saved_Veh", 1);
							}
							Local_83.f_15 = 1;
						}
					}
	...
	if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
	{
		if (!network_does_entity_exist_with_network_id(Local_83.f_9[0]))
		{
			if (Local_83.f_16 == 0)
			{
			...
			if (can_register_mission_peds(1))
			{
				if (func_26(iVar0))
				{
					...
					{
						if (network_has_control_of_network_id(Local_83.f_12[0]))
						{
							if (func_8(&(Local_83.f_9[0]), Local_83.f_12[0], 26, iVar0, -1, 1, 1, 1))
							{
								set_entity_only_damaged_by_player(net_to_ped(Local_83.f_9[0]), true);
								set_entity_is_target_priority(net_to_ped(Local_83.f_9[0]), true, 0f);
								set_blocking_of_non_temporary_events(net_to_ped(Local_83.f_9[0]), true);
								set_ped_relationship_group_hash(net_to_ped(Local_83.f_9[0]), Global_1837197);
								set_entity_is_target_priority(net_to_ped(Local_83.f_9[0]), true, 0f);
								set_entity_health(net_to_ped(Local_83.f_9[0]), round((200f * Global_262145.f_164)), 0);
								Local_83.f_16 = 1;
							}
						}
					}
	...
	if (!network_does_entity_exist_with_network_id(Local_83.f_9[0]) || !network_does_entity_exist_with_network_id(Local_83.f_12[0]))
	{
		return 0;
	}
	return 1;
...
int func_9(int iParam0)
{
	...
	{
		return !func_10(net_to_veh(iParam0));
	}
	return 0;
}
...
int func_11(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
...
void func_12(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	if (func_13(player_id(), Param0, iParam2) > -1)
	{
...
int func_14(var uParam0, var uParam1)
{
	...
	if (iLocal_100 < 5)
	{
		if (!func_25(Var0, 0f, 0f, 0f, 0))
		{
			if (Local_83.f_3 == -1)
			{
				Local_83.f_3 = network_add_entity_area(Var0, Var1);
			}
			else if (network_entity_area_does_exist(Local_83.f_3))
			{
				if (network_entity_area_have_all_replied(Local_83.f_3))
				{
					if (!network_entity_area_is_occupied(Local_83.f_3))
					{
						if (!func_15(Var2, 1084227584, 1, 1, 1123024896, 0, -1, 0, 0))
						{
							*uParam0 = { Var2 };
							*uParam1 = fVar3;
							network_remove_entity_area(Local_83.f_3);
							return 1;
						}
						else
						{
...
int func_15(struct<3> Param0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_382(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_20(player_id()), Param0, true) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_17(iVar1, 0) && _network_is_player_equal_to_index(player_id(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != player_id()))
				{
					if ((func_16(iVar1) || !bParam8) && !Global_2689235[iVar1 /*453*/].f_267)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (get_distance_between_coords(func_20(iVar1), Param0, true) <= (fVar2 + fParam1))
								{
...
int func_36()
{
	...
	if (BitTest(Local_83.f_0, 1))
	{
		...
		if (iLocal_86 == 0)
		{
			set_bit(&uLocal_91, true);
		}
		if (bLocal_99 < 5)
		{
			iVar5 = iLocal_86;
			if (network_is_participant_active(int_to_participantindex(iVar5)))
			{
				iVar0 = network_get_player_index(int_to_participantindex(iVar5));
				if (func_382(iVar0, 1, 1))
				{
					iVar1 = get_player_ped(iVar0);
					if (BitTest(uLocal_91, 1))
					{
						Var2 = { func_24(Local_83.f_5, bLocal_99) };
						Var3 = { get_entity_coords(iVar1, false) };
						fVar4 = get_distance_between_coords(Var2, Var3, true);
						if (fVar4 < 300f)
						{
							clear_bit(&uLocal_91, true);
						}
					}
				}
			}
			...
			if (iLocal_86 == Local_88.f_0)
			{
				if (BitTest(uLocal_91, 1))
				{
					set_bit(&(Local_83.f_4), bLocal_99);
				}
			}
		}
		else
		...
		switch (Local_83.f_6)
		{
				...
				if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
				{
					if (!func_40(Local_83.f_9[0]))
					{
						if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
						{
							if (func_9(Local_83.f_12[0]))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_83.f_9[0]), net_to_veh(Local_83.f_12[0])))
								{
			...
			case 2:
				if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
				{
					if (!func_40(Local_83.f_9[0]))
					{
						if (!is_ped_sitting_in_any_vehicle(net_to_ped(Local_83.f_9[0])))
						{
							Local_83.f_6 = 4;
						}
						else if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
						{
							if (!func_9(Local_83.f_12[0]))
							{
								Local_83.f_6 = 3;
			...
			case 3:
				if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
				{
					if (!func_40(Local_83.f_9[0]))
					{
						if (!is_ped_in_any_vehicle(net_to_ped(Local_83.f_9[0]), false))
						{
							Local_83.f_6 = 4;
						}
					}
...
void func_41()
{
	...
	if (network_is_host_of_this_script())
	{
		if (iLocal_85 >= Local_88.f_0)
		{
			iLocal_85 = 0;
			iLocal_98 = 0;
			clear_bit(&uLocal_91, false);
			set_bit(&uLocal_91, 5);
			clear_bit(&Local_83, 5);
			clear_bit(&Local_83, 17);
			clear_bit(&uLocal_91, 14);
			clear_bit(&uLocal_91, 19);
		...
		{
			iVar3 = network_get_player_index(int_to_participantindex(iVar0));
			bVar2 = iVar3;
			if (BitTest(uLocal_91, 5))
			{
				if (Local_88[iVar0 /*3*/].f_2 < 7)
				{
					clear_bit(&uLocal_91, 5);
				}
			}
			if (!BitTest(Local_83.f_0, 0))
			{
			...
			else if (BitTest(Local_88[iVar0 /*3*/], 2))
			{
				...
				if (!BitTest(Local_83.f_0, 4))
				{
					if (BitTest(Local_88[iVar0 /*3*/], 1))
					{
						Local_83.f_8 = iVar3;
						set_bit(&Local_83, 4);
						clear_bit(&uLocal_91, 15);
						clear_bit(&Local_83, 18);
					}
				}
				if (!BitTest(Local_83.f_0, 4))
				{
		...
		if (iLocal_85 >= Local_88.f_0)
		{
			...
			{
				clear_bit(&Local_83, 17);
				clear_bit(&Local_83, 15);
				clear_bit(&Local_83, 12);
...
void func_54()
{
	...
	if (BitTest(Local_83.f_0, 10))
	{
		if (Local_88[participant_id_to_int() /*3*/].f_2 < 6)
		{
			Local_88[participant_id_to_int() /*3*/].f_2 = 6;
		}
	}
	if (BitTest(Local_83.f_0, 4))
	{
	...
	if (Local_88[participant_id_to_int() /*3*/].f_2 > 0)
	{
		if (Local_88[participant_id_to_int() /*3*/].f_2 < 6)
		{
			if ((((func_51(player_id(), 1, 0) || func_356()) || func_355() > 0) || func_49(player_id(), 1)) || func_354())
			{
				Local_88[participant_id_to_int() /*3*/].f_2 = 6;
			}
		}
	...
	switch (Local_88[participant_id_to_int() /*3*/].f_2)
	{
		case 0:
			if (BitTest(Local_88[participant_id_to_int() /*3*/], 0))
			{
				if (BitTest(Local_83.f_0, 3))
				{
					if (!BitTest(Local_83.f_0, 15))
					{
						set_bit(&(Local_88[participant_id_to_int() /*3*/]), 2);
						func_351(11, 1);
						Local_88[participant_id_to_int() /*3*/].f_2 = 3;
					}
					else
					{
						Local_88[participant_id_to_int() /*3*/].f_2 = 6;
						set_bit(&uLocal_91, 16);
					}
				}
			}
			break;
		...
		case 3:
			if (func_350(Local_83.f_5))
			{
				...
				Local_88[participant_id_to_int() /*3*/].f_2 = 4;
			}
			break;
		...
		case 4:
			if (!func_348())
			{
				if (func_224())
				{
					Local_88[participant_id_to_int() /*3*/].f_2 = 5;
					func_222(88, 1);
					func_221();
				}
		...
		case 6:
			Local_88[participant_id_to_int() /*3*/] = 0;
			clear_bit(&uLocal_91, 3);
			clear_bit(&uLocal_91, 4);
			iLocal_90 = 0;
			func_198(12, 116);
			if (does_blip_exist(Global_1931395))
			{
				remove_blip(&Global_1931395);
			}
			func_62(&Local_103);
			func_55();
			func_351(11, 0);
			Local_88[participant_id_to_int() /*3*/].f_2 = 7;
			break;
		
		case 7:
			if (Local_83.f_2 == 0 && !BitTest(Local_83.f_0, 10))
			{
				Local_88[participant_id_to_int() /*3*/].f_2 = 0;
			}
			break;
	}
}
	...
	if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
	{
		if (!func_40(Local_83.f_9[0]))
		{
			if (does_blip_exist(Global_1931395))
			{
				...
				{
					set_blip_display(Global_1931395, 0);
				}
				else
				{
					set_blip_display(Global_1931395, 4);
				}
			}
			else
			{
				Global_1931395 = add_blip_for_entity(net_to_ped(Local_83.f_9[0]));
				set_blip_colour(Global_1931395, 1);
				set_blip_scale(Global_1931395, 0f);
			}
			if (does_blip_exist(Local_103.f_0))
			{
				if (func_197() || func_196())
				{
					set_blip_display(Local_103.f_0, 0);
				}
				else
				{
					set_blip_display(Local_103.f_0, 4);
				}
				if (!BitTest(uLocal_91, 10))
				{
					set_blip_name_from_text_file(Local_103.f_0, "FM_GDM_BLP");
					set_bit(&uLocal_91, 10);
				}
			}
			if (does_blip_exist(Local_103.f_1))
			{
				if (func_197() || func_196())
				{
					set_blip_display(Local_103.f_1, 0);
				}
				else
				{
					set_blip_display(Local_103.f_1, 4);
				}
				if (!BitTest(uLocal_91, 12))
				{
					set_blip_name_from_text_file(Local_103.f_1, "FM_GDM_BLP");
					set_bit(&uLocal_91, 12);
				}
			}
			if (!BitTest(uLocal_91, 6))
			{
				if (!BitTest(Global_2621446, 7) && !func_192(player_id(), 0, -1))
				{
			...
			else if (func_192(player_id(), 0, -1))
			{
				func_55();
				clear_bit(&uLocal_91, 6);
			}
		...
		if (!BitTest(Local_88[participant_id_to_int() /*3*/], 1))
		{
			iVar1 = network_get_destroyer_of_network_id(Local_83.f_9[0], &uVar0);
			if (iVar1 == player_id())
			{
				set_bit(&(Local_88[participant_id_to_int() /*3*/]), true);
				iVar2 = func_182(func_184(player_id(), 1), 1);
				if (iVar2 > 100)
				{
					iVar2 = 100;
				}
				iVar3 = iVar2 * 20;
				iVar3 = round((Global_262145.f_4238 * IntToFloat(iVar3)));
				func_138(2, "XPT_KAIE", -1859646258, 2131309714, iVar3, 1, -1, 0);
				if (Global_262145.f_2432 != 0f)
				{
					iVar4 = round(Global_262145.f_2432);
				}
				else
				{
					iVar4 = 2000;
				...
				{
					iVar5 = round(Global_262145.f_2428);
				}
				else
				{
					iVar5 = 8000;
				...
				{
					network_earn_from_ai_target_kill(iVar8, -1146479277);
				}
				func_65(5, iVar8);
			}
			else if (iVar1 != func_64())
			{
				...
				{
					if (!BitTest(Local_88[participant_id_to_int() /*3*/], 7))
					{
						if (!network_is_player_a_participant(iVar1))
						{
							set_bit(&(Local_88[participant_id_to_int() /*3*/]), 7);
						}
					}
				}
			}
	...
	if (*iParam0 > 0)
	{
		if (!func_136())
		{
			if (func_135(0))
			{
				if (!func_131(0))
				{
					if (network_is_player_active(func_130()))
					{
						if (func_129() == 100)
						{
							iVar0 = *iParam0;
...
void func_80(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_382(bParam0, 0, 1))
	{
		...
		_trigger_script_event_2(1, &Var0, 8, func_77(bParam0));
	}
}
...
int func_84(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (_network_is_player_equal_to_index(player_id(), iParam1) || iParam5)
	{
		...
		set_colour_of_next_text_component(func_91(iParam1, -2, 1, 0, 0));
		add_text_component_substring_player_name(func_89(&Var1));
		if (!iParam3 == 0)
		{
...
void func_85(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_88() || !network_is_activity_session()) || !func_17(player_id(), 0))
	{
		return;
	}
...
int func_91(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_352(player_id()) || (func_126() && func_125())) && !BitTest(Global_2815059.f_4660, 31)) && !bParam4)
	{
		iVar1 = func_124();
		if (does_entity_exist(iVar1))
		{
			if (is_ped_a_player(iVar1))
			{
				...
				{
					if (func_382(network_get_player_index_from_ped(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_104(iParam0, network_get_player_index_from_ped(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_104(iParam0, player_id(), iParam1, bParam2, bParam3);
		}
	}
	return func_104(iParam0, player_id(), iParam1, bParam2, bParam3);
}
...
{
	return func_93(player_id(), bParam0, iParam1, bParam2);
}
...
int func_103()
{
	if (func_101() && network_is_activity_session())
	{
		return 1;
	}
	return 0;
...
int func_104(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_106(iParam1, iParam0, iVar0, 0) && !BitTest(Global_4718592.f_15, 18)) || ((func_98(get_player_team(iParam1), get_player_team(iParam0), 0) && BitTest(Global_4718592.f_15, 23)) && !BitTest(Global_4718592.f_15, 18)))
			{
				return func_97(1);
			}
...
int func_122(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_64())
	{
		...
		if (BitTest(Global_4718592.f_15, 26) && !func_98(iParam0, get_player_team(iParam1), 0))
		{
			iVar0 = func_105(1);
		}
	}
...
{
	return func_132(player_id(), bParam0);
}
...
int func_140(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (func_171())
	{
		...
		if (bParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_151((func_159(player_id()) + iVar1), iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (bParam7)
		{
			if (iParam6 == -1)
			{
				func_141((func_143(player_id()) + iVar1));
			}
			else
			{
				func_141((func_143(player_id()) + iParam6));
			}
		}
	}
	return iVar1;
...
void func_151(int iParam0, int iParam1, int iParam2)
{
	if (func_171())
	{
		...
		if (func_157(player_id()))
		{
			...
			Global_1853348[player_id() /*834*/].f_205.f_6 = func_182(iParam0, 1);
		}
...
void func_163(int iParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		...
		if (network_is_participant_active(iVar4))
		{
			...
			{
				if (get_player_team(iVar5) == iVar1 || func_98(get_player_team(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != player_id())
					{
						if (func_165(player_id(), iVar5))
						{
							bVar3 = true;
						}
					}
	...
	if (bVar3)
	{
		iVar6 = round((func_164(*iParam0, 100) * (10f * Global_262145.f_4227)));
	}
	if (iVar2 > 4)
	{
		iVar2 = 4;
	...
	if (iVar2 >= 2)
	{
		iVar7 = round((func_164(*iParam0, 100) * (20f * Global_262145.f_4220)));
	}
...
void func_166(bool bParam0, int iParam1)
{
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_382(iVar4, 1, 1))
			{
				if (iVar4 != player_id())
				{
					if (func_167(player_id(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_165(player_id(), iVar4))
						{
	...
	if (bVar2)
	{
		iVar5 = round((func_164(*iParam1, 100) * (10f * Global_262145.f_4227)));
	}
	if (iVar1 > 4)
	{
		iVar1 = 4;
	...
	if (iVar1 >= 1)
	{
		iVar6 = round((func_164(*iParam1, 100) * (20f * Global_262145.f_4220)));
	}
...
int func_168(int iParam0)
{
	...
	iVar0 = round((func_164(*iParam0, 100) * 25f));
	*iParam0 = (*iParam0 + iVar0);
	return *iParam0;
}
...
int func_169(int iParam0)
{
	if (iParam0 < 0)
	{
		if (absi(iParam0) > func_159(player_id()))
		{
			iParam0 = -func_159(player_id());
		}
	}
	if (func_170(8000, 0, 0) > 0)
	{
		if (func_170(8000, 0, 0) < (iParam0 + func_159(player_id())))
		{
			iParam0 = (func_170(8000, 0, 0) - func_159(player_id()));
		}
	}
	return iParam0;
}
...
int func_173()
{
	...
	if (func_181(player_id()) || func_180(player_id()))
	{
	...
	else if (func_178() || func_174(player_id()))
	{
...
int func_194(int iParam0)
{
	if (iParam0 != func_64())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_382(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
void func_199(int iParam0)
{
	...
	{
		thefeed_remove_item(Global_2656326[iParam0 /*46*/].f_26);
	}
	iVar0 = iParam0;
	iVar1 = iVar0 + 1;
...
void func_201(int iParam0)
{
	...
	{
		Global_2656326[iParam0 /*46*/].f_38 = get_network_time();
	}
}
...
void func_203()
{
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_204(1);
			func_208(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_205(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
int func_211()
{
	if (!BitTest(uLocal_91, 17))
	{
		...
		set_bit(&uLocal_91, 17);
	}
	else if (!BitTest(uLocal_91, 18))
	{
		if (func_212(12, 116))
		{
			set_bit(&uLocal_91, 18);
		}
	}
	else
	{
...
int func_212(int iParam0, int iParam1)
{
	...
	func_199(iVar0);
	Global_2657491 = get_game_timer() + 1500;
	return 1;
}
...
void func_214(int iParam0, int iParam1, bool bParam2, char* sParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8, var uParam9, var uParam10)
{
	...
	Global_2656326[iVar4 /*46*/].f_38 = get_network_time();
	...
	if (func_215())
	{
		if (bParam2)
		{
			...
			{
				Var7 = { func_150(iVar0) };
				iVar8 = _0x36391F397731595D(&Var7);
				if (iVar8 != -1)
				{
...
void func_216()
{
	Global_1659413 = get_time_offset(get_network_time(), 30000);
}
...
char* func_218(int iParam0, int iParam1)
{
	...
	return stat_get_string(iVar0, -1);
}
...
struct<6> func_219()
{
	...
	if (is_string_null_or_empty(&(Global_1937518.f_10)))
	{
		...
		{
			iVar1 = unk_0xECF041186C5A94DC(iVar2);
			if (iVar1 != -1)
			{
...
int func_247(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	func_248(iParam0, sParam1, bVar1, func_252(player_id()));
	return 1;
}
...
void func_261()
{
	...
	{
		if (func_264(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_263(player_ped_id());
...
int func_283(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	func_284(iParam0, sParam1, bVar1, func_252(player_id()));
	return 1;
}
...
int func_287(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
void func_349(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
			{
				Global_2703735.f_3447.f_1[0] = net_to_veh(Local_83.f_12[0]);
			}
			if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				Global_2703735.f_3447.f_4[0] = net_to_ped(Local_83.f_9[0]);
			}
			break;
	}
}
...
int func_350(int iParam0)
{
	...
	{
		case 0:
			if (network_does_entity_exist_with_network_id(Local_83.f_12[0]) && network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				return 1;
			}
			break;
...
void func_357(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
...
void func_359()
{
	if (Local_88[participant_id_to_int() /*3*/].f_2 >= 5 && Local_88[participant_id_to_int() /*3*/].f_2 < 6)
	{
		if (BitTest(Local_83.f_0, 4))
		{
...
int func_360(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (_network_is_player_equal_to_index(player_id(), iParam1) || iParam3)
	{
		...
		if ((iVar1 != -1 && network_is_activity_session()) && iVar1 < 4)
		{
			...
			{
				set_colour_of_next_text_component(func_122(iVar1, iParam1, 0));
			}
			else
			{
				set_colour_of_next_text_component(func_91(iParam1, -2, 1, 0, 0));
		...
		add_text_component_substring_player_name(func_89(&Var2));
		if (!bParam4)
		{
			iVar0 = end_text_command_thefeed_post_ticker(false, true);
		}
...
void func_362()
{
	...
	if (iLocal_101 != Local_83.f_15)
	{
		...
		reserve_network_mission_vehicles(iLocal_101);
	}
	if (iLocal_102 != Local_83.f_16)
	{
		iLocal_102 = Local_83.f_16;
		reserve_network_mission_peds(iLocal_102);
	}
	if (func_382(player_id(), 0, 1))
	{
		if (!BitTest(Local_88[iVar0 /*3*/], 0))
		{
			if (Local_88[participant_id_to_int() /*3*/].f_2 == 0)
			{
				if (func_355() == 0)
				{
					set_bit(&(Local_88[iVar0 /*3*/]), false);
				}
			}
		}
		else if (BitTest(Local_88[iVar0 /*3*/], 0))
		{
			if ((func_51(player_id(), 1, 0) || func_48(player_id())) || func_355() > 0)
			{
				func_42(&uLocal_92);
				clear_bit(&(Local_88[iVar0 /*3*/]), false);
			}
			else if (!is_ped_injured(player_ped_id()))
			{
				...
				{
					clear_bit(&uLocal_91, 7);
					if (!func_49(player_id(), 0))
					{
						func_368();
					}
				}
		...
		{
			if (Local_88[participant_id_to_int() /*3*/].f_2 > 3 && Local_88[participant_id_to_int() /*3*/].f_2 < 6)
			{
				if (BitTest(Global_2703735.f_3447, 1))
				{
					set_bit(&(Local_88[iVar0 /*3*/]), 3);
				}
			}
		}
		if (Local_88[participant_id_to_int() /*3*/].f_2 > 3)
		{
			if (!BitTest(Local_88[participant_id_to_int() /*3*/], 5))
			{
				if (func_367(Local_83.f_5))
				{
					set_bit(&(Local_88[participant_id_to_int() /*3*/]), 5);
				}
			}
			else if (!func_367(Local_83.f_5))
			{
				clear_bit(&(Local_88[participant_id_to_int() /*3*/]), 5);
			}
			if (!BitTest(Local_88[participant_id_to_int() /*3*/], 6))
			{
				if (func_364(Local_83.f_5))
				{
					set_bit(&(Local_88[participant_id_to_int() /*3*/]), 6);
				}
			}
			if (!BitTest(Local_88[participant_id_to_int() /*3*/], 8))
			{
				if (func_363())
				{
					set_bit(&(Local_88[participant_id_to_int() /*3*/]), 8);
				}
			}
		}
...
int func_363()
{
	if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
	{
		if (func_9(Local_83.f_12[0]))
		{
			if (is_vehicle_stuck_timer_up(net_to_veh(Local_83.f_12[0]), 0, 7000) || is_vehicle_stuck_timer_up(net_to_veh(Local_83.f_12[0]), 1, 40000))
			{
				return 1;
			}
		}
		...
		case 0:
			if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				if (!func_40(Local_83.f_9[0]))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						if (func_365(net_to_ped(Local_83.f_9[0])))
						{
							return 1;
						}
					}
		...
		case 0:
			if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				if (!func_40(Local_83.f_9[0]))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						if (vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(net_to_ped(Local_83.f_9[0]), true)) < 40000f)
						{
							return 1;
						}
					}
...
void func_371()
{
	switch (Local_83.f_6)
	{
				...
				if (network_does_entity_exist_with_network_id(Local_83.f_12[0]))
				{
					if (func_9(Local_83.f_12[0]))
					{
						if (!func_40(Local_83.f_9[0]))
						{
							if (is_ped_sitting_in_vehicle(net_to_ped(Local_83.f_9[0]), net_to_veh(Local_83.f_12[0])))
							{
								if (get_script_task_status(net_to_ped(Local_83.f_9[0]), -258271821) != 1 && get_script_task_status(net_to_ped(Local_83.f_9[0]), -258271821) != 0)
								{
									task_vehicle_drive_wander(net_to_ped(Local_83.f_9[0]), net_to_veh(Local_83.f_12[0]), 20f, 786603);
								}
							}
						}
					}
					...
					if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
					{
						if (func_9(Local_83.f_12[0]))
						{
							if (!func_40(Local_83.f_9[0]))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_83.f_9[0]), net_to_veh(Local_83.f_12[0])))
								{
									if ((get_script_task_status(net_to_ped(Local_83.f_9[0]), -258271821) != 1 && get_script_task_status(net_to_ped(Local_83.f_9[0]), -258271821) != 0) || BitTest(Local_83.f_0, 9))
									{
										task_vehicle_drive_wander(net_to_ped(Local_83.f_9[0]), net_to_veh(Local_83.f_12[0]), 30f, 786469);
										if (BitTest(Local_83.f_0, 9))
										{
											clear_bit(&Local_83, 9);
										}
									}
								}
							}
		...
		case 3:
			if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				if (!func_40(Local_83.f_9[0]))
				{
					if (get_script_task_status(net_to_ped(Local_83.f_9[0]), -828834893) != 1 && get_script_task_status(net_to_ped(Local_83.f_9[0]), -828834893) != 0)
					{
						if (func_375(Local_83.f_9[0]))
						{
							if (network_has_control_of_network_id(Local_83.f_9[0]))
							{
								task_leave_any_vehicle(net_to_ped(Local_83.f_9[0]), 0, 0);
							}
						}
					}
				}
		...
		case 4:
			if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
			{
				if (!func_40(Local_83.f_9[0]))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						if (get_script_task_status(net_to_ped(Local_83.f_9[0]), 1805844857) != 1 && get_script_task_status(net_to_ped(Local_83.f_9[0]), 1805844857) != 0)
						{
							if (func_375(Local_83.f_9[0]))
							{
								if (network_has_control_of_network_id(Local_83.f_9[0]))
								{
									task_smart_flee_ped(net_to_ped(Local_83.f_9[0]), player_ped_id(), 500f, -1, false, true);
								}
							}
						}
					}
	...
	if (network_does_entity_exist_with_network_id(Local_83.f_9[0]))
	{
		if ((Local_88[participant_id_to_int() /*3*/].f_2 >= 5 && Local_88[participant_id_to_int() /*3*/].f_2 < 6) && !func_192(player_id(), 0, -1))
		{
...
void func_372(int iParam0, int* iParam1, float fParam2, bool bParam3, bool bParam4, bool bParam5, char* sParam6, int iParam7, int iParam8, bool bParam9, int iParam10)
{
	if (network_does_network_id_exist(iParam0))
	{
		...
		if (bParam3)
		{
			func_373(net_to_ped(iParam0), iParam1, 1, Global_2703735, bParam4, bParam5, fParam2, sParam6, iParam7, iParam8, bParam9, iParam10);
		}
		else
		{
			func_373(net_to_ped(iParam0), iParam1, -1, Global_2703735, bParam4, bParam5, fParam2, sParam6, iParam7, iParam8, bParam9, iParam10);
...
void func_380()
{
	...
	func_351(11, 0);
	func_198(12, 116);
	clear_bit(&(Global_2703735.f_3447), false);
	clear_bit(&(Global_2703735.f_3447), true);
	if (network_is_game_in_progress())
	{
	...
	if (network_is_game_in_progress())
	{
		if (network_is_host_of_this_script())
		{
			if (network_entity_area_does_exist(Local_83.f_3))
			{
				network_remove_entity_area(Local_83.f_3);
			}
			Local_83.f_3 = -1;
...
int func_383()
{
	...
	if (func_384() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_384()) == 0)
		{
			return 1;
		}
	}
...
void func_392(struct<21> Param0)
{
	...
	func_394(0, -1, 0);
	network_register_host_broadcast_variables(&Local_83, 23, 0);
	network_register_player_broadcast_variables(&Local_88, 97, 0);
	set_this_script_can_be_paused(false);
	if (!func_393())
	{
		func_380();
	}
	set_bit(&(Global_2703735.f_3447), false);
	clear_bit(&(Global_2703735.f_3447), true);
}
...
void func_395(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!network_is_game_in_progress())
	{
		func_381();
