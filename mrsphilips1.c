...
void __EntryFunction__()
{
	...
	{
		wait(0);
		_0x208784099002BC30("SF_MrsPhilips", 0);
		...
		case 1:
			switch (iLocal_80)
			{
				case 0:
					...
					{
						func_225();
						if (!is_door_registered_with_system(1736361794))
						{
							add_door_to_system(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, true, true, false);
						}
						if (is_door_registered_with_system(1736361794))
						{
							door_system_set_open_ratio(1736361794, 0f, true, false);
							door_system_set_door_state(1736361794, 0, true, false);
						}
						start_cutscene(0);
				...
				case 2:
					if (is_cutscene_playing())
					{
						...
						{
							func_219(player_ped_id(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
							force_ped_motion_state(player_ped_id(), joaat("MotionState_Walk"), false, 1, false);
							simulate_player_input_gait(player_id(), 1f, 4000, 0f, true, false);
...
void func_2()
{
	...
	{
		door_system_set_open_ratio(1736361794, 0f, true, false);
		door_system_set_door_state(1736361794, 1, true, false);
	}
	func_3(110, 1);
	func_253();
}
...
void func_210(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_214(player_id())) && !func_212(player_id(), 0)) && !func_211()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_214(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
int func_219(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_220(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_221(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_226(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_233(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_232(player_ped_id(), -828834893))
				{
...
{
	if (((!func_250(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_249(0)) || func_248(1))
			{
			}
			else
			{
...
void func_269(bool bParam0)
{
	...
	if (!func_290())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_270(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_271(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_277())
	{
		...
		{
			iVar2 = func_272(get_this_script_name());
			if (iVar2 > -1)
			{
