...
void func_3(int iParam0)
{
	...
	iVar0 = iParam0;
	clear_bit(&(Global_2678393.f_388), iVar0);
	clear_bit(&(Global_2678393.f_389), bVar0);
	clear_bit(&(Global_2678393.f_390), bVar0);
	clear_bit(&(Global_2678393.f_392), bVar0);
	clear_bit(&(Global_2678393.f_396), bVar0);
	clear_bit(&(Global_2678393.f_391), bVar0);
}
...
{
	return func_8(player_id(), bParam0);
}
...
int func_12(bool bParam0)
{
	if (func_5(bParam0, 0, 1))
	{
		...
		if (func_80(bParam0))
		{
			func_77(bParam0, func_78(func_79(player_id())), 1, 0);
		}
		if (func_75(bParam0))
		{
		...
		if (does_blip_exist(Global_2678393[iVar0]))
		{
			...
			else
			{
				switch (iVar1)
				{
					...
					case 254:
						if (get_player_team(iParam0) == get_player_team(Global_2703735))
						{
							return func_64(6);
						}
						else
...
int func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_58(player_id()) || (func_57() && func_56())) && !BitTest(Global_2815059.f_4660, 31)) && !bParam4)
	{
		iVar1 = func_55();
		if (does_entity_exist(iVar1))
		{
			if (is_ped_a_player(iVar1))
			{
				...
				{
					if (func_5(network_get_player_index_from_ped(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_35(iParam0, network_get_player_index_from_ped(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_35(iParam0, player_id(), iParam1, bParam2, bParam3);
		}
	}
	return func_35(iParam0, player_id(), iParam1, bParam2, bParam3);
}
...
{
	return func_25(player_id(), bParam0, iParam1, bParam2);
}
...
int func_34()
{
	if (func_32() && network_is_activity_session())
	{
		return 1;
	}
	return 0;
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_63(iParam1, iParam0, iVar0, 0) && !BitTest(Global_4718592.f_15, 18)) || ((func_29(get_player_team(iParam1), get_player_team(iParam0), 0) && BitTest(Global_4718592.f_15, 23)) && !BitTest(Global_4718592.f_15, 18)))
			{
				return func_22(1);
			}
...
int func_53(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_6())
	{
		...
		if (BitTest(Global_4718592.f_15, 26) && !func_29(iParam0, get_player_team(iParam1), 0))
		{
			iVar0 = func_36(1);
		}
	}
...
int func_69(int iParam0)
{
	...
	if (get_hash_key(get_this_script_name()) == func_70())
	{
		return 1;
	}
	return 0;
