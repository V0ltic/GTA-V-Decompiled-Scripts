	...
	while (true)
	{
		...
		if (is_world_point_within_brain_activation_range())
		{
			...
			switch (iLocal_70)
			{
				...
				case 2:
					if (((does_entity_exist(iLocal_78) && is_ped_dead_or_dying(iLocal_78, true)) && iLocal_98 < 5) && !bLocal_95)
					{
						func_12();
					}
					func_1();
...
void func_1()
{
	if (iLocal_280 && !iLocal_281)
	{
		...
		while (iLocal_97 < 11)
		{
			if (does_entity_exist(iLocal_88[iLocal_97]))
			{
				freeze_entity_position(iLocal_88[iLocal_97], false);
			}
			iLocal_97++;
		}
		if (!is_entity_dead(iLocal_80, false))
		{
			set_vehicle_engine_health(iLocal_80, 0f);
			freeze_entity_position(iLocal_80, false);
		}
		if (does_entity_exist(iLocal_89))
		{
			freeze_entity_position(iLocal_89, false);
		}
		...
		if (does_blip_exist(iLocal_84))
		{
			remove_blip(&iLocal_84);
		}
		if (does_blip_exist(iLocal_85))
		{
			remove_blip(&iLocal_85);
		}
		if (does_blip_exist(iLocal_86))
		{
			remove_blip(&iLocal_86);
		}
	...
	if (does_entity_exist(iLocal_88[0]) || does_entity_exist(iLocal_88[1]))
	{
		if (!is_sphere_visible(Local_75 + Vector(20f, 0f, 0f), 30f) && !is_entity_at_coord(player_ped_id(), Local_75, 80f, 80f, 80f, false, true, 0))
		{
			func_180();
		}
	}
...
void func_12()
{
	if (iLocal_102 == -1)
	{
		iLocal_102 = get_game_timer() + 5000;
	}
	if (get_game_timer() > iLocal_102)
	{
		...
		{
			freeze_entity_position(iLocal_80, false);
			apply_force_to_entity(iLocal_80, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, true, true, true, false, true);
			if (!is_entity_dead(iLocal_80, false))
			{
				explode_vehicle(iLocal_80, true, false);
			}
		}
	}
}
...
void func_14()
{
	...
	if (iLocal_61 == 0)
	{
		if (get_closest_fire_pos(&Var1, Local_68[0 /*5*/]))
		{
			fVar2 = 0f;
			fVar5 = 999999f;
			iVar0 = 0;
			while (iVar0 < Local_68.f_0)
			{
				if (iVar0 > 0)
				{
					fVar2 = (fVar2 + get_distance_between_coords(Local_68[(iVar0 - 1) /*5*/], Local_68[iVar0 /*5*/], true));
				}
				if (Local_68[iVar0 /*5*/].f_4)
				{
					if (get_closest_fire_pos(&Var1, Local_68[iVar0 /*5*/]))
					{
						fVar4 = get_distance_between_coords(Local_68[iVar0 /*5*/], Var1, true);
						if (fVar4 < fVar5)
						{
							fVar5 = fVar4;
							fVar6 = fVar2;
	...
	{
		_0xD9454B5752C857DC();
		fVar7 = (to_float((get_game_timer() - iLocal_63)) / fLocal_69);
		...
		{
			if ((get_game_timer() - Local_60[iVar0 /*5*/].f_4) > 1000)
			{
				fade_decals_in_range(Local_60[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((get_game_timer() - Local_60[iVar0 /*5*/].f_4) > 6000)
			{
				remove_script_fire(Local_60[iVar0 /*5*/]);
			}
			iVar0++;
		}
	}
...
void func_16(struct<3> Param0, bool bParam1)
{
	...
	remove_script_fire(Local_60[iLocal_65 /*5*/]);
	if (Local_60[iLocal_65 /*5*/].f_4 != 0)
	{
		fade_decals_in_range(Local_60[iLocal_65 /*5*/].f_1, 0.4f, 1f);
	}
	Local_60[iLocal_65 /*5*/].f_4 = get_game_timer();
	Local_60[iLocal_65 /*5*/].f_1 = { Param0 };
	Local_60[iLocal_65 /*5*/] = start_script_fire(Param0, iLocal_53, bParam1);
	iLocal_65++;
	if (iLocal_65 >= 31)
	{
		iLocal_65 = 0;
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (is_control_pressed(0, 24) && is_ped_shooting(player_ped_id()))
			{
				if (iLocal_54 == 0)
				{
					...
					iLocal_54 = get_game_timer() + 250;
				}
				if (get_game_timer() > iLocal_54)
				{
					if (!bLocal_44)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_68.f_0)
						{
							if (does_blip_exist(Local_68[iVar0 /*5*/].f_3))
							{
								fVar2 = get_distance_between_coords(Local_57, get_blip_coords(Local_68[iVar0 /*5*/].f_3), true);
								fVar3 = get_distance_between_coords(Local_68[iVar0 /*5*/], get_blip_coords(Local_68[iVar0 /*5*/].f_3), true);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_50 != -1)
							{
								...
								if (absi((iLocal_51 - iVar5)) < 3 && absi((iLocal_51 - iVar5)) > 0)
								{
									if (iLocal_51 < iVar5)
									{
										iVar6 = iLocal_51;
										while (iVar6 <= (iVar5 - 1))
										{
											if (does_blip_exist(Local_68[iVar6 /*5*/].f_3))
											{
												if (get_blip_alpha(Local_68[iVar6 /*5*/].f_3) > 0)
												{
													set_blip_alpha(Local_68[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (does_blip_exist(Local_68[iVar5 /*5*/].f_3))
									{
										if (get_blip_alpha(Local_68[iVar5 /*5*/].f_3) > 0)
										{
											set_blip_alpha(Local_68[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	...
	{
		case 0:
			request_script_audio_bank("CONSTRUCTION_ACCIDENT_1", false, -1);
			request_anim_dict("re@construction");
			if (Local_283.f_32 <= 0)
			{
				Local_283.f_32 = get_frame_count();
			}
			...
			func_108(&Local_283);
			if ((request_script_audio_bank("CONSTRUCTION_ACCIDENT_1", false, -1) && has_anim_dict_loaded("re@construction")) && func_104(&Local_283))
			{
				if (is_vehicle_driveable(iLocal_80, false))
				{
					iLocal_78 = create_ped_inside_vehicle(iLocal_80, 26, joaat("s_m_m_dockwork_01"), -1, true, true);
					set_ped_component_variation(iLocal_78, 0, 1, 0, 0);
					set_ped_component_variation(iLocal_78, 3, 1, 1, 0);
					set_ped_component_variation(iLocal_78, 4, 0, 1, 0);
					set_ped_component_variation(iLocal_78, 8, 0, 0, 0);
					task_play_anim(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, false, false, false);
					iLocal_90 = create_object(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, true, true, false);
					set_model_as_no_longer_needed(joaat("p_amb_phone_01"));
					attach_entity_to_entity(iLocal_90, iLocal_78, get_ped_bone_index(iLocal_78, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
					set_ped_combat_attributes(iLocal_78, 17, true);
					set_ped_stay_in_vehicle_when_jacked(iLocal_78, true);
					set_blocking_of_non_temporary_events(iLocal_78, true);
					set_ped_can_be_targetted(iLocal_78, false);
					func_103(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					set_ambient_voice_name(iLocal_78, "S_M_Y_GENERICWORKER_01_WHITE_01");
					iLocal_79 = create_ped(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, true, true);
					set_blocking_of_non_temporary_events(iLocal_79, true);
					set_entity_load_collision_flag(iLocal_79, true, 1);
					freeze_entity_position(iLocal_79, true);
					set_decision_maker(iLocal_78, joaat("empty"));
					clear_decision_maker_event_response(joaat("empty"), 24);
					clear_decision_maker_event_response(joaat("empty"), 47);
					clear_decision_maker_event_response(joaat("empty"), 62);
					clear_decision_maker_event_response(joaat("empty"), 138);
					clear_decision_maker_event_response(joaat("empty"), 56);
					iLocal_89 = create_object(joaat("prop_generator_01a"), Local_274.f_0, (Local_274.f_1 + 0.5f), (Local_274.f_2 - 0.25f), true, true, false);
					set_entity_heading(iLocal_89, 75f);
					set_entity_proofs(iLocal_89, false, true, true, false, false, false, false, false);
					iLocal_279 = start_particle_fx_looped_on_entity("scr_sparking_generator", iLocal_89, 0f, 0f, 0.2f, 0f, 0f, 0f, 1f, false, false, false);
					freeze_entity_position(iLocal_89, true);
		...
		case 1:
			...
			if (!is_ped_injured(player_ped_id()))
			{
				if (!iLocal_92)
				{
					...
					{
						if (is_entity_in_angled_area(player_ped_id(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, false, true, 0))
						{
							if (!is_entity_dead(iLocal_80, false))
							{
								if (!does_blip_exist(iLocal_85))
						...
						if (has_entity_been_damaged_by_entity(iLocal_78, player_ped_id(), true) || has_entity_been_damaged_by_entity(iLocal_80, player_ped_id(), true))
						{
							freeze_entity_position(iLocal_80, false);
							clear_ped_tasks(iLocal_78);
							open_sequence_task(&iLocal_107);
							task_leave_any_vehicle(0, 0, 0);
							task_smart_flee_ped(0, player_ped_id(), 150f, -1, false, false);
							close_sequence_task(iLocal_107);
							task_perform_sequence(iLocal_78, iLocal_107);
							clear_sequence_task(&iLocal_107);
							func_95();
						}
						request_model(joaat("prop_ld_pipe_single_01"));
						if ((((is_entity_at_coord(player_ped_id(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !is_ped_in_any_heli(player_ped_id())) && !is_ped_in_any_plane(player_ped_id())) && func_94(1, 0, 1)) && has_model_loaded(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_134())
							{
								if (!is_entity_dead(get_players_last_vehicle(), false))
								{
									iLocal_83 = get_players_last_vehicle();
								}
								func_84(1);
							}
							iLocal_91 = 1;
				...
				else
				{
					if (!is_ped_injured(iLocal_78))
					{
						if (is_ped_in_any_vehicle(iLocal_78, false))
						{
							if (!is_entity_dead(iLocal_80, false) && !does_blip_exist(iLocal_85))
							{
								iLocal_85 = func_96(iLocal_80, 0, 0);
							}
						}
						else if (!does_blip_exist(iLocal_84))
						{
							if (does_blip_exist(iLocal_85))
							{
								remove_blip(&iLocal_85);
					...
					if (!is_ped_injured(iLocal_78))
					{
						if (is_entity_at_entity(player_ped_id(), iLocal_78, Local_76, false, true, 0))
						{
							if (!bLocal_93)
							{
								func_48();
					...
					else
					{
						...
						if (is_ped_injured(iLocal_78) || is_entity_dead(iLocal_80, false))
						{
							func_95();
						}
					}
					if (!is_vehicle_driveable(iLocal_81, false))
					{
						if (does_blip_exist(iLocal_86))
						{
							remove_blip(&iLocal_86);
				...
				if (is_vehicle_driveable(iLocal_81, false))
				{
					if (iLocal_103 >= 3)
					{
						if (is_ped_in_any_vehicle(player_ped_id(), false) && is_ped_in_model(player_ped_id(), joaat("bulldozer")))
						{
							if (does_blip_exist(iLocal_86))
							{
								remove_blip(&iLocal_86);
								if (!is_ped_injured(iLocal_78) && !is_entity_dead(iLocal_80, false))
								{
									if (is_ped_in_any_vehicle(iLocal_78, false) && !does_blip_exist(iLocal_85))
									{
										iLocal_85 = func_96(iLocal_80, 0, 0);
									}
								}
						...
						else if (!is_ped_injured(iLocal_78) && !is_entity_dead(iLocal_80, false))
						{
							if (is_ped_in_any_vehicle(iLocal_78, false) && does_blip_exist(iLocal_85))
							{
								remove_blip(&iLocal_85);
				...
				if (!is_entity_dead(iLocal_80, false))
				{
					if (is_entity_on_fire(iLocal_80))
					{
						iLocal_97 = 0;
						while (iLocal_97 < 11)
						{
						...
						if (!is_ped_injured(iLocal_78))
						{
							...
							{
								set_blocking_of_non_temporary_events(iLocal_78, true);
								set_ped_config_flag(iLocal_78, 116, false);
								set_ped_config_flag(iLocal_78, 29, false);
								if (!bLocal_95)
								{
									func_46();
									wait(0);
								...
								if (!is_ped_injured(iLocal_78))
								{
									set_entity_health(iLocal_78, 99, 0);
								}
								if (!is_entity_dead(iLocal_80, false))
								{
									freeze_entity_position(iLocal_80, false);
...
void func_48()
{
	switch (iLocal_103)
	{
		case 0:
			if (!is_ped_injured(iLocal_78))
			{
				if ((get_game_timer() - iLocal_101) > 3000)
				{
		...
		case 2:
			if (!is_ped_injured(iLocal_78))
			{
				if ((get_game_timer() - iLocal_101) > 5000 && !func_23())
				{
					if (is_ped_in_any_vehicle(player_ped_id(), false))
					{
						iLocal_106 = get_entity_model(get_vehicle_ped_is_in(player_ped_id(), false));
					}
					if (is_ped_in_any_vehicle(iLocal_78, false))
					{
						if (is_vehicle_driveable(iLocal_81, false))
						{
							...
							else if (!does_blip_exist(iLocal_86))
							{
								iLocal_86 = func_96(iLocal_81, 0, 0);
								if (does_blip_exist(iLocal_85))
								{
		...
		case 3:
			if (get_game_timer() - iLocal_101) > get_random_int_in_range(5000, 8000)
			{
				if (!func_23())
				{
...
void func_49()
{
	...
	{
		case 0:
			add_petrol_decal(Local_274 + Vector(0f, 1f, 0f), 1f, 1f, 1f);
			wait(0);
			start_petrol_trail_decals(1f);
			add_petrol_trail_decal_info(Local_273, 1f);
			wait(0);
			add_petrol_trail_decal_info(Local_273 - Vector(0f, 4f, 0f), 1f);
			wait(0);
			add_petrol_trail_decal_info(Local_273 - Vector(0f, 8f, 0f), 1f);
			wait(0);
			add_petrol_trail_decal_info(Local_274, 1f);
		...
		case 2:
			if ((get_game_timer() - iLocal_105) > iLocal_73 || func_51())
			{
				if (does_particle_fx_looped_exist(iLocal_279))
				{
					stop_particle_fx_looped(iLocal_279, false);
				}
				func_50();
				if (!bLocal_95)
				{
					if (!is_ped_injured(iLocal_78) && !is_entity_dead(iLocal_80, false))
					{
						if (!is_entry_point_for_seat_clear(iLocal_78, iLocal_80, -1, false, false) && !is_entry_point_for_seat_clear(iLocal_78, iLocal_80, 0, false, false))
						{
							func_46();
							wait(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
				...
				set_roads_in_angled_area(-460.3019f, -870.3607f, 21.89325f, -508.4859f, -981.1199f, 27.32087f, 36.5625f, false, true, true);
				create_incident(3, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_278, 0, 0);
				settimera(0);
				iLocal_99 = 3;
			}
			break;
...
void func_52()
{
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!is_ped_injured(iLocal_78) && !is_entity_dead(iLocal_80, false))
				{
					...
					delete_object(&iLocal_90);
					if (is_entry_point_for_seat_clear(iLocal_78, iLocal_80, -1, false, false) || is_entry_point_for_seat_clear(iLocal_78, iLocal_80, 0, false, false))
					{
						if (is_entry_point_for_seat_clear(iLocal_78, iLocal_80, -1, false, false))
						{
							bLocal_94 = true;
							Local_77 = { get_entity_coords(iLocal_80, false) + Vector(0f, -1f, -3f) };
						}
						else
						{
							Local_77 = { get_entity_coords(iLocal_80, false) + Vector(0f, 1.5f, -3f) };
						}
						if (is_entity_at_coord(get_players_last_vehicle(), Local_77, 4.2f, 4f, 5f, false, true, 0))
						{
							if (!bLocal_93)
							{
								func_46();
		...
		case 1:
			if (!is_ped_injured(iLocal_78) && !is_entity_dead(iLocal_80, false))
			{
				if (!is_entity_dead(iLocal_81, false))
				{
					set_entity_proofs(iLocal_81, false, true, true, false, false, false, false, false);
				}
				set_entity_proofs(iLocal_78, false, true, false, false, false, false, false, false);
				freeze_entity_position(iLocal_80, false);
				open_sequence_task(&iLocal_107);
				if (bLocal_94)
				{
					...
					task_leave_any_vehicle(0, 0, 0);
					task_follow_nav_mesh_to_coord(0, -476.3904f, -986.836f, 22.5569f, 3f, -1, 0.25f, false, 40000f);
				}
				else
				{
					task_look_at_entity(0, player_ped_id(), 3000, 0, 2);
		...
		case 2:
			if (!is_ped_injured(iLocal_78))
			{
				if ((get_game_timer() - iLocal_101) > 500 && !is_ped_in_any_vehicle(iLocal_78, false))
				{
					iLocal_73 = 0;
					if (is_vehicle_driveable(iLocal_80, false))
					{
		...
		case 3:
			if (!is_ped_injured(iLocal_78))
			{
				if (is_entity_at_coord(iLocal_78, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, false, true, 0) || (get_game_timer() - iLocal_101) > 10000)
				{
		...
		case 4:
			if (!is_ped_injured(iLocal_78))
			{
				if (is_entity_at_coord(iLocal_78, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, false, true, 0) || (get_game_timer() - iLocal_101) > 10000)
				{
					if (!is_entity_dead(iLocal_80, false))
					{
						freeze_entity_position(iLocal_80, false);
		...
		case 5:
			if ((get_game_timer() - iLocal_101) > 3000)
			{
				...
				if (!is_ped_injured(iLocal_78))
				{
					...
					if (!is_entity_dead(iLocal_81, false))
					{
						set_entity_proofs(iLocal_81, false, false, false, false, false, false, false, false);
					}
					set_entity_proofs(iLocal_78, false, false, false, false, false, false, false, false);
					set_ped_can_ragdoll(iLocal_78, true);
					set_ped_can_be_targetted(iLocal_78, true);
					set_ped_stay_in_vehicle_when_jacked(iLocal_78, false);
					set_blocking_of_non_temporary_events(iLocal_78, false);
					set_decision_maker(iLocal_78, joaat("DEFAULT"));
					clear_ped_tasks(player_ped_id());
					open_sequence_task(&iLocal_107);
					task_play_anim(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0f, false, false, false);
					set_sequence_to_repeat(iLocal_107, true);
					close_sequence_task(iLocal_107);
					task_perform_sequence(iLocal_78, iLocal_107);
					clear_sequence_task(&iLocal_107);
				}
		...
		case 6:
			if (!is_ped_injured(iLocal_78))
			{
				if ((get_game_timer() - iLocal_101) > 6400)
				{
					Var0 = { -477.2774f, -990.0638f, 23.5497f };
					if (does_entity_exist(get_players_last_vehicle()))
					{
						if (is_entity_at_coord(get_players_last_vehicle(), -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
					...
					{
						if (is_entity_at_coord(iLocal_83, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					{
						if (is_entity_at_coord(iLocal_81, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
							Var0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
					...
					task_start_scenario_at_position(0, "WORLD_HUMAN_PICNIC", Var0, 304.8172f, 0, true, false);
					close_sequence_task(iLocal_107);
					task_perform_sequence(iLocal_78, iLocal_107);
					clear_sequence_task(&iLocal_107);
...
void func_60()
{
	...
	{
		func_62(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_61() == 2 == 0 && !network_is_game_in_progress())
			{
...
int func_88()
{
	switch (func_89(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
void func_97()
{
	if (func_100(1000))
	{
		...
		if (!is_entity_dead(iLocal_80, false))
		{
			set_vehicle_damage(iLocal_80, 0f, 1f, 1f, 200f, 800f, true);
		}
		bLocal_282 = true;
		iLocal_72 = 8;
	}
	switch (iLocal_72)
	{
		case 0:
			...
			clear_area_of_peds(Local_75, 50f, 0);
			clear_area_of_vehicles(Local_75, 30f, false, false, false, false, false, false, 0);
			clear_area_of_projectiles(Local_75, 100f, 0);
			if (!is_entity_dead(get_players_last_vehicle(), false))
			{
				if (is_entity_at_coord(get_players_last_vehicle(), Local_75, 8f, 8f, 8f, false, true, 0))
				{
					iLocal_82 = get_players_last_vehicle();
					set_entity_as_mission_entity(iLocal_82, true, false);
					delete_vehicle(&iLocal_82);
				}
			}
			if (is_entity_at_coord(player_ped_id(), -473.1686f, -984.6405f, 22.487f, 15f, 15f, 5f, false, true, 0))
			{
				set_entity_coords(player_ped_id(), -477.3538f, -972.67f, 22.5494f, true, false, false, true);
				set_entity_heading(player_ped_id(), 237.4839f);
			}
			iLocal_276 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, true, 2);
			iLocal_277 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, true, 2);
			shake_cam(iLocal_276, "HAND_SHAKE", 0.3f);
			shake_cam(iLocal_277, "HAND_SHAKE", 0.3f);
			func_99();
			set_cam_active(iLocal_276, true);
			render_script_cams(true, false, 3000, true, false, 0);
			wait(500);
			set_cam_active_with_interp(iLocal_277, iLocal_276, 3500, 1, 1);
		...
		case 1:
			if ((get_game_timer() - iLocal_104) > 3500)
			{
				play_sound_frontend(-1, "WEAKEN", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				play_sound_frontend(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				set_activate_object_physics_as_soon_as_it_is_unfrozen(iLocal_88[0], true);
				func_98(iLocal_276);
				func_98(iLocal_277);
				iLocal_276 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, true, 2);
				iLocal_277 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, true, 2);
				shake_cam(iLocal_276, "HAND_SHAKE", 0.3f);
				shake_cam(iLocal_277, "HAND_SHAKE", 0.3f);
				set_cam_active_with_interp(iLocal_277, iLocal_276, 4000, 1, 0);
				if (!is_ped_injured(iLocal_78))
				{
					clear_ped_tasks(iLocal_78);
					task_look_at_coord(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
				if (does_entity_exist(iLocal_90))
				{
					detach_entity(iLocal_90, true, true);
					delete_object(&iLocal_90);
				}
				iLocal_104 = get_game_timer();
				iLocal_72 = 2;
		...
		case 2:
			if ((get_game_timer() - iLocal_104) > 1500)
			{
				play_sound_frontend(-1, "CABLE_SNAPS", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				iLocal_104 = get_game_timer();
				iLocal_72 = 3;
			}
			break;
		...
		case 3:
			if ((get_game_timer() - iLocal_104) > 500)
			{
				if (does_entity_exist(iLocal_88[0]))
				{
					freeze_entity_position(iLocal_88[0], false);
					apply_force_to_entity(iLocal_88[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, true, true, true, false, true);
					break_object_fragment_child(iLocal_88[0], 11, false);
					break_object_fragment_child(iLocal_88[0], 18, false);
					break_object_fragment_child(iLocal_88[0], 19, false);
					break_object_fragment_child(iLocal_88[0], 23, false);
					break_object_fragment_child(iLocal_88[0], 9, false);
					break_object_fragment_child(iLocal_88[0], 12, false);
					break_object_fragment_child(iLocal_88[0], 17, false);
					start_particle_fx_non_looped_on_entity("scr_reconstruct_pipefall_debris", iLocal_88[0], 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
				}
				iLocal_104 = get_game_timer();
				iLocal_72 = 4;
			}
		...
		case 4:
			if ((get_game_timer() - iLocal_104) > 2000)
			{
				func_98(iLocal_276);
				func_98(iLocal_277);
				iLocal_276 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, true, 2);
				iLocal_277 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, true, 2);
				shake_cam(iLocal_276, "HAND_SHAKE", 0.3f);
				shake_cam(iLocal_277, "HAND_SHAKE", 0.3f);
				set_cam_active_with_interp(iLocal_277, iLocal_276, 1000, 3, 3);
				stop_sound(iLocal_100);
				iLocal_104 = get_game_timer();
				iLocal_72 = 5;
			}
			break;
		...
		case 5:
			if ((get_game_timer() - iLocal_104) > 500)
			{
				...
				{
					freeze_entity_position(iLocal_80, false);
					play_sound_frontend(-1, "PIPES_LAND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
					set_vehicle_damage(iLocal_80, 0f, 1f, 1f, 200f, 800f, true);
					if (!is_ped_injured(iLocal_78))
					{
						task_clear_look_at(iLocal_78);
					}
					task_play_anim(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0f, false, false, false);
					start_particle_fx_non_looped_on_entity("scr_reconstruct_pipe_impact", iLocal_80, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
					func_24(&uLocal_108, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
					if (does_cam_exist(iLocal_276) && does_cam_exist(iLocal_277))
					{
						shake_cam(iLocal_276, "HAND_SHAKE", 1.5f);
						shake_cam(iLocal_277, "HAND_SHAKE", 1.5f);
					}
					iLocal_104 = get_game_timer();
					iLocal_72 = 6;
				}
		...
		case 6:
			if ((get_game_timer() - iLocal_104) > 500)
			{
				func_98(iLocal_276);
				func_98(iLocal_277);
				iLocal_276 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, true, 2);
				iLocal_277 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, true, 2);
				shake_cam(iLocal_276, "HAND_SHAKE", 0.5f);
				shake_cam(iLocal_277, "HAND_SHAKE", 0.5f);
				set_cam_active_with_interp(iLocal_277, iLocal_276, 2500, 3, 3);
				if (!is_ped_injured(iLocal_78))
				{
					task_look_at_coord(iLocal_78, get_entity_coords(iLocal_78, true) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = get_game_timer();
				iLocal_72 = 7;
			}
		...
		case 7:
			if ((get_game_timer() - iLocal_104) > 2200 && !iLocal_96)
			{
			...
			if ((get_game_timer() - iLocal_104) > 2500)
			{
				if (is_vehicle_driveable(iLocal_80, false))
				{
		...
		case 8:
			...
			if (does_entity_exist(iLocal_88[0]))
			{
				delete_object(&(iLocal_88[0]));
			}
			if (is_vehicle_driveable(iLocal_80, false))
			{
				set_vehicle_engine_health(iLocal_80, 250f);
				set_entity_coords(iLocal_80, Local_75, true, false, false, true);
				set_entity_heading(iLocal_80, 80f);
				clear_area_of_objects(Local_75, 50f, 0);
			}
			if (!is_ped_injured(iLocal_78))
			{
				clear_ped_tasks(iLocal_78);
				task_clear_look_at(iLocal_78);
				task_play_anim(iLocal_78, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0f, false, false, false);
			}
			set_cam_active(iLocal_276, false);
			render_script_cams(false, false, 3000, true, false, 0);
			destroy_cam(iLocal_276, false);
			destroy_cam(iLocal_277, false);
			set_player_control(player_id(), true, 0);
			set_gameplay_cam_relative_heading(0f);
			display_radar(true);
			display_hud(true);
			...
			func_2(0, 1, 1, 0, 0, 0, 0);
			iLocal_101 = get_game_timer();
			set_model_as_no_longer_needed(joaat("prop_pipe_stack_01"));
			iLocal_88[1] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, true, true, false);
			set_entity_rotation(iLocal_88[1], -0.1939f, 105.0058f, 77.3964f, 2, true);
			iLocal_88[2] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, true, true, false);
			set_entity_rotation(iLocal_88[2], 24.3941f, 32.5423f, 80.6862f, 2, true);
			iLocal_88[3] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, true, true, false);
			set_entity_rotation(iLocal_88[3], 24.1841f, 110.287f, 78.4357f, 2, true);
			iLocal_88[4] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, true, true, false);
			set_entity_rotation(iLocal_88[4], -0.0264f, 29.5754f, 79.1811f, 2, true);
			iLocal_88[5] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, true, true, false);
			set_entity_rotation(iLocal_88[5], -0.6337f, 108.4339f, 77.9539f, 2, true);
			iLocal_88[6] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, true, true, false);
			set_entity_rotation(iLocal_88[6], 0.0929f, 74.2657f, 79.3839f, 2, true);
			iLocal_88[7] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, true, true, false);
			set_entity_rotation(iLocal_88[7], -0.0264f, 29.5754f, 80.9061f, 2, true);
			iLocal_88[8] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, true, true, false);
			set_entity_rotation(iLocal_88[8], -0.1087f, 109.7339f, 80.9789f, 2, true);
			iLocal_88[9] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, true, true, false);
			set_entity_rotation(iLocal_88[9], -0.3321f, 74.1907f, 81.6089f, 2, true);
			iLocal_88[10] = create_object_no_offset(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, true, true, false);
			set_entity_rotation(iLocal_88[10], 5.7811f, 104.6058f, 104.6964f, 2, true);
			iLocal_97 = 0;
			while (iLocal_97 < 11)
			{
				if (does_entity_exist(iLocal_88[iLocal_97]))
				{
					set_entity_dynamic(iLocal_88[iLocal_97], true);
					freeze_entity_position(iLocal_88[iLocal_97], true);
				}
				iLocal_97++;
			}
			if (bLocal_282)
...
void func_115()
{
	...
	if (func_104(&Local_283))
	{
		...
		add_scenario_blocking_area(Local_74 + Vector(50f, 50f, 50f), Local_74 - Vector(50f, 50f, 50f), false, true, true, true);
		Local_75 = { -455.6561f, -985.8071f, 22.4868f };
		iLocal_80 = create_vehicle(joaat("utillitruck2"), Local_75, 80f, true, true, false);
		set_vehicle_engine_on(iLocal_80, false, true, false);
		set_vehicle_doors_locked(iLocal_80, 3);
		set_vehicle_extra(iLocal_80, 1, true);
		set_vehicle_extra(iLocal_80, 2, true);
		set_vehicle_extra(iLocal_80, 3, false);
		set_vehicle_extra(iLocal_80, 4, true);
		set_vehicle_extra(iLocal_80, 5, true);
		set_vehicle_extra(iLocal_80, 6, false);
		set_vehicle_extra(iLocal_80, 7, true);
		freeze_entity_position(iLocal_80, true);
		set_entity_proofs(iLocal_80, false, false, false, true, false, false, false, false);
		set_entity_lod_dist(iLocal_80, 10000);
		set_vehicle_lod_multiplier(iLocal_80, 5f);
		iLocal_81 = create_vehicle(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, true, true, false);
		clear_area(Local_75, 10f, true, false, false, false);
		iLocal_88[0] = create_object_no_offset(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, true, true, false);
		set_entity_heading(iLocal_88[0], 90f);
		freeze_entity_position(iLocal_88[0], true);
		set_entity_proofs(iLocal_88[0], true, true, true, true, false, false, false, false);
		set_entity_lod_dist(iLocal_88[0], 10000000);
...
int func_121()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_132())
		{
			return 0;
		}
	}
...
int func_134()
{
	if ((Global_113375 == func_74() && get_random_event_flag()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
int func_155()
{
	...
	func_161(&uVar0, get_clock_seconds());
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_172()) || Global_31962) || func_171()) || func_43(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_172()) || Global_112433) || Global_31962) || func_171()) || func_43(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_172()) || Global_112433) || Global_31962) || func_171()) || func_43(8, -1)) || func_170()) || func_169()) || func_167()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_172() || get_player_wanted_level(player_id()) > 0) || func_43(8, -1)) || func_167()) || func_166()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_172()) || func_169()) || Global_112433) || Global_31962) || func_171()) || Global_44238) || func_43(8, -1)) || func_168()) || func_166()) || func_167()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_180()
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!is_ped_injured(iLocal_78))
			{
				set_ped_config_flag(iLocal_78, 317, true);
			}
			if (!is_entity_dead(iLocal_83, false))
			{
				if (!is_ped_in_vehicle(player_ped_id(), iLocal_83, false) && !is_entity_at_entity(player_ped_id(), iLocal_83, 50f, 50f, 50f, false, true, 0))
				{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_195(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_216(iParam0, 0, 0)) || func_216(iParam0, 1, 0)) || func_216(iParam0, 2, 0)) || func_215(iParam0) != 145) || func_214(iParam0)) || func_213(iParam0)) || func_212(iParam0)) || func_211(iParam0)) || !func_200(get_entity_model(iParam0)))
	{
		if (func_213(iParam0))
		{
		}
...
int func_201(int iParam0, bool bParam1)
{
	...
	{
		if ((func_206() || is_pc_version()) || func_205())
		{
		}
		else if (!func_208())
		{
