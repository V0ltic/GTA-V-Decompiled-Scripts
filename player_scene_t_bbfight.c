...
int func_2()
{
	...
	if (is_synchronized_scene_running(Global_97771))
	{
		...
		if (func_26(iVar1))
		{
			if (!is_string_null_or_empty(&Local_357))
			{
				if (!iLocal_361)
				{
					if (fVar0 < fLocal_360)
					...
					{
						if (!is_string_null_or_empty(&Local_351))
						{
							func_20(&uLocal_110, func_21(), player_ped_id(), &Local_351, 0, 1);
						}
						if (!is_string_null_or_empty(&Local_354))
						{
	...
	if (vdist(get_entity_coords(player_ped_id(), true), Local_283) > 100f)
	{
		return 1;
	}
	return 0;
...
int func_28(int iParam0, int iParam1)
{
	...
	while (iVar0 < *iParam0)
	{
		if (!is_ped_injured((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						task_synchronized_scene((*iParam0)[iVar0], Global_97770, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (is_synchronized_scene_running(Global_97771))
					{
						task_synchronized_scene((*iParam0)[iVar0], Global_97771, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						request_anim_dict(&cLocal_338);
						(*iParam1)[iVar0] = 102;
					}
					break;
				
				case 102:
					if (has_anim_dict_loaded(&cLocal_338) && is_entity_playing_anim((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						sVar1 = "victim_fall";
						fVar2 = -1f;
						fVar3 = -1f;
						if (find_anim_event_phase(&cLocal_338, &(Local_348[iVar0 /*16*/]), sVar1, &fVar2, &fVar3))
						{
							if (fVar2 < get_synchronized_scene_phase(Global_97771))
							{
								if (!is_ped_running_ragdoll_task((*iParam0)[iVar0]))
								{
						...
						if (iLocal_109 == 165)
						{
							if (!is_string_null_or_empty(&(Local_349[iVar0 /*16*/])))
							{
								sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								request_anim_dict(sVar4);
								if (0.95f < get_synchronized_scene_phase(Global_97771))
								{
									if (has_anim_dict_loaded(sVar4))
									{
										task_start_scenario_in_place((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, false);
										force_ped_ai_and_animation_update((*iParam0)[iVar0], false, false);
										wait(0);
										iLocal_350[iVar0] = -1;
										(*iParam1)[iVar0] = 5;
										break;
						...
						if (iLocal_109 == 259)
						{
							if (0.95f < get_synchronized_scene_phase(Global_97771))
							{
								task_put_ped_directly_into_melee((*iParam0)[iVar0], player_ped_id(), 0f, -1f, 0f, false);
								force_ped_ai_and_animation_update((*iParam0)[iVar0], false, false);
								wait(0);
								(*iParam1)[iVar0] = 10;
								break;
						...
						if (iLocal_109 == 246 && iVar0 == 0)
						{
							if (0.95f < get_synchronized_scene_phase(Global_97771))
							{
								...
								if (!is_ped_injured((*iParam0)[iVar0]))
								{
									task_put_ped_directly_into_melee(player_ped_id(), (*iParam0)[iVar0], 0f, -1f, 0f, false);
									wait(0);
								}
								(*iParam1)[iVar0] = 10;
								break;
				...
				case 200:
					if (is_synchronized_scene_running(Global_97770))
					{
						task_play_anim((*iParam0)[iVar0], &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0f, false, false, false);
						(*iParam1)[iVar0] = 201;
					}
					else if (is_synchronized_scene_running(Global_97771))
					{
				...
				case 201:
					if (is_synchronized_scene_running(Global_97771))
					{
						task_play_anim((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0f, false, false, false);
						task_look_at_entity((*iParam0)[iVar0], player_ped_id(), -1, 0, 2);
						request_anim_dict(&cLocal_338);
						(*iParam1)[iVar0] = 202;
					}
					break;
				...
				case 202:
					if (has_anim_dict_loaded(&cLocal_338) && is_entity_playing_anim((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 1))
					{
						sVar5 = "victim_fall";
						fVar6 = -1f;
						fVar7 = -1f;
						if (find_anim_event_phase(&cLocal_338, &(Local_348[iVar0 /*16*/]), sVar5, &fVar6, &fVar7))
						{
							if (fVar6 < get_entity_anim_current_time((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/])))
							{
								if (!is_ped_running_ragdoll_task((*iParam0)[iVar0]))
								{
									clear_ped_tasks((*iParam0)[iVar0]);
						...
						{
							if (get_entity_anim_current_time((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/])) > 0.954f)
							{
								if (iLocal_109 == 108)
								{
								...
								task_follow_nav_mesh_to_coord((*iParam0)[iVar0], Local_283 + Local_285[iVar0 /*3*/], 1f, -1, 0.25f, false, 40000f);
								force_ped_motion_state((*iParam0)[iVar0], joaat("MotionState_Walk"), false, 0, false);
								task_clear_look_at((*iParam0)[iVar0]);
								wait(0);
								(*iParam1)[iVar0] = 1;
							}
						}
				...
				case 0:
					Var8 = { get_entity_coords((*iParam0)[iVar0], true) };
					...
					fVar11 = get_entity_heading((*iParam0)[iVar0]);
					...
					fVar13 = absf((fVar11 - fVar12));
					if (fVar13 > 45f)
					{
						if (!get_script_task_status((*iParam0)[iVar0], 1920390111) == 1)
						{
							task_achieve_heading((*iParam0)[iVar0], fVar12, 0);
						}
						break;
					}
					if (!is_string_null_or_empty(&(Local_349[iVar0 /*16*/])))
				...
				case 1:
					Var14 = { get_entity_coords((*iParam0)[iVar0], true) };
					...
					if (!get_script_task_status((*iParam0)[iVar0], 713668775) == 1 && !get_script_task_status((*iParam0)[iVar0], 713668775) == 0)
					{
						task_follow_nav_mesh_to_coord((*iParam0)[iVar0], Var15, 0.5f, -1, 0.25f, false, 40000f);
						break;
					}
					break;
				
				case 10:
					if (get_script_task_status((*iParam0)[iVar0], -71340211) == 7 || get_script_task_status((*iParam0)[iVar0], -71340211) == 1)
					{
						iVar17 = 0;
						...
						set_relationship_between_groups(5, iLocal_279, joaat("player"));
						set_relationship_between_groups(5, joaat("player"), iLocal_279);
				...
				case 11:
					if (vdist(get_entity_coords(player_ped_id(), true), Local_283) > 50f && vdist(get_entity_coords(player_ped_id(), true), get_entity_coords((*iParam0)[iVar0], true)) > 50f)
					{
						set_relationship_between_groups(2, iLocal_279, joaat("player"));
						set_relationship_between_groups(2, joaat("player"), iLocal_279);
						clear_ped_tasks((*iParam0)[iVar0]);
						task_follow_nav_mesh_to_coord((*iParam0)[iVar0], Local_283 + Local_285[iVar0 /*3*/], 0.5f, -1, 0.25f, false, 40000f);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					if (func_32((*iParam0)[iVar0]))
					{
						if (does_entity_exist(iLocal_280[iVar0]))
						{
							delete_object(&(iLocal_280[iVar0]));
							set_object_as_no_longer_needed(&(iLocal_280[iVar0]));
						}
						clear_ped_tasks((*iParam0)[iVar0]);
						set_ped_should_play_immediate_scenario_exit((*iParam0)[iVar0]);
						(*iParam1)[iVar0] = 10;
						break;
					}
					if (!ped_has_use_scenario_task((*iParam0)[iVar0]))
					{
						if (are_strings_equal(&(Local_349[iVar0 /*16*/]), "any"))
						{
							if (does_scenario_exist_in_area(Local_283 + Local_285[iVar0 /*3*/], 20f, true))
							{
								task_use_nearest_scenario_to_coord((*iParam0)[iVar0], Local_283 + Local_285[iVar0 /*3*/], 20f, 0);
								iLocal_350[iVar0] = get_game_timer();
							}
						}
						else
						{
							...
							task_start_scenario_in_place((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, bVar18);
							iLocal_350[iVar0] = get_game_timer();
						}
					}
					else if (does_entity_exist(iLocal_280[iVar0]))
					{
						if (iLocal_350[iVar0] > 0)
						{
							if (get_game_timer() > iLocal_350[iVar0] + 1000)
							{
								delete_object(&(iLocal_280[iVar0]));
								set_object_as_no_longer_needed(&(iLocal_280[iVar0]));
							}
		...
		else if (does_entity_exist((*iParam0)[iVar0]))
		{
			if ((*iParam1)[iVar0] != -1)
			{
				iVar19 = 0;
	...
	while (iVar0 < 263)
	{
		if (BitTest(Global_32338[iVar0 /*23*/].f_11, 0))
		{
			...
			else
			{
				...
				if (vdist2(get_entity_coords(iParam0, true), Var1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (BitTest(Global_32338[iVar0 /*23*/].f_11, 19))
				{
					...
					while (iVar2 < iVar3)
					{
						...
						if (!func_30(Var4))
						{
							if (vdist2(get_entity_coords(iParam0, true), Var4) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_32(int iParam0)
{
	...
	while (iVar1 < 1)
	{
		...
		{
			if (func_33(player_ped_id(), Local_283 + Local_287[iVar1 /*3*/], Local_288[iVar1 /*3*/], (fLocal_284 + fLocal_289[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
				if (is_ped_facing_ped(iParam0, player_ped_id(), fVar2))
				{
					return 1;
				}
			}
...
int func_33(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<3> Var0;
	struct<3> Var1;
	...
	if (is_entity_in_angled_area(iParam0, Var0, Var1, (Param2.f_1 * 2f), bParam4, bParam5, iParam6))
	{
		return 1;
	}
	return 0;
...
int func_35(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_42(player_ped_id()) && func_42(iParam0))
	{
...
int func_38(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_40(Param1 - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_40(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_46()
{
	...
	{
		if (!is_player_switch_in_progress() && !func_47())
		{
			return 1;
		}
	}
...
void func_56()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_276)
		{
			...
			{
				request_model(iLocal_278[iVar0]);
				if (!has_model_loaded(iLocal_278[iVar0]))
				{
					bVar2 = false;
					request_model(iLocal_278[iVar0]);
				}
			...
			{
				request_model(iLocal_281[iVar0]);
				if (!has_model_loaded(iLocal_281[iVar0]))
				{
					bVar2 = false;
					request_model(iLocal_281[iVar0]);
				}
	...
	add_relationship_group("FIGHTERS", &iLocal_279);
	iVar0 = 0;
	while (iVar0 < iLocal_276)
	{
		if (iLocal_278[iVar0] != 0)
		{
			iLocal_276[iVar0] = create_ped(26, iLocal_278[iVar0], Local_283 + Local_285[iVar0 /*3*/], 0f, true, true);
			set_entity_heading(iLocal_276[iVar0], (fLocal_284 + fLocal_286[iVar0]));
			set_ped_random_component_variation(iLocal_276[iVar0], 0);
			if (iLocal_278[iVar0] == joaat("s_m_y_baywatch_01"))
			{
				if (get_ped_drawable_variation(iLocal_276[iVar0], 3) == 0)
				{
					if (get_ped_drawable_variation(iLocal_276[iVar0], 10) != 1)
					{
						set_ped_component_variation(iLocal_276[iVar0], 10, 1, 0, 0);
					}
				}
				else if (get_ped_drawable_variation(iLocal_276[iVar0], 10) == 1)
				{
					if (get_ped_drawable_variation(iLocal_276[iVar0], 10) != 0)
					{
						set_ped_component_variation(iLocal_276[iVar0], 10, 0, 0, 0);
					}
				}
			}
			set_ped_relationship_group_hash(iLocal_276[iVar0], iLocal_279);
			task_stand_still(iLocal_276[iVar0], -1);
			if (iLocal_109 == 285)
			{
				set_entity_max_health(iLocal_276[iVar0], 105);
				set_entity_health(iLocal_276[iVar0], 105, 0);
			}
		}
		if (iLocal_281[iVar0] != 0)
		{
			iLocal_280[iVar0] = create_object(iLocal_281[iVar0], Local_283 + Local_285[iVar0 /*3*/], true, true, false);
			set_entity_heading(iLocal_280[iVar0], (fLocal_284 + fLocal_286[iVar0]));
			attach_entity_to_entity(iLocal_280[iVar0], iLocal_276[iVar0], get_ped_bone_index(iLocal_276[iVar0], iLocal_282[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		}
		iVar0++;
	}
	set_relationship_between_groups(2, iLocal_279, joaat("player"));
...
void func_57()
{
	...
	switch (iLocal_109)
	{
		...
		case 166:
			...
			fLocal_286[0] = get_random_float_in_range(-180f, 180f);
		...
		case 259:
			Local_285[0 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_285[1 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			fLocal_286[0] = get_random_float_in_range(-180f, 180f);
			fLocal_286[1] = get_random_float_in_range(-180f, 180f);
		...
		default:
			...
			iLocal_278[0] = joaat("a_m_y_musclbeac_01");
			iLocal_278[1] = joaat("a_m_y_musclbeac_01");
			Local_287[0 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_288[0 /*3*/] = { 1f, 1f, 1f };
			fLocal_289[0] = get_random_float_in_range(-180f, 180f);
			break;
	}
}
...
void func_68()
{
	...
	while (iVar0 < iLocal_278)
	{
		if (iLocal_278[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_278[iVar0]);
		}
		iVar0++;
	}
	remove_relationship_group(iLocal_279);
