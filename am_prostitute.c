...
void __EntryFunction__()
{
	...
	{
		func_42();
		if (((func_34() || network_is_in_tutorial_session()) || (func_33(player_id()) || func_32(player_id()))) || func_29(player_id()))
		{
			func_43();
		}
		if (network_is_game_in_progress())
		{
			...
			func_1();
			iLocal_54++;
			if (iLocal_54 >= network_get_max_num_participants())
			{
				iLocal_54 = 0;
			}
		}
...
void func_1()
{
	...
	while (bVar0 < network_get_max_num_participants())
	{
		if ((iLocal_54 % bVar0) == 0)
		{
			...
			{
				iVar2 = get_player_ped(network_get_player_index(int_to_participantindex(bVar0)));
				if (!is_entity_dead(iVar2, false))
				{
					if (Local_58[bVar0 /*3*/].f_2)
					{
						if (vdist2(get_entity_coords(player_ped_id(), false), get_entity_coords(iVar2, true)) <= 22500f)
						{
							if (!iLocal_56)
							{
							...
							{
								set_bit(&iLocal_55, bVar0);
							}
						}
						else if (BitTest(iLocal_55, bVar0))
						{
							clear_bit(&iLocal_55, bVar0);
						}
					}
					else if (BitTest(iLocal_55, bVar0))
					{
...
void func_2()
{
	...
	{
		case 0:
			if (((func_25(player_id(), 1, 0) || func_24()) || !bVar3) || func_17())
			{
				iLocal_52 = 4;
			}
			else
		...
		case 3:
			if ((has_script_loaded("pb_prostitute") && _get_number_of_references_of_script_with_name_hash(joaat("pb_prostitute")) <= 0) && !network_is_script_active("pb_prostitute", network_player_id_to_int(), true, 0))
			{
				iVar4 = func_12(iVar2);
		...
		case 5:
			if (((!func_25(player_id(), 1, 0) && !func_24()) && bVar3) && !func_3())
			{
				iLocal_53 = get_game_timer() + 250;
				iLocal_52 = 0;
			}
...
int func_4()
{
	if (_get_number_of_references_of_script_with_name_hash(joaat("pb_prostitute")) <= 0 && !network_is_script_active("pb_prostitute", network_player_id_to_int(), true, 0))
	{
		return 1;
	}
	if (iLocal_57 == 0)
...
{
	Local_58[network_player_id_to_int() /*3*/] = iParam0;
}
...
int func_12(int iParam0)
{
	if (iParam0 == -1)
	{
		return Local_58[network_player_id_to_int() /*3*/];
	}
...
int func_13()
{
	...
	iVar0 = func_14();
	iVar1 = network_player_id_to_int();
	if (!does_entity_exist(func_12(iVar1)))
	{
		func_11(0);
		return iVar0;
	}
	if (iLocal_57 != 0 && is_thread_active(iLocal_57))
	{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				...
				if (func_28(&iVar2))
				{
					...
					{
						if (func_12(iVar1) == get_ped_in_vehicle_seat(iVar3, 0, false) || is_ped_in_vehicle(func_12(iVar1), iVar3, true))
						{
					...
					Var4 = { get_entity_coords(func_12(iVar1), false) };
					Var5 = { get_entity_coords(iVar0, false) };
					Var6 = { get_entity_coords(player_ped_id(), false) };
...
int func_14()
{
	...
	if (iVar2 > 0)
	{
		...
		while (iVar3 <= 7)
		{
			if (!is_ped_injured(uVar1[iVar3]))
			{
				if (is_ped_using_scenario(uVar1[iVar3], "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS") || is_ped_using_scenario(uVar1[iVar3], "WORLD_HUMAN_PROSTITUTE_LOW_CLASS"))
				{
					if (func_16(uVar1[iVar3]))
					{
						if (!func_15(uVar1[iVar3]))
						{
							if (!is_ped_fleeing(uVar1[iVar3]))
							{
								return uVar1[iVar3];
							}
						}
...
int func_16(int iParam0)
{
	...
	{
		if (are_strings_equal(sVar1, "GB_VEHICLE_EXPORT"))
		{
			return 0;
		}
		if (are_strings_equal(sVar1, "BUSINESS_BATTLES_SELL"))
		{
			return 0;
		}
		if (are_strings_equal(sVar1, "BUSINESS_BATTLES"))
		{
			return 0;
		}
		if (are_strings_equal(sVar1, "GB_CASINO"))
		{
			return 0;
		}
		if (are_strings_equal(sVar1, "GB_CASINO_HEIST"))
		{
			return 0;
		}
	}
...
int func_28(int iParam0)
{
	...
	{
		if (get_ped_in_vehicle_seat(get_vehicle_ped_is_using(*iParam0), -1, false) == *iParam0)
		{
			return 1;
		}
	}
...
void func_43()
{
	...
	if ((!func_48(player_id()) && !func_47(player_id())) && !func_46(player_id()))
	{
		func_45();
	}
	func_4();
...
void func_49(struct<21> Param0)
{
	...
	func_50(0, -1, 0);
	network_register_player_broadcast_variables(&Local_58, 97, 0);
	if (network_is_game_in_progress())
	{
		func_5();
	}
