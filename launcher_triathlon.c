...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(get_hash_of_this_script_name()) > 1 && !func_120(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (get_ground_z_for_3d_coord(ScriptParam_97.f_1[0 /*3*/], &fVar1, false, false))
			{
				if (fVar1 != 0f)
				{
		...
		if (does_entity_exist(iLocal_53) && !is_entity_dead(iLocal_53, false))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_102(3) && !Global_100475)
						{
							...
							{
								if ((!func_120(uLocal_58, 1) || !does_entity_exist(func_101())) && !Global_100475)
								{
									func_113(10);
									break;
								}
						...
						if (bVar3)
						{
							if (!is_entity_at_coord(iLocal_53, ScriptParam_97.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, false, true, iLocal_67))
							{
								bVar3 = false;
							}
							...
							if (bVar3)
							{
								...
								if (func_80(uLocal_54))
								{
									...
									else if (!func_120(uLocal_58, 2048) || !is_help_message_being_displayed())
									{
										func_78(&iLocal_60);
				...
				case 6:
					...
					if (func_120(uLocal_58, 2097152))
					{
						if (!func_102(3) && !is_thread_active(iLocal_50))
						{
							func_113(10);
						}
					}
					...
					{
						playstats_oddjob_done(round((func_34(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_33(&iLocal_71);
						...
						if (iLocal_63 != -1)
						{
							if (func_120(Global_112037, 0))
							{
								playstats_mission_checkpoint(func_41(iLocal_63), 0, Global_100478, 0);
...
void func_4()
{
	...
	{
		set_entity_as_mission_entity(iLocal_85, true, true);
	}
	if (does_entity_exist(iLocal_83))
	{
		set_entity_as_mission_entity(iLocal_83, true, true);
	}
	if (does_entity_exist(iLocal_84))
	{
		set_entity_as_mission_entity(iLocal_84, true, true);
	}
	iLocal_86 = add_scenario_blocking_area((Local_79.f_0 - 3f), (Local_79.f_1 - 3f), (Local_79.f_2 - 3f), (Local_79.f_0 + 3f), (Local_79.f_1 + 3f), (Local_79.f_2 + 3f), false, true, true, true);
	func_7();
	func_5();
}
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		clear_bit(&(Global_113386.f_20410.f_150[iVar1]), iVar0);
		clear_bit(&(Global_113386.f_20410.f_150[iVar1]), iVar0);
	}
}
...
void func_30()
{
	...
	if (is_xbox360_version() || func_32())
	{
		network_set_rich_presence(StackVal, 0, 0, 0);
	}
	else if (is_ps3_version() || func_31())
	{
...
void func_40(char* sParam0, int iParam1, int iParam2)
{
	...
	playstats_mission_started(sParam0, iParam1, iParam2, func_6(0));
}
...
void func_47()
{
	...
	if (bLocal_87)
	{
		...
		{
			if (does_navmesh_blocking_object_exist(iLocal_92[iVar0]))
			{
				remove_navmesh_blocking_object(iLocal_92[iVar0]);
			}
			iVar0++;
		}
...
void func_62()
{
	...
	else if ((is_ped_injured(iLocal_85) || is_shocking_event_in_sphere(91, get_entity_coords(iLocal_85, true), 40f)) || is_shocking_event_in_sphere(118, get_entity_coords(iLocal_85, true), 40f))
	{
		func_81("TRI_DEATH", -1);
		iVar0 = iLocal_69;
		func_75(iLocal_69);
	...
	if (does_entity_exist(iLocal_85))
	{
		if (!is_entity_dead(iLocal_85, false) && !is_entity_dead(player_ped_id(), false))
		{
			if (vdist2(get_entity_coords(iLocal_85, true), get_entity_coords(player_ped_id(), true)) <= 144f)
			{
				if (get_script_task_status(iLocal_85, 150319005) != 1)
				{
					task_look_at_entity(iLocal_85, player_ped_id(), -1, 0, 2);
				}
			}
			else if (get_script_task_status(iLocal_85, 150319005) == 1)
			{
				task_clear_look_at(iLocal_85);
			}
		}
	}
	if (bLocal_87)
...
void func_63()
{
	...
	if (get_game_timer() > iLocal_90 && fLocal_57 < (30f * 30f))
	{
		iLocal_90 = get_game_timer() + 10000;
		if (get_random_float_in_range(0f, 1f) <= 0.5f)
		{
			...
			iVar3 = get_ped_nearby_peds(player_ped_id(), &uVar2, iVar0);
			iVar5 = 0;
			while (iVar5 < iVar3)
			{
				if (!is_ped_injured(uVar2[iVar5]) && !does_entity_exist(iVar4))
				{
					if (get_entity_model(uVar2[iVar5]) == joaat("a_m_y_roadcyc_01"))
					{
						iVar4 = uVar2[iVar5];
					}
				}
			...
			if (does_entity_exist(iVar4) && !is_ped_injured(iVar4))
			{
				StringCopy(&Var6, "A_M_Y_TRIATHLON_01_MINI_0", 32);
				StringIntConCat(&Var6, get_random_int_in_range(1, 5), 32);
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_65(iParam3), false);
}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_99()) || Global_31962) || func_98()) || func_84(8, -1)) || func_95()) || func_97()) || func_96()) || func_86()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_99()) || Global_112433) || Global_31962) || func_98()) || func_84(8, -1)) || func_95()) || func_97()) || func_96()) || func_86()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_99()) || Global_112433) || Global_31962) || func_98()) || func_84(8, -1)) || func_97()) || func_96()) || func_86()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_99() || get_player_wanted_level(player_id()) > 0) || func_84(8, -1)) || func_86()) || func_94()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_99()) || func_96()) || Global_112433) || Global_31962) || func_98()) || Global_44238) || func_84(8, -1)) || func_95()) || func_94()) || func_86()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_105()
{
	...
	if (bLocal_87)
	{
		clear_area_of_objects(Local_78, 25f, 0);
		if (does_scenario_group_exist("Triathlon_1_Start") && iLocal_91 == 1)
		{
			set_scenario_group_enabled("Triathlon_1_Start", true);
		}
		if (does_scenario_group_exist("Triathlon_2_Start") && iLocal_91 == 0)
		{
			set_scenario_group_enabled("Triathlon_2_Start", true);
		}
		if (does_scenario_group_exist("Triathlon_3_Start") && iLocal_91 == 2)
		{
		...
		if (!does_entity_exist(iLocal_81))
		{
			...
			iLocal_81 = create_object(joaat("prop_tri_table_01"), Var1, true, true, false);
			set_entity_heading(iLocal_81, fVar0);
		...
		if (!does_entity_exist(iLocal_82))
		{
			...
			iLocal_82 = create_object(joaat("prop_chair_08"), Local_79, true, true, false);
			set_entity_heading(iLocal_82, fVar0);
		...
		if (!does_entity_exist(iLocal_83))
		{
			...
			iLocal_83 = create_object(joaat("p_cs_clipboard"), Var1, true, true, false);
			set_entity_rotation(iLocal_83, -90f, 0f, 90f, 2, false);
			activate_physics(iLocal_83);
		...
		if (!does_entity_exist(iLocal_85))
		{
			...
			iLocal_85 = create_ped(4, joaat("a_m_y_roadcyc_01"), Local_79, fVar0, true, true);
			set_ped_component_variation(iLocal_85, 0, 1, 0, 0);
			set_ped_component_variation(iLocal_85, 4, 0, 3, 0);
			set_ped_component_variation(iLocal_85, 3, 0, 2, 0);
			set_model_as_no_longer_needed(joaat("a_m_y_roadcyc_01"));
		}
		if (!does_entity_exist(iLocal_84))
		{
			if (iLocal_91 == 1)
			...
			iLocal_84 = create_object(joaat("prop_pencil_01"), Var2, true, true, false);
			set_model_as_no_longer_needed(joaat("prop_pencil_01"));
		}
		if (!is_ped_injured(iLocal_85))
		{
			if (does_scenario_exist_in_area(Local_79, 3f, true))
			{
				task_use_nearest_scenario_to_coord_warp(iLocal_85, Local_79, 2f, 0);
			}
			else
			{
				switch (iLocal_91)
				...
				task_start_scenario_at_position(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", Var3, fVar4, -1, false, true);
			}
		}
		iVar8 = 0;
		while (iVar8 < iLocal_92)
		{
			...
			if (!func_106(Var5))
			{
				iLocal_92[iVar8] = add_navmesh_blocking_object(Var5, Var6, fVar7, false, 7);
			}
			iVar8++;
		}
	}
...
int func_110()
{
	if (bLocal_87)
	{
		if (!has_model_loaded(joaat("prop_tri_table_01")))
		{
			return 0;
		}
		if (!has_model_loaded(joaat("prop_chair_08")))
		{
			return 0;
		}
		if (!has_model_loaded(joaat("a_m_y_roadcyc_01")))
		{
			return 0;
		}
		if (!has_anim_dict_loaded("amb@prop_human_seat_chair@male@generic@idle_a"))
		{
			return 0;
		}
		if (!has_model_loaded(joaat("p_cs_clipboard")))
		{
			return 0;
		}
		if (!has_model_loaded(joaat("prop_pencil_01")))
		{
			return 0;
		}
	}
...
void func_111()
{
	if (bLocal_87)
	{
		request_model(joaat("prop_tri_table_01"));
		request_model(joaat("prop_chair_08"));
		request_model(joaat("a_m_y_roadcyc_01"));
		request_model(joaat("p_cs_clipboard"));
		request_model(joaat("prop_pencil_01"));
...
void func_128()
{
	...
	remove_scenario_blocking_area(iLocal_86, false);
	if (!iLocal_89)
	{
