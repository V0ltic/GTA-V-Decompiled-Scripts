...
void func_8()
{
	...
	if (!Global_97527)
	{
		Global_97711 = get_clock_month();
		Global_97710 = get_clock_day_of_month();
		Global_97709 = get_clock_hours();
		Global_97527 = 1;
		Global_97532 = get_clock_day_of_week();
		Global_97531 = get_clock_hours();
		func_12();
		return;
	}
