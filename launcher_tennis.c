...
void __EntryFunction__()
{
	...
	iLocal_62 = get_player_ped(player_id());
	iLocal_68 = 0;
	...
	if (_get_number_of_references_of_script_with_name_hash(get_hash_of_this_script_name()) > 1 && !func_183(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
	...
	while (true)
	{
		...
		if (does_entity_exist(iLocal_62) && !is_entity_dead(iLocal_62, false))
		{
			Local_64 = { get_entity_coords(iLocal_62, true) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_181(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (are_strings_equal(&(Global_100441.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_168(3) && !Global_100475)
						{
							...
							{
								if ((!func_183(uLocal_67, 1) || !does_entity_exist(func_167())) && !Global_100475)
								{
									func_176(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!is_entity_in_angled_area(player_ped_id(), Local_86, Local_87, fLocal_88, true, false, iLocal_76) || (fLocal_90 > 0f && get_distance_between_coords(get_entity_coords(player_ped_id(), true), func_142(Local_86, Local_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (absf((Local_64.f_2 - Local_86.f_2)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_141(uLocal_63))
								{
									...
									else if (!func_183(uLocal_67, 2048) || !is_help_message_being_displayed())
									{
										func_139(&iLocal_69);
				...
				case 5:
					set_input_exclusive(0, 51);
					if (has_script_loaded(&cLocal_53))
					{
						if (iLocal_69 != -1)
						{
							func_139(&iLocal_69);
				...
				case 6:
					...
					if (func_183(uLocal_67, 2097152))
					{
						if (!func_168(3) && !is_thread_active(iLocal_51))
						{
							func_176(10);
						}
					}
					if (!is_thread_active(iLocal_51))
					{
						playstats_oddjob_done(round((func_13(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_12(&iLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_183(Global_112037, 0))
							{
								playstats_mission_checkpoint(func_21(iLocal_72), 0, Global_100478, 0);
				...
				case 7:
					...
					if (!is_string_null_or_empty(sLocal_74))
					{
						if (func_1(sLocal_74))
						{
							clear_help(true);
...
void func_2()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		func_3(player_ped_id());
	}
}

void func_3(int iParam0)
{
	release_ped_preload_variation_data(iParam0);
	release_ped_preload_prop_data(iParam0);
}
...
void func_40()
{
	...
	if (iLocal_92 == 2)
	{
		...
		else if (_get_number_of_references_of_script_with_name_hash(joaat("tennis_family")) == 0)
		{
			iLocal_94 = 0;
			iLocal_95 = 0;
		}
...
void func_46(int iParam0, int iParam1, var uParam2)
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			set_ped_preload_variation_data(iParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				set_ped_preload_prop_data(iParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_53(iParam2));
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_60(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_60(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_53(iParam0));
			if (iVar11 > iVar10)
			{
...
Vector3 func_142(struct<3> Param0, struct<3> Param1, float fParam2)
{
...
int func_149()
{
	if (func_170(6) || func_170(7))
	{
		...
		{
			switch (func_150(get_entity_coords(player_ped_id(), true)))
			{
				case 1:
					return func_169(96);
					break;
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_163()) || Global_31962) || func_162()) || func_145(8, -1)) || func_159()) || func_161()) || func_160()) || func_147()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_163()) || Global_112433) || Global_31962) || func_162()) || func_145(8, -1)) || func_159()) || func_161()) || func_160()) || func_147()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_163()) || Global_112433) || Global_31962) || func_162()) || func_145(8, -1)) || func_161()) || func_160()) || func_147()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_163() || get_player_wanted_level(player_id()) > 0) || func_145(8, -1)) || func_147()) || func_158()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_163()) || func_160()) || Global_112433) || Global_31962) || func_162()) || Global_44238) || func_145(8, -1)) || func_159()) || func_158()) || func_147()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_165()
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (func_134(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_133(player_ped_id());
...
void func_172()
{
	...
	if (bLocal_93 && _get_number_of_references_of_script_with_name_hash(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			iVar1 = get_random_int_in_range(1, 4);
			iVar2[0] = get_random_int_in_range(2, 8);
			iVar3 = 1;
...
void func_184()
{
	...
	if ((get_rain_level() + get_snow_level()) > 0.1f)
	{
		bLocal_93 = false;
	}
}
...
void func_192()
{
	...
	if (is_thread_active(iLocal_51))
	{
		force_cleanup_for_thread_with_this_id(iLocal_51, 3);
	}
	if (!is_string_null(&cLocal_53))
	{
		if (get_length_of_literal_string(&cLocal_53) != 0)
		{
			set_script_as_no_longer_needed(&cLocal_53);
		}
	}
