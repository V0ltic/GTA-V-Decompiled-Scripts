...
int func_2()
{
	...
	if (iVar1 < 0)
	{
		if (!is_player_switch_in_progress())
		{
			...
			while (iVar2 < 4)
			{
				if (does_entity_exist(iLocal_447[iVar2]))
				{
					if (!is_ped_injured(iLocal_447[iVar2]))
					{
	...
	if (!is_string_null_or_empty(&Local_464))
	{
		...
		fVar3 = vdist2(get_entity_coords(iLocal_447[iVar1], false), get_entity_coords(player_ped_id(), false));
		if (fVar3 < (150f * 150f) || is_gameplay_hint_active())
		{
...
int func_3(char* sParam0, int* iParam1, int iParam2)
{
	...
	if (!does_entity_exist(iLocal_447[*iParam2]))
	{
		*iParam2 = -1;
		return 0;
	}
	fVar2 = vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_447[*iParam2], false));
	if (fVar2 > (30f * 30f))
	{
		if (fVar2 > (150f * 150f))
		{
	...
	func_30(&uLocal_269, 2, player_ped_id(), "TREVOR", 0, 1);
...
void func_40(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_65(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
...
int func_45(char* sParam0)
{
	if (!func_46(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_67(sParam0)) || func_67("CMN_HINT"))
		{
			clear_help(true);
		}
		return 0;
...
int func_46(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_53() || func_52(Global_4718592.f_168757)) || func_51())
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			iVar1 = func_50(player_ped_id(), 0);
			if (((is_turret_seat(iVar0, iVar1) || (get_entity_model(iVar0) == joaat("apc") && iVar1 != -1)) || (get_entity_model(iVar0) == joaat("akula") && iVar1 != -1)) || (((get_entity_model(iVar0) == joaat("riot2") && iVar1 == 0) && func_49(iVar0, 10)) && get_vehicle_mod(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_47(int iParam0)
{
	if (iParam0 != func_13())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_48(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_60(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_63(bParam1, bParam2, bParam3) || is_ped_in_any_vehicle(player_ped_id(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((get_game_timer() - uParam0->f_4) > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), true) || func_61(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_69(int iParam0, int iParam1)
{
	...
	switch (iLocal_480[iParam0])
	{
		case 0:
			...
			if (fLocal_463 >= 0f)
			{
				if (is_vehicle_driveable(iLocal_450[iParam0], false))
				{
					if (!is_playback_going_on_for_vehicle(iLocal_450[iParam0]))
					{
						start_playback_recorded_vehicle(iLocal_450[iParam0], iLocal_461[iParam0], &Local_458, true);
					}
					else if (is_player_switch_in_progress())
					{
						if (get_player_switch_state() == 8 && get_player_switch_jump_cut_index() == 0)
						{
							skip_time_in_playback_recorded_vehicle(iLocal_450[iParam0], (fLocal_463 - get_time_position_in_recording(iLocal_450[iParam0])));
		...
		case 1:
			...
			if (!is_ped_sitting_in_vehicle(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
			...
			if (is_playback_going_on_for_vehicle(iLocal_450[iParam0]))
			{
				...
				if (!is_entity_dead(iVar0, false) && is_playback_going_on_for_vehicle(iVar0))
				{
				...
				{
					bVar1 = false;
					if (!get_ped_type(iLocal_447[iParam0]) == 6)
					{
						func_70(iLocal_450[iParam0], player_ped_id(), &(fLocal_481[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, bVar1);
					}
					else
					{
						fLocal_481[iParam0] = 1f;
						fVar2 = get_entity_speed(player_ped_id());
						fVar3 = get_entity_speed(iLocal_450[iParam0]);
						fLocal_481[iParam0] = 1f;
						if (fVar3 > fVar2)
						{
				...
				{
					stop_playback_recorded_vehicle(iLocal_450[iParam0]);
					return 0;
				}
				set_playback_speed(iLocal_450[iParam0], fLocal_481[iParam0]);
				fVar4 = (get_time_position_in_recording(iLocal_450[iParam0]) / get_total_duration_of_vehicle_recording(iLocal_461[iParam0], &Local_458));
				if (!is_playback_using_ai_going_on_for_vehicle(iLocal_450[iParam0]))
				{
					if (!get_ped_type(iLocal_447[iParam0]) == 6)
					{
						if (is_area_occupied(get_entity_coords(iLocal_450[iParam0], true) - Vector(1f, 1f, 1f), get_entity_coords(iLocal_450[iParam0], true) + Vector(1f, 1f, 1f), false, true, false, false, false, 0, false))
						{
							set_playback_to_use_ai(iLocal_450[iParam0], iLocal_266);
						}
					}
					else
					{
				...
				if (has_entity_been_damaged_by_entity(iLocal_447[iParam0], player_ped_id(), true) || has_entity_been_damaged_by_entity(iLocal_450[iParam0], player_ped_id(), true))
				{
					stop_playback_recorded_vehicle(iLocal_450[iParam0]);
					return 0;
				}
				if (has_entity_been_damaged_by_any_vehicle(iLocal_450[iParam0]))
				{
					stop_playback_recorded_vehicle(iLocal_450[iParam0]);
					return 0;
				}
				if (get_ped_type(iLocal_447[iParam0]) == 6)
				{
					...
					{
						if (does_entity_exist(get_vehicle_ped_is_using(player_ped_id())) && !is_playback_going_on_for_vehicle(get_vehicle_ped_is_using(player_ped_id())))
						{
							stop_playback_recorded_vehicle(iLocal_450[iParam0]);
							return 0;
						}
			...
			{
				clear_ped_tasks(iLocal_447[iParam0]);
				if (!get_ped_type(iLocal_447[iParam0]) == 6)
				{
					task_vehicle_drive_wander(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
					set_ped_keep_task(iLocal_447[iParam0], true);
					if (iLocal_268 == 281)
					{
						set_vehicle_engine_health(iLocal_450[iParam0], 0f);
					}
		...
		case 2:
			...
			if (is_ped_sitting_in_vehicle(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				if (get_script_task_status(iLocal_447[iParam0], -258271821) != 1)
				{
					task_vehicle_drive_wander(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				}
				else
				{
					set_drive_task_cruise_speed(iLocal_447[iParam0], fLocal_265);
				}
			}
			else
			{
		...
		case 3:
			...
			if (get_player_wanted_level(player_id()) <= 0)
			{
				...
				{
					clear_ped_tasks(iLocal_447[iParam0]);
					set_ped_as_no_longer_needed(&(iLocal_447[iParam0]));
					return 0;
				}
			}
			break;
		...
		case 4:
			if (is_ped_injured(iLocal_447[iParam0]))
			{
				iLocal_480[iParam0] = -1;
				return 0;
			}
			...
			if (!is_ped_sitting_in_vehicle(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				if (!is_ped_getting_into_a_vehicle(iLocal_447[iParam0]))
				{
					task_enter_vehicle(iLocal_447[iParam0], iLocal_450[iParam0], 20000, -1, 2f, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!is_ped_injured(iLocal_447[iParam0]))
			{
				if (get_script_task_status(iLocal_447[iParam0], 1805844857) != 1)
				{
					...
					task_smart_flee_ped(iLocal_447[iParam0], player_ped_id(), 150f, -1, false, false);
				}
			}
			else
			{
				...
				if (!is_entity_dead(iVar9, false))
				{
					...
					if (is_this_model_a_car(iVar10) || is_this_model_a_bike(iVar10))
					{
						if (is_vehicle_driveable(iVar9, false))
						{
							...
							set_air_drag_multiplier_for_players_vehicle(player_id(), fLocal_141);
						}
					}
				}
			}
...
int func_80()
{
	...
	if (!is_entity_dead(iVar0, false))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (is_vehicle_driveable(iLocal_450[iVar1], false) && !is_ped_injured(iLocal_447[iVar1]))
				{
					if (!is_string_null_or_empty(&Local_458) && iLocal_461[iVar1] > 0)
					{
						start_playback_recorded_vehicle(iLocal_450[iVar1], iLocal_461[iVar1], &Local_458, true);
						skip_time_in_playback_recorded_vehicle(iLocal_450[iVar1], fLocal_462);
						task_vehicle_mission(iLocal_447[iVar1], iLocal_450[iVar1], 0, 15, 20f, iLocal_266, 0.5f, 2f, true);
						if (get_ped_type(iLocal_447[iVar1]) == 6)
						{
							set_vehicle_siren(iLocal_450[iVar1], true);
						}
					}
				}
				iVar1++;
...
void func_89()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 4)
		{
			...
			{
				request_model(iLocal_448[iVar0]);
				if (!has_model_loaded(iLocal_448[iVar0]))
				{
					request_model(iLocal_448[iVar0]);
					bVar2 = false;
				}
			...
			{
				request_model(iLocal_451[iVar0]);
				if (!has_model_loaded(iLocal_451[iVar0]))
				{
					request_model(iLocal_451[iVar0]);
					bVar2 = false;
				}
			}
			if (!is_string_null_or_empty(&Local_458) && iLocal_461[iVar0] > 0)
			{
				request_vehicle_recording(iLocal_461[iVar0], &Local_458);
				if (!has_vehicle_recording_been_loaded(iLocal_461[iVar0], &Local_458))
				{
					request_vehicle_recording(iLocal_461[iVar0], &Local_458);
					bVar2 = false;
				}
	...
	add_relationship_group("chasecar", &iLocal_455);
	set_relationship_between_groups(3, iLocal_455, joaat("player"));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_451[iVar0] != 0)
		{
			clear_area(Local_456 + Local_452[iVar0 /*3*/], 20f, true, false, false, false);
			iLocal_450[iVar0] = create_vehicle(iLocal_451[iVar0], Local_456 + Local_452[iVar0 /*3*/], (fLocal_457 + fLocal_453[iVar0]), true, true, false);
			set_vehicle_colour_combination(iLocal_450[iVar0], iLocal_454);
			set_model_as_no_longer_needed(iLocal_451[iVar0]);
			_set_entity_cleanup_by_engine(iLocal_450[iVar0], true);
		}
		if (iLocal_448[iVar0] != 0)
		{
			iLocal_447[iVar0] = create_ped_inside_vehicle(iLocal_450[iVar0], iLocal_449, iLocal_448[iVar0], -1, true, true);
			set_ped_random_component_variation(iLocal_447[iVar0], 0);
			set_model_as_no_longer_needed(iLocal_448[iVar0]);
			set_ped_relationship_group_hash(iLocal_447[iVar0], iLocal_455);
			set_blocking_of_non_temporary_events(iLocal_447[iVar0], true);
			if (iLocal_448[iVar0] == joaat("a_m_y_roadcyc_01"))
			{
				set_ped_helmet(iLocal_447[iVar0], true);
			}
			if (iLocal_449 != 6)
			{
...
void func_90()
{
	...
	switch (iLocal_268)
	{
		...
		case 275:
			...
			fLocal_453[1] = get_random_float_in_range(-5f, 5f);
			fLocal_453[2] = get_random_float_in_range(-5f, 5f);
			fLocal_453[3] = get_random_float_in_range(-5f, 5f);
		...
		case 277:
			...
			fLocal_453[0] = get_random_float_in_range(-5f, 5f);
			fLocal_453[1] = get_random_float_in_range(-5f, 5f);
			fLocal_453[2] = get_random_float_in_range(-5f, 5f);
			fLocal_453[3] = get_random_float_in_range(-5f, 5f);
			iLocal_448[0] = joaat("s_m_y_ranger_01");
		...
		default:
			fVar5 = ((fLocal_457 + 90f) + get_random_float_in_range(-5f, 5f));
			Local_452[0 /*3*/] = { Vector(0f, cos(fVar5), sin(fVar5)) * FtoV(get_random_float_in_range(15f, 25f)) };
			fLocal_453[0] = get_random_float_in_range(-5f, 5f);
			iLocal_454 = 0;
			iLocal_448[0] = joaat("a_m_y_genstreet_01");
			iLocal_448[1] = 0;
...
void func_99()
{
	...
	while (iVar0 < 4)
	{
		set_ped_as_no_longer_needed(&(iLocal_447[iVar0]));
		set_vehicle_as_no_longer_needed(&(iLocal_450[iVar0]));
		if (iLocal_448[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_448[iVar0]);
		}
		...
		if (!is_string_null_or_empty(&Local_458) && iLocal_461[iVar0] > 0)
		{
			remove_vehicle_recording(iLocal_461[iVar0], &Local_458);
		}
		iVar0++;
	}
	func_68(&uLocal_434, 0, 0);
