		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1))
			{
				if (!func_78(player_ped_id(), Local_50, 5f, 1))
				{
					...
					{
						if ((func_251(player_ped_id()) && !BitTest(uLocal_47[0], 17)) && !BitTest(uLocal_47[1], 18))
						{
...
int func_186()
{
	...
	while (iVar1 <= 4)
	{
		if (func_251(uVar0[iVar1]) && uVar0[iVar1] != player_ped_id())
		{
...
int func_207()
{
	if (vdist2(get_entity_coords(player_ped_id(), true), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_13())
		{
			func_71(28);
	...
	else if (vdist2(get_entity_coords(player_ped_id(), true), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_13())
		{
			func_71(29);
...
int func_222(var uParam0)
{
	...
	if (func_251(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), false))
	{
		iVar0 = get_players_last_vehicle();
		if (func_87(iVar0))
		{
...
void func_225(bool bParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!is_help_message_being_displayed() && !func_228(func_91())) && !func_227())
			{
