...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("letterscraps")) > 1)
	{
	...
	switch (iLocal_43)
	{
		case 0:
			...
			else if (!is_ped_injured(player_ped_id()))
			{
				if (is_screen_faded_in())
				{
					if (!func_20())
					{
						if (((!is_mobile_phone_call_ongoing() && !func_14()) && !func_13()) && !func_12())
						{
							iLocal_58 = 0;
							iLocal_56 = 0;
							...
							iLocal_55 = request_scaleform_movie("LETTER_SCRAPS");
							while (!has_scaleform_movie_loaded(iLocal_55))
							{
								wait(0);
							}
							begin_scaleform_movie_method(iLocal_55, "SET_LETTER_TEXT");
							func_11(sLocal_57[0]);
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				draw_scaleform_movie_fullscreen(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_51)
				{
					...
					{
						add_pickup_to_interior_room_by_name((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
	...
	if (*uParam0)
	{
		switch (*iParam4)
		{
			...
			case 1:
				...
				add_text_component_integer(func_26(iParam3));
				end_text_command_scaleform_string();
				end_scaleform_movie_method();
...
int func_38(var uParam0, var uParam1, struct<3> Param2)
{
	...
	if ((uParam1[bVar0 /*11*/])->f_10)
	{
		...
		{
			if (has_pickup_been_collected((uParam1[bVar0 /*11*/])->f_1) || func_53((uParam1[bVar0 /*11*/])->f_1))
			{
	...
	{
		if ((vdist2(Param2, get_pickup_coords((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_58(13)) || func_58(14))
		{
...
void func_73()
{
	...
	set_scaleform_movie_as_no_longer_needed(&iLocal_55);
