...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_2(&(Var0.f_281));
		if (_get_number_of_references_of_script_with_name_hash(joaat("tennis")) > 0)
		{
			func_304(2, 140);
			func_310(&Var0);
		}
...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (func_285(uParam0, iVar8, *iParam2, func_309(uParam1)))
	{
		...
		set_entity_coords(uParam0->f_247, func_284(&(uParam0->f_247)), true, false, false, false);
	...
	switch (func_309(uParam1))
	{
		case 0:
			...
			{
				clear_prints();
				set_entity_coords((uParam0[iParam3 /*94*/])->f_32, func_271(&(uParam0->f_189), func_273(uParam1), uParam0->f_1661, uParam0->f_1658, iParam3 == func_272(uParam1), iParam3), true, true, false, true);
		...
		case 4:
			if (func_269(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_267(uParam0[iParam3 /*94*/], create_ped(1, uParam0->f_1669, Var13, get_heading_from_vector_2d(uParam0->f_1658, uParam0->f_1658.f_1), false, false));
					task_stand_still((uParam0[iParam3 /*94*/])->f_32, -1);
					set_entity_heading(func_266(uParam0[iParam3 /*94*/]), (get_heading_from_vector_2d(uParam0->f_1658, uParam0->f_1658.f_1) + 180f));
					Var1 = { func_271(&(uParam0->f_189), func_273(uParam1), uParam0->f_1661, uParam0->f_1658, iParam4 == func_272(uParam1), iParam4) };
					func_267(uParam0[iParam4 /*94*/], create_ped(1, uParam0->f_1668, Var1, get_heading_from_vector_2d(-uParam0->f_1658, -uParam0->f_1658.f_1), false, false));
					task_stand_still((uParam0[iParam4 /*94*/])->f_32, -1);
					set_entity_heading(func_266(uParam0[iParam4 /*94*/]), get_heading_from_vector_2d(-uParam0->f_1658, -uParam0->f_1658.f_1));
					Var1 = { 0f, 0f, 0f };
					func_270(uParam1, 8);
					func_265(uParam1, 0);
					...
					{
						func_260(uParam0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 0, 0, 0, 0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 2, 0, 0, 0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 3, 0, 0, 0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 4, 0, 0, 0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 5, 0, 0, 0);
						set_ped_component_variation(func_266(uParam0[iParam4 /*94*/]), 7, 0, 0, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			bVar14 = (get_game_timer() > func_255(uParam0[iParam3 /*94*/]) && get_game_timer() > func_255(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (is_entity_playing_anim(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && does_entity_exist(uParam0->f_247))
					{
						fVar19 = get_entity_anim_current_time(func_266(uParam0[func_272(uParam1) /*94*/]), sVar18, "serve");
		...
		case 10:
			...
			if (get_frame_count() > func_106(&(uParam0->f_247)) && func_105(uParam0[(1 - func_272(uParam1)) /*94*/], 256))
			{
		...
		case 12:
			...
			else if (get_frame_count() > func_106(&(uParam0->f_247)) && func_105(uParam0[(1 - func_178(uParam1)) /*94*/], 256))
			{
				func_104(uParam1, func_178(uParam1));
				func_270(uParam1, 14);
				func_103(iParam2);
			...
			{
				task_stand_still(func_266(uParam0[iParam4 /*94*/]), -1);
			}
			break;
		...
		case 14:
			...
			else
			{
				...
				if (func_177(uParam1))
				{
					func_32(uParam0, get_game_timer() + 1500);
				}
		...
		case 20:
			...
			{
				func_24(uParam0, 4);
				func_23(uParam0, get_game_timer() + 580);
			}
			else if (((get_game_timer() > func_22(uParam0) && func_230(uParam0, 4)) && does_entity_exist(uParam0->f_247)) && !is_entity_attached(uParam0->f_247))
			{
				func_268(uParam0, 1);
				func_195(uParam0[func_272(uParam1) /*94*/], &(uParam0->f_247));
				func_288(&(uParam0->f_247), 4);
			}
			if (func_272(uParam1) != iParam3 && get_script_task_status(func_266(uParam0[iParam3 /*94*/]), 242628503) == 7)
			{
				func_233(uParam0->f_1657, 1);
				func_237(uParam0[iParam3 /*94*/], uParam0, func_273(uParam1), iParam3, 0, 0);
...
void func_5(var uParam0, var uParam1, var uParam2)
{
	...
	if (!is_ped_injured(iVar0))
	{
		...
		if (iVar6 == 75)
		{
			...
			{
				if (!is_tennis_mode(func_266(uParam0)))
				{
	...
	if (!func_105(uParam0, 1024))
	{
		...
		if (func_76(uParam0) == 72 || func_76(uParam0) == 73)
		{
			if (func_11(uParam0) != 0)
			{
				...
				play_tennis_dive_anim(iParam1, iVar8, func_10(uParam0), func_9(uParam0), 1f, false);
				func_8(uParam0, get_game_timer() + 2871);
			}
		}
		else
		{
			play_tennis_swing_anim(iParam1, sVar1, &Var2, fVar5, func_7(uParam0), false);
		}
...
void func_21(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	{
		if (does_entity_exist(func_266(uParam1)))
		{
			if (is_tennis_mode(func_266(uParam1)))
			{
				set_ped_reset_flag(func_266(uParam1), 69, true);
			}
			set_ped_reset_flag(func_266(uParam1), 102, true);
		}
	}
}
...
int func_26(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	...
	else if ((!is_ped_injured(iVar1) && (bParam5 || iParam4 == 1)) && !func_105(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam3)
		{
	...
	else if (((!is_ped_injured(iVar2) && ((bParam5 || iParam4 == 4) || iParam4 == 1)) && !func_105(uParam0[iParam2 /*94*/], 8192)) && get_script_task_status(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
...
{
	if (!((!is_ped_injured(func_266(uParam0)) && is_task_move_network_active(func_266(uParam0))) && are_strings_equal(get_task_move_network_state(func_266(uParam0)), "running")))
	{
		task_move_network_by_name(func_266(uParam0), sParam1, fParam2, false, "mini@tennis", 4);
	}
}
...
void func_54(var uParam0, var uParam1)
{
	...
	{
		if (get_script_task_status(func_266(uParam0), 713668775) != 1 && get_script_task_status(func_266(uParam0), 242628503) != 1)
		{
			Var0 = { uParam0->f_37 - uParam1->f_29 * Vector(0.93f, 0.93f, 0.93f) };
			task_follow_nav_mesh_to_coord(func_266(uParam0), uParam1->f_29 + Var0, 2f, 20000, 0.25f, false, 40000f);
			func_59(uParam0, 2048);
			func_55("FAR_FROM_COURT", -1);
		}
	}
	else if (func_105(uParam0, 2048) && get_script_task_status(func_266(uParam0), 713668775) != 1)
	{
...
void func_58(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		iVar0 = func_51(get_random_float_in_range(0f, 1f) < 0.5f, 0, 3);
...
int func_98(var uParam0, int iParam1, var uParam2)
{
	...
	if (has_entity_collided_with_anything(*uParam0) || func_289(uParam0, 16))
	{
...
int func_107(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (uParam0->f_31 != 4 && get_game_timer() > func_165(uParam0))
	{
	...
	else if (get_game_timer() > func_165(uParam0))
	{
	...
	{
		if (func_105(uParam0, 4096) && get_game_timer() > func_165(uParam0))
		{
		...
		if (func_154(uParam0, Var11, bVar6))
		{
			...
			if ((iVar4 != 75 && iVar4 != 76) && (uParam0->f_31 == 4 || (uParam0->f_31 != 4 && func_105(uParam0, 512))))
			{
				if (!func_229(&(uParam0->f_4), 8) && !func_229(&(uParam0->f_4), 1))
				{
					...
					func_149(uParam0, get_frame_count() + 2);
					if (uParam0->f_31 == 4)
					{
			...
			else if (iVar4 == 75 && func_146(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				func_139(uParam0, get_game_timer() + 1000);
				if (iVar4 == 75 || fVar5 <= 0f)
				{
					clear_ped_tasks(func_266(uParam0));
...
void func_109(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_45(func_266(uParam0)) == 17 && get_random_float_in_range(0f, 1f) < 0.5f)
	{
	...
	if (bParam2 || bParam3)
	{
		...
		{
			play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_266(uParam0), 0, false, 0);
		}
		else if (func_92(uParam1) == 2)
		{
			play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_BACKSLICE_MASTER", "TENNIS_NPC_SMASH_BACKSLICE_MASTER"), func_266(uParam0), 0, false, 0);
		}
	...
	{
		play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_LOB_MASTER", "TENNIS_NPC_LOB_MASTER"), func_266(uParam0), 0, false, 0);
		iVar0 = 60;
	}
	else
	{
		if (func_92(uParam1) == 0)
		{
			play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_FOREARM_MASTER", "TENNIS_NPC_FOREARM_MASTER"), func_266(uParam0), 0, false, 0);
		}
		else if (func_92(uParam1) == 2)
		{
			play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_BACKSLICE_MASTER", "TENNIS_NPC_BACKSLICE_MASTER"), func_266(uParam0), 0, false, 0);
		}
		else if (func_92(uParam1) == 1)
		{
			play_sound_from_entity(-1, func_196(uParam0->f_31 != 4, "TENNIS_PLYR_TOPSPIN_MASTER", "TENNIS_NPC_TOPSPIN_MASTER"), func_266(uParam0), 0, false, 0);
		}
		iVar0 = 80;
	}
	if (uParam0->f_31 != 4)
...
{
	if (!is_ped_injured(func_266(uParam0)))
	{
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_112(iParam3), false);
}
...
void func_114(var uParam0, struct<3> Param1)
{
	...
	if (does_entity_exist(uParam0->f_247))
	{
		...
		func_119(&(uParam0->f_247), get_frame_count() + 5);
...
void func_116(var uParam0, bool bParam1)
{
	...
	{
		Var0 = { func_117(bParam1, func_284(uParam0), get_entity_coords(*uParam0, true)) };
	}
	uParam0->f_27 = { Var0 };
	uParam0->f_30 = { Var0 };
	uParam0->f_25 = 0f;
...
Vector3 func_124(var uParam0, var uParam1, struct<3> Param2, int iParam3)
{
	...
	{
		fVar6 = func_125(0.4f, 1f, get_random_float_in_range(0f, 1f));
...
int func_134(var uParam0, var uParam1, struct<3> Param2, bool bParam3)
{
	...
	if (!is_ped_injured(func_266(uParam0)) && _0xE95B0C7D5BA3B96B(func_266(uParam0)))
	{
		return 0;
	}
	if (func_137(uParam0) > get_frame_count())
	{
		return 0;
	}
	if (!func_105(uParam0, 1024))
	...
	Var8 = { get_ped_bone_coords(func_266(uParam0), 60309, 0f, 0f, 0f) };
	Var9 = { Var0 - Var8 };
...
void func_138(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, struct<3> Param6, bool bParam7)
{
	...
	if (!func_105(uParam1, 1024))
	{
		...
		func_8(uParam1, get_game_timer() + 2442);
		if ((1 && !func_229(&((uParam0[iParam3 /*94*/])->f_4), 256)) && get_game_timer() > func_255(uParam0[iParam3 /*94*/]))
		{
			iParam5 = (1 - iParam5);
			if (bParam7)
			{
...
int func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = _0x7F8F6405F4777AF6(Var5, func_117(bParam6, *uParam5, *uParam4), func_117(bParam6, *uParam4, *uParam5), false);
...
void func_162(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	*bParam3 = 0;
	...
	{
		case 2:
			if (does_entity_exist(uParam1->f_247) && func_287(&(uParam1->f_247)) > 0)
			{
				fVar0 = get_random_float_in_range(0f, 1f);
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_166(uParam0);
				func_174(uParam0, (to_float(iVar0) * get_frame_time()));
			}
		}
		if (!func_173(*uParam2))
		{
...
void func_179(var uParam0, var uParam1, bool bParam2)
{
	if (does_entity_exist(*uParam1))
	{
		if (bParam2)
		{
			if (!is_ped_injured(func_266(uParam0)))
			{
				task_look_at_entity(func_266(uParam0), *uParam1, -1, 6, 2);
			}
		}
		else if (!is_ped_injured(func_266(uParam0)))
		{
			task_clear_look_at(func_266(uParam0));
		}
	}
}
...
int func_183(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (((func_254(uParam0) > func_192(uParam1) && func_76(uParam2) == 75) && uParam0->f_1657 != 1) || (((func_254(uParam0) > func_192(uParam1) && func_76(uParam2) == 75) && uParam0->f_1657 == 1) && is_screen_faded_in()))
		{
			func_235(uParam2, 74);
			func_216(uParam0, 0);
		}
	...
	if (func_105(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_51(get_random_float_in_range(0f, 1f) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = get_random_int_in_range(1, 4);
			iVar0 = func_51(get_random_float_in_range(0f, 1f) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = get_random_int_in_range(0, 2);
		}
		Var5 = { func_123(Var6, Var5, get_random_float_in_range(0f, 1f)) };
		...
		*uParam2 = fVar4;
		...
		if (iVar0 == 1 || iVar0 == 0)
		{
			play_sound_from_entity(-1, func_196(uParam0->f_1657 == 1, "TENNIS_AMB_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_266(uParam2), 0, false, 0);
		}
		else
		{
			play_sound_from_entity(-1, func_196(uParam0->f_1657 == 1, "TENNIS_AMB_SERVE_MASTER", "TENNIS_NPC_SERVE_MASTER"), func_266(uParam2), 0, false, 0);
		}
...
void func_184(var uParam0, var uParam1, var uParam2)
{
	...
	if (does_entity_exist(uParam0->f_247))
	{
		...
		func_277(&(uParam0->f_247), get_entity_coords(uParam0->f_247, true));
		uParam0->f_247.f_16 = { func_284(&(uParam0->f_247)) };
		func_119(&(uParam0->f_247), get_frame_count() + 5);
		func_118(&(uParam0->f_247));
		func_116(&(uParam0->f_247), 1);
...
int func_200(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4)
{
	...
	{
		func_159(uParam0);
		if ((is_control_just_pressed(0, 223) && !bParam4) || (func_161(uParam0) > 30f && uParam1->f_1657 == 4))
		{
			...
			if (func_105(uParam0, 64))
			{
				if (func_206(uParam0) > 0.965f)
				{
					*uParam3 = { uParam1->f_282[0 /*2*/] };
					play_sound_from_entity(-1, "TENNIS_PLYR_SMASH_MASTER", func_266(uParam0), 0, false, 0);
				...
				else if (func_206(uParam0) > 0.7f)
				{
					*uParam3 = { uParam1->f_282[2 /*2*/] };
					...
					play_sound_from_entity(-1, "TENNIS_PLYR_SERVE_MASTER", func_266(uParam0), 0, false, 0);
				}
		...
		if (func_161(uParam0) > 30f || (is_control_just_pressed(0, 223) && !bParam4))
		{
			func_160(uParam0);
		}
	}
...
{
	if (!is_ped_injured(func_266(uParam0[iParam1 /*94*/])) && get_script_task_status(func_266(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	else if ((!is_ped_injured(func_266(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_105(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_28(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
		...
		force_ped_ai_and_animation_update(func_266(uParam0[iParam1 /*94*/]), false, false);
		func_59(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_105(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		if (!is_ped_injured(func_266(uParam0[iParam1 /*94*/])) && is_task_move_network_active(func_266(uParam0[iParam1 /*94*/])))
		{
			if (are_strings_equal(get_task_move_network_state(func_266(uParam0[iParam1 /*94*/])), "Intro") && is_task_move_network_ready_for_transition(func_266(uParam0[iParam1 /*94*/])))
			{
				request_task_move_network_state_transition(func_266(uParam0[iParam1 /*94*/]), "running");
			}
		}
	}
	return 1;
...
void func_219(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if ((uParam0->f_31 != 4 && !is_ped_injured(func_266(uParam0))) && !bParam5)
	{
	...
	if (!is_ped_injured(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam5) && !func_225(player_id(), 0))
		{
		...
		else
		{
			...
			fVar2 = (get_heading_from_vector_2d(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				task_play_anim(0, func_196(func_197(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0f, false, false, false);
			}
			if (!bParam8)
			{
			...
			if (func_220(get_entity_coords(uParam0->f_32, true), Var1, 0.1f))
			{
			...
			task_perform_sequence(func_266(uParam0), uParam0->f_54);
			set_ped_weapon_movement_clipset(func_266(uParam0), "weapons@tennis@male");
			func_81(&(uParam0->f_4), 4);
		}
	}
	if (bParam4 && does_entity_exist(func_266(uParam0)))
	{
		force_ped_ai_and_animation_update(func_266(uParam0), false, false);
	}
}
...
void func_228(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if ((uParam0->f_31 != 4 && !is_ped_injured(func_266(uParam0))) && !bParam7)
	{
		func_233(uParam1->f_1657, 1);
	}
	func_235(uParam0, 75);
	...
	if (!is_ped_injured(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam7) && !func_225(player_id(), 0))
		{
			if (!((!is_ped_injured(func_266(uParam0)) && is_task_move_network_active(func_266(uParam0))) && are_strings_equal(get_task_move_network_state(func_266(uParam0)), "running")))
			{
				func_224(uParam1, iParam3, 1);
		...
		else
		{
			set_entity_heading(uParam0->f_32, get_entity_heading(uParam0->f_32));
			func_59(uParam0, 16384);
			fVar2 = (get_heading_from_vector_2d(uParam0->f_40, uParam0->f_40.f_1) + func_145(bParam8, 180f, 0f));
			Var3 = { uParam1->f_189.f_29 - get_entity_coords((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_70(Var3, uParam0->f_40) < 0f;
			bVar5 = func_70(Var3, uParam0->f_43) < 0f;
			func_223(uParam0, 0);
...
void func_237(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((uParam0->f_31 != 3 && !bParam4) && !is_ped_injured(func_266(uParam0))) && !is_ped_ragdoll(func_266(uParam0)))
	{
		if ((is_tennis_mode(func_266(uParam0)) && !func_197(uParam0)) && !func_105(uParam0, 16384))
		{
			set_ped_weapon_movement_clipset(func_266(uParam0), "TENNIS_LOCOMOTION_FEMALE");
		}
		func_129(&iVar0, &iVar1, &uVar2, &uVar2, 1, 1);
		fVar3 = absf(to_float(iVar0));
		if ((fVar3 > 0f || absf(to_float(iVar1)) > 0f) && uParam0->f_31 != 4)
		{
			set_ped_min_move_blend_ratio(func_266(uParam0), 2f);
		}
		if ((func_76(uParam0) != 74 && uParam0->f_31 != 4) && fVar3 > 15f)
		{
			func_251(uParam0, (func_252(uParam0) + get_frame_time()));
		}
		else
		{
			func_251(uParam0, 0f);
		...
		if (is_tennis_mode(func_266(uParam0)) && fVar5 < 0f)
		{
			fVar6 = func_70(uParam0->f_43, func_284(&(uParam1->f_247)) - uParam0->f_37);
			_0x54F157E0336A3822(func_266(uParam0), "ForcedStopDirection", fVar6);
		}
	}
	else if (uParam0->f_31 != 3)
	{
		...
		if (!is_ped_injured(func_266(uParam0)) && is_task_move_network_active(func_266(uParam0)))
		{
			if (are_strings_equal(get_task_move_network_state(func_266(uParam0)), "Intro") && is_task_move_network_ready_for_transition(func_266(uParam0)))
			{
				request_task_move_network_state_transition(func_266(uParam0), "running");
			}
			...
			if (get_task_move_network_event(func_266(uParam0), "IdleStarted"))
			{
			...
			set_task_move_network_signal_bool(func_266(uParam0), &(uParam1->f_1670), true);
			set_task_move_network_signal_float(func_266(uParam0), "Speed", uParam0->f_62);
		}
	}
	if (((func_76(uParam0) == 75 && does_entity_exist(uParam1->f_247)) && has_entity_collided_with_anything(uParam1->f_247)) && vdist2(uParam0->f_37, func_284(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_59(uParam0, 256);
...
{
	if ((get_rain_level() <= 0f && get_snow_level() <= 0f) && func_76(uParam0) == 75)
	{
		if (absf(to_float(iParam1)) >= absf(to_float(iParam2)))
		{
			if (iParam1 > 15)
			{
				...
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_266(uParam0), 0, false, 0);
				}
	...
	switch (func_148(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_76(uParam0) == 75)
			{
				...
				{
					task_go_straight_to_coord(func_266(uParam0), Var1, 2f, -1, 40000f, 0.5f);
				...
				else if ((is_entity_at_coord(uParam0->f_32, func_71(&(uParam0->f_4)), Var2, false, true, 0) || get_script_task_status(func_266(uParam0), 2106541073) == 7) && !func_229(&(uParam0->f_4), 256))
				{
					func_236(&(uParam0->f_4), 0);
					func_218(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_76(uParam0) == 75)
			{
				_0xF56DFB7B61BE7276(func_284(uParam4), func_284(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				if (((!is_ped_injured(func_266(uParam0)) && !vdist2(uParam0->f_37, Var1) <= (0f * 0f)) && !func_229(&(uParam0->f_4), 4)) && !func_105(uParam0, 1024))
				{
					task_go_straight_to_coord(uParam0->f_32, func_71(&(uParam0->f_4)), 2f, -1, 40000f, 0.5f);
					Var1 = { func_71(&(uParam0->f_4)) };
					func_243(&(uParam0->f_4), Var1);
					func_81(&(uParam0->f_4), 4);
				...
				else if (vdist2(uParam0->f_37, Var1) <= (0f * 0f) || get_script_task_status(func_266(uParam0), 2106541073) == 7)
				{
...
void func_246(var uParam0, var uParam1)
{
	...
	if (get_game_timer() > func_248(&(uParam0->f_4)))
	{
		...
		func_247(&(uParam0->f_4), get_game_timer() + 500);
	}
}
...
{
	if (!is_ped_injured(func_266(uParam0[iParam1 /*94*/])) && !is_ped_injured(func_266(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				attach_entity_to_entity((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), get_ped_bone_index(func_266(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
			}
			attach_entity_to_entity((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), get_ped_bone_index(func_266(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		}
		else
		{
			if (!bParam4)
			{
				attach_entity_to_entity((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), get_ped_bone_index(func_266(uParam0[iParam1 /*94*/]), 28422), Local_162, Local_163, false, false, false, false, 2, true, 0);
			}
			attach_entity_to_entity((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), get_ped_bone_index(func_266(uParam0[iParam2 /*94*/]), 28422), Local_162, Local_163, false, false, false, false, 2, true, 0);
		}
	}
}
...
void func_274(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!is_ped_injured(func_266(uParam0[iVar0 /*94*/])) && get_script_task_status(func_266(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = get_sequence_progress(func_266(uParam0[iVar0 /*94*/]));
	}
	if (!is_ped_injured(func_266(uParam0[iVar1 /*94*/])) && get_script_task_status(func_266(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
		*uParam3 = get_sequence_progress(func_266(uParam0[iVar1 /*94*/]));
	}
	if (func_105(uParam0[iVar0 /*94*/], 16384) && *uParam2 > 0)
	{
		func_278(uParam0[iVar0 /*94*/], 16384);
		func_262(func_266(uParam0[iVar0 /*94*/]), 0);
		set_ped_weapon_movement_clipset(func_266(uParam0[iVar0 /*94*/]), "weapons@tennis@male");
	}
	if (func_105(uParam0[iVar1 /*94*/], 16384) && *uParam3 > 0)
	{
		func_278(uParam0[iVar1 /*94*/], 16384);
		func_262(func_266(uParam0[iVar1 /*94*/]), 0);
		set_ped_weapon_movement_clipset(func_266(uParam0[iVar1 /*94*/]), "weapons@tennis@male");
	}
}
...
int func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	Var0 = { 0f, 0f, 1f };
	fVar1 = func_145(fParam9 == -1f, get_frame_time(), fParam9);
	iVar2 = 0;
...
int func_307(var uParam0, int iParam1, int iParam2)
{
	...
	if (!is_ped_injured(player_ped_id()) && is_ped_shooting(player_ped_id()))
	{
		...
		if (!is_ped_injured(func_266(uParam0[(1 - iParam1) /*94*/])))
		{
			task_seek_cover_from_ped(func_266(uParam0[(1 - iParam1) /*94*/]), player_ped_id(), -1, false);
		}
		return 1;
	}
	if (is_ped_injured(iVar0))
...
void func_314(float fParam0, var uParam1, var uParam2)
{
	...
	*fParam0 = (*fParam0 + get_frame_time());
	if ((((*fParam0 > (5f + get_random_float_in_range(0f, 5f)) && func_76(uParam2) == 75) && !is_ped_injured(func_266(uParam2))) && !is_ped_injured(player_ped_id())) && func_77(get_entity_coords(player_ped_id(), true), uParam1->f_3[0 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, uParam1->f_3[3 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, (fVar2 * 1.5f)))
	{
