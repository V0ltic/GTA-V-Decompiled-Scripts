...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 32)
	{
		set_all_vehicle_generators_active_in_area(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, true);
		...
		clear_area(Var1, 40f, true, false, false, false);
	}
	else if (Var0.f_0 == 34)
	{
		iLocal_57 = func_247();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_209(329.513f, 3402.691f, 36.258f, get_entity_coords(Var0.f_35[1], true), 1056964608))
				{
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && !func_148()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_193(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_193(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_180(2))
		{
			if (!func_148())
			{
				if (((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_193(player_ped_id(), Param1, 1) < 20f)
				{
			...
			else if (((func_196(sParam3) && !*uParam8 == 1) && func_129(player_ped_id())) && func_193(player_ped_id(), Param1, 1) >= 20f)
			{
				func_292("pause conversation");
				func_195(1);
				*uParam8 = 1;
			}
			if (func_193(player_ped_id(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_198(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_193(player_ped_id(), Param2, 1) <= 100f)
				{
					func_201(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(player_ped_id(), Param2, 1) > 120f)
				{
					func_203(iParam0);
				}
			}
...
void func_213(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_214(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_214(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_219(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
{
	return func_224(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_230(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_230(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_230(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_247()
{
	return add_scenario_blocking_area(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, false, true, true, true);
}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_41[1]))
			{
				...
				attach_entity_to_entity(uParam0->f_41[1], uParam0->f_28[0], get_ped_bone_index(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, false, false, false, false, 2, true, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_251(iParam0);
...
int func_260(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			request_anim_dict("rcmminute1");
			clear_area(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			iLocal_51 = 1;
			break;
		
		case 1:
			clear_area(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
			if (!func_257(&iVar0) || !has_anim_dict_loaded("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[1]))
			{
				...
				set_vehicle_is_considered_by_player(uParam0->f_35[1], false);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
			...
			if (has_anim_dict_loaded("rcmminute1"))
			{
				if (func_129(uParam0->f_28[0]))
				{
					if (!is_entity_playing_anim(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						...
						task_play_anim(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0f, false, false, false);
				...
				if (func_129(uParam0->f_28[1]))
				{
					...
					task_play_anim(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0f, false, false, false);
...
void func_261(int iParam0, int iParam1)
{
	if (does_entity_exist(iParam0))
	{
		set_vehicle_alarm(iParam0, false);
...
void func_275(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		set_all_vehicle_generators_active_in_area(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, true);
	}
	else if (*iParam0 == 34)
	{
