...
void __EntryFunction__()
{
	...
	iLocal_30 = 52;
	iLocal_28 = 77;
	if (_get_number_of_references_of_script_with_name_hash(joaat("rampage_controller")) > 1)
	{
	...
	while (iVar0 < 5)
	{
		...
		set_bit(&(Global_113386.f_18574[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_28()
{
	...
	{
		func_32(13, floor(Global_113386.f_10194.f_3853));
	}
