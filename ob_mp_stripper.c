...
void __EntryFunction__()
{
	...
	if (does_entity_exist(iScriptParam_381))
	{
		iLocal_41 = iScriptParam_381;
		iLocal_312 = Global_1853348[player_id() /*834*/].f_267.f_32;
	...
	while (true)
	{
		...
		{
			if (get_distance_between_coords(Local_374, get_entity_coords(player_ped_id(), true), true) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
					...
					case 1:
						if (!is_ped_injured(player_ped_id()) && !func_62())
						{
							func_1();
						}
						else
			...
			else if (get_distance_between_coords(Local_374, get_entity_coords(player_ped_id(), false), true) > (3f + 2f))
			{
				func_90();
			}
		}
...
void func_1()
{
	...
	{
		case 0:
			if (((func_57(Local_374, Var0) && !func_56()) && get_entity_heading(player_ped_id()) > (fLocal_375 - 45f)) && get_entity_heading(player_ped_id()) < (fLocal_375 + 45f))
			{
		...
		case 1:
			if (func_53(1, 0, 1))
			{
				if (((func_57(Local_374, Var0) && !func_56()) && get_entity_heading(player_ped_id()) > (fLocal_375 - 45f)) && get_entity_heading(player_ped_id()) < (fLocal_375 + 45f))
				{
					if ((!is_player_free_aiming(player_id()) && !is_player_targetting_anything(player_id())) && is_control_just_pressed(2, 51))
					{
						func_52();
						Global_1835486 = 13;
						func_44();
						...
						clear_area_of_projectiles(Local_374, 2.5f, 0);
						func_33(player_id(), 0, 256, 0);
						iLocal_36 = 1;
						set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
						func_24(1, 1, 1, 0, 0, 0, 0);
						task_ped_slide_to_coord(player_ped_id(), Local_374, fLocal_375, 0.75f);
						iLocal_308 = 2;
					}
				}
				else
		...
		case 2:
			...
			func_20(1);
			if (get_script_task_status(player_ped_id(), 1045468327) == 7)
			{
				func_16(104, 1, -1, 1);
				iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_320, sLocal_321, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_15(iLocal_318))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_320, sLocal_322, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_318), sLocal_324, sLocal_320);
				}
				if (!func_15(iLocal_319))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_320, sLocal_323, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_319), sLocal_325, sLocal_320);
				}
				network_start_synchronised_scene(iLocal_313);
				iLocal_308 = 3;
			}
			break;
		...
		case 3:
			...
			hide_hud_and_radar_this_frame();
			func_20(1);
			iLocal_314 = network_get_local_scene_from_network_id(iLocal_313);
			if (get_synchronized_scene_phase(iLocal_314) > 0.99f)
			{
		...
		case 4:
			...
			func_20(1);
			iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_368, sLocal_369, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_15(iLocal_318))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_368, sLocal_370, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_318), sLocal_372, sLocal_368);
			}
			if (!func_15(iLocal_319))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_368, sLocal_371, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_319), sLocal_373, sLocal_368);
			}
			network_start_synchronised_scene(iLocal_313);
		...
		case 5:
			...
			{
				iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_344, sLocal_345, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_15(iLocal_318))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_344, sLocal_346, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_318), sLocal_348, sLocal_344);
				}
				if (!func_15(iLocal_319))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_344, sLocal_347, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_319), sLocal_349, sLocal_344);
				}
				network_start_synchronised_scene(iLocal_313);
				if (func_55("SA_STRIP_CAM"))
				{
		...
		case 6:
			...
			hide_hud_and_radar_this_frame();
			func_20(1);
			if (!is_synchronized_scene_running(iLocal_313))
			{
				iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, true, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_350, sLocal_351, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_15(iLocal_318))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_350, sLocal_352, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_318), sLocal_354, sLocal_350);
				}
				if (!func_15(iLocal_319))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_350, sLocal_353, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_319), sLocal_355, sLocal_350);
				}
				network_start_synchronised_scene(iLocal_313);
				iLocal_315++;
		...
		case 7:
			...
			{
				if (is_control_just_pressed(2, 223))
				{
					if (func_55("SA_STRIP_MENU"))
					{
						clear_help(true);
		...
		case 8:
			...
			func_20(1);
			iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_356, sLocal_357, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_15(iLocal_318))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_356, sLocal_358, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_318), sLocal_360, sLocal_356);
			}
			if (!func_15(iLocal_319))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_356, sLocal_359, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_319), sLocal_361, sLocal_356);
			}
			network_start_synchronised_scene(iLocal_313);
			iLocal_308 = 9;
			break;
		...
		case 10:
			...
			Global_1835487 = 3;
			iLocal_313 = network_create_synchronised_scene(Local_376, Local_377, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_313, sLocal_362, sLocal_363, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_15(iLocal_318))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_318), iLocal_313, sLocal_362, sLocal_364, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_318), sLocal_366, sLocal_362);
			}
			if (!func_15(iLocal_319))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_319), iLocal_313, sLocal_362, sLocal_365, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_319), sLocal_367, sLocal_362);
			}
			network_start_synchronised_scene(iLocal_313);
			iLocal_308 = 11;
			break;
		...
		case 11:
			...
			func_20(1);
			iLocal_314 = network_get_local_scene_from_network_id(iLocal_313);
			if (get_synchronized_scene_phase(iLocal_314) > 0.5f)
			{
				if (!func_15(iLocal_318))
				{
					if (network_has_control_of_network_id(iLocal_318))
					{
						func_10(&iLocal_318);
					}
				}
				if (!func_15(iLocal_319))
				{
					if (network_has_control_of_network_id(iLocal_319))
					{
						func_10(&iLocal_319);
					}
				}
				...
				stop_rendering_script_cams_using_catch_up(false, 1f, 3, 0);
				func_33(player_id(), 1, 0, 0);
				iLocal_36 = 0;
				iLocal_308 = 0;
			}
			break;
...
void func_2()
{
	...
	if (iVar0 > -1 && iVar0 != func_9())
	{
		...
		while (iVar1 < 29)
		{
			if (Global_1853348[player_id() /*834*/].f_267.f_32 == Global_1853348[iVar0 /*834*/].f_267[iVar1])
			{
				if (func_8(iVar1) != -1)
				{
					if (iVar0 == player_id())
...
void func_24(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_28(player_id())) && !func_26(player_id(), 0)) && !func_25()) && !bParam4) && !bParam5)
			{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_26(player_id(), 0) && !func_29()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_37(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_44()
{
	if (!network_does_network_id_exist(iLocal_318))
	{
		if (func_46(2, 0, 1))
		{
			if (can_register_mission_peds(2))
			{
				if (func_45(&iLocal_318, 5, iLocal_316, Local_378, fLocal_379, 1, 1, 1) && func_45(&iLocal_319, 5, iLocal_317, Local_378, fLocal_379, 1, 1, 1))
				{
					...
					set_model_as_no_longer_needed(iLocal_317);
					iLocal_310 = 0;
				}
			}
		}
...
int func_45(int iParam0, int iParam1, int iParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
int func_57(struct<3> Param0, float fParam1, var uParam2, var uParam3)
{
	if (is_player_playing(player_id()))
	{
		if ((!is_ped_in_any_vehicle(player_ped_id(), false) && !is_entity_on_fire(player_ped_id())) && is_player_control_on(player_id()))
		{
			...
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_61(0)) && !func_60())
				{
					if ((Global_97369 && Global_97370) || func_59())
					{
						return 0;
					}
					if (func_58(get_entity_coords(player_ped_id(), true), Param0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_62()
{
	...
	if (func_63() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_63()) == 0)
		{
			return 1;
		}
	}
...
int func_70()
{
	...
	if (has_model_loaded(iLocal_316) && has_model_loaded(iLocal_317))
	{
		iLocal_310 = 1;
		return 1;
	}
...
int func_71()
{
	request_anim_dict(sLocal_320);
	request_anim_dict(sLocal_326);
	request_anim_dict(sLocal_332);
	request_anim_dict(sLocal_338);
	request_anim_dict(sLocal_344);
	request_anim_dict(sLocal_350);
	request_anim_dict(sLocal_356);
	request_anim_dict(sLocal_362);
	if (((((((!has_anim_dict_loaded(sLocal_320) || !has_anim_dict_loaded(sLocal_326)) || !has_anim_dict_loaded(sLocal_332)) || !has_anim_dict_loaded(sLocal_338)) || !has_anim_dict_loaded(sLocal_344)) || !has_anim_dict_loaded(sLocal_350)) || !has_anim_dict_loaded(sLocal_356)) || !has_anim_dict_loaded(sLocal_362))
	{
		return 0;
	}
	else if (!iLocal_309)
...
void func_90()
{
	...
	if (iLocal_309)
	{
		remove_anim_dict(sLocal_320);
		remove_anim_dict(sLocal_326);
		remove_anim_dict(sLocal_332);
		remove_anim_dict(sLocal_338);
		remove_anim_dict(sLocal_344);
		remove_anim_dict(sLocal_350);
		remove_anim_dict(sLocal_356);
		remove_anim_dict(sLocal_362);
	}
	if (does_cam_exist(iLocal_311))
	{
		destroy_cam(iLocal_311, false);
	}
	func_11();
	if (iLocal_36)
	{
