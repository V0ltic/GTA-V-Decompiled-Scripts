...
void __EntryFunction__()
{
	...
	if (((func_338(10) && _get_number_of_references_of_script_with_name_hash(joaat("tennis")) == 0) || Global_97369) && !ScriptParam_616.f_1)
	{
	...
	while (true)
	{
		...
		if (network_is_in_session() && !ScriptParam_616.f_1)
		{
			func_306(&Var0);
		}
		if (!is_ped_injured(player_ped_id()))
		{
			if (vdist2(get_entity_coords(player_ped_id(), true), Var0.f_189.f_55) < 5625f || ScriptParam_616.f_1)
			{
		...
		if (!is_ped_injured(player_ped_id()))
		{
			if (vdist2(get_entity_coords(player_ped_id(), true), Var0.f_189.f_55) > (fVar2 * fVar2))
			{
				func_306(&Var0);
			}
		}
		if ((func_338(10) && _get_number_of_references_of_script_with_name_hash(joaat("tennis")) == 0) && !ScriptParam_616.f_1)
		{
			func_306(&Var0);
		}
		wait(0);
...
void func_2(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (func_284(uParam0, iVar8, *iParam2, func_305(uParam1)))
	{
		...
		set_entity_coords(uParam0->f_247, func_283(&(uParam0->f_247)), true, false, false, false);
		set_entity_velocity(uParam0->f_247, uParam0->f_247.f_10);
		Var6 = { func_283(&(uParam0->f_247)) };
	}
	...
	switch (func_305(uParam1))
	{
		case 0:
			...
			{
				clear_prints();
				set_entity_coords((uParam0[iParam3 /*94*/])->f_32, func_270(&(uParam0->f_189), func_272(uParam1), uParam0->f_1661, uParam0->f_1658, iParam3 == func_271(uParam1), iParam3), true, true, false, true);
				set_entity_heading(get_player_ped(get_player_index()), get_heading_from_vector_2d((uParam0[iParam3 /*94*/])->f_40, (uParam0[iParam3 /*94*/])->f_40.f_1));
				new_load_scene_start_sphere(uParam0->f_189.f_29, 50f, 0);
				func_269(uParam1, 1);
			}
			break;
		...
		case 4:
			if (func_268(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_266(uParam0[iParam3 /*94*/], create_ped(1, uParam0->f_1669, Var13, get_heading_from_vector_2d(uParam0->f_1658, uParam0->f_1658.f_1), false, false));
					task_stand_still((uParam0[iParam3 /*94*/])->f_32, -1);
					set_entity_heading(func_265(uParam0[iParam3 /*94*/]), (get_heading_from_vector_2d(uParam0->f_1658, uParam0->f_1658.f_1) + 180f));
					Var1 = { func_270(&(uParam0->f_189), func_272(uParam1), uParam0->f_1661, uParam0->f_1658, iParam4 == func_271(uParam1), iParam4) };
					func_266(uParam0[iParam4 /*94*/], create_ped(1, uParam0->f_1668, Var1, get_heading_from_vector_2d(-uParam0->f_1658, -uParam0->f_1658.f_1), false, false));
					task_stand_still((uParam0[iParam4 /*94*/])->f_32, -1);
					set_entity_heading(func_265(uParam0[iParam4 /*94*/]), get_heading_from_vector_2d(-uParam0->f_1658, -uParam0->f_1658.f_1));
					Var1 = { 0f, 0f, 0f };
					func_269(uParam1, 8);
					func_264(uParam1, 0);
					func_263(uParam1, iParam3);
					(uParam0[iParam3 /*94*/])->f_33 = create_object(joaat("prop_tennis_rack_01b"), uParam0->f_189.f_3[3 /*3*/], false, false, false);
					set_entity_visible((uParam0[iParam3 /*94*/])->f_33, false, false);
					(uParam0[iParam4 /*94*/])->f_33 = create_object(joaat("prop_tennis_rack_01b"), uParam0->f_189.f_3[2 /*3*/], false, false, false);
					func_262(uParam0, iParam3, iParam4, 0, 0);
					set_entity_visible((uParam0[iParam4 /*94*/])->f_33, false, false);
					set_entity_visible((uParam0[iParam3 /*94*/])->f_33, true, false);
					_0xB2D0BDE54F0E8E5A((uParam0[iParam3 /*94*/])->f_33, true);
					set_entity_visible((uParam0[iParam4 /*94*/])->f_33, true, false);
					_0xB2D0BDE54F0E8E5A((uParam0[iParam4 /*94*/])->f_33, true);
					func_261(func_265(uParam0[iParam3 /*94*/]), 1);
					func_261(func_265(uParam0[iParam4 /*94*/]), 1);
					if (uParam0->f_189 == 0)
					{
						func_259(uParam0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 0, 0, 0, 0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 2, 0, 0, 0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 3, 0, 0, 0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 4, 0, 0, 0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 5, 0, 0, 0);
						set_ped_component_variation(func_265(uParam0[iParam4 /*94*/]), 7, 0, 0, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			bVar14 = (get_game_timer() > func_254(uParam0[iParam3 /*94*/]) && get_game_timer() > func_254(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (is_entity_playing_anim(func_265(uParam0[func_271(uParam1) /*94*/]), sVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && does_entity_exist(uParam0->f_247))
					{
						fVar19 = get_entity_anim_current_time(func_265(uParam0[func_271(uParam1) /*94*/]), sVar18, "serve");
		...
		case 10:
			...
			if (get_frame_count() > func_105(&(uParam0->f_247)) && func_104(uParam0[(1 - func_271(uParam1)) /*94*/], 256))
			{
		...
		case 12:
			...
			else if (get_frame_count() > func_105(&(uParam0->f_247)) && func_104(uParam0[(1 - func_176(uParam1)) /*94*/], 256))
			{
				func_103(uParam1, func_176(uParam1));
				func_269(uParam1, 14);
				func_102(iParam2);
			...
			{
				task_stand_still(func_265(uParam0[iParam4 /*94*/]), -1);
			}
			break;
		...
		case 14:
			...
			else
			{
				...
				if (func_175(uParam1))
				{
					func_31(uParam0, get_game_timer() + 1500);
				}
		...
		case 20:
			...
			{
				func_23(uParam0, 4);
				func_22(uParam0, get_game_timer() + 580);
			}
			else if (((get_game_timer() > func_21(uParam0) && func_229(uParam0, 4)) && does_entity_exist(uParam0->f_247)) && !is_entity_attached(uParam0->f_247))
			{
				func_267(uParam0, 1);
				func_193(uParam0[func_271(uParam1) /*94*/], &(uParam0->f_247));
				func_287(&(uParam0->f_247), 4);
			}
			if (func_271(uParam1) != iParam3 && get_script_task_status(func_265(uParam0[iParam3 /*94*/]), 242628503) == 7)
			{
				func_232(uParam0->f_1657, 1);
				func_236(uParam0[iParam3 /*94*/], uParam0, func_272(uParam1), iParam3, 0, 0);
...
{
	if (does_entity_exist((uParam0[0 /*94*/])->f_33))
	{
		(uParam0[0 /*94*/])->f_46 = { get_entity_coords((uParam0[0 /*94*/])->f_33, true) };
	}
	if (does_entity_exist((uParam0[1 /*94*/])->f_33))
	{
		(uParam0[1 /*94*/])->f_46 = { get_entity_coords((uParam0[1 /*94*/])->f_33, true) };
	}
}
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	if (!is_ped_injured(iVar0))
	{
		...
		if (iVar6 == 75)
		{
			...
			{
				if (is_entity_playing_anim(iVar0, sVar7, "idle", 3))
				{
					stop_anim_task(iVar0, sVar7, "idle", -8f);
				}
				func_277(uParam0, 32);
			}
			if (!func_104(uParam0, 128) && !func_228(&(uParam0->f_4), 4))
			{
				if (!is_tennis_mode(func_265(uParam0)))
				{
		...
		else if (iVar6 == 74)
		{
			...
			{
				task_play_anim(iVar0, sVar7, sVar5, 8f, -8f, -1, 0, fVar1, false, false, false);
				func_230(uParam0, 7);
			}
			else if (get_entity_anim_current_time(iVar0, sVar7, sVar5) > fVar3)
			{
				stop_anim_task(iVar0, sVar7, sVar5, -8f);
				func_234(uParam0, 75);
			...
			else if (get_entity_anim_current_time(iVar0, sVar7, sVar5) >= fVar2)
			{
				if (!func_104(uParam0, 4))
				{
					func_58(uParam0, 4);
			...
			else if (get_entity_anim_current_time(iVar0, sVar7, sVar5) > fVar4)
			{
				if (func_104(uParam0, 4))
				{
					func_277(uParam0, 4);
...
void func_5(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	if (!func_104(uParam0, 1024))
	{
		...
		if (func_75(uParam0) == 72 || func_75(uParam0) == 73)
		{
			if (func_10(uParam0) != 0)
			{
				...
				play_tennis_dive_anim(iParam1, iVar8, func_9(uParam0), func_8(uParam0), 1f, false);
				func_7(uParam0, get_game_timer() + 2871);
			}
		}
		else
		{
			play_tennis_swing_anim(iParam1, sVar1, &Var2, fVar5, func_6(uParam0), false);
		}
	...
	else if (_0x19BFED045C647C49(iParam1) || get_tennis_swing_anim_complete(iParam1))
	{
...
void func_20(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	{
		if (does_entity_exist(func_265(uParam1)))
		{
			if (is_tennis_mode(func_265(uParam1)))
			{
				set_ped_reset_flag(func_265(uParam1), 69, true);
			}
			set_ped_reset_flag(func_265(uParam1), 102, true);
		}
	}
}
...
int func_25(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	...
	if (!is_ped_injured(iVar1) && get_script_task_status(iVar1, 242628503) != 7)
	{
		if (is_entity_playing_anim(iVar1, "mini@tennis", "idle_2_serve", 3))
		{
		}
		iVar0 = 0;
		if (is_tennis_mode(iVar1))
		{
			func_58(uParam0[iParam1 /*94*/], 16384);
		}
	}
	else if ((!is_ped_injured(iVar1) && (bParam5 || iParam4 == 1)) && !func_104(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam3)
		{
		...
		func_261(iVar1, 1);
		force_ped_ai_and_animation_update(iVar1, false, false);
		func_58(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_104(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam3)
	{
		if (!is_ped_injured(iVar1) && is_task_move_network_active(iVar1))
		{
			if (are_strings_equal(get_task_move_network_state(iVar1), "Intro") && is_task_move_network_ready_for_transition(iVar1))
			{
				request_task_move_network_state_transition(iVar1, "running");
			}
		}
	}
	bVar3 = (((iParam2 != iParam3 && iParam6 >= (func_26(uParam0[iParam2 /*94*/]) - 1)) && iVar0) && 1);
	if (!is_ped_injured(iVar2) && (get_script_task_status(iVar2, 242628503) != 7 && !bVar3))
	{
		if (is_entity_playing_anim(iVar2, "mini@tennis", "idle_2_serve", 3))
		{
		}
		if (is_tennis_mode(iVar2))
		{
			func_58(uParam0[iParam2 /*94*/], 16384);
		}
		iVar0 = 0;
	}
	else if (((!is_ped_injured(iVar2) && ((bParam5 || iParam4 == 4) || iParam4 == 1)) && !func_104(uParam0[iParam2 /*94*/], 8192)) && get_script_task_status(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
		...
		func_261(iVar2, 1);
		force_ped_ai_and_animation_update(iVar2, false, false);
		func_58(uParam0[iParam2 /*94*/], 8192);
	}
	else if (func_104(uParam0[iParam2 /*94*/], 8192) && iParam2 == iParam3)
	{
		if (!is_ped_injured(iVar2) && is_task_move_network_active(iVar2))
		{
			if (are_strings_equal(get_task_move_network_state(iVar2), "Intro") && is_task_move_network_ready_for_transition(iVar2))
			{
				request_task_move_network_state_transition(iVar2, "running");
			}
		}
	}
	return iVar0;
...
{
	if (!((!is_ped_injured(func_265(uParam0)) && is_task_move_network_active(func_265(uParam0))) && are_strings_equal(get_task_move_network_state(func_265(uParam0)), "running")))
	{
		task_move_network_by_name(func_265(uParam0), sParam1, fParam2, false, "mini@tennis", 4);
	}
}
...
void func_53(var uParam0, var uParam1)
{
	...
	{
		if (get_script_task_status(func_265(uParam0), 713668775) != 1 && get_script_task_status(func_265(uParam0), 242628503) != 1)
		{
			Var0 = { uParam0->f_37 - uParam1->f_29 * Vector(0.93f, 0.93f, 0.93f) };
			task_follow_nav_mesh_to_coord(func_265(uParam0), uParam1->f_29 + Var0, 2f, 20000, 0.25f, false, 40000f);
			func_58(uParam0, 2048);
			func_54("FAR_FROM_COURT", -1);
		}
	}
	else if (func_104(uParam0, 2048) && get_script_task_status(func_265(uParam0), 713668775) != 1)
	{
...
void func_57(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		iVar0 = func_50(get_random_float_in_range(0f, 1f) < 0.5f, 0, 3);
...
bool func_76(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	...
	return is_point_in_angled_area(Param0, Param1, Param2, fParam3, false, true);
}
...
void func_78(var uParam0)
{
	if (uParam0->f_20 == 0)
	{
		uParam0->f_24 = get_random_float_in_range(0f, 0.4f);
	}
	else if (uParam0->f_20 == 1)
	{
		uParam0->f_24 = get_random_float_in_range(0f, 0.2f);
	}
	else if (uParam0->f_20 == 2)
	{
		uParam0->f_24 = get_random_float_in_range(0f, 0.01f);
	}
}
...
Vector3 func_82(var uParam0, var uParam1, struct<3> Param2, var uParam3, float fParam4)
{
	...
	while (iVar0 < 75)
	{
		...
		if (bVar8 == bVar9)
		{
			...
			fVar5 = absf(((Var1.f_2 + Var6.f_2) - Param2.f_2));
			if (fVar5 < 0.15f)
			{
				fVar5 = 0f;
			}
...
float func_83(var uParam0, struct<3> Param1, float fParam2, float fParam3)
{
	...
	*fParam3 = vmag(Var0);
	...
	Var1 = { get_entity_velocity(uParam0->f_32) };
...
Vector3 func_87(struct<3> Param0, var uParam1, struct<3> Param2, struct<3> Param3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, var uParam9, float fParam10)
{
	...
	while (iVar2 < 180 && iVar1 < 2)
	{
		...
		{
			*fParam10 = (IntToFloat(iVar2) * get_frame_time());
			return Param2;
		}
...
int func_96(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	Var0 = { func_283(&(uParam1->f_247)) };
	if (absf((Var0.f_2 - uParam0->f_3[0 /*3*/].f_2)) <= 0.6f)
	{
...
int func_97(var uParam0, int iParam1, var uParam2)
{
	...
	if (has_entity_collided_with_anything(*uParam0) || func_288(uParam0, 16))
	{
		iVar0 = get_last_material_hit_by_entity(*uParam0);
		if (iVar0 == 122789469)
		{
		}
...
int func_106(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	bVar6 = (does_entity_exist(uParam1->f_247) && !is_entity_attached(uParam1->f_247));
	...
	if (uParam0->f_31 != 4 && get_game_timer() > func_163(uParam0))
	{
		bVar0 = is_control_pressed(0, 223);
		bVar2 = is_control_pressed(0, 224);
		bVar3 = is_control_pressed(0, 225);
		bVar1 = is_control_pressed(0, 222);
		if (((is_control_just_pressed(0, 223) || is_control_just_pressed(0, 224)) || is_control_just_pressed(0, 225)) || is_control_just_pressed(0, 222))
		{
			if (func_162(uParam0))
			{
				func_58(uParam0, 1);
	...
	else if (get_game_timer() > func_163(uParam0))
	{
	...
	if (((bVar0 || bVar1) || bVar2) || bVar3)
	{
		...
		if (func_153(uParam0))
		{
			set_pad_shake(0, 50, 85);
		}
	}
	else
	{
		if (func_104(uParam0, 4096) && get_game_timer() > func_163(uParam0))
		{
		...
		if (func_152(uParam0, Var11, bVar6))
		{
			...
			if ((iVar4 != 75 && iVar4 != 76) && (uParam0->f_31 == 4 || (uParam0->f_31 != 4 && func_104(uParam0, 512))))
			{
				if (!func_228(&(uParam0->f_4), 8) && !func_228(&(uParam0->f_4), 1))
				{
					...
					func_147(uParam0, get_frame_count() + 2);
					if (uParam0->f_31 == 4)
					{
			...
			else if (iVar4 == 75 && func_144(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				func_138(uParam0, get_game_timer() + 1000);
				if (iVar4 == 75 || fVar5 <= 0f)
				{
					clear_ped_tasks(func_265(uParam0));
...
void func_107(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (does_entity_exist(uParam1->f_247) && is_entity_attached(uParam1->f_247))
	{
		detach_entity(uParam1->f_247, true, true);
	}
...
void func_108(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_44(func_265(uParam0)) == 17 && get_random_float_in_range(0f, 1f) < 0.5f)
	{
	...
	if (bParam2 || bParam3)
	{
		...
		{
			play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_265(uParam0), 0, false, 0);
		}
		else if (func_91(uParam1) == 2)
		{
			play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_BACKSLICE_MASTER", "TENNIS_NPC_SMASH_BACKSLICE_MASTER"), func_265(uParam0), 0, false, 0);
		}
	...
	{
		play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_LOB_MASTER", "TENNIS_NPC_LOB_MASTER"), func_265(uParam0), 0, false, 0);
		iVar0 = 60;
	}
	else
	{
		if (func_91(uParam1) == 0)
		{
			play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_FOREARM_MASTER", "TENNIS_NPC_FOREARM_MASTER"), func_265(uParam0), 0, false, 0);
		}
		else if (func_91(uParam1) == 2)
		{
			play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_BACKSLICE_MASTER", "TENNIS_NPC_BACKSLICE_MASTER"), func_265(uParam0), 0, false, 0);
		}
		else if (func_91(uParam1) == 1)
		{
			play_sound_from_entity(-1, func_194(uParam0->f_31 != 4, "TENNIS_PLYR_TOPSPIN_MASTER", "TENNIS_NPC_TOPSPIN_MASTER"), func_265(uParam0), 0, false, 0);
		}
		iVar0 = 80;
	}
	if (uParam0->f_31 != 4)
	{
		set_pad_shake(0, iVar0, 256);
	}
}
...
{
	if (!is_ped_injured(func_265(uParam0)))
	{
...
void func_113(var uParam0, struct<3> Param1)
{
	...
	if (does_entity_exist(uParam0->f_247))
	{
		...
		Var0 = { get_entity_coords(uParam0->f_247, true) };
		...
		func_118(&(uParam0->f_247), get_frame_count() + 5);
...
void func_114(int iParam0, bool bParam1)
{
	if (does_entity_exist(iParam0))
	{
		if ((is_entity_visible(iParam0) && !bParam1) || (!is_entity_visible(iParam0) && bParam1))
		{
			set_entity_visible(iParam0, bParam1, false);
			_0xB2D0BDE54F0E8E5A(iParam0, bParam1);
		}
	}
}
...
void func_115(var uParam0, bool bParam1)
{
	...
	{
		Var0 = { func_116(bParam1, func_283(uParam0), get_entity_coords(*uParam0, true)) };
	}
	uParam0->f_27 = { Var0 };
	uParam0->f_30 = { Var0 };
	uParam0->f_25 = 0f;
...
Vector3 func_120(var uParam0, var uParam1, int iParam2, int iParam3, struct<3> Param4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	fVar7 = fVar6;
	Var8 = { Param4 };
	Var9 = { _0x21C235BC64831E5A(Var8, uParam1->f_189.f_32[0 /*3*/], uParam1->f_189.f_32[1 /*3*/], false) };
...
Vector3 func_121(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	{
		Var4 = { FtoV(get_random_float_in_range(-1f, 1f)) * uParam0->f_43 };
	...
	{
		fVar5 = get_random_float_in_range(-0.15f, 1.15f);
	...
	else if (uParam0->f_4.f_20 == 2)
	{
		...
		fVar15 = absf((fVar13 - fVar14));
		fVar16 = func_124(0.75f, 0.05f, (fVar15 / 90f));
		fVar17 = get_random_float_in_range(0f, 1f);
...
Vector3 func_123(var uParam0, var uParam1, struct<3> Param2, int iParam3)
{
	...
	{
		fVar6 = func_124(0.4f, 1f, get_random_float_in_range(0f, 1f));
	...
	Var7 = { _0x21C235BC64831E5A(uParam0->f_37, uParam1->f_3[iVar3 /*3*/], uParam1->f_3[iVar4 /*3*/], true) };
	if (absi(iParam3) > 15)
	{
		if (iParam3 > 0)
		{
...
int func_126(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			{
				if (get_random_float_in_range(0f, 1f) < 0.5f)
				{
					return 1;
				}
				else
		...
		case 2:
			if (get_random_float_in_range(0f, 1f) < 0.2f)
			{
...
void func_128(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	{
		fVar0 = get_control_unbound_normal(0, 218);
		fVar1 = get_control_unbound_normal(0, 219);
		fVar2 = get_control_unbound_normal(0, 220);
		fVar3 = get_control_unbound_normal(0, 221);
	}
	else
	{
		fVar0 = get_disabled_control_unbound_normal(0, 218);
		fVar1 = get_disabled_control_unbound_normal(0, 219);
		fVar2 = get_disabled_control_unbound_normal(0, 220);
		fVar3 = get_disabled_control_unbound_normal(0, 221);
	}
...
int func_133(var uParam0, var uParam1, struct<3> Param2, bool bParam3)
{
	...
	if (!is_ped_injured(func_265(uParam0)) && _0xE95B0C7D5BA3B96B(func_265(uParam0)))
	{
		return 0;
	}
	if (func_136(uParam0) > get_frame_count())
	{
		return 0;
	}
	if (!func_104(uParam0, 1024))
	...
	Var8 = { get_ped_bone_coords(func_265(uParam0), 60309, 0f, 0f, 0f) };
	Var9 = { Var0 - Var8 };
	fVar10 = func_69(uParam0->f_43, Var9);
	fVar11 = (absf(fVar5) - absf(fVar10));
	fVar11 = (fVar11 * 0.3f);
	if (!func_134(uParam0->f_33, &Var8, &(uParam0->f_40), &Var0, &(uParam1->f_10)))
	{
		return 0;
	}
	if (absf(fVar5) > (0.65f + fVar11))
	{
		return 0;
	}
	if (fVar6 < -0.9f)
	...
	set_entity_coords(*uParam1, Var0, true, false, false, true);
	return 1;
}
...
int func_134(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (does_entity_exist(iParam0))
	{
		get_entity_matrix(iParam0, &uVar2, &uVar1, &Var3, &Var0);
...
Vector3 func_135(var uParam0)
{
	...
	{
		process_entity_attachments(uParam0->f_33);
		get_entity_matrix(uParam0->f_33, &uVar2, &uVar1, &Var3, &Var0);
		Var0 = { Var0 + Var3 * Vector(0.4f, 0.4f, 0.4f) };
	}
	return Var0;
}
...
void func_137(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, struct<3> Param6, bool bParam7)
{
	...
	if (!func_104(uParam1, 1024))
	{
		...
		play_tennis_swing_anim(iVar1, sVar2, sVar3, 0f, 1f, true);
		func_58(uParam1, 1024);
		func_80(&(uParam1->f_4), 16);
		func_7(uParam1, get_game_timer() + 2442);
		if ((1 && !func_228(&((uParam0[iParam3 /*94*/])->f_4), 256)) && get_game_timer() > func_254(uParam0[iParam3 /*94*/]))
		{
			iParam5 = (1 - iParam5);
			if (bParam7)
			{
...
int func_139(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar0 = 75;
	fVar1 = 1000f;
	_0xF56DFB7B61BE7276(*uParam3, *uParam4, uParam0->f_37, uParam0->f_40, &fVar2);
...
int func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	fVar0 = 0f;
	_0xF56DFB7B61BE7276(*uParam1, *uParam2, uParam0->f_37, uParam0->f_40, &fVar0);
	...
	uVar4 = Var2.f_2;
	Var5 = { fVar3, 0f, uVar4 };
	*fParam7 = _0x7F8F6405F4777AF6(Var5, *uParam5, *uParam3, false);
	*fParam8 = _0x7F8F6405F4777AF6(Var5, func_116(bParam6, *uParam5, *uParam4), func_116(bParam6, *uParam4, *uParam5), false);
...
int func_144(var uParam0, var uParam1, var uParam2, struct<3> Param3, var uParam4)
{
	...
	if (uParam0->f_31 != 4)
	{
		...
		*uParam4 = func_69(uParam0->f_40, func_283(uParam2) - uParam0->f_37);
		...
		if (((!is_control_just_released(0, 223) && !is_control_just_released(0, 224)) && !is_control_just_released(0, 225)) && !is_control_just_released(0, 222))
		{
			return 0;
		}
	}
...
void func_145(var uParam0, var uParam1, var uParam2)
{
	...
	else
	{
		...
		fVar2 = absf((fVar0 - fVar1));
		fVar3 = func_124(0.15f, 0.5f, (fVar2 / 570f));
		fVar4 = get_random_float_in_range(0f, 1f);
		if (fVar4 < fVar3)
		{
			func_230(uParam0, 2);
		}
...
int func_150(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	fVar1 = 0.75f;
	fVar2 = 100f;
	_0xF56DFB7B61BE7276(*(uParam4[0 /*3*/]), *(uParam4[1 /*3*/]), uParam0->f_37, uParam0->f_40, &fVar6);
				...
				if ((uParam3[iVar18 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						...
						else if (iVar18 != 72 && iVar18 != 73)
						{
							...
							{
								iVar33++;
								Var28 = { _0x21C235BC64831E5A(Var27, *(uParam4[(iVar3 - iVar33) /*3*/]), *(uParam4[((iVar3 - iVar33) - 1) /*3*/]), true) };
								Var30 = { Var27 - Var28 };
								fVar31 = func_69(Var30, uParam0->f_40);
							}
							if (absf(fVar31) > 0.3f)
							{
								fVar31 = (fVar31 * (0.3f / absf(fVar31)));
							}
...
{
	uParam0->f_64 = (uParam0->f_64 + get_frame_time());
}

void func_156(var uParam0)
{
	uParam0->f_60 = (uParam0->f_60 + get_frame_time());
}

void func_157(var uParam0)
{
	uParam0->f_61 = (uParam0->f_61 + get_frame_time());
}
...
void func_160(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	*bParam3 = 0;
	...
	{
		case 2:
			if (does_entity_exist(uParam1->f_247) && func_286(&(uParam1->f_247)) > 0)
			{
				fVar0 = get_random_float_in_range(0f, 1f);
...
{
	uParam0->f_68 = (uParam0->f_68 + get_frame_time());
}
...
void func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7)
{
	...
	iVar0 = 0;
	uParam1->f_247.f_33 = (uParam1->f_247.f_33 - get_frame_time());
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_164(uParam0);
				func_172(uParam0, (to_float(iVar0) * get_frame_time()));
			}
		}
		if (!func_171(*uParam2))
		{
...
void func_177(var uParam0, var uParam1, bool bParam2)
{
	if (does_entity_exist(*uParam1))
	{
		if (bParam2)
		{
			if (!is_ped_injured(func_265(uParam0)))
			{
				task_look_at_entity(func_265(uParam0), *uParam1, -1, 6, 2);
			}
		}
		else if (!is_ped_injured(func_265(uParam0)))
		{
			task_clear_look_at(func_265(uParam0));
		}
	}
}
...
int func_181(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (((func_253(uParam0) > func_190(uParam1) && func_75(uParam2) == 75) && uParam0->f_1657 != 1) || (((func_253(uParam0) > func_190(uParam1) && func_75(uParam2) == 75) && uParam0->f_1657 == 1) && is_screen_faded_in()))
		{
			func_234(uParam2, 74);
			func_215(uParam0, 0);
		}
	...
	if (func_104(uParam2, 4))
	{
		...
		{
			iVar7 = get_random_int_in_range(2, 6);
			iVar0 = func_50(get_random_float_in_range(0f, 1f) < 0.2f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			iVar7 = get_random_int_in_range(1, 4);
			iVar0 = func_50(get_random_float_in_range(0f, 1f) < 0.1f, 6, iVar7);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = get_random_int_in_range(0, 2);
		}
		Var5 = { func_122(Var6, Var5, get_random_float_in_range(0f, 1f)) };
		...
		*uParam2 = fVar4;
		...
		if (iVar0 == 1 || iVar0 == 0)
		{
			play_sound_from_entity(-1, func_194(uParam0->f_1657 == 1, "TENNIS_AMB_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_265(uParam2), 0, false, 0);
		}
		else
		{
			play_sound_from_entity(-1, func_194(uParam0->f_1657 == 1, "TENNIS_AMB_SERVE_MASTER", "TENNIS_NPC_SERVE_MASTER"), func_265(uParam2), 0, false, 0);
		}
		detach_entity(uParam0->f_247, false, true);
...
void func_182(var uParam0, var uParam1, var uParam2)
{
	...
	if (does_entity_exist(uParam0->f_247))
	{
		...
		func_276(&(uParam0->f_247), get_entity_coords(uParam0->f_247, true));
		uParam0->f_247.f_16 = { func_283(&(uParam0->f_247)) };
		func_118(&(uParam0->f_247), get_frame_count() + 5);
		func_117(&(uParam0->f_247));
		func_115(&(uParam0->f_247), 1);
...
void func_193(var uParam0, var uParam1)
{
	...
	iVar0 = func_265(uParam0);
	if (does_entity_exist(*uParam1) && does_entity_exist(iVar0))
	{
		attach_entity_to_entity(*uParam1, iVar0, get_ped_bone_index(iVar0, 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
		func_114(*uParam1, 1);
	}
}
...
bool func_195(var uParam0)
{
	...
	if (uParam0->f_59 == 2)
	{
		...
		else if (is_ped_male(iVar0) && iVar1 != 14)
		{
			uParam0->f_59 = 1;
		}
		else
...
int func_199(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4)
{
	...
	if (does_entity_exist(uParam1->f_247))
	{
		func_157(uParam0);
		if ((is_control_just_pressed(0, 223) && !bParam4) || (func_159(uParam0) > 30f && uParam1->f_1657 == 4))
		{
			if ((((func_75(uParam0) == 74 && func_212(&(uParam0->f_73))) && !func_211(&(uParam0->f_73))) && func_210(&(uParam0->f_73)) > (1.1f + 1.25f)) && !func_104(uParam0, 64))
			{
				...
				{
					iVar0 = (round((get_control_normal(2, 239) * 256f)) - 128);
				}
			...
			if (func_104(uParam0, 64))
			{
				if (func_205(uParam0) > 0.965f)
				{
					*uParam3 = { uParam1->f_282[0 /*2*/] };
					play_sound_from_entity(-1, "TENNIS_PLYR_SMASH_MASTER", func_265(uParam0), 0, false, 0);
					set_pad_shake(0, 450, 256);
				...
				else if (func_205(uParam0) > 0.7f)
				{
					*uParam3 = { uParam1->f_282[2 /*2*/] };
					set_pad_shake(0, 200, 256);
					play_sound_from_entity(-1, "TENNIS_PLYR_SERVE_MASTER", func_265(uParam0), 0, false, 0);
				}
				else if (func_205(uParam0) > 0.45f)
				{
					*uParam3 = { uParam1->f_282[3 /*2*/] };
					play_sound_from_entity(-1, "TENNIS_PLYR_SERVE_MASTER", func_265(uParam0), 0, false, 0);
					set_pad_shake(0, 150, 256);
				}
				else if (func_205(uParam0) > 0.2f)
				{
					*uParam3 = { uParam1->f_282[4 /*2*/] };
					play_sound_from_entity(-1, "TENNIS_PLYR_SERVE_MASTER", func_265(uParam0), 0, false, 0);
					set_pad_shake(0, 100, 256);
				}
				else if (func_205(uParam0) >= 0f)
				{
					*uParam3 = { uParam1->f_282[5 /*2*/] };
					play_sound_from_entity(-1, "TENNIS_PLYR_SERVE_MASTER", func_265(uParam0), 0, false, 0);
					set_pad_shake(0, 70, 256);
				}
			}
			else
			{
		...
		if (func_159(uParam0) > 30f || (is_control_just_pressed(0, 223) && !bParam4))
		{
			func_158(uParam0);
		}
	}
...
int func_203(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	Var1 = { 0f, 0f, 0f };
	fVar8 = 1f;
	Var6 = { get_entity_coords(uParam1->f_247, true) };
	if (absi(iParam3) > 125)
	{
		fVar9 = 2.5f;
		fVar10 = 0.5f;
	...
	fVar0 = get_angle_between_2d_vectors(uParam0->f_40, uParam0->f_40.f_1, Var2.f_0, Var2.f_1);
	fVar0 = (fVar0 * fVar8);
	*uParam0 = fVar0;
	if (iParam2 == 0)
	{
...
{
	if (!is_ped_injured(func_265(uParam0[iParam1 /*94*/])) && get_script_task_status(func_265(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	else if ((!is_ped_injured(func_265(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_104(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_27(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
		...
		force_ped_ai_and_animation_update(func_265(uParam0[iParam1 /*94*/]), false, false);
		func_58(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_104(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		if (!is_ped_injured(func_265(uParam0[iParam1 /*94*/])) && is_task_move_network_active(func_265(uParam0[iParam1 /*94*/])))
		{
			if (are_strings_equal(get_task_move_network_state(func_265(uParam0[iParam1 /*94*/])), "Intro") && is_task_move_network_ready_for_transition(func_265(uParam0[iParam1 /*94*/])))
			{
				request_task_move_network_state_transition(func_265(uParam0[iParam1 /*94*/]), "running");
			}
		}
	}
	return 1;
...
void func_218(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if ((uParam0->f_31 != 4 && !is_ped_injured(func_265(uParam0))) && !bParam5)
	{
	...
	if (!is_ped_injured(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam5) && !func_224(player_id(), 0))
		{
			func_223(uParam1, iParam3, 1);
			set_entity_coords(uParam0->f_32, Var1, true, false, false, true);
			fVar0 = get_heading_from_vector_2d(-uParam1->f_1658, -uParam1->f_1658.f_1);
			if (uParam0->f_1 == 0)
			{
				fVar0 = (fVar0 + 180f);
			}
			set_entity_heading(uParam0->f_32, fVar0);
		}
		else
		{
			set_entity_heading(uParam0->f_32, get_entity_heading(uParam0->f_32));
			func_58(uParam0, 16384);
			fVar2 = (get_heading_from_vector_2d(uParam0->f_40, uParam0->f_40.f_1) + func_327(bParam6, 180f, 0f));
			Var3 = { uParam1->f_189.f_29 - get_entity_coords((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_69(Var3, uParam0->f_40) < 0f;
			bVar5 = func_69(Var3, uParam0->f_43) < 0f;
			iVar6 = 0;
			func_222(uParam0, 0);
			clear_sequence_task(&(uParam0->f_54));
			open_sequence_task(&(uParam0->f_54));
			if (!bParam6 && bParam7)
			{
				func_222(uParam0, func_26(uParam0) + 1);
				iVar6 = get_random_int_in_range(800, 1200);
				task_play_anim(0, func_194(func_195(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar6, 0, 0f, false, false, false);
			}
			if (!bParam8)
			{
				task_play_anim(0, "mini@tennis", "ready_2_idle", 1.5f, -8f, -1, 0, 0f, false, false, false);
				func_222(uParam0, func_26(uParam0) + 1);
			}
			if ((bParam6 && !bVar4) || (!bParam6 && bVar4))
			{
				...
				{
					task_go_straight_to_coord(0, Var7, 1f, 20000, 40000f, 0.5f);
				}
				else
				{
					task_follow_nav_mesh_to_coord(0, Var7, 1f, 20000, 0.25f, true, 40000f);
				}
				func_222(uParam0, func_26(uParam0) + 1);
			}
			if (func_219(get_entity_coords(uParam0->f_32, true), Var1, 0.1f))
			{
				task_achieve_heading(0, fVar2, 2500);
				func_222(uParam0, func_26(uParam0) + 1);
			}
			else
			{
				task_follow_nav_mesh_to_coord(0, Var1, 1f, 20000, 0.25f, false, fVar2);
				func_222(uParam0, func_26(uParam0) + 1);
			}
			sVar8 = func_194(func_195(uParam0), "mini@tennis", "mini@tennis@female");
			task_play_anim(0, sVar8, "idle_2_ready", 8f, -8f, -1, 0, 0f, false, false, false);
			func_222(uParam0, func_26(uParam0) + 1);
			close_sequence_task(uParam0->f_54);
			task_perform_sequence(func_265(uParam0), uParam0->f_54);
			set_ped_weapon_movement_clipset(func_265(uParam0), "weapons@tennis@male");
			func_80(&(uParam0->f_4), 4);
		}
	}
	if (bParam4 && does_entity_exist(func_265(uParam0)))
	{
		force_ped_ai_and_animation_update(func_265(uParam0), false, false);
	}
}
...
int func_219(struct<2> Param0, Vector3 vParam1, struct<2> Param2, var uParam3, float fParam4)
{
	...
	if (absf((Param0.f_0 - Param2.f_0)) <= fParam4)
	{
...
void func_227(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if ((uParam0->f_31 != 4 && !is_ped_injured(func_265(uParam0))) && !bParam7)
	{
		func_232(uParam1->f_1657, 1);
	}
	func_234(uParam0, 75);
	...
	if (!is_ped_injured(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam7) && !func_224(player_id(), 0))
		{
			if (!((!is_ped_injured(func_265(uParam0)) && is_task_move_network_active(func_265(uParam0))) && are_strings_equal(get_task_move_network_state(func_265(uParam0)), "running")))
			{
				func_223(uParam1, iParam3, 1);
			}
			set_entity_coords(uParam0->f_32, Var1, true, true, false, true);
			fVar0 = get_heading_from_vector_2d(-uParam1->f_1658, -uParam1->f_1658.f_1);
			if (uParam0->f_1 == 0)
			{
				fVar0 = (fVar0 + 180f);
		...
		else
		{
			set_entity_heading(uParam0->f_32, get_entity_heading(uParam0->f_32));
			func_58(uParam0, 16384);
			fVar2 = (get_heading_from_vector_2d(uParam0->f_40, uParam0->f_40.f_1) + func_327(bParam8, 180f, 0f));
			Var3 = { uParam1->f_189.f_29 - get_entity_coords((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_69(Var3, uParam0->f_40) < 0f;
			bVar5 = func_69(Var3, uParam0->f_43) < 0f;
			func_222(uParam0, 0);
			...
			if ((bParam8 && !bVar4) || (!bParam8 && bVar4))
			{
				...
				if (func_220(uParam1, uParam0))
				{
					task_go_straight_to_coord(0, Var6, 1f, 20000, 40000f, 0.5f);
				}
				else
				{
					task_follow_nav_mesh_to_coord(0, Var6, 1f, 20000, 0.25f, true, 40000f);
				}
				func_222(uParam0, func_26(uParam0) + 1);
			}
			task_follow_nav_mesh_to_coord(0, Var1, 1f, 20000, 0.25f, false, fVar2);
			func_222(uParam0, func_26(uParam0) + 1);
			task_play_anim(0, "mini@tennis", "idle_2_serve", 8f, -8f, -1, 0, 0f, false, false, false);
			func_222(uParam0, func_26(uParam0) + 1);
			close_sequence_task(uParam0->f_54);
			task_perform_sequence(uParam0->f_32, uParam0->f_54);
			set_ped_weapon_movement_clipset(uParam0->f_32, "weapons@tennis@male");
			func_80(&(uParam0->f_4), 4);
		}
	}
	...
	uParam0->f_37 = { get_entity_coords(uParam0->f_32, false) };
}
...
void func_232(int iParam0, bool bParam1)
{
	if (iParam0 != 1)
	{
		if (bParam1)
		{
			if (!is_ped_injured(player_ped_id()) && !is_player_control_on(get_player_index()))
			{
				set_player_control(get_player_index(), true, 0);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && is_player_control_on(get_player_index()))
		{
...
void func_236(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((uParam0->f_31 != 3 && !bParam4) && !is_ped_injured(func_265(uParam0))) && !is_ped_ragdoll(func_265(uParam0)))
	{
		if ((is_tennis_mode(func_265(uParam0)) && !func_195(uParam0)) && !func_104(uParam0, 16384))
		{
			set_ped_weapon_movement_clipset(func_265(uParam0), "TENNIS_LOCOMOTION_FEMALE");
		}
		func_128(&iVar0, &iVar1, &uVar2, &uVar2, 1, 1);
		fVar3 = absf(to_float(iVar0));
		if ((fVar3 > 0f || absf(to_float(iVar1)) > 0f) && uParam0->f_31 != 4)
		{
			set_ped_min_move_blend_ratio(func_265(uParam0), 2f);
		}
		if ((func_75(uParam0) != 74 && uParam0->f_31 != 4) && fVar3 > 15f)
		{
			func_250(uParam0, (func_251(uParam0) + get_frame_time()));
		}
		else
		{
			func_250(uParam0, 0f);
		...
		if (is_tennis_mode(func_265(uParam0)) && fVar5 < 0f)
		{
			fVar6 = func_69(uParam0->f_43, func_283(&(uParam1->f_247)) - uParam0->f_37);
			_0x54F157E0336A3822(func_265(uParam0), "ForcedStopDirection", fVar6);
		}
	}
	else if (uParam0->f_31 != 3)
	{
		...
		if (!is_ped_injured(func_265(uParam0)) && is_task_move_network_active(func_265(uParam0)))
		{
			if (are_strings_equal(get_task_move_network_state(func_265(uParam0)), "Intro") && is_task_move_network_ready_for_transition(func_265(uParam0)))
			{
				request_task_move_network_state_transition(func_265(uParam0), "running");
			}
			...
			if (get_task_move_network_event(func_265(uParam0), "IdleStarted"))
			{
				fVar14 = get_random_float_in_range(0f, 1f);
				StringCopy(&(uParam1->f_1670), func_194(fVar14 < 0.33f, "Idle3", func_194(fVar14 < 0.66f, "Idle4", "Idle1")), 8);
			}
			set_task_move_network_signal_bool(func_265(uParam0), &(uParam1->f_1670), true);
			set_task_move_network_signal_float(func_265(uParam0), "Speed", uParam0->f_62);
		}
	}
	if (((func_75(uParam0) == 75 && does_entity_exist(uParam1->f_247)) && has_entity_collided_with_anything(uParam1->f_247)) && vdist2(uParam0->f_37, func_283(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_58(uParam0, 256);
...
void func_237(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		fVar0 = get_control_normal(0, 30);
		fVar1 = get_control_normal(0, 31);
		fVar2 = get_control_normal(0, 1);
		fVar3 = get_control_normal(0, 2);
	}
	else
	{
		fVar0 = get_disabled_control_normal(0, 30);
		fVar1 = get_disabled_control_normal(0, 31);
		fVar2 = get_disabled_control_normal(0, 1);
		fVar3 = get_disabled_control_normal(0, 2);
	}
	*uParam0 = ((fVar0 + 1f) / 2f);
	*uParam1 = ((fVar1 + 1f) / 2f);
	*uParam2 = ((fVar2 + 1f) / 2f);
...
{
	if ((get_rain_level() <= 0f && get_snow_level() <= 0f) && func_75(uParam0) == 75)
	{
		if (absf(to_float(iParam1)) >= absf(to_float(iParam2)))
		{
			if (iParam1 > 15)
			{
				if (uParam0->f_35 != 3 && get_random_float_in_range(0f, 1f) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				else if (get_random_float_in_range(0f, 1f) < 0.1f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				uParam0->f_35 = 3;
			...
			{
				if (uParam0->f_35 != 2 && get_random_float_in_range(0f, 1f) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				else if (get_random_float_in_range(0f, 1f) < 0.1f)
			...
			{
				if (uParam0->f_35 != 4 && get_random_float_in_range(0f, 1f) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				uParam0->f_35 = 4;
		...
		else if (absf(to_float(iParam1)) < absf(to_float(iParam2)))
		{
			if (iParam2 > 15)
			{
				if (uParam0->f_35 != 1 && get_random_float_in_range(0f, 1f) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				else if (get_random_float_in_range(0f, 1f) < 0.1f)
			...
			{
				if (uParam0->f_35 != 0 && get_random_float_in_range(0f, 1f) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_265(uParam0), 0, false, 0);
				}
				else if (get_random_float_in_range(0f, 1f) < 0.1f)
	...
	switch (func_146(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_75(uParam0) == 75)
			{
				...
				{
					task_go_straight_to_coord(func_265(uParam0), Var1, 2f, -1, 40000f, 0.5f);
				...
				else if ((is_entity_at_coord(uParam0->f_32, func_70(&(uParam0->f_4)), Var2, false, true, 0) || get_script_task_status(func_265(uParam0), 2106541073) == 7) && !func_228(&(uParam0->f_4), 256))
				{
					func_235(&(uParam0->f_4), 0);
					func_217(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				_0xF56DFB7B61BE7276(func_283(uParam4), func_283(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar3);
				...
				if (((!is_ped_injured(func_265(uParam0)) && !vdist2(uParam0->f_37, Var1) <= (0f * 0f)) && !func_228(&(uParam0->f_4), 4)) && !func_104(uParam0, 1024))
				{
					task_go_straight_to_coord(uParam0->f_32, func_70(&(uParam0->f_4)), 2f, -1, 40000f, 0.5f);
					Var1 = { func_70(&(uParam0->f_4)) };
					func_242(&(uParam0->f_4), Var1);
					func_80(&(uParam0->f_4), 4);
				...
				else if (vdist2(uParam0->f_37, Var1) <= (0f * 0f) || get_script_task_status(func_265(uParam0), 2106541073) == 7)
				{
...
{
	uParam0->f_24 = (uParam0->f_24 - get_frame_time());
}
...
void func_245(var uParam0, var uParam1)
{
	...
	if (get_game_timer() > func_247(&(uParam0->f_4)))
	{
		...
		func_246(&(uParam0->f_4), get_game_timer() + 500);
	}
}
...
{
	uParam0->f_63 = (uParam0->f_63 + get_frame_time());
}
...
void func_260(var uParam0, int iParam1)
{
	...
	set_ragdoll_blocking_flags(*uParam0, 16);
...
void func_261(int iParam0, bool bParam1)
{
	...
	if (does_entity_exist(iParam0) && !is_ped_injured(iParam0))
	{
		...
		else if (is_ped_male(iParam0) && iVar0 != 14)
		{
			bVar1 = false;
		}
		else
		...
		enable_tennis_mode(iParam0, bParam1, bVar1);
	}
}

void func_262(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!is_ped_injured(func_265(uParam0[iParam1 /*94*/])) && !is_ped_injured(func_265(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				attach_entity_to_entity((uParam0[iParam1 /*94*/])->f_33, func_265(uParam0[iParam1 /*94*/]), get_ped_bone_index(func_265(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
			}
			attach_entity_to_entity((uParam0[iParam2 /*94*/])->f_33, func_265(uParam0[iParam2 /*94*/]), get_ped_bone_index(func_265(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		}
		else
		{
			if (!bParam4)
			{
				attach_entity_to_entity((uParam0[iParam1 /*94*/])->f_33, func_265(uParam0[iParam1 /*94*/]), get_ped_bone_index(func_265(uParam0[iParam1 /*94*/]), 28422), Local_162, Local_163, false, false, false, false, 2, true, 0);
			}
			attach_entity_to_entity((uParam0[iParam2 /*94*/])->f_33, func_265(uParam0[iParam2 /*94*/]), get_ped_bone_index(func_265(uParam0[iParam2 /*94*/]), 28422), Local_162, Local_163, false, false, false, false, 2, true, 0);
		}
	}
}
...
void func_267(var uParam0, int iParam1)
{
	...
	if (does_entity_exist(uParam0->f_247))
	{
		if (iParam1 || !is_entity_visible(uParam0->f_247))
		{
			delete_object(&(uParam0->f_247));
		}
		else
		{
			set_object_as_no_longer_needed(&(uParam0->f_247));
		}
	}
	Var0 = { uParam0->f_189.f_29 };
	uParam0->f_247 = create_object(joaat("prop_tennis_ball"), Var0, false, false, false);
	_0xB2D0BDE54F0E8E5A(uParam0->f_247, true);
	set_entity_records_collisions(uParam0->f_247, true);
	func_114(uParam0->f_247, 0);
	freeze_entity_position(uParam0->f_247, false);
...
{
	if (!request_script_audio_bank("SCRIPT\Tennis", false, -1))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!request_script_audio_bank("SCRIPT\TENNIS_VER2_A", false, -1))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!has_model_loaded(joaat("prop_tennis_ball")))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!has_model_loaded(uParam0->f_1668))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (uParam0->f_1657 == 1 && !has_model_loaded(uParam0->f_1669))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!has_model_loaded(joaat("prop_tennis_rack_01b")))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!has_anim_dict_loaded("mini@tennis"))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (uParam0->f_1657 == 1)
	{
		if (!has_anim_dict_loaded("mini@tennis@female"))
		{
			if (uParam0->f_1657 != 1)
			{
			}
	...
	if (uParam0->f_1657 != 1)
	{
		if (uParam0->f_1657 != 1 && !has_model_loaded(joaat("prop_vb_34_tencrt_lighting")))
		{
			return 0;
		}
		if (uParam0->f_1657 != 1 && !has_anim_dict_loaded("mini@triathlon"))
		{
		}
	}
	if (!has_anim_dict_loaded("weapons@tennis@male"))
	{
		return 0;
	}
	return 1;
...
void func_273(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!is_ped_injured(func_265(uParam0[iVar0 /*94*/])) && get_script_task_status(func_265(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = get_sequence_progress(func_265(uParam0[iVar0 /*94*/]));
	}
	if (!is_ped_injured(func_265(uParam0[iVar1 /*94*/])) && get_script_task_status(func_265(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
		*uParam3 = get_sequence_progress(func_265(uParam0[iVar1 /*94*/]));
	}
	if (func_104(uParam0[iVar0 /*94*/], 16384) && *uParam2 > 0)
	{
		func_277(uParam0[iVar0 /*94*/], 16384);
		func_261(func_265(uParam0[iVar0 /*94*/]), 0);
		set_ped_weapon_movement_clipset(func_265(uParam0[iVar0 /*94*/]), "weapons@tennis@male");
	}
	if (func_104(uParam0[iVar1 /*94*/], 16384) && *uParam3 > 0)
	{
		func_277(uParam0[iVar1 /*94*/], 16384);
		func_261(func_265(uParam0[iVar1 /*94*/]), 0);
		set_ped_weapon_movement_clipset(func_265(uParam0[iVar1 /*94*/]), "weapons@tennis@male");
	}
}
...
void func_274(var uParam0)
{
	if (func_275(uParam0))
	{
		stop_particle_fx_looped(uParam0->f_23, true);
		func_287(uParam0, 1);
	}
}
...
{
	return does_particle_fx_looped_exist(uParam0->f_23);
}
...
int func_279(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	Var0 = { 0f, 0f, 1f };
	fVar1 = func_327(fParam9 == -1f, get_frame_time(), fParam9);
	iVar2 = 0;
	...
	*uParam4 = (*uParam4 + fVar1);
	...
	draw_debug_line(uParam0->f_29 + Vector(1f, 0f, 0f), uParam0->f_29 + Vector(1f, 0f, 0f) + Var4, 0, 0, 255, 255);
	draw_debug_line(uParam0->f_29 + Vector(1f, 0f, 0f), uParam0->f_29 + Vector(2f, 0f, 0f), 0, 255, 0, 255);
	...
	if (iVar2 == 2)
	{
		if (bParam8)
		{
			play_sound_from_coord(-1, "TENNIS_NET_BALL_MEDIUM_MASTER", *uParam1, 0, false, 0, true);
			Var8 = { *uParam1 + *uParam2 };
			apply_impulse_to_cloth(*uParam1, Var8, 2f);
		}
	...
	else if (iVar2 == 3 && !bParam12)
	{
		if (bParam8)
		{
			play_sound_from_coord(-1, "TENNIS_NET_BALL_SKIM_MASTER", *uParam1, 0, false, 0, true);
			Var12 = { *uParam1 + *uParam2 };
			apply_impulse_to_cloth(*uParam1, Var12, 2f);
		}
		*uParam1 = { Var7 };
	...
	*uParam1 = { *uParam1 + *uParam2 * Vector(fVar1, fVar1, fVar1) };
	...
	{
		_0xF56DFB7B61BE7276(Var13, *uParam1, uParam0->f_29, 0f, 0f, 1f, &fVar14);
		...
		*iParam7++;
		...
		{
			play_sound_from_coord(-1, "TENNIS_CLS_BALL_HARD_MASTER", *uParam1, 0, false, 0, true);
		}
		else if ((bParam8 && *iParam7 > 1) && *iParam7 < 4)
		{
			play_sound_from_coord(-1, "TENNIS_CLS_BALL_MASTER", *uParam1, 0, false, 0, true);
		}
	}
	*uParam2 = { *uParam2 + func_280(*uParam2, fVar1) };
	draw_debug_text("ScriptedMotion", *uParam1, 0, 0, 255, 255);
	return iVar2;
}
...
int func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6)
{
	...
	_0xF56DFB7B61BE7276(*uParam1, *uParam2, uParam0->f_29, *uParam3, &fVar0);
	if (fVar0 >= 0f && fVar0 <= 1f)
	{
		Var1 = { *uParam1 + *uParam2 - *uParam1 * Vector(fVar0, fVar0, fVar0) };
		fVar3 = _0x7F8F6405F4777AF6(Var1, uParam0->f_39[0 /*3*/], uParam0->f_39[1 /*3*/], false);
		fVar4 = _0x7F8F6405F4777AF6(Var1, uParam0->f_39[1 /*3*/], uParam0->f_39[2 /*3*/], false);
...
int func_284(var uParam0, int iParam1, var uParam2, int iParam3)
{
	...
	if (is_entity_attached(uParam0->f_247))
	{
		return 0;
	}
...
void func_291(var uParam0, struct<3> Param1)
{
	...
	if (func_288(uParam0, 1))
	{
		if (!func_275(uParam0))
		{
			uParam0->f_23 = start_particle_fx_looped_at_coord("scr_tennis_ball_trail", Param1, 0f, 0f, 0f, 1f, false, false, false, true);
			get_hud_colour(12, &iVar0, &iVar1, &iVar2, &uVar3);
			set_particle_fx_looped_colour(uParam0->f_23, (to_float(iVar0) / 255f), (to_float(iVar1) / 255f), (to_float(iVar2) / 255f), false);
			uVar3 = uVar3;
		}
		set_particle_fx_looped_offsets(uParam0->f_23, Param1, 0f, 0f, 0f);
	}
}
...
void func_292()
{
	...
	disable_control_action(0, 20, true);
...
{
	uParam0->f_6 = (uParam0->f_6 + get_frame_time());
}
...
int func_303(var uParam0, int iParam1, int iParam2)
{
	...
	if (!is_ped_injured(player_ped_id()) && is_ped_shooting(player_ped_id()))
	{
		if (!is_ped_injured(iVar0))
		{
			task_seek_cover_from_ped(iVar0, player_ped_id(), -1, false);
		}
		if (!is_ped_injured(func_265(uParam0[(1 - iParam1) /*94*/])))
		{
			task_seek_cover_from_ped(func_265(uParam0[(1 - iParam1) /*94*/]), player_ped_id(), -1, false);
		}
		return 1;
	}
	if (is_ped_injured(iVar0))
	...
	if (has_entity_been_damaged_by_any_ped(iVar0))
	{
		return 1;
	}
	if (is_ped_in_melee_combat(iVar0))
	{
		return 1;
	}
	if ((!is_entity_dead(iVar0, false) && !is_entity_dead(player_ped_id(), false)) && has_entity_been_damaged_by_entity(iVar0, player_ped_id(), true))
	{
		return 1;
	}
	...
	if (uParam0->f_1657 != 1 && is_player_wanted_level_greater(player_id(), 0))
	{
	...
	if (has_entity_been_damaged_by_any_ped(iVar1))
	{
		return 1;
	}
	if (is_ped_in_melee_combat(iVar1))
	{
		return 1;
	}
	if ((!is_entity_dead(iVar1, false) && !is_entity_dead(player_ped_id(), false)) && has_entity_been_damaged_by_entity(iVar1, player_ped_id(), true))
	{
		return 1;
	}
	...
	if (uParam0->f_1657 == 1 && (is_entity_touching_entity(player_ped_id(), iVar0) || is_entity_touching_entity(player_ped_id(), iVar1)))
	{
		return 1;
	}
	return 0;
...
void func_306(var uParam0)
{
	if (does_entity_exist((uParam0[0 /*94*/])->f_33))
	{
		detach_entity((uParam0[0 /*94*/])->f_33, true, true);
		set_object_as_no_longer_needed(&((uParam0[0 /*94*/])->f_33));
	}
	if (does_entity_exist(uParam0->f_247))
	{
		detach_entity(uParam0->f_247, true, true);
		set_object_as_no_longer_needed(&(uParam0->f_247));
	}
	if (does_entity_exist((uParam0[1 /*94*/])->f_33))
	{
		detach_entity((uParam0[1 /*94*/])->f_33, true, true);
		set_object_as_no_longer_needed(&((uParam0[1 /*94*/])->f_33));
	}
	set_model_as_no_longer_needed(joaat("prop_tennis_ball"));
	set_model_as_no_longer_needed(uParam0->f_1668);
	set_model_as_no_longer_needed(uParam0->f_1669);
	set_model_as_no_longer_needed(joaat("prop_tennis_rack_01b"));
	...
	if (!is_entity_dead((uParam0[0 /*94*/])->f_32, false) && !is_ped_being_stealth_killed((uParam0[0 /*94*/])->f_32))
	{
		func_223(uParam0, 0, 1);
	}
	if (!is_entity_dead((uParam0[1 /*94*/])->f_32, false) && !is_ped_being_stealth_killed((uParam0[1 /*94*/])->f_32))
	{
...
{
	uParam0->f_1672 = (uParam0->f_1672 + round((get_frame_time() * 1000f)));
}
...
void func_311(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, int iParam7)
{
	...
	func_312(uParam1, func_50(uParam5->f_1, uParam5->f_3, get_random_int_in_range(500, 3000)));
	func_269(uParam1, 4);
	...
	request_model(joaat("prop_tennis_ball"));
	request_model(iParam6);
	request_model(iParam7);
	request_model(joaat("prop_tennis_rack_01b"));
...
var func_326(var uParam0)
{
	...
	fVar0 = 1E+08f;
	bVar3 = is_entity_dead(player_ped_id(), false);
	if (func_224(player_id(), 0))
	{
		bVar3 = is_entity_dead(get_player_ped(network_get_player_index(network_get_host_of_this_script())), false);
	}
	if (!bVar3)
	{
		if (func_224(player_id(), 0))
		{
			Var2 = { get_entity_coords(get_player_ped(network_get_player_index(network_get_host_of_this_script())), true) };
		}
		else
		{
