...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			func_97(func_113(get_this_script_name()));
			func_114(0);
		}
...
void func_9()
{
	...
	{
		set_ped_movement_clipset(iLocal_208, sLocal_277, 0.25f);
	}
}
...
void func_104()
{
	...
	while (!has_anim_dict_loaded(sLocal_277))
	{
		wait(0);
	}
	iLocal_278 = 1;
...
void func_118()
{
	if (iLocal_278 == 1)
	{
		if (has_anim_dict_loaded(sLocal_277))
		{
			remove_anim_dict(sLocal_277);
		}
	}
}
