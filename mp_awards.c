...
void __EntryFunction__()
{
	...
	{
		pause_menu_deactivate_context(995898030);
		pause_menu_deactivate_context(1433313072);
		pause_menu_deactivate_context(1096198329);
		pause_menu_deactivate_context(696733436);
		pause_menu_deactivate_context(831272562);
		pause_menu_deactivate_context(-1871331138);
		pause_menu_deactivate_context(874957556);
		pause_menu_deactivate_context(817402210);
		pause_menu_deactivate_context(337714004);
		pause_menu_deactivate_context(joaat("PageLeft"));
		pause_menu_deactivate_context(joaat("PageRight"));
		pause_menu_deactivate_context(-1770673475);
		pause_menu_set_busy_spinner(false, -1, 0);
		Global_1574599 = 0;
		_0x70F52471E758EBAE(Global_1646672.f_471, Global_1646672.f_472);
	...
	func_135();
	pause_menu_activate_context(874957556);
	...
	switch (iScriptParam_114)
	{
		case 3:
			while (iVar0 == 0)
			{
						...
						else
						{
							switch (Global_1643950.f_7)
							{
								case 0:
									...
									pause_menu_activate_context(817402210);
									pause_menu_deactivate_context(874957556);
									pause_menu_redraw_instructional_buttons(0);
				...
				request_streamed_texture_dict("MPAwards1", false);
				request_streamed_texture_dict("MPAwards2", false);
				request_streamed_texture_dict("MPAwards3", false);
				request_streamed_texture_dict("MPAwards4", false);
				request_streamed_texture_dict("MPAwards5", false);
				request_streamed_texture_dict("MPAwards6", false);
				request_streamed_texture_dict("MPTShirtAwards2", false);
				request_streamed_texture_dict("MPTshirtAwardLTS", false);
				if (!has_additional_text_loaded(8))
				{
					request_additional_text("MPAWD", 8);
				}
	...
	func_1();
	set_scaleform_movie_as_no_longer_needed(&uVar3);
	set_scaleform_movie_as_no_longer_needed(&uVar4);
	release_control_of_frontend();
	Global_1574599 = 0;
	pause_menu_set_busy_spinner(false, -1, 0);
	_0x70F52471E758EBAE(Global_1646672.f_471, Global_1646672.f_472);
...
void func_2(var uParam0, var uParam1, var uParam2)
{
	...
	if ((is_control_pressed(2, 187) || func_12(187, &(Global_1648034.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		set_bit(&(uParam0->f_464), false);
	}
	if ((is_control_pressed(2, 188) || func_12(188, &(Global_1648034.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		set_bit(&(uParam0->f_464), true);
	}
	if (((is_control_pressed(2, 189) || is_control_pressed(2, 241)) || func_12(189, &(Global_1648034.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		set_bit(&(uParam0->f_464), 2);
	}
	if (((is_control_pressed(2, 190) || is_control_pressed(2, 242)) || func_12(190, &(Global_1648034.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		set_bit(&(uParam0->f_464), 3);
	}
	if (BitTest(uParam0->f_464, 1))
	{
		clear_bit(&(uParam0->f_464), 1);
		switch (uParam1->f_7)
		{
			case 0:
	...
	{
		_get_pause_menu_selection(&uVar3, &iVar4);
		switch (uParam1->f_7)
		{
			case 0:
				if (iVar4 == 0 || iVar4 == 1)
				{
					uParam1->f_7 = 1;
					if (_0xC8E1071177A23BE5(&iVar5, &uVar6, &uVar7))
					{
	...
	{
		_get_pause_menu_selection_data(&uVar8, &iVar9, &iVar10);
		iVar11 = iVar9 + 1000;
		if (iVar11 >= 0)
		{
			if (iVar10 == 0)
...
{
	pause_menu_set_busy_spinner(bParam0, 6, 0);
}
...
void func_15(var uParam0)
{
	...
	if (has_additional_text_loaded(8))
	{
		if (((((((has_streamed_texture_dict_loaded("MPAwards1") && has_streamed_texture_dict_loaded("MPAwards2")) && has_streamed_texture_dict_loaded("MPAwards3")) && has_streamed_texture_dict_loaded("MPAwards4")) && has_streamed_texture_dict_loaded("MPAwards5")) && has_streamed_texture_dict_loaded("MPAwards6")) && iVar0) && iVar1)
		{
			iVar4 = 9;
			switch (uParam0->f_6)
			{
				...
				case 6:
					if ((func_122() || func_121()) || is_pc_version())
					{
						iLocal_110 = 1;
						iLocal_111 = 8;
					}
	...
	if (*uParam0 == 0)
	{
		...
		while (iVar0 <= 17)
		{
			if (uParam0->f_1[iVar0] == 1)
			{
				...
				scaleform_movie_method_add_param_int(0);
				scaleform_movie_method_add_param_int(0);
				scaleform_movie_method_add_param_int(uParam0->f_347[iVar0]);
				scaleform_movie_method_add_param_int(1);
				if (uParam0->f_424)
				{
				...
				scaleform_movie_method_add_param_int(uParam0->f_328[iVar0]);
				scaleform_movie_method_add_param_int(uParam0->f_385[iVar0]);
				scaleform_movie_method_add_param_int(uParam0->f_404[iVar0]);
				scaleform_movie_method_add_param_int(-1);
				scaleform_movie_method_add_param_int(-1);
				scaleform_movie_method_add_param_int(-1);
				scaleform_movie_method_add_param_int(uParam0->f_366[iVar0]);
				end_scaleform_movie_method();
			}
			*uParam0 = 1;
			iVar0++;
...
void func_17(var uParam0, int iParam1)
{
	...
	if (uParam0->f_427 == 0)
	{
		if (uParam0->f_426 != -1)
		{
			...
			scaleform_movie_method_add_param_int(0);
			scaleform_movie_method_add_param_int(uParam0->f_426);
			end_scaleform_movie_method();
			uParam0->f_426 = -1;
			uParam0->f_427 = 1;
		}
		...
		if (func_39(uParam0))
		{
			...
			while (iVar0 <= 11)
			{
				...
				if (uParam0->f_1[iVar0] == 1)
				{
					...
					scaleform_movie_method_add_param_int(uParam0->f_428[iVar0]);
					scaleform_movie_method_add_param_int(iVar1);
					if (func_37(&Var3))
					{
					...
					{
						begin_text_command_scaleform_string("HUD_AWDPROG");
						add_text_component_substring_text_label(&Var3);
						end_text_command_scaleform_string();
					}
					...
					{
						begin_text_command_scaleform_string("TIMER_DASHES");
						add_text_component_integer(uParam0->f_221[iVar0]);
						add_text_component_integer(uParam0->f_208[iVar0]);
						end_text_command_scaleform_string();
					}
					if (iVar2 >= 0)
					{
...
void func_30(var uParam0, int iParam1)
{
	...
	if (uParam0->f_458 == 0)
	{
		begin_scaleform_movie_method_on_frontend("SET_COLUMN_HIGHLIGHT");
		scaleform_movie_method_add_param_int(1);
		scaleform_movie_method_add_param_int(uParam0->f_455);
		end_scaleform_movie_method();
		uParam0->f_455 = -1;
		uParam0->f_458 = 1;
	}
...
int func_39(var uParam0)
{
	...
	while (iVar0 <= 11)
	{
		if (uParam0->f_1[iVar0] == 1)
		{
			if (!is_string_null_or_empty(&(uParam0->f_331[iVar0 /*8*/])))
			{
				request_streamed_texture_dict(&(uParam0->f_331[iVar0 /*8*/]), false);
				if (!has_streamed_texture_dict_loaded(&(uParam0->f_331[iVar0 /*8*/])))
				{
					return 0;
				}
			}
...
void func_123(var uParam0, var uParam1)
{
	...
	if (func_131(Global_1646672.f_473[uParam0->f_455]) || func_130(Global_1646672.f_486[uParam0->f_455]))
	{
		...
		{
			set_bit(&(Global_1646672.f_471), bVar2);
		}
		if (bVar3)
		{
			if (!BitTest(Global_1646672.f_472, bVar2))
			{
				set_bit(&(Global_1646672.f_472), bVar2);
			}
		}
	}
	iVar4 = uParam1->f_5 + 1;
