...
void __EntryFunction__()
{
	...
	if (has_force_cleanup_occurred(11))
	{
		...
		{
			if (is_ped_in_group(iLocal_51))
			{
				remove_ped_from_group(iLocal_51);
			}
		}
	...
	{
		if ((get_clock_hours() > 2 && get_clock_hours() < 15) && !is_player_wanted_level_greater(player_id(), 0))
		{
		}
		else
		{
	...
	{
		wait(0);
		if (is_world_point_within_brain_activation_range() || bLocal_80)
		{
			if (!func_149())
			{
				if (func_148())
			...
			switch (iLocal_46)
			{
				...
				case 1:
					...
					if (!iLocal_78)
					{
						...
						func_122();
						func_111();
						if (!is_synchronized_scene_running(iLocal_282))
						{
							func_110();
						}
					}
					else
					{
						...
						if (iLocal_47 == 3)
						{
							if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_67, true) < 100f)
							{
								if (!is_cutscene_active())
								{
									request_cutscene("sdrm_mcs_2", 8);
								}
								if (is_cutscene_active())
								{
									if (can_request_assets_for_cutscene_entity())
									{
										if ((((!is_ped_injured(iLocal_51) && !is_ped_injured(iLocal_53)) && !is_ped_injured(iLocal_52)) && !is_ped_injured(iLocal_54)) && !is_entity_dead(iLocal_96, false))
										{
											set_cutscene_ped_component_variation_from_ped("Groom", iLocal_51, 0);
											set_cutscene_ped_component_variation_from_ped("Groomsman", iLocal_53, 0);
											set_cutscene_ped_component_variation_from_ped("Bride", iLocal_52, 0);
											set_cutscene_ped_component_variation_from_ped("Father_of_the_bride", iLocal_54, 0);
										}
									}
								}
							}
							...
							{
								if (is_ped_in_any_vehicle(iLocal_53, false))
								{
									if (does_blip_exist(iLocal_286))
									{
										remove_blip(&iLocal_286);
										if (does_blip_exist(iLocal_284))
										{
											remove_blip(&iLocal_284);
										}
										if (!does_blip_exist(iLocal_284))
										{
						...
						if (func_3())
						{
							if (!is_ped_injured(iLocal_51))
							{
								task_smart_flee_ped(iLocal_51, player_ped_id(), 1000f, -1, false, false);
							}
							if (!is_ped_injured(iLocal_53))
							{
								task_smart_flee_ped(iLocal_53, player_ped_id(), 1000f, -1, false, false);
							}
							if (!is_ped_injured(iLocal_52))
							{
								task_smart_flee_ped(iLocal_52, player_ped_id(), 1000f, -1, false, false);
							}
							if (!is_ped_injured(iLocal_54))
							{
								task_smart_flee_ped(iLocal_54, player_ped_id(), 1000f, -1, false, false);
							}
							func_2();
						}
					}
...
int func_3()
{
	if (!is_ped_injured(player_ped_id()))
	{
		...
		{
			if (has_entity_been_damaged_by_entity(iLocal_51, player_ped_id(), true) || is_entity_in_water(iLocal_51))
			{
				return 1;
			}
			if (bLocal_80)
	...
	if (!is_entity_dead(iLocal_55, false))
	{
		if ((!is_vehicle_driveable(iLocal_55, false) || is_vehicle_stuck_on_roof(iLocal_55)) || is_entity_in_water(iLocal_55))
		{
			func_27();
		...
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			{
				if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false), iLocal_55))
				{
					func_27();
					if (func_4(&uLocal_100, "stagdau", "stagdwrcar", 4, 0, 0, 0))
					{
	...
	if (!is_ped_injured(iLocal_51))
	{
		if (!is_entity_at_entity(iLocal_51, player_ped_id(), 150f, 150f, 150f, false, true, 0))
		{
			if (!is_entity_dead(iLocal_55, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_55, false))
				{
	...
	if (iLocal_47 >= 1)
	{
		if (bLocal_87)
		{
			...
			else if (has_entity_been_damaged_by_entity(iLocal_53, player_ped_id(), true))
			{
				func_27();
				return 1;
			}
		...
		if (!is_entity_dead(iLocal_55, false))
		{
			if (!is_entity_at_entity(iLocal_55, player_ped_id(), 20f, 20f, 20f, false, true, 0))
			{
				if (!iLocal_90)
				{
					func_27();
			...
			if (!is_entity_at_entity(iLocal_55, player_ped_id(), 150f, 150f, 150f, false, true, 0))
			{
				return 1;
			}
		}
	...
	if (iLocal_47 == 3)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			if (is_ped_injured(iLocal_52) || is_ped_injured(iLocal_54))
			{
				return 1;
			}
			else if (has_entity_been_damaged_by_entity(iLocal_52, player_ped_id(), true) || has_entity_been_damaged_by_entity(iLocal_54, player_ped_id(), true))
			{
				return 1;
			}
		}
		if (!is_ped_injured(iLocal_53))
		{
			if (!is_entity_at_entity(iLocal_53, player_ped_id(), 20f, 20f, 20f, false, true, 0) && iLocal_274)
			{
				if (!iLocal_91)
				{
					func_27();
			...
			if (!is_entity_at_entity(iLocal_53, player_ped_id(), 150f, 150f, 150f, false, true, 0))
			{
				return 1;
			}
		}
...
int func_29(struct<3> Param0, bool bParam1)
{
	...
	set_blip_scale(iVar0, func_30(network_is_game_in_progress(), 1f, 1f));
	...
	switch (iLocal_95)
	{
		...
		case 2:
			if ((((!is_ped_injured(iLocal_51) && !is_ped_injured(iLocal_53)) && !is_ped_injured(iLocal_52)) && !is_ped_injured(iLocal_54)) && !is_entity_dead(iLocal_96, false))
			{
				if (func_57())
				{
					register_entity_for_cutscene(iLocal_96, "SDRM_Car", 0, 0, 0);
					register_entity_for_cutscene(iLocal_51, "Groom", 0, 0, 0);
					register_entity_for_cutscene(iLocal_53, "Groomsman", 0, 0, 0);
					register_entity_for_cutscene(iLocal_52, "Bride", 0, 0, 0);
					register_entity_for_cutscene(iLocal_54, "Father_of_the_bride", 0, 0, 0);
					start_cutscene(4);
					iLocal_95++;
				}
			}
		...
		case 3:
			...
			{
				if (!is_entity_dead(iLocal_96, false))
				{
					set_vehicle_on_ground_properly(iLocal_96, 5f);
					set_vehicle_doors_shut(iLocal_96, true);
					display_hud(true);
					display_radar(true);
		...
		case 4:
			...
			delete_ped(&iLocal_53);
			delete_ped(&iLocal_52);
			delete_ped(&iLocal_54);
...
void func_39()
{
	...
	{
		func_41(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_40() == 2 == 0 && !network_is_game_in_progress())
			{
...
void func_58(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_62(player_id())) && !func_60(player_id(), 0)) && !func_59()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_62(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_67()
{
	if (!is_entity_dead(iLocal_55, false) && !is_entity_dead(iLocal_51, false))
	{
		if (!iLocal_81)
		{
			if (is_ped_in_vehicle(player_ped_id(), iLocal_55, false) && is_ped_in_vehicle(iLocal_51, iLocal_55, false))
			{
				iLocal_81 = 1;
				if (does_blip_exist(iLocal_283))
				{
					remove_blip(&iLocal_283);
				}
		...
		if (!iLocal_81 && !iLocal_83)
		{
			if (is_ped_in_vehicle(player_ped_id(), iLocal_55, false))
			{
				if (!is_ped_in_vehicle(iLocal_51, iLocal_55, false))
				{
					if (!func_71())
					{
					}
					...
					if (!does_blip_exist(iLocal_283))
					{
						...
						set_blip_as_friendly(iLocal_283, true);
					}
					iLocal_81 = 0;
					iLocal_83 = 1;
				}
...
int func_69(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_30(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
void func_72()
{
	if (does_entity_exist(iLocal_51))
	{
		if (!is_ped_injured(iLocal_51))
		{
			if (is_entity_at_entity(iLocal_51, player_ped_id(), 4f, 4f, 4f, false, true, 0))
			{
				if ((!is_ped_in_any_vehicle(player_ped_id(), false) && !is_ped_in_any_vehicle(iLocal_51, false)) || is_ped_in_any_taxi(player_ped_id()))
				{
					if (does_blip_exist(iLocal_285))
					{
						remove_blip(&iLocal_285);
						if (!does_blip_exist(iLocal_284))
						{
							iLocal_284 = func_29(Local_59, 1);
						}
				...
				else if (is_ped_in_any_vehicle(player_ped_id(), false) && is_ped_in_any_vehicle(iLocal_51, false))
				{
					if (does_blip_exist(iLocal_285))
					{
						remove_blip(&iLocal_285);
				...
				else if (does_blip_exist(iLocal_284))
				{
					remove_blip(&iLocal_284);
					if (!does_blip_exist(iLocal_285))
					{
			...
			if (!is_ped_in_group(iLocal_51))
			{
				if (!is_entity_at_entity(player_ped_id(), iLocal_51, 10f, 10f, 10f, false, true, 0))
				{
					clear_ped_tasks(iLocal_51);
					set_ped_as_group_member(iLocal_51, func_73());
					set_ped_never_leaves_group(iLocal_51, true);
					set_ped_group_member_passenger_index(iLocal_51, 0);
				}
	...
	if (!is_ped_injured(iLocal_51))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), true))
		{
			if (!func_77())
			{
				...
				if (get_script_task_status(iLocal_51, 1227113341) != 1 && get_script_task_status(iLocal_51, 1227113341) != 0)
				{
					task_go_to_entity(iLocal_51, player_ped_id(), -1, 6f, 2f, 2f, 0);
				}
				if (is_ped_in_any_vehicle(iLocal_51, false))
				{
					task_leave_any_vehicle(iLocal_51, 0, 0);
				}
				if (!iLocal_89)
				{
					if (!func_71())
			...
			{
				iLocal_89 = 0;
				if (((get_script_task_status(iLocal_51, 1227113341) == 1 || get_script_task_status(iLocal_51, 1227113341) == 0) || get_script_task_status(iLocal_51, 242628503) == 1) || get_script_task_status(iLocal_51, 242628503) == 0)
				{
					clear_ped_tasks(iLocal_51);
					if (!is_ped_in_group(iLocal_51))
					{
		...
		else if (((!is_ped_in_group(iLocal_51) && !is_ped_in_any_vehicle(iLocal_51, false)) && get_script_task_status(iLocal_51, 242628503) != 1) && get_script_task_status(iLocal_51, 242628503) != 0)
		{
			set_ped_as_group_member(iLocal_51, func_73());
			set_ped_never_leaves_group(iLocal_51, true);
			set_ped_group_member_passenger_index(iLocal_51, 0);
...
int func_76()
{
	if (is_ped_in_any_vehicle(player_ped_id(), true))
	{
		...
		{
			if ((is_this_model_a_bicycle(get_entity_model(get_vehicle_ped_is_in(player_ped_id(), true))) || is_this_model_a_bike(get_entity_model(get_vehicle_ped_is_in(player_ped_id(), true)))) || is_this_model_a_quadbike(get_entity_model(get_vehicle_ped_is_in(player_ped_id(), true))))
			{
				return 1;
			}
		}
...
int func_77()
{
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (((((!is_ped_in_any_boat(player_ped_id()) && !is_ped_in_any_heli(player_ped_id())) && !is_ped_in_any_plane(player_ped_id())) && !is_ped_in_any_sub(player_ped_id())) && !is_ped_in_any_train(player_ped_id())) && !is_ped_in_model(player_ped_id(), joaat("rhino")))
			{
				if (get_vehicle_max_number_of_passengers(get_vehicle_ped_is_in(player_ped_id(), false)) >= 1)
				{
					return 1;
				}
			}
...
void func_78(int iParam0, bool bParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		if (bParam1)
		{
			if (is_ped_sitting_in_any_vehicle(player_ped_id()) && is_ped_sitting_in_any_vehicle(iParam0))
			{
				if (get_vehicle_ped_is_in(player_ped_id(), false) == get_vehicle_ped_is_in(iParam0, false))
				{
					bVar0 = true;
				}
			}
		...
		if (!is_ped_headtracking_entity(iParam0, player_ped_id()))
		{
			if (!bVar0)
			{
				task_look_at_entity(iParam0, player_ped_id(), -1, 2049, 2);
			}
		}
		else if (bVar0)
		{
			if (!is_ped_in_current_conversation(iParam0))
			{
...
void func_79()
{
	if (does_entity_exist(iLocal_51))
	{
		if (!is_entity_dead(iLocal_51, false) && !is_entity_dead(player_ped_id(), false))
		{
			...
			if (func_93("stagd_chape_3"))
			{
				...
				if (!is_ped_injured(iLocal_51))
				{
					if (is_ped_in_any_vehicle(iLocal_51, false))
					{
						...
						task_use_mobile_phone_timed(0, 30600);
						close_sequence_task(iLocal_77);
						task_perform_sequence(iLocal_51, iLocal_77);
						clear_sequence_task(&iLocal_77);
					}
				}
			}
			if (is_entity_at_entity(player_ped_id(), iLocal_51, 13.5f, 13.5f, 13.5f, false, true, 0) && is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (is_ped_in_vehicle(iLocal_51, get_vehicle_ped_is_in(player_ped_id(), false), false))
				{
					if (iLocal_47 == 0)
					{
						if (timerb() > 5000)
					...
					if (!bLocal_88)
					{
						...
						if (!is_entity_at_coord(player_ped_id(), Local_67, 150f, 150f, 150f, false, true, 0))
						{
							if (iLocal_267 == 0)
							{
...
void func_95()
{
	...
	if (does_entity_exist(iLocal_51))
	{
		if (!is_entity_dead(iLocal_51, false))
		{
			if (!is_ped_injured(iLocal_51))
			{
				if (!iLocal_93 && bLocal_82)
				{
					...
					if (iVar0 != 0)
					{
						...
						if (iVar1 != 4)
						{
							...
							disable_control_action(0, 273, true);
							disable_control_action(0, 4, true);
							disable_control_action(0, 270, true);
							disable_control_action(0, 5, true);
							disable_control_action(0, 1, true);
							disable_control_action(0, 271, true);
							disable_control_action(0, 6, true);
							disable_control_action(0, 2, true);
							disable_control_action(0, 272, true);
							disable_control_action(0, 3, true);
						}
					}
					if (is_entity_in_angled_area(iLocal_51, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, false, true, 0) || timera() > 5000)
					{
						iLocal_93 = 1;
						settimera(0);
						func_58(1, 1, 1, 0, 0, 0, 0);
						...
						request_vehicle_asset(joaat("superd"), 3);
						while (!has_vehicle_asset_loaded(joaat("superd")))
						{
							wait(0);
						}
						iLocal_98 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -2014.228f, 456.4961f, 103.5524f, -6.509435f, -0.037031f, -95.98762f, 29.00143f, false, 2);
						iLocal_99 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -2014.334f, 456.418f, 103.3152f, -6.198685f, -0.037031f, -100.5736f, 29.00143f, false, 2);
						shake_cam(iLocal_98, "HAND_SHAKE", 0.25f);
						shake_cam(iLocal_99, "HAND_SHAKE", 0.25f);
						set_cam_active(iLocal_98, true);
						render_script_cams(true, false, 3000, true, false, 0);
						wait(1000);
						set_cam_active_with_interp(iLocal_99, iLocal_98, 4000, 1, 1);
						render_script_cams(true, false, 3000, true, false, 0);
						clear_area_of_vehicles(Local_71, 10f, false, false, false, false, false, false, 0);
						if (!is_entity_dead(get_players_last_vehicle(), false))
						{
							request_vehicle_high_detail_model(get_players_last_vehicle());
							if (is_entity_at_coord(get_players_last_vehicle(), Local_71, 8f, 8f, 8f, false, true, 0))
							{
								iLocal_97 = get_players_last_vehicle();
								set_entity_as_mission_entity(iLocal_97, true, false);
								delete_vehicle(&iLocal_97);
							}
						}
						if (!is_entity_dead(iLocal_55, false))
						{
				...
				if (iLocal_93 && does_cam_exist(iLocal_98))
				{
					if (timera() > 5700 && !iLocal_281)
					{
						if ((is_ped_on_foot(player_ped_id()) && get_follow_ped_cam_view_mode() == 4) || (is_ped_in_any_vehicle(player_ped_id(), false) && get_follow_vehicle_cam_view_mode() == 4))
						{
					...
					if (timera() > 6000)
					{
						...
						display_radar(true);
						func_58(0, 1, 1, 0, 0, 0, 0);
						set_cam_active(iLocal_98, false);
						render_script_cams(false, false, 3000, true, false, 0);
						destroy_cam(iLocal_98, false);
						stop_gameplay_hint(false);
					}
				}
				if (is_entity_at_coord(player_ped_id(), -2201.417f, 4296.06f, 47.5076f, 100f, 100f, 100f, false, true, 0))
				{
					clear_area_of_vehicles(Local_67, 5f, false, false, false, false, false, false, 0);
				}
			}
			if (!bLocal_87)
			{
				if (is_entity_at_coord(player_ped_id(), Local_73, 100f, 100f, 100f, false, true, 0))
				{
					request_model(joaat("ig_bestmen"));
					if (has_model_loaded(joaat("ig_bestmen")))
					{
						iLocal_53 = create_ped(4, joaat("ig_bestmen"), -2202.747f, 4299.008f, 47.4293f, 73.0028f, true, true);
						func_96(&uLocal_100, 4, iLocal_53, "BESTMAN", 0, 1);
						set_ped_component_variation(iLocal_53, 0, 0, 0, 0);
						set_ped_relationship_group_hash(iLocal_53, joaat("player"));
						set_blocking_of_non_temporary_events(iLocal_53, true);
						set_ped_config_flag(iLocal_53, 185, true);
						open_sequence_task(&iLocal_77);
						task_turn_ped_to_face_entity(0, player_ped_id(), -1);
						task_look_at_entity(0, player_ped_id(), -1, 2048, 2);
						close_sequence_task(iLocal_77);
						task_perform_sequence(iLocal_53, iLocal_77);
						clear_sequence_task(&iLocal_77);
						bLocal_87 = true;
					}
				}
			...
			if (!bLocal_88)
			{
				if (is_entity_at_coord(player_ped_id(), Local_63, 20f, 20f, 20f, false, true, 0))
				{
					func_27();
					if (!func_71())
					{
			...
			if (((is_entity_in_angled_area(player_ped_id(), Local_60, Local_61, fLocal_62, false, true, 0) && is_entity_in_angled_area(iLocal_51, Local_60, Local_61, fLocal_62, false, true, 0)) || (is_entity_at_coord(iLocal_51, Local_59, 0f, 0f, 2f, true, true, 0) && func_66(1, 0, 1))) || bLocal_82)
			{
				switch (iLocal_47)
				{
					case 0:
						...
						if (!bLocal_82)
						{
							...
							if (is_ped_in_any_vehicle(player_ped_id(), false))
							{
								if (!is_entity_dead(get_players_last_vehicle(), false))
								{
									bring_vehicle_to_halt(get_players_last_vehicle(), 10.5f, 4, false);
								}
							}
							if (!is_entity_dead(iLocal_55, false))
							{
								iVar2 = _get_cam_active_view_mode_context();
								if (iVar2 != 0)
								{
									iVar3 = get_cam_view_mode_for_context(iVar2);
									if (iVar3 == 4)
									{
										task_look_at_entity(player_ped_id(), iLocal_51, 5000, 0, 2);
									}
									else
									{
										task_look_at_entity(player_ped_id(), iLocal_55, 5000, 2052, 4);
										set_gameplay_vehicle_hint(iLocal_55, 0f, 0f, 0f, true, -1, 3000, 2000);
									}
								}
							}
							func_27();
							if (!func_71())
							{
								...
								if (!is_ped_injured(iLocal_51))
								{
									clear_ped_tasks(iLocal_51);
									open_sequence_task(&iLocal_77);
									task_follow_nav_mesh_to_coord(0, -2013.094f, 460.3515f, 101.8024f, 2f, 20000, 0.25f, false, 40000f);
									task_follow_nav_mesh_to_coord(0, Local_71, 3f, 20000, 0.25f, false, 40000f);
									task_turn_ped_to_face_entity(0, player_ped_id(), -1);
									task_look_at_entity(0, player_ped_id(), -1, 2048, 2);
									close_sequence_task(iLocal_77);
									task_perform_sequence(iLocal_51, iLocal_77);
									clear_sequence_task(&iLocal_77);
									set_ped_keep_task(iLocal_51, true);
								}
								bLocal_82 = true;
								settimera(0);
							}
						}
						if (!is_ped_injured(iLocal_51) && !is_entity_dead(iLocal_55, false))
						{
							if ((bLocal_82 && is_entity_at_coord(iLocal_51, Local_71, 1f, 1f, 1f, false, true, 0)) && !is_ped_in_any_vehicle(iLocal_51, false))
							{
								if (is_ped_in_group(iLocal_51))
								{
									if (!func_71())
								...
								if (is_entity_occluded(iLocal_51))
								{
									if (!is_ped_injured(iLocal_51))
									{
										set_entity_visible(iLocal_51, false, false);
										set_entity_collision(iLocal_51, false, false);
										set_entity_invincible(iLocal_51, true);
									...
									if (timera() > 15000)
									{
										if (!is_ped_injured(iLocal_51))
										{
											set_ped_component_variation(iLocal_51, 2, 1, 0, 0);
											set_ped_component_variation(iLocal_51, 0, 0, 1, 0);
											set_ped_component_variation(iLocal_51, 3, 1, 0, 0);
											set_ped_component_variation(iLocal_51, 4, 1, 0, 0);
											set_ped_component_variation(iLocal_51, 11, 0, 0, 0);
											set_entity_visible(iLocal_51, true, false);
											set_entity_collision(iLocal_51, true, false);
											set_entity_invincible(iLocal_51, false);
											freeze_entity_position(iLocal_51, false);
											set_entity_coords(iLocal_51, Local_71, true, false, false, true);
											set_entity_heading(iLocal_51, 106.5078f);
											set_ped_group_member_passenger_index(iLocal_51, 0);
											set_ped_combat_attributes(iLocal_51, 17, true);
											set_ped_stay_in_vehicle_when_jacked(iLocal_51, true);
											task_look_at_entity(player_ped_id(), iLocal_51, -1, 2048, 4);
											if (!is_entity_dead(iLocal_55, false))
											{
												open_sequence_task(&iLocal_77);
												task_look_at_entity(0, player_ped_id(), -1, 2052, 4);
												task_enter_vehicle(0, iLocal_55, -1, 0, 2f, 1, 0);
												close_sequence_task(iLocal_77);
												task_perform_sequence(iLocal_51, iLocal_77);
												clear_sequence_task(&iLocal_77);
											}
					...
					case 1:
						if (!is_ped_injured(iLocal_51) && !is_entity_dead(iLocal_55, false))
						{
							if (is_entity_at_entity(iLocal_51, iLocal_55, 5f, 5f, 5f, false, true, 0) && !iLocal_92)
							{
							...
							if (is_ped_in_any_vehicle(iLocal_51, false))
							{
								...
								else
								{
									...
									if (iLocal_272 != 0 && get_game_timer() > iLocal_272 + 6000)
									{
					...
					case 2:
							...
							if (func_4(&uLocal_100, "stagdau", "stagd_hairc", 4, 0, 0, 0))
							{
								if (is_ped_in_any_vehicle(player_ped_id(), false))
								{
									if (!is_entity_dead(get_players_last_vehicle(), false))
									{
										...
										bring_vehicle_to_halt(get_players_last_vehicle(), 10.5f, 2, false);
									}
								}
								if (!is_ped_injured(iLocal_53) && !is_ped_injured(iLocal_51))
								{
									if (is_ped_in_any_vehicle(iLocal_51, false))
									{
										iLocal_96 = get_vehicle_ped_is_in(iLocal_51, false);
										open_sequence_task(&iLocal_77);
										task_enter_vehicle(0, iLocal_96, -1, 2, 1f, 1, 0);
										task_clear_look_at(0);
										close_sequence_task(iLocal_77);
										task_perform_sequence(iLocal_53, iLocal_77);
										set_ped_config_flag(iLocal_53, 185, false);
									}
									else
									{
										task_go_to_entity(iLocal_53, iLocal_51, -1, 8f, 2f, 2f, 0);
									}
									if (!does_blip_exist(iLocal_286))
									{
						...
						if (bLocal_82 && !is_ped_injured(iLocal_51))
						{
							if (get_script_task_status(iLocal_51, 242628503) == 7 || timera() > 12000)
							{
								Local_59 = { Local_63 };
								Local_60 = { Local_64 };
								Local_61 = { Local_65 };
								fLocal_62 = fLocal_66;
								request_model(joaat("ig_bride"));
								request_model(joaat("washington"));
								...
								{
									iLocal_52 = create_ped(5, joaat("ig_bride"), -330.36f, 6154.03f, 30.8f, 90f, true, true);
									set_blocking_of_non_temporary_events(iLocal_52, true);
									open_sequence_task(&iLocal_77);
									task_turn_ped_to_face_entity(0, player_ped_id(), -1);
									close_sequence_task(iLocal_77);
									task_perform_sequence(iLocal_52, iLocal_77);
									clear_sequence_task(&iLocal_77);
									iLocal_54 = create_ped(4, joaat("ig_bestmen"), -333.3692f, 6157.644f, 30.489f, 83.2763f, true, true);
									set_blocking_of_non_temporary_events(iLocal_54, true);
									task_turn_ped_to_face_entity(iLocal_54, player_ped_id(), -1);
									set_ped_component_variation(iLocal_54, 0, 1, 0, 0);
									iLocal_56[0] = create_vehicle(joaat("washington"), -342.1295f, 6141.404f, 30.4839f, 133.4604f, true, true, false);
									iLocal_56[1] = create_vehicle(joaat("baller2"), -338.3777f, 6137.41f, 30.476f, 135.6866f, true, true, false);
									iLocal_56[2] = create_vehicle(joaat("primo"), -329.4687f, 6143.247f, 30.4893f, 313.82f, true, true, false);
									iLocal_56[3] = create_vehicle(joaat("washington"), -322.3235f, 6135.427f, 30.4924f, 316.5898f, true, true, false);
									set_vehicle_colours(iLocal_56[0], get_random_int_in_range(0, 127), 0);
									set_vehicle_colours(iLocal_56[1], get_random_int_in_range(0, 127), 0);
									set_vehicle_colours(iLocal_56[2], get_random_int_in_range(0, 127), 0);
									set_vehicle_colours(iLocal_56[3], get_random_int_in_range(0, 127), 0);
									iLocal_47 = 3;
									bLocal_82 = false;
									iLocal_94 = 0;
								}
		...
		else if (is_entity_dead(iLocal_51, false))
		{
			func_183();
		}
	}
...
void func_97()
{
	if ((iLocal_274 && iLocal_271 != func_80(func_81())) && !does_cam_exist(iLocal_98))
	{
	...
	if (iLocal_271 == func_80(func_81()))
	{
		...
		if (!func_71())
		{
			...
			if (!is_ped_injured(iLocal_51))
			{
				task_use_mobile_phone(iLocal_51, 1, 1);
			}
			if (!is_ped_injured(iLocal_52))
			{
				task_smart_flee_ped(iLocal_52, player_ped_id(), 300f, -1, false, false);
			}
			if (!is_ped_injured(iLocal_54))
			{
				task_smart_flee_ped(iLocal_54, player_ped_id(), 300f, -1, false, false);
			}
			wait(8500);
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (!is_entity_dead(get_players_last_vehicle(), false))
				{
					bring_vehicle_to_halt(get_players_last_vehicle(), 10.5f, 3, false);
				}
			}
			wait(2000);
			if (!is_entity_dead(iLocal_51, false))
			{
				clear_ped_tasks(iLocal_51);
				task_look_at_entity(player_ped_id(), iLocal_51, 5000, 2048, 2);
				task_look_at_entity(iLocal_51, player_ped_id(), 5000, 2048, 2);
				task_leave_any_vehicle(iLocal_51, 0, 0);
				remove_ped_from_group(iLocal_51);
			}
			...
			{
				task_look_at_entity(player_ped_id(), iLocal_51, 5000, 0, 2);
				task_leave_any_vehicle(iLocal_53, 500, 0);
			}
			wait(1000);
			if (!is_entity_dead(iLocal_55, false))
			{
			...
			if (!is_entity_dead(iLocal_51, false) && !is_entity_dead(get_players_last_vehicle(), false))
			{
				open_sequence_task(&iLocal_77);
				if (get_players_last_vehicle() == iLocal_55)
				{
					task_enter_vehicle(0, iLocal_55, -1, -1, 1f, 8, 0);
					task_vehicle_mission_ped_target(0, iLocal_55, player_ped_id(), 8, 15f, 786469, 10f, 10f, true);
				}
				else
				{
...
void func_105()
{
	if (!is_ped_injured(iLocal_51))
	{
		if (!is_entity_dead(iLocal_55, false) && is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (is_ped_in_vehicle(iLocal_51, iLocal_55, false) && has_entity_collided_with_anything(iLocal_55))
			{
				if (!func_71())
				{
					if (func_106())
			...
			else if (is_ped_in_vehicle(iLocal_51, get_vehicle_ped_is_in(player_ped_id(), false), false) && has_entity_collided_with_anything(get_vehicle_ped_is_in(player_ped_id(), false)))
			{
				if (!func_71())
				{
					func_4(&uLocal_100, "stagdau", "stagd_bump1", 4, 0, 0, 0);
...
void func_107()
{
	if (!is_ped_injured(iLocal_51))
	{
		set_ped_can_play_ambient_base_anims(iLocal_51, false);
	}
	if (!is_ped_injured(iLocal_53))
	{
		set_ped_can_play_ambient_base_anims(iLocal_53, false);
	}
	if (((((is_entity_at_entity(iLocal_51, player_ped_id(), 4f, 4f, 4f, false, true, 0) || iLocal_47 == 1) || iLocal_90) || iLocal_91) || iLocal_89) || bLocal_82)
	{
		if ((((((iLocal_47 >= 2 && iLocal_84) && iLocal_47 != 1) && !iLocal_90) && !iLocal_91) && !iLocal_89) && !bLocal_82)
		{
			if (is_entity_at_entity(iLocal_53, player_ped_id(), 4f, 4f, 4f, false, true, 0))
			{
				if (func_109())
				{
					func_108(0);
...
void func_110()
{
	...
	else
	{
		if (!is_ped_injured(iLocal_51))
		{
			...
			{
				detach_entity(iLocal_58, true, true);
			}
		}
		while (func_71())
		{
...
void func_111()
{
	if (!is_ped_injured(player_ped_id()) && !is_ped_injured(iLocal_51))
	{
		if (!iLocal_79)
		{
			if ((is_entity_at_entity(player_ped_id(), iLocal_51, 130f, 60f, 50f, false, true, 0) && !is_entity_occluded(iLocal_51)) || is_entity_at_entity(player_ped_id(), iLocal_51, 10f, 10f, 10f, false, true, 0))
			{
				if (!does_blip_exist(iLocal_285))
				{
					iLocal_285 = func_70(iLocal_51, 0, 145);
					show_height_on_blip(iLocal_285, false);
					task_look_at_entity(iLocal_51, player_ped_id(), -1, 2052, 4);
				}
				if (is_entity_at_entity(player_ped_id(), iLocal_51, 10f, 10f, 10f, false, true, 0))
				{
					if (does_blip_exist(iLocal_285))
					{
						show_height_on_blip(iLocal_285, true);
					}
					settimerb(0);
					func_98();
					while (func_71())
			...
			if (!is_ped_injured(player_ped_id()) && !is_ped_injured(iLocal_51))
			{
				if ((!func_149() && is_entity_in_angled_area(player_ped_id(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, false, true, 0)) && does_blip_exist(iLocal_285))
				{
					if (!func_71())
					{
					...
					if (!is_entity_dead(get_players_last_vehicle(), false))
					{
						iLocal_57 = get_players_last_vehicle();
					}
					func_112(1);
				}
			}
		...
		else if (!iLocal_265)
		{
			if (!is_ped_injured(iLocal_51))
			{
				if (!is_entity_at_entity(player_ped_id(), iLocal_51, 25f, 25f, 25f, false, true, 0))
				{
					func_27();
					wait(0);
...
int func_116()
{
	switch (func_117(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
void func_122()
{
	if (does_entity_exist(iLocal_51))
	{
		if (!is_ped_injured(iLocal_51))
		{
			if (is_explosion_in_sphere(-1, get_entity_coords(iLocal_51, true), 3f))
			{
				clear_ped_tasks_immediately(iLocal_51);
				set_entity_health(iLocal_51, 99, 0);
			}
			if (!is_entity_dead(get_players_last_vehicle(), false))
			{
				if (get_entity_speed(get_players_last_vehicle()) < 3f)
				{
					freeze_entity_position(iLocal_51, true);
				}
				else
				{
					freeze_entity_position(iLocal_51, false);
					if (is_entity_touching_entity(get_players_last_vehicle(), iLocal_51))
					{
						clear_ped_tasks_immediately(iLocal_51);
						set_entity_health(iLocal_51, 99, 0);
					}
			...
			if (is_entity_at_entity(player_ped_id(), iLocal_51, 2f, 2f, 2f, false, true, 0))
			{
				if (!is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_66(1, 0, 1))
					{
						if (!iLocal_275)
						{
							...
							if (!is_ped_injured(iLocal_51))
							{
								clear_area(get_entity_coords(iLocal_51, true), 5f, true, false, false, false);
								remove_particle_fx_in_range(get_entity_coords(player_ped_id(), true), 5f);
							}
							if (!is_entity_dead(get_players_last_vehicle(), false))
							{
								if (is_entity_at_entity(get_players_last_vehicle(), iLocal_51, 5f, 5f, 5f, false, true, 0))
								{
									set_entity_coords(get_players_last_vehicle(), get_entity_coords(iLocal_51, true) - Vector(1.5f, 4f, 3f), true, false, false, true);
									set_vehicle_on_ground_properly(get_players_last_vehicle(), 5f);
								}
							}
							if (!is_ped_injured(iLocal_51))
							{
								iLocal_282 = create_synchronized_scene(-935.57f, 2767.616f, 24.448f, 2.433f, 0.152f, 53.743f, 2);
								iLocal_98 = create_cam("DEFAULT_ANIMATED_CAMERA", false);
								set_synchronized_scene_phase(iLocal_282, 0.158f);
								play_synchronized_cam_anim(iLocal_98, iLocal_282, "untie_cam", "re@stag_do@");
								clear_ped_tasks_immediately(player_ped_id());
								clear_ped_tasks_immediately(iLocal_51);
								task_synchronized_scene(iLocal_51, iLocal_282, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1000f, 0);
								force_ped_ai_and_animation_update(iLocal_51, false, false);
								task_synchronized_scene(player_ped_id(), iLocal_282, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1000f, 0);
	...
	if (iLocal_275 && !iLocal_276)
	{
		if (!iLocal_280)
		{
			if (get_synchronized_scene_phase(iLocal_282) > 0.2f && get_synchronized_scene_phase(iLocal_282) < 0.3f)
			{
				play_sound_from_entity(-1, "ROPE_CUT", player_ped_id(), "ROPE_CUT_SOUNDSET", false, 0);
				iLocal_280 = 1;
			}
		}
		if (get_synchronized_scene_phase(iLocal_282) > 0.4647059f && !iLocal_281)
		{
		...
		if (get_synchronized_scene_phase(iLocal_282) > 0.5f)
		{
			iLocal_276 = 1;
		}
		if (func_123(1000))
	...
	if (iLocal_276 && !iLocal_278)
	{
		...
		clear_ped_tasks_immediately(player_ped_id());
		set_entity_coords(player_ped_id(), -936.6537f, 2767.497f, 24.4289f, true, false, false, true);
		set_entity_heading(player_ped_id(), 208.4017f);
		force_ped_ai_and_animation_update(player_ped_id(), false, false);
		set_cam_active(iLocal_98, false);
		render_script_cams(false, false, 3000, true, false, 0);
		destroy_cam(iLocal_98, false);
		...
		if (!is_ped_injured(iLocal_51))
		{
			freeze_entity_position(iLocal_51, false);
			clear_ped_tasks_immediately(iLocal_51);
			set_ped_can_ragdoll(iLocal_51, true);
			set_entity_coords(iLocal_51, -935.6716f, 2767.772f, 24.4289f, true, false, false, true);
			set_entity_heading(iLocal_51, 136.9073f);
			force_ped_ai_and_animation_update(iLocal_51, false, false);
		}
		if (iLocal_279)
		{
	...
	if (iLocal_278 && !is_ped_injured(iLocal_51))
	{
		if (is_vehicle_driveable(get_players_last_vehicle(), false))
		{
			if ((((((is_entity_at_entity(iLocal_51, get_players_last_vehicle(), 20f, 20f, 20f, false, true, 0) && get_vehicle_max_number_of_passengers(get_players_last_vehicle()) >= 1) && !is_this_model_a_boat(get_entity_model(get_players_last_vehicle()))) && !is_this_model_a_heli(get_entity_model(get_players_last_vehicle()))) && !is_this_model_a_plane(get_entity_model(get_players_last_vehicle()))) && !is_this_model_a_train(get_entity_model(get_players_last_vehicle()))) && get_entity_model(get_players_last_vehicle()) != joaat("rhino"))
			{
				open_sequence_task(&iLocal_77);
				task_look_at_entity(0, player_ped_id(), 10000, 2048, 3);
				task_turn_ped_to_face_entity(0, player_ped_id(), 6500);
				task_enter_vehicle(0, get_players_last_vehicle(), -1, 0, 1f, 1, 0);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_51, iLocal_77);
				clear_sequence_task(&iLocal_77);
			}
			else if (!is_ped_in_group(iLocal_51))
			{
				set_ped_as_group_member(iLocal_51, func_73());
				set_ped_never_leaves_group(iLocal_51, true);
				set_ped_group_member_passenger_index(iLocal_51, 0);
		...
		set_blocking_of_non_temporary_events(iLocal_51, false);
		set_player_control(player_id(), true, 0);
		iLocal_284 = func_29(Local_59, 1);
		iLocal_78 = 1;
		bLocal_80 = true;
...
void func_125()
{
	if (!is_ped_injured(iLocal_51))
	{
		...
		iLocal_97 = get_random_vehicle_in_sphere(get_entity_coords(iLocal_51, false), 30f, 0, 4);
		if (!is_entity_dead(iLocal_97, false))
		{
			if (!is_vehicle_seat_free(iLocal_97, -1, false))
			{
				if (is_entity_at_entity(iLocal_97, iLocal_51, 30f, 30f, 30f, false, true, 0))
				{
					set_entity_as_mission_entity(iLocal_97, true, false);
					if (is_vehicle_driveable(iLocal_97, false))
					{
						start_vehicle_horn(iLocal_97, 3000, 0, false);
						if (!is_ped_injured(iLocal_51))
						{
...
void func_127()
{
	...
	func_128(43, 1);
	func_128(44, 1);
	request_model(joaat("u_m_y_staggrm_01"));
	request_model(joaat("superd"));
	request_model(joaat("prop_stag_do_rope"));
	while ((!has_model_loaded(joaat("u_m_y_staggrm_01")) || !has_model_loaded(joaat("superd"))) || !has_model_loaded(joaat("prop_stag_do_rope")))
	{
		wait(0);
	}
	request_anim_dict("re@stag_do@");
	request_anim_dict("re@stag_do@idle_a");
	request_script_audio_bank("ROPE_CUT", false, -1);
	while ((!has_anim_dict_loaded("re@stag_do@") || !has_anim_dict_loaded("re@stag_do@idle_a")) || !request_script_audio_bank("ROPE_CUT", false, -1))
	{
		wait(0);
	}
	iLocal_51 = create_ped(26, joaat("u_m_y_staggrm_01"), -935.57f, 2767.616f, 24.448f, 140.5f, true, true);
	set_ambient_voice_name(iLocal_51, "GROOM");
	set_ped_relationship_group_hash(iLocal_51, joaat("player"));
	set_blocking_of_non_temporary_events(iLocal_51, true);
	set_ped_money(iLocal_51, 0);
	set_ped_component_variation(iLocal_51, 2, 0, 0, 0);
	set_ped_component_variation(iLocal_51, 0, 0, 0, 0);
	set_ped_component_variation(iLocal_51, 3, 0, 0, 0);
	set_ped_component_variation(iLocal_51, 4, 0, 0, 0);
	set_ped_component_variation(iLocal_51, 11, 1, 0, 0);
	task_set_decision_maker(iLocal_51, joaat("empty"));
	set_ped_combat_movement(iLocal_51, 3);
	set_ped_config_flag(iLocal_51, 206, true);
	set_ped_config_flag(iLocal_51, 134, true);
	iLocal_58 = create_object(joaat("prop_stag_do_rope"), get_entity_coords(iLocal_51, true), true, true, false);
	attach_entity_to_entity(iLocal_58, iLocal_51, get_ped_bone_index(iLocal_51, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	iLocal_55 = create_vehicle(joaat("superd"), -2009.015f, 455.3556f, 101.6528f, 274.8103f, false, false, false);
	set_vehicle_has_strong_axles(iLocal_55, true);
	set_vehicle_dirt_level(iLocal_55, 0f);
	set_vehicle_doors_locked(iLocal_55, 3);
	set_vehicle_mod_kit(iLocal_55, 0);
	set_vehicle_mod_color_1(iLocal_55, 0, 73, 0);
	set_vehicle_mod_color_2(iLocal_55, 2, 48);
	set_vehicle_mod(iLocal_55, 11, 1, false);
	set_vehicle_mod(iLocal_55, 12, 1, false);
	request_vehicle_asset(joaat("superd"), 3);
	set_entity_lod_dist(iLocal_55, 10000);
	set_vehicle_lod_multiplier(iLocal_55, 5f);
	add_vehicle_upsidedown_check(iLocal_55);
	...
	Local_61 = { Local_70 };
	fLocal_62 = fLocal_72;
	set_vehicle_model_is_suppressed(joaat("superd"), true);
	set_all_vehicle_generators_active_in_area(Local_67 - Vector(10f, 10f, 10f), Local_67 + Vector(10f, 10f, 10f), false, true);
	add_scenario_blocking_area(Local_67 - Vector(20f, 20f, 20f), Local_67 + Vector(20f, 20f, 20f), false, true, true, true);
	add_scenario_blocking_area(get_entity_coords(iLocal_51, false) - Vector(10f, 10f, 10f), get_entity_coords(iLocal_51, false) + Vector(10f, 10f, 10f), false, true, true, true);
	add_scenario_blocking_area(Vector(101.6406f, 455.1994f, -2007.751f) - Vector(15f, 15f, 15f), Vector(101.6406f, 455.1994f, -2007.751f) + Vector(15f, 15f, 15f), false, true, true, true);
	add_scenario_blocking_area(Vector(47.4293f, 4299.008f, -2202.747f) - Vector(15f, 25f, 25f), Vector(47.4293f, 4299.008f, -2202.747f) + Vector(15f, 25f, 25f), false, true, true, true);
	clear_area_of_peds(get_entity_coords(iLocal_51, true), 10f, 0);
	if (!is_entity_dead(iLocal_51, false))
	{
		open_sequence_task(&iLocal_77);
		task_play_anim(0, "re@stag_do@idle_a", "idle_a_ped", 8f, -8f, -1, 9, 0f, false, false, false);
		close_sequence_task(iLocal_77);
		task_perform_sequence(iLocal_51, iLocal_77);
		clear_sequence_task(&iLocal_77);
		set_ped_keep_task(iLocal_51, true);
	...
	if (func_16() == 0)
	{
		func_96(&uLocal_100, 0, player_ped_id(), "MICHAEL", 0, 1);
	}
	if (func_16() == 1)
	{
		func_96(&uLocal_100, 0, player_ped_id(), "FRANKLIN", 0, 1);
	}
	if (func_16() == 2)
	{
		func_96(&uLocal_100, 0, player_ped_id(), "TREVOR", 0, 1);
	}
...
int func_136()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_147())
		{
			return 0;
		}
	}
...
int func_149()
{
	if ((Global_113375 == func_54() && get_random_event_flag()) && Global_113376)
	{
		return 1;
	}
	return 0;
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_174()) || Global_31962) || func_173()) || func_24(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_174()) || Global_112433) || Global_31962) || func_173()) || func_24(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_174()) || Global_112433) || Global_31962) || func_173()) || func_24(8, -1)) || func_172()) || func_171()) || func_169()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_174() || get_player_wanted_level(player_id()) > 0) || func_24(8, -1)) || func_169()) || func_168()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_174()) || func_171()) || Global_112433) || Global_31962) || func_173()) || Global_44238) || func_24(8, -1)) || func_170()) || func_168()) || func_169()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_183()
{
	...
	{
		func_221(0);
		set_all_vehicle_generators_active_in_area(Local_67 - Vector(10f, 10f, 10f), Local_67 + Vector(10f, 10f, 10f), true, true);
		remove_scenario_blocking_areas();
		func_27();
		reset_wanted_level_difficulty(player_id());
		if (!is_entity_dead(iLocal_57, false))
		{
			if (!is_ped_in_vehicle(player_ped_id(), iLocal_57, false) && !is_entity_at_entity(player_ped_id(), iLocal_57, 50f, 50f, 50f, false, true, 0))
			{
				func_195(iLocal_57, 0, 145);
			}
		}
		if (is_entity_at_coord(player_ped_id(), Local_67, 100f, 100f, 100f, false, true, 0))
		{
			if (!is_ped_injured(iLocal_51) && !is_ped_injured(iLocal_53))
			{
				open_sequence_task(&iLocal_77);
				task_follow_nav_mesh_to_coord(0, -330.36f, 6154.03f, 31.8f, 1f, -1, 0.25f, false, 40000f);
				task_chat_to_ped(0, iLocal_53, 16, 0f, 0f, 0f, 0f, 0f);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_51, iLocal_77);
				clear_sequence_task(&iLocal_77);
				open_sequence_task(&iLocal_77);
				task_follow_nav_mesh_to_coord(0, -330.36f, 6155.03f, 31.8f, 1f, -1, 0.25f, false, 40000f);
				task_chat_to_ped(0, iLocal_51, 16, 0f, 0f, 0f, 0f, 0f);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_53, iLocal_77);
				clear_sequence_task(&iLocal_77);
			}
		...
		set_vehicle_as_no_longer_needed(&iLocal_97);
		set_vehicle_as_no_longer_needed(&iLocal_55);
		...
		if (!is_ped_injured(iLocal_51))
		{
			set_ped_config_flag(iLocal_51, 317, true);
			if (!is_entity_attached(iLocal_51))
			{
				freeze_entity_position(iLocal_51, false);
			}
			remove_ped_from_group(iLocal_51);
		...
		else if (does_entity_exist(iLocal_58))
		{
			detach_entity(iLocal_58, true, true);
		}
		set_ped_as_no_longer_needed(&iLocal_51);
		if (!is_ped_injured(iLocal_53))
		{
			set_ped_config_flag(iLocal_53, 317, true);
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_198(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_219(iParam0, 0, 0)) || func_219(iParam0, 1, 0)) || func_219(iParam0, 2, 0)) || func_218(iParam0) != 145) || func_217(iParam0)) || func_216(iParam0)) || func_215(iParam0)) || func_214(iParam0)) || !func_203(get_entity_model(iParam0)))
	{
		if (func_216(iParam0))
		{
		}
...
int func_204(int iParam0, bool bParam1)
{
	...
	{
		if ((func_209() || is_pc_version()) || func_208())
		{
		}
		else if (!func_211())
		{
