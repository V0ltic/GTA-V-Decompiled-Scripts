...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			...
			{
				set_bit(&uLocal_49, 15);
				clear_help(true);
			}
		}
		else if ((is_help_message_being_displayed() && !Global_112026) && !BitTest(uLocal_49, 15))
		{
			set_bit(&uLocal_49, 15);
			clear_help(true);
		}
...
void func_4(bool bParam0)
{
	...
	clear_bit(&(uLocal_47[func_5(bParam0)]), bVar0);
}
...
void func_7()
{
	if (((BitTest(uLocal_49, 0) && !BitTest(uLocal_49, 1)) && !BitTest(uLocal_49, 14)) && func_13())
	{
		...
		if (iLocal_78 != -1)
		{
			if ((get_game_timer() - iLocal_78) < 200)
			{
				iLocal_43 = func_8();
			}
			else
...
int func_8()
{
	...
	else if (has_scaleform_movie_loaded(Global_20247) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while ((!is_scaleform_movie_method_return_value_ready(iVar0) && iVar6 == 0) && has_scaleform_movie_loaded(Global_20247) == 1)
				{
					wait(0);
				...
				iVar1 = get_scaleform_movie_method_return_value_int(iVar0);
				...
				iVar3 = iVar2;
				if (has_scaleform_movie_loaded(Global_20247) == 0)
				{
					iVar3 = 145;
				}
				if (iVar6 == 1)
...
void func_16(int iParam0)
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_110(1);
				iLocal_74 = request_scaleform_movie("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
				iLocal_75 = get_game_timer() + 3000;
			...
			case 1:
				...
				{
					if (has_scaleform_movie_loaded(iLocal_74))
					{
						begin_scaleform_movie_method(iLocal_74, "SHOW_MISSION_PASSED_MESSAGE");
						func_92("M_FB4P3_P");
						func_92("M_FB4P3");
						...
						iLocal_75 = get_game_timer() + 10000;
						func_90(0);
						iLocal_41 = 2;
					}
				}
			...
			case 2:
				if (has_scaleform_movie_loaded(iLocal_74) && is_mission_complete_ready_for_ui())
				{
					if (get_game_timer() < iLocal_75)
					{
						draw_scaleform_movie(iLocal_74, 0.5f, 0.3f, 1f, 1f, 255, 255, 255, 255, 0);
					}
					else if (get_game_timer() < iLocal_75 + 100)
					{
						begin_scaleform_movie_method(iLocal_74, "TRANSITION_OUT");
						end_scaleform_movie_method();
						iLocal_75 = (iLocal_75 - 100);
					}
					else if (get_game_timer() < iLocal_75 + 500)
					{
						draw_scaleform_movie(iLocal_74, 0.5f, 0.3f, 1f, 1f, 255, 255, 255, 255, 0);
					}
					else
			...
			case 3:
				...
				{
					set_vehicle_doors_locked(iLocal_51, 1);
				}
...
void func_17()
{
	...
	if (!BitTest(uLocal_49, 2))
	{
		...
		{
			if (func_78(player_ped_id(), Local_52, 100f, 1) && !func_77())
			{
				if (func_87(func_76(25)))
				{
					iLocal_51 = func_76(25);
					set_entity_as_mission_entity(iLocal_51, true, true);
					if (func_87(iLocal_51))
					{
						if (!decor_exist_on(iLocal_51, "GetawayVehicleValid"))
						{
							if (decor_set_bool(iLocal_51, "GetawayVehicleValid", true))
							{
							}
						}
						set_bit(&uLocal_49, false);
						set_bit(&uLocal_49, 2);
					}
				}
			...
			{
				if (!func_78(player_ped_id(), Local_52, 100f, 1))
				{
				}
			}
		}
			...
			if (!func_78(player_ped_id(), Local_52, 100f, 1))
			{
				if (func_87(iLocal_51))
				{
					if (!is_ped_in_vehicle(player_ped_id(), iLocal_51, false))
					{
						...
						clear_bit(&uLocal_49, 2);
						set_vehicle_has_been_driven_flag(iLocal_51, false);
						func_20(&iLocal_51);
						clear_bit(&uLocal_49, false);
					}
					else
					{
						func_70(0);
...
void func_18()
{
	if (BitTest(uLocal_49, 2) && BitTest(uLocal_49, 0))
	{
		if (func_87(iLocal_51))
		{
			if (func_19(player_ped_id(), iLocal_51, 10f, 1))
			{
				if (vdist2(get_entity_coords(iLocal_51, true), Local_52) >= 100f)
				{
					func_70(0);
				}
			}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_41(iParam0, 0, 0)) || func_41(iParam0, 1, 0)) || func_41(iParam0, 2, 0)) || func_63(iParam0) != 145) || func_40(iParam0)) || func_39(iParam0)) || func_38(iParam0)) || func_37(iParam0)) || !func_25(get_entity_model(iParam0)))
	{
		if (func_39(iParam0))
		{
		}
...
int func_26(int iParam0, bool bParam1)
{
	...
	{
		if ((func_31() || is_pc_version()) || func_30())
		{
		}
		else if (!func_33())
		{
...
var func_43()
{
	...
	func_53(&uVar0, get_clock_seconds());
	func_52(&uVar0, get_clock_minutes());
	func_51(&uVar0, get_clock_hours());
	func_46(&uVar0, get_clock_day_of_month());
	func_45(&uVar0, get_clock_month());
	func_44(&uVar0, get_clock_year());
	return uVar0;
}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_65(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_70(bool bParam0)
{
	if (BitTest(uLocal_49, 14))
	{
		...
		iLocal_40 = 0;
		iLocal_41 = 0;
		clear_bit(&uLocal_49, 6);
		clear_bit(&uLocal_49, 7);
		clear_bit(&uLocal_49, false);
		clear_bit(&uLocal_49, true);
		clear_bit(&uLocal_49, 8);
		clear_bit(&uLocal_49, 12);
		clear_bit(&uLocal_49, 2);
		clear_bit(&uLocal_49, 14);
		if (iLocal_37 == 4)
		{
			if (has_scaleform_movie_loaded(iLocal_74))
			{
...
void func_71(int iParam0)
{
	...
	set_bit(&(uLocal_47[func_5(iParam0)]), bVar0);
}
...
bool func_78(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
void func_94()
{
	...
	if (iLocal_42 == 0)
	{
		stat_set_int(joaat("fl_co_fb4p3"), Global_113386.f_10016.f_21, true);
		if (func_103())
		{
			...
			case 1:
				if (iLocal_42 != 2)
				{
					if (!is_string_null_or_empty(&Var0))
					{
						...
						else if (BitTest(uLocal_49, 10) && get_current_scripted_conversation_line() == 0)
						{
							func_129("LOCAUD", Local_44.f_7);
							func_128(1);
							iLocal_40 = 2;
...
void func_133()
{
	...
	else if (func_137() == -1)
	{
		...
		{
			if (!func_78(player_ped_id(), Local_50, 5f, 1))
			{
				if (func_135())
				{
...
bool func_134()
{
	return is_thread_active(Global_113386.f_18103.f_395);
}
...
void func_138()
{
	...
	{
		if (func_78(player_ped_id(), Local_52, 60f, 1))
		{
			if (func_87(func_76(25)))
			{
				if (vdist2(get_entity_coords(func_76(25), true), Local_52) >= 100f)
				{
					func_70(0);
				}
			}
...
void func_141()
{
	...
	if (func_172())
	{
		if (func_142(&iVar0))
		{
			...
			if (func_87(iLocal_51))
			{
				set_vehicle_doors_locked(iLocal_51, 2);
			}
			func_80(iVar0, 0);
		}
	}
...
int func_143()
{
	...
	{
		iLocal_40 = 1;
		func_144(192, get_entity_coords(player_ped_id(), true));
		return 1;
	}
	return 0;
}
...
int func_148()
{
	...
	if (player_id() == func_151())
	{
		return 0;
	}
	if (func_149(player_id()))
	{
		return 0;
	}
...
void func_162(bool bParam0, var uParam1)
{
	...
	func_163(&uLocal_80, Local_44.f_0, player_ped_id(), Local_44.f_1, 0, 1);
...
{
	Local_44.f_6 = get_name_of_zone(get_entity_coords(player_ped_id(), true));
	func_170(iParam0);
}
...
void func_173()
{
	if (!BitTest(uLocal_49, 6))
	{
		if (func_87(iLocal_51))
		{
			Local_52 = { get_entity_coords(iLocal_51, true) };
			fLocal_53 = get_entity_heading(iLocal_51);
			set_bit(&uLocal_49, 6);
			set_bit(&uLocal_49, 2);
...
int func_174(int iParam0)
{
	...
	{
		if (decor_set_bool(iParam0, "IgnoredByQuickSave", true))
		{
			return 1;
		}
	}
		...
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1) && BitTest(uLocal_49, 0))
			{
				if (!func_78(player_ped_id(), Local_50, 5f, 1))
				{
					...
					{
						if ((func_252(player_ped_id()) && !BitTest(uLocal_47[0], 17)) && !BitTest(uLocal_47[1], 18))
						{
							if (is_ped_stopped(player_ped_id()))
							{
								...
								if (BitTest(uLocal_49, 0))
								{
									if (!func_207() && func_187(get_entity_coords(iLocal_51, true)))
									{
										if (func_184(iLocal_51))
										{
											if (func_183(iLocal_51))
											{
												set_bit(&uLocal_49, true);
												if (func_72(player_ped_id()) == 0)
												{
													func_71(7);
													func_1(7, 1);
												...
												Local_50 = { get_entity_coords(player_ped_id(), true) };
												return;
											}
										}
									}
					...
					{
						if ((is_ped_stopped(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), false)) && !BitTest(uLocal_49, 20))
						{
							if (iLocal_245 != -1)
							{
								if ((get_game_timer() - iLocal_245) > 1000)
								{
									set_bit(&uLocal_49, 20);
								}
							}
							else
							{
			...
			{
				if (!func_78(player_ped_id(), Local_50, 10f, 1))
				{
					clear_bit(&uLocal_49, true);
				}
				...
				else if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_87(iLocal_51))
					{
						if (get_vehicle_ped_is_in(player_ped_id(), false) != iLocal_51)
						{
							func_1(46, 0);
							func_179(0);
							func_178();
...
int func_183(int iParam0)
{
	...
	if (!is_entry_point_for_seat_clear(player_ped_id(), iParam0, -1, false, false) && !is_entry_point_for_seat_clear(player_ped_id(), iParam0, 0, false, false))
	{
		func_71(37);
		return 0;
	}
...
int func_184(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_87(iParam0))
		{
			...
			if (!is_area_occupied(get_offset_from_entity_in_world_coords(iParam0, Var1), get_offset_from_entity_in_world_coords(iParam0, Var2), false, true, false, false, false, iParam0, false))
			{
				iVar0++;
			}
			else if (func_13())
			...
			if (iVar0 == 2)
			{
				if (func_185(get_entity_coords(iParam0, true)))
				{
					return 1;
				}
			}
...
int func_185(struct<3> Param0)
{
	...
	if (get_ground_z_for_3d_coord(Var2, &fVar0, false, false) && get_ground_z_for_3d_coord(Param0, &fVar1, false, false))
	{
...
int func_186()
{
	...
	while (iVar1 <= 4)
	{
		if (func_252(uVar0[iVar1]) && uVar0[iVar1] != player_ped_id())
		{
			if (vdist2(Local_50, get_entity_coords(uVar0[iVar1], true)) <= 16f)
			{
				return 1;
			}
		}
...
int func_189(struct<3> Param0)
{
	...
	fVar0 = vdist2(Param0, Global_95580[func_190(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_190(struct<3> Param0, bool bParam1)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_95580[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, Global_95580[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_191(struct<3> Param0)
{
	...
	fVar0 = vdist2(Param0, Global_95644[func_192(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_194(struct<3> Param0, struct<3> Param1)
{
	...
	fVar0 = absf((Param0.f_2 - Param1.f_2));
	if (fVar0 <= 5f)
	{
		return 1;
	}
...
{
	if (is_entity_in_angled_area(player_ped_id(), uParam0->f_1, uParam0->f_4, uParam0->f_7, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_201(char* sParam0)
{
	...
	while (iVar0 <= 12)
	{
		if (!is_string_null(sLocal_69[iVar0]))
		{
			if (are_strings_equal(sLocal_69[iVar0], sParam0))
			{
				return 1;
			}
		}
...
int func_203()
{
	...
	iVar0 = func_205(get_entity_coords(player_ped_id(), true), 145, 1);
	fVar1 = vdist2(get_entity_coords(player_ped_id(), true), Global_95479[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
int func_207()
{
	if (vdist2(get_entity_coords(player_ped_id(), true), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_13())
		{
			func_71(30);
	...
	else if (vdist2(get_entity_coords(player_ped_id(), true), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_13())
		{
			func_71(31);
...
int func_208(float fParam0)
{
	if (iLocal_42 == 1)
	{
		if (func_78(player_ped_id(), Global_96387[1 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
	...
	{
		if (func_78(player_ped_id(), Global_96387[0 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
	...
	{
		if (func_78(player_ped_id(), Global_96387[3 /*15*/], fParam0, 1))
		{
			return 1;
		}
	}
		...
		if (!is_player_switch_in_progress())
		{
			if (!BitTest(uLocal_49, 0))
			{
						...
						if (!BitTest(uLocal_49, 7))
						{
							...
							if (func_87(iVar0))
							{
								if (!func_222(iVar0))
								{
									...
									if (decor_set_bool(iVar0, "GetawayVehicleValid", false))
									{
									}
									set_bit(&uLocal_49, 7);
								}
				...
				else if (BitTest(uLocal_49, 8))
				{
					...
					if (func_87(iVar1))
					{
						if (func_19(player_ped_id(), iVar1, 10f, 1) && !decor_exist_on(iVar1, "Getaway_Winched"))
						{
							iLocal_51 = iVar1;
							set_entity_as_mission_entity(iLocal_51, true, true);
							set_bit(&uLocal_49, false);
			...
			{
				if (!func_19(player_ped_id(), iLocal_51, 80f, 1))
				{
					if (!decor_exist_on(iLocal_51, "Getaway_Winched"))
					{
						set_bit(&(uLocal_47[func_5(5)]), 5);
						set_bit(&uLocal_49, 8);
					}
					else
					{
				...
				{
					if (decor_set_bool(iLocal_51, "GetawayVehicleValid", false))
					{
					}
					func_209(17, 46);
					func_209(18, 46);
...
int func_214()
{
	...
	{
		if ((get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), 0, false) == player_ped_id() || get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), 1, false) == player_ped_id()) || get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), 2, false) == player_ped_id())
		{
			return 1;
		}
	}
...
int func_219(int iParam0)
{
	...
	if (!func_220(iVar0))
	{
		if (get_vehicle_model_acceleration(iVar0) > 0.165f && get_vehicle_model_estimated_max_speed(iVar0) > 31f)
		{
			return 1;
		}
	}
...
int func_223()
{
	...
	if (func_224(&iVar0))
	{
		if (!decor_exist_on(iVar0, "Getaway_Winched"))
		{
			decor_set_bool(iVar0, "Getaway_Winched", true);
			func_71(16);
			return 1;
		}
...
int func_224(var uParam0)
{
	...
	if (func_252(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), false))
	{
		iVar0 = get_players_last_vehicle();
		if (func_87(iVar0))
		{
...
void func_225()
{
	switch (iLocal_67)
	{
		case 0:
			if (BitTest(uLocal_49, 0))
			{
				if ((get_game_timer() - iLocal_73) > 500)
				{
					sLocal_70 = get_name_of_zone(get_entity_coords(player_ped_id(), true));
					iLocal_67 = 1;
				}
				else if (iLocal_73 == -1)
				{
		...
		case 1:
			if ((get_game_timer() - Local_68[iLocal_72 /*261*/].f_259) > 500)
			{
				if (!is_string_null_or_empty(sLocal_70) && !is_string_null_or_empty(Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
				{
					if (are_strings_equal(sLocal_70, Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
					{
						set_bit(&(Local_68[iLocal_72 /*261*/].f_258), iLocal_71);
					}
					else
					{
						clear_bit(&(Local_68[iLocal_72 /*261*/].f_258), bLocal_71);
					}
				}
				else
				{
				...
				{
					bLocal_71 = false;
					Local_68[iLocal_72 /*261*/].f_259 = get_game_timer();
					iLocal_72++;
					if (iLocal_72 >= 4)
					{
						iLocal_72 = 0;
...
void func_227(bool bParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!is_help_message_being_displayed() && !func_230(func_91())) && !func_229())
			{
		...
		case 2:
			...
			{
				fLocal_48 = (fLocal_48 + get_frame_time());
				if (fLocal_48 >= 20f)
				{
					iLocal_39 = 4;
				}
...
void func_235()
{
	...
	{
		if (iLocal_77 < 2 && (get_game_timer() - iLocal_76) > 480000)
		{
			if (iLocal_42 != 2)
			{
				func_71(44);
...
void func_239()
{
	if (iLocal_37 != 4)
	{
		if (iLocal_37 != 2)
		{
			if (is_help_message_being_displayed() && !Global_112026)
			{
				set_bit(&uLocal_49, 15);
				clear_help(true);
			}
		...
		if (has_this_additional_text_loaded("GETAWY", 5))
		{
			...
			clear_bit(&uLocal_49, 4);
			clear_bit(&uLocal_49, 5);
			func_267(0);
			if (func_134())
			{
				func_1(1, 1);
...
int func_243()
{
	if (iLocal_42 != 2)
	{
		if (iLocal_42 == 1 && func_91() == 2)
		{
			...
			{
				set_bit(&uLocal_49, 16);
			}
			return 1;
		}
		else if (BitTest(uLocal_49, 16))
		{
			clear_bit(&uLocal_49, 16);
		}
		if (func_244())
		{
			return 0;
...
int func_254()
{
	...
	if (!func_86(14) && _get_number_of_references_of_script_with_name_hash(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
