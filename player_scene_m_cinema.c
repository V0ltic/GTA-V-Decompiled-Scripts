...
int func_2()
{
	...
	if (vdist(get_entity_coords(player_ped_id(), true), Local_72) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (does_entity_exist(iParam0))
	{
		switch (iLocal_70[iParam1])
		{
			...
			case 1:
				...
				if (!is_string_null_or_empty(&(Local_71[iParam1 /*4*/])))
				{
				...
				{
					task_start_scenario_in_place(iParam0, sVar0, 0, true);
					set_ped_keep_task(iLocal_68[iParam1], true);
				}
				break;
			...
			case 3:
				...
				if (vdist2(get_entity_coords(iParam0, true), get_entity_coords(player_ped_id(), true)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!is_string_null_or_empty(&(Local_71[iVar0 /*4*/])))
			{
				request_script(&(Local_71[iVar0 /*4*/]));
				if (!has_script_loaded(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = create_ped(4, iLocal_69[iVar0], Local_72 + Local_74[iVar0 /*3*/], 0f, true, true);
			set_entity_heading(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			set_ped_can_ragdoll(iLocal_68[iVar0], false);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			Local_74[3 /*3*/] = { Vector(45.5004f, get_random_float_in_range(-205.8167f, -210.4254f), get_random_float_in_range(-1416.54f, -1428.501f)) - Local_72 };
