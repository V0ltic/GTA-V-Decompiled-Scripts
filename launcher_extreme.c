...
void __EntryFunction__()
{
	...
	if (Var0.f_0 == 17)
	{
		iLocal_57 = add_scenario_blocking_area(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), false, true, true, true);
		set_scenario_type_enabled("WORLD_VEHICLE_SALTON_DIRT_BIKE", false);
	}
	else if (Var0.f_0 == 18)
	{
		iLocal_57 = add_scenario_blocking_area(-1040f, -2870f, 0f, -910f, -2740f, 50f, false, false, true, true);
	}
	...
	while (true)
	{
		...
		{
			func_198(&Var0);
			if (has_sound_finished(iLocal_56))
			{
				func_193(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_192() && func_191(Var0.f_28[0])) && !is_any_speech_playing(Var0.f_28[0])) && has_sound_finished(iLocal_56)) && request_script_audio_bank("EXTREME_04_DOM_A", false, -1)) && request_script_audio_bank("EXTREME_04_DOM_B", false, -1)) && request_script_audio_bank("EXTREME_04_DOM_C", false, -1))
			{
				play_sound_from_entity(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_55 == 0 && func_191(player_ped_id())) && is_entity_at_coord(player_ped_id(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
void func_148()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_149(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_170(struct<3> Param0, bool bParam1)
{
	...
	set_blip_scale(iVar0, func_171(network_is_game_in_progress(), 1f, 1f));
...
int func_173(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (is_entity_in_angled_area(player_ped_id(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, false, true, 0))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
			...
			else if ((!func_174(player_ped_id(), -828834893) && func_191(get_vehicle_ped_is_in(player_ped_id(), false))) && func_149(get_vehicle_ped_is_in(player_ped_id(), false), 3f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_191(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_191(player_ped_id()) && func_191(iParam0->f_28[0])) && !func_192()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_197(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_198(int iParam0)
{
	if (can_request_assets_for_cutscene_entity())
	{
		...
		{
			set_cutscene_ped_component_variation_from_ped("Dom", iParam0->f_28[0], 0);
		}
	}
}
...
void func_199(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_197(player_ped_id(), Param2, 1) <= 100f)
				{
					func_202(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_197(player_ped_id(), Param2, 1) > 120f)
				{
					func_204(iParam0);
				}
			}
...
void func_208(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_191(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_210(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_209(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_210(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_209(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_216(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_219(int iParam0, float fParam1)
{
	...
	if (func_191(player_ped_id()) && func_191(iParam0))
	{
		if (func_230(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_221(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_227(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_227(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_234(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_227(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_247(int* iParam0, struct<3> Param1, float fParam2)
{
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_249(iParam0);
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_28[0]))
			{
				if (func_254(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					give_weapon_to_ped(uParam0->f_28[0], joaat("gadget_parachute"), 1, false, false);
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_28[0]))
			{
				...
				{
					set_entity_coords_no_offset(uParam0->f_28[0], -954.2f, -2760.05f, 14.04f, true, false, true);
					set_ped_config_flag(uParam0->f_28[0], 118, false);
					set_ped_config_flag(uParam0->f_28[0], 208, true);
					freeze_entity_position(uParam0->f_28[0], true);
					set_entity_collision(uParam0->f_28[0], false, false);
					set_ped_component_variation(uParam0->f_28[0], 8, 1, 0, 0);
					task_play_anim(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 33281, 0f, false, false, false);
					if (does_entity_exist(player_ped_id()))
					{
						task_look_at_entity(uParam0->f_28[0], player_ped_id(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				set_vehicle_dirt_level(uParam0->f_35[0], 0f);
			}
			if (!does_entity_exist(uParam0->f_35[1]))
			{
				...
				set_vehicle_dirt_level(uParam0->f_35[1], 0f);
			}
			if (!does_entity_exist(uParam0->f_35[2]))
			{
				func_258(&(uParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				set_vehicle_doors_locked(uParam0->f_35[2], 2);
				set_vehicle_colour_combination(uParam0->f_35[2], 2);
				set_vehicle_dirt_level(uParam0->f_35[2], 0f);
				set_vehicle_is_considered_by_player(uParam0->f_35[2], false);
				set_vehicle_automatically_attaches(uParam0->f_35[2], false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_259(iParam0);
...
void func_274(int iParam0, bool bParam1)
{
	if (*iParam0 == 18)
	{
		...
		{
			set_vehicle_doors_locked(iParam0->f_35[0], 1);
		}
		if (func_191(iParam0->f_35[1]))
		{
			set_vehicle_doors_locked(iParam0->f_35[1], 1);
		}
	}
	if (bParam1)
	{
	...
	if (*iParam0 == 17)
	{
		remove_scenario_blocking_area(iLocal_57, false);
