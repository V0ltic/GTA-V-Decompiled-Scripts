...
void __EntryFunction__()
{
	...
	{
		stop_ped_speaking(Local_386.f_28[1], true);
	}
	if (func_453(Local_386.f_28[2]))
	{
		stop_ped_speaking(Local_386.f_28[2], true);
	}
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			...
			{
				set_entity_proofs(iLocal_390, false, false, false, false, false, false, false, false);
			}
			if (func_453(iLocal_391))
			{
				set_entity_proofs(iLocal_391, false, false, false, false, false, false, false, false);
			}
			func_263("JOSH4_LOSECOPS", 7500, 1);
			set_player_wanted_level(get_player_index(), 2, false);
			set_player_wanted_level_now(get_player_index(), false);
			set_ped_non_creation_area(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f);
			set_ped_paths_in_area(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, false, 0);
			clear_area_of_peds(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_453(Local_386.f_28[0]))
			{
				task_look_at_entity(Local_386.f_28[0], player_ped_id(), -1, 0, 2);
			}
			set_instance_priority_hint(2);
			iLocal_394 = get_game_timer();
			iLocal_46 = 1;
			break;
		...
		case 1:
			...
			func_212();
			func_210();
			if (get_player_wanted_level(get_player_index()) <= 0 && !func_209())
			{
				iVar0 = 1;
				...
				{
					if (is_ped_in_vehicle(player_ped_id(), iLocal_390, false))
					{
						func_206(777);
					}
				}
...
void func_210()
{
	if (iLocal_414 == 0)
	{
		if (func_211(player_ped_id(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			play_police_report("SCRIPTED_SCANNER_REPORT_JOSH_4_01", 0f);
...
float func_211(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
void func_212()
{
	if (iLocal_409 == 0)
	{
		if (!is_entity_in_angled_area(player_ped_id(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, false, true, 0))
		{
			while (func_209())
			{
				func_232();
			...
			func_231(&uLocal_221, 2, player_ped_id(), "TREVOR", 0, 1);
			func_231(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
			iLocal_412 = get_game_timer();
			iLocal_409++;
		}
	}
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((get_game_timer() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
				...
				else if (iLocal_49 == 1)
				{
					if (func_453(Local_386.f_28[0]))
					{
						if (func_213(player_ped_id(), Local_386.f_28[0], 1) < 75f)
						{
	...
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_453(Local_386.f_28[0]))
				{
					clear_ped_tasks(Local_386.f_28[0]);
					if (func_207(iLocal_391))
					{
						if (is_position_occupied(-1138.421f, 298.0307f, 65.90032f, 4f, false, true, false, false, false, iLocal_391, false))
						{
							func_501("Back gate blocked");
							Local_55 = { -1130.35f, 307.92f, 65.19f };
							open_sequence_task(&iLocal_389);
							task_follow_nav_mesh_to_coord(0, Local_55, 2f, 20000, 1f, true, 40000f);
							task_follow_nav_mesh_to_coord(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, true, 40000f);
							task_smart_flee_ped(0, player_ped_id(), 500f, -1, false, false);
							close_sequence_task(iLocal_389);
							set_ped_keep_task(Local_386.f_28[0], true);
							task_perform_sequence(Local_386.f_28[0], iLocal_389);
						}
						else
						{
							...
							if (func_207(iLocal_391))
							{
								task_vehicle_mission_ped_target(0, iLocal_391, player_ped_id(), 8, 30f, 786469, 500f, 0.1f, true);
							}
							else
							{
								task_smart_flee_ped(0, player_ped_id(), 500f, -1, false, false);
					...
					else
					{
						...
						if (func_207(iLocal_391))
						{
							task_enter_vehicle(0, iLocal_391, 20000, -1, 2f, 1, 0);
							task_vehicle_mission_ped_target(0, iLocal_391, player_ped_id(), 8, 30f, 786469, 500f, 0.1f, true);
						}
						else
						{
					...
					set_ped_flee_attributes(Local_386.f_28[0], 2, true);
					clear_sequence_task(&iLocal_389);
				}
				iLocal_413 = get_game_timer();
				set_ped_can_be_dragged_out(Local_386.f_28[0], true);
				set_ped_config_flag(Local_386.f_28[0], 177, true);
				iLocal_49 = 1;
			}
			break;
		...
		case 1:
			if (func_453(Local_386.f_28[0]))
			{
				if (!iLocal_406)
				{
					...
					{
						if (func_213(Local_386.f_28[0], player_ped_id(), 0) < 20f)
						{
							func_231(&uLocal_221, 2, player_ped_id(), "TREVOR", 0, 1);
							func_231(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
							if (func_209())
				...
				if (func_207(iLocal_391))
				{
					if (is_ped_in_vehicle(Local_386.f_28[0], iLocal_391, true))
					{
						if (get_vehicle_engine_health(iLocal_391) < 20f)
						{
							clear_ped_tasks(Local_386.f_28[0]);
							task_leave_any_vehicle(Local_386.f_28[0], 0, 4416);
							task_smart_flee_ped(Local_386.f_28[0], player_ped_id(), 510f, -1, false, false);
							func_237(&iLocal_391);
						}
					}
					if (func_453(player_ped_id()))
					{
						if (is_ped_in_vehicle(player_ped_id(), iLocal_391, true))
						{
							clear_ped_tasks(Local_386.f_28[0]);
							task_smart_flee_ped(Local_386.f_28[0], player_ped_id(), 510f, -1, false, false);
							func_237(&iLocal_391);
					...
					if (is_ped_being_jacked(Local_386.f_28[0]))
					{
						if (iLocal_407 == 0)
						{
				...
				if (func_213(player_ped_id(), Local_386.f_28[0], 1) > 350f)
				{
				...
				if (func_453(player_ped_id()) && func_453(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						if (func_213(player_ped_id(), Local_386.f_28[0], 1) < 10f)
						{
							if (!func_209() && (get_game_timer() - iLocal_413) > 8000)
							{
			...
			{
				if (has_entity_been_damaged_by_entity(Local_386.f_28[0], player_ped_id(), true))
				{
...
void func_240()
{
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (is_entity_in_angled_area(player_ped_id(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, false, true, 2))
				{
					func_241("Player detected inside flee direction trigger: ", iLocal_393);
					request_model(iLocal_43);
					request_model(iLocal_42);
					...
					request_vehicle_recording(Local_47.f_9, Local_47.f_10);
					while ((!has_vehicle_recording_been_loaded(Local_47.f_9, Local_47.f_10) || !has_model_loaded(iLocal_43)) || !has_model_loaded(iLocal_42))
					{
						wait(0);
					}
		...
		case 1:
			if (!does_entity_exist(Local_47.f_7))
			{
				Local_47.f_7 = create_vehicle(iLocal_43, Local_47, 0f, true, true, false);
				set_vehicle_on_ground_properly(Local_47.f_7, 5f);
				set_entity_quaternion(Local_47.f_7, Local_47.f_3, Local_47.f_4, Local_47.f_5, Local_47.f_6);
				Local_47.f_8 = create_ped_inside_vehicle(Local_47.f_7, 6, iLocal_42, -1, true, true);
				give_weapon_to_ped(Local_47.f_8, joaat("weapon_pistol"), -1, false, true);
				set_blocking_of_non_temporary_events(Local_47.f_8, true);
				clear_ped_tasks(Local_47.f_8);
		...
		case 2:
			if (func_207(Local_47.f_7))
			{
				...
				{
					if (is_ped_in_any_vehicle(Local_47.f_8, false))
					{
						start_playback_recorded_vehicle(Local_47.f_7, Local_47.f_9, Local_47.f_10, true);
						force_playback_recorded_vehicle_update(Local_47.f_7, true);
						func_241("*** m_AI_FleeCar.iRecNum: ", Local_47.f_9);
						switch (Local_47.f_9)
						{
							case 0:
								set_playback_speed(Local_47.f_7, 1.5f);
								break;
							
							case 1:
								set_playback_speed(Local_47.f_7, 1f);
								break;
							
							case 2:
								set_playback_speed(Local_47.f_7, 1.4f);
								break;
		...
		case 3:
			if (func_207(Local_47.f_7))
			{
				if (!is_playback_going_on_for_vehicle(Local_47.f_7))
				{
					if (has_vehicle_recording_been_loaded(Local_47.f_9, Local_47.f_10))
					{
						remove_vehicle_recording(Local_47.f_9, Local_47.f_10);
		...
		case 4:
			if (func_207(Local_47.f_7))
			{
				if (func_453(Local_47.f_8))
				{
					set_blocking_of_non_temporary_events(Local_47.f_8, false);
...
void func_242()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if ((get_game_timer() - iLocal_394) > 4000)
			{
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_453(Local_386.f_28[iVar0]))
				{
					if (func_213(Local_386.f_28[iVar0], player_ped_id(), 0) > 10f)
					{
		...
		case 2:
			if ((get_game_timer() - iLocal_394) > 20000)
			{
				func_501("************************************** TIMEOUT - ARREST next frame");
				if (func_453(Local_386.f_28[1]))
				{
					clear_ped_tasks(Local_386.f_28[1]);
					set_blocking_of_non_temporary_events(Local_386.f_28[1], false);
					task_arrest_ped(Local_386.f_28[1], player_ped_id());
				}
				iLocal_48 = 4;
				iLocal_394 = get_game_timer();
			}
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_453(Local_386.f_28[iVar0]))
				{
					if (func_213(Local_386.f_28[iVar0], player_ped_id(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_453(Local_386.f_28[iVar0]))
					{
						clear_ped_tasks(Local_386.f_28[iVar0]);
						set_blocking_of_non_temporary_events(Local_386.f_28[iVar0], false);
						open_sequence_task(&iLocal_389);
						task_shoot_at_entity(0, player_ped_id(), -1, joaat("FIRING_PATTERN_BURST_FIRE"));
						close_sequence_task(iLocal_389);
						task_perform_sequence(Local_386.f_28[iVar0], iLocal_389);
						clear_sequence_task(&iLocal_389);
					}
					iVar0++;
				}
				func_231(&uLocal_56, 2, player_ped_id(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= (Local_386.f_28 - 1))
				{
					...
					{
						if (func_213(Local_386.f_28[iVar1], player_ped_id(), 1) > 20f)
						{
							set_ped_accuracy(Local_386.f_28[iVar1], 75);
						}
						else
						{
							set_ped_accuracy(Local_386.f_28[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((get_game_timer() - iLocal_411) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_386.f_28 - 1))
					{
						if (func_453(Local_386.f_28[iVar1]))
						{
							if (func_213(Local_386.f_28[iVar1], player_ped_id(), 1) >= 50f)
							{
	...
	if (iLocal_48 != 3)
	{
		...
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (func_453(Local_386.f_28[iVar0]))
			{
				if (is_player_targetting_entity(player_id(), Local_386.f_28[iVar0]))
				{
				...
				if (iLocal_48 != 4)
				{
					if (func_213(Local_386.f_28[iVar0], player_ped_id(), 0) < 2.3f)
					{
...
int func_243(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_453(player_ped_id()) && func_453(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_256(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_244(int iParam0, float fParam1)
{
	...
	if (func_453(player_ped_id()) && func_453(iParam0))
	{
		if (func_255(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(player_ped_id(), 6))
			{
				fVar0 = 40f;
...
{
	return func_246(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_250(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_252(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_252(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_260(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_252(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_262()
{
	...
	else
	{
		...
		{
			case 0:
				if ((get_game_timer() - iLocal_52) > 1000)
				{
					iLocal_50 = 1;
				}
				break;
			...
			case 1:
				if (!func_209() && !is_message_being_displayed())
				{
					if (iLocal_51)
					{
						func_231(&uLocal_56, 2, player_ped_id(), "TREVOR", 0, 1);
...
void func_264()
{
	if (iLocal_45 == 1)
	{
		...
		{
			if (get_cutscene_time() > 14000 && !iLocal_403)
			{
...
void func_265()
{
	...
	if (can_request_assets_for_cutscene_entity())
	{
		if (func_453(Local_386.f_28[1]))
		{
			...
			set_cutscene_ped_component_variation_from_ped("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_453(Local_386.f_28[2]))
		{
			func_501("Trying to set Cop 2 component variation (intro loop)");
			set_cutscene_ped_component_variation_from_ped("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		case 0:
			if (!are_strings_equal(sLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
		...
		case 1:
			switch (iLocal_408)
			{
				case 0:
					if (func_293(1, 1093140480, 0))
					{
						...
						if (func_207(iVar0))
						{
							...
							else if (is_entity_in_angled_area(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, false, true, 0))
							{
						...
						if (func_207(iLocal_390))
						{
							set_entity_coords(iLocal_390, -1107.5f, 280.33f, 64.01f, true, false, false, true);
							set_entity_heading(iLocal_390, 97.97f);
							set_vehicle_on_ground_properly(iLocal_390, 5f);
						}
						iLocal_408++;
					}
					break;
				...
				case 1:
					...
					request_model(iLocal_392);
					iLocal_408++;
					break;
				
				case 2:
					if (((has_anim_dict_loaded("rcmjosh4") && has_anim_dict_loaded("combat@gestures@pistol@halt")) && has_anim_dict_loaded("combat@gestures@pistol@glances")) && has_model_loaded(iLocal_392))
					{
						iLocal_408++;
					}
					break;
...
void func_268(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_272(player_id())) && !func_270(player_id(), 0)) && !func_269()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_272(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_276()
{
	if (can_set_exit_state_for_registered_entity("Josh", 0))
	{
		if (func_453(Local_386.f_28[0]))
		{
			func_501("Playing Josh's leadout");
			open_sequence_task(&iLocal_389);
			task_look_at_entity(0, player_ped_id(), -1, 2, 2);
			task_play_anim(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0f, false, false, false);
			close_sequence_task(iLocal_389);
			task_perform_sequence(Local_386.f_28[0], iLocal_389);
			clear_sequence_task(&iLocal_389);
			force_ped_motion_state(Local_386.f_28[0], joaat("MotionState_DoNothing"), false, 1, false);
		}
	}
	if (can_set_exit_state_for_registered_entity("Security_guard_pistol", 0))
	{
		if (func_453(iLocal_387) && func_453(Local_386.f_28[1]))
		{
			give_weapon_object_to_ped(iLocal_387, Local_386.f_28[1]);
			func_501("*** Gave idle cop gun");
		}
	}
	if (can_set_exit_state_for_registered_entity("FBI_Agent_1_Gun", 0))
	{
		if (func_453(iLocal_388) && func_453(Local_386.f_28[2]))
		{
			give_weapon_object_to_ped(iLocal_388, Local_386.f_28[2]);
			func_501("*** Gave notepad cop gun");
		}
	}
	if (can_set_exit_state_for_registered_entity("Cop_standing_idle", 0))
	{
		if (func_453(Local_386.f_28[1]))
		{
			force_ped_motion_state(Local_386.f_28[1], joaat("MotionState_Aiming"), false, 1, false);
			open_sequence_task(&iLocal_389);
			task_look_at_entity(0, player_ped_id(), -1, 1026, 2);
			task_aim_gun_at_entity(0, player_ped_id(), -1, true);
			task_play_anim(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0f, false, false, false);
			close_sequence_task(iLocal_389);
			task_perform_sequence(Local_386.f_28[1], iLocal_389);
			clear_sequence_task(&iLocal_389);
			func_501("*** Idle cop anim");
		}
	}
	if (can_set_exit_state_for_registered_entity("Cop_with_notepad", 0))
	{
		if (func_453(Local_386.f_28[2]))
		{
			force_ped_motion_state(Local_386.f_28[2], joaat("MotionState_Aiming"), false, 1, false);
			open_sequence_task(&iLocal_389);
			task_look_at_entity(0, player_ped_id(), -1, 1026, 2);
			task_go_to_coord_while_aiming_at_entity(0, -1103.72f, 289.46f, 63.23f, player_ped_id(), 1f, false, 0.1f, 4f, true, 0, true, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			task_go_to_coord_while_aiming_at_entity(0, -1106.08f, 288.55f, 63.31f, player_ped_id(), 1f, false, 0.1f, 4f, true, 0, true, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
			task_aim_gun_at_entity(0, player_ped_id(), -1, true);
			close_sequence_task(iLocal_389);
			task_perform_sequence(Local_386.f_28[2], iLocal_389);
			clear_sequence_task(&iLocal_389);
...
void func_278(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_280(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_292()
{
	...
	if (func_453(Local_386.f_28[0]))
	{
		register_entity_for_cutscene(Local_386.f_28[0], "Josh", 0, 0, 0);
		func_501("*** Registered Josh");
	}
	if (func_453(Local_386.f_28[1]))
	{
		iLocal_387 = create_weapon_object(joaat("weapon_pistol"), -1, get_entity_coords(Local_386.f_28[1], true), true, 1f, 0, 0, 1);
		register_entity_for_cutscene(Local_386.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_501("*** Registered Cop standing");
	}
	if (func_453(Local_386.f_28[2]))
	{
		iLocal_388 = create_weapon_object(joaat("weapon_pistol"), -1, get_entity_coords(Local_386.f_28[2], true), true, 1f, 0, 0, 1);
		register_entity_for_cutscene(Local_386.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_501("*** Registered Cop with notepad");
	}
	if (func_453(iLocal_387))
	{
		register_entity_for_cutscene(iLocal_387, "Security_guard_pistol", 0, 0, 0);
		func_501("*** Registered idle cop gun");
	}
	if (func_453(iLocal_388))
	{
		register_entity_for_cutscene(iLocal_388, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_293(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_297(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_296(player_ped_id(), -828834893))
				{
...
void func_300(int iParam0)
{
	...
	request_anim_dict("combat@gestures@pistol@glances");
	request_model(iLocal_392);
	while ((!has_anim_dict_loaded("combat@gestures@pistol@halt") || !has_anim_dict_loaded("combat@gestures@pistol@glances")) || !has_model_loaded(iLocal_392))
	{
		wait(0);
	}
	if (does_object_of_type_exist_at_coords(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), false))
	{
		set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, false, 0f, false);
	}
	if (does_object_of_type_exist_at_coords(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), false))
	{
		set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, false, 0f, false);
	}
	if (func_453(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			set_entity_coords(Local_386.f_28[0], -1103.962f, 291.3401f, 63.367f, true, false, false, true);
			set_entity_heading(Local_386.f_28[0], 193.1737f);
			task_play_anim(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0f, false, false, false);
		}
		set_entity_only_damaged_by_player(Local_386.f_28[0], true);
		set_ped_can_be_targetted(Local_386.f_28[0], true);
	}
	if (iParam0 == 1)
	{
		if (func_453(Local_386.f_28[2]))
		{
			give_weapon_to_ped(Local_386.f_28[2], joaat("weapon_pistol"), -1, true, true);
			set_entity_coords(Local_386.f_28[2], -1106.08f, 288.55f, 63.31f, true, false, false, true);
			open_sequence_task(&iLocal_389);
			task_aim_gun_at_entity(0, player_ped_id(), -1, true);
			close_sequence_task(iLocal_389);
			task_perform_sequence(Local_386.f_28[2], iLocal_389);
			clear_sequence_task(&iLocal_389);
			set_blocking_of_non_temporary_events(Local_386.f_28[2], true);
		}
	}
	if (iParam0 == 1)
	{
		if (func_453(Local_386.f_28[1]))
		{
			give_weapon_to_ped(Local_386.f_28[1], joaat("weapon_pistol"), -1, true, true);
			set_entity_coords(Local_386.f_28[1], -1102.41f, 289.73f, 63.18f, true, false, false, true);
			open_sequence_task(&iLocal_389);
			task_aim_gun_at_entity(0, player_ped_id(), -1, true);
			close_sequence_task(iLocal_389);
			task_perform_sequence(Local_386.f_28[1], iLocal_389);
			clear_sequence_task(&iLocal_389);
			set_blocking_of_non_temporary_events(Local_386.f_28[1], true);
		}
	}
	if (func_453(Local_386.f_28[1]))
	{
		set_ped_combat_attributes(Local_386.f_28[1], 23, true);
	}
	if (func_453(Local_386.f_28[2]))
	{
		set_ped_combat_attributes(Local_386.f_28[2], 23, true);
	}
	if (func_207(Local_386.f_35[1]))
	{
		set_vehicle_doors_locked(Local_386.f_35[1], 1);
	}
	func_231(&uLocal_221, 2, player_ped_id(), "TREVOR", 0, 1);
	iLocal_395 = 0;
	iLocal_396 = 0;
...
void func_302()
{
	...
	{
		case 0:
			if (!func_5(0) && is_entity_in_angled_area(player_ped_id(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
		...
		case 1:
			if (!func_5(0) && is_entity_in_angled_area(player_ped_id(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
				if (func_453(player_ped_id()) && func_267(Local_386.f_28[0]))
				{
					if (is_entity_in_angled_area(player_ped_id(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, false, true, 0))
					{
						if (!func_303())
						{
							if (!func_296(player_ped_id(), -875674219))
							{
								task_turn_ped_to_face_entity(player_ped_id(), Local_386.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					...
					{
						if (is_entity_playing_anim(Local_386.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_209())
						{
							task_play_anim(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0f, false, false, false);
							func_501("Done Josh leadin anim");
							if (func_267(Local_386.f_28[2]))
							{
								task_play_anim(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0f, false, false, false);
								func_501("Done Notepad cop leadin anim");
							}
							if (func_267(Local_386.f_28[1]))
							{
								task_play_anim(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0f, false, false, false);
								func_501("Done Speaker cop leadin anim");
							}
							remove_cutscene();
							request_cutscene_with_playback_list("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_400 = 1;
						}
					}
				}
				...
				{
					if ((func_453(player_ped_id()) && func_267(Local_386.f_28[0])) && !func_303())
					{
						if (!func_296(player_ped_id(), -875674219))
						{
							task_turn_ped_to_face_entity(player_ped_id(), Local_386.f_28[0], 0);
					...
					if (func_267(Local_386.f_28[0]))
					{
						if (is_entity_playing_anim(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (get_entity_anim_current_time(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
									if (func_214(&uLocal_221, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
										_0x293220DA1B46CEBC(2f, 3f, 1);
										iLocal_401 = 1;
									}
								}
							}
							if (get_entity_anim_current_time(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_299(1);
							}
							if (func_213(player_ped_id(), Local_386.f_28[0], 1) <= 2f)
							{
								if (func_209())
								{
									func_232();
...
void func_305()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_297(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_325(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_310(0)) || func_324(1))
			{
			}
			else
			{
...
void func_328()
{
	if (func_453(Local_386.f_28[1]))
	{
		set_entity_coords_no_offset(Local_386.f_28[1], -1102.48f, 290.2f, 64.22f, false, false, true);
		set_entity_heading(Local_386.f_28[1], 177.74f);
	}
	else
	{
		Local_386.f_28[1] = create_ped(6, iLocal_42, -1102.92f, 290.12f, -200f, 40.46f, false, false);
	}
	if (func_453(Local_386.f_28[2]))
	{
		set_entity_coords_no_offset(Local_386.f_28[2], -1103.94f, 290.21f, 64.28f, false, false, true);
		set_entity_heading(Local_386.f_28[2], -167.67f);
	}
	else
	{
		Local_386.f_28[2] = create_ped(6, iLocal_42, -1102.73f, 290.91f, -200f, 92.06f, false, false);
	}
	if (!func_334())
	{
		func_333(player_ped_id(), Local_53, fLocal_54, 1, 1);
		set_gameplay_cam_relative_pitch(0f, 1f);
		set_gameplay_cam_relative_heading(0f);
	}
	func_300(1);
	request_model(iLocal_392);
	while (!has_model_loaded(iLocal_392))
	{
		wait(0);
	}
	func_299(2);
...
int func_331(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		door_system_set_open_ratio(-1502457334, 0f, false, false);
		door_system_set_door_state(-1502457334, 3, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		door_system_set_open_ratio(-1994188940, 0f, false, false);
		door_system_set_door_state(-1994188940, 3, false, true);
		iVar0++;
	}
	else
	{
...
int func_332(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		create_forced_object(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false);
		door_system_set_open_ratio(904342475, 1f, false, false);
		door_system_set_door_state(904342475, 4, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		create_forced_object(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), false);
		door_system_set_open_ratio(-795418380, -0.9f, false, false);
		door_system_set_door_state(-795418380, 4, false, true);
		iVar0++;
	}
	else
	{
...
void func_337(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_153(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_342(*iParam1, 0, &uVar0))
		{
...
int func_342(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = get_entity_model(iParam0);
	if ((!func_371(iVar0, bParam1, uParam2) && !func_370(player_id())) && !func_352(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_350(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_348(iParam0)) && !bVar1) && !(func_347(get_entity_model(iParam0)) && func_344(player_id())))
	{
	...
	if (!network_is_game_in_progress())
	{
		if ((func_343(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_369(player_id()) || func_368(player_id()))
	{
		if (func_353(iParam0))
		{
			return 1;
...
int func_354(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_348(iParam0)) || func_355(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_356(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_358(get_entity_model(iParam0), 0))
			{
...
int func_371(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_350(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_375(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_286(iParam0, 0, 0)) || func_286(iParam0, 1, 0)) || func_286(iParam0, 2, 0)) || func_391(iParam0) != 145) || func_390(iParam0)) || func_389(iParam0)) || func_343(iParam0)) || func_388(iParam0)) || !func_378(get_entity_model(iParam0)))
	{
		if (func_389(iParam0))
		{
		}
...
int func_395(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_367(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_398(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_398(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_397(iParam0);
	if (func_396(*iParam0))
	{
...
void func_403(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_404(iParam0, iParam1))
				{
...
void func_405(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	if (func_437(uParam0))
	{
		...
		if (func_436(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_415(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
int func_415(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_417(iParam0, uVar1[iVar3], 1) && func_416(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_411(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
						delete_vehicle(&iParam0);
						return 1;
					}
...
void func_418(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_375(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_375(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_375(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_375(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_375(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_375(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_375(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_419() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
void func_452()
{
	...
	request_additional_text("JOSH4", 0);
...
int func_455(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_28[1]))
			{
				...
				if (func_453(uParam0->f_28[1]))
				{
					...
					give_weapon_to_ped(uParam0->f_28[1], joaat("weapon_pistol"), -1, false, true);
					if (has_anim_dict_loaded("rcmjosh4"))
					{
						clear_ped_tasks(uParam0->f_28[1]);
						task_play_anim(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0f, false, false, false);
					}
				}
				else
				{
			...
			if (!does_entity_exist(uParam0->f_28[2]))
			{
				...
				{
					set_ped_component_variation(uParam0->f_28[2], 0, 1, 1, 0);
					set_ped_component_variation(uParam0->f_28[2], 3, 0, 1, 0);
					set_ped_component_variation(uParam0->f_28[2], 10, 0, 1, 0);
					set_blocking_of_non_temporary_events(uParam0->f_28[2], true);
					give_weapon_to_ped(uParam0->f_28[2], joaat("weapon_pistol"), -1, false, true);
					if (has_anim_dict_loaded("rcmjosh4"))
					{
						clear_ped_tasks(uParam0->f_28[2]);
						task_play_anim(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0f, false, false, false);
					}
				}
				else
				{
			...
			if (!does_entity_exist(uParam0->f_35[1]))
			{
				...
				{
					set_vehicle_petrol_tank_health(uParam0->f_35[1], 900f);
					fVar2 = get_vehicle_engine_health(uParam0->f_35[1]);
					fVar2 = (fVar2 / 2f);
					set_vehicle_engine_health(uParam0->f_35[1], fVar2);
					set_vehicle_on_ground_properly(uParam0->f_35[1], 5f);
				}
				else
				{
					bVar3 = false;
		...
		case 3:
			if (does_object_of_type_exist_at_coords(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), false))
			{
				set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, true, 0f, false);
			}
			if (does_object_of_type_exist_at_coords(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), false))
			{
				set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, true, 0f, false);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_456(int* iParam0, bool bParam1)
{
	...
	set_vehicle_colour_combination(*iParam0, 4);
	set_vehicle_doors_locked(*iParam0, 3);
	set_vehicle_automatically_attaches(*iParam0, false, 0);
	set_vehicle_disable_towing(*iParam0, true);
}

void func_457(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_235(iParam0);
...
void func_458(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_236(iParam0);
	*iParam0 = create_ped(iParam4, iParam1, Param2, fParam3, false, false);
}

int func_459(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_460(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_468()
{
	...
	set_ped_paths_back_to_original(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, 0);
	func_469(&Local_386, 1, 0, 0);
	set_model_as_no_longer_needed(iLocal_43);
	set_model_as_no_longer_needed(iLocal_42);
...
void func_479(bool bParam0)
{
	...
	if (!func_496())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_480(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_481(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_487())
	{
		...
		{
			iVar2 = func_482(get_this_script_name());
			if (iVar2 > -1)
			{
