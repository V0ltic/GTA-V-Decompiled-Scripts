...
void __EntryFunction__()
{
	...
	{
		if (func_554(player_id(), 1))
		{
			terminate_this_thread();
		}
		if (func_553(player_id(), 1))
		{
			terminate_this_thread();
		}
	}
	...
	if (!func_551() && !network_is_game_in_progress())
	{
	...
	{
		func_535();
		network_set_this_script_is_network_script(2, false, player_id());
		func_530(0, -1, 0);
	...
	while (iLocal_60)
	{
		...
		if (func_551())
		{
			if (func_524(1024))
			{
				...
				{
					if (has_ped_head_blend_finished(player_ped_id()) && have_all_streaming_requests_completed(player_ped_id()))
					{
						func_528(1024);
			...
			if (!does_entity_exist(iLocal_90))
			{
				bVar0 = false;
			}
			else if (!network_has_control_of_entity(iLocal_90))
			{
				bVar0 = false;
				network_request_control_of_entity(iLocal_90);
			}
		}
				...
				if (bVar0)
				{
					...
					switch (iLocal_285)
					{
						case 0:
							if (iLocal_284 == -1)
							{
								if (is_ped_active_in_scenario(iLocal_90))
								{
									iLocal_284 = func_501();
								}
								else if (func_499())
							...
							else if (func_494())
							{
								if (func_493())
								{
									if (func_551())
									{
										if (network_has_control_of_entity(iLocal_90))
										{
											task_start_scenario_in_place(iLocal_90, "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", 0, false);
										}
										else
										{
											network_request_control_of_entity(iLocal_90);
...
void func_3()
{
	if (iLocal_286 > 0)
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (!is_ped_injured(iLocal_91))
			{
				if (!is_ped_in_vehicle(iLocal_91, iLocal_92, false))
				{
					func_97();
				}
			}
	...
	if (!does_entity_exist(iLocal_91) || is_entity_dead(iLocal_91, false))
	{
		func_96(15);
	}
	switch (iLocal_286)
	{
		...
		case 6:
			if (!is_ped_injured(iLocal_91))
			{
				if (get_script_task_status(iLocal_90, 242628503) == 7)
				{
					iLocal_63 = get_game_timer();
					iLocal_64 = (iLocal_63 - iLocal_62);
					if (iLocal_64 >= 10000 || !is_entity_at_entity(iLocal_90, iLocal_91, 12f, 12f, 5f, false, true, 0))
					{
		...
		case 7:
			if (!are_nodes_loaded_for_area(func_58(0), func_58(1), func_58(2), func_58(3)))
			{
				_request_paths_prefer_accurate_boundingstruct(func_58(0), func_58(1), func_58(2), func_58(3));
			}
			else
			{
				task_vehicle_drive_to_coord(iLocal_91, iLocal_92, Local_88, (get_vehicle_estimated_max_speed(iLocal_92) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_286 = 8;
			}
			break;
		
		case 8:
			if (vdist2(Local_88, get_entity_coords(iLocal_90, true)) < 25f && get_script_task_status(iLocal_91, -1817882002) != 1)
			{
				iLocal_288 = get_random_int_in_range(1, 3);
				iLocal_286 = 11;
			}
		...
		case 15:
			if (does_entity_exist(iLocal_90) && does_entity_exist(iLocal_92))
			{
				if (is_ped_in_vehicle(iLocal_90, iLocal_92, false))
				{
					if (!is_entity_dead(iLocal_91, false))
					{
						if (get_script_task_status(iLocal_91, -828834893) != 1)
						{
							task_leave_any_vehicle(iLocal_90, 0, 16842752);
						}
					}
				}
				else
...
void func_4()
{
	...
	{
		case 0:
			set_scripted_anim_seat_offset(iLocal_90, 0.916f);
		...
		case 1:
			if (vdist2(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_90, false)) < 22500f)
			{
				func_38();
			}
			func_35(iLocal_92);
...
int func_33(int iParam0)
{
	if (func_34())
	{
		if (!would_entity_be_occluded(get_entity_model(iParam0), get_entity_coords(iParam0, true), true))
		{
			return 1;
		}
	}
...
void func_36(var uParam0)
{
	...
	if (is_vehicle_driveable(*uParam0, false))
	{
		Var0 = { 0f, 0f, -0.1f };
		Var1 = { 0f, 0f, 0f };
		apply_force_to_entity(*uParam0, 1, Var0, Var1, 0, true, true, true, true, false);
	}
}

bool func_37()
{
	return has_anim_event_fired(iLocal_90, 876132797);
}
...
{
	if (is_string_null_or_empty(sLocal_61))
	{
		sLocal_61 = func_50(iParam0, 0, 0);
		return 0;
	}
	if (!has_anim_dict_loaded(sLocal_61))
	{
		return 0;
	}
	else
...
void func_43(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), true) && func_48(0, 1))
	{
		if (iLocal_48 != 4)
		{
	...
	else
	{
		...
		task_play_anim(0, sVar2, func_44(0, bParam2, bParam1, bVar1), 8f, -8f, -1, 0, 0f, false, false, false);
		task_play_anim(0, sVar2, func_44(1, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0f, false, false, false);
		task_play_anim(0, sVar2, func_44(2, bParam2, bParam1, bVar1), 8f, -4f, iParam3, 1, 0f, false, false, false);
		task_play_anim(0, sVar2, func_44(3, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0f, false, false, false);
		task_play_anim(0, sVar2, func_44(4, bParam2, bParam1, bVar1), 4f, -2f, -1, 0, 0f, false, false, false);
...
int func_55(int iParam0)
{
	...
	if (!is_entity_dead(iParam0, false))
	{
		if (is_ped_being_jacked(iParam0) || !func_57(iParam0, iLocal_92, -1))
		{
			Var0 = { get_entity_coords(iParam0, true) };
			set_ped_flee_attributes(iParam0, 196624, true);
			if (func_56())
			{
				task_smart_flee_coord(iParam0, Var0, 300f, -1, true, true);
			}
			else if (!is_entity_dead(get_peds_jacker(iParam0), false))
			{
...
float func_58(int iParam0)
{
	...
	Var0 = { get_entity_coords(iLocal_90, true) };
	Var1 = { Local_88 };
	if (iParam0 == 0)
	{
...
void func_59()
{
	if (!is_ped_injured(iLocal_91))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (is_ped_in_vehicle(iLocal_91, iLocal_92, false))
			{
				if (get_script_task_status(iLocal_90, 242628503) == 1)
				{
					if (get_sequence_progress(iLocal_90) > 0)
					{
						if (is_ped_in_vehicle(iLocal_90, iLocal_92, false))
						{
							func_492("prostitute WAITING TO END   - DRIVING OFF (WANDER)");
							open_sequence_task(&iLocal_95);
							task_vehicle_drive_wander(0, iLocal_92, 10f, 786603);
							close_sequence_task(iLocal_95);
							task_perform_sequence(iLocal_91, iLocal_95);
							clear_sequence_task(&iLocal_95);
							Local_88 = { func_60(get_entity_coords(iLocal_90, true)) };
							request_anim_dict(func_50(iLocal_90, 0, 0));
							iLocal_286 = 7;
...
void func_62()
{
	...
	if (!is_ped_injured(iLocal_91))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (is_ped_in_vehicle(iLocal_91, iLocal_92, false))
			{
				fVar0 = get_entity_speed(iLocal_92);
				if (is_entity_at_entity(iLocal_91, iLocal_90, 15f, 15f, 5f, false, true, 0) && fVar0 <= 1f)
				{
					func_69(iLocal_90);
					iLocal_63 = get_game_timer();
					iLocal_64 = (iLocal_63 - iLocal_62);
					if (iLocal_64 >= iLocal_66)
					{
						if (func_551())
						{
							if (network_has_control_of_entity(iLocal_91))
							{
								task_clear_look_at(iLocal_91);
							}
						}
						else
						{
						...
						iLocal_66 = get_random_int_in_range(0, 10000);
						if (iLocal_66 > 2500)
						{
							clear_ped_tasks(iLocal_90);
							clear_sequence_task(&iLocal_95);
							open_sequence_task(&iLocal_95);
							task_enter_vehicle(0, iLocal_92, -1, 0, 1f, 8388609, 0);
							task_stand_still(0, -1);
							close_sequence_task(iLocal_95);
							task_perform_sequence(iLocal_90, iLocal_95);
							clear_sequence_task(&iLocal_95);
							...
							if (!is_ped_injured(iLocal_91))
							{
								if (is_vehicle_driveable(iLocal_92, false))
								{
									if (is_ped_in_vehicle(iLocal_91, iLocal_92, false))
									{
										clear_sequence_task(&iLocal_95);
										open_sequence_task(&iLocal_95);
										task_stand_still(0, get_random_int_in_range(500, 2000));
										task_vehicle_drive_wander(0, iLocal_92, 10f, 786603);
										close_sequence_task(iLocal_95);
										task_perform_sequence(iLocal_91, iLocal_95);
										clear_sequence_task(&iLocal_95);
...
int func_63()
{
	...
	if (!does_entity_exist(iLocal_90) || is_ped_injured(iLocal_90))
	{
		return 1;
	}
	if (!func_551())
	{
		if (is_ped_in_any_vehicle(iLocal_90, true))
		{
			task_wander_standard(iLocal_90, 40000f, 0);
		}
		else if (func_491(iLocal_49, 4194304))
		{
			...
			{
				task_play_anim(0, func_67(iLocal_284), func_66(7), 8f, -1.5f, -1, 0, 0f, false, false, false);
			}
			func_64(1);
			close_sequence_task(iVar0);
			task_perform_sequence(iLocal_90, iVar0);
	...
	switch (iLocal_54)
	{
		...
		case 1:
			if (func_491(iLocal_73, 524288))
			{
				if (network_has_control_of_entity(iLocal_90))
				{
					task_play_anim(iLocal_90, func_67(iLocal_284), func_66(7), 8f, -1.5f, -1, 0, 0f, false, false, false);
				}
				else
				{
					network_request_control_of_entity(iLocal_90);
		...
		case 2:
			if (func_491(iLocal_73, 524288))
			{
				if (network_has_control_of_entity(iLocal_90))
				{
					if (get_script_task_status(iLocal_90, -2017877118) == 7)
					{
						func_64(0);
						iLocal_54 = 3;
					}
...
void func_64(bool bParam0)
{
	...
	if (((ped_has_use_scenario_task(iLocal_90) || is_ped_active_in_scenario(iLocal_90)) || is_ped_using_scenario(iLocal_90, func_65(0))) || is_ped_using_scenario(iLocal_90, func_65(1)))
	{
		return;
	}
	Var0 = { get_entity_coords(iLocal_90, true) };
	if (!does_scenario_of_type_exist_in_area(Var0, func_65(0), 20f, true) && !does_scenario_of_type_exist_in_area(Var0, func_65(1), 20f, true))
	{
		if (bParam0)
		{
	...
	if (!bParam0)
	{
		task_use_nearest_scenario_to_coord(iLocal_90, Var0, 20f, 0);
	}
	else
	{
		task_use_nearest_scenario_to_coord(0, Var0, 20f, 0);
	}
}
...
void func_68()
{
	if (is_ped_injured(iLocal_90))
	{
		return;
	}
	if (!is_any_speech_playing(iLocal_90))
	{
		if (func_23() == 2)
		{
			play_ped_ambient_speech_native(iLocal_90, "HOOKER_DECLINED_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			play_ped_ambient_speech_native(iLocal_90, "HOOKER_DECLINED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
int func_70(int iParam0)
{
	if (!is_ped_injured(iParam0))
	{
		if ((is_entity_playing_anim(iParam0, func_67(iLocal_284), func_66(1), 3) || is_entity_playing_anim(iParam0, func_67(iLocal_284), func_66(2), 3)) || is_entity_playing_anim(iParam0, func_67(iLocal_284), func_66(3), 3))
		{
			return 1;
		}
	}
	...
	if (!is_ped_injured(iLocal_91))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (is_ped_in_vehicle(iLocal_91, iLocal_92, false))
			{
				if (get_script_task_status(iLocal_90, 242628503) == 1)
				{
					if (get_sequence_progress(iLocal_90) > 1)
					{
						if (is_entity_at_entity(iLocal_90, iLocal_91, 20f, 20f, 10f, false, true, 0))
						{
							fVar0 = get_entity_speed(iLocal_92);
							if (fVar0 <= 1f)
							{
								func_72(0);
								iLocal_62 = get_game_timer();
								iLocal_66 = get_random_int_in_range(4000, 8000);
...
int func_72(bool bParam0)
{
	...
	if (!func_551())
	{
		if (bParam0)
		{
			add_entity_to_audio_mix_group(iLocal_90, "PROSTITUTE_GROUP", 0f);
		...
		if (func_491(iLocal_49, 4194304))
		{
			...
			task_play_anim(0, func_67(iLocal_284), func_66(0), 2f, -2f, -1, 0, 0f, false, false, false);
			task_play_anim(0, func_67(iLocal_284), func_66(iVar0), 2f, -2f, -1, 0, 0f, false, false, false);
			task_play_anim(0, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, 0f, false, false, false);
			close_sequence_task(iVar1);
			task_perform_sequence(iLocal_90, iVar1);
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (func_491(iLocal_49, 4194304))
			{
				if (network_has_control_of_entity(iLocal_90))
				{
					task_play_anim(iLocal_90, func_67(iLocal_284), func_66(0), 2f, -2f, -1, 0, 0f, false, false, false);
					iLocal_53 = 2;
				}
				else
				{
		...
		case 2:
			if (network_has_control_of_entity(iLocal_90))
			{
				...
				{
					iVar0 = get_random_int_in_range(1, 4);
					task_play_anim(iLocal_90, func_67(iLocal_284), func_66(iVar0), 2f, -2f, -1, 0, 0f, false, false, false);
					iLocal_53 = 3;
				}
			}
			else
		...
		case 3:
			if (network_has_control_of_entity(iLocal_90))
			{
				if (get_script_task_status(iLocal_90, -2017877118) == 7)
				{
					task_play_anim(iLocal_90, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, 0f, false, false, false);
					iLocal_53 = 4;
				}
			}
			else
	...
	if (!is_any_speech_playing(iLocal_90))
	{
		switch (func_23())
		{
			case 0:
				...
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_MICHAEL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_MICHAEL_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 1:
				if (!func_74(iLocal_90))
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_FRANKLIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_FRANKLIN_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			...
			case 2:
				if (!func_74(iLocal_90))
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				else
				{
					play_ped_ambient_speech_native(iLocal_90, "SOLICIT_TREVOR_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
				}
				break;
			}
	}
...
{
	if (is_ped_model(iParam0, Global_113386.f_10049.f_1[iParam1 /*11*/].f_10))
	{
		return 1;
	}
	return 0;
...
bool func_80(int iParam0, int iParam1, int iParam2)
{
	...
	return get_ped_texture_variation(iParam0, iVar0) == func_81(iParam1, iParam2);
}
...
bool func_84(int iParam0, int iParam1, int iParam2)
{
	...
	return get_ped_drawable_variation(iParam0, iVar0) == func_85(iParam1, iParam2);
}
...
void func_88()
{
	...
	if (!is_ped_injured(iLocal_91))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			...
			{
				fVar0 = get_entity_speed(iLocal_92);
				if (get_script_task_status(iLocal_91, -272084098) == 7 || fVar0 <= 1f)
				{
					get_model_dimensions(get_entity_model(iLocal_92), &Var2, &Var1);
					Var3 = { Var1 - Var2 };
					Var3 = { Var3 / Vector(2f, 2f, 2f) };
					Var4 = { get_offset_from_entity_in_world_coords(iLocal_92, 0.2f, 0.2f, 0f) };
					Var5 = { get_offset_from_entity_in_world_coords(iLocal_92, 0.2f, 0.2f, 0f) };
					Var6 = { get_entity_coords(iLocal_90, true) };
					if (vdist(Var6, Var5) < vdist(Var6, Var4))
					{
						Var4 = { Var5 };
					}
					open_sequence_task(&iLocal_95);
					task_follow_nav_mesh_to_coord(0, Var4.f_0, Var4.f_1, Var4.f_2, 1f, -1, 0.5f, 8192, 40000f);
					task_turn_ped_to_face_entity(0, iLocal_91, 0);
					task_stand_still(0, -1);
					close_sequence_task(iLocal_95);
					task_perform_sequence(iLocal_90, iLocal_95);
					clear_sequence_task(&iLocal_95);
	...
	if (!is_ped_injured(iLocal_91))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (is_ped_in_vehicle(iLocal_91, iLocal_92, false))
			{
				...
				{
					if (func_90(get_entity_coords(iLocal_91, true), 1106247680))
					{
						return;
					}
					Var0 = { get_entity_coords(iLocal_90, true) };
					if (get_closest_vehicle_node(Var0, &Var0, 8, 3f, 0f))
					{
						set_driver_ability(iLocal_91, 1f);
						set_driver_racing_modifier(iLocal_91, 0.2f);
						set_driver_aggressiveness(iLocal_91, 0.05f);
						task_vehicle_park(iLocal_91, iLocal_92, Var0, 0f, 3, 360f, true);
						task_look_at_entity(iLocal_91, iLocal_90, -1, 2048, 4);
...
bool func_90(struct<3> Param0, int iParam1)
{
	if (func_551())
	{
		return is_cop_ped_in_area_3d(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1));
	}
	return (is_cop_vehicle_in_area_3d(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1)) || is_cop_ped_in_area_3d(Param0 - Vector(iParam1, iParam1, iParam1), Param0 + Vector(iParam1, iParam1, iParam1)));
}
...
int func_91(int iParam0)
{
	...
	if (is_vehicle_driveable(*iParam0, false))
	{
		...
		if (func_94(iVar0, 0) && func_93(*iParam0))
		{
			...
			{
				iVar1 = get_vehicle_number_of_passengers(*iParam0, false, true);
				if (((iVar1 == 0 && is_vehicle_seat_free(*iParam0, 0, false)) && (!is_vehicle_door_damaged(*iParam0, 1) && !is_vehicle_door_damaged(*iParam0, 0))) || get_ped_in_vehicle_seat(*iParam0, 0, false) == iLocal_90)
				{
					if (func_47(*iParam0))
					{
					...
					else
					{
						...
						if (func_491(iLocal_49, 8))
						{
							if (has_clip_set_loaded(func_92()))
							{
								remove_clip_set(func_92());
								func_5(&iLocal_49, 8);
							}
						}
					}
...
void func_97()
{
	...
	iLocal_91 = 0;
	iLocal_92 = 0;
	task_play_anim(iLocal_90, func_67(iLocal_284), func_66(4), 2f, -2f, -1, 1, get_random_float_in_range(0f, 0.9f), false, false, false);
	func_96(0);
	iLocal_287 = 0;
	iLocal_285 = 1;
}
	...
	switch (iLocal_286)
	{
		case 0:
			...
			else if (iLocal_287 != 0 && !func_470("PROS_NO_MONEY"))
			{
				...
				{
					case 0:
						func_469(&uLocal_116, 0, player_ped_id(), "MICHAEL", 0, 1);
						break;
					
					case 1:
						func_469(&uLocal_116, 0, player_ped_id(), "FRANKLIN", 0, 1);
						break;
					
					case 2:
						func_469(&uLocal_116, 0, player_ped_id(), "TREVOR", 0, 1);
						break;
				}
				iLocal_286 = 1;
			}
...
void func_99(var uParam0)
{
	if (!func_551())
	{
		if (is_entity_playing_anim(player_ped_id(), func_50(player_ped_id(), 0, 0), func_101(1), 3))
		{
			return;
		}
	}
...
void func_102()
{
	if (!is_any_speech_playing(player_ped_id()))
	{
		if (iLocal_70 == 0)
		{
			...
			{
				set_ped_flee_attributes(iLocal_90, 32768, false);
				set_ped_flee_attributes(iLocal_90, 196624, true);
			}
			play_ped_ambient_speech_native(iLocal_90, "HOOKER_LEAVES_ANGRY", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			func_96(15);
		}
	}
}
...
void func_103()
{
	...
	{
		case 0:
			if (!is_any_speech_playing(iLocal_90) || func_121(&iLocal_101) > 4f)
			{
				func_116(iLocal_90);
		...
		case 1:
			func_113();
			if (is_any_speech_playing(iLocal_90) || func_112())
			{
...
void func_107(int iParam0, bool bParam1)
{
	...
	if (is_entity_playing_anim(player_ped_id(), func_50(player_ped_id(), 0, 0), func_110(1), 3))
	{
		task_play_anim(player_ped_id(), func_50(player_ped_id(), 0, 0), func_101(1), 4f, -8f, -1, 0, 0f, false, false, false);
	}
	if (!is_ped_injured(iParam0))
	{
		if (func_551())
		...
		if (func_491(iLocal_49, 134217728))
		{
			...
			task_smart_flee_ped(iParam0, player_ped_id(), 300f, -1, true, false);
		}
		else
		{
			set_ped_flee_attributes(iParam0, 196624, true);
			...
			{
				if (!is_vehicle_stopped(get_vehicle_ped_is_in(iParam0, false)))
				{
					func_109(iParam0, 1);
				}
				else
				{
					if (is_entity_playing_anim(iParam0, func_50(iParam0, 0, 0), func_110(0), 3))
					{
						if (iLocal_70 > 0)
						{
							task_play_anim(0, func_50(iParam0, 0, 0), func_101(0), 4f, -4f, -1, 0, 0f, false, false, false);
						}
						else
						{
							task_play_anim(0, func_50(iParam0, 0, 0), func_108(0), 4f, -4f, -1, 0, 0f, false, false, false);
						}
					}
					func_109(iParam0, 1);
				}
		...
		if (func_551())
		{
			if (network_has_entity_been_registered_with_this_thread(iLocal_90))
			{
				if (is_network_id_owned_by_participant(network_get_network_id_from_entity(iLocal_90)))
				{
...
{
	if (!is_entry_point_for_seat_clear(iParam0, get_vehicle_ped_is_in(iParam0, false), 0, false, false))
	{
		task_leave_any_vehicle(0, 0, 16842752);
	}
	else
	{
...
void func_111()
{
	...
	iVar0 = get_random_int_in_range(0, 1000);
	if ((iVar0 <= 333 && iLocal_297 == 0) || iLocal_297 == 3)
	{
		play_ped_ambient_speech_native(player_ped_id(), "HOOKER_STORY_REVULSION_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (((iVar0 > 333 && iVar0 <= 666) && iLocal_297 == 0) || iLocal_297 == 1)
	{
		play_ped_ambient_speech_native(player_ped_id(), "HOOKER_STORY_SARCASTIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (iLocal_297 == 0 || iLocal_297 == 2)
	{
		play_ped_ambient_speech_native(player_ped_id(), "HOOKER_STORY_SYMPATHETIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_122(var uParam0)
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			{
				if (get_ped_in_vehicle_seat(iVar1, -1, false) != player_ped_id())
				{
					bVar0 = true;
				}
				if (get_ped_in_vehicle_seat(iVar1, 0, false) != iLocal_90)
				{
					bVar0 = true;
				}
				if (get_vehicle_number_of_passengers(iVar1, false, true) > 2)
				{
					bVar0 = true;
				}
				if (bVar0)
...
void func_123(bool bParam0)
{
	...
	if (bParam0)
	{
		Var0 = { get_entity_rotation(iLocal_93, 2) };
		set_gameplay_cam_relative_heading(180f);
		set_gameplay_cam_relative_pitch((-5.5f - Var0.f_0), 1f);
	}
...
void func_125()
{
	if (is_vehicle_driveable(iLocal_93, false))
	{
		set_vehicle_brake_lights(iLocal_93, true);
	}
	if (iLocal_293 != 5)
	{
		...
		{
			if (!is_ped_sitting_in_any_vehicle(iLocal_90) || has_entity_been_damaged_by_any_ped(player_ped_id()))
			{
				iLocal_293 = 5;
			}
			if (is_ped_in_any_vehicle(player_ped_id(), false))
	...
	switch (iLocal_293)
	{
		...
		case 1:
			disable_control_action(0, 48, true);
			disable_control_action(0, 0, true);
			func_202();
			func_195();
			func_134();
...
void func_126()
{
	...
	if (!is_any_speech_playing(player_ped_id()))
	{
		if (iLocal_70 == 0)
		{
			play_ped_ambient_speech_native(player_ped_id(), "HOOKER_DECLINE_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
...
void func_129()
{
	...
	if (!is_any_speech_playing(iLocal_90))
	{
		play_ped_ambient_speech_native(iLocal_90, "SEX_FINISHED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_130()
{
	...
	if (!is_any_speech_playing(iLocal_90))
	{
		play_ped_ambient_speech_native(iLocal_90, "HOOKER_HAD_ENOUGH", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_134()
{
	...
	if (is_string_null_or_empty(func_50(player_ped_id(), 0, 0)))
	{
		return;
	}
	if (!has_anim_dict_loaded(func_50(player_ped_id(), 0, 0)))
	{
		return;
	}
	if (!is_entity_dead(player_ped_id(), false))
	...
	switch (iLocal_296)
	{
		...
		case 5:
			...
			{
				func_182(iLocal_90, 0);
				task_play_anim(iLocal_90, func_50(player_ped_id(), 0, 0), func_44(iLocal_296, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0f, false, false, false);
				func_182(player_ped_id(), -1);
				task_play_anim(player_ped_id(), func_50(player_ped_id(), 0, 0), func_44(iLocal_296, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0f, false, false, false);
				func_123(1);
				iLocal_50 = 0;
				iLocal_71 = 0;
				iLocal_59 = 0;
...
void func_142(int iParam0)
{
	...
	func_150(iVar0);
	set_ped_name_debug(iParam0, func_147(iVar0));
	Global_113386.f_10049.f_1[iVar0 /*11*/].f_10 = get_entity_model(iParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
{
	return get_ped_texture_variation(iParam0, func_82(iParam1));
}
...
{
	return get_ped_drawable_variation(iParam0, func_86(iParam1));
}
...
void func_152()
{
	...
	{
		func_154(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_153() == 2 == 0 && !network_is_game_in_progress())
			{
...
void func_157(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_79, func_50(player_ped_id(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_158(player_ped_id(), iLocal_80, func_50(player_ped_id(), 0, 0), func_44(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_79, func_50(player_ped_id(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_161(&iLocal_80, 0, 0, 0);
	func_160(player_ped_id(), iLocal_80, func_50(player_ped_id(), 0, 0), func_44(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_161(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	*iParam0 = func_164(Var0, 0f, 0f, 0f, bParam3, bParam2, 2);
	if (iParam1 == 0)
	{
		func_163(*iParam0, iLocal_93, get_entity_bone_index_by_name(iLocal_93, "seat_dside_f"));
	}
	else if (iParam1 == 1)
	{
		func_163(*iParam0, iLocal_93, get_entity_bone_index_by_name(iLocal_93, "seat_pside_f"));
	}
...
void func_162(int iParam0, struct<3> Param1, struct<3> Param2, bool bParam3)
{
	if (!func_551())
	{
		set_synchronized_scene_origin(iParam0, Param1, Param2, bParam3);
	}
}
...
int func_164(struct<3> Param0, struct<3> Param1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_551())
	{
		...
		iVar0 = network_create_synchronised_scene(Param0, Param1, iParam4, bParam2, bParam3, 1f, 0f, 1f);
	}
	else
	{
		iVar0 = create_synchronized_scene(Param0, Param1, iParam4);
		set_synchronized_scene_hold_last_frame(iVar0, bParam2);
		set_synchronized_scene_looped(iVar0, bParam3);
	}
	return iVar0;
}
...
void func_165(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_78, func_50(player_ped_id(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_158(player_ped_id(), iLocal_78, func_50(player_ped_id(), 0, 0), func_44(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_166(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_78, func_50(player_ped_id(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_160(player_ped_id(), iLocal_78, func_50(player_ped_id(), 0, 0), func_44(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
int func_169()
{
	...
	return func_170(func_26(player_ped_id()), 1);
}
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_77, func_50(player_ped_id(), 0, 0), func_44(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_158(player_ped_id(), iLocal_77, func_50(player_ped_id(), 0, 0), func_44(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_175(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_77, func_50(player_ped_id(), 0, 0), func_44(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
	func_160(player_ped_id(), iLocal_77, func_50(player_ped_id(), 0, 0), func_44(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}
...
void func_176(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_76, func_50(player_ped_id(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_158(player_ped_id(), iLocal_76, func_50(player_ped_id(), 0, 0), func_44(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_177(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_76, func_50(player_ped_id(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_160(player_ped_id(), iLocal_76, func_50(player_ped_id(), 0, 0), func_44(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
float func_178(int iParam0)
{
	...
	if (func_551())
	{
		fVar0 = get_synchronized_scene_phase(network_get_local_scene_from_network_id(iParam0));
	}
	else
	{
...
void func_180(bool bParam0, bool bParam1)
{
	...
	func_158(iLocal_90, iLocal_74, func_50(player_ped_id(), 0, 0), func_44(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
	func_158(player_ped_id(), iLocal_75, func_50(player_ped_id(), 0, 0), func_44(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}
...
void func_181(bool bParam0, bool bParam1)
{
	...
	func_160(iLocal_90, iLocal_74, func_50(player_ped_id(), 0, 0), func_44(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
	func_161(&iLocal_75, 0, 0, 1);
	func_160(player_ped_id(), iLocal_75, func_50(player_ped_id(), 0, 0), func_44(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}

void func_182(int iParam0, int iParam1)
{
	if (!is_ped_in_vehicle(iParam0, iLocal_93, false))
	{
		if (!func_551())
		{
			set_ped_into_vehicle(iParam0, iLocal_93, iParam1);
		}
		else if (!is_ped_in_vehicle(iParam0, iLocal_93, false))
		{
			task_enter_vehicle(iParam0, iLocal_93, -1, iParam1, 2f, 16, 0);
		}
	}
}
...
void func_183(int iParam0)
{
	...
	uVar0 = func_185(func_186(2), get_world_position_of_entity_bone(iLocal_93, get_entity_bone_index_by_name(iLocal_93, "windscreen")));
	uVar1 = func_185(func_186(1), get_world_position_of_entity_bone(iLocal_93, get_entity_bone_index_by_name(iLocal_93, "windscreen")));
	Var2 = { get_entity_rotation(iLocal_93, 2) };
	fVar3 = get_entity_heading(iLocal_93);
	if (fVar3 >= 180f)
	{
		fVar4 = (fVar3 - 180f);
	}
...
void func_184(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	...
	*uParam0 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
	...
	set_cam_params(*uParam0, Param1, uParam0->f_1, fParam3, 0, 1, 1, 2);
	render_script_cams(true, false, 3000, true, false, 0);
}
...
Vector3 func_186(int iParam0)
{
	...
	if (!is_entity_dead(iLocal_90, false))
	{
	}
	if (!is_vehicle_driveable(iLocal_93, false))
	{
	}
	get_model_dimensions(get_entity_model(iLocal_93), &uVar1, &Var2);
	Var3 = { get_world_position_of_entity_bone(iLocal_93, get_entity_bone_index_by_name(iLocal_93, "windscreen")) };
	Var4 = { get_offset_from_entity_given_world_coords(iLocal_93, Var3) };
	switch (iParam0)
	{
		case 0:
			Var0 = { get_offset_from_entity_in_world_coords(iLocal_93, 0f, (Var2.f_1 + 1.4f), Var4.f_2) };
			break;
		
		case 1:
			Var0 = { get_offset_from_entity_in_world_coords(iLocal_93, 1.5f, (Var2.f_1 + 1.2f), (Var4.f_2 - 0.1f)) };
			break;
		
		case 2:
			Var0 = { get_offset_from_entity_in_world_coords(iLocal_93, -3.7f, 0.7f, Var4.f_2) };
			break;
...
Vector3 func_187()
{
	...
	get_model_dimensions(get_entity_model(iLocal_93), &Var2, &uVar3);
	Var0 = { get_world_position_of_entity_bone(iLocal_93, get_entity_bone_index_by_name(iLocal_93, "windscreen")) };
	Var1 = { get_offset_from_entity_given_world_coords(iLocal_93, Var0) };
	Var1.f_2 = (Var1.f_2 + 0.09f);
	Var2.f_1 = (Var2.f_1 - 1f);
	return get_offset_from_entity_in_world_coords(iLocal_93, 0f, -absf(Var2.f_1), Var1.f_2);
}
...
{
	if (!does_cam_exist(Local_300[*iParam0 /*7*/]))
	{
		return;
	}
	if (!is_cam_rendering(Local_300[*iParam0 /*7*/]))
	{
		return;
	}
	shake_cam(Local_300[*iParam0 /*7*/], "HAND_SHAKE", 0.25f);
	...
	else
	{
		...
		if ((is_disabled_control_just_pressed(2, 0) && !is_pause_menu_active()) && !func_48(0, 1))
		{
			func_190(iParam0);
			set_cam_active(Local_300[*iParam0 /*7*/], true);
		}
...
void func_195()
{
		...
		if (func_199(iLocal_90))
		{
			if (!func_491(iLocal_49, 256))
			{
				...
				if (iLocal_70 == 1)
				{
					if (!func_551())
					{
						special_ability_charge_absolute(player_id(), 15, true, 0);
					}
				...
				else if (iLocal_70 == 2)
				{
					if (!func_551())
					{
						special_ability_charge_absolute(player_id(), 10, true, 0);
					}
				...
				else
				{
					if (!func_551())
					{
						special_ability_charge_absolute(player_id(), 5, true, 0);
					}
	...
	else
	{
		...
		{
			case 0:
				if (has_anim_event_fired(iLocal_90, 876132797))
				{
					set_pad_shake(0, 200, 84);
					apply_force_to_entity(iLocal_93, 1, 0f, 0f, -0.05f, 0f, 0f, 0f, 0, true, true, true, true, false);
					func_197();
				}
				break;
			...
			case 2:
				if (func_491(iLocal_49, 32768))
				{
					if (func_551())
					{
						iVar0 = network_get_local_scene_from_network_id(iLocal_77);
					}
					else
					{
						iVar0 = iLocal_77;
					...
					if (is_synchronized_scene_running(iVar0))
					{
						...
						if ((((((((((((((fVar1 > 0.01f && fVar1 < 0.019f) || (fVar1 > 0.093f && fVar1 < 0.1f)) || (fVar1 > 0.165f && fVar1 < 0.172f)) || (fVar1 > 0.231f && fVar1 < 0.239f)) || (fVar1 > 0.308f && fVar1 < 0.317f)) || (fVar1 > 0.37f && fVar1 < 0.378f)) || (fVar1 > 0.437f && fVar1 < 0.443f)) || (fVar1 > 0.507f && fVar1 < 0.518f)) || (fVar1 > 0.58f && fVar1 < 0.587f)) || (fVar1 > 0.651f && fVar1 < 0.659f)) || (fVar1 > 0.72f && fVar1 < 0.729f)) || (fVar1 > 0.788f && fVar1 < 0.794f)) || (fVar1 > 0.862f && fVar1 < 0.87f)) || (fVar1 > 0.937f && fVar1 < 0.946f))
						{
							if (!func_524(512))
							{
								...
								apply_force_to_entity(iLocal_93, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, true, true, true, true, false);
								func_197();
								func_196(512);
							}
						}
				...
				else if (has_anim_event_fired(iLocal_90, 876132797))
				{
					set_pad_shake(0, 200, 252);
					apply_force_to_entity(iLocal_93, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, true, true, true, true, false);
					func_197();
...
void func_197()
{
	...
	set_entity_health(player_ped_id(), iVar0, 0);
	func_198();
}
...
void func_198()
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		iLocal_57 = get_entity_health(player_ped_id());
	}
}

bool func_199(int iParam0)
{
	return (((is_entity_playing_anim(iParam0, func_54(), func_46(11), 3) || is_entity_playing_anim(iParam0, func_54(), func_46(21), 3)) || is_entity_playing_anim(iParam0, func_52(), func_45(11), 3)) || is_entity_playing_anim(iParam0, func_52(), func_45(21), 3));
}

bool func_200()
{
	return is_entity_playing_anim(iLocal_90, func_50(player_ped_id(), 0, 0), func_201(iLocal_90, func_49(), 1), 3);
}
...
void func_202()
{
	...
	if (is_any_speech_playing(iLocal_90) || is_any_speech_playing(player_ped_id()))
	{
		return;
	}
	if (get_random_int_in_range(0, 5000) > 2500)
	{
		func_203();
	}
}
...
void func_203()
{
	...
	if (!is_any_speech_playing(iLocal_90) && !is_any_speech_playing(player_ped_id()))
	{
		...
		else if (func_7(&iLocal_101) > get_random_float_in_range(2f, 5f))
		{
			if (!func_491(iLocal_49, 65536))
			{
				func_482(&iLocal_49, 65536);
				play_ped_ambient_speech_native(player_ped_id(), "SEX_GENERIC", "SPEECH_PARAMS_FORCE_NORMAL_CLEAR", 1);
				func_204(iLocal_289);
			}
			else
			{
...
void func_204(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				play_ped_ambient_speech_native(iLocal_90, "SEX_ORAL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				play_ped_ambient_speech_native(iLocal_90, "SEX_ORAL_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
		...
		case 2:
			if (func_205(player_id()))
			{
				play_ped_ambient_speech_native(iLocal_90, "SEX_GENERIC", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			else
			{
				play_ped_ambient_speech_native(iLocal_90, "SEX_GENERIC_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			}
			break;
	}
}
...
bool func_219(int iParam0)
{
	...
	if (func_551())
	{
		bVar0 = is_synchronized_scene_running(network_get_local_scene_from_network_id(iParam0));
	}
	else
	{
		bVar0 = is_synchronized_scene_running(iParam0);
	}
	return bVar0;
}
...
void func_220()
{
	if (is_screen_faded_out())
	{
		...
		set_entity_coords(player_ped_id(), func_222(), true, false, false, true);
		set_entity_heading(player_ped_id(), func_221());
		func_542();
		render_script_cams(false, false, 3000, true, false, 0);
		delete_ped(&iLocal_90);
	}
...
void func_223()
{
	...
	if (func_225(&iLocal_98, 3f) && !is_cam_active(iLocal_97))
	{
		iVar0 = floor(((func_224() - 2f) * 1000f));
		set_cam_active(iLocal_96, false);
		set_cam_active_with_interp(iLocal_97, iLocal_96, iVar0, 1, 1);
	}
...
void func_227(int iParam0, var uParam1)
{
	...
	if (get_event_data(1, iParam0, &uVar0, 13))
	{
	...
	if (does_entity_exist(*uParam0))
	{
		if (is_entity_a_vehicle(*uParam0))
		{
			if (does_entity_exist(player_ped_id()))
			{
				if (!is_entity_dead(player_ped_id(), false))
				{
					if (get_vehicle_ped_is_in(player_ped_id(), false) == get_vehicle_index_from_entity_index(*uParam0))
					{
						func_123(0);
						clear_ped_tasks(player_ped_id());
						func_542();
...
void func_229(var uParam0)
{
	...
	if (does_entity_exist(iLocal_90))
	{
		if (is_player_playing(player_id()))
		{
			iVar0 = get_entity_health(iLocal_90);
...
void func_232()
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		iLocal_93 = get_vehicle_ped_is_in(player_ped_id(), false);
		if (func_551())
		{
			if (network_has_control_of_entity(iLocal_93))
			{
				set_vehicle_handbrake(iLocal_93, true);
				set_vehicle_lights(iLocal_93, 4);
				set_vehicle_interiorlight(iLocal_93, true);
				set_vehicle_automatically_attaches(iLocal_93, false, 0);
			}
		}
		else
		{
		...
		if (!func_377() || !is_ped_in_vehicle(iLocal_90, iLocal_93, false))
		{
			func_473(0);
			return;
		}
	...
	func_213(0);
	if ((!is_vehicle_stopped(iLocal_93) && is_player_control_on(player_id())) && !func_491(iLocal_49, 1024))
	{
		iLocal_286 = 7;
		func_375(1, -1);
		request_script_audio_bank("SCRIPT\HUD_321_GO", true, -1);
		iLocal_292 = 0;
	...
	switch (iLocal_292)
	{
		...
		case 1:
			if (func_551())
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					...
					{
						if (network_get_entity_is_networked(get_vehicle_ped_is_in(player_ped_id(), false)))
						{
							if (get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), -1, false) == player_ped_id())
							{
								if (network_has_control_of_entity(get_vehicle_ped_is_in(player_ped_id(), false)))
								{
									if (!is_entity_a_mission_entity(get_vehicle_ped_is_in(player_ped_id(), false)))
									{
										set_entity_as_mission_entity(get_vehicle_ped_is_in(player_ped_id(), false), false, false);
									}
								}
								else
								{
									network_request_control_of_entity(get_vehicle_ped_is_in(player_ped_id(), false));
									return;
								}
							}
						}
						...
						{
							network_register_entity_as_networked(get_vehicle_ped_is_in(player_ped_id(), false));
							return;
						}
					}
				}
					...
					if (func_551())
					{
						if (is_ped_in_any_vehicle(player_ped_id(), false))
						{
							if (network_get_entity_is_networked(get_vehicle_ped_is_in(player_ped_id(), false)))
							{
								if (network_has_control_of_entity(get_vehicle_ped_is_in(player_ped_id(), false)))
								{
									set_vehicle_doors_locked_for_all_players(get_vehicle_ped_is_in(player_ped_id(), false), true);
									set_vehicle_doors_locked(get_vehicle_ped_is_in(player_ped_id(), false), 4);
									set_vehicle_respects_locks_when_has_driver(get_vehicle_ped_is_in(player_ped_id(), false), true);
								}
							}
						}
					}
				}
				reset_ped_in_vehicle_context(iLocal_90);
				iLocal_292 = 2;
			}
			break;
		...
		case 2:
			...
			if (func_365(player_ped_id(), 1))
			{
				if (func_363(&sVar1, 0))
				{
					iLocal_48 = get_follow_vehicle_cam_view_mode();
					iVar2 = get_follow_ped_cam_view_mode();
		...
		case 3:
			...
			if (((is_control_just_pressed(2, 187) || (_is_using_keyboard(2) && is_control_just_pressed(2, 242))) || (_is_using_keyboard(2) && is_disabled_control_just_pressed(0, 33))) || (((is_pc_version() && !_is_using_keyboard(2)) && iVar4 > 100) && (get_game_timer() - iLocal_87) > 300))
			{
				play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			...
			else if (((is_control_just_pressed(2, 188) || (_is_using_keyboard(2) && is_control_just_pressed(2, 241))) || (_is_using_keyboard(2) && is_disabled_control_just_pressed(0, 32))) || (((is_pc_version() && !_is_using_keyboard(2)) && iVar4 < -100) && (get_game_timer() - iLocal_87) > 300))
			{
				play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
				func_492("UP pressed!");
				if (iLocal_68 > 0)
...
void func_234(int iParam0)
{
	...
	{
		network_spent_prostitutes(iParam0, false, false);
	}
	else
	{
...
int func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!net_gameserver_is_session_valid(func_140()) || net_gameserver_is_session_refresh_pending())
		{
			Global_4535607 = 1;
			return 0;
		}
...
void func_252(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_254() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_254() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_253(bParam0));
...
void func_281(bool bParam0)
{
	...
	{
		set_mobile_radio_enabled_during_gameplay(bParam0);
		set_mobile_phone_radio_state(bParam0);
	}
}
...
void func_284()
{
	...
	else
	{
		...
		if (iLocal_289 == 0)
		{
			...
			request_script_audio_bank("PROSTITUTE_BLOWJOB", false, -1);
			iLocal_288 = 0;
		}
		...
		if (iVar5 == 1 && Global_23150.f_6119)
		{
			...
			if (get_hash_key(&(Global_23150.f_5081)) != 0 && Global_23150.f_5157 != -1)
			{
				...
				if (Global_23150.f_5159 != 0)
				{
					...
					draw_sprite(func_319(Global_23150.f_5159), func_316(Global_23150.f_5159, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
			...
			if (get_hash_key(&(Global_4539885.f_21)) != 0 && Global_4539885.f_65 != -1)
			{
				...
				if (Global_4539885.f_67 != 0)
				{
					...
					draw_sprite(func_319(Global_4539885.f_67), func_316(Global_4539885.f_67, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
				fVar49 = (fVar49 + (((get_rendered_character_height(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_326(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_326(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_319(26), func_316(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
										if (func_326(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_326(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_319(27), func_316(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
									}
												...
												if (func_326(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_326(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_319(Global_23150.f_4824[(iVar22 + iVar28)]), func_316(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_319(Global_23150.f_4824[(iVar22 + iVar28)]), func_316(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
									...
									if (get_hash_key(&(Global_23150.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_300() && _get_number_of_references_of_script_with_name_hash(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													if (Global_23150.f_2130[iVar24])
												...
												if (func_326(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_326(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																draw_sprite(func_319(Global_23150.f_4824[(iVar22 + iVar14)]), func_316(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (Global_23147 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_319(Global_23150.f_4824[(iVar22 + iVar14)]), func_316(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_319(Global_23150.f_4824[(iVar22 + iVar14)]), func_316(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
													}
									...
									if (func_326(Global_23150.f_4824[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_326(Global_23150.f_4824[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												draw_sprite(func_319(Global_23150.f_4824[iVar22]), func_316(Global_23150.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_297(Global_23150.f_4824[iVar22])), (fVar37 * func_297(Global_23150.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
											}
										}
									}
								}
...
int func_328(bool bParam0, bool bParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_30(8, -1) && func_329() != 65)) || (get_pause_menu_state() != 0 && !bParam1)) || (is_player_switch_in_progress() && !bParam0)) || is_commerce_store_open()) || Global_78579) || Global_23150.f_8807) || is_warning_message_active()) || Global_100493.f_1458)
	{
		return 0;
	}
	return 1;
...
void func_331()
{
	...
	{
		iLocal_295 = func_349();
		func_340(&iLocal_295, 0, 0, get_random_int_in_range(1, 2), 0, 0, 0);
	}
...
int func_349()
{
	...
	func_347(&uVar0, get_clock_seconds());
	func_346(&uVar0, get_clock_minutes());
	func_345(&uVar0, get_clock_hours());
	func_343(&uVar0, get_clock_day_of_month());
	func_344(&uVar0, get_clock_month());
	func_342(&uVar0, get_clock_year());
	return uVar0;
}
...
int func_363(char* sParam0, int iParam1)
{
	...
	if (network_is_game_in_progress() && func_364(player_id()))
	{
...
int func_365(int iParam0, bool bParam1)
{
	...
	else if (!is_entity_playing_anim(iParam0, func_50(player_ped_id(), 0, 0), func_110(bParam1), 3) && get_script_task_status(iParam0, -2017877118) != 1)
	{
		if (func_551())
		{
			if (iParam0 == player_ped_id())
			{
				if (!func_205(player_id()))
				{
					...
					if (!func_524(256))
					{
						func_196(256);
						iLocal_84 = iVar0;
						iLocal_85 = get_ped_texture_variation(player_ped_id(), 6);
						set_ped_component_variation(player_ped_id(), 6, 1, 0, 0);
						func_196(1024);
					}
				}
				task_play_anim(iParam0, func_50(player_ped_id(), 0, 0), func_366(bParam1), 2f, -8f, -1, 0, 0f, false, false, false);
			}
			else
			{
				task_play_anim(iParam0, func_50(player_ped_id(), 0, 0), func_366(bParam1), 2f, -8f, -1, 0, 0f, false, false, false);
	...
	{
		if (is_entity_playing_anim(iParam0, func_50(player_ped_id(), 0, 0), func_366(bParam1), 3))
		{
			if (get_entity_anim_current_time(iParam0, func_50(player_ped_id(), 0, 0), func_366(bParam1)) >= 0.95f)
			{
				task_play_anim(iParam0, func_50(player_ped_id(), 0, 0), func_110(bParam1), 8f, -2f, -1, 1, 0f, false, false, false);
			}
		}
		if (is_entity_playing_anim(iParam0, func_50(player_ped_id(), 0, 0), func_110(bParam1), 3))
		{
			return 1;
		}
	}
...
void func_369()
{
	...
	stop_current_playing_ambient_speech(iLocal_90);
	if (!is_any_speech_playing(iLocal_90))
	{
		if (iLocal_70 < 1)
		{
			play_ped_ambient_speech_native(iLocal_90, "HOOKER_OFFER_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else
		{
			play_ped_ambient_speech_native(iLocal_90, "HOOKER_OFFER_AGAIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
	}
}
...
int func_370()
{
	if (func_371(0, -1, 0) && request_script_audio_bank("SCRIPT\HUD_321_GO", true, -1))
	{
		return 1;
	}
	return 0;
...
void func_373()
{
	...
	if (does_entity_exist(iLocal_90))
	{
		iLocal_58 = get_entity_health(iLocal_90);
	}
}
...
void func_374()
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			if (does_entity_exist(iVar0))
			{
				Local_56 = { get_entity_coords(iVar0, true) };
			}
		}
	}
}
	...
	if (get_player_wanted_level(player_id()) == 0)
	{
		if (is_player_playing(player_id()))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				...
				if (!iLocal_93 == 0)
				{
					if ((is_vehicle_driveable(iLocal_93, false) && !is_entity_on_fire(iLocal_93)) && !is_entity_upsidedown(iLocal_93))
					{
...
int func_379(int iParam0)
{
	...
	Var1 = { get_entity_coords(iLocal_93, true) };
	if (iLocal_299[iParam0] == 0)
	{
		if (get_entity_model(iLocal_93) == joaat("tyrant"))
		{
			iLocal_299[iParam0] = start_shape_test_swept_sphere(Var0, Var1, 0.1f, 511, iLocal_93, 3);
		}
		else if (((get_entity_model(iLocal_93) == joaat("casco") || get_entity_model(iLocal_93) == joaat("feltzer3")) || get_entity_model(iLocal_93) == joaat("fagaloa")) || get_entity_model(iLocal_93) == joaat("warrener2"))
		{
			iLocal_299[iParam0] = start_shape_test_swept_sphere(Var0, Var1, 0.15f, 511, iLocal_93, 3);
		}
		else
		{
			iLocal_299[iParam0] = start_shape_test_swept_sphere(Var0, Var1, 0.25f, 511, iLocal_93, 3);
		}
	}
	else
	{
		switch (get_shape_test_result(iLocal_299[iParam0], &iVar2, &uVar3, &uVar4, &uVar5))
		{
			case 2:
...
void func_381()
{
	if (func_386() && !is_ped_in_any_vehicle(player_ped_id(), true))
	{
		iLocal_286 = 9;
		func_384(iLocal_90);
		func_384(player_ped_id());
		func_382();
		func_40(&iLocal_98);
	}
}
...
void func_382()
{
	...
	if (!does_cam_exist(iLocal_96))
	{
		iLocal_96 = create_cam("DEFAULT_SCRIPTED_CAMERA", true);
	}
	if (!does_cam_exist(iLocal_97))
	{
		iLocal_97 = create_cam("DEFAULT_SCRIPTED_CAMERA", true);
	}
	func_383(&Var0, &Var1);
	set_cam_coord(iLocal_96, Var0);
	set_cam_rot(iLocal_96, Var0.f_3, 2);
	set_cam_fov(iLocal_96, Var0.f_6);
	set_cam_coord(iLocal_97, Var1);
	set_cam_rot(iLocal_97, Var1.f_3, 2);
	set_cam_fov(iLocal_97, Var1.f_6);
	set_cam_active(iLocal_96, true);
	set_cam_active(iLocal_97, false);
	render_script_cams(true, false, 3000, true, false, 0);
}
...
void func_384(int iParam0)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		task_follow_nav_mesh_to_coord(0, func_385(), 1f, -1, 0.5f, 8192, 40000f);
		close_sequence_task(iVar0);
		task_perform_sequence(iParam0, iVar0);
		clear_sequence_task(&iVar0);
	}
...
bool func_386()
{
	return vdist2(get_entity_coords(player_ped_id(), true), func_388()) < (func_387() * func_387());
}
...
void func_389()
{
	...
	if (func_377() && is_ped_in_vehicle(iLocal_90, iLocal_93, false))
	{
		if (is_vehicle_stopped(iLocal_93) && is_vehicle_on_all_wheels(iLocal_93))
		{
			if ((func_396() && !func_386()) && !func_395())
			{
				...
				{
					iLocal_83 = add_navmesh_blocking_object(get_entity_coords(iLocal_93, false), 40f, 40f, 40f, get_entity_heading(iLocal_93), false, 7);
					set_player_control(player_id(), false, 896);
					func_482(&iLocal_49, 2048);
					iLocal_94 = 0;
					add_relationship_group("ProstituteInPlay", &iLocal_298);
					set_relationship_between_groups(1, iLocal_298, joaat("player"));
					set_ped_relationship_group_hash(iLocal_90, iLocal_298);
			...
			{
				if ((!is_any_speech_playing(player_ped_id()) && func_7(&iLocal_101) > 15f) && func_392())
				{
...
void func_391()
{
	...
	if (!is_any_speech_playing(iLocal_90))
	{
		play_ped_ambient_speech_native(iLocal_90, "HOOKER_SECLUDED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}
...
void func_393()
{
	if (func_551())
	{
		set_ped_config_flag(iLocal_90, 229, true);
		set_ped_config_flag(iLocal_90, 26, true);
		set_ped_config_flag(iLocal_90, 115, true);
		set_blocking_of_non_temporary_events(iLocal_90, true);
	}
}
...
void func_394()
{
	...
	{
		if (get_game_timer() > iLocal_82)
		{
			if (iLocal_94 == 0)
			{
				Var0 = { get_entity_coords(iLocal_93, true) };
				get_ground_z_for_3d_coord(Var0, &fVar2, false, false);
				Var0.f_2 = (fVar2 + 0.15f);
				Var1 = { get_offset_from_entity_in_world_coords(iLocal_93, 0f, 0f, -2f) };
				iLocal_94 = start_shape_test_capsule(Var0, Var1, 2f, 511, iLocal_93, 7);
			}
			else if (get_shape_test_result_including_material(iLocal_94, &iVar4, &uVar5, &uVar6, &iVar3, &uVar7) == 2)
			{
				if (iVar4 != 0)
				{
...
int func_395()
{
	...
	if (is_vehicle_driveable(iVar0, false))
	{
		if (!is_vehicle_seat_free(iVar0, 0, false))
		{
			if (is_entity_in_water(player_ped_id()) || is_entity_in_water(get_vehicle_ped_is_in(player_ped_id(), false)))
			{
				return 1;
			}
		}
...
int func_396()
{
	...
	if (!is_entity_dead(player_ped_id(), false))
	{
		...
		if (does_scenario_of_type_exist_in_area(Var1, func_65(0), 12f, false) || does_scenario_of_type_exist_in_area(Var1, func_65(1), 12f, false))
		{
			return 0;
		}
		if (func_402())
		...
		if (func_90(get_entity_coords(player_ped_id(), true), (30f * 0.5f)))
		{
			return 0;
		}
		if (!is_entry_point_for_seat_clear(iLocal_90, iLocal_93, 0, false, false))
		{
			return 0;
		}
		set_scenario_peds_to_be_returned_by_next_command(true);
		if (get_closest_ped(Var1, 20f, true, true, &iVar0, false, true, -1))
		{
			if (does_entity_exist(iVar0))
			{
				if (!is_entity_dead(iVar0, false))
				{
					if (has_entity_clear_los_to_entity(iVar0, iLocal_93, 17))
					{
						return 0;
					}
				}
...
int func_400(struct<3> Param0)
{
	...
	iVar0 = get_nth_closest_vehicle_node_id(get_entity_coords(player_ped_id(), false), 1, 1, 3f, 0f);
	get_vehicle_node_position(iVar0, &Param0);
	if (get_vehicle_node_is_gps_allowed(iVar0))
	{
		if (!get_vehicle_node_is_switched_off(iVar0))
		{
			if (vdist2(get_entity_coords(player_ped_id(), false), Param0) > 400f)
			{
				return 1;
			}
		}
		else if (vdist2(get_entity_coords(player_ped_id(), false), Param0) > 56.25f)
		{
			return 1;
		}
	}
	else if (!get_vehicle_node_is_switched_off(iVar0))
	{
		if (vdist2(get_entity_coords(player_ped_id(), false), Param0) > 400f)
		{
			return 1;
	...
	{
		iVar0 = get_nth_closest_vehicle_node_id(get_entity_coords(player_ped_id(), false), 1, 8, 3f, 0f);
		get_vehicle_node_position(iVar0, &Param0);
		if (vdist2(get_entity_coords(player_ped_id(), false), Param0) > 400f)
		{
			return 1;
...
int func_401(int iParam0, var* uParam1)
{
	...
	Var0[0 /*3*/] = { get_offset_from_entity_in_world_coords(iParam0, 2f, 0f, 0f) };
	Var0[1 /*3*/] = { get_offset_from_entity_in_world_coords(iParam0, -2f, 0f, 0f) };
	Var0[2 /*3*/] = { get_offset_from_entity_in_world_coords(iParam0, 0f, 2f, 0f) };
	Var0[3 /*3*/] = { get_offset_from_entity_in_world_coords(iParam0, 0f, -2f, 0f) };
	if (get_closest_major_vehicle_node(Var0[0 /*3*/], uParam1, 3f, 0))
	{
		return 1;
	}
	else if (get_closest_major_vehicle_node(Var0[1 /*3*/], uParam1, 3f, 0))
	{
		return 1;
	}
	else if (get_closest_major_vehicle_node(Var0[2 /*3*/], uParam1, 3f, 0))
	{
		return 1;
	}
	else if (get_closest_major_vehicle_node(Var0[3 /*3*/], uParam1, 3f, 0))
	{
		return 1;
	}
	return 0;
...
int func_403()
{
	if (_get_number_of_references_of_script_with_name_hash(joaat("carwash1")) > 0 || _get_number_of_references_of_script_with_name_hash(joaat("carwash2")) > 0)
	{
		return 1;
	}
	return 0;
...
void func_411()
{
	if (!is_entity_dead(iLocal_90, false))
	{
		if (is_entity_at_entity(iLocal_90, player_ped_id(), 5f, 5f, 5f, false, true, 0) || func_491(iLocal_49, 8192))
		{
			disable_control_action(0, 101, true);
			disable_control_action(0, 74, true);
			set_input_exclusive(0, 51);
			if (is_ped_in_any_vehicle(player_ped_id(), false) && is_ped_in_any_vehicle(iLocal_90, false))
			{
				set_entity_lod_dist(iLocal_90, 50);
				set_ped_lod_multiplier(iLocal_90, 5f);
				if (func_491(iLocal_49, 16))
				{
					if (is_player_playing(player_id()))
					{
				...
				if (is_vehicle_driveable(iLocal_93, false))
				{
					if (is_ped_sitting_in_vehicle(iLocal_90, iLocal_93) && is_ped_in_vehicle(player_ped_id(), iLocal_93, false))
					{
						...
						if (func_491(iLocal_49, 8))
						{
							if (has_clip_set_loaded(func_92()))
							{
								...
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_RESTRICTED_PASSENGER"));
								}
								else if (func_427(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_RESTRICTED_NOAMBIENT_PASSENGER"));
								}
								else if (func_426(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_LOWRIDER_PASSENGER"));
								}
								else if (func_425(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_LOWRIDER2_PASSENGER"));
								}
								else if (func_424(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
								}
								else if (func_423(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
								}
								else if (func_422(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
								}
								else if (func_421(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
								}
								else if (func_420(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
								}
								else if (func_419(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_RESTRICTED_SCHLAGEN_PASSENGER"));
								}
								else if (func_418(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_NEO_PASSENGER"));
								}
								else if (func_417(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_PEYOTE2_PASSENGER"));
								}
								else if (func_416(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_ZR350_PASSENGER"));
								}
								else if (func_415(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_IGNUS_PASSENGER"));
								}
								else if (func_414(iLocal_93))
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_ZENO_PASSENGER"));
								}
								else
								{
									set_ped_in_vehicle_context(iLocal_90, get_hash_key("MINI_PROSTITUTE_LOW_PASSENGER"));
								}
							}
						}
						if (func_551())
						{
							set_entity_as_mission_entity(iLocal_90, false, false);
						}
						else
						{
							set_entity_as_mission_entity(iLocal_90, true, true);
						}
						func_182(iLocal_90, 0);
						func_391();
						iLocal_62 = get_game_timer();
			...
			{
				if ((func_413(iLocal_90, player_ped_id(), 1) > 11f || func_412(20f)) || !is_ped_in_vehicle(player_ped_id(), iLocal_93, false))
				{
					func_115(&iLocal_107);
					if (!is_ped_in_any_vehicle(iLocal_90, false))
					{
						clear_ped_tasks(iLocal_90);
						func_473(0);
				...
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					...
					else if (!is_entry_point_for_seat_clear(iLocal_90, iLocal_93, 0, false, false))
					{
						if (!func_112())
						{
...
void func_429(var uParam0)
{
	...
	if (func_121(&iLocal_107) >= 20f || !is_entity_at_entity(iLocal_90, player_ped_id(), 3f, 3f, 3f, false, true, 0))
	{
		if (func_491(iLocal_73, 524288))
		{
			func_115(&iLocal_107);
	...
	func_69(iLocal_90);
	if (((is_entity_at_entity(iLocal_90, player_ped_id(), 3f, 3f, 3f, false, true, 0) || func_491(iLocal_73, 1)) && !func_217(0)) && !func_402())
	{
		if (!is_entry_point_for_seat_clear(iLocal_90, iLocal_93, 0, false, false))
		{
			if (!func_112())
	...
	else if (func_470("PROS_ACCEPT"))
	{
		...
		if (func_551())
		{
			iVar0 = get_script_task_status(iLocal_90, -2017877118);
			if (iVar0 != 1 && iVar0 != 0)
			{
				func_542();
				func_536(uParam0);
...
void func_430()
{
	...
	{
		func_433();
		if (func_431(iLocal_72, 1) || is_player_pressing_horn(player_id()))
		{
			play_ped_ambient_speech_native(player_ped_id(), "HOOKER_REQUEST", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		...
		if (func_491(iLocal_49, 8192))
		{
			func_468();
			Global_32110 = 1;
			Global_2689235[player_id() /*453*/].f_420 = 1;
			func_131("PROSTITUTES_SOLICIT_SCENE");
			func_87("PROSTITUTES_DRIVE_SCENE");
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (get_script_task_status(iLocal_90, -1794415470) != 1 && !is_ped_in_vehicle(iLocal_90, get_vehicle_ped_is_in(player_ped_id(), false), true))
				{
					task_enter_vehicle(iLocal_90, iLocal_93, -1, 0, 1f, 8388609, 0);
				}
			}
			sLocal_61 = func_50(player_ped_id(), 1, 0);
			request_anim_dict(sLocal_61);
			sLocal_61 = func_50(player_ped_id(), 0, 1);
			request_anim_dict(sLocal_61);
			func_40(&iLocal_101);
			iLocal_286 = 5;
		}
...
int func_437()
{
	...
	if (!func_551())
	{
		...
		else if (func_491(iLocal_49, 4194304))
		{
			...
			open_sequence_task(&iVar1);
			task_play_anim(0, func_67(iLocal_284), func_66(5), 2f, -2f, -1, 0, 0f, false, false, false);
			task_play_anim(0, func_67(iLocal_284), func_66(iVar0), 8f, -8f, -1, 1, 0f, false, false, false);
			close_sequence_task(iVar1);
			task_perform_sequence(iLocal_90, iVar1);
			clear_sequence_task(&iVar1);
		}
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (network_has_control_of_entity(iLocal_90))
			{
				task_play_anim(iLocal_90, func_67(iLocal_284), func_66(5), 2f, -2f, -1, 0, 0f, false, false, false);
				iLocal_55 = 2;
			}
			else
			{
		...
		case 2:
			if (network_has_control_of_entity(iLocal_90))
			{
				...
				{
					iVar0 = get_random_int_in_range(8, 11);
					task_play_anim(iLocal_90, func_67(iLocal_284), func_66(iVar0), 8f, -8f, -1, 1, 0f, false, false, false);
					iLocal_55 = 3;
				}
			}
			else
...
int func_438(bool bParam0)
{
	...
	if (func_413(iLocal_90, player_ped_id(), 1) > 11f)
	{
		return 0;
	}
	if (!is_ped_in_any_vehicle(player_ped_id(), false))
	...
	if (func_551())
	{
		if (get_vehicle_number_of_passengers(get_vehicle_ped_is_in(player_ped_id(), false), false, true) > 1)
		{
			return 0;
		}
	}
	if (bParam0)
	{
		if (get_entity_speed(get_vehicle_ped_is_in(player_ped_id(), false)) > 2f)
		{
			return 0;
		}
	}
	if (func_90(get_entity_coords(iLocal_90, true), 1106247680))
	{
		if (!func_491(iLocal_50, 8192) && !is_ped_in_any_police_vehicle(player_ped_id()))
		{
	...
	if (!func_377())
	{
		if (!func_551())
		{
			if ((!iLocal_86 && !Global_112433) && func_440(player_ped_id(), 0) == -1)
			{
				func_350("PROS_CAR", -1);
				iLocal_86 = 1;
			}
...
void func_439()
{
	...
	{
		if (!is_any_speech_playing(player_ped_id()) && !is_any_speech_playing(iLocal_90))
		{
			play_ped_ambient_speech_native(player_ped_id(), "HOOKER_CAR_INCORRECT", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
...
void func_441()
{
	...
	{
		func_430();
		if (get_script_task_status(iLocal_90, 242628503) == 7 && !func_491(iLocal_49, 8192))
		{
			if (func_72(1))
			{
				func_115(&iLocal_107);
...
void func_443(var uParam0)
{
	...
	if (!does_entity_exist(iLocal_93))
	{
		return;
	}
	get_model_dimensions(get_entity_model(iLocal_93), &Var2, &Var1);
	Var0 = { Var1 - Var2 };
	Var0 = { Var0 / Vector(2f, 2f, 2f) };
	Var3 = { get_offset_from_entity_in_world_coords(iLocal_93, -(Var0.f_0 + 0.2f), 0f, 0f) };
	Var4 = { get_offset_from_entity_in_world_coords(iLocal_93, (Var0.f_0 + 0.2f), 0f, 0f) };
	Var5 = { get_entity_coords(iLocal_90, true) };
	if (vdist(Var5, Var4) < vdist(Var5, Var3))
	{
		Var3 = { Var4 };
	}
	if ((get_script_task_status(iLocal_90, -1794415470) != 1 || !func_491(iLocal_49, 8192)) && vdist2(Local_89, Var3) > 0f)
	{
		if (func_551())
		{
			if (!is_entity_a_mission_entity(iLocal_90))
			{
				set_entity_as_mission_entity(iLocal_90, false, true);
			}
		...
		task_follow_nav_mesh_to_coord(0, Var3.f_0, Var3.f_1, Var3.f_2, 1f, -1, 1f, 8192, 40000f);
		task_turn_ped_to_face_coord(0, get_ped_bone_coords(player_ped_id(), 31086, 0f, 0f, 0f), 0);
		close_sequence_task(iVar6);
		task_perform_sequence(iLocal_90, iVar6);
	...
	if (func_438(1))
	{
		...
		if (func_471(&iLocal_107, 2f) || func_491(iLocal_49, 8192))
		{
			...
			if (func_363(&sVar0, 0))
			{
				...
				task_look_at_entity(player_ped_id(), iLocal_90, -1, 2048, 4);
				func_443(uParam0);
				func_482(&iLocal_49, 4);
				Global_32110 = 1;
				Global_2689235[player_id() /*453*/].f_420 = 1;
			...
			{
				if (are_strings_equal(func_467(&sVar0), "PIM_HHIDCR"))
				{
				...
				func_5(&iLocal_49, 4);
				Global_32110 = 0;
				Global_2689235[player_id() /*453*/].f_420 = 0;
			}
		}
	}
	else
...
void func_457(int iParam0, int iParam1, int iParam2)
{
	...
	if (network_is_game_in_progress() && func_461(player_id(), 1, 0))
	{
		return;
	}
	...
	{
		if (!Global_100493.f_1458 && !is_commerce_store_open())
		{
			iVar0 = 18;
...
int func_485()
{
	...
	iLocal_92 = get_random_vehicle_in_sphere(get_entity_coords(iLocal_90, true), 15f, 0, 6);
	if (does_entity_exist(iLocal_92) && !is_entity_dead(iLocal_92, false))
	{
		if (is_vehicle_driveable(iLocal_92, false))
		{
			if (func_91(&iLocal_92) && !func_487(iLocal_92, 1))
			{
				iLocal_91 = get_ped_in_vehicle_seat(iLocal_92, -1, false);
				if (!iLocal_91 == 0)
				{
					if (func_486(&iLocal_91))
					{
						iVar0 = get_entity_model(iLocal_92);
						if (!iVar0 == joaat("taxi") && !iVar0 == joaat("taxi"))
						{
							if (!is_entity_a_mission_entity(iLocal_91))
							{
								set_entity_as_mission_entity(iLocal_91, true, false);
							}
							if (!is_entity_a_mission_entity(iLocal_92))
							{
								set_entity_as_mission_entity(iLocal_92, true, false);
							}
							set_blocking_of_non_temporary_events(iLocal_91, true);
							set_entity_load_collision_flag(iLocal_91, false, 1);
							set_entity_load_collision_flag(iLocal_92, false, 1);
							return 1;
						}
					}
				}
...
int func_487(int iParam0, bool bParam1)
{
	if (Global_78319)
	{
		...
		{
			if (decor_exist_on(iParam0, "Company_SUV"))
			{
				return 1;
			}
		}
...
int func_488()
{
	if (is_entity_dead(player_ped_id(), false) || is_entity_dead(iLocal_90, false))
	{
		return 0;
	}
	return 1;
...
int func_489()
{
	if ((!func_488() || !is_ped_in_any_vehicle(player_ped_id(), false)) || func_491(iLocal_49, 4096))
	{
		return 0;
	}
	if (func_491(iLocal_49, 32))
...
void func_490()
{
	if (!is_entity_dead(iLocal_90, false))
	{
		if (!is_ped_fleeing(iLocal_90))
		{
			if (get_script_task_status(iLocal_90, 1805844857) != 1)
			{
				set_blocking_of_non_temporary_events(iLocal_90, false);
				set_ped_flee_attributes(iLocal_90, 196628, true);
				set_ped_should_play_immediate_scenario_exit(iLocal_90);
				task_smart_flee_ped(iLocal_90, player_ped_id(), 300f, -1, true, false);
...
int func_493()
{
	...
	if (get_script_task_status(iLocal_90, 1435919172) == 1)
	{
		return 0;
	}
	if (is_ped_using_any_scenario(iLocal_90))
	{
		return 0;
	}
	return 1;
	...
	switch (iLocal_291)
	{
		...
		case 3:
			if (!is_ped_injured(iLocal_90))
			{
				...
				{
					set_blocking_of_non_temporary_events(iLocal_90, false);
					set_ped_can_evasive_dive(iLocal_90, false);
				...
				else
				{
					...
					func_469(&uLocal_116, 4, iLocal_90, "Prostitutes", 0, 1);
					set_ped_can_evasive_dive(iLocal_90, false);
					set_ped_should_play_normal_scenario_exit(iLocal_90);
					return 1;
				}
			}
			break;
...
int func_499()
{
	if (is_player_switch_in_progress())
	{
		if (func_23() == 0)
		{
			...
			{
				if (!does_entity_belong_to_this_script(iLocal_90, true))
				{
					if (func_551())
					{
						set_entity_as_mission_entity(iLocal_90, false, false);
...
float func_500(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
int func_501()
{
	if (is_ped_using_scenario(iLocal_90, func_65(0)))
	{
		if (is_scripted_scenario_ped_using_conditional_anim(iLocal_90, "amb@world_human_prostitute@crackhooker@base", "base"))
		{
			return 0;
		}
		if (is_scripted_scenario_ped_using_conditional_anim(iLocal_90, "amb@world_human_prostitute@cokehead@base", "base"))
		{
			return 1;
		}
	}
	if (is_ped_using_scenario(iLocal_90, func_65(1)))
	{
		if (is_scripted_scenario_ped_using_conditional_anim(iLocal_90, "amb@world_human_prostitute@french@base", "base"))
		{
			return 3;
		}
		if (is_scripted_scenario_ped_using_conditional_anim(iLocal_90, "amb@world_human_prostitute@hooker@base", "base"))
		{
			return 2;
		}
	}
...
void func_503(int iParam0)
{
	...
	{
		if (!is_ped_headtracking_ped(iLocal_90, iParam0))
		{
			if (func_551())
			{
				if (network_has_control_of_entity(iLocal_90))
				{
					task_clear_look_at(iLocal_90);
					task_look_at_entity(iLocal_90, iParam0, -1, 2048, 4);
				}
			}
			else
			{
	...
	else if (is_ped_headtracking_ped(iLocal_90, iParam0))
	{
		if (func_551())
		{
			if (network_has_control_of_entity(iLocal_90))
...
void func_504()
{
	if (Global_32110)
	{
		if (is_vehicle_driveable(iLocal_93, false))
		{
			if (is_ped_in_vehicle(iLocal_90, iLocal_93, false))
			{
				func_505();
			}
		}
	...
	if (is_entity_dead(iLocal_90, false) || !does_entity_exist(iLocal_90))
	{
		if (Global_32114 != get_id_of_this_thread() && func_491(iLocal_49, 32))
		{
			func_5(&iLocal_49, 32);
		}
		return;
	}
	if ((vdist2(get_entity_coords(iLocal_90, true), get_entity_coords(player_ped_id(), true)) < Global_32113 || Global_32113 == 0f) && iLocal_287 != 4)
	{
		Global_32113 = vdist2(get_entity_coords(iLocal_90, true), get_entity_coords(player_ped_id(), true));
		Global_32114 = get_id_of_this_thread();
		func_482(&iLocal_49, 32);
	}
	else if (Global_32114 == get_id_of_this_thread())
	{
		Global_32113 = vdist2(get_entity_coords(iLocal_90, true), get_entity_coords(player_ped_id(), true));
	}
	else
...
void func_505()
{
	if (func_551())
	{
		if (network_has_control_of_entity(iLocal_90))
		{
			set_ped_reset_flag(iLocal_90, 323, true);
		}
	}
	else
	{
...
void func_506(var uParam0)
{
	if (!iLocal_286 == 12)
	{
		if (!is_entity_dead(iLocal_90, false) && !is_entity_dead(player_ped_id(), false))
		{
			if (func_510())
			{
				if (func_551())
				{
					...
					if (!is_entity_a_mission_entity(iLocal_90))
					{
						set_entity_as_mission_entity(iLocal_90, true, false);
					}
					task_smart_flee_ped(iLocal_90, player_ped_id(), 300f, -1, false, false);
					set_ped_keep_task(iLocal_90, true);
					clear_ped_tasks(player_ped_id());
					func_542();
					func_536(uParam0);
			...
			else if (has_entity_been_damaged_by_entity(iLocal_90, player_ped_id(), true))
			{
				iLocal_65++;
				if (iLocal_65 >= 2)
				{
				...
				else
				{
					...
					clear_entity_last_damage_entity(iLocal_90);
				}
			}
			else if (func_508())
			{
...
void func_507()
{
	...
	stop_current_playing_ambient_speech(iLocal_90);
	play_ped_ambient_speech_native(iLocal_90, "APOLOGY_NO_TROUBLE", "SPEECH_PARAMS_FORCE_SHOUTED_CRITICAL", 1);
}
...
int func_509()
{
	...
	else if (does_entity_exist(get_vehicle_ped_is_in(player_ped_id(), false)))
	{
		if (network_get_entity_is_networked(get_vehicle_ped_is_in(player_ped_id(), false)))
		{
			if (get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), -1, false) == player_ped_id())
...
int func_510()
{
	...
	if (!func_491(iLocal_49, 4096))
	{
		if (func_413(iLocal_90, player_ped_id(), 1) < 30f)
		{
			Var0 = { get_entity_coords(iLocal_90, true) };
			if ((((((is_shocking_event_in_sphere(88, Var0, 30f) || is_shocking_event_in_sphere(91, Var0, 30f)) || is_shocking_event_in_sphere(90, Var0, 30f)) || is_shocking_event_in_sphere(104, Var0, 30f)) || is_shocking_event_in_sphere(116, Var0, 30f)) || (is_shocking_event_in_sphere(114, Var0, 30f) && !func_551())) || is_ped_shooting(player_ped_id()))
			{
				if (!func_551())
				{
					set_blocking_of_non_temporary_events(iLocal_90, false);
...
int func_511()
{
	if ((does_entity_exist(iLocal_90) && !is_entity_dead(iLocal_90, false)) && !is_entity_dead(player_ped_id(), false))
	{
		if (func_551())
		{
			if (func_553(player_id(), 0))
			{
		...
		if (!is_ped_injured(iLocal_90))
		{
			if (!is_ped_in_any_vehicle(iLocal_90, false))
			{
				if (!func_513(9))
				{
					if (!is_entity_dead(iLocal_90, false) && !is_entity_dead(player_ped_id(), false))
					{
						if (is_entity_at_entity(iLocal_90, player_ped_id(), 100f, 100f, 50f, false, true, 0))
						{
							return 1;
						}
						else
				...
				else if (!(func_512() || is_player_switch_in_progress()))
				{
			...
			else if (!(func_512() || (is_player_switch_in_progress() && !func_403())))
			{
				func_492("prostitute SCRIPT SHOULD EXIT - PLAYER ON MISSION");
				func_106(0);
				func_96(15);
...
void func_517()
{
	...
	if (get_num_reserved_mission_peds(false, 0) != 1)
	{
		if (func_518(1, 0, 1))
		{
			if (get_num_created_mission_peds(false) <= 1)
			{
				reserve_network_mission_peds(1);
			}
		}
...
void func_529()
{
	...
	if (!is_player_playing(player_id()) || is_entity_dead(player_ped_id(), false))
	{
		func_2(0);
...
void func_536(var uParam0)
{
	...
	if (!is_ped_injured(iLocal_90))
	{
		if (is_entity_a_mission_entity(iLocal_90))
		{
			if ((func_551() && get_script_task_status(iLocal_90, 1805844857) != 1) && get_script_task_status(iLocal_90, -251125078) != 1)
			{
				task_wander_standard(iLocal_90, 40000f, 0);
				if (network_has_control_of_entity(iLocal_90))
				{
	...
	if (func_551())
	{
		if (does_navmesh_blocking_object_exist(iLocal_83))
		{
	...
	if (!is_entity_dead(player_ped_id(), false))
	{
		if (func_524(256))
		{
			set_ped_component_variation(player_ped_id(), 6, iLocal_84, iLocal_85, 0);
			func_196(1024);
		}
	}
	...
	if (Global_32114 == get_id_of_this_thread())
	{
		Global_32110 = 0;
		Global_2689235[player_id() /*453*/].f_420 = 0;
	}
...
void func_541(bool bParam0)
{
	if (!is_ped_injured(iLocal_90))
	{
		if (is_ped_in_any_vehicle(iLocal_90, false))
		{
			if (get_script_task_status(iLocal_90, -828834893) != 1)
			{
				task_leave_any_vehicle(iLocal_90, 0, 65536);
			}
		}
		if (bParam0)
		{
...
void func_542()
{
	...
	if (!is_entity_dead(iLocal_90, false))
	{
		...
		remove_entity_from_audio_mix_group(iLocal_90, 0f);
	}
	if (is_vehicle_driveable(iLocal_93, false) && !is_entity_dead(iLocal_93, false))
	{
		if (func_551())
		{
			if (network_has_control_of_entity(iLocal_93))
			{
				if (Global_1853348[player_id() /*834*/].f_267.f_32 <= 0 && !BitTest(Global_1853348[player_id() /*834*/].f_267.f_30, 11))
				{
					set_vehicle_handbrake(iLocal_93, false);
					set_vehicle_lights(iLocal_93, 3);
					set_vehicle_interiorlight(iLocal_93, false);
				}
				set_vehicle_automatically_attaches(iLocal_93, true, 0);
			}
		}
		else
		{
	...
	func_5(&iLocal_49, 2048);
	enable_control_action(2, 19, true);
	enable_control_action(2, 37, true);
	if (!func_539())
	{
		func_538();
	}
		...
		if (func_524(2))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (network_get_entity_is_networked(get_vehicle_ped_is_in(player_ped_id(), false)))
				{
					if (network_has_control_of_entity(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
						set_vehicle_doors_locked_for_all_players(get_vehicle_ped_is_in(player_ped_id(), false), false);
						set_vehicle_doors_locked(get_vehicle_ped_is_in(player_ped_id(), false), 1);
					}
				}
			}
			else if (network_get_entity_is_networked(iLocal_93))
			{
				if (network_has_control_of_entity(iLocal_93))
				{
					set_vehicle_doors_locked(iLocal_93, 1);
					set_vehicle_doors_locked_for_all_players(iLocal_93, false);
					set_vehicle_respects_locks_when_has_driver(iLocal_93, false);
				}
				else
				{
					network_request_control_of_entity(iLocal_93);
					set_vehicle_doors_locked(iLocal_93, 1);
					set_vehicle_doors_locked_for_all_players(iLocal_93, false);
					set_vehicle_respects_locks_when_has_driver(iLocal_93, false);
				}
...
void func_543()
{
	...
	{
		leaderboards_write_add_column(131, func_546(), 0f);
		leaderboards_write_add_column(117, func_545(), 0f);
		leaderboards_write_add_column(118, func_544(), 0f);
	}
}
		...
		if (is_ped_in_any_vehicle(iVar0, bParam1))
		{
			...
			while (iVar1 < 32)
			{
				...
				if (func_208(iVar2, 1, 1))
				{
					...
					{
						if (is_ped_in_vehicle(get_player_ped(iVar2), iVar3, bParam1))
						{
							return 1;
						}
					}
