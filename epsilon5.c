	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (func_248(1, 1093140480, 0))
			{
				...
				{
					register_entity_for_cutscene(Local_84.f_28[0], sLocal_83, 0, 0, 0);
				}
				if (func_247(player_ped_id()))
				{
...
void func_2()
{
	...
	if (iVar0 < 14)
	{
		stat_set_int(joaat("num_epsilon_step"), 14, true);
		func_202(23, 14);
	}
	func_3(322, 1);
	func_316();
...
void func_7()
{
	...
	{
		func_202(13, floor(Global_113386.f_10194.f_3853));
	}
...
int func_200()
{
	return func_201(get_this_script_name(), 0);
}
...
void func_205(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_206(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_207(iParam1)), 0));
		}
		else
		{
			func_206(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_207(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
...
void func_220(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_224(player_id())) && !func_222(player_id(), 0)) && !func_221()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_224(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_232(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_234(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_237(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_248(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_255(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_254(player_ped_id(), -828834893))
				{
...
void func_258()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (func_275(player_ped_id(), Local_84.f_28[0], 1) >= 4.5f)
			{
				if (!is_gameplay_hint_active())
				{
					if (func_274())
					{
						set_gameplay_entity_hint(Local_84.f_28[0], 0f, 0f, 0.5f, true, 30000, 2000, 2000, 0);
					}
					else
					{
						set_gameplay_entity_hint(Local_84.f_28[0], -1f, 0f, 0f, false, 30000, 2000, 2000, 0);
					}
					set_gameplay_hint_fov(fLocal_253);
					set_gameplay_hint_follow_distance_scalar(fLocal_254);
					set_gameplay_hint_base_orbit_pitch_offset(fLocal_255);
					_set_gameplay_hint_anim_offsetx(fLocal_256);
					_set_gameplay_hint_anim_offsety(fLocal_257);
			...
			if (iLocal_252 == 0)
			{
				if (func_275(player_ped_id(), Local_84.f_28[0], 1) <= 2.5f)
				{
					set_player_control(player_id(), false, 256);
					task_turn_ped_to_face_entity(player_ped_id(), Local_84.f_28[0], 0);
					iLocal_252 = 1;
				}
			}
			if (has_anim_dict_loaded("rcmepsilonism5"))
			{
				if (func_247(Local_84.f_28[0]))
				{
					if (is_entity_playing_anim(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (get_entity_anim_current_time(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							func_273(&uLocal_85, 4, Local_84.f_28[0], "MARNIE", 0, 1);
							func_273(&uLocal_85, 0, player_ped_id(), "MICHAEL", 0, 1);
							task_look_at_entity(Local_84.f_28[0], player_ped_id(), -1, 12, 2);
							task_play_anim(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0f, false, false, false);
							iLocal_82 = 2;
						}
					}
				}
		...
		case 2:
			if (func_247(Local_84.f_28[0]))
			{
				if (is_entity_playing_anim(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 3))
				{
					if (iLocal_251 == 0)
					{
						if (get_entity_anim_current_time(Local_84.f_28[0], "rcmepsilonism5", "leadin_action") >= 0.38f)
						{
					...
					if (get_entity_anim_current_time(Local_84.f_28[0], "rcmepsilonism5", "leadin_action") >= 0.95f)
					{
						iLocal_82 = 3;
					}
					if (iLocal_252 == 0)
...
void func_277()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_255(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_297(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_282(0)) || func_296(1))
			{
			}
			else
			{
...
int func_307(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_308(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_219(player_ped_id()))
				{
...
int func_308(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_309(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_316()
{
	...
	if (func_247(Local_84.f_28[0]))
	{
		set_ped_can_be_targetted(Local_84.f_28[0], false);
		set_ped_relationship_group_hash(Local_84.f_28[0], joaat("player"));
	}
...
void func_331(bool bParam0)
{
	...
	if (!func_348())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_332(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_333(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_339())
	{
		...
		{
			iVar2 = func_334(get_this_script_name());
			if (iVar2 > -1)
			{
