...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_76(iLocal_71))
			{
				if (((func_73() && !func_72()) && func_71()) && !func_70(0))
				{
					if (iLocal_73 != 0)
					{
						if (is_tracked_point_visible(iLocal_73))
						{
		...
		case 4:
			...
			{
				set_ped_capsule(iLocal_66, 0.75f);
			}
			if (!func_76(4))
			{
		...
		case 6:
			if (!func_34(3))
			{
				if (is_entity_in_angled_area(player_ped_id(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, false, true, 0))
				{
					func_33(3, 1);
				}
			}
			if (is_entity_in_angled_area(player_ped_id(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, false, true, 0))
			{
				if (func_34(3))
				{
			...
			if (!func_34(2))
			{
				if (is_entity_in_angled_area(player_ped_id(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, false, true, 0) || is_screen_faded_out())
				{
					create_model_hide(Local_58, 200f, joaat("prop_mineshaft_door"), false);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
			...
			if (func_34(1))
			{
				if (is_entity_in_angled_area(player_ped_id(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, false, true, 0))
				{
...
void func_3()
{
	switch (Global_113386.f_10049.f_134)
	{
		...
		case 1:
			...
			_set_extra_timecycle_modifier(func_4());
			play_sound_frontend(-1, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
...
bool func_22(int iParam0)
{
	...
	iVar1 = get_bits_in_range(Global_113386.f_10049.f_133, 0, (iVar0 - 1));
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		set_bit(&uLocal_78, iParam0);
	}
	else
	{
		clear_bit(&uLocal_78, iParam0);
	}
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			if (!get_mission_flag())
			{
				if (is_entity_at_coord(player_ped_id(), Local_51, Local_57, true, true, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (is_entity_at_coord(player_ped_id(), Local_52, Local_57, true, true, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(player_ped_id(), Local_55, fLocal_56);
				...
				new_load_scene_start_sphere(Local_55, 20f, 0);
				func_39(24, &iLocal_59);
				pin_interior_in_memory(iLocal_59);
				iLocal_72 = (get_game_timer() + 40000);
				while ((!is_new_load_scene_loaded() || !is_interior_ready(iLocal_59)) && iLocal_72 > get_game_timer())
				{
					wait(0);
				}
				new_load_scene_stop();
				if (iLocal_72 <= get_game_timer())
				{
					unpin_interior(iLocal_59);
					func_44(player_ped_id(), Local_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_49()
{
	...
	{
		case 0:
			if (is_entity_in_angled_area(player_ped_id(), Var0, Var1, fVar2, false, true, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
		...
		case 1:
			if (is_entity_in_angled_area(player_ped_id(), Var0, Var1, fVar2, false, true, 0) && !func_5(0))
			{
				if (!func_52(player_ped_id(), -880529684))
				{
					task_look_at_coord(player_ped_id(), -1007.995f, -476.8016f, 49.9117f, -1, 0, 2);
				}
				if (is_control_just_pressed(2, 51))
				{
					func_51(0);
					task_follow_nav_mesh_to_coord(player_ped_id(), -1007.351f, -477.5197f, 49.0282f, 1f, -1, 0.5f, false, 30.4025f);
					func_53(sLocal_77);
					display_radar(false);
...
int func_63()
{
	...
	if (get_player_wanted_level(player_id()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		set_bit(&(Global_113386.f_10049.f_133), iParam0);
		if (!bParam2)
		{
			play_sound_frontend(iLocal_69, sLocal_67, sLocal_68, false);
		}
		func_69();
	}
	else
	{
		clear_bit(&(Global_113386.f_10049.f_133), iParam0);
	}
}
...
bool func_71()
{
	return get_entity_model(player_ped_id()) == joaat("player_zero");
}
...
int func_72()
{
	if (func_67(player_ped_id()))
	{
		return is_ped_in_any_vehicle(player_ped_id(), false);
	}
	return 0;
}
...
bool func_78(struct<3> Param0)
{
	...
	return get_screen_coord_from_world_coord(Param0, &uVar0, &uVar1);
}
...
void func_82()
{
	if (func_67(player_ped_id()))
	{
		Local_70 = { get_entity_coords(player_ped_id(), false) };
	}
}
...
void func_83(struct<3> Param0)
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("murdermystery")) > 1)
	{
		terminate_this_thread();
	}
	iVar0 = 0;
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			...
			func_85(sLocal_74);
			iLocal_66 = create_ped(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, true, true);
			set_model_as_no_longer_needed(joaat("u_f_m_drowned_01"));
			task_play_anim(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0f, false, false, false);
			set_blocking_of_non_temporary_events(iLocal_66, true);
			set_ped_keep_task(iLocal_66, true);
			freeze_entity_position(iLocal_66, true);
			stop_ped_speaking(iLocal_66, true);
			disable_ped_pain_audio(iLocal_66, true);
			set_ped_config_flag(iLocal_66, 118, false);
			set_ped_config_flag(iLocal_66, 208, true);
			set_entity_invincible(iLocal_66, true);
			set_ped_relationship_group_hash(iLocal_66, joaat("player"));
			break;
		
		case 5:
			iLocal_63 = 731806707;
			add_door_to_system(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, true, true, false);
			door_system_set_door_state(iLocal_63, 1, true, false);
			iLocal_62 = create_camera_with_params(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, false, 2);
			break;
		
		case 6:
			func_86(joaat("u_m_o_filmnoir"));
			iLocal_64 = create_ped(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, true, true);
			set_ped_prop_index(iLocal_64, 0, 0, 0, false);
			set_model_as_no_longer_needed(joaat("u_m_o_filmnoir"));
			stop_ped_speaking(iLocal_64, true);
			disable_ped_pain_audio(iLocal_64, true);
			explode_ped_head(iLocal_64, joaat("weapon_sniperrifle"));
			set_ped_relationship_group_hash(iLocal_64, joaat("player"));
			iLocal_65 = create_object_no_offset(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			destroy_tracked_point(iLocal_73);
			iLocal_73 = 0;
			break;
		...
		case 4:
			...
			{
				set_ped_as_no_longer_needed(&iLocal_66);
			}
			remove_anim_dict(sLocal_74);
			break;
		
		case 5:
			if (is_door_registered_with_system(iLocal_63))
			{
				remove_door_from_system(iLocal_63, 0);
			}
			if (does_cam_exist(iLocal_62))
			{
		...
		case 6:
			...
			{
				set_ped_as_no_longer_needed(&iLocal_64);
			}
			...
			if (func_34(2))
			{
				remove_model_hide(Local_58, 200f, joaat("prop_mineshaft_door"), false);
			}
			break;
	}
}
