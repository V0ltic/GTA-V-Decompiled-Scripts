...
void __EntryFunction__()
{
	...
	if (has_force_cleanup_occurred(11))
	{
		...
		{
			if (is_ped_in_group(iLocal_54))
			{
				remove_ped_from_group(iLocal_54);
			}
		}
		func_226();
	}
	...
	{
		wait(0);
		if ((is_world_point_within_brain_activation_range() || iLocal_47 == 4) || iLocal_60 > 18)
		{
			if (!func_179())
			{
				if (func_178())
					...
					case 1:
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (!iLocal_81)
								{
									if ((is_entity_at_coord(player_ped_id(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, false, true, 0) && is_sphere_visible(Local_86, 1f)) || is_entity_at_coord(player_ped_id(), Local_86, 20f, 20f, 20f, false, true, 0))
									{
										func_149();
										func_140(1);
										iLocal_81 = 1;
								...
								{
									if (is_entity_at_coord(player_ped_id(), Local_86, 50f, 50f, 50f, false, true, 0))
									{
										func_138();
									}
									if (!is_ped_injured(iLocal_54))
									{
										if (!is_entity_at_coord(iLocal_54, Local_57, 30f, 30f, 30f, false, true, 0))
										{
											iLocal_47 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_71)
								{
									if (func_52())
									{
										if (is_entity_at_coord(player_ped_id(), Local_88, 23f, 60f, 20f, false, true, 0))
										{
											func_57(0);
											func_55();
											wait(0);
						...
						{
							if (is_entity_playing_anim(iLocal_53, "random@domestic", "f_attack_end", 3))
							{
						...
						if ((func_48() && !func_47()) && iLocal_46 != 2)
						{
							if (!is_ped_injured(iLocal_54))
							{
								if (is_entity_at_coord(iLocal_54, Local_90, 5f, 5f, 5f, false, true, 0))
								{
									if (!does_entity_exist(iLocal_91[8]))
									{
										iLocal_91[8] = create_object(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
										attach_entity_to_entity(iLocal_91[8], iLocal_54, get_ped_bone_index(iLocal_54, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, true, false, false, false, 2, true, 0);
									}
									func_46(0);
									wait(0);
									func_55();
...
void func_1()
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (does_entity_exist(iLocal_91[8]))
		{
			iLocal_92 = create_pickup_rotate(joaat("pickup_weapon_golfclub"), get_entity_coords(iLocal_91[8], true), get_entity_rotation(iLocal_91[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, true, 0);
			delete_object(&(iLocal_91[8]));
		}
		set_all_vehicle_generators_active_in_area(Local_57 - Vector(10f, 10f, 10f), Local_57 + Vector(10f, 10f, 10f), true, true);
		set_relationship_between_groups(255, iLocal_111, joaat("player"));
		if (bLocal_55)
		{
		...
		if (does_blip_exist(iLocal_85))
		{
			remove_blip(&iLocal_85);
		}
		if (does_blip_exist(uLocal_84[0]))
		{
			remove_blip(&(uLocal_84[0]));
		}
		if (does_entity_exist(iLocal_54))
		{
			if (!is_ped_injured(iLocal_54))
			{
				if (!is_ped_in_any_vehicle(iLocal_54, false))
				{
					reset_ped_last_vehicle(iLocal_54);
				}
				remove_ped_from_group(iLocal_54);
		...
		{
			if (does_entity_exist(iLocal_91[iVar0]))
			{
				detach_entity(iLocal_91[iVar0], true, true);
			}
			iVar0++;
		}
	...
	if ((!is_entity_at_coord(player_ped_id(), Local_57, 80f, 80f, 80f, false, true, 0) || has_pickup_been_collected(iLocal_92)) || !(does_entity_exist(iLocal_91[8]) && !does_pickup_exist(iLocal_92)))
	{
		func_226();
	}
}
...
int func_45()
{
	if (is_ped_injured(iLocal_53) && is_ped_injured(iLocal_54))
	{
		return 1;
	}
	return 0;
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_50(iParam3), false);
}
...
int func_52()
{
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		if (is_vehicle_driveable(iLocal_110, false))
		{
			if (!is_ped_injured(iLocal_54))
			{
				if (is_ped_sitting_in_vehicle(iLocal_54, iLocal_110))
				{
					return 1;
				}
			}
...
void func_57(bool bParam0)
{
	...
	else if ((!iLocal_63 && is_scripted_conversation_ongoing()) && !func_62())
	{
		Local_65 = { func_61() };
		Local_64 = { func_60() };
		func_58();
...
void func_81()
{
	switch (iLocal_62)
	{
		case 0:
			...
			{
				set_ped_max_move_blend_ratio(iLocal_54, 1f);
				if (is_entity_at_entity(iLocal_54, player_ped_id(), 8f, 8f, 8f, false, true, 0))
				{
					if (iLocal_60 < 19)
					{
		...
		case 1:
			...
			if (does_entity_exist(iLocal_54))
			{
				if (!is_ped_injured(iLocal_54))
				{
					...
					{
						if (is_ped_getting_into_a_vehicle(iLocal_54))
						{
							delete_object(&(iLocal_91[8]));
						}
					}
					if (is_ped_sitting_in_any_vehicle(iLocal_54))
					{
						func_125();
						func_119();
		...
		case 2:
			...
			if (is_entity_at_coord(player_ped_id(), Local_88, 10f, 10f, 10f, false, true, 0))
			{
			...
			if (does_entity_exist(iLocal_54))
			{
				if (!is_ped_injured(iLocal_54))
				{
					if (is_entity_at_coord(iLocal_54, Local_88, Global_19, true, true, 0) && func_115(1, 0, 1))
					{
						...
						if (is_ped_in_any_vehicle(iLocal_54, false))
						{
							bring_vehicle_to_halt(get_vehicle_ped_is_in(iLocal_54, false), 10.5f, 3, false);
							iLocal_62++;
						}
						else
						{
	...
	switch (iLocal_102)
	{
		...
		case 3:
			...
			if (!is_ped_injured(iLocal_54))
			{
				...
				iLocal_103 = get_game_timer() + 1000;
				iLocal_102++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_103 < get_game_timer())
			{
				...
				{
					set_player_control(player_id(), true, 0);
					iLocal_103 = get_game_timer() + 3000;
					iLocal_102++;
				}
			}
			break;
...
void func_116()
{
	...
	if (!func_155())
	{
		switch (iLocal_100)
		{
			...
			case 6:
				iLocal_101 = get_game_timer() + 1000;
				iLocal_100++;
				break;
			
			case 7:
				if (iLocal_101 < get_game_timer())
				{
					if (func_54() == 0)
					{
...
void func_117()
{
	if (!is_ped_injured(iLocal_54))
	{
		if (!iLocal_66)
		{
			...
			{
				if (!is_ped_in_vehicle(player_ped_id(), get_players_last_vehicle(), true) && is_ped_in_vehicle(iLocal_54, get_players_last_vehicle(), false))
				{
					func_57(0);
					func_55();
					wait(0);
		...
		{
			if (is_ped_in_vehicle(player_ped_id(), get_players_last_vehicle(), false) && is_ped_in_vehicle(iLocal_54, get_players_last_vehicle(), false))
			{
				iLocal_66 = 0;
			}
		}
...
void func_118()
{
	...
	if ((iLocal_96 - iLocal_95) > 60000)
	{
		...
		if (!is_ped_injured(iLocal_54))
		{
			if (is_entity_at_coord(iLocal_54, Local_89, 200f, 200f, 200f, false, true, 0))
			{
				task_follow_nav_mesh_to_coord(iLocal_54, Local_89, 1f, -1, 0.25f, false, 40000f);
			}
			else
			{
				task_wander_standard(iLocal_54, 40000f, 0);
			}
			set_ped_keep_task(iLocal_54, true);
			remove_ped_from_group(iLocal_54);
		}
...
void func_119()
{
	if (!is_ped_injured(iLocal_54))
	{
		if (is_entity_at_entity(player_ped_id(), iLocal_54, 8f, 8f, 8f, false, true, 0) || is_ped_in_any_taxi(player_ped_id()))
		{
			if ((is_ped_in_any_vehicle(player_ped_id(), false) && !is_ped_in_any_vehicle(iLocal_54, false)) && !is_ped_in_any_taxi(player_ped_id()))
			{
				if (!does_blip_exist(uLocal_84[0]))
				{
...
int func_121(struct<3> Param0, bool bParam1)
{
	...
	set_blip_scale(iVar0, func_122(network_is_game_in_progress(), 1f, 1f));
...
int func_124(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_122(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
void func_125()
{
	...
	while (iVar0 < iLocal_91)
	{
		set_object_as_no_longer_needed(&(iLocal_91[iVar0]));
		iVar0++;
	}
	...
	if (!is_ped_injured(iLocal_54))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), true))
		{
			if (!func_130())
			{
				...
				if (get_script_task_status(iLocal_54, 1227113341) != 1 && get_script_task_status(iLocal_54, 1227113341) != 0)
				{
					task_go_to_entity(iLocal_54, player_ped_id(), -1, 6f, 2f, 2f, 0);
				}
				if (is_ped_in_any_vehicle(iLocal_54, false))
				{
					task_leave_any_vehicle(iLocal_54, 0, 0);
				}
				if (!iLocal_73)
				{
					func_57(0);
		...
		else if (!is_ped_in_group(iLocal_54))
		{
			set_ped_as_group_member(iLocal_54, func_128());
			set_ped_never_leaves_group(iLocal_54, true);
			set_ped_group_member_passenger_index(iLocal_54, 0);
		}
	}
}
...
void func_131()
{
	switch (iLocal_61)
	{
		...
		case 2:
			...
			if (!is_ped_injured(iLocal_54))
			{
				if (is_entity_at_entity(player_ped_id(), iLocal_54, 12f, 12f, 5f, false, true, 2))
				{
					if (func_130())
					{
						set_relationship_between_groups(255, iLocal_111, joaat("player"));
				...
				if ((iLocal_99 - iLocal_98) > 60000)
				{
					if (func_154(&uLocal_114, "REDO2AU", "REDO2_TX", 4, 0, 0, 0))
					{
						...
						if (!is_ped_injured(iLocal_54))
						{
							...
							task_use_mobile_phone_timed(0, -1);
		...
		case 3:
			if (!is_ped_injured(iLocal_54) && does_entity_exist(iLocal_91[8]))
			{
				open_sequence_task(&iLocal_77);
				if (iLocal_60 > 18)
				{
				}
				task_follow_nav_mesh_to_coord(0, get_entity_coords(iLocal_91[8], true) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_133(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_91[8], true)));
				task_play_anim(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0f, false, false, false);
				task_play_anim(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0f, false, false, false);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_54, iLocal_77);
				clear_sequence_task(&iLocal_77);
				settimerb(0);
		...
		case 4:
		case 5:
			if (!is_ped_injured(iLocal_54) && !is_entity_dead(iLocal_91[8], false))
			{
				if (is_entity_playing_anim(iLocal_54, "random@domestic", "pickup_low", 3))
				{
					set_entity_no_collision_entity(iLocal_54, iLocal_91[8], false);
					if (get_entity_anim_current_time(iLocal_54, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_61 = 7;
					}
				}
				else if (timerb() > 10000 || is_entity_at_coord(player_ped_id(), get_entity_coords(iLocal_91[8], true), 1.5f, 1.5f, 3f, false, true, 0))
				{
					if (!is_entity_attached(iLocal_91[8]))
					{
						open_sequence_task(&iLocal_77);
						task_play_anim(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0f, false, false, false);
		...
		case 7:
			if (!is_ped_injured(iLocal_54))
			{
				if (is_entity_at_entity(iLocal_54, player_ped_id(), 20f, 20f, 20f, false, true, 0))
				{
					attach_entity_to_entity(iLocal_91[8], iLocal_54, get_ped_bone_index(iLocal_54, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, true, false, false, false, 2, true, 0);
					set_ped_as_group_member(iLocal_54, get_player_group(player_id()));
					set_ped_never_leaves_group(iLocal_54, true);
					set_ped_group_member_passenger_index(iLocal_54, 0);
					func_132();
					iLocal_47 = 4;
...
float func_133(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3)
{
...
void func_135()
{
	if (!iLocal_80)
	{
		if (!is_ped_injured(iLocal_54))
		{
			if (is_entity_at_entity(iLocal_54, player_ped_id(), 12f, 12f, 5f, false, true, 0))
			{
				clear_ped_tasks(iLocal_54);
				open_sequence_task(&iLocal_77);
				task_turn_ped_to_face_entity(0, player_ped_id(), 0);
				task_look_at_entity(0, player_ped_id(), 18000, 0, 2);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_54, iLocal_77);
				clear_sequence_task(&iLocal_77);
				task_look_at_entity(player_ped_id(), iLocal_54, 15000, 0, 2);
				iLocal_80 = 1;
			}
		}
	}
			...
			if (bLocal_97)
			{
				if (bLocal_50)
				{
					...
					if (!is_ped_injured(iLocal_54))
					{
						if (!func_155())
						{
							if (is_ped_facing_ped(iLocal_54, player_ped_id(), 90f))
							{
...
void func_136()
{
	if (does_entity_exist(iLocal_54))
	{
		if (is_entity_at_entity(player_ped_id(), iLocal_54, 15f, 15f, 15f, false, true, 0))
		{
			if (func_137())
			{
				func_46(0);
...
void func_138()
{
	...
	{
		case 0:
			if (!is_ped_injured(iLocal_54) && !is_ped_injured(iLocal_53))
			{
				if (is_sphere_visible(get_entity_coords(iLocal_53, true), 3f))
				{
					if (!func_155())
					{
						if (func_154(&uLocal_114, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							task_play_anim(iLocal_54, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, false, false, false);
							task_play_anim(iLocal_53, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, false, false, false);
							iLocal_60++;
						}
					}
				}
		...
		case 1:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[8]))
			{
				attach_entity_to_entity(iLocal_91[8], iLocal_53, get_ped_bone_index(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
				iLocal_60++;
			}
			break;
		...
		case 2:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[8]))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.335f)
					{
						detach_entity(iLocal_91[8], false, true);
						apply_force_to_entity(iLocal_91[8], 1, 0f, 6f, 4f, 0f, 0f, 0f, 0, false, false, true, false, true);
						iLocal_60++;
					}
				}
			}
		...
		case 3:
			if (!iLocal_70 && does_entity_exist(iLocal_91[8]))
			{
				if (has_entity_collided_with_anything(iLocal_91[8]))
				{
					play_sound_from_entity(-1, "CLOTHES_THROWN", iLocal_91[8], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
		...
		case 4:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[9]))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.473f)
					{
						attach_entity_to_entity(iLocal_91[9], iLocal_53, get_ped_bone_index(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
						iLocal_60++;
					}
				}
			}
		...
		case 6:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[9]))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.55f)
					{
						detach_entity(iLocal_91[9], false, true);
						apply_force_to_entity(iLocal_91[9], 1, 1f, 2f, 3f, 0f, 0f, 0f, 0, false, false, true, false, true);
						iLocal_60++;
					}
				}
			}
		...
		case 7:
			if (!iLocal_70 && does_entity_exist(iLocal_91[9]))
			{
				if (has_entity_collided_with_anything(iLocal_91[9]))
				{
					play_sound_from_entity(-1, "CLOTHES_THROWN", iLocal_91[9], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_155() || func_137())
		...
		case 8:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[10]))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.705f)
					{
						attach_entity_to_entity(iLocal_91[10], iLocal_53, get_ped_bone_index(iLocal_53, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, false, false, false, 2, true, 0);
						iLocal_60++;
					}
				}
			}
		...
		case 9:
			if (!is_ped_injured(iLocal_53) && does_entity_exist(iLocal_91[10]))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.838f)
					{
						detach_entity(iLocal_91[10], false, true);
						apply_force_to_entity(iLocal_91[10], 1, 1f, 3f, 3f, 0f, 0f, 0f, 0, false, false, true, false, true);
						iLocal_60++;
					}
				}
			}
		...
		case 10:
			if (!iLocal_70 && does_entity_exist(iLocal_91[10]))
			{
				if (has_entity_collided_with_anything(iLocal_91[10]))
				{
					play_sound_from_entity(-1, "CLOTHES_THROWN", iLocal_91[10], "RE_DOMESTIC_SOUNDSET", false, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_155() || func_137())
		...
		case 11:
			if (!is_ped_injured(iLocal_53) && !is_ped_injured(iLocal_54))
			{
				if (is_entity_playing_anim(iLocal_53, "random@domestic", "balcony_fight_female", 3))
				{
					if (get_entity_anim_current_time(iLocal_53, "random@domestic", "balcony_fight_female") > 0.94f)
					{
						task_turn_ped_to_face_entity(iLocal_53, iLocal_54, 0);
					}
				}
			}
			if (!func_155() || func_137())
		...
		case 16:
			if (!is_ped_injured(iLocal_54))
			{
				...
				task_turn_ped_to_face_coord(0, Local_87, 0);
				close_sequence_task(iLocal_77);
				task_perform_sequence(iLocal_54, iLocal_77);
				clear_sequence_task(&iLocal_77);
				iLocal_60++;
		...
		case 17:
			if (does_entity_exist(iLocal_53))
			{
				...
				{
					if (is_entity_at_coord(iLocal_53, Local_87, 1f, 1f, 5f, false, true, 0) && is_entity_occluded(iLocal_53))
					{
						delete_ped(&iLocal_53);
					}
				}
			}
			if (iLocal_75 < get_game_timer())
			{
				if (!func_155())
				{
					if (func_154(&uLocal_114, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_75 = get_game_timer() + 5000;
						iLocal_76++;
					}
				}
			}
	...
	if (!bLocal_50)
	{
		if (iLocal_60 > 2 && iLocal_60 < 8)
		{
			if (!is_ped_injured(iLocal_54))
			{
				if (is_entity_at_entity(player_ped_id(), iLocal_54, 6f, 4f, 5f, false, true, 0) || (is_entity_at_entity(player_ped_id(), iLocal_54, 12f, 12f, 5f, false, true, 2) && is_player_pressing_horn(player_id())))
				{
					clear_ped_tasks(iLocal_54);
					func_139();
					if (iLocal_60 > 18)
		...
		else if (iLocal_60 > 7)
		{
			if (!is_ped_injured(iLocal_54))
			{
				if (is_entity_at_entity(player_ped_id(), iLocal_54, 6f, 8f, 5f, false, true, 0))
				{
					if (does_blip_exist(uLocal_84[0]))
					{
						show_height_on_blip(uLocal_84[0], true);
					}
					clear_ped_tasks(iLocal_54);
					func_139();
					if (iLocal_60 > 18)
...
void func_139()
{
	...
	{
		open_sequence_task(&iLocal_77);
		task_go_straight_to_coord(0, Local_87, 1f, -1, 40000f, 0.5f);
		task_play_anim(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0f, false, false, false);
		close_sequence_task(iLocal_77);
...
int func_143()
{
	switch (func_144(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
void func_149()
{
	...
	{
		uLocal_84[0] = func_123(iLocal_54, 0, 145);
		show_height_on_blip(uLocal_84[0], false);
	}
}
...
void func_150()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	clear_area(Local_57, 2f, true, false, false, false);
	clear_area(Local_56, 2f, true, false, false, false);
	set_all_vehicle_generators_active_in_area(Local_57 - Vector(10f, 10f, 10f), Local_57 + Vector(10f, 10f, 10f), false, true);
	set_roads_in_angled_area(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, false, false, true);
	add_scenario_blocking_area(Local_57 - Vector(10f, 10f, 10f), Local_57 + Vector(10f, 10f, 10f), false, true, true, true);
	add_scenario_blocking_area(Local_88 - Vector(3f, 2f, 2f), Local_88 + Vector(3f, 2f, 2f), false, true, true, true);
	add_scenario_blocking_area(Vector(53.1038f, 56.6649f, -1366.481f) - Vector(1f, 1f, 1f), Vector(53.1038f, 56.6649f, -1366.481f) + Vector(1f, 1f, 1f), false, true, true, true);
	add_relationship_group("rghDomestic", &iLocal_111);
	set_relationship_between_groups(5, iLocal_111, joaat("player"));
	iLocal_53 = create_ped(26, iLocal_78, Local_56, fLocal_58, true, true);
	set_blocking_of_non_temporary_events(iLocal_53, true);
	set_ped_combat_attributes(iLocal_53, 17, true);
	set_ped_combat_attributes(iLocal_53, 8, false);
	...
	set_ped_flee_attributes(iLocal_53, 8, false);
	task_play_anim(iLocal_53, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0f, false, false, false);
	set_ped_relationship_group_hash(iLocal_53, iLocal_111);
	func_153(iLocal_53, "GENERIC_WHATEVER", 24);
	set_model_as_no_longer_needed(iLocal_78);
	set_ped_config_flag(iLocal_53, 185, true);
	iLocal_54 = create_ped(26, iLocal_79, Local_57, fLocal_59, true, true);
	set_blocking_of_non_temporary_events(iLocal_54, true);
	set_ped_flee_attributes(iLocal_54, 1, true);
	set_ped_flee_attributes(iLocal_54, 2, false);
	set_ped_flee_attributes(iLocal_54, 128, true);
	set_ped_flee_attributes(iLocal_54, 8, false);
	set_ped_flee_attributes(iLocal_54, 65536, true);
	set_ped_config_flag(iLocal_54, 185, true);
	set_ped_config_flag(iLocal_54, 206, true);
	set_ped_helmet(iLocal_54, false);
	set_ped_can_be_targetted(iLocal_54, false);
	task_play_anim(iLocal_54, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0f, false, false, false);
	set_ped_relationship_group_hash(iLocal_54, iLocal_111);
	func_153(iLocal_54, "GENERIC_WHATEVER", 24);
	set_model_as_no_longer_needed(iLocal_79);
	task_look_at_entity(iLocal_54, iLocal_53, -1, 0, 2);
	task_look_at_entity(iLocal_53, iLocal_54, -1, 0, 2);
	set_ped_component_variation(iLocal_53, 0, 1, 0, 0);
	set_ped_component_variation(iLocal_53, 2, 1, 1, 0);
	set_ped_component_variation(iLocal_53, 3, 1, 1, 0);
	set_ped_component_variation(iLocal_53, 4, 1, 2, 0);
	set_ped_component_variation(iLocal_54, 0, 0, 0, 0);
	set_ped_component_variation(iLocal_54, 2, 1, 0, 0);
	set_ped_component_variation(iLocal_54, 3, 1, 2, 0);
	set_ped_component_variation(iLocal_54, 4, 1, 1, 0);
	set_ped_component_variation(iLocal_54, 8, 0, 0, 0);
	func_152();
	set_bit(&uLocal_93, 5);
	if (func_54() == 0)
	{
		func_151(&uLocal_114, 0, player_ped_id(), "MICHAEL", 0, 1);
	}
	if (func_54() == 1)
	{
		func_151(&uLocal_114, 1, player_ped_id(), "FRANKLIN", 0, 1);
	}
	if (func_54() == 2)
	{
		func_151(&uLocal_114, 2, player_ped_id(), "TREVOR", 0, 1);
	}
	func_151(&uLocal_114, 3, iLocal_54, "REDOCastro", 0, 1);
	set_ambient_voice_name(iLocal_54, sLocal_112);
	func_151(&uLocal_114, 4, iLocal_53, "NATHALIA", 0, 1);
	set_ambient_voice_name(iLocal_53, sLocal_113);
	settimera(0);
	iLocal_109 = 1;
}
...
void func_152()
{
	iLocal_91[0] = create_object(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, true, true, false);
	set_entity_rotation(iLocal_91[0], -13.7262f, 0.5001f, -0.5886f, 2, true);
	freeze_entity_position(iLocal_91[0], true);
	set_model_as_no_longer_needed(joaat("prop_ld_tshirt_02"));
	iLocal_91[1] = create_object(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, true, true, false);
	set_entity_rotation(iLocal_91[1], -7.3906f, -12.8136f, -63.733f, 2, true);
	freeze_entity_position(iLocal_91[1], true);
	set_model_as_no_longer_needed(joaat("prop_ld_jeans_02"));
	iLocal_91[2] = create_object(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, true, true, false);
	set_entity_rotation(iLocal_91[2], -7.041683f, 10.17298f, 45.7617f, 2, true);
	freeze_entity_position(iLocal_91[2], true);
	set_model_as_no_longer_needed(joaat("prop_ld_shoe_01"));
	iLocal_91[3] = create_object(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, true, true, false);
	set_entity_rotation(iLocal_91[3], -8.5884f, 12.6893f, 57.1792f, 2, true);
	freeze_entity_position(iLocal_91[3], true);
	set_model_as_no_longer_needed(joaat("prop_ld_jeans_01"));
	iLocal_91[4] = create_object(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, true, true, false);
	set_entity_rotation(iLocal_91[4], -16.4886f, 2.4979f, -3.8769f, 2, true);
	freeze_entity_position(iLocal_91[4], true);
	set_model_as_no_longer_needed(joaat("prop_ld_shoe_02"));
	iLocal_91[5] = create_object(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, true, true, false);
	set_entity_rotation(iLocal_91[5], -3.5946f, -15.0978f, -75.5026f, 2, true);
	freeze_entity_position(iLocal_91[5], true);
	set_model_as_no_longer_needed(joaat("prop_ld_shirt_01"));
	iLocal_91[6] = create_object(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, true, true, false);
	set_entity_rotation(iLocal_91[6], 6.402527f, -15.68665f, -104.1308f, 2, true);
	freeze_entity_position(iLocal_91[6], true);
	set_model_as_no_longer_needed(joaat("prop_porn_mag_03"));
	iLocal_91[7] = create_object(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, true, true, false);
	set_entity_rotation(iLocal_91[7], -8.3642f, 1.9344f, 2.6889f, 2, true);
	freeze_entity_position(iLocal_91[7], true);
	set_model_as_no_longer_needed(joaat("prop_porn_mag_01"));
	iLocal_91[8] = create_object(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
	iLocal_91[9] = create_object(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, true, true, false);
	set_model_as_no_longer_needed(joaat("prop_cs_rub_binbag_01"));
	iLocal_91[10] = create_object(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, true, true, false);
...
void func_156()
{
	if (!is_ped_injured(iLocal_54) && !is_ped_injured(iLocal_53))
	{
		...
		{
			if (can_ped_see_hated_ped(iLocal_54, player_ped_id()) || can_ped_see_hated_ped(iLocal_53, player_ped_id()))
			{
				if (((is_player_targetting_entity(player_id(), iLocal_54) || is_player_free_aiming_at_entity(player_id(), iLocal_54)) || is_player_targetting_entity(player_id(), iLocal_53)) || is_player_free_aiming_at_entity(player_id(), iLocal_53))
				{
					if (iLocal_94 == -1)
					{
			...
			if ((iLocal_94 != -1 && get_game_timer() > iLocal_94 + 500) || is_ped_shooting(player_ped_id()))
			{
				func_163();
			}
		}
	...
	if (is_entity_at_coord(player_ped_id(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, false, true, 0))
	{
		func_160();
	}
	if (does_entity_exist(iLocal_53))
	...
	if (does_entity_exist(iLocal_54))
	{
		if (func_159(iLocal_54) || has_entity_been_damaged_by_entity(iLocal_54, player_ped_id(), true))
		{
			func_157();
		}
	}
	if (does_entity_exist(iLocal_53))
	{
		if (func_159(iLocal_53) || has_entity_been_damaged_by_entity(iLocal_53, player_ped_id(), true))
		{
			func_157();
		}
	}
	if (!is_ped_injured(iLocal_54))
	{
		if (!is_entity_at_entity(player_ped_id(), iLocal_54, 250f, 250f, 250f, false, true, 0) || is_entity_in_water(iLocal_54))
		{
			iLocal_47 = 11;
		}
	}
...
void func_161()
{
	...
	{
		clear_ped_tasks(iLocal_54);
		task_smart_flee_coord(iLocal_54, get_entity_coords(get_vehicle_ped_is_in(player_ped_id(), false), true), 150f, -1, false, false);
		set_ped_keep_task(iLocal_54, true);
	}
	iLocal_47 = 11;
}
...
int func_162(int iParam0)
{
	...
	{
		if (!is_ped_in_any_vehicle(iParam0, false) && is_entity_at_entity(player_ped_id(), iParam0, 1.5f, 1.5f, 8f, false, true, 2))
		{
			if (get_entity_speed(get_vehicle_ped_is_in(player_ped_id(), false)) > 4f)
			{
				return 1;
			}
		}
...
void func_164()
{
	...
	request_model(joaat("prop_golf_iron_01"));
	request_model(joaat("prop_cs_rub_binbag_01"));
	request_model(joaat("prop_golf_bag_01"));
	request_model(joaat("prop_ld_tshirt_02"));
	request_model(joaat("prop_ld_jeans_02"));
	request_model(joaat("prop_ld_shoe_01"));
	request_model(joaat("prop_ld_jeans_01"));
	request_model(joaat("prop_ld_shoe_02"));
	request_model(joaat("prop_ld_shirt_01"));
	request_model(joaat("prop_porn_mag_03"));
	request_model(joaat("prop_porn_mag_01"));
	request_anim_dict("random@domestic");
	request_anim_dict("random@security_van");
	if ((((((((((((((has_model_loaded(iLocal_78) && has_model_loaded(iLocal_79)) && has_model_loaded(joaat("prop_golf_iron_01"))) && has_model_loaded(joaat("prop_cs_rub_binbag_01"))) && has_model_loaded(joaat("prop_golf_bag_01"))) && has_model_loaded(joaat("prop_ld_tshirt_02"))) && has_model_loaded(joaat("prop_ld_jeans_02"))) && has_model_loaded(joaat("prop_ld_shoe_01"))) && has_model_loaded(joaat("prop_ld_jeans_01"))) && has_model_loaded(joaat("prop_ld_shoe_02"))) && has_model_loaded(joaat("prop_ld_shirt_01"))) && has_model_loaded(joaat("prop_porn_mag_03"))) && has_model_loaded(joaat("prop_porn_mag_01"))) && has_anim_dict_loaded("random@domestic")) && has_anim_dict_loaded("random@security_van"))
	{
		bLocal_48 = true;
	}
	else
...
int func_166()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_177())
		{
			return 0;
		}
	}
...
int func_179()
{
	if ((Global_113375 == func_40() && get_random_event_flag()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
int func_200()
{
	...
	func_206(&uVar0, get_clock_seconds());
	func_205(&uVar0, get_clock_minutes());
	func_204(&uVar0, get_clock_hours());
	func_203(&uVar0, get_clock_day_of_month());
	func_202(&uVar0, get_clock_month());
	func_201(&uVar0, get_clock_year());
	return uVar0;
}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_217()) || Global_31962) || func_216()) || func_77(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_217()) || Global_112433) || Global_31962) || func_216()) || func_77(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_217()) || Global_112433) || Global_31962) || func_216()) || func_77(8, -1)) || func_215()) || func_214()) || func_212()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_217() || get_player_wanted_level(player_id()) > 0) || func_77(8, -1)) || func_212()) || func_211()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_226()
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (does_entity_exist(iLocal_54))
		{
			if (!is_ped_injured(iLocal_54))
			{
				set_ped_config_flag(iLocal_54, 317, true);
				if (!is_ped_in_any_vehicle(iLocal_54, false))
				{
					reset_ped_last_vehicle(iLocal_54);
				}
