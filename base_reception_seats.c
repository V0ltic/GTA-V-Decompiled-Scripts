...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 1:
			if (func_51(uParam0))
			{
				uParam0->f_85.f_6 = get_game_timer();
				func_52(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_50(player_ped_id(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				...
				{
					if ((get_game_timer() - uParam0->f_85.f_6) > 150)
					{
		...
		case 4:
			...
			if (Var2.f_0 != 3)
			{
				Var3 = { get_anim_initial_offset_position(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				Var4 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				fVar5 = Var4.f_2;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_85.f_1 = network_create_synchronised_scene(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_85.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
				network_start_synchronised_scene(uParam0->f_85.f_1);
				uParam0->f_85.f_8.f_4 = get_game_timer();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = network_get_local_scene_from_network_id(uParam0->f_85.f_1);
			if (is_synchronized_scene_running(iVar7))
			{
				if (get_synchronized_scene_phase(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_85.f_1 = network_create_synchronised_scene(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
					network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_85.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					network_start_synchronised_scene(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 7:
			network_stop_synchronised_scene(uParam0->f_85.f_1);
			func_52(uParam0, 8);
			break;
		
		case 8:
			iVar8 = network_get_local_scene_from_network_id(uParam0->f_85.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((get_game_timer() - uParam0->f_85.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_85.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_85.f_4 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_85.f_4 == 6 && !has_anim_event_fired(player_ped_id(), -1322051853)) && !func_8(&(uParam0->f_85), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!is_pause_menu_active() && !func_8(&(uParam0->f_85), 0)) && !func_8(&(uParam0->f_85), 4)) && !func_21()) && !func_19(1)) && uParam0->f_85.f_8.f_2 != 3)
			{
...
void func_24(var uParam0)
{
	...
	uParam0->f_85.f_1 = network_create_synchronised_scene(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
	func_41(uParam0, &sVar0);
	network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_85.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	network_start_synchronised_scene(uParam0->f_85.f_1);
	func_9(&(uParam0->f_85.f_5));
	func_52(uParam0, 8);
}
...
int func_43(var uParam0)
{
	...
	switch (uParam0->f_85.f_8)
	{
		...
		default:
			iVar0 = get_random_int_in_range(0, func_14(uParam0->f_85.f_8));
	}
	return iVar0;
}
...
int func_47(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if ((iVar1 != player_id() && func_48(iVar1, 1, 1)) && func_50(get_player_ped(iVar1), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_85.f_4 > 4)
	{
		...
		set_ped_capsule(player_ped_id(), func_55(uParam0));
		uParam0->f_85.f_7 = get_frame_count();
	}
	...
	else if ((get_frame_count() - uParam0->f_85.f_7) < 5)
	{
		set_ped_capsule(player_ped_id(), func_55(uParam0));
	}
}
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_85), 1, is_entity_dead(player_ped_id(), false));
	func_57(&(uParam0->f_85), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_57(&(uParam0->f_85), 0, func_36(0));
	func_57(&(uParam0->f_85), 2, is_ped_running(player_ped_id()));
}
...
int func_61()
{
	...
	if (func_62() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_62()) == 0)
		{
			return 1;
		}
	}
...
{
	return is_entity_in_angled_area(iParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, false, true, 0);
}
...
int func_70()
{
	if (Global_1853191 != func_60())
	{
		if (network_is_script_active("base_reception_seats", Global_1853191, true, 0))
		{
			return 0;
		}
...
{
	if ((iParam1 == 0 || iParam1 == 1) && (is_scenario_group_enabled("FACILITY_MAIN_3") || is_scenario_group_enabled("FACILITY_MAIN_2")))
	{
		return 0;
	}
	return 1;
