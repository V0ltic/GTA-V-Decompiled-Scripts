...
void __EntryFunction__()
{
	...
	if (does_entity_exist(iLocal_103))
	{
	}
	func_321();
	if (!func_338())
	{
		if ((func_320(Local_80.f_28[0]) && func_320(player_ped_id())) && !func_319(player_ped_id(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	while (true)
	{
		...
		{
			if (func_320(player_ped_id()) && is_entity_in_angled_area(player_ped_id(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, false, true, 0))
			{
				if (func_320(Local_91.f_0))
				{
					if (func_319(player_ped_id(), Local_91.f_0, 10f, 1))
					{
						func_300();
					}
				}
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			clear_prints();
			clear_help(true);
			if (is_string_null_or_empty(sLocal_92))
			{
				func_354(1);
			}
			else
...
void func_8()
{
	switch (iLocal_85)
	{
		...
		case 1:
			...
			{
				if (!is_entity_dead(iLocal_102, false))
				{
					if (func_319(player_ped_id(), iLocal_102, 1f, 1))
					{
			...
			if (func_320(player_ped_id()))
			{
				if (iLocal_297 == 0)
				{
					if (is_entity_in_angled_area(player_ped_id(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, false, true, 0) && get_ped_parachute_state(player_ped_id()) == 2)
					{
						iLocal_297 = 1;
					}
				}
				if (func_231(Local_91.f_0))
				{
					if (timera() > 5000)
					{
						if ((get_game_timer() > iLocal_292 + 25000 || is_entity_in_angled_area(player_ped_id(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, false, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((get_game_timer() > iLocal_292 + 25000 || is_entity_in_angled_area(player_ped_id(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, false, true, 0))
				{
					iLocal_85 = 2;
				}
			}
			if (get_game_timer() < iLocal_292 + 5000)
			{
				if (_is_recording())
				{
		...
		case 2:
			if (((!is_ped_falling(player_ped_id()) && !is_ped_in_parachute_free_fall(player_ped_id())) && get_entity_height_above_ground(player_ped_id()) < 2f) && !is_ped_ragdoll(player_ped_id()))
			{
...
void func_232()
{
	...
	iVar0 = 0;
	fVar1 = 1f;
	iLocal_296 = get_game_timer();
	if (!does_cam_exist(iLocal_274))
	{
	}
	if (!does_cam_exist(iLocal_275))
	{
	}
	if (!does_cam_exist(iLocal_276))
	{
	}
	if (!does_cam_exist(iLocal_277))
	{
	}
	if (!does_cam_exist(iLocal_278))
	{
	}
	if (!does_cam_exist(iLocal_279))
	{
	}
	if (!does_cam_exist(iLocal_280))
	{
	}
	if (!does_cam_exist(iLocal_281))
	{
	}
	if (!does_cam_exist(iLocal_282))
	{
	}
	if (!does_cam_exist(iLocal_283))
	{
	}
	if (!does_cam_exist(iLocal_284))
	{
	}
	set_time_scale(fVar1);
	display_hud(false);
	display_radar(false);
	...
	while (get_game_timer() < iLocal_296 + 11000 && !is_screen_faded_out())
	{
		if (!is_synchronized_scene_running(iLocal_293) && !is_synchronized_scene_running(iLocal_294))
		{
			if (func_245(400))
			{
				bLocal_303 = true;
		...
		if (!iLocal_301)
		{
			...
			{
				if (get_synchronized_scene_phase(iLocal_293) == 1f)
				{
					if (func_320(Local_91.f_0))
					{
						iLocal_294 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						iLocal_286 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
						task_synchronized_scene(Local_91.f_0, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1000f, 0);
						set_synchronized_scene_hold_last_frame(iLocal_294, false);
						set_cam_active(iLocal_286, true);
						play_synchronized_cam_anim(iLocal_286, iLocal_294, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						render_script_cams(true, false, 3000, true, false, 0);
						force_ped_ai_and_animation_update(Local_91.f_0, false, false);
						destroy_cam(iLocal_285, false);
						iLocal_301 = 1;
					}
				}
			}
		...
		{
			if (is_synchronized_scene_running(iLocal_294) && get_synchronized_scene_phase(iLocal_294) >= 0.2f)
			{
			...
			if (is_synchronized_scene_running(iLocal_294) && get_synchronized_scene_phase(iLocal_294) == 1f)
			{
				if (func_320(Local_91.f_0))
				{
					iLocal_295 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					iLocal_287 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
					task_synchronized_scene(Local_91.f_0, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1000f, 0);
					set_synchronized_scene_hold_last_frame(iLocal_295, true);
					set_cam_active(iLocal_287, true);
					play_synchronized_cam_anim(iLocal_287, iLocal_295, "Fall_and_impact_CAM", "rcmextreme4");
					play_synchronized_audio_event(iLocal_295);
					render_script_cams(true, false, 3000, true, false, 0);
					force_ped_ai_and_animation_update(Local_91.f_0, false, false);
					destroy_cam(iLocal_286, false);
					iLocal_302 = 1;
				}
			}
		}
		else if (is_synchronized_scene_running(iLocal_295) && get_synchronized_scene_phase(iLocal_295) >= 0.323f)
		{
			if (!iLocal_298)
			{
				start_particle_fx_non_looped_at_coord("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, false, false, false);
				set_particle_fx_non_looped_alpha(1f);
				func_243();
				iLocal_298 = 1;
			}
			else if (!iLocal_304)
			{
				if (is_synchronized_scene_running(iLocal_295) && get_synchronized_scene_phase(iLocal_295) >= 0.44f)
				{
					iLocal_104 = start_particle_fx_looped_at_coord("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, false, false, false, false);
					set_particle_fx_looped_alpha(iLocal_104, 1f);
					iLocal_304 = 1;
				}
			}
		}
		if (get_game_timer() > iLocal_296 + 600 && fVar1 == 1f)
		{
			if (!iLocal_299)
			{
				iLocal_299 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (get_frame_time() / fVar2);
		if (get_game_timer() > iLocal_296 + 630)
		{
		...
		if (get_game_timer() > iLocal_296 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&iLocal_99);
		...
		if (get_game_timer() > iLocal_296 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_320(Local_91.f_0))
		...
		if (get_game_timer() > iLocal_296 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_320(Local_91.f_0))
		...
		if (get_game_timer() > iLocal_296 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (get_game_timer() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				destroy_cam(iLocal_287, false);
				iLocal_284 = create_cam("DEFAULT_SCRIPTED_CAMERA", true);
				set_cam_params(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				render_script_cams(true, false, 3000, true, false, 0);
				set_cam_active(iLocal_284, true);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_303)
	{
		if (is_synchronized_scene_running(iLocal_295))
		{
			stop_synchronized_audio_event(iLocal_295);
		}
	...
	if (func_320(Local_91.f_0))
	{
		if (iVar0 < 3)
		{
			set_entity_health(Local_91.f_0, 101, 0);
			Var4 = { get_entity_coords(Local_91.f_0, true) };
			if (Var4.f_2 > 155f)
			{
				fVar5 = 155f;
			}
			...
			set_entity_coords(Local_91.f_0, 1657.046f, -17.4571f, fVar5, true, false, false, true);
		}
	}
	_0x81CBAE94390F9F89();
	func_234(1, 1, 1, 1);
	...
	display_hud(true);
	display_radar(true);
	set_player_control(player_id(), true, 128);
	set_time_scale(1f);
	if (func_231(Local_91.f_0))
	{
		if (is_synchronized_scene_running(iLocal_295))
		{
			set_synchronized_scene_phase(iLocal_295, 1f);
		}
		clear_ped_tasks_immediately(Local_91.f_0);
		force_ped_ai_and_animation_update(Local_91.f_0, false, false);
		set_entity_coords(Local_91.f_0, 1655.77f, -20.04f, 135.8f, true, false, false, true);
		set_entity_health(Local_91.f_0, 0, 0);
	}
	func_233(&uLocal_106, 1, player_ped_id(), "FRANKLIN", 0, 1);
...
void func_235(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_239(player_id())) && !func_237(player_id(), 0)) && !func_236()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_239(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_248()
{
	...
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (is_entity_in_angled_area(player_ped_id(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, false, true, 0))
			{
				request_cutscene_with_playback_list("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				request_cutscene_with_playback_list("es_4_rcm_p2_concat", 5, 8);
			}
			stop_sound(iLocal_289);
			if (can_request_assets_for_cutscene_entity())
			{
				set_cutscene_ped_component_variation("Dom", 8, 2, 0, 0);
			}
			if (!func_269())
			{
				if (func_263(1, 20f, 1))
				{
					if ((!iLocal_305 || get_game_timer() > iLocal_306 + 3000) || is_entity_at_coord(player_ped_id(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						_0x48621C9FCA3EBD28(1);
						start_cutscene(2048);
						if (func_320(Local_91.f_0))
						{
							register_entity_for_cutscene(Local_91.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						wait(0);
						iLocal_305 = 0;
						...
						if (func_320(Local_91.f_0))
						{
							freeze_entity_position(Local_91.f_0, false);
						}
						if (does_entity_exist(iLocal_103) && !is_entity_dead(iLocal_103, false))
						{
							set_entity_visible(iLocal_103, false, false);
						}
						if (is_ped_in_any_vehicle(player_ped_id(), false))
						{
							iLocal_96 = get_vehicle_ped_is_in(player_ped_id(), false);
							iLocal_105 = get_entity_model(iLocal_96);
							if (is_this_model_a_car(iLocal_105) == 1 || is_this_model_a_bike(iLocal_105) == 1)
							{
						...
						clear_area_of_peds(1660.186f, -7.492f, 172.774f, 200f, 0);
						iLocal_288 = add_scenario_blocking_area(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, false, true, true, true);
						iLocal_85 = 1;
					}
				}
			}
		...
		case 1:
			if (is_cutscene_playing())
			{
				if (can_set_exit_state_for_camera(false))
				{
					if (!iLocal_90)
					{
						if (!is_synchronized_scene_running(iLocal_293))
						{
							if (func_320(Local_91.f_0))
							{
								if (!does_cam_exist(iLocal_285))
								{
									iLocal_285 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
								}
								set_cam_active(iLocal_285, true);
								render_script_cams(true, false, 3000, true, false, 0);
								iLocal_293 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								task_synchronized_scene(Local_91.f_0, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1000f, 0);
								set_synchronized_scene_hold_last_frame(iLocal_293, true);
								set_cam_active(iLocal_285, true);
								play_synchronized_cam_anim(iLocal_285, iLocal_293, "Base_Jump_Spot_CAM", "rcmextreme4");
								render_script_cams(true, false, 3000, true, false, 0);
								force_ped_ai_and_animation_update(Local_91.f_0, false, false);
								iLocal_90 = 1;
							}
				...
				if (func_320(Local_91.f_0))
				{
					if (can_set_exit_state_for_registered_entity("Dom", 0))
					{
						iLocal_85 = 2;
					}
				}
		...
		case 2:
			...
			if (does_entity_exist(iLocal_103) && !is_entity_dead(iLocal_103, false))
			{
				set_entity_visible(iLocal_103, true, false);
			}
			if (iLocal_87 == 0)
			{
...
void func_250(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_251(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_253(struct<3> Param0, float fParam1)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		if (does_entity_exist(iVar0))
		{
			...
			{
				set_entity_coords(iVar0, Param0, true, false, false, true);
...
int func_263(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_267(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_266(player_ped_id(), -828834893))
				{
...
void func_270()
{
	if (!is_ped_injured(player_ped_id()))
	{
		...
		{
			if (((((((is_control_pressed(0, 30) || is_control_pressed(0, 31)) || is_control_pressed(0, 23)) || is_control_pressed(0, 21)) || is_control_pressed(0, 22)) || (func_282() && is_control_pressed(0, 1))) || (func_282() && is_control_pressed(0, 2))) || (func_282() && is_control_pressed(0, 32)))
			{
	...
	switch (iLocal_85)
	{
		case 0:
			...
			{
				set_ped_combat_attributes(Local_80.f_28[0], 17, true);
			}
			iLocal_290 = 0;
			iLocal_305 = 1;
		...
		case 1:
			...
			if (func_320(player_ped_id()))
			{
				if (func_320(Local_91.f_0))
				{
					if (func_319(player_ped_id(), Local_91.f_0, 100f, 1))
					{
						request_cutscene_with_playback_list("es_4_rcm_p2_concat", 6, 8);
						if (can_request_assets_for_cutscene_entity())
						{
					...
					if (is_ped_ragdoll(Local_91.f_0))
					{
						set_entity_health(Local_91.f_0, 0, 0);
					}
					if (func_319(player_ped_id(), Local_91.f_0, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_300)
							{
								if (func_319(player_ped_id(), Local_91.f_0, 30f, 1) && !func_269())
								{
							...
							func_272();
							if (!is_ped_headtracking_ped(player_ped_id(), Local_91.f_0))
							{
								task_look_at_entity(player_ped_id(), Local_91.f_0, -1, 0, 2);
							}
						}
					}
					if (is_entity_in_angled_area(player_ped_id(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, false, true, 0))
					{
						if (!is_ped_in_any_vehicle(player_ped_id(), false))
						{
							iLocal_85 = 2;
		...
		case 2:
			...
			if (func_320(player_ped_id()))
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					bring_vehicle_to_halt(get_vehicle_ped_is_in(player_ped_id(), false), 5f, 1, false);
					wait(600);
					task_leave_any_vehicle(player_ped_id(), 0, 0);
				}
			}
...
void func_271()
{
	if (func_320(Local_91.f_0))
	{
		if (get_script_task_status(Local_91.f_0, 242628503) != 1)
		{
			task_perform_sequence(Local_91.f_0, iLocal_95);
		}
	}
}
...
void func_272()
{
	if (!func_269())
	{
		if (iLocal_290 < 5)
		{
			if (get_game_timer() > (iLocal_291 + (8000 + get_random_int_in_range(0, 2000))))
			{
				if (has_sound_finished(iLocal_289))
				{
	...
	if (!func_269())
	{
		if ((request_script_audio_bank("EXTREME_04_DOM_A", false, -1) && request_script_audio_bank("EXTREME_04_DOM_B", false, -1)) && request_script_audio_bank("EXTREME_04_DOM_C", false, -1))
		{
			if (has_sound_finished(iLocal_289))
			{
				play_sound_from_entity(iLocal_289, "DOM", Local_91.f_0, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}
...
int func_274(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_231(player_ped_id()) && func_231(iParam0))
	{
...
int func_277(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_261(Param1 - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_261(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_283()
{
	...
	else
	{
		...
		task_follow_nav_mesh_to_coord(player_ped_id(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
		func_247(800, 0);
		iLocal_88 = 1;
		func_290(1, 1, 1);
	}
...
void func_284()
{
	...
	task_follow_nav_mesh_to_coord(Local_80.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, false, 40000f);
	set_scenario_type_enabled("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	clear_area_of_vehicles(Local_91.f_1, 20f, false, false, false, false, false, false, 0);
	if (!does_entity_exist(iLocal_97))
	{
		iLocal_97 = create_vehicle(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, true, true, false);
	}
	if (!does_entity_exist(iLocal_98))
	{
		iLocal_98 = create_vehicle(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, true, true, false);
	}
	if (!does_entity_exist(iLocal_100))
	{
		iLocal_100 = create_object(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, true, true, false);
		set_entity_rotation(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, true);
	}
	if (!does_entity_exist(iLocal_101))
	{
		iLocal_101 = create_object(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, true, true, false);
		set_entity_rotation(iLocal_101, 90.03932f, -0.257438f, -13.86142f, 2, true);
	}
	if (func_320(Local_91.f_0))
	{
		if (get_script_task_status(Local_91.f_0, 242628503) != 1)
		{
			...
			task_play_anim(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0f, false, false, false);
			task_play_anim(0, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0f, false, false, false);
			set_sequence_to_repeat(iLocal_95, true);
	...
	if (func_320(Local_91.f_0))
	{
		set_ped_can_ragdoll_from_player_impact(Local_91.f_0, false);
		func_233(&uLocal_106, 4, Local_91.f_0, "DOM", 0, 1);
		set_ped_relationship_group_hash(Local_91.f_0, get_ped_relationship_group_hash(player_ped_id()));
	}
	if (!does_entity_exist(iLocal_103))
	{
		iLocal_103 = create_ambient_pickup(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), true, true);
	}
	set_entity_rotation(iLocal_103, -111.8225f, -0.454914f, -162.2231f, 2, true);
	play_entity_anim(iLocal_103, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, false, 0.99f, 0);
	func_249(1);
}

void func_285(int* iParam0, struct<3> Param1, float fParam2)
{
	...
	set_ped_name_debug(*iParam0, "EXTREME LAUNCHER RC");
}

void func_286(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_287(iParam0);
...
int func_288(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_294()
{
	switch (iLocal_86)
	{
		case 0:
			...
			{
				if (!iLocal_305 || get_game_timer() > iLocal_306 + 3500)
				{
					func_295();
					_0x48621C9FCA3EBD28(1);
					start_cutscene(0);
					if (func_231(Local_80.f_28[0]))
					{
						register_entity_for_cutscene(Local_80.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					wait(0);
					stop_gameplay_hint(false);
		...
		case 2:
			func_288(player_ped_id(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			force_ped_motion_state(player_ped_id(), joaat("MotionState_Walk"), false, 1, false);
			set_ped_min_move_blend_ratio(player_ped_id(), 1f);
			task_follow_nav_mesh_to_coord(player_ped_id(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			set_gameplay_cam_relative_pitch(0f, 1f);
...
void func_299()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_338() && func_320(Local_80.f_28[0])) && func_320(player_ped_id())) && iLocal_305 == 1)
	{
		if (!is_gameplay_hint_active())
		{
			set_player_control(player_id(), false, 0);
			task_look_at_entity(player_ped_id(), Local_80.f_28[0], -1, 0, 2);
			task_follow_to_offset_of_entity(player_ped_id(), Local_80.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, true);
			_set_gameplay_hint_anim_closeup(true);
			set_gameplay_entity_hint(Local_80.f_28[0], -0.5f, 0f, -0.2f, true, 30000, 2000, 2000, 0);
			set_gameplay_hint_fov(fVar0);
			set_gameplay_hint_follow_distance_scalar(fVar1);
			set_gameplay_hint_base_orbit_pitch_offset(fVar2);
			_set_gameplay_hint_anim_offsetx(fVar3);
			_set_gameplay_hint_anim_offsety(fVar4);
			iLocal_306 = get_game_timer();
		}
		else
		{
			if (func_319(player_ped_id(), Local_80.f_28[0], 4f, 1))
			{
...
void func_300()
{
	...
	if (iLocal_305)
	{
		if (!is_gameplay_hint_active())
		{
			set_player_control(player_id(), false, 0);
			task_look_at_entity(player_ped_id(), Local_91.f_0, -1, 0, 2);
			task_follow_nav_mesh_to_coord(player_ped_id(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, false, -161.08f);
			_set_gameplay_hint_anim_closeup(true);
			set_gameplay_entity_hint(Local_91.f_0, 0f, 0f, 0f, true, 30000, 2000, 2000, 0);
			set_gameplay_hint_fov(fVar0);
			set_gameplay_hint_follow_distance_scalar(fVar1);
			set_gameplay_hint_base_orbit_pitch_offset(fVar2);
			_set_gameplay_hint_anim_offsetx(fVar3);
...
void func_301()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(Local_91.f_0, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					set_blip_flashes(iLocal_94, true);
				}
			}
			else if (does_blip_exist(iLocal_94))
			{
				set_blip_flashes(iLocal_94, false);
			}
		}
		if (is_entity_in_angled_area(player_ped_id(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, false, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
...
{
	if (((!func_316(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_315(0)) || func_314(1))
			{
			}
			else
			{
...
void func_321()
{
	...
	request_additional_text("EXT4", 0);
	while (!has_additional_text_loaded(0))
	{
		wait(0);
	}
	request_model(joaat("prop_box_guncase_03a"));
	request_model(joaat("prop_box_wood01a"));
	request_model(joaat("p_parachute_s"));
	request_model(joaat("bmx"));
	while (((!has_model_loaded(joaat("prop_box_guncase_03a")) || !has_model_loaded(joaat("prop_box_wood01a"))) || !has_model_loaded(joaat("p_parachute_s"))) || !has_model_loaded(joaat("bmx")))
	{
		wait(0);
	}
	if (!does_entity_exist(iLocal_99))
	{
		iLocal_99 = create_object_no_offset(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, true, true, false);
		set_entity_rotation(iLocal_99, 90f, 0f, -63f, 2, true);
		freeze_entity_position(iLocal_99, true);
		set_entity_visible(iLocal_99, false, false);
	}
	func_325(1);
	if (!does_entity_exist(Local_91.f_0))
	{
		func_322(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
		freeze_entity_position(Local_91.f_0, true);
		set_blocking_of_non_temporary_events(Local_91.f_0, true);
		remove_all_ped_weapons(Local_91.f_0, true);
		set_ped_component_variation(Local_91.f_0, 8, 2, 0, 0);
		disable_ped_pain_audio(Local_91.f_0, true);
		set_ped_config_flag(Local_91.f_0, 137, true);
		set_ped_config_flag(Local_91.f_0, 118, false);
		set_ped_config_flag(Local_91.f_0, 208, true);
		set_ped_money(Local_91.f_0, 5000);
	}
	if (func_231(player_ped_id()))
	{
		func_233(&uLocal_106, 1, player_ped_id(), "FRANKLIN", 0, 1);
...
int func_322(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_323(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	request_model(Local_91.f_5);
	request_anim_dict("rcmextreme4");
	request_anim_dict("skydive@parachute@");
	request_model(joaat("sanchez"));
	request_ptfx_asset();
	if (iParam0 == 1)
	{
		while ((((!has_model_loaded(Local_91.f_5) || !has_model_loaded(joaat("sanchez"))) || !has_anim_dict_loaded("rcmextreme4")) || !has_anim_dict_loaded("skydive@parachute@")) || !has_ptfx_asset_loaded())
		{
			wait(0);
		}
	}
...
int func_333(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			set_ped_can_leg_ik(uParam0->f_28[0], true);
...
void func_339(int iParam0)
{
	...
	remove_scenario_blocking_area(iLocal_288, false);
...
void func_354(bool bParam0)
{
	...
	if (!func_375())
	{
		...
		{
			func_168(iVar0, 1, 0);
			func_355(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_356(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_362())
	{
		...
		{
			iVar2 = func_357(get_this_script_name());
			if (iVar2 > -1)
			{
