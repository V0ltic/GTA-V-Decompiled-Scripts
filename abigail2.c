...
void __EntryFunction__()
{
	...
	if (func_468(Local_54.f_28[0]))
	{
		...
		set_entity_as_mission_entity(iLocal_61, true, true);
	}
	func_467();
	if (func_466())
	{
...
void func_9()
{
	switch (iLocal_60)
	{
		case 0:
			...
			{
				set_vehicle_doors_locked(iLocal_56, 1);
			}
			iLocal_60 = 1;
			break;
		...
		case 1:
			...
			else if (func_235(player_ped_id(), iLocal_61) > 250f)
			{
				if (get_player_wanted_level(get_player_index()) == 0)
				{
					iLocal_60 = 2;
			...
			else
			{
				...
				if (iLocal_230 == 0)
				{
					if (((!func_232() && func_231(iLocal_61, player_ped_id(), 20f, 1)) && !is_ped_ragdoll(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_232()) && (get_game_timer() - iLocal_235) > 10000) && func_231(iLocal_61, player_ped_id(), 20f, 1)) && !is_ped_ragdoll(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_238()
{
	if (func_468(iLocal_61))
	{
		if ((get_game_timer() - iLocal_242) > 1000)
		{
...
void func_241(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_266(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
...
int func_247(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_254() || func_253(Global_4718592.f_168757)) || func_252())
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			iVar1 = func_251(player_ped_id(), 0);
			if (((is_turret_seat(iVar0, iVar1) || (get_entity_model(iVar0) == joaat("apc") && iVar1 != -1)) || (get_entity_model(iVar0) == joaat("akula") && iVar1 != -1)) || (((get_entity_model(iVar0) == joaat("riot2") && iVar1 == 0) && func_250(iVar0, 10)) && get_vehicle_mod(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_248(int iParam0)
{
	if (iParam0 != func_220())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_249(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_261(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_264(bParam1, bParam2, bParam3) || is_ped_in_any_vehicle(player_ped_id(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((get_game_timer() - uParam0->f_4) > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), true) || func_262(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_268()
{
	if (!does_blip_exist(iLocal_62) && func_468(iLocal_61))
	{
		iLocal_62 = func_269(iLocal_61, 1, 0, 5);
	}
	if (does_blip_exist(iLocal_62) && get_blip_colour(iLocal_62) != 1)
	{
		set_blip_as_friendly(iLocal_62, false);
		set_blip_colour(iLocal_62, 1);
	}
}
...
void func_270()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_232()) && func_231(iLocal_61, player_ped_id(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_268();
				}
				if (func_235(player_ped_id(), iLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
			if ((iLocal_233 == 0 && iLocal_232 == 1) && !func_232())
			{
				if (func_468(iLocal_61))
				{
					...
					set_player_wanted_level(get_player_index(), 3, false);
					set_player_wanted_level_now(player_id(), false);
				}
...
void func_272()
{
	...
	{
		case 0:
			iLocal_243 = add_scenario_blocking_area(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), false, true, true, true);
			func_300();
			if (func_468(iLocal_61))
			{
				func_298();
				if (func_3(iLocal_56))
				{
					...
					open_sequence_task(&iLocal_236);
					if (!is_ped_in_vehicle(iLocal_61, iLocal_56, false))
					{
						task_follow_nav_mesh_to_coord(0, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, true, 40000f);
						task_follow_nav_mesh_to_coord(0, -1567.85f, 5178.12f, 14.78f, 1f, 20000, 0.25f, true, 40000f);
						task_follow_nav_mesh_to_coord(0, -1571.85f, 5181.21f, 16.88f, 1f, 20000, 0.25f, true, 40000f);
						task_follow_nav_mesh_to_coord(0, -1579.01f, 5174.08f, 18.57f, 1f, 20000, 0.25f, true, 40000f);
						task_enter_vehicle(0, iLocal_56, 20000, -1, 1f, 1, 0);
					}
					task_vehicle_drive_to_coord_longrange(0, iLocal_56, Local_239, 20f, 786469, 10f);
					task_vehicle_park(0, iLocal_56, Local_239, 49.567f, 3, 10f, false);
					task_leave_vehicle(0, iLocal_56, 256);
					task_smart_flee_ped(0, player_ped_id(), 250f, -1, false, false);
					close_sequence_task(iLocal_236);
					task_perform_sequence(iLocal_61, iLocal_236);
				}
				else
				{
					task_wander_standard(iLocal_61, 40000f, 0);
				}
			}
		...
		case 1:
			...
			else if (is_entity_at_coord(iLocal_61, Local_239, 5f, 5f, 5f, false, true, 0))
			{
				func_237(3);
			}
			else
			{
				...
				if (iLocal_231 == 0)
				{
					if (((func_468(iLocal_56) && is_ped_in_vehicle(iLocal_61, iLocal_56, true)) && func_231(iLocal_61, player_ped_id(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_232()) && (get_game_timer() - iLocal_234) > 10000) && func_231(iLocal_61, player_ped_id(), 20f, 1)) && !is_ped_ragdoll(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = get_game_timer();
						iLocal_237++;
					}
	...
	if (does_blip_exist(*iParam0))
	{
		if ((get_game_timer() - *iParam3) > 500)
		{
			if (get_blip_colour(*iParam0) == 1)
			{
				...
				{
					if (!is_message_being_displayed() || func_274(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((get_game_timer() - iParam4) < 7500 && iParam5)
				{
					if (!is_message_being_displayed() || func_274(sParam2, 0, 0))
					{
...
int func_277()
{
	if (is_player_playing(player_id()) && get_player_wanted_level(player_id()) > 0)
	{
		return 1;
	}
	if (func_468(iLocal_56))
	{
		...
		if (is_ped_being_jacked(iLocal_61))
		{
			return 1;
		}
		if (func_468(iLocal_56))
		{
			if (is_ped_in_vehicle(iLocal_61, iLocal_56, false) && has_entity_been_damaged_by_entity(iLocal_56, player_ped_id(), true))
			{
				return 1;
			}
			if (((is_vehicle_tyre_burst(iLocal_56, 0, false) || is_vehicle_tyre_burst(iLocal_56, 1, false)) || is_vehicle_tyre_burst(iLocal_56, 4, false)) || is_vehicle_tyre_burst(iLocal_56, 5, false))
			{
				return 1;
			}
		}
...
int func_278(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_468(player_ped_id()) && func_468(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_291(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_279(int iParam0, float fParam1)
{
	...
	if (func_468(player_ped_id()) && func_468(iParam0))
	{
		if (func_290(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(player_ped_id(), 6))
			{
				fVar0 = 40f;
...
{
	return func_281(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_285(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_287(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_287(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_295(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_287(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_298()
{
	if (func_468(iLocal_61))
	{
		...
		set_ped_flee_attributes(iLocal_61, 4, true);
		set_ped_flee_attributes(iLocal_61, 1024, true);
		set_ped_config_flag(iLocal_61, 281, true);
		set_ped_config_flag(iLocal_61, 29, true);
		set_ped_config_flag(iLocal_61, 116, true);
		set_ped_config_flag(iLocal_61, 118, true);
		set_ped_can_be_targetted(iLocal_61, true);
		set_ped_path_can_drop_from_height(iLocal_61, false);
		set_ped_path_can_use_climbovers(iLocal_61, false);
	}
}
...
void func_300()
{
	if (!func_468(iLocal_56))
	{
		iLocal_56 = create_vehicle(iLocal_55, Local_57, fLocal_58, true, true, false);
		set_model_as_no_longer_needed(iLocal_55);
	}
	if (func_468(iLocal_56))
	{
		set_vehicle_doors_locked(iLocal_56, 3);
		set_vehicle_colour_combination(iLocal_56, 1);
		set_vehicle_model_is_suppressed(iLocal_55, true);
		set_vehicle_disable_towing(iLocal_56, true);
	}
}
			...
			switch (iLocal_241)
			{
				case 0:
					if (func_354(1, 1093140480, 0))
					{
						if (func_468(iLocal_61))
						{
							register_entity_for_cutscene(iLocal_61, "ABIGAIL", 0, 0, 0);
						}
						func_353();
						start_cutscene(0);
				...
				case 2:
					if (is_cutscene_playing())
					{
						if (can_set_exit_state_for_registered_entity("ABIGAIL", func_503(16)) && func_468(iLocal_61))
						{
							task_follow_nav_mesh_to_coord(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, true, 40000f);
						}
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_468(iLocal_61))
							{
								clear_ped_tasks_immediately(iLocal_61);
...
void func_306(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_308() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_308() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_307(bParam0));
...
void func_332(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_336(player_id())) && !func_334(player_id(), 0)) && !func_333()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_336(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
int func_340(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_342(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_343(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_354(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_358(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_233(player_ped_id(), -828834893))
				{
...
void func_361()
{
	request_additional_text("ABGAIL2", 0);
	request_model(iLocal_55);
	if ((!func_232() && has_additional_text_loaded(0)) && has_model_loaded(iLocal_55))
	{
		...
		if (func_468(Local_54.f_35[0]))
		{
			...
			set_entity_as_mission_entity(iLocal_56, true, true);
			set_model_as_no_longer_needed(iLocal_55);
		}
		iLocal_59 = 1;
	}
...
void func_363()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_358(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_382(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_256(0)) || func_381(1))
			{
			}
			else
			{
...
void func_385(int iParam0)
{
	...
	if (!func_390())
	{
		func_388(get_entity_coords(player_ped_id(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_387(0, -1, 1);
	func_386(1, 1, 1);
}
...
void func_388(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_391(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3, struct<3> Param4, float fParam5, struct<3> Param6, float fParam7)
{
	...
	if (func_347(Param0))
	{
		...
		set_ped_into_vehicle(player_ped_id(), iVar0, -1);
		func_395(&iVar0);
	}
	else if (!func_466())
	{
		func_340(player_ped_id(), Param0, fParam1, 0, 1);
	}
	request_model(iLocal_55);
	while (!has_model_loaded(iLocal_55))
	{
		wait(0);
	}
	...
	iLocal_56 = create_vehicle(iLocal_55, Param6, fParam7, true, true, false);
	set_vehicle_model_is_suppressed(iLocal_55, true);
	set_model_as_no_longer_needed(iLocal_55);
	func_300();
	if (func_347(Param4))
	{
		set_ped_into_vehicle(iLocal_61, iLocal_56, -1);
	}
}
...
void func_397(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_161(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_402(*iParam1, 0, &uVar0))
		{
...
int func_402(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = get_entity_model(iParam0);
	if ((!func_430(iVar0, bParam1, uParam2) && !func_429(player_id())) && !func_411(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_409(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_407(iParam0)) && !bVar1) && !(func_406(get_entity_model(iParam0)) && func_404(player_id())))
	{
	...
	if (!network_is_game_in_progress())
	{
		if ((func_403(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_428(player_id()) || func_427(player_id()))
	{
		if (func_412(iParam0))
		{
			return 1;
...
int func_413(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_407(iParam0)) || func_414(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_415(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_417(get_entity_model(iParam0), 0))
			{
...
int func_430(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_409(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_434(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_450(iParam0) != 145) || func_449(iParam0)) || func_448(iParam0)) || func_403(iParam0)) || func_447(iParam0)) || !func_437(get_entity_model(iParam0)))
	{
		if (func_448(iParam0))
		{
		}
...
int func_454(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_426(get_entity_model(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_457(*uParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*uParam0, 24, func_457(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_456(uParam0);
	if (func_455(*uParam0))
	{
...
void func_469(int iParam0)
{
	func_7(&uLocal_42, 0, 0);
	set_wanted_level_multiplier(1f);
	set_vehicle_model_is_suppressed(iLocal_55, false);
	set_model_as_no_longer_needed(iLocal_55);
	func_6(&iLocal_62);
	...
	remove_scenario_blocking_area(iLocal_243, false);
	if (iParam0 == 1)
	{
