...
void __EntryFunction__()
{
	...
	Global_43603 = get_game_timer() + 20000;
	iVar0 = 0;
		...
		switch (iLocal_58)
		{
			...
			case 1:
				...
				if (iLocal_58 == 1)
				{
					...
					else if ((get_game_timer() - iLocal_50) > 20000)
					{
						func_138();
						func_133(1);
						func_150(&iVar1, 1);
...
int func_31()
{
	...
	func_37(&uVar0, get_clock_seconds());
	func_36(&uVar0, get_clock_minutes());
	func_35(&uVar0, get_clock_hours());
...
void func_40()
{
	...
	iVar1 = ceil((get_frame_time() * 1000f));
...
void func_44(char* sParam0, int iParam1)
{
	...
	{
		if (func_43(sParam0) && !is_help_message_fading_out())
		{
			clear_help(false);
		}
	}
...
void func_67()
{
	...
	{
		if (func_69(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_74(int iParam0)
{
	...
	if (BitTest(Global_113386.f_7688[Global_43599 /*15*/].f_1, 3))
	{
		...
		if (iVar0 != -1)
		{
			if (func_75(player_ped_id(), iVar0, (Global_43053[iVar0 /*5*/].f_3 * 0.35f)))
			{
				func_150(&iParam0, 0);
				func_133(0);
				iLocal_58 = 0;
...
int func_75(int iParam0, int iParam1, float fParam2)
{
	...
	if (!is_entity_dead(iParam0, false))
	{
		...
		if (get_distance_between_coords(get_entity_coords(iParam0, true), Var0, true) < fVar1)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
...
int func_90()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (does_entity_exist(Global_96275[iVar0]))
		{
			return 0;
		}
	}
...
int func_93()
{
	if (does_entity_exist(Global_97919[2]))
	{
		return 0;
	}
	return 1;
...
int func_94()
{
	if (does_entity_exist(Global_97919[1]))
	{
		return 0;
	}
	return 1;
...
int func_95()
{
	if (does_entity_exist(Global_97919[0]))
	{
		return 0;
	}
	return 1;
...
int func_107()
{
	...
	if (Global_95443 == -1)
	{
		Global_95443 = get_game_timer();
	}
	if ((get_game_timer() - Global_95443) > 240000)
	{
		Global_95443 = -1;
		return 1;
	}
	...
	{
		fVar0 = vdist2(get_entity_coords(player_ped_id(), true), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_95443 = -1;
			return 1;
...
int func_118()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (vdist2(func_108(181, 0), get_entity_coords(player_ped_id(), true)) > 40000f)
		{
			return 1;
		}
	}
	...
	if ((get_game_timer() - Global_95443) > 30000)
	{
		Global_95443 = -1;
		return 1;
	}
	...
	if (Global_43599 != -1)
	{
		...
		else
		{
			...
			if (BitTest(Global_113386.f_7688[Global_43599 /*15*/].f_1, 15))
			{
				...
				clear_bit(&(Global_113386.f_7688[Global_43599 /*15*/].f_1), 15);
			}
			if (func_54(3))
			{
				if (!func_53(1))
...
void func_150(int iParam0, int iParam1)
{
	...
	if (BitTest(Global_113386.f_7688[Global_43599 /*15*/].f_1, 1))
	{
		if (!Global_113386.f_7688.f_913)
		{
			set_bit(&(Global_113386.f_7688[Global_43599 /*15*/].f_1), 10);
...
void func_160()
{
	if (iLocal_52 == 1)
	{
		if (!func_184())
		{
			stop_sound(iLocal_57);
			play_sound_frontend(-1, "End_Squelch", "CB_RADIO_SFX", true);
			iLocal_52 = 0;
		}
	...
	else if ((get_game_timer() - iLocal_54) >= 10000 || iLocal_53 >= 1)
	{
		if (func_66() == 2)
		{
					...
					if (can_vehicle_receive_cb_radio(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
						switch (iLocal_53)
						{
							case -1:
								...
								iLocal_53++;
								iLocal_57 = get_sound_id();
								break;
							
							case 0:
								if ((get_game_timer() - iLocal_55) >= 120000)
								{
									iLocal_53 = 1;
								}
								if ((get_game_timer() - iLocal_56) >= 300000)
								{
									iLocal_53 = 2;
								}
								break;
...
int func_161()
{
	...
	if (bVar3)
	{
		...
		{
			play_sound_frontend(-1, "Start_Squelch", "CB_RADIO_SFX", true);
			play_sound_frontend(iLocal_57, "Background_Loop", "CB_RADIO_SFX", true);
			return 1;
		}
	}
	else
	{
		...
		iVar1 = get_random_int_in_range(1, 23);
		StringIntConCat(&Var0, iVar1, 16);
...
int func_178()
{
	...
	while (iVar2 == 0)
	{
		iVar3 = get_random_int_in_range(1, 44);
		switch (iVar3)
		{
			case 5:
				if (iVar1 > 19)
...
int func_181()
{
	...
	iVar1 = get_random_int_in_range(1, 44);
	StringIntConCat(&Var0, iVar1, 16);
	StringCopy(&Var2, "CB_CHAR", 16);
	StringIntConCat(&Var2, iVar1, 16);
	func_177(&uLocal_59, 3, 0, &Var2, 0, 0);
...
int func_188(var uParam0)
{
	...
	if (uParam0->f_7 != -1)
	{
		if (func_75(player_ped_id(), uParam0->f_7, 0))
		{
			return 0;
		}
	}
...
void func_194(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_195(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_196(iParam1)), 0));
		}
		else
		{
			func_195(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_196(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
...
int func_204(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	...
	if (iParam3 != -1)
	{
		if (func_75(player_ped_id(), iParam3, 0))
		{
			return 0;
		}
	}
	...
	if (func_9(iVar4))
	{
		get_ped_nearby_peds(player_ped_id(), &uVar5, -1);
		switch (iParam1)
		{
			case 4:
				switch (iVar4)
			...
			if (iVar6[iVar7] != 0)
			{
				...
				while (iVar8 < 16)
				{
					if (does_entity_exist(uVar5[iVar8]))
					{
						...
						{
							if (!is_entity_dead(uVar5[iVar8], false))
							{
								if (!is_entity_dead(player_ped_id(), false))
								{
									if (vdist2(get_entity_coords(uVar5[iVar8], true), get_entity_coords(player_ped_id(), true)) < 6400f)
									{
										return 0;
									}
								}
				...
				if (does_entity_exist(iVar9))
				{
					if (!is_entity_dead(player_ped_id(), false))
					{
						if (vdist2(get_entity_coords(iVar9, true), get_entity_coords(player_ped_id(), true)) < 6400f)
						{
							return 0;
						}
					}
...
void func_220(var uParam0)
{
	if (uParam0->f_3 == 5)
	{
		if ((uParam0->f_4 - get_game_timer()) > 6000)
		{
			uParam0->f_4 = get_game_timer() + 6000;
		}
	}
}
...
void func_222(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			if (!is_ped_injured(player_ped_id()))
			{
				if (func_245(48))
				{
					...
					{
						if ((((!does_entity_exist(func_239(60)) && !does_entity_exist(func_239(61))) && Global_78315 == -1) && !func_238()) && !func_237())
						{
							if (func_66() == 0)
							{
								func_177(&uLocal_59, 0, player_ped_id(), "MICHAEL", 0, 1);
							...
							{
								func_177(&uLocal_59, 1, player_ped_id(), "FRANKLIN", 0, 1);
								func_177(&uLocal_59, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
							...
							{
								func_177(&uLocal_59, 2, player_ped_id(), "TREVOR", 0, 1);
								func_177(&uLocal_59, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
								cVar0[1] = "DAB_TREVOR";
								cVar0[2] = "DAB_SEND";
		...
		case 2:
			if (get_game_timer() > Global_43603)
			{
				iLocal_51++;
			}
			break;
...
int func_223()
{
	...
	while (iVar0 < 2)
	{
		if (get_distance_between_coords(Var4, Var3[iVar0 /*3*/], true) < fVar1)
		{
			fVar1 = get_distance_between_coords(Var4, Var3[iVar0 /*3*/], true);
			iVar2 = iVar0;
		}
		iVar0++;
	}
	func_228(60);
	func_228(61);
	if (is_sphere_visible(Var3[iVar2 /*3*/], 300f) || fVar1 < 300f)
	{
		if (iVar2 == 0)
		{
			iVar2 = 1;
...
int func_237()
{
	...
	iVar1 = get_ped_nearby_vehicles(player_ped_id(), &uVar0);
	iVar2 = 0;
	while (iVar2 <= (iVar1 - 1))
	{
		if (get_entity_model(uVar0[iVar2]) == joaat("blimp"))
		{
			if (!is_entity_dead(uVar0[iVar2], false) && is_vehicle_driveable(uVar0[iVar2], false))
			{
				return 1;
			}
		}
...
int func_238()
{
	...
	{
		if (get_entity_model(get_vehicle_ped_is_in(player_ped_id(), true)) == joaat("blimp"))
		{
			return 1;
		}
	}
...
void func_249(var uParam0)
{
	if (BitTest(uParam0->f_2, func_202()))
	{
		...
		{
			case 0:
				func_177(&Global_43434, 0, player_ped_id(), "MICHAEL", 0, 1);
				break;
			
			case 1:
				func_177(&Global_43434, 1, player_ped_id(), "FRANKLIN", 0, 1);
				break;
			
			case 2:
				func_177(&Global_43434, 2, player_ped_id(), "TREVOR", 0, 1);
				break;
		}
	}
	switch (uParam0->f_6)
	...
	if (func_9(func_66()))
	{
		if (BitTest(uParam0->f_2, func_202()))
		{
			...
			else
			{
				...
				if (is_string_null_or_empty(&(Var3.f_8)))
				{
					cVar4 = { Var3.f_4 };
				}
				else
...
int func_267(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_270(1);
			func_273(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
	...
	func_268(iParam0, sParam1, bVar1, func_269(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_271(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
