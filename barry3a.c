...
void __EntryFunction__()
{
	...
	func_454();
	if (does_entity_exist(Local_39.f_35[0]))
	{
		Local_43.f_4 = Local_39.f_35[0];
	}
	if (does_entity_exist(Local_39.f_41[0]))
	{
	...
	if (does_entity_exist(Local_39.f_35[1]))
	{
		func_426(&(Local_56[0 /*29*/]), &(Local_39.f_35[1]));
	}
	if (does_entity_exist(Local_39.f_28[0]))
	{
		func_425(&(Local_56[0 /*29*/].f_1), &(Local_39.f_28[0]));
	}
	if (does_entity_exist(Local_39.f_28[1]))
	{
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			func_217(&iLocal_42);
			if (is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
			{
				...
				else
				{
					iLocal_241 = 1;
					iLocal_242 = 1;
					if (get_profile_setting(203) == 0 || !func_215())
					{
						func_213(2);
						iLocal_240 = 0;
					}
		...
		case 1:
			...
			else if (!iLocal_241)
			{
				if (is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
				{
					...
					{
						iLocal_242 = 0;
						if (is_entity_at_coord(Local_43.f_4, Local_53, 6f, 6f, 2f, true, true, 0))
						{
							func_217(&iLocal_42);
							iLocal_41 = 0;
							iLocal_40 = 6;
			...
			else if (!is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
			{
				clear_prints();
				iLocal_241 = 0;
				iLocal_240 = 1;
			...
			else if (is_entity_at_coord(Local_43.f_4, Local_53, 6f, 6f, 2f, true, true, 0))
			{
				func_217(&iLocal_42);
				iLocal_41 = 0;
				iLocal_40 = 6;
...
void func_6()
{
	...
	{
		func_8(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_7() == 2 == 0 && !network_is_game_in_progress())
			{
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_75(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_75(iParam1), Global_78130[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_75(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_75(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_75(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_75(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_78128 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_75(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_75(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_75(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_51(get_entity_model(iParam0), 14, iVar0, get_hash_name_for_prop(iParam0, 0, iParam2, iParam3)))
			{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_75(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_57(get_entity_model(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_57(get_entity_model(iParam0), iVar1, 14, 4);
		}
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_75(iParam2));
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_52(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_52(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_52(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_52(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_86(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_86(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_75(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_75(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_150(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_166()
{
	...
	{
		func_155();
		set_next_player_tcmodifier(func_167(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
void func_168()
{
	...
	if (is_xbox360_version() || func_170())
	{
		network_set_rich_presence(StackVal, 0, 0, 0);
	}
	else if (is_ps3_version() || func_169())
	{
...
int func_203()
{
	return func_204(get_this_script_name(), 0);
}
...
bool func_210(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
int func_216(struct<3> Param0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_218()
{
	...
	{
		case 0:
			if (is_entity_at_coord(Local_43.f_4, Local_53, 10f, 10f, 2f, false, true, 0))
			{
				func_217(&iLocal_42);
		...
		case 1:
			if (is_entity_at_coord(Local_43.f_4, Local_53, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_220();
					if (!func_219(player_ped_id(), Local_43.f_4, 55f, 1) && !is_entity_on_screen(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_212(5)) && (get_profile_setting(203) == 0 || !func_215()))
					{
						func_213(5);
					}
				}
...
void func_220()
{
	if (!iLocal_238)
	{
		iLocal_239 = get_game_timer() + 3500;
		iLocal_238 = 1;
	}
	else if (!iLocal_237)
	{
		if (get_game_timer() > iLocal_239)
		{
			if (iLocal_233 == 1)
			{
...
void func_240()
{
	...
	{
		case 0:
			if (get_vehicle_petrol_tank_health(Local_43.f_4) < 1f)
			{
				set_vehicle_petrol_tank_health(Local_43.f_4, 10f);
			}
			if (get_vehicle_engine_health(Local_43.f_4) < 1f)
			{
				set_vehicle_engine_health(Local_43.f_4, 10f);
			}
...
void func_245()
{
	switch (iLocal_41)
	{
		case 0:
			func_217(&iLocal_42);
			if (!func_215() || get_profile_setting(203) == 0)
			{
				func_213(2);
				func_256(&uLocal_254);
				iLocal_235 = 0;
			...
			iLocal_233 = 1;
			iLocal_61 = get_game_timer() + 2500;
			iLocal_41 = 1;
			break;
		
		case 1:
			func_251(&uLocal_254, &uLocal_63, "BAR3AAU", &sLocal_255, &cLocal_261);
			if (!iLocal_60 && get_game_timer() > iLocal_61)
			{
				play_police_report("SCRIPTED_SCANNER_REPORT_BARRY_3A_01", 0f);
				iLocal_60 = 1;
			}
			if (is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
			{
...
void func_248()
{
	...
	{
		if (!func_215() && is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
		{
			if (!iLocal_229)
			{
				iLocal_229 = 1;
				iLocal_231 = get_game_timer();
			}
			if ((get_game_timer() - iLocal_231) > Local_228[iLocal_230 /*2*/].f_1 && (func_250() || iLocal_230 == 0))
			{
				if (iLocal_230 != 2 || get_entity_speed(Local_43.f_4) > 10f)
				{
					if (func_238() || get_profile_setting(203) == 0)
					{
...
int func_250()
{
	if (is_cop_ped_in_area_3d(get_entity_coords(player_ped_id(), true) - Vector(70f, 70f, 70f), get_entity_coords(player_ped_id(), true) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_251(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!is_scripted_conversation_ongoing() && func_252(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_257()
{
	switch (iLocal_41)
	{
		case 0:
			func_217(&iLocal_42);
			iLocal_42 = func_211(Local_43.f_4, 1, 5);
			set_blip_route(iLocal_42, true);
			if (func_212(3) && (get_profile_setting(203) == 0 || !func_215()))
			{
				func_213(3);
				func_256(&uLocal_254);
			}
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
			{
				func_217(&iLocal_42);
				iLocal_42 = func_216(Local_53, 5, 1);
				if (func_212(0) && (get_profile_setting(203) == 0 || !func_215()))
				{
					func_213(0);
					func_256(&uLocal_254);
				}
		...
		case 1:
			if (is_ped_in_vehicle(player_ped_id(), Local_43.f_4, false))
			{
				...
				else
				{
					...
					if (is_ped_sitting_in_vehicle(player_ped_id(), Local_43.f_4) && is_entity_at_coord(Local_43.f_4, Local_53, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_243 = 0;
						iLocal_41 = 2;
					}
					if (!iLocal_236)
					{
						if (((get_game_timer() - iLocal_231) > 8000 && iLocal_230 >= 4) && !func_215())
						{
...
void func_261(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_334(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_204(get_this_script_name(), 1);
			if (iVar4 != -1)
			{
...
{
	func_263(&Global_106934, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_263(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_233();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_293(player_ped_id());
		func_286(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_285())
		{
			func_281(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_272(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_275(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_286(int iParam0, bool bParam1)
{
	...
	iVar0 = func_149(iParam0);
	if (func_152(iVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
...
void func_287(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_292(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_289(Var7.f_1)) && iVar9 < 51)
			{
...
int func_298(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_319())
		{
			*uParam0 = func_303(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_303(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_318(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_304(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_326(BitTest(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (does_entity_exist(Global_103950.f_4))
	{
		if (is_vehicle_driveable(Global_103950.f_4, false))
		{
			if (func_365(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_362(get_entity_coords(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_339(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_279(iParam0, 0, 0)) || func_279(iParam0, 1, 0)) || func_279(iParam0, 2, 0)) || func_270(iParam0) != 145) || func_356(iParam0)) || func_355(iParam0)) || func_354(iParam0)) || func_353(iParam0)) || !func_343(get_entity_model(iParam0)))
	{
		if (func_355(iParam0))
		{
		}
...
int func_344(int iParam0, bool bParam1)
{
	...
	{
		if ((func_170() || is_pc_version()) || func_169())
		{
		}
		else if (!func_349())
		{
...
void func_358(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_357(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_362(struct<3> Param0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_363(struct<3> Param0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_368()
{
	...
	{
		set_all_vehicle_generators_active_in_area(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, false, true);
		iLocal_42 = func_211(Local_43.f_4, 1, 5);
		iLocal_40 = 1;
		iLocal_41 = 0;
	}
...
void func_369()
{
	...
	if ((iLocal_57 && Local_56[0 /*29*/].f_24 == 1) && Local_56[1 /*29*/].f_24 == 1)
	{
		...
		set_model_as_no_longer_needed(iLocal_58);
		iLocal_57 = 0;
	}
}
...
void func_370(int iParam0)
{
	...
	{
		case 0:
			if (!does_entity_exist(Local_56[iParam0 /*29*/].f_1))
			{
				if (func_207(Local_56[iParam0 /*29*/]))
				{
					if (has_model_loaded(iLocal_59))
					{
						Local_56[iParam0 /*29*/].f_1 = create_ped_inside_vehicle(Local_56[iParam0 /*29*/], 6, iLocal_59, -1, true, true);
						Local_56[iParam0 /*29*/].f_2 = create_ped_inside_vehicle(Local_56[iParam0 /*29*/], 6, iLocal_59, 0, true, true);
					}
				}
				else if (has_model_loaded(iLocal_58))
				{
					Local_56[iParam0 /*29*/] = create_vehicle(iLocal_58, Local_56[iParam0 /*29*/].f_3, Local_56[iParam0 /*29*/].f_6, true, true, false);
				}
			}
			else if (!is_entity_dead(Local_56[iParam0 /*29*/].f_1, false))
			{
				set_ped_as_cop(Local_56[iParam0 /*29*/].f_1, true);
				set_blocking_of_non_temporary_events(Local_56[iParam0 /*29*/].f_1, true);
				give_delayed_weapon_to_ped(Local_56[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, true);
				set_ped_accuracy(Local_56[iParam0 /*29*/].f_1, 10);
				if (func_207(Local_56[iParam0 /*29*/].f_2))
				{
					set_ped_as_cop(Local_56[iParam0 /*29*/].f_2, true);
					set_blocking_of_non_temporary_events(Local_56[iParam0 /*29*/].f_2, true);
					give_delayed_weapon_to_ped(Local_56[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, true);
					set_ped_accuracy(Local_56[iParam0 /*29*/].f_2, 10);
				}
		...
		case 1:
			if (func_210(player_ped_id(), Local_56[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (func_389(iParam0))
				{
					Local_56[iParam0 /*29*/].f_25 = get_game_timer() + 1750;
			...
			{
				if (!Local_56[iParam0 /*29*/].f_26 && does_entity_exist(Local_56[iParam0 /*29*/].f_1))
				{
					func_372(&(Local_56[iParam0 /*29*/].f_1));
					Local_56[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_27 && does_entity_exist(Local_56[iParam0 /*29*/].f_2))
				{
					func_372(&(Local_56[iParam0 /*29*/].f_2));
					Local_56[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_56[iParam0 /*29*/].f_28 && does_entity_exist(Local_56[iParam0 /*29*/]))
				{
		...
		case 2:
			if (get_game_timer() > Local_56[iParam0 /*29*/].f_25)
			{
				func_373(iParam0, 1);
			}
...
void func_373(int iParam0, int iParam1)
{
	...
	{
		set_blocking_of_non_temporary_events(Local_56[iParam0 /*29*/].f_1, false);
		set_ped_highly_perceptive(Local_56[iParam0 /*29*/].f_1, true);
		func_371(&(Local_56[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_207(Local_56[iParam0 /*29*/].f_2))
	{
		set_ped_as_cop(Local_56[iParam0 /*29*/].f_2, true);
		set_blocking_of_non_temporary_events(Local_56[iParam0 /*29*/].f_2, false);
		set_ped_highly_perceptive(Local_56[iParam0 /*29*/].f_2, true);
		func_371(&(Local_56[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_207(Local_56[iParam0 /*29*/]))
	{
		set_vehicle_engine_on(Local_56[iParam0 /*29*/], true, true, false);
...
int func_375(int iParam0)
{
	...
	if (func_207(iParam0))
	{
		...
		if (is_ped_being_jacked(iParam0) && func_219(iParam0, player_ped_id(), 2f, 1))
		{
			return 1;
		}
		...
		else if (is_projectile_in_area(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), true))
		{
			return 1;
		}
...
int func_376(int iParam0, float fParam1)
{
	...
	if (func_207(player_ped_id()) && func_207(iParam0))
	{
		if (func_387(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
int func_382(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_384(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_384(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_388(int iParam0)
{
	...
	if (does_entity_exist(iParam0))
	{
		...
		else if (is_projectile_in_area(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), true))
		{
			return 1;
		}
	}
...
{
	if (is_entity_in_angled_area(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	else if (Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && is_entity_in_angled_area(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_392()
{
	if (is_vehicle_stuck_on_roof(Local_43.f_4))
	{
		if (iLocal_47)
		{
			if ((get_game_timer() - iLocal_48) > 7000)
			{
				return 1;
			}
		}
...
int func_393()
{
	switch (iLocal_243)
	{
		...
		case 1:
			iLocal_244 = get_milliseconds_per_game_minute() * 120;
			iLocal_244 = (iLocal_244 + get_game_timer());
			iLocal_245 = (iLocal_244 - get_milliseconds_per_game_minute() * 30);
		...
		case 2:
			if (get_game_timer() >= iLocal_244)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_247 && get_game_timer() >= iLocal_245) && !func_215())
				{
...
void func_394()
{
	...
	if (iVar0 >= iLocal_250)
	{
		if ((iVar0 - iLocal_251) > 500)
		{
			...
			iLocal_251 = get_game_timer() + 1000;
		}
	}
	...
	switch (iLocal_41)
	{
		case 0:
			if (!func_401())
			{
				...
				clear_prints();
				clear_help(true);
				if (is_string_null_or_empty(sLocal_253))
				{
					sLocal_253 = "DEFAULT";
				}
				if (are_strings_equal(sLocal_253, "DEFAULT"))
				{
					func_475(1);
				}
				else
...
void func_396(bool bParam0)
{
	...
	set_all_vehicle_generators_active_in_area(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, true, true);
}
...
void func_402()
{
	...
	if (iLocal_246)
	{
		if ((!is_cutscene_playing() && !func_406(0)) && !func_401())
		{
			iVar0 = (iLocal_244 - get_game_timer());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
			_hide_area_and_vehicle_name_this_frame();
			if (get_game_timer() >= iLocal_245)
			{
...
void func_407(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
{
	if (((!func_420(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_406(0)) || func_419(1))
			{
			}
			else
			{
...
void func_423()
{
	if (func_207(Local_43.f_4))
	{
		set_vehicle_strong(Local_43.f_4, true);
		set_vehicle_has_strong_axles(Local_43.f_4, true);
		set_vehicle_can_leak_oil(Local_43.f_4, false);
		set_vehicle_can_leak_petrol(Local_43.f_4, false);
		if (!bLocal_46)
		{
			add_vehicle_upsidedown_check(Local_43.f_4);
		}
...
void func_432(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_436(player_id())) && !func_434(player_id(), 0)) && !func_433()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_436(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_440(bool bParam0)
{
	...
	{
		set_entity_coords(player_ped_id(), -1243.316f, -1041.637f, 7.5121f, true, false, false, true);
		set_entity_heading(player_ped_id(), 28.2f);
	}
	func_429(500, 1);
}
...
void func_445(struct<3> Param0, float fParam1, bool bParam2)
{
	request_model(Local_43.f_5);
	request_model(iLocal_51);
	while (!has_model_loaded(Local_43.f_5) || !has_model_loaded(iLocal_51))
	{
		wait(0);
	}
	if (func_207(Local_43.f_4))
	{
		if (bLocal_46)
		{
			remove_vehicle_upsidedown_check(Local_43.f_4);
			bLocal_46 = false;
		}
	}
	if (bParam2)
	...
	func_209(&iLocal_49);
	func_206(&(Local_43.f_4));
	Local_43.f_4 = create_vehicle(Local_43.f_5, Param0, fParam1, true, true, false);
	set_vehicle_colour_combination(Local_43.f_4, 1);
	if (bParam2)
	{
		func_446(player_ped_id(), Local_43.f_4, -1, 0);
	}
	set_vehicle_can_leak_oil(Local_43.f_4, false);
	set_vehicle_can_leak_petrol(Local_43.f_4, false);
	set_vehicle_strong(Local_43.f_4, true);
	set_vehicle_has_strong_axles(Local_43.f_4, true);
	add_vehicle_upsidedown_check(Local_43.f_4);
	set_vehicle_extra(Local_43.f_4, 1, true);
	set_vehicle_extra(Local_43.f_4, 2, true);
	set_vehicle_extra(Local_43.f_4, 3, true);
	iLocal_49 = create_object(iLocal_51, Param0, true, true, false);
	attach_entity_to_entity(iLocal_49, Local_43.f_4, 0, Local_50, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
	set_entity_collision(iLocal_49, true, false);
	bLocal_46 = true;
	func_424(Local_43.f_4, 0);
	set_model_as_no_longer_needed(Local_43.f_5);
	set_model_as_no_longer_needed(iLocal_51);
}
...
void func_449(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!does_entity_exist(Local_43.f_4))
		{
...
void func_454()
{
	request_additional_text("BARR3A", 0);
	Local_43.f_5 = joaat("dloader");
	Local_43 = { 1199.8f, -1259.22f, 34.23f };
	Local_43.f_3 = 174.7f;
	if (func_207(player_ped_id()))
	{
		func_241(&uLocal_63, 1, player_ped_id(), "FRANKLIN", 0, 1);
	}
	iLocal_236 = 0;
	iLocal_247 = 0;
	iLocal_230 = 0;
	...
	sLocal_253 = "DEFAULT";
	func_455(49, 1, 0);
	iLocal_54[0] = add_scenario_blocking_area(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, false, true, true, true);
	iLocal_54[1] = add_scenario_blocking_area(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, false, true, true, true);
...
void func_466()
{
	...
	remove_scenario_blocking_area(iLocal_54[0], false);
	remove_scenario_blocking_area(iLocal_54[1], false);
	set_instance_priority_hint(0);
...
void func_475(bool bParam0)
{
	...
	if (!func_493())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_476(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_477(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_480())
	{
		...
		{
			iVar2 = func_331(get_this_script_name());
			if (iVar2 > -1)
			{
