...
void __EntryFunction__()
{
	...
	func_35(1);
	request_cutscene("FOS_EP_1_P6", 8);
	func_18(0);
...
void func_8(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_13(player_id())) && !func_10(player_id(), 0)) && !func_9()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_13(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_33(int iParam0, int iParam1)
{
	...
	*iParam0 = add_scenario_blocking_area(-7000f, -7000f, -100f, 7000f, 7000f, 315f, false, true, true, true);
	...
	if (func_7(player_ped_id()) && iParam1 == 1)
	{
