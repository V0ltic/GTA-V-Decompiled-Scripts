...
int func_2()
{
	...
	fVar0 = vdist2(get_entity_coords(player_ped_id(), true), Local_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			{
				request_model(iLocal_69[iVar0]);
				if (!has_model_loaded(iLocal_69[iVar0]))
				{
					request_model(iLocal_69[iVar0]);
					bVar2 = false;
				}
		...
		if (!is_string_null_or_empty(&cLocal_75))
		{
			request_anim_dict(&cLocal_75);
			if (!has_anim_dict_loaded(&cLocal_75))
			{
				request_anim_dict(&cLocal_75);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = create_ped(26, iLocal_69[iVar0], Local_70 + Local_72[iVar0 /*3*/], 0f, true, true);
			set_entity_rotation(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + Local_73[iVar0 /*3*/], 2, true);
			set_ped_random_component_variation(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				set_ped_component_variation(iLocal_68[iVar0], 3, 1, 0, 0);
				set_ped_component_variation(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				set_ped_random_component_variation(iLocal_68[iVar0], 0);
			...
			task_play_anim_advanced(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), Local_70 + Local_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + Local_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0f, 2, 0);
			force_ped_ai_and_animation_update(iLocal_68[iVar0], false, false);
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = add_decal(iLocal_83[iVar0], Local_70 + Local_84[iVar0 /*3*/], Var3, Var4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, false, false, false);
			wait(0);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			Local_84[4 /*3*/] = { Local_84[0 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, get_random_float_in_range(0.5f, 0.5f), get_random_float_in_range(0.5f, 0.5f)) };
			Local_84[5 /*3*/] = { Local_84[1 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, get_random_float_in_range(0.5f, 0.5f), get_random_float_in_range(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 17, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 144, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_24(uParam1, 43, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_34()
{
	...
	while (iVar0 < iLocal_69)
	{
		if (iLocal_69[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_69[iVar0]);
		}
		iVar0++;
	}
	if (!is_string_null_or_empty(&cLocal_75))
	{
		remove_anim_dict(&cLocal_75);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		if (is_decal_alive(iLocal_82[iVar0]))
		{
		}
		iVar0++;
	}
