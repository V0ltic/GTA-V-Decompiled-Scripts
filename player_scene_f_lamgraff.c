...
int func_2()
{
	...
	{
		if (does_entity_exist(iLocal_235))
		{
			if (is_entity_playing_anim(Global_100162, &sLocal_239, &cLocal_271, 3))
			{
				if (is_entity_on_fire(Global_100162))
				{
					stop_anim_playback(Global_100162, 0, false);
					clear_ped_tasks(Global_100162);
					return 0;
				}
				fVar0 = get_synchronized_scene_phase(iLocal_280);
				if (!iLocal_234)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_281 != 0)
					{
						stop_particle_fx_looped(iLocal_281, false);
						iLocal_281 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_281 == 0)
					{
						iLocal_281 = start_particle_fx_looped_on_entity("scr_lamgraff_paint_spray", iLocal_235, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
						set_particle_fx_looped_colour(iLocal_281, fLocal_282, fLocal_283, fLocal_284, false);
					}
				}
...
int func_26()
{
	...
	if (!is_ped_injured(Global_100162))
	{
		if (does_entity_exist(iLocal_235))
		{
			if (is_entity_playing_anim(Global_100162, &sLocal_239, &cLocal_255, 3))
			{
				if (is_entity_on_fire(Global_100162))
				{
					stop_anim_playback(Global_100162, 0, false);
				...
				{
					clear_ped_tasks(Global_100162);
					if (!is_synchronized_scene_running(iLocal_280))
					{
						iLocal_280 = create_synchronized_scene(Local_237, 0f, 0f, fLocal_238, 2);
						set_synchronized_scene_looped(iLocal_280, true);
					}
					task_synchronized_scene(Global_100162, iLocal_280, &sLocal_239, &cLocal_271, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					clear_ped_tasks(Global_100162);
					clear_ragdoll_blocking_flags(Global_100162, 16);
					if (!is_synchronized_scene_running(iLocal_280))
					{
						iLocal_280 = create_synchronized_scene(Local_237, 0f, 0f, fLocal_238, 2);
						set_synchronized_scene_looped(iLocal_280, true);
...
void func_37()
{
	request_model(iLocal_236);
	request_ptfx_asset();
	while (!does_entity_exist(Global_100162) || !has_model_loaded(iLocal_236))
	{
		wait(0);
	}
	...
	if (does_entity_exist(Global_100162))
	{
		if (!is_ped_injured(Global_100162))
		{
			task_stand_still(Global_100162, -1);
		}
		set_ped_relationship_group_hash(Global_100162, joaat("player"));
	}
	set_entity_as_mission_entity(Global_100162, true, true);
	set_ped_config_flag(Global_100162, 132, true);
	set_ragdoll_blocking_flags(Global_100162, 16);
	func_39(&Global_100162, Global_95445);
	func_38(&uLocal_68, 1, player_ped_id(), "FRANKLIN", 0, 1);
	iLocal_235 = create_object(iLocal_236, get_entity_coords(Global_100162, true), true, true, false);
	attach_entity_to_entity(iLocal_235, Global_100162, get_ped_bone_index(Global_100162, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 17, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 144, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_44(uParam1, 43, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
