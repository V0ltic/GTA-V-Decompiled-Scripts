...
void func_2()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_5060), &Var0, 227);
	}
	else
	{
...
void func_3()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_4659), &Var0, 401);
	}
	else
	{
...
void func_4()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_4041), &Var0, 618);
	}
	else
	{
...
void func_5()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_3705), &Var0, 336);
	}
	else
	{
...
void func_6()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_3347), &Var0, 358);
	}
	else
	{
...
void func_7()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_2839), &Var0, 508);
	}
	else
	{
...
void func_8()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_2120), &Var0, 719);
	}
	else
	{
...
void func_9()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_1775), &Var0, 345);
	}
	else
	{
...
void func_10()
{
	...
	if (Global_2703734)
	{
		_copy_memory(&(Global_1649593.f_1177), &Var0, 598);
	}
	else
	{
...
{
	clear_bit(&(Global_1649593.f_7041[iParam0]), iParam1);
}
							...
							if (func_229(iVar6))
							{
								if (Global_1648034.f_1353[iVar6 /*11*/][iVar0] == iVar1 + 3 || Global_1648034.f_1187[iVar6 /*11*/][iVar0] == 1)
								{
									if (func_225(Global_1648034.f_1187[iVar6 /*11*/][iVar0]))
									{
										...
										{
											set_script_gfx_align(82, iVar5);
											set_script_gfx_align_params(fLocal_64, fLocal_65, fLocal_66, fLocal_67);
										}
...
void func_46(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, bool bParam11, char* sParam12, int iParam13, float fParam14, int iParam15, int iParam16, int iParam17, bool bParam18, int iParam19, bool bParam20, int iParam21, int iParam22, char* sParam23, bool bParam24, int iParam25, int iParam26, bool bParam27, int iParam28, bool bParam29, bool bParam30, int iParam31, bool bParam32, int iParam33, int iParam34, bool bParam35, bool bParam36, bool bParam37, int iParam38)
{
	...
	if (func_125())
	{
		...
		if (iParam5 < 1000000)
		{
			if ((get_current_language() == 8 && fParam14 >= 100f) && are_strings_equal("AMCH_KMHN", sParam12))
			{
				func_119(uParam2, 0, 0);
			}
			else if (((get_current_language() == 8 || get_current_language() == 9) || get_current_language() == 12) && ((iParam5 > 999 || iParam19 > 999) || fParam14 > 1000f))
			{
				func_119(uParam2, 0, 0);
			}
			else if (iParam19 > 99)
		...
		else if (get_current_language() == 8 && (are_strings_equal("HUD_CASH", sParam12) || are_strings_equal("HUD_CASH_NEG", sParam12)))
		{
			func_119(uParam2, 0, 0);
		}
		else
		...
		{
			iVar5 = func_101();
			set_script_gfx_draw_order(iVar5);
			...
			if (func_123())
			{
				if (bParam11)
				{
					if (get_current_language() == 9 || get_current_language() == 12)
					{
			...
			if (iParam21 == 2 && is_string_null_or_empty(sParam7))
			{
				sParam7 = "HUD_ROCKET";
			}
			else if (iParam21 == 4)
			...
			if (bParam18)
			{
				...
				if (has_streamed_texture_dict_loaded("CommonMenu"))
				{
					...
					if (bParam11 == 1)
					{
						...
						fVar12 = _end_text_command_get_width(true);
					}
					else
					{
						_begin_text_command_get_width(sParam7);
						if (iParam10 != -1)
						{
					...
					if (get_current_language() == 8 && bParam11 == 0)
					{
						fVar13 = (0.153f - 0.072f);
						fVar14 = -0.457f;
					}
					else if (get_current_language() == 10 && bParam11 == 0)
					{
						fVar13 = ((0.153f - 0.01f) - 0.06f);
						fVar14 = -0.457f;
					}
					else if (get_current_language() == 9 && bParam11 == 0)
					{
						fVar13 = ((0.153f - 0.012f) - 0.06f);
						fVar14 = -0.457f;
					}
					else if (get_current_language() == 12 && bParam11 == 0)
					{
						fVar13 = ((0.153f - 0.012f) - 0.06f);
						fVar14 = -0.457f;
					}
			...
			if (bVar4)
			{
				if (iParam21 != 0)
				{
					...
					switch (iParam21)
					{
						...
						case 18:
							if (iParam28 != func_68())
							{
								...
								if (iVar17 != 0)
								{
									sVar21 = get_pedheadshot_txd_string(iVar17);
									sVar22 = get_pedheadshot_txd_string(iVar17);
								}
							}
							if (func_123())
							{
					...
					{
						request_streamed_texture_dict(sVar21, false);
						if (has_streamed_texture_dict_loaded(sVar21))
						{
					...
					if (iParam21 == 18)
					{
						...
						{
							request_streamed_texture_dict(sVar18, false);
							if (has_streamed_texture_dict_loaded(sVar18))
							{
				...
				if ((iParam21 == 0 || iParam21 == 5) || iParam21 == 9)
				{
					...
					else if (iParam21 == 5)
					{
						if (bParam35)
						{
							if (!is_string_null_or_empty(sParam23))
							{
...
void func_48(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (!func_55(sVar0))
	{
		if (func_51())
		{
			...
			add_text_component_formatted_integer(iParam3, true);
			end_text_command_display_text(func_50(*uParam0), func_49(uParam0->f_1), 0);
		}
	}
}
...
void func_73(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	...
	if ((iParam3 / 2) > iVar8)
	{
		...
		get_hud_colour(iParam1, &iVar0, &iVar1, &iVar2, &iVar3);
		get_hud_colour(iParam2, &iVar4, &iVar5, &iVar6, &iVar7);
	}
	else
	{
		fVar9 = (to_float(iVar8) / to_float(iParam3));
		get_hud_colour(iParam2, &iVar0, &iVar1, &iVar2, &iVar3);
		get_hud_colour(iParam1, &iVar4, &iVar5, &iVar6, &iVar7);
	}
...
void func_83(var uParam0, int iParam1)
{
	...
	get_hud_colour(iParam1, &uVar1, &uVar2, &uVar3, &uVar4);
	Var0.f_4 = uVar1;
	Var0.f_5 = uVar2;
	Var0.f_6 = uVar3;
	Var0.f_7 = uVar4;
...
void func_84(struct<8> Param0, int iParam1, int iParam2)
{
	...
	if (func_51())
	{
		if (iParam2 == 1)
		{
			draw_rect(func_50(Var0.f_0), func_49(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, false);
		}
		else
		{
			draw_rect(func_50(Var0.f_0), func_49(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, false);
...
void func_90(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (func_51())
	{
		...
		if (iParam3 == 1)
		{
			draw_sprite(sParam0, sParam1, func_50(Var0.f_0), func_49(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, bParam6, 0);
		}
		else
		{
			draw_sprite(sParam0, sParam1, func_50(Var0.f_0), func_49(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, bParam6, 0);
...
int func_99(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (network_is_game_in_progress() && !bParam3)
	{
...
{
	set_bit(&(Global_1649593.f_7041[iParam0]), iParam1);
}
...
float func_112()
{
	...
	_get_active_screen_resolution(&iVar1, &iVar2);
...
void func_115(var uParam0)
{
	...
	if (((get_current_language() == 7 && get_current_language() == 1) && !get_is_widescreen()) && Global_1649593.f_1174)
	{
		fVar0 = (fVar0 + -0.007f);
	}
	if (Global_1649593.f_1175)
	{
		if (((((get_current_language() != 0 && get_current_language() != 5) && get_current_language() != 6) && get_current_language() != 9) && get_current_language() != 11) && get_current_language() != 12)
		{
			fVar0 = (fVar0 + -0.009f);
		}
		else
	...
	if (Global_1649593.f_1176)
	{
		...
		else if (((((get_current_language() != 0 && get_current_language() != 5) && get_current_language() != 6) && get_current_language() != 9) && get_current_language() != 11) && get_current_language() != 12)
		{
			fVar0 = (fVar0 + -0.024f);
		}
		else
	...
	if (((((((((get_current_language() == 8 || get_current_language() == 7) || get_current_language() == 1) && Global_1649593.f_1173 == 0) && Global_1649593.f_1172 == 0) && Global_1649593.f_1165 == 0) && Global_1649593.f_1174 == 0) && Global_1649593.f_1175 == 0) && Global_1649593.f_1176 == 0) && is_pc_version())
	{
		fVar0 = (fVar0 + -0.005f);
	}
	uParam0->f_9 = fVar0;
...
void func_127(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24, int iParam25)
{
	...
	if (func_125())
	{
		...
		{
			iVar2 = func_101();
			set_script_gfx_draw_order(iVar2);
			Var0.f_0 = *uParam3;
...
void func_128(int iParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, int iParam5, char* sParam6, char* sParam7, int iParam8)
{
	...
	if (!is_string_null_or_empty(sParam3))
	{
		...
		if (has_streamed_texture_dict_loaded(sParam3))
		{
	...
	{
		get_hud_colour(2, &iVar0, &iVar1, &iVar2, &uVar3);
		draw_rect(*uParam1, uParam1->f_1, uParam1->f_2, uParam1->f_3, iVar0, iVar1, iVar2, 153, false);
	}
	if ((((((((((((((iParam0 == 18 || iParam0 == 19) || iParam0 == 20) || iParam0 == 21) || iParam0 == 22) || iParam0 == 23) || iParam0 == 24) || iParam0 == 25) || iParam0 == 26) || iParam0 == 27) || iParam0 == 28) || iParam0 == 29) || iParam0 == 30) || iParam0 == 31) || iParam0 == 32)
	{
		...
		{
			request_streamed_texture_dict(sParam6, false);
			if (has_streamed_texture_dict_loaded(sParam6))
			{
		...
		case 32:
			if (*uParam5 != func_68())
			{
				*uParam6 = func_61(*uParam5);
				if (*uParam6 != 0)
				{
					StringCopy(sParam2, get_pedheadshot_txd_string(*uParam6), 24);
					StringCopy(sParam3, get_pedheadshot_txd_string(*uParam6), 24);
				}
			}
...
void func_132(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, var uParam23, bool bParam24, int iParam25, int iParam26, int iParam27, int iParam28, int iParam29, int iParam30, bool bParam31, int iParam32, int iParam33, var uParam34, int iParam35, int iParam36)
{
	...
	if (func_125())
	{
		...
		if (iParam5 < 1000000)
		{
			if ((get_current_language() == 8 && fParam6 >= 100f) && are_strings_equal("AMCH_KMHN", sParam7))
			{
				func_119(uParam2, 0, 0);
			}
			else if (((get_current_language() == 8 || get_current_language() == 9) || get_current_language() == 12) && ((iParam5 > 999 || iParam9 > 999) || fParam6 > 1000f))
			{
				func_119(uParam2, 0, 0);
			}
			else if (iParam9 > 99)
		...
		else if (get_current_language() == 8 && (are_strings_equal("HUD_CASH", sParam7) || are_strings_equal("HUD_CASH_NEG", sParam7)))
		{
			func_119(uParam2, 0, 0);
		}
		else
		...
		request_streamed_texture_dict("TimerBars", false);
		if (func_138(&cVar21, &Var22, &cVar24, &Var25, &cVar27, &Var28, &cVar30, &Var31, &cVar33, &Var34) && has_streamed_texture_dict_loaded("TimerBars"))
		{
			iVar66 = func_101();
			set_script_gfx_draw_order(iVar66);
			Var0.f_0 = *uParam3;
			Var0.f_1 = uParam3->f_1;
			if (iParam5 < 1000000)
			{
			...
			if (uParam34 && get_toggle_paused_renderphases_status())
			{
				if (bVar67)
				{
			...
			else if (are_strings_equal("HUD_CASH", sParam7) || are_strings_equal("HUD_CASH_S", sParam7))
			{
				sParam7 = "HUD_CASH_S";
				*uParam2 = 5;
				func_81(uParam2, 0);
			...
			else if (are_strings_equal("HUD_CASH_NEG", sParam7) || are_strings_equal("HUD_CASH_NEG_S", sParam7))
			{
				*uParam2 = 5;
				func_81(uParam2, 0);
...
void func_133(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	...
	{
		request_streamed_texture_dict(sParam1, false);
		if (has_streamed_texture_dict_loaded(sParam1))
		{
...
int func_139(char* sParam0, char* sParam1)
{
	...
	{
		request_streamed_texture_dict(sParam0, false);
		if (has_streamed_texture_dict_loaded(sParam0))
		{
			iVar0 = 1;
		}
	}
	...
	if (func_125())
	{
		...
		if (has_streamed_texture_dict_loaded("TimerBars"))
		{
			...
			if (func_123())
			{
				...
				else if (get_current_language() == 9 || get_current_language() == 12)
				{
...
void func_159(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	...
	{
		func_163();
		get_hud_colour(iParam5, &uVar0, &uVar1, &uVar2, &uVar3);
		...
		fVar4 = 0.131f;
		if (get_current_language() == 8)
		{
			fVar4 = 0.0872f;
		}
		else if (get_current_language() == 10)
		{
			fVar4 = 0.095f;
		}
		*uParam2 = 0.795f;
...
void func_204(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, bool bParam16, int iParam17, int iParam18, bool bParam19, int iParam20, bool bParam21, int iParam22, int iParam23, bool bParam24)
{
	...
	{
		iVar4 = func_101();
		set_script_gfx_draw_order(iVar4);
...
int func_241()
{
	...
	if (_is_multiplayer_chat_active())
	{
		return 0;
	}
	...
	if (Global_23011.f_4 && func_223(player_id()) == 0)
	{
		return 0;
	}
	...
	if (func_228() == 0)
	{
		if (Global_2689235[player_id() /*453*/].f_230 != 99)
		{
			if (((network_is_in_spectator_mode() == 0 && Global_1836575 == 0) && !BitTest(Global_2703735.f_1571.f_756, 11)) && Global_1853348[player_id() /*834*/] != 0)
			{
				return 0;
			}
		}
...
{
	clear_bit(&(Global_1649593.f_7057[iParam0]), iParam1);
}
