...
void __EntryFunction__()
{
	...
	iLocal_53 = 49;
	iLocal_54 = 64;
	iLocal_77 = get_standard_blip_enum_id();
	iLocal_78 = get_waypoint_blip_enum_id();
		...
		switch (iVar1)
		{
			...
			case 1:
				...
				if (!func_77() && !Global_97369)
				{
					if (iVar1 != 2)
					{
						if ((!is_minigame_in_progress() && !bVar0) && !func_76(5))
						{
							func_73();
							if (func_72())
							{
								...
								switch (iLocal_102)
								{
									case 0:
										if (func_70() == 0)
										{
											...
											{
												if (!is_help_message_being_displayed() && func_60())
												{
													iLocal_103 = 9;
									...
									case 2:
										...
										if (func_61(&iLocal_114) > 15f)
										{
											...
											fLocal_107 = (get_random_float_in_range(10f, 40f) + func_61(&iLocal_114));
											iLocal_102 = 3;
										}
										else if (iLocal_108)
										{
								...
								if (((is_control_pressed(0, 86) && !is_entity_upsidedown(player_ped_id())) && !Global_32111) && (get_game_timer() - iLocal_105) > 3000)
								{
									iVar4 = func_70();
									if (iVar4 == 0)
									{
							...
							else
							{
								...
								if (((get_game_timer() - iLocal_106) > 60000 && !func_66("TC_HOWTOSTART")) && iLocal_112)
								{
									iLocal_112 = 0;
								}
								if (bLocal_110)
			...
			case 4:
				...
				{
					set_horn_enabled(get_vehicle_ped_is_in(player_ped_id(), false), true);
				}
				if (has_script_loaded(&Local_97))
				{
			...
			case 8:
				if (func_72())
				{
					if (!func_23())
					{
						...
						iLocal_96 = start_new_script(&Local_97, 51000);
						set_script_as_no_longer_needed(&Local_97);
						if (!func_84(Global_113386.f_19097, 4))
						{
							func_82(&(Global_113386.f_19097), 4);
							set_vehicle_model_is_suppressed(func_22(), true);
						}
...
void func_2()
{
	...
	if (is_xbox360_version() || func_4())
	{
		network_set_rich_presence(StackVal, 0, 0, 0);
	}
	else if (is_ps3_version() || func_3())
	{
...
void func_30(char* sParam0, int iParam1)
{
	...
	{
		if (func_66(sParam0) && !is_help_message_fading_out())
		{
			clear_help(false);
		}
	}
...
void func_49()
{
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (func_51(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_86(player_ped_id());
...
int func_70()
{
	...
	else
	{
		...
		iVar1 = round(get_vehicle_engine_health(iVar0));
		iVar2 = get_entity_health(iVar0);
...
int func_78(bool bParam0)
{
	...
	if (is_control_just_released(0, 19) || (!bParam0 && is_disabled_control_just_released(0, 19)))
	{
		return 1;
	}
	if (is_pc_version())
...
void func_81(var uParam0)
{
	...
	if (iVar0 == 0)
	{
		func_59(uParam0, 0, player_ped_id(), "MICHAEL", 0, 1);
	}
	else if (iVar0 == 2)
	{
		func_59(uParam0, 0, player_ped_id(), "TREVOR", 0, 1);
	}
	else if (iVar0 == 1)
	{
		func_59(uParam0, 0, player_ped_id(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_59(uParam0, 0, player_ped_id(), "MICHAEL", 0, 1);
...
void func_91()
{
	...
	if (get_length_of_literal_string(&Local_97) != 0)
	{
		set_script_as_no_longer_needed(&Local_97);
	}
	if (does_blip_exist(iLocal_101))
