...
void __EntryFunction__()
{
	...
	iLocal_228 = 24818;
	iLocal_231 = 24816;
	if (has_force_cleanup_occurred(178))
	{
...
void func_1()
{
	switch (iLocal_221)
	{
		...
		case 1:
			if (func_17(&iLocal_208) > 5f)
			{
				if (!BitTest(Global_113386.f_10049.f_99, 3))
				{
					...
					func_7(28);
					set_bit(&(Global_113386.f_10049.f_99), 3);
					func_5(63, 1);
					iLocal_221++;
				}
			}
		...
		case 3:
			set_bit(&(Global_113386.f_10049.f_99), 0);
			func_2();
			break;
	}
}
...
void func_8(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_9(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_10(iParam1)), 0));
		}
		else
		{
			func_9(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_10(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
	...
	switch (iLocal_81)
	{
		case 0:
			if (bLocal_214)
			{
				if (!func_29())
				{
					iLocal_211 = request_scaleform_movie("MIDSIZED_MESSAGE");
					while (!has_scaleform_movie_loaded(iLocal_211))
					{
						wait(0);
					}
					begin_scaleform_movie_method(iLocal_211, "SHOW_BRIDGES_KNIVES_PROGRESS");
					func_28("PW_TITLE");
					scaleform_movie_method_add_param_int(20);
					func_28("PW_PASS");
					func_28("PW_CHALLENGE");
					scaleform_movie_method_add_param_int(func_26());
		...
		case 1:
			...
			{
				begin_scaleform_movie_method(iLocal_211, "SHARD_ANIM_OUT");
...
void func_22()
{
	if (has_scaleform_movie_loaded(iLocal_211))
	{
		set_scaleform_movie_as_no_longer_needed(&iLocal_211);
	}
}
...
void func_23()
{
	if (!func_29())
	{
		if (has_scaleform_movie_loaded(iLocal_211))
		{
			draw_scaleform_movie(iLocal_211, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
	}
}
...
int func_26()
{
	...
	if (iVar0 == 20)
	{
		set_bit(&(Global_113386.f_10049.f_99), 1);
	}
	return iVar0;
}
...
void func_32()
{
	...
	if ((func_17(&iLocal_205) <= 3f && func_34(0)) && func_33(player_ped_id()))
	{
		if ((is_control_just_pressed(0, 177) || (is_control_just_pressed(0, 24) && !is_ped_in_any_vehicle(player_ped_id(), false))) || (func_31() && !iLocal_216))
		{
			func_36(&iLocal_205, 0f);
			func_35(&iLocal_205);
		}
...
void func_46()
{
	switch (iLocal_79)
	{
		...
		case 6:
			func_54(iLocal_213);
			func_51(iLocal_82);
			stat_set_int(joaat("num_hidden_packages_7"), func_27(), true);
			bLocal_214 = true;
			func_48(&iLocal_205);
			func_48(&iLocal_208);
			iLocal_217 = 1;
...
void func_54(int iParam0)
{
	switch (iParam0)
	{
		case joaat("a_c_boar"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 4);
				iLocal_82 = 1;
			}
			break;
		...
		case joaat("a_c_cat_01"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 5);
				iLocal_82 = 3;
			}
			break;
		...
		case joaat("a_c_chickenhawk"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 6);
				iLocal_82 = 4;
			}
			break;
		...
		case joaat("a_c_cormorant"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 7);
				iLocal_82 = 5;
			}
			break;
		...
		case joaat("a_c_cow"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 8);
				iLocal_82 = 6;
			}
			break;
		...
		case joaat("a_c_coyote"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 9);
				iLocal_82 = 7;
			}
			break;
		...
		case joaat("a_c_crow"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 10);
				iLocal_82 = 8;
			}
			break;
		...
		case joaat("a_c_deer"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 11);
				iLocal_82 = 9;
			}
			break;
		...
		case joaat("a_c_hen"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 14);
				iLocal_82 = 10;
			}
			break;
		...
		case joaat("a_c_husky"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 16);
				iLocal_82 = 11;
			}
			break;
		...
		case joaat("a_c_mtlion"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 18);
				iLocal_82 = 12;
			}
			break;
		...
		case joaat("a_c_pig"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 19);
				iLocal_82 = 13;
			}
			break;
		...
		case joaat("a_c_poodle"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 21);
				iLocal_82 = 15;
			}
			break;
		...
		case joaat("a_c_pug"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 22);
				iLocal_82 = 16;
			}
			break;
		...
		case joaat("a_c_rabbit_01"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 23);
				iLocal_82 = 14;
			}
			break;
		...
		case joaat("a_c_retriever"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 24);
				iLocal_82 = 17;
			}
			break;
		...
		case joaat("a_c_chop"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 25);
				iLocal_82 = 18;
			}
			break;
		...
		case joaat("a_c_seagull"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 26);
				iLocal_82 = 19;
			}
			break;
		...
		case joaat("a_c_shepherd"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 29);
				iLocal_82 = 2;
			}
			break;
		...
		case joaat("a_c_westy"):
			...
			{
				set_bit(&(Global_113386.f_10049.f_99), 31);
				iLocal_82 = 20;
			}
			break;
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9)
{
	...
	iVar0 = get_focus_ped_on_screen(fParam1, iParam2, fParam3, fParam4, fParam5, fParam6, fParam7, iParam8, iParam9);
	...
	if (iVar0 != 0 && func_33(iVar0))
	{
		if (get_ped_type(iVar0) == 28)
		{
			...
			{
				*iParam0 = get_entity_model(iVar0);
				if (func_69(iVar0, 31086))
				{
					fVar1 = func_68(player_ped_id(), iVar0, 1);
					if (has_entity_clear_los_to_entity_in_front(player_ped_id(), iVar0))
					{
					}
					if (func_67(*iParam0))
					{
...
int func_69(int iParam0, int iParam1)
{
	...
	fVar2 = 0f;
	fVar3 = 0f;
	Local_220 = { get_world_position_of_entity_bone(iParam0, get_ped_bone_index(iParam0, iParam1)) };
	if (iLocal_213 == joaat("a_c_rabbit_01") || iLocal_213 == joaat("a_c_rat"))
	{
		Local_219 = { get_world_position_of_entity_bone(iParam0, get_ped_bone_index(iParam0, 24816)) };
	}
	else
	{
		Local_219 = { get_world_position_of_entity_bone(iParam0, get_ped_bone_index(iParam0, 24818)) };
	}
	get_screen_coord_from_world_coord(Local_219, &fVar0, &fVar1);
	get_screen_coord_from_world_coord(Local_220, &fVar2, &fVar3);
...
int func_72()
{
	if (_get_number_of_references_of_script_with_name_hash(joaat("paparazzo3a")) > 0)
	{
		return 1;
	}
...
void func_82()
{
	...
	{
		set_bit(&(Global_113386.f_10049.f_99), 2);
	}
	iLocal_221 = 0;
	iLocal_216 = func_31();
	iLocal_83[0] = 249;
