...
void func_3()
{
	if (func_6())
	{
		...
		if (_get_number_of_references_of_script_with_name_hash(get_hash_key(&uLocal_210)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	...
	{
		case 0:
			if ((((((func_35(130) && func_33(player_id()) != 192) && func_33(player_id()) != 190) && func_33(player_id()) != 191) && func_33(player_id()) != 225) && func_33(player_id()) != 226) && func_33(player_id()) != 227)
			{
				if (Global_32193)
				{
					iLocal_217 = 11;
		...
		case 1:
			if (_get_number_of_references_of_script_with_name_hash(joaat("emergencycall")) == 0)
			{
				if (!func_35(130))
				{
					iLocal_43 = 1;
...
{
	Global_32184 = 1;
	StringCopy(&Global_32185, get_this_script_name(), 32);
}
