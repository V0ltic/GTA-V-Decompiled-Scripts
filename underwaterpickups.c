...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { get_entity_coords(player_ped_id(), false) };
	func_1();
	while (true)
	{
		wait(0);
		...
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &iVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = create_pickup(iVar1, Var2, iVar4, iVar5, true, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = create_pickup(iVar1, Var2, iVar4, -1, true, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = create_pickup_rotate(iVar1, Var2, Var3, iVar4, 10000, 2, true, 0);
					}
				}
				else if (vdist2(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = create_pickup_rotate(iVar1, Var2, Var3, iVar4, -1, 2, true, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (does_pickup_exist(iLocal_3[iVar0]))
		{
			remove_pickup(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
