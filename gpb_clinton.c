...
void __EntryFunction__()
{
	...
	iLocal_208 = create_ped(25, iLocal_36, Local_210, ScriptParam_332.f_17[0], false, true);
	func_104();
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					task_follow_nav_mesh_to_coord(iLocal_208, Local_210, 1f, -1, 1f, 1024, ScriptParam_332.f_17[0]);
					iLocal_216 = 6;
				}
				break;
...
void func_114(int iParam0)
{
	...
	if (iLocal_209)
	{
		...
		if (are_strings_equal(&uVar0, &Local_327))
		{
			func_13();
		}
		if (iParam0 == 1)
