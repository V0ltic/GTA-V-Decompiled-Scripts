...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			Var0 = { func_86(player_id()) };
			_request_paths_prefer_accurate_boundingstruct((Var0.f_0 - 2000f), (Var0.f_1 - 2000f), (Var0.f_0 + 2000f), (Var0.f_1 + 2000f));
...
int func_34()
{
	...
	if (!func_55())
	{
		...
		while (iVar0 < 3)
		{
			if (!is_ped_injured(iLocal_63[iVar0]))
			{
				if (vdist2(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_63[iVar0], false)) < 400f)
				{
					if (!iLocal_52)
					{
						if (iLocal_61 == 2)
						{
							if (is_ped_in_any_vehicle(player_ped_id(), false) && get_entity_speed(player_ped_id()) < 2f)
							{
								iLocal_52 = 1;
								iLocal_61 = 3;
							}
							else if (is_ped_on_foot(player_ped_id()) && get_entity_speed(player_ped_id()) < 1f)
							{
								iLocal_52 = 1;
								iLocal_61 = 3;
							}
						}
						if (((has_entity_been_damaged_by_entity(iLocal_63[iVar0], player_ped_id(), true) || is_ped_shooting(player_ped_id())) || is_player_targetting_entity(player_id(), iLocal_63[iVar0])) || is_player_free_aiming_at_entity(player_id(), iLocal_63[iVar0]))
						{
							iLocal_52 = 1;
							iLocal_55 = 1;
							iLocal_54 = 1;
					...
					if (!iLocal_52 || iLocal_61 < 3)
					{
						if (timera() > 5000)
						{
							if (!is_ped_in_writhe(iLocal_63[iVar0]))
							{
								func_54(&uLocal_68, 1);
					...
					{
						if (!func_55() && !is_ped_in_writhe(iLocal_63[iVar0]))
						{
							set_relationship_between_groups(5, iLocal_66, joaat("player"));
							set_ped_combat_attributes(iLocal_63[iVar0], 2, true);
							func_54(&uLocal_68, 1);
							func_53(&uLocal_68, 1, iLocal_63[iVar0], "BorderPatrol", 0, 1);
							if (func_35() == 0)
							{
					...
					else if (!func_55())
					{
						...
						if (timera() > 5000 && !is_ped_in_writhe(iLocal_63[iVar0]))
						{
							func_54(&uLocal_68, 1);
							func_53(&uLocal_68, 1, iLocal_63[iVar0], "BorderPatrol", 0, 1);
							if (func_35() == 0)
...
int func_56()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(iLocal_63[iVar0]))
		{
			if (vdist2(get_entity_coords(player_ped_id(), false), get_entity_coords(iLocal_63[iVar0], false)) < 62500f)
			{
				return 1;
			}
			else
...
void func_57()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(iLocal_63[iVar0]))
		{
			...
			{
				if (is_ped_in_any_vehicle(iLocal_63[iVar0], false))
				{
					if (is_ped_in_any_vehicle(player_ped_id(), false) && !iLocal_57[iVar0])
					{
						if (!is_entity_dead(iLocal_64[iVar0], false))
						{
							task_vehicle_mission(iLocal_63[iVar0], iLocal_64[iVar0], get_vehicle_ped_is_in(player_ped_id(), false), iVar0 + 10, 30f, 786469, 10f, 5f, true);
						}
						if (!iLocal_55)
						{
						...
						if (!is_ped_injured(iLocal_63[iVar0]))
						{
							if (is_ped_in_any_vehicle(iLocal_63[iVar0], false))
							{
								task_drive_by(iLocal_63[iVar0], player_ped_id(), 0, 0f, 0f, 0f, 1000f, 60, true, -753768974);
								set_ped_keep_task(iLocal_63[iVar0], true);
							}
						}
						iLocal_58[iVar0] = 0;
						iLocal_57[iVar0] = 1;
					}
					else if (!is_ped_in_any_vehicle(player_ped_id(), false) && !iLocal_58[iVar0])
					{
						if (!is_ped_injured(iLocal_63[iVar0]) && !is_entity_dead(iLocal_64[iVar0], false))
						{
							task_vehicle_mission_ped_target(iLocal_63[iVar0], iLocal_64[iVar0], player_ped_id(), iVar0 + 10, 30f, 786469, 10f, 5f, true);
							if (!iLocal_55)
							{
								wait(get_random_int_in_range(400, 800));
							}
				...
				else if (!is_ped_in_any_vehicle(iLocal_63[iVar0], false))
				{
					task_combat_ped(iLocal_63[iVar0], player_ped_id(), 0, 16);
					set_ped_keep_task(iLocal_63[iVar0], true);
				}
			}
			else if (is_ped_in_any_vehicle(iLocal_63[iVar0], false))
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false) && !iLocal_59[iVar0])
				{
					if (get_script_task_status(iLocal_63[iVar0], 579380604) != 1 && get_script_task_status(iLocal_63[iVar0], 579380604) != 0)
					{
						clear_ped_tasks(iLocal_63[iVar0]);
						if (!is_entity_dead(iLocal_64[iVar0], false))
						{
							task_vehicle_mission(iLocal_63[iVar0], iLocal_64[iVar0], get_vehicle_ped_is_in(player_ped_id(), false), iVar0 + 10, 30f, 786469, 10f, 5f, true);
							task_look_at_entity(iLocal_63[iVar0], player_ped_id(), -1, 2096, 4);
						}
						iLocal_60[iVar0] = 0;
						iLocal_59[iVar0] = 1;
					}
				}
				else if (!is_ped_in_any_vehicle(player_ped_id(), false) && !iLocal_60[iVar0])
				{
					if ((!is_ped_injured(iLocal_63[iVar0]) && !is_ped_injured(player_ped_id())) && !is_entity_dead(iLocal_64[iVar0], false))
					{
						clear_ped_tasks(iLocal_63[iVar0]);
						task_vehicle_mission_ped_target(iLocal_63[iVar0], iLocal_64[iVar0], player_ped_id(), iVar0 + 10, 30f, 786469, 10f, 5f, true);
						task_look_at_entity(iLocal_63[iVar0], player_ped_id(), -1, 2096, 4);
			...
			{
				task_follow_to_offset_of_entity(iLocal_63[iVar0], player_ped_id(), 1f, 0f, 0f, 2f, -1, 0.1f, true);
			}
			if (!is_ped_injured(iLocal_63[iVar0]))
			{
				if (is_entity_in_water(iLocal_63[iVar0]))
				{
					if (is_ped_in_any_vehicle(iLocal_63[iVar0], false))
					{
						task_leave_any_vehicle(iLocal_63[iVar0], 0, 0);
					}
					if (!is_ped_in_combat(iLocal_63[iVar0], 0))
					{
						task_combat_ped(iLocal_63[iVar0], player_ped_id(), 0, 16);
					}
				}
			}
			if (is_ped_in_any_vehicle(player_ped_id(), false) && is_ped_in_any_vehicle(iLocal_63[iVar0], false))
			{
				if (get_entity_speed(player_ped_id()) > 13f)
				{
					if (is_entity_touching_entity(get_vehicle_ped_is_in(player_ped_id(), false), get_vehicle_ped_is_in(iLocal_63[iVar0], false)))
					{
						set_ped_can_be_knocked_off_vehicle(iLocal_63[iVar0], 3);
					}
					else
					{
						set_ped_can_be_knocked_off_vehicle(iLocal_63[iVar0], 1);
					}
				}
				else
				{
			...
			if (func_133())
			{
				task_smart_flee_ped(iLocal_63[iVar0], player_ped_id(), 1000f, -1, false, false);
			}
		}
		else if (does_entity_exist(iLocal_63[iVar0]))
		{
			iLocal_55 = 1;
			iLocal_54 = 1;
		}
...
void func_58()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(iLocal_63[iVar0]))
		{
			...
			{
				if (!does_blip_exist(uLocal_65[iVar0]))
				{
					uLocal_65[iVar0] = func_59(iLocal_63[iVar0], 1, 145);
				}
			}
		}
		else if (does_blip_exist(uLocal_65[iVar0]))
		{
			remove_blip(&(uLocal_65[iVar0]));
		}
		iVar0++;
	}
}
...
int func_60(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_61(network_is_game_in_progress(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_61(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
int func_66()
{
	switch (func_67(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
int func_72()
{
	...
	request_model(iVar4);
	request_model(iVar5);
	if ((has_model_loaded(iVar6) && has_model_loaded(iVar4)) && has_model_loaded(iVar5))
	{
		if ((is_vehicle_driveable(iLocal_64[0], false) && is_vehicle_driveable(iLocal_64[1], false)) && is_vehicle_driveable(iLocal_64[2], false))
		{
			return 1;
		}
		else
		{
			...
			{
				get_nth_closest_vehicle_node_favour_direction(get_offset_from_entity_in_world_coords(player_ped_id(), 0f, -25f, 0f), get_entity_coords(player_ped_id(), false), 1, &Var0, &fVar1, 1, 3f, 0);
				if (!is_sphere_visible(Var0, 5f))
				{
					add_relationship_group("re_border badGuys", &iLocal_66);
					...
					while (iVar2 < 3)
					{
						...
						if (iVar3 > 1)
						{
							iLocal_64[iVar2] = create_vehicle(iVar4, Var0, fVar1, true, true, false);
						}
						else
						{
							iLocal_64[iVar2] = create_vehicle(iVar5, Var0, fVar1, true, true, false);
						}
						iLocal_63[iVar2] = create_ped_inside_vehicle(iLocal_64[iVar2], 22, iVar6, -1, true, true);
						task_look_at_entity(iLocal_63[iVar2], player_ped_id(), -1, 2096, 4);
						set_ped_keep_task(iLocal_63[iVar2], true);
						set_blocking_of_non_temporary_events(iLocal_63[iVar2], true);
						set_ped_relationship_group_hash(iLocal_63[iVar2], iLocal_66);
						give_weapon_to_ped(iLocal_63[iVar2], joaat("weapon_sawnoffshotgun"), -1, true, true);
						set_vehicle_forward_speed(iLocal_64[iVar2], get_entity_speed(player_ped_id()));
						set_ped_combat_movement(iLocal_63[iVar2], 2);
						set_ped_combat_attributes(iLocal_63[iVar2], 50, true);
						set_ped_combat_attributes(iLocal_63[iVar2], 2, true);
						set_ped_combat_attributes(iLocal_63[iVar2], 1, true);
						set_ped_combat_attributes(iLocal_63[iVar2], 52, true);
						set_ped_accuracy(iLocal_63[iVar2], 5);
						set_ped_firing_pattern(iLocal_63[iVar2], 1566631136);
						set_ped_shoot_rate(iLocal_63[iVar2], get_random_int_in_range(50, 100));
						set_ped_can_be_knocked_off_vehicle(iLocal_63[iVar2], 1);
						set_ped_config_flag(iLocal_63[iVar2], 42, true);
						set_ped_helmet(iLocal_63[iVar2], false);
						set_ped_money(iLocal_63[iVar2], 233);
						set_ambient_voice_name(iLocal_63[iVar2], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
						stop_ped_speaking(iLocal_63[iVar2], true);
						iVar2++;
					}
					set_vehicle_colour_combination(iLocal_64[0], 0);
					set_vehicle_colour_combination(iLocal_64[1], 1);
					set_vehicle_colour_combination(iLocal_64[2], 2);
				}
			}
			switch (func_35())
			{
			...
			func_53(&uLocal_68, 0, player_ped_id(), sLocal_67, 0, 1);
...
int func_73()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_80())
		{
			return 0;
		}
	}
...
int func_108()
{
	...
	func_114(&uVar0, get_clock_seconds());
	func_113(&uVar0, get_clock_minutes());
	func_112(&uVar0, get_clock_hours());
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_125()) || Global_31962) || func_124()) || func_49(8, -1)) || func_121()) || func_123()) || func_122()) || func_120()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_125()) || Global_112433) || Global_31962) || func_124()) || func_49(8, -1)) || func_121()) || func_123()) || func_122()) || func_120()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_125()) || Global_112433) || Global_31962) || func_124()) || func_49(8, -1)) || func_123()) || func_122()) || func_120()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_125() || get_player_wanted_level(player_id()) > 0) || func_49(8, -1)) || func_120()) || func_119()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_133()
{
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			{
				if (((((is_ped_in_model(player_ped_id(), joaat("rhino")) || is_ped_in_model(player_ped_id(), joaat("ambulance"))) || is_ped_in_model(player_ped_id(), joaat("firetruk"))) || is_ped_in_any_police_vehicle(player_ped_id())) || is_ped_in_flying_vehicle(player_ped_id())) || Global_112433 == 1)
				{
					return 1;
				}
			}
...
void func_134()
{
	...
	if (iLocal_51)
	{
		...
		while (iVar0 < 3)
		{
			if (!is_ped_injured(iLocal_63[iVar0]) && !is_ped_injured(player_ped_id()))
			{
				task_smart_flee_ped(iLocal_63[iVar0], player_ped_id(), 1000f, -1, false, false);
				set_ped_keep_task(iLocal_63[iVar0], true);
			}
...
Vector3 func_146()
{
	...
	if (is_player_playing(player_id()))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_47, true);
		bLocal_50 = true;
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_48, true) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_48, true);
			bLocal_50 = 2;
		}
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_49, true) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_49, true);
			bLocal_50 = 3;
		}
		if (bLocal_50 == 1)
		{
