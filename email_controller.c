...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!Global_44247 && get_game_timer() > Global_43603)
		{
			iVar5 = 0;
			while (iVar5 < 122)
			{
...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_4(iParam1)), 0));
		}
		else
		{
			func_3(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_4(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
