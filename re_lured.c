...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (is_world_point_within_brain_activation_range() || bLocal_229)
		{
			if (!func_133())
			{
				if (func_132())
			...
			switch (iLocal_44)
			{
				...
				case 1:
					if (!bLocal_229)
					{
						...
						{
							set_ped_reset_flag(iLocal_55, 247, true);
						}
					}
					else
					{
					...
					{
						set_ped_reset_flag(iLocal_56, 156, true);
					}
					func_36();
					func_35();
					func_1();
...
void func_1()
{
	if (bLocal_229)
	{
		...
		{
			if (!is_entity_at_entity(player_ped_id(), iLocal_56, 100f, 100f, 100f, false, true, 0))
			{
				func_2();
			}
		}
		else if (!is_entity_at_entity(player_ped_id(), iLocal_56, 100f, 100f, 100f, false, true, 0))
		{
			func_3();
		}
	}
	else
	{
		if (!is_ped_injured(iLocal_55))
		{
			if (has_entity_been_damaged_by_entity(iLocal_55, player_ped_id(), true) || has_entity_been_damaged_by_any_vehicle(iLocal_55))
			{
				func_2();
			}
		}
		if (is_ped_injured(iLocal_55))
		{
			if (!is_ped_injured(iLocal_56))
			{
				...
				task_perform_sequence(iLocal_56, iLocal_61);
		...
		if (is_ped_injured(iLocal_56))
		{
			if (!is_ped_injured(iLocal_55))
			{
				...
				task_smart_flee_ped(0, player_ped_id(), 1000f, -1, false, false);
				close_sequence_task(iLocal_61);
				task_perform_sequence(iLocal_55, iLocal_61);
...
void func_36()
{
	...
	{
		if ((func_56() || is_ped_armed(player_ped_id(), 6)) || !is_entity_at_coord(player_ped_id(), get_entity_coords(iLocal_56, false), 12f, 12f, 5f, false, true, 0))
		{
			set_relationship_between_groups(5, iLocal_54, joaat("player"));
			if (!is_ped_injured(iLocal_56))
			{
				clear_ped_tasks(iLocal_56);
				task_combat_ped(iLocal_56, player_ped_id(), 0, 16);
				if (is_entity_at_entity(player_ped_id(), iLocal_56, 15f, 15f, 15f, false, true, 0))
				{
					func_54();
					wait(0);
			...
			{
				clear_ped_tasks(iLocal_55);
				task_combat_ped(iLocal_55, player_ped_id(), 0, 16);
			}
			iLocal_232 = 1;
		}
	}
...
int func_56()
{
	...
	Var0 = { 30f, 30f, 30f };
	Var1 = { -30f, -30f, -30f };
	if (!is_ped_injured(iLocal_55) && !is_ped_injured(iLocal_56))
	{
		if (is_bullet_in_area(get_ped_bone_coords(iLocal_55, 31086, 0f, 0f, 0f), 30f, true))
		{
			return 1;
		}
		if (is_entity_at_entity(player_ped_id(), iLocal_55, 30f, 30f, 30f, false, true, 0) && is_ped_armed(player_ped_id(), 6))
		{
			if (((is_player_free_aiming_at_entity(player_id(), iLocal_55) || is_player_free_aiming_at_entity(player_id(), iLocal_56)) || is_player_targetting_entity(player_id(), iLocal_55)) || is_player_targetting_entity(player_id(), iLocal_56))
			{
				if (can_ped_see_hated_ped(iLocal_55, player_ped_id()) || can_ped_see_hated_ped(iLocal_56, player_ped_id()))
				{
					func_54();
					wait(0);
		...
		Var0 = { Var0 + get_ped_bone_coords(iLocal_55, 31086, 0f, 0f, 0f) };
		Var1 = { Var1 + get_ped_bone_coords(iLocal_55, 31086, 0f, 0f, 0f) };
		...
		if (get_is_petrol_decal_in_range(get_ped_bone_coords(iLocal_55, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			{
				if (is_entity_touching_entity(player_ped_id(), iLocal_55) || is_entity_touching_entity(player_ped_id(), iLocal_56))
				{
					return 1;
				}
			}
		...
		if (is_cop_ped_in_area_3d(get_entity_coords(iLocal_55, false) - Local_49, get_entity_coords(iLocal_55, false) + Local_49) || is_cop_vehicle_in_area_3d(get_entity_coords(iLocal_55, false) - Local_49, get_entity_coords(iLocal_55, false) + Local_49))
		{
			return 1;
		}
	}
	...
	if (is_entity_at_coord(player_ped_id(), Local_47, 15f, 15f, 15f, false, true, 0))
	{
	...
	if (is_entity_at_coord(player_ped_id(), Local_47, 40f, 40f, 40f, false, true, 0))
	{
	...
	{
		if (has_entity_been_damaged_by_entity(iLocal_56, player_ped_id(), true))
		{
			func_54();
			return 1;
		}
...
void func_58()
{
	if (!bLocal_230)
	{
		if (!is_ped_injured(iLocal_56))
		{
			if (get_script_task_status(iLocal_56, 242628503) == 7 && is_entity_at_entity(iLocal_56, player_ped_id(), 2.8f, 2.8f, 2.8f, false, true, 0))
			{
				if (!iLocal_231)
				{
					iLocal_236 = 500;
					...
					if (!is_ped_injured(iLocal_56))
					{
						set_ped_money(iLocal_56, iLocal_237);
					}
					iLocal_231 = 1;
				}
				if (!is_ped_injured(iLocal_56))
...
void func_91()
{
	if (!is_ped_injured(iLocal_56))
	{
		if (is_entity_at_coord(player_ped_id(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			...
			{
				task_look_at_entity(iLocal_56, player_ped_id(), -1, 2048, 2);
				set_ped_ducking(iLocal_56, false);
				give_weapon_to_ped(iLocal_56, joaat("weapon_pistol"), 200, true, true);
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					func_54();
					wait(0);
				...
				else
				{
					...
					task_play_anim(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, -1, 0, 0f, false, false, false);
					task_go_to_entity_while_aiming_at_entity(0, player_ped_id(), player_ped_id(), 2f, false, 2.3f, 4f, true, true, joaat("FIRING_PATTERN_FULL_AUTO"));
					task_aim_gun_at_entity(0, player_ped_id(), 500, false);
					close_sequence_task(iLocal_61);
				}
				task_perform_sequence(iLocal_56, iLocal_61);
				...
				if (!is_ped_injured(iLocal_55))
				{
					task_look_at_entity(iLocal_55, player_ped_id(), -1, 2048, 2);
					give_weapon_to_ped(iLocal_55, joaat("weapon_pistol"), 200, true, true);
					open_sequence_task(&iLocal_61);
					task_go_to_coord_while_aiming_at_entity(0, Local_52, player_ped_id(), 2f, false, 0f, 4f, true, 512, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
					task_aim_gun_at_entity(0, player_ped_id(), 5000, false);
					close_sequence_task(iLocal_61);
					task_perform_sequence(iLocal_55, iLocal_61);
					clear_sequence_task(&iLocal_61);
				}
				...
				{
					open_sequence_task(&iLocal_61);
					task_look_at_entity(0, iLocal_56, -1, 2048, 2);
					task_pause(0, 1000);
					close_sequence_task(iLocal_61);
					task_perform_sequence(player_ped_id(), iLocal_61);
					clear_sequence_task(&iLocal_61);
					func_92(1);
				}
				func_54();
...
int func_100(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_101(network_is_game_in_progress(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_101(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
void func_102()
{
	...
	{
		if (is_entity_at_entity(player_ped_id(), iLocal_55, 15f, 15f, 15f, false, true, 0))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (!func_34())
				{
					if (iLocal_235 == 0)
					{
						...
						task_look_at_entity(iLocal_55, player_ped_id(), -1, 2052, 2);
						iLocal_235++;
						settimerb(0);
					}
...
void func_103()
{
	if (!is_ped_injured(iLocal_55))
	{
		if (!is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (is_ped_armed(player_ped_id(), 6) && can_ped_see_hated_ped(iLocal_55, player_ped_id()))
			{
				clear_ped_tasks(iLocal_55);
				open_sequence_task(&iLocal_61);
				task_look_at_entity(0, player_ped_id(), -1, 2052, 2);
...
void func_104()
{
	if (!func_133())
	{
		if (!is_entity_dead(iLocal_55, false))
		{
			if (is_entity_at_coord(player_ped_id(), Local_47, 65f, 60f, 60f, false, true, 0) || Global_113381)
			{
	...
	if (!iLocal_227)
	{
		if (!is_ped_injured(iLocal_55))
		{
			if (is_entity_at_entity(player_ped_id(), iLocal_55, 25f, 25f, 25f, false, true, 0) && func_133())
			{
				if (func_37(&uLocal_62, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					open_sequence_task(&iLocal_61);
					task_look_at_entity(0, player_ped_id(), -1, 2064, 2);
					task_play_anim(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 49, 0f, false, false, false);
	...
	if (!is_entity_dead(iLocal_55, false))
	{
		if (is_entity_at_entity(player_ped_id(), iLocal_55, 15f, 15f, 15f, false, true, 0) && is_ped_in_any_vehicle(player_ped_id(), false))
		{
			set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
		}
		if (is_entity_at_entity(player_ped_id(), iLocal_55, 8f, 8f, 8f, false, true, 0))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
				iLocal_228 = 1;
				...
				{
					settimerb(0);
					clear_ped_secondary_task(iLocal_55);
					open_sequence_task(&iLocal_61);
					task_look_at_entity(0, player_ped_id(), -1, 2064, 2);
					task_stand_still(0, 1000);
					task_follow_nav_mesh_to_coord(0, Local_51, 2f, -1, 0.25f, 512, 80.1325f);
					task_play_anim(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0f, false, false, false);
					close_sequence_task(iLocal_61);
					task_perform_sequence(iLocal_55, iLocal_61);
					clear_sequence_task(&iLocal_61);
			...
			else if (!iLocal_234)
			{
				...
				if (!func_34())
				{
					if (!is_ped_injured(iLocal_55))
					{
						...
						open_sequence_task(&iLocal_61);
						task_look_at_entity(0, player_ped_id(), -1, 3076, 2);
						task_turn_ped_to_face_entity(0, player_ped_id(), -1);
						close_sequence_task(iLocal_61);
						task_perform_sequence(iLocal_55, iLocal_61);
						clear_sequence_task(&iLocal_61);
...
int func_111()
{
	switch (func_112(&Global_32019, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return 1;
			break;
...
void func_117()
{
	...
	add_scenario_blocking_area(Local_47 - Vector(10f, 30f, 30f), Local_47 + Vector(10f, 30f, 30f), false, true, true, true);
	add_relationship_group("mugger", &iLocal_54);
	iLocal_55 = create_ped(19, joaat("a_f_m_skidrow_01"), Local_50, 79.765f, true, true);
	set_blocking_of_non_temporary_events(iLocal_55, true);
	set_ped_config_flag(iLocal_55, 185, true);
	set_ped_flee_attributes(iLocal_55, 128, true);
	stop_ped_speaking(iLocal_55, true);
	set_ped_relationship_group_hash(iLocal_55, iLocal_54);
	set_relationship_between_groups(5, iLocal_54, joaat("player"));
	open_sequence_task(&iLocal_61);
	task_look_at_entity(0, player_ped_id(), -1, 3076, 2);
	task_play_anim(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, -1, 1, 0f, false, false, false);
	task_turn_ped_to_face_entity(0, player_ped_id(), -1);
	close_sequence_task(iLocal_61);
	task_perform_sequence(iLocal_55, iLocal_61);
	clear_sequence_task(&iLocal_61);
	iLocal_56 = create_ped(7, joaat("a_m_m_tramp_01"), Local_48, fLocal_53, true, true);
	set_ambient_voice_name(iLocal_56, "A_M_M_TRAMP_01_BLACK_MINI_01");
	set_blocking_of_non_temporary_events(iLocal_56, true);
	set_ped_flee_attributes(iLocal_56, 128, true);
	set_entity_is_target_priority(iLocal_56, true, 0f);
	stop_ped_speaking(iLocal_56, true);
	set_ped_relationship_group_hash(iLocal_56, iLocal_54);
	task_look_at_entity(iLocal_56, player_ped_id(), -1, 2052, 2);
	func_118(&uLocal_62, 0, player_ped_id(), "FRANKLIN", 0, 1);
...
int func_120()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_131())
		{
			return 0;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_151(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_154()
{
	...
	func_160(&uVar0, get_clock_seconds());
	func_159(&uVar0, get_clock_minutes());
	func_158(&uVar0, get_clock_hours());
	func_157(&uVar0, get_clock_day_of_month());
	func_156(&uVar0, get_clock_month());
	func_155(&uVar0, get_clock_year());
	return uVar0;
}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_171()) || Global_31962) || func_170()) || func_51(8, -1)) || func_167()) || func_169()) || func_168()) || func_166()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_171()) || Global_112433) || Global_31962) || func_170()) || func_51(8, -1)) || func_169()) || func_168()) || func_166()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_171() || get_player_wanted_level(player_id()) > 0) || func_51(8, -1)) || func_166()) || func_165()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_171()) || func_168()) || Global_112433) || Global_31962) || func_170()) || Global_44238) || func_51(8, -1)) || func_167()) || func_165()) || func_166()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
