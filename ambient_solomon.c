...
void __EntryFunction__()
{
	...
	if (func_75(player_ped_id()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((get_mission_flag() == 0 && func_70() == 0) && func_69(player_ped_id(), Local_64, fLocal_65, 1));
			func_67();
		}
	}
	func_66(65, 0);
	...
	while (true)
	{
		func_75(player_ped_id());
		Local_244 = { get_entity_forward_vector(player_ped_id()) };
		if (get_player_wanted_level(player_id()) == 0)
		{
			func_63(&uLocal_233);
			func_3(&uLocal_234);
			if (func_2(get_entity_coords(player_ped_id(), true), 7, 0, 0))
			{
				func_66(65, 1);
				func_1(30);
				func_77();
...
void func_3(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_57(player_ped_id(), -1210.236f, -579.875f, 26.33215f, -1204.725f, -586.3573f, 29.56773f, 6f))
			{
				fLocal_235 = 0.25f;
				*uParam0++;
				return;
			...
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				...
				fVar1 = acos(func_56(Local_244, 0.73f, 0.683f, -0.013f));
				if (absf(fVar1) < 25f)
				{
		...
		case 2:
			...
			{
				func_51(&uLocal_68, 0, player_ped_id(), "MICHAEL", 0, 1);
				if (func_50())
				{
...
{
	iParam0->f_1 = create_vehicle(joaat("akuma"), Param1, fParam2, true, true, false);
	if (func_75(iParam0->f_1))
	{
		freeze_entity_position(iParam0->f_1, true);
		set_entity_collision(iParam0->f_1, false, false);
		set_entity_visible(iParam0->f_1, false, false);
		set_vehicle_engine_on(iParam0->f_1, false, true, false);
		*iParam0 = create_ped_inside_vehicle(iParam0->f_1, 26, get_entity_model(player_ped_id()), -1, true, true);
		if (func_75(*iParam0))
		{
			set_blocking_of_non_temporary_events(*iParam0, true);
			set_entity_visible(*iParam0, false, false);
...
{
	func_66(65, 1);
	set_roads_back_to_original_in_angled_area(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 1);
	func_6(135, iParam0);
	func_6(136, iParam0);
	set_roads_back_to_original_in_angled_area(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 1);
	func_6(137, iParam0);
...
int func_14(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				iVar0 = get_entity_model(func_15(get_vehicle_ped_is_in(player_ped_id(), true)));
				switch (iVar0)
				{
...
void func_16(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && _get_number_of_references_of_script_with_name_hash(Global_91229[26 /*34*/].f_6) == 0)
			{
				Global_113386.f_7261[iParam0] = 1;
				door_system_set_door_state(uParam1->f_5, Global_113386.f_7261[iParam0], true, true);
			}
...
int func_52(struct<3> Param0)
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (is_ped_model(uVar2[iVar1], iLocal_245))
			{
...
int func_57(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	...
	if (is_entity_in_angled_area(iParam0, Param1, Param2, fParam3, false, true, 0))
	{
		return 1;
	}
	...
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, Var1.f_0, Var2.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, 0f, Var2.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, Var2.f_0, Var2.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, Var1.f_0, Var1.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, 0f, Var1.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
	Var0 = { get_offset_from_entity_in_world_coords(iParam0, Var2.f_0, Var1.f_1, 0f) };
	if (is_point_in_angled_area(Var0, Param1, Param2, fParam3, false, true))
	{
		return 1;
	}
...
void func_63(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_57(player_ped_id(), -1055.046f, -469.3347f, 35.43333f, -1057.44f, -474.9772f, 39.8187f, 12.5f))
			{
				fLocal_235 = 0.25f;
				*uParam0++;
				return;
			...
			{
				iVar2 = get_vehicle_ped_is_in(player_ped_id(), false);
				fVar1 = acos(func_56(Local_244, -0.37f, -0.927f, -0.053f));
				if (absf(fVar1) < 45f)
				{
		...
		case 7:
			if (!func_57(player_ped_id(), -1055.514f, -474.6371f, 35.6278f, -1051.23f, -464.4126f, 39.91479f, 9.5f))
			{
				func_59(&iLocal_237);
				*uParam0++;
			}
...
{
	func_66(65, 0);
	set_roads_in_angled_area(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, false, false, true);
	func_6(135, iParam0);
	func_6(136, iParam0);
	set_roads_in_angled_area(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, false, false, true);
	func_6(137, iParam0);
...
{
	func_75(player_ped_id());
	if (_get_number_of_references_of_script_with_name_hash(joaat("solomon1")) > 0)
	{
		func_1(30);
		func_66(65, 1);
		func_77();
	...
	if (!func_69(player_ped_id(), Local_64, (fLocal_65 + 30f), 1))
	{
		func_77();
	}
	wait(0);
...
bool func_69(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
