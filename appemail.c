...
void __EntryFunction__()
{
	...
	iLocal_51 = func_79();
	request_additional_text("email", 1);
...
void func_4()
{
	if (Global_53556 != -1)
	{
		set_streamed_texture_dict_as_no_longer_needed(func_16(Global_53556));
		Global_53556 = -1;
	}
	Global_44247 = 0;
...
void func_5()
{
	...
	switch (Global_20266.f_1)
	{
		case 6:
			...
			if (Global_8741 == 1)
			{
				func_64(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20270), -1082130432, -1082130432, -1082130432);
				Global_20246 = Global_20270;
			}
			else
			{
				func_64(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20271), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_10();
				func_64(Global_20247, "SET_THEME", to_float(Global_113386.f_14051[Global_20266 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_21618)
				{
				...
				{
					func_13(Global_20247, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_117[Global_7451 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_13(Global_20247, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_1998[Global_7451 /*29*/].f_3), &(Global_1998[Global_7451 /*29*/].f_7), "CELL_217", &(Global_1998[Global_7451 /*29*/].f_3), 0);
				}
				func_64(Global_20247, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_21605 == 4 || Global_21605 == 3)
			{
				...
				else
				{
					...
					if (func_8(Global_7451, Global_20266) == 0)
					{
						...
						func_13(Global_20247, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_7451 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_64(Global_20247, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_20247, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_1998[Global_7451 /*29*/].f_3), &(Global_1998[Global_7451 /*29*/].f_7), &cVar0, &(Global_1998[Global_7451 /*29*/].f_3), 0);
					}
				}
				func_64(Global_20247, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_13(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
void func_17()
{
	...
	if (!iLocal_60)
	{
		...
		{
			iLocal_60 = 1;
			begin_scaleform_movie_method(Global_20247, "SET_INPUT_EVENT");
			scaleform_movie_method_add_param_int(1);
			end_scaleform_movie_method();
	...
	if (!iLocal_59)
	{
		if (is_control_pressed(2, 176) && timerb() > 100)
		{
			if (iLocal_56 == -1)
			{
				...
				iLocal_49 = end_scaleform_movie_method_return_value();
				while (!is_scaleform_movie_method_return_value_ready(iLocal_49))
				{
					wait(0);
				}
				iLocal_50 = get_scaleform_movie_method_return_value_int(iLocal_49);
				iLocal_56 = iLocal_50;
				if (func_39(iLocal_51) == 0)
				{
					iLocal_56 = -1;
...
void func_28(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_29(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_30(iParam1)), 0));
		}
		else
		{
			func_29(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_30(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
	...
	if (!bVar5)
	{
		...
		if (Global_47582[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				...
				begin_scaleform_movie_method(iParam0, "SET_DATA_SLOT");
				scaleform_movie_method_add_param_int(9);
				scaleform_movie_method_add_param_int(iVar11 + 1);
	...
	else
	{
		...
		else
		{
			...
			if (!bVar19)
			{
				...
				{
					begin_text_command_scaleform_string(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_53557[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						add_text_component_substring_text_label(&(Global_53557[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					end_text_command_scaleform_string();
				}
...
int func_57(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar5 < 16)
	{
		...
		if (bVar7)
		{
			...
			add_text_component_substring_text_label(sVar8);
			add_text_component_integer(Global_113386.f_24904[iVar6 /*4*/].f_3);
			end_text_command_scaleform_string();
			end_scaleform_movie_method();
			iVar2++;
			iVar0 = 1;
...
void func_61(int iParam0, int iParam1)
{
	...
	Global_53556 = iVar5;
	request_streamed_texture_dict(func_16(iVar5), false);
	while (!has_streamed_texture_dict_loaded(func_16(iVar5)))
	{
		wait(100);
	}
}
...
void func_63()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			thefeed_remove_item(Global_44252[iVar0]);
...
float func_69(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_71((to_float((get_game_timer() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
...
void func_75(bool bParam0)
{
	...
	if (bParam0)
	{
		begin_scaleform_movie_method(Global_20247, "SET_SOFT_KEYS");
		scaleform_movie_method_add_param_int(1);
		scaleform_movie_method_add_param_bool(true);
...
void func_80()
{
	...
	{
		if (func_83(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_82(player_ped_id());
