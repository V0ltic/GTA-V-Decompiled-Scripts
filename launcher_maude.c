...
void func_186(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_190(player_ped_id(), Param2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(player_ped_id(), Param2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
void func_196(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_198(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_197(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_197(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_204(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_207(int iParam0, float fParam1)
{
	...
	{
		if (func_218(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_209(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_210(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_215(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_215(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_222(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_215(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_234(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !has_anim_dict_loaded("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_235(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_236(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_240(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = add_scenario_blocking_area(Var0, Var1, false, true, true, true);
...
void func_269(var uParam0)
{
	if (is_synchronized_scene_running(uParam0->f_59))
	{
		...
		if (func_129(uParam0->f_41[0]))
		{
			stop_synchronized_entity_anim(uParam0->f_41[0], -1000f, true);
		}
	}
}
