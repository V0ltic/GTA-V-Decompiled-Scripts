...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("stock_controller")) > 1)
	{
		func_99();
	}
	Global_63138 = 1;
	...
	while (iVar0 < 204)
	{
		if (!Global_58896[iVar0 /*7*/])
		{
			if (Global_58896[iVar0 /*7*/].f_2)
			{
				...
				{
					stat_get_int(Global_58896[iVar0 /*7*/].f_3, &(Global_58896[iVar0 /*7*/].f_5), -1);
				}
				else
				{
					fVar1 = 0f;
					stat_get_float(Global_58896[iVar0 /*7*/].f_3, &fVar1, -1);
					Global_58896[iVar0 /*7*/].f_5 = floor(fVar1);
				}
			}
		}
		iVar0++;
	...
	while (true)
	{
		...
		func_80();
		if (!network_is_game_in_progress() && !func_79(14))
		{
			func_68();
			iVar3 = 16;
...
void func_4()
{
	...
	if (Global_60326)
	{
		if (!stat_community_synch_is_pending())
		{
			iVar0 = func_5();
			Global_60326 = 0;
			if (iVar0 < 5)
...
int func_5()
{
	...
	if (!network_is_signed_online() || !network_has_valid_ros_credentials())
	{
		return 1;
	}
	iVar0 = 0;
	...
	while (iVar0 < 80)
	{
		if (Global_55453[iVar0 /*36*/].f_8)
		{
			if (Global_55453[iVar0 /*36*/].f_35 > -1)
			{
				...
				stat_get_float(iVar2, &(Global_55453[iVar0 /*36*/].f_9), -1);
				if (Global_55453[iVar0 /*36*/].f_9 > 0f)
				{
					fVar3 = 0f;
					stat_community_get_history(iVar2, 0, &(Global_55453[iVar0 /*36*/].f_33));
					...
					{
						fVar5 = 0f;
						stat_community_get_history(iVar2, iVar4 + 1, &fVar5);
	...
	if (fVar0 > 1f)
	{
		...
		if (((iVar5 + iVar6) + iVar7) > 0)
		{
			...
			while (iVar2 < 10)
			{
				...
				{
					iVar8 = (iVar8 + floor(Global_113386.f_20564.f_11[iVar2]));
				}
				if (Global_113386.f_20564.f_55[iVar2] > 0)
				{
					iVar8 = (iVar8 + floor(Global_113386.f_20564.f_44[iVar2]));
				}
				if (Global_113386.f_20564.f_88[iVar2] > 0)
				{
					iVar8 = (iVar8 + floor(Global_113386.f_20564.f_77[iVar2]));
				}
				iVar2++;
			}
			iVar9 = 700000000;
...
void func_41()
{
	...
	while (iVar0 < 204)
	{
		if (!Global_58896[iVar0 /*7*/])
		{
			if (Global_58896[iVar0 /*7*/].f_2)
			{
				...
				if (!Global_58896[iVar0 /*7*/].f_4)
				{
					stat_get_int(Global_58896[iVar0 /*7*/].f_3, &iVar1, -1);
				}
				else
				{
					fVar2 = 0f;
					stat_get_float(Global_58896[iVar0 /*7*/].f_3, &fVar2, -1);
					iVar3 = floor(fVar2);
	...
	while (iVar0 < 80)
	{
		if (!Global_55453[iVar0 /*36*/].f_8)
		{
			...
			fVar5 = (fVar5 + ((get_random_float_in_range(-Global_58608[iVar4 /*7*/].f_6, Global_58608[iVar4 /*7*/].f_6) * 0.1f) * Global_55453[iVar0 /*36*/].f_9));
...
int func_61(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_77137.f_484[iVar0] == iParam0)
		{
			...
			{
				if (BitTest(Global_77137.f_555[0 /*21*/].f_9, 10) && Global_77137.f_555[0 /*21*/].f_4 == get_entity_model(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
			...
			case 142:
				...
				if (bVar4)
				{
					if (does_entity_exist(iVar1))
					{
						...
						{
							if (func_73(get_vehicle_index_from_entity_index(iVar1)))
							{
								func_2(3, 1);
							}
							func_72(get_entity_model(iVar1));
						}
				...
				if (bVar4)
				{
					if (does_entity_exist(iVar1))
					{
						if (is_entity_a_ped(iVar1))
						{
							...
							if (func_48() == 0 && iVar3 != player_ped_id())
							{
								if (is_entity_dead(iVar1, false) || IntToFloat(get_entity_health(iVar1)) < (0.5f * IntToFloat(get_ped_max_health(iVar3))))
								{
						...
						{
							func_69(get_entity_model(iVar1));
							func_2(111, 1);
						}
						else if (is_entity_an_object(iVar1))
						{
...
void func_74(int iParam0)
{
	...
	if (has_entity_been_damaged_by_any_vehicle(iParam0))
	{
		...
		if (is_entity_a_vehicle(iVar1))
		{
			...
			func_77(iVar2, get_ped_type(iVar0));
		}
		else
		{
			iVar3 = get_ped_cause_of_death(iVar0);
			iVar4 = get_entity_model(iParam0);
			func_76(iVar3, get_ped_type(iVar0), iVar4);
		}
	}
...
int func_75(int iParam0)
{
	...
	iVar0 = get_ped_source_of_death(get_ped_index_from_entity_index(iParam0));
...
void func_80()
{
	...
	{
		iVar0 = get_vehicle_ped_is_in(get_player_ped(get_player_index()), false);
		if (iLocal_29 != iVar0)
		{
			Local_27 = { Local_28 };
			iLocal_29 = iVar0;
		...
		Local_27 = { get_entity_coords(iVar0, true) };
		if (iLocal_29 == 0)
		{
			Local_28 = { Local_27 };
			iLocal_29 = iVar0;
		...
		if (func_81(iVar1, get_distance_between_coords(Local_27, Local_28, false)))
		{
			Local_28 = { Local_27 };
		}
	}
	...
	while (iVar0 < 80)
	{
		if (Global_55453[iVar0 /*36*/].f_8)
		{
			...
			if (iVar1 > -1)
			{
				...
				stat_set_int(Global_58334[iVar1 /*7*/].f_3[iParam0], iVar2, true);
			}
		}
		iVar0++;
	}
			...
			if ((Global_55453[iVar1 /*36*/].f_32 > 0f && Global_55453[iVar1 /*36*/].f_31 > 0f) && Global_55453[iVar1 /*36*/].f_9 > 0f)
			{
				...
				if (fVar16 != 1f)
				{
					...
					while (iVar3 <= 15)
					{
						...
						Global_55453[iVar1 /*36*/].f_14[iVar3] = (Global_55453[iVar1 /*36*/].f_14[iVar3] * (get_random_float_in_range(0.95f, 1.05f) + (fVar18 * fVar17)));
						if (iVar3 == 15)
						{
...
void func_94()
{
	...
	if (!Global_113386.f_20564.f_101)
	{
		...
		while (iVar0 < 80)
		{
			if (!Global_55453[iVar0 /*36*/].f_8)
			{
				Global_55453[iVar0 /*36*/].f_9 = get_random_float_in_range(15f, 290f);
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_55453[iVar0 /*36*/].f_9 = (Global_55453[iVar0 /*36*/].f_9 * get_random_float_in_range(fVar2, fVar3));
				Global_55453[iVar0 /*36*/].f_9 = func_93(func_92(absf(Global_55453[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
...
void func_95()
{
	...
	iVar2 = get_random_int_in_range(0, (Global_60615 - 1));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		iVar1 = 0;
