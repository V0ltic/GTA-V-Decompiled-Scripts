...
void func_24(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_76(player_ped_id(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_75(player_ped_id(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
...
int func_69(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((does_entity_exist(uVar0[iVar1]) && !is_ped_injured(uVar0[iVar1])) && is_entity_visible(uVar0[iVar1])) && func_76(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_70(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			{
				if (func_76(get_player_ped(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_71(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
void func_80(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		set_ped_capsule(player_ped_id(), func_81());
...
void func_82(var uParam0)
{
	...
	func_83(&(uParam0->f_7), 1, is_entity_dead(player_ped_id(), false));
	func_83(&(uParam0->f_7), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_83(&(uParam0->f_7), 0, func_50(0));
	func_83(&(uParam0->f_7), 2, is_ped_running(player_ped_id()));
}
...
int func_85()
{
	...
	if (func_94(player_id()) && is_screen_faded_out())
	{
		return 1;
	}
	if (func_86())
...
int func_86()
{
	...
	if (func_87() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_87()) == 0)
		{
			return 1;
		}
	}
...
int func_99()
{
	if (Global_2689235[player_id() /*453*/].f_318.f_9 != func_72())
	{
		if (network_is_script_active("auto_shop_seating", Global_2689235[player_id() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
