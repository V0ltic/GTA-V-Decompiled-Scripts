...
int func_2()
{
	...
	{
		fVar1 = get_synchronized_scene_phase(Global_97771);
		if (!is_string_null_or_empty(&Local_318))
		{
			if (!iLocal_322)
			{
				if (fVar1 < fLocal_321)
	...
	while (iVar0 < iLocal_233)
	{
		...
		{
			Var3 = { get_entity_coords(iLocal_233[iVar0], true) };
...
void func_26(int iParam0, int iParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		{
			case 0:
				if (is_entity_playing_anim(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (find_anim_event_phase(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						fVar2 = get_synchronized_scene_phase(Global_97771);
						if (fVar2 > fVar0)
						{
							clear_ped_tasks(iParam0);
							stop_synchronized_entity_anim(iParam0, -8f, true);
							...
							task_follow_nav_mesh_to_coord(iParam0, Local_243 + Local_246[iParam1 /*3*/], fVar3, -1, (fLocal_248[iParam1] * 0.1f), false, 40000f);
							force_ped_motion_state(iParam0, iVar4, false, 0, false);
				...
				{
					clear_ped_tasks(iParam0);
					if (is_string_null_or_empty(&(Local_308[iParam1 /*16*/])))
					{
						if (func_32(Local_246[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var5 = { get_entity_coords(iParam0, true) };
							Local_246[iParam1 /*3*/] = { Var5 - Local_243 * Vector(4f, 4f, 4f) };
						}
						if (!is_string_null_or_empty(&(Local_316[iParam1 /*16*/])))
						{
							set_ped_movement_clipset(iParam0, &(Local_316[iParam1 /*16*/]), 0.25f);
						}
						task_follow_nav_mesh_to_coord(iParam0, Local_243 + Local_246[iParam1 /*3*/], 1f, -1, 0.25f, false, 40000f);
						iLocal_234[iParam1] = 1;
					}
					else
					{
						if (!is_synchronized_scene_running(iLocal_317))
						{
							iLocal_317 = create_synchronized_scene(Local_243, 0f, 0f, fLocal_244, 2);
							set_synchronized_scene_looped(iLocal_317, true);
						}
						iVar6 = 5;
						iVar7 = 144;
						iVar8 = 0;
						if (iLocal_240[0] == joaat("p_trev_rope_01_s") || iLocal_240[1] == joaat("p_trev_rope_01_s"))
						{
							...
							set_ped_can_ragdoll_from_player_impact(iLocal_233[iParam1], false);
							set_entity_max_health(iLocal_233[iParam1], 1000);
							set_entity_health(iLocal_233[iParam1], get_entity_max_health(iLocal_233[iParam1]), 0);
							set_ped_suffers_critical_hits(iLocal_233[iParam1], false);
							...
							{
								set_entity_can_be_damaged(iLocal_239[iVar9], false);
								set_object_targettable(iLocal_239[iVar9], false);
								iVar9++;
							}
						}
						if (!func_31(iVar7, 16))
						...
						task_synchronized_scene(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
						iVar9 = 0;
						while (iVar9 < iLocal_239)
						{
							if (iLocal_240[iVar9] != 0)
							{
								if (!is_string_null_or_empty(&(Local_313[iVar9 /*16*/])))
								{
									play_synchronized_entity_anim(iLocal_239[iVar9], iLocal_317, &(Local_313[iVar9 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
								}
							}
							iVar9++;
						}
			...
			case 1:
				if (!is_ped_group_member(iLocal_233[iParam1], iLocal_238))
				{
					...
					if (iParam1 == 0)
					{
						set_ped_as_group_leader(iLocal_233[iParam1], iLocal_238);
					}
					else
					{
						set_ped_as_group_member(iLocal_233[iParam1], iLocal_238);
					}
				}
				if (get_script_task_status(iParam0, 713668775) != 1)
				{
					...
					task_wander_in_area(iParam0, Local_243 + Local_246[iParam1 /*3*/], fLocal_248[iParam1], 3f, 6f);
			...
			case 10:
				...
				set_ped_reset_flag(iLocal_233[iParam1], 249, true);
				set_ped_reset_flag(iLocal_233[iParam1], 335, true);
				if (is_entity_playing_anim(iLocal_233[iParam1], &Local_297, &(Local_308[iParam1 /*16*/]), 2))
				{
					if (iLocal_66 == 288)
					{
						if (iLocal_323 <= 0)
						{
							iLocal_323 = (get_game_timer() + get_random_int_in_range(10000, 15000));
						}
				...
				else
				{
					...
					task_synchronized_scene(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
					iVar14 = 0;
					while (iVar14 < iLocal_239)
					{
						if (iLocal_240[iVar14] != 0)
						{
							if (!is_string_null_or_empty(&(Local_313[iVar14 /*16*/])))
							{
								play_synchronized_entity_anim(iLocal_239[iVar14], iLocal_317, &(Local_313[iVar14 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar14++;
					}
				...
				switch (iLocal_236[iParam1])
				{
					...
					case 0:
						iVar15 = get_random_int_in_range(1500, 4000);
						task_look_at_entity(iLocal_233[iParam1], player_ped_id(), iVar15, 0, 2);
						iLocal_237[iParam1] = ((get_game_timer() + iVar15) + get_random_int_in_range(500, 2000));
						iLocal_236[iParam1] = 1;
						break;
					
					case 1:
						if (get_game_timer() > iLocal_237[iParam1])
						{
				...
				if (has_entity_been_damaged_by_entity(iLocal_233[iParam1], player_ped_id(), true))
				{
				}
				bVar16 = false;
				...
				if (bVar16)
				{
					set_synchronized_scene_phase(iLocal_317, 0f);
					set_synchronized_scene_hold_last_frame(iLocal_317, true);
					set_synchronized_scene_looped(iLocal_317, false);
					iVar17 = 4;
					iVar18 = 4276;
					iVar19 = 0;
					task_synchronized_scene(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_309[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
					set_entity_can_be_damaged(iLocal_233[iParam1], false);
					set_ragdoll_blocking_flags(iLocal_233[iParam1], iVar18);
					...
					while (iVar20 < iLocal_239)
					{
						...
						{
							if (!is_string_null_or_empty(&(Local_314[iVar20 /*16*/])))
							{
								play_synchronized_entity_anim(iLocal_239[iVar20], iLocal_317, &(Local_314[iVar20 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
								set_entity_can_be_damaged(iLocal_239[iVar20], false);
							}
						}
						iVar20++;
					}
			...
			case 11:
				...
				else if (get_synchronized_scene_phase(iLocal_317) >= 0.99f)
				{
					bVar21 = false;
				}
				if (!bVar21)
				{
					...
					set_synchronized_scene_hold_last_frame(iLocal_317, false);
					set_synchronized_scene_looped(iLocal_317, true);
					iVar22 = 0;
					iVar23 = 180;
					iVar24 = 0;
					task_synchronized_scene(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
					iVar25 = 0;
					while (iVar25 < iLocal_239)
					{
						if (iLocal_240[iVar25] != 0)
						{
							if (!is_string_null_or_empty(&(Local_315[iVar25 /*16*/])))
							{
								play_synchronized_entity_anim(iLocal_239[iVar25], iLocal_317, &(Local_315[iVar25 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar25++;
					}
			...
			case 12:
				...
				set_ped_reset_flag(iLocal_233[iParam1], 249, true);
				set_ped_reset_flag(iLocal_233[iParam1], 335, true);
				if (!is_entity_playing_anim(iLocal_233[iParam1], &Local_297, &(Local_310[iParam1 /*16*/]), 2))
				{
					if (!is_synchronized_scene_running(iLocal_317))
					{
						iLocal_317 = create_synchronized_scene(Local_243, 0f, 0f, fLocal_244, 2);
					}
					task_synchronized_scene(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1000f, 0);
					iVar26 = 0;
					while (iVar26 < iLocal_239)
					{
						if (iLocal_240[iVar26] != 0)
						{
							if (!is_string_null_or_empty(&(Local_315[iVar26 /*16*/])))
							{
								play_synchronized_entity_anim(iLocal_239[iVar26], iLocal_317, &(Local_315[iVar26 /*16*/]), &Local_297, 8f, 8f, 0, 1000f);
							}
						}
						iVar26++;
					}
	...
	else
	{
		...
		if (does_entity_exist(iParam0))
		{
			...
			{
				if (does_entity_exist(iLocal_239[iVar27]))
				{
					stop_synchronized_entity_anim(iLocal_239[iVar27], -8f, true);
					freeze_entity_position(iLocal_239[iVar27], false);
					set_entity_dynamic(iLocal_239[iVar27], true);
					set_object_as_no_longer_needed(&(iLocal_239[iVar27]));
				}
				iVar27++;
			}
		}
...
int func_28(int iParam0)
{
	...
	while (iVar0 < iLocal_233)
	{
		...
		{
			if (iLocal_234[iVar0] < 0 && does_entity_exist(iLocal_233[iVar0]))
			{
				return 1;
			}
		}
...
int func_29(int iParam0)
{
	...
	if (iLocal_66 == 237)
	{
		fVar1 = vdist2(get_entity_coords(iParam0, false), get_entity_coords(player_ped_id(), false));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_34(iParam3), false);
}
		...
		if (is_synchronized_scene_running(Global_97771))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!is_ped_injured(iLocal_233[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (find_anim_event_phase(&Local_297, &(Local_307[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&Local_297, &(Local_307[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					task_synchronized_scene(iLocal_233[iVar0], Global_97771, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			{
				if (does_entity_exist(iLocal_239[iVar0]))
				{
					if (!is_string_null_or_empty(&(Local_312[iVar0 /*16*/])))
					{
						play_synchronized_entity_anim(iLocal_239[iVar0], Global_97771, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1000f);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (is_synchronized_scene_running(Global_97770))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!is_ped_injured(iLocal_233[iVar0]))
			{
				task_synchronized_scene(iLocal_233[iVar0], Global_97770, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (does_entity_exist(iLocal_239[iVar0]))
			{
				if (!is_string_null_or_empty(&(Local_311[iVar0 /*16*/])))
				{
					play_synchronized_entity_anim(iLocal_239[iVar0], Global_97770, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1000f);
				}
			}
			iVar0++;
		}
		if (!is_string_null_or_empty(&Local_318))
		{
			func_27(&uLocal_67, 2, player_ped_id(), "TREVOR", 0, 1);
...
void func_47()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_235)
		{
			...
			{
				request_model(iLocal_235[iVar0]);
				if (!has_model_loaded(iLocal_235[iVar0]))
				{
					bVar2 = false;
					request_model(iLocal_235[iVar0]);
				}
			}
			if (!is_string_null_or_empty(&(Local_316[iVar0 /*16*/])))
			{
				request_clip_set(&(Local_316[iVar0 /*16*/]));
				if (!has_clip_set_loaded(&(Local_316[iVar0 /*16*/])))
				{
					bVar2 = false;
				}
			}
		...
		request_anim_dict(&Local_297);
		if (!has_anim_dict_loaded(&Local_297))
		{
			bVar2 = false;
			request_anim_dict(&Local_297);
		}
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			iLocal_233[iVar0] = create_ped(26, iLocal_235[iVar0], Local_243 + Local_245[iVar0 /*3*/], 0f, true, true);
			set_entity_heading(iLocal_233[iVar0], (fLocal_244 + fLocal_247[iVar0]));
			set_ped_random_component_variation(iLocal_233[iVar0], 0);
			if (iLocal_235[iVar0] == joaat("a_f_y_beach_01"))
			{
				if (iLocal_66 == 288)
				{
					set_ped_component_variation(iLocal_233[iVar0], 8, 1, 0, 0);
				}
			}
			set_ped_combat_attributes(iLocal_233[iVar0], 13, false);
			set_ped_combat_attributes(iLocal_233[iVar0], 17, true);
			task_play_anim(iLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, false, false, false);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_239)
	{
		if (iLocal_240[iVar0] != 0)
		{
			iLocal_239[iVar0] = create_object(iLocal_240[iVar0], Local_243 + Local_245[iVar0 /*3*/] + Local_241[iVar0 /*3*/], true, true, false);
			set_entity_rotation(iLocal_239[iVar0], Vector((fLocal_244 + fLocal_247[iVar0]), 0f, 0f) + Local_242[iVar0 /*3*/], 2, true);
			if (!is_string_null_or_empty(&(Local_311[iVar0 /*16*/])))
			{
				play_entity_anim(iLocal_239[iVar0], &(Local_311[iVar0 /*16*/]), &Local_297, 8f, true, false, false, 0f, 0);
			}
		}
		iVar0++;
	}
...
void func_48()
{
	...
	switch (iLocal_66)
	{
		case 237:
			...
			fLocal_321 = 0.15f;
			Local_245[0 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_245[1 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_246[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			Local_246[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			fLocal_247[0] = get_random_float_in_range(-180f, 180f);
			fLocal_247[1] = get_random_float_in_range(-180f, 180f);
			fLocal_248[0] = 50f;
			fLocal_248[1] = 50f;
		...
		case 244:
			...
			StringCopy(&(Local_308[0 /*16*/]), "", 64);
			Local_245[0 /*3*/] = { get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f };
...
void func_58()
{
	...
	while (iVar0 < iLocal_235)
	{
		if (iLocal_235[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_235[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_240)
	{
		if (iLocal_240[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_240[iVar0]);
		}
		iVar0++;
	}
	remove_anim_dict(&Local_297);
	if (does_group_exist(iLocal_238))
	{
