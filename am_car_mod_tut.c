	...
	while (true)
	{
		...
		switch (func_192(participant_id_to_int()))
		{
			case 0:
				if (func_191() == 2)
				{
					Local_138[participant_id_to_int() /*3*/] = 2;
				}
				else if (func_191() == 6)
				{
					Local_138[participant_id_to_int() /*3*/] = 5;
				}
				break;
			...
			case 2:
				if (func_191() == 2)
				{
					...
					else if (!BitTest(Local_138[participant_id_to_int() /*3*/].f_2, 1))
					{
						func_8();
					}
				}
			...
			case 5:
				...
				{
					Local_138[participant_id_to_int() /*3*/] = 6;
				}
				break;
...
void func_3()
{
	...
	if (network_is_host_of_this_script())
	{
		if (iLocal_137 == 0)
		{
			clear_bit(&uLocal_140, false);
			set_bit(&uLocal_140, true);
		}
		iVar0 = iLocal_137;
...
void func_8()
{
	...
	set_bit(&(Local_138[participant_id_to_int() /*3*/].f_2), false);
	set_bit(&(Local_138[participant_id_to_int() /*3*/].f_2), true);
	func_74(10, 0);
	func_73(0);
	func_30(1);
	func_23();
...
void func_30(bool bParam0)
{
	...
	iVar1 = func_69(player_id(), bParam0);
...
void func_73(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&(Global_1853348[player_id() /*834*/].f_143), 18);
	}
	else
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 18);
	}
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	if (does_blip_exist(Global_100493.f_255[iParam0]))
	{
	}
}
...
void func_78()
{
	...
	switch (Local_138[participant_id_to_int() /*3*/].f_1)
	{
		case 0:
			if (!BitTest(Local_138[participant_id_to_int() /*3*/].f_2, 0))
			{
				if (!is_ped_injured(player_ped_id()))
				{
					if (!BitTest(uLocal_140, 5))
					{
						if (get_player_wanted_level(player_id()) == 0)
						{
							...
							{
								clear_bit(&uLocal_140, 10);
							}
							if (!is_ped_sitting_in_any_vehicle(player_ped_id()))
							{
								if (BitTest(uLocal_140, 3))
								{
									clear_bit(&uLocal_140, 3);
								}
								if (BitTest(uLocal_140, 7))
								{
									clear_bit(&uLocal_140, 7);
								}
								if (BitTest(uLocal_140, 8))
								{
									clear_bit(&uLocal_140, 8);
								}
								if (BitTest(uLocal_140, 11))
								{
									clear_bit(&uLocal_140, 11);
								}
							...
							else
							{
								if (BitTest(uLocal_140, 2))
								{
									clear_bit(&uLocal_140, 2);
								}
								iVar0 = get_vehicle_ped_is_in(player_ped_id(), false);
								if ((!func_158(iVar0, 0, &uVar1) || !func_157(iVar0)) || func_156(get_entity_model(iVar0)))
								{
									if (func_155())
									{
										func_154(0);
									...
									if (!BitTest(uLocal_140, 8))
									{
										if (func_149())
										{
											if (is_vehicle_driveable(iVar0, false))
											{
												if (iLocal_148 > 0)
												{
													if (func_156(get_entity_model(iVar0)))
													{
														func_148("FM_CTUT_PRM", -1);
														set_bit(&uLocal_140, 8);
														set_bit(&uLocal_140, 11);
								...
								else
								{
									...
									if (!func_144() || (func_144() && is_player_control_on(player_id())))
									{
										if (!BitTest(uLocal_140, 3))
										{
											func_186("FM_CTUT_MOD", 0);
											set_bit(&uLocal_140, 3);
											func_146(&uLocal_141);
											...
											if (iLocal_139 == -1)
											{
												iLocal_139 = func_128(get_entity_coords(player_ped_id(), true), 4, -1);
												if (iLocal_139 != -1)
												{
									...
									else if (func_144() && !is_player_control_on(player_id()))
									{
										if (!BitTest(uLocal_140, 3))
										{
											set_bit(&uLocal_140, 3);
						...
						else
						{
							...
							if (func_155())
							{
								if (!is_ped_injured(player_ped_id()))
								{
									...
									{
										iVar0 = get_vehicle_ped_is_in(player_ped_id(), false);
										if ((!func_158(iVar0, 0, &uVar2) || !func_157(iVar0)) || func_156(get_entity_model(iVar0)))
										{
											func_154(0);
										}
									}
					...
					if (BitTest(uLocal_140, 3) || (func_144() && BitTest(uLocal_140, 10)))
					{
						if (func_144())
						{
							...
							if (!BitTest(uLocal_140, 9))
							{
								if (func_122())
								{
									set_bit(&uLocal_140, 9);
									set_bit(&(Global_2815059.f_1792), 25);
							...
							{
								if (func_117(player_id()) || (!func_115() && func_114()))
								{
									iVar3 = func_108(get_vehicle_ped_is_in(player_ped_id(), false), 0);
									if (iVar3 > 0)
									{
						...
						else if (BitTest(uLocal_140, 9))
						{
							if (!func_121())
							{
								...
								{
									clear_bit(&uLocal_140, 9);
									clear_bit(&uLocal_140, 3);
									clear_bit(&uLocal_140, 10);
									func_23();
									iLocal_139 = -1;
									func_89(player_id(), 1, 0, 0);
								}
							}
							else if (!BitTest(Local_138[participant_id_to_int() /*3*/].f_2, 0))
							{
								set_bit(&(Local_138[participant_id_to_int() /*3*/].f_2), false);
							}
						}
					...
					if (!BitTest(uLocal_140, 5))
					{
						if (((func_86(player_id(), 1, 0) || func_85()) || func_84() > 0) || (!func_82() && !func_144()))
						{
							set_bit(&uLocal_140, 5);
							func_23();
						}
					}
					else if (is_player_control_on(player_id()) || func_144())
					{
						if (is_screen_faded_in())
						{
							if ((((!func_86(player_id(), 1, 0) && !func_85()) && func_84() == 0) && func_82()) || func_144())
	...
	if (!BitTest(Local_138[participant_id_to_int() /*3*/].f_2, 1))
	{
		if (func_80())
		{
			func_8();
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_98(player_id(), 0) && !func_97()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_93(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
int func_108(int iParam0, bool bParam1)
{
	...
	if (func_110(get_entity_model(iParam0), 0))
	{
...
void func_118(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&(Global_1853348[player_id() /*834*/].f_143), 20);
	}
	else
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 20);
	}
}
...
int func_128(struct<3> Param0, int iParam1, int iParam2)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_21(iVar0))
		{
			...
			if (func_142(iVar4))
			{
				fVar1 = get_distance_between_coords(Param0, func_129(iVar0, 0), true);
...
int func_149()
{
	if (((((((((((((!func_4(player_id(), 1, 1) || is_ped_injured(player_ped_id())) || !is_player_control_on(player_id())) || func_153(8, -1)) || func_153(15, -1)) || func_152()) || func_153(3, -1)) || is_help_message_being_displayed()) || func_86(player_id(), 1, 0)) || func_85()) || func_114()) || func_151()) || func_150()) || is_pause_menu_active())
	{
		return 0;
	}
	return 1;
...
void func_154(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&(Global_2815059.f_1795), 4);
	}
	else
	{
		clear_bit(&(Global_2815059.f_1795), 4);
	}
}
...
int func_158(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_184(iVar0, bParam1, uParam2) && !func_183(player_id())) && !func_166(iParam0))
	{
		return 0;
	}
	if (func_183(player_id()))
	{
		if (func_165(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_164(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_162(iParam0)) && !bVar1) && !(func_161(get_entity_model(iParam0)) && func_160(player_id())))
	{
		switch (get_entity_model(iParam0))
		{
			case joaat("cerberus"):
	...
	if (!network_is_game_in_progress())
	{
		if ((func_159(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_182(player_id()) || func_181(player_id()))
	{
		if (func_167(iParam0))
		{
			return 1;
...
int func_168(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_162(iParam0)) || func_169(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_170(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_172(get_entity_model(iParam0), 0))
			{
...
int func_184(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_164(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
...
void func_193()
{
	...
	if (!func_190(0))
	{
		if (func_119(player_id()) || iLocal_147)
		{
			func_31(122, 1, -1, 1);
		}
	}
...
void func_195()
{
	...
	{
		network_set_presence_session_invites_blocked(false);
	}
...
int func_203()
{
	...
	if (func_204() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_204()) == 0)
		{
			return 1;
		}
	}
...
void func_211(struct<21> Param0)
{
	...
	func_215(0, -1, 0);
	network_register_host_broadcast_variables(&Local_61, 78, 0);
