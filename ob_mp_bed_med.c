...
void __EntryFunction__()
{
	...
	if ((has_force_cleanup_occurred(18) || func_84()) || Global_2815059.f_1917)
	{
		func_83();
	}
	...
	{
		wait(0);
		if ((!is_ped_injured(player_ped_id()) && (!is_player_switch_in_progress() || func_74() == 5)) && !func_66())
		{
			if (get_distance_between_coords(Local_334, get_entity_coords(player_ped_id(), false), true) < 3f)
			{
				switch (iLocal_322)
				{
					case 0:
			...
			else if (get_distance_between_coords(Local_334, get_entity_coords(player_ped_id(), false), true) > 6f)
			{
				func_83();
			}
		}
...
void func_1()
{
	iLocal_328 = network_get_local_scene_from_network_id(iLocal_327);
	switch (iLocal_323)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_323)
	{
		case 0:
			...
			if (func_74() == 5)
			{
				clear_bit(&uLocal_321, 0);
				if (get_follow_ped_cam_view_mode() == 4)
				{
					iLocal_326 = 1;
				}
				iLocal_327 = network_create_synchronised_scene(Local_338, Local_339, 2, false, true, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_327, sLocal_330, sLocal_332, 8f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_327);
				iLocal_323 = 7;
			}
			else if (func_54(9))
			{
				if ((((func_50(Local_334, Var0) && get_interior_from_entity(player_ped_id()) == get_interior_at_coords(Local_334)) && is_entity_in_angled_area(player_ped_id(), Local_336, Local_337, 2f, false, true, 0)) && func_49()) && !func_46(player_id()))
				{
					if (iLocal_329 == -1)
					{
		...
		case 1:
			Local_340 = { get_entity_coords(player_ped_id(), false) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(Local_334, Var0) && Local_340.f_2 < (Local_334.f_2 + 1f)) && func_54(9)) && get_interior_from_entity(player_ped_id()) == get_interior_at_coords(Local_334)) && is_entity_in_angled_area(player_ped_id(), Local_336, Local_337, 2f, false, true, 0)) && func_49()) && !func_46(player_id()))
				{
					if (func_42(iLocal_329, 1))
					{
						...
						func_37();
						clear_area_of_projectiles(Local_334, 3f, 0);
						Global_1835486 = 9;
						func_27(player_id(), 0, 256, 0);
						iLocal_36 = 1;
						set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
						func_17(1, 1, 1, 0, 0, 0, 0);
						Local_334 = { get_anim_initial_offset_position(sLocal_330, sLocal_331, Local_338, Local_339, 0f, 2) };
						Var1 = { get_anim_initial_offset_rotation(sLocal_330, sLocal_331, Local_338, Local_339, 0f, 2) };
						fLocal_335 = Var1.f_2;
						task_go_straight_to_coord(player_ped_id(), Local_334, 1f, 5000, fLocal_335, 0.05f);
						if (get_follow_ped_cam_view_mode() == 4 && does_entity_exist(iLocal_41))
						{
							set_ped_desired_heading(player_ped_id(), func_16(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_41, true)));
							force_ped_motion_state(player_ped_id(), joaat("MotionState_Aiming"), false, 0, false);
		...
		case 2:
			...
			{
				clear_bit(&uLocal_321, 0);
				iLocal_327 = network_create_synchronised_scene(Local_338, Local_339, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_327, sLocal_330, sLocal_331, 4f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_327);
				if (get_follow_ped_cam_view_mode() == 4)
				{
					iLocal_326 = 1;
		...
		case 4:
			...
			if (get_synchronized_scene_phase(iLocal_328) > 0.9f)
			{
				clear_bit(&uLocal_321, 0);
				iLocal_327 = network_create_synchronised_scene(Local_338, Local_339, 2, false, true, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_327, sLocal_330, sLocal_332, 8f, -2f, 261, 0, 1000f, 0);
		...
		case 6:
			...
			if (!func_46(player_id()) && is_control_just_pressed(2, 222))
			{
				if (func_38("SA_BED_OUT"))
				{
					clear_help(true);
				...
				clear_bit(&uLocal_321, 0);
				iLocal_327 = network_create_synchronised_scene(Local_338, Local_339, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_327, sLocal_330, sLocal_333, 2f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_327);
				iLocal_323 = 8;
			}
			break;
		...
		case 7:
			if ((!func_8() && is_interior_ready(get_interior_at_coords(Local_334))) && iLocal_326 == 1)
			{
				_disable_first_person_cam_this_frame();
			}
			if (((is_interior_ready(get_interior_at_coords(Local_334)) && !func_8()) && !func_6()) && Global_1574632.f_8 == 0)
			{
				bLocal_325 = true;
				clear_bit(&uLocal_321, 0);
				iLocal_327 = network_create_synchronised_scene(Local_338, Local_339, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_327, sLocal_330, sLocal_333, 1000f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_327);
				iLocal_323 = 8;
			}
			break;
...
void func_3(int iParam0)
{
	...
	if (network_is_game_in_progress())
	{
		Global_2671449.f_3 = get_network_time();
	}
}
...
void func_17(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_22(player_id())) && !func_19(player_id(), 0)) && !func_18()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_22(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_19(player_id(), 0) && !func_23()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_31(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
int func_49()
{
	...
	if (iVar1 > 0)
	{
		...
		while (iVar2 <= 7)
		{
			...
			{
				if (is_entity_in_angled_area(uVar0[iVar2], Local_336, Local_337, 2f, false, true, 0))
				{
					return 0;
				}
			}
...
int func_50(struct<3> Param0, float fParam1, var uParam2, var uParam3)
{
	if (is_player_playing(player_id()))
	{
		if ((!is_ped_in_any_vehicle(player_ped_id(), false) && !is_entity_on_fire(player_ped_id())) && is_player_control_on(player_id()))
		{
			...
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_43(0)) && !func_53())
				{
					if ((Global_97369 && Global_97370) || func_52())
					{
						return 0;
					}
					if (func_51(get_entity_coords(player_ped_id(), true), Param0, fParam1, 0))
					{
						return 1;
					}
				}
...
{
	if ((((((BitTest(Global_1835485, iParam0) || Global_1835486 != -1) || func_64()) || is_player_free_aiming(player_id())) || is_player_targetting_anything(player_id())) || func_63()) || func_60(iParam0))
	{
		return 0;
	}
	if (func_59(player_id()) == 4)
	{
		return 0;
	}
	if (func_55(player_id()) == 1)
	{
		return 0;
	}
	return 1;
...
int func_65()
{
	request_anim_dict(sLocal_330);
	if (!has_anim_dict_loaded(sLocal_330))
	{
		return 0;
	}
	iLocal_324 = 1;
...
void func_83()
{
	...
	if (iLocal_324)
	{
		remove_anim_dict(sLocal_330);
	}
	func_4();
	if ((!func_22(player_id()) && !is_new_load_scene_active()) && func_35())
	{
		func_27(player_id(), 1, 0, 0);
	}
	func_77();
