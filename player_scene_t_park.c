...
int func_2()
{
	...
	if (!is_string_null_or_empty(&cLocal_80))
	{
		if (!does_particle_fx_looped_exist(iLocal_77))
		{
			Var0 = { Vector(32.856f, 3819.65f, 1971.62f) - Local_75 };
			iLocal_77 = start_particle_fx_looped_at_coord(&cLocal_80, Local_75 + Var0, 0f, 0f, 0f, 1f, false, false, false, false);
		}
	}
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_entity_playing_anim(player_ped_id(), &sLocal_110, &cLocal_126, 2))
		{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						if (!does_entity_exist(iLocal_68) || iLocal_79 != -1)
						{
							if (start_particle_fx_non_looped_on_ped_bone(&cLocal_89, player_ped_id(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, false, false, false))
							{
								if (are_strings_equal(&cLocal_89, "scr_meth_pipe_smoke"))
								{
									func_17(player_ped_id(), 0, 1, 0, -1);
								}
								iLocal_169 = get_sound_id();
								play_sound_from_entity(iLocal_169, &cLocal_160, player_ped_id(), &cLocal_151, false, 0);
								iLocal_170++;
							}
						}
						else if (start_particle_fx_non_looped_on_entity(&cLocal_89, iLocal_68, 0f, 0f, -1f, 0f, 0f, 0f, 1f, false, false, false))
						{
							if (are_strings_equal(&cLocal_89, "scr_meth_pipe_smoke"))
							{
								func_17(player_ped_id(), 0, 1, 0, -1);
				...
				case 2:
					...
					{
						if (start_particle_fx_non_looped_at_coord(&cLocal_98, Local_75 + Local_107, 0f, 0f, 0f, 1f, false, false, false))
						{
							iLocal_170++;
						}
					}
			...
			{
				if (is_entity_attached(iLocal_68))
				{
					if (iLocal_74 != -1)
					{
						if (fVar1 > fLocal_73)
		...
		else
		{
			if (iLocal_78 != 0)
			{
				stop_particle_fx_looped(iLocal_78, false);
				iLocal_78 = 0;
				stop_sound(iLocal_169);
				release_sound_id(iLocal_169);
			}
			if (does_entity_exist(iLocal_68))
			{
				if (is_entity_attached(iLocal_68))
...
int func_3(int* iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			if (get_entity_model(*iParam0) != joaat("prop_cs_ironing_board") && get_entity_model(*iParam0) != joaat("prop_iron_01"))
			{
				freeze_entity_position(*iParam0, false);
				set_entity_dynamic(*iParam0, true);
			}
			if (get_entity_model(*iParam0) == joaat("prop_iron_01"))
			{
				Var1 = { get_entity_coords(*iParam0, true) };
				Var2 = { get_entity_rotation(*iParam0, 2) };
				set_entity_coords(*iParam0, Var1 + Vector(0.1f, 0f, 0f), true, false, false, true);
				set_entity_rotation(*iParam0, Var2.f_0, Var2.f_1, Var2.f_2, 2, true);
			}
			if (get_entity_model(*iParam0) != joaat("p_defilied_ragdoll_01_s"))
			{
		...
		case 3:
			...
			if (((get_entity_model(*iParam0) != joaat("prop_chateau_table_01") && get_entity_model(*iParam0) != joaat("v_res_tt_flusher")) && get_entity_model(*iParam0) != joaat("v_ilev_fh_lampa_on")) && get_entity_model(*iParam0) != joaat("prop_cs_remote_01"))
			{
				stop_synchronized_entity_anim(*iParam0, -8f, true);
			}
			if ((get_entity_model(*iParam0) != joaat("v_ilev_fh_dineeamesa") && get_entity_model(*iParam0) != joaat("v_res_tt_flusher")) && get_entity_model(*iParam0) != joaat("v_ilev_fh_lampa_on"))
			{
				freeze_entity_position(*iParam0, false);
			}
			set_entity_dynamic(*iParam0, true);
		...
		case 4:
			...
			Var4 = { get_entity_rotation(*iParam0, 2) };
			iVar5 = 0;
			switch (get_entity_model(*iParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					Var7 = { 0f, 0f, 53.6f };
					set_entity_coords(*iParam0, Var6, true, false, false, true);
					set_entity_rotation(*iParam0, Var7, 2, true);
			...
			delete_object(iParam0);
			*iParam0 = create_object(iVar5, Var3, true, true, false);
			set_entity_rotation(*iParam0, Var4, 2, true);
			set_model_as_no_longer_needed(iVar5);
			return 1;
			break;
		
		case 5:
			add_explosion(get_entity_coords(*iParam0, true), 0, 0.5f, true, false, 1f, false);
			delete_object(iParam0);
			return 1;
			break;
		...
		case 7:
			if (get_entity_model(*iParam0) == get_weapontype_model(joaat("weapon_pistol")))
			{
		...
		case 8:
			Var8 = { get_entity_coords(*iParam0, true) };
			Var9 = { get_entity_rotation(*iParam0, 2) };
			sVar10 = "";
			switch (get_entity_model(*iParam0))
			{
			...
			start_particle_fx_non_looped_at_coord(sVar10, Var8, Var9, 1f, false, false, false);
			delete_object(iParam0);
			return 1;
			break;
		
		case 9:
			Var11 = { get_entity_coords(*iParam0, true) };
			Var12 = { get_entity_rotation(*iParam0, 2) };
			sVar13 = "";
			switch (get_entity_model(*iParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			start_particle_fx_non_looped_at_coord(sVar13, Var11, Var12, 1f, false, false, false);
			delete_object(iParam0);
			*iParam0 = create_object(iVar14, Var11, true, true, false);
			set_entity_rotation(*iParam0, Var12, 2, true);
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					if (!is_entity_playing_anim(*iParam0, &sVar18, &sVar15, 2))
					{
						play_synchronized_entity_anim(*iParam0, Global_97771, &sVar15, &sVar18, 1000f, -8f, iVar17, 1000f);
					}
				}
			}
			set_model_as_no_longer_needed(iVar14);
			return 1;
			break;
	}
	return 0;
...
float func_30()
{
	...
	fVar0 = 0.1f;
	iVar1 = func_31(player_ped_id());
	iVar2 = func_36(player_ped_id());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
...
int func_37()
{
	if (!iLocal_69 == 0)
	{
		if (!does_entity_exist(iLocal_68))
		{
			...
			{
				iLocal_68 = create_object(iLocal_69, Local_75, true, true, false);
				attach_entity_to_entity(iLocal_68, player_ped_id(), get_ped_bone_index(player_ped_id(), iLocal_72), Local_70, Local_71, false, false, false, false, 2, true, 0);
			}
			else
			{
				iLocal_68 = create_object(iLocal_69, Local_75 + Local_70, true, true, false);
				set_entity_coords(iLocal_68, Local_75 + Local_70, true, false, false, true);
				set_entity_rotation(iLocal_68, Vector(uLocal_76, 0f, 0f) + Local_71, 2, true);
	...
	if (!func_38())
	{
		if (does_entity_exist(iLocal_68))
		{
			if (iLocal_72 != -1)
			{
				if (!is_entity_attached_to_entity(iLocal_68, player_ped_id()))
				{
					attach_entity_to_entity(iLocal_68, player_ped_id(), get_ped_bone_index(player_ped_id(), iLocal_72), Local_70, Local_71, false, false, false, false, 2, true, 0);
				}
			}
...
void func_53()
{
	...
	{
		bVar1 = true;
		if (is_player_switch_in_progress() && (get_player_switch_state() != 8 || get_player_switch_state() == 1))
		{
			bVar1 = false;
		}
		request_ptfx_asset();
		...
		if (!is_string_null_or_empty(&cLocal_142))
		{
			if (!request_ambient_audio_bank(&cLocal_142, false, -1))
			{
				bVar1 = false;
			}
		}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 17, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 144, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_56(uParam1, 43, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
