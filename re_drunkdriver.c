...
void __EntryFunction__()
{
	...
	{
		wait(0);
		if (is_world_point_within_brain_activation_range() || iLocal_58)
		{
			if (!func_194())
			{
				if (func_193())
			...
			switch (iLocal_51)
			{
				...
				case 1:
					...
					if (is_player_playing(player_id()))
					{
						func_171();
						func_168();
						if (iLocal_52 == 1 && !does_entity_exist(iLocal_73[1]))
						{
							func_76();
							if (func_74() || is_entity_dead(iLocal_74, false))
							{
								if (does_entity_exist(iLocal_73[0]))
								{
									if (!is_entity_dead(iLocal_73[0], false))
									{
										if (is_ped_in_group(iLocal_73[0]))
										{
											remove_ped_from_group(iLocal_73[0]);
										}
										clear_ped_tasks(iLocal_73[0]);
										task_smart_flee_ped(iLocal_73[0], player_ped_id(), 250f, -1, false, false);
										func_70(iLocal_73[0], 120000, 0);
										set_ped_keep_task(iLocal_73[0], true);
										func_68();
										wait(0);
						...
						if (iLocal_52 == 2 || (iLocal_52 == 1 && does_entity_exist(iLocal_73[1])))
						{
							func_76();
							if (iLocal_53 != 9)
							{
								if (func_74() || is_entity_dead(iLocal_74, false))
								{
									...
									if (does_entity_exist(iLocal_73[1]))
									{
										if (!is_ped_injured(iLocal_73[1]))
										{
											if (is_ped_in_group(iLocal_73[1]))
											{
												remove_ped_from_group(iLocal_73[1]);
											}
											clear_ped_tasks(iLocal_73[1]);
											task_smart_flee_ped(iLocal_73[1], player_ped_id(), 250f, -1, false, false);
											func_70(iLocal_73[1], 120000, 0);
											set_ped_keep_task(iLocal_73[1], true);
										}
									}
									if (iLocal_52 == 1)
									{
						...
						if (does_entity_exist(iLocal_73[0]))
						{
							if (!is_ped_injured(iLocal_73[0]))
							{
								set_ped_max_move_blend_ratio(iLocal_73[0], 1f);
							}
						}
						if (does_entity_exist(iLocal_73[1]))
						{
							if (!is_ped_injured(iLocal_73[1]))
							{
								set_ped_max_move_blend_ratio(iLocal_73[1], 1f);
							}
						}
					}
					if ((func_65() && !func_64()) && iLocal_53 != 9)
					{
						if (!is_ped_injured(iLocal_73[0]))
						{
							if (is_entity_at_coord(iLocal_73[0], Local_71, 5f, 5f, 5f, false, true, 0))
							{
								if (iLocal_52 == 2)
								{
									if (!is_ped_injured(iLocal_73[1]))
									{
										if (!is_ped_in_group(iLocal_73[0]) && !is_ped_in_group(iLocal_73[1]))
										{
											set_ped_as_group_member(iLocal_73[0], func_63());
											set_ped_as_group_member(iLocal_73[1], func_63());
										}
									}
								}
								func_62(0);
					...
					if (func_61())
					{
						if (does_entity_exist(iLocal_73[0]))
						{
							delete_ped(&(iLocal_73[0]));
						}
						if (does_entity_exist(iLocal_73[1]))
						{
							delete_ped(&(iLocal_73[1]));
						}
						func_36();
					}
...
void func_1()
{
	if (((iLocal_52 == 1 && iLocal_53 == 7) && iLocal_60 == 5) && iLocal_90)
	{
		...
		if (func_2())
		{
			...
			{
				Local_129 = { get_entity_speed_vector(get_vehicle_ped_is_in(player_ped_id(), false), false) };
			}
		}
	}
}
		...
		if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false))
		{
			if (iLocal_52 == 1)
			{
				if (does_entity_exist(iLocal_73[0]))
				{
					if (!is_ped_injured(iLocal_73[0]))
					{
						if (is_ped_in_vehicle(iLocal_73[0], get_vehicle_ped_is_in(player_ped_id(), false), false))
						{
							return 1;
						}
					}
			...
			if (iLocal_52 == 2)
			{
				if (does_entity_exist(iLocal_73[0]) && does_entity_exist(iLocal_73[1]))
				{
					if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
					{
						if (is_ped_in_vehicle(iLocal_73[0], get_vehicle_ped_is_in(player_ped_id(), false), false) && is_ped_in_vehicle(iLocal_73[1], get_vehicle_ped_is_in(player_ped_id(), false), false))
						{
							return 1;
						}
					}
...
int func_3()
{
	if (iLocal_52 == 2)
	{
		if (!is_entity_dead(iLocal_74, false))
		{
			if (!is_entity_at_entity(player_ped_id(), iLocal_74, 200f, 200f, 200f, false, true, 0))
			{
				return 1;
			}
			...
			{
				if (has_entity_collided_with_anything(iLocal_74) && get_entity_health(iLocal_74) < iLocal_68)
				{
					iLocal_68 = get_entity_health(iLocal_74);
					func_5(0);
					func_68();
					wait(0);
			...
			if (!is_vehicle_driveable(iLocal_74, false) || is_vehicle_stuck_on_roof(iLocal_74))
			{
				func_68();
				wait(0);
				if (!func_4())
				{
					if (func_67(&uLocal_140, "REDR2AU", "REDR2_LC", 4, 0, 0, 0))
					{
						if (!is_ped_injured(iLocal_73[0]))
						{
							task_wander_standard(iLocal_73[0], 40000f, 0);
							set_ped_keep_task(iLocal_73[0], true);
						}
						if (!is_ped_injured(iLocal_73[1]))
						{
							task_go_to_entity(iLocal_73[1], iLocal_73[0], -1, 0f, 1f, 2f, 0);
							set_ped_keep_task(iLocal_73[1], true);
						}
						return 1;
					}
			...
			if (has_entity_been_damaged_by_weapon(iLocal_74, 0, 2) && has_entity_been_damaged_by_entity(iLocal_74, player_ped_id(), false))
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					clear_ped_tasks(iLocal_73[0]);
...
void func_5(bool bParam0)
{
	...
	else if ((!iLocal_116 && is_scripted_conversation_ongoing()) && !func_33("REDR1_SWV"))
	{
		cLocal_118 = { func_9() };
		Local_117 = { func_8() };
		func_6();
...
int func_74()
{
	...
	if ((is_bullet_in_area(Local_125, 40f, true) || is_bullet_in_area(func_75(player_id()), 10f, false)) || is_projectile_in_area(Local_125 - Vector(40f, 40f, 40f), Local_125 + Vector(40f, 40f, 40f), false))
	{
		return 1;
	}
	if (!is_ped_injured(iLocal_73[0]))
	{
		if (has_entity_been_damaged_by_entity(iLocal_73[0], player_ped_id(), true) || is_entity_in_water(iLocal_73[0]))
		{
			return 1;
		}
		if (!is_entity_dead(get_players_last_vehicle(), false))
		{
			if (has_entity_been_damaged_by_entity(iLocal_73[0], get_players_last_vehicle(), true))
			{
				return 1;
			}
		}
		...
		{
			if (is_player_targetting_entity(player_id(), iLocal_73[0]) || is_player_free_aiming_at_entity(player_id(), iLocal_73[0]))
			{
				if (can_ped_see_hated_ped(iLocal_73[0], player_ped_id()))
				{
					return 1;
				}
			}
	...
	if (does_entity_exist(iLocal_73[1]))
	{
		if (!is_ped_injured(iLocal_73[1]))
		{
			if (has_entity_been_damaged_by_entity(iLocal_73[1], player_ped_id(), true))
			{
				return 1;
			}
			if (!is_entity_dead(get_players_last_vehicle(), false))
			{
				if (has_entity_been_damaged_by_entity(iLocal_73[1], get_players_last_vehicle(), true))
				{
					return 1;
				}
			}
			if (is_ped_armed(player_ped_id(), 6))
			{
				if (is_player_targetting_entity(player_id(), iLocal_73[1]) || is_player_free_aiming_at_entity(player_id(), iLocal_73[1]))
				{
					if (can_ped_see_hated_ped(iLocal_73[1], player_ped_id()))
					{
						return 1;
					}
				}
...
void func_76()
{
	...
	switch (iLocal_53)
	{
		case 0:
			if (iLocal_52 == 1)
			{
				if ((is_entity_in_angled_area(player_ped_id(), -1017.461f, -1259.868f, 3.9183f, -1061.891f, -1424.029f, 24.4253f, 171.75f, false, true, 0) && is_sphere_visible(Local_125, 1f)) || is_entity_at_coord(player_ped_id(), Local_125, 15f, 15f, 15f, false, true, 0))
				{
					...
					if (!is_ped_injured(iLocal_73[0]))
					{
						if (!does_blip_exist(uLocal_126[0]))
						{
							uLocal_126[0] = func_167(iLocal_73[0], 0, 145);
							show_height_on_blip(uLocal_126[0], false);
						}
					}
					if (!func_194())
					{
						if (!is_entity_dead(get_players_last_vehicle(), false))
						{
							iLocal_75 = get_players_last_vehicle();
						}
						func_166(&uLocal_140, "REDR1AU", "REDR1_DCO", 4, 0, 0, 0, 0);
						func_157(1);
						func_156(1);
					}
					if (is_entity_in_angled_area(player_ped_id(), -1011.144f, -1378.79f, 4.1997f, -1039.685f, -1337.61f, 9.7035f, 37.875f, false, true, 0))
					{
						if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
						{
							func_155();
							task_play_anim(iLocal_73[0], "random@drunk_driver_1", "drunk_argument_dd1", 2f, -2f, -1, 0, 0f, false, false, false);
							task_play_anim(iLocal_73[1], "random@drunk_driver_1", "drunk_argument_dd2", 2f, -2f, -1, 0, 0f, false, false, false);
							iLocal_103 = (get_game_timer() + 60000);
							if (does_blip_exist(uLocal_126[0]))
							{
								show_height_on_blip(uLocal_126[0], true);
							}
							iLocal_53 = 1;
						}
					}
			...
			if (iLocal_52 == 2)
			{
				if ((is_entity_in_angled_area(player_ped_id(), 1820.238f, 3671.948f, 30.8437f, 1957.818f, 3751.887f, 55.4436f, 159.9375f, false, true, 0) && is_sphere_visible(Local_125, 1f)) || is_entity_at_coord(player_ped_id(), Local_125, 15f, 15f, 15f, false, true, 0))
				{
					func_154();
					if (!func_194())
					{
					...
					if (is_entity_in_angled_area(player_ped_id(), 1877.761f, 3727.7f, 31.882f, 1896.962f, 3693.83f, 34.9925f, 19.1875f, false, true, 0))
					{
						...
						if (does_blip_exist(uLocal_126[1]))
						{
							show_height_on_blip(uLocal_126[1], true);
						}
						iLocal_103 = (get_game_timer() + 120000);
						iLocal_53 = 3;
					}
				}
			}
		...
		case 1:
			if (iLocal_103 < get_game_timer())
			{
				if (!is_ped_injured(iLocal_73[0]) && !is_entity_dead(iLocal_74, false))
				{
					open_sequence_task(&iLocal_79);
					task_look_at_entity(0, iLocal_73[1], 7000, 2060, 4);
					task_pause(0, 2500);
					task_enter_vehicle(0, iLocal_74, -1, -1, 1f, 1, 0);
					close_sequence_task(iLocal_79);
					task_perform_sequence(iLocal_73[0], iLocal_79);
					clear_sequence_task(&iLocal_79);
				}
				if (!is_ped_injured(iLocal_73[1]))
				{
					open_sequence_task(&iLocal_79);
					task_look_at_entity(0, iLocal_73[0], 7000, 2060, 4);
					task_follow_nav_mesh_to_coord(0, -1052.215f, -1354.937f, 4.3754f, 1f, -1, 1f, false, 40000f);
					task_follow_nav_mesh_to_coord(0, -1061.464f, -1384.922f, 4.2462f, 1f, -1, 1f, true, 40000f);
					task_wander_standard(0, 40000f, 0);
					close_sequence_task(iLocal_79);
					task_perform_sequence(iLocal_73[1], iLocal_79);
					clear_sequence_task(&iLocal_79);
				}
				settimera(0);
				iLocal_53 = 3;
			...
			if (!is_ped_injured(iLocal_73[0]))
			{
				if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 8f, 8f, 4f, false, true, 0))
				{
					if (is_ped_facing_ped(player_ped_id(), iLocal_73[0], 80f))
					{
						bLocal_101 = true;
						settimera(0);
						iLocal_53 = 4;
				...
				else if (!is_entity_at_entity(player_ped_id(), iLocal_73[0], 30f, 30f, 30f, false, true, 0))
				{
					_0xB542DE8C3D1CB210(true);
				}
				else
				{
					_0xB542DE8C3D1CB210(false);
				}
			}
			break;
		...
		case 3:
			...
			if (iLocal_52 == 2)
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 30f, 30f, 30f, false, true, 0))
					{
						func_153();
						if (func_152())
						{
				...
				if (is_entity_at_coord(player_ped_id(), Local_62, 15f, 15f, 15f, false, true, 0) && !is_ped_trying_to_enter_a_locked_vehicle(player_ped_id()))
				{
					if (!is_ped_injured(iLocal_73[0]))
					{
						if (is_ped_facing_ped(player_ped_id(), iLocal_73[0], 80f))
						{
							if (can_ped_see_hated_ped(iLocal_73[0], player_ped_id()))
							{
								...
								{
									open_sequence_task(&iLocal_79);
									task_look_at_entity(0, player_ped_id(), -1, 2060, 4);
									task_play_anim(0, "random@drunk_driver_2", "exit_1", 8f, -8f, -1, 0, 0f, false, false, false);
								...
								if (!is_ped_injured(iLocal_73[1]))
								{
									task_look_at_entity(iLocal_73[1], player_ped_id(), -1, 2060, 4);
								}
								settimera(0);
								iLocal_53 = 4;
							}
				...
				if (is_entity_in_angled_area(player_ped_id(), 1889.121f, 3715.057f, 31.844f, 1895.608f, 3703.586f, 34.8272f, 12.4375f, false, true, 0))
				{
					if (!is_ped_injured(iLocal_73[0]))
					{
						open_sequence_task(&iLocal_79);
				...
				if (is_vehicle_driveable(iLocal_74, false))
				{
					if (is_entity_at_entity(player_ped_id(), iLocal_74, 1.5f, 1.5f, 5f, false, true, 0) && is_ped_trying_to_enter_a_locked_vehicle(player_ped_id()))
					{
						if (func_152())
						{
							func_62(0);
						...
						if (func_67(&uLocal_140, "REDR2AU", "REDR2_TRY", 4, 0, 0, 0))
						{
							...
							while (iLocal_59 <= 1)
							{
								if (does_blip_exist(uLocal_126[iLocal_59]))
								{
									remove_blip(&(uLocal_126[iLocal_59]));
								}
								iLocal_59++;
							}
							if (!does_blip_exist(iLocal_127))
							{
								iLocal_127 = func_150(iLocal_74, 0, 0);
							}
							if (!is_ped_injured(iLocal_73[0]))
							{
								clear_ped_tasks_immediately(iLocal_73[0]);
							}
							iLocal_53 = 4;
						}
					}
				...
				if (iLocal_103 < get_game_timer())
				{
					...
					{
						if ((!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1])) && does_entity_exist(iLocal_74))
						{
							open_sequence_task(&iLocal_79);
							task_look_at_entity(0, iLocal_73[1], -1, 2060, 4);
							task_enter_vehicle(0, iLocal_74, -1, -1, 1f, 1, 0);
							close_sequence_task(iLocal_79);
							task_perform_sequence(iLocal_73[0], iLocal_79);
							clear_sequence_task(&iLocal_79);
							open_sequence_task(&iLocal_79);
							task_look_at_entity(0, iLocal_73[0], -1, 2060, 4);
							task_turn_ped_to_face_entity(0, iLocal_73[0], 0);
							task_enter_vehicle(0, iLocal_74, -1, 0, 1f, 1, 0);
							close_sequence_task(iLocal_79);
							task_perform_sequence(iLocal_73[1], iLocal_79);
							clear_sequence_task(&iLocal_79);
							iLocal_59 = 0;
		...
		case 4:
			if (iLocal_52 == 1)
			{
				switch (iLocal_137)
				{
					case 0:
						if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
						{
							if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 8f, 8f, 4f, false, true, 0) || bLocal_101)
							{
								_0xB542DE8C3D1CB210(false);
								task_look_at_entity(iLocal_73[0], player_ped_id(), -1, 2060, 4);
								task_look_at_entity(iLocal_73[1], player_ped_id(), -1, 2060, 4);
								task_look_at_entity(player_ped_id(), iLocal_73[0], -1, 2060, 4);
								if ((get_game_timer() + 50000) > iLocal_103 || is_player_pressing_horn(player_id()))
								{
									func_6();
									if (bLocal_101)
									{
					...
					case 1:
						if (!func_4())
						{
							if (func_149())
							{
								...
								{
									open_sequence_task(&iLocal_79);
									task_play_anim(0, "random@drunk_driver_1", "drunk_breakout_dd1", 2f, -2f, -1, 0, 0f, false, false, false);
									...
									{
										open_sequence_task(&iLocal_79);
										task_play_anim(0, "random@drunk_driver_1", "drunk_breakout_dd2", 2f, -2f, -1, 0, 0f, false, false, false);
										task_turn_ped_to_face_entity(0, iLocal_73[0], 0);
										task_pause(0, 3000);
										task_follow_nav_mesh_to_coord(0, -1052.215f, -1354.937f, 4.3754f, 1f, -1, 1f, false, 40000f);
										task_follow_nav_mesh_to_coord(0, -1061.464f, -1384.922f, 4.2462f, 1f, -1, 1f, true, 40000f);
							...
							else
							{
								if (!is_ped_injured(iLocal_73[0]))
								{
									if (is_ped_facing_ped(player_ped_id(), iLocal_73[0], 80f))
									{
										task_look_at_entity(iLocal_73[0], player_ped_id(), 10000, 2060, 4);
										task_look_at_entity(player_ped_id(), iLocal_73[0], 10000, 2060, 4);
										func_6();
										wait(0);
										iLocal_137++;
									}
					...
					case 3:
						if (!iLocal_84)
						{
							if (timera() > 1500)
							{
								...
								{
									open_sequence_task(&iLocal_79);
									task_look_at_entity(0, player_ped_id(), 10000, 2060, 4);
									task_turn_ped_to_face_entity(0, player_ped_id(), 0);
									task_pause(0, 500);
									close_sequence_task(iLocal_79);
									task_perform_sequence(iLocal_73[0], iLocal_79);
						...
						if (!func_149())
						{
							if (!func_4())
							{
								if (func_67(&uLocal_140, "REDR1AU", "REDR1_PLS", 4, 0, 0, 0))
								{
									...
									if (does_blip_exist(uLocal_126[0]))
									{
										remove_blip(&(uLocal_126[0]));
									}
									if (does_blip_exist(uLocal_126[1]))
									{
										remove_blip(&(uLocal_126[1]));
									}
									if (is_vehicle_driveable(iLocal_74, false))
									{
										set_vehicle_doors_locked(iLocal_74, 1);
										if (!is_ped_injured(iLocal_73[0]))
										{
											task_enter_vehicle(iLocal_73[0], iLocal_74, -1, 0, 1f, 1, 0);
										}
									}
									iLocal_137++;
								}
						...
						if (func_149())
						{
							if (!is_ped_injured(iLocal_73[0]))
							{
								if (!is_ped_in_group(iLocal_73[0]))
								{
									clear_ped_tasks(iLocal_73[0]);
									set_ped_as_group_member(iLocal_73[0], func_63());
									set_ped_never_leaves_group(iLocal_73[0], true);
									set_ped_group_member_passenger_index(iLocal_73[0], 0);
								}
								set_relationship_between_groups(255, iLocal_80, joaat("player"));
								func_146();
							}
							if (is_ped_in_any_vehicle(player_ped_id(), false))
							{
								if (get_vehicle_ped_is_in(player_ped_id(), false) != iLocal_74)
								{
									if (!func_4())
									{
										if (func_22() == 0)
			...
			if (iLocal_52 == 2)
			{
				switch (iLocal_137)
				{
					case 0:
						if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
						{
							if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 10f, 10f, 10f, false, true, 0))
							{
								if (is_ped_facing_ped(iLocal_73[0], player_ped_id(), 50f))
								{
									task_look_at_entity(player_ped_id(), iLocal_73[0], -1, 2060, 4);
									task_look_at_entity(iLocal_73[0], player_ped_id(), -1, 2060, 4);
									task_look_at_entity(iLocal_73[1], player_ped_id(), -1, 2060, 4);
					...
					case 2:
						...
						if (!func_4())
						{
							if (!is_ped_injured(iLocal_73[0]))
							{
								if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 20f, 20f, 20f, false, true, 0) && timera() > 9500)
								{
						...
						if (!is_entity_dead(iLocal_74, false))
						{
							if (is_ped_in_vehicle(player_ped_id(), iLocal_74, true))
							{
								iLocal_53 = 7;
							}
						}
			...
			if (iLocal_52 == 1)
			{
				if (!is_ped_injured(iLocal_73[0]) && !is_entity_dead(iLocal_74, false))
				{
					if (timera() > 50000 || get_ped_in_vehicle_seat(iLocal_74, -1, false) == iLocal_73[0])
					{
						if (func_67(&uLocal_140, "REDR1AU", "REDR1_FU", 4, 0, 0, 0))
						{
							if (is_vehicle_driveable(iLocal_74, false) && !is_vehicle_stuck_on_roof(iLocal_74))
							{
								if (!is_ped_injured(iLocal_73[0]))
								{
									if (is_vehicle_seat_free(iLocal_74, -1, false) && is_ped_in_vehicle(iLocal_73[0], iLocal_74, false))
									{
										task_shuffle_to_next_vehicle_seat(iLocal_73[0], iLocal_74, 0);
										iLocal_53 = 2;
									}
									else if (get_ped_in_vehicle_seat(iLocal_74, -1, false) == iLocal_73[0])
									{
										iLocal_53 = 2;
									}
									else if (get_ped_in_vehicle_seat(iLocal_74, -1, false) == player_ped_id())
									{
										iLocal_53 = 7;
									}
									else
							...
							else if (!is_ped_injured(iLocal_73[0]))
							{
								func_70(iLocal_73[0], 120000, 0);
								task_wander_standard(iLocal_73[0], 40000f, 0);
								set_ped_keep_task(iLocal_73[0], true);
			...
			if (iLocal_52 == 2)
			{
				if (timera() > 60000)
				{
					if (func_67(&uLocal_140, "REDR2AU", "REDR2_FU", 4, 0, 0, 0))
					{
						if (is_vehicle_driveable(iLocal_74, false))
						{
							if (is_vehicle_seat_free(iLocal_74, -1, false))
							{
								if (!is_ped_injured(iLocal_73[0]))
								{
									open_sequence_task(&iLocal_79);
		...
		case 2:
			if (iLocal_52 == 1)
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					if (!is_entity_dead(iLocal_74, false))
					{
						if (is_ped_in_vehicle(iLocal_73[0], iLocal_74, false))
						{
							if (get_script_task_status(iLocal_73[0], 355471868) != 1 && get_script_task_status(iLocal_73[0], 355471868) != 0)
							{
								set_vehicle_engine_health(iLocal_74, 5f);
								set_disable_pretend_occupants(iLocal_74, true);
								open_sequence_task(&iLocal_79);
								task_vehicle_mission_coors_target(0, iLocal_74, -1016.152f, -1352.855f, 4.4854f, 4, 50f, 262144, -1f, 100f, true);
								task_vehicle_mission_coors_target(0, iLocal_74, -1005.757f, -1353.806f, 4.4756f, 4, 50f, 262144, -1f, 100f, true);
								task_vehicle_mission_coors_target(0, iLocal_74, -989.2302f, -1354.278f, -7.3581f, 4, 50f, 262144, -1f, 100f, true);
								close_sequence_task(iLocal_79);
								task_perform_sequence(iLocal_73[0], iLocal_79);
								clear_sequence_task(&iLocal_79);
								set_ped_keep_task(iLocal_73[0], true);
			...
			if (iLocal_52 == 2)
			{
				if (is_vehicle_driveable(iLocal_74, false))
				{
					if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
					{
						if (is_ped_sitting_in_vehicle(iLocal_73[0], iLocal_74) && is_ped_sitting_in_vehicle(iLocal_73[1], iLocal_74))
						{
							set_disable_pretend_occupants(iLocal_74, true);
							clear_ped_tasks(iLocal_73[1]);
							task_stand_still(iLocal_73[1], -1);
							set_ped_keep_task(iLocal_73[1], true);
							iLocal_53 = 5;
						}
						if (!iLocal_81)
						{
							...
							{
								clear_ped_tasks(iLocal_73[0]);
								task_stand_still(iLocal_73[0], -1);
							}
							if (!is_ped_sitting_in_vehicle(iLocal_73[0], iLocal_74) && is_ped_sitting_in_vehicle(iLocal_73[1], iLocal_74))
							{
								clear_ped_tasks(iLocal_73[1]);
		...
		case 5:
			if (is_vehicle_driveable(iLocal_74, false))
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					clear_ped_tasks(iLocal_73[0]);
					open_sequence_task(&iLocal_79);
					task_vehicle_drive_to_coord(0, iLocal_74, get_offset_from_entity_in_world_coords(iLocal_74, 0f, 2f, 0f), 10f, 0, iLocal_78, 262144, 5f, -1f);
					task_vehicle_temp_action(0, iLocal_74, 24, 500);
					task_vehicle_temp_action(0, iLocal_74, 9, 1500);
					task_vehicle_temp_action(0, iLocal_74, 24, 500);
					task_vehicle_temp_action(0, iLocal_74, 11, 1500);
					task_vehicle_mission_coors_target(0, iLocal_74, 2185.817f, 3915.471f, 27.9257f, 4, 30f, 262144, 0f, 0f, true);
					close_sequence_task(iLocal_79);
					task_perform_sequence(iLocal_73[0], iLocal_79);
					clear_sequence_task(&iLocal_79);
					set_ped_keep_task(iLocal_73[0], true);
		...
		case 6:
			if (!is_ped_injured(iLocal_73[0]))
			{
				if (get_script_task_status(iLocal_73[0], 242628503) == 1)
				{
					if (get_sequence_progress(iLocal_73[0]) == 5)
					{
						func_66();
					}
				}
		...
		case 7:
			if (iLocal_52 == 1)
			{
				if (!is_ped_injured(iLocal_73[1]))
				{
					if (!is_entity_at_entity(player_ped_id(), iLocal_73[1], 50f, 50f, 50f, false, true, 0))
					{
						set_ped_as_no_longer_needed(&(iLocal_73[1]));
					}
				}
				switch (iLocal_60)
				{
					...
					case 1:
						if (timera() > 1000)
						{
							if (!is_ped_injured(iLocal_73[0]))
							{
								if (func_149())
								{
									if (is_vehicle_driveable(get_vehicle_ped_is_using(player_ped_id()), false))
									{
										fLocal_131 = func_145(player_ped_id(), iLocal_73[0], 1);
										iLocal_60++;
									}
								}
								else if (!iLocal_99)
					...
					case 2:
						...
						if (!is_ped_injured(iLocal_73[0]))
						{
							if (func_149())
							{
								if (!iLocal_98)
								{
									if (func_145(player_ped_id(), iLocal_73[0], 1) > (fLocal_131 + 5f))
									{
						...
						if (func_2())
						{
							...
							{
								if (!does_blip_exist(iLocal_83))
								{
									iLocal_83 = func_142(Local_71, 0);
									set_blip_sprite(iLocal_83, 269);
									func_140();
								}
							}
							iLocal_58 = 1;
						...
						if (!is_ped_injured(iLocal_73[0]))
						{
							if (func_145(player_ped_id(), iLocal_73[0], 1) > 50f)
							{
								func_66();
							}
						}
					...
					case 5:
						...
						if (!iLocal_90)
						{
							if ((get_game_timer() - iLocal_138) > 7000)
							{
								if (!func_4())
								{
						...
						if (!is_ped_injured(iLocal_73[0]))
						{
							if (is_entity_at_coord(iLocal_73[0], Local_69, Global_22, true, true, 0))
							{
								if (does_blip_exist(iLocal_82))
								{
									remove_blip(&iLocal_82);
								}
								if (does_blip_exist(iLocal_83))
								{
									remove_blip(&iLocal_83);
								}
								iLocal_53 = 8;
							}
						}
			...
			if (iLocal_52 == 2)
			{
				switch (iLocal_60)
				{
					...
					case 1:
						if (!is_ped_injured(iLocal_73[0]) && !is_entity_dead(iLocal_74, false))
						{
							task_clear_look_at(iLocal_73[0]);
							task_enter_vehicle(iLocal_73[0], iLocal_74, 30000, 2, 2f, 1, 0);
						}
						settimera(0);
						iLocal_60++;
						break;
					...
					case 2:
						if (!is_ped_injured(iLocal_73[1]) && !is_entity_dead(iLocal_74, false))
						{
							open_sequence_task(&iLocal_79);
							task_clear_look_at(0);
							task_follow_to_offset_of_entity(0, iLocal_74, 1.5f, -3f, 0f, 1f, 4000, 0.1f, true);
							task_enter_vehicle(0, iLocal_74, 30000, 1, 2f, 1, 0);
							close_sequence_task(iLocal_79);
							task_perform_sequence(iLocal_73[1], iLocal_79);
							clear_sequence_task(&iLocal_79);
						}
					...
					case 3:
						...
						if (is_ped_in_any_vehicle(player_ped_id(), false))
						{
							if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false))
							{
								if (!is_entity_dead(iLocal_73[0], false) && !is_entity_dead(iLocal_73[1], false))
								{
									if (is_ped_in_vehicle(iLocal_73[0], get_vehicle_ped_is_in(player_ped_id(), false), false) && is_ped_in_vehicle(iLocal_73[1], get_vehicle_ped_is_in(player_ped_id(), false), false))
									{
										set_relationship_between_groups(255, iLocal_80, joaat("player"));
					...
					case 5:
						...
						if ((get_game_timer() - iLocal_138) > 9000)
						{
							func_125();
						}
						if (iLocal_309 == 9 && ((get_game_timer() - iLocal_310) > 6000 && (get_game_timer() - iLocal_310) < 6500))
						{
						...
						if (!is_entity_dead(iLocal_74, false))
						{
							if ((!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1])) && is_ped_in_vehicle(player_ped_id(), iLocal_74, false))
							{
								if (is_entity_at_coord(iLocal_73[0], Local_69, Global_22, true, true, 0) && is_entity_at_coord(iLocal_73[1], Local_69, Global_22, false, true, 0))
								{
									iLocal_60++;
								}
							}
		...
		case 8:
			...
			while (iLocal_59 <= (iLocal_72 - 1))
			{
				if (!is_ped_injured(iLocal_73[iLocal_59]))
				{
					set_blocking_of_non_temporary_events(iLocal_73[iLocal_59], false);
				}
				iLocal_59++;
			}
			if (iLocal_52 == 1)
			{
				if (func_124(1, 0, 1) && iLocal_104 == -1)
				{
					...
					if (is_ped_in_any_vehicle(player_ped_id(), false))
					{
						bring_vehicle_to_halt(get_players_last_vehicle(), (10.5f - 5f), 2, false);
					}
					if (func_2())
					{
						if (get_vehicle_ped_is_in(player_ped_id(), false) == iLocal_74)
			...
			if (iLocal_52 == 2)
			{
				if (func_124(1, 0, 1) && iLocal_104 == -1)
				{
					...
					if (is_ped_in_any_vehicle(player_ped_id(), false))
					{
						bring_vehicle_to_halt(get_players_last_vehicle(), (10.5f - 4f), 2, false);
						new_load_scene_start_sphere(1143.587f, 2672.224f, 37.1142f, 70f, 2);
						new_load_scene_start_sphere(930.2788f, 2856.145f, 59.2884f, 70f, 2);
					}
...
void func_77()
{
	switch (iLocal_106)
	{
		case 0:
			...
			{
				remove_ped_from_group(iLocal_73[0]);
				task_look_at_entity(iLocal_73[1], player_ped_id(), 10000, 2060, 4);
			}
		...
		case 2:
			if (iLocal_105 < get_game_timer())
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					task_go_straight_to_coord(iLocal_73[0], Local_70, 1f, -1, 40000f, 0.5f);
					iLocal_105 = get_game_timer() + 500;
					iLocal_106++;
				}
			}
			break;
		...
		case 3:
			if (iLocal_105 < get_game_timer())
			{
				if (!is_ped_injured(iLocal_73[1]))
				{
					task_follow_nav_mesh_to_coord(iLocal_73[1], Local_70, 1f, -1, 0.25f, false, 40000f);
					iLocal_106++;
				}
			}
			break;
	...
	switch (iLocal_106)
	{
		...
		case 2:
			if (!is_ped_injured(iLocal_73[1]))
			{
				...
				task_follow_nav_mesh_to_coord(0, Local_70, 1f, -1, 0.25f, false, 40000f);
				close_sequence_task(iLocal_79);
				task_perform_sequence(iLocal_73[1], iLocal_79);
				clear_sequence_task(&iLocal_79);
				iLocal_105 = get_game_timer() + 1500;
				iLocal_106++;
			}
			break;
		...
		case 3:
			if (iLocal_105 < get_game_timer())
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					task_follow_nav_mesh_to_coord(iLocal_73[0], Local_70, 1f, -1, 0.25f, false, 40000f);
					iLocal_106++;
				}
			}
			break;
		...
		case 4:
			if (func_22() == 2)
			{
				...
				{
					iLocal_105 = get_game_timer() + 1000;
					iLocal_106 = 7;
				}
			}
			else if (func_22() == 1)
		...
		case 6:
			if (!is_ped_injured(iLocal_73[0]))
			{
				if (func_22() == 2)
				{
					...
					{
						task_follow_nav_mesh_to_coord(iLocal_73[0], Local_70, 1f, -1, 0.25f, false, 40000f);
						iLocal_105 = get_game_timer() + 3500;
						iLocal_106++;
					}
				}
...
void func_110()
{
	...
	switch (iLocal_106)
	{
		case 0:
			...
			if (is_vehicle_driveable(iLocal_74, false))
			{
				if (is_vehicle_stopped(iLocal_74))
				{
					if (is_vehicle_driveable(iLocal_74, false))
					{
						if (!is_ped_injured(iLocal_73[0]))
						{
							clear_ped_tasks(iLocal_73[0]);
							remove_ped_from_group(iLocal_73[0]);
							task_look_at_entity(player_ped_id(), iLocal_73[0], 4000, 2060, 4);
						}
						if (!is_ped_injured(iLocal_73[1]))
						{
							clear_ped_tasks(iLocal_73[1]);
		...
		case 1:
			if (is_vehicle_driveable(iLocal_74, false))
			{
				iLocal_108 = create_camera_with_params(26379945, 1121.335f, 2643.908f, 37.862f, 1.5062f, 0f, 20.274f, 33.0256f, false, 2);
				iLocal_109 = create_camera_with_params(26379945, 1121.302f, 2643.998f, 37.8919f, 1.5062f, 0f, 18.7019f, 33.0256f, false, 2);
				shake_cam(iLocal_108, "HAND_SHAKE", 0.3f);
				shake_cam(iLocal_109, "HAND_SHAKE", 0.3f);
				set_cam_active_with_interp(iLocal_109, iLocal_108, 2500, 0, 0);
				render_script_cams(true, false, 3000, true, false, 0);
				clear_area(Local_69, 8f, true, false, false, false);
				set_entity_coords(iLocal_74, 1120.551f, 2647.307f, 36.9963f, true, false, false, true);
				set_entity_heading(iLocal_74, 179.7675f);
				set_vehicle_on_ground_properly(iLocal_74, 5f);
				iLocal_105 = get_game_timer() + 2500;
				iLocal_106++;
			}
			break;
		
		case 2:
			if (iLocal_105 - 500) < get_game_timer()
			{
				if (!is_ped_injured(iLocal_73[1]))
				{
					if (is_ped_in_any_vehicle(iLocal_73[1], false))
					{
						open_sequence_task(&iLocal_79);
						task_follow_nav_mesh_to_coord(0, Local_70, 1f, -1, 0.25f, false, 40000f);
						close_sequence_task(iLocal_79);
			...
			if (iLocal_105 - 1000) < get_game_timer()
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					if (is_ped_in_any_vehicle(iLocal_73[0], false))
					{
						open_sequence_task(&iLocal_79);
						task_follow_nav_mesh_to_coord(0, Local_70 - Vector(0f, 0f, 1f), 1f, -1, 0.25f, false, 40000f);
						close_sequence_task(iLocal_79);
						task_perform_sequence(iLocal_73[0], iLocal_79);
						clear_sequence_task(&iLocal_79);
						set_ped_keep_task(iLocal_73[0], true);
			...
			if (iLocal_105 < get_game_timer())
			{
				set_cam_params(iLocal_108, 1105.849f, 2664.653f, 38.047f, 3.6983f, 0.0242f, -140.4768f, 41.7126f, 0, 1, 1, 2);
				set_cam_params(iLocal_109, 1106f, 2664.469f, 38.0625f, 3.6984f, 0.0242f, -140.4769f, 41.7126f, 0, 1, 1, 2);
				set_cam_active_with_interp(iLocal_109, iLocal_108, 5000, 0, 0);
				new_load_scene_stop();
				iLocal_105 = get_game_timer() + 6000;
				iLocal_106++;
			}
			break;
		...
		case 3:
			if (iLocal_105 < get_game_timer())
			{
				set_cam_params(iLocal_108, 1122.37f, 2646.108f, 38.3339f, -5.6746f, -0.1271f, 33.7683f, 50f, 0, 1, 1, 2);
				set_cam_params(iLocal_109, 1122.338f, 2646.157f, 38.3281f, -5.6746f, -0.1271f, 33.7683f, 50f, 0, 1, 1, 2);
				set_cam_active_with_interp(iLocal_109, iLocal_108, 1500, 1, 1);
				if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
				{
					set_entity_coords(iLocal_73[0], 1141.156f, 2643.205f, 37.1487f, true, false, false, true);
					set_entity_heading(iLocal_73[0], 262.7369f);
					set_entity_coords(iLocal_73[1], 1140.152f, 2644.149f, 37.1487f, true, false, false, true);
					set_entity_heading(iLocal_73[1], 262.1522f);
				}
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
				...
				iLocal_105 = get_game_timer() + 1700;
				iLocal_106++;
			}
			break;
		...
		case 6:
			if (!func_4())
			{
				if (func_22() == 2)
				{
					if (func_67(&uLocal_140, "REDR2AU", "REDR2_NOT", 4, 0, 0, 0))
					{
						iLocal_105 = get_game_timer() + 5500;
						iLocal_106++;
					}
				}
				if (func_22() == 1 || func_22() == 0)
		...
		case 7:
			...
			if (is_vehicle_driveable(iLocal_74, false))
			{
				set_vehicle_doors_locked(iLocal_74, 7);
			}
			if (iLocal_111)
			{
				if (!is_entity_dead(iLocal_74, false))
				{
					...
					set_vehicle_doors_shut(iLocal_74, true);
...
void func_113(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_117(player_id())) && !func_115(player_id(), 0)) && !func_114()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_117(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_121()
{
	switch (iLocal_106)
	{
		...
		case 1:
			iLocal_105 = get_game_timer() + 3000;
			iLocal_106++;
			break;
		...
		case 3:
			if (!is_ped_injured(iLocal_73[0]))
			{
				open_sequence_task(&iLocal_79);
				task_leave_any_vehicle(0, 0, 0);
				task_turn_ped_to_face_entity(0, player_ped_id(), 1800);
				task_follow_nav_mesh_to_coord(0, Local_70, 1f, -1, 0.25f, false, 40000f);
				task_play_anim(0, "random@drunk_driver_1", "drunk_fall_over", 2f, -2f, -1, 2359304, 0f, false, false, false);
				close_sequence_task(iLocal_79);
				task_perform_sequence(iLocal_73[0], iLocal_79);
				clear_sequence_task(&iLocal_79);
				set_ped_keep_task(iLocal_73[0], true);
				iLocal_105 = get_game_timer() + 2000;
				iLocal_106++;
			}
			break;
...
void func_123()
{
	switch (iLocal_106)
	{
		case 0:
			if (is_vehicle_driveable(iLocal_74, false))
			{
				if (is_vehicle_stopped(iLocal_74) && !func_4())
				{
					if (!is_ped_injured(iLocal_73[0]))
					{
						clear_ped_tasks(iLocal_73[0]);
...
void func_125()
{
	...
	{
		iVar0 = 0;
		iVar1 = _get_cam_active_view_mode_context();
		if (iVar1 != 0)
		{
			iVar2 = get_cam_view_mode_for_context(iVar1);
			if (iVar2 == 4)
			{
				iVar0 = 1;
			}
		}
		if ((((((((func_130(64) || is_control_pressed(0, 86)) || is_control_pressed(0, 71)) || is_control_pressed(0, 72)) || is_control_pressed(0, 76)) || is_control_pressed(0, 73)) || is_control_pressed(0, 68)) || is_control_pressed(0, 75)) || iVar0)
		{
	...
	switch (iLocal_309)
	{
		case 0:
			if (func_129())
			{
				task_look_at_entity(iLocal_73[0], iLocal_73[1], -1, 2060, 4);
				task_look_at_entity(iLocal_73[1], iLocal_73[0], -1, 2060, 4);
				if (func_67(&uLocal_140, "REDR2AU", "REDR2_HC", 4, 0, 0, 0))
				{
					open_sequence_task(&iLocal_79);
					task_play_anim(0, "random@drunk_driver_2", "cardrunkflirt_intro_m", 2f, -2f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "random@drunk_driver_2", "cardrunkflirt_loop_m", 2f, -2f, -1, 1, 0f, false, false, false);
					close_sequence_task(iLocal_79);
					task_perform_sequence(iLocal_73[0], iLocal_79);
					clear_sequence_task(&iLocal_79);
					open_sequence_task(&iLocal_79);
					task_play_anim(0, "random@drunk_driver_2", "cardrunkflirt_intro_f", 2f, -2f, -1, 0, 0f, false, false, false);
					task_play_anim(0, "random@drunk_driver_2", "cardrunkflirt_loop_f", 2f, -2f, -1, 1, 0f, false, false, false);
					close_sequence_task(iLocal_79);
					task_perform_sequence(iLocal_73[1], iLocal_79);
					clear_sequence_task(&iLocal_79);
					iLocal_310 = get_game_timer();
					iLocal_309++;
				}
			}
			break;
		...
		case 2:
			if (func_129())
			{
				if ((get_game_timer() - iLocal_310) > 5000)
				{
		...
		case 3:
			if ((get_game_timer() - iLocal_310) > 15000)
			{
				if (func_129())
				{
					task_play_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m", 2f, -2f, -1, 0, 0f, false, false, false);
					task_play_anim(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_intro_f", 2f, -2f, -1, 0, 0f, false, false, false);
					iLocal_309++;
				}
			}
			break;
		...
		case 4:
			...
			{
				func_127();
				if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m", 3))
				{
					if (get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m") > 0.9f)
					{
						task_play_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0f, false, false, false);
						task_play_anim(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0f, false, false, false);
						iLocal_310 = get_game_timer();
						iLocal_309++;
					}
				}
			}
			else if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
			{
				clear_ped_tasks(iLocal_73[0]);
				clear_ped_tasks(iLocal_73[1]);
				iLocal_309 = 3;
		...
		case 5:
			if (func_129())
			{
				func_127();
				func_126();
				if (is_ped_in_vehicle(player_ped_id(), get_vehicle_ped_is_in(iLocal_73[1], false), false))
				{
					if ((get_game_timer() - iLocal_310) > 15000)
					{
						bVar3 = false;
						iVar4 = _get_cam_active_view_mode_context();
						if (iVar4 != 0)
						{
							iVar5 = get_cam_view_mode_for_context(iVar4);
							if (iVar5 == 4)
							{
								bVar3 = true;
							}
						...
						{
							open_sequence_task(&iLocal_79);
							task_play_anim(0, "random@drunk_driver_2", "driver_enter_m", 2f, -2f, -1, 0, 0f, false, false, false);
							task_play_anim(0, "random@drunk_driver_2", "driver_idle_m", 2f, -2f, -1, 1, 0f, false, false, false);
							close_sequence_task(iLocal_79);
							task_perform_sequence(player_ped_id(), iLocal_79);
							clear_sequence_task(&iLocal_79);
						}
						if (func_22() == 0)
						{
						...
						else if (func_22() == 2)
						{
							...
							{
								iLocal_310 = get_game_timer() + 14000;
								iLocal_309++;
							}
						}
					}
		...
		case 6:
			func_127();
			func_126();
			if ((get_game_timer() - iLocal_310) > 5000 && func_129())
			{
				if (is_ped_in_vehicle(player_ped_id(), get_vehicle_ped_is_in(iLocal_73[1], false), false))
				{
					if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 3))
					{
						if (get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m") > 0.9f)
						{
							if (is_entity_playing_anim(player_ped_id(), "random@drunk_driver_2", "driver_idle_m", 3))
							{
								task_play_anim(player_ped_id(), "random@drunk_driver_2", "driver_exit_m", 2f, -2f, -1, 0, 0f, false, false, false);
							}
							task_play_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 2f, -2f, -1, 0, 0f, false, false, false);
							task_play_anim(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_outro_f", 2f, -2f, -1, 0, 0f, false, false, false);
							iLocal_309++;
						}
					}
				}
		...
		case 7:
			...
			if (func_129())
			{
				if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
				{
					if (get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.25f && get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") > 0.2f)
					{
						apply_force_to_entity(get_vehicle_ped_is_in(iLocal_73[0], false), 0, 0f, 0f, 20f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
						iLocal_310 = get_game_timer();
						iLocal_309++;
					}
				}
		...
		case 8:
			...
			if (func_129())
			{
				if (!is_ped_in_vehicle(player_ped_id(), get_vehicle_ped_is_in(iLocal_73[1], false), false))
				{
					if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
					{
						if (get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.525f)
						{
							task_play_anim(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0f, false, false, false);
							task_play_anim(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0f, false, false, false);
							iLocal_309 = 6;
			...
			if ((get_game_timer() - iLocal_310) > 10000)
			{
				if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
				{
					clear_ped_tasks(iLocal_73[0]);
...
void func_126()
{
	if (!is_ped_injured(iLocal_73[1]))
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(iLocal_73[0], false), false))
		{
			if (is_entity_playing_anim(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 3))
			{
				if ((((get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.15f && get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.1f) || (get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.35f && get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.3f)) || (get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.65f && get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.6f)) || (get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.9f && get_entity_anim_current_time(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.85f))
				{
					apply_force_to_entity(get_vehicle_ped_is_in(iLocal_73[0], false), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, true, true, true, false, true);
					play_sound_from_entity(-1, "SUSPENSION_SCRIPT_FORCE", get_vehicle_ped_is_in(iLocal_73[0], false), 0, false, 0);
				}
			}
		}
	}
...
int func_129()
{
	...
	if (!is_ped_injured(iLocal_73[1]))
	{
		if (is_ped_in_any_vehicle(iLocal_73[1], false))
		{
			iVar0 = get_vehicle_ped_is_in(iLocal_73[1], false);
			if (is_vehicle_driveable(iVar0, false))
			{
				if (!is_ped_injured(iLocal_73[0]))
				{
					if (is_ped_in_vehicle(iLocal_73[0], iVar0, false))
					{
						if (get_ped_in_vehicle_seat(iVar0, 2, false) == iLocal_73[0] && get_ped_in_vehicle_seat(iVar0, 1, false) == iLocal_73[1])
						{
							return 1;
						}
					}
...
int func_131()
{
	if (func_22() == 2)
	{
		if (func_65())
		{
			if (get_distance_between_coords(-1014.154f, 4881.411f, 245.0001f, get_entity_coords(get_player_ped(get_player_index()), false), true) < 400f)
			{
				if (!Global_32202)
				{
...
void func_133()
{
	if (!bLocal_88)
	{
		...
		if ((iLocal_90 && !iLocal_114) && (get_game_timer() - iLocal_138) > 9000)
		{
			if (!func_4())
			{
	...
	if (iLocal_114 && !iLocal_115)
	{
		if (!func_4())
		{
			...
			iLocal_122 = get_game_timer() + 6000;
			iLocal_115 = 1;
		}
	}
	if (!bLocal_88)
	{
		if ((iLocal_114 && !iLocal_113) && iLocal_122 < get_game_timer())
		{
			if (!func_4())
			{
	...
	else if ((bLocal_88 && !iLocal_112) && iLocal_122 < get_game_timer())
	{
		if (!func_4())
		{
...
void func_134()
{
	...
	{
		if ((get_time_since_player_hit_vehicle(player_id()) > 0 && get_time_since_player_hit_vehicle(player_id()) < 100) || has_entity_collided_with_anything(get_vehicle_ped_is_in(player_ped_id(), false)))
		{
		...
		func_135(Local_129, (get_game_timer() - iLocal_128));
	}
	if (iLocal_130 > 17)
	{
		iLocal_89 = 1;
...
void func_135(struct<3> Param0, int iParam1)
{
	...
	if (func_2())
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false))
		{
			Var0 = { get_entity_speed_vector(get_vehicle_ped_is_in(player_ped_id(), false), false) };
		}
	}
	Var1 = { Var0 - Param0 };
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!is_vehicle_on_all_wheels(get_vehicle_ped_is_in(player_ped_id(), false)) && !func_33("REDR1_SWV"))
			{
				if (iLocal_132 == -1)
				{
					iLocal_132 = get_game_timer() + 400;
				}
				else if (iLocal_132 < get_game_timer())
				{
					iLocal_130 += 3;
					func_5(0);
					func_68();
		...
		switch (iLocal_91)
		{
			...
			case 1:
				if (timerb() > 3000 || !func_4())
				{
					...
					{
						clear_ped_tasks(iLocal_73[0]);
						task_play_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_94, 8f, -8f, -1, 0, 0f, false, false, false);
						iLocal_91++;
					}
				}
				break;
			...
			case 2:
				if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_94, 3))
				{
					fVar0 = get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_1", sLocal_94);
					if (fVar0 > 0.243f && fVar0 < 0.28f)
					{
						if (!iLocal_85)
						{
							start_particle_fx_non_looped_on_ped_bone("scr_puke_in_car", iLocal_73[0], 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, false, false, false);
							iLocal_85 = 1;
						}
					}
					...
					if (get_entity_anim_current_time(iLocal_73[0], "random@drunk_driver_1", sLocal_94) > 0.8f)
					{
						iLocal_91++;
					}
				}
			...
			case 3:
				...
				{
					task_play_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 2f, -4f, -1, 1, 0f, false, false, false);
					iLocal_85 = 0;
					iLocal_91++;
				}
				break;
...
void func_138()
{
	...
	if ((iLocal_134 - iLocal_133) > 60000 && iLocal_136)
	{
		...
		if (!is_ped_injured(iLocal_73[0]) && !is_ped_injured(iLocal_73[1]))
		{
			...
			task_follow_to_offset_of_entity(iLocal_73[1], iLocal_73[0], 0f, 1f, 0f, 1f, -1, 0.1f, true);
			func_70(iLocal_73[1], 120000, 0);
			set_ped_keep_task(iLocal_73[1], true);
			if (is_ped_in_group(iLocal_73[1]))
			{
...
void func_139()
{
	if (iLocal_52 == 1)
	{
		if (!is_ped_injured(iLocal_73[0]))
		{
			if (!is_entity_at_entity(player_ped_id(), iLocal_73[0], 150f, 150f, 150f, false, true, 0))
			{
				func_66();
			}
			if (func_149() || is_ped_on_foot(player_ped_id()))
			{
				if (!is_ped_in_group(iLocal_73[0]))
				{
					set_ped_as_group_member(iLocal_73[0], func_63());
			...
			else if (is_ped_in_group(iLocal_73[0]))
			{
				remove_ped_from_group(iLocal_73[0]);
			}
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				if (is_ped_in_vehicle(iLocal_73[0], get_vehicle_ped_is_in(player_ped_id(), false), false))
				{
					if ((!is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3) && !is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_94, 3)) && !is_ped_getting_into_a_vehicle(iLocal_73[0]))
					{
						task_play_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 2f, -4f, -1, 1, 0f, false, false, false);
					}
					if (func_152())
				...
				else if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3))
				{
					stop_anim_playback(iLocal_73[0], 0, false);
				}
			}
			else
			{
				if (is_ped_in_any_vehicle(iLocal_73[0], false))
				{
					if (is_entity_playing_anim(iLocal_73[0], "random@drunk_driver_1", sLocal_93, 3))
					{
						stop_anim_playback(iLocal_73[0], 0, false);
					}
				}
			...
			if (is_entity_at_entity(player_ped_id(), iLocal_73[0], 8f, 8f, 8f, false, true, 0) || is_ped_in_any_taxi(player_ped_id()))
			{
				if (does_blip_exist(uLocal_126[0]))
				{
					remove_blip(&(uLocal_126[0]));
	...
	if (iLocal_52 == 2)
	{
		if ((!is_entity_dead(iLocal_74, false) && !is_ped_injured(iLocal_73[0])) && !is_ped_injured(iLocal_73[1]))
		{
			if (!is_entity_at_entity(player_ped_id(), iLocal_73[0], 150f, 150f, 150f, false, true, 0) || !is_entity_at_entity(player_ped_id(), iLocal_73[1], 150f, 150f, 150f, false, true, 0))
			{
				if (does_entity_exist(iLocal_73[0]))
				{
					if (!is_ped_injured(iLocal_73[0]))
			...
			if (is_ped_in_vehicle(player_ped_id(), iLocal_74, false))
			{
				if (is_ped_in_vehicle(iLocal_73[0], iLocal_74, false) && is_ped_in_vehicle(iLocal_73[1], iLocal_74, false))
				{
					if (func_152())
					{
						func_62(0);
...
int func_142(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(Param0);
	set_blip_scale(iVar0, func_143(network_is_game_in_progress(), 1f, 1f));
	...
	if (!is_ped_injured(iLocal_73[0]))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), true))
		{
			if (!func_149())
			{
				...
				if (get_script_task_status(iLocal_73[0], 1227113341) != 1 && get_script_task_status(iLocal_73[0], 1227113341) != 0)
				{
					task_go_to_entity(iLocal_73[0], player_ped_id(), -1, 6f, 2f, 2f, 0);
				}
				if (is_ped_in_any_vehicle(iLocal_73[0], false))
				{
					task_leave_any_vehicle(iLocal_73[0], 0, 0);
				}
				if (!iLocal_102)
				{
					if (!func_4())
	...
	switch (*uParam1)
	{
		case 0:
			if (!is_ped_injured(iParam0))
			{
				...
				task_turn_ped_to_face_entity(0, player_ped_id(), -1);
				close_sequence_task(iLocal_79);
				task_perform_sequence(iParam0, iLocal_79);
				clear_sequence_task(&iLocal_79);
				*uParam1++;
			}
			break;
...
int func_149()
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false))
		{
			...
			{
				if (get_vehicle_max_number_of_passengers(get_vehicle_ped_is_in(player_ped_id(), false)) >= iVar0)
				{
					return 1;
				}
			}
	...
	else if (is_ped_in_any_vehicle(player_ped_id(), true))
	{
		...
		{
			if (((((!is_this_model_a_bike(get_entity_model(get_vehicle_ped_is_entering(player_ped_id()))) && !is_this_model_a_heli(get_entity_model(get_vehicle_ped_is_entering(player_ped_id())))) && !is_this_model_a_plane(get_entity_model(get_vehicle_ped_is_entering(player_ped_id())))) && !is_this_model_a_boat(get_entity_model(get_vehicle_ped_is_entering(player_ped_id())))) && !is_this_model_a_train(get_entity_model(get_vehicle_ped_is_entering(player_ped_id())))) && get_entity_model(get_vehicle_ped_is_entering(player_ped_id())) != joaat("rhino"))
			{
				return 1;
			}
		}
...
int func_151(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_143(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
void func_154()
{
	...
	while (iLocal_59 <= (iLocal_72 - 1))
	{
		if (!does_blip_exist(uLocal_126[iLocal_59]))
		{
			...
			show_height_on_blip(uLocal_126[iLocal_59], false);
		}
		iLocal_59++;
	}
}
...
int func_169()
{
	...
	if (is_ped_in_any_vehicle(iLocal_73[0], false))
	{
		if (!is_entity_dead(get_vehicle_ped_is_in(iLocal_73[0], false), false))
		{
			iVar0 = get_vehicle_layout_hash(get_vehicle_ped_is_in(iLocal_73[0], false));
...
void func_172()
{
	if (!iLocal_57)
	{
		...
		func_174(43, 1);
		func_174(44, 1);
		clear_area(Local_62, 8f, true, false, false, false);
		add_scenario_blocking_area(Local_62 - Vector(8f, 8f, 8f), Local_62 + Vector(8f, 8f, 8f), false, true, true, true);
		set_all_vehicle_generators_active_in_area(Local_66 - Vector(10f, 15f, 15f), Local_66 + Vector(10f, 15f, 15f), false, true);
		set_all_vehicle_generators_active_in_area(Local_69 - Vector(10f, 15f, 15f), Local_69 + Vector(10f, 15f, 15f), false, true);
		set_bit(&uLocal_123, 5);
		if (func_22() == 0)
		{
			func_173(&uLocal_140, 0, player_ped_id(), "MICHAEL", 0, 1);
		}
		else if (func_22() == 1)
		{
			func_173(&uLocal_140, 1, player_ped_id(), "FRANKLIN", 0, 1);
		}
		else if (func_22() == 2)
		{
			func_173(&uLocal_140, 2, player_ped_id(), "TREVOR", 0, 1);
		}
		add_relationship_group("rghDrunkPeds", &iLocal_80);
		iLocal_74 = create_vehicle(iLocal_78, Local_66, fLocal_67, true, true, false);
		add_vehicle_upsidedown_check(iLocal_74);
		set_vehicle_on_ground_properly(iLocal_74, 5f);
		set_vehicle_model_is_suppressed(iLocal_78, true);
		set_vehicle_doors_locked(iLocal_74, 3);
		set_vehicle_disable_towing(iLocal_74, true);
		iLocal_68 = get_entity_health(iLocal_74);
		iLocal_73[0] = create_ped(26, iLocal_76, Local_62, fLocal_63, true, true);
		set_blocking_of_non_temporary_events(iLocal_73[0], true);
		set_ped_relationship_group_hash(iLocal_73[0], iLocal_80);
		set_ped_config_flag(iLocal_73[0], 185, true);
		set_ped_flee_attributes(iLocal_73[0], 65536, true);
		set_model_as_no_longer_needed(iLocal_76);
		stop_ped_speaking(iLocal_73[0], true);
		iLocal_73[1] = create_ped(26, iLocal_77, Local_64, fLocal_65, true, true);
		set_blocking_of_non_temporary_events(iLocal_73[1], true);
		set_ped_relationship_group_hash(iLocal_73[1], iLocal_80);
		set_ped_config_flag(iLocal_73[1], 185, true);
		set_ped_flee_attributes(iLocal_73[1], 65536, true);
		stop_ped_speaking(iLocal_73[1], true);
		set_relationship_between_groups(5, iLocal_80, joaat("player"));
		set_model_as_no_longer_needed(iLocal_77);
		if (iLocal_52 == 1)
		{
			task_play_anim(iLocal_73[0], "random@drunk_driver_1", "drunk_driver_stand_loop_dd1", 8f, -2f, -1, 1, 0f, false, false, false);
			task_play_anim(iLocal_73[1], "random@drunk_driver_1", "drunk_driver_stand_loop_dd2", 8f, -2f, -1, 1, 0f, false, false, false);
			set_ped_movement_clipset(iLocal_73[0], "MOVE_M@DRUNK@VERYDRUNK", 0.25f);
			set_ped_movement_clipset(iLocal_73[1], "MOVE_M@DRUNK@MODERATEDRUNK", 0.25f);
			set_ped_component_variation(iLocal_73[0], 0, 1, 2, 0);
			set_ped_component_variation(iLocal_73[0], 3, 0, 1, 0);
			set_ped_component_variation(iLocal_73[0], 4, 0, 1, 0);
			set_ped_component_variation(iLocal_73[1], 0, 1, 1, 0);
			set_ped_component_variation(iLocal_73[1], 3, 0, 0, 0);
			set_ped_component_variation(iLocal_73[1], 4, 0, 1, 0);
			remove_vehicle_window(iLocal_74, 1);
			set_ped_config_flag(iLocal_73[0], 206, true);
			set_ped_config_flag(iLocal_73[0], 299, true);
			set_ped_can_be_targetted(iLocal_73[0], false);
			set_ambient_voice_name(iLocal_73[0], "REDR1Drunk1_AI_Drunk");
			set_ambient_voice_name(iLocal_73[1], "A_M_Y_VINEWOOD_01_BLACK_MINI_01");
			func_173(&uLocal_140, 3, iLocal_73[0], "REDR1Drunk1", 0, 1);
			func_173(&uLocal_140, 4, iLocal_73[1], "REDR1Drunk2", 0, 1);
		}
		if (iLocal_52 == 2)
		{
			add_scenario_blocking_area(Local_69 - Vector(10f, 50f, 30f), Local_69 + Vector(10f, 50f, 30f), false, true, true, true);
			set_vehicle_has_strong_axles(iLocal_74, true);
			set_ped_component_variation(iLocal_73[1], 0, 0, 0, 0);
			set_ped_component_variation(iLocal_73[1], 2, 0, 2, 0);
			set_ped_component_variation(iLocal_73[1], 3, 1, 1, 0);
			set_ped_component_variation(iLocal_73[1], 4, 1, 2, 0);
			set_ped_component_variation(iLocal_73[1], 8, 0, 0, 0);
			set_ped_config_flag(iLocal_73[0], 134, true);
			set_ped_config_flag(iLocal_73[1], 134, true);
			set_ped_config_flag(iLocal_73[0], 26, true);
			set_ped_config_flag(iLocal_73[1], 26, true);
			set_ped_config_flag(iLocal_73[0], 206, true);
			set_ped_config_flag(iLocal_73[1], 206, true);
			set_ped_can_be_targetted(iLocal_73[0], false);
			set_ped_can_be_targetted(iLocal_73[1], false);
			task_start_scenario_in_place(iLocal_73[0], "WORLD_HUMAN_BUM_STANDING", 0, false);
			task_look_at_entity(iLocal_73[0], iLocal_73[1], -1, 2060, 4);
			task_start_scenario_in_place(iLocal_73[1], "WORLD_HUMAN_BUM_STANDING", 0, false);
			set_ped_can_play_ambient_anims(iLocal_73[1], false);
			task_look_at_entity(iLocal_73[1], iLocal_73[0], -1, 2060, 4);
			set_ped_movement_clipset(iLocal_73[0], "MOVE_M@DRUNK@MODERATEDRUNK_HEAD_UP", 0.25f);
			set_ped_movement_clipset(iLocal_73[1], "MOVE_M@DRUNK@SLIGHTLYDRUNK", 0.25f);
			set_ambient_voice_name(iLocal_73[0], "A_M_Y_BeachVesp_01_White_Mini_01");
			set_ambient_voice_name(iLocal_73[1], "A_F_Y_EastSA_03_Latino_FULL_01");
...
void func_179()
{
	...
	if (((has_model_loaded(iLocal_76) && has_model_loaded(iLocal_78)) && has_anim_set_loaded("MOVE_M@DRUNK@MODERATEDRUNK")) && has_model_loaded(iLocal_77))
	{
		if (iLocal_52 == 1)
		{
			if (((has_ptfx_asset_loaded() && has_anim_dict_loaded("random@drunk_driver_1")) && has_anim_set_loaded("MOVE_M@DRUNK@VERYDRUNK")) && request_script_audio_bank("CONSTRUCTION_ACCIDENT_1", false, -1))
			{
				iLocal_54 = 1;
			}
		}
...
int func_181()
{
	if (is_player_playing(player_id()) && !is_ped_injured(player_ped_id()))
	{
		...
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_192())
		{
			return 0;
		}
	}
...
int func_194()
{
	if ((Global_113375 == func_58() && get_random_event_flag()) && Global_113376)
	{
		return 1;
	}
	return 0;
...
{
	return (shift_right(iParam0, 26) & 31 * func_212(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_215()
{
	...
	func_221(&uVar0, get_clock_seconds());
	func_220(&uVar0, get_clock_minutes());
	func_219(&uVar0, get_clock_hours());
	func_218(&uVar0, get_clock_day_of_month());
	func_217(&uVar0, get_clock_month());
	func_216(&uVar0, get_clock_year());
	return uVar0;
}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_232()) || Global_31962) || func_231()) || func_30(8, -1)) || func_228()) || func_230()) || func_229()) || func_227()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_232()) || Global_112433) || Global_31962) || func_231()) || func_30(8, -1)) || func_228()) || func_230()) || func_229()) || func_227()) || Global_113386.f_7688.f_919[iVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_232()) || Global_112433) || Global_31962) || func_231()) || func_30(8, -1)) || func_230()) || func_229()) || func_227()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_232() || get_player_wanted_level(player_id()) > 0) || func_30(8, -1)) || func_227()) || func_226()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_240()
{
	...
	if (iLocal_139)
	{
		...
		set_all_vehicle_generators_active_in_area(Local_66 - Vector(10f, 15f, 15f), Local_66 + Vector(10f, 15f, 15f), true, true);
		set_all_vehicle_generators_active_in_area(Local_69 - Vector(10f, 15f, 15f), Local_69 + Vector(10f, 15f, 15f), true, true);
		func_156(0);
		if (!is_entity_dead(get_players_last_vehicle(), false))
		{
			if (!is_entity_a_mission_entity(get_players_last_vehicle()))
			{
				set_entity_as_mission_entity(get_players_last_vehicle(), true, false);
			}
		}
		if (!is_entity_dead(iLocal_75, false))
		{
			if (!is_ped_in_vehicle(player_ped_id(), iLocal_75, false) && func_145(player_ped_id(), iLocal_75, 1) > 50f)
			{
		...
		if (does_entity_exist(iLocal_73[0]))
		{
			if (!is_ped_injured(iLocal_73[0]))
			{
				set_ped_config_flag(iLocal_73[0], 317, true);
				if (!is_ped_in_any_vehicle(iLocal_73[0], false))
				{
					reset_ped_last_vehicle(iLocal_73[0]);
				}
				if (is_ped_in_group(iLocal_73[0]))
				{
					remove_ped_from_group(iLocal_73[0]);
		...
		while (iLocal_59 <= (iLocal_72 - 1))
		{
			if (does_entity_exist(iLocal_73[iLocal_59]))
			{
				if (!is_ped_injured(iLocal_73[iLocal_59]))
				{
					set_ped_config_flag(iLocal_73[iLocal_59], 317, true);
					if (!is_ped_in_any_vehicle(iLocal_73[iLocal_59], false))
					{
						reset_ped_last_vehicle(iLocal_73[iLocal_59]);
					}
					set_ped_can_be_targetted(iLocal_73[iLocal_59], true);
					set_relationship_between_groups(255, iLocal_80, joaat("player"));
					set_blocking_of_non_temporary_events(iLocal_73[iLocal_59], false);
				}
				set_ped_as_no_longer_needed(&(iLocal_73[iLocal_59]));
			}
			iLocal_59++;
		}
		iLocal_59 = 0;
		...
		if (does_cam_exist(iLocal_107))
		{
			if (is_cam_active(iLocal_107))
			{
				set_cam_active(iLocal_107, false);
			}
		}
	}
	func_241(-1);
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_255(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_275(iParam0) != 145) || func_274(iParam0)) || func_273(iParam0)) || func_272(iParam0)) || func_271(iParam0)) || !func_260(get_entity_model(iParam0)))
	{
		if (func_273(iParam0))
		{
		}
...
int func_261(int iParam0, bool bParam1)
{
	...
	{
		if ((func_266() || is_pc_version()) || func_265())
		{
		}
		else if (!func_268())
		{
...
Vector3 func_280()
{
	...
	if (is_player_playing(player_id()))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_306, true);
		iLocal_305 = 1;
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_307, true) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_307, true);
			iLocal_305 = 2;
		}
		if (iLocal_305 == 1)
		{
