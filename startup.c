...
void __EntryFunction__()
{
	...
	iLocal_52 = 0;
	bVar0 = func_81();
	if (_is_command_line_benchmark_value_set() || _landing_menu_is_active())
	{
		bVar0 = false;
	}
	if (bVar0)
	...
	func_77();
	Global_4542087 = 0;
	set_bit(&Global_4542087, false);
	set_bit(&Global_4542087, true);
	iVar1 = 0;
	while (iVar1 < 129)
	{
	...
	switch (iLocal_52)
	{
		case 0:
			...
			set_script_with_name_hash_as_no_longer_needed(joaat("standard_global_init"));
			break;
	}
	wait(0);
	Global_78321 = 1;
	...
	switch (iLocal_52)
	{
		case 0:
			...
			start_save_data(&Global_113386, 1, true);
			register_float_to_save(&Global_113386, "fSaveVersion");
			stop_save_data();
			if (Global_1)
			{
	...
	start_save_data(&Global_2359296, 5568, false);
	start_save_array_with_size(&Global_2359296, 5568, "g_savedMPGlobals");
	iVar1 = 0;
	while (iVar1 < 1)
	{
	...
	stop_save_data();
	iVar2 = 5568;
	iVar3 = get_size_of_save_data(false);
	if (iVar2 != iVar3)
	{
	}
	if (!is_commerce_data_valid() && !_0x1D4DC17C38FEAFF0())
	{
		_0xB606E6CC59664972(0);
	}
	_set_all_paths_cache_boundingstruct(false);
	_set_player_is_in_animal_form(false);
	func_2();
	func_1();
...
void func_4(var uParam0, int iParam1)
{
	...
	start_save_array_with_size(&(uParam0->f_5540.f_19), 8, &cVar0);
	start_save_struct_with_size(&(uParam0->f_5540.f_19[0 /*7*/]), 7, "TEMPSTAT_DATE");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/]), "TEMPSTAT_DATE.year");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	register_int_to_save(&(uParam0->f_5540.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	stop_save_struct();
	stop_save_array();
}
...
void func_5(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	start_save_array_with_size(&(uParam0->f_5540.f_15), 4, &cVar0);
	start_save_struct_with_size(&(uParam0->f_5540.f_15[0 /*3*/]), 3, "TEMPSTAT_VEC");
	register_float_to_save(&(uParam0->f_5540.f_15[0 /*3*/]), "TEMPSTAT_VEC.x");
	register_float_to_save(&(uParam0->f_5540.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	register_float_to_save(&(uParam0->f_5540.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	stop_save_struct();
	stop_save_array();
}
...
void func_6(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	start_save_array_with_size(&(uParam0->f_5540.f_6), 9, &cVar0);
	_0x8269816F6CFD40F8(&(uParam0->f_5540.f_6[0 /*8*/]), "TEMPSTAT_LABEL");
	stop_save_array();
}
...
void func_7(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	start_save_array_with_size(&(uParam0->f_5540.f_4), 2, &cVar0);
	register_bool_to_save(&(uParam0->f_5540.f_4[0]), "TEMPSTAT_BOOL");
	stop_save_array();
}
...
void func_8(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	start_save_array_with_size(&(uParam0->f_5540.f_2), 2, &cVar0);
	register_float_to_save(&(uParam0->f_5540.f_2[0]), "TEMPSTAT_FLOAT");
	stop_save_array();
}
...
void func_9(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	start_save_array_with_size(&(uParam0->f_5540), 2, &cVar0);
	register_int_to_save(&(uParam0->f_5540[0]), "TEMPSTAT_INT1");
	stop_save_array();
}
...
void func_10(var uParam0, int iParam1)
{
	...
	start_save_struct_with_size(&(uParam0->f_5390), 150, &cVar0);
	register_int_to_save(&(uParam0->f_5390), "MPATM_CARET_");
	iVar1 = 0;
	StringCopy(&Var2, "MPATMLOGVAL", 16);
	start_save_array_with_size(&(uParam0->f_5390.f_1), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar3 = { Var2 };
		StringIntConCat(&cVar3, iVar1, 16);
		register_int_to_save(&(uParam0->f_5390.f_1[iVar1]), &cVar3);
		iVar1++;
	}
	stop_save_array();
	StringCopy(&Var2, "MPATMLOGSCRS", 16);
	start_save_array_with_size(&(uParam0->f_5390.f_18), 97, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar4 = { Var2 };
		StringIntConCat(&cVar4, iVar1, 16);
		_0x48F069265A0E4BEC(&(uParam0->f_5390.f_18[iVar1 /*6*/]), &cVar4);
		iVar1++;
	}
	stop_save_array();
	StringCopy(&Var2, "MPATMLOGACT", 16);
	start_save_array_with_size(&(uParam0->f_5390.f_115), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar5 = { Var2 };
		StringIntConCat(&cVar5, iVar1, 16);
		register_enum_to_save(&(uParam0->f_5390.f_115[iVar1]), &cVar5);
		iVar1++;
	}
	stop_save_array();
	StringCopy(&Var2, "MPATMLOGDAT", 16);
	start_save_array_with_size(&(uParam0->f_5390.f_132), 17, &Var2);
	iVar1 = 0;
	while (iVar1 < 16)
	{
		cVar6 = { Var2 };
		StringIntConCat(&cVar6, iVar1, 16);
		register_int_to_save(&(uParam0->f_5390.f_132[iVar1]), &cVar6);
		iVar1++;
	}
	stop_save_array();
	register_bool_to_save(&(uParam0->f_5390.f_149), "mpAnyVecBought");
	stop_save_struct();
}
...
void func_11(var uParam0, int iParam1)
{
	...
	start_save_struct_with_size(&(uParam0->f_5149), 241, &Var0);
	_register_int64_to_save(&(uParam0->f_5149), "BOUNTY_GAMERH64_1");
	_register_int64_to_save(&(uParam0->f_5149.f_1), "BOUNTY_GAMERH64_2");
	_register_int64_to_save(&(uParam0->f_5149.f_2), "BOUNTY_GAMERH64_3");
	_register_int64_to_save(&(uParam0->f_5149.f_3), "BOUNTY_GAMERH64_4");
	_register_int64_to_save(&(uParam0->f_5149.f_4), "BOUNTY_GAMERH64_5");
	_register_int64_to_save(&(uParam0->f_5149.f_5), "BOUNTY_GAMERH64_6");
	_register_int64_to_save(&(uParam0->f_5149.f_6), "BOUNTY_GAMERH64_7");
	_register_int64_to_save(&(uParam0->f_5149.f_7), "BOUNTY_GAMERH64_8");
	_register_int64_to_save(&(uParam0->f_5149.f_8), "BOUNTY_GAMERH64_9");
	_register_int64_to_save(&(uParam0->f_5149.f_9), "BOUNTY_GAMERH64_10");
	_register_int64_to_save(&(uParam0->f_5149.f_10), "BOUNTY_GAMERH64_11");
	_register_int64_to_save(&(uParam0->f_5149.f_11), "BOUNTY_GAMERH64_12");
	_register_int64_to_save(&(uParam0->f_5149.f_12), "BOUNTY_GAMERH64_13");
	register_int_to_save(&(uParam0->f_5149.f_13), "BOUNTY_TIME");
	register_int_to_save(&(uParam0->f_5149.f_14), "BOUNTY_VALUE");
	StringConCat(&Var0, "_GH", 24);
	start_save_array_with_size(&(uParam0->f_5149.f_15), 209, &Var0);
	iVar2 = 0;
	while (iVar2 < 16)
	{
		...
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/]), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_2", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_1), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_3", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_2), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_4", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_3), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_5", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_4), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_6", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_5), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_7", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_6), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_8", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_7), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_9", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_8), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_10", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_9), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_11", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_10), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_12", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_11), &cVar1);
		MemCopy(&cVar1, {Var0}, 8);
		StringConCat(&cVar1, "64_", 32);
		StringIntConCat(&cVar1, iVar2, 32);
		StringConCat(&cVar1, "_13", 32);
		_register_int64_to_save(&(uParam0->f_5149.f_15[iVar2 /*13*/].f_12), &cVar1);
		iVar2++;
	}
	stop_save_array();
	StringCopy(&Var0, "MP_BOUNTY_SAVED", 24);
	...
	start_save_array_with_size(&(uParam0->f_5149.f_224), 17, &Var0);
	iVar2 = 0;
	while (iVar2 < 16)
	{
		MemCopy(&cVar1, {Var0}, 8);
		StringIntConCat(&cVar1, iVar2, 32);
		register_int_to_save(&(uParam0->f_5149.f_224[iVar2]), &cVar1);
		iVar2++;
	}
	stop_save_array();
	stop_save_struct();
...
void func_13(var* uParam0, char* sParam1)
{
	...
	start_save_struct_with_size(uParam0, 4468, sParam1);
	...
	start_save_array_with_size(&(uParam0->f_40), 7, "CLOTHES");
	iVar0 = 0;
	while (iVar0 < uParam0->f_40)
	{
		StringCopy(&Var1, "CLOTHES", 16);
		StringIntConCat(&Var1, iVar0, 16);
		register_int_to_save(&(uParam0->f_40[iVar0]), &Var1);
		iVar0++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_47), 1225, "CARMODS");
	iVar0 = 0;
	while (iVar0 < uParam0->f_47)
	{
		StringCopy(&Var1, "CARMODS", 16);
		StringIntConCat(&Var1, iVar0, 16);
		register_int_to_save(&(uParam0->f_47[iVar0]), &Var1);
		iVar0++;
	}
	stop_save_array();
	register_int_to_save(&(uParam0->f_1272), "iLastCrewCharWasIn");
	register_int_to_save(&(uParam0->f_1273), "iStripperUnlockedBS");
	register_int_to_save(&(uParam0->f_1274), "iGeneralBS");
	register_int_to_save(&(uParam0->f_1275), "iCarsModifiedTimeStamp");
	start_save_array_with_size(&(uParam0->f_1276), 10, "GOLF_fLongestDriveHole");
	iVar2 = 0;
	while (iVar2 < uParam0->f_1276)
	{
		StringCopy(&cVar3, "fLongestDriveHole_", 64);
		StringIntConCat(&cVar3, iVar2, 64);
		register_float_to_save(&(uParam0->f_1276[iVar2]), &cVar3);
		iVar2++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_1286), 10, "GOLF_fLongestPuttHole");
	iVar2 = 0;
	while (iVar2 < uParam0->f_1286)
	{
		StringCopy(&cVar3, "fLongestPuttHole_", 64);
		StringIntConCat(&cVar3, iVar2, 64);
		register_float_to_save(&(uParam0->f_1286[iVar2]), &cVar3);
		iVar2++;
	}
	stop_save_array();
	register_int_to_save(&(uParam0->f_1296), "GOLF_iBestRound");
	register_float_to_save(&(uParam0->f_1297), "GOLF_fLongestDrive");
	register_float_to_save(&(uParam0->f_1298), "GOLF_fLongestPutt");
	register_int_to_save(&(uParam0->f_1299), "iShareLJCashTotal");
	register_int_to_save(&(uParam0->f_1300), "iShareLJCashTime");
	register_int_to_save(&(uParam0->f_1301), "iReceiveLJCashTotal");
	register_int_to_save(&(uParam0->f_1302), "iReceiveLJCashTime");
	register_int_to_save(&(uParam0->f_1303), "LAST_ACC_PROP");
	register_int_to_save(&(uParam0->f_1304), "MULTI1_PROP_VAL");
	register_int_to_save(&(uParam0->f_1333), "LAST_ACC_SMPLINT");
	start_save_array_with_size(&(uParam0->f_1305), 28, "PROP_ARY_VAL");
	iVar4 = 0;
	while (iVar4 < uParam0->f_1305)
	{
		StringCopy(&Var1, "PROP_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_1305[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	register_int_to_save(&(uParam0->f_1334), "KR_PATCH_UPDATE");
	iVar4 = 0;
	start_save_array_with_size(&(uParam0->f_2690), 919, "DLC_MODS");
	iVar4 = 0;
	while (iVar4 < uParam0->f_2690)
	{
		StringCopy(&Var1, "DLC_MODS_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_2690[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	iVar4 = 0;
	start_save_array_with_size(&(uParam0->f_3609), 627, "DLC_SUPERMODS");
	iVar4 = 0;
	while (iVar4 < uParam0->f_3609)
	{
		StringCopy(&Var1, "DLC_SMODS_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_3609[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_1335), 274, "OUTFIT_CompDraw");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringIntConCat(&Var1, iVar4, 16);
		start_save_array_with_size(&(uParam0->f_1335[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompDraw", 16);
			...
			register_int_to_save(&(uParam0->f_1335[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		stop_save_array();
		iVar4++;
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_1609), 274, "OUTFIT_CompTex");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		start_save_array_with_size(&(uParam0->f_1609[iVar4 /*13*/]), 13, &Var1);
		iVar5 = 0;
		while (iVar5 < 12)
		{
			StringCopy(&Var1, "CompTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			register_int_to_save(&(uParam0->f_1609[iVar4 /*13*/][iVar5]), &Var1);
			iVar5++;
		}
		stop_save_array();
		iVar4++;
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_1883), 211, "OUTFIT_PropID");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		start_save_array_with_size(&(uParam0->f_1883[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropID", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			register_int_to_save(&(uParam0->f_1883[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		stop_save_array();
		iVar4++;
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2094), 211, "OUTFIT_PropTex");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		start_save_array_with_size(&(uParam0->f_2094[iVar4 /*10*/]), 10, &Var1);
		iVar5 = 0;
		while (iVar5 < 9)
		{
			StringCopy(&Var1, "PropTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar5, 16);
			register_int_to_save(&(uParam0->f_2094[iVar4 /*10*/][iVar5]), &Var1);
			iVar5++;
		}
		stop_save_array();
		iVar4++;
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2305), 22, "OUTFIT_Stored");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2305[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2327), 22, "OUTFIT_CrewTatA");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2327[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2349), 22, "OUTFIT_CrewTatB");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2349[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2371), 22, "OUTFIT_CrewTatC");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2371[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2393), 22, "OUTFIT_CrewTatD");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2393[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2415), 22, "OUTFIT_CrewTatE");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2415[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2437), 22, "OUTFIT_CrewTatF");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_2437[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2628), 22, "OUTFIT_Shirt");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_2628[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2459), 169, "OUTFIT_Name");
	iVar4 = 0;
	while (iVar4 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		_0x8269816F6CFD40F8(&(uParam0->f_2459[iVar4 /*8*/]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_2650), 40, "LAST_JobGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/]), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_2", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_1), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_3", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_2), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_4", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_3), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_5", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_4), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_6", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_5), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_7", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_6), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_8", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_7), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_9", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_8), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_10", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_9), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_11", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_10), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_12", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_11), &cVar6);
		cVar6 = { Var1 };
		StringConCat(&cVar6, "_13", 16);
		_register_int64_to_save(&(uParam0->f_2650[iVar4 /*13*/].f_12), &cVar6);
		iVar4++;
	}
	stop_save_array();
	register_bool_to_save(&(uParam0->f_4236), "DO_CompletedObjectives");
	register_bool_to_save(&(uParam0->f_4237), "DO_LoggedInToday");
	register_int_to_save(&(uParam0->f_4238), "DO_xValue");
	register_int_to_save(&(uParam0->f_4239), "DO_LastHistoryLength");
	register_int_to_save(&(uParam0->f_4240), "DO_LastResetTime");
	start_save_array_with_size(&(uParam0->f_4241), 10, "DO_Objectives");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_4241[iVar4 /*3*/]), &Var1);
		StringCopy(&Var1, "Completed", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_bool_to_save(&(uParam0->f_4241[iVar4 /*3*/].f_1), &Var1);
		StringCopy(&Var1, "Initial", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_4241[iVar4 /*3*/].f_2), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4251), 25, "DO_History");
	iVar4 = 0;
	while (iVar4 < 24)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar4, 16);
		register_int_to_save(&(uParam0->f_4251[iVar4]), &Var1);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4276), 49, "LAST_JobGamer_TL");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		_0xFAA457EF263E8763(&(uParam0->f_4276[iVar4 /*16*/]), &cVar7);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4325), 11, "BGSAVEINT");
	iVar0 = 0;
	while (iVar0 < 10)
	{
		StringCopy(&Var1, "BGSAVEINT", 16);
		StringIntConCat(&Var1, iVar0, 16);
		register_int_to_save(&(uParam0->f_4325[iVar0]), &Var1);
		iVar0++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4336), 3, "PROPLIB");
	iVar0 = 0;
	while (iVar0 < uParam0->f_4336)
	{
		StringCopy(&Var1, "PROPLIB", 16);
		StringIntConCat(&Var1, iVar0, 16);
		register_int_to_save(&(uParam0->f_4336[iVar0]), &Var1);
		iVar0++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4339), 40, "LAST_GOGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/]), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_2", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_1), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_3", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_2), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_4", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_3), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_5", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_4), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_6", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_5), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_7", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_6), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_8", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_7), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_9", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_8), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_10", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_9), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_11", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_10), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_12", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_11), &cVar8);
		cVar8 = { Var1 };
		StringConCat(&cVar8, "_13", 16);
		_register_int64_to_save(&(uParam0->f_4339[iVar4 /*13*/].f_12), &cVar8);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4379), 40, "LAST_GOJobGamer");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/]), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_2", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_1), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_3", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_2), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_4", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_3), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_5", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_4), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_6", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_5), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_7", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_6), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_8", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_7), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_9", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_8), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_10", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_9), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_11", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_10), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_12", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_11), &cVar9);
		cVar9 = { Var1 };
		StringConCat(&cVar9, "_13", 16);
		_register_int64_to_save(&(uParam0->f_4379[iVar4 /*13*/].f_12), &cVar9);
		iVar4++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_4419), 49, "LAST_GOJobGamer_TL");
	iVar4 = 0;
	while (iVar4 < 3)
	{
		...
		_0xFAA457EF263E8763(&(uParam0->f_4419[iVar4 /*16*/]), &cVar10);
		iVar4++;
	}
	stop_save_array();
	stop_save_array();
...
void func_15(var* uParam0, int iParam1)
{
	...
	start_save_array_with_size(&(uParam0->f_41), 11, "CAR_HIDDEN");
	iVar1 = 0;
	while (iVar1 < 10)
	{
		StringCopy(&cVar0, "CAR_HIDDEN", 64);
		StringIntConCat(&cVar0, iVar1, 64);
		register_bool_to_save(&(uParam0->f_41[iVar1]), &cVar0);
		iVar1++;
	}
	stop_save_array();
	...
	register_bool_to_save(&(uParam0->f_52), &cVar0);
	StringCopy(&cVar0, "bMultiplayerDataWiped", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_bool_to_save(&(uParam0->f_53), &cVar0);
	StringCopy(&cVar0, "bCarAppPlateSet", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_bool_to_save(&(uParam0->f_55), &cVar0);
	StringCopy(&cVar0, "bDeleteCarData", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_bool_to_save(&(uParam0->f_54), &cVar0);
	StringCopy(&cVar0, "iCarAppPlateBack", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_int_to_save(&(uParam0->f_60), &cVar0);
	StringCopy(&cVar0, "tlCarAppPlateText", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	_register_text_label_to_save_2(&(uParam0->f_56), &cVar0);
	StringCopy(&cVar0, "iOrderCount", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_int_to_save(&(uParam0->f_61), &cVar0);
	StringCopy(&cVar0, "iOrderVehicle", 64);
	StringIntConCat(&cVar0, iParam1, 64);
	register_int_to_save(&(uParam0->f_62), &cVar0);
	start_save_array_with_size(&(uParam0->f_63), 11, "SAVED_VEH_SLOT");
	iVar1 = 0;
	while (iVar1 < 10)
	{
		StringCopy(&cVar0, "VEH_SLOT", 64);
		StringIntConCat(&cVar0, iVar1, 64);
		register_int_to_save(&(uParam0->f_63[iVar1]), &cVar0);
		iVar1++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_74), 11, "SAVED_VEH_PRIO");
	iVar1 = 0;
	while (iVar1 < 10)
	{
		StringCopy(&cVar0, "VEH_PRIO", 64);
		StringIntConCat(&cVar0, iVar1, 64);
		register_int_to_save(&(uParam0->f_74[iVar1]), &cVar0);
		iVar1++;
	}
	stop_save_array();
	register_int_to_save(&(uParam0->f_85), "LAST_USED");
	register_int_to_save(&(uParam0->f_86), "NEW_SAVED");
	register_bool_to_save(&(uParam0->f_87), "SETUP_INIT");
}

void func_16(var* uParam0, char* sParam1)
{
	start_save_struct_with_size(uParam0, 41, sParam1);
...
void func_18(var* uParam0, char* sParam1)
{
	...
	start_save_struct_with_size(uParam0, 586, sParam1);
	register_bool_to_save(uParam0, "TV_ON");
	register_int_to_save(&(uParam0->f_1), "TV_CHANNEL_ID");
	register_bool_to_save(&(uParam0->f_2), "PENTHOUSE_TV_ON");
	register_int_to_save(&(uParam0->f_3), "PENTHOUSE_TV_CHANNEL_ID");
	register_bool_to_save(&(uParam0->f_4), "MEDIA_ROOM_TV_ON");
	register_int_to_save(&(uParam0->f_5), "MEDIA_ROOM_TV_CHANNEL_ID");
	start_save_array_with_size(&(uParam0->f_6), 3, "RADIO_ON");
	iVar0 = 0;
	while (iVar0 < 2)
	{
		StringCopy(&cVar1, "RADIO_ON_ID", 16);
		StringIntConCat(&cVar1, iVar0, 16);
		register_bool_to_save(&(uParam0->f_6[iVar0]), &cVar1);
		iVar0++;
	}
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_9), 3, "RADIO_STATION");
	iVar0 = 0;
	while (iVar0 < 2)
	{
	...
	stop_save_array();
	register_bool_to_save(&(uParam0->f_12), "GARAGE_TV_ON");
	register_int_to_save(&(uParam0->f_13), "GARAGE_TV_CHANNEL_ID");
	register_bool_to_save(&(uParam0->f_14), "GARAGE_RADIO_ON");
	register_int_to_save(&(uParam0->f_15), "GARAGE_RADIO_STATION_ID");
	register_int_to_save(&(uParam0->f_16), "NUMBERS_TIMES_SMOKED");
	register_int_to_save(&(uParam0->f_17), "NUMBER_TIMES_DRANK");
	register_int_to_save(&(uParam0->f_18), "NUMBER_TIMES_STRIPPERS");
	register_int_to_save(&(uParam0->f_19), "NUMBERS_TIMES_SMOKED_SECOND");
	register_int_to_save(&(uParam0->f_20), "NUMBER_TIMES_DRANK_SECOND");
	register_int_to_save(&(uParam0->f_21), "NUMBER_TIMES_STRIPPERS_SECOND");
	register_int_to_save(&(uParam0->f_22), "NUMBERS_TIMES_SMOKED3");
	register_int_to_save(&(uParam0->f_23), "NUMBER_TIMES_DRANK3");
	register_int_to_save(&(uParam0->f_24), "NUMBER_TIMES_STRIPPERS3");
	register_int_to_save(&(uParam0->f_25), "NUMBERS_TIMES_SMOKED4");
	register_int_to_save(&(uParam0->f_26), "NUMBER_TIMES_DRANK4");
	register_int_to_save(&(uParam0->f_27), "NUMBER_TIMES_STRIPPERS4");
	register_int_to_save(&(uParam0->f_28), "NUMBERS_TIMES_SMOKED5");
	register_int_to_save(&(uParam0->f_29), "NUMBER_TIMES_DRANK5");
	register_int_to_save(&(uParam0->f_30), "NUMBER_TIMES_STRIPPERS5");
	register_int_to_save(&(uParam0->f_31), "NUMBERS_TIMES_SMOKEDYacht");
	register_int_to_save(&(uParam0->f_32), "NUMBER_TIMES_DRANKYacht");
	register_int_to_save(&(uParam0->f_33), "NUMBER_TIMES_STRIPPERSYacht");
	register_enum_to_save(&(uParam0->f_34), "DATE_LAST_CLEANED_APARTMENT");
	register_enum_to_save(&(uParam0->f_35), "SHOWERS_TAKEN");
	start_save_array_with_size(&(uParam0->f_36), 23, "PROP_DRINKS");
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_59), 23, "PROP_SMOKES");
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_82), 23, "PROP_STRIPPERS");
	StringCopy(&cVar1, "STRIPPERS_", 16);
	iVar0 = 0;
	while (iVar0 < 5)
	{
		StringIntConCat(&cVar1, iVar0 + 5, 16);
		register_int_to_save(&(uParam0->f_82[iVar0]), &cVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 17)
	...
	stop_save_array();
	start_save_array_with_size(&(uParam0->f_105), 481, "PROP_NAMEDVEHS");
	iVar0 = 0;
	while (iVar0 < 30)
	{
		StringCopy(&cVar1, "NAMEDVEH_", 16);
		StringIntConCat(&cVar1, iVar0, 16);
		_0xFAA457EF263E8763(&(uParam0->f_105[iVar0 /*16*/]), &cVar1);
		iVar0++;
	}
	stop_save_array();
	stop_save_array();
...
void func_20(var* uParam0, char* sParam1)
{
	...
	start_save_struct_with_size(uParam0, 7, sParam1);
	register_int_to_save(uParam0, "BAV_Timestamp");
	start_save_array_with_size(&(uParam0->f_1), 6, "B_A_V_BS_ID");
	iVar0 = 0;
	while (iVar0 < 5)
	{
...
void func_24()
{
	...
	while (bVar0 < 3)
	{
		...
		while (iVar1 <= 198)
		{
			...
			{
				clear_bit(&(Global_113386.f_25182[iVar1]), bVar0);
				iVar2 = (iVar1 + (198 - 171)) + 1;
				set_bit(&(Global_113386.f_25182[iVar2]), bVar0);
			}
			iVar1++;
		}
		bVar0++;
...
void func_25()
{
	...
	{
		set_bit(&(Global_113386.f_10016.f_25), 6);
	}
}
...
void func_32(int iParam0, int iParam1)
{
	...
	while (!has_script_with_name_hash_loaded(iParam0))
	{
		wait(0);
		request_script_with_name_hash(iParam0);
	}
...
void func_33()
{
	...
	_0x7E2BD3EF6C205F09("phone_cam1", true);
	_0x7E2BD3EF6C205F09("phone_cam2", true);
	_0x7E2BD3EF6C205F09("phone_cam3", true);
	_0x7E2BD3EF6C205F09("phone_cam4", true);
	_0x7E2BD3EF6C205F09("phone_cam5", true);
	_0x7E2BD3EF6C205F09("phone_cam6", true);
	_0x7E2BD3EF6C205F09("phone_cam7", true);
	_0x7E2BD3EF6C205F09("phone_cam9", true);
	_0x7E2BD3EF6C205F09("phone_cam12", false);
}
...
void func_59(struct<4> Param0, var uParam1, var uParam2, struct<6> Param3, struct<4> Param4, var uParam5, var uParam6, var uParam7)
{
	...
	*uParam7 = { _get_object_offset_from_coords(Param4, 0f, Var0) };
...
int func_67(int iParam0)
{
	...
	if (network_is_game_in_progress() && func_76())
	{
		iVar0 = 0;
		bVar1 = false;
		if (func_73(iParam0))
		...
		if (_net_gameserver_catalog_item_exists_hash(iVar3))
		{
			iVar4 = net_gameserver_get_price(iVar3, 426439576, true);
	...
	while (!bVar1)
	{
		...
		while (bVar0 < 13)
		{
			if (!BitTest(uVar2, bVar0))
			{
				...
				if (has_script_with_name_hash_loaded(iVar3) && func_79(bVar0, uVar2))
				{
					start_new_script_with_name_hash(iVar3, 1424);
					set_script_with_name_hash_as_no_longer_needed(iVar3);
					set_bit(&uVar2, bVar0);
					if (func_78(bVar0))
					{
						bVar1 = false;
...
int func_81()
{
	if (((_loadingscreen_get_load_freemode() || _0xF2CA003F167E21D2()) || _0x88B588B41FF7868E()) || _0x67FC09BC554A75E5())
	{
		return 1;
	}
	return 0;
...
void func_82(int iParam0)
{
	...
	while (iVar0 < 13)
	{
		request_script_with_name_hash(func_80(iVar0));
		iVar0++;
	}
	switch (iParam0)
	{
		case 0:
			request_script_with_name_hash(joaat("standard_global_reg"));
			request_script_with_name_hash(joaat("standard_global_init"));
			break;
	}
}
