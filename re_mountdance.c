...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (is_entity_dead(iLocal_91, false) && !iLocal_95 == 7)
			{
		...
		{
			case 0:
				if ((is_world_point_within_brain_activation_range() && !func_34()) && !func_12())
				{
					if (func_11())
					{
						iLocal_91 = create_ped(26, iLocal_88, Local_89, fLocal_90, true, true);
						set_blocking_of_non_temporary_events(iLocal_91, true);
						iLocal_92 = create_object(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, true, true, false);
						set_entity_heading(iLocal_92, (233.8288f + 180f));
						set_ped_prop_index(iLocal_91, 0, 0, 0, false);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = create_synchronized_scene(Local_89 + Vector(1f, 0f, 0f), 0f, 0f, fLocal_90, 2);
				task_synchronized_scene(iLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1000f, 0);
				_set_synchronized_audio_event_position_this_frame("MNT_DNC", iLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (prepare_synchronized_audio_event_for_scene(iLocal_97, "MNT_DNC") == 1)
				{
					play_synchronized_audio_event(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				Var0 = { get_entity_coords(iLocal_91, true) };
				set_ped_lod_multiplier(iLocal_91, 3f);
				if (func_10(player_ped_id(), iLocal_91) < 10f)
				{
					set_ik_target(player_ped_id(), 1, iLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					set_ik_target(iLocal_91, 1, player_ped_id(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(iLocal_91, player_ped_id(), 1) < 25f)
				{
					if (!does_blip_exist(iLocal_96))
					{
						func_5(&iLocal_96, &iLocal_91, 0);
						set_blip_colour(iLocal_96, 3);
					}
				}
				else if (does_blip_exist(iLocal_96))
				{
					func_4(&iLocal_96);
				}
				if (get_synchronized_scene_phase(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (is_ped_ragdoll(iLocal_91))
				{
					stop_synchronized_audio_event(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((is_ped_injured(iLocal_91) || is_bullet_in_area(Var0, 50f, true)) || is_bullet_in_area(Var0, 50f, false)) || is_projectile_in_area(Var0, 20f, 20f, 20f, false)) || is_explosion_in_sphere(-1, Var0, 50f)) || (((is_player_free_aiming_at_entity(player_id(), iLocal_91) || is_player_targetting_entity(player_id(), iLocal_91)) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), Var0, true) < 25f) && func_1(iLocal_91, player_ped_id(), 1126825984, 0)))
				{
					stop_synchronized_audio_event(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!is_ped_ragdoll(iLocal_91))
				{
					if (iLocal_93 == 1)
					{
						task_follow_nav_mesh_to_coord(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 40000f);
					}
					else
					{
						task_follow_nav_mesh_to_coord(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 40000f);
					}
					set_ped_keep_task(iLocal_91, true);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (get_script_task_status(iLocal_91, 713668775) != 1 && get_script_task_status(iLocal_91, 713668775) != 0)
				{
					set_blocking_of_non_temporary_events(iLocal_91, false);
					if (iLocal_93 == 1)
					{
						task_smart_flee_ped(iLocal_91, player_ped_id(), 100f, -1, false, false);
					}
					else
					{
						task_wander_standard(iLocal_91, 40000f, 0);
					}
					set_ped_keep_task(iLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((is_entity_occluded(iLocal_91) && get_distance_between_coords(get_entity_coords(iLocal_91, true), get_entity_coords(player_ped_id(), true), true) > 50f) && !is_world_point_within_brain_activation_range())
				{
					func_37(1);
				}
				break;
...
int func_1(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_3(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_3(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_11()
{
	...
	request_anim_dict(sLocal_94);
	if (has_model_loaded(iLocal_88) && has_anim_dict_loaded(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()
{
	...
	{
		if (vmag2(get_entity_velocity(player_ped_id())) > 1369f && !func_27())
		{
			return 0;
		}
	}
...
void func_37(bool bParam0)
{
	...
	if (does_entity_exist(iLocal_91))
	{
		if (bParam0)
		{
			delete_ped(&iLocal_91);
		}
		else
		{
			set_ped_as_no_longer_needed(&iLocal_91);
		}
	}
