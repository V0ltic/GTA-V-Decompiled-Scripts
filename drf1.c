...
void __EntryFunction__()
{
	...
	if (has_force_cleanup_occurred(67))
	{
		...
		if (bVar13)
		{
			if (does_entity_exist(iLocal_380) && is_ped_injured(iLocal_380))
			{
				func_270(80, 1);
				stat_set_bool(joaat("sp_killed_dr_friedlander"), true, true);
			}
			func_268(0, 0);
		}
		else
	...
	stop_fire_in_range(-1899.756f, -561.3688f, 10.78784f, 100f);
	...
	if (!is_player_dead(player_id()) && !is_ped_injured(player_ped_id()))
	{
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				if (func_250())
				{
					give_weapon_to_ped(player_ped_id(), joaat("weapon_unarmed"), -1, false, true);
				}
				...
				task_follow_nav_mesh_to_coord(player_ped_id(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 0.25f, false, 40000f);
				iVar8 = create_camera_with_params(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, false, 2);
				iVar9 = create_camera_with_params(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, false, 2);
				set_cam_active_with_interp(iVar9, iVar8, 5000, 1, 1);
			...
			case 1:
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (can_request_assets_for_cutscene_entity())
						{
							...
							{
								func_137(&Local_387, player_ped_id(), 0, 2);
							}
				...
				{
					if (!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_379, false))
					{
						register_entity_for_cutscene(player_ped_id(), &Local_387, 0, 0, 0);
						register_entity_for_cutscene(iLocal_379, &Local_391, 0, 0, 0);
					}
					start_cutscene(0);
					play_stream_frontend();
					new_load_scene_stop();
					new_load_scene_start(-1906.842f, -572.3835f, 19.1046f, -1.5254f, 0.0003f, 171.4657f, 12f, 0);
					func_133(&iLocal_228);
					func_133(&iVar6);
					iLocal_60 = 2;
				}
			...
			case 2:
				if (does_cam_exist(iVar8))
				{
					destroy_cam(iVar8, false);
				}
				if (does_cam_exist(iVar9))
				{
					destroy_cam(iVar9, false);
				}
				if (can_set_exit_state_for_registered_entity(&Local_387, 0))
				{
					func_132(iLocal_379, 1, 0);
				}
				if (can_set_exit_state_for_registered_entity(&Local_391, 0))
				{
			...
			case 3:
				...
				if (is_screen_faded_out() || bVar14)
				{
					...
					while (is_new_load_scene_active() && !is_new_load_scene_loaded())
					{
						wait(0);
						func_120();
					}
				...
				if (!bVar2)
				{
					if (!bLocal_407 && !is_cutscene_active())
					{
						Local_61.f_20 = 0;
				...
				else if ((func_135(&iLocal_231) > 5f && func_134()) || (has_cutscene_loaded() && ((Local_61.f_20 != 1 || func_135(&iLocal_231) > fVar12) || func_93(iLocal_62, iLocal_379, &iLocal_384))))
				{
					func_90();
					if (!is_entity_dead(player_ped_id(), false))
					{
			...
			case 14:
				if (does_cam_exist(iLocal_384))
				{
					render_script_cams(false, false, 3000, true, false, 0);
					destroy_cam(iLocal_384, false);
				}
				if (((func_89() && is_cutscene_playing()) && !is_screen_fading_out()) && !is_screen_faded_out())
				{
					stop_cutscene(false);
				}
				if (can_set_exit_state_for_camera(false))
				{
					...
					else
					{
						...
						if (!is_entity_dead(player_ped_id(), false))
						{
							...
							set_entity_collision(player_ped_id(), true, false);
							freeze_entity_position(player_ped_id(), false);
							func_86(player_ped_id(), -1902.609f, -559.9267f, 10.7916f);
							set_entity_heading(player_ped_id(), fLocal_398);
							set_gameplay_cam_relative_heading(0f);
							set_gameplay_cam_relative_pitch(0f, 1f);
							func_78(0, 1, 1, 0, 0, 0, 0);
							iLocal_382 = get_players_last_vehicle();
							if (does_entity_exist(iLocal_382))
							{
								if (!is_entity_dead(iLocal_382, false))
								{
									set_entity_coords(iLocal_382, func_77(iLocal_382), true, false, false, true);
									set_entity_heading(iLocal_382, 231f);
								}
							}
							if (is_screen_faded_out())
							{
								if (!iLocal_408)
								{
									new_load_scene_start(-1903.87f, -562.9188f, 12.8354f, func_76(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_408 = 1;
									wait(0);
								}
								if (!iLocal_409)
				...
				else
				{
					if (!iLocal_408)
					{
						if (get_cutscene_time() > 60000)
						{
							if (iLocal_62 == 4)
							{
								new_load_scene_start(-1905.5f, -557.8768f, 12.4125f, func_76(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								new_load_scene_start(-1903.87f, -562.9188f, 12.8354f, func_76(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_409)
					{
						if (_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_135(&iVar7) > func_74(func_252()))
							{
								if (func_252() == 4)
								{
									iLocal_380 = create_ped(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, true, true);
									set_ped_component_variation(iLocal_380, 3, iLocal_404, iLocal_405, 0);
									set_ped_component_variation(iLocal_380, 4, 0, iLocal_406, 0);
									set_ped_money(iLocal_380, (2000 + get_random_int_in_range(5, 301)));
									set_entity_load_collision_flag(iLocal_380, true, 1);
			...
			case 15:
				...
				if (is_entity_dead(iLocal_380, false))
				{
					...
					if (does_blip_exist(iLocal_383))
					{
						set_blip_colour(iLocal_383, 1);
					}
					iLocal_60 = 17;
				}
				else if (!does_entity_exist(iLocal_380) || func_72(iLocal_380, player_ped_id(), 1) > 300f)
				{
					func_96(&uLocal_63, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (does_blip_exist(iLocal_383))
					{
						set_blip_colour(iLocal_383, 3);
					}
					if (does_entity_exist(iLocal_380))
					{
						clear_area_of_projectiles(get_entity_coords(iLocal_380, true), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_55();
					set_ped_config_flag(iLocal_380, 26, true);
					if (func_75(&iLocal_246))
					{
						if (func_135(&iLocal_246) > 2.5f)
						{
							simulate_player_input_gait(player_id(), 2f, 1000, 0f, true, false);
							set_player_control(player_id(), false, 0);
							func_133(&iLocal_246);
						}
					}
					if (!iLocal_411)
					{
						...
						if (func_135(&iLocal_243) > 2f)
						{
							...
							iLocal_384 = create_camera_with_params(26379945, Var16, Var17, 50f, false, 2);
							set_cam_active_with_interp(iLocal_384, iLocal_385, 2660, 1, 1);
							if (does_entity_exist(iLocal_382) && !is_entity_dead(iLocal_382, false))
							{
								set_vehicle_fixed(iLocal_382);
								set_entity_invincible(iLocal_382, false);
								set_vehicle_can_break(iLocal_382, true);
							}
							func_119(&iLocal_243);
							iLocal_411 = 1;
						}
					...
					else if (does_cam_exist(iLocal_385))
					{
						if (func_135(&iLocal_243) >= 2.66f)
						{
							set_gameplay_cam_relative_heading(func_54(get_follow_ped_cam_view_mode() == 2, -16f, 0f));
							render_script_cams(false, true, 340, false, false, 0);
					...
					if (iLocal_410 && is_player_control_on(player_id()))
					{
						if (func_52(&iLocal_237, 0.5f))
						{
							...
							if (!does_blip_exist(iLocal_383))
							{
								if (!is_entity_dead(iLocal_380, false))
								{
									iLocal_383 = add_blip_for_entity(iLocal_380);
									set_blip_colour(iLocal_383, 1);
									func_119(&iLocal_237);
								}
							}
							else if (get_blip_colour(iLocal_383) != 3)
							{
								set_blip_colour(iLocal_383, 3);
					...
					if (!is_ped_injured(iLocal_380))
					{
						if (does_entity_exist(iLocal_381))
						{
							if (is_ped_in_any_vehicle(iLocal_380, false))
							{
								iVar0 = 1;
							}
							if (!is_ped_fleeing(iLocal_380))
							{
								if ((((((((!is_vehicle_driveable(iLocal_381, false) || is_ped_in_vehicle(player_ped_id(), iLocal_381, true)) || is_vehicle_stuck_timer_up(iLocal_381, 0, 2000)) || is_vehicle_stuck_timer_up(iLocal_381, 1, 2000)) || is_vehicle_stuck_timer_up(iLocal_381, 2, 2000)) || is_vehicle_stuck_timer_up(iLocal_381, 3, 2000)) || (iVar0 && !is_ped_in_any_vehicle(iLocal_380, false))) || func_48(iLocal_381)) || func_44(iLocal_381))
								{
									task_smart_flee_ped(iLocal_380, player_ped_id(), 3000f, -1, false, false);
								}
							}
						}
						else if (!is_ped_fleeing(iLocal_380))
						{
							task_smart_flee_ped(iLocal_380, player_ped_id(), 3000f, -1, false, false);
						}
						if (!bVar15 && !is_entity_in_angled_area(iLocal_380, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, false, true, 0))
						{
			...
			case 17:
				...
				if (func_135(&iLocal_234) > 4f || is_screen_faded_out())
				{
					remove_blip(&iLocal_383);
					if (does_cam_exist(iLocal_384))
					{
						destroy_cam(iLocal_384, false);
					}
					...
					if (!func_1(80))
					{
						if (does_entity_exist(iLocal_380))
						{
							if (does_entity_exist(iLocal_381) && is_ped_in_vehicle(iLocal_380, iLocal_381, false))
							{
								delete_vehicle(&iLocal_381);
							}
						}
						delete_ped(&iLocal_380);
					}
...
void func_6(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_8() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_8() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_7(bParam0));
...
void func_39()
{
	...
	{
		if (func_42(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
int func_44(int iParam0)
{
	...
	if ((func_47(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), false)) && func_45(iParam0))
	{
...
void func_55()
{
	...
	if ((!does_entity_exist(iLocal_380) || is_entity_dead(iLocal_380, false)) || is_entity_dead(player_ped_id(), false))
	{
		return;
	}
	...
	fVar3 = vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_380, true));
	if (iLocal_401 < 7)
	{
		if (iLocal_401 <= 0)
		{
			...
			{
				bVar1 = get_random_int_in_range(0, 7);
				set_bit(&uLocal_400, bVar1);
		...
		{
			if (fVar3 <= 144f && !is_scripted_speech_playing(player_ped_id()))
			{
				bVar1 = get_random_int_in_range(0, (7 - iLocal_401));
	...
	if (iLocal_403 < 8)
	{
		if (iLocal_403 <= 0)
		{
			if (func_135(&iLocal_252) > 1f && !is_scripted_speech_playing(iLocal_380))
			{
				bVar1 = get_random_int_in_range(0, 8);
				set_bit(&uLocal_402, bVar1);
		...
		{
			if (fVar3 <= 2500f && !is_scripted_speech_playing(iLocal_380))
			{
				bVar1 = get_random_int_in_range(0, (8 - iLocal_403));
				bVar2 = false;
				while (bVar2 >= 0)
				{
	...
	if (((!iLocal_410 && iLocal_401 >= 1) && iLocal_403 >= 1) && !is_message_being_displayed())
	{
		iLocal_410 = 1;
	}
}
...
Vector3 func_77(int iParam0)
{
	...
	get_entity_matrix(iParam0, &uVar0, &uVar1, &uVar2, &uVar3);
	get_model_dimensions(get_entity_model(iParam0), &uVar4, &Var5);
...
void func_78(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_82(player_id())) && !func_80(player_id(), 0)) && !func_79()) && !bParam4) && !bParam5)
			{
...
void func_88()
{
	...
	if (!is_vehicle_driveable(iLocal_381, false))
	{
		delete_vehicle(&iLocal_381);
		iLocal_381 = create_vehicle(iLocal_57, Local_396, fLocal_399, true, true, false);
		set_vehicle_colour_combination(iLocal_381, 6);
	}
	if (does_entity_exist(iLocal_379))
	{
		delete_ped(&iLocal_379);
	}
	if ((!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_381, false)) && is_vehicle_driveable(iLocal_381, false))
	{
		set_entity_coords(player_ped_id(), -1907.827f, -560.0641f, 10.8064f, true, false, false, true);
		set_entity_heading(player_ped_id(), 260.195f);
		set_entity_coords(iLocal_381, Local_396, true, false, false, true);
		set_entity_heading(iLocal_381, fLocal_399);
		if (does_entity_exist(iLocal_382))
		{
			if (!is_entity_dead(iLocal_382, false))
			{
				set_vehicle_fixed(iLocal_382);
				set_entity_invincible(iLocal_382, true);
				set_vehicle_can_break(iLocal_382, false);
				set_entity_coords(iLocal_382, func_77(iLocal_382), true, false, false, true);
				set_entity_heading(iLocal_382, 231f);
			}
		}
		...
		if ((!iLocal_409 || !does_entity_exist(iLocal_380)) || is_entity_dead(iLocal_380, false))
		{
			iLocal_380 = create_ped(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, true, true);
			set_ped_component_variation(iLocal_380, 3, iLocal_404, iLocal_405, 0);
			set_ped_component_variation(iLocal_380, 4, 0, iLocal_406, 0);
		...
		{
			set_entity_coords(iLocal_380, -1899.7f, -562.2f, 10.7945f, true, false, false, true);
			set_entity_heading(iLocal_380, 217.9453f);
			clear_ped_tasks_immediately(iLocal_380);
			task_stand_still(iLocal_380, -1);
		}
		if (is_screen_faded_out())
		{
			if (!iLocal_408)
			{
				new_load_scene_start(-1905.5f, -557.8768f, 12.4125f, func_76(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_408 = 1;
				wait(0);
			}
			while (!is_new_load_scene_loaded() || (!is_ped_injured(iLocal_380) && !have_all_streaming_requests_completed(iLocal_380)))
			{
				wait(0);
			}
			if (!is_entity_dead(player_ped_id(), false))
		...
		fVar0 = 2f;
		if (!is_ped_injured(iLocal_380) && !is_entity_dead(iLocal_381, false))
		{
			open_sequence_task(&iLocal_386);
			task_enter_vehicle(0, iLocal_381, -1, -1, fVar0, 1, 0);
			task_vehicle_drive_to_coord(0, iLocal_381, -1783.73f, -629.1945f, 9.89f, 20f, 0, get_entity_model(iLocal_381), 786484, 10f, 12f);
			task_vehicle_drive_wander(0, iLocal_381, 19f, 786484);
			close_sequence_task(iLocal_386);
			task_perform_sequence(iLocal_380, iLocal_386);
			force_ped_motion_state(iLocal_380, joaat("MotionState_Run"), true, 1, true);
		}
		iLocal_383 = add_blip_for_entity(iLocal_380);
		set_blip_colour(iLocal_383, 1);
		func_119(&iLocal_237);
		set_gameplay_cam_relative_heading(0f);
		set_gameplay_cam_relative_pitch(0f, 1f);
		iLocal_385 = create_camera_with_params(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, true, 2);
		render_script_cams(true, false, 3000, true, false, 0);
		display_radar(false);
		display_hud(false);
	}
	clear_area(-1886.884f, -571.1942f, 11.3828f, 2.5f, true, true, false, false);
	create_vehicle(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, true, true, false);
}
...
int func_93(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_94())
	{
		if (!is_ped_injured(player_ped_id()) && !is_ped_injured(iParam1))
		{
			if (!is_entity_playing_anim(player_ped_id(), &cVar1, &Var3, 3))
			{
				task_play_anim(player_ped_id(), &cVar1, &Var3, 2f, -1000f, -1, iVar0, 0f, false, false, false);
				task_play_anim(iParam1, &cVar1, &cVar4, 2f, -1000f, -1, iVar0, 0f, false, false, false);
				task_play_anim(player_ped_id(), &cVar2, &cVar5, 2f, -1000f, -1, 32 | iVar0, 0f, false, 4, false);
				task_play_anim(iParam1, &cVar2, &cVar6, 2f, -1000f, -1, 32 | iVar0, 0f, false, false, false);
				force_ped_ai_and_animation_update(player_ped_id(), false, false);
				force_ped_ai_and_animation_update(iParam1, false, false);
				if (does_cam_exist(*iParam2))
				{
					destroy_cam(*iParam2, false);
				}
				if (!does_cam_exist(*iParam2))
				{
					*iParam2 = create_camera(26379945, false);
				}
				set_cam_coord(*iParam2, -1906.842f, -572.3835f, 19.1046f);
				set_cam_rot(*iParam2, -1.5254f, 0.0003f, 171.4657f, 2);
				set_cam_fov(*iParam2, 17f);
				set_cam_active(*iParam2, true);
				render_script_cams(true, false, 3000, true, false, 0);
			}
			else if (get_entity_anim_current_time(player_ped_id(), &cVar1, &Var3) >= 0.99f)
			{
				return 1;
			}
		}
...
bool func_94()
{
	return (has_anim_dict_loaded("missdrfriedlanderdrf_idles") && has_anim_dict_loaded("facials@drf"));
}
...
int func_97(int* iParam0, int* iParam1, var uParam2)
{
	...
	{
		bVar0 = is_control_just_pressed(2, 201);
		bVar1 = is_control_just_pressed(2, 202);
		if (bVar0 || bVar1)
		{
			if (bVar0)
			{
...
void func_98(int* iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_103(iParam0->f_1, 256) || (func_103(iParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			scaleform_movie_method_add_param_bool(func_103(iParam0->f_1, 4096));
			end_scaleform_movie_method();
		}
		iVar5 = 0;
		iVar6 = 0;
		while (iVar6 < iParam0->f_123)
		{
			...
			if (bVar4)
			{
				if (begin_scaleform_movie_method(*iParam0, "SET_DATA_SLOT"))
				{
					...
					if (!is_string_null_or_empty(iParam0->f_2[iVar6 /*15*/]))
					{
					...
					if (is_pc_version())
					{
						if (func_103(iParam0->f_1, 4096))
						{
							if (iParam0->f_2[iVar6 /*15*/].f_1)
							{
								...
								scaleform_movie_method_add_param_int(iParam0->f_2[iVar6 /*15*/].f_3[0 /*2*/].f_1);
							}
							else
							{
...
void func_107(char* sParam0, var uParam1, int iParam2)
{
	...
	iVar0 |= 98304;
	request_cutscene_with_playback_list(sParam0, iVar0, 8);
}
...
int func_108(var uParam0, int iParam1)
{
	...
	if (are_strings_equal(&Var1, "OBTSX01"))
	{
		return 8;
	}
	else if (are_strings_equal(&Var1, "OBTSX02"))
	{
		return 16;
	}
	else if (are_strings_equal(&Var1, "OBTSX03"))
	{
		return 32;
	}
	else if (are_strings_equal(&Var1, "OBTSX04"))
	{
		return 64;
	}
	else if (are_strings_equal(&Var1, "OBTSX05"))
	{
		return 128;
	}
	else if (are_strings_equal(&Var1, "OBTSX06"))
	{
		return 256;
	}
	else if (are_strings_equal(&Var1, "OBTSX07"))
	{
		return 512;
	}
	else if (are_strings_equal(&Var1, "OBTSX08"))
	{
		return 1024;
	}
	else if (are_strings_equal(&Var1, "OBTSX09"))
	{
		return 2048;
	}
	else if (are_strings_equal(&Var1, "OBTSX10"))
	{
		return 4096;
	}
	else if (are_strings_equal(&Var1, "OBTSX11"))
	{
		return 8192;
	}
	else if (are_strings_equal(&Var1, "OBTSX12"))
	{
		return 16384;
	}
	return 8;
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		iVar1 = get_random_int_in_range(1, 3);
	}
	else if (iParam3 <= 0 || iParam3 >= 13)
	{
		iVar1 = get_random_int_in_range(1, 4);
	}
	...
	{
		iVar1 = get_random_int_in_range(1, 6);
	}
	switch (iVar1)
	{
		case 1:
...
void func_120()
{
	...
	{
		disable_control_action(2, 200, false);
	}
}
...
void func_131(int iParam0, var uParam1, int* iParam2, int iParam3, var uParam4, struct<3> Param5, float fParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	
	*iParam2 = get_players_last_vehicle();
	if (does_entity_exist(*iParam2))
	{
		...
		else
		{
			...
			if (is_this_model_a_boat(iVar0) || is_this_model_a_train(iVar0))
			{
				*iParam2 = 0;
			}
			else
			{
				iVar1 = get_ped_in_vehicle_seat(*iParam2, -1, false);
				if (iVar1 != 0 && iVar1 != player_ped_id())
				{
					*iParam2 = 0;
				}
			}
	...
	if (does_entity_exist(Global_96938[0]))
	{
		*uParam1 = Global_96938[0];
		set_entity_as_mission_entity(*uParam1, true, true);
	}
	...
	if (!does_entity_exist(*uParam1))
	{
		*uParam1 = create_vehicle(iParam7, Param5, fParam6, true, true, false);
		set_vehicle_colour_combination(*uParam1, 6);
	}
	if (does_entity_exist(*iParam2))
	{
		if (!is_entity_a_mission_entity(*iParam2))
		{
			set_entity_as_mission_entity(*iParam2, true, false);
		}
	}
	func_73(uParam4, 0, player_ped_id(), "MICHAEL", 0, 1);
	func_73(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (does_cam_exist(*iParam3))
	{
		destroy_cam(*iParam3, false);
	}
	if (!does_cam_exist(*iParam3))
	{
		*iParam3 = create_camera(26379945, false);
	}
	set_cam_coord(*iParam3, -1906.842f, -572.3835f, 19.1046f);
	set_cam_rot(*iParam3, -1.5254f, 0.0003f, 171.4657f, 2);
	set_cam_fov(*iParam3, 17f);
	set_cam_active(*iParam3, true);
	render_script_cams(true, false, 3000, true, false, 0);
	new_load_scene_stop();
}
...
void func_132(int iParam0, int iParam1, int iParam2)
{
	...
	StringCopy(&cVar6, "drfriedlander_idle_01", 24);
	if (iParam1 && !is_ped_injured(player_ped_id()))
	{
		set_entity_coords(player_ped_id(), -1907.39f, -577.33f, 17.64f, true, false, false, true);
		set_entity_heading(player_ped_id(), 318.6574f);
		task_play_anim(player_ped_id(), &cVar1, &cVar3, 1000f, -2f, -1, iVar0, 0f, false, false, false);
		task_play_anim(player_ped_id(), &cVar2, &cVar5, 1000f, -2f, -1, 32 | iVar0, 0f, false, 4, false);
		force_ped_ai_and_animation_update(player_ped_id(), false, false);
	}
	if (iParam2 && !is_ped_injured(iParam0))
	{
		set_entity_coords(iParam0, -1907.69f, -574.77f, 17.67f, true, false, false, true);
		set_entity_heading(iParam0, 177f);
		task_play_anim(iParam0, &cVar1, &cVar4, 1000f, -2f, -1, iVar0, 0f, false, false, false);
		task_play_anim(iParam0, &cVar2, &cVar6, 1000f, -2f, -1, 32 | iVar0, 0f, false, false, false);
...
int func_142(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_144(iParam2));
...
void func_161(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_144(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_223(char* sParam0, int iParam1)
{
	...
	request_cutscene_with_playback_list(sParam0, iVar1, 8);
}
...
int func_224(int iParam0)
{
	...
	if (are_strings_equal(&Var1, "OBTOW01"))
	{
		return 128;
	}
	else if (are_strings_equal(&Var1, "OBTOW02"))
	{
		return 256;
	}
	else if (are_strings_equal(&Var1, "OBTOW03"))
	{
		return 512;
	}
	else if (are_strings_equal(&Var1, "OBTOW04"))
	{
		return 1024;
	}
	else if (are_strings_equal(&Var1, "OBTOW05"))
	{
		return 2048;
	}
	else if (are_strings_equal(&Var1, "OBTOW06"))
	{
		return 4096;
	}
	else if (are_strings_equal(&Var1, "OBTOW07"))
	{
		return 8192;
	}
	else if (are_strings_equal(&Var1, "OBTOW08"))
	{
		return 16384;
	}
	else if (are_strings_equal(&Var1, "OBTOW09"))
	{
		return 32768;
	}
	else if (are_strings_equal(&Var1, "OBTOW10"))
	{
		return 65536;
	}
	else if (are_strings_equal(&Var1, "OBTOW11"))
	{
		return 131072;
	}
	return 128;
...
struct<4> func_225(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_230(&(Global_113386.f_19961), 8) && iParam1) && iParam0 != 4) && func_228(3) > 0) && get_random_float_in_range(0f, 1f) < 0.75f)
	{
		bVar1 = 8;
		*uParam3 = 4;
	}
	else
	{
		...
		{
			iVar4 = get_random_int_in_range(1, iVar3 + 1);
			bVar5 = true;
			while (iVar4 > 0)
			{
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!is_entity_dead(player_ped_id(), false))
	{
		set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), false);
	}
	if (!does_entity_exist(*uParam0) || is_entity_dead(*uParam0, false))
	{
		*uParam0 = create_ped(26, iParam1, Param2, fParam3, true, true);
	}
	set_ped_component_variation(*uParam0, 3, iParam4, iParam5, 0);
	set_ped_component_variation(*uParam0, 4, 0, iParam6, 0);
	func_234(1, 0);
...
{
	if (!load_stream("Office_Background_Stream", "SHRINK_SOUNDS"))
	{
		return 0;
	}
	if (func_242(uParam0))
...
void func_245(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	func_247(uParam0);
	request_additional_text("SHRINK", 0);
	load_stream("Office_Background_Stream", "SHRINK_SOUNDS");
	new_load_scene_start(-1904.2f, -573.2f, 19.6f, -0.2f, 0f, -59.4f, 10f, 0);
	func_246();
}
...
void func_253(int iParam0, int* iParam1, int iParam2, int iParam3)
{
	...
	{
		set_vehicle_as_no_longer_needed(iParam1);
	}
