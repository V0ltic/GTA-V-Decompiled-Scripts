...
void __EntryFunction__()
{
	...
	fLocal_566 = 0f;
	iLocal_574 = -1;
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appImportExport")) > 1)
	{
		func_411(1, 0);
	}
	iLocal_559 = request_scaleform_movie("IMPORT_EXPORT_WAREHOUSE");
	func_408(1);
	func_406(1);
	func_405();
	thefeed_pause();
	while (!has_scaleform_movie_loaded(iLocal_559))
	{
		wait(0);
	}
	Global_77117 = 1;
	...
	{
		uLocal_553 = func_402(player_id());
	}
	Global_1946220 = 0;
	func_390(player_id(), 0, 0, 0);
	func_389();
	func_382();
	if (is_pc_version())
	{
	...
	if (func_379())
	{
		set_bit(&uLocal_552, true);
	}
	if (func_378())
	{
		set_bit(&uLocal_552, 3);
	}
	func_375();
	...
	while (Global_77117)
	{
		...
		else if (!func_404(player_id()) && !func_374())
		{
		...
		switch (iLocal_576)
		{
			case 0:
				...
				else if (func_262(player_id()) && network_is_player_in_mp_cutscene(player_id()))
				{
					iLocal_576 = 1;
					if (is_pc_version())
					{
...
int func_1(int iParam0)
{
	if (iParam0 != func_3())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_2(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_12(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		if (iVar1 != 0)
		{
			...
			func_25(iVar1);
			func_17(iVar1);
			iVar2 = (Global_1853348[player_id() /*834*/].f_267.f_142.f_1 - 1);
			if (iVar2 >= 0)
			{
				func_16(iVar2);
			}
...
void func_16(int iParam0)
{
	...
	{
		Global_1853348[player_id() /*834*/].f_267.f_142.f_1 = iParam0;
	}
}
...
void func_18()
{
	...
	while (iVar1 < 40)
	{
		...
		if ((iVar2[iVar1] / 32) < iVar3)
		{
			...
			{
				set_bit(&(iVar3[(iVar2[iVar1] / 32)]), (iVar2[iVar1] % 32));
			}
	...
	while (iVar1 < 39)
	{
		if (iVar2[iVar1] == 0 || !func_19(player_id(), iVar2[iVar1]))
		{
			iVar0 = iVar1;
			while (iVar0 <= 38)
			{
...
void func_25(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (Global_1853348[player_id() /*834*/].f_267.f_142.f_2[iVar0] == iParam0 || Global_1853348[player_id() /*834*/].f_267.f_142.f_2[iVar0] == (1000 + iParam0))
		{
			Global_1853348[player_id() /*834*/].f_267.f_142.f_2[iVar0] = 0;
		}
		else
		{
			iVar0++;
...
void func_50(int iParam0, int iParam1)
{
	...
	{
		if (!func_59(player_id(), 0) && !func_59(player_id(), 3))
		{
			func_58(iParam0);
...
{
	return func_63(player_id(), bParam0);
}
...
int func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1892703[player_id() /*599*/].f_10.f_332[iVar0] = func_74(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1892703[player_id() /*599*/].f_10.f_332[iVar0] = func_69(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
void func_77(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (iParam0 != func_3())
		{
			...
			{
				set_bit(&(Global_2689235[iParam0 /*453*/].f_197), 19);
			}
		}
	}
	else if (iParam0 != func_3())
	{
		if (BitTest(Global_2689235[iParam0 /*453*/].f_197, 19))
		{
			clear_bit(&(Global_2689235[iParam0 /*453*/].f_197), 19);
		}
	}
}
...
int func_78(bool bParam0, bool bParam1)
{
	...
	if (!func_253(player_id(), 188, 0))
	{
		iLocal_550 = func_87(player_id(), 188, 0);
		if (iLocal_550 == 16)
		{
			iLocal_550 = 19;
		}
	...
	if (bParam1)
	{
		...
		while (iVar0 < 4)
		{
			...
			if (iVar1 != func_3())
			{
				if (((!network_is_player_connected(iVar1) || !func_2(iVar1, 1, 1)) || !func_404(iVar1)) || func_79(iVar1))
				{
...
int func_82()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1892703[player_id() /*599*/].f_10.f_11[iVar0] != func_3())
		{
			if ((func_404(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0]) && func_2(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0], 1, 1)) && !func_79(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0]))
			{
				iVar1++;
			}
		}
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_161(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		
		case 233:
			return func_154(iParam1, iParam2, iParam3, int_to_playerindex(bParam5), iParam4);
		...
		case 243:
			return func_138(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
		
		case 158:
			return func_134(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
		
		case 181:
			return func_131(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_210(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
		
		case 233:
			return func_204(iParam1, iParam3, iParam4, int_to_playerindex(bParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_195(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
		
		case 158:
			return func_189(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
		
		case 181:
			return func_183(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
...
bool func_254()
{
	return Global_1892703[player_id() /*599*/].f_10.f_331 != 2000;
}
...
void func_263()
{
	...
	if (iLocal_562 == 2000000)
	{
		...
		{
			begin_scaleform_movie_method(iLocal_559, "GET_CURRENT_SELECTION");
			iLocal_560 = end_scaleform_movie_method_return_value();
			begin_scaleform_movie_method(iLocal_559, "GET_CURRENT_TAB_ID");
			iLocal_561 = end_scaleform_movie_method_return_value();
			iLocal_562 = 1000000;
		}
	}
	if (iLocal_562 == 1000000 && (is_scaleform_movie_method_return_value_ready(iLocal_560) && is_scaleform_movie_method_return_value_ready(iLocal_561)))
	{
		iLocal_551 = get_scaleform_movie_method_return_value_int(iLocal_561);
		iVar0 = get_scaleform_movie_method_return_value_int(iLocal_560);
		bVar1 = true;
		bVar2 = true;
		iLocal_562 = iVar0;
		if (func_321(iVar0))
		...
		else if (func_312(iVar0))
		{
			...
			{
				func_308(1, 0);
				call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(iLocal_558), -1f, -1f, -1f, -1f);
				iLocal_558 = iVar3;
				func_304(iVar3);
			}
			else
		...
		if (bVar1)
		{
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(iVar0), -1f, -1f, -1f, -1f);
		}
		if (bVar2)
		{
			func_303(iLocal_551);
		...
		if (*iParam0 == 101)
		{
			if (iLocal_549)
			{
				...
				else
				{
					Var1 = { func_286(bVar0) };
					func_288();
					call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1f, -1f);
...
int func_267(int iParam0, bool bParam1)
{
	...
	iVar0 = ceil((IntToFloat(func_272(iParam0)) * Global_262145.f_19464));
	iVar1 = 0;
	if (!bParam1)
	{
...
int func_270(int iParam0, bool bParam1)
{
	...
	iVar0 = ceil((IntToFloat(func_272(iParam0)) * Global_262145.f_19463));
	iVar1 = 0;
	if (!bParam1)
	{
...
void func_284()
{
	...
	bVar7 = true;
	bVar8 = true;
	if ((iVar3 > 0 && !network_can_spend_money(iVar3, false, true, false, -1, 0)) || func_283(0))
	{
		bVar6 = false;
	}
	if ((iVar4 > 0 && !network_can_spend_money(iVar4, false, true, false, -1, 0)) || func_283(1))
	{
		bVar7 = false;
	}
	if ((iVar5 > 0 && !network_can_spend_money(iVar5, false, true, false, -1, 0)) || func_283(2))
	{
		bVar8 = false;
	}
	begin_scaleform_movie_method(iLocal_559, "SHOW_BUYERS");
...
void func_285()
{
	...
	while (iVar0 >= 0)
	{
		if (iLocal_554[iVar0] != 0)
		{
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(iLocal_554[iVar0]), -1f, -1f, -1f, -1f);
			iLocal_554[iVar0] = 0;
		}
		else
		{
...
void func_288()
{
	begin_scaleform_movie_method(iLocal_559, "HIDE_OVERLAY");
	end_scaleform_movie_method();
	iLocal_575 = 0;
	if (iLocal_549)
	{
...
void func_290(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, bool bParam9)
{
	...
	if (!iVar1 == 0)
	{
		_trigger_script_event_2(1, &Var0, 14, iVar1);
	}
}
...
var func_291(bool bParam0, bool bParam1)
{
	...
	if (iVar2 == player_id() || func_2(iVar2, bParam0, 1))
	{
		set_bit(&uVar0, iVar2);
	}
	iVar1 = 0;
...
void func_293(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_2689235[player_id() /*453*/].f_198, 6))
		{
			set_bit(&(Global_2689235[player_id() /*453*/].f_198), 6);
		}
	}
	else if (BitTest(Global_2689235[player_id() /*453*/].f_198, 6))
	{
		clear_bit(&(Global_2689235[player_id() /*453*/].f_198), 6);
	}
}
...
void func_294()
{
	...
	Global_1892703[player_id() /*599*/].f_10.f_331 = 2000;
}
...
void func_295(int iParam0)
{
	if (func_311(iParam0))
	{
		Global_1892703[player_id() /*599*/].f_10.f_331 = iParam0;
	}
}
...
void func_296(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_2689235[player_id() /*453*/].f_197, 18))
		{
			set_bit(&(Global_2689235[player_id() /*453*/].f_197), 18);
		}
	}
	else if (BitTest(Global_2689235[player_id() /*453*/].f_197, 18))
	{
		clear_bit(&(Global_2689235[player_id() /*453*/].f_197), 18);
	}
}
...
void func_300(var uParam0)
{
	...
	while (iVar0 < iVar2)
	{
		if ((((Global_1892703[player_id() /*599*/].f_10.f_11[iVar0] != func_3() && func_2(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0], 1, 1)) && !func_301(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0])) && func_404(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0])) && !func_79(Global_1892703[player_id() /*599*/].f_10.f_11[iVar0]))
		{
			(*uParam0)[iVar1] = Global_1892703[player_id() /*599*/].f_10.f_11[iVar0];
			iVar1++;
		}
		else
		{
...
int func_311(int iParam0)
{
	...
	{
		if (!func_19(player_id(), Var1.f_1[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
{
	begin_scaleform_movie_method(iLocal_559, "SHOW_OVERLAY");
	func_318(sParam0);
...
char* func_319()
{
	if (Global_1853348[player_id() /*834*/].f_267.f_142.f_1 > 1)
	{
		return "AH_COOLDOWN2";
	}
	return "AH_COOLDOWN";
...
void func_322()
{
	...
	if (is_control_just_pressed(2, 205))
	{
		...
		{
			func_303(0);
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
		}
	}
	...
	if (is_control_just_pressed(2, 206))
	{
		...
		{
			func_303(1);
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
		}
	}
	enable_control_action(2, 207, true);
	if (is_control_pressed(2, 207))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(207), -1f, -1f, -1f, -1f);
	}
	if (is_control_just_released(2, 207))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_RELEASE_EVENT", to_float(207), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 208, true);
	if (is_control_pressed(2, 208))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(208), -1f, -1f, -1f, -1f);
	}
	if (is_control_just_released(2, 208))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_RELEASE_EVENT", to_float(208), -1f, -1f, -1f, -1f);
	}
	func_326();
	enable_control_action(2, 201, true);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	...
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		...
		{
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_RELEASE_EVENT", to_float(237), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 238))
		{
			call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_RELEASE_EVENT", to_float(238), -1f, -1f, -1f, -1f);
		}
		func_323(0, 1);
	}
	else
...
void func_323(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		{
			begin_scaleform_movie_method(iLocal_559, "SET_ANALOG_STICK_INPUT");
			iLocal_567 = iVar0;
			iLocal_568 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_567);
			scaleform_movie_method_add_param_int(iLocal_568);
	...
	if (bParam1)
	{
		...
		if (((iVar2 != 127 || iLocal_569 != 127) || iVar3 != 127) || iLocal_570 != 127)
		{
			...
			iLocal_570 = iVar3;
			scaleform_movie_method_add_param_bool(false);
			scaleform_movie_method_add_param_int(iLocal_569);
			scaleform_movie_method_add_param_int(iLocal_570);
...
void func_324()
{
	fLocal_563 = get_disabled_control_normal(2, 239);
	fLocal_564 = get_disabled_control_normal(2, 240);
	if (fLocal_563 != fLocal_565 || fLocal_564 != fLocal_566)
	{
		begin_scaleform_movie_method(iLocal_559, "SET_MOUSE_INPUT");
		scaleform_movie_method_add_param_float(fLocal_563);
		scaleform_movie_method_add_param_float(fLocal_564);
		end_scaleform_movie_method();
	...
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(237), -1f, -1f, -1f, -1f);
	}
...
void func_326()
{
	...
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 187, true);
	if (is_control_just_pressed(2, 187))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 189, true);
	if (is_control_just_pressed(2, 189))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 190, true);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_559, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
}
...
void func_327()
{
	...
	if (!BitTest(uLocal_552, 0) && !BitTest(uLocal_552, 2))
	{
		...
		else if (func_332(22))
		{
			sVar0 = "IE_SEC_TUT12";
			iLocal_573 = 8000;
			set_bit(&Global_1946101, 22);
			func_329(&iLocal_571, &uLocal_572, 33);
		}
	}
	if (!is_string_null_or_empty(sVar0) && !BitTest(uLocal_552, 0))
	{
		func_328(sVar0, iLocal_573);
		set_bit(&uLocal_552, false);
	}
...
void func_358()
{
	...
	if (!BitTest(uLocal_552, 2) && !func_299())
	{
		...
		else if (iLocal_551 == 1 && !func_360(3816, -1))
		{
			...
			iLocal_574 = 2;
			func_359(3816, 1, -1);
			set_bit(&uLocal_552, 6);
		}
	}
	if (bVar0)
	{
		set_bit(&uLocal_552, 2);
	}
...
void func_361()
{
	...
	draw_scaleform_movie_fullscreen(iLocal_559, 255, 255, 255, 255, 0);
	func_368();
	func_365(0);
	func_362(1);
}
...
void func_382()
{
	...
	while (iVar0 < 40)
	{
		iVar1 = Global_1853348[player_id() /*834*/].f_267.f_142.f_2[iVar0];
		if (iVar1 > 1000)
		{
			iVar1 = (iVar1 - 1000);
		}
	...
	{
		iVar2 = func_384(8);
		begin_scaleform_movie_method(iLocal_559, "SET_COOLDOWN");
		scaleform_movie_method_add_param_int(iVar2);
		end_scaleform_movie_method();
	}
	func_383();
...
void func_383()
{
	begin_scaleform_movie_method(iLocal_559, "SHOW_EXPORT_SCREEN");
	end_scaleform_movie_method();
}
...
void func_385(int iParam0)
{
	...
	begin_scaleform_movie_method(iLocal_559, "UPDATE_COLLECTION");
...
void func_388(int iParam0, bool bParam1)
{
	...
	begin_scaleform_movie_method(iLocal_559, "UPDATE_VEHICLE");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iVar0);
	scaleform_movie_method_add_param_int(iVar1);
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_56(player_id(), 0) && !func_398()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_394(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_411(int iParam0, bool bParam1)
{
	...
	func_406(0);
	func_260();
	set_scaleform_movie_as_no_longer_needed(&iLocal_559);
	if (bParam1)
	{
		func_390(player_id(), 1, 8388608, 0);
		stop_audio_scene("GTAO_Computer_Screen_Active_Scene");
	}
	if (is_pc_version() && _0xA0FE76168A189DDB())
	{
		func_381(0, 1, 1, 1);
	}
	thefeed_resume();
