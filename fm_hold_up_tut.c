...
void __EntryFunction__()
{
	...
	{
		func_315();
		if (func_308() || !func_307(player_id(), 0, 1))
		{
			func_305();
		}
		switch (func_304(participant_id_to_int()))
		{
			case 0:
				if (func_303() == 2)
				{
					iLocal_140[participant_id_to_int()] = 2;
				}
				else if (func_303() == 6)
				{
					iLocal_140[participant_id_to_int()] = 5;
				}
				break;
			...
			case 2:
				if (func_303() == 2)
				{
					...
					{
						if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 4))
						{
							func_33(1);
							func_32(0);
							func_25();
			...
			case 5:
				...
				{
					iLocal_140[participant_id_to_int()] = 6;
				}
				break;
		...
		switch (Local_65.f_5.f_2)
		{
			case 0:
				if (!BitTest(Local_65.f_5.f_3, 1))
				{
					...
					set_bit(&(Local_65.f_5.f_3), true);
				}
				if (Global_2815059.f_1788)
				{
					set_bit(&(Local_65.f_5.f_3), false);
				...
				if (BitTest(Local_65.f_5.f_3, 1))
				{
					if (BitTest(Local_65.f_5.f_3, 0))
					{
						if (!func_20(&(Local_65.f_5)) || func_19(&(Local_65.f_5), 5000, 0))
						{
							...
							{
								Local_65.f_5.f_72 = 0;
								clear_bit(&(Local_65.f_5.f_3), 2);
								clear_bit(&(Local_65.f_5.f_3), 3);
							}
							...
							if (network_is_player_active(bVar1))
							{
								...
								{
									set_bit(&(Local_65.f_5.f_73), bVar1);
									Local_65.f_5.f_72++;
			...
			case 2:
				...
				if (Local_65.f_5.f_4 == 32)
				{
					...
					{
						func_3();
						clear_bit(&(Local_65.f_5.f_3), false);
						Local_65.f_5.f_2 = 0;
					}
					else
					{
...
void func_3()
{
	...
	Var0.f_0 = 390850539;
	Var0.f_1 = player_id();
	_trigger_script_event_2(1, &Var0, 2, func_4(1, 1));
}
								...
								if (Global_2689064.f_87[iVar12] == 0)
								{
									if (!BitTest(*iParam1, bVar1))
									{
										if (!is_ped_injured(iVar9))
										{
											...
											{
												Var7 = { func_10(bVar1) };
												fVar4 = vdist2(get_entity_coords(iVar9, true), Var7);
												if (fVar4 > fVar6)
												{
													fVar5 = vdist2(get_entity_coords(iVar11, true), Var7);
													if (fVar5 > fVar6)
													{
														bVar2 = bVar1;
														bVar0 = true;
														set_bit(iParam1, bVar1);
													}
												}
											}
										}
...
void func_21()
{
	...
	if (network_is_host_of_this_script())
	{
		if (iLocal_139 == 0)
		{
			clear_bit(&uLocal_165, false);
			set_bit(&uLocal_165, true);
		}
		iVar1 = iLocal_139;
		...
		if (iLocal_139 == 32)
		{
			...
			{
				set_bit(&(Local_65.f_1), false);
			}
			set_bit(&uLocal_165, false);
			iLocal_139 = 0;
		}
	}
}
...
void func_32(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 0))
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), false);
		}
	}
	else if (BitTest(Global_1853348[player_id() /*834*/].f_143, 0))
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), false);
	}
}
...
void func_33(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 4))
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 4);
		}
	}
	else if (BitTest(Global_1853348[player_id() /*834*/].f_143, 4))
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 4);
	}
}
...
int func_34(var uParam0)
{
	...
	if (*uParam0 > 0)
	{
		...
		if (!BitTest(uParam0->f_1, 2))
		{
			...
			{
				if ((func_299(player_id(), 1, 0) || func_298()) || func_297() != 0)
				{
					func_295(uParam0);
					set_bit(&(uParam0->f_1), 2);
					clear_bit(&(uParam0->f_1), 12);
					clear_bit(&uLocal_165, 11);
				}
			}
		}
				...
				if (!func_299(player_id(), 1, 0))
				{
					if (!func_298())
					{
						if (func_297() == 0)
						{
							...
							clear_bit(&(uParam0->f_1), true);
							clear_bit(&(uParam0->f_1), false);
							clear_bit(&(uParam0->f_1), 3);
							clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 2);
							if (*uParam0 > 1)
							{
								*uParam0 = 1;
							}
		...
		{
			if (func_299(player_id(), 1, 0) || func_298())
			{
				set_bit(&(Global_1853348[iVar3 /*834*/].f_143), 5);
				*uParam0 = 0;
				func_32(0);
				func_294(0);
				func_24(8, 0);
		...
		if (*uParam0 < 3)
		{
			if (Local_65.f_5.f_5[player_id()] == -1)
			{
		...
		if (BitTest(Global_1853348[player_id() /*834*/].f_143, 9))
		{
	...
	switch (*uParam0)
	{
		case 0:
									...
									if (func_297() == 0)
									{
										if (func_169())
										{
											if (func_151(uParam0))
											{
												...
												if (BitTest(Global_1853348[iVar3 /*834*/].f_143, 5))
												{
													clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), 5);
												}
											}
										}
									}
			...
			else
			{
				if (BitTest(Global_1853348[iVar3 /*834*/].f_143, 0))
				{
					clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), false);
					clear_bit(&(uParam0->f_1), false);
					clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), 2);
					clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 16);
					func_32(0);
				}
				if (BitTest(Global_1853348[iVar3 /*834*/].f_143, 12))
				{
					...
					{
						clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), 12);
					}
				}
				...
				{
					clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), 13);
					func_18(&(uParam0->f_6));
				}
			}
			break;
		...
		case 1:
			...
			{
				if (BitTest(Global_1853348[player_id() /*834*/].f_143, 16))
				{
					clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 16);
				}
				if (BitTest(uParam0->f_1, 14))
				{
					clear_bit(&(uParam0->f_1), 14);
				}
				if (!does_blip_exist(uParam0->f_4))
				{
					if (iVar1 >= 0)
					{
						uParam0->f_4 = add_blip_for_coord(func_10(iVar1));
						set_blip_route(uParam0->f_4, true);
						set_blip_priority(uParam0->f_4, 9);
					}
				}
			...
			else
			{
				...
				if (!BitTest(Global_1853348[iVar3 /*834*/].f_143, 2))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						if ((vdist2(get_entity_coords(player_ped_id(), true), func_10(iVar1)) < (15f * 15f) || (iVar0 == -1 && func_143(25f))) || func_142(1101004800, 1117126656))
						{
							if (does_blip_exist(uParam0->f_4))
							{
							...
							if (iVar0 > -1 && func_145(iVar0, 1))
							{
								...
								{
									if (network_is_player_active(bVar4))
									{
							...
							set_bit(&(Global_1853348[iVar3 /*834*/].f_143), 2);
						}
					}
				}
				else
				{
					if (!is_ped_injured(player_ped_id()))
					{
						if (!BitTest(uParam0->f_1, 2))
						{
							if ((!BitTest(uLocal_165, 18) && vdist2(get_entity_coords(player_ped_id(), true), func_10(iVar1)) > (35f * 35f)) || (BitTest(uLocal_165, 18) && vdist2(get_entity_coords(player_ped_id(), true), func_10(iVar1)) > (90f * 90f)))
							{
								clear_bit(&(uParam0->f_1), false);
								clear_bit(&(Global_1853348[iVar3 /*834*/].f_143), 2);
								clear_bit(&uLocal_165, 18);
							}
						}
					}
					...
					if (!BitTest(Global_1853348[iVar3 /*834*/].f_143, 2))
					{
						if (!BitTest(Global_1853348[iVar3 /*834*/].f_143, 12))
						{
							if (func_20(&(uParam0->f_10)))
							{
								...
								{
									set_bit(&(Global_1853348[iVar3 /*834*/].f_143), 12);
									set_bit(&(Global_1853348[iVar3 /*834*/].f_143), 13);
									if (does_blip_exist(uParam0->f_4))
									{
										remove_blip(&(uParam0->f_4));
									}
				...
				if (!BitTest(uParam0->f_1, 14))
				{
					if (!func_115())
					{
						...
						if (!BitTest(uParam0->f_1, 3) && !BitTest(uParam0->f_1, 14))
						{
							...
							set_bit(&(uParam0->f_1), 3);
							set_bit(&(Global_1853348[iVar3 /*834*/].f_143), 8);
						}
					}
				}
				else
	...
	if (*uParam0 > 0)
	{
		...
		if (!func_302())
		{
			if (func_90(uParam0))
			{
				...
				if (BitTest(uParam0->f_1, 15))
				{
					iVar0 = Local_65.f_5.f_5[player_id()];
					if (func_129(iVar0, 1))
					{
					}
				}
...
void func_35(bool bParam0)
{
	...
	iVar1 = func_83(player_id(), bParam0);
...
void func_89(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 17))
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 17);
		}
	}
	else if (BitTest(Global_1853348[player_id() /*834*/].f_143, 17))
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 17);
	}
}
...
int func_90(var uParam0)
{
	...
	iVar0 = Local_65.f_5.f_5[player_id()];
	if (BitTest(Global_1853348[participant_id_to_int() /*834*/].f_143, 2))
	{
		if (func_148(1168, -1, 0) > iLocal_331)
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 10);
			if (iVar0 > -1)
			{
				iVar1 = iVar0;
	...
	if ((BitTest(uParam0->f_1, 7) && !BitTest(uParam0->f_1, 10)) && !BitTest(uParam0->f_1, 9))
	{
		...
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 11);
			return 1;
		}
	}
	return 0;
...
void func_93(var uParam0)
{
	...
	if (BitTest(uParam0->f_1, 6))
	{
		if (!does_blip_exist(uParam0->f_5))
		{
			if (!func_115())
			{
				iVar0 = Local_65.f_5.f_38[player_id()];
				if (iVar0 > -1)
				{
					Var1 = { func_95(iVar0) };
					if (!func_94(Var1, 0f, 0f, 0f, 0))
					{
						if (!does_blip_exist(uParam0->f_5))
						{
							_set_ignore_secondary_route_nodes(true);
							uParam0->f_5 = add_blip_for_coord(Var1);
							set_blip_sprite(uParam0->f_5, 52);
							set_blip_scale(uParam0->f_5, 1f);
							set_blip_priority(uParam0->f_5, 7);
							set_blip_route(uParam0->f_5, true);
						}
					}
				}
			}
				...
				if (!is_pause_menu_active())
				{
					if (func_98())
					{
						if (func_143(1089470464))
						{
							...
							else if (!BitTest(uLocal_165, 7) || is_disabled_control_pressed(0, 37))
							{
								func_150("FM_PASS_DBL", -1);
								set_bit(&uLocal_165, 7);
							}
						}
					}
				}
...
int func_98()
{
	if (((((((((((((((!func_307(player_id(), 1, 1) || is_ped_injured(player_ped_id())) || !is_player_control_on(player_id())) || func_104(8, -1)) || func_104(15, -1)) || func_103()) || func_104(3, -1)) || is_help_message_being_displayed()) || func_299(player_id(), 1, 0)) || func_298()) || func_102()) || func_101()) || func_100()) || is_pause_menu_active()) || network_is_in_tutorial_session()) || func_99())
	{
		return 0;
	}
	return 1;
...
void func_105(var uParam0)
{
	...
	if (func_66())
	{
		...
		{
			if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 2))
			{
				if (iLocal_331 > -1)
				{
	...
	if (!BitTest(uParam0->f_1, 7))
	{
		if (!func_113())
		{
			...
			{
				if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 2) && ((_get_number_of_references_of_script_with_name_hash(joaat("am_hold_up")) == 0 && !BitTest(Global_1853348[player_id() /*834*/].f_143, 16)) && !func_112()))
				{
					set_bit(&(uParam0->f_1), 9);
					set_bit(&(uParam0->f_1), 7);
				}
				else if (*uParam0 >= 1)
				{
					if ((!func_115() && !BitTest(uParam0->f_1, 8)) && _get_number_of_references_of_script_with_name_hash(joaat("am_hold_up")) == 0)
					{
						set_bit(&(uParam0->f_1), 9);
						set_bit(&(uParam0->f_1), 7);
					}
	...
	else if (BitTest(uParam0->f_1, 10))
	{
		if (func_113())
		{
			if (BitTest(uParam0->f_1, 7))
			{
				clear_bit(&(uParam0->f_1), 7);
				clear_bit(&(uParam0->f_1), 9);
				clear_bit(&(uParam0->f_1), 10);
			}
		}
	}
	if (BitTest(uParam0->f_1, 9))
	{
		if (!BitTest(uParam0->f_1, 10))
		{
			if (*uParam0 > 1)
			{
				if (func_143(10f))
				{
					iVar2 = network_get_host_of_script(func_111(), -1, 0);
					if (iVar2 != func_110())
					{
						clear_bit(&(uParam0->f_1), 9);
						set_bit(&(uParam0->f_1), 10);
						func_107();
					}
				}
			}
...
void func_106(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			set_bit(&(Global_2815059.f_1795), 21);
		}
	}
	else if (BitTest(Global_2815059.f_1795, 21))
	{
		clear_bit(&(Global_2815059.f_1795), 21);
	}
}
...
void func_107()
{
	...
	if (Local_65.f_5.f_38[player_id()] > -1)
	{
		iVar0 = func_11(Local_65.f_5.f_38[player_id()]);
		func_108(iVar0, 1, func_109(network_get_host_of_script(func_111(), -1, 0)));
	}
}
...
void func_114(var uParam0)
{
	...
	if (!BitTest(uParam0->f_1, 1) && !BitTest(Global_1853348[iVar1 /*834*/].f_143, 8))
	{
		if (iVar0 > -1)
		{
			...
			{
				clear_bit(&(Global_1853348[iVar1 /*834*/].f_143), 6);
			}
			if (!func_145(iVar0, 1))
			{
				clear_bit(&(uParam0->f_1), false);
	...
	else
	{
		if (*uParam0 < 3)
		{
			if (!BitTest(Global_1853348[iVar1 /*834*/].f_143, 6))
			{
				set_bit(&(Global_1853348[iVar1 /*834*/].f_143), 6);
			}
		}
...
int func_115()
{
	...
	Var1 = { func_95(Local_65.f_5.f_38[player_id()]) };
	if (!is_ped_injured(player_ped_id()))
	{
		if (!func_94(Var1, 0f, 0f, 0f, 0))
		{
			...
			if (iVar0 != 0)
			{
				if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Var1, true) < 25f)
				{
					return 1;
				}
			}
...
void func_116(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_20(&iParam1))
	{
		iVar0 = (iParam0 - get_time_difference(get_network_time(), iParam1));
		if (iVar0 >= 0)
		{
...
{
	return does_blip_exist(Global_2678393[iParam0]);
}
...
int func_129(int iParam0, bool bParam1)
{
	...
	if (iParam0 > -1)
	{
		...
		if (network_is_player_active(iVar0))
		{
			...
			{
				set_ped_can_be_targetted_by_player(player_ped_id(), bVar0, bParam1);
				return 1;
			}
		}
	}
...
void func_130(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 7))
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 7);
		}
	}
	else if (BitTest(Global_1853348[player_id() /*834*/].f_143, 7))
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 7);
	}
}
...
{
	func_135(sParam0, get_player_name(iParam1), bParam3, 1);
}
		...
		if (is_ped_sitting_in_any_vehicle(player_ped_id()))
		{
			...
			if (iVar1 > -1 && func_145(iVar1, 1))
			{
				...
				if (network_is_player_active(iVar3))
				{
					...
					{
						iVar4 = get_player_ped(bVar3);
						if (!is_ped_injured(iVar4))
						{
							if (is_ped_sitting_in_any_vehicle(iVar4))
							{
								if (get_vehicle_ped_is_in(iVar4, false) == iVar2)
								{
									return 1;
								}
							}
...
int func_142(float fParam0, float fParam1)
{
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_ped_sitting_in_any_vehicle(player_ped_id()))
		{
			if (get_entity_speed(get_vehicle_ped_is_in(player_ped_id(), false)) > fParam0)
			{
				if (func_143(fParam1))
				{
					if (!BitTest(uLocal_165, 18))
					{
						set_bit(&uLocal_165, 18);
					}
					return 1;
				}
			}
		...
		case 0:
			...
			else if (func_19(&(uParam0->f_14), 7000, 0))
			{
				if (func_167())
				{
					...
					else if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 16))
					{
						func_144("FM_IHELP_LCP", 0);
						set_bit(&(Global_1853348[player_id() /*834*/].f_143), 16);
		...
		case 1:
			...
			else if (func_167())
			{
				if (get_player_wanted_level(player_id()) == 0)
				{
					...
					if ((!func_20(&uLocal_332) || func_19(&uLocal_332, 20000, 0)) || BitTest(Global_1853348[player_id() /*834*/].f_143, 16))
					{
						if (BitTest(Global_1853348[player_id() /*834*/].f_143, 16))
						{
							clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 16);
...
bool func_169()
{
	...
	if (!BitTest(uLocal_165, 2))
	{
		if (!BitTest(uLocal_165, 10))
		{
			...
			{
				set_bit(&uLocal_165, 9);
			}
			set_bit(&uLocal_165, 10);
		}
		else if (!BitTest(uLocal_165, 9))
		{
				...
				if (!BitTest(uLocal_165, 5) || (BitTest(uLocal_165, 5) && func_19(&uLocal_161, 60000, 0)))
				{
					if (func_286())
					{
						...
						else
						{
							...
							{
								set_bit(&uLocal_165, 3);
								clear_bit(&uLocal_165, 5);
							}
						}
					}
				}
			...
			else if (!func_292())
			{
				...
				else
				{
					...
					clear_bit(&uLocal_165, 3);
					set_bit(&uLocal_165, 5);
				}
			}
		}
		else if (func_286())
...
int func_187(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_193(1);
			func_197(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
	...
	func_188(iParam0, sParam1, bVar1, func_192(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_194(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
void func_206()
{
	...
	{
		if (func_209(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_208(player_ped_id());
...
int func_228(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	func_229(iParam0, sParam1, bVar1, func_192(player_id()));
	return 1;
}
...
void func_273(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&(Global_1853348[player_id() /*834*/].f_143), 28);
	}
	else
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 28);
	}
}
		...
		while (iVar0 < 32)
		{
			...
			if (func_307(iVar1, 1, 1))
			{
				if (iVar1 != player_id())
				{
					if (func_291(iVar1))
					{
						if (vdist2(Var2, get_entity_coords(get_player_ped(iVar1), true)) < (fParam0 * fParam0))
						{
							return 1;
						}
					}
...
void func_293()
{
	...
	_trigger_script_event_2(1, &Var0, 3, func_4(1, 1));
}
...
void func_294(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1853348[player_id() /*834*/].f_143, 3))
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_143), 3);
		}
	}
	else if (BitTest(Global_1853348[player_id() /*834*/].f_143, 3))
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_143), 3);
	}
}
...
void func_305()
{
	_set_ignore_secondary_route_nodes(false);
	func_25();
	func_24(8, 0);
	network_set_friendly_fire_option(true);
...
int func_308()
{
	...
	if (func_309() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_309()) == 0)
		{
			return 1;
		}
	}
...
void func_316(struct<21> Param0)
{
	...
	func_318(0, -1, 0);
	network_register_host_broadcast_variables(&Local_65, 79, 0);
	network_register_player_broadcast_variables(&iLocal_140, 33, 0);
	set_this_script_can_be_paused(false);
	if (!func_317())
	{
		func_305();
	}
	clear_bit(&Global_1922763, true);
	clear_bit(&Global_1922763, 15);
	clear_bit(&Global_1922763, 14);
	func_24(8, 1);
	if (!func_291(player_id()))
	{
		func_273(1);
...
void func_320(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!network_is_game_in_progress())
	{
		func_306();
