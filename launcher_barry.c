...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0.f_0 == 2 || Var0.f_0 == 3)
		{
			...
			{
				set_cutscene_ped_prop_variation("Barry", 1, 0, 0, 0);
			}
		}
		else if (Var0.f_0 == 4)
		{
		...
		if (func_207(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_205(&Var0, get_entity_coords(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_205(&Var0, get_entity_coords(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_190(&uLocal_58, get_entity_coords(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_189(Var0.f_0))
		{
			if ((get_game_timer() - iLocal_54) > 5000)
			{
				iVar2 = 1;
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_188()) || Global_31962) || func_187()) || func_186(8, -1)) || func_184()) || func_93()) || func_185()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_188()) || Global_112433) || Global_31962) || func_187()) || func_186(8, -1)) || func_93()) || func_185()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_188() || get_player_wanted_level(player_id()) > 0) || func_186(8, -1)) || func_183()) || func_182()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_190(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3)
{
	switch (*uParam0)
	{
		case 0:
			if ((get_game_timer() - iLocal_224) > 5000)
			{
				*uParam0 = 1;
			}
			break;
		...
		case 1:
			if (func_203(player_ped_id(), Param1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_203(player_ped_id(), Param1, 1) >= 25f)
			{
				func_145();
				*uParam0 = 0;
			}
...
void func_204(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	...
	uParam1.f_7 = get_random_int_in_range(0, uParam1.f_6);
	open_sequence_task(&iVar0);
	task_play_anim(0, iParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0f, false, false, false);
	task_play_anim(0, iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0f, false, false, false);
...
int func_205(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_207(player_ped_id()) && func_207(iParam0->f_28[0])) && !func_147()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_203(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_203(player_ped_id(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_203(player_ped_id(), Param2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
...
void func_217(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_207(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_219(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_218(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_219(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_218(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_225(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_228(int iParam0, float fParam1)
{
	...
	{
		if (func_239(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_230(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_231(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_234(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_236(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_236(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_235(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_243(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_236(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_254()
{
	...
	if (func_207(player_ped_id()))
	{
		if (func_255(player_ped_id(), Var0, fVar1, 1))
		{
			func_152();
		}
	}
...
bool func_255(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
void func_256(int iParam0)
{
	if (func_207(iParam0->f_28[0]))
	{
		...
		if (is_explosion_in_sphere(-1, get_entity_coords(iParam0->f_28[0], true), 5.1f))
		{
			func_257(iParam0);
			if (func_207(iParam0->f_28[0]))
			{
				apply_damage_to_ped(iParam0->f_28[0], 1000, true, 0);
			}
		}
	}
}
...
void func_257(var uParam0)
{
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		if (func_207(uParam0->f_28[0]))
		{
			...
			task_smart_flee_ped(uParam0->f_28[0], player_ped_id(), 10000f, -1, false, false);
		}
		func_222(&(uParam0->f_41[2]));
	}
}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				if (does_entity_exist(uParam0->f_35[0]))
				{
					set_vehicle_alarm(uParam0->f_35[0], false);
			...
			if (!does_entity_exist(uParam0->f_41[0]))
			{
				...
				{
					attach_entity_to_entity(uParam0->f_41[0], uParam0->f_35[0], 0, Var3, Var4, false, false, false, false, 2, true, 0);
				}
				else
				{
					bVar8 = false;
...
void func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_222(iParam0);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_267(iParam0);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_41[0]))
			{
				...
				if (does_entity_exist(uParam0->f_41[0]) && does_entity_exist(uParam0->f_35[0]))
				{
					attach_entity_to_entity(uParam0->f_41[0], uParam0->f_35[0], 0, Var2, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
				}
				else
				{
					bVar7 = false;
		...
		case 3:
			if (func_207(uParam0->f_35[1]))
			{
				if (func_207(uParam0->f_28[0]))
				{
					set_ped_as_cop(uParam0->f_28[0], true);
					set_ped_into_vehicle(uParam0->f_28[0], uParam0->f_35[1], -1);
					give_delayed_weapon_to_ped(uParam0->f_28[0], joaat("weapon_pistol"), 100, true);
				}
				if (func_207(uParam0->f_28[1]))
				{
					set_ped_as_cop(uParam0->f_28[1], true);
					set_ped_into_vehicle(uParam0->f_28[1], uParam0->f_35[1], 0);
					give_delayed_weapon_to_ped(uParam0->f_28[1], joaat("weapon_pistol"), 100, true);
				}
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
...
void func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_271(iParam0);
...
int func_281(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			...
			{
				set_entity_rotation(uParam0->f_41[4], -90f, 0f, -30.8f, 2, true);
			...
			{
				set_entity_rotation(uParam0->f_41[3], -90f, 0f, 75f, 2, true);
...
int func_292(int iParam0, struct<3> Param1, float fParam2)
{
	int iVar0[4];
	int iVar1;
...
int func_293(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_294(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
