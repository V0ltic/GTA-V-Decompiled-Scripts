...
void __EntryFunction__()
{
	...
	iLocal_701 = -1;
	iLocal_702 = -1;
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appBikerBusiness")) > 1)
	{
		func_514(1);
	}
	iLocal_688 = request_scaleform_movie("BIKER_BUSINESSES");
	while (!has_scaleform_movie_loaded(iLocal_688))
	{
		wait(0);
	}
	func_511(1);
	...
	{
		func_491(player_id(), 0, 0, 0);
	}
	func_472();
	if (does_entity_exist(player_ped_id()) && !is_entity_dead(player_ped_id(), false))
	{
		Local_502 = { get_entity_coords(player_ped_id(), true) };
	}
	if (!func_471(7638, -1))
	{
		func_468();
	...
	if (iLocal_517 != 0)
	{
		...
		if (bVar0 != -1)
		{
			if (func_465(player_id(), iLocal_517) == func_464(iLocal_517))
			{
				if (!BitTest(Global_1640674, bVar0))
				{
					func_463(bVar0, 1, 0);
					set_bit(&Global_1640674, bVar0);
				}
			}
			else
			{
				clear_bit(&Global_1640674, bVar0);
			}
		}
	}
	while (func_462())
	{
		if (BitTest(Global_1853348[player_id() /*834*/].f_267.f_30, 14) || func_461(player_ped_id(), Local_502, 1) > 5f)
		{
			func_514(0);
		}
		...
		iVar1 = 1;
		if ((func_460(player_id()) && iVar1) || (((!func_471(7638, -1) && func_458(player_id())) && func_436()) && !func_471(7638, -1)))
		{
			func_435(7638, 1, -1);
		}
		func_422();
		...
		else if (iLocal_514 != 190)
		{
			...
			else if (func_8(&uLocal_519, 200, 0))
			{
				if (!Global_1946108)
				{
					func_3(player_id(), iLocal_517, bLocal_518, 1);
					Global_1946108 = 1;
					func_514(0);
				}
...
void func_11()
{
	...
	{
		begin_scaleform_movie_method(iLocal_688, "GET_CURRENT_SELECTION");
		iLocal_689 = end_scaleform_movie_method_return_value();
		begin_scaleform_movie_method(iLocal_688, "GET_SELECTED_BUSINESS_ID");
		iLocal_691 = end_scaleform_movie_method_return_value();
		begin_scaleform_movie_method(iLocal_688, "GET_CURRENT_SCREEN_ID");
		iLocal_692 = end_scaleform_movie_method_return_value();
		iLocal_505 = 0;
		iLocal_504 = 0;
	}
	if ((is_control_just_pressed(2, 202) || is_control_just_pressed(2, 238)) && iLocal_505)
	{
		begin_scaleform_movie_method(iLocal_688, "GET_CURRENT_SCREEN_ID");
		iLocal_692 = end_scaleform_movie_method_return_value();
		iLocal_505 = 0;
	}
	if (is_scaleform_movie_method_return_value_ready(iLocal_692) && !iLocal_505)
	{
		iLocal_513 = get_scaleform_movie_method_return_value_int(iLocal_692);
		iLocal_505 = 1;
	}
	if (iLocal_509 && !iLocal_510)
	{
		begin_scaleform_movie_method(iLocal_688, "GET_CURRENT_ROLLOVER");
		iLocal_690 = end_scaleform_movie_method_return_value();
		iLocal_510 = 1;
	}
	if (iLocal_510)
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_690))
		{
			iLocal_511 = get_scaleform_movie_method_return_value_int(iLocal_690);
			iLocal_510 = 0;
		}
	}
	if (iLocal_511 == 3014 && func_419())
	{
		...
		end_text_command_display_help(0, false, true, 8000);
	...
	if (!iLocal_504)
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_689) && is_scaleform_movie_method_return_value_ready(iLocal_691))
		{
			iVar1 = get_scaleform_movie_method_return_value_int(iLocal_689);
			iVar2 = get_scaleform_movie_method_return_value_int(iLocal_691);
			iVar3 = -1;
			if (iLocal_517 != 0)
			{
			...
			switch (iVar1)
			{
				...
				case 102:
					func_246(0, iVar2);
					play_sound_frontend(-1, "Click_Cancel", "DLC_Biker_Computer_Sounds", true);
					break;
				...
				case 3002:
					if (Global_1853348[player_id() /*834*/].f_267.f_191[iVar3 /*13*/].f_4 <= 0)
					{
				...
				case 3003:
					...
					{
						if (func_205(player_id()) && !func_208(player_id()))
						{
							iVar4 = func_31(player_id(), 192, 0);
						}
						if (iVar4 == 15)
						{
				...
				case 3014:
					...
					else if (!network_can_spend_money(iVar7, false, true, false, -1, 0))
					{
...
int func_16(int iParam0)
{
	...
	iVar1 = func_465(player_id(), iParam0);
...
void func_18(int iParam0, int iParam1)
{
	...
	else if (Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_4 <= 0)
	{
		func_221(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	...
	else if (func_28(player_id(), iLocal_517, iParam0))
	{
		func_221(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (network_can_spend_money(func_19(iParam0, iLocal_517), false, true, false, -1, 0))
	{
...
int func_19(int iParam0, int iParam1)
{
	...
	switch (iVar0)
	{
		...
		case 5:
			iVar1 = func_26(player_id());
			if (network_is_game_in_progress() && func_25())
			{
				iVar2 = 0;
				iVar3 = 0;
				if (iParam0 == 8)
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_113(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		
		case 233:
			return func_106(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		...
		case 243:
			return func_89(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 158:
			return func_84(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 181:
			return func_81(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_162(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
		
		case 233:
			return func_156(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_147(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_141(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_135(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
...
{
	if (!func_207(player_id(), iParam0, 0))
	{
		return 0;
	}
	if (!func_69(player_id()))
	{
		return 0;
	}
	if (func_208(player_id()))
...
int func_209(int iParam0)
{
	...
	else if (!func_218(player_id(), iVar0) && !func_217(iVar0))
	{
		return 2;
	}
...
int func_210(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1640666[iParam0] > 0 && (!func_215(iParam1) || !func_211(player_id(), iParam1)))
		{
			if (!Global_262145.f_21597 || func_205(player_id()))
			{
				return 1;
			}
		}
	...
	if ((Global_1640666[iParam0] > 0 && !func_215(iParam1)) && (!Global_262145.f_18996 || func_69(player_id())))
	{
		return 1;
	}
	return 0;
...
{
	return func_216(player_id(), iParam0);
}
...
{
	iLocal_512 = iParam0;
	begin_scaleform_movie_method(iLocal_688, "SHOW_OVERLAY");
	...
	_scaleform_movie_method_add_param_texture_name_string_2(sParam2);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam3);
	end_scaleform_movie_method();
	if (bParam5)
	{
		play_sound_frontend(-1, "Click_Fail", "DLC_Biker_Computer_Sounds", true);
	}
	iLocal_507 = 1;
}
...
void func_222(int iParam0, int iParam1)
{
	...
	if (func_238(player_id(), func_27(iVar0)))
	{
		iVar3 = func_237(player_id(), func_27(iVar0));
	...
	if (iVar2 > 0 && !network_can_spend_money(iVar2, false, true, false, -1, 0))
	{
...
{
	if (func_224(iParam0) || func_7(player_id(), iParam0))
	{
		return 0;
	}
	return 1;
...
int func_225(int iParam0)
{
	...
	if (func_28(player_id(), iParam0, 0))
	{
		iVar1 = (func_19(0, iParam0) / 2);
		iVar0 = (iVar0 + iVar1);
	}
	if (func_28(player_id(), iParam0, 2))
	{
...
int func_239(int iParam0)
{
	...
	if (network_is_game_in_progress() && func_25())
	{
		...
		if (_net_gameserver_catalog_item_exists_hash(iVar2))
		{
			iVar3 = net_gameserver_get_price(iVar2, 426439576, true);
...
void func_246(bool bParam0, int iParam1)
{
	...
	call_scaleform_movie_method(iLocal_688, "HIDE_OVERLAY");
	iLocal_507 = 0;
	if (bParam0)
	{
		switch (iLocal_512)
		{
			case 2001:
				if (iLocal_506)
				{
					call_scaleform_movie_method(iLocal_688, "SHOW_HOMEPAGE");
					iLocal_506 = 0;
				}
				else if (!func_224(iParam1))
				{
					play_sound_frontend(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					if (func_238(player_id(), func_27(iParam1)))
					{
						func_414(iParam1);
						func_413(bVar0, 0);
					}
			...
			case 3005:
				play_sound_frontend(-1, "Business_Shutdown", "DLC_Biker_Computer_Sounds", true);
				bVar0 = func_466(iLocal_517);
				func_331();
				func_413(bVar0, 1);
				func_472();
				if (func_330(player_id()))
				{
					...
					if (func_328(iVar2))
					{
						...
						func_314(iVar3, 1);
						set_bit(&Global_1946103, bVar0);
					}
				}
				break;
			
			case 3006:
				play_sound_frontend(-1, "Business_Restart", "DLC_Biker_Computer_Sounds", true);
				bVar0 = func_466(iLocal_517);
...
void func_247(bool bParam0)
{
	...
	{
		Global_1640642[bParam0] = get_cloud_time_as_int();
...
void func_251(int iParam0, int iParam1)
{
	...
	iVar4 = get_hash_key(func_240(iParam0));
...
int func_253(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!net_gameserver_is_session_valid(func_24()) || net_gameserver_is_session_refresh_pending())
		{
			Global_4535607 = 1;
			return 0;
		}
...
void func_272(int iParam0, var uParam1)
{
	...
	{
		if (!func_281(player_id(), 0) && !func_281(player_id(), 3))
		{
			func_280(iParam0);
...
{
	return func_87(player_id(), bParam0);
}

int func_284()
{
	return func_205(player_id());
}

void func_285(var uParam0, var uParam1)
{
	Global_1892703[player_id() /*599*/].f_10.f_194 = uParam0;
	Global_1892703[player_id() /*599*/].f_10.f_194.f_1 = uParam1;
}
...
void func_286(bool bParam0, bool bParam1)
{
	...
	Global_1853348[player_id() /*834*/].f_267.f_191[bParam0 /*13*/].f_6 = bParam1;
}
...
void func_304(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_7(player_id(), iParam0))
	{
		...
		if (bParam2)
		{
			set_bit(&(Global_1853348[player_id() /*834*/].f_267.f_191[iVar0 /*13*/].f_5), bParam1);
		}
		else
		{
			clear_bit(&(Global_1853348[player_id() /*834*/].f_267.f_191[iVar0 /*13*/].f_5), bParam1);
		}
...
int func_307(int iParam0)
{
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			Var8.f_0 = get_hash_key(func_240(iLocal_517));
			Var8.f_1 = iVar6;
			Var8.f_2 = iParam0;
			_0x675D19C6067CAE08(iVar2, &Var8, 0, 1);
		}
		iLocal_503 = 1;
		if (func_25())
		{
			...
			if (func_292(func_300()))
			{
				if (func_291(func_300()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						net_gameserver_set_telemetry_nonce_seed(func_294(func_300()));
						if (!bParam10)
						{
...
{
	if (!func_28(player_id(), iParam1, iParam0) && network_can_spend_money(func_19(iParam0, iParam1), false, true, false, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_312(bool bParam0)
{
	...
	{
		Global_1640649[bParam0] = get_cloud_time_as_int();
...
void func_314(int iParam0, bool bParam1)
{
	...
	iVar0 = func_324(player_id(), iParam0);
	if (!func_323(iVar0))
	{
		return;
	}
	...
	if (iParam0 < 4)
	{
		...
		clear_bit(&(Global_1853348[player_id() /*834*/].f_267.f_295.f_2), bVar1);
	}
	else
	{
		clear_bit(&(Global_1853348[player_id() /*834*/].f_267.f_295.f_3), bVar1);
	}
	if (bParam1)
	{
...
void func_331()
{
	...
	bVar0 = func_466(iLocal_517);
	if (func_25() && func_465(player_id(), iLocal_517) > 0)
	{
		iVar1 = func_301(1);
		iLocal_697 = 1;
		while (!func_290(bVar0, iVar1, &iLocal_700))
		...
		{
			iLocal_700 = 0;
			iVar2 = func_465(player_id(), iLocal_517);
			...
			if (iLocal_700 == 2)
			{
				func_332(player_id(), iLocal_517, 1, 0, 0, 0);
				func_463(bVar0, 0, 0);
			}
		}
	}
...
{
	clear_bit(&Global_1640673, bParam0);
	clear_bit(&Global_1640673, bParam0 + 6);
}
		...
		case 1:
			if (func_292(func_300()))
			{
				if (func_291(func_300()) == 2)
				{
					...
					{
						net_gameserver_set_telemetry_nonce_seed(func_294(func_300()));
						iVar0 = func_219(player_id(), iParam0);
						iVar1 = func_27(iVar0);
						_network_earn_from_business_product(iParam2, get_hash_key(func_240(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_255(func_300());
				}
...
int func_355(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_27(iVar0);
	iVar2 = func_237(player_id(), iVar1);
...
void func_356(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1853348[player_id() /*834*/].f_267.f_191[iVar2 /*13*/] == 0)
		{
			bVar1 = iVar2;
		}
		else
...
void func_360()
{
	...
	Global_1640663 = get_cloud_time_as_int();
}
...
void func_361(int iParam0)
{
	...
	if (Global_1853348[player_id() /*834*/].f_267.f_191[iParam0 /*13*/] != 0 && Global_1640656[iParam0] != 0)
	{
		iVar0 = (get_cloud_time_as_int() - Global_1640656[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
...
{
	Global_1640656[iParam0] = get_cloud_time_as_int();
...
void func_364(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	clear_bit(&(Global_2815059.f_5195.f_14[iVar0]), bVar1);
}
...
void func_365(int iParam0)
{
	...
	bVar4 = false;
	sVar5 = get_name_of_zone(func_390(iVar0, 0));
	...
	iVar12 = func_465(player_id(), iVar0);
	iVar13 = func_387(player_id(), iVar0, iVar12, 1);
	iVar14 = 0;
	iVar15 = 0;
	iVar16 = 0;
	iVar17 = 0;
	...
	if (func_7(player_id(), iVar0))
	{
		...
		bVar4 = Global_1853348[player_id() /*834*/].f_267.f_191[iVar8 /*13*/].f_4 > 0;
	...
	begin_scaleform_movie_method(iLocal_688, "ADD_BUSINESS");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iVar2);
	_scaleform_movie_method_add_param_texture_name_string_2(&Var6);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar5);
	_scaleform_movie_method_add_param_texture_name_string_2(&Var6);
	...
	scaleform_movie_method_add_param_int(iVar27);
	...
	end_scaleform_movie_method();
	begin_scaleform_movie_method(iLocal_688, "ADD_BUSINESS_STATS");
	scaleform_movie_method_add_param_int(iParam0);
	...
	scaleform_movie_method_add_param_int(iVar24);
	end_scaleform_movie_method();
	begin_scaleform_movie_method(iLocal_688, "SET_START_PRODUCTION_STATUS");
	scaleform_movie_method_add_param_bool(bVar4);
	end_scaleform_movie_method();
}
...
int func_369(int iParam0)
{
	...
	iVar0 = func_466(iParam0);
	if ((func_7(player_id(), iParam0) && Global_1640666[iVar0] < Global_262145.f_18433) && !func_220(iVar0))
	{
		return 1;
	}
	return 0;
...
void func_392(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1853348[player_id() /*834*/].f_267.f_191[iVar1 /*13*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		Global_1853348[player_id() /*834*/].f_267.f_191[iVar0 /*13*/] = iParam0;
		if (func_214(iParam0))
		{
			Global_1853348[player_id() /*834*/].f_267.f_191[iVar0 /*13*/].f_12 = 0;
			func_417(9359, 0, -1);
...
int func_402(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		*iParam1 = func_466(iParam2);
		...
		if (iVar1 > 0)
		{
			if (!network_can_spend_money(iVar1, false, true, false, -1, 0))
			{
				func_412(get_hash_key(&cVar3), iVar1, 0);
				iLocal_699 = 1;
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", true);
				return 0;
			}
	...
	Var11.f_0 = get_hash_key(func_240(iParam0));
	...
	iParam2 = func_219(player_id(), *iParam1);
	...
	if (iParam2 == 0 || iParam2 == 32)
	{
		...
		_0x6FD97159FE3C971A(iVar4, &Var11, 0, 1);
	}
	else
	{
		if (iVar2 > 0)
		{
			...
			network_earn_from_property(iVar2, get_hash_key(func_240(iParam2)));
		}
		if (iVar4 > 0)
		{
			if (func_25())
			...
			_0xA51B086B0B2C0F7A(iVar4, &Var11, 0, 1);
		}
	}
	if (func_25())
	{
...
void func_414(int iParam0)
{
	...
	iVar0 = func_27(iParam0);
	iVar1 = func_237(player_id(), iVar0);
...
void func_415(int iParam0, int iParam1)
{
	...
	if (func_416(iParam0, iParam1))
	{
		...
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/] = iParam0;
		func_337(bVar0, 0);
		func_248(func_338(bVar0), 0, -1, 1, 0);
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_1 = 0;
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_11 = 0;
		func_248(func_339(bVar0), 0, -1, 1, 0);
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_4 = 0;
		func_417(func_340(bVar0), 0, -1);
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_5 = 0;
		func_248(func_306(bVar0, 2), 0, -1, 1, 0);
		func_248(func_306(bVar0, 0), 0, -1, 1, 0);
		func_248(func_306(bVar0, 1), 0, -1, 1, 0);
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_6 = 0;
		func_435(func_287(bVar0), 0, -1);
		if (bVar0 != 5)
		{
			func_401(bVar0);
		}
		Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_8 = 0;
		func_435(func_334(bVar0), 0, -1);
		if (func_214(iParam0))
		{
			Global_1853348[player_id() /*834*/].f_267.f_191[bVar0 /*13*/].f_12 = 0;
...
void func_421()
{
	...
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 206, true);
	if (is_control_just_pressed(2, 206))
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		...
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
		enable_control_action(2, 187, true);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_RELEASE_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_RELEASE_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (is_control_just_pressed(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
			iLocal_509 = 1;
		}
		enable_control_action(2, 187, true);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
			iLocal_509 = 1;
		}
	}
	...
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 190, true);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 201, true);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 202, true);
	if (is_control_just_pressed(2, 202))
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1f, -1f);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	enable_control_action(2, 204, true);
	if (is_control_just_pressed(2, 204))
	{
		call_scaleform_movie_method_with_number(iLocal_688, "SET_INPUT_EVENT", to_float(204), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		begin_scaleform_movie_method(iLocal_688, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			begin_scaleform_movie_method(iLocal_688, "SET_ANALOG_STICK_INPUT");
			iLocal_693 = iVar0;
			iLocal_694 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_693);
			scaleform_movie_method_add_param_int(iLocal_694);
			end_scaleform_movie_method();
			iLocal_509 = 1;
		}
	}
	...
	if (((iVar2 != 127 || iLocal_695 != 127) || iVar3 != 127) || iLocal_696 != 127)
	{
		...
		scaleform_movie_method_add_param_int(iLocal_695);
		scaleform_movie_method_add_param_int(iLocal_696);
		scaleform_movie_method_add_param_bool(bVar4);
		end_scaleform_movie_method();
		if (!bVar4)
		{
...
void func_422()
{
	...
	set_script_gfx_draw_order(1);
	draw_scaleform_movie_fullscreen(iLocal_688, 255, 255, 255, 255, 0);
	func_429();
	func_426(0);
	func_423(1);
...
void func_448()
{
	...
	{
		if (func_451(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_450(player_ped_id());
...
float func_461(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
void func_472()
{
	...
	if (func_490())
	{
		...
		if (!func_17(iLocal_517))
		{
			iVar3 = func_387(player_id(), iLocal_517, func_465(player_id(), iLocal_517), 1);
			fVar4 = (to_float(iVar3) * Global_262145.f_19111);
			iVar5 = round(fVar4);
			func_479(func_268(iLocal_517), &cVar7, &sVar6);
			func_478(iVar1, 1, &sVar6, &cVar7, iVar5, 1);
			func_479(!func_268(iLocal_517), &cVar7, &sVar6);
			fVar4 = (to_float(iVar3) * Global_262145.f_19112);
			iVar5 = round(fVar4);
		...
		while (iVar8 < 12)
		{
			...
			if (func_28(player_id(), iLocal_517, iVar9) || Global_1853348[player_id() /*834*/].f_267.f_191[iVar0 /*13*/].f_4 <= 0)
			{
				bVar10 = false;
			}
...
{
	begin_scaleform_movie_method(iLocal_688, "ADD_BUSINESS_UPGRADE");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iParam1);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam2);
	scaleform_movie_method_add_param_int(iParam3);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam6);
	scaleform_movie_method_add_param_int(iParam4);
	end_scaleform_movie_method();
	begin_scaleform_movie_method(iLocal_688, "SET_BUSINESS_UPGRADE_STATUS");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iParam1);
...
{
	begin_scaleform_movie_method(iLocal_688, "ADD_BUSINESS_BUYER");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iParam1);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam2);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam3);
	scaleform_movie_method_add_param_int(iParam4);
	end_scaleform_movie_method();
	begin_scaleform_movie_method(iLocal_688, "SET_BUSINESS_BUYER_STATUS");
	scaleform_movie_method_add_param_int(iParam0);
	scaleform_movie_method_add_param_int(iParam1);
	scaleform_movie_method_add_param_bool(bParam5);
	end_scaleform_movie_method();
...
void func_480(bool bParam0)
{
	...
	sVar0 = func_482(player_id());
	if (is_string_null_or_empty(sVar0))
	{
		sVar0 = func_481();
	}
	begin_scaleform_movie_method(iLocal_688, "SET_PLAYER_DATA");
	_scaleform_movie_method_add_param_texture_name_string_2(sVar0);
...
{
	if (((func_34(iParam0, 28) || func_34(player_id(), 28)) || func_489(iParam0)) && !func_487(iParam0))
	{
		return func_481();
	}
	if (iParam0 != player_id())
	{
		if (!func_486() && !network_check_user_content_privileges(0, -1, true))
		{
			return func_481();
		}
	}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_278(player_id(), 0) && !func_499()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_495(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_514(int iParam0)
{
	...
	set_scaleform_movie_as_no_longer_needed(&iLocal_688);
	func_507(iParam0);
	func_509(0);
	func_518();
	set_audio_script_cleanup_time(1000);
	play_sound_frontend(-1, "Exit", "DLC_Biker_Computer_Sounds", true);
	if (is_pc_version())
	{
		func_467(0, 1, 1, 1);
	}
	if (!func_506(player_id()) && !func_270(player_id()))
	{
		func_491(player_id(), 1, 0, 0);
	}
	if (func_471(7638, -1) && func_517())
	{
		Var0 = { func_516() };
		if (are_strings_equal(&Var0, "BPLES_TUT1"))
		{
			func_435(7638, 0, -1);
			func_515();
		}
