...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("ob_jukebox")) > 1)
	{
		func_211(0);
	}
	iLocal_115 = Global_1853348[player_id() /*834*/].f_267.f_32;
	...
	func_194(player_id(), &Var0);
	if (func_193(Var0))
	{
		if (network_is_gamer_in_my_session(&Var0))
		{
			iLocal_111 = network_get_player_from_gamer_handle(&Var0);
		}
	}
	if (iLocal_115 == 126)
	{
		iLocal_111 = func_186(player_id());
		start_audio_scene("dlc_ch_arcade_music_volume");
		set_audio_scene_variable("dlc_ch_arcade_music_volume", "ArcadeRadioVolumeDucking", Local_137.f_1);
	}
	...
	while (true)
	{
		...
		else if (iLocal_115 != -1 && iLocal_115 <= 128)
		{
			...
			if (iLocal_115 == 126)
			{
				iLocal_110 = get_closest_object_of_type(Local_134, 2f, joaat("ch_prop_arcade_jukebox_01a"), true, false, false);
			}
			else
			{
				iLocal_110 = get_closest_object_of_type(Local_134, 2f, joaat("bkr_prop_clubhouse_jukebox_01a"), true, false, false);
			}
			if (does_entity_exist(iLocal_110))
			{
				Local_135 = { get_entity_coords(iLocal_110, true) - get_entity_forward_vector(iLocal_110) * Vector(0.6f, 0.6f, 0.6f) };
				Local_135.f_2 = (Local_135.f_2 + 0.5f);
				Local_136 = { get_offset_from_entity_in_world_coords(iLocal_110, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
void func_6()
{
	if (iLocal_111 == player_id() && func_174())
	{
...
void func_8(int iParam0)
{
	...
	if (iLocal_115 == 126)
	{
		...
		iVar1 = (get_cloud_time_as_int() - iLocal_121);
	...
	else
	{
		...
		iVar3 = (get_cloud_time_as_int() - iLocal_121);
	...
	iLocal_121 = get_cloud_time_as_int();
}
...
{
	Global_1853348[player_id() /*834*/].f_267.f_363 = uParam0;
}
...
void func_21()
{
	...
	{
		func_179(Local_137.f_3);
		if (iLocal_111 == player_id() && Local_137.f_4)
		{
			if (iLocal_115 == 126)
			{
	...
	{
		func_176(bVar0);
		if ((iLocal_111 == player_id() && Local_137.f_4) && !bVar0)
		{
			if (iLocal_115 == 126)
			{
	...
	switch (iLocal_127)
	{
		case 0:
			if (func_163() && func_162())
			{
				...
				else if ((iLocal_117 != -1 && func_158(iLocal_117, 1)) && !is_ped_running(player_ped_id()))
				{
					func_157(2);
					func_155(&iLocal_117);
					func_145(player_id(), 0, 256, 0);
					set_bit(&(Local_138[player_id() /*3*/]), 0);
					set_bit(&Global_2787701, 4);
				}
				set_bit(&Global_2787701, 3);
			}
			else if (iLocal_117 != -1)
			{
				func_155(&iLocal_117);
				clear_bit(&Global_2787701, 3);
			}
		...
		case 2:
			if (Local_137.f_2 == player_id() && func_142())
			{
				iLocal_118 = 0;
				func_157(1);
				clear_bit(&(Local_138[player_id() /*3*/]), 0);
				set_bit(&(Local_138[player_id() /*3*/]), 1);
				func_141(&uLocal_130);
			}
			else if (Local_137.f_2 != -1 || !func_142())
			{
				func_157(0);
				clear_bit(&(Local_138[player_id() /*3*/]), 0);
				clear_bit(&Global_2787701, 4);
				func_145(player_id(), 1, 0, 0);
			}
			break;
		...
		case 1:
			...
			{
				iLocal_114 = 0;
				set_bit(&uLocal_120, 1);
				func_157(3);
				if (!network_can_spend_money(1, false, false, false, -1, 0))
				{
					iLocal_126 = 1;
				}
			}
		...
		case 4:
			...
			{
				clear_bit(&uLocal_120, 3);
				func_39(1, -1);
			}
			iVar0 = network_get_local_scene_from_network_id(iLocal_119);
			if (!is_entity_playing_anim(player_ped_id(), sLocal_125, "EXIT", 3))
			{
				func_30(BitTest(uLocal_120, 5));
				if (iLocal_113 != -1)
				{
					if ((is_entity_playing_anim(player_ped_id(), sLocal_125, "INSERT_COINS", 3) && get_synchronized_scene_phase(iVar0) >= 0.82f) || !BitTest(uLocal_120, 5))
					{
						func_29(iLocal_113);
					}
				}
			}
			else if (get_synchronized_scene_phase(iVar0) >= 0.96f)
			{
				clear_bit(&uLocal_120, 5);
				clear_bit(&uLocal_120, 4);
				clear_bit(&(Local_138[player_id() /*3*/]), 1);
				clear_bit(&(Local_138[player_id() /*3*/]), 2);
				clear_bit(&(Local_138[player_id() /*3*/]), 3);
				func_145(player_id(), 1, 0, 0);
				clear_bit(&Global_2787701, 4);
				iLocal_126 = 0;
				if (iLocal_115 == 126)
				...
				_playstats_mc_clubhouse_activity(func_27(func_28()), func_26(func_28()), func_25(), func_24(), 4, iLocal_123, 0);
				func_157(0);
			}
			break;
	}
...
{
	Local_138[player_id() /*3*/].f_1 = iParam0;
	set_bit(&(Local_138[player_id() /*3*/]), 2);
}
...
int func_38(char* sParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = network_get_local_scene_from_network_id(iLocal_119);
	request_anim_dict(sLocal_125);
	if (has_anim_dict_loaded(sLocal_125))
	{
		if ((!is_synchronized_scene_running(iVar0) || get_synchronized_scene_phase(iVar0) >= 0.96f) || bParam1)
		{
			if (is_synchronized_scene_running(iLocal_119))
			{
				detach_synchronized_scene(iLocal_119);
				iLocal_119 = -1;
			}
			iLocal_119 = network_create_synchronised_scene(Local_136, get_entity_rotation(iLocal_110, 2), 2, false, bParam2, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_119, sLocal_125, sParam0, 4f, -2f, 5, 0, 2f, 0);
			network_start_synchronised_scene(iLocal_119);
			return 1;
		}
	}
	return 0;
		...
		if (iVar5 == 1 && Global_23150.f_6119)
		{
			...
			if (get_hash_key(&(Global_23150.f_5081)) != 0 && Global_23150.f_5157 != -1)
			{
				...
				if (Global_23150.f_5159 != 0)
				{
					...
					draw_sprite(func_69(Global_23150.f_5159), func_66(Global_23150.f_5159, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
			...
			if (get_hash_key(&(Global_4539885.f_21)) != 0 && Global_4539885.f_65 != -1)
			{
				...
				if (Global_4539885.f_67 != 0)
				{
					...
					draw_sprite(func_69(Global_4539885.f_67), func_66(Global_4539885.f_67, 1), ((Global_23147 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
				}
				fVar49 = (fVar49 + (((get_rendered_character_height(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_76(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_76(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_69(26), func_66(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
										if (func_76(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_76(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													draw_sprite(func_69(27), func_66(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
												}
											}
										}
									}
												...
												if (func_76(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_76(Global_23150.f_4824[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_69(Global_23150.f_4824[(iVar22 + iVar28)]), func_66(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_69(Global_23150.f_4824[(iVar22 + iVar28)]), func_66(Global_23150.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
									...
									if (get_hash_key(&(Global_23150.f_79[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_49() && _get_number_of_references_of_script_with_name_hash(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
													if (Global_23150.f_2130[iVar24])
												...
												if (func_76(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_76(Global_23150.f_4824[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																draw_sprite(func_69(Global_23150.f_4824[(iVar22 + iVar14)]), func_66(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (Global_23147 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else if (Global_23150.f_5474[iVar8] == 2)
															{
																draw_sprite(func_69(Global_23150.f_4824[(iVar22 + iVar14)]), func_66(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
															else
															{
																draw_sprite(func_69(Global_23150.f_4824[(iVar22 + iVar14)]), func_66(Global_23150.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
															}
														}
													}
									...
									if (func_76(Global_23150.f_4824[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_76(Global_23150.f_4824[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												draw_sprite(func_69(Global_23150.f_4824[iVar22]), func_66(Global_23150.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_46(Global_23150.f_4824[iVar22])), (fVar37 * func_46(Global_23150.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, false, 0);
											}
										}
									}
								}
...
int func_78(bool bParam0, bool bParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_80(8, -1) && func_79() != 65)) || (get_pause_menu_state() != 0 && !bParam1)) || (is_player_switch_in_progress() && !bParam0)) || is_commerce_store_open()) || Global_78579) || Global_23150.f_8807) || is_warning_message_active()) || Global_100493.f_1458)
	{
		return 0;
	}
	return 1;
...
void func_84()
{
	...
	else
	{
		...
		if (((iLocal_115 != 126 && iLocal_111 == player_id()) && func_86()) && iLocal_114 == (func_85() - 1))
		{
...
int func_85()
{
	if (iLocal_115 == 126)
	{
		if (iLocal_111 == player_id() && func_86())
		{
			return 10;
		}
		return 9;
...
void func_98()
{
	...
	while (iVar1 < iVar0)
	{
		...
		if (((iLocal_115 != 126 && iLocal_111 == player_id()) && func_86()) && iVar1 == (func_85() - 1))
		{
...
void func_103()
{
	...
	bVar7 = (is_control_just_pressed(2, 202) || is_disabled_control_just_pressed(2, 202));
	iVar0 = get_control_value(2, 196);
	if (!BitTest(uLocal_120, 0))
	{
		...
		{
			bVar2 = (iVar0 < 100 || is_control_pressed(2, 188));
			bVar3 = (iVar0 > 150 || is_control_pressed(2, 187));
			bVar4 = is_control_pressed(2, 52);
			bVar5 = is_control_pressed(2, 51);
		}
		if (((bVar2 || bVar3) || bVar4) || bVar5)
		{
			func_19(&uLocal_128, 0, 0);
			set_bit(&uLocal_120, 0);
		}
	}
	else if (func_18(&uLocal_128, iVar1, 0))
	{
		func_141(&uLocal_128);
		clear_bit(&uLocal_120, 0);
	}
	if (bVar3)
	{
		iLocal_114++;
...
void func_104(int iParam0)
{
	...
	if (func_5(iLocal_115, -1))
	{
		iVar0 = get_hash_key(func_119(iParam0));
	}
	else if (iLocal_115 == 126)
	{
		iVar0 = get_hash_key(func_118(iParam0));
	}
	if (network_can_spend_money(1, false, false, true, -1, 0))
	{
		if (func_117())
		{
		...
		{
			_network_spent_jukebox(1, iVar0, 0, 0);
		}
	}
}
...
int func_106(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (!bVar0)
	{
		if (!net_gameserver_is_session_valid(func_15()) || net_gameserver_is_session_refresh_pending())
		{
			Global_4535607 = 1;
			return 0;
		}
...
void func_114(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	struct<3> Var0;
	int iVar1;
...
{
	Local_138[player_id() /*3*/].f_2 = fParam0;
	set_bit(&(Local_138[player_id() /*3*/]), 3);
}
...
void func_122(var uParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, var uParam5)
{
	if (is_pc_version() && !_network_is_text_chat_active())
	{
		if (_is_using_keyboard_2(2))
		{
			...
			{
				enable_control_action(1, 1, true);
				enable_control_action(1, 2, true);
			}
			else
			{
				disable_control_action(1, 1, true);
				disable_control_action(1, 2, true);
			}
			func_128(0, 0, 0, 1);
			func_127(0, -1, 1);
		}
		...
		if (func_124(0, 0, 0) || is_control_pressed(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_123(0, 0, 0) || is_control_pressed(2, 187))
		{
			*uParam1 = 1;
		}
...
int func_136()
{
	...
	switch (iLocal_118)
	{
		case 0:
			func_31(0);
			Var0 = { get_offset_from_entity_in_world_coords(iLocal_110, 0.06f, -0.8958f, 0.2f) };
			...
			if (!func_140(get_entity_coords(player_ped_id(), true), Var0, 0.8f, 0))
			{
				if (!func_137(player_ped_id(), 2106541073))
				{
					task_go_straight_to_coord(player_ped_id(), Var0, 1f, 4000, get_entity_heading(iLocal_110), 0.125f);
				}
			}
			else
			{
...
int func_140(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_56(player_id(), 0) && !func_153()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_149(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_160()
{
	if (is_help_message_being_displayed() && func_161("JBOX_NO_MONEY"))
	{
		clear_help(true);
	}
}
...
int func_162()
{
	if (func_174() || network_can_spend_money(1, false, false, false, -1, 0))
	{
		return 1;
	}
	return 0;
...
int func_163()
{
	...
	iVar0 = 1;
	if (func_210(player_id()) && !func_182(iLocal_111))
	{
		iVar0 = 0;
	}
	if ((((((((((((((!BitTest(Global_2787701, 5) && !func_170()) && !func_36(0)) && !func_169()) && !is_ped_in_cover(player_ped_id(), false)) && get_room_key_from_entity(player_ped_id()) == get_room_key_from_entity(iLocal_110)) && is_entity_at_coord(player_ped_id(), Local_135, 0.55f, 0.8f, 1.5f, false, true, 1)) && !is_entity_playing_anim(player_ped_id(), sLocal_125, "EXIT", 3)) && !func_168(player_id())) && !func_167()) && iVar0) && !BitTest(Global_1946250.f_4, 2)) && func_164(player_ped_id()) <= 9) && !Global_2667225.f_2681) && !is_ped_ragdoll(player_ped_id()))
	{
		return 1;
	}
	return 0;
...
void func_176(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&uLocal_120, 6);
	}
	else
	{
		clear_bit(&uLocal_120, 6);
	}
	if (func_5(iLocal_115, -1))
	{
...
{
	set_static_emitter_enabled("DLC_H3_Arcade_Main_Area_Music_Emitter", bParam0);
	set_static_emitter_enabled("DLC_H3_Arcade_Planning_Room_Radio_Emitter", bParam0);
}
...
void func_178(int iParam0, bool bParam1)
{
	if (func_4(iParam0) == 97)
	{
		set_static_emitter_enabled("SE_bkr_biker_dlc_int_02_REC", bParam1);
		set_static_emitter_enabled("SE_bkr_biker_dlc_int_02_GRG", bParam1);
		return;
	}
	else if (func_4(iParam0) == 91)
	{
		set_static_emitter_enabled("SE_bkr_biker_dlc_int_01_BAR", bParam1);
		set_static_emitter_enabled("SE_bkr_biker_dlc_int_01_GRG", bParam1);
		set_static_emitter_enabled("SE_bkr_biker_dlc_int_01_REC", bParam1);
		return;
	}
}
...
void func_179(int iParam0)
{
	if (func_5(iLocal_115, -1))
	{
		...
		{
			if (iLocal_111 == player_id() && iLocal_121 != 0)
			{
				func_8(iLocal_112);
			}
...
void func_180(int iParam0)
{
	...
	set_emitter_radio_station("DLC_H3_Arcade_Main_Area_Music_Emitter", sVar0);
	set_emitter_radio_station("DLC_H3_Arcade_Planning_Room_Radio_Emitter", sVar0);
}
...
void func_181(int iParam0, int iParam1)
{
	...
	if (func_4(iParam0) == 97)
	{
		set_emitter_radio_station("SE_bkr_biker_dlc_int_02_REC", sVar0);
		set_emitter_radio_station("SE_bkr_biker_dlc_int_02_GRG", sVar0);
		return;
	}
	else if (func_4(iParam0) == 91)
	{
		set_emitter_radio_station("SE_bkr_biker_dlc_int_01_BAR", sVar0);
		set_emitter_radio_station("SE_bkr_biker_dlc_int_01_GRG", sVar0);
		set_emitter_radio_station("SE_bkr_biker_dlc_int_01_REC", sVar0);
		return;
	}
}
...
int func_191(int iParam0)
{
	if (iParam0 != func_185())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_192(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
void func_195()
{
	...
	if (network_is_game_in_progress() && !BitTest(uLocal_120, 2))
	{
		iVar0 = Global_1310720.f_1440;
		if (func_203(player_id()))
		{
			iVar0 = func_202() + 32;
		}
		...
		network_register_host_broadcast_variables(&Local_137, 5, 0);
		network_register_player_broadcast_variables(&Local_138, 97, 0);
		if (!func_196())
		{
			func_211(0);
		}
		set_bit(&uLocal_120, 2);
	}
}
...
int func_203(int iParam0)
{
	if (iParam0 != func_185())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_192(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_204()
{
	...
	else if (iLocal_115 != Global_1853348[player_id() /*834*/].f_267.f_32)
	{
		func_211(0);
	}
}
...
void func_211(bool bParam0)
{
	...
	set_bit(&Global_2787701, 2);
	if (iLocal_117 != -1)
	{
		func_155(&iLocal_117);
	}
	if (iLocal_111 == player_id())
	{
		func_8(iLocal_112);
	}
	if (is_help_message_being_displayed() && func_161("JBOX_NO_MONEY"))
...
void func_212()
{
	...
	{
		if (((is_entity_playing_anim(player_ped_id(), sLocal_125, "IDLE", 3) || is_entity_playing_anim(player_ped_id(), sLocal_125, "EXIT", 3)) || is_entity_playing_anim(player_ped_id(), sLocal_125, "INSERT_COINS", 3)) || is_entity_playing_anim(player_ped_id(), sLocal_125, "SELECT_TRACK", 3))
		{
