...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((network_is_game_in_progress() && network_is_activity_session()) && !func_41())
		{
			if (Global_4718592 == 0 && (Global_4718592.f_2 == 7 || Global_4718592.f_2 == 1))
			{
				if (func_36(player_id()) || func_35(player_id()))
				{
		...
		else
		{
			...
			switch (iLocal_150)
			{
				...
				case 1:
					Local_47.f_3.f_26 = 1;
					if (iLocal_151 == 0 && !BitTest(Global_1853348[player_id() /*834*/].f_36.f_18, 30))
					{
					...
					{
						if (BitTest(Global_1853348[player_id() /*834*/].f_36.f_18, 29))
						{
							if (func_2())
							{
								func_1();
...
int func_6()
{
	if (BitTest(Global_1853348[player_id() /*834*/].f_36.f_18, 30))
	{
		return 0;
	}
	if (BitTest(Global_1853348[player_id() /*834*/].f_36.f_18, 29))
	...
	if (((((((((((((((func_29() == 0 && !func_28()) && !func_2()) && !func_27()) && !func_26()) && !func_25()) && !func_24()) && !func_23()) && !func_22()) && func_19()) && func_12()) && Global_1853348[player_id() /*834*/].f_95 != 8) && Global_1853348[player_id() /*834*/].f_95 != 9) && !func_10(player_id())) && !func_9()) && !func_7(player_id(), 1, 0))
	{
		return 1;
	}
	return 0;
	...
	switch (*uParam0)
	{
		...
		case 6:
			...
			if ((uParam0->f_1 + uParam0->f_2) > 2000)
			{
				...
				else if (network_player_is_cheater())
				{
					func_4(uParam0, 10);
				}
				else
...
int func_46(var uParam0, var* uParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	switch (uParam0->f_4)
	{
		case 0:
			...
			if (func_307())
			{
				ugc_set_query_data_from_offline(true);
			}
			else
			{
				ugc_set_query_data_from_offline(false);
			}
			if (uParam0->f_14 == 0)
			{
				switch (iParam5)
		...
		case 1:
			if (func_307())
			{
				...
				{
					ugc_set_query_data_from_offline(true);
					if (datafile_load_offline_ugc("RockstarPlaylists", 0))
					{
				...
				{
					ugc_set_query_data_from_offline(true);
					ugc_policies_make_private(iParam4);
					func_34(uParam0, 2);
				}
			}
		...
		case 2:
			if ((ugc_is_getting() || ugc_did_get_succeed()) && ugc_get_content_num() > 0)
			{
				uParam0->f_10 = (uParam0->f_10 + ugc_get_content_num());
				uParam0->f_7 = 0;
				while (uParam0->f_7 <= (ugc_get_content_num() - 1))
				{
					if (datafile_select_ugc_data(uParam0->f_7, 0))
					{
						switch (iParam5)
						{
							case 0:
						...
						case 0:
							switch (iParam4)
							{
								...
								case 2:
									...
									{
										func_33(uParam0, 1, 1);
										Global_794709.f_3 = get_cloud_time_as_int();
										func_275();
										ugc_cancel_query();
										*uParam0 = 1;
										return 1;
								...
								case 6:
									if (uParam0->f_9 > 100)
									{
										...
										if (bParam10)
										{
											Global_1009429.f_2 = get_cloud_time_as_int();
										}
										else
										{
											Global_998606.f_2 = get_cloud_time_as_int();
										}
										func_275();
										ugc_cancel_query();
										*uParam0 = 1;
			...
			if (ugc_has_get_finished())
			{
				if (ugc_did_get_succeed())
				{
					if (iParam5 == 0 && (iParam4 == 1 || iParam4 == 2))
					{
						if (ugc_get_content_total() == 0)
						{
							if (uParam0->f_11 < 3)
							{
								uParam0->f_11++;
					...
					if (ugc_get_content_total() != 0)
					{
						uParam0->f_13 = ugc_get_content_total();
					}
					if (bParam10)
					{
						if (iParam2 == 8)
					...
					if (iParam4 == 1)
					{
						Global_794709.f_1 = ugc_get_content_hash();
						iVar1 = uParam0->f_9;
						if (iVar1 == 0)
						{
							iVar1 = uParam0->f_13;
				...
				else if (iParam5 == 0 && (iParam4 == 1 || iParam4 == 2))
				{
					...
					else
					{
						...
						uParam0->f_41 = ugc_get_query_result();
						func_34(uParam0, 1);
						func_274(1, 1, 0);
						uParam0->f_10 = 0;
						uParam0->f_8 = 0;
	...
	if (bParam0)
	{
		...
		while (iVar0 < iVar4)
		{
			...
			if (BitTest(Global_1835448[iVar1], bVar2))
			{
				...
				clear_bit(&(Global_1835448[iVar1]), bVar2);
				return;
			}
			clear_bit(&(Global_1835448[iVar1]), bVar2);
			iVar0++;
...
void func_54(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_60(ugc_get_content_category(uParam0->f_7)))
	{
		func_276();
		return;
	}
	if (!func_58(uParam0->f_24, uParam0->f_25, ugc_get_content_user_id(uParam0->f_7), ugc_get_content_category(uParam0->f_7)))
	{
		func_276();
		return;
	}
	...
	{
		if (func_56(ugc_get_content_user_id(uParam0->f_7)))
		{
			func_276();
			return;
		}
	...
	{
		Var4 = { func_55(player_id()) };
		network_clan_player_get_desc(&iVar3, 35, &Var4);
		Global_1053582.f_935 = iVar3;
	}
	sVar0 = datafile_get_file_dict(0);
	sVar1 = datadict_get_dict(sVar0, "data");
	sVar2 = datadict_get_dict(sVar1, "trg");
	iVar3 = datadict_get_int(sVar1, "crew");
	...
	{
		bVar5 = datadict_get_bool(sVar1, "open");
		if (!bVar5)
		{
			func_276();
			return;
	...
	StringCopy(&(Global_1053582.f_354[uParam0->f_9 /*16*/]), datadict_get_string(sVar1, "crewnm"), 64);
	StringCopy(&(Global_1053582[uParam0->f_9 /*16*/]), ugc_get_content_name(uParam0->f_7), 64);
	StringCopy(&(Global_1053582.f_257[uParam0->f_9 /*6*/]), ugc_get_content_id(uParam0->f_7), 24);
	Global_1053582.f_884[uParam0->f_9] = datadict_get_int(sVar1, "cash");
	Global_1053582.f_901[uParam0->f_9] = datadict_get_int(sVar2, "scr");
	Global_1053582.f_918[uParam0->f_9] = datadict_get_int(sVar2, "time");
	Global_1053582.f_936 = uParam0->f_9 + 1;
	if (!is_string_null_or_empty(&(Global_1053582[uParam0->f_9 /*16*/])) && !is_string_null_or_empty(&(Global_1053582.f_257[uParam0->f_9 /*6*/])))
	{
		uParam0->f_9++;
	}
	func_276();
...
int func_56(char* sParam0)
{
	...
	Var1 = { func_55(player_id()) };
	if (network_are_handles_the_same(&Var1, &Var0))
	{
		return 1;
	}
	return 0;
...
struct<13> func_57(char* sParam0)
{
	...
	network_handle_from_user_id(sParam0, &Var0, 13);
	return Var0;
}
...
int func_58(int iParam0, bool bParam1, char* sParam2, int iParam3)
{
	...
	if (iParam0 == 0)
	{
		...
		if (bParam1)
		{
			...
			else if (!network_is_friend(&Var0))
			{
				return 0;
			}
		}
		else if (func_59())
		{
			...
			else if ((unk_0x559EBF901A8C68E0(&Var0) && network_has_view_gamer_user_content_result(&Var0)) && !network_can_view_gamer_user_content(&Var0))
			{
				return 0;
			}
		}
...
void func_62(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	StringCopy(uParam1[uParam0->f_9 /*16*/], ugc_get_content_name(uParam0->f_7), 64);
	StringCopy(&(uParam1->f_513[uParam0->f_9 /*6*/]), ugc_get_content_id(uParam0->f_7), 24);
	sVar2 = datafile_get_file_dict(0);
	uVar3 = datadict_get_array(sVar2, "list");
	if (bParam2)
	{
		if (datadict_get_type(sVar2, "h2h") == 1)
		{
			bVar0 = datadict_get_bool(sVar2, "h2h");
		}
		if (datadict_get_type(sVar2, "h2h") == 1)
		{
			bVar1 = datadict_get_bool(sVar2, "ch");
		}
		if (bVar0)
		{
			set_bit(&(uParam1->f_1865), uParam0->f_9);
		}
		if (bVar1)
		{
			set_bit(&(uParam1->f_1866), uParam0->f_9);
		}
	}
	iVar4 = dataarray_get_count(uVar3);
	iVar5 = 0;
	while (iVar5 <= (iVar4 - 1))
	{
		uVar6[iVar5] = dataarray_get_dict(uVar3, iVar5);
		if (datadict_get_type(uVar6[iVar5], "type") == 2)
		{
			uParam1->f_1219[uParam0->f_9 /*17*/][iVar5] = datadict_get_int(uVar6[iVar5], "type");
		}
		iVar5++;
	}
	uParam1->f_1864 = uParam0->f_9;
	if (!is_string_null_or_empty(uParam1[uParam0->f_9 /*16*/]) && !is_string_null_or_empty(&(uParam1->f_513[uParam0->f_9 /*6*/])))
	{
		uParam0->f_9++;
	}
	uParam1->f_1864++;
...
void func_63(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	StringCopy(uParam1[uParam0->f_9 /*16*/], ugc_get_content_name(uParam0->f_7), 64);
	StringCopy(&(uParam1->f_257[uParam0->f_9 /*6*/]), ugc_get_content_id(uParam0->f_7), 24);
	sVar2 = datafile_get_file_dict(0);
	uVar3 = datadict_get_array(sVar2, "list");
	if (bParam2)
	{
		...
		if (bVar0)
		{
			set_bit(&(uParam1->f_937), uParam0->f_9);
		}
		if (bVar1)
		{
			set_bit(&(uParam1->f_938), uParam0->f_9);
		}
	}
	iVar4 = dataarray_get_count(uVar3);
	if (iVar4 != 0)
	{
		...
		{
			uVar6[iVar5] = dataarray_get_dict(uVar3, iVar5);
			uParam1->f_611[uParam0->f_9 /*17*/][iVar5] = datadict_get_int(uVar6[iVar5], "type");
			iVar5++;
		}
	}
	uParam1->f_936 = uParam0->f_9;
	if (!is_string_null_or_empty(uParam1[uParam0->f_9 /*16*/]) && !is_string_null_or_empty(&(uParam1->f_257[uParam0->f_9 /*6*/])))
	{
		uParam0->f_9++;
	}
	uParam1->f_936++;
...
void func_64(var uParam0, bool bParam1)
{
	...
	sVar0 = datafile_get_file_dict(0);
	sVar1 = datadict_get_dict(sVar0, "mission");
	sVar2 = datadict_get_dict(sVar1, "gen");
	iVar3 = uParam0->f_9;
	iVar4 = datadict_get_int(sVar2, "type");
	iVar5 = get_hash_key(ugc_get_root_content_id(uParam0->f_7));
	if (bParam1 == 0)
	{
		if (!func_60(ugc_get_content_category(uParam0->f_7)))
		{
		...
		if (func_112(iVar5) && !func_111(player_id()))
		{
			func_276();
			return;
		}
		...
		iVar6 = datadict_get_int(sVar2, "rank");
		if (iVar6 > 1000)
		{
			if (datafile_get_file_dict(0) != 0)
			{
		...
		if (datadict_get_int(sVar2, "type") == 0 && (datadict_get_int(sVar2, "subtype") == 7 || datadict_get_int(sVar2, "subtype") == 1))
		{
			func_276();
			return;
		}
	...
	else
	{
		...
		{
			if ((datadict_get_int(sVar2, "type") == 0 || datadict_get_type(sVar2, "type") != 2) && datadict_get_int(sVar2, "subtype") == 6)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
		...
		{
			if ((datadict_get_int(sVar2, "type") == 0 || datadict_get_type(sVar2, "type") != 2) && datadict_get_int(sVar2, "subtype") == 5)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
		...
		{
			if (datadict_get_int(sVar2, "type") == 2)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
		...
		{
			if (datadict_get_int(sVar2, "type") == 1)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
	...
	if (datadict_get_type(sVar2, "cam") == 5)
	{
		Global_1036842.f_33[iVar3 /*88*/].f_59 = { func_106(sVar2, "cam") };
	}
	else if (datadict_get_type(sVar2, "cam") == 6)
	{
		sVar8 = datadict_get_dict(sVar2, "cam");
		if (datadict_get_type(sVar8, "x") == 2)
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59 = to_float(datadict_get_int(sVar8, "x"));
		}
		else
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59 = datadict_get_float(sVar8, "x");
		}
		if (datadict_get_type(sVar8, "y") == 2)
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_1 = to_float(datadict_get_int(sVar8, "y"));
		}
		else
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_1 = datadict_get_float(sVar8, "y");
		}
		if (datadict_get_type(sVar8, "z") == 2)
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_2 = to_float(datadict_get_int(sVar8, "z"));
		}
		else
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_2 = datadict_get_float(sVar8, "z");
		}
	}
	Global_1036842.f_33[iVar3 /*88*/].f_62 = { func_105(sVar2) };
	Global_1036842.f_33[iVar3 /*88*/].f_69 = datadict_get_int(sVar2, "min");
	Global_1036842.f_33[iVar3 /*88*/].f_71 = datadict_get_int(sVar2, "num");
	if (Global_1036842.f_33[iVar3 /*88*/].f_71 == -1)
	{
		Global_1036842.f_33[iVar3 /*88*/].f_71 = func_104();
	}
	StringCopy(&(Global_1036842.f_33[iVar3 /*88*/].f_22), ugc_get_content_name(uParam0->f_7), 64);
	Global_1036842.f_33[iVar3 /*88*/].f_81 = ugc_get_content_category(uParam0->f_7);
	Global_1036842.f_33[iVar3 /*88*/].f_68 = datadict_get_int(sVar2, "subtype");
	Global_1036842.f_33[iVar3 /*88*/].f_80 = datadict_get_int(sVar2, "adverm");
	Global_1036842.f_33[iVar3 /*88*/].f_70 = datadict_get_int(sVar2, "rank");
	Global_1036842.f_33[iVar3 /*88*/].f_73 = func_103(ugc_get_content_rating(uParam0->f_7, 0), ugc_get_content_rating_count(uParam0->f_7, 0));
	StringCopy(&(Global_1036842.f_33[iVar3 /*88*/]), ugc_get_content_id(uParam0->f_7), 24);
	Global_1036842.f_33[iVar3 /*88*/].f_55 = _0xAEAB987727C5A8A4(uParam0->f_7);
	if (func_102() != 2)
	{
	...
	StringCopy(&(Global_1036842.f_33[iVar3 /*88*/].f_6), ugc_get_content_user_name(uParam0->f_7), 64);
	ugc_get_content_updated_date(uParam0->f_7, &(Global_1036842.f_33[iVar3 /*88*/].f_82));
	Global_1036842.f_2762[iVar3] = 0;
	if (!func_307())
	{
		if (ugc_is_language_supported(ugc_get_content_language(uParam0->f_7)))
		{
			Global_1036842.f_33[iVar3 /*88*/].f_54 = ugc_get_content_description_hash(uParam0->f_7);
		}
		else
		{
		...
		Global_1036842.f_33[iVar3 /*88*/].f_66 = ugc_get_content_file_version(uParam0->f_7, Global_1036842.f_33[iVar3 /*88*/].f_67);
		if (ugc_get_content_has_player_record(uParam0->f_7))
		{
			Global_1036842.f_2762[iVar3] = ugc_get_content_has_player_bookmarked(uParam0->f_7);
		}
	}
	Global_1036842.f_33[iVar3 /*88*/].f_75 = datadict_get_int(sVar2, "charcon");
	Global_1036842.f_33[iVar3 /*88*/].f_72 = datadict_get_int(sVar2, "tnum");
	...
	Global_1036842.f_33[iVar3 /*88*/].f_76 = datadict_get_int(sVar2, "optbs");
	if (BitTest(Global_1036842.f_33[iVar3 /*88*/].f_76, 27))
	{
		bVar9 = true;
	}
	Global_1036842.f_33[iVar3 /*88*/].f_76 = 0;
	set_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 13);
	if (bVar9)
	{
		set_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 27);
	}
	clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 15);
	clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 18);
	clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 19);
	clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 29);
	clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 28);
	func_66(get_hash_key(ugc_get_root_content_id(uParam0->f_7)), &(Global_1036842.f_33[iVar3 /*88*/].f_76), &(Global_1036842.f_33[iVar3 /*88*/].f_77), Global_1036842.f_33[iVar3 /*88*/].f_80);
	set_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 13);
	if (is_string_null_or_empty(&(Global_1036842.f_33[iVar3 /*88*/])))
	{
		clear_bit(&(Global_1036842.f_33[iVar3 /*88*/].f_76), 13);
	}
...
{
	if (_0x7FCC39C46C3C03BD(iParam0))
	{
		return 2;
	}
	else if (_0x1D610EB0FEA716D9(iParam0))
	{
		return 1;
	}
	return 1;
...
Vector3 func_105(char* sParam0)
{
	...
	if (datadict_get_type(sParam0, "camp") == 3)
	{
		Var0.f_0 = datadict_get_float(sParam0, "camp");
	}
	else if (datadict_get_type(sParam0, "camp") == 2)
	{
		Var0.f_0 = to_float(datadict_get_int(sParam0, "camp"));
	}
	if (datadict_get_type(sParam0, "camh") == 3)
	{
		Var0.f_2 = datadict_get_float(sParam0, "camh");
	}
	else if (datadict_get_type(sParam0, "camh") == 2)
	{
		Var0.f_2 = to_float(datadict_get_int(sParam0, "camh"));
	}
	return Var0;
}
...
Vector3 func_106(char* sParam0, char* sParam1)
{
	...
	if (datadict_get_type(sParam0, sParam1) == 5)
	{
		Var0 = { datadict_get_vector(sParam0, sParam1) };
	}
	else if (datadict_get_type(sParam0, sParam1) == 6)
	{
		uVar1 = datadict_get_dict(sParam0, sParam1);
		if (datadict_get_type(uVar1, "x") == 2)
		{
			Var0.f_0 = to_float(datadict_get_int(sVar1, "x"));
		}
		else
		{
			Var0.f_0 = datadict_get_float(sVar1, "x");
		}
		if (datadict_get_type(sVar1, "y") == 2)
		{
			Var0.f_1 = to_float(datadict_get_int(sVar1, "y"));
		}
		else
		{
			Var0.f_1 = datadict_get_float(sVar1, "y");
		}
		if (datadict_get_type(sVar1, "z") == 2)
		{
			Var0.f_2 = to_float(datadict_get_int(sVar1, "z"));
		}
		else
		{
			Var0.f_2 = datadict_get_float(sVar1, "z");
		}
	}
	return Var0;
}
...
Vector3 func_107(char* sParam0)
{
	...
	if (is_point_in_angled_area(Var0, -2233.327f, 2436.134f, -14.65155f, -2229.56f, 2399.576f, 11.99761f, 24f, false, true))
	{
		Var0 = { -2303.54f, 2428.09f, 2.02f };
	}
	if (is_point_in_angled_area(Var0, 603.6218f, 5573.046f, 694.484f, 594.2379f, 5542.792f, 727.479f, 33.5f, false, true))
	{
...
void func_120(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (iParam1 != 0 && iParam1 != 1)
	{
		...
		if (!func_58(uParam0->f_24, uParam0->f_25, ugc_get_content_user_id(uParam0->f_7), ugc_get_content_category(uParam0->f_7)))
		{
			if (bParam5 && func_59())
			{
				...
				set_bit(&(Global_1835448[iVar2]), iVar1);
				Var3 = { func_57(ugc_get_content_user_id(uParam0->f_7)) };
				if (bParam4)
				{
					Global_1031312.f_5462[iVar0] = network_start_user_content_permissions_check(&Var3);
				}
				else
				{
					Global_1020252.f_5462[iVar0] = network_start_user_content_permissions_check(&Var3);
				}
			}
			else
			{
	...
	if (bParam4)
	{
		...
		else if (func_212(uParam0, &(Global_1025782.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0))
		{
			...
			set_bit(&(Global_1025782.f_5[iVar0 /*88*/].f_76), 16);
			uParam0->f_9++;
		}
	}
	else if (bParam3)
	...
	else if (func_212(uParam0, &(Global_1020252.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0))
	{
		...
		{
			Global_1020252.f_4++;
			set_bit(&(Global_1020252.f_5[iVar0 /*88*/].f_76), 16);
		}
		uParam0->f_9++;
	}
	if (datafile_get_file_dict(0) != 0)
...
void func_121(var uParam0, int iParam1, int iParam2)
{
	if (iParam1 == 0 || iParam1 == 1)
	{
		if (ugc_get_content_is_verified(uParam0->f_7))
		{
...
int func_128(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		if (func_131(iParam1, Global_78130[1 /*14*/].f_2, &iVar0))
		{
			...
			if (bParam3)
			{
				clear_bit(&iVar1, Global_78130[1 /*14*/].f_1);
			}
			else
			{
				set_bit(&iVar1, Global_78130[1 /*14*/].f_1);
			}
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_135(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_135(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_145(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_180(int iParam0, bool bParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		if (bParam1)
		{
			set_bit(&iVar0, func_185(iVar1));
		}
		else
		{
			clear_bit(&iVar0, func_185(iVar1));
		}
		if (!func_184(0))
		{
...
void func_196(int iParam0, bool bParam1)
{
	...
	if (iVar0 > -1)
	{
		if (bParam1)
		{
			set_bit(&(Global_2825435.f_1032[func_183(iVar0)]), func_185(iVar0));
		}
		else
		{
			clear_bit(&(Global_2825435.f_1032[func_183(iVar0)]), func_185(iVar0));
		}
	}
}
...
int func_212(var uParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Var0.f_67 = 2;
	*sParam1 = { Var0 };
	sVar1 = datafile_get_file_dict(0);
	sVar2 = datadict_get_dict(sVar1, "mission");
	sVar3 = datadict_get_dict(sVar2, "gen");
	if (Global_262145.f_7091 == 0)
	{
		if (datadict_get_int(sVar3, "type") == 0 && datadict_get_int(sVar3, "subtype") == 6)
		{
			if (datafile_get_file_dict(0) != 0)
			{
				datafile_delete(0);
	...
	if (Global_262145.f_7092 == 0)
	{
		if (datadict_get_int(sVar3, "type") == 0 && datadict_get_int(sVar3, "subtype") == 5)
		{
			if (datafile_get_file_dict(0) != 0)
			{
				datafile_delete(0);
	...
	if ((iParam2 == 0 || iParam2 == 1) || iParam2 == 2)
	{
		if (Global_262145.f_7692 == 0)
		{
			if (datadict_get_int(sVar3, "type") == 2)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
		...
		if (Global_262145.f_7693 == 0)
		{
			if (datadict_get_int(sVar3, "type") == 1)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
	...
	if (bParam3)
	{
		if (!ugc_get_content_is_published(uParam0->f_7))
		{
			if (datadict_get_type(sVar3, "optbs") == 2)
			{
				iVar4 = datadict_get_int(sVar3, "optbs");
				if (BitTest(iVar4, 31))
				{
					if (datafile_get_file_dict(0) != 0)
					{
		...
		if (iParam2 != 0)
		{
			iVar5 = datadict_get_int(sVar3, "rank");
			if (iVar5 > 1000)
			{
				if (datafile_get_file_dict(0) != 0)
				{
	...
	if (iParam4 != 0)
	{
		if (datadict_get_int(sVar3, "type") == 0)
		{
			if (datadict_get_int(sVar3, "subtype") == 2)
			{
				return 0;
			}
		}
	}
	ugc_get_content_updated_date(uParam0->f_7, &(sParam1->f_82));
	sParam1->f_56 = { func_107(sVar3) };
	sParam1->f_59 = { func_106(sVar3, "cam") };
	sParam1->f_62 = { func_105(sVar3) };
	sParam1->f_69 = datadict_get_int(sVar3, "min");
	sParam1->f_71 = datadict_get_int(sVar3, "num");
	if (sParam1->f_71 == -1)
	{
		sParam1->f_71 = func_104();
	}
	StringCopy(&(sParam1->f_22), ugc_get_content_name(uParam0->f_7), 64);
	sParam1->f_65 = datadict_get_int(sVar3, "type");
	sParam1->f_68 = datadict_get_int(sVar3, "subtype");
	sParam1->f_80 = datadict_get_int(sVar3, "adverm");
	sParam1->f_79 = datadict_get_int(sVar3, "testcomplete");
	sParam1->f_70 = datadict_get_int(sVar3, "rank");
	sParam1->f_73 = func_103(ugc_get_content_rating(uParam0->f_7, 0), ugc_get_content_rating_count(uParam0->f_7, 0));
	StringCopy(sParam1, ugc_get_content_id(uParam0->f_7), 24);
	sParam1->f_81 = ugc_get_content_category(uParam0->f_7);
	sParam1->f_55 = _0xAEAB987727C5A8A4(uParam0->f_7);
	if (func_102() != 2)
	{
	...
	if (datadict_get_type(sVar3, "optbs") == 2)
	{
		sParam1->f_76 = datadict_get_int(sVar3, "optbs");
	}
	clear_bit(&(sParam1->f_76), 25);
	if (bParam3 || bParam5)
	{
		if (!ugc_get_content_is_published(uParam0->f_7))
		{
			set_bit(&(sParam1->f_76), 25);
		}
	}
	StringCopy(&(sParam1->f_6), ugc_get_content_user_name(uParam0->f_7), 64);
	if (_0x8C8D2739BA44AF0F(uParam0->f_7))
	{
		StringCopy(&(sParam1->f_6), get_player_name(player_id()), 64);
	}
	if (!func_307())
	{
		if (ugc_is_language_supported(ugc_get_content_language(uParam0->f_7)))
		{
			sParam1->f_54 = ugc_get_content_description_hash(uParam0->f_7);
		}
		else
		{
			sParam1->f_54 = -1;
		...
		sParam1->f_66 = ugc_get_content_file_version(uParam0->f_7, sParam1->f_67);
	}
	if (iParam2 == 0 && !bParam5)
	{
		...
		iVar6 = ugc_get_content_rating_positive_count(uParam0->f_7, 1);
	...
	sParam1->f_75 = datadict_get_int(sVar3, "charcon");
	sParam1->f_72 = datadict_get_int(sVar3, "tnum");
	func_100(sParam1->f_65, &(sParam1->f_71), &(sParam1->f_69));
	set_bit(&(sParam1->f_76), 13);
	clear_bit(&(sParam1->f_76), 15);
	clear_bit(&(sParam1->f_76), 18);
	clear_bit(&(sParam1->f_76), 19);
	clear_bit(&(sParam1->f_76), 29);
	clear_bit(&(sParam1->f_76), 28);
	func_66(get_hash_key(ugc_get_root_content_id(uParam0->f_7)), &(sParam1->f_76), &(sParam1->f_77), sParam1->f_80);
	if (is_string_null_or_empty(sParam1))
	{
		clear_bit(&(sParam1->f_76), 13);
	}
...
int func_214(struct<3> Param0)
{
	...
	if (is_point_in_angled_area(Param0, 986.8618f, 74.74512f, 115.0391f, 975.716f, 57.44831f, 118.0387f, 14.5625f, false, true))
	{
		return 1;
	}
	if (is_point_in_angled_area(Param0, 1093.315f, 219.7407f, -50.98997f, 1084.527f, 219.227f, -45.92859f, 8.75f, false, true))
	{
		return 1;
	}
	if (is_point_in_angled_area(Param0, 380.203f, -70.9054f, 102.181f, 382.593f, -62.2445f, 104.988f, 21.56f, false, true))
	{
		return 1;
	}
	if (is_point_in_angled_area(Param0, -1016f, -437.619f, 62.6791f, -1020.69f, -429.961f, 65.4861f, 21.56f, false, true))
	{
		return 1;
	}
	if (is_point_in_angled_area(Param0, -588.595f, -705.387f, 111.823f, -587.902f, -714.344f, 114.63f, 21.56f, false, true))
	{
		return 1;
	}
	if (is_point_in_angled_area(Param0, -992.769f, -760.456f, 60.7122f, -1001.73f, -761.172f, 63.5192f, 21.56f, false, true))
	{
		return 1;
	}
	if (Global_2789203)
	{
		...
		while (iVar0 < 3)
		{
			if (is_point_in_angled_area(Param0, Global_2789203.f_1[iVar0 /*3*/], Global_2789203.f_11[iVar0 /*3*/], Global_2789203.f_21[iVar0], false, true))
			{
				return 1;
			}
			iVar0++;
...
int func_215(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
void func_216(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	if (!func_307())
	{
		...
		uParam0->f_604[uParam1->f_9 /*88*/].f_66 = ugc_get_content_file_version(uParam1->f_7, uParam0->f_604[uParam1->f_9 /*88*/].f_67);
		uParam0->f_9405[uParam1->f_9 /*13*/].f_6 = ugc_get_content_language(uParam1->f_7);
	}
	...
	if (datadict_get_type(sVar2, "optbs") == 2)
	{
		uParam0->f_604[uParam1->f_9 /*88*/].f_76 = datadict_get_int(sVar2, "optbs");
	}
	if (!func_307())
	{
		if (ugc_is_language_supported(ugc_get_content_language(uParam1->f_7)))
		{
			uParam0->f_604[uParam1->f_9 /*88*/].f_54 = ugc_get_content_description_hash(uParam1->f_7);
		}
		else
		{
	...
	uParam0->f_604[uParam1->f_9 /*88*/].f_69 = datadict_get_int(sVar2, "min");
	uParam0->f_604[uParam1->f_9 /*88*/].f_71 = datadict_get_int(sVar2, "num");
	if (uParam0->f_604[uParam1->f_9 /*88*/].f_71 == -1)
	{
		uParam0->f_604[uParam1->f_9 /*88*/].f_71 = func_104();
	}
	StringCopy(&(uParam0->f_604[uParam1->f_9 /*88*/].f_22), ugc_get_content_name(uParam1->f_7), 64);
	uParam0->f_604[uParam1->f_9 /*88*/].f_65 = datadict_get_int(sVar2, "type");
	uParam0->f_604[uParam1->f_9 /*88*/].f_68 = datadict_get_int(sVar2, "subtype");
	StringCopy(&(uParam0->f_604[uParam1->f_9 /*88*/].f_6), ugc_get_content_user_id(uParam1->f_7), 64);
	StringCopy(&(uParam0->f_3[uParam1->f_9 /*6*/]), ugc_get_content_user_name(uParam1->f_7), 24);
	uParam0->f_604[uParam1->f_9 /*88*/].f_81 = iParam3;
	if (is_string_null_or_empty(&(uParam0->f_3[uParam1->f_9 /*6*/])))
	{
	...
	uParam0->f_604[uParam1->f_9 /*88*/].f_70 = datadict_get_int(sVar2, "rank");
	uParam0->f_9405[uParam1->f_9 /*13*/] = datadict_get_int(sVar2, "tnum");
	if (!func_307())
	{
		uParam0->f_604[uParam1->f_9 /*88*/].f_73 = func_103(ugc_get_content_rating(uParam1->f_7, 0), ugc_get_content_rating_count(uParam1->f_7, 0));
		uParam0->f_9405[uParam1->f_9 /*13*/].f_4 = ugc_get_content_rating_count(uParam1->f_7, 0);
	}
	StringCopy(&(uParam0->f_604[uParam1->f_9 /*88*/]), ugc_get_content_id(uParam1->f_7), 24);
	iVar4 = get_hash_key(&(uParam0->f_604[uParam1->f_9 /*88*/]));
	uParam0->f_9405[uParam1->f_9 /*13*/].f_3 = iVar4;
	uParam0->f_1 = (uParam0->f_1 + iVar4);
	uParam0->f_604[uParam1->f_9 /*88*/].f_75 = datadict_get_int(sVar2, "charcon");
	uParam0->f_604[uParam1->f_9 /*88*/].f_78 = datadict_get_int(sVar2, "ltm");
	func_100(uParam0->f_604[uParam1->f_9 /*88*/].f_65, &(uParam0->f_604[uParam1->f_9 /*88*/].f_71), &(uParam0->f_604[uParam1->f_9 /*88*/].f_69));
	set_bit(&(uParam0->f_604[uParam1->f_9 /*88*/].f_76), 13);
	...
	if (!func_307())
	{
		if (ugc_get_content_has_player_record(uParam1->f_7))
		{
			set_bit(&(uParam0->f_604[uParam1->f_9 /*88*/].f_76), 14);
			uParam0->f_9405[uParam1->f_9 /*13*/].f_7 = ugc_get_content_has_player_bookmarked(uParam1->f_7);
		}
		uParam0->f_10707[uParam1->f_9] = _0xAEAB987727C5A8A4(uParam1->f_7);
		uParam0->f_9405[uParam1->f_9 /*13*/].f_1 = get_hash_key(ugc_get_root_content_id(uParam1->f_7));
...
char* func_230()
{
	return _get_label_text("CREATOR_RSC");
}

char* func_231()
{
	return _get_label_text("CREATOR_RSV");
}
...
void func_232(var uParam0, bool bParam1)
{
	...
	if (func_307())
	{
		if (func_264(ugc_get_content_id(uParam0->f_7)))
		{
			if (datafile_get_file_dict(0) != 0)
			{
				datafile_delete(0);
	...
	if ((datadict_get_int(sVar2, "type") == 0 && datadict_get_int(sVar2, "subtype") == 7) && uParam0->f_9 < 2000)
	{
		if (datafile_get_file_dict(0) != 0)
		{
			datafile_delete(0);
	...
	{
		if (datadict_get_int(sVar2, "type") == 0)
		{
			if (datadict_get_int(sVar2, "subtype") == 1 || datadict_get_int(sVar2, "subtype") == 7)
			{
				if (datafile_get_file_dict(0) != 0)
				{
					datafile_delete(0);
			...
			iVar3 = datadict_get_int(sVar2, "optbs");
	...
	if (!func_307())
	{
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_5 = ugc_get_content_file_version(uParam0->f_7, 0);
		Global_794709.f_4[uParam0->f_9 /*88*/].f_67 = func_101(uParam0->f_7);
		Global_794709.f_4[uParam0->f_9 /*88*/].f_66 = ugc_get_content_file_version(uParam0->f_7, Global_794709.f_4[uParam0->f_9 /*88*/].f_67);
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_6 = ugc_get_content_language(uParam0->f_7);
	}
	Global_794709.f_4[uParam0->f_9 /*88*/].f_56 = { func_107(sVar2) };
	if (datadict_get_type(sVar2, "optbs") == 2)
	{
		Global_794709.f_4[uParam0->f_9 /*88*/].f_76 = datadict_get_int(sVar2, "optbs");
	}
	clear_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 15);
	clear_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 18);
	clear_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 19);
	clear_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 29);
	clear_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 28);
	...
	if (!func_307())
	{
		if (ugc_is_language_supported(ugc_get_content_language(uParam0->f_7)))
		{
			Global_794709.f_4[uParam0->f_9 /*88*/].f_54 = ugc_get_content_description_hash(uParam0->f_7);
		}
		else
		{
	...
	if (datadict_get_type(sVar2, "mgrk") == 2)
	{
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_8 = datadict_get_int(sVar2, "mgrk");
	}
	if (datadict_get_type(sVar2, "mght") == 2)
	{
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_9 = datadict_get_int(sVar2, "mght");
	}
	Global_794709.f_177589[uParam0->f_9 /*13*/].f_11 = datadict_get_int(sVar2, "cncmbs");
	Global_794709.f_4[uParam0->f_9 /*88*/].f_69 = datadict_get_int(sVar2, "min");
	Global_794709.f_4[uParam0->f_9 /*88*/].f_71 = datadict_get_int(sVar2, "num");
	if (Global_794709.f_4[uParam0->f_9 /*88*/].f_71 == -1)
	{
		Global_794709.f_4[uParam0->f_9 /*88*/].f_71 = func_104();
	}
	StringCopy(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_22), ugc_get_content_name(uParam0->f_7), 64);
	Global_794709.f_4[uParam0->f_9 /*88*/].f_65 = datadict_get_int(sVar2, "type");
	if (func_307())
	{
	...
	{
		StringCopy(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_6), ugc_get_content_user_id(uParam0->f_7), 64);
	}
	Global_794709.f_4[uParam0->f_9 /*88*/].f_70 = datadict_get_int(sVar2, "rank");
	Global_794709.f_177589[uParam0->f_9 /*13*/] = datadict_get_int(sVar2, "tnum");
	if (!func_307())
	{
		Global_794709.f_4[uParam0->f_9 /*88*/].f_73 = func_103(ugc_get_content_rating(uParam0->f_7, 0), ugc_get_content_rating_count(uParam0->f_7, 0));
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_4 = ugc_get_content_rating_count(uParam0->f_7, 0);
	}
	Global_794709.f_4[uParam0->f_9 /*88*/].f_75 = datadict_get_int(sVar2, "charcon");
	Global_794709.f_4[uParam0->f_9 /*88*/].f_78 = datadict_get_int(sVar2, "ltm");
	StringCopy(&(Global_794709.f_4[uParam0->f_9 /*88*/]), ugc_get_content_id(uParam0->f_7), 24);
	iVar6 = get_hash_key(&(Global_794709.f_4[uParam0->f_9 /*88*/]));
	...
	if (Global_794709.f_4[uParam0->f_9 /*88*/].f_65 == 6 && !bParam1)
	{
		if (Global_1039641.f_684 < 85)
		{
			...
			if (datadict_get_type(sVar2, "rad") == 2)
			{
				Global_1039641.f_512[Global_1039641.f_684] = to_float(datadict_get_int(sVar2, "rad"));
			}
			else
			{
				Global_1039641.f_512[Global_1039641.f_684] = datadict_get_float(sVar2, "rad");
			}
	...
	{
		Global_794709.f_4[uParam0->f_9 /*88*/].f_68 = datadict_get_int(sVar2, "subtype");
		Global_794709.f_4[uParam0->f_9 /*88*/].f_80 = datadict_get_int(sVar2, "adverm");
	}
	...
	if (func_307())
	{
		if (are_strings_equal(ugc_get_content_id(uParam0->f_7), "lUo6JFfliE-ZQ_8gd90ZxQ"))
		{
			Global_794709.f_4[uParam0->f_9 /*88*/].f_56 = { 897.5109f, -2340.599f, 29.4461f };
		}
	}
	set_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 13);
	if (!func_307())
	{
		Global_794709.f_177589[uParam0->f_9 /*13*/].f_1 = get_hash_key(ugc_get_root_content_id(uParam0->f_7));
	...
	if (!func_307())
	{
		...
		if ((Global_794709.f_203868 < 5 && Global_794709.f_4[uParam0->f_9 /*88*/].f_65 == 0) && Global_794709.f_4[uParam0->f_9 /*88*/].f_68 == 1)
		{
			...
			StringCopy(&(Global_794709.f_203837[Global_794709.f_203868 /*6*/]), ugc_get_root_content_id(uParam0->f_7), 24);
		...
		if (bParam1)
		{
			if (ugc_get_content_has_player_record(uParam0->f_7))
			{
				set_bit(&(Global_794709.f_4[uParam0->f_9 /*88*/].f_76), 14);
			}
		}
		else if (!bVar7)
		{
			...
			if (ugc_get_content_has_player_record(uParam0->f_7))
			{
				...
				Global_794709.f_177589[uParam0->f_9 /*13*/].f_7 = ugc_get_content_has_player_bookmarked(uParam0->f_7);
			}
		}
	}
	if (!bParam1 && !bVar7)
...
int func_265(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var* uParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				if (ugc_query_my_content(iParam1, iParam6, func_267(iParam3), 0, iParam8, iParam7))
				{
					return 1;
				}
			}
			else if (ugc_get_my_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (ugc_query_my_content(iParam1, iParam6, func_267(iParam3), 1, iParam8, iParam7))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (ugc_query_my_content(iParam1, iParam6, func_267(iParam3), 2, iParam8, iParam7))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (ugc_get_friend_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 4:
			if (iParam4 == -1)
			{
				iParam4 = func_266(player_id());
			}
			if (ugc_get_crew_content(iParam4, iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 5:
			...
			{
				if (_0x692D58DF40657E8C(iParam2, iParam1, iParam6, func_267(iParam3), 0, false))
				{
					return 1;
				}
			}
			else if (ugc_get_get_by_category(iParam2, iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 6:
			if (ugc_get_top_rated_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 7:
			if (ugc_get_most_recently_played_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 8:
			if (ugc_get_bookmarked_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
		...
		case 9:
			if (iParam3 == 4)
			{
				if (ugc_query_most_recently_created_content(iParam1, iParam6, func_267(iParam3), iParam7))
				{
					return 1;
				}
			}
			else if (ugc_get_most_recently_created_content(iParam1, iParam6, func_267(iParam3), uParam5))
			{
				return 1;
			}
			break;
...
int func_266(int iParam0)
{
	...
	network_clan_player_get_desc(&uVar1, 35, &Var0);
	return uVar1;
}
...
void func_268(var uParam0)
{
	...
	sVar0 = datafile_get_file_dict(0);
	uVar1 = datadict_get_array(sVar0, "list");
	uParam0->f_1864 = dataarray_get_count(uVar1);
	...
	{
		uVar3[iVar2] = dataarray_get_dict(uVar1, iVar2);
		StringCopy(uParam0[iVar2 /*16*/], datadict_get_string(uVar3[iVar2], "name"), 64);
		StringCopy(&(uParam0->f_513[iVar2 /*6*/]), datadict_get_string(uVar3[iVar2], "cid"), 24);
		iVar2++;
	}
	if (datafile_get_file_dict(0) != 0)
	{
...
int func_282(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			Var0 = { func_285() };
			StringCopy(&(uParam0->f_1), network_member_id_from_gamer_handle(&Var0), 24);
			func_276();
			*uParam0++;
			break;
		
		case 1:
			if (_0xB746D20B17F2A229(&(uParam0->f_1), func_267(0)))
			{
				*uParam0++;
			}
			break;
		...
		case 2:
			if (ugc_has_query_creators_finished())
			{
				if (ugc_did_query_creators_succeed())
				{
					if (ugc_get_creator_num() > 0 && datafile_select_creator_stats(0, 0))
					{
						sVar1 = datafile_get_file_dict(0);
						iVar2 = datadict_get_int(sVar1, "pt");
						func_284(2, iVar2);
						*uParam0++;
					}
					else
...
void func_284(int iParam0, int iParam1)
{
	...
	iVar1 = uVar0;
	stat_set_int(iVar1, iParam1, true);
}
...
int func_287(struct<2> Param0, var uParam1, struct<3> Param2, float fParam3)
{
	if (!func_65(Param2))
	{
...
int func_289()
{
	...
	iVar0 = 0;
	iVar1 = get_profile_setting(933);
	iVar2 = get_profile_setting(934);
	iVar3 = get_profile_setting(935);
	iVar4 = get_profile_setting(936);
	iVar5 = get_profile_setting(937);
	iVar6 = get_profile_setting(938);
		...
		if (BitTest(Global_998606.f_604[iVar1 /*88*/].f_76, 13))
		{
			...
			while (iVar0 <= (iParam1 - 1))
			{
				if (BitTest(Global_794709.f_4[iVar0 /*88*/].f_76, 13))
				{
					...
					{
						clear_bit(&(Global_998606.f_604[iVar1 /*88*/].f_76), 13);
...
int func_298(var uParam0)
{
	...
	switch (uParam0->f_4)
	{
		case 0:
			...
			while (iVar0 <= 63)
			{
				if (iVar0 < 35)
				{
					...
					{
						ugc_release_cached_description(Global_786550.f_3538[iVar0 /*132*/].f_129);
					}
		...
		case 24:
			...
			while (iVar0 <= 63)
			{
				if (iVar0 < 35)
				{
					...
					if (!is_string_null_or_empty(&(Global_1050140.f_1179[iVar0 /*6*/])))
					{
						uParam0->f_13++;
					}
				}
		...
		case 1:
			if (ugc_query_by_content_ids(&(Global_1050140.f_1179), uParam0->f_13, true, func_267(0)))
			{
				func_34(uParam0, 2);
			}
			break;
		...
		while (iVar0 <= uParam0->f_12 + 63)
		{
			if (iVar0 < 35)
			{
				...
				while (!bVar6)
				{
					...
					{
						StringCopy(&(Global_786550.f_3538[iVar0 /*132*/][iVar5 /*16*/]), _get_text_substring_safe(sVar2, iVar3, iVar4, 63), 64);
						iVar3 = (iVar3 + get_length_of_literal_string(&(Global_786550.f_3538[iVar0 /*132*/][iVar5 /*16*/])));
						iVar5++;
					}
				}
			}
...
void func_303(var uParam0)
{
	...
	if (!func_307())
	{
		Global_786550.f_3082[uParam0->f_9 /*13*/].f_5 = ugc_get_content_file_version(uParam0->f_7, 0);
		Global_786550.f_1[uParam0->f_9 /*88*/].f_67 = func_101(uParam0->f_7);
		Global_786550.f_1[uParam0->f_9 /*88*/].f_66 = ugc_get_content_file_version(uParam0->f_7, Global_794709.f_4[uParam0->f_9 /*88*/].f_67);
		Global_786550.f_3082[uParam0->f_9 /*13*/].f_6 = ugc_get_content_language(uParam0->f_7);
	}
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_56 = { func_107(sVar2) };
	if (datadict_get_type(sVar2, "optbs") == 2)
	{
		Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76 = datadict_get_int(sVar2, "optbs");
	}
	clear_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 15);
	clear_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 18);
	clear_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 19);
	clear_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 29);
	clear_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 28);
	...
	if (!func_307())
	{
		if (ugc_is_language_supported(ugc_get_content_language(uParam0->f_7)))
		{
			Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_54 = ugc_get_content_description_hash(uParam0->f_7);
		}
		else
		{
	...
	if (datadict_get_type(sVar2, "mgrk") == 2)
	{
		Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/].f_8 = datadict_get_int(sVar2, "mgrk");
	}
	if (datadict_get_type(sVar2, "mght") == 2)
	{
		Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/].f_9 = datadict_get_int(sVar2, "mght");
	}
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_69 = datadict_get_int(sVar2, "min");
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_71 = datadict_get_int(sVar2, "num");
	if (Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_71 == -1)
	{
		Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_71 = func_104();
	}
	StringCopy(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_22), ugc_get_content_name(uParam0->f_7), 64);
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_65 = datadict_get_int(sVar2, "type");
	if (func_307())
	{
	...
	{
		StringCopy(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_6), ugc_get_content_user_id(uParam0->f_7), 64);
	}
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_70 = datadict_get_int(sVar2, "rank");
	Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/] = datadict_get_int(sVar2, "tnum");
	if (!func_307())
	{
		Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_73 = func_103(ugc_get_content_rating(uParam0->f_7, 0), ugc_get_content_rating_count(uParam0->f_7, 0));
		Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/].f_4 = ugc_get_content_rating_count(uParam0->f_7, 0);
	}
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_75 = datadict_get_int(sVar2, "charcon");
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_78 = datadict_get_int(sVar2, "ltm");
	Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_68 = datadict_get_int(sVar2, "subtype");
	StringCopy(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/]), ugc_get_content_id(uParam0->f_7), 24);
	iVar5 = get_hash_key(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/]));
	...
	set_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 13);
	if (datafile_get_file_dict(0) != 0)
	{
		datafile_delete(0);
	}
	if (!func_307())
	{
		Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/].f_1 = get_hash_key(ugc_get_root_content_id(uParam0->f_7));
		if (ugc_get_content_has_player_record(uParam0->f_7))
		{
			set_bit(&(Global_786550.f_1[(uParam0->f_9 + uParam0->f_12) /*88*/].f_76), 14);
			Global_786550.f_3082[(uParam0->f_9 + uParam0->f_12) /*13*/].f_7 = ugc_get_content_has_player_bookmarked(uParam0->f_7);
		}
	}
	uParam0->f_9++;
	Global_786550++;
...
{
	if (is_ps3_version() || (func_311() && iParam0 == 0))
	{
...
int func_310()
{
	...
	if ((func_311() && _network_has_age_restricted_profile() == 0) && network_have_online_privileges())
	{
		return 1;
	}
	if (func_59() && network_have_online_privileges())
	{
		return 1;
	}
...
int func_314()
{
	...
	if (has_script_loaded("UGC_Global_Registration") && has_script_loaded("UGC_Global_Registration_2"))
	{
		...
		set_script_as_no_longer_needed("UGC_Global_Registration_2");
		return 1;
	}
	return 0;
}
