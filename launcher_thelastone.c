...
int func_186(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_177(2))
	{
		if (!func_148())
		{
			if (((func_129(player_ped_id()) && func_129(uParam0->f_28[0])) && (get_game_timer() - uParam0->f_60) > iParam6) && func_192(player_ped_id(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_187(sParam3))
		{
			...
			{
				if (func_192(player_ped_id(), Param1, 1) >= 20f)
				{
					func_146();
				}
			}
...
void func_193(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam2))
		{
			...
			{
				if (func_192(player_ped_id(), Param3, 1) <= 100f)
				{
					func_196(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_192(player_ped_id(), Param4, 1);
					fVar1 = func_192(player_ped_id(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								remove_cutscene();
								request_cutscene_with_playback_list(sParam2, 5, 8);
								func_194(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							remove_cutscene();
							request_cutscene_with_playback_list(sParam2, 6, 8);
							func_194(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_192(player_ped_id(), Param3, 1) > 120f)
				{
					func_197(iParam0);
				}
			}
...
int func_240(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_243(&iVar0) || !has_anim_dict_loaded("rcmlastone1")) || !has_weapon_asset_loaded(joaat("weapon_pumpshotgun"))) || !has_weapon_asset_loaded(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = create_ped(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, true, true);
...
int func_254(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_255(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_256(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
