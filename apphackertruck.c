...
void __EntryFunction__()
{
	...
	iLocal_286 = 1;
	iLocal_287 = -1;
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appBusinessHub")) > 1)
	{
		func_543(0, 1);
	}
...
void func_4()
{
	...
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_291))
		{
			iVar0 = get_scaleform_movie_method_return_value_int(iLocal_291);
			switch (iVar0)
			{
				case 0:
					func_456();
					play_sound_frontend(-1, "Select_Mission_Cancel", "DLC_GR_MOC_Computer_Sounds", true);
					break;
				...
				case 2:
					func_362(1);
					play_sound_frontend(-1, "Log_In", "DLC_GR_MOC_Computer_Sounds", true);
					break;
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		iVar2 = iVar0;
		iVar3 = 0;
		if (func_28(player_id(), iVar2))
		{
			iVar4 = func_26(player_id(), iVar2);
			iVar3 = func_25(player_id(), iVar4);
		...
		begin_scaleform_movie_method(iLocal_290, "ADD_JOB");
		...
		{
			begin_text_command_scaleform_string(&Var7);
			add_text_component_substring_text_label(&Var6);
...
{
	begin_scaleform_movie_method(iLocal_290, "SHOW_JOB_OVERLAY");
...
{
	if (!func_24(player_id(), iParam0) && !func_23(iParam1))
	{
		func_22(9, iParam2);
		return 1;
	}
...
void func_29()
{
	...
	begin_scaleform_movie_method(iLocal_290, "CLEAR_JOBS");
	end_scaleform_movie_method();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
void func_37(int iParam0)
{
	...
	iVar0 = iParam0;
	if (func_28(player_id(), iVar0))
	{
		iLocal_289 = func_220(player_id(), iVar0);
		iVar1 = func_19(player_id(), iLocal_289);
		if (!func_24(player_id(), iLocal_289) && !func_23(iVar1))
		{
			func_219();
		}
		else if (func_16(player_id(), iLocal_289))
		{
			func_219();
		}
...
int func_39(int iParam0)
{
	...
	if (!func_217(player_id(), iParam0, 0))
	{
		iVar0 = func_45(player_id(), iParam0, 0);
		if (iVar0 == 7)
		{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_122(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		
		case 233:
			return func_115(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		...
		case 243:
			return func_98(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 158:
			return func_93(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 181:
			return func_90(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
...
int func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_174(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
		
		case 233:
			return func_165(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_156(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_150(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_144(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
...
void func_219()
{
	play_sound_frontend(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", true);
}
...
void func_221()
{
	if (!func_24(player_id(), func_35(player_id())))
	{
...
int func_222()
{
	if (Global_1853348[player_id() /*834*/].f_267.f_191[5 /*13*/].f_4 == 1 && !func_23(5))
	{
		return 1;
	}
	return 0;
...
void func_223()
{
	...
	if (!func_217(player_id(), 178, 0))
	{
		iVar0 = func_45(player_id(), 178, 0);
		if (iVar0 == 14)
		{
	...
	else if (func_224(player_id(), func_227(player_id())))
	{
	...
	else
	{
		...
		else
		{
			...
			if (iVar9 <= 0)
			{
				if (!func_231())
				{
					iVar9 = (Global_262145.f_15610 - absi(get_time_difference(get_game_timer(), Global_2789228.f_142)));
				}
			}
			if (iVar9 > 0)
			{
			...
			{
				begin_text_command_scaleform_string(&Var6);
				add_text_component_substring_text_label(&cVar7);
				if (!is_string_null_or_empty(&Var8))
				{
					add_text_component_substring_text_label(&Var8);
				}
				end_text_command_scaleform_string();
			}
			scaleform_movie_method_add_param_bool(bVar5);
			scaleform_movie_method_add_param_int(-1);
			end_scaleform_movie_method();
			iVar0++;
		}
...
int func_232(int iParam0)
{
	...
	if (func_237(iParam0))
	{
		if (func_236(iParam0))
		{
			...
			iVar2 = ((iVar1 + func_233()) - get_cloud_time_as_int());
			return iVar2;
		}
	}
	return -1;
...
int func_261(int iParam0, bool bParam1)
{
	...
	{
		if (func_45(player_id(), iVar0, 0) == 4)
		{
			func_22(7, iParam0);
			return 0;
		}
...
int func_263(int iParam0, int iParam1)
{
	...
	while (iVar2 < 32)
	{
		...
		{
			bVar9 = ((func_55(iVar6) != iVar5 || iVar5 == func_18()) && iVar6 != player_id());
			iVar4 = 0;
			while (iVar4 < 10)
			{
				if (iVar0[iVar4] != -1)
				{
					...
					if (!func_323(Var7))
					{
						if (does_blip_exist(Global_2678393[iVar6]))
						{
							Var8 = { get_blip_coords(Global_2678393[iVar6]) };
							Var8.f_2 = get_approx_floor_for_point(Var8.f_0, Var8.f_1);
						}
						else
						{
							Var8 = { func_268(iVar6) };
						...
						if (!func_323(Var8))
						{
							if (vdist2(Var8, Var7) < (func_267(iParam0, bVar9) * func_267(iParam0, bVar9)))
							{
								iVar0[iVar4] = -1;
								if (!bVar9)
								{
	...
	if (iVar3 > 0)
	{
		*iParam1 = iVar1[get_random_int_in_range(0, iVar3)];
		return 1;
	}
	else if (bVar10)
	{
...
int func_264(int iParam0, int iParam1)
{
	...
	{
		case 240:
			if (does_blip_exist(Global_2678393[player_id()]))
			{
				Var0 = { get_blip_coords(Global_2678393[player_id()]) };
				Var0.f_2 = get_approx_floor_for_point(Var0.f_0, Var0.f_1);
			}
			else
			{
				Var0 = { func_268(player_id()) };
			}
			if (vdist2(func_324(iParam0, iParam1), Var0) > (func_265(iParam0) * func_265(iParam0)))
			{
				return 1;
			}
			break;
...
Vector3 func_268(int iParam0)
{
	...
	{
		Var1 = { func_319(func_320(Global_1853348[player_id() /*834*/].f_267.f_32)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
int func_278(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_73(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
int func_279(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if (((Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_1575058) && iParam0 == player_id()) && func_73(iParam0, 1, 0))
		{
			return func_72(Global_2689235[iParam0 /*453*/].f_318.f_6) == 20;
		}
	}
...
int func_315(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_73(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_316(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_317(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
void func_331()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			begin_text_command_scaleform_string(&Var6);
			add_text_component_substring_text_label(&cVar1);
			end_text_command_scaleform_string();
		}
		...
		scaleform_movie_method_add_param_bool(bVar8);
...
int func_340(int iParam0)
{
	if (func_42(player_id()))
	{
		return func_341(player_id(), iParam0);
	}
	return 0;
}
...
void func_342()
{
	...
	while (iVar0 < 9)
	{
		...
		bVar4 = ((func_346(player_id()) && func_344(player_id())) && !func_256(player_id()));
		iVar5 = 0;
		iVar6 = 0;
		...
		{
			begin_text_command_scaleform_string(&Var3);
			add_text_component_substring_text_label(&cVar2);
			end_text_command_scaleform_string();
		}
...
int func_343(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = absi((iParam2 - absi(get_time_difference(iVar1, iParam0))));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
void func_349()
{
	play_sound_frontend(-1, "Select_Mission_Are_You_Sure", "DLC_GR_MOC_Computer_Sounds", true);
}
...
{
	begin_scaleform_movie_method(iLocal_290, "SHOW_OVERLAY");
	func_8(sParam0);
	...
	if (!is_string_null_or_empty(sParam9))
	{
		...
		if (iParam8 != -1)
		{
			add_text_component_integer(iParam8);
		}
...
void func_362(int iParam0)
{
	...
	{
		clear_bit(&(Global_1946250.f_3), 28);
	}
	iLocal_116 = iParam0;
	begin_scaleform_movie_method(iLocal_290, "SHOW_SCREEN");
	scaleform_movie_method_add_param_int(iParam0);
	end_scaleform_movie_method();
}
...
void func_363()
{
	if (func_455() != 0)
	{
		play_sound_frontend(-1, "Select_Mission_Launch", "DLC_GR_MOC_Computer_Sounds", true);
	}
	switch (func_455())
	{
		case 1:
		...
		case 3:
			...
			{
				set_bit(&(Global_1946250.f_4), 4);
				func_442(167);
			}
			break;
		
		case 4:
			if (func_224(player_id(), func_227(player_id())))
			{
				func_359("HT_VC_P1", "SEC_V_STEAL_F", "OR_OVRLY_OK", "", 1, 0, 0, -1, -1, 0, 0);
			}
			else if (func_398())
			{
				set_bit(&(Global_1946250.f_4), 5);
				func_396();
				func_395(1);
				func_543(0, 1);
			}
		...
		case 5:
			if (func_371(func_35(player_id()), 225))
			{
		...
		case 0:
			play_sound_frontend(-1, "Select_Mission_Unavailable_OK", "DLC_GR_MOC_Computer_Sounds", true);
			break;
	}
	func_456();
}
...
int func_380()
{
	...
	if (!bVar0)
	{
		if (!net_gameserver_is_session_valid(func_173()) || net_gameserver_is_session_refresh_pending())
		{
...
void func_381(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	struct<3> Var0;
	int iVar1;
...
void func_401(int iParam0, int iParam1)
{
	...
	{
		if (!func_410(player_id(), 0) && !func_410(player_id(), 3))
		{
			func_409(iParam0);
...
{
	return func_96(player_id(), bParam0);
}
...
int func_414(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1892703[player_id() /*599*/].f_10.f_332[iVar0] = func_419(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1892703[player_id() /*599*/].f_10.f_332[iVar0] = func_415(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
void func_421()
{
	...
	while (iVar0 < 32)
	{
		...
		else if (func_423(player_id(), Global_1946187[iVar0]))
		{
			iVar7 = func_422(iVar5, &(Global_1946187[iVar0]));
			if (func_423(player_id(), Global_1946187[iVar0]))
			{
...
int func_424(var uParam0)
{
	...
	while (iVar2 < 3)
	{
		if (func_423(player_id(), (iVar1 + iVar2)))
		{
			return 1;
		}
		iVar2++;
...
int func_428(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (iVar3 > 0)
	{
		if (!network_can_spend_money(iVar3, false, true, false, -1, 0))
		{
			play_sound_frontend(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", true);
			return 0;
		}
	...
	if (iVar3 >= 0 && (iVar3 == 0 || (iVar3 > 0 && (func_394() || network_can_spend_money(iVar3, false, true, false, -1, 0)))))
	{
		if (iVar3 > 0)
		{
		...
		if (func_394())
		{
			net_gameserver_set_telemetry_nonce_seed(func_384(func_391()));
		}
		_network_buy_contraband(iVar3, iParam0, get_hash_key(&cVar1), false, true);
		if (func_394())
		{
			func_376(func_391());
		}
...
bool func_440(var uParam0, bool bParam1)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			iVar1 = get_hash_key("MP_STAT_HANGAR_CONTRABAND_MISSION_v0");
...
void func_442(int iParam0)
{
	...
	else if (iParam0 == 229)
	{
		if (iLocal_288 == 8)
		{
			iLocal_288 = get_random_int_in_range(0, 8);
			func_450(18);
		}
		else
		{
...
{
	Global_1892703[player_id() /*599*/].f_10.f_234 = uParam0;
	Global_1892703[player_id() /*599*/].f_10.f_234.f_22 = uParam1;
}

void func_449(int iParam0)
{
	clear_bit(&(Global_2815059.f_5195.f_47), iParam0);
}
...
void func_456()
{
	begin_scaleform_movie_method(iLocal_290, "HIDE_OVERLAY");
	end_scaleform_movie_method();
	func_360(0);
...
void func_457()
{
	if (func_458())
	{
		if (!BitTest(uLocal_109, 3))
		{
			begin_scaleform_movie_method(iLocal_290, "GET_CURRENT_SELECTION");
			iLocal_291 = end_scaleform_movie_method_return_value();
...
void func_459()
{
	...
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
	}
	func_464(2, 206, 1);
	if (is_control_just_pressed(2, 206))
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		...
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
		func_464(2, 187, 1);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_RELEASE_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_RELEASE_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (is_control_just_pressed(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
		}
		func_464(2, 187, 1);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
		}
	}
	func_464(2, 189, 1);
	if (is_control_just_pressed(2, 189))
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	func_464(2, 190, 1);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
	func_464(2, 201, 1);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	func_464(2, 202, 1);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	func_464(2, 204, 1);
	if (is_control_just_pressed(2, 204))
	{
		call_scaleform_movie_method_with_number(iLocal_290, "SET_INPUT_EVENT", to_float(204), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		begin_scaleform_movie_method(iLocal_290, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			begin_scaleform_movie_method(iLocal_290, "SET_ANALOG_STICK_INPUT");
			iLocal_292 = iVar0;
			iLocal_293 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_292);
			scaleform_movie_method_add_param_int(iLocal_293);
			end_scaleform_movie_method();
		}
	}
	func_464(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_294 != 127) || iVar3 != 127) || iLocal_295 != 127)
	{
		...
		scaleform_movie_method_add_param_int(iLocal_294);
		scaleform_movie_method_add_param_int(iLocal_295);
		scaleform_movie_method_add_param_bool(bVar4);
		end_scaleform_movie_method();
	}
...
void func_461()
{
	begin_scaleform_movie_method(iLocal_290, "HIDE_JOB_OVERLAY");
	end_scaleform_movie_method();
	clear_bit(&uLocal_109, 4);
	clear_bit(&uLocal_109, 5);
}
...
void func_466()
{
	...
	set_script_gfx_draw_order(1);
	draw_scaleform_movie_fullscreen(iLocal_290, 255, 255, 255, 255, 0);
	func_477();
	func_470(0);
	func_467(1);
}
...
void func_484(int iParam0)
{
	...
	begin_scaleform_movie_method(iLocal_290, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
...
int func_486(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			return (func_339(player_id()) && func_340(0));
			break;
		
		case 3:
			return (func_330(player_id()) && func_340(0));
			break;
		
		case 4:
			return ((func_34(player_id()) && func_489(1)) && !func_488(5));
			break;
		
		case 5:
			if (func_487(player_id()) && func_32(player_id()))
			{
				return 1;
			}
			break;
...
int func_489(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			while (iVar0 < 6)
			{
				iVar1 = func_25(player_id(), iVar0);
				if (func_20(iVar1))
				{
					if (func_27(iVar1) == func_490(iParam0) && func_21(player_id(), iVar1))
					{
						iVar2 = func_19(player_id(), iVar1);
						if (Global_1853348[player_id() /*834*/].f_267.f_191[iVar2 /*13*/].f_7 || Global_1640649[iVar2] != 0)
						{
							return Global_1853348[player_id() /*834*/].f_267.f_191[iVar2 /*13*/].f_4 > 0;
						}
					}
				}
				iVar0++;
		...
		case 2:
			...
			while (iVar0 < func_245())
			{
				...
				if (iVar1 <= 0)
				{
					if (!func_231())
					{
						iVar1 = (Global_262145.f_15610 - absi(get_time_difference(get_game_timer(), Global_2789228.f_142)));
					}
				}
				if (iVar1 >= 0)
				{
...
{
	begin_scaleform_movie_method(iLocal_290, "UPDATE_COOLDOWN");
	scaleform_movie_method_add_param_int(iParam0);
	...
	switch (iParam0)
	{
		...
		case 5:
			...
			else
			{
				iVar5 = func_13(iLocal_112);
				iVar7 = iLocal_112;
				if (func_28(player_id(), iVar7))
				{
					iVar1 = func_26(player_id(), iVar7);
					iVar8 = func_25(player_id(), iVar1);
				...
				else
				{
					...
					if (!bVar4)
					{
						...
						if (iVar3 <= 0)
						{
							if (!func_231())
							{
								iVar3 = (Global_262145.f_15610 - absi(get_time_difference(get_game_timer(), Global_2789228.f_142)));
							}
						}
...
void func_510()
{
	...
	{
		if (func_513(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_512(player_ped_id());
...
int func_526(bool bParam0)
{
	...
	return get_random_int_in_range(iVar0, iVar1);
}
...
void func_530()
{
	...
	else if (func_465() || is_control_just_released(2, 199))
	{
		func_543(0, 1);
	}
...
{
	func_530();
	iLocal_290 = request_scaleform_movie("hacker_truck_desktop");
	while (!has_scaleform_movie_loaded(iLocal_290))
	{
		wait(0);
	}
	func_471(1);
...
{
	set_scaleform_movie_as_no_longer_needed(&iLocal_290);
	func_539(iParam0);
	func_541(0);
	func_544();
	...
	if (bParam1)
	{
		play_sound_frontend(-1, "Logout", "DLC_GR_MOC_Computer_Sounds", true);
	}
	if (is_pc_version())
	{
		func_536(0, 1, 1, 1);
