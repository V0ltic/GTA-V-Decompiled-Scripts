	...
	if (!func_234(Local_43.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				...
				{
					set_blocking_of_non_temporary_events(Local_43.f_28[0], true);
				}
				iLocal_42 = 1;
				break;
			...
			case 1:
				...
				{
					if (is_synchronized_scene_running(iLocal_228))
					{
						if (get_synchronized_scene_phase(iLocal_228) >= 1f)
						{
							iLocal_42 = 2;
						}
					}
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_233(player_ped_id()) && func_233(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_247(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_235(int iParam0, float fParam1)
{
	...
	if (func_233(player_ped_id()) && func_233(iParam0))
	{
		if (func_246(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(player_ped_id(), 6))
			{
				fVar0 = 40f;
...
{
	return func_237(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_241(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_243(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_243(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_251(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_243(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_253()
{
	if (is_player_playing(player_id()) && func_233(Local_43.f_28[0]))
	{
		set_ik_target(Local_43.f_28[0], 1, player_ped_id(), 31086, 0f, 0f, 0f, 0, -1, -1);
		set_ik_target(player_ped_id(), 1, Local_43.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_233(player_ped_id()))
			{
				...
				{
					func_289(sLocal_56, player_ped_id(), 0, 2);
				}
			}
			if (func_282(1, 1093140480, 0))
			{
				...
				{
					register_entity_for_cutscene(Local_43.f_28[0], sLocal_58, 0, 0, 0);
				}
				if (func_233(player_ped_id()))
				{
					register_entity_for_cutscene(player_ped_id(), sLocal_56, 0, 0, 0);
				}
				if (does_entity_exist(iLocal_47[0]))
				{
					register_entity_for_cutscene(iLocal_47[0], sLocal_52, 0, iLocal_48, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_47[0], sLocal_52, 2, iLocal_48, 0);
				}
				if (does_entity_exist(iLocal_47[1]))
				{
					register_entity_for_cutscene(iLocal_47[1], sLocal_53, 0, iLocal_49, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_47[1], sLocal_53, 2, iLocal_49, 0);
				}
				if (does_entity_exist(iLocal_45))
				{
					register_entity_for_cutscene(iLocal_45, sLocal_55, 0, iLocal_51, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_45, sLocal_55, 2, iLocal_51, 0);
				}
				if (does_entity_exist(iLocal_46))
				{
					register_entity_for_cutscene(iLocal_46, sLocal_54, 0, iLocal_50, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_46, sLocal_54, 2, iLocal_50, 0);
				}
				_0x293220DA1B46CEBC(5f, 0f, 0);
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity(sLocal_58, 0))
			{
				iLocal_228 = create_synchronized_scene(Local_229, Local_230, 2);
				task_synchronized_scene(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
				force_ped_ai_and_animation_update(Local_43.f_28[0], false, false);
			}
			if (can_set_exit_state_for_registered_entity(sLocal_56, 0))
			{
				set_entity_coords(player_ped_id(), -258.8661f, 292.7882f, 90.5764f, true, false, false, true);
				set_entity_heading(player_ped_id(), 153.0417f);
				force_ped_ai_and_animation_update(player_ped_id(), false, false);
			}
			if (!does_entity_exist(iLocal_46))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_54, iLocal_50)))
				{
					iLocal_46 = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_54, iLocal_50));
				}
			}
			else if (is_synchronized_scene_running(iLocal_228) && can_set_exit_state_for_registered_entity(sLocal_54, 0))
			{
				set_entity_coords(iLocal_46, Local_229, false, false, false, true);
				set_entity_rotation(iLocal_46, Local_230, 2, false);
				play_synchronized_entity_anim(iLocal_46, iLocal_228, "leadout_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
				force_entity_ai_and_animation_update(iLocal_46);
			}
			if (!does_entity_exist(iLocal_47[0]))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_52, 0)))
				{
					iLocal_47[0] = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_52, iLocal_48));
				}
			}
			else if (is_synchronized_scene_running(iLocal_228) && can_set_exit_state_for_registered_entity(sLocal_52, 0))
			{
				play_synchronized_entity_anim(iLocal_47[0], iLocal_228, "leadout_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 1, 1000f);
				force_entity_ai_and_animation_update(iLocal_47[0]);
			}
			if (!does_entity_exist(iLocal_47[1]))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_53, 0)))
				{
					iLocal_47[1] = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_53, iLocal_49));
				}
			}
			else if (is_synchronized_scene_running(iLocal_228) && can_set_exit_state_for_registered_entity(sLocal_53, 0))
			{
				play_synchronized_entity_anim(iLocal_47[1], iLocal_228, "leadout_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 1, 1000f);
				force_entity_ai_and_animation_update(iLocal_47[1]);
			}
			if (!does_entity_exist(iLocal_45))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_55, 0)))
				{
					iLocal_45 = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_55, iLocal_51));
				}
			}
			else if (is_synchronized_scene_running(iLocal_228) && can_set_exit_state_for_registered_entity(sLocal_55, 0))
			{
				set_entity_coords(iLocal_45, -261.1132f, 294.1956f, 90.68612f, false, false, false, true);
				set_entity_rotation(iLocal_45, -0.604164f, -2.332095f, 89.8831f, 2, false);
				force_entity_ai_and_animation_update(iLocal_45);
			}
...
void func_267(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_269(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_282(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_287(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_295()
{
	if (func_265())
	{
		set_gameplay_entity_hint(Local_43.f_28[0], 0f, 0f, 0f, true, -1, 1500, 2000, 0);
	}
}
...
void func_296()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_232(Local_43.f_28[0]) && does_entity_exist(iLocal_46))
			{
				iLocal_226 = create_synchronized_scene(get_entity_coords(iLocal_46, true), get_entity_rotation(iLocal_46, 2), 2);
				task_synchronized_scene(Local_43.f_28[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				if (does_entity_exist(iLocal_46))
				{
					play_synchronized_entity_anim(iLocal_46, iLocal_226, "leadin_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
				}
				if (does_entity_exist(iLocal_47[0]))
				{
					play_synchronized_entity_anim(iLocal_47[0], iLocal_226, "leadin_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1000f);
				}
				if (does_entity_exist(iLocal_47[1]))
				{
					play_synchronized_entity_anim(iLocal_47[1], iLocal_226, "leadin_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1000f);
				}
				func_256(1, 1, 1, 1);
				iLocal_42 = 1;
			}
		...
		case 1:
			if (func_232(Local_43.f_28[0]) && does_entity_exist(iLocal_46))
			{
				if (is_synchronized_scene_running(iLocal_226))
				{
					if (get_synchronized_scene_phase(iLocal_226) > 0.99f)
					{
						if (!is_synchronized_scene_running(iLocal_227))
						{
							iLocal_227 = create_synchronized_scene(get_entity_coords(iLocal_46, true), get_entity_rotation(iLocal_46, 2), 2);
							task_synchronized_scene(Local_43.f_28[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
							force_ped_ai_and_animation_update(Local_43.f_28[0], false, false);
							if (does_entity_exist(iLocal_46))
							{
								play_synchronized_entity_anim(iLocal_46, iLocal_227, "idle_01_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_46);
							}
							if (does_entity_exist(iLocal_47[0]))
							{
								play_synchronized_entity_anim(iLocal_47[0], iLocal_227, "idle_01_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_47[0]);
							}
							if (does_entity_exist(iLocal_47[1]))
							{
								play_synchronized_entity_anim(iLocal_47[1], iLocal_227, "idle_01_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_47[1]);
							}
						}
					}
					if (get_synchronized_scene_phase(iLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
					...
					if (get_synchronized_scene_phase(iLocal_226) > 0.05f)
					{
						func_295();
					}
				}
...
void func_297()
{
	if (does_entity_exist(Local_43.f_41[3]) && !iLocal_235)
	{
		start_particle_fx_non_looped_at_coord("scr_rcpap1_camera", get_ped_bone_coords(Local_43.f_28[0], 28422, Local_232), get_entity_rotation(Local_43.f_41[3], 2), 1f, false, false, false);
		if (!has_sound_finished(iLocal_231))
		{
			stop_sound(iLocal_231);
		}
		if (request_script_audio_bank(sLocal_233, false, -1))
		{
			play_sound_from_coord(iLocal_231, "CAMERA", get_ped_bone_coords(Local_43.f_28[0], 28422, Local_232), sLocal_234, false, 0, false);
			iLocal_235 = 1;
		}
	}
}
...
void func_300()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_287(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_307()
{
	...
	if (func_232(player_ped_id()))
	{
		iLocal_44 = get_ped_relationship_group_hash(player_ped_id());
	}
	if (func_232(Local_43.f_28[0]))
	{
		set_ped_relationship_group_hash(Local_43.f_28[0], iLocal_44);
		set_ped_config_flag(Local_43.f_28[0], 132, true);
		set_ped_keep_task(Local_43.f_28[0], true);
		set_blocking_of_non_temporary_events(Local_43.f_28[0], true);
	}
	if (!does_entity_exist(iLocal_45))
	{
		iLocal_45 = get_closest_object_of_type(-261.19f, 292.22f, 90.79f, 10f, iLocal_51, true, false, true);
	...
	func_315(&uLocal_59, 1, player_ped_id(), "FRANKLIN", 0, 1);
	func_315(&uLocal_59, 3, Local_43.f_28[0], "BEVERLY", 0, 1);
	request_additional_text("PAP3", 0);
	request_anim_dict(sLocal_57);
	request_ptfx_asset();
	while (!has_anim_dict_loaded(sLocal_57) || !has_ptfx_asset_loaded())
	{
		func_299();
		wait(0);
	}
...
void func_308()
{
	...
	func_311();
	func_255(1);
	func_310(player_ped_id(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_309(1, 1, 1);
}
...
int func_310(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
void func_311()
{
	if (func_233(Local_43.f_28[0]) && does_entity_exist(iLocal_46))
	{
		iLocal_228 = create_synchronized_scene(Local_229, Local_230, 2);
		task_synchronized_scene(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
		if (does_entity_exist(iLocal_46))
		...
		set_synchronized_scene_phase(iLocal_228, 0.02f);
	}
	bLocal_225 = false;
}
...
int func_317()
{
	...
	else if (does_entity_exist(Local_43.f_28[0]))
	{
		if (is_entity_dead(Local_43.f_28[0], false))
		{
			func_318("P3BEVDEAD");
			return 1;
		}
		else if (get_ped_max_health(Local_43.f_28[0]) > get_entity_health(Local_43.f_28[0]))
		{
			func_318("P3BEVHURT");
			return 1;
		}
...
void func_319()
{
	...
	{
		case 0:
			if (are_strings_equal(sLocal_236, "DEFAULT"))
			{
				func_472(1);
			}
			else
...
int func_334(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_305(0)) || func_335(1))
			{
			}
			else
			{
...
void func_342(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_153(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_347(*iParam1, 0, &uVar0))
		{
...
int func_347(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = get_entity_model(iParam0);
	if ((!func_376(iVar0, bParam1, uParam2) && !func_375(player_id())) && !func_357(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_355(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_353(iParam0)) && !bVar1) && !(func_352(get_entity_model(iParam0)) && func_349(player_id())))
	{
	...
	if (!network_is_game_in_progress())
	{
		if ((func_348(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_374(player_id()) || func_373(player_id()))
	{
		if (func_358(iParam0))
		{
			return 1;
...
int func_359(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_353(iParam0)) || func_360(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_361(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_363(get_entity_model(iParam0), 0))
			{
...
int func_376(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_355(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_380(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_274(iParam0, 0, 0)) || func_274(iParam0, 1, 0)) || func_274(iParam0, 2, 0)) || func_396(iParam0) != 145) || func_395(iParam0)) || func_394(iParam0)) || func_348(iParam0)) || func_393(iParam0)) || !func_383(get_entity_model(iParam0)))
	{
		if (func_394(iParam0))
		{
		}
...
int func_400(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_372(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_403(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_403(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_402(iParam0);
	if (func_401(*iParam0))
	{
...
void func_408(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_409(iParam0, iParam1))
				{
...
void func_410(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	if (func_442(uParam0))
	{
		...
		if (func_441(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_420(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
int func_420(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_422(iParam0, uVar1[iVar3], 1) && func_421(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_416(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
int func_421(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_423(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_380(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_380(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_380(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_380(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_380(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_380(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_380(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_424() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
int func_450(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (!func_455(&iVar0) || !has_anim_dict_loaded(sVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			if (func_232(uParam0->f_28[0]))
			{
				...
				{
					func_451(&(uParam0->f_41[3]), iVar0[1], get_offset_from_entity_in_world_coords(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_233(uParam0->f_41[3]))
					{
						attach_entity_to_entity(uParam0->f_41[3], uParam0->f_28[0], get_ped_bone_index(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
						set_model_as_no_longer_needed(iVar0[1]);
					}
					else
					{
						bVar6 = false;
			...
			if (bVar6)
			{
				iVar1[0] = get_closest_object_of_type(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), true, false, true);
				Var2[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				Var3[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				iVar1[1] = get_closest_object_of_type(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), true, false, true);
				Var2[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				Var3[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				iVar1[2] = get_closest_object_of_type(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), true, false, true);
				Var2[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				Var3[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar5 = 0;
				while (iVar5 <= 2)
				{
					set_object_as_no_longer_needed(&(iVar1[iVar5]));
					iVar5++;
				}
				create_model_hide(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				create_model_hide(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				create_model_hide(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
				uParam0->f_41[0] = create_object_no_offset(joaat("prop_cs_dumpster_01a"), Var2[0 /*3*/], true, true, false);
				set_entity_rotation(uParam0->f_41[0], Var3[0 /*3*/], 2, true);
				set_can_climb_on_entity(uParam0->f_41[0], false);
				uParam0->f_41[1] = create_object_no_offset(joaat("prop_cs_dumpster_lidl"), Var2[1 /*3*/], true, true, false);
				set_entity_rotation(uParam0->f_41[1], Var3[1 /*3*/], 2, true);
				set_can_climb_on_entity(uParam0->f_41[1], false);
				uParam0->f_41[2] = create_object_no_offset(joaat("prop_cs_dumpster_lidr"), Var2[2 /*3*/], true, true, false);
				set_entity_rotation(uParam0->f_41[2], Var3[2 /*3*/], 2, true);
				set_can_climb_on_entity(uParam0->f_41[2], false);
				iLocal_37 = 3;
			}
			break;
		...
		case 3:
			...
			{
				iLocal_40 = create_synchronized_scene(get_entity_coords(uParam0->f_41[0], true), get_entity_rotation(uParam0->f_41[0], 2), 2);
				play_synchronized_entity_anim(uParam0->f_41[0], iLocal_40, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1000f);
				set_synchronized_scene_looped(iLocal_40, true);
				if (func_233(uParam0->f_28[0]))
				{
					task_synchronized_scene(uParam0->f_28[0], iLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_233(uParam0->f_41[1]))
				{
					play_synchronized_entity_anim(uParam0->f_41[1], iLocal_40, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1000f);
				}
				if (func_233(uParam0->f_41[2]))
				{
					play_synchronized_entity_anim(uParam0->f_41[2], iLocal_40, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1000f);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_451(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_266(iParam0);
...
int func_452(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
void func_457()
{
	...
	release_sound_id(iLocal_231);
	if (does_entity_exist(iLocal_47[0]))
	{
		freeze_entity_position(iLocal_47[0], true);
	}
	if (does_entity_exist(iLocal_47[1]))
	{
		freeze_entity_position(iLocal_47[1], true);
	}
	func_470(&(iLocal_47[0]), 0);
	func_470(&(iLocal_47[1]), 0);
	func_470(&iLocal_45, 0);
	func_470(&iLocal_46, 0);
	remove_anim_dict(sLocal_57);
	remove_ptfx_asset();
...
void func_472(bool bParam0)
{
	...
	if (!func_489())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_473(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_480())
	{
		...
		{
			iVar2 = func_475(get_this_script_name());
			if (iVar2 > -1)
			{
