...
void __EntryFunction__()
{
	...
	set_bit(&Global_78567, 7);
	if (!does_cam_exist(iLocal_181))
	{
		iLocal_181 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, true, 2);
		set_cam_params(iLocal_181, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
		set_cam_active(iLocal_181, true);
	...
	if (func_56(player_ped_id()))
	{
		...
		clear_area_of_projectiles(get_entity_coords(player_ped_id(), true), 60f, 0);
	...
	while (!load_stream("LEVIATHON_RIDE_MASTER", 0))
	{
		func_53();
		func_56(player_ped_id());
		wait(0);
	}
	play_stream_frontend();
	if (does_cam_exist(iLocal_181))
	{
		set_cam_params(iLocal_181, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
		iVar6 = get_game_timer() + 5000;
	}
	while (!func_50(&uLocal_41) && !is_ped_in_any_vehicle(player_ped_id(), false))
	{
		func_53();
		func_56(player_ped_id());
		wait(0);
	}
	if (func_56(get_players_last_vehicle()))
	{
		if (func_49(get_players_last_vehicle(), joaat("bagger")))
		{
			func_34(-1633.43f, -1111.998f, 11.02252f, -1661.27f, -1142.66f, 25.51722f, 12f, -1630.952f, -1107.58f, 12.0215f, 51.9704f, 1, 1, 1, 0, 0);
		}
		else if (func_49(get_players_last_vehicle(), joaat("sandking")))
		{
	...
	wait(0);
	func_15();
	if (func_56(player_ped_id()) && func_56(Local_164.f_9))
	{
		set_entity_coords(player_ped_id(), -1648.4f, -1127.6f, 18.3f, true, false, false, true);
		attach_entity_to_entity(player_ped_id(), Local_164.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		set_entity_visible(player_ped_id(), false, false);
	}
	while (get_game_timer() < iVar6)
	{
		wait(0);
	}
	if (does_cam_exist(iLocal_181))
	{
		set_cam_active(iLocal_181, false);
		destroy_cam(iLocal_181, false);
	}
	if (func_56(player_ped_id()))
	{
		Local_169.f_20 = 60;
		Local_169.f_21 = 20;
		Var1 = { get_ped_bone_coords(player_ped_id(), 31086, 0f, -0.25f, 0f) };
		func_14(&Local_169, Var1, get_entity_rotation(Local_164.f_9, 2), 50f, Local_169.f_20, Local_169.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		attach_cam_to_entity(Local_169.f_0, player_ped_id(), 0f, 0f, 0.5f, true);
	}
	wait(0);
	if (func_56(player_ped_id()) && func_56(Local_165.f_9))
	{
		func_12(get_entity_coords(player_ped_id(), true), get_entity_coords(Local_165.f_9, true), &fVar4, &fVar5, 1);
		func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
		set_cam_rot(Local_169.f_0, Vector(fVar5, 0f, fVar4) + Local_169.f_14, 2);
	}
	start_audio_scene("FAIRGROUND_RIDES_LEVIATHAN");
	iLocal_187 = get_game_timer() + 5000;
	...
	while (true)
	{
		...
		if (func_56(player_ped_id()) && func_56(Local_165.f_9))
		{
			func_12(get_entity_coords(player_ped_id(), true), get_entity_coords(Local_165.f_9, true), &fVar4, &fVar5, 1);
			func_9(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			set_cam_rot(Local_169.f_0, Vector((fVar5 + (fVar7 * (fVar8 * 2f))), 0f, (fVar4 + fVar7)) + Local_169.f_14, 2);
		}
		func_53();
		func_2();
		...
		if (get_game_timer() > iLocal_187)
		{
			if (fLocal_190 > 0.01f)
			{
				if (fLocal_190 > 0.5f)
				{
					play_ped_ambient_speech_native(player_ped_id(), "ROLLERCOASTER_CHAT_EXCITED", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				else
				{
					play_ped_ambient_speech_native(player_ped_id(), "ROLLERCOASTER_CHAT_NORMAL", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				iLocal_187 = (get_game_timer() + get_random_int_in_range(8000, 13000));
			}
		}
		if (iLocal_179 == 0)
		{
			if (is_control_just_pressed(2, 18) || is_control_just_pressed(2, 51))
			{
				func_1(500, 0);
				iLocal_179 = 1;
			}
...
void func_6()
{
	...
	fVar0 = to_float(absi((Local_192[iLocal_191 + 1 /*3*/] - Local_192[iLocal_191 /*3*/])));
...
void func_16(int iParam0, int iParam1)
{
	...
	func_12(get_entity_coords(iParam0, true), get_entity_coords(iParam1, true), &fVar0, &fVar1, 1);
	set_entity_rotation(iParam0, fVar0, 0f, fVar1, 2, true);
}
...
void func_17(var uParam0)
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			set_pad_shake(0, iLocal_184, iLocal_185);
		}
	}
	...
	*uParam0 = { *uParam0 + Local_160 };
	...
	{
		set_entity_coords_no_offset(uParam0->f_9, *uParam0, false, false, true);
	}
...
void func_19()
{
	...
	{
		case 0:
			fLocal_163 = (fLocal_163 + (get_frame_time() / 2f));
			if (fLocal_163 >= 5f)
			{
				fLocal_163 = 5f;
				iLocal_168 = 1;
		...
		case 1:
			if (Local_164.f_4[1] == 224 && iLocal_162 == 0)
			{
				...
				if (func_56(player_ped_id()))
				{
					play_sound_from_entity(-1, "BIG_STOP", player_ped_id(), 0, false, 0);
				}
			}
			break;
		
		case 2:
			fLocal_163 = (fLocal_163 - get_frame_time());
			if (fLocal_163 <= 0f)
			{
				fLocal_163 = 0f;
				iLocal_168 = 3;
...
void func_28(var uParam0, int iParam1, int iParam2)
{
	...
	*uParam0 = { func_18(&(Local_159[uParam0->f_4[0] /*3*/]), &(Local_159[uParam0->f_4[1] /*3*/]), &(Local_159[uParam0->f_4[2] /*3*/]), &(Local_159[uParam0->f_4[3] /*3*/]), uParam0->f_3) };
	*uParam0 = { *uParam0 + Local_160 };
	uParam0->f_9 = create_object_no_offset(iLocal_40, *uParam0, true, true, false);
	if (func_56(uParam0->f_9))
	{
		set_entity_collision(uParam0->f_9, false, false);
		set_entity_visible(uParam0->f_9, false, false);
...
void func_29()
{
	...
	iLocal_180[0] = get_closest_object_of_type(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), true, false, true);
	iLocal_180[1] = get_closest_object_of_type(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iLocal_180[2] = get_closest_object_of_type(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iLocal_180[3] = get_closest_object_of_type(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		if (does_entity_exist(iLocal_180[iVar0]))
		{
			set_entity_as_mission_entity(iLocal_180[iVar0], true, false);
			set_entity_visible(iLocal_180[iVar0], false, false);
			set_entity_collision(iLocal_180[iVar0], false, false);
			set_entity_invincible(iLocal_180[iVar0], true);
		}
		iVar0++;
	}
}
...
void func_40()
{
	...
	{
		if (func_44(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
int func_49(int iParam0, int iParam1)
{
	...
	get_model_dimensions(iParam1, &Var2, &Var3);
	if (absf((Var1.f_0 - Var0.f_0)) > absf((Var3.f_0 - Var2.f_0)))
	{
		return 0;
	}
	if (absf((Var1.f_1 - Var0.f_1)) > absf((Var3.f_1 - Var2.f_1)))
	{
		return 0;
	}
	return 1;
...
int func_52(var uParam0, bool bParam1)
{
	...
	{
		case 1:
			request_action_mode_asset((uParam0[bParam1 /*7*/])->f_3);
			break;
		
		case 2:
			request_anim_dict((uParam0[bParam1 /*7*/])->f_3);
			break;
		
		case 3:
			request_anim_set((uParam0[bParam1 /*7*/])->f_3);
			break;
		
		case 4:
			request_script_audio_bank((uParam0[bParam1 /*7*/])->f_3, false, -1);
			break;
		
		case 5:
			load_stream((uParam0[bParam1 /*7*/])->f_3, (uParam0[bParam1 /*7*/])->f_4);
			break;
		
		case 6:
			request_model((uParam0[bParam1 /*7*/])->f_1);
			break;
		...
		case 8:
			request_additional_text((uParam0[bParam1 /*7*/])->f_3, (uParam0[bParam1 /*7*/])->f_5);
			break;
		
		case 9:
			request_streamed_texture_dict((uParam0[bParam1 /*7*/])->f_3, false);
			break;
		
		case 10:
			request_vehicle_recording((uParam0[bParam1 /*7*/])->f_5, (uParam0[bParam1 /*7*/])->f_3);
			break;
		
		case 11:
			request_waypoint_recording((uParam0[bParam1 /*7*/])->f_3);
			break;
		
		case 12:
			request_weapon_asset((uParam0[bParam1 /*7*/])->f_2, 31, 0);
			break;
	...
	uParam0->f_117 = 0;
	(uParam0[bParam1 /*7*/])->f_6 = get_game_timer() + 10000;
	set_bit(&(uParam0->f_113), bParam1);
	return 1;
}
...
void func_57(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_60(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_71(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_71(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_71(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_78128 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_71(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_71(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_71(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_82(get_entity_model(iParam0), 14, iVar0, get_hash_name_for_prop(iParam0, 0, iParam2, iParam3)))
			{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_71(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_88(get_entity_model(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_88(get_entity_model(iParam0), iVar1, 14, 4);
		}
	}
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_71(iParam2));
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_83(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_83(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_83(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_83(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_71(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_177(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_71(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_179(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_183(player_id())) && !func_181(player_id(), 0)) && !func_180()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_183(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_187(bool bParam0)
{
	...
	func_223();
	func_222(player_ped_id(), -1631.348f, -1112.651f, 12.0206f);
	set_entity_heading(player_ped_id(), 316.464f);
	...
	func_20(0);
	_0x6D6840CEE8845831("fairgroundHub");
	if (bParam0)
	{
		func_58(500, 0);
...
void func_194(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_196() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_196() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_195(bParam0));
...
void func_223()
{
	...
	{
		iLocal_180[0] = create_object(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[1]))
	{
		iLocal_180[1] = create_object(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[2]))
	{
		iLocal_180[2] = create_object(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_180[3]))
	{
		iLocal_180[3] = create_object(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, true, true, false);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_180)
	{
		...
		{
			set_entity_heading(iLocal_180[iVar0], 140f);
			set_entity_visible(iLocal_180[iVar0], true, false);
			set_entity_collision(iLocal_180[iVar0], true, false);
			freeze_entity_position(iLocal_180[iVar0], true);
			set_entity_invincible(iLocal_180[iVar0], true);
...
void func_228()
{
	...
	{
		func_215(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_231() == 2 == 0 && !network_is_game_in_progress())
			{
