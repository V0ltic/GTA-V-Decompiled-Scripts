	...
	while (func_36(23) && !func_35(134))
	{
		if (func_30() == 1)
		{
			if (does_entity_exist(player_ped_id()))
			{
				...
				{
					if ((!is_ped_falling(player_ped_id()) && !is_entity_in_water(player_ped_id())) && !is_entity_on_fire(player_ped_id()))
					{
						if (!bVar0)
						{
							if (!((func_29() || is_player_switch_in_progress()) || func_28()))
							{
								if (func_13())
								{
									bVar0 = true;
						...
						else
						{
							if (iLocal_28)
							{
								...
								enable_control_action(0, 173, true);
								enable_control_action(0, 172, true);
								enable_control_action(0, 174, true);
								enable_control_action(0, 175, true);
								enable_control_action(0, 176, true);
								enable_control_action(0, 177, true);
								enable_control_action(0, 178, true);
								enable_control_action(0, 179, true);
							...
							switch (func_12())
							{
								...
								case -1989308064:
									func_7(12, 0);
									func_6(134, 1);
									stat_set_int(joaat("sp_final_decision"), 2, true);
									break;
								...
								case -1060930305:
									func_7(12, 1);
									func_6(134, 1);
									stat_set_int(joaat("sp_final_decision"), 1, true);
									break;
								
								case -1817481777:
									func_7(12, 2);
									func_6(134, 1);
									stat_set_int(joaat("sp_final_decision"), 3, true);
									break;
...
int func_13()
{
	if (Global_20266.f_1 > 3)
	{
		clear_bit(&Global_8137, false);
		func_23(0);
		return 0;
	}
	set_bit(&Global_8137, false);
	if (func_14(0, 0, 1, 1))
	{
		return 1;
	}
...
void func_40(int iParam0)
{
	...
	Global_43604[iParam0] = get_game_timer();
}

void func_41()
{
	Global_43603 = get_game_timer();
}
