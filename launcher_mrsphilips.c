...
void __EntryFunction__()
{
	...
	func_233(&Var0);
	iLocal_52 = add_scenario_blocking_area(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), false, true, true, true);
...
int func_245(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_246(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_247(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
