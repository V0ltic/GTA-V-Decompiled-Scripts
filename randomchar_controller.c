				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_56))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (does_blip_exist(Global_32338[iVar3 /*23*/].f_19))
								{
									set_blip_flashes(Global_32338[iVar3 /*23*/].f_19, true);
									set_blip_flash_timer(Global_32338[iVar3 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
void func_10()
{
	...
	{
		if (func_14(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
{
	return (shift_right(iParam0, 26) & 31 * func_31(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_42()
{
	...
	func_38(&uVar0, get_clock_month());
	func_36(&uVar0, get_clock_year());
	return uVar0;
}
...
void func_49()
{
	if (is_player_playing(player_id()))
	{
		if (!func_45(55))
		{
			if ((func_53(5) && func_51(player_ped_id(), func_52(5), 1) < func_50(5)) || (func_53(6) && func_51(player_ped_id(), func_52(6), 1) < func_50(6)))
			{
...
void func_76()
{
	...
	if (!func_82(iVar0) || iVar0 == 52)
	{
		if (!BitTest(Global_113386.f_18574.f_390[iLocal_52], bLocal_51))
		{
			...
			if (iVar0 == 58)
			{
				set_bit(&(Global_113386.f_18574.f_390[iLocal_52]), bLocal_51);
			}
			else if (get_minimap_fow_coordinate_is_revealed(Var1.f_6))
			{
				set_bit(&(Global_113386.f_18574.f_390[iLocal_52]), bLocal_51);
			}
...
void func_83(int iParam0)
{
	...
	if (!BitTest(Global_113386.f_18574[iParam0 /*6*/], 1))
	{
		if (!Var0.f_23)
		{
			set_bit(&(Global_113386.f_18574[iParam0 /*6*/]), true);
		}
	}
	if (BitTest(Global_113386.f_18574[iParam0 /*6*/], 0) && !BitTest(Global_113386.f_18574[iParam0 /*6*/], 3))
	{
		if (!Global_113386.f_18574[iParam0 /*6*/].f_1)
		{
			...
			if (iParam0 == 57)
			{
				iVar2 = get_random_int_in_range(3, 11);
				iVar2 *= 30;
		...
		if (BitTest(Global_113386.f_18574[iParam0 /*6*/], 1))
		{
			if (!BitTest(Global_113386.f_18574[iParam0 /*6*/], 2))
			{
				...
				if (bVar3)
				{
					set_bit(&(Global_113386.f_18574[iParam0 /*6*/]), 2);
					...
					if (iParam0 == 35)
					{
						...
						_0x6D6840CEE8845831("launcher_MrsPhilips");
					}
					else if (iParam0 == 58)
					{
						Global_112473[iParam0 /*10*/].f_3 = 0;
						_0x6D6840CEE8845831("launcher_Tonya");
					}
					else
					{
	...
	if (BitTest(Global_113386.f_18574[iParam0 /*6*/], 2) && !BitTest(Global_113386.f_18574[iParam0 /*6*/], 3))
	{
		...
		if (!bVar11)
		{
			clear_bit(&(Global_113386.f_18574[iParam0 /*6*/]), 2);
		}
	}
	iVar12 = 1;
	...
	else if (Global_112473[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && get_distance_between_coords(get_entity_coords(player_ped_id(), false), Var0.f_6, false) > fVar13)
		{
			Global_112473[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	if (!BitTest(Global_113386.f_18574[iParam0 /*6*/], 4))
	{
		...
		{
			set_bit(&(Global_113386.f_18574[iParam0 /*6*/]), 4);
		}
		else if (iVar14 == 2)
		{
			if (func_94(Var0.f_26, func_9()))
			{
				if (!func_89() && !is_player_switch_in_progress())
				{
	...
	if (is_player_playing(player_id()))
	{
		if (!func_45(35))
		{
			if (BitTest(Global_113386.f_18574[iParam0 /*6*/], 2) && !BitTest(Global_113386.f_18574[iParam0 /*6*/], 3))
			{
				...
				{
					if (vdist2(Var0.f_6, get_entity_coords(player_ped_id(), true)) < 81f)
					{
						sVar16 = "";
						...
						if (!is_string_null_or_empty(sVar16))
						{
...
void func_98(int iParam0, int iParam1)
{
	...
	set_bits_in_range(&(Global_32338[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_32335 == 1)
	{
		Global_32336 = 1;
	}
...
void func_102(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		set_bit(&(Global_32338[iVar0 /*23*/].f_11), 28);
	}
	else
	{
		clear_bit(&(Global_32338[iVar0 /*23*/].f_11), 28);
	}
	if (Global_32335 == 1)
	{
		Global_32336 = 1;
...
int func_112(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				iVar0 = get_entity_model(func_113(get_vehicle_ped_is_in(player_ped_id(), true)));
				switch (iVar0)
				{
...
void func_114(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && _get_number_of_references_of_script_with_name_hash(Global_91229[26 /*34*/].f_6) == 0)
			{
				Global_113386.f_7261[iParam0] = 1;
				door_system_set_door_state(uParam1->f_5, Global_113386.f_7261[iParam0], true, true);
			}
