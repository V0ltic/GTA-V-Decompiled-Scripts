...
void __EntryFunction__()
{
	...
	if ((func_58() || func_57()) || is_pc_version())
	{
		iLocal_142 = 40;
	}
		...
		case 3:
			while (iLocal_134 == 0)
			{
				...
				if (_0x2E22FEFA0100275E())
				{
					...
					{
						_get_pause_menu_selection_data(&uVar0, &iVar1, &iVar2);
						if (iVar1 == 50)
						{
							iLocal_138 = iVar2;
							func_1(&uLocal_140);
...
int func_1(var uParam0)
{
	...
	if (iVar0 > 16)
	{
		...
		pause_menu_activate_context(-1871331138);
	}
	else
	{
		iLocal_139 = 0;
...
void func_3(bool bParam0, bool bParam1)
{
	...
	{
		scaleform_movie_method_add_param_int(bParam0);
	...
	if (bParam0 == 2)
	{
		if (bParam1)
		{
			clear_bit(&Global_1574941, bParam0);
		}
		else
		{
			set_bit(&Global_1574941, bParam0);
		}
	}
}
...
void func_5(bool bParam0, bool bParam1, bool bParam2, char* sParam3, bool bParam4)
{
	...
	if (!is_string_null_or_empty(sParam3))
	{
		...
		add_text_component_integer(bParam1);
		add_text_component_integer(bParam2);
...
int func_39(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			if ((((func_41() || func_40()) || is_pc_version()) || func_57()) || func_58())
			{
				iVar0 += 2;
				iVar0 += 2;
				iVar0++;
		...
		case 6:
			if ((network_has_social_club_account() || func_41()) || func_40())
			{
				iVar0 = 0;
				iVar0 += 19;
				iVar0 += 8;
...
void func_45()
{
	...
	_get_pause_menu_selection_data(&uVar0, &uVar1, &uVar2);
	func_43(0);
	iLocal_138 = 0;
...
int func_49(int iParam0)
{
	...
	iVar1 = func_52(iVar0);
	bVar2 = func_51(iVar0);
	if ((is_control_just_released(2, iParam0) || is_disabled_control_just_released(2, iParam0)) || func_50(iParam0, &(Global_1648034.f_1060), 1))
	{
