...
void __EntryFunction__()
{
	...
	{
		wait(0);
		_0x208784099002BC30("SF_GRTSI", 0);
...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_224(&uLocal_83, 1, player_ped_id(), "FRANKLIN", 0, 1);
...
int func_210()
{
	...
	if (player_id() == func_213())
	{
		return 0;
	}
	if (func_211(player_id()))
	{
		return 0;
	}
...
{
	if (((!func_248(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_247(0)) || func_246(1))
			{
			}
			else
			{
...
void func_253(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_153(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_258(*iParam1, 0, &uVar0))
		{
...
int func_258(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = get_entity_model(iParam0);
	if ((!func_287(iVar0, bParam1, uParam2) && !func_286(player_id())) && !func_268(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_266(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_264(iParam0)) && !bVar1) && !(func_263(get_entity_model(iParam0)) && func_260(player_id())))
	{
	...
	{
		if ((func_259(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_285(player_id()) || func_284(player_id()))
	{
		if (func_269(iParam0))
		{
			return 1;
...
int func_270(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_264(iParam0)) || func_271(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_272(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_274(get_entity_model(iParam0), 0))
			{
...
int func_287(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_266(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_291(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_308(iParam0, 0, 0)) || func_308(iParam0, 1, 0)) || func_308(iParam0, 2, 0)) || func_307(iParam0) != 145) || func_306(iParam0)) || func_305(iParam0)) || func_259(iParam0)) || func_304(iParam0)) || !func_294(get_entity_model(iParam0)))
	{
		if (func_305(iParam0))
		{
		}
...
int func_313(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_283(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_316(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_321(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_322(iParam0, iParam1))
				{
...
void func_323(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
...
bool func_329(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
int func_330(struct<3> Param0, float fParam1)
{
	return func_331(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_331(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_355(uParam0))
	{
		...
		if (func_354(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_333(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
int func_333(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_335(iParam0, uVar1[iVar3], 1) && func_334(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_329(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
int func_334(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_336(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_291(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_291(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_291(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_291(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_291(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_291(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_291(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_337() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
void func_382(bool bParam0)
{
	...
	if (!func_403())
	{
		...
		{
			func_161(iVar0, 1, 0);
			func_383(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
