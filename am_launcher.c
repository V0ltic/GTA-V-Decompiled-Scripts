...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (func_396(network_player_id_to_int()))
		{
			case 0:
				if (func_395() == 1)
				{
					if (func_394())
					{
						Local_210[network_player_id_to_int() /*3*/] = 1;
					}
				}
				break;
			...
			case 1:
				...
				{
					Local_210[network_player_id_to_int() /*3*/] = 3;
				}
				break;
...
void func_1()
{
	...
	switch (Global_2779753.f_2)
	{
		...
		case 6:
			if (!func_11())
			{
				if (network_is_script_active(func_6(Global_2779753.f_3.f_1), -1, false, 0))
				{
					func_318(7);
...
void func_2(bool bParam0)
{
	...
	{
		clear_bit(&(Global_2779753.f_1), bParam0);
	}
}
...
int func_11()
{
	...
	if (network_get_host_of_script("AM_IMP_EXP", -1, 0) != func_295())
	{
		func_12(func_13(network_get_host_of_script("AM_IMP_EXP", -1, 0)), 1);
		Global_2815059.f_1724 = 0;
		func_318(7);
		func_4(Global_2779753.f_3);
	}
...
void func_17(bool bParam0)
{
	if (!BitTest(Global_2779753.f_1, bParam0))
	{
		set_bit(&(Global_2779753.f_1), bParam0);
	}
}
...
int func_20(var[] uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20)
{
	...
	else if (network_get_host_of_script(func_22(), -1, 0) != player_id())
	{
		return 0;
	}
	func_21();
...
void func_21()
{
	...
	if (network_get_host_of_script(func_22(), -1, 0) == player_id())
	{
		iVar0 = 0;
		while (iVar0 < 9)
		{
...
int func_72(int iParam0, var uParam1)
{
	...
	fVar4 = get_random_float_in_range(0f, fVar1);
	iVar3 = 0;
	while (iVar3 < func_75(iParam0))
	{
...
int func_77(int iParam0, int iParam1, int iParam2)
{
	...
	fVar7 = get_random_float_in_range(0f, fVar3);
	iVar8 = -1;
	iVar6 = iVar0;
	while (iVar6 <= iVar1)
	{
...
int func_86()
{
	...
	func_96(&uVar0, get_clock_seconds());
	func_95(&uVar0, get_clock_minutes());
	func_94(&uVar0, get_clock_hours());
	func_89(&uVar0, get_clock_day_of_month());
	func_88(&uVar0, get_clock_month());
	func_87(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_92(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_102(struct<3> Param0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16)
{
...
int func_103(struct<3> Param0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_112(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_108(player_id()), Param0, true) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_105(iVar1, 0) && _network_is_player_equal_to_index(player_id(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != player_id()))
				{
					if ((func_104(iVar1) || !bParam8) && !Global_2689235[iVar1 /*453*/].f_267)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (get_distance_between_coords(func_108(iVar1), Param0, true) <= (fVar2 + fParam1))
								{
...
int func_113(struct<3> Param0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && player_id() != iVar1) || iParam6 == 0)
		{
			if (func_112(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!is_ped_injured(get_player_ped(iVar1)) && func_104(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							if (((get_player_team(player_id()) == -1 && uParam7) && bParam4) && func_114(iVar1))
							{
							}
							else if (does_entity_exist(get_player_ped(iVar1)))
							{
								if (get_distance_between_coords(func_109(iVar1), Param0, true) < fParam1)
								{
									return 1;
								}
							}
...
int func_128(var uParam0, int iParam1, int iParam2)
{
	switch (func_71(iParam1))
	{
		...
		case 2:
			if (iParam2 != func_295())
			{
				if (!func_138(uParam0->f_129, uParam0->f_767, uParam0->f_1220, get_entity_coords(get_player_ped(iParam2), false)))
				{
					return 0;
				}
			}
...
int func_138(int iParam0, int iParam1, int iParam2, struct<3> Param3)
{
	...
	_0xE42D626EEC94E5D9(Param3, 0, &iVar0, &iVar1, &iVar2);
...
int func_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_112(iParam4, 0, 1))
	{
		...
		{
			fVar4 = get_distance_between_coords(Var0, Var1, true);
...
float func_141(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case 294:
			...
			{
				case 0:
					return to_float(Global_262145.f_33543);
				
				case 1:
					return to_float(Global_262145.f_33544);
		...
		case 295:
			return to_float(Global_262145.f_33545);
		
		case 297:
			switch (iParam1)
			{
				case 1:
					return to_float(Global_262145.f_33546);
				
				case 0:
					return to_float(Global_262145.f_33547);
		...
		case 296:
			return to_float(Global_262145.f_33548);
		
		case 298:
			return to_float(Global_262145.f_33549);
		
		case 293:
			switch (iParam1)
			{
				case 1:
					return to_float(Global_262145.f_33550);
				
				case 0:
					return to_float(Global_262145.f_33551);
		...
		case 291:
			return to_float(Global_262145.f_33552);
		
		case 292:
			return to_float(Global_262145.f_33553);
		
		case 299:
			switch (iParam1)
			{
				case 0:
					return to_float(Global_262145.f_33554);
				
				case 1:
					return to_float(Global_262145.f_33555);
		...
		case 300:
			return to_float(Global_262145.f_33556);
		
		case 301:
			switch (iParam1)
			{
				case 0:
					return to_float(Global_262145.f_33557);
				
				case 1:
					return to_float(Global_262145.f_33558);
...
Vector3 func_144(var uParam0, int iParam1, int iParam2, int iParam3)
{
	switch (iParam1)
	{
		...
		case 296:
			return func_147(func_32(iParam2, iParam3, 0, player_id()));
	}
...
Vector3 func_154(struct<3> Param0)
{
	...
	if (func_159(0))
	{
		...
		if (func_156(iVar0))
		{
			return get_offset_from_entity_in_world_coords(iVar0, Param0);
		}
		else
		{
	...
	{
		iVar1 = func_157(player_id());
		if (func_156(iVar1))
		{
			return get_offset_from_entity_in_world_coords(iVar1, Param0);
		}
	}
	return 0f, 0f, 0f;
}
...
{
	return func_160(player_id(), bParam0);
}
...
Vector3 func_164(int iParam0)
{
	...
	{
		Var1 = { func_211(func_212(Global_1853348[player_id() /*834*/].f_267.f_32)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
int func_175(int iParam0)
{
	if (iParam0 != func_295())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_112(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
int func_176(int iParam0)
{
	if (iParam0 != func_295())
	{
		...
		else if (((Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_1575058) && iParam0 == player_id()) && func_112(iParam0, 1, 0))
		{
			return func_170(Global_2689235[iParam0 /*453*/].f_318.f_6) == 20;
		}
	}
...
int func_208(int iParam0)
{
	if (iParam0 != func_295())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_112(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_209(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_210(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
int func_220(char* sParam0, var uParam1, var uParam2)
{
	...
	func_239();
	if (!datafile_load_offline_ugc(sParam0, 0))
	{
		return 0;
	}
	func_222(uParam1);
...
void func_222(var uParam0)
{
	...
	uVar1 = datadict_get_dict(sVar0, "mission");
	Global_4718592.f_116954 = datadict_get_int(sVar0, "debugOnlyVersion");
...
void func_224(var uParam0, var uParam1)
{
	...
	if (bVar4)
	{
		uVar3 = datadict_get_array(*uParam0, "fmbs");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar9[iVar2])
		{
			StringCopy(&Var0, "bs", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar8[iVar2] = datadict_get_array(iVar7, &Var0);
		}
		iVar2++;
	}
	if (bVar11)
	{
		uVar10 = datadict_get_array(iVar7, "mn");
	}
	if (bVar13)
	{
		uVar12 = datadict_get_array(iVar7, "pos");
	}
	if (bVar15)
	{
		uVar14 = datadict_get_array(iVar7, "head");
	}
	if (bVar17)
	{
		uVar16 = datadict_get_array(iVar7, "rot");
	}
	if (bVar19)
	{
		uVar18 = datadict_get_array(iVar7, "cv");
	}
	if (bVar21)
	{
		uVar20 = datadict_get_array(iVar7, "crt");
	}
	if (bVar23)
	{
		uVar22 = datadict_get_array(iVar7, "int");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar27[iVar2])
		{
			StringCopy(&Var0, "bs", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar26[iVar2] = datadict_get_array(iVar25, &Var0);
		}
		iVar2++;
	}
	if (bVar29)
	{
		uVar28 = datadict_get_array(iVar25, "mn");
	}
	if (bVar31)
	{
		uVar30 = datadict_get_array(iVar25, "pos");
	}
	if (bVar33)
	{
		uVar32 = datadict_get_array(iVar25, "head");
	}
	if (bVar35)
	{
		uVar34 = datadict_get_array(iVar25, "wpn");
	}
	if (bVar37)
	{
		uVar36 = datadict_get_array(iVar25, "veh");
	}
	if (bVar39)
	{
		uVar38 = datadict_get_array(iVar25, "st");
	}
	if (bVar41)
	{
		uVar40 = datadict_get_array(iVar25, "scen");
	}
	if (bVar43)
	{
		uVar42 = datadict_get_array(iVar25, "anim");
	}
	if (bVar45)
	{
		uVar44 = datadict_get_array(iVar25, "int");
	}
	if (bVar47)
	{
		uVar46 = datadict_get_array(iVar25, "asi");
	}
	if (bVar49)
	{
		uVar48 = datadict_get_array(iVar25, "grp");
	}
	if (bVar51)
	{
		uVar50 = datadict_get_array(iVar25, "mvmt");
	}
	if (bVar53)
	{
		uVar52 = datadict_get_array(iVar25, "mrd");
	}
	if (bVar55)
	{
		uVar54 = datadict_get_array(iVar25, "sr");
	}
	if (bVar57)
	{
		uVar56 = datadict_get_array(iVar25, "sa");
	}
	if (bVar59)
	{
		uVar58 = datadict_get_array(iVar25, "hr");
	}
	if (bVar61)
	{
		uVar60 = datadict_get_array(iVar25, "dr");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar66[iVar2])
		{
			StringCopy(&Var0, "ar", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar65[iVar2] = datadict_get_array(iVar64, &Var0);
		}
		iVar2++;
	}
	if (bVar68)
	{
		uVar67 = datadict_get_array(iVar62, "ed");
	}
	if (bVar70)
	{
		uVar69 = datadict_get_array(iVar62, "gt");
	}
	iVar2 = 0;
	while (iVar2 < 2)
	{
		if (iVar74[iVar2])
		{
			StringCopy(&Var0, "bsa", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar73[iVar2] = datadict_get_array(iVar72, &Var0);
		}
		iVar2++;
	}
	if (bVar76)
	{
		uVar75 = datadict_get_array(iVar72, "mn");
	}
	if (bVar78)
	{
		uVar77 = datadict_get_array(iVar72, "pos");
	}
	if (bVar80)
	{
		uVar79 = datadict_get_array(iVar72, "head");
	}
	if (bVar82)
	{
		uVar81 = datadict_get_array(iVar72, "col");
	}
	if (bVar84)
	{
		uVar83 = datadict_get_array(iVar72, "int");
	}
	if (bVar86)
	{
		uVar85 = datadict_get_array(iVar72, "vds");
	}
	if (bVar89)
	{
		uVar88 = datadict_get_array(iVar87, "sprt");
	}
	if (bVar91)
	{
		uVar90 = datadict_get_array(iVar87, "hclr");
	}
	if (bVar93)
	{
		uVar92 = datadict_get_array(iVar87, "scl");
	}
	if (bVar95)
	{
		uVar94 = datadict_get_array(iVar87, "sh");
	}
	iVar2 = 0;
	while (iVar2 < 2)
	{
		if (iVar99[iVar2])
		{
			StringCopy(&Var0, "bsa", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar98[iVar2] = datadict_get_array(iVar97, &Var0);
		}
		iVar2++;
	}
	if (bVar101)
	{
		uVar100 = datadict_get_array(iVar97, "mn");
	}
	if (bVar103)
	{
		uVar102 = datadict_get_array(iVar97, "pos");
	}
	if (bVar105)
	{
		uVar104 = datadict_get_array(iVar97, "head");
	}
	if (bVar107)
	{
		uVar106 = datadict_get_array(iVar97, "rot");
	}
	if (bVar109)
	{
		uVar108 = datadict_get_array(iVar97, "int");
	}
	if (bVar115)
	{
		uVar114 = datadict_get_array(iVar113, "idx");
	}
	if (bVar119)
	{
		uVar118 = datadict_get_array(iVar117, "pos");
	}
	if (bVar121)
	{
		uVar120 = datadict_get_array(iVar117, "rad");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar123[iVar2])
		{
			StringCopy(&Var0, "bsa", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar122[iVar2] = datadict_get_array(iVar117, &Var0);
		}
		iVar2++;
	}
	if (bVar125)
	{
		uVar124 = datadict_get_array(iVar117, "brd");
	}
	if (bVar128)
	{
		uVar127 = datadict_get_array(iVar126, "sprt");
	}
	if (bVar130)
	{
		uVar129 = datadict_get_array(iVar126, "hclr");
	}
	if (bVar132)
	{
		uVar131 = datadict_get_array(iVar126, "scl");
	}
	if (bVar134)
	{
		uVar133 = datadict_get_array(iVar126, "sh");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar138[iVar2])
		{
			StringCopy(&Var0, "ibs", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar137[iVar2] = datadict_get_array(iVar136, &Var0);
		}
		iVar2++;
	}
	if (bVar140)
	{
		uVar139 = datadict_get_array(iVar136, "vmn");
	}
	if (bVar142)
	{
		uVar141 = datadict_get_array(iVar136, "vmx");
	}
	if (bVar144)
	{
		uVar143 = datadict_get_array(iVar136, "fwd");
	}
	if (bVar148)
	{
		uVar147 = datadict_get_array(iVar146, "pedi");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar151[iVar2])
		{
			StringCopy(&Var0, "scro", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar150[iVar2] = datadict_get_array(iVar149, &Var0);
		}
		if (iVar153[iVar2])
		{
			StringCopy(&Var0, "pos", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar152[iVar2] = datadict_get_array(iVar149, &Var0);
		}
		if (iVar155[iVar2])
		{
			StringCopy(&Var0, "look", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar154[iVar2] = datadict_get_array(iVar149, &Var0);
		}
		if (iVar157[iVar2])
		{
			StringCopy(&Var0, "dur", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar156[iVar2] = datadict_get_array(iVar149, &Var0);
		}
		iVar2++;
	}
	if (bVar160)
	{
		uVar159 = datadict_get_array(iVar158, "name");
	}
	if (bVar163)
	{
		uVar162 = datadict_get_array(iVar161, "pos");
	}
	if (bVar165)
	{
		uVar164 = datadict_get_array(iVar161, "head");
	}
	if (bVar167)
	{
		uVar166 = datadict_get_array(iVar161, "plnkp");
	}
	iVar2 = 0;
	while (iVar2 < 1)
	{
		if (iVar169[iVar2])
		{
			StringCopy(&Var0, "ibs", 16);
			StringIntConCat(&Var0, iVar2, 16);
			uVar168[iVar2] = datadict_get_array(iVar161, &Var0);
		}
		iVar2++;
	}
...
struct<16> func_225(var* uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (bParam3 && iParam1 < dataarray_get_count(uParam0))
	{
		StringCopy(&Var0, dataarray_get_string(uParam0, iParam1), 64);
	}
	else
	{
...
int func_226(var* uParam0, int iParam1, int iParam2, bool bParam3)
{
	if (bParam3 && iParam1 < dataarray_get_count(uParam0))
	{
		return dataarray_get_bool(uParam0, iParam1);
	}
	return iParam2;
}
...
float func_227(var* uParam0, int iParam1, float fParam2, bool bParam3)
{
	if (bParam3 && iParam1 < dataarray_get_count(uParam0))
	{
		return dataarray_get_float(uParam0, iParam1);
	}
	return fParam2;
}

Vector3 func_228(var* uParam0, int iParam1, struct<3> Param2, bool bParam3)
{
	if (bParam3 && iParam1 < dataarray_get_count(uParam0))
	{
		return dataarray_get_vector(uParam0, iParam1);
	}
	return Param2;
}
...
int func_229(var* uParam0, int iParam1, int iParam2, bool bParam3)
{
	if (bParam3 && iParam1 < dataarray_get_count(uParam0))
	{
		return dataarray_get_int(uParam0, iParam1);
	}
	return iParam2;
}
...
{
	if (func_231(iParam0) && datadict_get_type(iParam0, sParam1) == 1)
	{
		return datadict_get_bool(iParam0, sParam1);
	}
	return iParam2;
}
...
{
	if (func_231(iParam0) && datadict_get_type(iParam0, sParam1) == 3)
	{
		return datadict_get_float(iParam0, sParam1);
	}
	return fParam2;
}
...
{
	if (func_231(iParam0) && datadict_get_type(iParam0, sParam1) == 2)
	{
		return datadict_get_int(iParam0, sParam1);
	}
	return iParam2;
}
...
struct<16> func_236(int iParam0, char* sParam1, char* sParam2)
{
	...
	if (func_231(iParam0) && datadict_get_type(iParam0, sParam1) == 4)
	{
		StringCopy(&Var0, datadict_get_string(iParam0, sParam1), 64);
	}
	else
	{
		StringCopy(&Var0, sParam2, 64);
...
int func_237(int iParam0, char* sParam1)
{
	...
	return datadict_get_type(iParam0, sParam1);
}
...
void func_238(var uParam0, int iParam1, char* sParam2)
{
	...
	if (!func_231(*uParam0) && datadict_get_type(iParam1, sParam2) == 6)
	{
		*uParam0 = datadict_get_dict(iParam1, sParam2);
		if (!func_231(*uParam0))
		{
		}
	}
	...
	switch (iParam0)
	{
		case 276:
			switch (iParam1)
			{
				case 2:
				case 3:
					return get_random_int_in_range(iParam2, iParam3 + 1);
...
void func_301()
{
	func_302(func_13(network_get_host_of_script(func_22(), -1, 0)), 0);
	if (get_random_int_in_range(0, 100) < Global_262145.f_137)
	{
		if (network_get_num_participants() >= Global_262145.f_138)
		{
			func_302(func_13(network_get_host_of_script(func_22(), -1, 0)), 1);
			func_17(4);
		}
	}
}
...
int func_303(struct<2> Param0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
	...
	{
		if (network_is_player_active(int_to_playerindex(iVar0)) && func_112(int_to_playerindex(iVar0), 1, 1))
		{
			if (BitTest(Local_210[iVar0 /*3*/].f_1, 0))
			{
				...
				if (Param0.f_1 == 18)
				{
					if (network_get_num_participants() >= func_304(Param0.f_0))
					{
						return 1;
					}
					else
...
int func_317(int iParam0)
{
	if (iParam0 == 12)
	{
		if (network_is_script_active("AM_PENNED_IN", -1, false, 0))
		{
			return 1;
		}
	}
...
void func_325()
{
	...
	iVar0 = 10000;
	switch (Local_210[network_player_id_to_int() /*3*/].f_2)
	{
		case 0:
			if (Global_2779753.f_2 >= 4 && Global_2779753.f_2 != 8)
			{
				if (func_300(1))
				{
					set_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), false);
					clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), true);
				}
				if (!func_393(player_id(), 1))
				{
					func_392(4);
				}
				else if (!func_393(player_id(), 3))
				{
					func_319(&uLocal_202);
					set_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 3);
				}
				else
				{
					...
					{
						clear_bit(&uLocal_199, true);
						func_392(4);
						clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 3);
					}
				}
			}
			else if (func_393(player_id(), 1))
			{
				clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), true);
			}
			break;
		...
		case 4:
			if (func_393(player_id(), 0))
			{
				if (Global_2779753.f_2 == 8)
				{
					func_392(8);
					clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), false);
					clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 4);
				}
			...
			else
			{
				if (func_380())
				{
					if (!func_370())
					{
						set_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 4);
					}
				...
				if (!func_393(player_id(), 0))
				{
					...
					{
						set_bit(&uLocal_199, true);
					}
					func_392(0);
					set_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), true);
					clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 4);
				}
			}
			break;
		...
		case 5:
			...
			{
				clear_bit(&(Global_2815059.f_206.f_1), true);
				clear_bit(&(Global_2815059.f_206.f_1), 2);
				clear_bit(&(Global_2815059.f_206.f_1), 3);
				func_392(6);
			}
		...
		case 6:
			...
			if (!func_331())
			{
				if (!func_393(player_id(), 2))
				{
					Local_200.f_16 = -1;
					if (_get_number_of_references_of_script_with_name_hash(get_hash_key(&cVar1)) == 0)
					{
						if (!network_is_script_active(&cVar1, -1, false, 0) || network_get_num_script_participants(&cVar1, -1, 0) < 32)
						{
							if (!network_is_script_active(&cVar1, -1, true, 0))
							{
								Local_200.f_0 = Global_2779753.f_3.f_1;
								if (func_326(Local_200, 0))
								{
									set_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 2);
								}
							}
						}
					}
				}
				else if (_get_number_of_references_of_script_with_name_hash(get_hash_key(&cVar1)) != 0)
				{
					if (Global_2779753.f_2 == 7)
					{
						func_392(7);
						set_bit(&uLocal_199, false);
						clear_bit(&(Local_210[network_player_id_to_int() /*3*/].f_1), 2);
					}
				}
			}
			break;
...
int func_326(struct<17> Param0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5)
{
	char cVar0[32];
	bool bVar1;
	int iVar2;
	...
	if (does_script_exist(&cVar0))
	{
		...
		if (has_script_loaded(&cVar0))
		{
			...
			if (bParam5)
			{
				...
				while (iVar2 < 16)
				{
					if (network_is_script_active(&cVar0, iVar2, bVar1, 0))
					{
						return 0;
					}
					iVar2++;
			...
			else if (network_is_script_active(&cVar0, Param0.f_16, bVar1, 0))
			{
				return 0;
			}
			iVar3 = start_new_script_with_args(&cVar0, &Param0, 21, func_327(Param0.f_0));
		...
		if (!BitTest(Global_2815059.f_206.f_1, 1))
		{
			if (((Global_262145.f_45 * 120000) - func_350(&(Global_2779753.f_177), 0, 0)) < 360000)
			{
				if (!BitTest(Global_2815059.f_206.f_1, 1))
				{
					...
					set_bit(&(Global_2815059.f_206.f_1), true);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_350(&(Global_2779753.f_177), 0, 0)) < 600000)
			{
				if (!BitTest(Global_2815059.f_206.f_1, 2))
				{
					...
					set_bit(&(Global_2815059.f_206.f_1), 2);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_350(&(Global_2779753.f_177), 0, 0)) < 1200000)
			{
				if (!BitTest(Global_2815059.f_206.f_1, 3))
				{
					...
					set_bit(&(Global_2815059.f_206.f_1), 3);
				}
			}
		}
	}
...
void func_334(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_337() || !network_is_activity_session()) || !func_105(player_id(), 0))
	{
		return;
	}
...
int func_354(int iParam0)
{
	...
	{
		case 0:
			return (((func_360(0) && func_359(func_109(player_id()), 40f, 40f, 40f)) && get_entity_speed(player_ped_id()) < 10f) && !func_358());
		
		case 4:
			return (((((func_339(20, 0, 0) && !func_357(player_id(), 1)) && !func_357(player_id(), 2)) && !func_357(player_id(), 3)) && !Global_2703735.f_3428) && !func_355());
...
int func_358()
{
	if (is_entity_in_angled_area(player_ped_id(), 1216.995f, -3001.906f, 4.865235f, 835.3747f, -3013.846f, 54.7638f, 250f, false, true, 0))
	{
		return 1;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 1284.885f, -3184.986f, 4.906164f, 833.8964f, -3182.306f, 54.90125f, 250f, false, true, 0))
	{
		return 1;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 1284.793f, -3270.265f, 4.902858f, 838.3597f, -3268.248f, 55.07449f, 250f, false, true, 0))
	{
		return 1;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 864.6642f, -2900.037f, 4.900886f, 864.0037f, -3345.969f, 54.90067f, 250f, false, true, 0))
	{
		return 1;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 447.0059f, -2983.689f, 5.00868f, 750.05f, -2981.953f, 54.88502f, 250f, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_359(struct<3> Param0, struct<3> Param1)
{
	struct<3> Var0;
	
	if (get_closest_vehicle_node(Param0, &Var0, 0, 3f, 0f))
	{
		if (is_entity_at_coord(player_ped_id(), Var0, Param1, false, true, 0))
		{
			return 1;
		}
	}
...
int func_363(bool bParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_112(int_to_playerindex(iVar0), 0, 1))
		{
...
int func_370()
{
	...
	if (((((iVar0 >= 0 && func_377(iVar0)) || func_375(player_id())) || func_373(player_id())) || !func_372(player_id())) || !func_371())
	{
		return 0;
	}
	return 1;
...
bool func_380()
{
	return ((((((((((((((((((((((!network_is_in_tutorial_session() && !func_391(player_id())) && !func_364()) && !func_390()) && !func_338()) && !func_389()) && !func_387(player_id())) && !network_is_activity_session()) && !func_366(player_id())) && func_352()) && !func_357(player_id(), 0)) && !func_357(player_id(), 7)) && !func_357(player_id(), 21)) && !func_357(player_id(), 25)) && (!func_386(player_id(), 0, -1) || Global_2779753.f_3 == 11)) && func_112(player_id(), 1, 1)) && !func_385(player_id())) && func_372(player_id())) && !func_173(player_id())) && !func_172(player_id())) && !func_171(player_id())) && !func_383(player_id())) && !func_381());
}
...
{
	Local_210[network_player_id_to_int() /*3*/].f_2 = iParam0;
}
...
int func_397()
{
	...
	if (func_398() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_398()) == 0)
		{
			return 1;
		}
	}
...
int func_406(struct<21> Param0)
{
	...
	func_407(0, -1, 0);
	network_register_host_broadcast_variables(&Global_2779753, 186, 0);
	network_register_player_broadcast_variables(&Local_210, 97, 0);
	set_this_script_can_be_paused(false);
	Local_210[network_player_id_to_int() /*3*/] = 0;
	func_392(0);
	return 1;
}
