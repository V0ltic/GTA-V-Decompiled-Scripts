...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (network_is_in_tutorial_session())
		{
			...
			{
				if (ScriptParam_150.f_16 != (50 + player_id()))
				{
					func_55(2);
				}
			}
			else if (ScriptParam_150.f_16 != network_get_player_tutorial_session_instance(player_id()))
			{
				func_55(2);
			}
		}
		...
		switch (func_53(participant_id_to_int()))
		{
			case 0:
				if (Global_4718592 == 2)
				{
		...
		if (network_is_host_of_this_script())
		{
			switch (func_46())
			{
				...
				case 2:
					if (func_53(participant_id_to_int()) == 1)
					{
						func_1();
					}
					break;
...
void func_1()
{
	...
	while (bLocal_123 < 6)
	{
		if (func_7(int_to_playerindex(iLocal_122), 0, 1))
		{
			if (BitTest(Local_148[iLocal_122 /*4*/].f_2, bLocal_123))
			{
				set_bit(&(Local_125.f_2[bLocal_123]), iLocal_122);
			}
			else
			{
				clear_bit(&(Local_125.f_2[bLocal_123]), bLocal_122);
			}
		}
		else
		{
			clear_bit(&(Local_125.f_9[bLocal_123]), bLocal_122);
			clear_bit(&(Local_125.f_9[bLocal_123]), bLocal_122);
		}
...
void func_2(bool bParam0, int iParam1, int iParam2)
{
	...
	{
		if (door_system_get_door_pending_state(iParam1) == -1)
		{
			if (door_system_get_door_state(iParam1) != iParam2)
			{
				if (network_has_control_of_door(iParam1))
				{
					set_bit(&(iLocal_146[bParam0]), bVar0);
					door_system_set_door_state(iParam1, iParam2, true, true);
		...
		else if (door_system_get_door_pending_state(iParam1) != iParam2)
		{
			if (network_has_control_of_door(iParam1))
			{
				set_bit(&(iLocal_146[bParam0]), bVar0);
...
void func_9()
{
	...
	Var1 = { func_33(player_id()) };
	fVar0 = vdist(Var1, Local_121[iLocal_124 /*17*/].f_3);
	if ((BitTest(Global_2824440, iLocal_124) || BitTest(Global_2824440.f_1, iLocal_124)) || BitTest(Global_2824440.f_2, iLocal_124))
	{
		...
		{
			set_bit(&(Local_148[player_id() /*4*/].f_2), iLocal_124);
		}
		if (BitTest(Global_2824440.f_1, bLocal_124))
		{
			clear_bit(&(Local_148[player_id() /*4*/].f_2), bLocal_124);
		}
		if (BitTest(Global_2824440.f_2, bLocal_124))
		{
			set_bit(&(Local_148[player_id() /*4*/].f_3), bLocal_124);
		}
	}
	else if (fVar0 <= 20f)
	{
		if (is_point_in_angled_area(Var1, Local_121[bLocal_124 /*17*/].f_3, Local_121[bLocal_124 /*17*/].f_6, Local_121[bLocal_124 /*17*/].f_9, false, true))
		{
			if (!BitTest(Local_148[player_id() /*4*/].f_2, bLocal_124))
			{
				set_bit(&(Local_148[player_id() /*4*/].f_2), bLocal_124);
			}
		}
		if ((bLocal_124 == 0 || bLocal_124 == 1) || bLocal_124 == 5)
		{
			if (Global_2726961 || !func_13())
			{
				if (is_point_in_angled_area(Var1, Local_121[bLocal_124 /*17*/].f_10, Local_121[bLocal_124 /*17*/].f_13, Local_121[bLocal_124 /*17*/].f_16, false, true))
				{
					if (!BitTest(Local_148[player_id() /*4*/].f_2, bLocal_124))
					{
						set_bit(&(Local_148[player_id() /*4*/].f_2), bLocal_124);
		...
		if ((bLocal_124 == 2 || bLocal_124 == 3) || bLocal_124 == 4)
		{
			if (func_11() >= 0)
			{
				if (func_10(29))
				...
				else if (BitTest(Local_148[player_id() /*4*/].f_2, bLocal_124) && !is_point_in_angled_area(Var1, Local_121[bLocal_124 /*17*/].f_3, Local_121[bLocal_124 /*17*/].f_6, Local_121[bLocal_124 /*17*/].f_9, false, true))
				{
					clear_bit(&(Local_148[player_id() /*4*/].f_2), bLocal_124);
				}
			}
	...
	else if (BitTest(Local_148[player_id() /*4*/].f_2, bLocal_124))
	{
		clear_bit(&(Local_148[player_id() /*4*/].f_2), bLocal_124);
	}
	bLocal_124++;
...
int func_13()
{
	...
	if (func_28(player_id(), 1) && !Global_1973160)
	{
		return 1;
	}
...
void func_34()
{
	...
	{
		func_42(iVar0, &Var3);
		if (get_distance_between_coords(func_33(player_id()), Var3.f_1, true) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
			{
				iVar4 = int_to_playerindex(iVar1);
				if (func_7(iVar4, 1, 1))
				{
					if (func_35(iVar4) && is_entity_in_angled_area(get_player_ped(iVar4), Var3.f_4[0 /*3*/], Var3.f_4[1 /*3*/], Var3.f_11, false, true, 0))
					{
						bVar2 = true;
						iVar1 = 32;
					}
			...
			if (bVar2)
			{
				...
				{
					fLocal_149[iVar0] = (fLocal_149[iVar0] + (Var3.f_12 * timestep()));
					if (fLocal_149[iVar0] > 1f)
					{
						fLocal_149[iVar0] = 1f;
					}
					set_script_update_door_audio(Var3.f_0, true);
					door_system_set_open_ratio(Var3.f_0, fLocal_149[iVar0], false, false);
					door_system_set_door_state(Var3.f_0, 0, false, true);
				}
			}
			else if (fLocal_149[iVar0] != 0f)
			{
				...
				set_script_update_door_audio(Var3.f_0, true);
				door_system_set_open_ratio(Var3.f_0, fLocal_149[iVar0], false, false);
				door_system_set_door_state(Var3.f_0, 1, false, true);
			}
		}
		iVar0++;
	}
...
int func_47(int iParam0, int iParam1)
{
	...
	while (iVar1 < 40)
	{
		if (*iParam0 < 315)
		{
			...
			{
				if (!is_door_registered_with_system(Var0.f_0))
				{
					return 0;
				}
			}
...
void func_50(struct<15> Param0, bool bParam1)
{
	if (Param0.f_0 != 0)
	{
		add_door_to_system(Param0.f_0, Param0.f_2, Param0.f_3, false, bParam1, Param0.f_11);
		if (Param0.f_9)
		{
			door_system_set_hold_open(Param0.f_0, true);
		}
		if (Param0.f_12 != 0f)
		{
			door_system_set_open_ratio(Param0.f_0, Param0.f_12, false, bParam1);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
			{
				door_system_set_door_state(Param0.f_0, Param0.f_8, bParam1, false);
			}
		}
		if (Param0.f_10)
		{
			_0xA85A21582451E951(Param0.f_0, true);
		}
		if (Param0.f_14 != 0f)
		{
			door_system_set_automatic_rate(Param0.f_0, Param0.f_14, bParam1, false);
		}
		if (Param0.f_13 != 0f)
		{
			door_system_set_automatic_distance(Param0.f_0, Param0.f_13, bParam1, false);
		}
	}
}
	...
	while (iVar1 < 40)
	{
		if (*iParam0 < 315)
		{
			...
			if (Var0.f_1 == 99 || Var0.f_1 == iParam1)
			{
				if (is_door_registered_with_system(Var0.f_0))
				{
					remove_door_from_system(Var0.f_0, 0);
					return 0;
				}
			}
		}
...
{
	Local_148[participant_id_to_int() /*4*/] = iParam0;
}
...
int func_59(struct<21> Param0)
{
	...
	func_63(0, -1, 0);
	network_register_host_broadcast_variables(&Local_125, 30, 0);
	network_register_player_broadcast_variables(&Local_148, 129, 0);
	if (!func_60())
	{
		return 0;
	}
...
int func_72()
{
	...
	if (func_73() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_73()) == 0)
		{
			return 1;
		}
	}
