...
void func_139()
{
	...
	func_146();
	func_111();
	if (func_78(player_ped_id(), Local_50, 150f, 1) && !is_entity_in_angled_area(player_ped_id(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, false, true, 0))
	{
		clear_area_of_vehicles(Local_50, 6f, false, true, false, false, false, false, 0);
		set_all_vehicle_generators_active_in_area(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, false, true);
	}
	...
	if (BitTest(uLocal_49, 0))
	{
		if (BitTest(uLocal_49, 1))
		{
			...
			if (func_87(iLocal_51))
			{
				if (!is_ped_in_vehicle(player_ped_id(), iLocal_51, false))
				{
					if (is_vehicle_stopped(iLocal_51))
					{
						func_141();
						func_140(&uLocal_246);
						func_93(35, 0);
						...
						set_all_vehicle_generators_active_in_area(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, true, true);
						func_80(4, 0);
					}
				}
			}
...
void func_146()
{
	...
	{
		case 0:
			if (((!does_blip_exist(iLocal_245) && BitTest(uLocal_49, 0)) && !BitTest(uLocal_49, 1)) && BitTest(uLocal_49, 18))
			{
...
int func_147(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(Param0);
	set_blip_scale(iVar0, func_148(network_is_game_in_progress(), 1f, 1f));
	...
	if (func_105(35))
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_49, 1))
			{
				if (func_87(iLocal_51))
				{
					is_entity_at_coord(iLocal_51, Local_50, 4f, 4f, 2f, true, true, 0);
					if (is_entity_in_angled_area(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, false, true, 0))
					{
						func_152(24, 46);
			...
			{
				if (!func_78(iLocal_51, Local_50, 10f, 1) || is_entity_upsidedown(iLocal_51))
				{
					clear_bit(&uLocal_49, true);
				}
			}
								...
								if (!func_170(iVar0))
								{
									if (func_163(iVar0) && !func_162())
									{
										if (!is_entity_a_mission_entity(iVar0))
										{
											...
											{
												func_71(9);
												set_bit(&uLocal_49, 19);
											}
											else if (func_72(player_ped_id()) == 0)
											{
												func_71(17);
											}
											else
...
int func_174()
{
	...
	{
		iLocal_40 = 1;
		func_175(192, get_entity_coords(player_ped_id(), true));
		return 1;
	}
	return 0;
}
...
void func_192(bool bParam0, var uParam1)
{
	...
	func_193(&uLocal_80, Local_44.f_0, player_ped_id(), Local_44.f_1, 0, 1);
...
void func_213(bool bParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!is_help_message_being_displayed() && !func_216(func_91())) && !func_215())
			{
