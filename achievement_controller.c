		...
		if (!func_162(14))
		{
			...
			if (Global_31969)
			{
				if (!has_achievement_been_passed(12))
				{
					...
					{
						func_135(12, iVar0);
						stat_set_int(joaat("num_gold_medals_obtained"), iVar0, true);
					}
					if (iVar0 >= 70)
					{
						func_129(12, 1);
			...
			if (does_entity_exist(player_ped_id()))
			{
				...
				{
					iLocal_67++;
					if (get_game_timer() > iLocal_57)
					{
						func_118(0);
						iLocal_57 = (get_game_timer() + iLocal_62);
					}
					if (get_game_timer() > iLocal_58)
					{
						if (!has_achievement_been_passed(14) || iLocal_65 == 1)
						{
							if (func_117(53))
							{
								func_116();
						...
						iLocal_58 = (get_game_timer() + iLocal_63);
					}
				}
			}
...
void func_1()
{
	...
	bVar0 = _0x225798743970412B(&iVar1);
...
int func_19(int iParam0, int iParam1, int iParam2)
{
	if (func_20(iParam0))
	{
		return has_ped_got_weapon_component(iParam0, iParam1, iParam2);
	}
	return 0;
}
...
int func_22(int iParam0, int iParam1)
{
	...
	if (network_is_game_in_progress() && func_69())
	{
		StringCopy(&Var11, func_67(iParam1, iParam0), 16);
		func_62(&sVar10, Var11, get_entity_model(player_ped_id()), 3, 1, func_65(iParam0), func_64(iParam0), -1, 0, 0);
...
int func_69()
{
	if (network_is_game_in_progress() && func_70())
	{
		return 1;
	}
	return 0;
...
void func_90(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_93(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_91(Var7.f_1)) && iVar9 < 51)
			{
...
void func_101()
{
	...
	while (iVar0 <= 49)
	{
		...
		{
			if (_sc_get_has_achievement_been_passed(iVar0))
			{
				func_129(iVar0, 1);
			}
		}
...
void func_108(var uParam0)
{
	...
	uParam0->f_80 = (uParam0->f_80 + get_frame_time());
	if (!func_107(uParam0))
	{
		return;
	}
...
int func_116()
{
	...
	if (network_is_game_in_progress() || Global_78319)
	{
		return 0;
	}
	if (is_player_playing(player_id()))
	{
		...
		{
			fVar0 = get_minimap_fow_discovery_ratio();
			if (fVar0 > 0.01f && is_pc_version())
			{
				func_135(14, floor((fVar0 * 100f)));
			}
			if (fVar0 >= 0.975f)
			{
				func_129(14, 1);
...
int func_119()
{
	...
	iVar0 = 0;
	iVar1 = 0;
	iVar0 = (iVar0 + stat_get_number_of_days(joaat("first_person_cam_time")) * 24);
	iVar0 = (iVar0 + stat_get_number_of_hours(joaat("first_person_cam_time")));
	iVar1 = (iVar1 + stat_get_number_of_days(joaat("mp_first_person_cam_time")) * 24);
	iVar1 = (iVar1 + stat_get_number_of_hours(joaat("mp_first_person_cam_time")));
	if ((iVar0 + iVar1) >= 15)
	{
		func_129(50, 1);
		return 1;
...
int func_120()
{
	...
	iVar0 = get_num_successful_stunt_jumps();
	if (iVar0 > 0)
	{
...
int func_121(bool bParam0)
{
	...
	stat_get_int(joaat("num_discipline_gold_earned"), &iVar3, -1);
	if (iVar1 > iVar3 && iVar1 > 0)
	{
		stat_set_int(joaat("num_discipline_gold_earned"), iVar1, true);
		func_135(17, iVar1);
	}
	if (bParam0)
	{
...
void func_151()
{
	...
	if (is_entity_playing_anim(player_ped_id(), "creatures@shark@move", "attack_player", 3))
	{
		func_129(25, 1);
		return;
	}
	if (is_entity_dead(player_ped_id(), false))
	{
		iVar0 = get_ped_source_of_death(player_ped_id());
		if (is_entity_a_ped(iVar0))
		{
			iVar1 = get_ped_index_from_entity_index(iVar0);
			if (func_152(iVar1))
			{
				if (get_entity_model(iVar1) == joaat("a_c_sharktiger"))
				{
					func_129(25, 1);
					return;
				}
...
void func_153()
{
	switch (iLocal_56)
	{
		...
		case 1:
			if (func_157() || is_player_switch_in_progress())
			{
				return;
			}
