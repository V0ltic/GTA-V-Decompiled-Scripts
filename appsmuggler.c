...
void __EntryFunction__()
{
	...
	sLocal_117 = "";
	iLocal_121 = 8;
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appSmuggler")) > 1)
	{
		func_392(0, 1);
	}
	func_382();
	while (func_381())
	{
		...
		{
			if (!Global_1946250.f_3364 && is_screen_faded_out())
			{
				func_1(1);
				Global_1946108 = 1;
				func_392(0, 1);
...
void func_6()
{
	...
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_301))
		{
			iVar0 = get_scaleform_movie_method_return_value_int(iLocal_301);
			switch (iVar0)
			{
				case 0:
					func_269();
				...
				case 35:
					if (iLocal_119 != 0)
					{
						play_sound_frontend(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
					}
					iLocal_119 = 0;
					break;
				...
				case 36:
					if (iLocal_119 != 1)
					{
						play_sound_frontend(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
					}
					iLocal_119 = 1;
					break;
				...
				case 37:
					if (iLocal_119 != 2)
					{
						play_sound_frontend(-1, "Show_Sell_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
					}
					iLocal_119 = 2;
					break;
				...
				case 29:
					...
					{
						iLocal_119 = 2;
						call_scaleform_movie_method_with_number(iLocal_300, "SHOW_SCREEN", 2f, -1f, -1f, -1f, -1f);
					}
					break;
...
int func_12(int iParam0)
{
	...
	if (!func_195(player_id(), iParam0, 0))
	{
		iVar0 = func_21(player_id(), iParam0, 0);
		if (iVar0 == 7)
		{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_100(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		
		case 233:
			return func_93(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		...
		case 243:
			return func_76(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 158:
			return func_71(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
		
		case 181:
			return func_68(iParam1, iParam2, int_to_playerindex(iParam5), iParam4);
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_152(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
		
		case 233:
			return func_143(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_134(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_128(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
		
		case 181:
			return func_122(iParam1, iParam3, int_to_playerindex(iParam5), 0, -1, 0, 0);
...
{
	begin_scaleform_movie_method(iLocal_300, "SHOW_OVERLAY");
	func_200(sParam0);
	...
	if (bParam5)
	{
		play_sound_frontend(-1, "Click_Link", "GTAO_SMG_Hangar_Computer_Sounds", true);
	}
	else if (bParam4)
	{
		play_sound_frontend(-1, "Click_Fail", "GTAO_SMG_Hangar_Computer_Sounds", true);
	}
...
void func_221()
{
	switch (func_267())
	{
		case 2:
			...
			{
				func_245();
				play_sound_frontend(-1, "Click_Special", "GTAO_SMG_Hangar_Computer_Sounds", true);
				func_226(229, 0);
			}
			else
			{
...
void func_228(int iParam0, int iParam1)
{
	...
	{
		if (!func_237(player_id(), 0) && !func_237(player_id(), 3))
		{
			func_236(iParam0);
...
{
	return func_74(player_id(), bParam0);
}

int func_240()
{
	return func_15(player_id());
}
...
int func_255()
{
	...
	if (!bVar0)
	{
		if (!net_gameserver_is_session_valid(func_151()) || net_gameserver_is_session_refresh_pending())
		{
...
void func_268()
{
	begin_scaleform_movie_method(iLocal_300, "HIDE_OVERLAY");
	end_scaleform_movie_method();
	func_199(0);
...
void func_270()
{
	if (func_271())
	{
		if (!BitTest(uLocal_109, 0))
		{
			begin_scaleform_movie_method(iLocal_300, "GET_CURRENT_SELECTION");
			iLocal_301 = end_scaleform_movie_method_return_value();
...
void func_274()
{
	if (func_214())
	{
		begin_scaleform_movie_method(iLocal_300, "UPDATE_SELL_COOLDOWN");
		scaleform_movie_method_add_param_int(func_276(Global_2789376.f_26, Global_2789376.f_28));
		scaleform_movie_method_add_param_int(func_275(Global_2789376.f_28));
		end_scaleform_movie_method();
	}
	else
	{
...
int func_276(int iParam0, var uParam1, int iParam2)
{
	...
	iVar0 = (iParam2 - absi(get_time_difference(get_network_time(), iParam0)));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
void func_277()
{
	...
	begin_scaleform_movie_method(iLocal_300, "UPDATE_STEAL_COOLDOWN");
	iVar0 = 1;
	while (iVar0 <= 8)
	{
		...
		if (func_196(iVar1))
		{
			scaleform_movie_method_add_param_int(func_276(Global_2789376[iVar2 /*2*/], Global_2789376.f_17[iVar2]));
		}
		else
		{
			scaleform_movie_method_add_param_int(0);
...
void func_278(int iParam0)
{
	...
	begin_scaleform_movie_method(iLocal_300, "ADD_CARGO");
	...
	scaleform_movie_method_add_param_float(to_float(iVar3));
...
void func_279()
{
	...
	begin_scaleform_movie_method(iLocal_300, "SET_STATS");
	_scaleform_movie_method_add_param_texture_name_string_2(sVar0);
	scaleform_movie_method_add_param_int(iVar1);
	scaleform_movie_method_add_param_int(iVar2);
	scaleform_movie_method_add_param_float(fVar9);
	scaleform_movie_method_add_param_int(iVar3);
	scaleform_movie_method_add_param_float(fVar10);
	...
	scaleform_movie_method_add_param_int(iLocal_113);
...
char* func_290(int iParam0)
{
	...
	if (((func_14(iParam0, 28) || func_14(player_id(), 28)) || func_294(iParam0)) && !func_292(iParam0))
	{
	...
	if (iVar1 != func_16())
	{
		if (iVar1 != player_id())
		{
			if (!func_291() && !network_check_user_content_privileges(0, -1, true))
			{
...
void func_312()
{
	...
	if (((network_is_player_active(iVar0) && func_219(iVar0)) && !func_74(iVar0, 0)) && !func_319())
	{
		if (!func_318())
		{
...
void func_313()
{
	...
	if (iVar1 != -1 && iVar1 < 31)
	{
		begin_scaleform_movie_method(iLocal_300, "REMOVE_ACTIVE_ORGANISATION");
		_scaleform_movie_method_add_param_texture_name_string_2(&(Local_299[iVar1 /*16*/]));
		end_scaleform_movie_method();
		StringCopy(&(Local_299[iVar1 /*16*/]), "", 64);
		clear_bit(&uLocal_114, bLocal_110);
		func_314(int_to_playerindex(bLocal_110));
	}
}
...
void func_315(int iParam0, int iParam1)
{
	...
	if (func_15(iParam0))
	{
		...
		begin_scaleform_movie_method(iLocal_300, "ADD_ACTIVE_ORGANISATION");
		_scaleform_movie_method_add_param_texture_name_string_2(func_317(iParam0));
		_scaleform_movie_method_add_param_texture_name_string_2(sVar1);
		iVar2 = 0;
		while (iVar2 < iVar3)
		{
			_scaleform_movie_method_add_param_texture_name_string_2(&(Var4[iVar2 /*16*/]));
			iVar2++;
		}
		end_scaleform_movie_method();
		sVar1 = func_317(iParam0);
		func_316(iParam0, func_32(iParam0));
		set_bit(&uLocal_114, iParam1);
	}
	else
	{
		begin_scaleform_movie_method(iLocal_300, "ADD_ACTIVE_ORGANISATION");
...
int func_319()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (!func_15(int_to_playerindex(bLocal_110)))
			{
				return 1;
			}
			else
			{
				return iLocal_115[iVar0] != func_32(int_to_playerindex(bLocal_110));
			}
		}
		iVar0++;
	}
...
void func_320()
{
	...
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
		if (iLocal_119 == 1)
		{
			iLocal_119 = 0;
			play_sound_frontend(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
		if (iLocal_119 == 0)
		{
			iLocal_119 = 1;
			play_sound_frontend(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
	...
	if (_is_using_keyboard_2(2))
	{
		...
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
		func_323(2, 187, 1);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_RELEASE_EVENT", to_float(300), -1f, -1f, -1f, -1f);
		}
		if (is_control_just_released(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_RELEASE_EVENT", to_float(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (is_control_just_pressed(2, 188))
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
		}
		func_323(2, 187, 1);
		if (is_control_just_pressed(2, 187))
		{
			call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
		}
	}
	func_323(2, 189, 1);
	if (is_control_just_pressed(2, 189))
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	func_323(2, 190, 1);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
	func_323(2, 201, 1);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	func_323(2, 202, 1);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	func_323(2, 204, 1);
	if (is_control_just_pressed(2, 204))
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(204), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard_2(2))
	{
		begin_scaleform_movie_method(iLocal_300, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			begin_scaleform_movie_method(iLocal_300, "SET_ANALOG_STICK_INPUT");
			iLocal_302 = iVar0;
			iLocal_303 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_302);
			scaleform_movie_method_add_param_int(iLocal_303);
			end_scaleform_movie_method();
		}
	}
	func_323(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_304 != 127) || iVar3 != 127) || iLocal_305 != 127)
	{
		...
		scaleform_movie_method_add_param_int(iLocal_304);
		scaleform_movie_method_add_param_int(iLocal_305);
...
void func_321()
{
	...
	{
		iLocal_119 = 0;
		call_scaleform_movie_method_with_number(iLocal_300, "SHOW_SCREEN", 0f, -1f, -1f, -1f, -1f);
		play_sound_frontend(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
		return;
	}
	if (func_322())
	...
	{
		call_scaleform_movie_method_with_number(iLocal_300, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1f, -1f);
	}
	play_sound_frontend(-1, "Click_Back", "GTAO_SMG_Hangar_Computer_Sounds", true);
}
...
void func_325()
{
	...
	set_script_gfx_draw_order(1);
	draw_scaleform_movie_fullscreen(iLocal_300, 255, 255, 255, 255, 0);
	func_336();
	func_329(0);
	func_326(1);
...
void func_348()
{
	...
	if (!BitTest(uLocal_109, 7) && !is_string_null_or_empty(&Var0))
	{
...
void func_366()
{
	...
	{
		if (func_369(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_368(player_ped_id());
...
{
	func_380();
	iLocal_300 = request_scaleform_movie("HANGAR_CARGO");
	while (!has_scaleform_movie_loaded(iLocal_300))
	{
		wait(0);
	}
	func_330(1);
...
{
	set_scaleform_movie_as_no_longer_needed(&iLocal_300);
	func_388(iParam0);
	func_390(0);
	func_393();
	...
	if (bParam1)
	{
		play_sound_frontend(-1, "Exit", "GTAO_SMG_Hangar_Computer_Sounds", true);
	}
	if (is_pc_version())
	{
		func_383(0, 1, 1, 1);
