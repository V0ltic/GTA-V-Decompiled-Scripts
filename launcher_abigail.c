...
int func_190(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_129(player_ped_id()) && func_129(uParam0->f_28[0])) && !func_148()) && (get_game_timer() - uParam0->f_60) > iParam6) && func_194(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
{
	if (func_129(*uParam1) && func_129(player_ped_id()))
	{
		switch (*iParam0)
		{
			case 0:
				iParam0->f_166 = (get_game_timer() + get_random_int_in_range(1000, 2000));
				func_193(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				task_play_anim(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0f, false, false, false);
				*iParam0 = 1;
				break;
			
			case 1:
				if (get_game_timer() > iParam0->f_166)
				{
					if (is_entity_in_angled_area(player_ped_id(), Local_52, Local_53, 8f, false, true, 0))
					{
						task_play_anim(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0f, false, false, false);
						*iParam0 = 3;
					}
					else if (func_207(player_ped_id(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (is_entity_playing_anim(*uParam1, cLocal_55, "outro", 3) && get_entity_anim_current_time(*uParam1, cLocal_55, "outro") > 0.99f)
				{
					task_play_anim(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0f, false, false, false);
				}
				break;
			
			case 3:
				if (is_entity_playing_anim(*uParam1, cLocal_55, "intro", 3) && get_entity_anim_current_time(*uParam1, cLocal_55, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_196(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (is_entity_in_angled_area(player_ped_id(), Local_52, Local_53, 8f, false, true, 0))
					{
						task_play_anim(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0f, false, false, false);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_148())
				{
					if (is_entity_playing_anim(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (get_entity_anim_current_time(*uParam1, cLocal_55, "loop_talk") > 0.99f)
						{
							iParam0->f_166 = (get_game_timer() + get_random_int_in_range(7000, 10000));
							if (!is_entity_in_angled_area(player_ped_id(), Local_52, Local_53, 8f, false, true, 0))
							{
								task_play_anim(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0f, false, false, false);
								*iParam0 = 1;
							}
							else
							{
								task_play_anim(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0f, false, false, false);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (is_entity_playing_anim(*uParam1, cLocal_55, "loop_look", 3) && get_entity_anim_current_time(*uParam1, cLocal_55, "loop_look") > 0.99f)
				{
					if (is_entity_in_angled_area(player_ped_id(), Local_52, Local_53, 8f, false, true, 0))
					{
						if (get_game_timer() > iParam0->f_166)
...
int func_255(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			request_anim_dict(cLocal_55);
			func_262(&(uParam0->f_48), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_261(&iVar0) || !has_anim_dict_loaded(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				set_vehicle_disable_towing(uParam0->f_35[0], true);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_263(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!has_model_loaded(iVar0) || !has_anim_dict_loaded(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
