...
{
	return is_entity_in_angled_area(iParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, false, true, 0);
}
...
int func_70()
{
	if (Global_1853191 != func_60())
	{
		if (network_is_script_active("base_corridor_seats", Global_1853191, true, 0))
		{
			return 0;
		}
