...
void __EntryFunction__()
{
	...
	_0x208784099002BC30("M_FinaleChoice", 0);
...
void func_6()
{
	...
	{
		register_entity_for_cutscene(player_ped_id(), "FRANKLIN", 0, joaat("player_one"), 0);
	}
	...
	clear_area_of_objects(8.61554f, 541.0764f, 175.0283f, 7.5f, 0);
	clear_area_of_projectiles(8.61554f, 541.0764f, 175.0283f, 7.5f, 0);
	...
	while (is_cutscene_playing() || !bVar1)
	{
		_0x208784099002BC30("M_FinaleChoice", 0);
		...
		if (!iLocal_28)
		{
			if ((get_game_timer() - iLocal_29) > 92400)
			{
				_0x81CBAE94390F9F89();
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_81(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_14(*iParam1, 0, &uVar0))
		{
...
int func_14(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_44(iVar0, bParam1, uParam2) && !func_43(player_id())) && !func_25(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_23(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_21(iParam0)) && !bVar1) && !(func_20(get_entity_model(iParam0)) && func_16(player_id())))
	{
	...
	{
		if ((func_15(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_42(player_id()) || func_41(player_id()))
	{
		if (func_26(iParam0))
		{
			return 1;
...
int func_27(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_21(iParam0)) || func_28(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_29(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_31(get_entity_model(iParam0), 0))
			{
...
int func_44(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_23(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_48(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_68(iParam0, 0, 0)) || func_68(iParam0, 1, 0)) || func_68(iParam0, 2, 0)) || func_67(iParam0) != 145) || func_66(iParam0)) || func_65(iParam0)) || func_15(iParam0)) || func_64(iParam0)) || !func_52(get_entity_model(iParam0)))
	{
		if (func_65(iParam0))
		{
		}
...
int func_53(int iParam0, bool bParam1)
{
	...
	{
		if ((func_58() || is_pc_version()) || func_57())
		{
		}
		else if (!func_60())
		{
...
int func_73(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_40(get_entity_model(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_76(*uParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*uParam0, 24, func_76(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_75(uParam0);
	if (func_74(*uParam0))
	{
...
int func_82(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	struct<82> Var1;
	int iVar2;
...
void func_83(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_84(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_84(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_87()
{
	...
	{
		if (func_90(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
int func_92(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_93(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_96(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_84(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

bool func_97(struct<3> Param0, int iParam1)
{
	return func_98(Global_103950.f_2890.f_12.f_66, Param0, iParam1);
}

int func_98(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_100(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_110(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_112()
{
	request_cutscene("CHOICE_INT", 8);
	while (!has_cutscene_loaded())
	{
		request_cutscene("CHOICE_INT", 8);
		if (can_request_assets_for_cutscene_entity())
		{
			func_113("FRANKLIN", player_ped_id(), 0, 2);
		}
		wait(0);
	}
}
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_120(iParam2));
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_129(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_129(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_120(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_203()
{
	set_vehicle_as_no_longer_needed(&iLocal_30);
