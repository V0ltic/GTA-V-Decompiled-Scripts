...
void __EntryFunction__()
{
	...
	clear_area(Var1, Var0.f_15, true, false, false, false);
	while (true)
	{
		wait(0);
		if (!func_218(&Var0, 1))
		...
		if (Var0.f_0 == 42)
		{
			...
			{
				set_cutscene_ped_component_variation(func_209(), 4, 0, 0, func_208());
...
{
	func_21(sParam1);
	clear_bit(&(Global_113386.f_18574[iParam0 /*6*/]), 5);
	if (_get_number_of_references_of_script_with_name_hash(joaat("mission_stat_watcher")) > 0)
	{
		while (_get_number_of_references_of_script_with_name_hash(joaat("mission_stat_watcher")) > 0)
		{
			func_19();
			wait(0);
		}
	...
	while (!BitTest(Global_113386.f_18574[iParam0 /*6*/], 5))
	{
		if (_get_number_of_references_of_script_with_name_hash(joaat("mission_stat_watcher")) > 0)
		{
			set_bit(&(Global_113386.f_18574[iParam0 /*6*/]), 5);
		}
	}
	func_4(iParam0);
}
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_34(bParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_58(int iParam0, bool bParam1)
{
	...
	bVar0 = func_45(iParam0);
	if (func_36(bVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
			...
			while (iVar2 <= (8 - 1))
			{
				Global_113386.f_2363.f_539.f_1730[iVar2 /*4*/][bVar0] = _hud_weapon_wheel_get_slot_hash(iVar2);
				if (bParam1)
				{
...
void func_59(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_64(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_61(Var7.f_1)) && iVar9 < 51)
			{
...
void func_65(int iParam0)
{
	...
	if (func_36(bVar0) && !is_ped_injured(iParam0))
	{
		Global_113386.f_2363.f_539.f_294[bVar0] = get_ped_armour(iParam0);
	}
}
...
int func_70(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_93())
		{
			*uParam0 = func_76(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_76(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_92(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_77(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_100(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_106(int iParam0)
{
	...
	if (is_xbox360_version() || func_108())
	{
		uVar0 = iParam0;
		network_set_rich_presence(9, &uVar0, 1, 1);
	}
	else if (is_ps3_version() || func_107())
	{
		StringCopy(&cVar1, "SPRC_", 24);
		StringIntConCat(&cVar1, iParam0, 24);
		StringConCat(&cVar1, "_STR", 24);
		network_set_rich_presence_string(9, &cVar1);
	}
}
...
void func_109(char* sParam0, int iParam1, int iParam2)
{
	...
	playstats_mission_started(sParam0, iParam1, iParam2, func_110(0));
}
...
int func_115(var* uParam0)
{
	...
	if (func_144(&(uParam0->f_1)))
	{
		...
		func_116(*uParam0);
		iVar0 = start_new_script_with_args(&(uParam0->f_1), uParam0, 61, 51000);
		set_script_as_no_longer_needed(&(uParam0->f_1));
...
void func_136(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_140(player_id())) && !func_138(player_id(), 0)) && !func_137()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_140(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_149()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_150(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_167()
{
	return func_168(get_this_script_name(), 0);
}
...
int func_171(struct<3> Param0, bool bParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(Param0);
	set_blip_scale(iVar0, func_172(network_is_game_in_progress(), 1f, 1f));
...
int func_175(int iParam0, int iParam1)
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (is_entity_in_angled_area(player_ped_id(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, false, true, 0))
				{
					if (func_129(iParam0->f_28[0]))
					{
						if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_181(2))
							{
			...
			{
				if ((((!is_entity_in_angled_area(player_ped_id(), -1895.788f, -434.0192f, 40.30126f, -1883.038f, -444.0811f, 50.24509f, 8.5f, false, true, 0) && !is_entity_in_angled_area(player_ped_id(), -1883.576f, -443.6434f, 36.40581f, -1874.826f, -448.0797f, 49.15162f, 8.5f, false, true, 0)) && !is_entity_in_angled_area(player_ped_id(), -1876.343f, -446.2214f, 35.64637f, -1866.952f, -456.5601f, 49.0442f, 8.5f, false, true, 0)) && !is_entity_in_angled_area(player_ped_id(), -1882.997f, -438.9922f, 44.17246f, -1874.079f, -443.342f, 48.69179f, 0.75f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), -1878.822f, -441.7655f, 44.9175f, -1877.941f, -439.9522f, 47.28982f, 1.25f, false, true, 0))
				{
					if (func_129(iParam0->f_28[0]))
					{
						if (func_177(iParam0))
			...
			{
				if (!is_entity_in_angled_area(player_ped_id(), 837.0731f, 1261.086f, 366.1592f, 780.8383f, 1260.829f, 351.405f, 17.75f, false, true, 0))
				{
					if (func_129(iParam0->f_28[0]))
					{
						if (func_177(iParam0))
		...
		case 2:
			...
			{
				if (is_ped_in_vehicle(player_ped_id(), iParam0->f_35[0], false))
				{
					if (func_181(3))
					{
						func_178(iParam0->f_27, *iParam0);
		...
		case 1:
			...
			{
				if (!is_entity_dead(iParam0->f_35[0], false))
				{
					if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0->f_35[0], true), true) < iParam0->f_15)
					{
						if (func_181(2))
						{
							if (func_179(iParam0->f_27))
		...
		case 3:
			if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), iParam0->f_17[0 /*3*/], true) < iParam0->f_15)
			{
				if (func_181(2))
				{
					if (func_179(iParam0->f_27))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_129(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
						if (is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("towtruck")) || is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("towtruck2")))
						{
							if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false), iParam0->f_35[0]))
							{
								if (func_181(3))
								{
									return 1;
						...
						else if ((is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("cargobob")) || is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("cargobob2"))) || is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("cargobob3")))
						{
							if (does_cargobob_have_pick_up_rope(get_vehicle_ped_is_in(player_ped_id(), false)) && is_vehicle_attached_to_cargobob(get_vehicle_ped_is_in(player_ped_id(), false), iParam0->f_35[0]))
							{
								if (func_181(3))
								{
									return 1;
			...
			else if (*iParam0 == 10)
			{
				...
				{
					if (is_entity_in_angled_area(player_ped_id(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, false, true, 0))
					{
						if (func_181(2))
						{
							if (func_179(iParam0->f_27))
			...
			{
				if (is_entity_in_angled_area(player_ped_id(), -164.2046f, 277.4866f, 91.55322f, -153.6f, 277.4061f, 97.33813f, 10f, false, true, 0))
				{
					return 0;
				}
			}
			...
			{
				if (is_entity_in_angled_area(player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, false, true, 0))
				{
					if (func_181(2))
					{
						if (func_179(1))
			...
			{
				if (is_entity_in_angled_area(player_ped_id(), -992.4995f, 358.7455f, 96.3735f, -1021.94f, 361.8888f, 65.36148f, 30f, false, true, 0))
				{
					if (!is_entity_in_angled_area(player_ped_id(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, false, true, 0))
					{
						if (!is_entity_in_angled_area(player_ped_id(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_181(2))
							{
								if (func_179(iParam0->f_27))
			...
			if (is_entity_in_angled_area(player_ped_id(), iParam0->f_17[0 /*3*/], iParam0->f_17[1 /*3*/], iParam0->f_24, false, true, 0))
			{
				if (*iParam0 == 45)
				{
					if (is_entity_in_angled_area(player_ped_id(), 2338.697f, 2597.037f, 45.39052f, 2324.003f, 2597.185f, 47.74961f, 8.5f, false, true, 0))
					{
						return 0;
					}
				}
...
int func_177(var uParam0)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false) && uParam0->f_27)
	{
		...
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(uParam0->f_28[0], true), true) < (uParam0->f_15 + fVar0))
		{
			return 1;
		}
	}
	else if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(uParam0->f_28[0], true), true) < uParam0->f_15)
	{
		return 1;
	}
	return 0;
	...
	if (iParam0 == 1)
	{
		...
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			if (is_ped_in_any_heli(player_ped_id()) || is_ped_in_any_plane(player_ped_id()))
			{
				...
				set_vehicle_engine_on(get_vehicle_ped_is_in(player_ped_id(), false), false, true, false);
			}
			func_148();
		}
	}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_189()) || Global_31962) || func_188()) || func_187(8, -1)) || func_185()) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_185()) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_189()) || Global_112433) || Global_31962) || func_188()) || func_187(8, -1)) || func_93()) || func_186()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_189() || get_player_wanted_level(player_id()) > 0) || func_187(8, -1)) || func_184()) || func_183()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_189()) || func_186()) || Global_112433) || Global_31962) || func_188()) || Global_44238) || func_187(8, -1)) || func_185()) || func_183()) || func_184()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_190(int iParam0)
{
	...
	iVar0 = 0;
	if (func_129(player_ped_id()))
	{
		iVar0 = 0;
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			if (does_entity_exist(iParam0->f_28[iVar0]))
			{
				if (func_129(iParam0->f_28[iVar0]))
				{
					if (has_entity_been_damaged_by_entity(iParam0->f_28[iVar0], player_ped_id(), true) || is_bullet_in_area(get_entity_coords(iParam0->f_28[iVar0], true), 7.5f, true))
					{
						if (func_181(2))
						{
							func_178(iParam0->f_27, *iParam0);
...
{
	if (func_192(uParam1, get_entity_coords(player_ped_id(), true)))
	{
		if (func_181(2))
		{
			if (func_179(iParam0->f_27))
...
bool func_192(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_193(int iParam0, var uParam1, var uParam2)
{
	if (func_129(*uParam1))
	{
		...
		{
			case 0:
				if (request_script_audio_bank("CAR_TRUNK_THUMPS", false, -1))
				{
					iParam0->f_1 = get_sound_id();
					iParam0->f_2 = get_game_timer();
					iParam0->f_3 = get_random_int_in_range(6000, 12000);
					*iParam0 = 1;
				}
				break;
			
			case 1:
				if ((get_game_timer() - iParam0->f_2) > iParam0->f_3)
				{
					play_sound_from_coord(iParam0->f_1, "TRUNK_THUMPS", get_offset_from_entity_in_world_coords(*uParam1, 0f, -2.2f, 0.5f), 0, false, 0, false);
					play_ped_ambient_speech_with_voice_native(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_194(0), false);
					iParam0->f_4 = get_random_int_in_range(3, 7);
					iParam0->f_5 = 0;
					iParam0->f_6 = get_game_timer();
					iParam0->f_7 = get_random_int_in_range(100, 250);
					*iParam0 = 2;
				}
				break;
			
			case 2:
				if ((get_game_timer() - iParam0->f_6) > iParam0->f_7)
				{
					iParam0->f_8 = get_random_int_in_range(-200, -120);
					iParam0->f_9 = (0.5f * to_float(get_random_int_in_range(-2, 3)));
					apply_force_to_entity(*uParam1, 1, 0f, 0f, IntToFloat(iParam0->f_8), iParam0->f_9, -1.5f, 0f, 0, true, true, false, true, true);
					iParam0->f_5++;
					if (iParam0->f_5 < iParam0->f_4)
					{
						iParam0->f_6 = get_game_timer();
						iParam0->f_7 = get_random_int_in_range(150, 280);
					}
					else
					{
						iParam0->f_2 = get_game_timer();
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && !func_147()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_199(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_199(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_181(2))
		{
			if (!func_147())
			{
				if (((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && func_129(iParam0->f_28[1])) && func_199(player_ped_id(), Param1, 1) < 20f)
				{
			...
			else if (((func_202(sParam3) && !*uParam8 == 1) && func_129(player_ped_id())) && func_199(player_ped_id(), Param1, 1) >= 20f)
			{
				func_318("pause conversation");
				func_201(1);
				*uParam8 = 1;
			}
			if (func_199(player_ped_id(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_204(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
				...
				if (func_207(uParam1))
				{
					if (has_anim_dict_loaded(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							{
								task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
							}
							else
							{
								...
								if (func_206(uParam1))
								{
									task_play_anim_advanced(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									task_play_anim_advanced(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								task_play_anim_advanced(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
			...
			case 2:
				if (!func_206(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
				{
					task_play_anim(0, *uParam1, uParam1->f_2, 4f, -4f, -1, 262144, 0f, false, false, false);
					task_play_anim(0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
				}
				else
				{
					task_play_anim_advanced(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					task_play_anim_advanced(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_205(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
void func_210(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_199(player_ped_id(), Param2, 1) <= 100f)
				{
					func_213(iParam0, 1);
				}
			}
			else
			{
				switch (func_212(*iParam0))
				{
					case 1:
						...
						{
							request_cutscene_with_playback_list(sParam1, 14, 8);
						}
						else
						{
				...
				if (func_199(player_ped_id(), Param2, 1) > 120f)
				{
					func_215(iParam0);
				}
			}
...
int func_212(int iParam0)
{
	if (Global_78315 == iParam0)
	{
		if (Global_78316 == -1)
		{
			if (Global_78314 < get_frame_count())
			{
				return 1;
			}
		}
...
void func_219(var uParam0)
{
	...
	if (func_129(player_ped_id()))
	{
		...
		while (iVar0 <= (uParam0->f_28 - 1))
		{
			...
			{
				if (!is_ped_in_any_vehicle(uParam0->f_28[iVar0], false))
				{
					set_entity_collision(uParam0->f_28[iVar0], true, false);
				...
				if (*uParam0 == 34)
				{
					...
					{
						set_entity_collision(uParam0->f_41[0], true, false);
				...
				switch (*uParam0)
				{
					...
					case 8:
						...
						open_sequence_task(&iVar1);
						task_play_anim(0, "rcmcollect_paperleadinout@", "meditate_getup", 8f, -8f, -1, 8, 0f, false, false, false);
						task_smart_flee_ped(0, player_ped_id(), 10000f, -1, false, false);
						close_sequence_task(iVar1);
					...
					case 1:
						...
						open_sequence_task(&iVar1);
						task_play_anim(0, "rcmabigail", "breakout_base", 8f, -8f, -1, 8, 0f, false, false, false);
						task_smart_flee_ped(0, player_ped_id(), 10000f, -1, false, false);
						close_sequence_task(iVar1);
						task_perform_sequence(uParam0->f_28[iVar0], iVar1);
						clear_sequence_task(&iVar1);
					...
					case 32:
						...
						if (iVar0 == 0)
						{
							task_play_anim(0, "rcmminute1", "base_to_idle_joe", 8f, -8f, -1, 32776, 0f, false, false, false);
						}
						else
						{
							task_play_anim(0, "rcmminute1", "base_to_idle_josef", 8f, -8f, -1, 32776, 0f, false, false, false);
						}
						task_smart_flee_ped(0, player_ped_id(), 10000f, -1, false, false);
						close_sequence_task(iVar1);
						task_perform_sequence(uParam0->f_28[iVar0], iVar1);
					...
					case 24:
						...
						open_sequence_task(&iVar1);
						task_play_anim(0, "special_ped@hao@base", "hao_exit", 8f, -8f, -1, 520, 0f, false, false, false);
						task_smart_flee_ped(0, player_ped_id(), 10000f, -1, false, false);
						close_sequence_task(iVar1);
						task_perform_sequence(uParam0->f_28[iVar0], iVar1);
						clear_sequence_task(&iVar1);
					...
					default:
						...
						task_smart_flee_ped(uParam0->f_28[iVar0], player_ped_id(), 10000f, -1, false, false);
						break;
					}
			}
			iVar0++;
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_223(player_ped_id(), uParam0->f_35[iVar0]))
							{
		...
		while (iVar0 <= iVar1)
		{
			if (does_entity_exist(uParam0->f_28[iVar0]))
			{
				if (!is_ped_injured(uParam0->f_28[iVar0]))
				{
					...
					{
						if (is_entity_at_entity(uParam0->f_28[iVar0], player_ped_id(), 3f, 3f, 3f, false, true, 0))
						{
							if (iParam2 == 0)
							{
								func_219(uParam0);
					...
					if (func_243(*uParam0))
					{
						...
						if (is_explosion_in_sphere(-1, get_entity_coords(uParam0->f_28[iVar0], true), 15f))
						{
							if (iParam2 == 0)
							{
								func_219(uParam0);
					...
					if (!func_225(*uParam0))
					{
						if (is_explosion_in_sphere(-1, get_entity_coords(uParam0->f_28[iVar0], true), 5f))
						{
							if (iParam2 == 0)
							{
								func_219(uParam0);
...
int func_226(int iParam0, float fParam1)
{
	...
	if (func_129(player_ped_id()) && func_129(iParam0))
	{
		if (func_237(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_228(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	return (uVar0 || (get_game_timer() - Local_49[iVar2 /*4*/].f_3) < iParam4);
}
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_234(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_234(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_241(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_234(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_244(int iParam0)
{
	...
	if (func_129(player_ped_id()) && func_129(iParam0))
	{
		...
		open_sequence_task(&iVar0);
		task_play_anim(0, "rcmextreme3", "jump_fall", 1000f, -8f, -1, 8, 0f, false, false, false);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				if (func_129(uParam0->f_35[0]))
				{
					set_vehicle_colours(uParam0->f_35[0], 65, 0);
					_set_vehicle_door_can_break(uParam0->f_35[0], 5, false);
					set_vehicle_number_plate_text(uParam0->f_35[0], "28BNT310");
					set_vehicle_number_plate_text_index(uParam0->f_35[0], 0);
					set_vehicle_doors_locked(uParam0->f_35[0], 10);
					set_vehicle_can_deform_wheels(uParam0->f_35[0], false);
					set_vehicle_can_leak_oil(uParam0->f_35[0], false);
					set_vehicle_can_leak_petrol(uParam0->f_35[0], false);
				}
			}
...
int func_254(var uParam0, var uParam1)
{
	...
	if (does_entity_exist(*uParam1) && has_model_loaded(iLocal_54))
	{
		*uParam0 = create_ped(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, true, true);
		...
		Var0 = { get_offset_from_entity_in_world_coords(*uParam1, -0.2f, -1.8f, -1f) };
		fVar2 = (-90f + get_entity_heading(*uParam1));
		Var1 = { 0f, 0f, fVar2 };
		set_entity_coords_no_offset(*uParam0, Var0, false, false, true);
		set_entity_rotation(*uParam0, Var1, 2, true);
		attach_entity_to_entity(*uParam0, *uParam1, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, false, false, false, false, 2, true, 0);
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_256(iParam0);
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[1]))
			{
				...
				{
					set_vehicle_colours(uParam0->f_35[1], 0, 0);
					set_vehicle_doors_locked(uParam0->f_35[1], 10);
				}
			}
			if (bVar2)
			{
...
void func_264(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 37:
			...
			{
				remove_scenario_blocking_area(iLocal_67, false);
		...
		case 38:
			if (bParam1)
			{
				iLocal_67 = add_scenario_blocking_area(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true);
				set_scenario_type_enabled("WORLD_HUMAN_GUARD_STAND", false);
				set_scenario_type_enabled("WORLD_HUMAN_CLIPBOARD", false);
				set_scenario_type_enabled("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_67 = add_scenario_blocking_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true);
		...
		case 41:
			if (bParam1)
			{
				iLocal_67 = add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_67 = add_scenario_blocking_area(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true);
...
int func_268(var uParam0, var uParam1)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_261(&iVar0) || !has_anim_dict_loaded(uParam0->f_48)) || !has_anim_dict_loaded(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_272(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !has_anim_dict_loaded(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_273(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_261(&iVar0) || !has_anim_dict_loaded(uParam0->f_48)) || !has_anim_dict_loaded(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				{
					set_vehicle_on_ground_properly(uParam0->f_35[0], 5f);
					set_vehicle_colours(uParam0->f_35[0], 97, 97);
					set_vehicle_dirt_level(uParam0->f_35[0], 13.5f);
					_set_vehicle_door_can_break(uParam0->f_35[0], 2, false);
					set_vehicle_door_open(uParam0->f_35[0], 2, false, true);
					set_vehicle_door_control(uParam0->f_35[0], 2, 0, 1f);
					force_entity_ai_and_animation_update(uParam0->f_35[0]);
					return 0;
				}
			}
			if (func_129(uParam0->f_35[0]))
			{
				fVar3 = get_vehicle_door_angle_ratio(uParam0->f_35[0], 2);
				if (!is_vehicle_door_fully_open(uParam0->f_35[0], 2) && fVar3 < 0.8f)
				{
					set_vehicle_door_control(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_129(uParam0->f_35[0]))
			{
				if (!is_entity_playing_anim(uParam0->f_35[0], sVar2, "idle_speedo", 3))
				{
					if (has_anim_dict_loaded(sVar2))
					{
						task_vehicle_play_anim(uParam0->f_35[0], sVar2, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_129(uParam0->f_35[1]))
			{
				set_vehicle_colours(uParam0->f_35[1], 27, 27);
			}
			func_275(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_128(uParam0->f_28[0]))
			{
				set_ped_dies_in_water(uParam0->f_28[0], false);
				set_entity_coords_no_offset(uParam0->f_28[0], -1054.7f, 355.94f, 68.35f, false, false, true);
				set_entity_heading(uParam0->f_28[0], 23.67f);
				task_play_anim(uParam0->f_28[0], sVar2, "Swimming_Idle", 8f, -8f, -1, 0, 0f, false, false, false);
			}
			...
			if (func_128(uParam0->f_28[1]))
			{
				...
				set_ped_component_variation(uParam0->f_28[1], 3, 0, 2, 0);
				set_ped_component_variation(uParam0->f_28[1], 4, 0, 0, 0);
				set_ped_component_variation(uParam0->f_28[1], 8, 0, 1, 0);
				set_ped_dies_in_water(uParam0->f_28[1], false);
				uParam0->f_59 = create_synchronized_scene(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				set_synchronized_scene_looped(uParam0->f_59, true);
				set_synchronized_scene_hold_last_frame(uParam0->f_59, false);
				task_synchronized_scene(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "base_girl", 1000f, -8f, 592, 0, 1000f, 0);
			}
			func_275(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_128(uParam0->f_28[2]))
			{
				set_ped_default_component_variation(uParam0->f_28[2]);
				set_entity_coords_no_offset(uParam0->f_28[2], -1012.57f, 357.48f, 70.62f, false, false, true);
				set_entity_health(uParam0->f_28[2], 160, 0);
				if (has_anim_dict_loaded(sVar2))
				{
					task_play_anim(uParam0->f_28[2], sVar2, "idle_gardener", 1000f, -8f, -1, 270337, 0f, false, false, false);
				}
			}
			func_274(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_129(uParam0->f_41[0]))
			{
				set_entity_rotation(uParam0->f_41[0], 0f, 0f, -11.27f, 2, true);
				set_entity_can_be_damaged(uParam0->f_41[0], false);
				set_entity_invincible(uParam0->f_41[0], true);
				set_can_auto_vault_on_entity(uParam0->f_41[0], false);
				set_can_climb_on_entity(uParam0->f_41[0], false);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
			...
			remove_anim_dict(uParam0->f_48);
			remove_anim_dict(sVar2);
			return 1;
			break;
	}
	return 0;
...
void func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_220(iParam0);
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_276(iParam0);
...
int func_277(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_264(38, 1);
			iVar2 = get_interior_at_coords_with_type(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (is_valid_interior(iVar2))
			{
				refresh_interior(iVar2);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
		...
		case 1:
			if (!func_261(&iVar0) || !has_anim_dict_loaded(uParam0->f_48))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_128(uParam0->f_28[1]))
			{
				set_ped_can_be_targetted(uParam0->f_28[1], false);
				set_ped_component_variation(uParam0->f_28[1], 0, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[1], 2, 0, 2, 0);
				set_ped_component_variation(uParam0->f_28[1], 3, 1, 2, 0);
				set_ped_component_variation(uParam0->f_28[1], 4, 0, 1, 0);
				set_ped_component_variation(uParam0->f_28[1], 7, 0, 1, 0);
				set_ped_component_variation(uParam0->f_28[1], 8, 1, 0, 0);
			}
			uParam0->f_59 = create_synchronized_scene(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			set_synchronized_scene_looped(uParam0->f_59, true);
			set_synchronized_scene_hold_last_frame(uParam0->f_59, false);
			if (func_128(uParam0->f_28[0]))
			{
				task_synchronized_scene(uParam0->f_28[0], uParam0->f_59, uParam0->f_48, "BASE_02_Willie", 1000f, -8f, 17, 0, 1000f, 0);
			}
			if (func_128(uParam0->f_28[1]))
			{
				task_synchronized_scene(uParam0->f_28[1], uParam0->f_59, uParam0->f_48, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1000f, 0);
			}
			...
			if (func_128(uParam0->f_28[2]))
			{
				...
				set_ped_component_variation(uParam0->f_28[2], 2, 1, 2, 0);
				set_ped_component_variation(uParam0->f_28[2], 3, 1, 1, 0);
				set_ped_component_variation(uParam0->f_28[2], 4, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[2], 7, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[2], 8, 1, 0, 0);
			}
			if (func_128(uParam0->f_28[3]))
			{
				set_ped_component_variation(uParam0->f_28[3], 0, 1, 1, 0);
				set_ped_component_variation(uParam0->f_28[3], 2, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[3], 3, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[3], 4, 1, 1, 0);
				set_ped_component_variation(uParam0->f_28[3], 7, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[3], 8, 1, 0, 0);
			}
			if (func_128(uParam0->f_28[4]))
			{
				set_ped_component_variation(uParam0->f_28[4], 0, 0, 0, 0);
				set_ped_component_variation(uParam0->f_28[4], 2, 0, 2, 0);
				set_ped_component_variation(uParam0->f_28[4], 3, 0, 0, 0);
				set_ped_component_variation(uParam0->f_28[4], 4, 0, 1, 0);
				set_ped_component_variation(uParam0->f_28[4], 8, 0, 0, 0);
			}
			if (func_128(uParam0->f_28[5]))
			{
				set_ped_component_variation(uParam0->f_28[5], 0, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[5], 2, 2, 0, 0);
				set_ped_component_variation(uParam0->f_28[5], 3, 0, 3, 0);
				set_ped_component_variation(uParam0->f_28[5], 4, 1, 0, 0);
				set_ped_component_variation(uParam0->f_28[5], 8, 0, 2, 0);
			}
			func_255(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_129(uParam0->f_35[0]))
			{
				set_vehicle_colour_combination(uParam0->f_35[0], 1);
				set_vehicle_doors_locked(uParam0->f_35[0], 1);
				set_can_auto_vault_on_entity(uParam0->f_35[0], false);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && func_129(uParam0->f_28[1]))
			{
				set_blocking_of_non_temporary_events(uParam0->f_28[0], true);
				set_blocking_of_non_temporary_events(uParam0->f_28[1], true);
				iVar2 = create_synchronized_scene(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				task_synchronized_scene(uParam0->f_28[0], iVar2, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1000f, 0);
				task_synchronized_scene(uParam0->f_28[1], iVar2, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1000f, 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_287(int iParam0)
{
	...
	if (Global_100441.f_11 == 6)
	{
		if (Global_100441 < 9)
		{
			...
			if (are_strings_equal(&(Global_100441.f_3), sVar0))
			{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("candidate_controller")) == 0)
	{
		Global_112473[iParam0 /*10*/].f_1 = 1;
...
void func_299(int iParam0, int iParam1, bool bParam2)
{
	...
	if (does_blip_exist(iLocal_69))
	{
		remove_blip(&iLocal_69);
	}
	if (bParam2)
	{
...
void func_314(var uParam0)
{
	if (is_synchronized_scene_running(uParam0->f_59))
	{
		if (func_128(uParam0->f_28[1]))
		{
			...
			stop_synchronized_entity_anim(uParam0->f_28[1], -1000f, true);
		}
	}
}
...
void func_316(var uParam0)
{
	if (is_synchronized_scene_running(uParam0->f_59))
	{
		if (func_128(uParam0->f_28[0]))
		{
			...
			stop_synchronized_entity_anim(uParam0->f_28[0], -1000f, true);
		}
		if (func_128(uParam0->f_28[1]))
		{
			if (func_315(uParam0->f_28[1], 1785177548))
