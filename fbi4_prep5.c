...
void func_1()
{
	switch (iLocal_82)
	{
		case 0:
			...
			clear_help(true);
			func_21();
			if (!is_string_null_or_empty(sLocal_189))
			{
				if (are_strings_equal(sLocal_189, "PRE_FKICKOFF"))
				{
					while ((get_game_timer() - iLocal_373) < 2000)
					{
						wait(0);
					}
				}
...
void func_23()
{
	switch (iLocal_82)
	{
		...
		case 2:
			...
			if ((get_game_timer() - iLocal_372) > 2000)
			{
				func_22(&iLocal_197);
		...
		case 3:
			func_38(player_ped_id(), 16.0317f, -1118.455f, 27.8667f, 170.4274f);
			func_24(1, 1, 1);
			iLocal_82 = 2;
			break;
	}
...
int func_95(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_38(player_ped_id(), Local_200, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
int func_96(int iParam0, struct<3> Param1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			request_additional_text(sLocal_190, 0);
			request_additional_text(sLocal_202, 6);
...
void func_99(var uParam0)
{
	...
	func_78(uParam0, iVar0, player_ped_id(), sVar1, 0, 1);
}
	...
	switch (iLocal_82)
	{
		case 0:
			if (func_95(iLocal_81, bLocal_28))
			{
				...
				if (does_blip_exist(iLocal_197))
				{
					set_blip_colour(iLocal_197, 2);
					set_blip_route_colour(iLocal_197, 2);
				}
		...
		case 1:
			func_106();
			if (func_105(player_ped_id(), Local_200, 2f, 1) && func_104(28))
			{
				if (!iLocal_196)
				{
					clear_player_wanted_level(player_id());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(player_ped_id(), Local_200, 75f, 1))
					{
						if (!iLocal_195)
						{
							func_22(&iLocal_197);
					...
					else if (func_105(player_ped_id(), Local_200, 12f, 1))
					{
						if (iLocal_195)
						{
							func_22(&iLocal_197);
...
bool func_105(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
void func_108(int* iParam0, struct<3> Param1, bool bParam2, bool bParam3, char* sParam4)
{
	if (!does_blip_exist(*iParam0))
	{
		*iParam0 = func_109(Param1, 5, bParam2);
		if (bParam3)
		{
			set_blip_name_from_text_file(*iParam0, sParam4);
		}
	}
}
		...
		case 0:
			if (func_95(iLocal_81, 0))
			{
				if (func_291())
				{
					...
					while (!func_112(28) && (get_game_timer() - iVar0) < 2000)
					{
						wait(0);
					}
					func_25(500, 1);
				...
				else
				{
					if (func_284(0))
					{
						func_38(player_ped_id(), 16.5342f, -1122.583f, 27.8635f, 354.7487f);
						set_gameplay_cam_relative_heading(0f);
						iVar0 = get_game_timer();
						while (!func_112(28) && (get_game_timer() - iVar0) < 2000)
						{
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, false))
	{
		...
		if (get_vehicle_mod_kit(*iParam1) >= 0 && func_123(*iParam1, 0, &uVar0))
		{
...
int func_123(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_152(iVar0, bParam1, uParam2) && !func_151(player_id())) && !func_133(iParam0))
	{
		return 0;
	}
	if (func_151(player_id()))
	{
		if (func_132(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_131(player_id()) && (is_this_model_a_heli(iVar0) || is_this_model_a_plane(iVar0)))
	{
		bVar1 = true;
	}
	if (((is_big_vehicle(iParam0) && !func_129(iParam0)) && !bVar1) && !(func_128(get_entity_model(iParam0)) && func_125(player_id())))
	{
	...
	if (!network_is_game_in_progress())
	{
		if ((func_124(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_135(int iParam0)
{
	...
	{
		iVar0 = get_entity_model(iParam0);
		if ((is_big_vehicle(iParam0) && !func_129(iParam0)) || func_136(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_137(int iParam0, bool bParam1)
{
	switch (get_entity_model(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_139(get_entity_model(iParam0), 0))
			{
...
int func_152(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_131(player_id()) && (is_this_model_a_heli(iParam0) || is_this_model_a_plane(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_156(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_176(iParam0, 0, 0)) || func_176(iParam0, 1, 0)) || func_176(iParam0, 2, 0)) || func_175(iParam0) != 145) || func_174(iParam0)) || func_173(iParam0)) || func_124(iParam0)) || func_172(iParam0)) || !func_160(get_entity_model(iParam0)))
	{
		if (func_173(iParam0))
		{
		}
...
int func_161(int iParam0, bool bParam1)
{
	...
	{
		if ((func_166() || is_pc_version()) || func_165())
		{
		}
		else if (!func_168())
		{
...
int func_181(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_148(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_184(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_184(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_183(iParam0);
	if (func_182(*iParam0))
	{
...
void func_189(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_190(iParam0, iParam1))
				{
...
void func_191(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
...
bool func_200(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
int func_201(struct<3> Param0, float fParam1)
{
	return func_202(&(Global_106934.f_2890), Param0, fParam1, 0);
}

int func_202(var uParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_225(uParam0))
	{
		...
		if (func_224(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_204(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
int func_204(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_205(iParam0, uVar1[iVar3], 1) && func_97(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_200(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
void func_206(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_156(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_156(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_156(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_156(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_156(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_156(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_156(iVar5));
				}
				iVar5++;
			}
		}
...
bool func_233(struct<3> Param0, int iParam1)
{
	return func_234(Global_106934.f_2890.f_12.f_66, Param0, iParam1);
}

int func_234(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_236()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(player_ped_id(), Local_200, 150f, 1))
				{
					func_243(2);
				}
				else if (!func_105(player_ped_id(), Local_200, 75f, 1))
				{
					if (!bLocal_201)
					{
						clear_prints();
...
void func_255(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_257() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_257() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_256(bParam0));
...
void func_305(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_298(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_298(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_306(iParam0));
			if (iVar11 > iVar10)
			{
...
bool func_365(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_372(bool bParam0)
{
	...
	if (does_cam_exist(iLocal_198))
	{
		render_script_cams(false, false, 3000, true, false, 0);
		destroy_cam(iLocal_198, false);
	}
}
