...
void func_1()
{
	...
	set_model_as_no_longer_needed(joaat("a_f_y_soucent_01"));
	if (does_entity_exist(iLocal_268))
	{
		if (is_entity_occluded(iLocal_268))
		{
			set_model_as_no_longer_needed(joaat("a_f_y_soucent_01"));
			delete_ped(&iLocal_268);
		}
		else
		{
			set_model_as_no_longer_needed(joaat("a_f_y_soucent_01"));
			set_ped_as_no_longer_needed(&iLocal_268);
		}
	}
	if (does_entity_exist(iLocal_269))
	{
		if (is_entity_occluded(iLocal_269))
		{
			set_model_as_no_longer_needed(joaat("towtruck"));
			if (is_entity_a_mission_entity(iLocal_269))
			{
				delete_vehicle(&iLocal_269);
			}
		}
		else
		{
			set_model_as_no_longer_needed(joaat("towtruck"));
			set_vehicle_as_no_longer_needed(&iLocal_269);
		}
	}
}
		...
		switch (*iParam0)
		{
			...
			case 15:
				...
				if (func_150(iParam0, 0, 1))
				{
					...
					func_118();
					*iParam3 = 0;
					if (is_control_just_pressed(0, 86) || is_disabled_control_pressed(0, 86))
					{
						func_117();
						func_115();
			...
			case 16:
				...
				*iParam3 = 0;
				...
				if (iVar4 == 1)
				{
					if (!bParam4)
					{
						func_24(get_this_script_name(), 0);
					}
					iLocal_70 = 1;
					*iParam0 = 17;
				}
			...
			case 17:
				if (!is_thread_active(iLocal_245))
				{
					...
					else
					{
						...
						func_144(&(Global_113386.f_19973.f_1), 8192);
						func_144(&(Global_113386.f_19973.f_1), 16384);
						if (does_entity_exist(iLocal_268) && !is_entity_dead(iLocal_268, false))
						{
							remove_ped_from_group(iLocal_268);
						}
						if (does_blip_exist(iLocal_267))
						{
							remove_blip(&iLocal_267);
						}
				...
				if (Global_100441 == 10)
				{
					if (Global_100475)
					{
						...
						if (Global_113386.f_19973.f_3 >= 5)
						{
							...
							{
								clear_area_of_vehicles(408.8376f, -1638.952f, 28.2928f, 8f, false, false, false, false, false, false, 0);
								if (!does_entity_exist(iLocal_269))
								{
									if (iLocal_265 == joaat("towtruck"))
									{
									...
									iLocal_269 = create_vehicle(iLocal_265, 408.8376f, -1638.952f, 28.2928f, 230.2387f, true, true, false);
									set_model_as_no_longer_needed(iLocal_265);
								}
								if (!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_269, false))
								{
									set_ped_into_vehicle(player_ped_id(), iLocal_269, -1);
									set_ped_coords_keep_vehicle(player_ped_id(), 408.8376f, -1638.952f, 28.2928f);
									set_entity_heading(iLocal_269, 230.2387f);
									*iParam0 = 16;
								}
							}
						}
			...
			case 19:
				if ((get_game_timer() - *uParam2) > iLocal_249)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
void func_27(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_106();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_66(player_ped_id());
		func_59(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_56())
		{
			func_49(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_57()
{
	...
	{
		if (func_47(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_65(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_62(Var7.f_1)) && iVar9 < 51)
			{
...
int func_71(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_94())
		{
			*uParam0 = func_77(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_77(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_93(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_78(iVar0, 0), true);
...
var func_95()
{
	...
	func_105(&uVar0, get_clock_seconds());
	func_104(&uVar0, get_clock_minutes());
	func_103(&uVar0, get_clock_hours());
	func_98(&uVar0, get_clock_day_of_month());
	func_97(&uVar0, get_clock_month());
	func_96(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_101(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
int func_107()
{
	...
	if (has_script_loaded("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			Local_51.f_2 = 1;
			iLocal_245 = start_new_script_with_args("Towing", &Local_51, 9, 51000);
			set_script_as_no_longer_needed("Towing");
			if (!is_entity_dead(iLocal_268, false))
			{
				set_ped_keep_task(iLocal_268, true);
			}
			set_ped_as_no_longer_needed(&iLocal_268);
			remove_anim_dict("amb@world_human_smoking@male@male_a@base");
			remove_anim_dict("oddjobs@towingcome_here");
...
void func_118()
{
	switch (iLocal_70)
	{
		case 1:
			if (!func_142())
			{
				if (!is_help_message_being_displayed() && !func_141(&iLocal_58))
				{
					set_frontend_radio_active(false);
					func_139(&iLocal_58);
				}
				else if (!is_help_message_being_displayed() && func_141(&iLocal_58))
				{
	...
	if (is_ped_in_any_vehicle(iParam0, false))
	{
		...
		if (!is_entity_dead(iVar0, false))
		{
			if (get_ped_in_vehicle_seat(iVar0, -1, false) == iParam0)
			{
				...
				{
					iLocal_269 = iVar0;
					if (does_entity_exist(iLocal_269) && !is_entity_dead(iLocal_269, false))
					{
						iLocal_265 = get_entity_model(iLocal_269);
					}
					return 1;
				}
			}
...
void func_146(var uParam0, int iParam1)
{
	if (!func_150(uParam0, 0, 1))
	{
		if (func_143(iParam1))
		{
			if (is_control_just_pressed(0, 86) || is_disabled_control_pressed(0, 86))
			{
				if ((((((!func_142() && !is_help_message_being_displayed()) && !func_114(0)) && !func_58(6)) && !func_58(7)) && !get_player_wanted_level(player_id()) > 0) && func_106() == 1)
				{
					func_135(&uLocal_80, 1, player_ped_id(), "FRANKLIN", 0, 1);
					func_135(&uLocal_80, 4, 0, "TOWDISPATCH", 0, 1);
...
void func_148(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	...
	fVar0 = vdist2(Param1, get_entity_coords(iParam0, true));
	switch (iLocal_71)
	{
		case 0:
			...
			if (is_ped_in_any_vehicle(iParam0, false))
			{
				...
				if (!is_entity_dead(iVar1, false))
				{
					...
					if ((iVar2 == joaat("towtruck") || iVar2 == joaat("towtruck2")) && get_entity_health(iVar1) > 400)
					{
						return;
					}
				}
		...
		case 2:
			if (has_model_loaded(joaat("towtruck")))
			{
				if (!is_sphere_visible(Local_254, fLocal_255) || func_22(Global_113386.f_19973.f_1, 1073741824))
				{
					if (!does_entity_exist(iLocal_269))
					{
						iLocal_269 = create_vehicle(joaat("towtruck"), Param1, fParam2, true, true, false);
						set_model_as_no_longer_needed(joaat("towtruck"));
						iLocal_71 = 3;
					}
				}
		...
		case 3:
			if (is_ped_in_any_vehicle(iParam0, false))
			{
				if (get_vehicle_ped_is_in(iParam0, false) == iLocal_269)
				{
					iLocal_71 = 0;
				}
			}
			if (is_entity_dead(iLocal_269, false))
			{
				iLocal_71 = 0;
			}
			if (fVar0 > 62500f)
...
int func_150(var uParam0, bool bParam1, bool bParam2)
{
	...
	if ((get_game_timer() - iLocal_248) < iLocal_249)
	{
		return 0;
	}
	return 1;
