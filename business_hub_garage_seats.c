...
int func_81()
{
	if (is_entity_in_angled_area(player_ped_id(), -1502.824f, -3006.31f, -80.557f, -1513.824f, -3006.31f, -84.557f, 9.5f, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_82()
{
	if (Global_2689235[player_id() /*453*/].f_318.f_9 != func_19())
	{
		if (network_is_script_active("business_hub_garage_seats", Global_2689235[player_id() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
