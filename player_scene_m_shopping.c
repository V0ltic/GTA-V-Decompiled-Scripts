		...
		switch (iLocal_258)
		{
			...
			case 1:
				...
				else if (is_synchronized_scene_running(Global_97771))
				{
					...
					if (!is_entity_playing_anim(*iParam0, &cLocal_268, &cLocal_286, 2))
					{
						clear_ped_tasks(*iParam0);
						stop_synchronized_entity_anim(*iParam0, -16f, true);
						set_ped_move_anims_blend_out(*iParam0);
						task_follow_nav_mesh_to_coord(*iParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), false, 40000f);
						force_ped_motion_state(*iParam0, joaat("MotionState_Walk"), false, 0, false);
					...
					else
					{
						...
						if (!find_anim_event_phase(&cLocal_268, &cLocal_286, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
				...
				{
					clear_ped_tasks(*iParam0);
					if (is_string_null_or_empty(&cLocal_295))
					{
						task_follow_nav_mesh_to_coord(*iParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), false, 40000f);
						force_ped_motion_state(*iParam0, joaat("MotionState_Walk"), false, 0, false);
						clear_ragdoll_blocking_flags(*iParam0, 2);
					...
					{
						task_start_scenario_at_position(*iParam0, &cLocal_295, Local_264 + Local_304, (fLocal_265 + fLocal_305), 0, false, true);
			...
			case 2:
				...
				else
				{
					...
					{
						Var3 = { get_offset_from_entity_in_world_coords(player_ped_id(), 5f, 0f, 0f) };
			...
			case 3:
				...
				{
					if (vdist2(get_entity_coords(*iParam0, true), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
					{
						if (fLocal_267 == 0f)
						{
							fLocal_267 = (vmag(Local_266) * 0.75f);
						}
						task_wander_in_area(*iParam0, Local_264 + Local_266, fLocal_267, 3f, 6f);
						func_134(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (vdist2(get_entity_coords(*iParam0, true), Local_264 + Local_266) < (fLocal_267 * fLocal_267))
				{
					if (does_scenario_exist_in_area(Local_264 + Local_266, fLocal_267, true))
					{
						task_use_nearest_scenario_to_coord(*iParam0, Local_264 + Local_266, fLocal_267, 0);
						remove_scenario_blocking_area(iLocal_307, false);
						func_134(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					if (get_safe_coord_for_ped(Var4, false, &Var5, 14))
					{
						if (vdist2(get_entity_coords(*iParam0, true), Var5) > 100f)
						{
							task_follow_nav_mesh_to_coord(*iParam0, Var5, 1f, -1, 0.25f, false, 40000f);
							Var6 = { get_entity_coords(*iParam0, true) - Vector(2f, 2f, 2f) };
							Var7 = { get_entity_coords(*iParam0, true) + Vector(2f, 2f, 2f) };
							iLocal_307 = add_scenario_blocking_area(Var6, Var7, false, false, true, true);
			...
			case 7:
				...
				func_7(*iParam0);
				if (is_entity_playing_anim(*iParam0, &cLocal_268, &cLocal_277, 2))
				{
				}
				else if (is_entity_playing_anim(*iParam0, &cLocal_268, &cLocal_286, 2))
				{
				}
				break;
			...
			case 8:
				...
				if (get_script_task_status(*iParam0, 1805844857) != 1)
				{
					task_smart_flee_ped(*iParam0, player_ped_id(), 50f, 20000, true, false);
					return 1;
				}
				if (vdist2(get_entity_coords(*iParam0, true), get_entity_coords(*iParam0, true)) > (50f * 1.25f))
				{
					task_follow_nav_mesh_to_coord(*iParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), false, 40000f);
...
Vector3 func_5(struct<3> Param0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_6(Var0, get_random_float_in_range(0f, fParam1)) };
...
void func_7(int iParam0)
{
	...
	if (is_ped_injured(iParam0))
	{
		if (!iLocal_310 && has_entity_been_damaged_by_entity(iParam0, player_ped_id(), true))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_113(75, get_entity_coords(iParam0, false), 250f, -1);
	...
	else
	{
		...
		if (iLocal_308 > 0)
		{
			if (iLocal_309 == 0)
			{
				if (iLocal_308 + 15000 < get_game_timer())
				{
			...
			else if (iLocal_308 + 10000 < get_game_timer())
			{
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_9(iParam2), 1);
}
...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int* iParam5, int iParam6)
{
	...
	if (iVar8 || func_36(sParam3, &Var4, uParam4))
	{
		if (iVar3 == 5)
		{
			if (iVar2 == 0)
			{
				func_35(uParam2, 0, player_ped_id(), "MICHAEL", 0, 1);
			}
			else if (iVar2 == 1)
			{
				func_35(uParam2, 0, player_ped_id(), "FRANKLIN", 0, 1);
			}
			else if (iVar2 == 2)
			{
				func_35(uParam2, 0, player_ped_id(), "TREVOR", 0, 1);
			}
		}
...
int func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)
{
	...
	if (func_33(sParam0, 7))
	{
		...
		{
			func_35(uParam2, 0, player_ped_id(), sVar0, 0, 1);
...
int func_33(char* sParam0, int iParam1)
{
	...
	else if (!func_34() && !is_mobile_phone_call_ongoing())
	{
...
void func_52(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_54() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_54() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_53(bParam0));
...
int func_89(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	func_90(iParam0, sParam1, bVar1, func_91(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_93(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
int func_131(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (has_ped_received_event(iParam0, 124))
		{
			return 1;
		}
	}
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_9(iParam3), false);
}
...
int func_135()
{
	if (!func_137())
	{
		func_35(&uLocal_68, 0, player_ped_id(), "MICHAEL", 0, 1);
	...
	if (iLocal_261 != 0)
	{
		...
		{
			iLocal_260 = get_closest_object_of_type(Local_264 + Local_262, 1f, iLocal_261, true, false, true);
			if (does_entity_exist(iLocal_260))
			{
				set_entity_coords(iLocal_260, Local_264 + Local_262, true, false, false, true);
				set_entity_rotation(iLocal_260, Vector(fLocal_265, 0f, 0f) + Local_263, 2, true);
...
void func_146()
{
	...
	if (iLocal_259 != 0)
	{
		request_vehicle_asset(iLocal_259, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_259 != 0)
		{
			if (!has_vehicle_asset_loaded(iLocal_259))
			{
				bVar1 = false;
			}
		}
...
void func_148()
{
	...
	switch (iLocal_67)
	{
		...
		default:
			Local_266 = { get_random_float_in_range(-50f, 50f), get_random_float_in_range(-50f, 50f), 0f };
			fLocal_267 = (vmag(Local_266) * 0.75f);
			break;
	}
...
int func_154(int iParam0, bool bParam1)
{
	...
	{
		if ((func_159() || is_pc_version()) || func_158())
		{
		}
		else if (!func_161())
		{
...
void func_173()
{
	if (iLocal_259 != 0)
	{
		remove_vehicle_asset(iLocal_259);
	}
