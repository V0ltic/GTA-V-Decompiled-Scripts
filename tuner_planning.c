...
void __EntryFunction__()
{
	...
	fLocal_513 = 100f;
	fLocal_523 = 0.5f;
	StringCopy(&Local_287, get_this_script_name(), 64);
	Local_287 = { Local_287 };
...
{
	begin_scaleform_movie_method(uParam0->f_711, "SHOW_MAIN_SCREEN");
	func_7(uParam1->f_11);
	func_7(uParam1->f_12);
	scaleform_movie_method_add_param_int(uParam1->f_13);
	scaleform_movie_method_add_param_texture_name_string(uParam1->f_14[0]);
	scaleform_movie_method_add_param_texture_name_string(uParam1->f_14[1]);
	func_7((*uParam1)[0 /*5*/]);
	scaleform_movie_method_add_param_texture_name_string((uParam1[0 /*5*/])->f_2);
	scaleform_movie_method_add_param_int((uParam1[0 /*5*/])->f_3);
	func_7((*uParam1)[1 /*5*/]);
	scaleform_movie_method_add_param_texture_name_string((uParam1[1 /*5*/])->f_2);
	scaleform_movie_method_add_param_int((uParam1[1 /*5*/])->f_3);
	scaleform_movie_method_add_param_texture_name_string(uParam1->f_17.f_2);
	scaleform_movie_method_add_param_int(uParam1->f_17.f_3);
	scaleform_movie_method_add_param_bool((uParam1[0 /*5*/])->f_4);
	scaleform_movie_method_add_param_bool((uParam1[1 /*5*/])->f_4);
	scaleform_movie_method_add_param_bool(uParam1->f_17.f_4);
	func_7(uParam1->f_17);
...
{
	call_scaleform_movie_method_with_number(uParam0->f_711, "SET_CURRENT_SELECTION", to_float(iParam1), -1f, -1f, -1f, -1f);
...
{
	begin_scaleform_movie_method(uParam0->f_711, "SET_STYLE");
...
{
	return func_30(player_id(), iParam0, bParam1);
}
...
void func_43(int iParam0)
{
	...
	if (func_45() == 0 || is_pause_menu_active())
	{
		func_44(1);
...
void func_47(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_45() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_44(0);
...
int func_50()
{
	if (func_52(player_id(), 0))
	{
		if (Global_1853348[player_id() /*834*/].f_775 != func_36())
		{
			if (func_35(Global_1853348[player_id() /*834*/].f_775, 0, 1))
			{
				if (func_51(Global_1853348[player_id() /*834*/].f_775, 1, 0))
				{
					return 0;
				}
			}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_52(player_id(), 0) && !func_72()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_68(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
int func_93(var uParam0)
{
	...
	if (!func_35(player_id(), 1, 1))
	{
		return 0;
	}
	if (func_84(uParam0) && uParam0->f_1084 != player_id())
	{
		return 0;
	}
	...
	if (func_101(player_id(), 0) && func_100(player_id()))
	{
		return 0;
	}
	if (uParam0->f_726 != 3)
...
int func_111(var uParam0)
{
	...
	func_207(func_208(player_id()));
	func_64(player_id(), 0, 376832, 0);
	Global_2715699.f_3830 = 1;
	func_206(player_id(), 0);
	func_205();
	func_204();
	switch (uParam0->f_1082)
	{
...
void func_112(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (func_164(Var0))
		{
			if (func_52(player_id(), 0))
			{
				if (does_entity_exist(func_161()) && !is_entity_dead(func_161(), false))
				{
					Var0 = { get_entity_coords(func_161(), true) };
					Var1 = { 0f, 0f, get_entity_heading(func_161()) };
					if (func_51(Global_1853348[player_id() /*834*/].f_775, 1, 0))
					{
			...
			if ((func_160(player_id()) || func_158(player_id())) && func_157())
			{
				Var0.f_2 = (Var0.f_2 + 1.5f);
			}
			else if (is_valid_interior(get_interior_from_entity(player_ped_id())))
			{
				if (func_160(player_id()))
				{
	...
	{
		iVar6 = func_152(player_id());
		Var0 = { _get_object_offset_from_coords(func_151(iVar6), func_150(iVar6), 3.5688f, 7.9792f, 4.1641f) };
	...
	{
		func_135();
		func_134(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		if (!func_164(Var7))
		{
			Var0 = { Var7 };
		}
		func_128(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		Var1 = { Var7 };
	}
...
void func_113(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (network_is_game_in_progress())
		{
			...
			{
				func_64(player_id(), 0, 32768, 0);
			}
			else if (func_114())
			{
				func_64(player_id(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_64(player_id(), 0, 319492, 0);
			}
		}
		else
		{
			func_64(player_id(), 0, 57348, 0);
		}
	}
}
...
{
	if (!animpostfx_is_running(func_170(0)))
	{
		animpostfx_play(func_170(iParam0), 0, true);
	}
}
...
Vector3 func_209(int iParam0)
{
	...
	{
		Var1 = { func_261(func_262(Global_1853348[player_id() /*834*/].f_267.f_32)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
int func_220(int iParam0)
{
	if (iParam0 != func_36())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_35(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
int func_221(int iParam0)
{
	if (iParam0 != func_36())
	{
		...
		else if (((Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_1575058) && iParam0 == player_id()) && func_35(iParam0, 1, 0))
		{
			return func_159(Global_2689235[iParam0 /*453*/].f_318.f_6) == 20;
		}
	}
...
int func_257(int iParam0)
{
	if (iParam0 != func_36())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_35(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_258(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_259(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
void func_276(var uParam0, bool bParam1, int iParam2)
{
	if (bParam1)
	{
		if ((uParam0->f_1092 && !func_34(player_id())) || iParam2)
		{
			func_64(player_id(), 1, 0, 0);
			freeze_entity_position(player_ped_id(), false);
			uParam0->f_1092 = 0;
...
void func_282()
{
	...
	while (iVar0 < 32)
	{
		if (network_is_player_active(int_to_playerindex(iVar0)))
		{
			...
			if (iVar1 != func_36() && iVar1 != player_id())
			{
...
{
	set_bit(&(Local_292.f_2[(iParam1 / 32)]), (iParam1 % 32));
...
void func_303()
{
	...
	{
		if (func_306(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_305(player_ped_id());
...
int func_324(var uParam0)
{
	...
	if (is_control_just_pressed(2, 188) || func_325(uParam0, 0, 0))
	{
		return 0;
	}
	else if (is_control_just_pressed(2, 187) || func_325(uParam0, 0, 1))
	{
		return 1;
	}
	else if (is_control_just_pressed(2, 189) || func_325(uParam0, 0, 2))
	{
		return 2;
	}
	else if (is_control_just_pressed(2, 190) || func_325(uParam0, 0, 3))
	{
		return 3;
	}
...
void func_327(var uParam0)
{
	...
	if (uParam0->f_741.f_32 != uParam0->f_741.f_33)
	{
		...
		if (func_339())
		{
			shake_cam(uParam0->f_741.f_1, func_338(), func_337());
		}
...
void func_332(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	if (uParam0->f_26)
	{
		uParam0->f_14 = func_333(uParam0->f_14, to_float(-uParam0->f_21), to_float(uParam0->f_21));
		uParam0->f_14.f_1 = func_333(uParam0->f_14.f_1, to_float(-uParam0->f_22), to_float(uParam0->f_22));
		uParam0->f_14.f_2 = func_333(uParam0->f_14.f_2, to_float(-uParam0->f_20), to_float(uParam0->f_20));
	}
...
void func_349(var uParam0)
{
	if (func_379(uParam0))
	{
		if (has_scaleform_movie_loaded(uParam0->f_711))
		{
			...
			draw_scaleform_movie(uParam0->f_711, func_377(), func_376(), func_375(), func_374(), 255, 255, 255, 255, 0);
...
int func_355(int iParam0, int iParam1)
{
	...
	if (iParam0 != -1)
	{
		...
		if (iVar0 != 0)
		{
			if (get_cloud_time_as_int() < iVar0)
			{
				return 1;
			}
		}
			...
			while (bVar0 < uParam2->f_693)
			{
				if (BitTest(uParam2->f_689, bVar0))
				{
					...
					if (!BitTest(uParam2->f_690, bVar0))
					{
						...
						func_365(get_control_instructional_button(iVar1, iVar2, true));
						if (iVar3 < 363)
						{
							func_365(get_control_instructional_button(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_365(get_control_group_instructional_button(iVar4, iVar5, true));
					}
...
void func_386(var uParam0, struct<3> Param1, struct<3> Param2, var uParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9, float fParam10, bool bParam11)
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param2 };
	uParam0->f_7 = uParam3;
...
{
	uParam0->f_711 = request_scaleform_movie(func_390(uParam0));
	uParam0->f_712 = request_scaleform_movie(func_389(uParam0));
}
...
void func_393()
{
	if (network_is_activity_session() && func_394() == 25)
	{
...
bool func_402(var uParam0)
{
	if (!BitTest(uParam0->f_1085, 0))
	{
		if (iLocal_276 == player_id())
		{
		}
		if (iLocal_275 == player_ped_id())
		{
		}
...
void func_408(var uParam0, int iParam1)
{
	...
	set_bit(&(Local_292[(iParam1 / 32)]), (iParam1 % 32));
}
...
void func_411(int iParam0, bool bParam1)
{
	...
	Global_1977138[network_player_id_to_int() /*57*/].f_4 = iParam0;
	func_415(1);
	if (bParam1)
	{
...
int func_439()
{
	if (does_entity_exist(iLocal_275) && func_35(iLocal_276, 1, 1))
	{
...
{
	begin_scaleform_movie_method(iParam0, "GET_CURRENT_SELECTION");
	iLocal_269 = end_scaleform_movie_method_return_value();
	iLocal_271 = 1;
}

void func_451(int iParam0)
{
	begin_scaleform_movie_method(iParam0, "GET_CURRENT_ROLLOVER");
	iLocal_268 = end_scaleform_movie_method_return_value();
	iLocal_270 = 1;
}
...
void func_471(var uParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_497(player_id(), 271, 0);
	if (iVar1 != -1)
	{
		func_493(iVar1);
		func_455(uParam0, 2);
	...
	Global_1974423[network_player_id_to_int() /*25*/].f_24 = 1;
	func_27(1);
	func_455(uParam0, 4);
}
...
void func_473(int iParam0, int iParam1)
{
	...
	{
		if (!func_480(player_id(), 0) && !func_480(player_id(), 3))
		{
			func_479(iParam0);
...
{
	return func_219(player_id(), bParam0);
}
...
int func_536(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_566(iParam1, iParam2, iParam3, int_to_playerindex(iParam5), iParam4);
		
		case 233:
			return func_559(iParam1, iParam2, iParam3, int_to_playerindex(bParam5), iParam4);
		...
		case 243:
			return func_544(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
		
		case 158:
			return func_540(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
		
		case 181:
			return func_537(iParam1, iParam2, int_to_playerindex(bParam5), iParam4);
...
int func_587(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_615(iParam1, iParam3, iParam4, int_to_playerindex(iParam5), 0, 0, 0);
		
		case 233:
			return func_609(iParam1, iParam3, iParam4, int_to_playerindex(bParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_600(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
		
		case 158:
			return func_594(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
		
		case 181:
			return func_588(iParam1, iParam3, int_to_playerindex(bParam5), 0, -1, 0, 0);
...
{
	if (is_scaleform_movie_method_return_value_ready(iLocal_269))
	{
		*iParam0 = get_scaleform_movie_method_return_value_int(iLocal_269);
		return 1;
	}
	*iParam0 = -1;
	return 0;
...
void func_661(var uParam0)
{
	...
	switch (iVar0)
	{
		...
		case 201:
			if (func_6(uParam0->f_1084) && is_help_message_being_displayed())
			{
				clear_help(true);
			}
			break;
...
{
	if (is_scaleform_movie_method_return_value_ready(iLocal_268))
	{
		*iParam0 = get_scaleform_movie_method_return_value_int(iLocal_268);
		return 1;
	}
	*iParam0 = -1;
	return 0;
...
void func_664(var uParam0)
{
	switch (uParam0->f_726)
	{
		...
		case 2:
			request_script_audio_bank("DLC_MPHEIST/HEIST_PLANNING_BOARD", false, -1);
			break;
...
void func_665(bool bParam0)
{
	...
	{
		set_bit(&iVar0, 4);
		set_bit(&(Global_1977138[network_player_id_to_int() /*57*/].f_1), 4);
	}
	else
	{
		clear_bit(&iVar0, 4);
		clear_bit(&(Global_1977138[network_player_id_to_int() /*57*/].f_1), 4);
	}
	func_404(9618, iVar0, -1, 1, 0);
}
...
{
	call_scaleform_movie_method(uParam0->f_711, "SHOW_BLANK_SCREEN");
	if (iLocal_273 != -1)
	{
		iLocal_273 = -1;
	}
...
{
	begin_scaleform_movie_method(uParam0->f_711, "SHOW_SELECTION_SCREEN");
	scaleform_movie_method_add_param_texture_name_string((*uParam1)[0 /*6*/]);
	func_7((uParam1[0 /*6*/])->f_1);
	func_7((uParam1[0 /*6*/])->f_2);
	scaleform_movie_method_add_param_int((uParam1[0 /*6*/])->f_3);
	scaleform_movie_method_add_param_texture_name_string((*uParam1)[1 /*6*/]);
	func_7((uParam1[1 /*6*/])->f_1);
	func_7((uParam1[1 /*6*/])->f_2);
	scaleform_movie_method_add_param_int((uParam1[1 /*6*/])->f_3);
	scaleform_movie_method_add_param_texture_name_string((*uParam1)[2 /*6*/]);
	func_7((uParam1[2 /*6*/])->f_1);
	func_7((uParam1[2 /*6*/])->f_2);
	scaleform_movie_method_add_param_int((uParam1[2 /*6*/])->f_3);
	scaleform_movie_method_add_param_int(uParam1->f_19);
	scaleform_movie_method_add_param_int(uParam1->f_20);
	scaleform_movie_method_add_param_int((uParam1[0 /*6*/])->f_4);
	scaleform_movie_method_add_param_int((uParam1[1 /*6*/])->f_4);
	scaleform_movie_method_add_param_int((uParam1[2 /*6*/])->f_4);
	scaleform_movie_method_add_param_bool((uParam1[0 /*6*/])->f_5);
	scaleform_movie_method_add_param_bool((uParam1[1 /*6*/])->f_5);
	scaleform_movie_method_add_param_bool((uParam1[2 /*6*/])->f_5);
	end_scaleform_movie_method();
	if (iLocal_273 != 0)
	{
		iLocal_273 = 0;
...
int func_681()
{
	if (is_entity_in_angled_area(iLocal_275, -1350.245f, 137.3038f, -96.10934f, -1347.282f, 138.094f, -94.10934f, 1.75f, false, true, 0) && func_682(get_entity_heading(iLocal_275), 198f, 75f))
	{
		return 1;
	}
	return 0;
...
void func_693()
{
	iLocal_275 = player_ped_id();
	iLocal_276 = player_id();
}
