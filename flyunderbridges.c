			...
			if (is_player_playing(player_id()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (vdist2(get_entity_coords(player_ped_id(), false), Local_39[bLocal_31 /*3*/]) < fLocal_40)
							{
								if (is_ped_in_any_heli(player_ped_id()) || is_ped_in_any_plane(player_ped_id()))
								{
									...
									if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false))
									{
										if (func_15())
										{
											if (is_entity_in_angled_area(player_ped_id(), Local_41, Local_42, fLocal_45, false, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (is_entity_in_angled_area(player_ped_id(), Local_43, Local_44, fLocal_45, false, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
					...
					case 1:
						if (!is_ped_injured(player_ped_id()))
						{
							...
							else if (!is_entity_in_air(get_vehicle_ped_is_in(player_ped_id(), false)))
							{
								func_14();
							}
							if (bLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!is_entity_in_angled_area(player_ped_id(), Local_41, Local_42, fLocal_45, false, true, 0) && !is_entity_in_angled_area(player_ped_id(), Local_43, Local_44, fLocal_45, false, true, 0))
										{
											func_14();
											func_1();
									...
									else if (!is_entity_in_angled_area(player_ped_id(), Local_41, Local_42, fLocal_45, false, true, 0) && is_entity_in_angled_area(player_ped_id(), Local_43, Local_44, fLocal_45, false, true, 0))
									{
										iLocal_36 = 1;
									}
									else if (!is_entity_in_angled_area(player_ped_id(), Local_41, Local_42, fLocal_45, false, true, 0) && !is_entity_in_angled_area(player_ped_id(), Local_43, Local_44, fLocal_45, false, true, 0))
...
void func_1()
{
	...
	else
	{
		...
		if (bLocal_31 < 32)
		{
			set_bit(&(Global_113386.f_10049.f_96), bLocal_31);
		}
		else if (bLocal_31 < 64)
		{
			set_bit(&(Global_113386.f_10049.f_97), (bLocal_31 - 32));
		}
		else
		{
			set_bit(&(Global_113386.f_10049.f_98), (bLocal_31 - 64));
		}
		Global_96886 = 1;
		func_30();
		iLocal_29 = 1;
...
int func_15()
{
	if (bLocal_38)
	{
		...
		{
			if (get_entity_upright_value(get_vehicle_ped_is_in(player_ped_id(), false)) > -0.6f && get_entity_upright_value(get_vehicle_ped_is_in(player_ped_id(), false)) < 0.6f)
			{
				return 1;
			}
		}
...
void func_16()
{
	if ((get_game_timer() - iLocal_48) > 500)
	{
		if (bLocal_31 == 29)
		{
	...
	switch (iLocal_28)
	{
		case 0:
			if (iLocal_29 && !bLocal_47)
			{
				if (!func_23())
				{
					iLocal_30 = request_scaleform_movie("MIDSIZED_MESSAGE");
					while (!has_scaleform_movie_loaded(iLocal_30))
					{
						wait(0);
					}
					begin_scaleform_movie_method(iLocal_30, "SHOW_BRIDGES_KNIVES_PROGRESS");
					if (bLocal_38)
					{
						func_22("FU_KNIFE");
					...
					scaleform_movie_method_add_param_int(func_30());
		...
		case 1:
			if ((((((timerb() > 3750 || is_screen_faded_out()) || !is_player_playing(player_id())) || func_23()) || !is_player_control_on(player_id())) || func_21()) || func_20())
			{
				begin_scaleform_movie_method(iLocal_30, "SHARD_ANIM_OUT");
		...
		case 2:
			if ((((((timerb() > 500 || is_screen_faded_out()) || !is_player_playing(player_id())) || func_23()) || !is_player_control_on(player_id())) || func_21()) || func_20())
			{
				iLocal_28 = 3;
			}
			else
...
int func_30()
{
	...
	else
	{
		...
		if (iVar2 >= 50)
		{
			presence_event_updatestat_int(joaat("sp0_water_cannon_deaths"), 100, 0);
		}
		else if (iVar2 >= 38)
		{
			presence_event_updatestat_int(joaat("sp0_water_cannon_deaths"), 75, 0);
		}
		else if (iVar2 >= 25)
		{
			func_44(290, 0, 0);
			presence_event_updatestat_int(joaat("sp0_water_cannon_deaths"), 50, 0);
		}
		else if (iVar2 >= 13)
		{
			presence_event_updatestat_int(joaat("sp0_water_cannon_deaths"), 25, 0);
		}
	}
...
void func_45()
{
	...
	{
		func_48(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_46() == 2 == 0 && !network_is_game_in_progress())
			{
