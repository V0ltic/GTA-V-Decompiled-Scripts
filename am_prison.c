...
void __EntryFunction__()
{
	...
	{
		func_41();
		if (func_34() || network_is_in_tutorial_session())
		{
			func_42();
		}
		if (network_is_game_in_progress())
		{
			...
			if (!func_27() || func_24(player_id(), 0))
			{
				if ((((((((!Global_1836146 && !func_23(3)) && !func_20(player_id(), 0)) && !is_player_switch_in_progress()) && is_player_control_on(player_id())) && !func_18(player_id())) && !func_16(func_17(player_id()))) && !func_14(player_id(), 146)) && !func_10(player_id()))
				{
					if (func_9(get_entity_coords(player_ped_id(), false), 4, 100, 0))
					{
...
int func_27()
{
	...
	if (Global_1853348[player_id() /*834*/] == -1)
	{
		return 0;
	}
	return 1;
...
int func_29()
{
	switch (Local_96.f_0)
	{
		case 0:
			...
			{
				Local_96.f_4 = add_scenario_blocking_area(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, false, true, true, true);
			}
			func_30(&(uLocal_95[participant_id_to_int()]), 1);
			Local_96.f_0 = 1;
			break;
		
		case 1:
			if (vdist2(get_entity_coords(player_ped_id(), false), 1693.164f, 2559.616f, 44.5649f) >= 1030225f)
			{
				Local_96.f_0 = 2;
			}
			break;
		...
		case 2:
			if (Global_1836146 || func_23(3))
			{
				remove_scenario_blocking_area(Local_96.f_4, false);
			}
			return 1;
			break;
	}
...
void func_44(struct<21> Param0)
{
	...
	func_46(0, -1, 0);
	network_register_host_broadcast_variables(&iLocal_93, 2, 0);
	network_register_player_broadcast_variables(&uLocal_95, 33, 0);
...
void func_48(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!network_is_game_in_progress())
	{
		func_43();
