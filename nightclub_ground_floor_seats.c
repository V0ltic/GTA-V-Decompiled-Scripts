...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = network_get_local_scene_from_network_id(uParam0->f_141.f_1);
		if (is_synchronized_scene_running(iVar0))
		{
			network_stop_synchronised_scene(uParam0->f_141.f_1);
		}
	}
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 1:
			...
			if (func_64(uParam0))
			{
				uParam0->f_141.f_6 = get_game_timer();
				func_65(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_63(player_ped_id(), uParam0[uParam0->f_141.f_2 /*14*/]) && func_62(player_ped_id(), (uParam0[uParam0->f_141.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_141.f_2 /*14*/]))
			{
				...
				else
				{
					...
					{
						if ((get_game_timer() - uParam0->f_141.f_6) > 150)
						{
		...
		case 4:
			...
			Var2 = { get_anim_initial_offset_position(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			Var3 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			fVar4 = Var3.f_2;
			fVar5 = 0.05f;
			...
			task_go_straight_to_coord(player_ped_id(), Var2, 1f, 500, fVar4, fVar5);
		...
		case 5:
			...
			Var7 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_34(get_entity_heading(player_ped_id()), fVar8, 5f))
			{
				uParam0->f_141.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
				network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_141.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1000f, 0);
				network_start_synchronised_scene(uParam0->f_141.f_1);
				uParam0->f_141.f_8.f_4 = get_game_timer();
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = network_get_local_scene_from_network_id(uParam0->f_141.f_1);
			if (is_synchronized_scene_running(iVar9))
			{
				if (get_synchronized_scene_phase(iVar9) >= 1f)
				{
					func_10(uParam0, 0);
					func_50(uParam0, &sVar0);
					func_49(uParam0, &sVar1);
					uParam0->f_141.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
					network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_141.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					network_start_synchronised_scene(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			iVar10 = network_get_local_scene_from_network_id(uParam0->f_141.f_1);
			iVar11 = get_script_task_status(player_ped_id(), 1785177548);
			if (iVar11 == 0 || iVar11 == 1)
			{
				if (is_synchronized_scene_running(iVar10))
				{
					if ((get_synchronized_scene_phase(iVar10) >= 0.7f || has_anim_event_fired(player_ped_id(), 364629851)) || has_anim_event_fired(player_ped_id(), 2116425869))
					{
						network_stop_synchronised_scene(uParam0->f_141.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_10(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((get_game_timer() - uParam0->f_141.f_8.f_4) >= 90000)
		{
			iVar1 = func_11(uParam0);
			if (iVar1 != uParam0->f_141.f_8.f_1)
			{
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_141.f_4 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_141.f_4 == 6 && !has_anim_event_fired(player_ped_id(), -1322051853)) && !func_32(&(uParam0->f_141), 12))
		{
		...
		else
		{
			...
			bVar2 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2689235[player_id() /*453*/].f_318.f_9, 4)) && func_23(Global_2689235[player_id() /*453*/].f_318.f_9))
			{
				bVar2 = true;
			}
			if (((((!is_pause_menu_active() && !func_32(&(uParam0->f_141), 0)) && !func_32(&(uParam0->f_141), 4)) && !func_22()) && !func_20(1)) && uParam0->f_141.f_8.f_2 != 3)
			{
				if (uParam0->f_141.f_5 == -1)
				{
					if (uParam0->f_141.f_8 == 1 || uParam0->f_141.f_8 == 0)
					{
						if (_is_using_keyboard(2))
						{
							if (bVar2)
							{
								if (func_17(player_id()) == 3)
								{
									func_54(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC_BM", 0, 0, 0, 0);
								}
								else if (func_17(player_id()) == 2)
								{
				...
				if (uParam0->f_141.f_4 == 6)
				{
					...
					if (((is_disabled_control_just_pressed(2, iVar3) && !is_control_just_pressed(2, 203)) && !Global_2789737) && !Global_2789734)
					{
						func_30(uParam0);
					}
					if (((((is_disabled_control_just_pressed(2, 203) && !is_disabled_control_just_pressed(2, iVar3)) && func_26(func_27())) && func_25()) && func_24(Global_2689235[player_id() /*453*/].f_318.f_9, 4)) && func_23(Global_2689235[player_id() /*453*/].f_318.f_9))
					{
						Global_2789737 = 1;
						Global_2789734 = 1;
					}
...
int func_25()
{
	if (is_entity_in_angled_area(player_ped_id(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, false, true, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = network_create_synchronised_scene(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
	func_50(uParam0, &sVar0);
	network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_141.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	network_start_synchronised_scene(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_65(uParam0, 8);
}
...
int func_52(var uParam0)
{
	...
	switch (uParam0->f_141.f_8)
	{
		...
		default:
			iVar0 = get_random_int_in_range(0, func_14(uParam0->f_141.f_8));
	}
	if (uParam0->f_141.f_8 == 1)
	{
		if (func_12())
...
int func_56(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (iVar1 != player_id() && func_59(iVar1, 1, 1))
			{
				if (func_63(get_player_ped(iVar1), uParam0[uParam0->f_141.f_2 /*14*/]) || func_58(iVar1) == uParam0->f_141.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((does_entity_exist(uVar0[iVar1]) && !is_ped_injured(uVar0[iVar1])) && is_entity_visible(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_141.f_2 /*14*/]) || vdist2(get_entity_coords(uVar0[iVar1], false), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
int func_62(int iParam0, struct<3> Param1, int iParam2)
{
	if (does_entity_exist(iParam0))
	{
		if (iParam2 == 3)
		{
			if (func_34(get_entity_heading(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(get_entity_heading(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_141.f_4 > 4)
	{
		...
		set_ped_capsule(player_ped_id(), func_68());
		uParam0->f_141.f_7 = get_frame_count();
	}
	else if ((get_frame_count() - uParam0->f_141.f_7) < 5)
	{
		set_ped_capsule(player_ped_id(), func_68());
	}
}
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_141), 1, is_entity_dead(player_ped_id(), false));
	func_70(&(uParam0->f_141), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_70(&(uParam0->f_141), 0, func_45(0));
	func_70(&(uParam0->f_141), 2, is_ped_running(player_ped_id()));
}
...
int func_72()
{
	if (is_screen_faded_out() && !func_82())
	{
		return 1;
	}
	if (!func_81())
	...
	if (Global_2689235[player_id() /*453*/].f_318.f_9 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_73()
{
	...
	if (func_74() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_74()) == 0)
		{
			return 1;
		}
	}
...
int func_81()
{
	if (is_entity_in_angled_area(player_ped_id(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_83()
{
	if (Global_2689235[player_id() /*453*/].f_318.f_9 != func_19())
	{
		if (network_is_script_active("nightclub_ground_floor_seats", Global_2689235[player_id() /*453*/].f_318.f_9, true, 0))
		{
			return 0;
		}
		network_set_this_script_is_network_script(32, false, Global_2689235[player_id() /*453*/].f_318.f_9);
		func_91(0, -1, 0);
