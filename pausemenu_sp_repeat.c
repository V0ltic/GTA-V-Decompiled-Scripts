...
void __EntryFunction__()
{
	...
	if (Global_2883694)
	{
		if (_get_number_of_references_of_script_with_name_hash(-43879923) == 0)
		{
			request_script_with_name_hash(-43879923);
			while (!has_script_with_name_hash_loaded(-43879923))
			{
				wait(0);
			}
	...
	{
		if (_get_number_of_references_of_script_with_name_hash(1179280373) == 0)
		{
			request_script_with_name_hash(1179280373);
			while (!has_script_with_name_hash_loaded(1179280373))
			{
				wait(0);
			}
		...
		case 1:
			switch (ScriptParam_30.f_1)
			{
				...
				case 52:
					...
					{
						_0x0CF54F20DE43879C(ScriptParam_30.f_3);
					}
					break;
				...
				case 76:
					if (Global_78585 != -1)
					{
						...
						if (is_ped_in_any_vehicle(player_ped_id(), false))
						{
							...
							{
								Global_78570 = { get_entity_velocity(get_vehicle_ped_is_in(player_ped_id(), false)) };
							}
						}
...
void func_29(bool bParam0, int iParam1)
{
	...
	scaleform_movie_method_add_param_int((3 - iVar2));
	func_30(sVar0);
	func_30(sVar1);
...
float func_48(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	else
	{
		begin_scaleform_movie_method_on_frontend("SET_DESCRIPTION");
		scaleform_movie_method_add_param_int(2);
		scaleform_movie_method_add_param_int(func_49(iVar1));
		scaleform_movie_method_add_param_float(fVar0);
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		begin_scaleform_movie_method(iParam5, "SET_DATA_SLOT");
	}
	else
	{
	...
	if (iParam5 == 0)
	{
		...
		add_text_component_substring_text_label(func_55(iParam4));
		end_text_command_scaleform_string();
	}
	else
	{
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	if (iParam6 != 0)
	{
		begin_scaleform_movie_method(iParam6, "SET_DATA_SLOT");
	}
	else
	{
		begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT");
	...
	if (iParam6 == 0)
	{
		...
		add_text_component_substring_text_label(func_55(iParam5));
		end_text_command_scaleform_string();
	}
	else
	{
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	scaleform_movie_method_add_param_int(ceil(fVar0));
	if (iParam6 == 0)
	{
		begin_text_command_scaleform_string("PM_RP_STATD");
		add_text_component_substring_text_label(sParam4);
...
void func_59(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	if (iParam4 != 0)
	{
		begin_scaleform_movie_method(iParam4, "SET_DATA_SLOT");
	}
	else
	{
		begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT");
	...
	if (iParam4 == 0)
	{
		...
		add_text_component_substring_text_label(func_55(iParam3));
		end_text_command_scaleform_string();
	}
	else
	{
