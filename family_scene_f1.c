...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param3, var uParam4)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (does_entity_exist(Global_97919[iVar0]))
			{
...
void func_8(struct<3> Param0, struct<3> Param1, var uParam2)
{
	...
	{
		if (has_bullet_impacted_in_box(Param0, Param1, true, true))
		{
			*uParam2++;
			if (*uParam2 > 6)
			{
		...
		else if ((is_explosion_in_area(0, Param0, Param1) || is_explosion_in_area(2, Param0, Param1)) || is_projectile_type_in_area(Param0, Param1, joaat("weapon_grenadelauncher"), true))
		{
			Global_95464 = 5;
		}
	}
...
void func_9(struct<3> Param0, struct<3> Param1)
{
	...
	if (get_current_ped_weapon(player_ped_id(), &iVar0, true))
	{
		...
		{
			if (is_explosion_in_area(3, Param0, Param1))
			{
				Global_95464 = 2;
			}
		}
...
{
	if ((is_ped_ducking(player_ped_id()) || is_ped_in_cover(player_ped_id(), false)) || get_ped_stealth_movement(player_ped_id()))
	{
		if (is_entity_in_area(player_ped_id(), Param0, Param1, false, true, 0))
		{
			if (*uParam2 < 0)
			{
				*uParam2 = get_game_timer();
			}
			else if (get_game_timer() > *uParam2 + 10000)
			{
				Global_95464 = 1;
			}
		}
...
void func_13(struct<3> Param0, struct<3> Param1)
{
	...
	if (get_current_ped_weapon(player_ped_id(), &iVar0, true))
	{
		...
		{
			if (is_projectile_type_in_area(Param0, Param1, iVar0, true))
			{
				Global_95464 = 0;
			}
		}
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam5)
{
	...
	else if (is_player_playing(player_id()))
	{
		*uParam2 = get_interior_from_entity(player_ped_id());
		if (!is_string_null_or_empty(sParam5))
		{
			...
			{
				*uParam3 = get_interior_at_coords_with_type(Param4, sParam5);
			}
		}
		func_38(iParam1);
		*uParam0 = 0;
	...
	if (is_valid_interior(*uParam2) && is_interior_ready(*uParam2))
	{
		...
		else if (!is_string_null_or_empty(sParam5))
		{
			Var1 = { get_offset_from_interior_in_world_coords(*uParam2, 0f, 0f, 0f) };
...
int func_45(int iParam0, struct<3> Param1, float fParam2)
{
	...
	if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Param1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_100491)
...
int func_46(int iParam0)
{
	...
	if (get_random_event_flag() && Global_113376)
	{
		return 0;
	}
	if (!func_31(iParam0))
...
void func_51()
{
	...
	func_52(&uLocal_121, 0, player_ped_id(), "FRANKLIN", 0, 1);
}
...
void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)
{
	...
	while (iVar0 < *uParam0)
	{
		if (is_synchronized_scene_running((*uParam0)[iVar0]))
		{
			detach_synchronized_scene((*uParam0)[iVar0]);
		}
		(*uParam0)[iVar0] = -1;
		iVar0++;
	}
	...
	while (iVar0 < *uParam1)
	{
		...
		if (does_entity_exist((*uParam1)[iVar0]) && does_entity_belong_to_this_script((*uParam1)[iVar0], true))
		{
	...
	while (iVar0 < *uParam2)
	{
		...
		if (*uParam2)[iVar0] != player_ped_id()
		{
		...
		{
			if (is_entity_attached((*uParam3)[iVar0]))
			{
				detach_entity((*uParam3)[iVar0], true, true);
			}
		}
		if (func_86((*uParam3)[iVar0], "familyProp", iVar0))
		{
			delete_object(uParam3[iVar0]);
		}
		if (does_entity_exist((*uParam3)[iVar0]) && does_entity_belong_to_this_script((*uParam3)[iVar0], true))
		{
			set_object_as_no_longer_needed(uParam3[iVar0]);
		}
		if (func_86((*uParam5)[iVar0], "familyExtraPed", iVar0))
		{
			delete_ped(uParam5[iVar0]);
		}
		if (does_entity_exist((*uParam5)[iVar0]) && does_entity_belong_to_this_script((*uParam5)[iVar0], true))
		{
			set_ped_as_no_longer_needed(uParam5[iVar0]);
		}
		if ((*uParam4)[iVar0] != 0)
		{
			set_model_as_no_longer_needed((*uParam4)[iVar0]);
		}
		if ((*uParam6)[iVar0] != 0)
		{
			set_model_as_no_longer_needed((*uParam6)[iVar0]);
		}
...
int func_78()
{
	...
	while (iVar6 < 11)
	{
		...
		if (does_object_of_type_exist_at_coords(Var1, 10f, iVar0, false))
		{
			iVar7 = get_closest_object_of_type(Var1, 10f, iVar0, false, false, true);
			if (does_entity_exist(iVar7))
			{
				if (iVar3 == 825812850)
				{
					set_entity_rotation(iVar7, 0f, 0f, 21f, 2, true);
				}
		...
		else if (!is_door_registered_with_system(iVar3))
		{
		}
		else
		{
			door_system_set_door_state(iVar3, 3, true, true);
			door_system_set_open_ratio(iVar3, 0f, true, true);
			if (((iVar6 != 6 && iVar6 != 7) && iVar6 != 8) && iVar6 != 9)
			{
				remove_door_from_system(iVar3, 0);
			}
		}
		iVar6++;
	}
...
void func_79(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		set_bit(&(Global_41748[iParam0 /*31*/].f_1), 6);
	}
	else
	{
		clear_bit(&(Global_41748[iParam0 /*31*/].f_1), 6);
	}
}
...
{
	stop_stream();
	if ((*uParam0 == 0 && *uParam1 == -1) && is_string_null_or_empty(sParam2))
	{
		return 0;
	}
	if (*uParam0 != 0)
...
void func_83(int* iParam0)
{
	...
	{
		if (get_script_task_status(*iParam0, -2017877118) != 0)
		{
...
int func_86(int iParam0, char* sParam1, int iParam2)
{
	...
	if (get_cause_of_most_recent_force_cleanup() == 64 && get_entity_model(iParam0) != joaat("prop_bong_01"))
	{
		if (!is_entity_dead(iParam0, false) && !does_entity_belong_to_this_script(iParam0, true))
		{
	...
	{
		if (is_entity_a_vehicle(iParam0) && is_player_playing(player_id()))
		{
			if (is_ped_in_vehicle(player_ped_id(), get_vehicle_index_from_entity_index(iParam0), false))
			{
				return 0;
			}
		}
	...
	if (!is_entity_dead(iParam0, false))
	{
		...
		if (get_entity_model(iParam0) == joaat("prop_bong_01"))
		{
			return 0;
		}
	}
