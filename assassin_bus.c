...
void __EntryFunction__()
{
	...
	iLocal_143 = 100;
	iLocal_144 = 3;
	iLocal_738 = get_standard_blip_enum_id();
	iLocal_739 = get_waypoint_blip_enum_id();
	iLocal_984 = 1;
	iLocal_1331 = -1;
	fLocal_1333 = 1f;
	...
	iLocal_1395 = 1;
	iLocal_1417 = -1;
	iLocal_1420 = get_random_int_in_range(5, 15);
	iLocal_1425 = get_random_int_in_range(5, 10);
	iLocal_1430 = 1000;
	fLocal_1438 = 0.5f;
	fLocal_1442 = 15f;
	...
	if (has_force_cleanup_occurred(3))
	{
		...
		{
			set_entity_visible(iLocal_1352, true, false);
			set_entity_collision(iLocal_1352, true, false);
			set_entity_can_be_damaged(iLocal_1352, true);
		}
		func_551();
	...
	if (func_543())
	{
		...
		if (iLocal_1436 == 0)
		{
			if (bLocal_1404)
			{
				...
				if ((!is_this_model_a_boat(get_entity_model(iVar0)) && !is_this_model_a_plane(get_entity_model(iVar0))) && !is_this_model_a_heli(get_entity_model(iVar0)))
				{
	...
	while (true)
	{
		...
		if (func_490(&uScriptParam_1915))
		{
			if (func_489())
			{
				...
				func_486();
				remove_scenario_blocking_area(iLocal_1470[0], false);
				remove_scenario_blocking_area(iLocal_1470[1], false);
				remove_scenario_blocking_area(iLocal_1470[2], false);
				remove_scenario_blocking_area(iLocal_1470[3], false);
				remove_scenario_blocking_area(iLocal_1470[4], false);
				remove_scenario_blocking_area(iLocal_1470[5], false);
...
void func_1(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_986)
	{
		...
		case 1:
			...
			if (func_103(&uLocal_148, 1, 0) && is_mission_complete_ready_for_ui())
			{
...
void func_10(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_12() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_12() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_11(bParam0));
...
void func_42()
{
	...
	{
		if (func_45(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_53(var uParam0, int iParam1)
{
	...
	if (!Global_78587)
	{
		if (!is_player_dead(get_player_index()))
		{
			if (!Global_78588)
			{
				if (is_screen_faded_out() && !func_4(0))
				{
...
void func_56(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_62(uParam0->f_1, 256) || (func_62(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			scaleform_movie_method_add_param_bool(func_62(uParam0->f_1, 4096));
			end_scaleform_movie_method();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_64(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_567)
	{
		switch (func_44(get_player_ped(get_player_index())))
		{
			case 1:
...
void func_65(var uParam0, bool bParam1)
{
	...
	func_61(get_control_instructional_button(2, 215, true));
	func_60("ES_HELP");
	if (is_pc_version())
	{
		scaleform_movie_method_add_param_bool(true);
	...
	if (bParam1)
	{
		begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
		scaleform_movie_method_add_param_int(1);
		func_61(get_control_instructional_button(2, 216, true));
		func_60("ES_XPAND");
		if (is_pc_version())
		{
			scaleform_movie_method_add_param_bool(true);
...
void func_67(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_88();
		draw_rect(0.5f, (fVar1 - (func_91((2f - 0.5f)) - 0.001388889f)), fVar6, func_82(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_66((fVar11 / (0.6f * func_91(25f))), 0f, 1f);
					func_88();
					draw_rect(0.5f, (fVar1 + func_91((2f * 0.5f))), fVar6, func_82(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
					fVar1 = (fVar1 + func_91((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_91((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					end_text_command_display_text(fVar20, (fVar1 + func_91((2f * 2f))), 0);
					break;
...
void func_79(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			draw_sprite("CommonMenu", func_75(7, 0), (fParam4 - 0.006f), ((fParam2 + func_91(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_71(5, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_75(5, 0), (fParam4 - 0.006f), ((fParam2 + func_91(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_71(6, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_75(6, 0), (fParam4 - 0.006f), ((fParam2 + func_91(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_104(var uParam0)
{
	...
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(2);
	func_61(get_control_instructional_button(2, 188, true));
	func_60("ES_HELP_TU");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(1);
	func_61(get_control_instructional_button(2, 187, true));
	func_60("ES_HELP_TD");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(0);
	func_61(get_control_instructional_button(2, 202, true));
	func_60("ES_HELP_AB");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	end_scaleform_movie_method();
...
void func_107()
{
	...
	if (!iLocal_137)
	{
		...
		else
		{
			...
			if (!is_string_null_or_empty(&(Local_729.f_18)))
			{
				if (bLocal_135)
				{
...
void func_108()
{
	if (_get_number_of_references_of_script_with_name_hash(joaat("assassin_valet")) == 1)
	{
	...
	else if (_get_number_of_references_of_script_with_name_hash(joaat("assassin_multi")) == 1)
	{
	...
	else if (_get_number_of_references_of_script_with_name_hash(joaat("assassin_hooker")) == 1)
	{
	...
	else if (_get_number_of_references_of_script_with_name_hash(joaat("assassin_bus")) == 1)
	{
	...
	else if (_get_number_of_references_of_script_with_name_hash(joaat("assassin_construction")) == 1)
	{
...
void func_115()
{
	if (does_entity_exist(iLocal_1467) && is_vehicle_driveable(iLocal_1467, false))
	{
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_136(iParam0, 0, 0)) || func_136(iParam0, 1, 0)) || func_136(iParam0, 2, 0)) || func_159(iParam0) != 145) || func_135(iParam0)) || func_134(iParam0)) || func_133(iParam0)) || func_132(iParam0)) || !func_120(get_entity_model(iParam0)))
	{
		if (func_134(iParam0))
		{
		}
...
int func_121(int iParam0, bool bParam1)
{
	...
	{
		if ((func_126() || is_pc_version()) || func_125())
		{
		}
		else if (!func_128())
		{
...
var func_139()
{
	...
	func_142(&uVar0, get_clock_day_of_month());
	func_141(&uVar0, get_clock_month());
...
{
	return (shift_right(iParam0, 26) & 31 * func_145(BitTest(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_162(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_167()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!is_ped_injured(Local_1902[iVar0 /*30*/].f_14[iVar1]) && is_ped_in_any_vehicle(Local_1902[iVar0 /*30*/].f_14[iVar1], false))
			{
				set_ped_combat_attributes(Local_1902[iVar0 /*30*/].f_14[iVar1], 3, false);
				set_ped_flee_attributes(Local_1902[iVar0 /*30*/].f_14[iVar1], 2, false);
				set_ped_keep_task(Local_1902[iVar0 /*30*/].f_14[iVar1], true);
			}
			iVar1++;
		}
		iVar0++;
...
int func_172(var uParam0, int* iParam1)
{
	...
	switch (iLocal_984)
	{
		...
		case 4:
			...
			func_463();
			set_ped_model_is_suppressed(*uParam0, true);
		...
		case 7:
			func_379();
			func_378();
			if (does_blip_exist(iParam1->f_2))
			{
				func_375();
				if (func_373(uParam0->f_6, fLocal_1442) && is_player_ready_for_cutscene(player_id()))
				{
					if (does_blip_exist(iParam1->f_2))
					{
						remove_blip(&(iParam1->f_2));
			...
			{
				iParam1->f_2 = add_blip_for_coord(uParam0->f_6);
				set_blip_route(iParam1->f_2, true);
			}
			else
			{
				func_369();
			...
			func_368(iParam1);
			func_367();
			if ((((is_player_wanted_level_greater(player_id(), 0) && func_366(iParam1->f_1, 1) < fLocal_1442) || !func_365(iParam1->f_1)) || is_explosion_in_sphere(-1, uParam0->f_9, 25f)) || has_entity_been_damaged_by_entity(iParam1->f_1, player_ped_id(), true))
			{
		...
		case 10:
			...
			if (func_353(&Local_987, uParam0))
			{
				if (iLocal_969 == 1)
				{
					if (get_ped_last_damage_bone(*iParam1, &iVar0) && iVar0 != -1)
					{
						if (!func_352(*iParam1))
						{
							start_particle_fx_non_looped_on_ped_bone("scr_ojbusass_bus_impact", *iParam1, 0f, 0f, 0f, get_entity_forward_vector(iParam1->f_1), iVar0, 2f, false, false, false);
						}
					}
					else if (!func_352(*iParam1))
					{
						start_particle_fx_non_looped_on_ped_bone("scr_ojbusass_bus_impact", *iParam1, 0f, 0f, 0f, get_entity_forward_vector(iParam1->f_1), 31086, 2f, false, false, false);
					}
				}
...
void func_182()
{
	if (!iLocal_1412)
	{
		if (get_player_wanted_level(player_id()) > 0)
		{
			...
			{
				play_police_report("SCRIPTED_SCANNER_REPORT_ASS_BUS_01", 0f);
				iLocal_1412 = 1;
			}
		}
	}
...
int func_192()
{
	...
	if (player_id() == func_195())
	{
		return 0;
	}
	if (func_193(player_id()))
	{
		return 0;
	}
...
int func_205(int* iParam0)
{
	...
	{
		case 0:
			if (!is_entity_dead(iParam0->f_1, false) && !is_entity_dead(player_ped_id(), false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iParam0->f_1, false))
				{
		...
		case 1:
			if (!is_entity_dead(iParam0->f_1, false) && !is_entity_dead(player_ped_id(), false))
			{
				if (!is_ped_in_vehicle(player_ped_id(), iParam0->f_1, false))
				{
					Var1 = { get_entity_coords(iParam0->f_1, false) };
			...
			else if (!is_entity_dead(player_ped_id(), false) && does_entity_exist(iParam0->f_1))
			{
				if (!is_ped_in_vehicle(player_ped_id(), iParam0->f_1, false))
				{
					Var1 = { get_entity_coords(iParam0->f_1, false) };
		...
		case 2:
			if (is_vehicle_driveable(iParam0->f_1, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iParam0->f_1, false))
				{
					iLocal_1437 = 0;
...
void func_207(int iParam0, bool bParam1)
{
	...
	if (func_168(&iLocal_1493) > fLocal_1443)
	{
		...
		if (is_vehicle_driveable(iParam0, false))
		{
			iVar2 = get_ped_in_vehicle_seat(iParam0, iVar0, false);
			if (!is_ped_injured(iVar2))
			{
				if (!bParam1)
				{
					if (iVar1 == 0)
					{
						play_pain(iVar2, 6, 0, 0);
					}
					else if (iVar1 == 1)
					{
						play_pain(iVar2, 7, 0, 0);
					}
					else if (iVar1 == 2)
					{
						play_pain(iVar2, 3, 0, 0);
					}
				}
			}
		}
		fLocal_1443 = get_random_float_in_range(0f, 3f);
		func_186(&iLocal_1493);
	}
}
...
void func_208()
{
	if (does_cam_exist(iLocal_140))
	{
		if (is_cam_active(iLocal_140))
		{
			set_cam_active(iLocal_140, false);
			render_script_cams(false, false, 3000, true, false, 0);
			display_hud(true);
			destroy_cam(iLocal_140, false);
		}
	}
}
...
void func_209(int* iParam0)
{
	...
	else if (is_vehicle_driveable(iParam0->f_1, false))
	{
		if (does_entity_exist(*iParam0))
		{
			if (does_entity_exist(iParam0->f_8))
			{
				if (is_vehicle_driveable(iParam0->f_8, false) && is_ped_in_vehicle(*iParam0, iParam0->f_8, false))
				{
					if (is_entity_touching_entity(iParam0->f_1, *iParam0) || is_entity_touching_entity(iParam0->f_1, iParam0->f_8))
					{
						func_186(&iLocal_977);
					}
				}
				else if (is_entity_touching_entity(iParam0->f_1, *iParam0) || is_entity_touching_entity(iParam0->f_1, iParam0->f_8))
				{
					func_186(&iLocal_977);
				}
			}
...
void func_210(var uParam0, int* iParam1)
{
	...
	switch (iLocal_1349)
	{
		...
		case 2:
			if (has_entity_been_damaged_by_entity(iParam1->f_1, player_ped_id(), true))
			{
				func_355(Local_1350, uParam0, 2);
				return;
			}
			if (is_vehicle_driveable(iParam1->f_1, false))
			{
				if (func_343(iParam1))
				{
					func_342();
	...
	if (iLocal_1349 > 4)
	{
		if (func_228(*iParam1, 175f, 0))
		{
			...
			{
				if (!is_entity_on_screen(*iParam1) || is_entity_occluded(*iParam1))
				{
					if (does_blip_exist(iParam1->f_2))
					{
						remove_blip(&(iParam1->f_2));
			...
			if (func_168(&iLocal_1487) > 5f)
			{
				if (iLocal_1386)
				{
					if (is_vehicle_driveable(iParam0->f_1, false))
					{
						if (is_ped_in_vehicle(player_ped_id(), iParam0->f_1, false))
						{
							fVar0 = get_entity_speed(iParam0->f_1);
							if (fVar0 > 10f)
							{
								if (!is_ped_injured(*iParam0))
								{
									...
									{
										if (is_vehicle_driveable(iParam0->f_8, false))
										{
											if (is_ped_in_vehicle(*iParam0, iParam0->f_8, false))
											{
												func_223(iParam0);
											}
											else if (!iLocal_1384)
...
void func_213(var uParam0)
{
	if (!is_message_being_displayed())
	{
		if (func_171(&iLocal_1481))
		{
			if (!func_224())
			{
				if (is_vehicle_driveable(uParam0->f_1, false))
				{
					if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, false))
					{
						if (iLocal_1433 != 0)
						{
							func_217(uParam0);
...
{
	if (!is_ped_injured(iParam1) && is_ped_in_vehicle(iParam1, uParam0->f_1, false))
	{
		return 1;
	}
	return 0;
...
void func_217(var uParam0)
{
	...
	iVar0 = get_entity_health(uParam0->f_1);
	switch (iLocal_1431)
	{
		case 0:
			if (get_vehicle_number_of_passengers(uParam0->f_1, false, true) >= 2)
			{
				iLocal_1430 = get_entity_health(uParam0->f_1);
				iLocal_1431++;
			}
			break;
		...
		case 1:
			if (!func_224())
			{
				if (iVar0 < (iLocal_1430 - 50) || has_entity_collided_with_anything(uParam0->f_1))
				{
					if (func_216(uParam0, iLocal_1457))
					{
						func_204(&(uParam0->f_16), 4, iLocal_1457, "BusPed1", 0, 1);
		...
		case 2:
			if (!func_224())
			{
				if (iVar0 < (iLocal_1430 - 150) || has_entity_collided_with_anything(uParam0->f_1))
				{
					if (func_216(uParam0, iLocal_1458))
					{
						func_204(&(uParam0->f_16), 5, iLocal_1458, "BusPed2", 0, 1);
		...
		case 3:
			if (!func_224())
			{
				if (iVar0 < (iLocal_1430 - 200) || has_entity_collided_with_anything(uParam0->f_1))
				{
...
void func_218(var uParam0)
{
	...
	else if (!is_ped_injured(*uParam0))
	{
...
{
	iLocal_1425 = get_random_int_in_range(iParam0, iParam1);
	func_186(&iLocal_1481);
	func_186(&iLocal_1487);
	iLocal_1421++;
}
...
{
	iLocal_1420 = get_random_int_in_range(iParam0, iParam1);
	func_186(&iLocal_1478);
	func_186(&iLocal_1487);
	iLocal_1419++;
}
...
void func_225(var uParam0, int* iParam1)
{
	if (iLocal_1349 < 4)
	{
		if (does_entity_exist(iParam1->f_1))
		{
			...
			if (is_vehicle_stuck_timer_up(iParam1->f_1, 0, 1000))
			{
				func_355(Local_1350, uParam0, 3);
			}
			if (iLocal_1349 >= 3)
			{
				if (is_vehicle_driveable(iParam1->f_1, false))
				{
					if (!is_ped_in_vehicle(player_ped_id(), iParam1->f_1, false))
					{
						if (bLocal_1382 == 1)
						{
							bLocal_1382 = false;
		...
		if (!bLocal_1382)
		{
			if (!is_entity_dead(iParam1->f_1, false))
			{
				Local_1451 = { get_entity_coords(iParam1->f_1, true) };
			}
			if (!is_ped_injured(player_ped_id()))
			{
				Local_1452 = { get_entity_coords(player_ped_id(), true) };
			}
...
void func_227()
{
	remove_blip(&(Local_1902[0 /*30*/].f_9));
	remove_blip(&(Local_1902[1 /*30*/].f_9));
	remove_blip(&(Local_1902[2 /*30*/].f_9));
	remove_blip(&(Local_1902[3 /*30*/].f_9));
}
	...
	if (does_entity_exist(iParam0))
	{
		if (!is_ped_injured(iParam0))
		{
			if (is_ped_in_any_vehicle(iParam0, false))
			{
				...
				if (fVar1 > fParam1)
				{
					if (!is_entity_on_screen(iVar0) || is_entity_occluded(iVar0))
					{
						return 1;
					}
					else if (fParam2 != 0f)
			...
			{
				if (!is_entity_on_screen(iParam0) || is_entity_occluded(iParam0))
				{
					return 1;
				}
			}
...
void func_229(var uParam0, int* iParam1)
{
	if (!iLocal_1381 == 1)
	{
		if (iLocal_1349 < 4)
		{
			if (((((func_238(*iParam1, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_236(&uLocal_1418)) || iLocal_1428 >= 2) || get_player_wanted_level(player_id()) > 0) || !is_vehicle_driveable(iParam1->f_1, false)) || func_235(*iParam1, iParam1->f_8, 1097859072))
			{
				if (get_player_wanted_level(player_id()) > 0)
				{
				}
				...
				if (is_vehicle_driveable(iParam1->f_1, false))
				{
					if (does_entity_exist(*iParam1))
					{
						if (!is_ped_injured(*iParam1))
						{
							if (func_366(*iParam1, 1) < 30f || has_entity_been_damaged_by_entity(*iParam1, player_ped_id(), true))
							{
								func_227();
								if (does_blip_exist(iParam1->f_2))
								{
								...
								iLocal_1385 = 1;
								if ((func_233(iParam1) && !is_entity_on_screen(iParam1->f_1)) && !is_entity_on_screen(*iParam1))
								{
									set_ped_into_vehicle(*iParam1, iParam1->f_8, -1);
...
{
	set_player_wanted_level_no_drop(player_id(), iParam0, false);
	set_player_wanted_level_now(player_id(), false);
	set_wanted_level_difficulty(player_id(), fParam1);
...
void func_231(var uParam0, var uParam1)
{
	if (is_vehicle_driveable(*uParam1, false))
	{
		...
		{
			if (is_ped_in_vehicle(*uParam0, *uParam1, false))
			{
				if (!is_waypoint_playback_going_on_for_vehicle(*uParam1))
				{
...
{
	task_vehicle_follow_waypoint_recording(iParam0, iParam1, "OJASbs_102", 52, 0, 20, -1, -1f, false, 2f);
	Local_1444 = { -455.2892f, -326.1364f, 41.22218f };
	waypoint_recording_get_num_points("OJASbs_102", &iLocal_1434);
	set_entity_load_collision_flag(iParam0, true, 1);
	fLocal_1439 = get_vehicle_estimated_max_speed(iParam1);
	modify_vehicle_top_speed(iParam1, (fLocal_1438 * 100f));
	set_ped_combat_attributes(iParam0, 3, true);
	set_vehicle_forward_speed(iParam1, 1.5f);
}

int func_233(var uParam0)
{
	if (!is_entity_dead(uParam0->f_1, false) && !is_entity_dead(uParam0->f_8, false))
	{
		if (is_vehicle_driveable(uParam0->f_1, false))
		{
			if (is_vehicle_driveable(uParam0->f_8, false))
			{
				if (func_234(uParam0->f_8, Local_1902[iLocal_1417 /*30*/].f_5, 1) > 5f || is_entity_touching_entity(uParam0->f_1, uParam0->f_8))
				{
					return 0;
				}
			}
...
int func_235(int iParam0, int iParam1, float fParam2)
{
	if (does_entity_exist(iParam1))
	{
		if (is_vehicle_driveable(iParam1, false))
		{
			...
			else if (is_entity_touching_entity(player_ped_id(), iParam1))
			{
				return 1;
			}
		}
...
int func_237()
{
	if (bLocal_1382)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				if (is_ped_shooting(player_ped_id()) && !is_ped_current_weapon_silenced(player_ped_id()))
				{
					return 1;
				}
			}
...
int func_239(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_116)
		{
			iLocal_117 = get_entity_health(iParam0);
			bLocal_116 = true;
		}
		iLocal_118 = get_entity_health(iParam0);
	...
	if (func_240(player_ped_id(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_366(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_242(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_243(iVar1))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
		...
		if (is_vehicle_driveable(iParam0, false))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1, false) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, true))
				{
					...
					{
						if (func_244(player_ped_id(), iParam0, 1) < 40f)
						{
...
void func_246(int* iParam0)
{
	if (!is_ped_injured(*iParam0))
	{
		if (!is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if ((get_script_task_status(*iParam0, 1805844857) != 1 && get_script_task_status(*iParam0, -1824940423) != 1) && get_script_task_status(*iParam0, 242628503) != 1)
			{
				task_smart_flee_ped(*iParam0, player_ped_id(), 500f, -1, false, false);
			}
			set_ped_max_move_blend_ratio(*iParam0, 2f);
		}
		else if (((get_script_task_status(*iParam0, 1805844857) != 1 && get_script_task_status(*iParam0, 1805844857) != 0) && get_script_task_status(*iParam0, 242628503) != 1) && get_script_task_status(*iParam0, 242628503) != 0)
		{
			task_smart_flee_ped(*iParam0, player_ped_id(), 500f, -1, false, false);
		}
	}
	...
	if (!does_blip_exist(uParam0->f_2))
	{
		if (!is_ped_injured(*uParam0))
		{
			if (iParam1 || !func_224())
			{
				...
				uParam0->f_2 = add_blip_for_entity(*uParam0);
...
void func_252(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_275(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
...
int func_257(char* sParam0)
{
	if (!func_258(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_277(sParam0)) || func_277("CMN_HINT"))
		{
			clear_help(true);
		}
		return 0;
...
int func_258(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_265() || func_264(Global_4718592.f_168757)) || func_263())
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			iVar1 = func_262(player_ped_id(), 0);
			if (((is_turret_seat(iVar0, iVar1) || (get_entity_model(iVar0) == joaat("apc") && iVar1 != -1)) || (get_entity_model(iVar0) == joaat("akula") && iVar1 != -1)) || (((get_entity_model(iVar0) == joaat("riot2") && iVar1 == 0) && func_261(iVar0, 10)) && get_vehicle_mod(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_259(int iParam0)
{
	if (iParam0 != func_195())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_260(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_270(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_273(bParam1, bParam2, bParam3) || is_ped_in_any_vehicle(player_ped_id(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((get_game_timer() - uParam0->f_4) > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), true) || func_271(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_278(int iParam0, int iParam1, var uParam2)
{
	if (is_vehicle_driveable(iParam1, false))
	{
		if (!is_entity_dead(iParam0, false))
		{
			if (is_ped_in_any_vehicle(iParam0, false))
			{
				if (!is_waypoint_playback_going_on_for_vehicle(iParam1))
				{
					if (get_script_task_status(iParam0, 451360105) != 1 && get_script_task_status(iParam0, 451360105) != 0)
					{
						task_leave_vehicle(iParam0, iParam1, 0);
					}
				}
				else
				{
			...
			else if (get_script_task_status(iParam0, 713668775) != 1 && get_script_task_status(iParam0, -1794415470) != 1)
			{
				func_279(iParam0);
			}
		}
	...
	if (!is_entity_dead(iParam0, false))
	{
		if (get_script_task_status(iParam0, 242628503) != 1 && get_script_task_status(iParam0, 242628503) != 0)
		{
			if (func_234(iParam0, Local_1444, 1) <= 50f)
			{
				...
				task_go_to_coord_any_means(0, Local_1444, 2f, 0, false, 786603, -1f);
...
void func_281(int iParam0, int iParam1)
{
	...
	if (func_168(&iLocal_1490) > 1f)
	{
		...
		if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam1, false))
		{
			if (is_waypoint_playback_going_on_for_vehicle(iParam1))
			{
				if (fVar0 > 150f)
				...
				iVar1 = get_vehicle_waypoint_progress(iParam1);
				...
				if (fLocal_1440 != 0f)
				{
					set_drive_task_cruise_speed(iParam0, fLocal_1440);
				}
			}
		}
	}
...
void func_282()
{
	if (!iLocal_1400)
	{
		if (!is_ped_injured(iLocal_1502))
		{
			clear_ped_tasks(iLocal_1502);
			task_play_anim(iLocal_1502, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0f, false, false, false);
			play_pain(iLocal_1502, 6, 0, 0);
			iLocal_1400 = 1;
		}
	}
	else if (does_entity_exist(iLocal_1502))
	{
		if (func_238(iLocal_1502, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1))
		{
			if (get_script_task_status(iLocal_1502, 1805844857) != 1)
			{
				clear_ped_tasks(iLocal_1502);
				task_smart_flee_ped(iLocal_1502, player_ped_id(), 1000f, -1, false, false);
			}
		}
		if (func_366(iLocal_1502, 1) > 100f)
		{
			if (!is_entity_on_screen(iLocal_1502) || is_entity_occluded(iLocal_1502))
			{
				delete_ped(&iLocal_1502);
			}
		}
	}
}
	...
	switch (iLocal_1416)
	{
		case 0:
			if (func_303(1, 3f))
			{
				...
				if (!is_entity_dead(uParam1->f_1, false))
				{
					set_vehicle_use_player_light_settings(uParam1->f_1, true);
				}
				func_301(uParam1->f_1);
				if (!is_entity_dead(player_ped_id(), false))
				{
					register_entity_for_cutscene(player_ped_id(), "Franklin", 0, 0, 0);
				}
				if (!is_entity_dead(*uParam0, false))
				{
					register_entity_for_cutscene(*uParam0, "Mugger", 0, get_entity_model(*uParam0), 0);
				}
				if (!is_entity_dead(iLocal_1502, false))
				{
					register_entity_for_cutscene(iLocal_1502, "Mugging_Victim", 0, joaat("a_f_o_genstreet_01"), 0);
				}
				if (!is_entity_dead(uParam1->f_1, false))
				{
					if (bLocal_1403)
					{
						register_entity_for_cutscene(uParam1->f_1, "Franklins_Coach", 0, joaat("coach"), 0);
						register_entity_for_cutscene(0, "Franklins_Bus", 3, joaat("bus"), 0);
					}
					else
					{
						register_entity_for_cutscene(uParam1->f_1, "Franklins_Bus", 0, joaat("bus"), 0);
						register_entity_for_cutscene(0, "Franklins_Coach", 3, joaat("coach"), 0);
					}
				}
				if (!is_entity_dead(uParam1->f_8, false))
				{
					register_entity_for_cutscene(uParam1->f_8, "Stolen_Bike", 0, joaat("scorcher"), 0);
				}
				start_cutscene(0);
		...
		case 1:
			if (is_cutscene_playing())
			{
				...
				if (does_cam_exist(iLocal_1468) && is_cam_active(iLocal_1468))
				{
					set_cam_active(iLocal_1468, false);
					destroy_cam(iLocal_1468, false);
					render_script_cams(false, false, 3000, true, false, 0);
				}
				else if (does_cam_exist(iLocal_1468))
				{
					destroy_cam(iLocal_1468, false);
				}
				if ((does_entity_exist(*uParam0) && !is_ped_injured(*uParam0)) && is_vehicle_driveable(uParam1->f_8, false))
				{
					if (can_set_exit_state_for_registered_entity("Mugger", 0) && can_set_exit_state_for_registered_entity("Stolen_Bike", 0))
					{
						task_enter_vehicle(*uParam0, uParam1->f_8, 20000, -1, 2f, 1, 0);
						set_ped_combat_attributes(*uParam0, 3, false);
						set_ped_can_be_knocked_off_vehicle(*uParam0, 3);
						func_232(*uParam0, uParam1->f_8);
						iLocal_1386 = 1;
					}
				}
				if (can_set_exit_state_for_registered_entity("Mugging_Victim", 0))
				{
					if (does_entity_exist(iLocal_1502) && !is_ped_injured(iLocal_1502))
					{
						func_282();
					}
				}
				if (can_set_exit_state_for_registered_entity("Franklin", 0))
				{
					if (((does_entity_exist(player_ped_id()) && !is_ped_injured(player_ped_id())) && does_entity_exist(uParam1->f_1)) && !is_entity_dead(uParam1->f_1, false))
					{
						set_ped_into_vehicle(player_ped_id(), uParam1->f_1, -1);
			...
			if (has_cutscene_finished())
			{
				...
				if (!is_ped_injured(*uParam0))
				{
					if (does_entity_exist(uParam1->f_8) && is_vehicle_driveable(uParam1->f_8, false))
					{
						set_ped_into_vehicle(*uParam0, uParam1->f_8, -1);
						set_ped_combat_attributes(*uParam0, 3, false);
						set_ped_can_be_knocked_off_vehicle(*uParam0, 3);
					}
					else
					{
						...
						else if (!is_vehicle_driveable(uParam1->f_8, false))
						{
						}
						task_smart_flee_ped(*uParam0, player_ped_id(), 500f, -1, false, false);
					}
				}
				func_231(uParam1, &(uParam1->f_8));
				render_script_cams(false, false, 3000, true, false, 0);
				func_287(1, 1, 1);
				freeze_entity_position(uParam1->f_1, false);
		...
		case 2:
			...
			if (!is_entity_dead(uParam1->f_1, false))
			{
				set_vehicle_use_player_light_settings(uParam1->f_1, false);
			}
			iLocal_1349 = 5;
			break;
	}
...
void func_285(int iParam0, bool bParam1)
{
	if (is_vehicle_driveable(iParam0, false))
	{
		set_vehicle_door_shut(iParam0, 1, bParam1);
		set_vehicle_door_shut(iParam0, 0, bParam1);
	}
}
...
void func_286(int iParam0, int iParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!is_ped_injured(Local_1902[iParam1 /*30*/].f_14[iVar0]))
			{
				if (iVar0 == 0)
				{
				...
				clear_ped_tasks(Local_1902[iParam1 /*30*/].f_14[iVar0]);
				open_sequence_task(&iVar1);
				task_turn_ped_to_face_entity(0, iParam0, 0);
				task_play_anim(0, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0f, false, false, false);
				task_wander_standard(0, 40000f, 0);
				close_sequence_task(iVar1);
				task_perform_sequence(Local_1902[iParam1 /*30*/].f_14[iVar0], iVar1);
...
void func_289(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_293(player_id())) && !func_291(player_id(), 0)) && !func_290()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_293(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_297(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_1503 != 0 && iLocal_1503 != joaat("object")) && iLocal_1503 != joaat("gadget_parachute"))
		{
			...
			{
				set_current_ped_weapon(player_ped_id(), iLocal_1503, false);
			}
		}
	}
}
...
void func_298(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	{
		func_300();
		remove_player_helmet(get_player_index(), false);
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_299(get_player_index()), 50f, 0);
		}
		...
		if (iParam4 == 1)
		{
			...
			if (func_352(player_ped_id()))
			{
				iLocal_1503 = get_selected_ped_weapon(player_ped_id());
...
void func_301(int iParam0)
{
	if (is_vehicle_driveable(iParam0, false))
	{
		if (!bLocal_1403)
		{
			set_vehicle_door_open(iParam0, 1, false, false);
		}
		set_vehicle_door_open(iParam0, 0, false, false);
	}
}

void func_302()
{
	if (streamvol_is_valid(iLocal_1501))
	{
		streamvol_delete(iLocal_1501);
		iLocal_1410 = 0;
	}
}
...
int func_303(int iParam0, float fParam1)
{
	...
	iVar0 = 1;
	request_cutscene("ASS_MCS_1", 8);
	_0xEF39EE20C537E98C(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		if (!func_306(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
		{
			iVar0 = 0;
		}
		if (!is_vehicle_on_all_wheels(get_vehicle_ped_is_in(player_ped_id(), false)))
		{
			iVar0 = 0;
		}
	}
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, false))
		{
			...
			if (func_270(&uLocal_1903, 1, 0, 0))
			{
				...
				else if (!is_audio_scene_active("ASSASSINATION_BUS_SCREAMS_INT_SCENE"))
				{
					start_audio_scene("ASSASSINATION_BUS_SCREAMS_INT_SCENE");
				}
				if (!does_cam_exist(iLocal_140))
				{
					iLocal_140 = create_camera(26379945, false);
					_set_cam_controls_radar_rotation(iLocal_140, true);
					...
					if (bLocal_1402)
					{
						attach_cam_to_entity(iLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, true);
						point_cam_at_entity(iLocal_140, uParam0->f_1, -0.0074f, -3.4691f, 1.1139f, true);
					}
					else if (bLocal_1403)
					{
						attach_cam_to_entity(iLocal_140, uParam0->f_1, -0.0387f, -5.3568f, 0.8942f, true);
						point_cam_at_entity(iLocal_140, uParam0->f_1, 0.0245f, -2.4095f, 0.3379f, true);
					}
					else
					{
						attach_cam_to_entity(iLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, true);
					...
					set_cam_fov(iLocal_140, 35f);
				}
				if (!is_cam_active(iLocal_140))
				{
					set_cam_active(iLocal_140, true);
					render_script_cams(true, false, 3000, true, false, 0);
					display_hud(false);
				}
			}
			else if (does_cam_exist(iLocal_140))
			{
				if (is_cam_active(iLocal_140))
				{
					set_cam_active(iLocal_140, false);
...
void func_310(var uParam0, var uParam1)
{
	...
	if (iVar0 == 3)
	{
		if (!is_entity_dead(uParam0->f_1, false) && !is_entity_dead(player_ped_id(), false))
		{
			if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, true))
			{
				if (is_entity_in_angled_area(uParam0->f_1, 112.8744f, -780.2048f, 29.41912f, 118.2785f, -782.2339f, 34.38423f, 2.5f, false, true, 0))
				{
	...
	if (!is_sphere_visible(Local_1902[iVar0 /*30*/].f_1, 15f))
	{
		clear_area_of_vehicles(Local_1902[iVar0 /*30*/].f_1, 15f, false, false, false, false, false, false, 0);
	}
	if (iLocal_1395)
	{
		fVar1 = ((get_entity_speed(player_ped_id()) / 5f) + 6f);
	...
	if (bLocal_1391)
	{
		if (!is_entity_dead(uParam0->f_1, false))
		{
	...
	if (iLocal_1395)
	{
		if (is_vehicle_driveable(uParam0->f_1, false) && is_ped_in_vehicle(player_ped_id(), uParam0->f_1, false))
		{
			if (is_entity_at_coord(player_ped_id(), Local_1902[iVar0 /*30*/].f_21, 5f, 5f, 2f, true, true, 0))
			{
			}
		}
	}
	if (!is_entity_dead(uParam0->f_1, false))
	{
		if (is_ped_sitting_in_vehicle(player_ped_id(), uParam0->f_1))
		{
			if (Local_1902[iVar0 /*30*/])
			{
				Var3 = { get_ped_bone_coords(player_ped_id(), 31086, 0f, 0f, 0f) };
				if ((((get_distance_between_coords(Var3, Local_1902[iVar0 /*30*/].f_21, true) <= fVar1 && is_player_ready_for_cutscene(player_id())) && streamvol_has_loaded(iLocal_1501)) && !func_337(iVar0)) && !bLocal_1391)
				{
					iLocal_1395 = 0;
				}
				if (iLocal_1433 > 0)
...
void func_311(var uParam0, var uParam1, int iParam2)
{
	...
	switch (iLocal_1415)
	{
		case 0:
			if (Local_1902[iParam2 /*30*/])
			{
				...
				func_334(0, 0, 1);
				func_332(iParam2);
				Var0 = { get_vehicle_deformation_at_pos(uParam0->f_1, 1.21f, 6.15f, 0.3f) };
				if (get_distance_between_coords(Var0, 0f, 0f, 0f, true) > 0.23f)
				{
					bLocal_1392 = true;
					set_vehicle_door_broken(uParam0->f_1, 1, true);
					set_vehicle_door_broken(uParam0->f_1, 0, true);
				}
				if (iLocal_1433 == 0)
				{
					func_386(1, "assassin_bus_stage_drive_to_stops", 0, 0, 0, 1);
				...
				iLocal_1468 = create_camera_with_params(26379945, Local_1447, Local_1448, 65f, false, 2);
				set_cam_fov(iLocal_1468, 38f);
				set_cam_active(iLocal_1468, true);
				if (!bLocal_1388)
				{
					attach_cam_to_entity(iLocal_1468, uParam0->f_1, -4.4984f, 8.6802f, -0.3745f, true);
					point_cam_at_entity(iLocal_1468, uParam0->f_1, -2.0642f, 7.0391f, 0.243f, true);
				}
				clear_area_of_objects(Local_1902[iParam2 /*30*/].f_1, 30f, 0);
				clear_area_of_peds(Local_1902[iParam2 /*30*/].f_1, 30f, 0);
				remove_particle_fx_in_range(Local_1902[iParam2 /*30*/].f_1, 7f);
				render_script_cams(true, false, 3000, true, false, 0);
				if (iParam2 == 0)
				{
					func_331(uParam0);
				...
				else
				{
					...
					set_entity_coords(uParam0->f_1, Local_1446, true, false, false, true);
					set_entity_heading(uParam0->f_1, fLocal_1453);
					set_vehicle_fixed(uParam0->f_1);
					set_vehicle_on_ground_properly(uParam0->f_1, 5f);
					set_vehicle_forward_speed(uParam0->f_1, 2f);
					Var2 = { get_entity_coords(uParam0->f_1, true) };
					fVar4 = get_entity_heading(uParam0->f_1);
					Var3 = { _get_object_offset_from_coords(Var2, fVar4, 2f, 5.6201f, 0.1098f) };
					task_look_at_coord(player_ped_id(), Var3, 5000, 0, 2);
				}
			...
			if (func_171(&iLocal_1472))
			{
				if (func_168(&iLocal_1472) > fLocal_1441)
				{
					...
					if (iParam2 == 0)
					{
						...
						{
							task_enter_vehicle(iVar1, uParam0->f_1, 20000, 0, 2f, 258, 0);
							if (does_entity_exist(iVar1))
							{
								force_ped_ai_and_animation_update(iVar1, true, false);
							}
						}
					}
					else if (iParam2 == 1)
		...
		case 2:
			...
			if ((func_168(&iLocal_1472) > 1.5f && !bLocal_1392) || (bLocal_1392 && !func_224()))
			{
				...
				func_186(&iLocal_1472);
				remove_blip(&(Local_1902[iParam2 /*30*/].f_9));
	...
	if (iLocal_1415 == 1)
	{
		if (func_313(iLocal_142))
		{
			...
			if (!is_entity_dead(uParam0->f_1, false))
			{
				set_entity_heading(uParam0->f_1, Local_1902[iParam2 /*30*/].f_20);
			}
			remove_blip(&(Local_1902[iParam2 /*30*/].f_9));
			if (iParam2 == iLocal_1417)
			{
				...
				if (!is_ped_injured(*uParam0))
				{
					if (is_vehicle_driveable(uParam0->f_8, false))
					{
						...
						set_entity_coords(uParam0->f_8, Local_1902[iLocal_1417 /*30*/].f_5, true, false, false, true);
						set_entity_heading(uParam0->f_8, Local_1902[iLocal_1417 /*30*/].f_8);
						set_vehicle_on_ground_properly(uParam0->f_8, 5f);
						set_ped_can_be_knocked_off_vehicle(*uParam0, 3);
						if (!is_ped_in_vehicle(*uParam0, uParam0->f_8, false))
						{
							set_ped_into_vehicle(*uParam0, uParam0->f_8, -1);
						}
					}
				}
				clear_area(Local_1902[iLocal_1417 /*30*/].f_5, 30f, false, false, false, false);
				clear_area_of_objects(Local_1902[iLocal_1417 /*30*/].f_5, 30f, 0);
...
void func_312(var uParam0)
{
	...
	func_287(1, 1, 1);
	do_screen_fade_in(500);
	freeze_entity_position(uParam0->f_1, false);
	iLocal_1414 = 0;
	clear_focus();
}
...
{
	if (func_314() && get_game_timer() >= iParam0 + 1000)
	{
...
void func_316(var uParam0)
{
	if (!is_ped_injured(*uParam0))
	{
		...
		set_ped_component_variation(*uParam0, 2, 2, 2, 0);
...
void func_317(var uParam0, var uParam1, int iParam2)
{
	...
	if (does_entity_exist(Local_1902[iParam2 /*30*/].f_14[2]))
	{
		delete_ped(&(Local_1902[iParam2 /*30*/].f_14[2]));
	}
	if (!does_entity_exist(*uParam1))
	{
		...
		set_entity_health(*uParam1, 175, 0);
	}
	uParam1->f_8 = Local_1902[iParam2 /*30*/].f_19;
	if (!is_entity_playing_anim(*uParam1, "oddjobs@assassinate@bus@", "base", 3))
	{
		task_play_anim(*uParam1, "oddjobs@assassinate@bus@", "base", 8f, -16f, -1, 1, 0f, false, false, false);
	}
}
...
void func_318(var uParam0, var uParam1)
{
	if (!does_entity_exist(*uParam1))
	{
		*uParam1 = create_ped(4, *uParam0, uParam0->f_1, uParam0->f_4, true, true);
		set_ped_model_is_suppressed(*uParam0, true);
		set_ped_can_use_auto_conversation_lookat(*uParam1, true);
		set_ped_can_be_targetted(*uParam1, true);
		set_ped_can_be_shot_in_vehicle(*uParam1, true);
		set_ped_config_flag(*uParam1, 29, true);
		set_entity_is_target_priority(*uParam1, true, 0f);
		if (!iLocal_973)
		{
			add_relationship_group("Target", &iLocal_983);
			iLocal_973 = 1;
		}
		set_relationship_between_groups(5, iLocal_983, joaat("player"));
		set_relationship_between_groups(5, joaat("player"), iLocal_983);
		set_ped_relationship_group_hash(*uParam1, iLocal_983);
		if (uParam0->f_268)
		{
		...
		if (uParam0->f_269)
		{
			set_ped_combat_attributes(*uParam1, 3, false);
			set_ped_get_out_upside_down_vehicle(*uParam1, true);
		}
		if (uParam0->f_13 != 0)
		{
			give_weapon_to_ped(*uParam1, uParam0->f_13, -1, false, true);
		}
		if (uParam0->f_274 == 0)
		{
			set_ped_component_variation(*uParam1, 0, 0, 1, 0);
			set_ped_component_variation(*uParam1, 2, 2, 2, 0);
			set_ped_component_variation(*uParam1, 3, 0, 1, 0);
			set_ped_component_variation(*uParam1, 4, 0, 1, 0);
			set_ped_component_variation(*uParam1, 8, 1, 2, 0);
			func_204(&(uParam1->f_16), 3, *uParam1, "INVESTOR", 0, 1);
		}
		else if (uParam0->f_274 == 1)
		{
			func_204(&(uParam1->f_16), 3, *uParam1, "OJAhkJUNKIE", 0, 1);
			set_ped_component_variation(*uParam1, 0, 0, 0, 0);
			set_ped_component_variation(*uParam1, 2, 1, 0, 0);
			set_ped_component_variation(*uParam1, 3, 1, 2, 0);
			set_ped_component_variation(*uParam1, 4, 0, 0, 0);
			set_ped_config_flag(*uParam1, 134, true);
			set_ped_plays_head_on_horn_anim_when_dies_in_vehicle(*uParam1, true);
			set_ped_money(*uParam1, get_random_int_in_range(80, 100));
			give_weapon_to_ped(*uParam1, joaat("weapon_combatpistol"), -1, false, true);
			set_ped_accuracy(*uParam1, 50);
		}
	}
}
...
void func_319(var uParam0, int iParam1)
{
	...
	clear_area(Local_1902[iParam1 /*30*/].f_1, 10f, false, false, false, false);
	set_all_vehicle_generators_active_in_area((Local_1902[iParam1 /*30*/].f_1 - 30f), (Local_1902[iParam1 /*30*/].f_1.f_1 - 30f), (Local_1902[iParam1 /*30*/].f_1.f_2 - 30f), (Local_1902[iParam1 /*30*/].f_1 + 30f), (Local_1902[iParam1 /*30*/].f_1.f_1 + 30f), (Local_1902[iParam1 /*30*/].f_1.f_2 + 30f), false, true);
	if (!does_entity_exist(Local_1902[iParam1 /*30*/].f_14[0]))
	{
		Local_1902[iParam1 /*30*/].f_14[0] = create_ped(4, uParam0->f_16, Var0[0 /*3*/], Local_1902[iParam1 /*30*/].f_4, true, true);
		if (iParam1 == 0)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 3, 2, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 4, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 8, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 2, 1, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 4, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 8, 1, 0, 0);
		}
		else if (iParam1 == 3)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 2, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 3, 1, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		task_look_at_entity(Local_1902[iParam1 /*30*/].f_14[0], player_ped_id(), -1, 2048, 4);
		task_play_anim(Local_1902[iParam1 /*30*/].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
		set_blocking_of_non_temporary_events(Local_1902[iParam1 /*30*/].f_14[0], true);
		add_entity_to_audio_mix_group(Local_1902[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0f);
	}
	if (!does_entity_exist(Local_1902[iParam1 /*30*/].f_14[1]))
	{
		Local_1902[iParam1 /*30*/].f_14[1] = create_ped(4, joaat("a_m_m_eastsa_01"), Var0[1 /*3*/], Local_1902[iParam1 /*30*/].f_4, true, true);
		if (iParam1 == 0)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 0, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 3, 1, 3, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		else if (iParam1 == 1)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 0, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 4, 0, 2, 0);
		}
		else if (iParam1 == 3)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 3, 2, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		task_look_at_entity(Local_1902[iParam1 /*30*/].f_14[1], player_ped_id(), -1, 2048, 4);
		task_play_anim(Local_1902[iParam1 /*30*/].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
		set_blocking_of_non_temporary_events(Local_1902[iParam1 /*30*/].f_14[1], true);
		add_entity_to_audio_mix_group(Local_1902[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0f);
	}
	if (!does_entity_exist(Local_1902[iParam1 /*30*/].f_14[2]))
	{
		Local_1902[iParam1 /*30*/].f_14[2] = create_ped(4, uParam0->f_14, Var0[2 /*3*/], Local_1902[iParam1 /*30*/].f_4, true, true);
		if (iParam1 == 0)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 0, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 3, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 4, 0, 2, 0);
		}
		else if (iParam1 == 1)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 3, 1, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 2)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 2, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 3, 1, 2, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 3)
		{
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 0, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 3, 0, 1, 0);
			set_ped_component_variation(Local_1902[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		task_look_at_entity(Local_1902[iParam1 /*30*/].f_14[2], player_ped_id(), -1, 2048, 4);
		task_play_anim(Local_1902[iParam1 /*30*/].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
		set_blocking_of_non_temporary_events(Local_1902[iParam1 /*30*/].f_14[2], true);
		add_entity_to_audio_mix_group(Local_1902[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0f);
	}
	if (iParam1 == 3)
	{
		if (!does_entity_exist(Local_1902[iParam1 /*30*/].f_19))
		{
			Local_1902[iParam1 /*30*/].f_19 = create_vehicle(uParam0->f_15, Local_1902[iParam1 /*30*/].f_5, Local_1902[iParam1 /*30*/].f_8, true, true, false);
			set_vehicle_on_ground_properly(Local_1902[iParam1 /*30*/].f_19, 5f);
		}
	}
}
...
void func_321(var uParam0)
{
	...
	while (iVar1 < 9)
	{
		if (iLocal_1427 < 4)
		{
			if (is_vehicle_driveable(uParam0->f_1, false))
			{
				if (get_ped_in_vehicle_seat(uParam0->f_1, iVar1, false) != 0)
				{
					iVar0 = get_ped_in_vehicle_seat(uParam0->f_1, iVar1, false);
					if (iLocal_1427 == 0)
					{
	...
	while (iVar0 <= 2)
	{
		if (is_vehicle_driveable(uParam0->f_1, false))
		{
			if (!is_ped_injured(Local_1902[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				if (is_vehicle_seat_free(uParam0->f_1, iVar1, false))
				{
					set_ped_into_vehicle(Local_1902[iParam1 /*30*/].f_14[iVar0], uParam0->f_1, iVar1);
				}
			}
		}
		iVar0++;
...
void func_323()
{
	iLocal_1502 = create_ped(5, joaat("a_f_o_genstreet_01"), 110.6556f, -776.3679f, 30.439f, 346.1708f, true, true);
	set_ped_component_variation(iLocal_1502, 0, 0, 0, 0);
	set_ped_component_variation(iLocal_1502, 2, 1, 2, 0);
	set_ped_component_variation(iLocal_1502, 3, 0, 2, 0);
	set_ped_component_variation(iLocal_1502, 4, 0, 0, 0);
	set_ped_component_variation(iLocal_1502, 8, 1, 2, 0);
	set_blocking_of_non_temporary_events(iLocal_1502, true);
}
...
var func_325(struct<3> Param0, int iParam1)
{
	...
	while (iVar3 <= 2)
	{
		if (!is_entity_dead(Local_1902[iParam1 /*30*/].f_14[iVar3], false))
		{
...
{
	if (!does_cam_exist(iLocal_1468))
	{
		iLocal_1468 = create_camera_with_params(26379945, get_final_rendered_cam_coord(), get_final_rendered_cam_rot(2), 35f, false, 2);
	}
	if (!does_cam_exist(iLocal_1469))
	{
		iLocal_1469 = create_camera_with_params(26379945, get_final_rendered_cam_coord(), get_final_rendered_cam_rot(2), 34f, false, 2);
	}
	if (is_vehicle_driveable(uParam0->f_1, false) && !is_entity_dead(uParam0->f_1, false))
	{
		if (bLocal_1402)
		{
			attach_cam_to_entity(iLocal_1468, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, true);
			point_cam_at_entity(iLocal_1468, uParam0->f_1, 1.2599f, 5.969f, 0.7051f, true);
		}
		else if (bLocal_1403)
		{
			attach_cam_to_entity(iLocal_1468, uParam0->f_1, -1.6144f, 4.8097f, 0.4117f, true);
			point_cam_at_entity(iLocal_1468, uParam0->f_1, 1.328f, 4.756f, -0.1711f, true);
		}
		else
		{
			attach_cam_to_entity(iLocal_1468, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, true);
		...
		set_cam_near_clip(iLocal_1468, 0.55f);
		set_cam_active(iLocal_1468, true);
	}
	cascade_shadows_enable_entity_tracker(false);
	cascade_shadows_set_cascade_bounds_scale(0.3f);
	render_script_cams(true, false, 3000, true, false, 0);
}
...
void func_327(var uParam0, int iParam1)
{
	...
	if (bLocal_1402)
	{
		Var0 = { _get_object_offset_from_coords(Var2, fVar3, 2.519f, 5.6f, 0.1098f) };
		get_ground_z_for_3d_coord(Var0, &fVar4, false, false);
	}
	else if (bLocal_1403)
	{
		Var0 = { _get_object_offset_from_coords(Var2, fVar3, 2.519f, 5.6f, 0.1098f) };
	...
	if (!is_ped_injured(iVar1))
	{
		clear_ped_tasks_immediately(iVar1);
		set_entity_coords(iVar1, Var0.f_0, Var0.f_1, fVar4, true, false, false, true);
		set_entity_heading(iVar1, fVar5);
	}
}
...
void func_328(var uParam0, int iParam1)
{
	...
	{
		force_ped_ai_and_animation_update(iVar0, false, false);
		if (iParam1 == 0)
		{
			set_ped_movement_clipset(iVar0, "move_m@casual@d", 0.25f);
			task_follow_nav_mesh_to_coord(iVar0, 305.2689f, -768.1415f, 28.17335f, 1f, 20000, 0.25f, false, 40000f);
			force_ped_motion_state(iVar0, joaat("MotionState_Walk"), false, 0, false);
		}
		else if (iParam1 == 1)
		{
			set_ped_movement_clipset(iVar0, "move_m@casual@d", 0.25f);
			task_go_straight_to_coord(iVar0, 358.6953f, -1065.935f, 28.39328f, 1f, 20000, 40000f, 0.5f);
		}
		else if (iParam1 == 3)
		{
			task_go_straight_to_coord(iVar0, 111.6832f, -781.5098f, 30.26971f, 1f, 20000, 40000f, 0.5f);
		}
		else
		{
			task_enter_vehicle(iVar0, uParam0->f_1, 20000, 0, 1f, 256, 0);
		}
	}
}
...
void func_329(var uParam0, int iParam1)
{
	switch (iLocal_1435)
	{
		case 0:
			...
			{
				case 0:
					task_vehicle_follow_waypoint_recording(player_ped_id(), uParam0->f_1, "OJASbs01", 786603, 0, 16, -1, 3f, false, 2f);
					func_215(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNG", 9, 0, 0, 0);
					break;
				
				case 1:
					task_vehicle_follow_waypoint_recording(player_ped_id(), uParam0->f_1, "OJASbs02", 786603, 0, 16, -1, 3f, false, 2f);
					func_215(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGa", 9, 0, 0, 0);
					break;
				
				case 2:
					task_vehicle_follow_waypoint_recording(player_ped_id(), uParam0->f_1, "OJASbs03", 786603, 0, 16, -1, 3f, false, 2f);
					func_215(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGb", 9, 0, 0, 0);
					break;
				
				case 3:
					task_vehicle_follow_waypoint_recording(player_ped_id(), uParam0->f_1, "OJASbs04", 786603, 0, 16, -1, 3f, false, 2f);
		...
		case 1:
			if (func_171(&iLocal_1472))
			{
				if (func_168(&iLocal_1472) > 3f)
				{
					...
					detach_cam(iLocal_1468);
					stop_cam_pointing(iLocal_1468);
					set_cam_coord(iLocal_1468, Local_1447);
					set_cam_rot(iLocal_1468, Local_1448, 2);
...
void func_330(var uParam0, int iParam1, bool bParam2)
{
	...
	Var1 = { 0f, -3f, 0f };
	clear_ped_tasks(player_ped_id());
	if (is_waypoint_playback_going_on_for_vehicle(uParam0->f_1))
	{
	...
	if (iParam1 == 0)
	{
		...
		fLocal_1453 = 160.65f;
		Local_1449 = { _get_object_offset_from_coords(Local_1446, fLocal_1453, Var1) };
	}
	else if (iParam1 == 1)
	{
	...
	get_ground_z_for_3d_coord(Local_1446, &uVar0, false, false);
	set_ped_coords_keep_vehicle(player_ped_id(), Local_1449);
	set_entity_heading(uParam0->f_1, fLocal_1453);
	set_vehicle_on_ground_properly(uParam0->f_1, 5f);
	set_vehicle_forward_speed(uParam0->f_1, 5f);
	set_vehicle_fixed(uParam0->f_1);
	if (bLocal_1402)
	{
		Local_1445 = { _get_object_offset_from_coords(Local_1446, fLocal_1453, 2f, 5.6201f, 0.1098f) };
	}
	else if (bLocal_1403)
	{
		Local_1445 = { _get_object_offset_from_coords(Local_1446, fLocal_1453, 2f, 5.6201f, 0.1098f) };
	...
	if (bParam2)
	{
		task_look_at_coord(player_ped_id(), Local_1445, 5000, 0, 2);
	}
}
...
void func_331(var uParam0)
{
	...
	if (does_entity_exist(uParam0->f_1) && !is_entity_dead(uParam0->f_1, false))
	{
		iVar1 = 0;
		while (iVar1 < 8)
		{
			if (!is_vehicle_seat_free(uParam0->f_1, iVar1, false))
			{
				iVar0[iVar1] = get_ped_in_vehicle_seat(uParam0->f_1, iVar1, false);
				set_entity_as_mission_entity(iVar0[iVar1], true, false);
				if (does_entity_exist(iVar0[iVar1]))
				{
					delete_ped(&(iVar0[iVar1]));
				}
			}
			iVar1++;
		}
...
void func_332(int iParam0)
{
	...
	fVar0 = get_entity_heading(player_ped_id());
	fVar1 = (Local_1902[iParam0 /*30*/].f_4 + 180f);
	Var2 = { -sin(fVar0), cos(fVar0), 0f };
	Var3 = { Local_1902[iParam0 /*30*/].f_1 - Var4 };
	Var5 = { get_entity_speed_vector(player_ped_id(), false) };
	Var6 = { get_entity_forward_vector(player_ped_id()) };
	if (!bLocal_1390)
	{
...
void func_336()
{
	if (does_entity_exist(iLocal_1462[0]))
	{
		set_ped_as_no_longer_needed(&(iLocal_1462[0]));
	}
	if (does_entity_exist(iLocal_1462[1]))
	{
		set_ped_as_no_longer_needed(&(iLocal_1462[1]));
	}
	if (does_entity_exist(iLocal_1462[2]))
	{
		set_ped_as_no_longer_needed(&(iLocal_1462[2]));
	}
	if (does_entity_exist(iLocal_1462[3]))
	{
		set_ped_as_no_longer_needed(&(iLocal_1462[3]));
	}
}
...
int func_337(int iParam0)
{
	...
	fVar0 = get_entity_heading(player_ped_id());
	fVar1 = (Local_1902[iParam0 /*30*/].f_4 - 180f);
	if (cos(absf((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1390 = false;
		iVar2 = 0;
	}
...
void func_338(int iParam0)
{
	if (!iLocal_1410)
	{
		if (func_371(Local_1902[iParam0 /*30*/].f_1, 1) <= 100f)
		{
			...
			{
				iLocal_1501 = streamvol_create_frustum(Local_1902[iParam0 /*30*/].f_24, Local_1902[iParam0 /*30*/].f_27, 25f, 12, 127);
				if (iLocal_1433 == 3)
				{
					request_cutscene("ASS_MCS_1", 8);
					_0xEF39EE20C537E98C(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
...
void func_340()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!does_blip_exist(Local_1902[iVar0 /*30*/].f_9))
			{
				Var1 = { _get_object_offset_from_coords(Local_1902[iVar0 /*30*/].f_1, Local_1902[iVar0 /*30*/].f_4, 0f, 3f, 0f) };
				Local_1902[iVar0 /*30*/].f_9 = func_341(Var1, 1);
				set_blip_name_from_text_file(Local_1902[iVar0 /*30*/].f_9, &(Local_1902[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
int func_341(struct<3> Param0, bool bParam1)
{
	int iVar0;
...
void func_342()
{
	if (!is_ped_in_vehicle(player_ped_id(), iLocal_1463, false))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1463);
	}
	if (!is_ped_in_vehicle(player_ped_id(), iLocal_1464, false))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1464);
	}
}
...
int func_343(var uParam0)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, false))
		{
			set_entity_as_mission_entity(uParam0->f_1, true, false);
			return 1;
		}
		else
		{
			iVar0 = get_vehicle_ped_is_in(player_ped_id(), false);
			if (get_entity_model(iVar0) == joaat("bus"))
			{
				uParam0->f_1 = iVar0;
				set_entity_as_mission_entity(uParam0->f_1, true, false);
				bLocal_1402 = true;
			}
			else if (get_entity_model(iVar0) == joaat("coach"))
			{
				uParam0->f_1 = iVar0;
				set_entity_as_mission_entity(uParam0->f_1, true, false);
				bLocal_1403 = true;
...
int func_346(var uParam0)
{
	...
	request_model(joaat("a_f_o_genstreet_01"));
	if (has_model_loaded(*uParam0) && has_model_loaded(joaat("a_f_o_genstreet_01")))
	{
		iVar0 = 1;
	}
	else
...
int func_347(var uParam0)
{
	...
	request_model(uParam0->f_16);
	request_model(uParam0->f_14);
	request_model(joaat("a_m_m_eastsa_01"));
	if ((has_model_loaded(uParam0->f_16) && has_model_loaded(uParam0->f_14)) && has_model_loaded(joaat("a_m_m_eastsa_01")))
	{
		iVar0 = 1;
	}
	else
			...
			if (iLocal_1433 > 0)
			{
				if (!iLocal_1399)
				{
					...
					while (iVar0 < 9)
					{
						if (is_vehicle_driveable(uParam0->f_1, false))
						{
							if (get_ped_in_vehicle_seat(uParam0->f_1, iVar0, false) != 0)
							{
								iLocal_1461 = get_ped_in_vehicle_seat(uParam0->f_1, iVar0, false);
...
void func_350(int* iParam0, bool bParam1)
{
	...
	if (!iLocal_1396)
	{
		if (has_anim_dict_loaded("veh@bus@passenger@rds@idle_panic") && has_anim_dict_loaded("veh@bus@passenger@rps@idle_panic"))
		{
			iLocal_1396 = 1;
		}
	}
	if (!iLocal_1406)
	{
		if (!is_entity_dead(iParam0->f_1, false) && !is_entity_dead(player_ped_id(), false))
		{
			if (has_entity_collided_with_anything(iParam0->f_1) || is_ped_shooting(player_ped_id()))
			{
				iLocal_1406 = 1;
			}
		}
	...
	if (iLocal_1396 && iLocal_1406)
	{
		if (!iLocal_1394)
		{
			...
			while (iVar0 < 9)
			{
				if (is_vehicle_driveable(iParam0->f_1, false))
				{
					if (get_ped_in_vehicle_seat(iParam0->f_1, iVar0, false) != 0)
					{
						iVar1 = get_ped_in_vehicle_seat(iParam0->f_1, iVar0, false);
						if (!bParam1)
						{
							if ((get_random_int_in_range(0, 65535) % 3) < 1)
							{
								if (is_entity_playing_anim(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 3) || is_entity_playing_anim(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 3))
								{
						...
						if (bParam1)
						{
							if ((iVar0 % 2) == 0)
							{
								task_play_anim(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
							}
							else
							{
								task_play_anim(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
							}
						}
					}
				}
		...
		if (bParam1)
		{
			...
			if (!is_audio_scene_active("ASSASSINATION_BUS_SCREAMS_EXT_SCENE"))
			{
...
int func_353(var uParam0, var uParam1)
{
	if (is_screen_faded_in())
	{
		...
		else if (does_entity_exist(*uParam0))
		{
			if (is_ped_injured(*uParam0))
			{
				if (is_vehicle_driveable(uParam0->f_1, false) && has_entity_been_damaged_by_entity(*uParam0, uParam0->f_1, true))
				{
					iLocal_969 = 1;
				}
			...
			else if (is_vehicle_driveable(uParam0->f_1, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, false))
				{
					if (get_entity_speed(uParam0->f_1) > 10f && is_entity_touching_entity(uParam0->f_1, *uParam0))
					{
						if (is_ped_in_any_vehicle(*uParam0, false))
						{
							knock_ped_off_vehicle(*uParam0);
						}
...
void func_354(int* iParam0)
{
	if (!iLocal_1413)
	{
		if (does_entity_exist(iParam0->f_8) && !is_entity_dead(iParam0->f_8, false))
		{
			if (!is_entity_dead(player_ped_id(), false) && is_ped_in_vehicle(player_ped_id(), iParam0->f_8, false))
			{
				modify_vehicle_top_speed(iParam0->f_8, 0f);
				iLocal_1413 = 1;
			}
		}
	}
...
{
	return func_244(get_player_ped(get_player_index()), iParam0, bParam1);
}
	...
	if (iLocal_984 > 4)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1467 && get_entity_model(iVar0) != joaat("bus")) && get_entity_model(iVar0) != joaat("coach"))
					{
						iLocal_1467 = iVar0;
						set_entity_as_mission_entity(iLocal_1467, true, true);
						set_vehicle_has_been_driven_flag(iLocal_1467, false);
					}
				}
			}
		}
...
void func_368(int* iParam0)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			iLocal_1465 = get_vehicle_ped_is_using(player_ped_id());
			iLocal_1471 = get_entity_model(iLocal_1465);
			if (iLocal_1471 != 0)
			{
				if (iLocal_1471 == joaat("bus"))
				{
					...
					bLocal_1402 = true;
					set_vehicle_has_strong_axles(iParam0->f_1, true);
					iLocal_984 = 10;
				}
...
int func_370(var uParam0)
{
	if (!does_entity_exist(iLocal_1462[3]))
	{
		...
		if ((has_model_loaded(uParam0->f_16) && has_model_loaded(uParam0->f_14)) && has_model_loaded(joaat("a_m_m_eastsa_01")))
		{
			if (!does_entity_exist(iLocal_1462[0]))
			{
				iLocal_1462[0] = create_ped(4, joaat("a_m_m_eastsa_01"), 435.0773f, -650.2194f, 27.74271f, 85.9928f, true, true);
				set_ped_component_variation(iLocal_1462[0], 0, 0, 0, 0);
				set_ped_component_variation(iLocal_1462[0], 2, 0, 0, 0);
				set_ped_component_variation(iLocal_1462[0], 3, 0, 2, 0);
				set_ped_component_variation(iLocal_1462[0], 4, 1, 2, 0);
				set_ped_component_variation(iLocal_1462[0], 10, 1, 1, 0);
				if (does_scenario_exist_in_area(435.0773f, -650.2194f, 27.74271f, 2f, true))
				{
					task_use_nearest_scenario_to_coord_warp(iLocal_1462[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					task_wander_standard(iLocal_1462[0], 40000f, 0);
				}
			}
			if (!does_entity_exist(iLocal_1462[1]))
			{
				iLocal_1462[1] = create_ped(4, uParam0->f_16, 436.3171f, -642.8832f, 27.73943f, 32.8396f, true, true);
				if (does_scenario_exist_in_area(436.3171f, -642.8832f, 27.73943f, 2f, true))
				{
					task_use_nearest_scenario_to_coord_warp(iLocal_1462[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					task_wander_standard(iLocal_1462[1], 40000f, 0);
				}
			}
			if (!does_entity_exist(iLocal_1462[2]))
			{
				iLocal_1462[2] = create_ped(4, uParam0->f_14, 435.6569f, -645.5588f, 27.73775f, 343.8998f, true, true);
				if (does_scenario_exist_in_area(435.6569f, -645.5588f, 27.73775f, 2f, true))
				{
					task_use_nearest_scenario_to_coord_warp(iLocal_1462[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					task_wander_standard(iLocal_1462[2], 40000f, 0);
				}
			}
			iLocal_1462[3] = create_ped(4, joaat("a_m_m_eastsa_01"), 436.6802f, -629.7325f, 27.71444f, 179.4746f, true, true);
			set_ped_component_variation(iLocal_1462[1], 0, 0, 2, 0);
			set_ped_component_variation(iLocal_1462[1], 2, 0, 0, 0);
			set_ped_component_variation(iLocal_1462[1], 3, 0, 1, 0);
			set_ped_component_variation(iLocal_1462[1], 4, 0, 2, 0);
			set_ped_component_variation(iLocal_1462[1], 10, 1, 0, 0);
			if (does_scenario_exist_in_area(436.6802f, -629.7325f, 27.71444f, 2f, true))
			{
				task_use_nearest_scenario_to_coord_warp(iLocal_1462[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				task_wander_standard(iLocal_1462[3], 40000f, 0);
			}
			return 1;
		}
	}
...
float func_371(struct<3> Param0, bool bParam1)
{
	return func_234(get_player_ped(get_player_index()), Param0, bParam1);
}
...
int func_374()
{
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		if (is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("taxi")))
		{
...
void func_378()
{
	if (!does_entity_exist(iLocal_1466))
	{
		if (!is_entity_dead(player_ped_id(), false))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				iLocal_1466 = get_vehicle_ped_is_in(player_ped_id(), false);
				if (does_entity_exist(iLocal_1466) && !is_entity_dead(iLocal_1466, false))
				{
					func_380(iLocal_1466);
				}
			}
...
void func_379()
{
	...
	if (vdist2(Var0, Local_1356) > 10000f)
	{
		if (does_entity_exist(iLocal_1353))
		{
			set_model_as_no_longer_needed(joaat("p_phonebox_01b_s"));
			delete_object(&iLocal_1353);
		}
		if (does_entity_exist(iLocal_1352))
		{
			set_entity_visible(iLocal_1352, true, false);
...
void func_386(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_434(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_427(get_this_script_name(), 1);
			if (iVar4 != -1)
			{
...
{
	func_388(&Global_106934, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_388(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_41();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_404(player_ped_id());
		func_397(player_ped_id(), 0);
...
void func_397(int iParam0, bool bParam1)
{
	...
	iVar0 = func_44(iParam0);
	if (func_43(iVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
...
void func_398(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_403(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_400(Var7.f_1)) && iVar9 < 51)
			{
...
int func_408(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_181())
		{
			*uParam0 = func_410(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_410(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_180(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_411(iVar0, 0), true);
...
Vector3 func_415(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
void func_429(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_436(var uParam0, struct<3> Param1, float fParam2)
{
...
int func_438(var uParam0, var uParam1, bool bParam2)
{
	...
	if (uParam0->f_274 == 0)
	{
		if (((((((!get_is_waypoint_recording_loaded("OJASbs_102") || !get_is_waypoint_recording_loaded("OJASbs01")) || !get_is_waypoint_recording_loaded("OJASbs02")) || !get_is_waypoint_recording_loaded("OJASbs03")) || !get_is_waypoint_recording_loaded("OJASbs04")) || !has_vehicle_asset_loaded(uParam0->f_5)) || !has_vehicle_asset_loaded(uParam0->f_15)) || !has_ptfx_asset_loaded())
		{
			return 0;
		}
	}
	...
	{
		if ((((!get_is_waypoint_recording_loaded("OJAShk_101") || !get_is_waypoint_recording_loaded("OJAShk_102")) || !get_is_waypoint_recording_loaded("OJAShk_103")) || !get_is_waypoint_recording_loaded("OJAShk_104")) || !has_anim_dict_loaded("ODDJOBS@assassinate@vice@incar"))
		{
		}
	}
	...
	if ((!has_additional_text_loaded(3) && !func_444(&(uParam0->f_34))) && !func_439(uParam1))
	{
		func_491(uParam1);
		return 0;
	}
...
void func_446(int* iParam0)
{
	set_gameplay_cam_relative_heading(0f);
	set_gameplay_cam_relative_pitch(0f, 1f);
	if (does_blip_exist(iParam0->f_2))
	{
		remove_blip(&(iParam0->f_2));
	}
	if (does_entity_exist(*iParam0))
	{
		delete_ped(iParam0);
...
void func_451(var uParam0, var uParam1)
{
	...
	if (does_blip_exist(uParam1->f_2))
	{
		remove_blip(&(uParam1->f_2));
	}
	...
	set_gameplay_cam_relative_heading(0f);
	set_gameplay_cam_relative_pitch(0f, 1f);
	if (!does_entity_exist(Local_1902[3 /*30*/].f_19))
	{
		Local_1902[3 /*30*/].f_19 = create_vehicle(uParam0->f_15, Local_1902[3 /*30*/].f_5, Local_1902[3 /*30*/].f_8, true, true, false);
		set_vehicle_on_ground_properly(Local_1902[3 /*30*/].f_19, 5f);
	}
	iLocal_1409 = 0;
	iLocal_1412 = 0;
	iLocal_1433 = 3;
	...
	set_entity_coords(uParam1->f_8, 110.2194f, -775.8312f, 30.4426f, true, false, false, true);
	set_entity_heading(uParam1->f_8, 77.2454f);
	set_ped_into_vehicle(*uParam1, uParam1->f_8, -1);
	iLocal_1396 = 0;
	task_vehicle_follow_waypoint_recording(*uParam1, uParam1->f_8, "OJASbs_102", 52, 0, 20, -1, -1f, false, 2f);
	Local_1444 = { -455.2892f, -326.1364f, 41.22218f };
	waypoint_recording_get_num_points("OJASbs_102", &iLocal_1434);
	set_entity_load_collision_flag(*uParam1, true, 1);
	fLocal_1439 = get_vehicle_estimated_max_speed(uParam1->f_8);
	modify_vehicle_top_speed(uParam1->f_8, (fLocal_1438 * 100f));
	set_ped_combat_attributes(*uParam1, 3, true);
	set_vehicle_forward_speed(uParam1->f_8, 1.5f);
	iLocal_1386 = 1;
	freeze_entity_position(uParam1->f_1, false);
...
{
	if (does_entity_exist(uParam1->f_1) && !is_entity_dead(uParam1->f_1, false))
	{
		Local_1902[0 /*30*/].f_14[0] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_16, 3, true, true);
		set_blocking_of_non_temporary_events(Local_1902[0 /*30*/].f_14[0], true);
		Local_1902[0 /*30*/].f_14[1] = create_ped_inside_vehicle(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 4, true, true);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[1], 0, 0, 2, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[1], 2, 1, 0, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[1], 3, 1, 0, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[1], 4, 0, 0, 0);
		set_blocking_of_non_temporary_events(Local_1902[0 /*30*/].f_14[1], true);
		Local_1902[0 /*30*/].f_14[2] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_14, 5, true, true);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[2], 0, 1, 0, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[2], 2, 2, 0, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[2], 3, 1, 0, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[2], 4, 0, 2, 0);
		set_ped_component_variation(Local_1902[0 /*30*/].f_14[2], 8, 1, 0, 0);
		set_blocking_of_non_temporary_events(Local_1902[0 /*30*/].f_14[2], true);
		Local_1902[1 /*30*/].f_14[0] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_16, 6, true, true);
		set_blocking_of_non_temporary_events(Local_1902[1 /*30*/].f_14[0], true);
		Local_1902[1 /*30*/].f_14[1] = create_ped_inside_vehicle(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 7, true, true);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[1], 0, 0, 1, 0);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[1], 3, 0, 1, 0);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[1], 4, 0, 0, 0);
		set_blocking_of_non_temporary_events(Local_1902[1 /*30*/].f_14[1], true);
		Local_1902[1 /*30*/].f_14[2] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_14, 8, true, true);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[2], 0, 0, 0, 0);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[2], 3, 0, 1, 0);
		set_ped_component_variation(Local_1902[1 /*30*/].f_14[2], 4, 0, 2, 0);
		set_blocking_of_non_temporary_events(Local_1902[1 /*30*/].f_14[2], true);
		Local_1902[2 /*30*/].f_14[0] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_16, 0, true, true);
		set_blocking_of_non_temporary_events(Local_1902[2 /*30*/].f_14[0], true);
		Local_1902[2 /*30*/].f_14[1] = create_ped_inside_vehicle(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 1, true, true);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[1], 0, 0, 2, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[1], 2, 0, 0, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[1], 3, 1, 1, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[1], 4, 0, 1, 0);
		set_blocking_of_non_temporary_events(Local_1902[2 /*30*/].f_14[1], true);
		Local_1902[2 /*30*/].f_14[2] = create_ped_inside_vehicle(uParam1->f_1, 4, uParam0->f_14, 2, true, true);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[2], 0, 0, 2, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[2], 2, 0, 1, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[2], 3, 1, 2, 0);
		set_ped_component_variation(Local_1902[2 /*30*/].f_14[2], 4, 0, 1, 0);
		set_blocking_of_non_temporary_events(Local_1902[2 /*30*/].f_14[2], true);
	}
}
...
void func_453(var uParam0)
{
	...
	if (bLocal_1403)
	{
		uParam0->f_1 = create_vehicle(joaat("coach"), 118.3466f, -786.1586f, 30.3105f, 68.7988f, true, true, false);
		set_vehicle_on_ground_properly(uParam0->f_1, 5f);
		set_vehicle_colour_combination(uParam0->f_1, 0);
	}
	else
	{
		uParam0->f_1 = create_vehicle(joaat("bus"), 118.3466f, -786.1586f, 30.3105f, 68.7988f, true, true, false);
		set_vehicle_on_ground_properly(uParam0->f_1, 5f);
		set_vehicle_colour_combination(uParam0->f_1, 0);
	}
	if (is_vehicle_driveable(uParam0->f_1, false))
	{
		set_entity_coords(uParam0->f_1, 118.3466f, -786.1586f, 30.3105f, true, false, false, true);
		set_entity_heading(uParam0->f_1, 68.7988f);
	}
}
...
void func_454()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 < 3)
		{
			if (does_entity_exist(Local_1902[iVar0 /*30*/].f_14[iVar1]))
			{
				delete_ped(&(Local_1902[iVar0 /*30*/].f_14[iVar1]));
			}
			iVar1++;
		}
		iVar0++;
...
{
	clear_area(Local_1450, 50f, true, false, false, false);
	set_all_vehicle_generators_active_in_area((Local_1450.f_0 - 40f), (Local_1450.f_1 - 40f), (Local_1450.f_2 - 40f), (Local_1450.f_0 + 40f), (Local_1450.f_1 + 40f), (Local_1450.f_2 + 40f), false, true);
	if (does_entity_exist(uParam1->f_1))
	{
		if (!bLocal_1393)
		{
			if (is_ped_in_vehicle(player_ped_id(), uParam1->f_1, false))
			{
				clear_ped_tasks_immediately(player_ped_id());
				set_entity_coords(player_ped_id(), uParam0->f_9, true, false, false, true);
			}
			else
			{
				set_entity_coords(player_ped_id(), 423.25f, -641.36f, 28.5068f, true, false, false, true);
			}
		}
		delete_vehicle(&(uParam1->f_1));
	}
	if (!does_entity_exist(uParam1->f_1))
	{
		if (bLocal_1403)
		{
			uParam1->f_1 = create_vehicle(joaat("coach"), uParam0->f_9, uParam0->f_12, true, true, false);
			set_vehicle_on_ground_properly(uParam1->f_1, 5f);
			set_vehicle_colour_combination(uParam1->f_1, 0);
		}
		else
		{
			uParam1->f_1 = create_vehicle(joaat("bus"), uParam0->f_9, uParam0->f_12, true, true, false);
			set_vehicle_on_ground_properly(uParam1->f_1, 5f);
			set_vehicle_colour_combination(uParam1->f_1, 0);
		}
	}
	if (!bLocal_1393)
	{
		if (is_vehicle_driveable(uParam1->f_1, false))
		{
			set_ped_into_vehicle(player_ped_id(), uParam1->f_1, -1);
		}
	}
...
{
	iLocal_1463 = create_vehicle(uParam0->f_5, 439.7705f, -571.9359f, 27.5068f, 325f, true, true, false);
	set_vehicle_on_ground_properly(iLocal_1463, 5f);
	iLocal_1464 = create_vehicle(uParam0->f_5, 406.7046f, -625.4039f, 27.5068f, 91f, true, true, false);
	set_vehicle_on_ground_properly(iLocal_1464, 5f);
}
...
void func_460(var uParam0, var uParam1)
{
	...
	func_204(&(uParam1->f_16), 1, player_ped_id(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_274 == 1)
	{
		set_blip_name_from_text_file(uParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		...
		{
			uParam1->f_7 = create_ped(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, true, true);
			if (uParam0->f_274 == 1)
			{
				task_play_anim(uParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0f, false, false, false);
				set_ped_can_use_auto_conversation_lookat(uParam1->f_7, true);
				func_204(&(uParam1->f_16), 4, uParam1->f_7, "OJAhkHOOKER", 0, 1);
				set_blocking_of_non_temporary_events(uParam1->f_7, true);
				set_ped_combat_attributes(uParam1->f_7, 17, true);
				set_ped_flee_attributes(uParam1->f_7, 128, true);
				set_ped_config_flag(uParam1->f_7, 134, true);
			}
		}
	}
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			uParam1->f_8 = create_vehicle(uParam0->f_15, uParam0->f_26, uParam0->f_29, true, true, false);
		}
		if (uParam0->f_274 == 1)
		{
			set_vehicle_extra(uParam1->f_8, 3, false);
			remove_vehicle_window(uParam1->f_8, 1);
			remove_vehicle_window(uParam1->f_8, 0);
			iLocal_971 = create_ped_inside_vehicle(uParam1->f_8, 4, uParam0->f_16, -1, true, true);
			set_blocking_of_non_temporary_events(iLocal_971, true);
	...
	if (uParam0->f_274 == 2)
	{
		if (!does_blip_exist(uParam1->f_2))
		{
			uParam1->f_2 = add_blip_for_coord(uParam0->f_6);
			set_blip_route(uParam1->f_2, true);
			set_blip_route_colour(uParam1->f_2, 1);
			set_blip_colour(uParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		uParam1->f_2 = add_blip_for_coord(uParam0->f_6);
		set_blip_route(uParam1->f_2, true);
		set_blip_route_colour(uParam1->f_2, 3);
		set_blip_colour(uParam1->f_2, 3);
		set_blip_name_from_text_file(uParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		uParam1->f_2 = add_blip_for_coord(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			uParam1->f_11[iVar0] = create_object(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], true, true, false);
			set_entity_records_collisions(uParam1->f_11[iVar0], true);
			set_entity_collision(uParam1->f_11[iVar0], true, false);
			if (iVar0 == 1)
			{
				freeze_entity_position(uParam1->f_11[iVar0], true);
			}
			if (uParam0->f_262[iVar0] != 0f)
			{
				set_entity_heading(uParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_461(var uParam0, var uParam1)
{
	if (uParam0->f_5 != 0)
	{
		if (!does_entity_exist(uParam1->f_1))
		{
			uParam1->f_1 = create_vehicle(uParam0->f_5, uParam0->f_9, uParam0->f_12, true, true, false);
			if (uParam0->f_274 == 1)
			{
				set_vehicle_extra(uParam1->f_1, 2, true);
				remove_vehicle_window(uParam1->f_1, 1);
				remove_vehicle_window(uParam1->f_1, 0);
				set_vehicle_doors_locked(uParam1->f_1, 3);
			}
			else if (uParam0->f_274 == 0)
			{
				set_entity_load_collision_flag(uParam1->f_1, true, 1);
				set_vehicle_colour_combination(uParam1->f_1, 0);
			}
			add_vehicle_upsidedown_check(uParam1->f_1);
			if (uParam0->f_267 == 1)
			{
				if (does_entity_exist(uParam1->f_1))
				{
					if (is_vehicle_driveable(uParam1->f_1, false))
					{
						...
						{
							set_ped_into_vehicle(*uParam1, uParam1->f_1, -1);
						}
					}
				}
			}
...
void func_463()
{
	...
	set_vehicle_density_multiplier_this_frame(1.5f);
	set_parked_vehicle_density_multiplier_this_frame(0.5f);
	set_roads_in_angled_area(426.035f, -644.93f, -100f, 421.035f, -644.93f, 100f, 55f, false, false, true);
	...
	iLocal_1470[0] = add_scenario_blocking_area(Var0[0 /*3*/] - Vector(8f, 8f, 8f), Var0[0 /*3*/] + Vector(8f, 8f, 8f), false, true, true, true);
	iLocal_1470[1] = add_scenario_blocking_area(Var0[1 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[1 /*3*/] + Vector(8.5f, 8.5f, 8.5f), false, true, true, true);
	iLocal_1470[2] = add_scenario_blocking_area(Var0[2 /*3*/] - Vector(8.5f, 8.5f, 8.5f), Var0[2 /*3*/] + Vector(8.5f, 8.5f, 8.5f), false, true, true, true);
	iLocal_1470[3] = add_scenario_blocking_area(Var0[3 /*3*/] - Vector(9.5f, 9.5f, 9.5f), Var0[3 /*3*/] + Vector(9.5f, 9.5f, 9.5f), false, true, true, true);
	iLocal_1470[4] = add_scenario_blocking_area(Var0[4 /*3*/] - Vector(8f, 8f, 8f), Var0[4 /*3*/] + Vector(8f, 8f, 8f), false, true, true, true);
	iLocal_1470[5] = add_scenario_blocking_area(Var0[5 /*3*/] - Vector(15f, 15f, 15f), Var0[5 /*3*/] + Vector(15f, 15f, 15f), false, true, true, true);
}
...
void func_464(var uParam0, var uParam1, bool bParam2)
{
	...
	if (uParam0->f_274 == 1)
	{
		request_additional_text("ASS_hk", 3);
	...
	{
		request_additional_text("ASS_bs", 3);
		...
		request_vehicle_asset(uParam0->f_5, 3);
		request_vehicle_asset(uParam0->f_15, 3);
		request_ptfx_asset();
	}
	else if (uParam0->f_274 == 2)
	{
		request_additional_text("ASS_ml", 3);
		request_ptfx_asset();
	}
	...
	if (uParam0->f_274 == 0)
	{
		while (((((((((!get_is_waypoint_recording_loaded("OJASbs_102") || !get_is_waypoint_recording_loaded("OJASbs01")) || !get_is_waypoint_recording_loaded("OJASbs02")) || !get_is_waypoint_recording_loaded("OJASbs03")) || !get_is_waypoint_recording_loaded("OJASbs04")) || !has_anim_dict_loaded("ODDJOBS@assassinate@old_lady")) || !has_vehicle_asset_loaded(uParam0->f_5)) || !has_vehicle_asset_loaded(uParam0->f_15)) || !has_ptfx_asset_loaded()) || !has_clip_set_loaded("move_m@casual@d"))
		{
			func_491(uParam1);
			wait(0);
		}
	...
	{
		while (((((!get_is_waypoint_recording_loaded("OJAShk_101") || !get_is_waypoint_recording_loaded("OJAShk_102")) || !get_is_waypoint_recording_loaded("OJAShk_103")) || !get_is_waypoint_recording_loaded("OJAShk_104")) || !has_anim_dict_loaded("ODDJOBS@assassinate@vice@incar")) || !has_anim_dict_loaded("mini@hookers_spvanilla"))
		{
			func_491(uParam1);
			wait(0);
		}
	...
	while ((!has_additional_text_loaded(3) || !func_444(&(uParam0->f_34))) || !func_439(uParam1))
	{
		func_491(uParam1);
		wait(0);
	}
	if (uParam0->f_274 == 1)
	{
		clear_area_of_vehicles(uParam0->f_18, 100f, false, false, false, false, false, false, 0);
		set_all_vehicle_generators_active_in_area(-690.763f, -1607.467f, -100.9649f, -404.4197f, -1856.529f, 100.5908f, false, true);
		set_random_vehicle_density_multiplier_this_frame(0.2f);
...
void func_474(var uParam0)
{
	switch (iLocal_1351)
	{
		case 0:
			...
			request_model(joaat("p_phonebox_01b_s"));
			if (has_anim_dict_loaded("oddjobs@assassinate@bus@call") && has_model_loaded(joaat("p_phonebox_01b_s")))
			{
			...
			if (bLocal_1374)
			{
				if (does_entity_exist(iLocal_1352))
				{
					...
					clear_area(-26.48f, -110.66f, 56.0227f, 3f, true, false, false, false);
					...
					if (does_entity_exist(iLocal_1352))
					{
						set_entity_visible(iLocal_1352, false, false);
						set_entity_collision(iLocal_1352, false, false);
						set_entity_can_be_damaged(iLocal_1352, false);
						iLocal_1353 = create_object(joaat("p_phonebox_01b_s"), -26.48f, -110.66f, 56.0227f, true, true, false);
						set_entity_rotation(iLocal_1353, 0f, 0f, 157.62f, 2, true);
						set_entity_collision(iLocal_1353, false, false);
						set_entity_can_be_damaged(iLocal_1353, false);
						set_entity_visible(player_ped_id(), true, false);
					}
					iLocal_1380 = streamvol_create_sphere(-26.48f, -110.66f, 56.0227f, 350f, 12, 127);
					func_289(1, 1, 1, 0, 0, 0, 0);
					clear_area_of_peds(Local_1357, 5f, 0);
					if (!is_entity_dead(player_ped_id(), false))
					{
						force_ped_ai_and_animation_update(player_ped_id(), false, false);
						set_entity_coords(player_ped_id(), Local_1357, true, false, false, true);
						set_entity_heading(player_ped_id(), fLocal_1358);
						remove_ped_helmet(player_ped_id(), true);
					}
					iLocal_1377 = create_synchronized_scene(Local_1375, Local_1376, 2);
					if (does_entity_exist(iLocal_1353))
					{
						attach_synchronized_scene_to_entity(iLocal_1377, iLocal_1353, -1);
					}
					task_synchronized_scene(player_ped_id(), iLocal_1377, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
					play_synchronized_entity_anim(iLocal_1353, iLocal_1377, "ass_bus_call_phone", "oddjobs@assassinate@bus@call", 1000f, -2f, 0, 1000f);
					if (!does_cam_exist(iLocal_1354))
					{
						iLocal_1355 = create_camera_with_params(26379945, Local_1362, Local_1363, 36f, true, 2);
						iLocal_1354 = create_camera_with_params(26379945, Local_1364, Local_1365, 36f, false, 2);
						set_cam_active_with_interp(iLocal_1354, iLocal_1355, 2500, 1, 1);
						render_script_cams(true, false, 3000, true, false, 0);
						shake_cam(iLocal_1354, "HAND_SHAKE", 0.2f);
					}
					func_204(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_204(&(uParam0->f_16), 1, player_ped_id(), "FRANKLIN", 0, 1);
					display_radar(false);
					display_hud(false);
					iLocal_1379 = add_navmesh_blocking_object(-26.48f, -110.66f, 56.0227f, 3f, 3f, 3f, 0f, false, 7);
					set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
				...
				else
				{
					...
					if (!does_entity_exist(iLocal_1352))
					{
						iLocal_1352 = get_closest_object_of_type(Local_1356, 5f, joaat("prop_phonebox_01b"), true, false, true);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1373)
			{
				if (!is_entity_dead(player_ped_id(), false))
				{
					if (is_synchronized_scene_running(iLocal_1377))
					{
						if (get_synchronized_scene_phase(iLocal_1377) > 0.05f)
						{
			...
			if (func_171(&iLocal_1366))
			{
				if ((func_168(&iLocal_1366) > fLocal_1359 || (is_synchronized_scene_running(iLocal_1377) && get_synchronized_scene_phase(iLocal_1377) >= 0.962f)) || bLocal_1372)
				{
					iLocal_1351 = 3;
				}
			}
		...
		case 2:
			...
			if (bLocal_1372)
			{
				if (is_screen_faded_out())
				{
					...
					{
						force_ped_ai_and_animation_update(player_ped_id(), false, false);
						set_entity_coords(player_ped_id(), -25.8488f, -109.9882f, 56.0738f, true, false, false, true);
						set_entity_heading(player_ped_id(), 236.2218f);
					}
					stop_synchronized_entity_anim(iLocal_1353, -1000f, true);
					wait(0);
					do_screen_fade_in(500);
		...
		case 3:
			...
			if (streamvol_is_valid(iLocal_1380))
			{
				streamvol_delete(iLocal_1380);
			}
			set_entity_collision(iLocal_1353, true, false);
			display_radar(true);
			display_hud(true);
			clear_ped_tasks(player_ped_id());
			set_player_control(player_id(), true, 0);
			...
			set_object_as_no_longer_needed(&iLocal_1352);
			iLocal_984 = 4;
			break;
	}
}
...
int func_477(int iParam0, float fParam1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5, float fParam6)
{
	if (does_cam_exist(*iParam0))
	{
		if (func_171(&iLocal_1369))
		{
			...
			{
				set_cam_coord(iLocal_1354, Param2);
				set_cam_rot(iLocal_1354, Param3, 2);
				set_cam_fov(iLocal_1354, fParam4);
				if (bParam5)
				{
					shake_cam(iLocal_1354, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_478(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_479(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_479(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_480(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_481(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_486()
{
	if (does_entity_exist(iLocal_1465))
	{
		if (is_ped_in_vehicle(player_ped_id(), iLocal_1465, false))
		{
			clear_ped_tasks_immediately(player_ped_id());
			set_entity_coords(player_ped_id(), 421.5518f, -640.2153f, 27.5072f, true, false, false, true);
		}
		set_entity_as_mission_entity(iLocal_1465, true, false);
		delete_vehicle(&iLocal_1465);
	}
}

void func_487(int iParam0, struct<3> Param1, struct<3> Param2)
{
	remove_scenario_blocking_area(iParam0, false);
	clear_ped_non_creation_area();
	disable_navmesh_in_area(Param1, Param2, 0);
}
...
void func_494(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_543())
	{
	...
	if (func_533(uParam0))
	{
		...
		if (func_532(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_501(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
int func_501(int iParam0, struct<3> Param1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_503(iParam0, uVar1[iVar3], 1) && func_502(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_160(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
void func_505(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_151(iParam0, iParam1))
				{
...
void func_506(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_162(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_162(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_162(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_162(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_162(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_162(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_162(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_507() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
int func_512(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_516(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_515(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_515(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_514(iParam0);
	if (func_513(*iParam0))
	{
...
void func_531(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_541(struct<3> Param0, struct<3> Param1)
{
	set_ped_non_creation_area(Param0, Param1);
	disable_navmesh_in_area(Param0, Param1, 1);
	return add_scenario_blocking_area(Param0, Param1, false, true, true, true);
}
...
void func_544(var uParam0)
{
	...
	remove_road_node_speed_zone(iLocal_970);
	set_vehicle_density_multiplier_this_frame(1f);
	set_random_vehicle_density_multiplier_this_frame(1f);
	set_all_vehicle_generators_active_in_area(-690.763f, -1607.467f, -100.9649f, -404.4197f, -1856.529f, 100.5908f, true, true);
	set_roads_back_to_original_in_angled_area(-706.106f, -1708.865f, -100f, -512.576f, -1842.173f, 100f, 100f, 1);
	set_roads_back_to_original_in_angled_area(-480.9742f, -1801.922f, 19.28045f, -712.8968f, -1671.164f, 29.93867f, 170f, 1);
	set_roads_back_to_original_in_angled_area(-674.8915f, -1683.639f, 9.116446f, -446.189f, -1807.7f, 31.72464f, 200f, 1);
	set_roads_back_to_original_in_angled_area(-662.6993f, -1645.326f, 24.07147f, -672.2144f, -1777.59f, 38.81248f, 45f, 1);
	set_roads_back_to_original_in_angled_area(-382.9608f, -1688.732f, 17.8985f, -431.2512f, -1811.23f, 37.6825f, 80f, 1);
	Var0 = { 414.1398f, -640.002f, 27.5001f };
	set_all_vehicle_generators_active_in_area((Var0.f_0 - 40f), (Var0.f_1 - 40f), (Var0.f_2 - 40f), (Var0.f_0 + 40f), (Var0.f_1 + 40f), (Var0.f_2 + 40f), true, true);
	set_roads_back_to_original_in_angled_area(426.035f, -644.93f, -100f, 421.035f, -644.93f, 100f, 55f, 1);
...
void func_551()
{
	if (does_navmesh_blocking_object_exist(iLocal_1379))
	{
		remove_navmesh_blocking_object(iLocal_1379);
	}
}
