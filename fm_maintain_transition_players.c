...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Local_194.f_8 == 1)
		{
			if ((!is_player_switch_in_progress() && !func_662(player_id())) && func_661())
			{
				Local_194.f_8 = 0;
				...
				if (!Local_194.f_13)
				{
					if (!func_658() || func_628())
					{
						...
						if (func_658())
						{
							...
							set_entity_coords(player_ped_id(), ScriptParam_219.f_11, true, false, false, true);
							iVar1 = get_interior_at_coords_with_type(345.0041f, 4842.001f, -59.9997f, "xm_x17dlc_int_02");
							func_622(iVar1);
						}
						Local_194.f_13 = 1;
						Local_194.f_5 = 0;
		...
		func_303();
		if ((!network_is_activity_session() && network_is_in_transition()) && !network_is_transition_busy())
		{
		...
		{
			iLocal_212 = get_clock_hours();
			iLocal_213 = get_clock_minutes();
			iLocal_214 = get_clock_seconds();
				...
				case 1:
					if (func_84(&Local_189))
					{
						if (func_29(&Local_189, &Local_193, iLocal_181))
						{
							...
							{
								Global_1888862[player_id() /*120*/] = Global_4718592.f_593;
		...
		{
			set_clock_time(iLocal_212, iLocal_213, iLocal_214);
			if (func_18())
			{
				if (iLocal_206 == 0)
				{
				...
				if (!func_667())
				{
					...
					{
						set_clock_time(Global_1931030.f_8, 0, 0);
					}
				}
			}
			else
...
char* func_8()
{
	...
	if (_0x88B588B41FF7868E())
	{
		return func_10();
	}
	if (_0x67FC09BC554A75E5())
	{
		return func_10();
	}
	switch (func_9())
		...
		if (iParam1 != (uParam0[bVar0 /*19*/])->f_1)
		{
			...
			while (iVar1 < Global_2715699.f_1.f_2805)
			{
				if (bVar0 != iVar1 && iParam1 != (uParam0[iVar1 /*19*/])->f_1)
				{
					...
					{
						set_bit(&iLocal_199, bVar0);
					}
					else if (iLocal_203[bVar0] == iLocal_203[iVar1])
					{
						set_bit(&iLocal_200, bVar0);
					}
				}
				iVar1++;
			}
...
void func_87(int iParam0)
{
	...
	{
		fVar0 = (to_float(Global_4718592.f_142646) / 10f);
...
void func_101()
{
	clear_bit(&(Global_2714762.f_2), 7);
}

void func_102()
{
	clear_bit(&Global_2714762, 9);
}

void func_103()
{
	clear_bit(&Global_2714762, 13);
}

void func_104()
{
	clear_bit(&(Global_1853348[player_id() /*834*/].f_96.f_32), false);
}

void func_105()
{
	set_script_as_no_longer_needed(func_10());
	...
	set_script_as_no_longer_needed("am_doors");
}
...
void func_116(int iParam0, int iParam1, var uParam2, var uParam3)
{
	...
	while (iVar1 <= (iParam1 - 1))
	{
		...
		{
			iVar5 = ceil((to_float(iVar2) / to_float(Global_4718592.f_110323[iVar1])));
			if (iVar5 < 1)
			{
				iVar5 = 1;
			}
			...
			while (iVar3 > iVar5 && iVar8 < 10000)
			{
				...
				while (bVar0 <= (iParam0 - 1))
				{
					if (BitTest(iVar6, bVar0))
					{
						...
						while (iVar3 < iVar5 && iVar8 < 10000)
						{
							iVar4 = get_random_int_in_range(0, iVar2);
							iVar7 = 0;
							bVar0 = false;
							while (bVar0 <= (iParam0 - 1))
							{
			...
			else
			{
				...
				while (iVar0 <= (Global_2715699.f_1.f_2805 - 1))
				{
					...
					while (iVar1 <= (Global_2715699.f_1.f_2805 - 1))
					{
						...
						{
							set_bit(&uVar6, Global_2715699.f_1.f_845[iVar0 /*57*/].f_44);
						}
						iVar1++;
					}
					iVar0++;
...
int func_123()
{
	...
	network_get_transition_host(&uVar0);
	if (network_is_handle_valid(&uVar0, 13))
	{
		iVar1 = 0;
		while (iVar1 <= (Global_2715699.f_1.f_2805 - 1))
		{
			if (network_is_handle_valid(&(Global_2715699.f_1.f_845[iVar1 /*57*/]), 13))
			{
				if (network_are_handles_the_same(&(Global_2715699.f_1.f_845[iVar1 /*57*/]), &uVar0))
				{
					return iVar1;
				}
			}
...
int func_138()
{
	...
	iVar0 = Global_1853348[player_id() /*834*/].f_192;
	switch (iVar0)
	{
		case 0:
			if (!func_667())
...
int func_140()
{
	...
	if (func_141() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_141()) == 0)
		{
			return 1;
		}
	}
...
void func_145(int iParam0)
{
	...
	{
		func_11(0);
		if (!network_is_script_active(func_8(), -1, true, 0))
		{
			if (func_283())
			{
	...
	else if ((network_is_activity_session() && func_146()) && func_18())
	{
		func_11(0);
		func_6(iParam0->f_3);
		iLocal_206 = 1;
...
void func_147(bool bParam0)
{
	...
	network_set_script_automuted(0);
	func_270();
	func_267();
	func_266(0);
	...
	func_170();
	func_164();
	_0xFF4803BC019852D9(Global_1575063, Global_1575062);
	func_148();
	network_session_voice_set_timeout(60000);
}
...
void func_151(int iParam0, int iParam1, bool bParam2)
{
	...
	set_bit(&(Global_1641223[iVar0]), bParam2);
}
...
void func_155(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar0 < iVar1)
	{
		set_bit(&(Global_1641652[iVar0 /*6*/]), bParam2);
		switch (bParam2)
		{
			case 1:
...
void func_164()
{
	...
	if (is_player_online())
	{
		...
		{
			Global_1575090[player_id() /*35*/] = { func_168() };
			if (func_167())
			{
				if (func_165(player_id(), &Global_1576215, &Global_1576216, &Global_1576217))
				{
					Global_1576214 = 1;
				}
				else
...
int func_165(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	if (is_player_online() && network_is_signed_online())
	{
		Var1 = { func_166(iParam0) };
		if (network_clan_service_is_valid() && network_clan_player_is_active(&Var1))
		{
			network_clan_player_get_desc(&Var0, 35, &Var1);
			*uParam1 = Var0.f_32;
			*uParam2 = Var0.f_33;
			*uParam3 = Var0.f_34;
			return 1;
...
struct<35> func_168()
{
	...
	if (is_player_online())
	{
		network_clan_player_get_desc(&Var1, 0, &Var0);
	}
	return Var1;
}
...
int func_171(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (BitTest(Global_78130[1 /*14*/].f_6, 0))
	{
		if (BitTest(Global_78130[1 /*14*/].f_6, 6))
		{
			...
			{
				iVar0 = get_shop_ped_apparel_variant_component_count(Global_2883588);
				iVar1 = 0;
				while (iVar1 < iVar0)
				{
					get_variant_component(Global_2883588, iVar1, &iVar2, &uVar3, &iVar4);
		...
		else
		{
			if (iParam1 != 5)
			{
				...
				if (bParam3)
				{
					set_bit(&iVar9, Global_78130[1 /*14*/].f_1);
				}
				else
				{
					clear_bit(&iVar9, Global_78130[1 /*14*/].f_1);
				}
...
int func_174(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 == joaat("mp_m_freemode_01"))
	{
		...
		else if (iParam1 >= 241)
		{
			...
			if (iVar1 != -1)
			{
				iVar2 = get_shop_ped_apparel_variant_component_count(iVar1);
				iVar3 = 0;
				while (iVar3 < iVar2)
				{
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		...
		else if (iParam1 >= 136)
		{
			...
			if (iVar7 != -1)
			{
				iVar8 = get_shop_ped_apparel_variant_component_count(iVar7);
				iVar9 = 0;
				while (iVar9 < iVar8)
				{
...
int func_175(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_177(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_180(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_177(iParam2));
...
int func_189(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (BitTest(Global_78130[1 /*14*/].f_6, 0) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
		...
		if (iParam1 != 5)
		{
			...
			if (bParam3)
			{
				set_bit(&iVar0, Global_78130[1 /*14*/].f_1);
			}
			else
			{
				clear_bit(&iVar0, Global_78130[1 /*14*/].f_1);
			}
		...
		if (bParam4)
		{
			if (func_190(iParam1, Global_78130[1 /*14*/].f_2, &iVar1))
			{
				...
				set_bit(&iVar2, Global_78130[1 /*14*/].f_1);
...
void func_211(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_205(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_205(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_177(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_251(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	if (iVar0 != 0)
	{
		stat_set_date(iVar0, &uParam1, 7, true);
	}
}
...
void func_263()
{
	...
	while (iVar0 <= 6)
	{
		...
		{
			iVar1 = player_id();
			clear_bit(&(Global_2689235[iVar1 /*453*/].f_237), Global_1643899[iVar0]);
...
int func_283()
{
	if (does_script_exist(func_8()))
	{
		if (_get_number_of_references_of_script_with_name_hash(func_141()) <= 0)
		{
			request_script(func_8());
			if (has_script_loaded(func_8()))
			{
				if (are_strings_equal(func_10(), func_8()))
				{
					start_new_script(func_8(), 32750);
				}
				else if (are_strings_equal("Creator", func_8()))
				{
					start_new_script(func_8(), 23000);
				}
				else
				{
					start_new_script(func_8(), 32750);
				}
				set_script_as_no_longer_needed(func_8());
				return 1;
			}
		}
		else
...
void func_285(var uParam0, int iParam1)
{
	...
	request_streamed_texture_dict("BANNER_RACE_REMIX", false);
	if (has_streamed_texture_dict_loaded("BANNER_RACE_REMIX"))
	{
		...
		*uParam0 = (*uParam0 * (*uParam0 / 2));
		...
		draw_sprite("BANNER_RACE_REMIX", sVar5, 0.5f, fVar4, fVar2, fVar3, 0f, 255, 255, 255, *uParam0, false, 0);
...
void func_291(var uParam0, bool bParam1)
{
	...
	if (has_streamed_texture_dict_loaded(sVar0))
	{
		get_screen_resolution(&iVar1, &iVar2);
		if (iVar1 > 2048)
		{
			iVar1 = 2048;
		}
		...
		*uParam0 = (*uParam0 * (*uParam0 / 2));
		...
		draw_sprite(sVar0, sVar6, 0.5f, fVar5, fVar3, fVar4, 0f, 255, 255, 255, *uParam0, false, 0);
		set_script_gfx_draw_behind_pausemenu(false);
	}
}
...
int func_298()
{
	...
	if (((func_661() && network_is_activity_session()) && func_299() <= 26) && does_cam_exist(Global_2714762.f_781))
	{
		return 1;
	}
	return 0;
...
void func_305()
{
	...
	{
		set_radar_zoom_to_distance(Global_2726591);
	}
	lock_minimap_position(fLocal_179, fLocal_180);
}
...
void func_311()
{
	...
	while (iVar0 <= (Global_4980736.f_69352 - 1))
	{
		if (!func_337(Global_4980736.f_69361[iVar0 /*151*/]))
		{
			...
			custom_minimap_set_blip_object(iVar1);
			custom_minimap_create_blip(Global_4980736.f_69361[iVar0 /*151*/]);
		}
		iVar0++;
	}
}
...
char* func_314(int iParam0, int iParam1, int iParam2)
{
	...
	iParam0 = _get_pickup_hash(iParam0);
...
int func_321(int iParam0)
{
	...
	if (Global_262145.f_21960)
	{
		if (!func_336())
		{
			iVar1 = get_weapon_type_from_pickup_type(Global_4980736.f_69361[iParam0 /*151*/].f_15);
	...
	if (iVar2 > -1)
	{
		...
		{
			if ((!func_323(player_id(), 0) && !Global_1836572) && !func_322())
			{
...
bool func_331()
{
	return (BitTest(Global_4718592.f_11, 18) && network_is_activity_session());
}
...
void func_338()
{
	...
	if (func_345())
	{
		start_gps_custom_route(116, true, true);
		iVar0 = 0;
		while (iVar0 <= (func_344() - 1))
		{
			if (!func_337(Global_4718592.f_95507[iVar0 /*58*/]))
			{
				add_point_to_gps_custom_route(Global_4718592.f_95507[iVar0 /*58*/]);
				iVar1 = iVar0;
			}
			iVar0++;
		}
		set_gps_custom_route_render(true, 18, 30);
		if (func_341() && func_323(player_id(), 0))
		{
			iVar0 = 0;
			while (iVar0 <= (func_344() - 1))
			{
				if (!func_337(Global_4718592.f_95507[iVar0 /*58*/]))
				{
					...
					{
						custom_minimap_set_blip_object(146);
						custom_minimap_create_blip(Global_4718592.f_95507[iVar0 /*58*/]);
					}
				}
				iVar0++;
			}
		...
		{
			custom_minimap_set_blip_object(145);
			custom_minimap_create_blip(Global_4718592.f_95507[0 /*58*/]);
		}
		if (!func_337(Global_4718592.f_95507[iVar1 /*58*/]))
		{
			custom_minimap_set_blip_object(144);
			custom_minimap_create_blip(Global_4718592.f_95507[iVar1 /*58*/]);
		}
	}
	else
	{
		...
		if (!func_337(Global_4718592.f_95507[0 /*58*/]))
		{
			add_point_to_gps_custom_route(Global_4718592.f_95507[0 /*58*/]);
		}
		set_gps_custom_route_render(true, 18, 30);
		iVar2 = 55;
		if (!func_337(Global_4718592.f_95507[0 /*58*/]))
		...
		if (!func_337(_get_object_offset_from_coords(Global_4718592.f_95507[0 /*58*/], func_339(Global_4718592.f_95507[0 /*58*/], Global_4718592.f_95507[1 /*58*/]), 0f, IntToFloat(iVar2), 0f)))
		{
			custom_minimap_set_blip_object(145);
			custom_minimap_create_blip(_get_object_offset_from_coords(Global_4718592.f_95507[0 /*58*/], func_339(Global_4718592.f_95507[0 /*58*/], Global_4718592.f_95507[1 /*58*/]), 0f, IntToFloat(iVar2), 0f));
		}
	}
}

float func_339(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
...
void func_340(int iParam0)
{
	...
	set_bit(&(Global_2715699.f_1.f_2813[iVar0]), bVar1);
}
...
int func_349()
{
	...
	if ((Global_4718592 == 1 && Global_4718592.f_625 != 1) && !func_351(player_id()))
	{
	...
	if (Global_4718592 == 0 && !func_351(player_id()))
	{
	...
	if ((Global_4718592 == 3 && !func_351(player_id())) && !func_350(Global_4718592.f_168757))
	{
		if (func_348(Global_4718592) > 0)
		{
			return 1;
...
void func_361(int iParam0)
{
	...
	if (func_483())
	{
		...
		if (!func_308(43))
		{
			...
			{
				if (func_653() && !is_player_switch_in_progress())
				{
					func_475(&(iParam0->f_11), iParam0->f_4);
					...
					if (!func_337(Var1))
					{
						...
						new_load_scene_start_sphere(Var1, func_370(), func_369());
						func_368();
						func_367();
						func_340(43);
						func_366();
...
void func_362()
{
	clear_bit(&(Global_2714762.f_2), true);
}

void func_363()
{
	set_bit(&(Global_2714762.f_2), false);
}
...
void func_366()
{
	clear_bit(&Global_2714762, 27);
}

void func_367()
{
	clear_bit(&(Global_2714762.f_2), false);
}

void func_368()
{
	set_bit(&(Global_2714762.f_2), true);
}
...
Vector3 func_389(struct<3> Param0, struct<3> Param1)
{
	if (func_390())
	{
		return Param1;
...
int func_393(int iParam0, struct<3> Param1, bool bParam2, bool bParam3)
{
	if (bParam2)
	{
...
int func_396(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5)
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2;
	...
	{
		fVar6 = get_distance_between_coords(Var3, Var5, false);
		Var7 = { Var3 - Var5 };
		Var8 = { Var4 - Var5 };
		Var7 = { func_400(Var7) };
		Var8 = { func_400(Var8) };
	...
	switch (Global_4980736.f_195934[iParam1 /*111*/].f_9)
	{
		...
		case 2:
			...
			if (is_point_in_angled_area(Param0, Var1, Var2, fVar9, false, bParam2))
			{
				if (func_398(Param0, Var1.f_2, Var2.f_2))
				{
					iVar0 = 1;
...
int func_398(struct<3> Param0, float fParam1, float fParam2)
{
	float fVar0;
...
int func_399(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5)
{
...
int func_407()
{
	...
	{
		if (is_ipl_active("h4_Underwater_Gate_Closed"))
		{
			remove_ipl("h4_Underwater_Gate_Closed");
		}
	}
	else if (!is_ipl_active("h4_Underwater_Gate_Closed"))
	{
		request_ipl("h4_Underwater_Gate_Closed");
		return 0;
	}
	...
	{
		if (is_ipl_active("h4_beach_party"))
		{
			remove_ipl("h4_beach_party");
		}
		if (is_ipl_active("h4_beach_props_party"))
		{
			remove_ipl("h4_beach_props_party");
		}
	}
	else
	{
		if (!is_ipl_active("h4_beach_party"))
		{
			request_ipl("h4_beach_party");
			return 0;
		}
		if (!is_ipl_active("h4_beach_props_party"))
		{
			request_ipl("h4_beach_props_party");
			return 0;
		}
	}
	if (BitTest(Global_4718592.f_162525, 4))
	{
		if (is_ipl_active("h4_IslandX_Mansion_GuardFence"))
		{
			remove_ipl("h4_IslandX_Mansion_GuardFence");
		}
		if (is_ipl_active("h4_IslandX_Mansion_Entrance_Fence"))
		{
			remove_ipl("h4_IslandX_Mansion_Entrance_Fence");
		}
		if (is_ipl_active("h4_IslandX_Mansion_B_Side_Fence"))
		{
			remove_ipl("h4_IslandX_Mansion_B_Side_Fence");
		}
	}
	else
	{
		if (!is_ipl_active("h4_IslandX_Mansion_GuardFence"))
		{
			request_ipl("h4_IslandX_Mansion_GuardFence");
			return 0;
		}
		if (!is_ipl_active("h4_IslandX_Mansion_Entrance_Fence"))
		{
			request_ipl("h4_IslandX_Mansion_Entrance_Fence");
			return 0;
		}
		if (!is_ipl_active("h4_IslandX_Mansion_B_Side_Fence"))
		{
			request_ipl("h4_IslandX_Mansion_B_Side_Fence");
			return 0;
		}
	}
	if (BitTest(Global_4718592.f_162525, 5))
	{
		if (is_ipl_active("h4_islandx_sea_mines"))
		{
			remove_ipl("h4_islandx_sea_mines");
		}
	}
	else if (!is_ipl_active("h4_islandx_sea_mines"))
	{
		request_ipl("h4_islandx_sea_mines");
		return 0;
	}
	if (BitTest(Global_4718592.f_162525, 6))
	{
		if (is_ipl_active("h4_island_padlock_props"))
		{
			remove_ipl("h4_island_padlock_props");
		}
	}
	else if (!is_ipl_active("h4_island_padlock_props"))
	{
		request_ipl("h4_island_padlock_props");
		return 0;
	}
	if (BitTest(Global_4718592.f_162525, 7))
	{
		if (is_ipl_active("h4_islandxdock_water_hatch"))
		{
			remove_ipl("h4_islandxdock_water_hatch");
		}
		if (is_ipl_active("h4_islandx_barrack_hatch"))
		{
			remove_ipl("h4_islandx_barrack_hatch");
		}
	}
	else
	{
		if (!is_ipl_active("h4_islandxdock_water_hatch"))
		{
			request_ipl("h4_islandxdock_water_hatch");
			return 0;
		}
		if (!is_ipl_active("h4_islandx_barrack_hatch"))
		{
			request_ipl("h4_islandx_barrack_hatch");
			return 0;
		}
	}
	if (BitTest(Global_4718592.f_162525, 8))
	{
		if (is_ipl_active("h4_BoatBlockers"))
		{
			remove_ipl("h4_BoatBlockers");
		}
	}
	else if (!is_ipl_active("h4_BoatBlockers"))
	{
		request_ipl("h4_BoatBlockers");
		return 0;
	}
	if (BitTest(Global_4718592.f_162525, 9))
	{
		if (!is_ipl_active("h4_islandx"))
		{
			request_ipl("h4_islandx");
			return 0;
		}
	}
	else if (is_ipl_active("h4_islandx"))
	{
		remove_ipl("h4_islandx");
	}
	return 1;
}
...
void func_411()
{
	...
	_set_toggle_minimap_heist_island(true);
	_set_ai_global_path_nodes_type(1);
	set_max_wanted_level(0);
	set_wanted_level_multiplier(0f);
	set_dispatch_cops_for_player(player_id(), false);
	set_audio_flag("PlayerOnDLCHeist4Island", true);
	set_ambient_zone_list_state_persistent("AZL_DLC_Hei4_Island_Zones", true, true);
	set_ambient_zone_list_state_persistent("AZL_DLC_Hei4_Island_Disabled_Zones", false, true);
...
int func_412(int iParam0)
{
	if (iParam0 != func_414())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_413(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_422(bool bParam0)
{
	if (bParam0)
	{
		if (_get_global_water_type() != 1)
		{
			if (!func_423())
			{
				_load_global_water_type(1);
			}
		}
	}
	else if (_get_global_water_type() != 0)
	{
		_load_global_water_type(0);
	}
}
...
int func_423()
{
	...
	if (network_is_activity_session() && !Global_2726594)
	{
		return 1;
	}
	return 0;
...
int func_428()
{
	...
	if (Global_1973204 == 0)
	{
		...
		{
			iVar1 = get_random_int_in_range(0, 1000);
			if (iVar1 < 500)
			{
				Global_1973204 = 1;
			}
...
bool func_429()
{
	return is_ipl_active("H4_islandx_terrain_01");
}
...
int func_431(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		clear_bit(&Global_1965451, true);
		func_474(&Global_1965449);
	}
	else if (!is_interior_ready(*uParam0))
	{
		clear_bit(&Global_1965451, true);
		func_474(&Global_1965449);
	}
	...
	if (BitTest(Global_4718592.f_162497, 12))
	{
		...
		{
			Var0 = { func_469(193) };
			iVar1 = get_interior_at_coords_with_type(Var0, Var0.f_3);
			if (iVar1 == 0)
			{
			}
			...
			{
				*uParam0 = iVar1;
				if (get_interior_from_entity(player_ped_id()) != *uParam0)
				{
				}
				if (get_interior_from_entity(player_ped_id()) != *uParam0 || network_is_in_spectator_mode())
				{
					func_464(193, 0);
					disable_interior(*uParam0, false);
					refresh_interior(*uParam0);
				}
...
void func_440(bool bParam0, var uParam1)
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			activate_interior_entity_set(*uParam1, sVar1);
			_set_interior_entity_set_color(*uParam1, sVar1, Global_4718592.f_162543.f_29[iVar0]);
		}
		else
		{
			deactivate_interior_entity_set(*uParam1, sVar1);
		}
		iVar0++;
	}
}
...
void func_441(var uParam0, char* sParam1, bool bParam2)
{
	if (bParam2)
	{
		activate_interior_entity_set(*uParam0, sParam1);
	}
	else
	{
		deactivate_interior_entity_set(*uParam0, sParam1);
	}
}
...
void func_442(var uParam0, bool bParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		if (bVar0)
		{
			activate_interior_entity_set(*uParam0, sParam2);
		}
		else
		{
			deactivate_interior_entity_set(*uParam0, sParam2);
		}
	}
	else
	{
...
void func_447(int iParam0, var uParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (_network_is_thread_active(iVar0) && network_is_host_of_this_script())
	{
		...
		if (bParam2)
		{
			...
			if (bVar1)
			{
				if (!Global_1966040)
				{
					if (network_is_game_in_progress())
					{
						network_override_clock_time(iVar2, iVar3, 0);
					}
					else
					{
						set_clock_time(iVar2, iVar3, 0);
					}
					if (!BitTest(Global_1965451, 4))
					{
						set_bit(&Global_1965451, 4);
					}
				}
				...
				if (func_448())
				{
					...
					_0x0AE73D8DF3A762B2(!bParam4);
				}
				else
				{
					_0x0AE73D8DF3A762B2(true);
				}
				set_override_weather(sVar4);
			}
		}
	}
}
...
int func_449()
{
	if (_get_number_of_references_of_script_with_name_hash(joaat("fm_deathmatch_creator")) == 0 && _get_number_of_references_of_script_with_name_hash(joaat("fm_race_creator")) == 0)
	{
		return 0;
	}
...
{
	if (get_timecycle_modifier_index() == -1 && func_335())
	{
		return 1;
	}
	if ((get_timecycle_modifier_index() != -1 && !bParam0) && func_335())
	{
		return 1;
	}
	return 0;
...
void func_463(bool bParam0, var uParam1)
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			activate_interior_entity_set(*uParam1, sVar1);
			_set_interior_entity_set_color(*uParam1, sVar1, Global_4718592.f_162543.f_34[iVar0]);
		}
		else
		{
			deactivate_interior_entity_set(*uParam1, sVar1);
...
int func_471(var uParam0)
{
	...
	request_ipl("xs_arena_interior_vip");
	if (!is_valid_interior(*uParam0))
	{
		Var0 = { func_469(194) };
		iVar1 = get_interior_at_coords_with_type(Var0, Var0.f_3);
	...
	if (is_interior_ready(*uParam0))
	{
		if (is_valid_interior(*uParam0))
		{
			if (!Global_1836151)
			{
				...
				{
					activate_interior_entity_set(*uParam0, "VIP_XMAS_DECS");
				}
				else
				{
					deactivate_interior_entity_set(*uParam0, "VIP_XMAS_DECS");
				}
				refresh_interior(*uParam0);
				Global_1836151 = 1;
			}
...
int func_473()
{
	...
	iVar0 = 1;
	request_named_ptfx_asset("scr_xs_pits");
	if (!has_named_ptfx_asset_loaded("scr_xs_pits"))
	{
		iVar0 = 0;
	}
	if (!request_script_audio_bank("DLC_AWXM2018/Arena_Traps", false, -1))
	{
		iVar0 = 0;
	}
	request_named_ptfx_asset("scr_xs_props");
	if (!has_named_ptfx_asset_loaded("scr_xs_props"))
	{
		iVar0 = 0;
	}
	return iVar0;
	...
	if ((((Global_4718592 == 0 && !func_359(0)) && !func_355()) && !func_377()) && !func_372(Global_4718592.f_116524))
	{
		if (bParam1)
		{
			if (func_388(&Global_2711251))
			{
				...
				if (!func_401())
				{
					if (get_ground_z_for_3d_coord(*uParam0, &uVar1, false, false))
					{
						uParam0->f_2 = uVar1;
					}
				}
...
Vector3 func_480(var uParam0)
{
	...
	{
		Var4 = { func_481(iVar0) };
		iVar3 = absi(round(get_distance_between_coords(*uParam0, Var4, false)));
		if (iVar3 < iVar2)
		{
			iVar1 = iVar0;
			iVar2 = iVar3;
	...
	switch (Global_1966049.f_2)
	{
		...
		case 1:
			if (func_510())
			{
				...
				else if (prepare_music_event("AW_LOBBY_MUSIC_START"))
				{
					func_505();
					Global_1966049.f_2 = 2;
				}
		...
		case 2:
			if (func_510())
			{
				...
				if (func_300() != 57)
				{
					if (func_490() > 4)
					{
						if (does_cam_exist(Global_2714762.f_781))
						{
							if (!func_485(get_cam_coord(Global_2714762.f_781), -194.2056f, -1853.75f, 70.3345f, 3f, 0))
							{
								set_cam_coord(Global_2714762.f_781, -194.2056f, -1853.75f, 70.3345f);
								set_cam_rot(Global_2714762.f_781, -10.0011f, 0f, 131.0271f, 2);
								set_cam_fov(Global_2714762.f_781, 42.6052f);
							}
						}
					}
				}
...
void func_491()
{
	...
	if ((func_504() && func_503() != joaat("am_mp_arena_garage")) || _get_number_of_references_of_script_with_name_hash(joaat("base_lounge_seats")) > 0)
	{
		return;
	}
	bVar1 = true;
	...
	switch (func_490())
	{
		case 1:
			func_96(2);
			set_tv_channel_playlist(1, "AWTV_START", true);
		...
		case 2:
			...
			if (_is_tv_playlist_item_playing(1278133276))
			{
				func_501(func_502(), &sVar2);
				set_tv_channel_playlist(1, &sVar2, true);
				func_96(3);
			}
			else
			{
		...
		case 3:
			if (_is_tv_playlist_item_playing(joaat("END_OF_MOVIE_MARKER")))
			{
		...
		case 5:
			...
			{
				if (_is_tv_playlist_item_playing(Global_2788177))
				{
					Global_2788178 = Global_2788177;
					func_495();
				}
			}
			else if (_is_tv_playlist_item_playing(Global_2788176))
			{
	...
	if (bVar1)
	{
		...
		set_script_gfx_draw_behind_pausemenu(true);
		draw_tv_channel(0.5f, 0.5f, 1f, 1f, 0f, iVar3, iVar3, iVar3, iVar4);
	}
	if (Global_1574938 > 0 && is_warning_message_active())
	{
		func_95();
	}
}
...
int func_493(int iParam0, float fParam1)
{
	...
	iVar0 = absi(get_time_difference(get_network_time(), iParam0));
	fVar1 = (IntToFloat(iVar0) / fParam1);
	return func_494(round(((255f * fVar1) * fVar1)), 0, 255);
}
...
void func_495()
{
	Global_2788181 = get_network_time();
}
...
bool func_504()
{
	return (Global_1946250.f_518 != 0 && _get_number_of_references_of_script_with_name_hash(Global_1946250.f_518) > 0);
}
...
void func_515(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (has_streamed_texture_dict_loaded(sVar0))
	{
		...
		draw_sprite(sVar0, "bg_texture", fVar1, fVar2, fVar3, fVar4, 0f, 255, 255, 255, iParam1, false, 0);
		if (bParam0)
		{
			set_script_gfx_draw_behind_pausemenu(false);
		}
...
void func_516(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		*uParam1 = (Global_1966049.f_7.f_1 + fVar1);
		...
		{
			Global_1966049.f_4 = { get_random_float_in_range(0.4751f, 0.5249f), get_random_float_in_range(0.4751f, 0.5249f), 0f };
		}
		*uParam2 = 1.05f;
		*uParam3 = 1.05f;
	}
...
void func_518(int iParam0)
{
	if (func_519(*iParam0, iParam0->f_3))
	{
		...
		else if (is_audio_scene_active("DLC_MPHEIST_LOBBY_SCENE"))
		{
...
void func_520()
{
	if ((Global_2725867 == 1 || func_629()) || (network_is_activity_session() && func_521(&(Global_1937518.f_58))))
	{
		if (iLocal_184 != 1)
		{
			freeze_microphone();
...
int func_521(var uParam0)
{
	...
	iVar0 = 1;
	if (!is_synchronized_scene_running(uParam0->f_1) && !uParam0->f_407)
	{
		iVar0 = 0;
	}
	return iVar0;
...
void func_523()
{
	if (Global_1659931 >= 0 && Global_1659931 < get_num_unlocked_radio_stations())
	{
		set_radio_to_station_index(Global_1659931);
	}
	else
	{
...
int func_528()
{
	if (func_323(player_id(), 0))
	{
		if (Global_1853348[player_id() /*834*/].f_775 != func_414())
		{
			if (func_413(Global_1853348[player_id() /*834*/].f_775, 0, 1))
			{
				if (func_529(Global_1853348[player_id() /*834*/].f_775, 1, 0))
				{
					return 0;
				}
			}
...
void func_531()
{
	...
	{
		if (!func_435(&uLocal_209) && network_is_activity_session())
		{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (network_is_activity_session())
			{
				...
				{
					func_553();
					if (network_do_transition_to_new_game(false, 32, true))
					{
				...
				{
					func_553();
					if (network_do_transition_to_game(false, 32))
					{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_323(player_id(), 0) && !func_547()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_544(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_555(int iParam0, int iParam1, bool bParam2)
{
	...
	network_session_set_matchmaking_group(iVar0);
	if (iVar0 == 4)
	{
		func_584(1, iParam1);
		set_player_team(player_id(), 8);
	}
	switch (iParam0)
	{
		case 0:
			if ((func_265(player_id()) && network_is_signed_online()) && func_581())
			{
				func_571(iParam1);
			}
			...
			network_session_add_active_matchmaking_group(4);
			network_session_add_active_matchmaking_group(0);
			bVar3 = func_560();
			if (bVar3 > 0)
			{
				network_session_set_matchmaking_property_id(bVar3);
			}
			network_session_set_matchmaking_mental_state(func_558());
			iVar2 = func_557(9, 0);
			iVar1 = func_557(8, 0);
			...
			network_session_set_matchmaking_group_max(0, iVar2);
			network_session_set_matchmaking_group_max(4, iVar1);
			switch (func_556())
			{
				case 3:
					_0xF49ABC20D8552257(2);
					break;
				
				case 4:
					_0xF49ABC20D8552257(3);
					break;
				
				case 5:
					_0xF49ABC20D8552257(4);
					break;
				
				case 2:
					_0xF49ABC20D8552257(1);
					break;
			}
			break;
	}
...
void func_571(int iParam0)
{
	...
	func_572(joaat("mpply_current_crew_rank"), func_573(func_574(player_id()), 1));
}
...
void func_591()
{
	...
	if (network_is_game_in_progress())
	{
		...
		while (bVar0 < 32)
		{
			...
			{
				if ((Global_1853348[iVar3 /*834*/].f_775 == player_id() && func_323(iVar3, 0)) && iVar3 != player_id())
				{
					Var4 = { func_166(iVar3) };
					if (iVar2 < 32)
					{
		...
		{
			func_592(iVar1);
			network_add_followers(&Global_1057413, iVar2);
		}
	}
}
...
void func_592(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		...
		Var0.f_0 = 936426042;
		Var0.f_2 = { func_169() };
		_trigger_script_event_2(1, &Var0, 15, iParam0);
	}
}
...
void func_603(int iParam0)
{
	...
	{
		Var0 = { func_169() };
		if (func_605(Var0) && network_is_activity_spectator_from_handle(&Var0))
		{
			func_604();
		}
	}
...
void func_606(var uParam0, char* sParam1, int iParam2, char* sParam3)
{
	if (*uParam0 == 0)
	{
		if ((((!is_string_null_or_empty(sParam3) && func_302() != -1) && (func_666() || func_667())) && !func_608(func_302())) && (func_607() - 1) > get_cloud_time_as_int())
		{
			begin_text_command_busyspinner_on(sParam3);
			add_text_component_substring_player_name(&(Global_2715699.f_1.f_845[func_302() /*57*/].f_13));
			end_text_command_busyspinner_on(iParam2);
		}
		else
		{
			begin_text_command_busyspinner_on(sParam1);
			end_text_command_busyspinner_on(iParam2);
		}
		*uParam0 = 1;
	}
...
void func_610(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1)
	{
		hide_hud_component_this_frame(17);
	}
	hide_hud_component_this_frame(2);
...
void func_614(var uParam0, bool bParam1, int iParam2)
{
	...
	else if (bParam1)
	{
		...
		else if (!is_audio_scene_active("MP_LOBBY_SCENE"))
		{
...
int func_622(int iParam0)
{
	...
	if (is_interior_disabled(iParam0))
	{
		disable_interior(iParam0, false);
	}
	if (is_interior_capped(iParam0))
	{
		cap_interior(iParam0, false);
	}
	pin_interior_in_memory(iParam0);
	return 1;
}

void func_623()
{
	if (is_pause_menu_active() || is_pause_menu_restarting())
	{
		display_radar(false);
		set_frontend_active(false);
	}
...
void func_636(int iParam0)
{
	...
	if (func_638() == 0 || is_pause_menu_active())
	{
		func_637(1);
...
void func_640(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_638() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_637(0);
...
int func_646()
{
	...
	if (func_605(Var1))
	{
		return network_get_player_from_gamer_handle(&Var1);
	}
	return func_414();
}
	...
	while (iVar0 < 32)
	{
		if (func_648(iVar0))
		{
			*uParam0 = 0;
			...
			{
				Var1 = { func_166(player_id()) };
				if (network_is_handle_valid(&Var1, 13))
				{
					if (network_is_handle_valid(&(Global_2715699.f_1.f_845[iVar0 /*57*/]), 13))
					{
						if (network_are_handles_the_same(&(Global_2715699.f_1.f_845[iVar0 /*57*/]), &Var1))
						{
							*uParam0 = 1;
						}
					}
...
void func_673()
{
	clear_bit(&(Global_1853348[player_id() /*834*/].f_96.f_32), 3);
}
...
void func_675(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, var uParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (func_337(Var0))
		{
			if (func_323(player_id(), 0))
			{
				if (does_entity_exist(func_707()) && !is_entity_dead(func_707(), false))
				{
					Var0 = { get_entity_coords(func_707(), true) };
					Var1 = { 0f, 0f, get_entity_heading(func_707()) };
					if (func_529(Global_1853348[player_id() /*834*/].f_775, 1, 0))
					{
			...
			if ((func_706(player_id()) || func_704(player_id())) && func_703())
			{
				Var0.f_2 = (Var0.f_2 + 1.5f);
			}
			else if (is_valid_interior(get_interior_from_entity(player_ped_id())))
			{
				if (func_706(player_id()))
				{
	...
	{
		iVar6 = func_701(player_id());
		Var0 = { _get_object_offset_from_coords(func_700(iVar6), func_699(iVar6), 3.5688f, 7.9792f, 4.1641f) };
	...
	{
		func_656();
		func_693(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		if (!func_337(Var7))
		{
			Var0 = { Var7 };
		}
		func_688(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		Var1 = { Var7 };
	}
	...
	if (func_717() && !bParam11)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			if (!func_687(player_id()))
			{
				func_540(player_id(), 0, 4, 0);
...
void func_676(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (network_is_game_in_progress())
		{
			...
			if (func_645(player_id()))
			{
				func_540(player_id(), 0, 32768, 0);
			}
			else if (func_677())
			{
				func_540(player_id(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_540(player_id(), 0, 319492, 0);
			}
		}
		else
		{
			func_540(player_id(), 0, 57348, 0);
		}
	}
}
...
Vector3 func_690(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
{
	if (!animpostfx_is_running(func_715(0)))
	{
		animpostfx_play(func_715(iParam0), 0, true);
	}
}
