...
int func_2()
{
	...
	if (func_5(&iLocal_87, 0f))
	{
		...
		if (!is_entity_dead(iLocal_69[iVar0], false))
		{
			iVar1 = get_ped_in_vehicle_seat(iLocal_69[iVar0], -1, false);
			if (!is_ped_injured(iVar1))
			{
				fVar2 = get_random_float_in_range(0.5f, 1f);
				fVar3 = get_random_float_in_range(0f, 0.5f);
				start_vehicle_horn(iLocal_69[iVar0], round((fVar2 * 1000f)), 0, false);
				func_3(&iLocal_87, fVar3);
			}
		}
	}
	if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_85, true) > 100f)
	{
		return 1;
	}
	return 0;
...
int func_11()
{
	...
	if (func_5(&iLocal_87, 0f))
	{
		...
		if (!is_entity_dead(iLocal_69[iVar0], false))
		{
			...
			if (!is_ped_injured(iVar1))
			{
				fVar2 = (get_random_float_in_range(0.5f, 1f) * 2f);
				fVar3 = (get_random_float_in_range(0f, 0.5f) * 2f);
				start_vehicle_horn(iLocal_69[iVar0], round((fVar2 * 1000f)), 0, false);
				func_3(&iLocal_87, fVar3);
			}
		}
	...
	{
		func_13();
		func_12(&iLocal_87, get_random_float_in_range(1.75f, 2.25f));
		return 1;
	}
	if (!func_9(&iLocal_87))
	{
		func_12(&iLocal_87, (get_random_float_in_range(1.75f, 2.25f) * 2f));
	}
	return 0;
}
...
void func_13()
{
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_73[iVar0], false))
		{
			iVar2 = get_ped_in_vehicle_seat(iLocal_73[iVar0], -1, false);
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_77[iVar0], false))
		{
			iVar3 = get_ped_in_vehicle_seat(iLocal_77[iVar0], -1, false);
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_81[iVar0], false))
		{
			iVar4 = get_ped_in_vehicle_seat(iLocal_81[iVar0], -1, false);
...
void func_14(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { 0f, fParam2, 0f };
	Var1 = { get_offset_from_entity_in_world_coords(iParam1, Var0) };
	open_sequence_task(&iVar2);
	task_vehicle_drive_to_coord(0, iParam1, Var1, fParam2, 0, get_entity_model(iParam1), iParam3, 2f, 5f);
	task_vehicle_drive_wander(0, iParam1, fParam2, iParam3);
...
int func_16()
{
	...
	{
		if (!is_player_switch_in_progress() && !func_18())
		{
			return 1;
		}
	}
...
void func_33()
{
	...
	{
		request_model(iLocal_68[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_70)
	{
		request_model(iLocal_70[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_74)
	{
		request_model(iLocal_74[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_78)
	{
		request_model(iLocal_78[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		request_model(iLocal_82[iVar0]);
		iVar0++;
	}
	iVar1 = 0;
	bVar2 = false;
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_68)
		{
			if (!has_model_loaded(iLocal_68[iVar0]))
			{
				request_model(iLocal_68[iVar0]);
				bVar2 = false;
			}
		...
		while (iVar0 < 12)
		{
			...
			{
				if (!has_model_loaded(iLocal_70[iVar0]))
				{
					request_model(iLocal_70[iVar0]);
					bVar2 = false;
				}
				...
				{
					clear_area(Local_85 + Local_71[iVar0 /*3*/], 10f, true, false, false, false);
					iLocal_69[iVar0] = create_vehicle(iLocal_70[iVar0], Local_85 + Local_71[iVar0 /*3*/], (fLocal_86 + uLocal_72[iVar0]), true, true, false);
					set_entity_lod_dist(iLocal_69[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_69[iVar0], 2f);
					_set_entity_cleanup_by_engine(iLocal_69[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!does_entity_exist(iLocal_73[iVar0]))
			{
				if (!has_model_loaded(iLocal_74[iVar0]))
				{
					request_model(iLocal_74[iVar0]);
					bVar2 = false;
				}
				...
				{
					clear_area(Local_85 + Local_75[iVar0 /*3*/], 10f, true, false, false, false);
					iLocal_73[iVar0] = create_vehicle(iLocal_74[iVar0], Local_85 + Local_75[iVar0 /*3*/], (fLocal_86 + uLocal_76[iVar0]), true, true, false);
					set_entity_lod_dist(iLocal_73[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_73[iVar0], 2f);
					_set_entity_cleanup_by_engine(iLocal_73[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!does_entity_exist(iLocal_77[iVar0]))
			{
				if (!has_model_loaded(iLocal_78[iVar0]))
				{
					request_model(iLocal_78[iVar0]);
					bVar2 = false;
				}
				...
				{
					clear_area(Local_85 + Local_79[iVar0 /*3*/], 10f, true, false, false, false);
					iLocal_77[iVar0] = create_vehicle(iLocal_78[iVar0], Local_85 + Local_79[iVar0 /*3*/], (fLocal_86 + uLocal_80[iVar0]), true, true, false);
					set_entity_lod_dist(iLocal_77[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_77[iVar0], 2f);
					_set_entity_cleanup_by_engine(iLocal_77[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			...
			{
				if (!has_model_loaded(iLocal_82[iVar0]))
				{
					request_model(iLocal_82[iVar0]);
					bVar2 = false;
				}
				...
				{
					clear_area(Local_85 + Local_83[iVar0 /*3*/], 10f, true, false, false, false);
					iLocal_81[iVar0] = create_vehicle(iLocal_82[iVar0], Local_85 + Local_83[iVar0 /*3*/], (fLocal_86 + uLocal_84[iVar0]), true, true, false);
					set_entity_lod_dist(iLocal_81[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_81[iVar0], 2f);
					_set_entity_cleanup_by_engine(iLocal_81[iVar0], true);
				}
			}
			iVar0++;
		}
	...
	while (iVar0 < 12)
	{
		if (!is_entity_dead(iLocal_69[iVar0], false))
		{
			iVar3 = create_ped_inside_vehicle(iLocal_69[iVar0], 4, iLocal_68[func_36()], -1, true, true);
			func_34(iVar3);
			_set_entity_cleanup_by_engine(iLocal_69[iVar0], true);
			_set_entity_cleanup_by_engine(iVar3, true);
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_73[iVar0], false))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_73[iVar0]) > 0)
			{
				iVar4 = create_ped_inside_vehicle(iLocal_73[iVar0], 4, iLocal_68[func_36()], -1, true, true);
				func_34(iVar4);
				_set_entity_cleanup_by_engine(iLocal_69[iVar0], true);
				_set_entity_cleanup_by_engine(iVar4, true);
				set_model_as_no_longer_needed(iLocal_74[iVar0]);
			}
		}
		iVar0++;
	}
	if (!get_vehicle_max_number_of_passengers(iLocal_73[2]) > 0)
	{
		attach_vehicle_to_trailer(iLocal_73[0], iLocal_73[2], 1f);
	}
	if (!get_vehicle_max_number_of_passengers(iLocal_73[3]) > 0)
	{
		attach_vehicle_to_trailer(iLocal_73[1], iLocal_73[3], 1f);
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_77[iVar0], false))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_77[iVar0]) > 0)
			{
				iVar5 = create_ped_inside_vehicle(iLocal_77[iVar0], 4, iLocal_68[func_36()], -1, true, true);
				func_34(iVar5);
				_set_entity_cleanup_by_engine(iLocal_69[iVar0], true);
				_set_entity_cleanup_by_engine(iVar5, true);
				set_model_as_no_longer_needed(iLocal_78[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_81[iVar0], false))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_81[iVar0]) > 0)
			{
				iVar6 = create_ped_inside_vehicle(iLocal_81[iVar0], 4, iLocal_68[func_36()], -1, true, true);
				func_34(iVar6);
				_set_entity_cleanup_by_engine(iLocal_69[iVar0], true);
				_set_entity_cleanup_by_engine(iVar6, true);
				set_model_as_no_longer_needed(iLocal_82[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_68)
	{
		set_model_as_no_longer_needed(iLocal_68[iVar0]);
		iVar0++;
	}
}
...
void func_34(int iParam0)
{
	...
	if (get_entity_model(iParam0) == joaat("a_m_m_salton_01"))
	{
		if (get_ped_drawable_variation(iParam0, 3) == 1)
		{
			if (func_35())
			{
				set_ped_component_variation(iParam0, 3, 0, get_ped_texture_variation(iParam0, 3), 0);
			}
			else
			{
				set_ped_component_variation(iParam0, 3, 2, get_ped_texture_variation(iParam0, 3), 0);
			}
		}
	}
}
...
int func_36()
{
	...
	iVar0 = get_random_int_in_range(0, iLocal_68);
	if (has_model_loaded(iLocal_68[iVar0]))
	{
		return iVar0;
	}
	...
	{
		if (has_model_loaded(iLocal_68[iVar2]))
		{
	...
	switch (iParam0)
	{
		...
		case 209:
			...
			*(uParam12[0 /*3*/]) = { Vector(0f, -18.4198f, 12.4248f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[0] = (-42.9526f + get_random_float_in_range(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(0f, 6.1436f, -6.4904f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[1] = (0f + get_random_float_in_range(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, -46.6f, 15.2f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[2] = (74.0878f + get_random_float_in_range(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, -43.7f, 9f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[3] = (-102.24f + get_random_float_in_range(-5f, 5f));
			break;
		...
		case 210:
			...
			*(uParam12[0 /*3*/]) = { Vector(0f, -8.466f, -3.4877f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[0] = (-10.26f + get_random_float_in_range(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(0f, 5.6192f, -2.7229f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[1] = (2.3194f + get_random_float_in_range(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, 5.1081f, 6.8717f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[2] = (350.1767f + get_random_float_in_range(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, -9.6576f, 0.997f) + func_45(-1090519040, 1056964608) };
			(*uParam13)[3] = (349.0776f + get_random_float_in_range(-5f, 5f));
			break;
		...
		default:
			...
			while (iVar6 < *uParam12)
			{
				...
				*(uParam12[iVar6 /*3*/]) = { 0f, 0f, 0f };
				(*uParam13)[iVar6] = get_random_float_in_range(0f, 360f);
				iVar6++;
			}
			break;
	}
...
void func_39(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	(*uParam3)[0] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
	(*uParam3)[1] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
	(*uParam3)[2] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
	(*uParam3)[3] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
	iVar2 = 0;
	while (iVar2 < *uParam4)
	{
		(*uParam4)[iVar2] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
		iVar2++;
	}
}
...
void func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	while (iVar0 < *uParam4)
	{
		(*uParam4)[iVar0] = (*uParam1)[get_random_int_in_range(0, *uParam1)];
		iVar0++;
	}
}
...
{
	return get_random_float_in_range(fParam0, fParam1), get_random_float_in_range(fParam0, fParam1), 0f;
}
...
void func_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	*(uParam0[1 /*3*/]) = { Vector(0f, -21.4697f, -0.889f) + func_45(-1090519040, 1056964608) };
	...
	while (iVar1 <= (*uParam0 - 1))
	{
		...
		*(uParam0[iVar1 /*3*/]) = { *(uParam0[iVar1 /*3*/]) + func_45(-1090519040, 1056964608) };
		(*uParam1)[iVar1] = get_random_float_in_range(-22f, -15f);
		iVar1++;
	}
	...
	*(uParam4[3 /*3*/]) = { Vector(-12.7f, -10.9f, -13.4f) + func_45(-1090519040, 1056964608) };
	(*uParam1)[0] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[1] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[2] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[3] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[4] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[5] = get_random_float_in_range(-22f, -15f);
	(*uParam1)[6] = get_random_float_in_range(-22f, -15f);
	(*uParam3)[0] = get_random_float_in_range(-22f, -15f);
	(*uParam3)[1] = get_random_float_in_range(-22f, -15f);
	(*uParam3)[2] = get_random_float_in_range(-22f, -15f);
	(*uParam3)[3] = get_random_float_in_range(-22f, -15f);
	(*uParam5)[0] = get_random_float_in_range(-6f, 4f);
	(*uParam5)[1] = get_random_float_in_range(-16f, -6f);
	(*uParam5)[2] = get_random_float_in_range(-38f, -28f);
	(*uParam5)[3] = get_random_float_in_range(-28f, -18f);
}
...
void func_56()
{
	...
	{
		set_vehicle_as_no_longer_needed(&(iLocal_69[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_73)
	{
		set_vehicle_as_no_longer_needed(&(iLocal_73[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	...
	{
		set_vehicle_as_no_longer_needed(&(iLocal_81[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_68)
