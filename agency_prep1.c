...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_974)
		{
			if (!is_entity_at_coord(player_ped_id(), Local_971, 200f, 200f, 200f, false, true, 0) && !is_sphere_visible(Local_971, 50f))
			{
				clear_area(Local_971, 50f, true, false, false, false);
				iLocal_974 = 1;
			}
		}
		else if (!is_entity_at_coord(player_ped_id(), Local_971, 200f, 200f, 200f, false, true, 0))
		{
			iLocal_974 = 0;
		}
		if (!iLocal_979)
		{
			if (Global_96938.f_358 == get_hash_key("AHP1_TRUCKCALLED") || Global_96868)
			{
				func_98(543);
		...
		while (iVar0 <= 7)
		{
			if ((does_entity_exist(iLocal_802[iVar0]) && !is_ped_injured(iLocal_802[iVar0])) && does_entity_exist(iLocal_800))
			{
				if (vdist2(get_entity_coords(iLocal_802[iVar0], true), get_entity_coords(player_ped_id(), true)) > 2500f)
				{
					set_ped_keep_task(iLocal_802[iVar0], true);
					task_smart_flee_ped(iLocal_802[iVar0], player_ped_id(), 300f, 20000, true, false);
					set_ped_as_no_longer_needed(&(iLocal_802[iVar0]));
				}
			}
			iVar0++;
		}
		...
		switch (iLocal_969)
		{
			case -1:
				...
				{
					if (does_entity_exist(iLocal_802[iVar1]))
					{
						if (does_entity_exist(get_vehicle_ped_is_entering(player_ped_id())))
						{
							iVar2 = get_vehicle_ped_is_entering(player_ped_id());
							if ((is_vehicle_driveable(iVar2, false) && vdist(get_entity_coords(player_ped_id(), true), get_entity_coords(iVar2, true)) < 30f) && is_vehicle_model(iVar2, joaat("firetruk")))
							{
								set_relationship_between_groups(5, joaat("player"), iLocal_803);
								set_relationship_between_groups(5, iLocal_803, joaat("player"));
			...
			case 0:
				if (!does_entity_exist(iLocal_800))
				{
					func_94();
					if ((does_entity_exist(get_players_last_vehicle()) && is_vehicle_driveable(get_players_last_vehicle(), false)) && get_entity_model(get_players_last_vehicle()) == joaat("firetruk"))
					{
						iLocal_800 = get_players_last_vehicle();
						set_entity_as_mission_entity(iLocal_800, true, true);
					}
				}
				else
				{
					func_45();
					if (!iLocal_975 && is_vehicle_driveable(iLocal_800, false))
					{
					...
					if (vdist2(get_entity_coords(player_ped_id(), true), Local_971) < pow(100f, 2f))
					{
					...
					if (bLocal_980)
					{
						if (is_vehicle_driveable(iLocal_800, false) && is_vehicle_driveable(iLocal_801, false))
						{
							func_36(iLocal_801);
							if (is_ped_sitting_in_vehicle(player_ped_id(), iLocal_801) && is_entity_at_coord(iLocal_800, Local_971, Global_19, true, true, 0))
							{
								if (does_blip_exist(iLocal_798))
								{
									remove_blip(&iLocal_798);
								}
					...
					else if (is_vehicle_driveable(iLocal_800, false))
					{
						func_36(iLocal_800);
						if (is_ped_sitting_in_vehicle(player_ped_id(), iLocal_800) && is_entity_at_coord(iLocal_800, Local_971, Global_19, true, true, 0))
						{
							if (does_blip_exist(iLocal_798))
							{
								remove_blip(&iLocal_798);
				...
				{
					if ((vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_800, true)) > 22500f && is_entity_occluded(iLocal_800)) || vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_800, true)) > 90000f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
			...
			case 1:
				if (is_vehicle_driveable(iLocal_800, false))
				{
			...
			case 2:
				if (is_vehicle_driveable(iLocal_800, false))
				{
					if (!is_entity_at_coord(iLocal_800, Local_971, Global_19 + Vector(2f, 2f, 2f), true, true, 0))
					{
						iLocal_969 = 0;
					}
					else if (bLocal_980)
					{
						if (does_entity_exist(iLocal_801))
						{
							if (!is_entity_attached_to_entity(iLocal_801, iLocal_800))
							{
								set_vehicle_automatically_attaches(iLocal_800, false, 0);
								if (is_vehicle_siren_on(iLocal_800))
								{
									set_vehicle_siren(iLocal_800, false);
								}
								set_vehicle_doors_locked(iLocal_800, 2);
								clear_prints();
								settimera(0);
								iLocal_969++;
							}
							...
							{
								detach_vehicle_from_tow_truck(iLocal_801, iLocal_800);
							}
						}
					}
					else if (!is_ped_in_vehicle(player_ped_id(), iLocal_800, false))
					{
						if (is_vehicle_siren_on(iLocal_800))
						{
							set_vehicle_siren(iLocal_800, false);
			...
			case 101:
				...
				if (!iLocal_981)
				{
					if ((is_vehicle_driveable(iLocal_800, false) && is_ped_in_vehicle(player_ped_id(), iLocal_800, false)) || (is_vehicle_driveable(iLocal_801, false) && is_ped_in_vehicle(player_ped_id(), iLocal_801, false)))
					{
						if ((is_entity_in_zone(player_ped_id(), "DAVIS") && get_entity_speed(player_ped_id()) > 5f) && get_player_wanted_level(player_id()) > 0)
						{
							if (func_3())
							{
				...
				else if (is_vehicle_driveable(iLocal_800, false))
				{
					...
					else if (is_ped_sitting_in_vehicle(player_ped_id(), iLocal_800))
					{
						if (!iLocal_977)
						{
							func_11("AHP_LOSECOPS", 7500, 1);
							iLocal_977 = 1;
							iLocal_970 = get_game_timer();
						}
					}
					else if ((iLocal_977 && (get_game_timer() - iLocal_970) < 7500) && is_message_being_displayed())
					{
						clear_prints();
					}
					if (vdist2(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_800, true)) > 22500f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
...
void func_14(char* sParam0)
{
	...
	if (does_entity_exist(iLocal_800))
	{
		if (!is_ped_in_vehicle(player_ped_id(), iLocal_800, false))
		{
			delete_vehicle(&iLocal_800);
		}
	}
	iVar0 = 0;
	while (iVar0 < iLocal_802)
	{
		if (does_entity_exist(iLocal_802[iVar0]))
		{
			delete_ped(&(iLocal_802[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Global_96938.f_9)
	{
		...
		{
			delete_ped(&(Global_96938.f_9[iVar0]));
		}
		iVar0++;
	}
...
int func_17()
{
	if (does_entity_exist(player_ped_id()))
	{
		...
		{
			if (is_entity_in_angled_area(player_ped_id(), 226.6765f, -1668.942f, 25.46082f, 185.6446f, -1635.836f, 39.29184f, 57.75f, false, true, 0))
			{
				return 1;
			}
		}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		if (get_player_wanted_level(player_id()) > 0)
		{
			if (is_vehicle_driveable(iParam0, false))
			{
				...
				{
					if (does_blip_exist(iLocal_799))
					{
						remove_blip(&iLocal_799);
					}
				}
				else if (!does_blip_exist(iLocal_799))
				{
					iLocal_799 = func_40(iParam0, 0, 0);
				}
			}
		}
		else if (is_ped_in_vehicle(player_ped_id(), iParam0, false))
		{
			if (does_blip_exist(iLocal_799))
			{
				remove_blip(&iLocal_799);
...
int func_37(struct<3> Param0, bool bParam1)
{
	...
	set_blip_scale(iVar0, func_38(network_is_game_in_progress(), 1f, 1f));
...
int func_41(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_38(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
void func_45()
{
	...
	if (!is_player_switch_in_progress())
	{
		...
		{
			case 0:
				if ((is_vehicle_driveable(iVar0, false) && is_ped_in_vehicle(player_ped_id(), iVar0, false)) && get_player_wanted_level(player_id()) == 0)
				{
					iVar1 = 0;
					while (iVar1 < 3)
					{
						iVar2 = func_92(iVar1);
						if ((!is_ped_injured(iVar2) && is_ped_in_vehicle(iVar2, iVar0, false)) && get_ped_in_vehicle_seat(iVar0, -1, false) == iVar2)
						{
			...
			case 1:
				...
				{
					if ((((is_ped_injured(func_92(iLocal_983)) || get_ped_in_vehicle_seat(iVar0, -1, false) != func_92(iLocal_983)) || !is_ped_in_vehicle(func_92(iLocal_983), iVar0, false)) || !func_91(func_92(iLocal_983))) || !is_ped_in_vehicle(player_ped_id(), iVar0, false))
					{
					...
					else
					{
						switch (iLocal_1003)
						{
							...
							case 1:
								if (are_nodes_loaded_for_area(Local_986.f_0, Local_986.f_1, Local_988.f_0, Local_988.f_1))
								{
									iLocal_1003++;
								}
								break;
							...
							case 2:
								task_vehicle_drive_to_coord(func_92(iLocal_983), iVar0, Local_971, 15f, 0, joaat("firetruk"), 786484, 5f, 5f);
								if (vdist(get_entity_coords(iVar0, true), Local_971) > 250f)
								{
									set_vehicle_custom_path_node_streaming_radius(iVar0, vdist(get_entity_coords(iLocal_800, true), Local_971));
								}
								iLocal_1003++;
								break;
							
							case 3:
								if (is_entity_in_angled_area(iVar0, 697.6884f, -1013.364f, 27.4968f, 688.3482f, -1013.179f, 22.32968f, 29.25f, false, true, 0))
								{
									if (vdist(get_entity_coords(iVar0, true), Local_984) < vdist(get_entity_coords(iVar0, true), Local_985))
									{
										if (bLocal_980)
										{
											task_vehicle_drive_to_coord(func_92(iLocal_983), iVar0, Local_985, 5f, 0, get_entity_model(iVar0), 262144, 2f, 2f);
										}
										else
										{
											task_vehicle_park(func_92(iLocal_983), iVar0, Local_971, 180f, 1, 15f, false);
										}
									}
									else if (bLocal_980)
									{
										task_vehicle_drive_to_coord(func_92(iLocal_983), iVar0, Local_984, 5f, 0, get_entity_model(iVar0), 262144, 2f, 2f);
									}
									else
									{
										task_vehicle_park(func_92(iLocal_983), iVar0, Local_971, 0f, 1, 15f, false);
									}
									iLocal_1003++;
								}
								break;
...
void func_46()
{
	...
	bVar0 = false;
	if (!is_ped_injured(func_92(iLocal_983)) && get_player_wanted_level(player_id()) == 0)
	{
		if ((((does_entity_exist(iLocal_800) && is_vehicle_driveable(iLocal_800, false)) && is_ped_in_vehicle(player_ped_id(), iLocal_800, false)) && is_ped_in_vehicle(func_92(iLocal_983), iLocal_800, false)) || (((does_entity_exist(iLocal_801) && is_vehicle_driveable(iLocal_801, false)) && is_ped_in_vehicle(player_ped_id(), iLocal_801, false)) && is_ped_in_vehicle(func_92(iLocal_983), iLocal_801, false)))
		{
			bVar0 = true;
		}
	}
	switch (iLocal_990)
	{
		case 0:
			...
			if (func_71(0, 1, 145, 0, uVar1, &cLocal_991, &cLocal_995, 1))
			{
				...
				if (func_28() == 1)
				{
					...
					func_69(&uLocal_804, 1, player_ped_id(), "FRANKLIN", 0, 1);
				}
				else
				{
					func_69(&uLocal_804, 1, func_92(1), "FRANKLIN", 0, 1);
					func_69(&uLocal_804, 0, player_ped_id(), "MICHAEL", 0, 1);
				}
				if (!iLocal_1000)
				{
		...
		case 1:
			if (bVar0)
			{
				if ((get_game_timer() - iLocal_1002) > 5000 || iLocal_1000)
				{
		...
		case 2:
			...
			if (is_player_switch_in_progress() || (!bLocal_999 && !func_49()))
			{
				func_47();
				iLocal_990 = 3;
				iLocal_1002 = get_game_timer();
		...
		case 3:
			if ((get_game_timer() - iLocal_1002) > 10000)
			{
				iLocal_990 = 0;
			}
			break;
...
int func_85()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (func_86(get_entity_coords(player_ped_id(), true)))
		{
			set_bit(&iVar0, 20);
		}
	}
...
int func_94()
{
	if (((is_ped_in_any_vehicle(player_ped_id(), false) && is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), false), false)) && get_vehicle_ped_is_in(player_ped_id(), false) != iLocal_800) && get_vehicle_ped_is_in(player_ped_id(), false) != iLocal_801)
	{
		if (is_vehicle_model(get_vehicle_ped_is_in(player_ped_id(), false), joaat("firetruk")))
		{
			iLocal_800 = get_vehicle_ped_is_in(player_ped_id(), false);
			set_entity_as_mission_entity(iLocal_800, true, true);
			iLocal_975 = 0;
			return 1;
		}
		...
		{
			if (does_entity_exist(get_entity_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false))))
			{
				if (is_vehicle_driveable(get_vehicle_index_from_entity_index(get_entity_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false))), false))
				{
					iLocal_801 = get_vehicle_ped_is_in(player_ped_id(), false);
					set_entity_as_mission_entity(iLocal_801, true, true);
					if (get_vehicle_index_from_entity_index(get_entity_attached_to_tow_truck(iLocal_801)) != iLocal_800)
					{
						iLocal_800 = get_vehicle_index_from_entity_index(get_entity_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false)));
						iLocal_975 = 0;
						set_entity_as_mission_entity(iLocal_800, true, true);
					}
					return 1;
...
void func_95()
{
	...
	if (iLocal_1004 < 8)
	{
		if (iLocal_1004 < 4)
		{
			if (does_entity_exist(Global_96938.f_9[iLocal_1004]))
			{
				if (!is_ped_injured(Global_96938.f_9[iLocal_1004]))
				{
					if (vdist2(get_entity_coords(Global_96938.f_9[iLocal_1004], true), get_entity_coords(player_ped_id(), true)) < 900f)
					{
						set_entity_as_mission_entity(Global_96938.f_9[iLocal_1004], true, true);
						iLocal_802[iLocal_1004] = Global_96938.f_9[iLocal_1004];
						bVar0 = true;
						Global_96938.f_9[iLocal_1004] = 0;
					}
					else if (vdist2(get_entity_coords(Global_96938.f_9[iLocal_1004], true), get_entity_coords(player_ped_id(), true)) > 2500f && is_entity_occluded(Global_96938.f_9[iLocal_1004]))
					{
						set_entity_as_mission_entity(Global_96938.f_9[iLocal_1004], true, true);
						delete_ped(&(Global_96938.f_9[iLocal_1004]));
					}
				}
			}
		}
		if (!bVar0)
		{
			if (get_closest_ped(get_entity_coords(player_ped_id(), true), 30f, true, true, &iVar1, false, true, 21))
			{
				if ((does_entity_exist(iVar1) && !is_ped_injured(iVar1)) && !func_96(iVar1, &iLocal_802))
				{
		...
		if (bVar0)
		{
			if (!is_ped_injured(iLocal_802[iLocal_1004]))
			{
				set_ped_relationship_group_hash(iLocal_802[iLocal_1004], iLocal_803);
				set_player_wanted_level_no_drop(player_id(), 1, false);
				set_ped_combat_attributes(iLocal_802[iLocal_1004], 17, false);
				set_wanted_level_difficulty(player_id(), 0f);
			}
			iLocal_1004++;
		}
...
void func_97()
{
	if (bLocal_980)
	{
		if (((!is_vehicle_driveable(iLocal_801, false) || (is_vehicle_driveable(iLocal_801, false) && !is_entity_attached_to_entity(iLocal_800, iLocal_801))) || (is_vehicle_driveable(iLocal_800, false) && is_ped_in_vehicle(player_ped_id(), iLocal_800, false))) || (does_entity_exist(iLocal_801) && vdist(get_entity_coords(player_ped_id(), true), get_entity_coords(iLocal_801, true)) > 250f))
		{
			bLocal_980 = false;
		}
	}
	else if ((is_vehicle_driveable(iLocal_801, false) && is_ped_in_vehicle(player_ped_id(), iLocal_801, false)) && is_entity_attached_to_entity(iLocal_800, iLocal_801))
	{
		bLocal_980 = true;
	}
}
...
void func_99()
{
	...
	if ((does_entity_exist(Global_96938[0]) && is_vehicle_driveable(Global_96938[0], false)) && is_ped_in_vehicle(player_ped_id(), Global_96938[0], false))
	{
		set_entity_as_mission_entity(Global_96938[0], true, true);
		iLocal_800 = Global_96938[0];
		Global_96938[0] = 0;
	}
	if ((does_entity_exist(Global_96938[1]) && is_vehicle_driveable(Global_96938[1], false)) && is_ped_in_vehicle(player_ped_id(), Global_96938[1], false))
	{
		if (does_entity_exist(get_entity_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false))) && is_vehicle_driveable(get_vehicle_index_from_entity_index(get_entity_attached_to_tow_truck(get_vehicle_ped_is_in(player_ped_id(), false))), false))
		{
	...
	add_relationship_group("FireMen", &iLocal_803);
	set_relationship_between_groups(5, joaat("player"), iLocal_803);
	set_relationship_between_groups(5, iLocal_803, joaat("player"));
	if (func_10(0))
	{
		...
		iLocal_1005 = add_scenario_blocking_area(Var0 - Vector(10f, 30f, 30f), Var0 + Vector(10f, 30f, 30f), false, true, true, true);
		clear_area(Var0, 20f, true, false, false, false);
		iLocal_802[0] = create_ped(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, true, true);
		iLocal_802[1] = create_ped(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, true, true);
		iLocal_802[2] = create_ped(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, true, true);
		iVar1 = 0;
		while (iVar1 <= (iLocal_802 - 1))
		{
			if (!is_ped_injured(iLocal_802[iVar1]))
			{
				task_start_scenario_in_place(iLocal_802[iVar1], "WORLD_HUMAN_HANG_OUT_STREET", 0, false);
				set_ped_combat_attributes(iLocal_802[iVar1], 17, false);
				set_ped_relationship_group_hash(iLocal_802[iVar1], iLocal_803);
			}
			iVar1++;
		}
		set_relationship_between_groups(255, joaat("player"), iLocal_803);
		set_relationship_between_groups(255, iLocal_803, joaat("player"));
		iLocal_969 = -1;
		if (func_106())
		{
...
void func_107()
{
	...
	if (does_entity_exist(iLocal_800))
	{
		set_vehicle_as_no_longer_needed(&iLocal_800);
	}
	remove_scenario_blocking_area(iLocal_1005, false);
