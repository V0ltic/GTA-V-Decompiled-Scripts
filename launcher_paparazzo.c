...
void func_150()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_151(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_168()
{
	return func_169(get_this_script_name(), 0);
}
...
int func_172(struct<3> Param0, bool bParam1)
{
	...
	set_blip_scale(iVar0, func_173(network_is_game_in_progress(), 1f, 1f));
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_194(player_ped_id(), Param2, 1) <= 100f)
				{
					func_193(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_194(player_ped_id(), Param2, 1) > 120f)
				{
					func_196(iParam0);
				}
			}
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && !func_148()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_194(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_215(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_217(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_223(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_223(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_241()
{
	return add_scenario_blocking_area(-74.8392f, 300.5241f, 104f, -62.467f, 318.6961f, 109f, false, true, true, true);
}
...
int func_243(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !has_anim_dict_loaded(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_41[0]))
			{
				...
				if (func_129(uParam0->f_28[0]) && does_entity_exist(uParam0->f_41[0]))
				{
			...
			if (!does_entity_exist(uParam0->f_41[1]))
			{
				...
				if (func_129(uParam0->f_28[1]) && does_entity_exist(uParam0->f_41[1]))
				{
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_209(iParam0);
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_248(iParam0);
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_254(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			set_vehicle_colour_combination(uParam0->f_35[0], 2);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_255(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !has_anim_dict_loaded(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_128(uParam0->f_28[0]))
			{
				...
				{
					func_244(&(uParam0->f_41[3]), iVar0[1], get_offset_from_entity_in_world_coords(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_129(uParam0->f_41[0]))
			{
				iLocal_54 = create_synchronized_scene(get_entity_coords(uParam0->f_41[0], true), get_entity_rotation(uParam0->f_41[0], 2), 2);
				play_synchronized_entity_anim(uParam0->f_41[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1000f);
				set_synchronized_scene_looped(iLocal_54, true);
				if (func_129(uParam0->f_28[0]))
				{
					task_synchronized_scene(uParam0->f_28[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_129(uParam0->f_41[1]))
				{
					play_synchronized_entity_anim(uParam0->f_41[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1000f);
				}
				if (func_129(uParam0->f_41[2]))
				{
					play_synchronized_entity_anim(uParam0->f_41[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1000f);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_256(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_252(&iVar0) || !has_anim_dict_loaded("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_128(uParam0->f_28[0]))
			{
				if (!does_entity_exist(uParam0->f_41[0]))
				{
					func_244(&(uParam0->f_41[0]), iVar0[2], get_offset_from_entity_in_world_coords(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_129(uParam0->f_41[0]))
					{
						...
						set_model_as_no_longer_needed(iVar0[2]);
					}
					else
					{
						bVar2 = false;
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				set_vehicle_colour_combination(uParam0->f_35[0], 7);
				...
				set_vehicle_number_plate_text(uParam0->f_35[0], "P4P4R4Z0");
		...
		case 3:
			if (func_129(uParam0->f_28[0]) && func_129(player_ped_id()))
			{
				task_look_at_entity(uParam0->f_28[0], player_ped_id(), -1, 0, 2);
				iLocal_54 = create_synchronized_scene(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				set_synchronized_scene_looped(iLocal_54, true);
				task_synchronized_scene(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1000f, 0);
			...
			clear_area_of_peds(-70.12f, 298.33f, 105.25f, 30f, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				set_model_as_no_longer_needed(iVar0[iVar1]);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				if (func_180(uParam0->f_35[0]))
				{
					set_vehicle_colours(uParam0->f_35[0], 62, 62);
				}
				else
				{
					bVar2 = false;
		...
		case 3:
			if (func_129(uParam0->f_28[0]))
			{
				if (has_anim_dict_loaded("rcmpaparazzo1beckon"))
				{
					...
					task_play_anim(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0f, false, false, false);
					task_play_anim(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0f, false, false, false);
...
void func_258(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				set_all_vehicle_generators_active_in_area(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, false, true);
				remove_vehicles_from_generators_in_area(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				set_all_vehicle_generators_active_in_area(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, true, true);
			}
			break;
	}
}
...
void func_272(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			case 46:
				set_model_as_no_longer_needed(iLocal_53);
				func_274(iParam0, 0, 0, 0);
				break;
			
			case 47:
				set_scenario_type_enabled("WORLD_HUMAN_PAPARAZZI", true);
				remove_scenario_blocking_area(iLocal_56, false);
				func_274(iParam0, 0, 0, 0);
				break;
			
			case 48:
				remove_model_hide(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				remove_model_hide(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				remove_model_hide(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (_get_number_of_references_of_script_with_name_hash(joaat("paparazzo3")) > 0)
			{
				wait(0);
			}
		}
