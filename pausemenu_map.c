		...
		case 3:
			while (true)
			{
				...
				if (is_frontend_ready_for_control())
				{
					iVar2 = 1;
					func_296();
					iLocal_179 = get_new_selected_mission_creator_blip();
					...
					if (does_blip_exist(iLocal_179))
					{
						...
						{
							if (is_mission_creator_blip(iLocal_179))
							{
								if (Global_78319)
								{
					...
					if (Global_77137.f_577)
					{
						...
						else
						{
							...
							_set_player_blip_position_this_frame(Global_77137.f_578, Global_77137.f_578.f_1);
						}
					}
					if (Global_78319)
					{
...
void func_1()
{
	...
	{
		set_streamed_texture_dict_as_no_longer_needed(func_2());
		clear_bit(&Global_1976978, 0);
	}
}
...
void func_3()
{
	...
	if (Global_1976978.f_3 == 0)
	{
		if (does_blip_exist(iLocal_180))
		{
			if (is_mission_creator_blip(iLocal_180) && func_244(iLocal_180))
			{
				...
				if (iVar0 != -1 && func_4(iVar0))
				{
					if (is_control_just_pressed(2, 203))
					{
						...
						set_bit(&(Global_1976978.f_3), iVar0);
...
void func_5()
{
	...
	if (Local_226.f_11 == 1)
	{
		...
		if (Local_227.f_4 == 0)
		{
			...
			{
				StringCopy(&(Local_226.f_5), texture_download_get_name(Local_227.f_0), 24);
				if (!is_string_null_or_empty(&(Local_226.f_5)) && Local_227.f_4 == 1)
				{
				...
				else
				{
					...
					else if (get_hash_of_map_area_at_coords(Local_181) == joaat("City"))
					{
...
void func_6(int iParam0, char* sParam1, char* sParam2, int iParam3, char* sParam4, char* sParam5, bool bParam6, int iParam7, int iParam8, int iParam9, char* sParam10, bool bParam11, int iParam12, int iParam13)
{
	...
	if (begin_scaleform_movie_method_on_frontend("SET_COLUMN_TITLE"))
	{
		...
		bVar7 = true;
		bVar8 = true;
		if ((iParam8 > -1 && !is_string_null_or_empty(sParam10)) && !Global_262145.f_8572)
		{
			...
			else
			{
				...
				if (iVar10 == 27)
				{
					if (func_13(player_id()) && func_12())
					{
						iVar0 = get_hash_key(&(Global_1048576.f_44));
						iVar10 = func_15(iVar0);
					}
				}
			...
			if (bVar6)
			{
				...
				add_text_component_float(fVar1, 0);
			...
			{
				begin_text_command_scaleform_string("PM_MULTI");
				add_text_component_float(fVar2, 0);
				end_text_command_scaleform_string();
			}
			else
			{
			...
			{
				begin_text_command_scaleform_string("PM_MULTI");
				add_text_component_float(fVar3, 0);
				end_text_command_scaleform_string();
			}
			else
			{
...
int func_43()
{
	...
	if (iVar0 == -1)
	{
		iVar1 = (get_cloud_time_as_int() - Global_262145.f_26776);
		if (iVar1 < 0)
		{
			iVar1 = absi(iVar1);
		}
...
int func_45()
{
	...
	if (iVar0 == -1)
	{
		iVar1 = (get_cloud_time_as_int() - Global_262145.f_10730);
		if (iVar1 < 0)
		{
			iVar1 = (iVar1 * -1);
		}
...
int func_47(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			if (iParam5 && is_string_null_or_empty(sParam1))
			{
				return 0;
			}
			if (iParam2 == -1)
			...
			*uParam0 = ugc_texture_download_request(sParam1, iParam4, iParam2, 0, sParam1, false);
			uParam0->f_1 = 2;
			break;
		
		case 2:
			switch (get_status_of_texture_download(*uParam0))
			{
				case 1:
					return 0;
...
void func_50()
{
	...
	if (iLocal_228 == 0)
	{
		if (iLocal_229 == 0)
		{
			if (does_blip_exist(iLocal_180))
			{
				if (is_mission_creator_blip(iLocal_180))
				{
					take_control_of_frontend();
					if (is_control_just_pressed(2, 203))
					{
		...
		else
		{
			...
			if (is_control_just_released(2, 202) || _0xD313DE83394AF134())
			{
				iLocal_229 = 0;
			}
			release_control_of_frontend();
	...
	else
	{
		...
		if (is_control_just_released(2, 201) || iLocal_230)
		{
			if (!iLocal_230)
			{
				func_149();
			...
			if (!func_148())
			{
				...
				if (does_blip_exist(iLocal_180))
				{
					iVar1 = get_blip_sprite(iLocal_180);
					if (iVar1 == 490)
					{
						func_147();
						func_146();
					...
					else if (((((((((((((((iVar1 == 545 || iVar1 == 546) || func_145(iVar1)) || iVar1 == 565) || iVar1 == 571) || iVar1 == 610) || iVar1 == 611) || iVar1 == 641) || iVar1 == 785) || iVar1 == 786) || iVar1 == 809) || iVar1 == 726) || (iVar1 == 315 && get_blip_colour(iLocal_180) == func_144(126))) || (iVar1 == 305 && get_blip_colour(iLocal_180) == func_144(15))) || iVar1 == 835) || iVar1 == 836)
					{
						func_146();
					}
				}
				func_78(func_79(player_id()));
				if (!is_string_null_or_empty(&sLocal_236) && !func_77())
				{
					func_76();
				}
				func_74(&sLocal_236);
		...
		else if (is_control_just_released(2, 202) || _0xD313DE83394AF134())
		{
			iLocal_228 = 0;
			iLocal_230 = 0;
		}
...
void func_54()
{
	set_bit(&(Global_1853348[player_id() /*834*/].f_36.f_18), 15);
}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_64(player_id(), 0) && !func_63()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_59(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
Vector3 func_80(int iParam0)
{
	...
	{
		Var1 = { func_139(func_140(Global_1853348[player_id() /*834*/].f_267.f_32)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
int func_96(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if (((Global_1575058 || Global_2667225.f_2680) && iParam0 == player_id()) && func_84(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6;
		}
	}
...
int func_97(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if (((Global_2689235[iParam0 /*453*/].f_318.f_6 != -1 && Global_1575058) && iParam0 == player_id()) && func_84(iParam0, 1, 0))
		{
			return func_88(Global_2689235[iParam0 /*453*/].f_318.f_6) == 20;
		}
	}
...
int func_135(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_84(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
void func_136(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_137(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
int func_169(var uParam0, int iParam1)
{
	...
	if (network_is_game_in_progress())
	{
		if (get_player_wanted_level(player_id()) > 0)
		{
			if (network_is_signed_online())
			{
				if (!network_can_spend_money((func_220(iParam1, iVar0, 0, -1) + func_215(20)), false, false, true, -1, 0))
				{
					return 1;
				}
			}
		}
		if (func_84(player_id(), 1, 1))
		{
		...
		if (network_is_signed_online())
		{
			if (!network_can_spend_money(func_220(iParam1, iVar0, 0, -1), false, false, true, -1, 0))
			{
				return 3;
			}
		}
		...
		if (((((((((((Global_1853348[player_id() /*834*/] == 14 || Global_1853348[player_id() /*834*/] == 15) || Global_1853348[player_id() /*834*/] == 13) || Global_1853348[player_id() /*834*/] == 6) || Global_1853348[player_id() /*834*/] == 5) || Global_1853348[player_id() /*834*/] == 32) || func_199()) || BitTest(Global_1853348[player_id() /*834*/].f_833, 6)) || func_192(player_ped_id(), 1215605247, 0, uParam0, 0, 500, 1, 0)) || func_191(player_id(), 0)) || func_190(player_id(), 1, 0)) || Global_1853348[player_id() /*834*/] == 148)
		{
			return 9;
		}
...
int func_187()
{
	...
	iVar0 = func_189();
	if (network_can_spend_money(iVar0, false, true, false, -1, 0) || func_188(1) >= iVar0)
	{
		return 1;
	}
	return 0;
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	if (iParam1 != -1)
	{
		if (get_distance_between_coords(get_entity_coords(iParam0, true), func_195(iParam1), true) <= IntToFloat(iParam2))
		{
			return 1;
		}
	}
...
int func_199()
{
	if (func_191(player_id(), 8))
	{
		return 1;
	}
	if (func_191(player_id(), 10))
	{
		return 1;
	}
	if (func_191(player_id(), 12))
	{
		return 1;
	}
	if (func_191(player_id(), 14))
	{
		return 1;
	}
	if (func_191(player_id(), 13))
	{
		return 1;
	}
	if (func_203())
...
void func_223(int iParam0, int iParam1, var uParam2)
{
	...
	{
		show_start_mission_instructional_button(false);
		_show_contact_instructional_button(true);
		*iParam1 = 0;
	}
	func_255(iVar0);
	func_6(iVar0, "", _get_label_text(func_236(iParam0)), 0, func_2(), func_235(iParam0), 1, 1, -1, -1, 0, 0, 0, 0);
	func_230(iVar0, iVar1, iVar2, iVar1, 0, "DLCC_CONTACT", func_234(iParam0), 0, 0, 0, 0);
	iVar1++;
	if (!is_string_null_or_empty(func_229(iParam0)))
	{
		func_230(iVar0, iVar1, iVar2, iVar1, 0, "DLCC_PROPERTY", func_229(iParam0), 0, 0, 0, 0);
		iVar1++;
	}
	if (!is_string_null_or_empty(func_228(iParam0)))
	{
		func_230(iVar0, iVar1, iVar2, iVar1, 0, "DLCC_WEBSITE", func_228(iParam0), 0, 0, 0, 0);
		iVar1++;
	}
	if (!is_string_null_or_empty(func_227(iParam0)))
	{
	...
	iVar1++;
	func_226(iVar0, iVar1, iVar2, iVar1, 0, _get_label_text(func_225(iParam0)), 1, 5);
	iVar1++;
	func_224(iVar0);
	release_control_of_frontend();
}
...
void func_230(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT"))
	{
		...
		if (bParam9)
		{
			if (are_strings_equal(sParam6, func_233()))
			{
			}
			if (are_strings_equal(sParam6, func_232()))
			{
			}
			if (are_strings_equal(sParam6, "Verified"))
			{
			}
			if (compare_strings(sParam6, func_232(), false, 10) == 0)
			{
			}
			if (func_231(sParam6))
			{
		...
		scaleform_movie_method_add_param_bool(bParam10);
		end_scaleform_movie_method();
	}
}
...
int func_239(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_245()
{
	if (func_239(get_blip_coords(iLocal_179), func_248(func_43()), 1056964608, 0))
	{
		iLocal_216 = -1;
		StringCopy(&Local_182, "NULL", 64);
		StringCopy(&cLocal_191, _get_label_text(func_247(func_43())), 64);
...
int func_249()
{
	...
	{
		if (func_239(get_blip_coords(iLocal_179), Local_181, 1056964608, 0))
		{
			iLocal_216 = -1;
			StringCopy(&Local_182, "NULL", 64);
			StringCopy(&cLocal_191, _get_label_text(func_252(func_45())), 64);
...
bool func_254(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
void func_256(int iParam0, bool bParam1)
{
	...
	if (iParam0 == 2)
	{
		if (bParam1)
		{
			clear_bit(&Global_1574941, iParam0);
		}
		else
		{
			set_bit(&Global_1574941, iParam0);
		}
	}
}
...
void func_257(int iParam0, int iParam1, struct<3> Param2, int iParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, struct<6> Param15, var uParam16, int iParam17, bool bParam18, int iParam19, bool bParam20, bool bParam21, int iParam22, int iParam23, int iParam24)
{
	...
	*uParam16 = iParam0;
	...
	else if (get_hash_of_map_area_at_coords(Param2) == joaat("City"))
	{
	...
	if (iParam10 == 134)
	{
		...
		func_230(iParam0, 3, iParam1, 3, 0, "PM_AREA", get_name_of_zone(Param2), 0, 0, 0, 0);
	...
	else if (iParam10 == 254)
	{
		...
		func_230(iParam0, 3, iParam1, 3, 0, "PM_AREA", get_name_of_zone(func_260(func_43())), 0, 0, 0, 0);
		func_226(iParam0, 4, iParam1, 4, 0, " ", 0, 4);
		func_226(iParam0, 5, iParam1, 5, 0, sParam6, iParam22, 5);
	}
	else
	{
		...
		if (iParam19 > 1)
		{
			...
			iVar3++;
			func_230(iParam0, iVar3, iParam1, iVar3, 0, "PM_AREA", get_name_of_zone(Param2), 0, 0, 0, 0);
			iVar3++;
...
void func_259(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6)
{
	if (begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT"))
	{
		...
		scaleform_movie_method_add_param_int(1);
		func_41(sParam4);
		begin_text_command_scaleform_string(sParam5);
...
void func_262(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6)
{
	if (begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT"))
	{
		...
		func_41(sParam4);
		begin_text_command_scaleform_string(sParam5);
		add_text_component_substring_time(iParam6, 2567);
		end_text_command_scaleform_string();
		end_scaleform_movie_method();
	}
}
...
void func_264(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	if (begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT"))
	{
		...
		func_41(sParam4);
		func_41(sParam5);
		scaleform_movie_method_add_param_int(iParam6);
		scaleform_movie_method_add_param_int(iParam7);
...
void func_267(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	if (begin_scaleform_movie_method_on_frontend("SET_DATA_SLOT"))
	{
		...
		if (iParam5 != iParam6)
		{
			begin_text_command_scaleform_string("PM_PLAYERS_V");
...
int func_271(int iParam0, var uParam1)
{
	...
	else
	{
		...
		if (!ugc_is_description_request_in_progress(iParam0) && uParam1->f_1 == 0)
		{
...
void func_272(int iParam0)
{
	...
	iVar1 = 0;
	iVar2 = 65;
	_show_contact_instructional_button(false);
	show_start_mission_instructional_button(true);
	func_255(iVar0);
	func_6(iVar0, "", _get_label_text(func_279(iParam0)), 0, func_2(), func_278(iParam0), 1, 1, -1, -1, 0, 0, 0, 0);
	if (iParam0 == 0 && Global_1977014 != -1)
	{
		if (Global_262145.f_6230[Global_1977014] > 31 || Global_262145.f_6230[Global_1977014] < 0)
		{
			func_230(iVar0, iVar1, iVar2, iVar1, 0, "FMMCCPD_CHG", get_display_name_from_vehicle_model(Global_262145.f_6230[Global_1977014]), 0, 0, 0, 0);
			iVar1++;
		}
		else
		{
	...
	func_226(iVar0, iVar1, iVar2, iVar1, 0, " ", 0, 4);
	iVar1++;
	func_226(iVar0, iVar1, iVar2, iVar1, 0, _get_label_text(func_273(iParam0)), 1, 5);
	iVar1++;
	func_224(iVar0);
	release_control_of_frontend();
}
...
int func_281(int iParam0)
{
	...
	iVar0 = get_blip_sprite(iParam0);
	iVar1 = func_282(get_blip_colour(iParam0));
	if (iVar1 != 126)
	{
		return -1;
	}
...
int func_283(int iParam0, var uParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26)
{
	...
	*uParam26 = 0;
	...
	{
		if (get_blip_info_id_display(iParam0) != 0)
		{
			*uParam1 = { get_blip_coords(iParam0) };
			iVar0 = -1;
			iVar1 = get_blip_sprite(iParam0);
			iVar2 = get_blip_colour(iParam0);
			if (iVar1 == 835)
			{
				...
				case 4:
					...
					else
					{
						...
						if (iVar0 != -1)
						{
							...
							{
								StringCopy(sParam2, get_player_name(player_id()), 64);
							}
...
int func_285(var uParam0, struct<2> Param1, var uParam2)
{
	int iVar0;
...
int func_286(var uParam0, struct<2> Param1, var uParam2)
{
	int iVar0;
...
int func_287(var uParam0, struct<2> Param1, var uParam2)
{
	int iVar0;
...
void func_295(int iParam0)
{
	if (is_hovering_over_mission_creator_blip())
	{
		if (does_blip_exist(iParam0))
		{
			if (get_blip_sprite(iParam0) == 490)
			{
				Global_1836829 = 1;
			}
		}
...
void func_296()
{
	if (Global_262145.f_30927)
	{
		if (!BitTest(Global_1976978, 0))
		{
			request_streamed_texture_dict(func_2(), false);
			set_bit(&Global_1976978, 0);
		}
	}
}
