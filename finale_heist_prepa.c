...
void __EntryFunction__()
{
	...
	func_398();
	func_384();
	iLocal_264 = add_scenario_blocking_area(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, false, true, true, true);
	func_383(27, 0);
	if (func_382())
	{
	...
	while (true)
	{
		_0x208784099002BC30("M_STS", 0);
		if (func_380(player_ped_id()))
		{
			func_373();
			func_370();
			func_365();
...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			...
			clear_help(true);
			func_33();
			if (!is_string_null_or_empty(sLocal_257))
			{
				func_31(sLocal_257);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, get_entity_coords(player_ped_id(), true)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				clear_area(372.9868f, -1623.531f, 28.2928f, 100f, true, false, false, false);
				func_2();
				func_399();
			}
			break;
...
void func_2()
{
	...
	remove_vehicle_upsidedown_check(Local_290.f_0);
	func_5(&Local_290);
	func_4(&iLocal_262);
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_35()
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				if (func_12(&uLocal_150, get_entity_coords(player_ped_id(), true)))
				{
		...
		case 3:
			...
			{
				if (!is_ped_in_vehicle(player_ped_id(), Local_290.f_0, false))
				{
					set_ped_into_vehicle(player_ped_id(), Local_290.f_0, -1);
				}
				else
				{
...
void func_39(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_44(player_id())) && !func_41(player_id(), 0)) && !func_40()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_44(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
int func_49(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	float fVar1;
...
int func_58(int iParam0, struct<3> Param1, int* iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			if (!is_entity_at_coord(player_ped_id(), Param1, fParam10, fParam10, 2f, false, true, 2))
			{
				...
				{
					clear_this_print(func_68(func_69()));
				}
				*iParam5 = 1;
			...
			else
			{
				...
				{
					fVar0 = (fParam10 / 2f);
					if (func_63(player_ped_id(), Param1, fVar0, 1))
					{
						*iParam5 = 0;
	...
	else
	{
		...
		if (!*iParam6)
		{
			...
			{
				clear_this_print(func_61(func_69(), 0));
			}
...
bool func_63(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, Local_265, 0))
			{
				...
				{
					iLocal_271 = add_navmesh_blocking_object(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), false, 7);
					if (get_blip_from_entity(Local_290.f_0) != 0)
					{
						iVar0 = get_blip_from_entity(Local_290.f_0);
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_290.f_1, Local_290.f_4) && func_82(4, Local_265, 0)) && func_82(3, Local_265, 0)) && func_82(5, Local_265, 0))
				{
					func_74(player_ped_id(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_72();
					clear_area_of_peds(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					clear_area_of_peds(Local_289[0 /*22*/].f_1, 5f, 0);
					func_77();
					func_75();
					bLocal_28 = false;
					func_36(1, 1, 1);
...
void func_72()
{
	...
	iLocal_467 = 1;
	func_383(27, 0);
	door_system_set_door_state(Global_41748[13 /*31*/], 4, true, false);
	iLocal_468 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (bVar0 <= (15 - 1))
		{
			clear_bit(&(Local_289[iVar1 /*22*/].f_15), bVar0);
			bVar0++;
		}
...
void func_75()
{
	...
	func_76(&uLocal_294, iVar0, player_ped_id(), sVar1, 0, 1);
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		set_blocking_of_non_temporary_events(Local_289[iVar0 /*22*/], false);
		if (!func_78(Local_289[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					task_start_scenario_at_position(Local_289[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, false, true);
					break;
				
				case 2:
					task_use_mobile_phone(Local_289[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		give_weapon_to_ped(Local_289[iVar0 /*22*/], joaat("weapon_pistol"), -1, false, false);
		set_ped_relationship_group_hash(Local_289[iVar0 /*22*/], iLocal_292);
...
int func_82(int iParam0, struct<3> Param1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			request_additional_text(sLocal_258, 0);
			request_additional_text(cLocal_293, 6);
		...
		case 2:
			if (func_7(Global_96938[0]))
			{
				...
				if (func_7(Local_290.f_0))
				{
					if (!does_vehicle_have_stuck_vehicle_check(Local_290.f_0))
					{
						add_vehicle_upsidedown_check(Local_290.f_0);
					}
					_set_vehicle_door_can_break(Local_290.f_0, 2, false);
					_set_vehicle_door_can_break(Local_290.f_0, 3, false);
					func_89(Local_290.f_0, 0);
					set_vehicle_has_strong_axles(Local_290.f_0, true);
					set_vehicle_doors_locked(Local_290.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (does_entity_exist(Global_96938.f_9[iVar0]))
				{
					if (!is_ped_dead_or_dying(Global_96938.f_9[iVar0], true))
					{
						set_entity_as_mission_entity(Global_96938.f_9[iVar0], true, true);
						Local_289[iVar0 /*22*/] = Global_96938.f_9[iVar0];
						if (func_380(Local_289[iVar0 /*22*/]))
						{
							set_ped_target_loss_response(Local_289[iVar0 /*22*/], 2);
							stop_ped_speaking(Local_289[iVar0 /*22*/], true);
							func_87(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_86(&(Local_289[iVar0 /*22*/]), Local_289[iVar0 /*22*/].f_5, Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					...
					set_ped_name_debug(Local_289[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					set_entity_as_mission_entity(Global_96938[iVar3], true, true);
		...
		case 5:
			if (func_83(&iLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_290.f_0))
				{
					attach_entity_to_entity(iLocal_262, Local_290.f_0, 0, 0f, -1.85f, 0.05f, get_entity_rotation(Local_290.f_0, 2), false, false, false, false, 2, true, 0);
					if (is_entity_attached_to_entity(Local_290.f_0, iLocal_262))
					{
						return 1;
					}
				}
		...
		if (func_85(iParam1, "Loading", 0))
		{
			*uParam0 = create_ped(26, iParam1, Param2, fParam3, true, true);
			if (func_380(*uParam0))
			{
				...
				if (bParam6)
				{
					set_blocking_of_non_temporary_events(*uParam0, bParam6);
				}
				if (!bParam7)
				{
					set_ped_can_be_targetted(*uParam0, bParam7);
				}
				if (bParam4)
				{
					func_84(iParam1, 1);
...
void func_87(int iParam0)
{
	if (func_380(Local_289[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			set_ped_component_variation(Local_289[iParam0 /*22*/], 0, 0, 1, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 3, 0, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 4, 0, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 8, 0, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 9, 1, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			set_ped_component_variation(Local_289[iParam0 /*22*/], 0, 1, 1, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 3, 0, 1, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 4, 0, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 8, 1, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 9, 2, 0, 0);
			set_ped_component_variation(Local_289[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}
		...
		switch (*iParam2)
		{
			case 0:
				if (is_ped_in_vehicle(player_ped_id(), *iParam0, false))
				{
					...
					if (func_66(func_60(func_69()), 0, 0))
					{
						clear_this_print(func_60(func_69()));
					}
					if (*iParam0 == iParam6)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						clear_this_print(func_61(func_69(), bParam7));
					}
					if (func_69() != 33)
					{
						func_94(iParam0);
			...
			case 2:
			case 1:
				if ((!is_ped_in_vehicle(player_ped_id(), *iParam0, false) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
...
void func_94(int* iParam0)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		if (iVar0 != *iParam0)
		{
			if (func_7(iVar0))
			{
				if (get_entity_model(iVar0) == func_95(func_69()))
				{
					func_93(iParam0);
					*iParam0 = iVar0;
					func_89(*iParam0, 1);
...
int func_96(int iParam0)
{
	...
	if ((func_380(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), false)) && func_7(iParam0))
	{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				...
				if (!iLocal_469)
				{
					play_police_report("SCRIPTED_SCANNER_REPORT_BS_PREP_A_01", 0f);
					iLocal_469 = 1;
				}
			}
	...
	while (iVar0 < 3)
	{
		...
		if (!is_ped_injured(iVar1))
		{
			switch (iLocal_44[iVar0])
			{
				...
				case 1:
					if (func_109(iVar0, iVar1) && does_entity_belong_to_this_script(iVar1, true))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
				...
				case 2:
					if (func_107(iVar0, iVar1) && does_entity_belong_to_this_script(iVar1, true))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			task_vehicle_mission_coors_target(iParam1, get_vehicle_ped_is_in(iParam1, false), Local_266, 4, 20f, 786469, 3.5f, 5f, true);
			iLocal_43[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(player_ped_id(), Local_266, 2f, 1))
			{
				iLocal_43[iParam0] = 4;
			}
			break;
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!is_position_occupied(Local_254[iLocal_470 /*4*/], 1.5f, false, false, true, false, false, iParam1, false))
			{
				...
				task_follow_nav_mesh_to_coord(iParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, false, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((does_entity_exist(Local_290.f_0) && is_vehicle_driveable(Local_290.f_0, false)) && !is_entity_at_coord(Local_290.f_0, Local_266, 2f, 2f, 2f, false, true, 0))
		{
			if ((!is_ped_injured(player_ped_id()) && is_ped_in_vehicle(player_ped_id(), Local_290.f_0, false)) && get_player_wanted_level(player_id()) == 0)
			{
				if (is_ped_in_vehicle(iParam1, Local_290.f_0, false) && get_ped_in_vehicle_seat(Local_290.f_0, -1, false) == iParam1)
				{
					iLocal_44[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (is_entity_in_angled_area(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, false, true, 0) && is_entity_in_angled_area(player_ped_id(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, false, true, 0))
		{
			iLocal_470 = 0;
			iLocal_44[iParam0] = 1;
			return 1;
		}
		else if (is_entity_in_angled_area(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, false, true, 0) && is_entity_in_angled_area(player_ped_id(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, false, true, 0))
		{
			iLocal_470 = 1;
			iLocal_44[iParam0] = 1;
			return 1;
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		...
		{
			suppress_crime_this_frame(player_id(), 38);
			suppress_crime_this_frame(player_id(), 30);
			bLocal_274 = false;
		}
		if (iLocal_40 == 2)
		{
			if (!iLocal_286)
			{
				if (!func_63(player_ped_id(), Local_290.f_1, 180f, 1))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_119()
{
	...
	{
		if (does_entity_exist(Local_289[iVar0 /*22*/]) && !is_ped_injured(Local_289[iVar0 /*22*/]))
		{
			if (has_entity_been_damaged_by_entity(Local_289[iVar0 /*22*/], player_ped_id(), true))
			{
				clear_entity_last_damage_entity(Local_289[iVar0 /*22*/]);
				if (((is_ped_current_weapon_silenced(player_ped_id()) || is_ped_being_stealth_killed(Local_289[iVar0 /*22*/])) || was_ped_killed_by_stealth(Local_289[iVar0 /*22*/])) || was_ped_killed_by_takedown(Local_289[iVar0 /*22*/]))
				{
					if (!bLocal_274)
					{
						suppress_crime_this_frame(player_id(), 41);
						suppress_crime_this_frame(player_id(), 33);
...
void func_120(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(1000, 1500)
				{
					if (!func_78(Local_289[iParam0 /*22*/], -875674219))
					{
						set_ped_should_play_immediate_scenario_exit(Local_289[iParam0 /*22*/]);
						task_turn_ped_to_face_entity(Local_289[iParam0 /*22*/], player_ped_id(), 0);
					}
					Local_289[iParam0 /*22*/].f_14 = get_game_timer();
				}
			}
			else
			{
		...
		case 2:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(5000, 6000)
			{
		...
		case 3:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(2500, 3000)
			{
		...
		case 6:
			...
			if ((get_game_timer() - Local_289[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!is_ped_being_stunned(Local_289[iParam0 /*22*/], 0) && !is_ped_in_writhe(Local_289[iParam0 /*22*/]))
				{
					Local_289[iParam0 /*22*/].f_14 = get_game_timer();
					func_127(iParam0);
				}
		...
		case 5:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((get_game_timer() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_274 && func_124(iParam0, 15))
				{
					func_73();
					func_134(iParam0);
					_0xC594B315EDF2D4AF(Local_289[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_465 != -1)
					{
						if ((get_game_timer() - iLocal_465) > 12000)
						{
							func_123(-1);
						}
						else if ((is_ped_shooting(player_ped_id()) || is_ped_climbing(player_ped_id())) || is_ped_in_melee_combat(player_ped_id()))
						{
							func_123(2);
						}
						else if (get_entity_player_is_free_aiming_at(player_id(), &iVar1))
						{
					...
					if ((func_78(Local_289[iParam0 /*22*/], -2128726980) || func_78(Local_289[iParam0 /*22*/], -982327190)) && get_player_wanted_level(player_id()) < 2)
					{
						if (!func_78(Local_289[iParam0 /*22*/], 1392476864))
						{
							task_arrest_ped(Local_289[iParam0 /*22*/], player_ped_id());
						}
					}
				}
			}
...
void func_123(int iParam0)
{
	...
	{
		set_blocking_of_non_temporary_events(Local_289[0 /*22*/], false);
	}
	if (func_380(Local_289[1 /*22*/]))
	{
		set_blocking_of_non_temporary_events(Local_289[1 /*22*/], false);
	}
	if (func_380(Local_289[2 /*22*/]))
	{
		set_blocking_of_non_temporary_events(Local_289[2 /*22*/], false);
	}
	if (iParam0 != -1)
	{
		set_player_wanted_level(player_id(), iParam0, false);
		set_player_wanted_level_now(player_id(), false);
	}
}
...
void func_125()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_195(&(Local_289[iVar0 /*22*/].f_6));
			Local_289[iVar0 /*22*/].f_14 = get_game_timer();
...
void func_127(int iParam0)
{
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_380(Local_289[iParam0 /*22*/]))
		{
			if (func_78(Local_289[iParam0 /*22*/], 242628503) || is_ped_running_mobile_phone_task(Local_289[iParam0 /*22*/]))
			{
				clear_ped_tasks(Local_289[iParam0 /*22*/]);
			}
			else if (func_78(Local_289[iParam0 /*22*/], -1098463898) || func_78(Local_289[iParam0 /*22*/], 993674639))
			{
				set_ped_should_play_immediate_scenario_exit(Local_289[iParam0 /*22*/]);
			}
			set_ped_as_cop(Local_289[iParam0 /*22*/], true);
			task_arrest_ped(Local_289[iParam0 /*22*/], player_ped_id());
			give_weapon_to_ped(Local_289[iParam0 /*22*/], joaat("weapon_pistol"), -1, false, true);
			clear_entity_last_damage_entity(Local_289[iParam0 /*22*/]);
			_0xBC9490CA15AEA8FB(player_id());
			func_128(iParam0);
...
void func_128(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !is_entity_dead(Local_289[iParam0 /*22*/], false))
	{
		if (func_133(iParam0) && func_131(Local_289[iParam0 /*22*/], 30f))
		{
			...
			else if (!func_124(iParam0, 15) || is_entity_in_angled_area(player_ped_id(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, false, true, 0))
			{
				func_129();
				iLocal_461 = 0;
				if (iParam0 == 2)
				...
				{
					play_ped_ambient_speech_with_voice_native(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", false);
				}
				iLocal_464 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	if (func_380(player_ped_id()) && func_380(iParam0))
	{
		if (func_132(player_ped_id(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
void func_134(int iParam0)
{
	...
	{
		clear_ped_tasks(Local_289[iParam0 /*22*/]);
		set_ped_relationship_group_hash(Local_289[iParam0 /*22*/], iLocal_292);
		if (iParam0 == 2)
		{
			open_sequence_task(&iVar0);
			if (!func_63(Local_289[iParam0 /*22*/], Local_289[iParam0 /*22*/].f_1, 3f, 1))
			{
				task_follow_nav_mesh_to_coord(0, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, false, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
				task_achieve_heading(0, Local_289[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_459[2] && is_string_null_or_empty("sResumeRoot"))
			{
				task_start_scenario_in_place(0, "WORLD_HUMAN_STAND_MOBILE", 0, true);
			}
			else
			{
				task_use_mobile_phone(0, 1, 1);
			}
			close_sequence_task(iVar0);
			task_perform_sequence(Local_289[iParam0 /*22*/], iVar0);
		...
		func_135();
		set_blocking_of_non_temporary_events(Local_289[iParam0 /*22*/], false);
...
void func_135()
{
	if (func_12(&uLocal_46, get_entity_coords(player_ped_id(), true)))
	{
		if (!func_103())
		{
			if ((!are_strings_equal(&cLocal_471, "NONE") && !are_strings_equal(&cLocal_475, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
void func_151(int iParam0)
{
	switch (Local_289[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_103())
			{
				if (is_ped_being_stealth_killed(Local_289[iParam0 /*22*/]))
				{
					func_129();
				}
			}
			...
			{
				if (iLocal_459[2] && !is_ped_in_current_conversation(Local_289[iParam0 /*22*/]))
				{
					clear_ped_tasks(Local_289[iParam0 /*22*/]);
					task_start_scenario_in_place(Local_289[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, true);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || is_explosion_in_sphere(-1, get_entity_coords(Local_289[iParam0 /*22*/], true), 100f))
		{
			if ((!is_ped_being_stealth_killed(Local_289[iParam0 /*22*/]) && !was_ped_killed_by_stealth(Local_289[iParam0 /*22*/])) && !was_ped_killed_by_takedown(Local_289[iParam0 /*22*/]))
			{
				func_125();
			}
			else if (!bLocal_274)
			{
				suppress_crime_this_frame(player_id(), 41);
				suppress_crime_this_frame(player_id(), 33);
				suppress_crime_this_frame(player_id(), 12);
				set_player_wanted_level(player_id(), 0, false);
				set_player_wanted_level_now(player_id(), false);
			}
		}
	}
	else if (func_153(Local_289[iParam0 /*22*/], player_ped_id(), 5f, 1))
	{
		if (!bLocal_274)
		{
			suppress_crime_this_frame(player_id(), 41);
...
int func_154(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_6(player_ped_id()) && func_6(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_167(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_155(int iParam0, float fParam1)
{
	...
	if (func_6(player_ped_id()) && func_6(iParam0))
	{
		if (func_166(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(player_ped_id(), 6))
			{
				fVar0 = 40f;
...
{
	return func_157(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_163(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_171(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if (is_entity_at_coord(player_ped_id(), get_offset_from_entity_in_world_coords(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !is_ped_armed(player_ped_id(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	{
		if (((!bLocal_272 && !is_ped_being_stealth_killed(Local_289[iParam0 /*22*/])) && !was_ped_killed_by_stealth(Local_289[iParam0 /*22*/])) && !was_ped_killed_by_takedown(Local_289[iParam0 /*22*/]))
		{
			func_175(iParam0);
		}
	}
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 3 || (get_game_timer() - iLocal_276) > 7500)
			{
		...
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 4 || (get_game_timer() - iLocal_276) > 7500)
			{
				if (!bLocal_273)
				{
					if (iParam0 == 0)
		...
		else if (iParam1 == 5)
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					play_ped_ambient_speech_with_voice_native(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", false);
				}
				else if (iParam0 == 1)
				{
		...
		Local_289[iParam0 /*22*/].f_14 = get_game_timer();
		Local_289[func_150(iParam0) /*22*/].f_14 = get_game_timer();
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	Var0 = { func_181() };
	if (is_string_null_or_empty(sParam1) || is_string_null_or_empty(&Var0))
	{
	...
	if ((!are_strings_equal(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_294, cLocal_293, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 1 || (get_game_timer() - iLocal_276) > 7500)
			{
				if (!bLocal_272)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_289[iParam0 /*22*/].f_19 != 2 || (get_game_timer() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_289[iParam0 /*22*/].f_19 != 4 || (get_game_timer() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 5)
			{
				...
				play_ped_ambient_speech_with_voice_native(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", false);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_272)
		{
			if (!BitTest(Local_289[iParam0 /*22*/].f_15, 12))
			{
				set_bit(&(Local_289[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	...
	if ((!func_149(iParam0) && Local_289[iParam0 /*22*/].f_20 != 6) && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				if (is_entity_in_angled_area(player_ped_id(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, false, true, 0))
				{
					if (is_ped_falling(player_ped_id()) || is_ped_climbing(player_ped_id()))
					{
						iLocal_282 = 1;
					...
					{
						if ((((fVar0 > 16f && !Local_289[iParam0 /*22*/].f_16) && !BitTest(Local_289[iParam0 /*22*/].f_15, 10)) && !is_entity_in_angled_area(player_ped_id(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, false, true, 0)) && is_entity_in_angled_area(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, false, true, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((is_entity_in_angled_area(player_ped_id(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, false, true, 0) && is_entity_in_angled_area(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, false, true, 0)) && !BitTest(Local_289[iParam0 /*22*/].f_15, 10)) && !BitTest(Local_289[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_16) && !is_entity_in_angled_area(player_ped_id(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, false, true, 0))
					{
						func_186(iParam0, 11);
					}
				}
			}
			else if ((get_game_timer() - iLocal_281) > 4000)
			{
				iLocal_282 = 0;
			}
		}
		else if (is_entity_in_angled_area(player_ped_id(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, false, true, 0) && is_entity_in_angled_area(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, false, true, 0))
		{
...
void func_185(int iParam0, bool bParam1)
{
	...
	{
		clear_bit(&(Local_289[iParam0 /*22*/].f_15), bParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_186(int iParam0, bool bParam1)
{
	if (!BitTest(Local_289[iParam0 /*22*/].f_15, bParam1))
	{
		set_bit(&(Local_289[iParam0 /*22*/].f_15), bParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_289[iParam0 /*22*/], player_ped_id(), 5f, 1) && !is_ped_being_stealth_killed(Local_289[iParam0 /*22*/])) && !was_ped_killed_by_stealth(Local_289[iParam0 /*22*/])) && !was_ped_killed_by_takedown(Local_289[iParam0 /*22*/]))
		{
	...
	else if (!func_153(Local_289[iParam0 /*22*/], player_ped_id(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (is_entity_at_coord(player_ped_id(), get_offset_from_entity_in_world_coords(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, false, true, 0))
		{
			return 1;
		}
	}
...
{
	if (is_entity_touching_entity(Local_289[iParam0 /*22*/], player_ped_id()))
	{
		if (is_ped_ragdoll(Local_289[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_190(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_289[iParam0 /*22*/].f_16)
			{
				if (!BitTest(Local_289[iParam0 /*22*/].f_15, 12))
				{
					if (is_entity_in_angled_area(player_ped_id(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, false, true, 0))
					{
						iLocal_282 = 1;
						iLocal_281 = get_game_timer();
						if (iVar0 == 4)
			...
			else if (!is_entity_in_angled_area(player_ped_id(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, false, true, 0) || BitTest(Local_289[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (is_entity_in_angled_area(player_ped_id(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, false, true, 0))
	{
		func_193(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
				...
				if (func_7(iVar0))
				{
					if (func_192(get_entity_model(iVar0)))
					{
						bLocal_273 = true;
					}
					else
					...
					if (!is_entity_in_angled_area(iVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, false, true, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!BitTest(Local_289[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					set_bit(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
				else
				{
					clear_bit(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
			}
			break;
...
{
	if (func_153(player_ped_id(), Local_289[iParam0 /*22*/], 30f, 1))
	{
		if (func_157(Local_289[iParam0 /*22*/], player_ped_id(), 140f, 1, 250, 7))
		{
...
void func_197()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (does_entity_exist(Local_289[iVar0 /*22*/]))
			{
				if (func_7(get_players_last_vehicle()))
				{
					if (has_entity_been_damaged_by_entity(Local_289[iVar0 /*22*/], get_players_last_vehicle(), true))
					{
						clear_entity_last_damage_entity(Local_289[iVar0 /*22*/]);
						func_125();
					}
...
void func_198(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_19)
	{
		case 1:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(2500, 3000)
			{
				if (is_entity_in_angled_area(player_ped_id(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, false, true, 0))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					if ((BitTest(Local_289[iParam0 /*22*/].f_15, 13) && (get_game_timer() - iLocal_276) > 2500) && !iLocal_466)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_294, cLocal_293, sVar0, 7, 0, 0);
						clear_bit(&(Local_289[iParam0 /*22*/].f_15), 13);
						clear_bit(&(Local_289[func_150(iParam0) /*22*/].f_15), 13);
						iLocal_466 = 1;
					}
					Local_289[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(2500, 3000)
			{
				if (!func_153(Local_289[iParam0 /*22*/], player_ped_id(), 1.5f, 1))
				{
					clear_bit(&(Local_289[iParam0 /*22*/].f_15), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (get_game_timer() - Local_289[iParam0 /*22*/].f_14) > get_random_int_in_range(2500, 3000)
			{
				...
				{
					clear_bit(&(Local_289[iParam0 /*22*/].f_15), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_201(int iParam0)
{
	...
	if (!iLocal_466)
	{
		bVar0 = get_ped_stealth_movement(player_ped_id());
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(player_ped_id(), Local_289[iParam0 /*22*/], 10f, 1))
				{
...
void func_202(int iParam0)
{
	...
	bVar0 = is_ped_armed(player_ped_id(), 4);
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_153(player_ped_id(), Local_289[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_289[iParam0 /*22*/].f_16)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || is_explosion_in_sphere(-1, get_entity_coords(Local_289[iParam0 /*22*/], true), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_380(Local_289[iParam0 /*22*/]))
	{
		...
		if (is_entity_at_entity(player_ped_id(), Local_289[iParam0 /*22*/], fVar0, fVar0, fVar0, false, true, 0))
		{
			if (is_player_free_aiming_at_entity(player_id(), Local_289[iParam0 /*22*/]) || is_player_targetting_entity(player_id(), Local_289[iParam0 /*22*/]))
			{
				if (Local_289[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_380(Local_289[0 /*22*/]) && func_380(Local_289[1 /*22*/])) && func_12(&uLocal_46, get_entity_coords(player_ped_id(), true))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f, 1)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f, 1))
		{
		...
		else if ((func_380(Local_289[2 /*22*/]) && func_12(&uLocal_98, get_entity_coords(player_ped_id(), true))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f, 1))
		{
...
bool func_206(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_103() && is_screen_faded_in())
		{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				...
				if (is_door_registered_with_system(Global_41748[13 /*31*/]))
				{
					set_script_update_door_audio(Global_41748[13 /*31*/], true);
				}
				iLocal_479 = 0;
				_0x293220DA1B46CEBC(2f, 10f, 4);
				iLocal_41 = 1;
			}
			break;
		...
		case 1:
			if (get_player_wanted_level(player_id()) < 3)
			{
				if (func_380(Local_289[2 /*22*/]))
				{
					...
					{
						if (is_entity_in_angled_area(player_ped_id(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, false, true, 2) || is_ped_shooting(player_ped_id()))
						{
			...
			if ((is_ped_climbing(player_ped_id()) && iLocal_479 == 0) && func_132(Local_290.f_0, player_ped_id(), 1) < 100f)
			{
				_0x293220DA1B46CEBC(7f, 7f, 4);
				iLocal_479 = 1;
			}
			if (func_7(Local_290.f_0))
			{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, 0))
			{
				...
				clear_area_of_peds(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				clear_area_of_peds(Local_289[0 /*22*/].f_1, 5f, 0);
				if (func_275(player_ped_id(), 12, 4) || func_275(player_ped_id(), 12, 3))
				{
					bLocal_272 = true;
				}
				func_224();
...
void func_224()
{
	...
	if (does_entity_exist(iVar0))
	{
		if (is_vehicle_driveable(iVar0, false))
		{
			func_225(iVar0, get_entity_coords(iVar0, true), get_entity_heading(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_245(iParam0, 0, 0)) || func_245(iParam0, 1, 0)) || func_245(iParam0, 2, 0)) || func_268(iParam0) != 145) || func_244(iParam0)) || func_243(iParam0)) || func_242(iParam0)) || func_241(iParam0)) || !func_229(get_entity_model(iParam0)))
	{
		if (func_243(iParam0))
		{
		}
...
int func_230(int iParam0, bool bParam1)
{
	...
	{
		if ((func_235() || is_pc_version()) || func_234())
		{
		}
		else if (!func_237())
		{
...
var func_248()
{
	...
	func_258(&uVar0, get_clock_seconds());
	func_257(&uVar0, get_clock_minutes());
	func_256(&uVar0, get_clock_hours());
	func_251(&uVar0, get_clock_day_of_month());
	func_250(&uVar0, get_clock_month());
	func_249(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_254(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_262(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_259(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_275(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_276(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_276(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_281(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_281(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_281(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_281(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_276(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_276(iParam2));
...
void func_309(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_299(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_299(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_276(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_366()
{
	if (is_cop_ped_in_area_3d(385.8528f, -1629.945f, 35.29278f, 398.8063f, -1640.865f, 28f))
	{
		door_system_set_door_state(iLocal_269, 0, true, true);
	}
	else
	{
		door_system_set_door_state(iLocal_269, 1, true, true);
	}
}
...
void func_367()
{
	if (bLocal_274)
	{
		if (is_cop_ped_in_area_3d(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || is_entity_in_angled_area(player_ped_id(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, false, true, 0))
		{
			if (func_12(&uLocal_150, get_entity_coords(player_ped_id(), true)))
			{
	...
	else if (is_ped_in_any_police_vehicle(player_ped_id()) || iLocal_42 == 1)
	{
		if (is_entity_in_angled_area(player_ped_id(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, false, true, 0) || is_cop_ped_in_area_3d(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_369(Global_41748[13 /*31*/], &fLocal_270);
		}
		else
	...
	else if (!is_cop_ped_in_area_3d(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
	{
		func_368(Global_41748[13 /*31*/], &fLocal_270);
	}
	else
...
void func_368(int iParam0, float fParam1)
{
	if (is_door_registered_with_system(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!does_navmesh_blocking_object_exist(iLocal_271))
			{
				iLocal_271 = add_navmesh_blocking_object(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), false, 7);
			}
			door_system_set_open_ratio(iParam0, *fParam1, true, true);
			*fParam1 = (*fParam1 - (0.2f * timestep()));
			if (*fParam1 <= 0f)
			{
				door_system_set_door_state(iParam0, 1, true, false);
				remove_navmesh_blocking_object(iLocal_271);
				*fParam1 = 0f;
			}
		}
	}
...
void func_374()
{
	...
	{
		if (!func_63(player_ped_id(), 372.0053f, -1604.076f, 36.7536f, 100f, 1) && !bLocal_287)
		{
			func_376("PR_AREAWARN", &bLocal_287);
		}
		else if (!func_63(player_ped_id(), 372.0053f, -1604.076f, 36.7536f, 170f, 1) && bLocal_287)
		{
			func_375(3);
		}
	}
...
void func_377()
{
	...
	else
	{
		...
		if (iLocal_40 == 2 || iLocal_40 == 3)
		{
			if (!func_153(player_ped_id(), Local_290.f_0, 50f, 1) && !bLocal_288)
			{
				func_376("PR_VANWARN", &bLocal_288);
			}
			else if (!func_153(player_ped_id(), Local_290.f_0, 100f, 1) && bLocal_288)
			{
				func_375(4);
			}
		}
...
void func_378()
{
	if (is_vehicle_stuck_on_roof(Local_290.f_0))
	{
		if (iLocal_268)
		{
			if ((get_game_timer() - iLocal_267) > 5000)
			{
				func_375(2);
				return;
			}
...
void func_388()
{
	...
	if (!is_door_registered_with_system(iLocal_269))
	{
		add_door_to_system(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, true, true, false);
	}
	door_system_set_door_state(Global_41748[13 /*31*/], 1, true, false);
	door_system_set_door_state(iLocal_269, 1, true, false);
}
...
void func_394()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (bVar2 <= (15 - 1))
		{
			clear_bit(&(Local_289[iVar1 /*22*/].f_15), bVar2);
			bVar2++;
		}
		iVar1++;
	}
...
void func_398()
{
	add_relationship_group("COPS", &iLocal_292);
}

void func_399()
{
	remove_relationship_group(iLocal_292);
	func_410(1);
	if (is_door_registered_with_system(Global_41748[13 /*31*/]))
	{
		set_script_update_door_audio(Global_41748[13 /*31*/], false);
	}
	door_system_set_open_ratio(Global_41748[13 /*31*/], 0f, true, true);
	door_system_set_door_state(Global_41748[13 /*31*/], 4, true, true);
	door_system_set_door_state(iLocal_269, 0, true, false);
	remove_door_from_system(iLocal_269, 0);
	remove_scenario_blocking_area(iLocal_264, false);
	func_55();
	set_max_wanted_level(5);
	set_wanted_level_multiplier(1f);
	func_409();
...
void func_400(bool bParam0)
{
	...
	if (bParam0)
	{
		if (does_entity_exist(Local_290.f_0))
		{
			if (does_entity_exist(player_ped_id()))
			{
				if (!is_ped_injured(player_ped_id()))
	...
	if (does_cam_exist(iLocal_263))
	{
		render_script_cams(false, false, 3000, true, false, 0);
		destroy_cam(iLocal_263, false);
	}
}
...
void func_406()
{
	...
	set_model_as_no_longer_needed(Local_290.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		set_model_as_no_longer_needed(Local_291[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
