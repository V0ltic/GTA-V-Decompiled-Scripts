...
void __EntryFunction__()
{
	...
	sLocal_140 = "";
	iLocal_149 = -1;
	if (_get_number_of_references_of_script_with_name_hash(get_hash_key("appFixerSecurity")) > 1)
	{
		func_416(1, 0);
	}
...
void func_3(int iParam0, int iParam1)
{
	...
	{
		if (!func_14(player_id(), 0) && !func_14(player_id(), 3))
		{
			func_13(iParam0);
...
{
	return func_18(player_id(), bParam0);
}
...
{
	begin_scaleform_movie_method(iLocal_150, "UPDATE_START_BUTTON");
	func_27(sParam0);
...
void func_31()
{
	...
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_152))
		{
			iVar0 = get_scaleform_movie_method_return_value_int(iLocal_152);
			if (iVar0 != iLocal_148)
			{
				if (!func_68())
				{
...
{
	begin_scaleform_movie_method(iLocal_150, "UPDATE_DATA_LEAK_SCREEN");
	func_27(sParam0);
	scaleform_movie_method_add_param_bool(bParam1);
	...
	func_27(sParam6);
	scaleform_movie_method_add_param_bool(bParam7);
	scaleform_movie_method_add_param_bool(bParam8);
...
int func_35()
{
	...
	iVar0 = 0;
	iVar0 = (iVar0 + func_36(func_37(player_id(), 7)));
	iVar0 = (iVar0 + func_36(func_37(player_id(), 10)));
	iVar0 = (iVar0 + func_36(func_37(player_id(), 4)));
	return iVar0;
}
...
{
	begin_scaleform_movie_method(iLocal_150, "UPDATE_TAB_DATA");
	func_27(sParam0);
	_scaleform_movie_method_add_param_texture_name_string_2(sParam1);
	func_27(sParam2);
	scaleform_movie_method_add_param_bool(bParam3);
	scaleform_movie_method_add_param_bool(bParam4);
	scaleform_movie_method_add_param_bool(bParam5);
	func_27(sParam6);
	end_scaleform_movie_method();
...
void func_41()
{
	clear_bit(&uLocal_129, 16);
	clear_bit(&uLocal_129, 17);
}
...
{
	begin_scaleform_movie_method(iLocal_150, "ENABLE_TABS");
...
bool func_51(int iParam0, bool bParam1)
{
	...
	return func_37(player_id(), iParam0);
}
...
{
	func_41();
	set_bit(&uLocal_129, 16);
}

void func_62()
{
	func_41();
	set_bit(&uLocal_129, 17);
}
...
void func_67(bool bParam0)
{
	if (bParam0)
	{
		set_bit(&uLocal_129, 15);
	}
	else
	{
		clear_bit(&uLocal_129, 15);
	}
}
...
void func_69()
{
	...
	{
		if (is_scaleform_movie_method_return_value_ready(iLocal_151))
		{
			iVar0 = get_scaleform_movie_method_return_value_int(iLocal_151);
			if (!is_screen_faded_in())
			{
				clear_bit(&uLocal_129, 4);
				return;
			}
			...
			switch (iVar0)
			{
				...
				case 216:
					func_312();
					set_bit(&(Global_2689235[player_id() /*453*/].f_318.f_1), 22);
					func_323(3);
					break;
				...
				case 219:
					if (((func_287(0) && func_285(0)) && func_283()) && !func_281(1))
					{
						...
						else if (!func_277(player_id()) && !BitTest(Global_1977048.f_1, 23))
						{
							func_323(2);
						}
						else
...
{
	begin_scaleform_movie_method(iLocal_150, "SET_CURRENT_SELECTION");
	func_71(iParam0);
	end_scaleform_movie_method();
}
...
int func_75(int iParam0)
{
	...
	func_199(func_200(player_id()));
	func_187(player_id(), 0, 376832, 0);
	Global_2715699.f_3830 = 1;
	func_186(player_id(), 0);
	func_185();
	func_184();
	iVar2 = 284;
	func_183(77);
...
void func_77(int iParam0)
{
	...
	if (func_79() == 0 || is_pause_menu_active())
	{
		func_78(1);
...
void func_81(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_79() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_78(0);
...
void func_84(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (func_139(Var0))
		{
			if (func_9(player_id(), 0))
			{
				if (does_entity_exist(func_136()) && !is_entity_dead(func_136(), false))
				{
					Var0 = { get_entity_coords(func_136(), true) };
					Var1 = { 0f, 0f, get_entity_heading(func_136()) };
					if (func_135(Global_1853348[player_id() /*834*/].f_775, 1, 0))
					{
			...
			if ((func_134(player_id()) || func_132(player_id())) && func_131())
			{
	...
	{
		iVar6 = func_126(player_id());
		Var0 = { _get_object_offset_from_coords(func_125(iVar6), func_124(iVar6), 3.5688f, 7.9792f, 4.1641f) };
	...
	{
		func_108();
		func_107(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		if (!func_139(Var7))
		{
			Var0 = { Var7 };
		}
		func_101(&Var7, 144, Global_1853348[player_id() /*834*/].f_267.f_32);
		Var1 = { Var7 };
	}
...
void func_85(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (network_is_game_in_progress())
		{
			...
			{
				func_187(player_id(), 0, 32768, 0);
			}
			else if (func_86())
			{
				func_187(player_id(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_187(player_id(), 0, 319492, 0);
			}
		}
		else
		{
			func_187(player_id(), 0, 57348, 0);
		}
	}
}
...
int func_92()
{
	if (func_9(player_id(), 0))
	{
		if (Global_1853348[player_id() /*834*/].f_775 != func_19())
		{
			if (func_12(Global_1853348[player_id() /*834*/].f_775, 0, 1))
			{
				if (func_135(Global_1853348[player_id() /*834*/].f_775, 1, 0))
				{
					return 0;
...
Vector3 func_103(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
{
	if (!animpostfx_is_running(func_145(0)))
	{
		animpostfx_play(func_145(iParam0), 0, true);
	}
}
...
void func_181()
{
	set_bit(&(Global_1888862[player_id() /*120*/].f_29), 29);
}

void func_182()
{
	set_bit(&(Global_2714762.f_3), 15);
}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_9(player_id(), 0) && !func_195()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_191(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
Vector3 func_201(int iParam0)
{
	...
	{
		Var1 = { func_252(func_253(Global_1853348[player_id() /*834*/].f_267.f_32)) };
		if (vmag(Var1) > 0f)
		{
			return Var1;
		}
...
void func_249(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_250(struct<3> Param0, int iParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var2[3];
...
void func_262(char* sParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4, bool bParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10)
{
	...
	begin_scaleform_movie_method(iLocal_150, sLocal_144);
	func_27(sParam0);
...
void func_269()
{
	...
	bVar20 = func_51(10, 0);
	bVar21 = func_271(0);
	begin_scaleform_movie_method(iLocal_150, "SHOW_DATA_LEAK_SCREEN");
	func_27(sVar6);
	func_27(sVar7);
	scaleform_movie_method_add_param_bool(bVar9);
	scaleform_movie_method_add_param_bool(bVar10);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar8);
	func_27(sVar11);
	func_27(sVar12);
	scaleform_movie_method_add_param_bool(bVar14);
	scaleform_movie_method_add_param_bool(bVar15);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar13);
	func_27(sVar16);
	func_27(sVar17);
	scaleform_movie_method_add_param_bool(bVar19);
	scaleform_movie_method_add_param_bool(bVar20);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar18);
	scaleform_movie_method_add_param_bool(bVar21);
	func_27(sVar0);
	func_27(sVar1);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar2);
	func_27(sVar3);
	func_27(sVar4);
...
void func_278()
{
	...
	iVar5 = 0;
	bVar6 = false;
	begin_scaleform_movie_method(iLocal_150, "SHOW_DATA_RECOVERY_SCREEN");
	func_27(sVar0);
	func_27(sVar1);
...
int func_281(bool bParam0)
{
	if (bParam0)
	{
		if (get_cloud_time_as_int() < func_52(9909, -1, 0))
		{
			return 1;
		}
		return 0;
	}
	return func_282(player_id());
}
...
int func_282(int iParam0)
{
	if (iParam0 != -1)
	{
		if (get_cloud_time_as_int() < Global_1977138[iParam0 /*57*/].f_27.f_5)
		{
			return 1;
		}
	}
...
void func_291(int iParam0)
{
	Global_75490 = 1;
	Global_1946108 = 1;
	func_2(263, func_292(player_id(), iParam0), -1);
	func_416(1, 1);
}
...
void func_293(int iParam0, int iParam1)
{
	...
	iVar0 = func_292(player_id(), iParam1);
	...
	bVar6 = true;
	sVar7 = "FAPP_EARNINGS";
	iVar8 = func_294(player_id());
	bVar9 = true;
	begin_scaleform_movie_method(iLocal_150, "UPDATE_SECURITY_CONTRACT_SELECTION_SCREEN");
	func_27(sVar1);
...
int func_297(int iParam0, bool bParam1)
{
	...
	return func_298(player_id(), iParam0);
}
...
void func_300(int iParam0)
{
	...
	func_264(1);
	iVar0 = func_292(player_id(), iParam0);
	sVar1 = func_305(iVar0);
	sVar2 = func_304(iVar0);
	sVar3 = "SEC_VIP_LANDING_IMAGE";
	iVar4 = func_303(iParam0);
	iVar5 = func_301(iParam0);
	begin_scaleform_movie_method(iLocal_150, "UPDATE_SECURITY_CONTRACT_SELECTION_TAB");
	func_27(sVar1);
	func_27(sVar2);
	func_71(iVar5);
	_scaleform_movie_method_add_param_texture_name_string_2(sVar3);
	scaleform_movie_method_add_param_int(iVar4);
	end_scaleform_movie_method();
	if (func_30())
	{
		set_bit(&uLocal_129, 14);
		if (!func_29("FXR_NX_SEC_WAIT"))
		{
...
{
	switch (func_302(player_id(), iParam0))
	{
		case 0:
			return 1;
			break;
...
int func_308()
{
	if (func_279(0) && !func_277(player_id()))
	{
...
void func_312()
{
	...
	begin_scaleform_movie_method(iLocal_150, "SHOW_HOME_SCREEN");
...
void func_313()
{
	...
	if (get_hash_key(sLocal_144) == -2021992805)
	{
		sVar0 = "HIDE_OVERLAY_TWO_BUTTON";
	}
	begin_scaleform_movie_method(iLocal_150, sVar0);
	end_scaleform_movie_method();
	func_264(0);
	clear_bit(&uLocal_129, 2);
}
...
void func_314()
{
	switch (func_322())
	{
		case 2:
			...
			func_26("FAPP_ACCEPT", 1);
			func_70(217);
			if (func_272(player_id()) && !func_315())
			{
				set_bit(&(Global_1977048.f_1), 21);
			}
			func_313();
			break;
	}
...
void func_316()
{
	begin_scaleform_movie_method(iLocal_150, "UPDATE_MENU_LOCKED_STATES");
	scaleform_movie_method_add_param_bool(func_273(0));
	scaleform_movie_method_add_param_bool(func_273(1));
	scaleform_movie_method_add_param_bool(func_273(2));
	end_scaleform_movie_method();
}
...
void func_323(int iParam0)
{
	...
	play_sound_frontend(-1, sVar0, "DLC_Fixer_Agency_Computer_Soundset", true);
}
...
void func_328()
{
	if (!BitTest(uLocal_129, 4) && !func_68())
	{
		if (!BitTest(uLocal_129, 5))
		{
			begin_scaleform_movie_method(iLocal_150, "GET_CURRENT_ROLLOVER");
			iLocal_152 = end_scaleform_movie_method_return_value();
			iLocal_153 = 20;
			set_bit(&uLocal_129, 5);
		}
	}
}
...
void func_329()
{
	if (func_330())
	{
		if (!BitTest(uLocal_129, 4))
		{
			begin_scaleform_movie_method(iLocal_150, "GET_CURRENT_SELECTION");
			iLocal_151 = end_scaleform_movie_method_return_value();
			set_bit(&uLocal_129, 4);
		}
	}
}
...
{
	begin_scaleform_movie_method(iLocal_150, "SHOW_SPEAKER");
	scaleform_movie_method_add_param_bool(bParam0);
	end_scaleform_movie_method();
}
...
void func_348()
{
	...
	{
		if (func_351(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
void func_361()
{
	...
	else if (BitTest(uLocal_129, 8))
	{
		...
		else if (func_364(&uLocal_141, iLocal_137, 0) && !func_327())
		{
			...
			if (func_362())
			{
				set_bit(&uLocal_129, 7);
				set_bit(&uLocal_129, 9);
			}
		}
	}
}
...
void func_372()
{
	if ((!BitTest(uLocal_129, 8) && !is_string_null_or_empty(sLocal_140)) && !func_327())
	{
	...
	if (!BitTest(uLocal_129, 12))
	{
		...
		if (func_28() == 2)
		{
			if (func_272(player_id()))
			{
				if (!func_374(player_id(), 3))
				{
					func_324("FXRAP_FIN_WAIT3", -1);
				}
				else if (!func_374(player_id(), 4))
				{
...
void func_375()
{
	...
	clear_bit(&uLocal_129, 3);
	func_378(2, 205, 1);
	if (is_control_just_pressed(2, 205))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1f, -1f);
	}
	func_378(2, 206, 1);
	if (is_control_just_pressed(2, 206))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(206), -1f, -1f, -1f, -1f);
	}
	func_378(2, 188, 1);
	if (is_control_just_pressed(2, 188))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1f, -1f);
		set_bit(&uLocal_129, 3);
	}
	func_378(2, 187, 1);
	if (is_control_just_pressed(2, 187))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1f, -1f);
		set_bit(&uLocal_129, 3);
	}
	func_378(2, 189, 1);
	if (is_control_just_pressed(2, 189))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1f, -1f);
	}
	func_378(2, 190, 1);
	if (is_control_just_pressed(2, 190))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1f, -1f);
	}
	func_378(2, 201, 1);
	if (is_control_just_pressed(2, 201))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1f, -1f);
	}
	func_378(2, 202, 1);
	if (is_control_just_pressed(2, 202) && !BitTest(uLocal_129, 4))
	{
		func_377();
	}
	func_378(2, 203, 1);
	...
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1f, -1f);
	}
	func_378(2, 204, 1);
	if (is_control_just_pressed(2, 204))
	{
		call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(204), -1f, -1f, -1f, -1f);
	}
	if (_is_using_keyboard(2))
	{
		...
		{
			begin_scaleform_movie_method(iLocal_150, "SET_MOUSE_INPUT");
		...
		func_378(2, 238, 1);
		if (is_control_just_pressed(2, 238) && !BitTest(uLocal_129, 4))
		{
			func_377();
		}
	}
	else
	{
		...
		{
			begin_scaleform_movie_method(iLocal_150, "SET_ANALOG_STICK_INPUT");
			iLocal_133 = iVar0;
			iLocal_134 = iVar1;
			scaleform_movie_method_add_param_bool(true);
			scaleform_movie_method_add_param_int(iLocal_133);
			scaleform_movie_method_add_param_int(iLocal_134);
			end_scaleform_movie_method();
			set_bit(&uLocal_129, 3);
		}
	}
	...
	if (((iVar2 != 127 || iLocal_135 != 127) || iVar3 != 127) || iLocal_136 != 127)
	{
		...
		scaleform_movie_method_add_param_int(iLocal_135);
		scaleform_movie_method_add_param_int(iLocal_136);
...
void func_377()
{
	...
	call_scaleform_movie_method_with_number(iLocal_150, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1f, -1f);
	func_323(4);
}
...
void func_380()
{
	...
	set_script_gfx_draw_order(1);
	draw_scaleform_movie_fullscreen(iLocal_150, 255, 255, 255, 255, 0);
	func_389();
	func_383(0);
	func_381(1);
}
...
void func_395()
{
	...
	else if (func_405(player_id()))
	{
		Global_1946250.f_4704 = func_404(player_id());
		func_416(1, 0);
	}
	else if (func_396())
	{
...
int func_396()
{
	...
	if (func_397() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_397()) == 0)
		{
			return 1;
		}
	}
...
void func_406()
{
	...
	iLocal_150 = request_scaleform_movie("FIXER_APP");
	while (!has_scaleform_movie_loaded(iLocal_150))
	{
		func_392();
		wait(0);
	}
	...
	uLocal_145 = func_412(func_211(player_id()));
	func_410();
	func_323(9);
	func_408();
	if (is_pc_version())
...
{
	func_276(0);
	begin_scaleform_movie_method(iLocal_150, "SHOW_LOGIN_SCREEN");
...
{
	set_scaleform_movie_as_no_longer_needed(&iLocal_150);
	if (is_audio_scene_active("DLC_Fixer_Office_Room_Use_PC_Scene"))
	{
	...
	thefeed_resume();
	func_263();
	clear_bit(&(Global_2689235[player_id() /*453*/].f_318.f_1), 22);
	Global_77118 = 0;
