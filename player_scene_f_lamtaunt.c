	...
	while (iLocal_257 && func_137(2, 0))
	{
		...
		switch (iLocal_66)
		{
			...
			case 2:
				if (func_133())
				{
					func_132(&uLocal_68, 0, player_ped_id(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_337 && has_entity_been_damaged_by_entity(iParam0, player_ped_id(), true))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_108(75, get_entity_coords(iParam0, false), 250f, -1);
	...
	fVar4 = vdist2(get_entity_coords(iParam0, true), get_entity_coords(player_ped_id(), true));
	if (fVar4 > (8f * 8f))
	{
		iLocal_335 = -1;
	}
	...
	else
	{
		if (iLocal_335 <= 0)
		{
			iLocal_335 = get_game_timer();
		}
		if (iLocal_335 > 0)
		{
			if (iLocal_336 == 0)
			{
				if (iLocal_335 + 15000 < get_game_timer())
				{
			...
			else if (iLocal_335 + 10000 < get_game_timer())
			{
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int* iParam5, int iParam6)
{
	...
	if (!bVar5)
	{
		iVar6 = get_room_key_from_entity(iParam0);
	...
	if (does_text_label_exist(&cVar7))
	{
		iVar8 = 1;
	}
	else
	...
	if (iVar8 || func_31(sParam3, &Var4, uParam4))
	{
		if (iVar3 == 5)
		{
			if (iVar2 == 0)
			{
				func_132(uParam2, 0, player_ped_id(), "MICHAEL", 0, 1);
			}
			else if (iVar2 == 1)
			{
				func_132(uParam2, 0, player_ped_id(), "FRANKLIN", 0, 1);
			}
			else if (iVar2 == 2)
			{
				func_132(uParam2, 0, player_ped_id(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)
{
	...
	if (func_29(sParam0, 7))
	{
		...
		{
			func_132(uParam2, 0, player_ped_id(), sVar0, 0, 1);
...
int func_29(char* sParam0, int iParam1)
{
	...
	else if (!func_30() && !is_mobile_phone_call_ongoing())
	{
...
int func_31(char* sParam0, char* sParam1, var uParam2)
{
	...
	if (func_29(sParam0, 7))
	{
		...
		while (iVar6 < *uParam2)
		{
			if (!is_string_null_or_empty(uParam2[iVar6 /*4*/]))
			{
				iVar7 = 0;
				while (iVar7 < Var3.f_0)
				{
					if (!is_string_null_or_empty(&(Var3[iVar7 /*4*/])))
					{
						if (are_strings_equal(uParam2[iVar6 /*4*/], &(Var3[iVar7 /*4*/])))
						{
							iVar8 = iVar7;
		...
		iVar9 = get_random_int_in_range(0, iVar5 + 1);
...
void func_39()
{
	...
	{
		if (func_34(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_40(player_ped_id());
...
void func_47(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_49() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_49() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_48(bParam0));
...
int func_84(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_87(1);
			func_90(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
	...
	func_85(iParam0, sParam1, bVar1, func_86(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_88(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
int func_125(int* iParam0, int iParam1)
{
	...
	if (does_entity_exist(*iParam0))
	{
		...
		{
			case 0:
				if (is_entity_playing_anim(*iParam0, &cLocal_317, &(Local_327[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_334;
					fVar2 = -1f;
					fVar3 = -1f;
					if (find_anim_event_phase(&cLocal_317, &(Local_327[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (get_synchronized_scene_phase(Global_97771) > fVar1)
					{
						...
						if (is_ped_injured(*iParam0))
						{
							...
							task_go_straight_to_coord(*iParam0, Local_263 + Local_266[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 40000f, 0.5f);
							force_ped_motion_state(*iParam0, joaat("MotionState_Walk"), false, 1, false);
							force_ped_ai_and_animation_update(*iParam0, false, false);
							clear_ragdoll_blocking_flags(*iParam0, 2);
						}
						wait(0);
						iLocal_260[iParam1] = 1;
						return 1;
				...
				if (!is_synchronized_scene_running(Global_97770) && !is_synchronized_scene_running(Global_97771))
				{
					wait(0);
					if (is_ped_injured(*iParam0))
					{
			...
			case 1:
				if (get_script_task_status(*iParam0, 2106541073) != 1)
				{
					task_follow_nav_mesh_to_coord(*iParam0, Local_263 + Local_266[iParam1 /*3*/], 1f, -1, 0.25f, bVar0, 40000f);
					iLocal_260[iParam1] = 2;
					return 1;
				}
				fVar5 = vmag(Local_266[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (vdist2(get_entity_coords(*iParam0, true), Local_263) >= fVar5)
				{
					if (!func_130() && !is_entity_on_screen(*iParam0))
					{
						task_follow_nav_mesh_to_coord(*iParam0, Local_263 + Local_266[iParam1 /*3*/], 1f, -1, 0.25f, bVar0, 40000f);
						iLocal_260[iParam1] = 2;
						return 1;
				...
				if (is_player_targetting_entity(player_id(), *iParam0) || is_ped_in_combat(*iParam0, 0))
				{
			...
			case 2:
				...
				if (get_script_task_status(*iParam0, 713668775) != 1)
				{
					...
					task_wander_in_area(*iParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 3f, 6f);
			...
			case 3:
				...
				if (is_scenario_type_enabled(sLocal_333))
				{
					set_scenario_type_enabled(sLocal_333, false);
				}
				if (vdist2(get_entity_coords(*iParam0, true), Local_263 + Local_266[iParam1 /*3*/]) < (fLocal_268[iParam1] * fLocal_268[iParam1]))
				{
					if (does_scenario_exist_in_area(Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], true))
					{
						task_use_nearest_scenario_to_coord(*iParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					else if (get_safe_coord_for_ped(Var6, false, &Var7, 14))
					{
						if (vdist2(get_entity_coords(*iParam0, true), Var7) > 100f)
						{
							task_follow_nav_mesh_to_coord(*iParam0, Var7, 1f, -1, 0.25f, bVar0, 40000f);
							iLocal_260[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				set_relationship_between_groups(5, iLocal_261, joaat("player"));
				set_relationship_between_groups(5, joaat("player"), iLocal_261);
				set_relationship_between_groups(5, iLocal_261, Global_95445);
				set_relationship_between_groups(5, Global_95445, iLocal_261);
...
Vector3 func_126(struct<3> Param0, float fParam1, float fParam2)
{
	...
	while (iVar3 < 10)
	{
		Var0 = { get_random_float_in_range(-fParam1, fParam1), get_random_float_in_range(-fParam1, fParam1), 0f };
		if (((Var0.f_0 * Var0.f_0) + (Var0.f_1 * Var0.f_1)) <= fVar1)
		{
			fVar2 = (fParam2 / 2f);
			Var0.f_2 = get_random_float_in_range(-fVar2, fVar2);
			return Param0 + Var0;
		}
		iVar3++;
	}
...
Vector3 func_127(struct<3> Param0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	Var0 = { func_128(Var0, get_random_float_in_range(0f, fParam1)) };
...
int func_135()
{
	...
	if (!func_134())
	{
		if (is_synchronized_scene_running(Global_97771))
		{
			...
			while (iVar0 < iLocal_258)
			{
				if (!is_ped_injured(iLocal_258[iVar0]))
				{
					task_synchronized_scene(iLocal_258[iVar0], Global_97771, &cLocal_317, &(Local_327[iVar0 /*16*/]), 8f, -4f, 3, 0, 1000f, 0);
					iLocal_260[iVar0] = 0;
				}
				else
				{
...
int func_136()
{
	...
	if (is_synchronized_scene_running(Global_97770))
	{
		...
		while (iVar0 < iLocal_258)
		{
			if (!is_ped_injured(iLocal_258[iVar0]))
			{
				task_synchronized_scene(iLocal_258[iVar0], Global_97770, &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		if (!is_ped_injured(player_ped_id()))
		{
			func_132(&uLocal_68, 1, player_ped_id(), "FRANKLIN", 0, 1);
		}
		if (!is_ped_injured(Global_100162))
		{
			func_132(&uLocal_68, 4, Global_100162, "LAMAR", 0, 1);
		}
		if (!is_ped_injured(iLocal_258[0]))
		{
			func_132(&uLocal_68, 5, iLocal_258[0], "GangMember1", 0, 1);
		}
		if (!is_ped_injured(iLocal_258[1]))
		{
...
void func_145()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_258)
		{
			...
			{
				request_model(iLocal_259[iVar0]);
				if (!has_model_loaded(iLocal_259[iVar0]))
				{
					bVar2 = false;
					request_model(iLocal_259[iVar0]);
				}
		...
		if (!is_string_null_or_empty(&cLocal_317))
		{
			request_anim_dict(&cLocal_317);
			if (!has_anim_dict_loaded(&cLocal_317))
			{
				bVar2 = false;
				request_anim_dict(&cLocal_317);
			}
	...
	if (does_entity_exist(Global_100162))
	{
		if (func_37(19) == get_entity_model(Global_100162))
		{
			set_entity_as_mission_entity(Global_100162, true, true);
		}
		func_146(&Global_100162, Global_95445);
		set_ped_config_flag(Global_100162, 132, true);
		set_ped_config_flag(Global_100162, 317, true);
		func_146(&Global_100162, Global_95445);
	}
	add_relationship_group("TAUNTERS", &iLocal_261);
	iVar0 = 0;
	while (iVar0 < iLocal_258)
	{
		if (iLocal_259[iVar0] != 0)
		{
			iLocal_258[iVar0] = create_ped(iLocal_262, iLocal_259[iVar0], Local_263 + Local_265[iVar0 /*3*/], 0f, true, true);
			set_entity_heading(iLocal_258[iVar0], (fLocal_264 + fLocal_267[iVar0]));
			set_ped_random_component_variation(iLocal_258[iVar0], 0);
			set_ped_relationship_group_hash(iLocal_258[iVar0], iLocal_261);
			task_play_anim(iLocal_258[iVar0], &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -8f, -1, 9, 0f, false, false, false);
			set_ped_config_flag(iLocal_258[iVar0], 317, true);
			if (iLocal_262 == 6)
			{
				give_weapon_to_ped(iLocal_258[iVar0], joaat("weapon_stungun"), 1000, false, true);
			}
		}
		iVar0++;
	}
...
void func_147()
{
	...
	{
		case 218:
			Local_265[0 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_265[1 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_266[0 /*3*/] = { -77.3f, -4.1f, 1f };
			Local_266[1 /*3*/] = { Local_266[0 /*3*/] };
			Local_266[iLocal_258 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_267[0] = get_random_float_in_range(-180f, 180f);
			fLocal_267[1] = get_random_float_in_range(-180f, 180f);
			fLocal_268[0] = 30f;
...
void func_158()
{
	...
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			set_ped_as_no_longer_needed(&(iLocal_258[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_259)
	{
		if (iLocal_259[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_259[iVar0]);
		}
		iVar0++;
	}
	remove_relationship_group(iLocal_261);
	if (!is_scenario_type_enabled(sLocal_333))
	{
		set_scenario_type_enabled(sLocal_333, true);
	}
