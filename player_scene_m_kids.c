...
void func_3(int iParam0, int iParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		{
			case 0:
				if (is_synchronized_scene_running(Global_97771))
				{
					if (is_entity_playing_anim(iParam0, &sLocal_249, &(Local_298[iParam1 /*16*/]), 2))
					{
			...
			case 5:
				if (is_entity_playing_anim(iParam0, &sLocal_249, &(Local_298[iParam1 /*16*/]), 2))
				{
					...
					if (is_synchronized_scene_running(Global_97771))
					{
						if (!is_entity_dead(iLocal_239[iParam1], false))
						{
							if (is_entity_playing_anim(iLocal_239[iParam1], &sLocal_249, &(Local_244[iParam1 /*16*/]), 2))
							{
								if (get_synchronized_scene_phase(Global_97771) > 0.817f)
								{
									stop_synchronized_entity_anim(iLocal_239[iParam1], -8f, true);
									Var6 = { -824.5328f, 175.0702f, 69.8919f };
									fVar7 = 156.6901f;
									Var6.f_0 = -824.333f;
									fVar7 = 140.49f;
									set_entity_coords(iLocal_239[iParam1], Var6, true, false, false, true);
									set_entity_heading(iLocal_239[iParam1], fVar7);
									set_vehicle_on_ground_properly(iLocal_239[iParam1], 5f);
								}
							}
						}
						if (get_synchronized_scene_phase(Global_97771) > fLocal_313)
						{
			...
			case 10:
				...
				{
					if (!is_synchronized_scene_running(iLocal_312))
					{
						iLocal_312 = create_synchronized_scene(Var0 + Var12, 0f, 0f, (fVar1 + fVar13), 2);
						set_synchronized_scene_looped(iLocal_312, true);
						set_synchronized_scene_hold_last_frame(iLocal_312, false);
					}
					task_synchronized_scene(iParam0, iLocal_312, &sVar8, &cVar9, 1000f, -8f, 0, 0, 1000f, 0);
					set_synchronized_scene_hold_last_frame(iLocal_312, true);
					iLocal_235[iParam1] = 1;
				}
				break;
	...
	switch (iParam1)
	{
		...
		case 60:
			if (func_4(iParam0, 59, uParam2, uParam3))
			{
				...
				*uParam3 = (*uParam3 + get_random_float_in_range(-10f, 10f));
				return 1;
			}
			break;
...
int func_9()
{
	...
	if (!func_34())
	{
		if (is_synchronized_scene_running(Global_97771))
		{
			if (is_string_null_or_empty(&Local_299))
			{
			}
			else if (!iLocal_303)
			{
			...
			{
				fVar0 = get_synchronized_scene_phase(Global_97771);
				if (!iLocal_304)
				{
					if (fVar0 <= fLocal_302)
					{
...
int func_34()
{
	...
	if (get_player_switch_state() > 8)
	{
		...
		if (get_player_switch_state() == 11)
		{
			...
			{
				if (get_player_switch_interp_out_current_time() > 100)
				{
					return 0;
				}
			}
...
int func_35()
{
	...
	if (!is_string_null_or_empty(&Local_299) && !iLocal_303)
	{
		if (func_11(&uLocal_67, "PRSAUD", &Local_299, 3, 0, 0, 0, 0))
		{
			iLocal_303 = 1;
	...
	if (!func_34())
	{
		if (is_synchronized_scene_running(Global_97771))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!is_ped_injured(iLocal_233[iVar0]))
				{
					if (!is_entity_dead(iLocal_239[iVar0], false))
					{
						if (is_ped_sitting_in_vehicle(iLocal_233[iVar0], iLocal_239[iVar0]))
						{
							set_entity_coords(iLocal_233[iVar0], get_entity_coords(iLocal_233[iVar0], true), true, false, false, true);
						}
					}
					task_synchronized_scene(iLocal_233[iVar0], Global_97771, &sLocal_249, &(Local_298[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
					iLocal_235[iVar0] = 0;
				}
				else
				{
				...
				if (!is_entity_dead(iLocal_239[iVar0], false))
				{
					if (is_playback_going_on_for_vehicle(iLocal_239[iVar0]))
					{
						stop_playback_recorded_vehicle(iLocal_239[iVar0]);
					}
					play_synchronized_entity_anim(iLocal_239[iVar0], Global_97771, &(Local_244[iVar0 /*16*/]), &sLocal_249, 8f, 8f, 0, 1000f);
				}
				iVar0++;
			}
			if (!is_string_null_or_empty(&Local_299) && iLocal_303)
...
int func_36()
{
	...
	if (is_synchronized_scene_running(Global_97770))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_233)
		{
			if (!is_ped_injured(iLocal_233[iVar0]))
			{
				task_synchronized_scene(iLocal_233[iVar0], Global_97770, &sLocal_249, &(Local_297[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			if (!is_entity_dead(iLocal_239[iVar0], false))
			{
				if (!is_string_null_or_empty(&(Local_243[iVar0 /*16*/])))
				{
					play_synchronized_entity_anim(iLocal_239[iVar0], Global_97770, &(Local_243[iVar0 /*16*/]), &sLocal_249, 8f, 8f, 0, 1000f);
				}
				else
				{
					if (!is_playback_going_on_for_vehicle(iLocal_239[iVar0]))
					{
						start_playback_recorded_vehicle(iLocal_239[iVar0], iLocal_308[iVar0], &Local_305, true);
					}
					skip_time_in_playback_recorded_vehicle(iLocal_239[iVar0], (fLocal_310 - get_time_position_in_recording(iLocal_239[iVar0])));
					set_playback_speed(iLocal_239[iVar0], fLocal_311);
				}
			}
			iVar0++;
		}
		if (!is_string_null_or_empty(&Local_299))
		{
			func_37(&uLocal_67, 0, player_ped_id(), "MICHAEL", 0, 1);
			if (iLocal_66 == 156)
			{
	...
	else if (is_synchronized_scene_running(Global_97771))
	{
		_dispose_synchronized_scene(Global_97771);
		if (!is_string_null_or_empty(&Local_299))
		{
			func_37(&uLocal_67, 0, player_ped_id(), "MICHAEL", 0, 1);
			if (iLocal_66 == 156)
...
int func_38(int iParam0, int iParam1)
{
	...
	if (!is_player_switch_in_progress())
	{
		...
		{
			Var0 = { get_entity_coords(iParam1, false) };
			fVar1 = vdist(get_entity_coords(player_ped_id(), false), Var0);
			if (fVar1 > 250f)
			{
				...
				else if (!is_sphere_visible(Var0, 1.5f))
				{
					return 0;
				}
			}
...
void func_46()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_233)
		{
			...
			{
				request_model(iLocal_240[iVar0]);
				if (!has_model_loaded(iLocal_240[iVar0]))
				{
					bVar2 = false;
					request_model(iLocal_240[iVar0]);
				}
			}
			if (!is_string_null_or_empty(&Local_305) && iLocal_308[iVar0] > 0)
			{
				request_vehicle_recording(iLocal_308[iVar0], &Local_305);
				if (!has_vehicle_recording_been_loaded(iLocal_308[iVar0], &Local_305))
				{
					request_vehicle_recording(iLocal_308[iVar0], &Local_305);
					bVar2 = false;
				}
		...
		if (!is_string_null_or_empty(&sLocal_249))
		{
			request_anim_dict(&sLocal_249);
			if (!has_anim_dict_loaded(&sLocal_249))
			{
				bVar2 = false;
				request_anim_dict(&sLocal_249);
			}
		...
		if (func_6(iLocal_236[0], iLocal_237[0], &Var3, &cVar4, &iVar5, &iVar6))
		{
			...
			{
				request_anim_dict(&Var3);
				if (!has_anim_dict_loaded(&Var3))
				{
					bVar2 = false;
					request_anim_dict(&Var3);
				}
	...
	while (iVar0 < iLocal_239)
	{
		if (iLocal_240[iVar0] != 0)
		{
			iLocal_239[iVar0] = create_vehicle(iLocal_240[iVar0], Local_245 + Local_241[iVar0 /*3*/], (fLocal_246 + fLocal_242[iVar0]), false, false, false);
			set_vehicle_on_ground_properly(iLocal_239[iVar0], 5f);
			if (!is_string_null_or_empty(&(Local_243[iVar0 /*16*/])))
			{
				play_entity_anim(iLocal_239[iVar0], &(Local_243[iVar0 /*16*/]), &sLocal_249, 8f, true, false, false, 0f, 0);
			}
			else
			{
				start_playback_recorded_vehicle(iLocal_239[iVar0], iLocal_308[iVar0], &Local_305, true);
	...
	add_relationship_group("KIDSS", &iLocal_238);
	iVar0 = 0;
	while (iVar0 < iLocal_233)
	{
		if (iLocal_234[iVar0] != 145)
		{
			if (func_172(&(iLocal_233[iVar0]), iLocal_234[iVar0], Local_245 + Local_247[iVar0 /*3*/], (fLocal_246 + fLocal_248[iVar0]), 1))
			{
				...
				set_ped_relationship_group_hash(iLocal_233[iVar0], iLocal_238);
				if (!is_string_null_or_empty(&(Local_297[iVar0 /*16*/])))
				{
					task_play_anim(iLocal_233[iVar0], &sLocal_249, &(Local_297[iVar0 /*16*/]), 8f, -8f, -1, 9, 0f, false, false, false);
					iLocal_235[iVar0] = 0;
				}
				else if (is_vehicle_driveable(iLocal_239[iVar0], false))
				{
					set_ped_into_vehicle(iLocal_233[iVar0], iLocal_239[iVar0], -1);
					iLocal_235[iVar0] = 20;
				}
			}
		}
...
int func_47(var uParam0, int iParam1, int iParam2)
{
	switch (iParam2)
	{
		...
		case 218:
			...
			set_ped_component_variation(*uParam0, 3, 2, 2, 0);
			set_ped_component_variation(*uParam0, 4, 5, 0, 0);
			set_ped_component_variation(*uParam0, 6, 1, 0, 0);
			set_ped_component_variation(*uParam0, 10, 1, 0, 0);
			return 1;
			break;
		...
		case 225:
			...
			set_ped_component_variation(*uParam0, 3, 2, 1, 0);
...
int func_48(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		case 4:
			...
			set_ped_prop_index(iParam0, 0, 0, 1, false);
			return 1;
			break;
		
		case 10:
			set_ped_default_component_variation(iParam0);
			set_ped_prop_index(iParam0, 0, 0, 0, false);
			set_ped_prop_index(iParam0, 1, 0, 0, false);
			if (iParam2 != 101)
			{
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_50(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_50(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_55(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_55(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 1) || does_shop_ped_apparel_have_restriction_tag(func_55(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (does_shop_ped_apparel_have_restriction_tag(iParam3, joaat("HAT"), 0) || does_shop_ped_apparel_have_restriction_tag(func_55(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_50(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_50(iParam2));
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_73(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_73(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_50(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_50(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_50(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_50(iVar0), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
						}
						func_162(iVar0);
						if (Global_78128 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_50(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_50(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_50(iParam1), Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4, iParam4);
		}
		if (Global_78128 == 1)
		{
			iVar2 = 0;
...
void func_156(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_157(get_entity_model(iParam0), 14, iVar0, get_hash_name_for_prop(iParam0, 0, iParam2, iParam3)))
			{
...
int func_158(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_63(get_entity_model(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_63(get_entity_model(iParam0), iVar1, 14, 4);
		}
	}
...
int func_172(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_175(int iParam0)
{
	if (!func_25(iParam0))
	{
		return has_model_loaded(func_174(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_176(int iParam0)
{
	if (!func_25(iParam0))
	{
		request_model(func_174(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_177()
{
	...
	{
		case 86:
			Local_247[0 /*3*/] = { get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f };
			fLocal_248[0] = get_random_float_in_range(-180f, 180f);
			iLocal_234[0] = 14;
			iLocal_236[0] = 0;
			iLocal_237[0] = 19;
		...
		case 168:
			Local_247[0 /*3*/] = { get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f };
			fLocal_248[0] = get_random_float_in_range(-180f, 180f);
			Local_247[1 /*3*/] = { get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f };
			fLocal_248[1] = get_random_float_in_range(-180f, 180f);
			iLocal_234[0] = 14;
			iLocal_234[1] = 15;
			iLocal_236[0] = 0;
			iLocal_236[1] = 1;
		...
		case 173:
			...
			Local_241[0 /*3*/] = { get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f };
			fLocal_242[0] = get_random_float_in_range(-180f, 180f);
		...
		default:
			Local_247[0 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			Local_247[1 /*3*/] = { get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f };
			fLocal_248[0] = get_random_float_in_range(-180f, 180f);
			fLocal_248[1] = get_random_float_in_range(-180f, 180f);
			iLocal_234[0] = 145;
			iLocal_234[1] = 145;
...
struct<4> func_178(char* sParam0, int iParam1)
{
	...
	switch (get_random_int_in_range(0, iParam1))
	{
		case 0:
...
int func_185(int iParam0, var uParam1, char* sParam2)
{
	...
	switch (iParam0)
	{
		...
		case 306:
			...
			*uParam1 = get_heading_from_vector_2d(-Var4.f_0, -Var4.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 307:
			...
			*uParam1 = get_heading_from_vector_2d(-Var5.f_0, -Var5.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 308:
			...
			*uParam1 = get_heading_from_vector_2d(-Var6.f_0, -Var6.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 309:
			...
			*uParam1 = get_heading_from_vector_2d(-Var7.f_0, -Var7.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
...
void func_188()
{
	...
	while (iVar0 < iLocal_234)
	{
		...
		if (!is_string_null_or_empty(&Local_305) && iLocal_308[iVar0] > 0)
		{
			remove_vehicle_recording(iLocal_308[iVar0], &Local_305);
		}
		iVar0++;
	}
	remove_relationship_group(iLocal_238);
...
void func_189(int iParam0)
{
	if (!func_25(iParam0))
	{
		set_model_as_no_longer_needed(func_174(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
