...
void __EntryFunction__()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	iLocal_44 = get_standard_blip_enum_id();
	iLocal_45 = get_waypoint_blip_enum_id();
	...
	iLocal_105 = -1;
	iLocal_106 = -1;
	sLocal_107 = get_control_instructional_button(2, 195, true);
...
void func_1()
{
	...
	func_5();
	if (func_3(Global_112417) && is_ped_in_vehicle(player_ped_id(), Global_112417, true))
	{
		if (!func_2(player_ped_id(), -828834893) && !func_2(player_ped_id(), 451360105))
		{
	...
	else
	{
		if (is_player_wanted_level_greater(player_id(), 0))
		{
			...
			{
				if (is_ped_in_vehicle(Global_112418, Global_112417, false))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						task_vehicle_mission_ped_target(Global_112418, Global_112417, player_ped_id(), 8, 25f, 790564, 300f, 15f, true);
					}
				}
				else if (!is_ped_fleeing(Global_112418))
				{
					if (!is_ped_injured(player_ped_id()))
					{
						task_smart_flee_ped(Global_112418, player_ped_id(), 300f, -1, false, false);
					}
				}
				set_ped_keep_task(Global_112418, true);
				set_blocking_of_non_temporary_events(Global_112418, false);
			}
		}
		else if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
		{
			if (is_ped_in_vehicle(Global_112418, Global_112417, false))
			{
				if (!func_2(Global_112418, -258271821))
				{
					task_vehicle_drive_wander(Global_112418, Global_112417, 12f, 790699);
				}
			}
			set_ped_keep_task(Global_112418, true);
			set_blocking_of_non_temporary_events(Global_112418, false);
...
void func_5()
{
	...
	if (does_group_exist(func_6()))
	{
		get_group_size(func_6(), &uVar1, &iVar0);
		if (iVar0 > 0)
		{
			iVar2 = get_ped_as_group_member(func_6(), 0);
			...
			if (iVar0 > 1)
			{
				iVar2 = get_ped_as_group_member(func_6(), 1);
				if (!is_ped_injured(iVar2))
				{
					clear_ped_tasks(iVar2);
					if (!is_entity_dead(Global_112417, false))
			...
			if (is_ped_sitting_in_vehicle(Global_112418, Global_112417))
			{
				if (!func_61())
				{
					...
					if (func_54(func_55()) >= iLocal_101)
					{
						...
						else if (get_entity_speed(Global_112417) > 5f)
						{
							if (!func_8())
							{
								iLocal_818 = 12;
...
void func_13(bool bParam0)
{
	...
	else if (BitTest(Global_113386.f_20564.f_471, bParam0) || BitTest(Global_2359296[func_15() /*5567*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		clear_bit(&(Global_113386.f_20564.f_471), bParam0);
		clear_bit(&(Global_2359296[func_15() /*5567*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		begin_text_command_thefeed_post("COUP_RED");
		add_text_component_substring_text_label(func_14(bParam0));
			...
			if (!*iParam1 == 0)
			{
				...
				else if (*iParam1 == 9)
				{
					if (is_player_playing(player_id()))
					{
						...
						func_48(player_ped_id(), "TAXI_CHANGE_DEST", 7);
						if (bVar0)
						{
				...
				else if (*iParam1 == 18)
				{
					...
					else if (timera() > 4000)
					{
						if (is_player_playing(player_id()))
						{
							...
							{
								case 0:
									func_48(player_ped_id(), "RADIO_REQ_VIBE", 7);
									break;
								
								case 1:
									func_48(player_ped_id(), "RADIO_REQ_LRR", 7);
									break;
								
								case 2:
									func_48(player_ped_id(), "RADIO_REQ_JNR", 7);
									break;
								
								case 3:
									func_48(player_ped_id(), "RADIO_REQ_MASSIVEB", 7);
									break;
								
								case 4:
									func_48(player_ped_id(), "RADIO_REQ_K109", 7);
									break;
								
								case 5:
									func_48(player_ped_id(), "RADIO_REQ_WKTT", 7);
									break;
								
								case 6:
									func_48(player_ped_id(), "RADIO_REQ_LCHC", 7);
									break;
								
								case 7:
									func_48(player_ped_id(), "RADIO_REQ_JOURNEY", 7);
									break;
								
								case 8:
									func_48(player_ped_id(), "RADIO_REQ_FUSION", 7);
									break;
								
								case 9:
									func_48(player_ped_id(), "RADIO_REQ_BEAT", 7);
									break;
								
								case 10:
									func_48(player_ped_id(), "RADIO_REQ_BROKER", 7);
									break;
								
								case 11:
									func_48(player_ped_id(), "RADIO_REQ_VLADIVOSTOK", 7);
									break;
								
								case 12:
									func_48(player_ped_id(), "RADIO_REQ_PLR", 7);
									break;
								
								case 13:
									func_48(player_ped_id(), "RADIO_REQ_SANJUAN", 7);
									break;
								
								case 14:
									func_48(player_ped_id(), "RADIO_REQ_FRANCOIS", 7);
									break;
								
								case 15:
									func_48(player_ped_id(), "RADIO_REQ_CLASSICS", 7);
									break;
							}
							if (bVar0)
							{
				...
				else if (*iParam1 == 20)
				{
					if (is_player_playing(player_id()))
					{
						...
						func_48(player_ped_id(), "TAXI_STEP_ON_IT", 7);
						if (bVar0)
						{
							stop_ped_speaking(player_ped_id(), true);
						}
				...
				else if (*iParam1 == 23)
				{
					if (is_player_playing(player_id()))
					{
						...
						func_48(player_ped_id(), "THANKS", 7);
						if (bVar0)
						{
							stop_ped_speaking(player_ped_id(), true);
						}
...
char* func_46()
{
	...
	StringCopy(&cVar0, get_name_of_zone(func_47(Local_43.f_0)), 32);
...
int func_50(int iParam0, bool bParam1)
{
	...
	if (is_player_playing(player_id()))
	{
		if (does_group_exist(func_6()))
		{
			get_group_size(func_6(), &iVar2, &iVar1);
			if (iVar1 > 0)
			{
				iVar2 = 0;
				while (iVar2 < iVar1)
				{
					iVar0 = get_ped_as_group_member(func_6(), iVar2);
...
void func_56()
{
	...
	{
		if (func_59(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_58(player_ped_id());
	...
	if (func_226())
	{
		...
		if (iLocal_821 != 4)
		{
			...
			if (iLocal_821 != 0)
			{
				if (func_210())
				{
					if (has_scaleform_movie_loaded(iLocal_111))
					{
						func_187();
						iLocal_58 = 1;
					}
		...
		switch (iLocal_821)
		{
			case 0:
				if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
				{
					if (is_ped_sitting_in_vehicle(Global_112418, Global_112417))
					{
						if (!is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_enter", 3) && !is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_idle", 3))
						{
				...
				if (func_177())
				{
					if (func_176() && !is_ped_getting_into_a_vehicle(player_ped_id()))
					{
						func_187();
						iLocal_818 = 1;
						iLocal_820 = 0;
			...
			case 1:
				...
				if (func_173())
				{
					stat_increment(joaat("sp_number_of_taxis_used"), 1f);
					iLocal_58 = 1;
					iLocal_821 = 2;
				}
				break;
	...
	if (!func_219())
	{
		if (has_scaleform_movie_loaded(iLocal_112))
		{
			if (iLocal_821 != 0)
			{
				...
				if (!are_strings_equal(sLocal_107, sVar0))
				{
					sLocal_107 = sVar0;
					iLocal_58 = 1;
				}
			...
			while (bVar0 < uParam2->f_693)
			{
				if (BitTest(uParam2->f_689, bVar0))
				{
					...
					if (!BitTest(uParam2->f_690, bVar0))
					{
						...
						func_69(get_control_instructional_button(iVar1, iVar2, true));
						if (iVar3 < 363)
						{
							func_69(get_control_instructional_button(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_69(get_control_group_instructional_button(iVar4, iVar5, true));
					}
...
int func_74()
{
	...
	if (does_cam_exist(iLocal_68))
	{
		if (is_cam_active(iLocal_68))
		{
			return 0;
		}
	}
...
void func_79()
{
	...
	switch (iLocal_823)
	{
		...
		case 1:
			if (is_screen_faded_out() && is_audio_scene_active("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (is_vehicle_driveable(Global_112417, false))
				{
					set_vehicle_radio_enabled(Global_112417, false);
				}
				clear_prints();
				...
				{
					delete_object(&iLocal_109);
					set_model_as_no_longer_needed(iLocal_108);
				}
				if (is_cam_active(iLocal_68))
				{
					set_particle_fx_cam_inside_vehicle(false);
					Global_112434 = 0;
					set_cam_active(iLocal_68, false);
					render_script_cams(false, false, 3000, true, false, 0);
		...
		case 3:
			if (Global_78335 == -1)
			{
				...
				func_116();
				func_115();
				clear_area(Global_112424, 5f, true, false, false, false);
				func_111(1097859072);
				if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
				{
					set_entity_coords(Global_112417, Global_112424, true, false, false, true);
					set_entity_heading(Global_112417, Global_112430);
					freeze_entity_position(Global_112417, true);
				}
				set_gameplay_cam_relative_heading(0f);
				set_gameplay_cam_relative_pitch(0f, 1f);
				new_load_scene_stop();
				clear_area(Global_112424, 5000f, true, false, false, false);
				clear_area_of_objects(Global_112424, 5000f, 0);
				clear_area_of_projectiles(Global_112424, 30f, 0);
				remove_particle_fx_in_range(Global_112424, 5000f);
				remove_decals_in_range(Global_112424, 5000f);
				if (Global_97363 != -1)
				{
		...
		case 4:
			if (new_load_scene_start_sphere(Global_112424, 4500f, 0))
			{
				iLocal_57 = 1;
				iLocal_823 = 5;
			}
		...
		case 6:
			...
			if (iLocal_815 != -1)
			{
				...
				if (bVar1)
				{
					advance_clock_time_to(Global_91229[iLocal_815 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				{
					iLocal_67 = 0;
					get_ground_z_for_3d_coord(Global_112424 + Vector(100f, 0f, 0f), &fVar2, false, false);
				...
				if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
				{
					freeze_entity_position(Global_112417, false);
					set_entity_heading(Global_112417, Global_112430);
					set_entity_coords(Global_112417, Global_112424, true, false, false, true);
					set_vehicle_on_ground_properly(Global_112417, 5f);
					task_vehicle_temp_action(Global_112418, Global_112417, 24, 5000);
				}
				iLocal_89 = get_game_timer();
				iLocal_823 = 8;
			}
		...
		case 8:
			if (func_160(iLocal_89, 500))
			{
				...
				if (is_vehicle_driveable(Global_112417, false))
				{
					set_vehicle_radio_enabled(Global_112417, true);
				}
				if (!func_80())
				{
...
void func_81()
{
	...
	switch (iLocal_816)
	{
		case 92:
			Var0 = { func_83(229, 0) };
			fVar1 = get_distance_between_coords(Global_112424, Var0, true);
			if (fVar1 < 100f)
			{
				Var0 = { func_82(Global_112424 - Var0) };
				Var0 = { (Global_112424 + (Var0.f_0 * IntToFloat((100 - round(fVar1))))), (Global_112424.f_1 + (Var0.f_1 * IntToFloat((100 - round(fVar1))))), Global_112424.f_2 };
				get_closest_vehicle_node_with_heading(Var0, &Global_112424, &Global_112430, 1, 3f, 0);
				set_entity_coords(Global_112417, Global_112424, true, false, false, true);
				set_entity_heading(Global_112417, Global_112430);
			}
			break;
...
{
	return func_104(get_clock_hours(), iParam0, iParam1);
}
...
void func_111(float fParam0)
{
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (get_nth_closest_vehicle_node(Global_112424, iVar2, &Var3, 1, 1077936128, 0))
			{
				iVar2++;
			}
		}
	}
	if (vdist2(Var3, Global_112424) > 2f)
	{
		get_safe_coord_for_ped(Var3, false, &Global_112424, 0);
	}
}

int func_112(int iParam0, struct<3> Param1, float fParam2)
{
	int iVar0[5];
	int iVar1;
	...
	while (iVar1 < iVar0)
	{
		*iParam0 = get_closest_vehicle(Param1, fParam2, iVar0[iVar1], 67590);
		if (*iParam0 != 0)
		{
			return 1;
		}
...
void func_116()
{
	...
	fVar0 = func_119(get_entity_coords(player_ped_id(), false), Global_112424);
	if (bLocal_64)
	{
	...
	add_to_clock_time(iVar1, iVar2, 0);
...
void func_120()
{
	...
	fVar0 = (((func_119(get_entity_coords(player_ped_id(), false), Global_112424) / 50f) * fLocal_73) * 2.4f);
...
void func_121()
{
	iLocal_103 = (iLocal_103 + round((get_frame_time() * 1000f)));
	if (iLocal_103 > 5000)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
	}
	if (get_distance_between_coords(get_entity_coords(player_ped_id(), false), Local_833, false) > 50f)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
		Local_833 = { get_entity_coords(player_ped_id(), false) };
	}
	iLocal_101 = ceil(fLocal_82);
	if (iLocal_101 != iLocal_102)
	{
		begin_scaleform_movie_method(iLocal_111, "SET_TAXI_PRICE");
		scaleform_movie_method_add_param_int(iLocal_101);
		end_scaleform_movie_method();
		fLocal_83 = vdist(get_entity_coords(player_ped_id(), false), Global_112424);
...
void func_122()
{
	...
	if (!func_38(14))
	{
		fVar1 = calculate_travel_distance_between_points(get_entity_coords(player_ped_id(), true), Global_112424);
		stat_increment(iVar0, fVar1);
	}
}
...
{
	new_load_scene_stop();
	if (streamvol_is_valid(Global_112096.f_218))
	{
		streamvol_delete(Global_112096.f_218);
	}
}
	...
	if (does_blip_exist(*iParam0))
	{
		switch (iLocal_820)
		{
			case 0:
				...
				if (does_blip_exist(Global_112422) && *iParam0 == Global_112422)
				{
			...
			case 2:
				...
				{
					if (func_125(&Global_112417, get_entity_coords(Global_112417, false), Local_829, uParam1, fParam2, &iLocal_88, iParam0, 1000))
					{
						iLocal_820 = 3;
						return 0;
					}
...
int func_125(var uParam0, struct<3> Param1, struct<3> Param2, var* uParam3, float* fParam4, int iParam5, var uParam6, int iParam7)
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
	...
	if (func_129(Local_830, Local_831))
	{
		while (!bVar13 && *iParam5 < iVar18)
		{
			...
			if (get_nth_closest_vehicle_node_with_heading(Param2, *iParam5, uParam3, fParam4, &iVar6, iVar14, fVar0, fVar1))
			{
				iVar12 = get_nth_closest_vehicle_node_id(*uParam3, 1, iVar14, 3f, 0f);
				if (is_vehicle_node_id_valid(iVar12))
				{
					if (get_closest_road(*uParam3, 1f, 1, &uVar4, &uVar3, &iVar8, &iVar7, &fVar10, bVar15))
					{
						...
						else
						{
							...
							if (get_vehicle_node_properties(*uParam3, &uVar21, &uVar20))
							{
								if (!uVar20 & 64 == 0)
								{
						...
						{
							*uParam3 = { _get_object_offset_from_coords(*uParam3, *fParam4, fVar9, 0f, 0f) };
							if (is_vehicle_driveable(*uParam0, false))
							{
								iVar5 = *uParam0;
							}
							if (!is_point_obscured_by_a_mission_entity(*uParam3, 3f, 3f, 3f, iVar5))
							{
			...
			*iParam5++;
			if (*iParam5 >= iVar19)
			{
				*uParam3 = { Param2 };
				...
				{
					fVar11 = 1f;
					fVar11 = get_approx_floor_for_area((*uParam3 - 2f), (uParam3->f_1 - 2f), (*uParam3 + 2f), (uParam3->f_1 + 2f));
					if (fVar11 > 1f)
					{
						iLocal_67 = 1;
						uParam3->f_2 = fVar11;
...
{
	if (does_blip_exist(*uParam0) && func_127(*uParam0) == get_waypoint_blip_enum_id())
	{
		return 1;
	}
	return 0;
...
int func_133(struct<3> Param0, var* uParam1, float* fParam2, int iParam3)
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var2[6];
...
int func_144(struct<3> Param0, var* uParam1, float* fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_146(int iParam0, struct<3> Param1)
{
	switch (iParam0)
	{
		case 76:
			...
			if (is_point_in_angled_area(Param1, -1157.595f, -2726.636f, 12.94464f, -1110.794f, -2679.33f, 22.94466f, 26f, false, true))
			{
				return 1;
			}
			break;
		...
		case 70:
			...
			if (is_point_in_angled_area(Param1, -1908.065f, 4432.693f, 51.3842f, -1962.212f, 4473.8f, 22.93989f, 70f, false, true))
			{
				return 1;
			}
			break;
		...
		case 71:
			...
			if (is_point_in_angled_area(Param1, -541.8311f, 2050.599f, 186.3904f, -499.787f, 1968.325f, 228.0183f, 70f, false, true))
			{
				return 1;
			}
			break;
		...
		case 73:
			...
			if (is_point_in_angled_area(Param1, -179.8588f, 4216.167f, 30.26505f, -246.32f, 4226.653f, 53.77886f, 70f, false, true))
			{
				return 1;
			}
			break;
		...
		case 74:
			...
			if (is_point_in_angled_area(Param1, 1634.122f, 3858.049f, 28.33912f, 1573.259f, 3800.442f, 48.35476f, 70f, false, true))
			{
				return 1;
			}
			break;
		...
		case 75:
			...
			if (is_point_in_angled_area(Param1, 2057.873f, 2059.198f, 63.88074f, 1999.045f, 2190.544f, 122.2642f, 110f, false, true))
			{
				return 1;
			}
			break;
		...
		case 72:
			...
			if (is_point_in_angled_area(Param1, 3028.084f, 2768.167f, 57.72984f, 2944.284f, 2772.836f, 30.23068f, 85f, false, true))
			{
				return 1;
			}
			break;
		...
		case 106:
			...
			if (is_point_in_angled_area(Param1, 2097.951f, 4820.308f, 55.48169f, 2151.254f, 4726.398f, 31.0732f, 120f, false, true))
			{
				return 1;
			}
			break;
		...
		case 125:
			...
			if (is_point_in_angled_area(Param1, -763.5086f, -1297.98f, 2.000373f, -864.1372f, -1278.007f, 24.15038f, 85f, false, true))
			{
				return 1;
			}
			break;
		...
		case 126:
			...
			if (is_point_in_angled_area(Param1, 1137.022f, 89.06853f, 74.89022f, 1267.821f, 292.0106f, 102.9904f, 195f, false, true))
			{
				return 1;
			}
			break;
		...
		case 127:
			...
			if (is_point_in_angled_area(Param1, 2512.305f, 1519.462f, 28.55504f, 2380.374f, 1521.587f, 58.80984f, 90f, false, true))
			{
				return 1;
			}
			break;
		...
		case 128:
			...
			if (is_point_in_angled_area(Param1, -193.5583f, 6533.439f, -1.902109f, -299.2512f, 6645.049f, 20.45973f, 120f, false, true))
			{
				return 1;
			}
			break;
		...
		case 131:
			...
			if (is_point_in_angled_area(Param1, -1171.147f, 4647.89f, 203.7937f, -1280.149f, 4457.597f, 5.653551f, 120f, false, true))
			{
				return 1;
			}
			break;
		...
		case 132:
			...
			if (is_point_in_angled_area(Param1, -687.974f, 4499.52f, 114.781f, -826.0081f, 4496.864f, 49.88359f, 140f, false, true))
			{
				return 1;
			}
			break;
		...
		case 134:
			...
			if (is_point_in_angled_area(Param1, -1364.701f, 4490.626f, 49.52477f, -1367.169f, 4340.34f, -1.682158f, 100f, false, true))
			{
				return 1;
			}
			break;
		...
		case 135:
			...
			if (is_point_in_angled_area(Param1, 2566.189f, 5007.007f, 97.36896f, 2491.714f, 4923.261f, 30.43494f, 80f, false, true))
			{
				return 1;
			}
			break;
		...
		case 136:
			...
			if (is_point_in_angled_area(Param1, 1009.917f, -163.4684f, 102.1028f, 1113.474f, -221.3295f, 49.8745f, 90f, false, true))
			{
				return 1;
			}
			break;
...
int func_148(int iParam0, struct<3> Param1)
{
	switch (iParam0)
	{
		...
		case 11:
			...
			if (is_point_in_angled_area(Param1, 1882.79f, 4725.034f, 34.74373f, 1701.497f, 4677.47f, 47.89289f, 159.5f, false, true))
			{
				return 1;
			}
			break;
		...
		case 21:
			...
			if (is_point_in_angled_area(Param1, -1903.322f, -401.2384f, 19.23456f, -1844.879f, -445.7261f, 73.56197f, 115f, false, true))
			{
				return 1;
			}
			break;
		...
		case 22:
			...
			if (is_point_in_angled_area(Param1, 794.2453f, 1277.443f, -100f, 833.8215f, 1277.108f, 400f, 19f, false, true))
			{
				return 1;
			}
			break;
		...
		case 23:
			...
			if (is_point_in_angled_area(Param1, -1015.526f, 6287.513f, -10.94449f, -761.3104f, 5895.014f, 45.33727f, 167.75f, false, true))
			{
				return 1;
			}
			break;
		...
		case 24:
			...
			if (is_point_in_angled_area(Param1, -72.13491f, -1267.587f, 27.68361f, -72.18015f, -1256.712f, 31f, 30f, false, true))
			{
				return 1;
			}
			break;
		...
		case 33:
			...
			if (is_point_in_angled_area(Param1, -21.12362f, 4518.907f, 119.7836f, 43.13283f, 4538.929f, 72.58955f, 48f, false, true))
			{
				return 1;
			}
			break;
		...
		case 39:
			...
			if (is_point_in_angled_area(Param1, -1088.425f, 372.0723f, 62.75896f, -967.03f, 363.5976f, 101.3483f, 75f, false, true))
			{
				return 1;
			}
			break;
		...
		case 43:
			...
			if (is_point_in_angled_area(Param1, -91.45676f, -1296.975f, 26.15437f, 40.67288f, -1297.459f, 58.29368f, 110f, false, true))
			{
				return 1;
			}
			break;
		...
		case 47:
			...
			if (is_point_in_angled_area(Param1, -78.38029f, 285.5254f, 102.6286f, -51.1546f, 357.5217f, 122.0617f, 40f, false, true))
			{
				return 1;
			}
			break;
		...
		case 49:
			...
			if (is_point_in_angled_area(Param1, 420.5196f, 116.2892f, 77.57532f, 212.2937f, 193.6794f, 131.8767f, 250f, false, true))
			{
				return 1;
			}
			break;
		...
		case 50:
			...
			if (is_point_in_angled_area(Param1, 1140.158f, -540.9644f, 49.99944f, 972.3716f, -535.1002f, 85.64397f, 168.25f, false, true))
			{
				return 1;
			}
			break;
...
int func_150(int iParam0, struct<3> Param1)
{
	switch (iParam0)
	{
		case 3:
			...
			if (is_point_in_angled_area(Param1, -1535.754f, -922.101f, 4.122119f, -1487.87f, -961.3929f, 26.71922f, 50f, false, true))
			{
				return 1;
			}
			break;
		...
		case 8:
			...
			if (is_point_in_angled_area(Param1, 53.12898f, -463.9999f, 36.9208f, 99.3761f, -329.3476f, 118.0454f, 125f, false, true))
			{
				return 1;
			}
			break;
		...
		case 38:
			...
			if (is_point_in_angled_area(Param1, 1420.347f, -2036.558f, 47.36072f, 1341.11f, -2103.844f, 72.32651f, 55f, false, true))
			{
				return 1;
			}
			break;
		...
		case 48:
			...
			if (is_point_in_angled_area(Param1, -2306.98f, 435.3038f, 171.4666f, -2303.291f, 366.3199f, 179.6018f, 65.5f, false, true))
			{
				return 1;
			}
			break;
		...
		case 45:
			...
			if (is_point_in_angled_area(Param1, 1324.172f, 1110.748f, 99.65493f, 1523.097f, 1110.473f, 132.8859f, 170f, false, true))
			{
				return 1;
			}
			break;
		...
		case 60:
			...
			if (is_point_in_angled_area(Param1, -995.978f, -517.4324f, 11.37763f, -1060.725f, -547.5588f, 65.33043f, 35.75f, false, true))
			{
				return 1;
			}
			break;
		...
		case 86:
			...
			if (is_point_in_angled_area(Param1, 682.6544f, -968.7439f, 19.97575f, 762.8684f, -964.4064f, 43.03712f, 53f, false, true))
			{
				return 1;
			}
			break;
		...
		case 87:
			...
			if (is_point_in_angled_area(Param1, 148.8361f, -3029.146f, 4.277727f, 148.1396f, -3342.344f, 22.90379f, 97.75f, false, true))
			{
				return 1;
			}
			break;
		...
		case 78:
			...
			if (is_point_in_angled_area(Param1, 446.8174f, -1691.708f, 23.28233f, 288.5565f, -1552.352f, 108.3117f, 155f, false, true))
			{
				return 1;
			}
			break;
		...
		case joaat("mpsv_lp0_31"):
			...
			if (is_point_in_angled_area(Param1, 910.9382f, -1749.91f, 14.50614f, 921.7415f, -1455.248f, 99.67125f, 210f, false, true))
			{
				return 1;
			}
			break;
		...
		case 83:
			...
			if (is_point_in_angled_area(Param1, 2657.302f, 2974.529f, 34.53447f, 2591.657f, 2880.223f, 68.08156f, 78.75f, false, true))
			{
				return 1;
			}
			break;
		...
		case 84:
			...
			if (is_point_in_angled_area(Param1, 83.32325f, -1312.172f, 23.33694f, 148.383f, -1273.553f, 49.46651f, 65f, false, true))
			{
				return 1;
			}
			break;
...
int func_156(var uParam0, int iParam1, float fParam2)
{
	...
	while (iVar4 < 8)
	{
		if (Global_97374[iVar4 /*17*/])
		{
			...
			{
				if (does_blip_exist(Global_32338[Global_97374[iVar4 /*17*/].f_9 /*23*/].f_19))
				{
					Var3 = { get_blip_coords(Global_32338[Global_97374[iVar4 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						Var3.f_2 = 1f;
					}
	...
	if (does_group_exist(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!is_ped_injured(iVar2))
				{
					if (!is_ped_sitting_in_vehicle(iVar2, Global_112417))
					{
						iVar3 = 0;
						if (!is_vehicle_seat_free(Global_112417, iVar3, false))
						{
							iVar3 = func_159(&Global_112417);
							if (is_vehicle_seat_free(Global_112417, iVar3, false))
							{
								clear_ped_tasks(iVar2);
								set_ped_into_vehicle(iVar2, Global_112417, iVar3);
							}
						}
						else
						{
...
int func_159(var uParam0)
{
	if (does_entity_exist(*uParam0))
	{
		...
		{
			if (is_vehicle_seat_free(*uParam0, 0, false))
			{
				return 0;
			}
			...
			if (is_vehicle_seat_free(*uParam0, 2, false))
			{
				return 2;
			}
		}
...
void func_169()
{
	...
	if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
	{
		if (is_ped_sitting_in_vehicle(Global_112418, Global_112417))
		{
			if (is_vehicle_stopped(Global_112417))
			{
				if (!is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_enter", 3) && !is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_idle", 3))
				{
					if (!func_2(Global_112418, -2118855366))
			...
			{
				Var0 = { get_entity_coords(Global_112417, true) };
				fVar1 = get_entity_heading(Global_112417);
				task_vehicle_park(Global_112418, Global_112417, Var0, fVar1, 3, 60f, false);
			}
		}
	}
}
		...
		if (bLocal_61)
		{
			...
			if (is_vehicle_driveable(Global_112417, false))
			{
				if (!is_ped_injured(Global_112418))
				{
					if (func_172())
					{
						if (get_entity_speed(Global_112417) < 2f)
						{
							if (!is_ped_injured(player_ped_id()))
							{
								if (is_ped_in_vehicle(player_ped_id(), Global_112417, true))
					...
					else if (is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_enter", 3) || is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_idle", 3))
					{
						if (is_ped_headtracking_ped(Global_112418, player_ped_id()))
						{
							task_clear_look_at(Global_112418);
						}
						task_play_anim(Global_112418, &cLocal_824, "leanover_exit", 4f, -4f, -1, 0, 0f, false, false, false);
					}
					else if (is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_exit", 3))
					{
						set_entity_anim_speed(Global_112418, &cLocal_824, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_112418, 242628503))
					{
						...
						else
						{
							...
							clear_ped_tasks(Global_112418);
							task_clear_look_at(Global_112418);
							set_driver_ability(Global_112418, 0.5f);
							open_sequence_task(&iLocal_813);
							task_vehicle_drive_to_coord_longrange(0, Global_112417, Global_112424, fVar1, iVar0, 45f);
							task_vehicle_park(0, Global_112417, Global_112424, Global_112430, iLocal_110, 60f, true);
							close_sequence_task(iLocal_813);
							task_perform_sequence(Global_112418, iLocal_813);
							clear_sequence_task(&iLocal_813);
						}
					}
				}
			}
...
int func_171(int iParam0, int iParam1)
{
	...
	bVar4 = true;
	bVar5 = false;
	iVar3 = get_ped_as_group_member(func_6(), 0);
	if (!is_ped_injured(iVar3))
	{
		...
		bVar4 = true;
		iVar2 = get_ped_in_vehicle_seat(Global_112417, iVar6, false);
		...
		if (get_ped_config_flag(iVar3, 167, false))
		{
			bVar4 = false;
		}
		...
		if (bVar4)
		{
			task_enter_vehicle(iVar3, Global_112417, 20000, iVar6, 2f, 9437185, 0);
			bVar5 = true;
		}
	}
	if (iVar0 > 1)
	{
		iVar3 = get_ped_as_group_member(func_6(), 1);
		if (!is_ped_injured(iVar3))
		{
			bVar4 = true;
			iVar6 = 0;
...
int func_172()
{
	if ((is_entity_at_coord(Global_112417, Global_112424, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_821 == 4)
	{
		iLocal_56 = 1;
		if (get_script_task_status(Global_112418, 242628503) == 7)
		{
			return 1;
		}
	}
...
int func_175()
{
	if (!is_ped_injured(Global_112418) && is_vehicle_driveable(Global_112417, false))
	{
		if (is_ped_sitting_in_vehicle(Global_112418, Global_112417))
		{
			request_anim_dict(&cLocal_824);
			if (has_anim_dict_loaded(&cLocal_824))
			{
				if (is_ped_headtracking_ped(Global_112418, player_ped_id()))
				{
					task_clear_look_at(Global_112418);
				...
				open_sequence_task(&iLocal_813);
				task_play_anim(0, &cLocal_824, "leanover_enter", 4f, -8f, -1, 0, 0f, false, false, false);
				task_play_anim(0, &cLocal_824, "leanover_idle", 4f, -8f, -1, 1, 0f, false, false, false);
				close_sequence_task(iLocal_813);
				task_perform_sequence(Global_112418, iLocal_813);
				clear_sequence_task(&iLocal_813);
				return 1;
...
int func_176()
{
	...
	if (does_entity_exist(Global_112417))
	{
		if (is_vehicle_driveable(Global_112417, false))
		{
			iLocal_109 = create_object(iLocal_108, get_entity_coords(Global_112417, true), true, true, false);
			attach_entity_to_entity(iLocal_109, Global_112417, get_entity_bone_index_by_name(Global_112417, "Chassis"), Local_837, Local_838, false, false, false, false, 2, true, 0);
			set_taxi_lights(Global_112417, false);
			if (!is_named_rendertarget_registered("taxi"))
			{
				register_named_rendertarget("taxi", false);
				link_named_rendertarget(get_entity_model(iLocal_109));
			}
			iLocal_93 = get_named_rendertarget_render_id("taxi");
		}
	}
	return 0;
}
...
int func_177()
{
	request_model(iLocal_108);
	iLocal_111 = request_scaleform_movie("taxi_display");
	iLocal_112 = request_scaleform_movie("instructional_buttons");
	request_anim_dict(&cLocal_824);
	if (((has_model_loaded(iLocal_108) && has_scaleform_movie_loaded(iLocal_111)) && has_scaleform_movie_loaded(iLocal_112)) && has_anim_dict_loaded(&cLocal_824))
	{
		return 1;
	}
	return 0;
...
void func_178()
{
	...
	if (!does_cam_exist(iLocal_68))
	{
		...
		{
			iLocal_68 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
			attach_cam_to_entity(iLocal_68, Global_112417, Local_835, true);
			func_182();
			_set_cam_controls_radar_rotation(iLocal_68, true);
		}
	}
	...
	else if (is_cam_active(iLocal_68))
	{
		set_cam_active(iLocal_68, false);
		set_gameplay_cam_relative_heading(0f);
		set_gameplay_cam_relative_pitch(0f, 1f);
...
void func_179()
{
	...
	begin_scaleform_movie_method(iLocal_111, "HIGHLIGHT_DESTINATION");
	scaleform_movie_method_add_param_int(iLocal_92);
	end_scaleform_movie_method();
}
...
void func_180()
{
	...
	if (does_blip_exist(Local_43.f_0))
	{
		Var0 = { get_blip_coords(Local_43.f_0) };
		if (does_cam_exist(iLocal_68) && is_cam_active(iLocal_68))
		{
...
void func_181(bool bParam0, bool bParam1, int iParam2)
{
	switch (iParam0)
	{
		...
		default:
			...
			{
				clear_bit(&(Global_1648034.f_1046), iParam0);
			}
			break;
	}
}
...
void func_182()
{
	if (does_cam_exist(iLocal_68))
	{
		...
		set_cam_fov(iLocal_68, fLocal_74);
		set_cam_near_clip(iLocal_68, 0.01f);
		_set_cam_smooth_shadows(iLocal_68, true);
...
void func_183(int iParam0, int iParam1, struct<3> Param2)
{
	...
	if (!is_entity_dead(iParam0, false))
	{
		if (does_cam_exist(*iParam1))
		{
			...
			fVar3 = Var0.f_1;
			Var4 = { func_82(get_offset_from_entity_in_world_coords(Global_112417, Param2) - get_offset_from_entity_in_world_coords(Global_112417, Local_835)) };
...
void func_187()
{
	...
	iVar0 = 0;
	func_192();
	begin_scaleform_movie_method(iLocal_111, "CLEAR_TAXI_DISPLAY");
	end_scaleform_movie_method();
	iVar0 = 0;
	while (iVar0 < iLocal_91)
	{
		if (!does_blip_exist(Local_819[iVar0 /*3*/]))
		{
		}
		else if (func_127(Local_819[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_131(get_blip_coords(Local_819[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			begin_scaleform_movie_method(iLocal_111, "ADD_TAXI_DESTINATION");
			scaleform_movie_method_add_param_int(iVar0);
			scaleform_movie_method_add_param_int(get_blip_sprite(Local_819[bVar0 /*3*/]));
			get_hud_colour(get_blip_hud_colour(Local_819[bVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			...
			if (iVar6 == -1)
			{
				...
				add_text_component_substring_blip_name(Local_819[bVar0 /*3*/]);
				end_text_command_scaleform_string();
			}
			else
			{
				begin_text_command_scaleform_string("STRING");
				add_text_component_substring_text_label(func_188(iVar6));
				end_text_command_scaleform_string();
			}
			if (get_blip_info_id_type(Local_819[bVar0 /*3*/]) == 2)
			{
				if (!is_ped_injured(get_ped_index_from_entity_index(get_blip_info_id_entity_index(Local_819[bVar0 /*3*/]))))
				{
					Var5 = { get_entity_coords(get_ped_index_from_entity_index(get_blip_info_id_entity_index(Local_819[bVar0 /*3*/])), true) };
				}
			}
			else if (get_blip_info_id_type(Local_819[bVar0 /*3*/]) == 1)
			{
				if (is_vehicle_driveable(get_blip_info_id_entity_index(Local_819[bVar0 /*3*/]), false))
				{
					Var5 = { get_entity_coords(get_blip_info_id_entity_index(Local_819[bVar0 /*3*/]), true) };
				}
			}
			else
			{
				Var5 = { get_blip_coords(Local_819[bVar0 /*3*/]) };
			}
			func_68(get_name_of_zone(Var5));
			if (Local_819[bVar0 /*3*/].f_2 == 0)
			{
				if (Local_819[bVar0 /*3*/].f_1 != 0)
				{
					begin_text_command_scaleform_string("STRTNM1");
					add_text_component_substring_text_label_hash_key(Local_819[bVar0 /*3*/].f_1);
					end_text_command_scaleform_string();
				}
			}
			else
			{
				...
				add_text_component_substring_text_label_hash_key(Local_819[bVar0 /*3*/].f_1);
				add_text_component_substring_text_label_hash_key(Local_819[bVar0 /*3*/].f_2);
				end_text_command_scaleform_string();
			}
			end_scaleform_movie_method();
			if (bLocal_60)
	...
	if (bLocal_60)
	{
		begin_scaleform_movie_method(iLocal_111, "SHOW_TAXI_DESTINATION");
		end_scaleform_movie_method();
		begin_scaleform_movie_method(iLocal_111, "HIGHLIGHT_DESTINATION");
		scaleform_movie_method_add_param_int(bLocal_92);
		end_scaleform_movie_method();
	}
	else
	{
		begin_scaleform_movie_method(iLocal_111, "SET_TAXI_PRICE");
		scaleform_movie_method_add_param_int(bLocal_101);
		end_scaleform_movie_method();
		begin_scaleform_movie_method(iLocal_111, "SHOW_TAXI_DESTINATION");
		end_scaleform_movie_method();
		begin_scaleform_movie_method(iLocal_111, "HIGHLIGHT_DESTINATION");
...
void func_192()
{
	...
	func_196(117, 1);
	iLocal_94 = func_193();
	iLocal_95 = get_number_of_active_blips();
	if (get_mission_flag())
	{
		if (iLocal_94 == 0)
		{
			if (does_blip_exist(Global_112421))
			{
				iVar0 = 0;
				while (iVar0 < 40)
				{
...
int func_193()
{
	...
	iVar0 = 0;
	iVar1 = get_first_blip_info_id(iLocal_44);
	while (does_blip_exist(iVar1))
	{
		if (func_195(iVar1))
		{
			if ((get_blip_info_id_type(iVar1) == 4 || get_blip_info_id_type(iVar1) == 6) || get_blip_info_id_type(iVar1) == 3)
			{
				iVar0++;
			}
			if (get_blip_info_id_type(iVar1) == 2 || get_blip_info_id_type(iVar1) == 1)
			{
				if (func_194(iVar1))
				{
					iVar0++;
		...
		iVar1 = get_next_blip_info_id(iLocal_44);
	}
	iVar1 = get_first_blip_info_id(iLocal_45);
	while (does_blip_exist(iVar1))
	{
		if (func_195(iVar1))
		{
			if (get_blip_info_id_type(iVar1) == 4)
			{
				iVar0++;
			}
		}
		iVar1 = get_next_blip_info_id(iLocal_45);
	}
	return iVar0;
}
...
{
	if (((get_blip_hud_colour(iParam0) == 9 || get_blip_hud_colour(iParam0) == 11) || get_blip_hud_colour(iParam0) == 10) || get_blip_hud_colour(iParam0) == 61)
	{
		return 1;
	}
	return 0;
...
void func_196(int iParam0, bool bParam1)
{
	...
	iVar2 = get_first_blip_info_id(iParam0);
	iVar3 = 20;
	while (does_blip_exist(iVar2))
	{
			...
			if (func_195(iVar2))
			{
				if (func_208(iVar2))
				{
					if (!func_206(&iVar2))
					{
						...
						if (does_blip_exist(Global_112420))
						{
						...
						if (bVar1)
						{
							...
							if (func_195(iVar2))
							{
								iVar4 = get_blip_info_id_type(iVar2);
		...
		iLocal_98++;
		iVar2 = get_next_blip_info_id(iParam0);
	}
}
...
void func_198(struct<3> Param0, int iParam1)
{
	...
	if (func_127(Local_819[iParam1 /*3*/]) == get_waypoint_blip_enum_id())
	{
		iLocal_97 = iParam1;
		Local_834 = { get_blip_coords(Local_819[iParam1 /*3*/]) };
	}
}
...
float func_202(int iParam0)
{
	...
	if (is_player_playing(player_id()))
	{
		if (does_blip_exist(iParam0))
		{
			Var0 = { func_47(iParam0) - get_entity_coords(player_ped_id(), true) };
		}
	}
	return vmag(Var0);
}
...
void func_203(int iParam0, var uParam1)
{
	...
	*uParam1 = *iParam0;
	if (!*uParam1 == Global_112422)
	{
		...
		get_street_name_at_coord(Var0, &(uParam1->f_1), &(uParam1->f_2));
	}
	else
	{
		get_street_name_at_coord(Global_112424, &(uParam1->f_1), &(uParam1->f_2));
	}
}
...
int func_204(int iParam0)
{
	...
	if (does_blip_exist(*iParam0))
	{
		iVar0 = get_blip_hud_colour(*iParam0);
...
int func_205(int iParam0)
{
	...
	while (iVar0 < 8)
	{
		if (Global_97374[iVar0 /*17*/])
		{
			if (Global_97374[iVar0 /*17*/].f_9 != 263)
			{
				if (does_blip_exist(Global_32338[Global_97374[iVar0 /*17*/].f_9 /*23*/].f_19))
				{
					if (Global_32338[Global_97374[iVar0 /*17*/].f_9 /*23*/].f_19 == *iParam0)
					{
						return Global_97374[iVar0 /*17*/].f_5;
...
int func_206(int iParam0)
{
	...
	if (func_207(get_blip_coords(*iParam0), 0f, 0f, 0f, 0))
	{
		return 1;
	}
...
bool func_210()
{
	...
	bVar0 = false;
	if (!does_blip_exist(Local_819[bLocal_92 /*3*/]))
	{
	...
	if (timerb() > 250)
	{
		if (!bVar0)
		{
			if (iLocal_95 != get_number_of_active_blips())
			{
				bVar0 = true;
			}
			iLocal_95 = get_number_of_active_blips();
		...
		if (!bVar0)
		{
			if (iLocal_97 != -1)
			{
				if (does_blip_exist(Local_819[iLocal_97 /*3*/]))
				{
					if (func_127(Local_819[iLocal_97 /*3*/]) == get_waypoint_blip_enum_id())
					{
						Var1 = { get_blip_coords(Local_819[iLocal_97 /*3*/]) };
				...
				{
					iVar2 = get_first_blip_info_id(get_waypoint_blip_enum_id());
					if (does_blip_exist(iVar2))
					{
						Var1 = { get_blip_coords(iVar2) };
						if (!func_131(Var1, Local_834, 1056964608, 0))
						{
							bVar0 = true;
						}
...
int func_211()
{
	...
	if (func_3(Global_112417))
	{
		...
		if (!is_vehicle_seat_free(Global_112417, 0, false))
		{
			iVar0++;
		}
		if (!is_vehicle_seat_free(Global_112417, 1, false))
...
void func_212()
{
	if (iLocal_821 != 0)
	{
		set_text_render_id(iLocal_93);
		set_script_gfx_draw_order(4);
		set_script_gfx_draw_behind_pausemenu(true);
		if (is_vehicle_driveable(Global_112417, false))
		{
			draw_scaleform_movie(iLocal_111, fLocal_86, fLocal_87, fLocal_84, fLocal_85, 0, 0, 0, 255, 0);
		}
	}
}
	...
	if (iLocal_821 != 0)
	{
		...
		if (!bLocal_60)
		{
			if (iLocal_91 > 0)
			{
				...
				if (is_control_just_pressed(2, 176))
				{
					if (does_blip_exist(Local_819[bLocal_92 /*3*/]))
					{
						iLocal_818 = 2;
		...
		else
		{
			...
			if (iLocal_821 == 2)
			{
				if (is_control_just_pressed(2, 177))
				{
					iLocal_818 = 13;
					iLocal_58 = 1;
					if (!is_ped_injured(Global_112418))
				...
				if (!bLocal_64)
				{
					if (is_control_just_pressed(2, 179))
					{
						iLocal_818 = 20;
						bLocal_64 = true;
						iLocal_58 = 1;
						...
						if (!is_ped_injured(Global_112418))
						{
							if (!is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_enter", 3))
							{
								if (!is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_idle", 3))
								{
									if (!is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_exit", 3))
									{
										clear_ped_tasks(Global_112418);
									}
								}
...
void func_215()
{
	...
	begin_scaleform_movie_method(iLocal_111, "SET_INPUT_EVENT");
	...
	if (does_blip_exist(Local_819[bLocal_92 /*3*/]))
	{
		Var0 = { get_blip_coords(Local_819[bLocal_92 /*3*/]) };
		if (!func_216(Var0))
		{
			lock_minimap_position(Var0.f_0, Var0.f_1);
		}
...
void func_222()
{
	if (!Global_112422 == 0)
	{
		if (!does_blip_exist(Global_112422))
		{
			Global_112422 = 0;
		}
	}
...
int func_226()
{
	...
	if (is_player_playing(player_id()))
	{
		if (is_ped_sitting_in_any_vehicle(player_ped_id()))
		{
			...
			{
				if (func_227(get_vehicle_ped_is_in(player_ped_id(), false)))
				{
					iVar0 = get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), false), -1, false);
...
{
	if (is_vehicle_model(iParam0, joaat("taxi")))
	{
		return 1;
	}
	return 0;
...
int func_228(int iParam0)
{
	...
	if (func_58(player_ped_id()) != iLocal_71)
	{
		return 1;
	}
	if (!does_entity_exist(Global_112417))
	...
	if (iLocal_821 != 4)
	{
		if (iParam0 == 1)
		{
			...
			if (((is_vehicle_stuck_timer_up(Global_112417, 2, 30000) || is_vehicle_stuck_timer_up(Global_112417, 3, 30000)) || is_vehicle_stuck_timer_up(Global_112417, 0, 7000)) || is_vehicle_stuck_timer_up(Global_112417, 1, 7000))
			{
				return 1;
			}
		}
...
int func_230()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		if (func_234(&iVar0, func_236(), func_235()))
		{
			...
			{
				Local_832 = { get_entity_coords(Global_112417, true) - get_entity_coords(player_ped_id(), true) };
				Local_832.f_2 = 0f;
				fLocal_72 = vmag(Local_832);
				iLocal_71 = func_58(player_ped_id());
				func_231();
				iLocal_96 = func_211();
				iLocal_58 = 1;
				disable_control_action(0, 75, true);
...
void func_237(bool bParam0)
{
	...
	set_scaleform_movie_as_no_longer_needed(&iLocal_111);
	set_scaleform_movie_as_no_longer_needed(&iLocal_112);
	if (func_238(Global_112418))
	{
		if (is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_enter", 3))
		{
			stop_entity_anim(Global_112418, "leanover_enter", &cLocal_824, -2f);
		}
		else if (is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_idle", 3))
		{
			stop_entity_anim(Global_112418, "leanover_idle", &cLocal_824, -2f);
		}
		else if (is_entity_playing_anim(Global_112418, &cLocal_824, "leanover_exit", 3))
		{
			stop_entity_anim(Global_112418, "leanover_exit", &cLocal_824, -2f);
		}
		if (is_ped_headtracking_ped(Global_112418, player_ped_id()))
		{
			task_clear_look_at(Global_112418);
