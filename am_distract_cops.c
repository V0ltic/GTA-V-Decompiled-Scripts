...
void __EntryFunction__()
{
	...
	if (network_is_game_in_progress() && func_281(player_id(), 0, 1))
	{
	...
	while (true)
	{
		...
		switch (func_255(participant_id_to_int()))
		{
			case 0:
				if (func_254() == 1)
				{
...
void func_11()
{
	...
	if (Local_83.f_0 == 1)
	{
		if (network_is_participant_active(int_to_participantindex(iLocal_92)))
		{
			iVar0 = network_get_player_index(int_to_participantindex(iLocal_92));
	...
	iLocal_92++;
	if (iLocal_92 == network_get_max_num_participants())
	{
		if (iLocal_93 == 0)
		{
			if (BitTest(Local_83.f_1, 0))
			{
				clear_bit(&(Local_83.f_1), false);
			}
		}
		else
		{
...
void func_14()
{
	...
	{
		if ((BitTest(Local_85[participant_id_to_int() /*4*/].f_1, 0) && get_player_wanted_level(player_id()) >= (Local_83.f_16 - 1)) && Local_85[participant_id_to_int() /*4*/].f_2 < 10)
		{
			Local_85[participant_id_to_int() /*4*/].f_2++;
		}
		if (Local_85[participant_id_to_int() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_85[participant_id_to_int() /*4*/].f_2 * Global_262145.f_8565);
			...
			if (iVar0 > 0)
			{
				...
				{
					network_earn_from_ambient_job(iVar0, "AM_DISTRACT_COPS", &uVar1);
				}
			}
			if (func_94())
			{
...
void func_26(var uParam0, int iParam1)
{
	...
	if (!Global_78587)
	{
		if (!is_player_dead(get_player_index()))
		{
			if (!Global_78588)
			{
				if (is_screen_faded_out() && !func_28(0))
				{
...
int func_37(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_73(player_id()) || (func_72() && func_71())) && !BitTest(Global_2815059.f_4660, 31)) && !bParam4)
	{
		iVar1 = func_70();
		if (does_entity_exist(iVar1))
		{
			if (is_ped_a_player(iVar1))
			{
				...
				{
					if (func_281(network_get_player_index_from_ped(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_50(iParam0, network_get_player_index_from_ped(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_50(iParam0, player_id(), iParam1, bParam2, bParam3);
		}
	}
	return func_50(iParam0, player_id(), iParam1, bParam2, bParam3);
}
...
{
	return func_39(player_id(), bParam0, iParam1, bParam2);
}
...
int func_49()
{
	if (func_47() && network_is_activity_session())
	{
		return 1;
	}
	return 0;
...
int func_50(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_52(iParam1, iParam0, iVar0, 0) && !BitTest(Global_4718592.f_15, 18)) || ((func_44(get_player_team(iParam1), get_player_team(iParam0), 0) && BitTest(Global_4718592.f_15, 23)) && !BitTest(Global_4718592.f_15, 18)))
			{
				return func_43(1);
			}
...
int func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_77())
	{
		...
		if (BitTest(Global_4718592.f_15, 26) && !func_44(iParam0, get_player_team(iParam1), 0))
		{
			iVar0 = func_51(1);
		}
	}
	...
	if (*iParam0 > 0)
	{
		if (!func_132())
		{
			if (func_131(0))
			{
				if (!func_127(0))
				{
					if (network_is_player_active(func_126()))
					{
						if (func_125() == 100)
						{
							iVar0 = *iParam0;
...
void func_112(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_281(bParam0, 0, 1))
	{
		...
		_trigger_script_event_2(1, &Var0, 8, func_106(bParam0));
	}
}
...
int func_116(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (_network_is_player_equal_to_index(player_id(), iParam1) || iParam5)
	{
		...
		set_colour_of_next_text_component(func_37(iParam1, -2, 1, 0, 0));
		add_text_component_substring_player_name(func_121(&Var1));
		if (!iParam3 == 0)
		{
...
void func_117(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_120() || !network_is_activity_session()) || !func_75(player_id(), 0))
	{
		return;
	}
...
{
	return func_128(player_id(), bParam0);
}
...
{
	return func_57(player_id(), bParam0);
}

bool func_132()
{
	return func_58(player_id());
}
...
void func_133()
{
	...
	if (does_blip_exist(iLocal_87))
	{
		...
		{
			set_blip_display(iLocal_87, 0);
		}
		else
		{
			set_blip_display(iLocal_87, 4);
		}
	}
	switch (Local_85[participant_id_to_int() /*4*/].f_3)
	{
		case 0:
			if (is_entity_at_coord(player_ped_id(), Local_83.f_2, Local_83.f_5, Local_83.f_5, 1000f, false, true, 0))
			{
				func_226();
				set_bit(&(Local_85[participant_id_to_int() /*4*/].f_1), false);
				set_bit(&(Global_2815059.f_4662), false);
...
void func_135()
{
	if (!BitTest(uLocal_86, 5))
	{
		...
		else if (!func_281(player_id(), 1, 1))
		{
			set_bit(&uLocal_86, 5);
		}
	}
...
void func_143()
{
	if (func_9(&uLocal_88, 30000, 0))
	{
		...
		func_144(0, player_ped_id(), "XPT_DSC", -1636175450, 2048546661, (Global_262145.f_8566 * Local_83.f_16), 1, -1, 0, 0, 0);
		Local_85[participant_id_to_int() /*4*/].f_2++;
		func_5(&uLocal_88);
	}
}
	...
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (does_entity_exist(iParam1))
		{
			if (is_entity_a_ped(iParam1))
			{
				...
				func_150(get_ped_bone_coords(iVar1, 31086, 0f, 0f, 0f), iVar0, 0, sParam8, iParam10);
			}
		}
	}
	else
...
void func_145(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	...
	if (iParam0 == func_147(player_ped_id()))
	{
		func_146(1);
	}
...
Vector3 func_148(int iParam0, bool bParam1)
{
	...
	if (iParam0 == func_149(player_ped_id()) && get_cam_view_mode_for_context(_get_cam_active_view_mode_context()) == 4)
	{
...
int func_155(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (func_185())
	{
		...
		if (bParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_166((func_175(player_id()) + iVar1), iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (bParam7)
		{
			if (iParam6 == -1)
			{
				func_156((func_158(player_id()) + iVar1));
			}
			else
			{
				func_156((func_158(player_id()) + iParam6));
			}
		}
	}
	return iVar1;
...
void func_166(int iParam0, int iParam1, int iParam2)
{
	if (func_185())
	{
		...
		if (func_174(player_id()))
		{
			Global_1853348[player_id() /*834*/].f_205.f_1 = iParam0;
			Global_1853348[player_id() /*834*/].f_205.f_6 = func_172(iParam0, 1);
		}
...
void func_176(int iParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		...
		if (network_is_participant_active(iVar4))
		{
			...
			{
				if (get_player_team(iVar5) == iVar1 || func_44(get_player_team(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != player_id())
					{
						if (func_178(player_id(), iVar5))
						{
							bVar3 = true;
						}
					}
	...
	if (bVar3)
	{
		iVar6 = round((func_177(*iParam0, 100) * (10f * Global_262145.f_4227)));
	}
	if (iVar2 > 4)
	{
		iVar2 = 4;
	...
	if (iVar2 >= 2)
	{
		iVar7 = round((func_177(*iParam0, 100) * (20f * Global_262145.f_4220)));
	}
...
void func_179(bool bParam0, int iParam1)
{
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_281(iVar4, 1, 1))
			{
				if (iVar4 != player_id())
				{
					if (func_180(player_id(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_178(player_id(), iVar4))
						{
	...
	if (bVar2)
	{
		iVar5 = round((func_177(*iParam1, 100) * (10f * Global_262145.f_4227)));
	}
	if (iVar1 > 4)
	{
		iVar1 = 4;
	...
	if (iVar1 >= 1)
	{
		iVar6 = round((func_177(*iParam1, 100) * (20f * Global_262145.f_4220)));
	}
...
int func_183(int iParam0)
{
	if (iParam0 < 0)
	{
		if (absi(iParam0) > func_175(player_id()))
		{
			iParam0 = -func_175(player_id());
		}
	}
	if (func_184(8000, 0, 0) > 0)
	{
		if (func_184(8000, 0, 0) < (iParam0 + func_175(player_id())))
		{
			iParam0 = (func_184(8000, 0, 0) - func_175(player_id()));
		}
	}
	return iParam0;
}
...
int func_187()
{
	...
	if (func_195(player_id()) || func_194(player_id()))
	{
	...
	else if (func_192() || func_188(player_id()))
	{
...
void func_199()
{
	...
	{
		if (get_player_wanted_level(player_id()) < Local_83.f_16)
		{
			set_player_wanted_level(player_id(), Local_83.f_16, false);
...
void func_200()
{
	...
	{
		func_203();
		Local_85[participant_id_to_int() /*4*/].f_3 = 0;
	}
	else if (!is_entity_at_coord(player_ped_id(), Local_83.f_2, Local_83.f_6, Local_83.f_6, 950f, false, true, 0))
	{
		if (!BitTest(uLocal_86, 0) && BitTest(uLocal_86, 3))
		{
			if (!is_help_message_being_displayed() && !func_202())
			{
				if (!func_250())
				{
...
void func_203()
{
	...
	func_5(&uLocal_90);
	func_204();
	clear_bit(&(Local_85[participant_id_to_int() /*4*/].f_1), false);
	clear_bit(&uLocal_86, 3);
	set_bit(&(Global_2815059.f_4662), false);
	if (!BitTest(uLocal_86, 5))
	{
		set_bit(&uLocal_86, 5);
...
int func_213()
{
	if ((((((func_190(player_id()) == 229 || func_190(player_id()) == 191) || func_220()) || func_219()) || func_218()) || Global_2788199.f_227 == 1) || (Global_2667225.f_1753 && func_214(player_id())))
	{
		return 0;
	}
	return 1;
...
void func_227(struct<3> Param0, int iParam1, int iParam2)
{
...
void func_228(struct<3> Param0, var uParam1, int iParam2, int iParam3)
{
	func_229(Param0, 0f, 0f, 0f, uParam1, 0, iParam2, iParam3);
}

void func_229(struct<3> Param0, struct<3> Param1, var uParam2, int iParam3, int iParam4, var uParam5)
{
	struct<12> Var0;
	
	if (func_238(player_id()) || uParam5)
	{
		if (Var0.f_10 == 1)
		{
		...
		if (func_232(Var0))
		{
			Global_2667225.f_45.f_64 = func_231(player_id());
...
int func_233(struct<3> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10)
{
	int iVar0;
...
bool func_234(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_235(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3)
{
...
int func_236(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
...
void func_246(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	func_247(Param0, 0f, 0f, 0f, fParam1, 0, iParam2, iParam4, iParam3, iParam5);
}

void func_247(struct<3> Param0, struct<3> Param1, var uParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7)
{
	struct<12> Var0;
...
void func_248(struct<12> Param0, int iParam1)
{
...
void func_251()
{
	...
	{
		if (((((((func_252(60000) && func_254() == 1) && Local_83.f_7 <= 1) && !is_help_message_being_displayed()) && !is_pause_menu_active()) && func_281(player_id(), 1, 1)) && !func_202()) && Local_83.f_16 != 5)
		{
			if (!func_250())
			{
...
void func_253()
{
	...
	{
		iLocal_87 = add_blip_for_radius(Local_83.f_2, Local_83.f_5);
		set_blip_colour(iLocal_87, 50);
		set_blip_alpha(iLocal_87, 220);
		show_height_on_blip(iLocal_87, false);
		set_blip_name_from_text_file(iLocal_87, "DCP_BLIPN");
		if (func_250())
		{
			set_blip_display(iLocal_87, 0);
		}
...
int func_258(bool bParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_281(int_to_playerindex(iVar0), 0, 1))
		{
...
int func_260()
{
	...
	if (func_261() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_261()) == 0)
		{
			return 1;
		}
	}
...
void func_271(struct<21> Param0)
{
	...
	func_275(0, -1, 0);
	network_register_host_broadcast_variables(&Local_83, 20, 0);
...
void func_277(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!network_is_game_in_progress())
	{
		func_269();
