...
void __EntryFunction__()
{
	...
	iLocal_54 = add_scenario_blocking_area(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, false, true, true, true);
	...
	while (true)
	{
		...
		{
			if (!func_201(-72.323f, -1258.643f, 28.648f, get_entity_coords(Var0.f_35[0], true), 1056964608))
			{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_184()) || Global_31962) || func_183()) || func_182(8, -1)) || func_180()) || func_93()) || func_181()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_184()) || Global_112433) || Global_31962) || func_183()) || func_182(8, -1)) || func_93()) || func_181()) || func_179()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_184() || get_player_wanted_level(player_id()) > 0) || func_182(8, -1)) || func_179()) || func_178()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_185(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_129(player_ped_id()) && func_129(uParam0->f_28[0])) && !func_148()) && (get_game_timer() - uParam0->f_60) > iParam6) && func_189(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_189(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
void func_190(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_189(player_ped_id(), Param2, 1) <= 100f)
				{
					func_193(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(player_ped_id(), Param2, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_201(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_210(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_213(int iParam0, float fParam1)
{
	...
	if (func_129(player_ped_id()) && func_129(iParam0))
	{
		if (func_224(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_215(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_221(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_221(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_228(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_221(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_239(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_246(&iVar0) || !has_anim_dict_loaded(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				set_vehicle_colours(uParam0->f_35[0], 38, 0);
				set_vehicle_extra_colours(uParam0->f_35[0], 91, 0);
				set_vehicle_mod_kit(uParam0->f_35[0], 0);
				preload_vehicle_mod(uParam0->f_35[0], 0, 2);
				preload_vehicle_mod(uParam0->f_35[0], 1, 1);
				preload_vehicle_mod(uParam0->f_35[0], 2, 1);
				preload_vehicle_mod(uParam0->f_35[0], 3, 1);
				preload_vehicle_mod(uParam0->f_35[0], 4, 1);
				preload_vehicle_mod(uParam0->f_35[0], 6, 0);
				preload_vehicle_mod(uParam0->f_35[0], 7, 2);
				preload_vehicle_mod(uParam0->f_35[0], 10, 0);
				preload_vehicle_mod(uParam0->f_35[0], 23, 20);
				set_vehicle_mod(uParam0->f_35[0], 0, 2, false);
				set_vehicle_mod(uParam0->f_35[0], 1, 1, false);
				set_vehicle_mod(uParam0->f_35[0], 2, 1, false);
				set_vehicle_mod(uParam0->f_35[0], 3, 1, false);
				set_vehicle_mod(uParam0->f_35[0], 4, 1, false);
				set_vehicle_mod(uParam0->f_35[0], 6, 0, false);
				set_vehicle_mod(uParam0->f_35[0], 7, 2, false);
				set_vehicle_mod(uParam0->f_35[0], 10, 0, false);
				set_vehicle_mod(uParam0->f_35[0], 23, 20, false);
				toggle_vehicle_mod(uParam0->f_35[0], 18, true);
				toggle_vehicle_mod(uParam0->f_35[0], 17, true);
				toggle_vehicle_mod(uParam0->f_35[0], 22, true);
				set_vehicle_doors_locked(uParam0->f_35[0], 3);
				roll_down_window(uParam0->f_35[0], 0);
				set_vehicle_lights(uParam0->f_35[0], 2);
			...
			if (!does_entity_exist(uParam0->f_35[1]))
			{
				...
				set_vehicle_colour_combination(uParam0->f_35[1], 10);
			}
			if (func_129(uParam0->f_28[0]))
			{
				func_240(&(uParam0->f_41[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				attach_entity_to_entity(uParam0->f_41[0], uParam0->f_28[0], get_ped_bone_index(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
			}
			if (bVar4)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			{
				iVar5 = get_entity_bone_index_by_name(uParam0->f_35[0], "chassis_dummy");
				Var6 = { get_world_position_of_entity_bone(uParam0->f_35[0], iVar5) };
				iVar2 = create_synchronized_scene(Var6, get_entity_rotation(uParam0->f_35[0], 2), 2);
				set_synchronized_scene_looped(iVar2, true);
				set_synchronized_scene_hold_last_frame(iVar2, false);
				task_synchronized_scene(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1000f, 0);
...
void func_240(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_200(iParam0);
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_242(iParam0);
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_258(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_259(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_260(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_261(int iParam0, bool bParam1)
{
	...
	remove_scenario_blocking_area(iLocal_54, false);
	if (bParam1)
	{
		func_197(*iParam0);
	}
