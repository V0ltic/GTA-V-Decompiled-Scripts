...
void func_3(var uParam0)
{
	...
	{
		func_20(-1);
		iVar0 = network_get_local_scene_from_network_id(uParam0->f_8);
		if (is_synchronized_scene_running(iVar0))
		{
			network_stop_synchronised_scene(uParam0->f_8);
		}
		if (!func_19() && !is_new_load_scene_active())
		{
			func_4(player_id(), 1, 0, 0);
		}
	}
	clear_bit(&(Global_2689235[player_id() /*453*/].f_318.f_4), 15);
}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_13(player_id(), 0) && !func_12()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_8(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_24(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if ((func_78(player_ped_id(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_77(player_ped_id(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13)) && !(func_75() && uParam0->f_9 == 8))
			{
				if ((((((((((((func_74(uParam0) || func_70(uParam0)) || func_69(uParam0)) || !func_68(uParam0)) || func_66(player_id())) || is_ped_in_any_vehicle(player_ped_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || is_ped_in_melee_combat(player_ped_id())) || is_ped_performing_melee_action(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_injured(player_ped_id())) || BitTest(Global_1946250.f_4, 2)) || func_65(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					set_bit(&(Global_1946250.f_3), 16);
					if (func_70(uParam0))
					{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						if ((get_game_timer() - uParam0->f_11) > 150)
						{
					...
					else if (is_control_just_pressed(0, 51))
					{
						...
						{
							set_bit(&(Global_2689235[player_id() /*453*/].f_318.f_4), 15);
							func_58(157);
						}
					}
				}
		...
		case 4:
			...
			if (uParam0->f_1.f_1 == 3)
			{
				if (get_cam_view_mode_for_context(0) == 4)
				{
					...
					{
						set_cam_view_mode_for_context(0, 1);
						func_54(&(uParam0->f_7), 13);
					}
				}
			}
			disable_control_action(0, 0, true);
			Var2 = { get_anim_initial_offset_position(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0f, 2) };
			Var3 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0f, 2) };
			fVar4 = Var3.f_2;
			fVar5 = 0.05f;
		...
		case 5:
			...
			Var7 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_53(uParam0), func_52(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_39(get_entity_heading(player_ped_id()), fVar8, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (get_cam_view_mode_for_context(0) == 4)
				...
				disable_control_action(0, 0, true);
				uParam0->f_8 = network_create_synchronised_scene(func_53(uParam0), func_52(uParam0), 2, true, false, 1f, 0f, 1.12f);
				network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_8, &sVar0, &sVar1, 2f, -1000f, 9, 0, 1000f, 0);
				network_start_synchronised_scene(uParam0->f_8);
		...
		case 6:
			...
			func_40(uParam0);
			func_31(uParam0);
			iVar9 = network_get_local_scene_from_network_id(uParam0->f_8);
			if (func_55(&(uParam0->f_7), 13))
			{
				disable_control_action(0, 0, true);
			}
			if (is_synchronized_scene_running(iVar9))
			{
				if (get_synchronized_scene_phase(iVar9) >= 1f)
				{
					if (uParam0->f_1.f_1 == 3)
					{
						if (func_55(&(uParam0->f_7), 13))
						{
							if (get_cam_view_mode_for_context(0) == 1)
							{
								set_cam_view_mode_for_context(0, 1);
					...
					func_56(uParam0, &sVar1);
					uParam0->f_8 = network_create_synchronised_scene(func_53(uParam0), func_52(uParam0), 2, true, false, 1f, 0f, 1.12f);
					network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_8, &sVar0, &sVar1, 4f, -1.5f, 9, 0, 1000f, 0);
					network_start_synchronised_scene(uParam0->f_8);
					func_54(&(uParam0->f_7), 8);
		...
		case 8:
			iVar10 = network_get_local_scene_from_network_id(uParam0->f_8);
			iVar11 = get_script_task_status(player_ped_id(), 1785177548);
			if (iVar11 == 0 || iVar11 == 1)
			{
				if (is_synchronized_scene_running(iVar10))
				{
					if ((get_synchronized_scene_phase(iVar10) >= 0.7f || has_anim_event_fired(player_ped_id(), get_hash_key("BREAKOUT_FINISH"))) || has_anim_event_fired(player_ped_id(), get_hash_key("BREAK_OUT")))
					{
						network_stop_synchronised_scene(uParam0->f_8);
						func_20(-1);
						func_21(uParam0);
...
void func_25(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((get_game_timer() - uParam0->f_1) >= 90000 && uParam0->f_1.f_1 != 3)
		{
			iVar1 = func_26(uParam0);
			if (iVar1 != uParam0->f_1.f_2)
			{
...
void func_31(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_13 == 6 && !has_anim_event_fired(player_ped_id(), get_hash_key("BLOCK_INTERRUPT"))) && !func_55(&(uParam0->f_7), 12))
		{
		...
		else
		{
			...
			if (((((!is_pause_menu_active() && !func_55(&(uParam0->f_7), 0)) && !func_55(&(uParam0->f_7), 4)) && !func_34()) && !func_32(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
...
void func_37(var uParam0)
{
	...
	uParam0->f_8 = network_create_synchronised_scene(func_53(uParam0), func_52(uParam0), 2, true, false, 1f, 0f, 1.12f);
	func_57(uParam0, &sVar0);
	network_add_ped_to_synchronised_scene(player_ped_id(), uParam0->f_8, &sVar0, "exit", 4f, -4f, 9, 0, 1000f, 0);
	network_start_synchronised_scene(uParam0->f_8);
	func_22(&(uParam0->f_6));
	func_80(uParam0, 8);
}
...
void func_40(var uParam0)
{
	...
	_clamp_gameplay_cam_pitch(-70.0027f, -10.1277f);
	switch (uParam0->f_13)
	{
		case 4:
		case 8:
...
int func_61(var uParam0)
{
	...
	iVar0 = get_random_int_in_range(0, func_29(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_27())
		{
...
int func_69(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((does_entity_exist(uVar0[iVar1]) && !is_ped_injured(uVar0[iVar1])) && is_entity_visible(uVar0[iVar1])) && func_78(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_70(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (iVar1 != player_id() && func_73(iVar1, 1, 1))
			{
				if (func_78(get_player_ped(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_71(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_77(int iParam0, struct<3> Param1, int iParam2)
{
	if (does_entity_exist(iParam0))
	{
		...
		{
			if (func_39(get_entity_heading(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_39(get_entity_heading(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
{
	return is_entity_in_angled_area(iParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, false, true, 0);
}
...
int func_79(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_78(player_ped_id(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_77(player_ped_id(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
		{
			return 1;
		}
		else
...
void func_82(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		set_ped_capsule(player_ped_id(), func_83());
		uParam0->f_12 = get_frame_count();
	}
	else if ((get_frame_count() - uParam0->f_12) < 5)
	{
		set_ped_capsule(player_ped_id(), func_83());
	}
}
...
void func_84(var uParam0)
{
	...
	func_85(&(uParam0->f_7), 1, is_entity_dead(player_ped_id(), false));
	func_85(&(uParam0->f_7), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_85(&(uParam0->f_7), 0, func_50(0));
	func_85(&(uParam0->f_7), 2, is_ped_running(player_ped_id()));
}
...
int func_87()
{
	...
	if (func_96(player_id()) && is_screen_faded_out())
	{
		return 1;
	}
	if (func_88())
...
int func_88()
{
	...
	if (func_89() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_89()) == 0)
		{
			return 1;
		}
	}
...
int func_101()
{
	if (network_is_script_active("music_studio_seating", func_112(), true, 0))
	{
		return 0;
	}
	network_set_this_script_is_network_script(32, false, func_112());
	func_110(0, -1, 0);
