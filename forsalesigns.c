...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		...
		{
			if ((((!func_49() && !is_ped_fleeing(iLocal_44)) && !is_ped_ragdoll(iLocal_44)) && !is_ped_prone(iLocal_44)) && !is_ped_injured(iLocal_44))
			{
				if (func_48(iLocal_44, player_ped_id(), 1) <= 3f)
				{
					if ((get_game_timer() - iLocal_43) > 8000)
					{
			...
			if (func_48(iLocal_44, player_ped_id(), 1) > 150f)
			{
				func_24(&iLocal_44);
			}
		}
	...
	while (bVar0 < 15)
	{
		if (does_entity_exist(Local_210[bVar0 /*11*/]))
		{
			if (has_object_been_broken(Local_210[bVar0 /*11*/], 0) || func_22(Local_210[bVar0 /*11*/]))
			{
				set_bit(&(Global_113386.f_10049.f_108), bVar0);
				func_19(bVar0);
				set_object_as_no_longer_needed(&(Local_210[bVar0 /*11*/]));
				bLocal_39 = true;
				func_18(1, 0);
				func_16();
			}
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				...
				{
					iLocal_41 = request_scaleform_movie("MIDSIZED_MESSAGE");
					if (has_scaleform_movie_loaded(iLocal_41))
					{
						iVar0 = get_sound_id();
						play_sound_frontend(iVar0, "SIGN_DESTROYED", "HUD_AWARDS", true);
						iLocal_40++;
					}
				}
				break;
			...
			case 1:
				begin_scaleform_movie_method(iLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
				begin_text_command_scaleform_string("FS_TITLE");
				end_text_command_scaleform_string();
				begin_text_command_scaleform_string("FS_DESTROY");
				add_text_component_integer(func_5(2));
				end_text_command_scaleform_string();
			...
			case 2:
				if (timerb() > 7000)
				{
					begin_scaleform_movie_method(iLocal_41, "SHARD_ANIM_OUT");
				...
				else if (!func_10())
				{
					if (has_scaleform_movie_loaded(iLocal_41))
					{
						draw_scaleform_movie_fullscreen(iLocal_41, 100, 100, 100, 255, 0);
					}
				}
				break;
			...
			case 4:
				if (has_scaleform_movie_loaded(iLocal_41))
				{
					set_scaleform_movie_as_no_longer_needed(&iLocal_41);
				}
				bLocal_211 = false;
				bLocal_39 = false;
				iLocal_40 = 0;
...
void func_11(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	{
		if (func_13(player_ped_id(), uParam0->f_3, fParam3, 1) && !does_entity_exist(*uParam0))
		{
			...
			*uParam0 = create_object(iParam1, uParam0->f_3, true, true, false);
			uParam0->f_10 = 1;
...
bool func_13(int iParam0, struct<3> Param1, float fParam2, bool bParam3)
{
...
void func_14(int* iParam0, var uParam1)
{
	if (!is_ped_injured(player_ped_id()))
	{
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(*iParam0, true), true) >= 110f && !is_entity_on_screen(*iParam0))
		{
			func_15(iParam0);
			*uParam1 = 0;
		}
...
int func_22(int iParam0)
{
	...
	Var0 = { get_entity_rotation(iParam0, 0) };
...
void func_38()
{
	...
	{
		if (func_41(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
int func_52()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (get_entity_model(uVar2[iVar1]) == func_54(58))
			{
				iLocal_44 = uVar2[iVar1];
				if (!is_entity_a_mission_entity(iLocal_44))
				{
					set_entity_as_mission_entity(iLocal_44, true, false);
				}
				set_ped_money(iLocal_44, 0);
				set_ped_can_be_targetted(iLocal_44, false);
				set_ped_name_debug(iLocal_44, "POSTJOSH");
				set_ped_relationship_group_hash(iLocal_44, joaat("player"));
...
void func_57()
{
	...
	set_model_as_no_longer_needed(iLocal_38);
...
void func_66()
{
	...
	{
		func_68(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_67() == 2 == 0 && !network_is_game_in_progress())
			{
