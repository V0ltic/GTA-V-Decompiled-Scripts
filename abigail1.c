...
void func_1()
{
	switch (iLocal_87)
	{
		case 0:
			...
			{
				if (is_entity_playing_anim(iLocal_83, "rcmabigail", "loop_talk", 3) || is_entity_playing_anim(iLocal_83, "rcmabigail", "loop_look", 3))
				{
					task_play_anim(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0f, false, false, false);
					remove_cutscene();
					func_305(1);
					request_cutscene_with_playback_list("ABIGAIL_MCS_1_CONCAT", 2, 8);
					iLocal_87 = 1;
				}
				else
				{
		...
		case 1:
			func_302();
			if ((func_306(iLocal_83) && is_entity_playing_anim(iLocal_83, "rcmabigail", "loop_2_cs", 3)) && get_entity_anim_current_time(iLocal_83, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_87++;
			}
			break;
		...
		case 2:
			...
			if (func_293(1, 1093140480, 0))
			{
				if (func_306(iLocal_83))
				{
					register_entity_for_cutscene(iLocal_83, "ABIGAIL", 0, 0, 0);
				}
				func_292();
				start_cutscene(2048);
		...
		case 4:
			if (is_cutscene_playing())
			{
				...
				{
					iLocal_84 = create_cam("DEFAULT_SCRIPTED_CAMERA", true);
					set_cam_params(iLocal_84, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					set_cam_params(iLocal_84, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
					render_script_cams(true, false, 3000, true, false, 0);
					shake_cam(iLocal_84, "HAND_SHAKE", 0.3f);
				}
				if (func_306(player_ped_id()) && can_set_exit_state_for_registered_entity("Michael", 0))
				{
					_0x81CBAE94390F9F89();
					clear_ped_tasks(player_ped_id());
					task_follow_nav_mesh_to_coord(player_ped_id(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 0.25f, false, 40000f);
					task_look_at_coord(player_ped_id(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_306(iLocal_83) && can_set_exit_state_for_registered_entity("Abigail", 0))
				{
					clear_ped_tasks(iLocal_83);
					task_follow_nav_mesh_to_coord(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 0.25f, false, 40000f);
				}
			}
			else
			{
				iLocal_86 = get_game_timer() + 10000;
				iLocal_87++;
			}
			break;
		
		case 5:
			if ((iLocal_89 == 0 && get_follow_ped_cam_view_mode() == 4) && get_game_timer() > (iLocal_86 - 300))
			{
				animpostfx_play("CamPushInNeutral", 0, false);
				play_sound_frontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", true);
				iLocal_89 = 1;
			}
			if (func_227(1000) || get_game_timer() > iLocal_86)
			{
...
int func_202()
{
	return func_203(get_this_script_name(), 0);
}
...
void func_217(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_221(player_id())) && !func_219(player_id(), 0)) && !func_218()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_221(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_234(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			clear_area_of_peds(func_235(get_player_index()), 50f, 0);
		}
		if (iParam5 == 1)
		{
	...
	if (does_entity_exist(Global_103950.f_4))
	{
		if (is_vehicle_driveable(Global_103950.f_4, false))
		{
			if (func_284(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_281(get_entity_coords(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_255(iParam0, 0, 0)) || func_255(iParam0, 1, 0)) || func_255(iParam0, 2, 0)) || func_274(iParam0) != 145) || func_254(iParam0)) || func_253(iParam0)) || func_252(iParam0)) || func_251(iParam0)) || !func_241(get_entity_model(iParam0)))
	{
		if (func_253(iParam0))
		{
		}
...
var func_257()
{
	...
	func_267(&uVar0, get_clock_seconds());
	func_266(&uVar0, get_clock_minutes());
	func_265(&uVar0, get_clock_hours());
	func_260(&uVar0, get_clock_day_of_month());
	func_259(&uVar0, get_clock_month());
	func_258(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_263(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_271(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_268(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_277(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_293(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), false))
	{
		...
		{
			if (!func_300(get_vehicle_ped_is_in(player_ped_id(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_299(player_ped_id(), -828834893))
				{
...
void func_302()
{
	if (func_306(player_ped_id()))
	{
		...
		if (iLocal_88 == 0)
		{
			if (func_306(iLocal_83))
			{
				if (func_303(player_ped_id(), iLocal_83, 1) < 4f || (get_entity_speed(player_ped_id()) > 2f && func_303(player_ped_id(), iLocal_83, 1) < 6f))
				{
...
void func_308()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			if (func_300(get_vehicle_ped_is_in(player_ped_id(), false), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_328(0) || Global_78588) || Global_78577 == 1) || !is_screen_faded_in())
	{
		return 0;
	}
	switch (Global_78573)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_313(0)) || func_327(1))
			{
			}
			else
			{
...
void func_346(bool bParam0)
{
	...
	if (!func_363())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_347(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_112473[iVar0 /*10*/].f_9 == -1)
...
int func_348(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_354())
	{
		...
		{
			iVar2 = func_349(get_this_script_name());
			if (iVar2 > -1)
			{
