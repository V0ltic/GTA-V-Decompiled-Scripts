			...
			if (Var0.f_0 == 22)
			{
				if (can_request_assets_for_cutscene_entity())
				{
					if (func_200(Var0.f_28[1]))
					{
						...
						set_cutscene_ped_component_variation_from_ped("MaryAnnes_Friend", Var0.f_28[1], 0);
						set_cutscene_ped_prop_variation("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_55 = 1;
					}
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_200(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
...
void func_189(int iParam0)
{
	...
	if ((get_game_timer() - iLocal_57) >= 900)
	{
		if (func_200(iParam0->f_28[0]))
		{
			if (!func_147())
...
{
	play_ped_ambient_speech_with_voice_native(iParam0, sParam1, sParam2, func_191(iParam3), false);
}
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_200(player_ped_id()) && func_200(iParam0->f_28[0])) && !func_147()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_196(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_196(int iParam0, struct<3> Param1, bool bParam2)
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_180(2))
	{
		if (!func_147())
		{
			if (((func_200(player_ped_id()) && func_200(iParam0->f_28[0])) && (get_game_timer() - iParam0->f_60) > iParam6) && func_196(player_ped_id(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_195(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_193(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		{
			if (func_200(player_ped_id()))
			{
				if (func_196(player_ped_id(), Param1, 1) >= 20f)
				{
					func_145();
				}
			}
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_196(player_ped_id(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_196(player_ped_id(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
void func_210(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_200(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_212(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_211(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_211(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_218(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_221(int iParam0, float fParam1)
{
	...
	if (func_200(player_ped_id()) && func_200(iParam0))
	{
		if (func_232(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_223(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_229(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_229(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_236(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_229(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_261(iParam0);
