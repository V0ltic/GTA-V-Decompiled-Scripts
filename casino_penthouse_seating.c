...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_57(player_ped_id(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_56(player_ped_id(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(player_id())) || is_ped_in_any_vehicle(player_ped_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || is_ped_in_melee_combat(player_ped_id())) || is_ped_performing_melee_action(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_injured(player_ped_id())) || BitTest(Global_1946250.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
		...
		case 4:
			...
			Var2 = { get_anim_initial_offset_position(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			Var3 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar4 = Var3.f_2;
			fVar5 = 0.05f;
		...
		case 5:
			...
			Var7 = { get_anim_initial_offset_rotation(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar8 = Var7.f_2;
			if ((iVar6 != 1 && iVar6 != 0) || func_16(get_entity_heading(player_ped_id()), fVar8, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (get_cam_view_mode_for_context(0) == 4)
				...
				disable_control_action(0, 0, true);
				uParam0->f_8 = network_create_synchronised_scene(func_31(uParam0), func_30(uParam0), 2, true, false, 1f, 0f, 1.12f);
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		fVar1 = vmag(Var0);
		if ((uParam0->f_13 == 6 && !has_anim_event_fired(player_ped_id(), get_hash_key("BLOCK_INTERRUPT"))) && !func_33(&(uParam0->f_7), 12))
		{
		...
		else
		{
			...
			if (((((!is_pause_menu_active() && !func_33(&(uParam0->f_7), 0)) && !func_33(&(uParam0->f_7), 4)) && !func_11()) && !func_9(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
...
int func_39(var uParam0)
{
	...
	iVar0 = get_random_int_in_range(0, func_6(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
		{
...
int func_50(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((does_entity_exist(uVar0[iVar1]) && !is_ped_injured(uVar0[iVar1])) && is_entity_visible(uVar0[iVar1])) && func_57(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_51(var uParam0)
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (iVar1 != player_id() && func_54(iVar1, 1, 1))
			{
				if (func_57(get_player_ped(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_52(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_56(int iParam0, struct<3> Param1, int iParam2)
{
	if (does_entity_exist(iParam0))
	{
		...
		{
			if (func_16(get_entity_heading(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(get_entity_heading(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
void func_61(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		set_ped_capsule(player_ped_id(), func_62());
...
void func_63(var uParam0)
{
	...
	func_64(&(uParam0->f_7), 1, is_entity_dead(player_ped_id(), false));
	func_64(&(uParam0->f_7), 3, is_ped_in_any_vehicle(player_ped_id(), true));
	func_64(&(uParam0->f_7), 0, func_27(0));
	func_64(&(uParam0->f_7), 2, is_ped_running(player_ped_id()));
}
...
int func_66()
{
	...
	if (func_79(player_id()) && is_screen_faded_out())
	{
		return 1;
	}
	if (func_77() != 0)
...
int func_69()
{
	...
	if (func_70() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_70()) == 0)
		{
			return 1;
		}
	}
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && (is_player_playing(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_96(player_id(), 0) && !func_95()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_91(iVar27) && !is_entity_attached_to_any_vehicle(iVar27))
				{
					if (!bVar22)
					{
...
void func_100()
{
	network_set_this_script_is_network_script(32, false, func_111());
	func_109(0, -1, 0);
	func_108();
	func_101();
	if (network_is_game_in_progress())
