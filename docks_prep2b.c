...
void __EntryFunction__()
{
	...
	set_weather_type_overtime_persist("EXTRASUNNY", 30f);
	func_284();
	if (!func_283())
	{
		iLocal_28 = 0;
...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (func_2(iLocal_34, player_ped_id(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (func_2(iLocal_34, player_ped_id(), 1) > 100f)
				{
					func_3(2);
					return;
				}
				else if ((is_vehicle_stuck_timer_up(iLocal_34, 3, 30000) || is_vehicle_stuck_timer_up(iLocal_34, 1, 40000)) || is_vehicle_stuck_timer_up(iLocal_34, 0, 7000))
				{
					func_3(3);
					return;
				}
...
void func_29()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (does_entity_exist(iLocal_34))
		{
			freeze_entity_position(iLocal_34, false);
		}
		...
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
				{
					task_leave_vehicle(player_ped_id(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
	...
	if (iLocal_54 == 1)
	{
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (!is_ped_in_vehicle(player_ped_id(), iLocal_34, true))
				{
					set_vehicle_door_shut(iLocal_34, 0, false);
					set_vehicle_door_shut(iLocal_34, 1, false);
					set_vehicle_doors_locked(iLocal_34, 2);
					set_vehicle_is_considered_by_player(iLocal_34, false);
...
void func_35()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!is_ped_in_vehicle(player_ped_id(), iLocal_39, false))
				{
					set_ped_into_vehicle(player_ped_id(), iLocal_39, -1);
				}
			}
			else
			{
				set_entity_coords(player_ped_id(), -1565.084f, 2780.813f, 16.4022f, true, false, false, true);
				set_entity_heading(player_ped_id(), 53.6086f);
			}
			break;
			...
			if (func_20() == 2)
			{
				if (does_entity_exist(iLocal_34))
				{
					if (is_vehicle_driveable(iLocal_34, false))
					{
						if (!is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
						{
							set_ped_into_vehicle(player_ped_id(), iLocal_34, -1);
						}
						freeze_entity_position(iLocal_34, false);
					}
				}
...
void func_37()
{
	...
	{
		case 2:
			clear_area(-1588.1f, 2794.9f, 17.2f, 20f, true, false, false, false);
			...
			request_model(joaat("cargobob"));
			request_model(joaat("s_m_y_marine_01"));
			request_model(joaat("s_m_m_pilot_02"));
			request_model(joaat("buzzard"));
			while (((!has_model_loaded(joaat("cargobob")) || !has_model_loaded(joaat("s_m_y_marine_01"))) || !has_model_loaded(joaat("s_m_m_pilot_02"))) || !has_model_loaded(joaat("buzzard")))
			{
				wait(0);
			}
			if (func_283())
			{
				if (func_120())
				{
					if (!is_this_model_a_heli(func_119()) && !is_this_model_a_plane(func_119()))
					{
						func_117();
						while (!func_116())
						{
			...
			if (!does_entity_exist(iLocal_34))
			{
				clear_area(Local_118, 10f, true, false, false, false);
				iLocal_34 = create_vehicle(joaat("cargobob"), Local_118, fLocal_122, true, true, false);
				set_vehicle_can_be_targetted(iLocal_34, false);
				freeze_entity_position(iLocal_34, true);
				set_entity_load_collision_flag(iLocal_34, true, 1);
				set_model_as_no_longer_needed(joaat("cargobob"));
				set_vehicle_model_is_suppressed(joaat("cargobob"), true);
				set_vehicle_strong(iLocal_34, true);
				set_vehicle_engine_can_degrade(iLocal_34, false);
				func_115(iLocal_34, 0);
			}
			func_112();
			if (!does_entity_exist(iLocal_35[0]))
			{
				if (has_model_loaded(joaat("buzzard")))
				{
					clear_area(-1866.446f, 3071.395f, 31.8104f, 10f, true, false, false, false);
					iLocal_35[0] = create_vehicle(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, true, true, false);
					set_entity_load_collision_flag(iLocal_35[0], true, 1);
					set_vehicle_can_be_targetted(iLocal_35[0], true);
					set_vehicle_on_ground_properly(iLocal_35[0], 5f);
					add_entity_to_audio_mix_group(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0f);
					set_model_as_no_longer_needed(joaat("buzzard"));
					set_vehicle_is_considered_by_player(iLocal_35[0], false);
				}
			}
			if (func_283())
			{
				if (!does_entity_exist(iLocal_39))
				{
					if (func_120())
					{
						if (!is_this_model_a_heli(func_119()) && !is_this_model_a_plane(func_119()))
						{
							...
							set_model_as_no_longer_needed(func_119());
							set_vehicle_has_strong_axles(iLocal_39, true);
							set_vehicle_strong(iLocal_39, true);
						}
					}
				}
			}
		...
		case 3:
			...
			request_model(joaat("s_m_y_marine_01"));
			request_model(joaat("s_m_m_pilot_02"));
			while (((!has_model_loaded(joaat("cargobob")) || !has_model_loaded(joaat("buzzard"))) || !has_model_loaded(joaat("s_m_y_marine_01"))) || !has_model_loaded(joaat("s_m_m_pilot_02")))
			{
				wait(0);
			}
			iLocal_80 = 0;
			...
			if (!does_entity_exist(iLocal_34))
			{
				...
				freeze_entity_position(iLocal_34, true);
				set_entity_load_collision_flag(iLocal_34, true, 1);
				set_heli_blades_full_speed(iLocal_34);
				set_model_as_no_longer_needed(joaat("cargobob"));
				set_vehicle_model_is_suppressed(joaat("cargobob"), true);
				set_vehicle_strong(iLocal_34, true);
				set_vehicle_engine_can_degrade(iLocal_34, false);
			...
			{
				iLocal_31[0] = create_ped_inside_vehicle(iLocal_35[0], 26, joaat("s_m_m_pilot_02"), -1, true, true);
				set_model_as_no_longer_needed(joaat("s_m_m_pilot_02"));
			}
			else if (!is_ped_in_vehicle(iLocal_31[0], iLocal_35[0], false))
			{
				set_ped_into_vehicle(iLocal_31[0], iLocal_35[0], -1);
			}
		...
		case 4:
			...
			set_player_wanted_level(player_id(), 0, false);
			set_player_wanted_level_now(player_id(), false);
			while (!has_model_loaded(joaat("cargobob")))
			{
				wait(0);
			}
			if (!does_entity_exist(iLocal_34))
			{
				clear_area(Local_118, 10f, true, false, false, false);
				iLocal_34 = create_vehicle(joaat("cargobob"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, true, true, false);
				set_entity_load_collision_flag(iLocal_34, true, 1);
				set_model_as_no_longer_needed(joaat("cargobob"));
				set_vehicle_model_is_suppressed(joaat("cargobob"), true);
				set_vehicle_engine_can_degrade(iLocal_34, false);
				set_vehicle_strong(iLocal_34, true);
				set_vehicle_engine_on(iLocal_34, true, true, false);
				set_heli_blades_full_speed(iLocal_34);
				set_vehicle_forward_speed(iLocal_34, 30f);
				func_115(iLocal_34, 0);
			}
			give_weapon_to_ped(player_ped_id(), joaat("gadget_parachute"), -1, false, true);
			break;
		...
		case 5:
			request_model(joaat("cargobob"));
			request_model(joaat("sandking"));
			while (!has_model_loaded(joaat("cargobob")) || !has_model_loaded(joaat("sandking")))
			{
				wait(0);
			}
			if (!does_entity_exist(iLocal_34))
			{
				clear_area(1749.61f, 3272.95f, 40.1533f, 5f, true, false, false, false);
				iLocal_34 = create_vehicle(joaat("cargobob"), 1749.61f, 3272.95f, 40.1533f, 51.128f, true, true, false);
				set_entity_load_collision_flag(iLocal_34, true, 1);
				set_model_as_no_longer_needed(joaat("cargobob"));
				set_vehicle_strong(iLocal_34, true);
				set_vehicle_engine_can_degrade(iLocal_34, false);
			...
			{
				iLocal_36[0] = create_vehicle(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, true, true, false);
				freeze_entity_position(iLocal_36[0], true);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_8(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
void func_112()
{
	if (iLocal_80 == 0)
	{
		if (has_model_loaded(joaat("s_m_y_marine_01")) && has_model_loaded(joaat("s_m_m_pilot_02")))
		{
			if (!does_entity_exist(iLocal_32[0]))
			{
				iLocal_32[0] = create_ped(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, true, true);
			}
			if (!does_entity_exist(iLocal_32[1]))
			{
				iLocal_32[1] = create_ped(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, true, true);
			}
			if (!does_entity_exist(iLocal_32[2]))
			{
				iLocal_32[2] = create_ped(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, true, true);
			}
			if (!does_entity_exist(iLocal_32[3]))
			{
				iLocal_32[3] = create_ped(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, true, true);
			}
			if (!does_entity_exist(iLocal_32[4]))
			{
				iLocal_32[4] = create_ped(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, true, true);
			}
			if (!does_entity_exist(iLocal_32[5]))
			{
				iLocal_32[5] = create_ped(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, true, true);
			}
			if (!does_entity_exist(iLocal_32[6]))
			{
				iLocal_32[6] = create_ped(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, true, true);
			}
			if (iLocal_28 != 3)
			{
				if (!does_entity_exist(iLocal_32[7]))
				{
					iLocal_32[7] = create_ped(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, true, true);
				}
				if (!does_entity_exist(iLocal_32[8]))
				{
					iLocal_32[8] = create_ped(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, true, true);
				}
			}
			if (!does_entity_exist(iLocal_32[9]))
			{
				iLocal_32[9] = create_ped(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, true, true);
			}
			if (!does_entity_exist(iLocal_32[10]))
			{
				iLocal_32[10] = create_ped(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, true, true);
			}
			if (!does_entity_exist(iLocal_32[11]))
			{
				iLocal_32[11] = create_ped(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, true, true);
			}
			if (!does_entity_exist(iLocal_32[12]))
			{
				iLocal_32[12] = create_ped(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, true, true);
			}
			if (!does_entity_exist(iLocal_31[0]))
			{
				iLocal_31[0] = create_ped(26, joaat("s_m_m_pilot_02"), -1859.831f, 3071.758f, 31.8104f, 139.3607f, true, true);
				set_ped_prop_index(iLocal_31[0], 0, 2, 0, false);
				set_ped_component_variation(iLocal_31[0], 8, 0, 0, 0);
				set_entity_load_collision_flag(iLocal_31[0], true, 1);
				give_weapon_to_ped(iLocal_31[0], joaat("weapon_assaultrifle"), 2000, true, true);
				set_ped_relationship_group_hash(iLocal_31[0], iLocal_44);
			...
			while (iLocal_55 <= 12)
			{
				...
				{
					if (!is_ped_injured(iLocal_32[iLocal_55]))
					{
						set_entity_load_collision_flag(iLocal_32[iLocal_55], true, 1);
						give_weapon_to_ped(iLocal_32[iLocal_55], joaat("weapon_assaultrifle"), 2000, true, true);
						set_ped_relationship_group_hash(iLocal_32[iLocal_55], iLocal_44);
						set_ped_accuracy(iLocal_32[iLocal_55], 10);
						func_114(iLocal_32[iLocal_55], 595);
						func_113(iLocal_32[iLocal_55], 0);
						set_blocking_of_non_temporary_events(iLocal_32[iLocal_55], true);
...
void func_121(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_122(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_122(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_124(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_125(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_128()
{
	if (!func_36())
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			set_entity_coords(player_ped_id(), 1738.131f, 3283.38f, 40.1261f, true, false, false, true);
			set_entity_heading(player_ped_id(), 25.3545f);
		}
	}
	if (does_entity_exist(iLocal_31[0]))
	{
		delete_ped(&(iLocal_31[0]));
	}
	iLocal_55 = 0;
	while (iLocal_55 <= 12)
	{
		if (does_entity_exist(iLocal_32[iLocal_55]))
		{
			delete_ped(&(iLocal_32[iLocal_55]));
		}
		iLocal_55++;
	}
	if (func_20() == 2)
	{
		if (does_entity_exist(uLocal_124[0]))
		{
			delete_ped(&(uLocal_124[0]));
		}
	}
	if (func_20() == 0)
	{
		if (does_entity_exist(uLocal_124[2]))
		{
			delete_ped(&(uLocal_124[2]));
		}
	}
	if (does_entity_exist(iLocal_35[0]))
	{
		remove_entity_from_audio_mix_group(iLocal_35[0], 0f);
	}
	...
	if (does_entity_exist(iLocal_35[0]))
	{
		delete_vehicle(&(iLocal_35[0]));
	}
	if (does_entity_exist(Global_96938[0]))
	{
		if (!does_entity_belong_to_this_script(Global_96938[0], true))
		{
			set_entity_as_mission_entity(Global_96938[0], true, true);
		}
		delete_vehicle(&(Global_96938[0]));
	}
	if (does_entity_exist(Global_96938[1]))
	{
		if (!does_entity_belong_to_this_script(Global_96938[1], true))
		{
			set_entity_as_mission_entity(Global_96938[1], true, true);
		}
		delete_vehicle(&(Global_96938[1]));
	}
	if (does_entity_exist(Global_96938[2]))
	{
		if (!does_entity_belong_to_this_script(Global_96938[2], true))
		{
			set_entity_as_mission_entity(Global_96938[2], true, true);
		}
		delete_vehicle(&(Global_96938[2]));
	}
	if (does_entity_exist(iLocal_36[0]))
	{
		delete_vehicle(&(iLocal_36[0]));
	}
	...
	{
		delete_object(&iLocal_43);
	}
	if (does_cam_exist(iLocal_40))
	{
		if (is_cam_active(iLocal_40))
		{
			render_script_cams(false, false, 3000, true, false, 0);
		}
		destroy_cam(iLocal_40, false);
	}
}

void func_129()
{
	if (does_blip_exist(iLocal_45))
	{
		remove_blip(&iLocal_45);
	}
	if (does_blip_exist(iLocal_46))
	{
		remove_blip(&iLocal_46);
	}
	...
	if (does_entity_exist(iLocal_34))
	{
		if (is_vehicle_driveable(iLocal_34, false))
		{
			if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
			{
				...
				if (iLocal_107 == 1)
				{
					if (get_game_timer() < iLocal_68 + 7500)
					{
						clear_prints();
					}
				}
				if (iLocal_28 == 4)
				{
					...
					if (iLocal_78 == 0)
					{
						...
						{
							if (!func_137() || !is_subtitle_preference_switched_on())
							{
				...
				if (iLocal_28 == 3)
				{
					if (!does_blip_exist(uLocal_47[0]))
					{
			...
			else if (iLocal_28 != 5)
			{
				...
				if (iLocal_28 == 4)
				{
					if (iLocal_78 == 1)
					{
						if (get_game_timer() < iLocal_69 + 7500)
						{
							clear_prints();
						}
					}
...
int func_133(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		set_blip_scale(iVar0, func_134(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
...
int func_138(struct<3> Param0, bool bParam1)
{
	int iVar0;
	...
	if (iLocal_54 == 0)
	{
		...
		while (iLocal_55 <= 12)
		{
			if (does_entity_exist(iLocal_32[iLocal_55]))
			{
				if (!is_ped_injured(iLocal_32[iLocal_55]))
				{
					set_ped_keep_task(iLocal_32[iLocal_55], true);
					set_ped_as_no_longer_needed(&(iLocal_32[iLocal_55]));
				}
			}
			iLocal_55++;
		}
		if (does_entity_exist(iLocal_35[0]))
		{
			set_vehicle_as_no_longer_needed(&(iLocal_35[0]));
		}
		if (does_entity_exist(iLocal_31[0]))
		{
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (does_entity_exist(iLocal_34))
			{
				if (is_vehicle_driveable(iLocal_34, false))
				{
					if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
					{
						if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_118, true) > 800f)
						{
						...
						if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!is_message_being_displayed())
								{
									if (!func_137() || !is_subtitle_preference_switched_on())
									{
										func_160(&uLocal_198, 2, player_ped_id(), "TREVOR", 0, 1);
		...
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
				{
					if (is_entity_at_coord(player_ped_id(), Local_119, 2f, 2f, 2f, true, true, 0))
					{
					}
					if (is_entity_in_angled_area(player_ped_id(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, false, true, 0))
					{
						if (!is_entity_in_air(iLocal_34) && is_vehicle_stopped(iLocal_34))
						{
							func_140(1, 600);
...
void func_161(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_234(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_227(get_this_script_name(), 1);
			if (iVar4 != -1)
			{
...
{
	func_163(&Global_106934, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_163(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_20();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_187(player_ped_id());
		func_180(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_179())
		{
			func_172(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_74(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_181(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_186(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_183(Var7.f_1)) && iVar9 < 51)
			{
...
int func_189(struct<3> Param0, char* sParam1, struct<3> Param2)
{
	int iVar0;
	int iVar1;
...
int func_191(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_213())
		{
			*uParam0 = func_197(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_197(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_212(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_198(iVar0, 0), true);
...
Vector3 func_202(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
var func_214()
{
	...
	func_224(&uVar0, get_clock_seconds());
	func_223(&uVar0, get_clock_minutes());
	func_222(&uVar0, get_clock_hours());
	func_217(&uVar0, get_clock_day_of_month());
	func_216(&uVar0, get_clock_month());
	func_215(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_220(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_229(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_239()
{
	if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!does_entity_exist(iLocal_36[0]))
			{
				request_model(joaat("sandking"));
				if (has_model_loaded(joaat("sandking")))
				{
					iLocal_36[0] = create_vehicle(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, true, true, false);
					freeze_entity_position(iLocal_36[0], true);
					set_model_as_no_longer_needed(joaat("sandking"));
	...
	{
		if (get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_119, true) > 550f)
		{
			if (does_entity_exist(iLocal_36[0]))
			{
				delete_vehicle(&(iLocal_36[0]));
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_83[0] == 1)
		{
			...
			if (does_entity_exist(iLocal_34))
			{
				if (is_vehicle_driveable(iLocal_34, false))
				{
					if (is_entity_in_angled_area(iLocal_34, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, false, true, 0))
					{
						if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
						{
							set_player_wanted_level(player_id(), 0, false);
...
void func_244()
{
	iLocal_37 = get_closest_vehicle(get_entity_coords(player_ped_id(), true), 300f, joaat("lazer"), 4);
	iLocal_38 = get_closest_vehicle(get_entity_coords(player_ped_id(), true), 300f, joaat("lazer"), 16386);
	if (does_entity_exist(iLocal_37) && is_entity_in_air(iLocal_37))
	{
		if (!does_blip_exist(iLocal_48))
		{
			iLocal_48 = add_blip_for_entity(iLocal_37);
			set_blip_as_friendly(iLocal_48, false);
		}
	}
	if (does_entity_exist(iLocal_38) && is_entity_in_air(iLocal_38))
	{
		if (!does_blip_exist(iLocal_49))
		{
			iLocal_49 = add_blip_for_entity(iLocal_38);
			set_blip_as_friendly(iLocal_49, false);
		}
	}
}
...
void func_245()
{
	if (iLocal_28 == 3)
	{
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
				{
					Local_121 = { get_entity_coords(player_ped_id(), true) };
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									if (func_2(player_ped_id(), iLocal_31[0], 1) < 600f)
									{
										if (get_distance_between_coords(Local_121, -75.8f, -819.9f, 326f, true) > 1600f && get_distance_between_coords(Local_121, -2159f, 3067f, 33f, true) < 1000f)
										{
										...
										{
											if (get_distance_between_coords(Local_121, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
											...
											if (get_distance_between_coords(Local_121, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (get_distance_between_coords(Local_121, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
			...
			if (does_entity_exist(iLocal_35[0]))
			{
				if (is_vehicle_driveable(iLocal_35[0], false))
				{
					if (does_entity_exist(iLocal_31[0]))
					{
						if (!is_ped_injured(iLocal_31[0]))
						{
							if (func_2(player_ped_id(), iLocal_31[0], 1) < 200f)
							{
								Local_120 = { get_entity_coords(iLocal_35[0], true) };
								clear_ped_tasks(iLocal_31[0]);
								set_ped_sphere_defensive_area(iLocal_31[0], Local_120, 10f, false, false);
				...
				if (is_vehicle_driveable(iLocal_35[0], false))
				{
					if (does_entity_exist(iLocal_31[0]))
					{
						if (!is_ped_injured(iLocal_31[0]))
						{
							...
							Local_120 = { get_entity_coords(iLocal_35[0], true) };
							clear_ped_tasks(iLocal_31[0]);
							open_sequence_task(&iLocal_367);
							if (!is_ped_in_vehicle(iLocal_31[0], iLocal_35[0], false))
							{
								task_enter_vehicle(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							task_heli_mission(0, iLocal_35[0], 0, 0, Local_120.f_0, Local_120.f_1, (Local_120.f_2 + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							task_heli_mission(0, iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1f, 0);
							close_sequence_task(iLocal_367);
							task_perform_sequence(iLocal_31[0], iLocal_367);
							clear_sequence_task(&iLocal_367);
							iLocal_81[0] = 1;
						}
					}
				}
			...
			if (is_vehicle_driveable(iLocal_35[0], false))
			{
				if (does_entity_exist(iLocal_31[0]))
				{
					if (!is_ped_injured(iLocal_31[0]))
					{
						if (is_ped_in_vehicle(iLocal_31[0], iLocal_35[0], false))
						{
							if (get_game_timer() > (iLocal_67 + 90000))
							{
								if (iLocal_104 == 0)
								{
							...
							else if (get_game_timer() > iLocal_67 + 10000 && !is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
							{
								if (iLocal_104 == 0)
								{
									set_ped_accuracy(iLocal_31[0], 100);
							...
							if (func_2(iLocal_35[0], player_ped_id(), 1) < 300f)
							{
								if (iLocal_106 == 0)
								{
					...
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									task_heli_mission(iLocal_31[0], iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									task_heli_mission(iLocal_31[0], iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									task_heli_mission(iLocal_31[0], iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									task_heli_mission(iLocal_31[0], iLocal_35[0], 0, 0, get_offset_from_entity_in_world_coords(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, get_entity_heading(iLocal_35[0]), round(get_entity_height(iLocal_35[0], get_entity_coords(iLocal_35[0], true), true, true)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (does_entity_exist(iLocal_35[0]))
						{
							if (is_vehicle_driveable(iLocal_35[0], false))
							{
								if (does_entity_exist(iLocal_31[0]))
								{
									if (!is_ped_injured(iLocal_31[0]))
									{
										task_heli_mission(iLocal_31[0], iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (does_entity_exist(iLocal_35[0]))
					{
						if (is_vehicle_driveable(iLocal_35[0], false))
						{
							if (does_entity_exist(iLocal_31[0]))
							{
								if (!is_ped_injured(iLocal_31[0]))
								{
									task_heli_mission(iLocal_31[0], iLocal_35[0], 0, player_ped_id(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
	...
	if (does_entity_exist(iLocal_31[0]))
	{
		if (!is_ped_injured(iLocal_31[0]))
		{
			...
			{
				clear_ped_tasks(iLocal_31[0]);
				set_entity_health(iLocal_31[0], 0, 0);
				if (does_blip_exist(uLocal_47[0]))
				{
					remove_blip(&(uLocal_47[0]));
				}
...
void func_246()
{
	if (iLocal_85 == 0)
	{
		if ((((func_247(get_entity_coords(player_ped_id(), true), 3, 0, 0) || is_entity_in_angled_area(player_ped_id(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, false, true, 0)) || is_entity_in_angled_area(player_ped_id(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, false, true, 0))
		{
			iLocal_85 = 1;
		}
	}
	...
	if (iLocal_80 == 1)
	{
				...
				if (does_entity_exist(iLocal_32[iLocal_55]))
				{
					if (!is_ped_injured(iLocal_32[iLocal_55]))
					{
						if (does_entity_exist(iLocal_34))
						{
							if (is_vehicle_driveable(iLocal_34, false))
							{
								if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false) || iLocal_87 == 1)
								{
									if (func_2(player_ped_id(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											clear_ped_tasks(iLocal_32[iLocal_55]);
											set_ped_sphere_defensive_area(iLocal_32[iLocal_55], get_entity_coords(iLocal_32[iLocal_55], true), 50f, false, false);
											task_combat_ped(iLocal_32[iLocal_55], player_ped_id(), 0, 16);
											set_ped_combat_attributes(iLocal_32[iLocal_55], 51, true);
											set_ped_combat_attributes(iLocal_32[iLocal_55], 43, true);
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										clear_ped_tasks(iLocal_32[iLocal_55]);
										open_sequence_task(&iLocal_367);
										task_follow_nav_mesh_to_coord(0, get_entity_coords(iLocal_34, true), 2f, -1, 20f, false, 40000f);
										task_combat_ped(0, player_ped_id(), 0, 16);
										close_sequence_task(iLocal_367);
										task_perform_sequence(iLocal_32[iLocal_55], iLocal_367);
										clear_sequence_task(&iLocal_367);
										iLocal_93[iLocal_55] = 0;
										iLocal_94[iLocal_55] = 0;
								...
								else
								{
									...
									if (func_2(player_ped_id(), iLocal_32[iLocal_55], 1) > 41f && func_2(player_ped_id(), iLocal_32[iLocal_55], 1) < 400f)
									{
										if (iLocal_94[iLocal_55] == 0)
										{
											iLocal_74 = get_random_int_in_range(0, 4);
											clear_ped_tasks(iLocal_32[iLocal_55]);
											set_ped_sphere_defensive_area(iLocal_32[iLocal_55], get_entity_coords(iLocal_32[iLocal_55], true), 50f, false, false);
											open_sequence_task(&iLocal_367);
											if (iLocal_74 == 0)
											{
												task_go_to_entity(0, player_ped_id(), -1, 25f, 2f, 2f, 0);
											}
											else if (iLocal_74 == 1)
											{
											...
											{
												task_go_to_entity(0, player_ped_id(), -1, 25f, 3f, 2f, 0);
											}
											else if (iLocal_74 == 3)
											{
												task_stand_still(0, 500);
		...
		if (((iLocal_85 == 0 && iLocal_98 == 0) && iLocal_109 == 0) && iLocal_86 == 0)
		{
			...
			while (iLocal_72 <= 1)
			{
				if (does_entity_exist(iLocal_32[iLocal_72]))
				{
					if (!is_ped_injured(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], player_ped_id(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								if (!is_entity_on_screen(iLocal_32[iLocal_72]))
								{
									clear_ped_tasks_immediately(iLocal_32[iLocal_72]);
								}
								else
								{
									clear_ped_tasks(iLocal_32[iLocal_72]);
								}
								task_aim_gun_at_entity(iLocal_32[iLocal_72], player_ped_id(), -1, false);
								iLocal_101[iLocal_72] = 1;
							}
							if (iLocal_110 == 1)
							{
								if (get_game_timer() > iLocal_70 + 20000)
								{
									iLocal_109 = 1;
								}
							}
						}
						else if (func_2(iLocal_32[iLocal_72], player_ped_id(), 1) > 30f)
						{
...
int func_247(struct<3> Param0, int iParam1, int iParam2, bool bParam3)
{
	struct<3> Var0[15];
	struct<3> Var1[15];
	float fVar2[15];
...
void func_248()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (!does_entity_exist(iLocal_35[0]))
		{
			if (does_entity_exist(Global_96938[1]))
			{
				if (is_vehicle_driveable(Global_96938[1], false))
				{
					...
					set_vehicle_can_be_targetted(iLocal_35[0], true);
					set_entity_load_collision_flag(iLocal_35[0], true, 1);
					freeze_entity_position(iLocal_35[0], false);
					add_entity_to_audio_mix_group(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0f);
					set_vehicle_is_considered_by_player(iLocal_35[0], false);
				}
			}
		...
		if (does_entity_exist(Global_96938[2]))
		{
			...
			{
				if (is_this_model_a_heli(get_entity_model(Global_96938[2])))
				{
					set_entity_as_mission_entity(Global_96938[2], true, true);
					func_256(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((is_this_model_a_car(get_entity_model(Global_96938[2])) || is_this_model_a_bike(get_entity_model(Global_96938[2]))) || is_this_model_a_bicycle(get_entity_model(Global_96938[2]))) || is_this_model_a_quadbike(get_entity_model(Global_96938[2])))
				{
					set_entity_as_mission_entity(Global_96938[2], true, true);
	...
	if (iLocal_54 == 1)
	{
		...
		if (iLocal_86 == 0)
		{
			if (get_game_timer() > iLocal_61 + 3000)
			{
				iLocal_63 = 0;
				while (iLocal_63 <= 12)
				{
					if (does_entity_exist(iLocal_32[iLocal_63]))
					{
						if (!is_ped_injured(iLocal_32[iLocal_63]))
						{
							if (func_2(player_ped_id(), iLocal_32[iLocal_63], 1) < 40f)
							{
								if (can_ped_see_hated_ped(iLocal_32[iLocal_63], player_ped_id()))
								{
									...
									if (iLocal_114 == 0)
									{
										if (!is_ped_in_any_vehicle(player_ped_id(), false) && !func_253(0))
										{
											if (func_252(player_ped_id()) != joaat("weapon_unarmed"))
											{
									...
									else if (!is_ped_in_any_vehicle(player_ped_id(), false) && !func_253(0))
									{
										if (func_252(player_ped_id()) != joaat("weapon_unarmed"))
										{
											if (get_game_timer() > iLocal_73 + 3000)
											{
												start_alarm("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", false);
												set_ambient_zone_state("AZ_AFB_ALARM_SPEECH", true, true);
												iLocal_86 = 1;
		...
		if (does_entity_exist(iLocal_34))
		{
			if (is_vehicle_driveable(iLocal_34, false))
			{
				if (func_2(player_ped_id(), iLocal_34, 1) < 30f)
				{
					iLocal_87 = 1;
				}
				if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
...
{
	clear_bit(&Global_96296, iParam0);
}
	...
	if (does_entity_exist(Global_103950.f_4))
	{
		if (is_vehicle_driveable(Global_103950.f_4, false))
		{
			if (func_265(24) != Global_103950.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_262(get_entity_coords(Global_103950.f_4, true), iParam3, &Var0, &uVar1))
					{
						Param0 = { Var0 };
						fParam1 = uVar1;
					}
...
void func_257(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
void func_259(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_73(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_262(struct<3> Param0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_263(struct<3> Param0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_266()
{
	if (iLocal_54 == 0)
	{
		...
		func_270(4, 0);
		func_270(12, 0);
		add_relationship_group("MarineGroupHash", &iLocal_44);
		set_relationship_between_groups(5, iLocal_44, joaat("player"));
		set_relationship_between_groups(5, joaat("army"), joaat("player"));
		set_relationship_between_groups(1, iLocal_44, joaat("army"));
		set_relationship_between_groups(1, joaat("army"), iLocal_44);
		set_relationship_between_groups(1, joaat("COP"), iLocal_44);
		set_relationship_between_groups(1, iLocal_44, joaat("COP"));
		set_relationship_between_groups(1, joaat("COP"), joaat("army"));
		set_relationship_between_groups(1, joaat("army"), joaat("COP"));
		if (func_283())
		{
			if (Global_94618 == 1)
			{
...
void func_267()
{
	...
	set_entity_coords(player_ped_id(), 1747.04f, 3267.456f, 40.246f, true, false, false, true);
	set_entity_heading(player_ped_id(), 229.0887f);
	if (does_entity_exist(iLocal_34))
	{
		delete_vehicle(&iLocal_34);
	}
	if (!does_entity_exist(iLocal_34))
	{
		...
		iLocal_34 = create_vehicle(joaat("cargobob"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, true, true, false);
		set_vehicle_door_shut(iLocal_34, 0, true);
		set_vehicle_door_shut(iLocal_34, 1, true);
		set_vehicle_doors_locked(iLocal_34, 2);
		set_vehicle_strong(iLocal_34, true);
		freeze_entity_position(iLocal_34, true);
		set_vehicle_engine_can_degrade(iLocal_34, false);
...
{
	block_dispatch_service_resource_creation(iParam0, !bParam1);
	enable_dispatch_service(iParam0, bParam1);
}
	...
	if (does_entity_exist(iLocal_34))
	{
		if (is_vehicle_driveable(iLocal_34, false))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_34, false))
				{
					if (is_ped_sitting_in_vehicle(player_ped_id(), iLocal_34))
					{
						if (func_273(player_ped_id(), iLocal_34) == -1)
						{
...
void func_274()
{
	if (!is_ped_injured(player_ped_id()))
	{
		...
		{
			if (func_247(get_entity_coords(player_ped_id(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (get_player_wanted_level(player_id()) != 0 && get_distance_between_coords(get_entity_coords(player_ped_id(), true), Local_118, true) > 1000f)
			{
				set_player_wanted_level(player_id(), 0, false);
				set_player_wanted_level_now(player_id(), false);
			}
...
void func_276()
{
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (does_entity_exist(iLocal_32[iLocal_64]))
			{
				if (!is_ped_injured(iLocal_32[iLocal_64]))
				{
					if (can_ped_see_hated_ped(iLocal_32[iLocal_64], player_ped_id()))
					{
						if (func_2(iLocal_32[iLocal_64], player_ped_id(), 1) < 40f)
						{
						...
						if (func_2(iLocal_32[iLocal_64], player_ped_id(), 1) < 25f)
						{
							if (func_252(player_ped_id()) != joaat("weapon_unarmed"))
							{
	...
	if (iLocal_85 == 0)
	{
		...
		while (iLocal_71 <= 1)
		{
			if (does_entity_exist(iLocal_32[iLocal_71]))
			{
				if (!is_ped_injured(iLocal_32[iLocal_71]))
				{
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_137())
						{
							if (!is_message_being_displayed() || !is_subtitle_preference_switched_on())
							{
								if (func_2(player_ped_id(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (can_ped_see_hated_ped(iLocal_32[iLocal_71], player_ped_id()))
									{
										if (!is_ped_in_any_vehicle(player_ped_id(), false) && !func_253(0))
										{
											if (func_252(player_ped_id()) != joaat("weapon_unarmed"))
											{
												if (does_entity_exist(iLocal_32[0]))
												{
													if (!is_ped_injured(iLocal_32[0]))
													{
														if (func_2(player_ped_id(), iLocal_32[0], 1) < 30f)
														{
												...
												if (does_entity_exist(iLocal_32[1]))
												{
													if (!is_ped_injured(iLocal_32[1]))
													{
														if (func_2(player_ped_id(), iLocal_32[1], 1) < 30f)
														{
							...
							if (!is_message_being_displayed() || !is_subtitle_preference_switched_on())
							{
								if (func_2(player_ped_id(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (can_ped_see_hated_ped(iLocal_32[iLocal_71], player_ped_id()))
									{
										if (!is_ped_in_any_vehicle(player_ped_id(), false))
										{
											if (func_252(player_ped_id()) == joaat("weapon_unarmed") || func_253(0))
											{
												if (does_entity_exist(iLocal_32[0]))
												{
													if (!is_ped_injured(iLocal_32[0]))
					...
					if (iLocal_99 == 1 || iLocal_100 == 1)
					{
						if (iLocal_98 == 0 && iLocal_85 == 0)
						{
							if (iLocal_117 == 0)
							{
								if (get_game_timer() > iLocal_65 + 8000)
								{
									if (!func_137())
									{
										if (!is_message_being_displayed() || !is_subtitle_preference_switched_on())
							...
							if (get_game_timer() > iLocal_66 + 8000)
							{
								if (!func_137())
								{
									if (!is_message_being_displayed() || !is_subtitle_preference_switched_on())
	...
	if (get_game_timer() > iLocal_56 + 12000)
	{
		if (iLocal_85 == 1 || iLocal_98 == 1)
		{
			if (!is_message_being_displayed() || !is_subtitle_preference_switched_on())
			{
				if (!func_137())
				{
					if (func_280())
					{
						iLocal_60 = get_random_int_in_range(0, 6);
						if (iLocal_60 == 0)
						{
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_278(iParam2), 1);
}
...
int func_279()
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		get_closest_ped(get_entity_coords(player_ped_id(), true), 30f, false, true, &iVar0, false, true, -1);
	}
	iLocal_58 = 0;
	while (iLocal_58 <= 9)
	{
		if (does_entity_exist(iLocal_32[iLocal_58]))
		{
			if (!is_ped_injured(iLocal_32[iLocal_58]))
			{
...
int func_280()
{
	...
	while (iLocal_59 <= 9)
	{
		if (does_entity_exist(iLocal_32[iLocal_59]))
		{
			if (!is_ped_injured(iLocal_32[iLocal_59]))
			{
				if (func_2(player_ped_id(), iLocal_32[iLocal_59], 1) < 25f)
				{
					return 1;
				}
			}
...
{
	func_285(73);
	request_additional_text("DOCKP2B", 0);
	...
	set_all_vehicle_generators_active_in_area(-2024.2f, 2968f, 30.2f, -2004f, 2921.5f, 37.6f, false, true);
	set_all_vehicle_generators_active_in_area(-2133.3f, 2993.7f, 41.1f, -2152.7f, 3039.4f, 31.6f, false, true);
	set_all_vehicle_generators_active_in_area(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, false, true);
	iLocal_50 = add_scenario_blocking_area(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, false, true, true, true);
	iLocal_52 = add_scenario_blocking_area(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, false, true, true, true);
	clear_area(-1876.8f, 2806.1f, 32.3f, 8f, true, false, false, false);
	clear_area(-1857.7f, 2797.9f, 32.4f, 8f, true, false, false, false);
	set_audio_flag("WantedMusicOnMission", true);
	set_vehicle_model_is_suppressed(joaat("buzzard"), true);
	set_all_vehicle_generators_active_in_area(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, false, true);
	remove_vehicles_from_generators_in_area(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 0);
	set_all_vehicle_generators_active_in_area(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, false, true);
...
void func_286()
{
	...
	set_police_radar_blips(true);
	set_all_vehicle_generators_active_in_area(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, true, true);
	set_all_vehicle_generators_active_in_area(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, true, true);
	_0x0A436B8643716D14();
	remove_scenario_blocking_area(iLocal_50, false);
	remove_scenario_blocking_area(iLocal_51, false);
	remove_scenario_blocking_area(iLocal_52, false);
	func_270(1, 1);
	func_270(2, 1);
	func_270(7, 1);
	func_270(8, 1);
	...
	remove_relationship_group(iLocal_44);
