...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("ambient_mrsphilips")) > 1)
	{
	...
	while (true)
	{
		...
		iVar0 = func_172();
		fVar1 = (_replay_free_cam_get_max_range() + 5f);
		if (vdist2(get_entity_coords(player_ped_id(), false), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_39(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_107(int iParam0)
{
	...
	if (is_xbox360_version() || func_109())
	{
		uVar0 = iParam0;
		network_set_rich_presence(9, &uVar0, 1, 1);
	}
	else if (is_ps3_version() || func_108())
	{
...
void func_110(char* sParam0, int iParam1, int iParam2)
{
	...
	playstats_mission_started(sParam0, iParam1, iParam2, func_111(0));
}
...
int func_144()
{
	return func_139(get_this_script_name(), 0);
}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_158()) || Global_31962) || func_157()) || func_156(8, -1)) || func_154()) || func_94()) || func_155()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_158()) || Global_112433) || Global_31962) || func_157()) || func_156(8, -1)) || func_94()) || func_155()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || get_player_wanted_level(player_id()) > 0) || func_156(8, -1)) || func_153()) || func_152()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_158()) || func_155()) || Global_112433) || Global_31962) || func_157()) || Global_44238) || func_156(8, -1)) || func_154()) || func_152()) || func_153()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_159()
{
	...
	switch (iLocal_80)
	{
		...
		case 1:
			if (!func_164(25) && !is_player_switch_in_progress())
			{
