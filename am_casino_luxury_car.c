...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_303();
		switch (func_302(participant_id()))
		{
			case 0:
...
int func_8(int iParam0)
{
	...
	{
		return !func_9(net_to_veh(iParam0));
	}
	return 0;
}
...
int func_23()
{
	...
	if (!func_306(0))
	{
		if (func_113(func_252(player_id()), &Local_89, &(Local_89.f_3)))
		{
			func_112(0);
		}
	}
	...
	{
		clear_area(Local_89, 5f, true, false, false, false);
		if (func_107(&(Local_83.f_6), func_111(), Local_89, Local_89.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			...
			set_model_as_no_longer_needed(func_111());
			return 1;
		}
	}
	return 0;
...
void func_24(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam0, false))
	{
		if ((network_is_game_in_progress() && network_has_control_of_entity(iParam0)) || !network_is_game_in_progress())
		{
			...
			if (func_80(get_entity_model(iParam0)))
			{
				if (uParam1->f_9[44] == 2)
				{
			...
			if ((!func_34(4) && !bParam4) && !network_is_activity_session())
			{
				func_28(iParam0);
			}
			if (func_27(iVar0))
			...
			if (func_26(get_entity_model(iParam0)))
			{
				switch (uParam1->f_9[5])
				{
					case 1:
			...
			switch (uParam1->f_94)
			{
				...
				case 2:
					...
					{
						if (func_25(uParam1->f_81) && network_is_gamer_in_my_session(&(uParam1->f_81)))
						{
...
void func_29(struct<3> Param0)
{
	...
	_trigger_script_event_2(1, &Var0, 5, func_30(1, 1));
}
...
bool func_47(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, int iParam7, int iParam8)
{
...
int func_51(int iParam0)
{
	if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam0, false))
	{
		if (does_vehicle_have_crew_emblem(iParam0, 0) || func_52(iParam0))
		{
			return 1;
		}
	}
...
int func_53(int iParam0, var* uParam1)
{
	...
	if (((((((!(does_entity_exist(iParam0) && !is_entity_dead(iParam0, false)) || !network_has_control_of_entity(iParam0)) || !network_check_user_content_privileges(0, -1, true)) || !((network_is_handle_valid(uParam1, 13) && network_clan_service_is_valid()) && network_clan_player_is_active(uParam1))) || iVar0 == func_104()) || !func_326(iVar0, 0, 0)) || !bVar1) || func_54(iParam0))
	{
		return 0;
	}
	return 1;
...
{
	return func_61(player_id(), bParam0);
}
...
int func_75(int iParam0, int iParam1, int iParam2)
{
	...
	if ((network_is_game_in_progress() && func_76()) && Global_1576214)
	{
...
void func_81(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_101(iVar0 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_101(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_101(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_101(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_101(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_101(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_101(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_101(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_82() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
int func_88(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_92(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_91(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_91(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_90(iParam0);
	if (func_89(*iParam0))
	{
...
int func_107(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
...
void func_108(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	if (func_109(player_id(), Param0, iParam2) > -1)
	{
...
int func_109(int iParam0, struct<3> Param1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_112(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	set_bit(&(uLocal_87[iVar0]), iVar1);
}

int func_113(struct<3> Param0, var uParam1, var uParam2)
{
	struct<31> Var0;
...
int func_114(struct<3> Param0, struct<3> Param1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (func_247() && !Global_2667225.f_680 == get_frame_count())
	{
	...
	if (!get_id_of_this_thread() == Global_2667225.f_675)
	{
		if (!Global_2667225.f_676 == 0)
		{
			if (get_time_difference(get_network_time(), Global_2667225.f_679) < func_244(0))
			{
				return 0;
			}
			else
	...
	else
	{
		...
		if (!Global_2667225.f_676 == 0)
		{
			if (get_time_difference(get_network_time(), Global_2667225.f_679) > func_244(1))
			{
				Global_2667225.f_676 = 0;
			}
		}
	...
	switch (Global_2667225.f_676)
	{
		case 2:
			if (are_nodes_loaded_for_area((Param0.f_0 - 100f), (Param0.f_1 - 100f), (Param0.f_0 + 100f), (Param0.f_1 + 100f)))
			{
				...
				if (((uParam6->f_3 && func_196(Param0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam6->f_7) && !func_194(Param0, *uParam5, iParam2, player_id(), 0))
				{
					Global_2667225.f_683 = { Param0 };
				...
				if (get_time_difference(get_network_time(), Global_2667225.f_700) < 10000)
				{
					if (network_entity_area_does_exist(Global_2667225.f_699))
					{
						if (network_entity_area_have_all_replied(Global_2667225.f_699))
						{
							...
							{
								if (func_133(Global_2667225.f_683, Global_2667225.f_686, iParam2, player_id(), 0) || func_116(Global_2667225.f_683, Global_2667225.f_686, iParam2, 1, 0, 0, 0, 1, 0))
								{
									func_135(Global_2667225.f_683, 0);
									func_134(-1);
								}
...
int func_116(struct<3> Param0, float fParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam7 == 1 && player_id() != iVar1) || iParam7 == 0)
		{
			if (func_326(iVar1, bParam3, bParam4))
			{
				...
				{
					if (!bParam6 || (!is_ped_injured(get_player_ped(iVar1)) && func_132(iVar1)))
					{
						if ((!bParam5 || (bParam5 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							if (((get_player_team(player_id()) == -1 && iParam8) && bParam5) && func_127(iVar1))
							{
							}
...
int func_117(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, float fParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	if (vdist(Param0, Param1) < func_125(iParam3, 1008981770))
	{
...
void func_118(struct<3> Param0, float fParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_126(struct<3> Param0, float fParam1, int iParam2, struct<3> Param3, float fParam4, int iParam5, int iParam6)
{
...
int func_133(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_136(struct<3> Param0, float fParam1)
{
	int iVar0;
...
int func_137(struct<3> Param0, float fParam1, int iParam2, bool bParam3, float fParam4)
{
	struct<3> Var0;
	struct<3> Var1;
	var uVar2;
...
void func_138(struct<3> Param0, var uParam1, int iParam2, var uParam3)
{
	struct<8> Var0;
	...
	*uParam3 = func_139(&Param0, &uParam1, &iParam2);
	...
	Var0.f_6 = iParam2;
	Var0.f_7 = *uParam3;
	_trigger_script_event_2(1, &Var0, 8, func_30(1, 1));
}
														...
														if (func_160(Var1, uParam2))
														{
															if ((uParam2->f_48 && !func_180(&Var1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (vmag(Var1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_159(Var1, fVar2, uParam2->f_34, player_id(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
...
int func_145(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	bool bVar2;
		...
		if (!iParam2 == iVar0 || iParam3 == 1)
		{
			...
			if (!bVar2)
			{
				if (func_326(iVar1, 0, 1) && func_326(iParam2, 0, 1))
				{
					...
					else if (vdist(func_252(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
				...
				{
					if (vdist(func_252(iVar1), Param0) < 1f)
					{
						return 1;
					}
				}
...
void func_146(int iParam0, struct<3> Param1, int iParam2, var* uParam3, float* fParam4, var uParam5, bool bParam6, int iParam7, int iParam8, float fParam9, float fParam10, bool bParam11)
{
	int iVar0;
...
void func_149(struct<3> Param0, float fParam1, int iParam2)
{
	struct<3> Var0;
	var uVar1;
...
int func_150(struct<3> Param0, float fParam1, float fParam2)
{
	int iVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (func_326(iParam0, 0, 1))
	{
		if (!func_156(iParam0))
		{
			if (_network_is_player_equal_to_index(player_id(), iParam0))
			{
				...
				{
					if (func_153(player_id(), 1, 0))
					{
						if (!func_152(get_player_team(iParam0), get_player_team(player_id()), 0))
						{
							return 1;
						}
					}
...
int func_161(struct<3> Param0, struct<3> Param1, struct<3> Param2, bool bParam3, bool bParam4)
{
...
bool func_163(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam3 && bParam4)
	{
		Param0.f_2 = 0f;
...
int func_164(struct<3> Param0, float fParam1)
{
	int iVar0;
	...
	if (func_153(player_id(), 1, 0))
	{
		...
		if (Global_1058069.f_268 > 0)
		{
			...
			while (iVar0 < Global_1058069.f_268)
			{
				...
				{
					if (func_117(Param0, get_entity_coords(Global_1058069.f_233[iVar0], true), get_entity_heading(Global_1058069.f_233[iVar0]), get_entity_model(Global_1058069.f_233[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_1058069.f_266 > 0)
		{
			...
			while (iVar0 < Global_1058069.f_266)
			{
				...
				{
					if (func_117(Param0, get_entity_coords(Global_1058069.f_119[iVar0], true), get_entity_heading(Global_1058069.f_119[iVar0]), get_entity_model(Global_1058069.f_119[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
Vector3 func_165(struct<3> Param0, float* fParam1, int iParam2, bool bParam3, struct<3> Param4, bool bParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11, var uParam12)
{
	struct<3> Var0;
	var uVar1;
	var uVar2;
	...
	if (uVar2 & 1024 == 0 && !bParam6)
	{
		...
		if (bParam10)
		{
			...
			if (is_this_model_a_heli(iParam7) && func_167(Param0))
			{
				return 0f, 0f, 0f;
			}
		}
...
float func_169(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
bool func_171(struct<3> Param0, var uParam1)
{
...
int func_174(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_175(struct<3> Param0, var uParam1, float fParam2, bool bParam3, bool bParam4)
{
	switch (uParam1->f_10)
	{
		case 0:
...
void func_178(var uParam0, struct<3> Param1, float fParam2, float fParam3, bool bParam4, float fParam5)
{
	struct<3> Var0;
	struct<3> Var1;
	...
	else
	{
		...
		if (fParam5 == 0f)
		{
			func_124(&Var0, 0f, 0f, get_random_float_in_range(0f, 360f));
		}
		else
		{
...
Vector3 func_181(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, int iParam4, float fParam5, bool bParam6)
{
	int iVar0;
	struct<3> Var1;
...
void func_182(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, float fParam4, bool bParam5)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
Vector3 func_183(struct<3> Param0, struct<3> Param1)
{
...
void func_184(var uParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, float fParam5, bool bParam6)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_185(struct<3> Param0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	bool bVar1;
			...
			if (iVar2 > -1 && iVar2 < 101)
			{
				...
				if (vmag(Var3) > 0f)
				{
					if ((uParam2->f_57 && vdist(Var3, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_159(Var3, fVar4, uParam2->f_34, player_id(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
int func_194(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_195(struct<3> Param0, int iParam1, struct<3> Param2, int iParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_196(struct<3> Param0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16)
{
...
int func_197(struct<3> Param0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_326(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_198(player_id()), Param0, true) <= (fVar2 + fParam1))
				{
				...
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != player_id()))
				{
					if ((func_132(iVar1) || !bParam8) && !Global_2689235[iVar1 /*453*/].f_267)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (get_distance_between_coords(func_198(iVar1), Param0, true) <= (fVar2 + fParam1))
								{
...
int func_201(struct<3> Param0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && player_id() != iVar1) || iParam6 == 0)
		{
			if (func_326(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!is_ped_injured(get_player_ped(iVar1)) && func_132(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							if (((get_player_team(player_id()) == -1 && uParam7) && bParam4) && func_127(iVar1))
							{
							}
							else if (does_entity_exist(get_player_ped(iVar1)))
							{
								if (get_distance_between_coords(func_252(iVar1), Param0, true) < fParam1)
								{
									return 1;
								}
							}
...
int func_203(struct<3> Param0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_204(int iParam0)
{
	...
	if (func_213(player_id(), 0) || (func_210(player_id()) && func_71(func_209(player_id())) == 12))
	{
		return 1;
	}
	if (func_208(player_id()) || (func_210(player_id()) && func_71(func_209(player_id())) == 8))
	{
		return 1;
	}
	if (func_207(player_id()) || (func_210(player_id()) && func_71(func_209(player_id())) == 5))
	{
		return 1;
	}
	if (func_206(player_id()) || (func_210(player_id()) && func_71(func_209(player_id())) == 10))
	{
		return 1;
	}
	if (func_205(player_id()) || (func_210(player_id()) && func_71(func_209(player_id())) == 6))
	{
		return 1;
	}
	return 0;
...
void func_216(struct<3> Param0, int iParam1)
{
	int iVar0;
	int iVar1;
	int iVar2[3];
	...
	if (!func_234())
	{
		...
		if (iVar1 > -1)
		{
			...
			switch (iVar1)
			{
				...
				case 30:
					if (func_229(iParam1))
					{
						func_230(Global_1853348[player_id() /*834*/].f_267.f_32);
					}
					break;
		...
		else if (func_226(Param0, &iVar2, &iVar3) || (func_203(Param0, &(iVar2[0])) && (is_this_model_a_plane(iParam1) || is_this_model_a_heli(iParam1))))
		{
			func_245();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				{
					if (((func_224(player_ped_id()) || func_223(player_ped_id())) && is_this_model_a_plane(iParam1)) || is_this_model_a_heli(iParam1))
					{
						if (func_222(iParam1))
						{
...
void func_218(struct<3> Param0, float fParam1, int iParam2, bool bParam3)
{
	struct<2> Var0;
	struct<2> Var1;
	float fVar2;
...
int func_226(struct<2> Param0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_232(struct<3> Param0, float fParam1)
{
...
int func_235(struct<2> Param0, var uParam1, bool bParam2, float fParam3)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_240(struct<3> Param0, float fParam1)
{
	int iVar0;
...
int func_241(struct<3> Param0, float fParam1)
{
	int iVar0;
...
int func_247()
{
	if (!Global_2667225.f_606 == 0 && get_time_difference(get_network_time(), Global_2667225.f_611) < func_244(0))
	{
		return 1;
	}
	return 0;
...
int func_248()
{
	...
	if (!func_250(player_id()) && !func_249(0))
	{
		return 0;
	}
	return 1;
...
void func_253(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	set_bit(&(Local_83.f_2[iVar0]), iVar1);
}
...
void func_255()
{
	...
	if (func_257(participant_id()) != 3 && func_20() == 3)
	{
		func_256(3);
	}
	switch (func_257(participant_id()))
	{
		case 0:
			if (func_20() > 0)
			{
...
{
	Local_85[participant_id_to_int() /*4*/].f_1 = iParam0;
}
...
{
	set_bit(&(Global_1892703[player_id() /*599*/].f_10.f_6), iParam0);
}
...
{
	Global_1892703[player_id() /*599*/].f_10.f_303 = iParam0;
}

int func_267()
{
	return Global_1892703[player_id() /*599*/].f_10.f_303;
}
...
void func_271()
{
	...
	if (!is_ped_injured(player_ped_id()) && func_277(player_ped_id(), func_16(), 120f, 1))
	{
		if (!func_265(participant_id(), 1))
		{
			func_276(1);
	...
	else if (func_265(participant_id(), 1))
	{
		func_275(1);
	}
	if (!func_265(participant_id(), 0) && func_272())
	{
		func_276(0);
	}
}
...
int func_272()
{
	if (func_269())
	{
		if (!func_277(player_ped_id(), func_16(), 1000f, 1))
		{
			return 1;
		}
		if (func_274(player_id(), 1, 1))
		{
			return 1;
		}
	...
	else if (!network_is_player_a_participant(func_17()))
	{
		return 1;
	}
	return 0;
...
void func_275(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	clear_bit(&(Local_85[participant_id_to_int() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_276(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	set_bit(&(Local_85[participant_id_to_int() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_279()
{
	...
	if (iVar0 != func_281())
	{
		switch (func_281())
		{
			...
			case 0:
				if ((func_269() && !func_265(participant_id(), 0)) && iVar0 == 2)
				{
					func_276(0);
				}
				break;
...
{
	return func_285(player_id(), bParam0);
}
...
void func_286()
{
	...
	switch (func_19())
	{
		...
		case 2:
			if (((((!func_12(3) && !func_265(participant_id(), 2)) && func_7()) && !network_is_entity_fading(func_16())) && func_289(func_10())) && func_288(func_16()) == 0)
			{
				set_vehicle_doors_locked_for_all_players(func_16(), true);
				network_fade_out_entity(func_16(), false, true);
				func_276(2);
			}
			break;
		
		case 3:
			if (((!func_12(4) && !func_265(participant_id(), 3)) && func_7()) && !is_entity_visible(func_16()))
			{
				func_276(3);
			}
			break;
		...
		case 4:
			if (((!func_12(5) && !func_265(participant_id(), 4)) && func_7()) && func_289(func_10()))
			{
				iVar0 = func_10();
				func_287(&iVar0);
				func_276(4);
...
void func_291()
{
	if (func_297())
	{
		...
		{
			iLocal_90 = add_blip_for_entity(func_16());
			set_blip_sprite(iLocal_90, func_296());
			func_293(&iLocal_90, func_295());
			set_blip_name_from_text_file(iLocal_90, func_292());
		}
	}
	else if (does_blip_exist(iLocal_90))
	{
...
int func_297()
{
	...
	if (is_ped_in_vehicle(player_ped_id(), func_16(), false))
	{
		return 0;
	}
	if (!func_7())
...
{
	Local_85[participant_id_to_int() /*4*/] = iParam0;
}
...
void func_303()
{
	...
	while (iVar0 < network_get_max_num_participants())
	{
		if (network_is_participant_active(iVar0))
		{
			...
			iVar1 = network_get_player_index(iLocal_86[iVar0]);
...
void func_304(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	clear_bit(&(Local_83.f_2[iVar0]), iVar1);
}
...
int func_307()
{
	...
	if (func_308() != 0)
	{
		if (_get_number_of_references_of_script_with_name_hash(func_308()) == 0)
		{
			return 1;
		}
	}
...
{
	func_260(9);
	Global_1892703[player_id() /*599*/].f_10.f_304 = 0;
}
...
int func_322(struct<21> Param0)
{
	...
	func_323(0, -1, 0);
	network_register_host_broadcast_variables(&Local_83, 8, 0);
	network_register_player_broadcast_variables(&Local_85, 33, 0);
