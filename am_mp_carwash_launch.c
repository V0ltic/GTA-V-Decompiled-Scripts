...
void __EntryFunction__()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("am_mp_carwash_launch")) > 1)
	{
	...
	if (Global_2883694)
	{
		if (_get_number_of_references_of_script_with_name_hash(131838674) == 0)
		{
	...
	while (iVar4 == 0)
	{
		if ((((((func_9(player_id(), 1, 0) || func_8()) || !func_7(player_id())) || func_6()) || func_5(player_id())) || func_4(player_id())) || func_2(player_id()))
		{
			iVar4 = 0;
		}
		else
