...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!func_220(&Var0, 1))
		{
			if (Var0.f_0 == 30)
			{
				if (func_219(player_ped_id(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
			...
			if (iLocal_225 == 0)
			{
				if (can_request_assets_for_cutscene_entity())
				{
					if (func_207(Var0.f_28[1]))
					{
						...
						set_cutscene_ped_component_variation_from_ped("Cop_standing_idle", Var0.f_28[1], 0);
					}
					if (func_207(Var0.f_28[2]))
					{
						func_309("Josh 4: Trying to set Cop 2 component variation");
						set_cutscene_ped_component_variation_from_ped("Cop_with_notepad", Var0.f_28[2], 0);
					}
					iLocal_225 = 1;
				}
			}
	...
	if (*uParam0 == 30)
	{
		if (func_207(uParam0->f_28[0]))
		{
			if (bLocal_223)
			{
				if (!is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_175(player_ped_id(), uParam0->f_28[0], 1) <= 15f)
					{
						func_309("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_175(player_ped_id(), uParam0->f_28[0], 1) <= 10f)
				{
...
int func_176(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_219(player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
			...
			else if ((!func_177(player_ped_id(), -828834893) && func_207(get_vehicle_ped_is_in(player_ped_id(), false))) && func_150(get_vehicle_ped_is_in(player_ped_id(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
...
int func_178(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_219(player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
			...
			else if ((!func_177(player_ped_id(), -828834893) && func_207(get_vehicle_ped_is_in(player_ped_id(), false))) && func_150(get_vehicle_ped_is_in(player_ped_id(), false), 4f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					if (func_207(get_vehicle_ped_is_in(player_ped_id(), false)))
					{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_193()) || Global_31962) || func_192()) || func_191(8, -1)) || func_189()) || func_93()) || func_190()) || func_188()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_193()) || Global_112433) || Global_31962) || func_192()) || func_191(8, -1)) || func_93()) || func_190()) || func_188()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_193() || get_player_wanted_level(player_id()) > 0) || func_191(8, -1)) || func_188()) || func_187()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_194()
{
	...
	{
		case 0:
			if ((get_game_timer() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
		...
		case 1:
			if (func_219(player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_219(player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_145();
				bLocal_223 = true;
				iLocal_56 = 0;
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_207(player_ped_id()) && func_207(iParam0->f_28[0])) && !func_147()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_219(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_210(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_219(player_ped_id(), Param2, 1) <= 100f)
				{
					func_213(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_219(player_ped_id(), Param2, 1) > 120f)
				{
					func_215(iParam0);
				}
			}
...
void func_221(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_207(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_223(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_222(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_223(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_222(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
			...
			if (does_entity_exist(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_228(player_ped_id(), uParam0->f_35[iVar0]))
							{
...
int func_231(int iParam0, float fParam1)
{
	...
	{
		if (func_242(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_233(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_239(get_entity_coords(iParam1, true) - get_entity_coords(iParam0, true)) };
	...
	{
		Var1 = { func_239(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_246(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_239(Param1 - get_entity_coords(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	func_262(iParam0);
...
void func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_264(iParam0);
...
int func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
...
int func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_273(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_271(&iVar0) || !has_anim_dict_loaded("rcmjosh3"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_275(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_271(&iVar0) || !has_anim_dict_loaded("rcmjosh2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_207(uParam0->f_28[0]))
			{
				...
				iLocal_54 = create_synchronized_scene(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				set_synchronized_scene_looped(iLocal_54, true);
				task_synchronized_scene(uParam0->f_28[0], iLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1000f, 0);
			}
...
int func_288(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
...
int func_289(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_290(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_291(int iParam0, bool bParam1)
{
	...
	{
		case 30:
			remove_forced_object(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"));
			break;
	}
	if (bParam1)
	{
