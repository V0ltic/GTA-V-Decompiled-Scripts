...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_175())
		{
			...
			{
				fLocal_31 = vdist2(get_entity_coords(player_ped_id(), true), Local_32);
			}
			func_173(&iVar1);
			func_31(&iVar2);
			if (iLocal_39 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_28(0) == 0 && (get_game_timer() - iLocal_59) > 2000)
					{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_11(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_15(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_31(int iParam0)
{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			if (has_model_loaded(joaat("dune")))
			{
				clear_area_of_vehicles(Local_45, 4f, false, false, false, false, false, false, 0);
				if (does_entity_exist(iLocal_44))
				{
					delete_vehicle(&iLocal_44);
				}
				iLocal_44 = create_vehicle(func_164(), Local_45, fLocal_46, true, true, false);
				set_vehicle_radio_enabled(iLocal_44, false);
				set_model_as_no_longer_needed(func_164());
				if (does_entity_exist(iLocal_44))
				{
					if (does_extra_exist(iLocal_44, 1))
					{
						set_vehicle_extra(iLocal_44, 1, true);
					}
					if (does_extra_exist(iLocal_44, 2))
					{
						set_vehicle_extra(iLocal_44, 2, false);
					}
					if (does_extra_exist(iLocal_44, 3))
					{
						set_vehicle_extra(iLocal_44, 3, false);
					}
					set_vehicle_colours(iLocal_44, 0, 0);
				}
				iLocal_43 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_47)
				{
					if (is_ped_in_any_vehicle(iLocal_28, false))
					{
						iVar1 = get_vehicle_ped_is_using(iLocal_28);
						if (iVar1 == iLocal_44)
						{
							iLocal_47 = 1;
							set_vehicle_as_no_longer_needed(&iLocal_44);
							iLocal_43 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				if (!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_44, false))
				{
					set_ped_into_vehicle(player_ped_id(), iLocal_44, -1);
				}
			}
			if (!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_44, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_44, true))
				{
					func_162();
				}
			}
			if (!is_entity_dead(iLocal_44, false) && !is_entity_dead(player_ped_id(), false))
			{
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					...
					if (iVar2 == iLocal_44)
					{
						if (vdist2(Local_45, get_entity_coords(iLocal_28, true)) < 100f)
						{
							request_script("Traffick_Ground");
							if (does_entity_exist(iLocal_29) && !is_entity_dead(iLocal_29, false))
							{
								...
								{
									set_players_last_vehicle(iLocal_29);
								}
							}
							iLocal_43 = 6;
						}
		...
		case 6:
			if (has_script_loaded("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_30 = start_new_script_with_args("Traffick_Ground", &Var4, 97, 51000);
					func_81(16);
					set_script_as_no_longer_needed("Traffick_Ground");
					set_entity_as_mission_entity(iLocal_44, true, false);
					set_vehicle_as_no_longer_needed(&iLocal_44);
...
int func_53()
{
	...
	func_52(&uVar0, get_clock_seconds());
	func_51(&uVar0, get_clock_minutes());
	func_50(&uVar0, get_clock_hours());
	func_48(&uVar0, get_clock_day_of_month());
	func_49(&uVar0, get_clock_month());
...
void func_81(int iParam0)
{
	...
	if (is_xbox360_version() || func_83())
	{
		uVar0 = iParam0;
		network_set_rich_presence(8, &uVar0, 1, 1);
	}
	else if (is_ps3_version() || func_82())
	{
...
void func_87(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_22();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_104(player_ped_id());
		func_97(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_96())
		{
			func_89(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_98(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_103(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_100(Var7.f_1)) && iVar9 < 51)
			{
...
int func_109(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_132())
		{
			*uParam0 = func_115(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_115(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_131(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_116(iVar0, 0), true);
...
Vector3 func_120(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_152(iParam0)) || func_151(iParam0)) || func_150(iParam0)) || func_149(iParam0)) || !func_139(get_entity_model(iParam0)))
	{
		if (func_151(iParam0))
		{
		}
...
int func_140(int iParam0, bool bParam1)
{
	...
	{
		if ((func_83() || is_pc_version()) || func_82())
		{
		}
		else if (!func_145())
		{
...
void func_155(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)
{
	if (func_154(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_163()
{
	...
	if (!does_entity_exist(iLocal_29))
	{
		if (!is_entity_dead(player_ped_id(), false))
		{
			if (vdist2(get_entity_coords(player_ped_id(), true), Local_32) < 2500f)
			{
				iLocal_29 = get_players_last_vehicle();
				if (does_entity_exist(iLocal_29))
				{
					iVar0 = get_entity_model(iLocal_29);
					if (iVar0 == joaat("dune"))
					{
					}
				}
...
int func_166()
{
	if (func_28(9))
	{
		if (_get_number_of_references_of_script_with_name_hash(joaat("trevor2")) == 1)
		{
			if (!iLocal_36[0])
			{
				iLocal_36[0] = 1;
		...
		if (_get_number_of_references_of_script_with_name_hash(joaat("finale_heist2b")) == 1)
		{
			if (!iLocal_36[1])
			{
				iLocal_36[1] = 1;
		...
		if (_get_number_of_references_of_script_with_name_hash(joaat("traffick_air")) == 1)
		{
			if (!iLocal_36[2])
			{
				iLocal_36[2] = 1;
		...
		if (_get_number_of_references_of_script_with_name_hash(joaat("traffick_ground")) == 1)
		{
			if (!iLocal_36[3])
			{
				iLocal_36[3] = 1;
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (has_model_loaded(joaat("cuban800")))
			{
				...
				{
					clear_area_of_vehicles(Local_42, 8f, false, false, false, false, false, false, 0);
					iLocal_40 = create_vehicle(joaat("cuban800"), Local_42, 25.29f, true, true, false);
					set_model_as_no_longer_needed(joaat("cuban800"));
					set_vehicle_colour_combination(iLocal_40, 2);
		...
		case 4:
			if (does_entity_exist(iLocal_40))
			{
				if (is_entity_dead(iLocal_40, false) || is_entity_dead(player_ped_id(), false))
				{
					iLocal_39 = 9;
					return;
				}
			...
			if (func_28(9))
			{
				if (_get_number_of_references_of_script_with_name_hash(joaat("traffick_ground")) == 1)
				{
					if (!is_entity_dead(iLocal_40, false))
					{
						set_vehicle_doors_locked(iLocal_40, 2);
						return;
					}
				}
			}
			else if (_get_number_of_references_of_script_with_name_hash(joaat("traffick_ground")) == 0)
			{
				if (!is_entity_dead(iLocal_40, false))
				{
					set_vehicle_doors_locked(iLocal_40, 1);
				}
			}
			if (!bLocal_35)
			{
			...
			if (!bVar0 && !*iParam0)
			{
				if (!iLocal_41)
				{
					if (is_ped_in_any_vehicle(iLocal_28, false))
					{
						...
						{
							iLocal_41 = 1;
							set_vehicle_as_no_longer_needed(&iLocal_40);
							iLocal_39 = 9;
						}
					}
				}
			...
			if (*iParam0)
			{
				set_ped_into_vehicle(iLocal_28, iLocal_40, -1);
			}
			if (!is_entity_dead(player_ped_id(), false) && !is_entity_dead(iLocal_40, false))
			{
				if (is_ped_in_vehicle(player_ped_id(), iLocal_40, true))
				{
					func_162();
				}
			}
				...
				if (is_ped_in_any_vehicle(player_ped_id(), false))
				{
					...
					if (iVar2 == iLocal_40)
					{
						...
						if (does_entity_exist(iLocal_29) && !is_entity_dead(iLocal_29, false))
						{
							if (get_entity_model(iLocal_29) != joaat("dune") && get_entity_model(iLocal_29) != joaat("cuban800"))
							{
								if (!is_entity_in_angled_area(iLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, false, true, 0))
								{
									func_135(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 6:
			if (has_script_loaded("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					if (!*iParam0)
					{
						func_84(get_this_script_name(), 0);
					}
					iLocal_30 = start_new_script("Traffick_Air", 51000);
					func_81(15);
				...
				if (Global_100475)
				{
					*iParam0 = 1;
					if (does_entity_exist(player_ped_id()))
					{
						if (!is_ped_injured(player_ped_id()))
						{
							set_entity_coords(player_ped_id(), 2136.446f, 4791.483f, 39.9702f, true, false, false, true);
						}
					}
					request_model(joaat("cuban800"));
					request_script("Traffick_Air");
...
int func_175()
{
	...
	if (_get_number_of_references_of_script_with_name_hash(joaat("traffick_ground")) == 1 || _get_number_of_references_of_script_with_name_hash(joaat("traffick_air")) == 1)
	{
		return 1;
	}
	iLocal_28 = player_ped_id();
	if (is_entity_dead(iLocal_28, false))
	{
	}
	if (func_185())
	{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_184()) || Global_31962) || func_178()) || func_177(8, -1)) || func_176()) || func_132()) || func_183()) || func_182()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_184()) || Global_112433) || Global_31962) || func_178()) || func_177(8, -1)) || func_132()) || func_183()) || func_182()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_184() || get_player_wanted_level(player_id()) > 0) || func_177(8, -1)) || func_182()) || func_181()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_184()) || func_183()) || Global_112433) || Global_31962) || func_178()) || Global_44238) || func_177(8, -1)) || func_176()) || func_181()) || func_182()) || Global_113386.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_189()
{
	if (!iLocal_58)
	{
		iLocal_57 = add_scenario_blocking_area(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), false, true, true, true);
		iLocal_58 = 1;
	}
}
...
void func_194()
{
	...
	iLocal_34 = 0;
	remove_weapon_asset(joaat("weapon_combatpistol"));
	remove_weapon_asset(joaat("weapon_smg"));
	remove_weapon_asset(joaat("weapon_stickybomb"));
	remove_weapon_asset(joaat("weapon_assaultshotgun"));
	remove_weapon_asset(joaat("weapon_rpg"));
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (does_pickup_exist(uLocal_50[iVar0]))
		{
			remove_pickup(uLocal_50[iVar0]);
		}
		if (does_entity_exist(uLocal_49[iVar0]))
		{
			delete_object(&(uLocal_49[iVar0]));
		}
		iVar0++;
	}
}
