...
int func_171()
{
	if (func_174(2))
	{
		if (func_173(player_ped_id(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !is_ped_ragdoll(player_ped_id()))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), false))
			{
			...
			else if ((!func_172(player_ped_id(), -828834893) && func_129(get_vehicle_ped_is_in(player_ped_id(), false))) && func_151(get_vehicle_ped_is_in(player_ped_id(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), true) || func_182()) || Global_31962) || func_181()) || func_180(8, -1)) || func_178()) || func_93()) || func_179()) || func_177()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), 0)) || func_182()) || Global_112433) || Global_31962) || func_181()) || func_180(8, -1)) || func_178()) || func_93()) || func_179()) || func_177()) || Global_113386.f_7688.f_919[bVar0] == 5) || Global_43599 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || is_ped_in_combat(player_ped_id(), 0)) || func_182()) || Global_112433) || Global_31962) || func_181()) || func_180(8, -1)) || func_93()) || func_179()) || func_177()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_182() || get_player_wanted_level(player_id()) > 0) || func_180(8, -1)) || func_177()) || func_176()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), 0) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), true)) || func_182()) || func_179()) || Global_112433) || Global_31962) || func_181()) || Global_44238) || func_180(8, -1)) || func_178()) || func_176()) || func_177()) || Global_113386.f_7688.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_129(player_ped_id()) && func_129(iParam0->f_28[0])) && !func_148()) && (get_game_timer() - iParam0->f_60) > iParam6) && func_173(player_ped_id(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_193(int iParam0, char* sParam1, struct<3> Param2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_173(player_ped_id(), Param2, 1) <= 100f)
				{
					func_196(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_173(player_ped_id(), Param2, 1) > 120f)
				{
					func_198(iParam0);
				}
			}
...
void func_202(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_129(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_203(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), true), get_entity_coords(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_203(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
		...
		case 2:
			...
			if (!does_entity_exist(uParam0->f_35[0]))
			{
				...
				if (func_129(uParam0->f_35[0]))
				{
					...
					set_vehicle_model_is_suppressed(iLocal_53, true);
				}
			}
			if (bVar2)
			{
...
void func_271(int iParam0, bool bParam1)
{
	...
	func_272(sVar0);
	set_vehicle_model_is_suppressed(iLocal_53, false);
