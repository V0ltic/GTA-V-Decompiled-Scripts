...
void func_1()
{
	...
	if (iLocal_219)
	{
		...
		{
			if ((((!func_185() && !is_ped_fleeing(iLocal_53)) && !is_ped_ragdoll(iLocal_53)) && !is_ped_prone(iLocal_53)) && !is_ped_injured(iLocal_53))
			{
				if (func_184(iLocal_53, player_ped_id(), 1) <= 3f)
				{
					if ((get_game_timer() - iLocal_220) > 8000)
					{
						if (func_173(&uLocal_54, "EPS5AUD", "EP5_FOLLOW", 7, 0, 0, 0))
						{
							iLocal_220 = get_game_timer();
						}
					}
				}
			}
			if (func_184(iLocal_53, player_ped_id(), 1) > 150f)
			{
				func_172(&iLocal_53);
			}
		}
	...
	if (is_player_playing(player_id()) && func_170(0))
	{
		switch (iLocal_222)
		{
			case 0:
				if (func_191(91) && is_player_control_on(player_id()))
				{
					func_167(4, 10, 1);
					...
					iLocal_226 = (Global_113386.f_10049.f_104 + 2 % func_150(get_clock_month(), get_clock_year()));
				...
				else if (!func_191(91))
				{
					if (iLocal_50 == 0)
					{
						if (func_147())
						{
							func_146(&uLocal_54, 0, player_ped_id(), "MICHAEL", 0, 1);
			...
			case 1:
				iLocal_223 = func_159();
				iLocal_226 = (Global_113386.f_10049.f_104 + 2 % func_150(get_clock_month(), get_clock_year()));
				if ((((func_144(iLocal_223, iLocal_225) || get_clock_day_of_month() == iLocal_226) && is_player_control_on(player_id())) && get_room_key_from_entity(player_ped_id()) != get_hash_key("V_Michael_1_M_Ward")) && get_room_key_from_entity(player_ped_id()) != get_hash_key("V_Michael_1_Master"))
				{
			...
			case 2:
				if ((func_48(player_ped_id(), 12, iLocal_47) && is_player_control_on(player_id())) && !is_help_message_being_displayed())
				{
					func_47("EPSROBE_H2", -1);
					iLocal_224 = func_159();
					iLocal_225 = func_159();
					func_151(&iLocal_225, 0, 0, 1, 0, 0, 0);
					fLocal_51 = get_random_float_in_range(120000f, 240000f);
			...
			case 3:
				if (!func_48(player_ped_id(), 12, iLocal_47) && !func_46())
				{
					iLocal_222 = 2;
				}
				...
				if (iLocal_48)
				{
					if ((is_player_control_on(player_id()) && !is_help_message_being_displayed()) && !func_45(14))
					{
						...
						if (iVar1 < 10)
						{
							if (iVar1 > 1)
							{
								begin_text_command_thefeed_post("EPSROBE_01");
								add_text_component_integer(iVar1);
								end_text_command_thefeed_post_ticker(false, true);
							}
							else
							{
								begin_text_command_thefeed_post("EPSROBE_00");
								end_text_command_thefeed_post_ticker(false, true);
							}
						}
						func_148();
			...
			case 4:
				if (is_player_control_on(player_id()) && !is_help_message_being_displayed())
				{
...
void func_11()
{
	...
	{
		if (func_140(Global_113386.f_2363.f_539.f_4321) != get_entity_model(player_ped_id()))
		{
...
int func_15(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_22(1);
			func_25(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
	...
	func_16(iParam0, sParam1, bVar1, func_21(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_23(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
{
	return (shift_right(iParam0, 26) & 31 * func_39(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_41()
{
	if (((!func_44() && !is_entity_dead(player_ped_id(), false)) && !is_ped_injured(player_ped_id())) && !is_ambient_speech_playing(player_ped_id()))
	{
		if (iLocal_49 == 1)
		{
			if (is_ped_walking(player_ped_id()) || is_ped_still(player_ped_id()))
			{
				func_42(player_ped_id(), "CULT_TALK", 4);
				fLocal_51 = get_random_float_in_range(120000f, 240000f);
				iLocal_52 = get_game_timer();
				iLocal_49 = 0;
			}
		}
		else if (IntToFloat((get_game_timer() - iLocal_52)) > fLocal_51)
		{
			iLocal_49 = 1;
		}
	}
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_43(iParam2), 1);
}
...
int func_48(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78130[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_49(iParam1)) && Global_78130[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_49(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar5 = setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_49(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		setup_shop_ped_apparel_query_tu(iParam3, 10, -1, false, -1, func_49(iParam2));
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			...
			if (iVar8 > iVar7)
			{
				...
				func_72(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, does_shop_ped_apparel_have_restriction_tag(Var5.f_1, joaat("OUTFIT_ONLY"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_72(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, does_shop_ped_apparel_have_restriction_tag(Var9.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = setup_shop_ped_apparel_query_tu(iVar1, 10, -1, false, -1, func_49(iParam0));
			if (iVar11 > iVar10)
			{
...
int func_159()
{
	...
	func_158(&uVar0, get_clock_seconds());
	func_157(&uVar0, get_clock_minutes());
	func_156(&uVar0, get_clock_hours());
	func_154(&uVar0, get_clock_day_of_month());
	func_155(&uVar0, get_clock_month());
...
void func_162(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_163(end_text_command_thefeed_post_messagetext(&cVar2, &cVar2, false, 2, _get_label_text(func_164(iParam1)), 0));
		}
		else
		{
			func_163(end_text_command_thefeed_post_messagetext("CHAR_DEFAULT", "CHAR_DEFAULT", false, 2, _get_label_text(func_164(iParam1)), 0));
		}
		switch (Global_20266)
		{
			case 0:
...
void func_187()
{
	...
	if (Global_113386.f_10049.f_105 < 240)
	{
		...
		else if (!func_48(player_ped_id(), 12, iLocal_47))
		{
			Global_113386.f_10049.f_105 = 0;
			iLocal_50 = 1;
			iLocal_222 = 2;
...
int func_189()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (get_entity_model(uVar2[iVar1]) == func_190(60))
			{
				iLocal_53 = uVar2[iVar1];
				if (!is_entity_a_mission_entity(iLocal_53))
				{
					set_entity_as_mission_entity(iLocal_53, true, false);
				}
				set_ped_money(iLocal_53, 0);
...
void func_193()
{
	...
	if (Global_113386.f_10049.f_105 >= 240 || func_191(92) == 1)
	{
		...
		if (iVar0 < 16)
		{
			stat_set_int(joaat("num_epsilon_step"), 16, true);
			func_199(23, 16);
		}
		func_198(8);
		func_194(77, 0, 0);
...
void func_195()
{
	...
	{
		func_199(13, floor(Global_113386.f_10194.f_3853));
	}
	if (!datafile_is_save_pending())
	{
		if (!Global_78319)
		{
			if (func_196() == 2 == 0 && !network_is_game_in_progress())
			{
