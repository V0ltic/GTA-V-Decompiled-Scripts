...
void __EntryFunction__()
{
	...
	iLocal_134 = 100;
	iLocal_135 = 3;
	iLocal_729 = get_standard_blip_enum_id();
	iLocal_730 = get_waypoint_blip_enum_id();
	iLocal_972 = 1;
	iLocal_1153 = -1;
	fLocal_1155 = 1f;
	...
	if (has_force_cleanup_occurred(3))
	{
		...
		func_526();
		if (does_entity_exist(iLocal_1175))
		{
			set_entity_visible(iLocal_1175, true, false);
			set_entity_collision(iLocal_1175, true, false);
			set_entity_can_be_damaged(iLocal_1175, true);
		}
	...
	iLocal_1270 = add_scenario_blocking_area(Local_1257 - Vector(2f, 2f, 2f), Local_1257 + Vector(2f, 2f, 2f), false, true, true, true);
	func_521();
	iLocal_1154 = 1;
	...
	while (true)
	{
		...
		if (func_512(&uScriptParam_1875))
		{
			if (func_511())
			{
				...
				remove_scenario_blocking_area(iLocal_1270, false);
				func_531();
...
int func_21(var uParam0)
{
	...
	{
		case 0:
			if (IntToFloat(iLocal_1239) >= ((fLocal_1254 * 1f) / 2f) && !is_message_being_displayed())
			{
				func_38(&(uParam0->f_16), 1, player_ped_id(), "FRANKLIN", 0, 1);
...
void func_39(int iParam0, var uParam1, float fParam2, var uParam3, bool bParam4)
{
	...
	*uParam1 = (get_game_timer() - *iParam0);
...
void func_48()
{
	if (!iLocal_1232)
	{
		if (get_player_wanted_level(player_id()) > 0)
		{
			if (!func_51())
			{
				func_49(player_ped_id(), "SPOT_POLICE", 24);
				iLocal_1232 = 1;
			}
		}
	}
...
{
	play_ped_ambient_speech_native(iParam0, sParam1, func_50(iParam2), 1);
}
	...
	if (iLocal_972 > 4)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1267 && !is_entity_in_water(iVar0)) && !is_entity_a_mission_entity(iVar0))
					{
						iLocal_1267 = iVar0;
						set_entity_as_mission_entity(iLocal_1267, true, false);
						set_vehicle_has_been_driven_flag(iLocal_1267, false);
					}
				}
			}
		}
...
void func_53(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_974)
	{
		...
		case 1:
			...
			if (func_142(&uLocal_139, 1, 0) && is_mission_complete_ready_for_ui())
			{
...
void func_99(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_105(uParam0->f_1, 256) || (func_105(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			scaleform_movie_method_add_param_bool(func_105(uParam0->f_1, 4096));
			end_scaleform_movie_method();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_108(var uParam0, bool bParam1)
{
	...
	func_104(get_control_instructional_button(2, 215, true));
	func_103("ES_HELP");
	if (is_pc_version())
	{
		scaleform_movie_method_add_param_bool(true);
	...
	if (bParam1)
	{
		begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
		scaleform_movie_method_add_param_int(1);
		func_104(get_control_instructional_button(2, 216, true));
		func_103("ES_XPAND");
		if (is_pc_version())
		{
			scaleform_movie_method_add_param_bool(true);
...
void func_110(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_128();
		draw_rect(0.5f, (fVar1 - (func_131((2f - 0.5f)) - 0.001388889f)), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_109((fVar11 / (0.6f * func_131(25f))), 0f, 1f);
					func_128();
					draw_rect(0.5f, (fVar1 + func_131((2f * 0.5f))), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), false);
					fVar1 = (fVar1 + func_131((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_131((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_560)
			{
				case 0:
					...
					end_text_command_display_text(fVar20, (fVar1 + func_131((2f * 2f))), 0);
					break;
...
void func_122(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	set_text_justification(1);
	set_text_scale(1f, func_124(14f));
	set_text_centre(false);
	set_text_font(0);
	func_128();
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			draw_sprite("CommonMenu", func_118(7, 0), (fParam4 - 0.006f), ((fParam2 + func_131(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_114(5, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_118(5, 0), (fParam4 - 0.006f), ((fParam2 + func_131(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_114(6, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_118(6, 0), (fParam4 - 0.006f), ((fParam2 + func_131(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, false, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_123(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			set_text_scale(1f, func_124(18f));
			set_text_font(4);
			if (iParam0 < 0)
			{
...
void func_143(var uParam0)
{
	...
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(2);
	func_104(get_control_instructional_button(2, 188, true));
	func_103("ES_HELP_TU");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(1);
	func_104(get_control_instructional_button(2, 187, true));
	func_103("ES_HELP_TD");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "SET_DATA_SLOT");
	scaleform_movie_method_add_param_int(0);
	func_104(get_control_instructional_button(2, 202, true));
	func_103("ES_HELP_AB");
	end_scaleform_movie_method();
	begin_scaleform_movie_method(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	end_scaleform_movie_method();
...
void func_144(var uParam0)
{
	...
	fVar0 = 0f;
	set_text_justification(0);
	set_text_scale(1f, func_124(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_146()
{
	...
	if (!iLocal_128)
	{
		...
		else
		{
			...
			if (!is_string_null_or_empty(&(Local_720.f_18)))
			{
				if (bLocal_126)
				{
	...
	switch (iLocal_972)
	{
		...
		case 4:
			...
			if (bLocal_1208)
			{
				...
				clear_area(Local_1260, 5f, true, false, false, false);
		...
		case 7:
			...
			if (iLocal_1171 >= 2)
			{
				if (does_entity_exist(iLocal_1263))
				{
					if (func_282(iLocal_1263, player_ped_id(), 1) > 500f)
					{
						set_vehicle_as_no_longer_needed(&iLocal_1263);
					}
				}
			}
			if (!iLocal_1230)
			...
			{
				if ((func_265(uParam0, uParam1) || (is_player_targetting_entity(player_id(), *uParam1) && func_264(*uParam1, 1) < 150f)) || (is_player_free_aiming_at_entity(player_id(), *uParam1) && func_264(*uParam1, 1) < 150f))
				{
					func_263(*uParam1);
					iLocal_972 = 10;
				}
		...
		case 10:
			...
			{
				if (iLocal_1210 && !is_ped_injured(*uParam1))
				{
					func_259();
					play_pain(*uParam1, 1, 0, 0);
				}
		...
		case 11:
			...
			{
				if (!is_ped_injured(*uParam1) && iLocal_1171 == 2)
				{
					set_entity_health(*uParam1, 0, 0);
				}
				if (iLocal_1171 == 1)
				{
					if (!is_ped_injured(uParam1->f_7))
					{
						open_sequence_task(&iVar0);
						task_play_anim(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_quick_f", 8f, -8f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0f, false, false, false);
						close_sequence_task(iVar0);
						task_perform_sequence(uParam1->f_7, iVar0);
					...
					if (does_entity_exist(uParam1->f_1))
					{
						...
						{
							set_vehicle_has_been_driven_flag(uParam1->f_1, false);
						}
					}
				}
				iLocal_1234++;
		...
		case 12:
			...
			{
				play_police_report("SCRIPTED_SCANNER_REPORT_ASS_MULTI_01", 0f);
			}
			break;
	}
	return 0;
...
void func_167(var uParam0, int* iParam1)
{
	...
	*iParam1 = 0;
	if (iLocal_1171 != 1)
	{
		set_vehicle_as_no_longer_needed(&(iParam1->f_1));
		if (does_entity_exist(iLocal_1263))
		{
			set_vehicle_as_no_longer_needed(&iLocal_1263);
		}
	}
	else if (does_entity_exist(iParam1->f_1))
	{
		iLocal_1263 = iParam1->f_1;
	}
	if (does_entity_exist(iLocal_1262))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1262);
	}
	if (does_entity_exist(iLocal_1265))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1265);
	}
	if (does_entity_exist(iLocal_1264))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1264);
	}
	iLocal_1212 = 0;
	iLocal_1242 = 0;
	iLocal_132 = 0;
...
void func_178(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			remove_anim_dict((*uParam0)[iVar0]);
		}
		iVar0++;
	}
}
...
void func_183(int* iParam0, var uParam1)
{
	...
	if (uParam1->f_14 != 0)
	{
		set_model_as_no_longer_needed(uParam1->f_14);
	}
	if (does_entity_exist(*iParam0))
	{
		set_ped_as_no_longer_needed(iParam0);
	...
	{
		set_ped_as_no_longer_needed(&(iParam0->f_7));
	}
	if (does_entity_exist(iParam0->f_9))
	{
		set_ped_as_no_longer_needed(&(iParam0->f_9));
	}
}
...
void func_184(int* iParam0, var uParam1)
{
	...
	set_model_as_no_longer_needed(joaat("a_f_y_fitness_02"));
	if (does_entity_exist(*iParam0))
	{
		set_ped_as_no_longer_needed(iParam0);
	}
	...
	while (iVar0 <= 1)
	{
		if (does_entity_exist(Local_1874[iVar0 /*9*/]))
		{
			set_ped_as_no_longer_needed(&(Local_1874[iVar0 /*9*/]));
		}
		iVar0++;
	}
}
...
void func_185()
{
	...
	while (iVar0 < 4)
	{
		if (does_entity_exist(iLocal_1266[iVar0]))
		{
			set_vehicle_as_no_longer_needed(&(iLocal_1266[iVar0]));
		}
		iVar0++;
	}
}
...
void func_186()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			set_model_as_no_longer_needed(iLocal_1269[iVar0]);
		}
		iVar0++;
	}
}
...
void func_192(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_216(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
...
int func_197(char* sParam0)
{
	if (!func_198(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_218(sParam0)) || func_218("CMN_HINT"))
		{
			clear_help(true);
		}
		return 0;
...
int func_198(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_205() || func_204(Global_4718592.f_168757)) || func_203())
	{
		if (is_ped_in_any_vehicle(player_ped_id(), false))
		{
			...
			iVar1 = func_202(player_ped_id(), 0);
			if (((is_turret_seat(iVar0, iVar1) || (get_entity_model(iVar0) == joaat("apc") && iVar1 != -1)) || (get_entity_model(iVar0) == joaat("akula") && iVar1 != -1)) || (((get_entity_model(iVar0) == joaat("riot2") && iVar1 == 0) && func_201(iVar0, 10)) && get_vehicle_mod(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_199(int iParam0)
{
	if (iParam0 != func_28())
	{
		...
		else if ((Global_1575058 && iParam0 == player_id()) && func_200(iParam0, 1, 0))
		{
			return Global_2689235[iParam0 /*453*/].f_318.f_6 != -1;
		}
	}
...
int func_211(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_214(bParam1, bParam2, bParam3) || is_ped_in_any_vehicle(player_ped_id(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((get_game_timer() - uParam0->f_4) > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), true) || func_212(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	switch (iLocal_1172)
	{
		...
		case 1:
			if (func_224(*uParam1, uParam1->f_1, &Local_120, &uLocal_122, 1, 0, 0, 1, 1) || iLocal_1212)
			{
				...
				{
					set_entity_load_collision_flag(*uParam1, true, 1);
					if (is_ped_in_vehicle(*uParam1, uParam1->f_1, false))
					{
						if (is_vehicle_driveable(uParam1->f_1, false))
						{
							if (!is_ped_in_any_vehicle(player_ped_id(), false))
							{
								task_vehicle_mission_ped_target(*uParam1, uParam1->f_1, player_ped_id(), 8, 35f, 786468, 500f, -1f, true);
							}
							else
							{
								task_vehicle_mission(*uParam1, uParam1->f_1, get_vehicle_ped_is_in(player_ped_id(), false), 8, 35f, 786468, 500f, -1f, true);
							}
						}
					}
					else
					{
						task_smart_flee_ped(*uParam1, player_ped_id(), 1000f, -1, false, false);
					}
				}
				settimera(0);
				iLocal_1172 = 2;
			...
			{
				if (!is_ped_in_any_vehicle(*uParam1, false))
				{
					set_ped_into_vehicle(*uParam1, uParam1->f_1, -1);
					set_vehicle_on_ground_properly(uParam1->f_1, 5f);
				}
				set_vehicle_forward_speed(uParam1->f_1, 4f);
				open_sequence_task(&iVar0);
				task_vehicle_mission_coors_target(0, uParam1->f_1, -1637.682f, 1018.619f, 152.1026f, 4, 22f, 786468, 10f, -1f, true);
				task_vehicle_drive_wander(0, uParam1->f_1, 22f, 786468);
				close_sequence_task(iVar0);
		...
		case 2:
			...
			else if (!is_ped_injured(*uParam1))
			{
				if (!iLocal_1220)
				{
					if (!is_ped_in_any_vehicle(*uParam1, false))
					{
						if (get_script_task_status(*uParam1, 780511057) != 1)
						{
							set_ped_combat_attributes(*uParam1, 1, false);
							task_smart_flee_ped(*uParam1, player_ped_id(), 1000f, -1, false, false);
							iLocal_1220 = 1;
						}
					}
				}
				if ((func_264(*uParam1, 1) < 15f && !func_51()) && !is_ped_ragdoll(*uParam1))
				{
					if (!iLocal_1215)
					{
...
{
	func_44(&iLocal_1271);
	fLocal_1253 = get_random_float_in_range(3f, 7f);
}
...
int func_225(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_264(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_228(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_229(iVar1))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
		...
		if (is_vehicle_driveable(iParam0, false))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1, false) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, true))
				{
					...
					{
						if (func_282(player_ped_id(), iParam0, 1) < 40f)
						{
...
void func_231(var uParam0)
{
	...
	set_blip_colour(uParam0->f_2, 1);
	set_blip_route(uParam0->f_2, false);
}
...
int func_232(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_102(network_is_game_in_progress(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_102(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, bParam1);
	}
	else if (is_entity_an_object(iParam0))
	{
...
void func_233(var uParam0)
{
	switch (iLocal_1172)
	{
		...
		case 1:
			if (!iLocal_1210)
			{
				if ((((func_224(*uParam0, 0, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || has_bullet_impacted_in_area(get_entity_coords(*uParam0, true), 15f, false, true)) || iLocal_1212) || func_264(*uParam0, 1) < 5f) || (is_ped_in_flying_vehicle(player_ped_id()) && func_264(*uParam0, 1) <= 35f))
				{
					if (!is_ped_injured(*uParam0))
					{
						...
						task_play_anim(*uParam0, "oddjobs@assassinate@multi@windowwasher", "_shot_reaction", 8f, -8f, -1, 2, 0f, false, false, false);
						iLocal_1172 = 2;
					}
				}
			}
		...
		case 2:
			...
			if (get_script_task_status(*uParam0, -2017877118) != 1 && get_script_task_status(*uParam0, 474215631) != 1)
			{
				task_cower(*uParam0, -1);
			}
			break;
	}
	if (bLocal_1219)
...
void func_235(var uParam0, var uParam1)
{
	...
	switch (iLocal_1172)
	{
		case 0:
			...
			{
				set_boat_sinks_when_wrecked(uParam1->f_1, true);
			}
			if (!is_entity_dead(*uParam1, false))
			{
				set_ragdoll_blocking_flags(*uParam1, 16);
			}
			if (!is_entity_dead(uParam1->f_7, false))
			{
				set_ragdoll_blocking_flags(uParam1->f_7, 16);
				set_entity_health(uParam1->f_7, 105, 0);
			}
		...
		case 1:
			...
			if (((func_224(*uParam1, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || func_224(uParam1->f_7, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1)) || func_244(uParam1)) || (func_243(*uParam1, 50f) && iLocal_1212))
			{
				if (!is_ped_injured(*uParam1))
				{
					if (fVar1 <= 75f)
					{
						if (!is_entity_dead(uParam1->f_1, false))
						{
							...
							{
								iLocal_1298 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
								attach_synchronized_scene_to_entity(iLocal_1298, uParam1->f_1, get_entity_bone_index_by_name(uParam1->f_1, "seat_dside_r"));
								task_synchronized_scene(*uParam1, iLocal_1298, "veh@boat@marquis@rps@enter_exit", "jump_out", 4f, -4f, 0, 1, 1000f, 0);
							}
						}
					}
					else
					{
						...
						if (!is_entity_dead(uParam1->f_1, false))
						{
							iLocal_1298 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
							attach_synchronized_scene_to_entity(iLocal_1298, uParam1->f_1, get_entity_bone_index_by_name(uParam1->f_1, "seat_dside_r"));
							task_synchronized_scene(*uParam1, iLocal_1298, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_m", 4f, -1000f, 0, 1, 1000f, 0);
						}
					}
				}
				if (!is_ped_injured(uParam1->f_7))
				{
					...
					{
						task_play_anim(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_f", 8f, -8f, -1, 0, 0f, false, false, false);
						task_play_anim(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0f, false, false, false);
					}
					close_sequence_task(iVar0);
					task_perform_sequence(uParam1->f_7, iVar0);
					clear_sequence_task(&iVar0);
					set_ped_keep_task(uParam1->f_7, true);
				...
				if (!is_ped_injured(uParam1->f_9))
				{
					if (get_script_task_status(uParam1->f_9, 1805844857) != 1)
					{
						clear_ped_tasks(uParam1->f_9);
						task_smart_flee_ped(uParam1->f_9, player_ped_id(), 200f, -1, false, false);
						set_ped_keep_task(uParam1->f_9, true);
					}
				}
				iLocal_1236 = 0;
				set_entity_load_collision_flag(*uParam1, true, 1);
			...
			else
			{
				...
				if (!iLocal_1216)
				{
					if (is_ped_in_vehicle(player_ped_id(), iLocal_1262, false))
					{
						if (!is_ped_injured(uParam1->f_9))
						{
							if (get_script_task_status(uParam1->f_9, 1805844857) != 1)
		...
		case 2:
			if (!is_entity_dead(*uParam1, false))
			{
				if (!is_entity_dead(uParam1->f_1, false))
				{
					if (get_ped_in_vehicle_seat(uParam1->f_1, -1, false) != *uParam1)
					{
						if (bLocal_1225)
						{
							if (is_synchronized_scene_running(iLocal_1298))
							{
								fVar2 = get_synchronized_scene_phase(iLocal_1298);
							}
							if (fVar2 > 0.8f)
							{
								clear_ped_tasks(*uParam1);
								set_ped_into_vehicle(*uParam1, uParam1->f_1, -1);
							}
						}
						else
						{
							...
							if (fVar2 > 0.9f)
							{
								if (get_script_task_status(*uParam1, 1805844857) != 1)
								{
									task_smart_flee_ped(*uParam1, player_ped_id(), 1000f, -1, false, false);
								}
							}
					...
					else if (get_script_task_status(*uParam1, -1273030092) != 1)
					{
						task_vehicle_mission_coors_target(*uParam1, uParam1->f_1, get_entity_coords(player_ped_id(), true), 8, 20f, 786468, 500f, -1f, true);
					}
				}
				if (!iLocal_1214)
				{
	...
	switch (iLocal_1238)
	{
		case 0:
			if (!func_51())
			{
				if (iLocal_1237 == -1)
				{
					iLocal_1237 = get_random_int_in_range(0, 4);
				}
		...
		case 2:
			if (func_221())
			{
				if (iLocal_1237 == -1)
				{
					iLocal_1237 = get_random_int_in_range(0, 3);
				}
				else if (iLocal_1237 == 0)
				{
...
int func_242(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			task_look_at_entity(Local_975.f_0, player_ped_id(), 5000, 0, 2);
			*iParam0++;
			break;
...
int func_243(int iParam0, float fParam1)
{
	...
	if (get_player_wanted_level(player_id()) > 0)
	{
		if (!is_ped_injured(iParam0))
		{
			...
			if (is_cop_ped_in_area_3d((Var0.f_0 - fParam1), (Var0.f_1 - fParam1), (Var0.f_2 - fParam1), (Var0.f_0 + fParam1), (Var0.f_1 + fParam1), (Var0.f_2 + fParam1)))
			{
				return 1;
			}
		}
...
int func_244(var uParam0)
{
	...
	{
		if (is_ped_in_vehicle(player_ped_id(), uParam0->f_1, true) || is_entity_touching_entity(player_ped_id(), uParam0->f_1))
		{
			return 1;
		}
	}
...
void func_245(var uParam0, var uParam1)
{
	...
	switch (iLocal_1172)
	{
		...
		case 1:
			if (((((func_224(*uParam1, 0, &Local_120, &uLocal_122, 1, 0, 0, 1, 1) || func_255(&bLocal_1217)) || func_254(*uParam1, &iLocal_1277, 1f, 20f, &uLocal_1218)) || (func_243(*uParam1, 25f) && iLocal_1212)) || is_explosion_in_angled_area(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1212)
			{
				stop_scripted_conversation(false);
				...
				if (is_ped_shooting(player_ped_id()) || (iVar2 && iVar1 != joaat("weapon_unarmed")))
				{
					task_smart_flee_ped(*uParam1, player_ped_id(), 500f, -1, false, false);
				}
				else
				{
					task_combat_ped(*uParam1, player_ped_id(), 0, 16);
				}
				func_267(0);
				set_entity_load_collision_flag(*uParam1, true, 1);
				iLocal_1212 = 1;
		...
		case 2:
			...
			{
				iVar0 = func_250(0, get_entity_coords(player_ped_id(), true), 20f);
				if (iVar0 != 0)
				{
		...
		if (!func_51())
		{
			if (!iLocal_1212)
			{
				if (!iLocal_1213)
				{
					...
					else if (func_264(*uParam0, 1) < 20f && !is_message_being_displayed())
					{
						func_249(uParam0);
					}
				}
			...
			else
			{
				if (!iLocal_1214)
				{
					if (get_script_task_status(*uParam0, 1805844857) == 1)
					{
				...
				if (!iLocal_1215)
				{
					if (get_script_task_status(*uParam0, 780511057) == 1)
					{
...
void func_247(var uParam0)
{
	if (!is_ped_injured(*uParam0))
	{
		...
		{
			if (is_entity_playing_anim(*uParam0, "misscommon@response", "bring_it_on", 3))
			{
		...
		{
			if (get_script_task_status(*uParam0, -2017877118) != 1 && !func_51())
			{
		...
		{
			if (is_entity_playing_anim(*uParam0, "misscommon@response", "threaten", 3))
			{
		...
		{
			if (get_script_task_status(*uParam0, -2017877118) != 1)
			{
...
void func_248(int iParam0, char* sParam1, char* sParam2)
{
	...
	task_play_anim(0, sParam1, sParam2, 4f, -4f, -1, 0, 0f, false, false, false);
	close_sequence_task(iVar0);
...
void func_249(var uParam0)
{
	...
	else if (iLocal_1242 < 7)
	{
		if (func_45(&iLocal_1271) > fLocal_1253 && !func_51())
		{
			...
			func_44(&iLocal_1271);
			fLocal_1253 = get_random_float_in_range(5f, 8f);
			iLocal_1242++;
		}
	}
}

var func_250(bool bParam0, struct<3> Param1, float fParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 1)
	{
		if (!is_ped_injured(Local_1874[iVar0 /*9*/]))
		{
			if ((bParam0 && is_ped_male(Local_1874[iVar0 /*9*/])) || (!bParam0 && !is_ped_male(Local_1874[iVar0 /*9*/])))
			{
...
float func_251(int iParam0, struct<3> Param1, bool bParam2)
{
	if (is_entity_dead(iParam0, false))
	{
		return -1f;
	...
	if (!is_ped_injured(Local_1874[iVar0 /*9*/]))
	{
		switch (Local_1874[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (get_script_task_status(Local_1874[iVar0 /*9*/], 242628503) != 1)
					{
						clear_ped_tasks(Local_1874[iVar0 /*9*/]);
						open_sequence_task(&iVar1);
						task_go_to_coord_any_means(0, Local_1874[iVar0 /*9*/].f_1, 1f, 0, false, 786603, -1f);
						task_turn_ped_to_face_coord(0, Local_1257, 0);
						close_sequence_task(iVar1);
						task_perform_sequence(Local_1874[iVar0 /*9*/], iVar1);
						clear_sequence_task(&iVar1);
					}
				}
				else if (get_script_task_status(Local_1874[iVar0 /*9*/], 242628503) != 1 && get_script_task_status(Local_1874[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (get_script_task_status(Local_1874[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (get_script_task_status(Local_1874[iVar0 /*9*/], -1146898486) != 1)
				{
					task_wander_standard(Local_1874[iVar0 /*9*/], 40000f, 0);
				}
				break;
			}
	}
	...
	if (!is_ped_ragdoll(iParam0))
	{
		if (bParam1)
		{
			if (is_ped_male(iParam0))
			{
				...
				if (iVar0 == 0)
				{
					task_play_anim(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
				}
				else if (iVar0 == 1)
				{
					task_play_anim(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
				}
				else
				{
					task_play_anim(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					task_play_anim(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
				}
				else
				{
					task_play_anim(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, get_random_float_in_range(0f, 1f), false, false, false);
...
void func_256()
{
	if (does_entity_exist(Local_975.f_0))
	{
		if (!is_ped_injured(Local_975.f_0))
		{
			set_ped_reset_flag(Local_975.f_0, 187, true);
			set_ped_reset_flag(Local_975.f_0, 155, true);
		}
	}
}
...
void func_261(var uParam0)
{
	...
	if (is_vehicle_driveable(uParam0->f_1, false))
	{
		if (!is_ped_injured(*uParam0))
		{
			if (!is_entity_playing_anim(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 3))
			{
				task_play_anim(*uParam0, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_m", 8f, -8f, -1, 1, 0f, false, false, false);
			}
			if (!is_entity_attached(*uParam0))
			{
				attach_entity_to_entity(*uParam0, uParam0->f_1, 0, Var0, Var1, true, true, false, false, 2, true, 0);
			}
		}
		if (!is_ped_injured(uParam0->f_7))
		{
			if (!is_entity_playing_anim(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 3))
			{
				task_play_anim(uParam0->f_7, "oddjobs@assassinate@multi@yachttarget@lapdance", "yacht_ld_f", 8f, -8f, -1, 1, 0f, false, false, false);
			}
			if (!is_entity_attached(uParam0->f_7))
			{
				attach_entity_to_entity(uParam0->f_7, uParam0->f_1, 0, Var2, Var3, true, true, true, false, 2, true, 0);
			}
		}
	}
}
...
void func_262(var uParam0, var uParam1)
{
	...
	{
		case 0:
			if (get_script_task_status(*uParam1, 242628503) != 1)
			{
				fVar1 = get_entity_heading(*uParam1);
				if (fVar1 < (uParam0->f_4 - 20f) || fVar1 > (uParam0->f_4 + 20f))
				{
					if (get_script_task_status(*uParam1, 1920390111) != 1)
					{
						task_achieve_heading(*uParam1, uParam0->f_4, 0);
					}
				}
				else
				{
					open_sequence_task(&iVar0);
					task_play_anim(0, "oddjobs@assassinate@multi@", "idle_a", 4f, -4f, -1, 1, 0f, false, false, false);
					close_sequence_task(iVar0);
					task_perform_sequence(*uParam1, iVar0);
					clear_sequence_task(&iVar0);
				}
...
{
	return func_282(get_player_ped(get_player_index()), iParam0, bParam1);
}
...
int func_266(int iParam0)
{
	if (iLocal_1171 == 0)
	{
		if ((func_224(*iParam0, 0, &Local_120, &uLocal_122, 0, 0, 0, 1, 1) || func_255(&bLocal_1217)) || is_explosion_in_sphere(-1, Local_1257, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1221)
	{
		...
		while (iVar0 <= 1)
		{
			if (!is_ped_injured(Local_1874[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (get_script_task_status(Local_1874[iVar0 /*9*/], 1805844857) != 1)
					{
						task_smart_flee_ped(Local_1874[iVar0 /*9*/], player_ped_id(), 200f, -1, false, false);
						set_ped_keep_task(Local_1874[iVar0 /*9*/], true);
					}
				}
				else if (get_script_task_status(Local_1874[iVar0 /*9*/], 1805844857) != 1)
				{
					task_go_to_coord_any_means(Local_1874[iVar0 /*9*/], func_268(), 2f, 0, false, 786603, -1f);
					set_ped_keep_task(Local_1874[iVar0 /*9*/], true);
				}
			}
			if (bParam0)
...
Vector3 func_268()
{
	...
	iVar1 = (get_random_int_in_range(0, 65535) % 6);
	switch (iVar1)
	{
		case 0:
...
int func_269(int iParam0, var uParam1)
{
	if (is_screen_faded_in())
	{
		...
		else if (does_entity_exist(*iParam0))
		{
			if (is_ped_injured(*iParam0))
			{
				if (is_vehicle_driveable(iParam0->f_1, false) && has_entity_been_damaged_by_entity(*iParam0, iParam0->f_1, true))
				{
					iLocal_957 = 1;
				}
			...
			else if (is_vehicle_driveable(iParam0->f_1, false))
			{
				...
				{
					if (get_entity_speed(iParam0->f_1) > 10f && is_entity_touching_entity(iParam0->f_1, *iParam0))
					{
						if (is_ped_in_any_vehicle(*iParam0, false))
						{
							knock_ped_off_vehicle(*iParam0);
						}
						set_entity_health(*iParam0, 0, 0);
						iLocal_957 = 1;
						_0x293220DA1B46CEBC(3f, 2f, 3);
						return 1;
					}
...
int func_272(var uParam0)
{
	...
	if (has_model_loaded(*uParam0) && has_model_loaded(uParam0->f_14))
	{
		return 1;
	}
	return 0;
...
void func_273(var uParam0, int iParam1)
{
	switch (iLocal_1171)
	{
		case 0:
			...
			{
				set_ped_component_variation(*iParam1, 0, 0, 0, 0);
		...
		case 1:
			...
			{
				iParam1->f_9 = create_ped(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, true, true);
				force_ped_ai_and_animation_update(iParam1->f_9, false, false);
				task_start_scenario_at_position(iParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, false, true);
				set_ped_combat_attributes(iParam1->f_9, 17, true);
			}
			if (!is_ped_injured(iParam1->f_7))
			{
				set_blocking_of_non_temporary_events(iParam1->f_7, true);
				set_ped_dies_in_water(iParam1->f_7, false);
				set_ped_component_variation(iParam1->f_7, 0, 1, 0, 0);
				set_ped_component_variation(iParam1->f_7, 2, 1, 2, 0);
				set_ped_component_variation(iParam1->f_7, 3, 0, 3, 0);
				set_ped_component_variation(iParam1->f_7, 4, 0, 3, 0);
				set_ped_component_variation(iParam1->f_7, 8, 1, 0, 0);
			}
			if (does_entity_exist(iParam1->f_1))
			{
				set_vehicle_radio_enabled(iParam1->f_1, true);
				set_vehicle_radio_loud(iParam1->f_1, true);
				_set_entity_cleanup_by_engine(iParam1->f_1, true);
			}
			if (!is_ped_injured(*iParam1))
			{
				set_ped_dies_in_water(*iParam1, false);
				func_38(&uLocal_1299, 3, *iParam1, "OJAmlYACHTTARGET", 0, 1);
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlYACHTTARGET", 0, 1);
				set_entity_load_collision_flag(*iParam1, true, 1);
			}
			iLocal_1262 = create_vehicle(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, true, true, false);
			remove_scenario_blocking_area(iLocal_1270, false);
			iLocal_1270 = add_scenario_blocking_area(Vector(-0.10296f, -468.8926f, -2182.363f) - Vector(15f, 15f, 15f), Vector(-0.10296f, -468.8926f, -2182.363f) + Vector(15f, 15f, 15f), false, true, true, true);
			iLocal_1237 = -1;
			iLocal_1238 = 0;
			break;
		
		case 2:
			if ((!is_ped_injured(*iParam1) && does_entity_exist(iParam1->f_11[0])) && does_entity_exist(iParam1->f_11[1]))
			{
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlWASHER", 0, 1);
				attach_entity_to_entity(*iParam1, iParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, true, true, false, false, 2, true, 0);
				task_play_anim(*iParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0f, false, false, false);
				set_entity_lod_dist(iParam1->f_11[0], 225);
				set_entity_lod_dist(iParam1->f_11[1], 225);
			}
			break;
		...
		case 3:
			if (!is_ped_injured(*iParam1))
			{
				set_ped_combat_attributes(*iParam1, 6, true);
				give_ped_helmet(*iParam1, false, 4096, -1);
				set_ped_helmet(*iParam1, true);
				...
				{
					set_ped_into_vehicle(*iParam1, iParam1->f_1, -1);
					set_vehicle_on_ground_properly(iParam1->f_1, 5f);
				}
			}
			iLocal_1264 = create_vehicle(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, true, true, false);
			set_vehicle_on_ground_properly(iLocal_1264, 5f);
			iLocal_1265 = create_vehicle(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, true, true, false);
			set_vehicle_on_ground_properly(iLocal_1265, 5f);
			break;
	}
	if (!is_ped_injured(*iParam1))
	{
		set_entity_is_target_priority(*iParam1, true, 0f);
	}
}
...
void func_274()
{
	...
	Local_1874[0 /*9*/] = create_ped(5, joaat("a_f_y_fitness_02"), Local_1874[0 /*9*/].f_1, 169.9513f, true, true);
	func_253(Local_1874[0 /*9*/], 1);
	Local_1874[1 /*9*/] = create_ped(5, joaat("a_f_y_beach_01"), Local_1874[1 /*9*/].f_1, 257.4617f, true, true);
	func_253(Local_1874[1 /*9*/], 1);
	set_ped_combat_attributes(Local_1874[0 /*9*/], 17, true);
	set_ped_combat_attributes(Local_1874[0 /*9*/], 1, false);
	set_blocking_of_non_temporary_events(Local_1874[0 /*9*/], true);
	set_ped_combat_attributes(Local_1874[1 /*9*/], 17, true);
	set_ped_combat_attributes(Local_1874[1 /*9*/], 1, false);
	set_blocking_of_non_temporary_events(Local_1874[1 /*9*/], true);
}
...
void func_275(var uParam0, int iParam1)
{
	...
	func_38(&(iParam1->f_16), 1, player_ped_id(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_274 == 1)
	{
		set_blip_name_from_text_file(iParam1->f_2, "ASS_HK_DESTBLIP");
	}
	else if (uParam0->f_274 == 0)
	{
	}
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		...
		{
			iParam1->f_7 = create_ped(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, true, true);
			if (uParam0->f_274 == 1)
			{
				task_play_anim(iParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0f, false, false, false);
				set_ped_can_use_auto_conversation_lookat(iParam1->f_7, true);
				func_38(&(iParam1->f_16), 4, iParam1->f_7, "OJAhkHOOKER", 0, 1);
				set_blocking_of_non_temporary_events(iParam1->f_7, true);
				set_ped_combat_attributes(iParam1->f_7, 17, true);
				set_ped_flee_attributes(iParam1->f_7, 128, true);
				set_ped_config_flag(iParam1->f_7, 134, true);
			}
		}
	}
	if (uParam0->f_15 != 0)
	{
		if (uParam0->f_274 != 0)
		{
			iParam1->f_8 = create_vehicle(uParam0->f_15, uParam0->f_26, uParam0->f_29, true, true, false);
		}
		if (uParam0->f_274 == 1)
		{
			set_vehicle_extra(iParam1->f_8, 3, false);
			remove_vehicle_window(iParam1->f_8, 1);
			remove_vehicle_window(iParam1->f_8, 0);
			iLocal_959 = create_ped_inside_vehicle(iParam1->f_8, 4, uParam0->f_16, -1, true, true);
			set_blocking_of_non_temporary_events(iLocal_959, true);
	...
	if (uParam0->f_274 == 2)
	{
		if (!does_blip_exist(iParam1->f_2))
		{
			...
			set_blip_route_colour(iParam1->f_2, 1);
			set_blip_colour(iParam1->f_2, 1);
		}
	}
	else if (uParam0->f_274 == 0)
	{
		iParam1->f_2 = add_blip_for_coord(uParam0->f_6);
		set_blip_route(iParam1->f_2, true);
		set_blip_route_colour(iParam1->f_2, 3);
		set_blip_colour(iParam1->f_2, 3);
		set_blip_name_from_text_file(iParam1->f_2, "ASS_BS_BLIP");
	}
	else
	{
		iParam1->f_2 = add_blip_for_coord(uParam0->f_6);
	...
	while (iVar0 < 4)
	{
		...
		{
			iParam1->f_11[iVar0] = create_object(uParam0->f_244[iVar0], uParam0->f_249[iVar0 /*3*/], true, true, false);
			set_entity_records_collisions(iParam1->f_11[iVar0], true);
			set_entity_collision(iParam1->f_11[iVar0], true, false);
			if (iVar0 == 1)
			{
				freeze_entity_position(iParam1->f_11[iVar0], true);
			}
			if (uParam0->f_262[iVar0] != 0f)
			{
				set_entity_heading(iParam1->f_11[iVar0], uParam0->f_262[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_278(var uParam0, var uParam1)
{
	if (!does_entity_exist(*uParam1))
	{
		*uParam1 = create_ped(4, *uParam0, uParam0->f_1, uParam0->f_4, true, true);
		...
		if (!iLocal_961)
		{
			add_relationship_group("Target", &iLocal_971);
			iLocal_961 = 1;
		}
		set_relationship_between_groups(5, iLocal_971, joaat("player"));
		set_relationship_between_groups(5, joaat("player"), iLocal_971);
		set_ped_relationship_group_hash(*uParam1, iLocal_971);
		if (uParam0->f_268)
		{
...
int func_280(var uParam0)
{
	...
	request_model(joaat("a_f_y_fitness_02"));
	if ((has_model_loaded(*uParam0) && has_model_loaded(joaat("a_f_y_beach_01"))) && has_model_loaded(joaat("a_f_y_fitness_02")))
	{
		return 1;
	}
	return 0;
...
{
	return func_251(get_player_ped(get_player_index()), Param0, bParam1);
}
...
void func_283()
{
	...
	if (func_510(&iLocal_1283))
	{
		if (func_45(&iLocal_1283) > 30f)
		{
			...
			if (iLocal_1234 == 1)
			{
				if (vdist(Var0, Local_1296[0 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
			...
			{
				if (vdist(Var0, Local_1296[1 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
						set_player_wanted_level(player_id(), 2, false);
			...
			{
				if (vdist(Var0, Local_1296[2 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
						set_player_wanted_level(player_id(), 2, false);
...
void func_284()
{
	if (iLocal_1171 == 2)
	{
		if (!does_rope_exist(&iLocal_1256))
		{
			if (!is_ped_injured(Local_975.f_0))
			{
				if (!iLocal_1210)
				{
					set_entity_load_collision_flag(Local_975.f_0, true, 1);
					set_ped_to_ragdoll(Local_975.f_0, 1, 1, 0, true, true, false);
				}
			}
			if (load_stream("WINDOWWASHERFALL_MASTER", 0))
			{
				play_stream_from_position(-648.59f, 305.73f, 120f);
			}
			if (is_first_person_aim_cam_active())
			{
				set_first_person_aim_cam_zoom_factor(1f);
			}
			iLocal_1210 = 1;
		}
		else if (!does_rope_exist(&iLocal_1255))
		{
			if (!is_ped_injured(Local_975.f_0))
			{
				if (!iLocal_1210)
			...
			if (load_stream("WINDOWWASHERFALL_MASTER", 0))
			{
				play_stream_from_position(-638.1931f, 306.014f, 121.4236f);
			}
			if (is_first_person_aim_cam_active())
			{
				set_first_person_aim_cam_zoom_factor(1f);
...
void func_285(var uParam0, var uParam1)
{
	...
	if (does_entity_exist(uParam1->f_11[0]))
	{
		Var3 = { get_entity_coords(uParam1->f_11[0], true) };
	}
	else
	{
	...
	if (!is_entity_dead(*uParam1, false))
	{
		Var1 = { get_entity_coords(*uParam1, true) };
	}
	switch (iLocal_1244)
	{
		case 0:
			if (!bLocal_1219)
			{
				if (iLocal_1171 == 2)
				{
					if (vdist2(Var0, Var1) < 40000f)
					{
						if (does_entity_exist(uParam1->f_11[0]))
						{
							if (does_entity_exist(uParam1->f_11[1]))
							{
								...
								else
								{
									if (!does_rope_exist(&iLocal_1256))
									{
										iLocal_1256 = add_rope(-648.59f, 305.73f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, false, false, true, 5f, true, 0);
									}
									if (!does_rope_exist(&iLocal_1255))
									{
										iLocal_1255 = add_rope(-638.93f, 304.92f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, false, false, true, 5f, true, 0);
									}
									if (does_rope_exist(&iLocal_1255) && does_rope_exist(&iLocal_1256))
									{
										attach_entities_to_rope(iLocal_1256, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar5, -648.59f, 305.73f, Var3.f_2, fVar6, false, false, 0, 0);
										attach_entities_to_rope(iLocal_1255, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar5, -638.93f, 304.92f, Var3.f_2, fVar6, false, false, 0, 0);
										bLocal_1219 = true;
										iLocal_1244 = 1;
									}
								}
		...
		case 1:
			...
			{
				if (is_entity_on_screen(uParam1->f_11[0]))
				{
					if (iLocal_1172 < 2)
					{
						if (!is_ped_injured(*uParam1))
						{
							...
							task_play_anim(0, "oddjobs@assassinate@multi@windowwasher", "_idle_to_up", 8f, -8f, -1, 0, 0f, false, false, false);
							task_play_anim(0, "oddjobs@assassinate@multi@windowwasher", "_up_loop", 1000f, -8f, -1, 1, 0f, false, false, false);
							close_sequence_task(iVar4);
							task_perform_sequence(*uParam1, iVar4);
		...
		case 2:
			Var2 = { get_entity_coords(uParam1->f_11[0], true) };
			if (is_entity_dead(*uParam1, false))
			{
				iLocal_1244 = 3;
			}
			if (does_rope_exist(&iLocal_1256) && does_rope_exist(&iLocal_1255))
			{
				start_rope_winding(iLocal_1256);
				start_rope_winding(iLocal_1255);
				if (Var2.f_2 >= 125f)
				{
					if (iLocal_1172 < 2)
					{
						...
						{
							open_sequence_task(&iVar4);
							task_play_anim(0, "oddjobs@assassinate@multi@windowwasher", "_up_to_wash", 8f, -8f, -1, 0, 0f, false, false, false);
							task_play_anim(0, "oddjobs@assassinate@multi@windowwasher", "_wash_loop", 1000f, -8f, -1, 1, 0f, false, false, false);
							close_sequence_task(iVar4);
							task_perform_sequence(*uParam1, iVar4);
							clear_sequence_task(&iVar4);
						}
					}
					stop_rope_winding(iLocal_1256);
					stop_rope_winding(iLocal_1255);
					iLocal_1244 = 3;
					apply_force_to_entity(uParam1->f_11[0], 2, -20f, 0f, -20f, -4.78f, 0.65f, -0.78f, 0, false, false, true, false, true);
				}
			}
			else
			{
...
void func_286()
{
	if (!does_entity_exist(iLocal_1268))
	{
		if (!is_entity_dead(player_ped_id(), false))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), false))
			{
				iLocal_1268 = get_vehicle_ped_is_in(player_ped_id(), false);
				if (does_entity_exist(iLocal_1268) && !is_entity_dead(iLocal_1268, false))
				{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			if (Global_97772[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || get_entity_model(iParam0) == func_294(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		*uParam1 = get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(&(uParam1->f_77), func_297(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_303()
{
	...
	if (!does_entity_exist(iLocal_1176))
	{
		return;
	}
	if (!is_entity_dead(player_ped_id(), false))
...
void func_305(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_372(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_365(get_this_script_name(), 1);
			if (iVar4 != -1)
			{
...
{
	func_307(&Global_106934, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_307(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_325(player_ped_id());
		func_318(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_317())
		{
			func_313(player_ped_id(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_319(int iParam0, var uParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = get_ped_weapontype_in_slot(iParam0, func_324(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((_get_dlc_weapon_data_sp(iVar5, &Var7) && !func_321(Var7.f_1)) && iVar9 < 51)
			{
...
int func_329(var uParam0)
{
	if (!is_entity_dead(player_ped_id(), false) && !is_ped_injured(player_ped_id()))
	{
		if (func_351())
		{
			*uParam0 = func_335(get_entity_coords(player_ped_id(), false), 6, -1, 0, 1, -1);
...
int func_335(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam1 == 6 || iParam1 == func_350(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(Param0, func_336(iVar0, 0), true);
...
Vector3 func_340(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
var func_352()
{
	...
	func_362(&uVar0, get_clock_seconds());
	func_361(&uVar0, get_clock_minutes());
	func_360(&uVar0, get_clock_hours());
	func_355(&uVar0, get_clock_day_of_month());
	func_354(&uVar0, get_clock_month());
	func_353(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_358(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
void func_367(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_377(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20465)
	{
		if (Global_20266.f_1 == 6)
		{
			...
			func_380(1);
			func_382(Global_20247, "DISPLAY_VIEW", 1f, to_float(Global_20246), -1082130432, -1082130432, -1082130432);
		}
	}
	...
	func_378(iParam0, sParam1, bVar1, func_379(player_id()));
	return 1;
}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (Global_2725398)
							{
								if (iVar1 == 14)
								{
									func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22668), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8705[iVar0] = 1;
						}
					...
					if (iVar0 == Global_8143[iVar1 /*15*/].f_4)
					{
						if (Global_8705[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(Global_22673), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_78319)
								{
									...
									func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20266)
									...
									func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_8143[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_381(Global_20247, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8143[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8143[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8705[iVar0] = 1;
						}
					}
...
int func_387(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_391()
{
	request_model(joaat("premier"));
	request_model(joaat("dilettante"));
	request_model(joaat("vigero"));
	while ((!has_model_loaded(joaat("premier")) || !has_model_loaded(joaat("dilettante"))) || !has_model_loaded(joaat("vigero")))
	{
		return 0;
	}
	return 1;
...
int func_400(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!has_additional_text_loaded(3) && !func_396(&(uParam0->f_34))) && !func_392(uParam1))
	{
		func_514(uParam1);
		return 0;
	}
...
int func_405(int iParam0, bool bParam1)
{
	...
	{
		if ((func_410() || is_pc_version()) || func_409())
		{
		}
		else if (!func_412())
		{
...
void func_420()
{
	if (!does_entity_exist(iLocal_1266[0]))
	{
		iLocal_1266[0] = create_vehicle(iLocal_1269[0], -723.8201f, -916.5402f, 18.0145f, 267.798f, true, true, false);
	}
	if (!does_entity_exist(iLocal_1266[1]))
	{
		iLocal_1266[1] = create_vehicle(iLocal_1269[1], -735.5003f, -931.6205f, 18.0173f, 359.3239f, true, true, false);
		set_entity_lod_dist(iLocal_1266[1], 100);
	}
	if (!does_entity_exist(iLocal_1266[2]))
	{
		iLocal_1266[2] = create_vehicle(iLocal_1269[0], -726.7143f, -940.2681f, 18.0173f, 178.3615f, true, true, false);
	}
	if (!does_entity_exist(iLocal_1266[3]))
	{
		iLocal_1266[3] = create_vehicle(iLocal_1269[2], -730.5711f, -909.9425f, 18.0349f, 357.4066f, true, true, false);
	}
}
	...
	if (func_403(uParam0))
	{
		...
		if (func_402(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_439(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, false)) || func_311(iParam0, 0, 0)) || func_311(iParam0, 1, 0)) || func_311(iParam0, 2, 0)) || func_292(iParam0) != 145) || func_429(iParam0)) || func_428(iParam0)) || func_427(iParam0)) || func_426(iParam0)) || !func_425(get_entity_model(iParam0)))
	{
		if (func_428(iParam0))
		{
		}
...
int func_439(int iParam0, struct<3> Param1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_440(iParam0, uVar1[iVar3], 1) && func_404(get_entity_coords(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_210(Param1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, true), get_entity_coords(uVar1[iVar3], true), true) < 10f)
					{
...
void func_442(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_97772[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_97772[iVar0]) == func_294(iParam0, iParam1))
				{
...
void func_443(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (is_vehicle_driveable(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_297(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_297(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_297(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					...
					{
						set_bit(&(uParam1->f_77), func_297(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			...
			{
				set_bit(&(uParam1->f_77), func_297(4));
			}
		}
		...
		{
			set_bit(&(uParam1->f_77), func_297(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar5 <= 2)
			{
				...
				{
					set_bit(&(uParam1->f_77), func_297(iVar5));
				}
				iVar5++;
			}
		}
		...
		if (((func_444() && is_this_model_a_plane(uParam1->f_66)) && _does_vehicle_have_landing_gear(iParam0)) && !is_vehicle_model(iParam0, joaat("avenger")))
		{
...
int func_449(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_453(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_452(*iParam0, ((*uParam1)[38] - 1)))
	{
		set_vehicle_mod(*iParam0, 24, func_452(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_451(iParam0);
	if (func_450(*iParam0))
	{
...
void func_468(struct<3> Param0, float fParam1, bool bParam2)
{
	int iVar0;
...
void func_469(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!has_additional_text_loaded(3) || !func_396(&(uParam0->f_34))) || !func_392(uParam1))
	{
		func_514(uParam1);
		wait(0);
	}
...
void func_481(var uParam0)
{
	*uParam0 = joaat("s_m_y_winclean_01");
	...
	load_stream("WINDOWWASHERFALL_MASTER", 0);
	fLocal_1252 = 500f;
}
...
void func_485()
{
	...
	while (iVar0 < 3)
	{
		request_model(iLocal_1269[iVar0]);
		iVar0++;
	}
}
...
void func_488(var uParam0)
{
	if (iLocal_1174 < 3)
	{
		set_hd_area(-717.8348f, -932.1736f, 18.01735f, 26f);
	}
	switch (iLocal_1174)
	{
		case 0:
			...
			if ((has_anim_dict_loaded("oddjobs@assassinate@multi@call") && has_model_loaded(joaat("p_phonebox_01b_s"))) && func_391())
			{
				bLocal_1229 = true;
			}
			if (bLocal_1229)
			{
				if (does_entity_exist(iLocal_1175))
				{
					...
					clear_area(-700.1226f, -916.8699f, 18.1667f, 5f, true, false, false, false);
					...
					if (does_entity_exist(iLocal_1175))
					{
						set_entity_visible(iLocal_1175, false, false);
						set_entity_collision(iLocal_1175, false, false);
						set_entity_can_be_damaged(iLocal_1175, false);
						iLocal_1176 = create_object(joaat("p_phonebox_01b_s"), -700.1226f, -916.8699f, 18.1667f, true, true, false);
						set_entity_rotation(iLocal_1176, 0f, 0f, 0f, 2, true);
						set_entity_collision(iLocal_1176, false, false);
						set_entity_can_be_damaged(iLocal_1176, false);
					}
					iLocal_1200 = streamvol_create_sphere(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
					func_494(1, 1, 1, 0, 0, 0, 0);
					if (!is_entity_dead(player_ped_id(), false))
					{
						force_ped_ai_and_animation_update(player_ped_id(), false, false);
						set_entity_coords(player_ped_id(), Local_1180, true, false, false, true);
						set_entity_heading(player_ped_id(), fLocal_1181);
						set_current_ped_weapon(player_ped_id(), joaat("weapon_unarmed"), true);
						remove_ped_helmet(player_ped_id(), true);
					}
					iLocal_1199 = create_synchronized_scene(Local_1197, Local_1198, 2);
					if (does_entity_exist(iLocal_1176))
					{
						attach_synchronized_scene_to_entity(iLocal_1199, iLocal_1176, -1);
					}
					task_synchronized_scene(player_ped_id(), iLocal_1199, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
					play_synchronized_entity_anim(iLocal_1176, iLocal_1199, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1000f);
					if (!does_cam_exist(iLocal_1177))
					{
						iLocal_1178 = create_camera_with_params(26379945, Local_1185, Local_1186, 35f, true, 2);
						iLocal_1177 = create_camera_with_params(26379945, Local_1187, Local_1188, 35f, false, 2);
						set_cam_active_with_interp(iLocal_1177, iLocal_1178, 2500, 1, 1);
						render_script_cams(true, false, 3000, true, false, 0);
						shake_cam(iLocal_1177, "HAND_SHAKE", 0.2f);
					}
					func_420();
					func_38(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_38(&(uParam0->f_16), 1, player_ped_id(), "FRANKLIN", 0, 1);
				...
				else
				{
					...
					if (!does_entity_exist(iLocal_1175))
					{
						iLocal_1175 = get_closest_object_of_type(Local_1179, 5f, joaat("prop_phonebox_01b"), true, false, true);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1196)
			{
				if (!is_entity_dead(player_ped_id(), false))
				{
					if (is_synchronized_scene_running(iLocal_1199))
					{
						if (get_synchronized_scene_phase(iLocal_1199) > 0.05f)
						{
			...
			if (((func_510(&iLocal_1189) && func_45(&iLocal_1189) > fLocal_1182) || (is_synchronized_scene_running(iLocal_1199) && get_synchronized_scene_phase(iLocal_1199) >= 0.978f)) || bLocal_1195)
			{
				iLocal_1174 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1195)
			{
				if (is_screen_faded_out())
				{
					...
					{
						force_ped_ai_and_animation_update(player_ped_id(), false, false);
						set_entity_coords(player_ped_id(), -700.2628f, -917.5313f, 18.2147f, true, false, false, true);
						set_entity_heading(player_ped_id(), 73.3924f);
					}
					stop_synchronized_entity_anim(iLocal_1176, -1000f, true);
					wait(0);
		...
		case 3:
			...
			if (streamvol_is_valid(iLocal_1200))
			{
				streamvol_delete(iLocal_1200);
			}
			set_entity_collision(iLocal_1176, true, false);
			clear_hd_area();
			display_radar(true);
			display_hud(true);
			...
			set_object_as_no_longer_needed(&iLocal_1175);
			iLocal_972 = 4;
			break;
	}
}
...
int func_492(int iParam0, float fParam1, struct<3> Param2, struct<3> Param3, float fParam4, bool bParam5, float fParam6)
{
	if (does_cam_exist(*iParam0))
	{
		if (func_510(&iLocal_1192))
		{
			...
			{
				set_cam_coord(iLocal_1177, Param2);
				set_cam_rot(iLocal_1177, Param3, 2);
				set_cam_fov(iLocal_1177, fParam4);
				if (bParam5)
				{
					shake_cam(iLocal_1177, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_494(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((((!is_ped_injured(player_ped_id()) && !func_498(player_id())) && !func_496(player_id(), 0)) && !func_495()) && !bParam4) && !bParam5)
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (((!is_ped_injured(player_ped_id()) && !func_498(player_id())) && !bParam4) && !bParam5)
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_78317 = 0;
...
void func_502(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_503(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_503(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_504(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_505(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_525(var uParam0)
{
	...
	remove_road_node_speed_zone(iLocal_958);
